...
type: docs
weight: 9
url: /de/python-net/aspose-cells-for-python-net-22-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-51595|Falsche vertikale Ausrichtung des Zellentextes beim Konvertieren in PDF aus einer Excel-Datei mit Pivot-Tabelle|
|CELLSNET-51621|Freigegebene Formeln wurden für verschiedene Dateiformate falsch kopiert|
|CELLSNET-51524|Falscher Zeilenumbruch beim Konvertieren in PDF aus einer Excel-Datei mit Pivot-Tabelle|
...
|CELLSNET-51550|Links in benannten Bereichen werden bei der XLS-zu-XLSM-Konvertierung gelöscht|
|CELLSNET-51551|Beim Konvertieren von XLS-Dateien in XLSM wurden Dateien beschädigt und der externe Link in einen DDE-Link geändert|
|CELLSNET-51558|Beim Konvertieren von XLS-Dateien mit xlAlternateStartup-Link in XLSM werden beschädigte Dateien ausgegeben|
|CELLSNET-51564|Doppelte Daten des Smart Markers|
|CELLSNET-51574|Ein Textfeld mit zwei Spalten wird nur mit einer Spalte gerendert, wenn eine XLSX-Datei erneut gespeichert wird|
|CELLSNET-51580|Ein externer Link vom Typ xlPathMissing wird bei der XLS-zu-XLSM-Konvertierung in den normalen externalLinkPath-Typ geändert|
...
|CELLSNET-51696|Beim Konvertieren von XLS in XLSM wird die Datenverbindungsdefinitionseigenschaft „Passwort speichern“ geändert|
