---
title: Aspose.Cells für Python über .NET 22.9 Versionshinweise
type: docs
weight: 8
url: /de/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 

Dies ist die erste Version für Aspose.Cells für Python über .NET.
Diese Seite enthält Versionshinweise für Aspose.Cells für Python über .NET 22.9.
...
|CELLSNET-51709|Unterstützen Sie mehrere Tabellen in einem Arbeitsblatt mit .Numbers|
...
|CELLSNET-51735|Falscher fetter Text beim Konvertieren von Excel-Pivot-Tabellen in PDF|
|CELLSNET-51761|Wenn eine XLS-Datei mit Pivot-Tabelle in XLSM konvertiert wird, werden die Datenverbindungsdetails gelöscht|
|CELLSNET-51899|XLS-zu-XLSM-Konvertierung - MS Excel konnte die XLSM-Ausgabedatei nicht öffnen|
...
|CELLSNET-51800|Werte aus XLSX sind in der Ausgabe-PDF falsch|
...
|CELLSNET-51187|Vertikale gepunktete Linien, die mit den Beschriftungen auf der Achse im Diagramm zum SVG-Rendering falsch ausgerichtet sind|
|CELLSNET-51734|System.Security.Cryptography.Pkcs 6.0.1-Abhängigkeit erfordert .NET Core 3.1|
|CELLSNET-51912|Beim Konvertieren von Excel in PDF zeigt das resultierende PDF die Achse nicht korrekt an|
|CELLSNET-51744|Gridweb springt immer wieder zurück|
|CELLSNET-51608|Beim Exportieren von Excel nach HTML auf Docker (Azure Cloud Kubernetes) wird die Nummer hinter einem roten/grünen Kreis versteckt.|
|CELLSNET-51864|Problem beim Berechnen von „PageSetup.Zoom“ mit HorizontalPageBreaks|
|CELLSNET-51938|XLSX zu PDF: Zeichenabstand ist falsch|
|CELLSNET-51226|Bezeichnerattribut für Diagramm/Gruppe in Excel-Arbeitsmappe hinzufügen|
|CELLSNET-51461|Unnötige Ränder werden für die Daten in der Excel-zu-DOCX-Konvertierung hinzugefügt|
|CELLSNET-51736| Cell Ränder gingen im resultierenden PDF verloren|
...
|CELLSNET-51772|Die Verbindungsinformationen werden beim Konvertieren der XLS-Datei in XLSM geändert|
...
|CELLSNET-51829|Bei der Konvertierung von XLS- in XLSM-Dateien gingen einige benutzerdefinierte Eigenschaften verloren|
...
|CELLSNET-51865|Das XLS-Arbeitsblatt enthält keine Daten, während Sie in Excel gefüllte Zeilen sehen können|
|CELLSNET-51880|XLSB-zu-XLSM-Konvertierung - die XLSM-Ausgabedatei ist beschädigt|
|CELLSNET-51898|XLS-zu-XLSM-Konvertierung - die XLSM-Ausgabedatei ist beschädigt|
...
|CELLSNET-51922|Cell Der Schutz geht nach dem Öffnen und erneuten Speichern der XLSX-Datei verloren|
...
|CELLSNET-51965|Ausnahme beim Importieren einer XLSX-Datei mit Buchhaltungsformatierung in Aspose.Cells.GridDesktop|
|CELLSNET-51961|Ausnahme "Index war außerhalb des gültigen Bereichs" beim Rendern eines ODS in PDF|
