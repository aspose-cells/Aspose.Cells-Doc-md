---
title: So passen Sie das UI Aussehen für das Modul in GridJs an  
type: docs
weight: 250
url: /de/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Dieser Artikel beschreibt, wie man das UI Aussehen für das Modal Fenster in GridJs anpasst.
...
# Modal-Stilrichtlinie für GridJs
...
- [Schöne Stilbeispiele](#beautiful-style-examples)
...
| Datenüberprüfung | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
...
| Einfügen/Löschen | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Beispiel 2: Minimalistisches Reines Thema 🤍

Ideal für professionelle und Unternehmensanwendungen.
...
### Beispiel 3: Dunkelmodus-Thema 🌙

Ideal für Anwendungen mit Dunkelmodus-Unterstützung.
...
### Beispiel 4: Verspieltes Buntes Thema 🌈

Perfekt für kreative und lustige Anwendungen.
...
### Beispiel 5: Unternehmensprofessionelles Thema 💼

Geeignet für Geschäfts- und Unternehmensanwendungen.
...
### 2. Zugänglichkeit aufrechterhalten
