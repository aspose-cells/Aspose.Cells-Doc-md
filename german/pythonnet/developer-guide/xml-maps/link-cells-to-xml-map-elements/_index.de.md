...
type: docs
weight: 50
url: /de/python-net/link-cells-to-xml-map-elements/
---

## **Mögliche Verwendungsszenarien**

Sie können Ihre Zellen mit Aspose.Cells für Python via .NET an XML-Map-Elemente binden. Bitte verwenden Sie die Methode [**Cells.link_to_xml_map()**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/link_to_xml_map) hierfür.
