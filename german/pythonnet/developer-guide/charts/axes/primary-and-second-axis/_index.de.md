...
description: Erfahren Sie, wie Sie Primär und Sekundärachsen in Aspose.Cells für Python via .NET verstehen und nutzen. Unser Leitfaden hilft Ihnen, die Unterschiede zwischen Primär und Sekundärachsen zu verstehen und sie effektiv in Ihren Diagrammen zu konfigurieren und zu verwenden.
keywords: Aspose.Cells für Python via .NET, Primärachsen, Sekundärachsen, Verständnis, Unterschiede, Konfiguration, Nutzung.
type: docs
weight: 190
url: /de/python-net/primary-and-second-axis/
---
