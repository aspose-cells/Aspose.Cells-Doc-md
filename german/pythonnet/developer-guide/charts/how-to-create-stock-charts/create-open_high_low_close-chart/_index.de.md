---
title: Erstellen Sie ein Open High Low Close(OHLC) Aktiendiagramm
description: Erfahren Sie, wie Sie ein Open High Low Close Aktienchart mit Aspose.Cells für Python via .NET erstellen. Unser Leitfaden zeigt, wie Sie Börsendaten, einschließlich Eröffnungs , Höchst , Tiefst und Schlusskurse, auf einem Diagramm darstellen, um eine bessere Analyse und Visualisierung zu gewährleisten.
keywords: Aspose.Cells für Python via .NET, Open High Low Close Aktienchart, Börsendaten, Analyse, Visualisierung.
type: docs
weight: 182
url: /de/python-net/create-open-high-low-close-stock-chart/
---
...
Wir verwenden oft Farben statt Schwarz-Weiß, um steigende und fallende Preise anzuzeigen. Im ersten Satz von candlesticks unten zeigt Rot steigende und Grün fallende Preise an.
