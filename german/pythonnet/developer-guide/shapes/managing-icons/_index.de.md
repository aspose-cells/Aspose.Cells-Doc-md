...
type: docs
weight: 100
url: /de/python-net/insert-svg-to-excel/
---

## Symbole in Arbeitsblatt in Aspose.Cells für Python via .NET einfügen

Wenn Sie [Aspose.Cells für Python via .NET](https://products.aspose.com/cells/) verwenden müssen, um 'Symbole' in einer Excel-Datei hinzuzufügen, kann dieses Dokument Ihnen dabei helfen.
...
Hier haben wir *Beispielcode* vorbereitet, um Ihnen beim Einfügen von Symbolen mit [Aspose.Cells für Python via .NET](https://products.aspose.com/cells/) zu helfen. Es gibt auch eine notwendige [Beispieldatei](sample.xlsx) und eine Icon-[Ressourcendatei](icon.zip). Wir haben die Excel-Oberfläche verwendet, um ein Symbol mit dem gleichen Anzeigeeffekt wie die [Ressourcendatei](icon.zip) in der [Beispieldatei](sample.xlsx) einzufügen.
