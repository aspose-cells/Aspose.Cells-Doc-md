...
type: docs
weight: 1700
url: /de/python-net/tile-picture-as-a-texture-inside-the-shape/
---
...
Sie können die Formfläche mit einem Bild füllen und mithilfe der [**Shape.fill.texture_fill.is_tiling**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/texturefill/is_tiling) Eigenschaft und dem Einstellen auf **true** kacheln. Bitte sehen Sie sich den folgenden Beispielcode, seine [Beispiel-Excel-Datei](46465050.xlsx) sowie den Screenshot zur Referenz an.
