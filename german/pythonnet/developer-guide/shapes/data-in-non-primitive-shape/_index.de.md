...
description: Dieser Artikel zeigt Daten in nicht primitiver Form durch die Aspose.Cells für Python via .NET API.
keywords: Python Excel Bibliothek, Python Daten in nicht primitiver Form, Python wie man auf Daten einer nicht primitiven Form zugreift.
---
...
In Aspose.Cells für Python via .NET werden nicht-primitive Formen vom Typ [**AutoShapeType.NOT_PRIMITIVE**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/autoshapetype) zugewiesen. Ihre Art kann mit der Eigenschaft [**Shape.auto_shape_type**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shape/auto_shape_type) überprüft werden.
