...
type: docs
weight: 40
url: /de/python-net/protect-and-unprotect-workbook-structure/
description: Schützen und Aufheben des Schutzes der Arbeitsmappenstruktur von Excel Dateien mithilfe von CSharp Codes
---
...
## **Arbeitsmappenstruktur mit Aspose.Cells für Python via .NET schützen**
...
## **Arbeitsmappenstruktur mit Aspose.Cells für Python via .NET entsperren**
Das Entsperren der Arbeitsmappenstruktur ist einfach mit der Aspose.Cells für Python via .NET API.
