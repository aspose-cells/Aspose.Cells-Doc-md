...
type: docs
weight: 10
url: /de/python-net/protecting-worksheets/
---
...
Die Klasse [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet) bietet die Methode [**protect**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/protect), die zum Anwenden des Schutzes auf das Arbeitsblatt verwendet wird. [**protect**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/protect/#aspose.cells.ProtectionType-str-str) Methode akzeptiert die folgenden Parameter:

- Schutztyp, der Typ des Schutzes, der auf das Arbeitsblatt angewendet werden soll. Der Schutztyp wird mithilfe der [**ProtectionType**](https://reference.aspose.com/cells/python-net/aspose.cells/protectiontype)-Enumeration angewendet.
...
Die [**ProtectionType**](https://reference.aspose.com/cells/python-net/aspose.cells/protectiontype)-Aufzählung enthält die folgenden vordefinierten Schutztypen:
...
In dieser Methode verwenden wir die API von Aspose.Cells für Python via .NET ausschließlich für diese Aufgabe.

Beispiel: Das folgende Beispiel zeigt, wie man ein paar Zellen im Arbeitsblatt schützt. Es entsperrt zunächst alle Zellen im Arbeitsblatt und sperrt dann 3 Zellen (A1, B1, C1). Schließlich wird das Arbeitsblatt geschützt. Das [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style)-Objekt enthält eine boolesche Eigenschaft, [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked). Sie können die [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked)-Eigenschaft auf true oder false setzen und die Methode *Column/Row.ApplyStyle()* verwenden, um die Zeile/Spalte mit Ihren gewünschten Attributen zu sperren oder zu entsperren.
...
Aspose.Cells für Python via .NET ermöglicht es Ihnen, jede Zeile im Arbeitsblatt einfach zu sperren. Hier können wir die Methode [**apply_style()**](https://reference.aspose.com/cells/python-net/aspose.cells/row/apply_style) der Klasse [**Aspose.Cells.Row**](https://reference.aspose.com/cells/python-net/aspose.cells/row) verwenden, um [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) auf eine bestimmte Zeile im Arbeitsblatt anzuwenden. Diese Methode benötigt zwei Argumente: ein [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style)-Objekt und ein [**StyleFlag**](https://reference.aspose.com/cells/python-net/aspose.cells/styleflag)-Objekt, das alle Mitglieder im Zusammenhang mit der angewendeten Formatierung enthält.

Das folgende Beispiel zeigt, wie man eine Zeile im Arbeitsblatt schützt. Es entsperrt zunächst alle Zellen im Arbeitsblatt und sperrt dann die erste Zeile. Schließlich wird das Arbeitsblatt geschützt. Das [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style)-Objekt enthält eine boolesche Eigenschaft, [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked). Sie können die [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked)-Eigenschaft auf true oder false setzen, um die Zeile/Spalte mit dem [**StyleFlag**](https://reference.aspose.com/cells/python-net/aspose.cells/styleflag)-Objekt zu sperren oder zu entsperren.
...
Aspose.Cells für Python via .NET ermöglicht es Ihnen, jede Spalte im Arbeitsblatt einfach zu sperren. Hier können wir die Methode [**apply_style()**](https://reference.aspose.com/cells/python-net/aspose.cells/column/apply_style) der Klasse [**Aspose.Cells.Column**](https://reference.aspose.com/cells/python-net/aspose.cells/column) verwenden, um [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) auf eine bestimmte Spalte im Arbeitsblatt anzuwenden. Diese Methode benötigt zwei Argumente: ein [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style)-Objekt und ein [**StyleFlag**](https://reference.aspose.com/cells/python-net/aspose.cells/styleflag)-Objekt, das alle Mitglieder im Zusammenhang mit der angewendeten Formatierung enthält.
