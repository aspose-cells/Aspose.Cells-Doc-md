...
description: In diesem Artikel lernen Sie, wie Sie die Scheiben in Excel Arbeitsblättern programmgesteuert mit Aspose.Cells für Python via .NET APIs einfrieren.
keywords: Python Excel Bibliothek, Python Scheiben einfrieren, Fenster in Python einfrieren.
---
...
## ***Wie man Scheiben in Excel einfriert**
...
## **So frieren Sie Scheiben mit Aspose.Cells für Python Excel Library ein**
Es ist einfach, Scheiben mit Aspose.Cells für Python via .NET einzufrieren. Bitte verwenden Sie die [**Worksheet.freeze_panes**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/freeze_panes/#str-int-int)-Methode, um Scheiben an der ausgewählten Zelle zu fixieren.
