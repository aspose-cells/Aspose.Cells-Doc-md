...
description: Dieser Artikel erklärt, wie man programmgesteuert Header und Footer aus Excel oder OpenOffice Dateien mit der Aspose.Cells für Python via .NET API erhält.
keywords: Python Excel Bibliothek, Python Header und Footer abrufen, Header und Footer in Befehlsliste parse mithilfe von Python.
---
...
## **Wie man Header und Footer in MS Excel erhält**
...
## **Wie man Header und Footer mit der Aspose.Cells for Python Excel-Bibliothek erhält**
...
## **Wie man Header und Footer in eine Befehlsliste parst**
...
Aspose.Cells für Python via .NET bietet [**Worksheet.page_setup.get_commands**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/get_commands/#str) Methode, um Header und Footer als Befehlsliste zu parsen.
