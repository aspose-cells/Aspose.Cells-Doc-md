...
description: Aspose.Cells ist eine Python Bibliothek zur Arbeit mit Tabellenkalkulationsdateien, die es Benutzern ermöglicht, bestehende Zellstile zu modifizieren. Dieser Artikel zeigt, wie man mithilfe der Aspose.Cells für Python via .NET ein bestehendes Zellstil anpasst, um das Erscheinungsbild der Zellen nach Bedarf zu ändern.
...
type: docs
weight: 90
url: /de/python-net/modify-an-existing-style/
---
...
Aspose.Cells für Python via .NET ermöglicht die Veränderung dieser Stile oder eines beliebigen anderen Stils, den Sie mit Ihren gewünschten Attributen definieren.
...
Die folgenden Beispiele zeigen, wie die Methode [**Style.update**](https://reference.aspose.com/cells/python-net/aspose.cells/style/update) verwendet wird.

### **Erstellen und Ändern eines Stils**

Dieses Beispiel erstellt ein [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style)-Objekt, wendet es auf einen Zellenbereich an und ändert das [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style)-Objekt. Die Änderungen werden automatisch auf die Zelle und den Bereich angewendet, auf den der Stil angewendet wurde.
