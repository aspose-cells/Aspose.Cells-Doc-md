...
type: docs
weight: 10
url: /de/python-net/how-to-format-number-to-fraction/
description: Dieser Beitrag stellt vor, wie man eine Zahl in Aspose.Cells für Python via .NET in Brüche umwandelt.
...
## **Das Formatieren von Zahlen in Brüche in Aspose.Cells für Python via .NET ist ein unkomplizierter Vorgang. Aspose.Cells für Python via .NET ist eine leistungsstarke Bibliothek, mit der Sie in .NET-Anwendungen ohne installierten Microsoft Excel mit Excel-Dateien arbeiten können. Sie bietet eine Vielzahl von Funktionen, einschließlich der Formatierung von Zahlen als Brüche.**
Hier ist eine Schritt-für-Schritt-Anleitung, wie Sie Zahlen in Aspose.Cells für Python via .NET in Brüche formatieren:

Hier ist eine Schritt-für-Schritt-Anleitung, wie man Nummern in Aspose.Cells für Python via .NET in Brüche umwandelt:
