...
type: docs
weight: 10
url: /de/python-net/format-number-to-date/
description: Dieser Beitrag stellt vor, wie man eine Zahl in Aspose.Cells für Python via .NET in Datum umwandelt.
...
## **Wie man eine Zahl in Aspose.Cells für Python via .NET in Datum formatiert**

Um Zahlen in Aspose.Cells für Python via .NET für den Umgang mit Excel-Dateien als Datum zu formatieren, können Sie programmatisch Datumsformatierungen auf Zellen anwenden. Hier zeigen wir, wie Sie das mit Python und Aspose.Cells tun können:
