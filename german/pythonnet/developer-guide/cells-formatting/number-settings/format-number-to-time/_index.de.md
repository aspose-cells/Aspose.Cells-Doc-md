...
type: docs
weight: 10
url: /de/python-net/how-to-format-number-to-time/
description: Dieser Artikel stellt vor, wie man Zahlen in die Zeitformate unter Verwendung der Aspose.Cells für Python via .NET API formatiert.
...
## **Wie man eine Zahl in Aspose.Cells für Python via .NET auf Zeit formatiert**
Das Formatieren von Zahlen auf Zeit in Aspose.Cells für Python via .NET ist ein einfacher Prozess, bei dem ein benutzerdefiniertes Zahlenformat auf eine Zelle oder einen Zellbereich angewendet wird. Aspose.Cells ist eine leistungsstarke Bibliothek, mit der Sie in .NET-Anwendungen mit Excel-Dateien arbeiten können, ohne Microsoft Excel zu benötigen. Hier erfahren Sie, wie Sie Zahlen auf Zeit formatieren können:
