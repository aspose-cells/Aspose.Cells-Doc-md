...
description: So fügen Sie ein berechnetes Feld in der Pivot-Tabelle mit Aspose.Cells for Python via .NET hinzu.
...
Fügen Sie ein berechnetes Feld zur Excel-Datei hinzu, indem Sie Aspose.Cells for Python via .NET verwenden. Bitte sehen Sie sich den folgenden Beispielcode an. Nach der Ausführung des Beispielcodes wird dem Arbeitsblatt eine Pivot-Tabelle mit berechnetem Feld hinzugefügt.
