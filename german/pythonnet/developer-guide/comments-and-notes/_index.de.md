...
type: docs
weight: 128
url: /de/python-net/comments-and-notes/
description: Kommentare oder Notizen mit Aspose.Cells für Python via .NET einfügen und verwalten.
...
Fügen Sie mithilfe der [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection)-Sammlung und der [**add**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection/add)-Methode der [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet)-Objektsammlung einen Kommentar zu einer Zelle hinzu. Das neue [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment)-Objekt kann aus der [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection)-Sammlung durch Weitergabe des Kommentarindex abgerufen werden. Nach dem Abrufen des [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment)-Objekts passen Sie die Kommentarnotiz mithilfe der [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment)-Eigenschaft des [**note**](https://reference.aspose.com/cells/python-net/aspose.cells/comment/note)-Objekts an.
...
## **Erweiterte Themen**
- [Ändern der Textrichtung des Kommentars](/cells/de/python-net/change-text-direction-of-the-comment/)
- [Ändern der Kommentarschriftfarbe](/cells/de/python-net/how-to-change-the-comment-font-color/)
- [Wie man den Kommentarhintergrund einstellt](/cells/de/python-net/how-to-set-comment-background/)
- [Antwortkommentare](/cells/de/python-net/threaded-comments/)
