---
title: Diagramm in lokales Bild umwandeln mit Node.js über C++
description: Erfahren Sie, wie Sie Globalisierungskonfigurationen für Diagramme mit Aspose.Cells for Node.js via C++ festlegen. Unser Leitfaden zeigt, wie Sie das Diagramm so konfigurieren, dass es mehrere Sprachen und regionale Formate unterstützt, um Text, Daten und Zahlen korrekt in verschiedenen Sprachen anzuzeigen.
keywords: Aspose.Cells for Node.js via C++, Diagramme, Globalisierungseinstellungen, Mehrsprachigkeit, Regionale Formate, Anzeige, Text, Daten, Zahlen.
linktitle: Lokalisierten Bereich festlegen
type: docs
weight: 50
url: /de/nodejs-cpp/convert-chart-to-localized-image/
...
- [Wie man die chinesische Region für das Diagramm einstellt](/cells/de/nodejs-cpp/convert-chart-to-image-for-chinese-region/)
