---  
title: Diagramm in Bild mit Node.js über C++  
description: Lernen Sie, wie Sie mit Aspose.Cells for Node.js via C++ ein Diagramm in ein Bildformat wie JPEG oder PNG konvertieren. Dieser Leitfaden zeigt, wie man ein Diagramm aus Microsoft Excel exportiert und als eigenständiges Bild für weitere Verwendung und Bearbeitung speichert.  
keywords: Aspose.Cells for Node.js via C++, Diagramm in Bild, Microsoft Excel, Bildkonvertierung, Export, eigenständiges Bild.  
linktitle: Diagramm als Bild  
type: docs  
weight: 46  
url: /de/nodejs-cpp/chart-to-image/  
---  

## **Diagramme darstellen**

Aspose.Cells APIs unterstützen die Konvertierung von Excel-Diagrammen in Bildformate, ohne dass zusätzliche Tools oder Anwendungen erforderlich sind. Um die Render-Unterstützung bereitzustellen, stellt die [**Chart**](https://reference.aspose.com/cells/nodejs-cpp/chart) Klasse die [**toImage(string)**](https://reference.aspose.com/cells/nodejs-cpp/chart/#toImage-string-) Methoden mit einer Vielzahl von Überladungen bereit, um den Anwendungsanforderungen gerecht zu werden.

### **Grafiken in Bilder umwandeln**

Die [**Chart.toImage(string)**](https://reference.aspose.com/cells/nodejs-cpp/chart/#toImage-string-) Methode verfügt über eine Vielzahl von Überladungen, um einfache sowie fortgeschrittene Renderings zu unterstützen. Falls die Anforderung besteht, das Diagramm in seinen Standardabmessungen zu rendern, sollten Sie die [**Chart.toImage(string)**](https://reference.aspose.com/cells/nodejs-cpp/chart/#toImage-string-) Methode wie folgt verwenden.
...
Es ist auch möglich, Diagramme mit erweiterten Einstellungen in Bilder zu rendern. Die Aspose.Cells APIs haben eine Überladungsvariante der [**Chart.toImage(string)**](https://reference.aspose.com/cells/nodejs-cpp/chart/#toImage-string-) Methode bereitgestellt, die eine Instanz von [**ImageOrPrintOptions**](https://reference.aspose.com/cells/nodejs-cpp/imageorprintoptions) akzeptiert und Parameter wie Auflösung, Glättungsmodus, Bildformat usw. festlegen kann.
