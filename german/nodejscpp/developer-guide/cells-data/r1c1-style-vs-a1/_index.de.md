...
type: docs
weight: 30
url: /de/nodejs-cpp/r1c1-reference-style-vs-a1/
description: R1C1 Referenzstil gegen A1 Stil mit Aspose.Cells for Node.js via C++.
keywords: R1C1 Referenzstil gegen A1 Stil in Node.js via C++, R1C1 Referenzstil in Node.js via C++, Wechsel zwischen R1C1 Referenzstil und A1 Stil in Node.js via C++, A1 Referenzstil in Node.js via C++.
---
