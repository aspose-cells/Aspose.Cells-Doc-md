---
title: Formatieren und Ändern von benannten Bereichen mit Node.js über C++
linktitle: Benannte Bereiche formatieren und ändern
type: docs
weight: 85
url: /de/nodejs-cpp/format-and-modify-named-ranges/
description: Erfahren Sie, wie man benannte Bereiche mit Aspose.Cells for Node.js via C++ formatiert und ändert. 
---
...
Um Formatierungen anzuwenden, definieren Sie ein [**Style**](https://reference.aspose.com/cells/nodejs-cpp/style)-Objekt, um die Stil-Einstellungen festzulegen, und wenden Sie sie auf das [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range)-Objekt an.
...
Es ist möglich, Rahmen um einen Zellbereich hinzuzufügen, anstatt nur um eine einzelne Zelle. Das [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range)-Objekt bietet eine [**setOutlineBorder(BorderType, CellBorderType, CellsColor)**](https://reference.aspose.com/cells/nodejs-cpp/range/#setOutlineBorder-bordertype-cellbordertype-cellscolor-)-Methode, die folgende Parameter akzeptiert, um einen Rahmen zum Zellbereich hinzuzufügen:

- Randtyp, der Typ des Rahmens, ausgewählt aus der [**BorderType**](https://reference.aspose.com/cells/nodejs-cpp/bordertype)-Aufzählung.
- Linienstil, der Linienstil, ausgewählt aus der [**CellBorderType**](https://reference.aspose.com/cells/nodejs-cpp/cellbordertype)-Aufzählung.
...
Aspose.Cells ermöglicht es Ihnen, einen benannten Bereich umzubenennen. Sie können den benannten Bereich abrufen und umbenennen, indem Sie das [**Name.getText()**](https://reference.aspose.com/cells/nodejs-cpp/name/#getText--)-Attribut verwenden. Das folgende Beispiel zeigt, wie man einen benannten Bereich umbenennt.
...
Aspose.Cells bietet die [**Range.unionRang(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#unionRang-range-)-Methode, um Bereiche zu vereinigen; die Methode gibt ein [*Array*]-Objekt zurück. Das folgende Beispiel zeigt, wie man Bereiche vereinigt.
...
Aspose.Cells bietet die [**Range.intersect(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#intersect-range-)-Methode, um zwei Bereiche zu schneiden. Die Methode gibt ein [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range)-Objekt zurück. Um zu prüfen, ob ein Bereich mit einem anderen überschneidet, verwenden Sie die [**Range.intersect(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#intersect-range-)-Methode, die einen Boolean-Wert zurückgibt. Das folgende Beispiel zeigt, wie man die Bereiche schneidet.
...
Aspose.Cells bietet die [**Range.merge()**](https://reference.aspose.com/cells/nodejs-cpp/range/#merge--)-Methode, um die Zellen im Bereich zu zusammenfügen. Das folgende Beispiel zeigt, wie man die einzelnen Zellen eines benannten Bereichs zusammenfügt.
