...
type: docs
weight: 20
url: /de/nodejs-cpp/consolidation-function/
description: Wie man die ConsolidationFunction auf Datenfelder der Pivot Tabelle mit Aspose.Cells for Node.js via C++ anwendet.
keywords: Aspose.Cells for Node.js via C++ Excel, Excel Node.js Bibliothek, ConsolidationFunction für Datenfelder der Pivot Tabelle mit Aspose.Cells for Node.js via C++ verwenden.
---
...
Aspose.Cells for Node.js via C++ bietet [**ConsolidationFunction**](https://reference.aspose.com/cells/nodejs-cpp/consolidationfunction/)-Aufzählung zur Unterstützung der folgenden Konsolidierungsfunktionen.
