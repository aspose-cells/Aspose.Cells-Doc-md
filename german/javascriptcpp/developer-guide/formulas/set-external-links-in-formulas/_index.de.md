---
title: Externe Links in Formeln mit JavaScript via C++ setzen
linktitle: Externe Links in Formeln setzen
type: docs
weight: 20
url: /de/javascript-cpp/set-external-links-in-formulas/
description: Erfahren Sie, wie man externe Links in Formeln mit Aspose.Cells for JavaScript via C++ setzt. 
keywords: Externe Links in Formeln mit JavaScript via C++ setzen, externe Dateien in Formeln mit JavaScript via C++ einbinden 
---

{{% alert color="primary" %}} 

Manchmal ist es notwendig, Verknüpfungen zu externen Dateien in Formeln einzufügen, zum Beispiel, um einen Zellen- oder Bereichswert gegen sie zu evaluieren. Aspose.Cells for JavaScript via C++ bietet dieses Feature und dieses Dokument erklärt, wie man es benutzt.
