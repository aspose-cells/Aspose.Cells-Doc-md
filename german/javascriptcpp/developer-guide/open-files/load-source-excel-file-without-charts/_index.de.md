---
title: Laden der Quelldatei ohne Diagramme mit JavaScript über C++
linktitle: Quell Excel Datei ohne Diagramme laden
type: docs
weight: 420
url: /de/javascript-cpp/load-source-excel-file-without-charts/
description: Lernen, wie man eine Excel Datei ohne Diagramme mit Aspose.Cells for JavaScript über C++ lädt. 
---

{{% alert color="primary" %}}

Aspose.Cells ermöglicht es Ihnen, Ihre Excel-Datei ohne Diagramme zu laden. Bitte verwenden Sie die Eigenschaft [**LoadOptions.loadFilter**](https://reference.aspose.com/cells/javascript-cpp/loadoptions/#loadFilter--) dafür.
