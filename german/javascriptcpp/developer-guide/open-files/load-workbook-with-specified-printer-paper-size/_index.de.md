---
title: Arbeitsmappe mit angegebenem Druckerpapiergröße via JavaScript und C++ laden
linktitle: Arbeitsbuch mit spezifischer Druckerpapiergröße laden
type: docs
weight: 430
url: /de/javascript-cpp/load-workbook-with-specified-printer-paper-size/
description: Lernen, wie man die Druckerpapiergröße beim Laden einer Arbeitsmappe mit Aspose.Cells for JavaScript über C++ festlegt.
---

{{% alert color="primary" %}}
Sie können die Druckerpapiergröße Ihrer Wahl angeben, wenn Sie Ihre Arbeitsmappe mit der Eigenschaft [**LoadOptions.paperSize(PaperSizeType)**](https://reference.aspose.com/cells/javascript-cpp/loadoptions/#paperSize-papersizetype-) laden. Bitte beachten Sie, dass, wenn Sie eine neue Datei in MS Excel erstellen, die Papiergröße der Einstellung des Standarddruckers auf Ihrer Maschine entspricht.
{{% /alert %}}

Der folgende Beispielcode zeigt die Verwendung der Eigenschaft [**LoadOptions.paperSize(PaperSizeType)**](https://reference.aspose.com/cells/javascript-cpp/loadoptions/#paperSize-papersizetype-). Es erstellt zunächst eine Arbeitsmappe, speichert sie in einem Speicherstream im XLSX-Format. Dann lädt es sie mit A5-Papiergröße und speichert sie im PDF-Format. Danach lädt es sie erneut mit A3-Papiergröße und speichert sie wieder im PDF-Format. Wenn Sie die Ausgabedateien öffnen und ihre Papiergrößen überprüfen, werden Sie sehen, dass sie unterschiedlich sind. Eines ist A5 und das andere A3. Bitte laden Sie die [A5-Ausgabe-PDF](5115234.pdf) und die [A3-Ausgabe-PDF](5115233.pdf) herunter, die vom Code generiert wurden, zu Referenzzwecken.
