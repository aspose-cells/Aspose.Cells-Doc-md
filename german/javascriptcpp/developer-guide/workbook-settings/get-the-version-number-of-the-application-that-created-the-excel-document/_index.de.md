---
title: Die Versionsnummer der Anwendung abrufen, die das Excel Dokument erstellt hat, mit JavaScript via C++
linktitle: Ermitteln Sie die Versionsnummer der Anwendung, die das Excel Dokument erstellt hat
type: docs
weight: 210
url: /de/javascript-cpp/get-the-version-number-of-the-application-that-created-the-excel-document/
---

{{% alert color="primary" %}}

Oft ist es notwendig, die Versionsnummer der Anwendung zu kennen, die eine Microsoft Excel-Datei erstellt hat. Das Aspose.Cells for JavaScript via C++ bietet die Eigenschaft [**Workbook.builtInDocumentProperties**](https://reference.aspose.com/cells/javascript-cpp/workbook/#builtInDocumentProperties--) zu diesem Zweck.

{{% /alert %}}

Der folgende Beispielcode zeigt die Verwendung der Eigenschaft [**Workbook.builtInDocumentProperties**](https://reference.aspose.com/cells/javascript-cpp/workbook/#builtInDocumentProperties--). Er lädt Excel-Dateien, die mit Microsoft Excel 2003, 2007, 2010 und 2013 erstellt wurden und gibt die Versionsnummer der Anwendung aus, die diese Excel-Dokumente erstellt hat.
