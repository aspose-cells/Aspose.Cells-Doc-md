---
title: Excel Datei öffnen ohne Open Save Cancel Dialog mit JavaScript via C++
linktitle: Öffnen einer Excel Datei ohne Dialogfeld Öffnen Speichern Abbrechen
type: docs
weight: 150
url: /de/javascript-cpp/opening-excel-file-without-open-save-cancel-dialog-box/
--- 
...
Wie oben erklärt, ist es ein Sicherheitsrisiko, eine Datei ohne Bestätigung, dass Sie sie wirklich öffnen möchten, auf Ihrem System zu öffnen oder laufen zu lassen. Einige Dateien enthalten Viren, und einige Websites versuchen, schädliche Dateien automatisch auf Ihren Computer herunterzuladen, ohne dass Sie gefragt werden. Es wird daher nicht empfohlen, den Download-Dialog ohne Download-Hinweis zuzulassen, damit Benutzer die Datei und deren Quelle vor dem Herunterladen oder Ausführen überprüfen können. Das Deaktivieren des Download-Dialogs macht das System anfällig für Viren, Trojaner und Hacker, die Ihr System heimlich beeinflussen könnten. 
