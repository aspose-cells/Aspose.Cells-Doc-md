---
title: Wie man das Arbeitsblattansicht mit JavaScript über C++ steuert
linktitle: Wie man die Ansicht der Arbeitsmappe steuert
type: docs
weight: 600
url: /de/javascript-cpp/how-to-control-workbook-view/
description: Lernen Sie, wie Sie die Arbeitsblattansicht über die Aspose.Cells for JavaScript via C++ API steuern.
keywords: Wie man die Arbeitsblattansicht JavaScript über C++, Excel Ansicht JavaScript über C++ festlegt, Arbeitsblattansicht JavaScript über C++ ausführt, Arbeitsblattansicht JavaScript über C++ einstellt, Excel Ansicht JavaScript über C++ steuert.
---

## **Mögliche Verwendungsszenarien**
Wenn Sie die Anzeige von Excel-Seiten anpassen müssen, sollten Sie wissen, wie man jedes Modul steuert, wie z.B. horizontale und vertikale Bildlaufleisten, ob offene Excel-Dateien ausgeblendet werden sollen usw. Die Aspose.Cells for JavaScript über C++ bietet diese Funktion. Die Aspose.Cells for JavaScript über C++ stellt die folgenden Eigenschaften und Methoden bereit, um Ihre Ziele zu erreichen.
...
## **Wie man die Arbeitsblattansicht mit Aspose.Cells for JavaScript über C++ steuert**
