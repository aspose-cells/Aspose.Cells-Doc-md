...
type: docs
weight: 140
url: /de/javascript-cpp/add-image-hyperlinks/
description: Erfahren Sie, wie man Bilder Hyperlinks durch die Aspose.Cells for JavaScript via C++ API hinzufügt.
keywords: Bild Hyperlinks JavaScript über C++ hinzufügen, Bild Hyperlinks JavaScript über C++ einfügen
---

{{% alert color="primary" %}} 

Hyperlinks sind nützlich, um auf Informationen auf anderen Arbeitsblättern oder Websites zuzugreifen. Microsoft Excel ermöglicht es Benutzern, Hyperlinks im Text in Zellen und auf Bildern hinzuzufügen. Bild-Hyperlinks können das Navigieren in einem Arbeitsblatt erleichtern, z.B. als Vor- und Zurück-Buttons oder Logos, die auf bestimmte Websites verlinken. Dieses Dokument erklärt, wie man Bild-Hyperlinks in einem Arbeitsblatt mit Aspose.Cells for JavaScript via C++ einfügt.

{{% /alert %}} 

Aspose.Cells for JavaScript via C++ ermöglicht es, beim Laufzeit Hyperlinks zu Bildern in Tabellenkalkulationen hinzuzufügen. Es ist möglich, die Bildschirm-Tastatur und die Adresse des Links festzulegen und zu ändern. Der folgende Beispielcode zeigt, wie man einen Bild-Hyperlink in ein Arbeitsblatt einfügt.
