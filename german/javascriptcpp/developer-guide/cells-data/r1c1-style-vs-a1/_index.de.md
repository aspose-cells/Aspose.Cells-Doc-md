...
type: docs
weight: 30
url: /de/javascript-cpp/r1c1-reference-style-vs-a1/
description: R1C1 Referenzstil vs. A1 Stil mit der Aspose.Cells for JavaScript via C++
keywords: R1C1 Referenzstil vs. A1 Stil JavaScript via C++, R1C1 Referenzstil JavaScript via C++, Wie zwischen R1C1 Referenzstil und A1 Referenzstil JavaScript via C++ wechseln, A1 Referenzstil JavaScript via C++
---
