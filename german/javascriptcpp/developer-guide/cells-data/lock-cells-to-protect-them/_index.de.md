...
type: docs
weight: 130
url: /de/javascript-cpp/how-to-lock-cells-to-protect-them/
description: Dieser Artikel zeigt Ihnen Code, der erklärt, wie man Zellen sperrt, um sie mit dem Aspose.Cells for JavaScript via C++ zu schützen.
keywords: JavaScript Zellen sperren, um sie zu schützen, wie man Zellen mit JavaScript sperrt, um sie zu schützen, Zellen in JavaScript sperren, um sie zu schützen.
---
...
## **Wie man Zellen mit JavaScript sperrt, um sie zu schützen**

Aspose.Cells ist eine leistungsstarke Bibliothek zum programmatischen Arbeiten mit Excel-Dateien. Um Zellen mit dem Aspose.Cells for JavaScript via C++ zu sperren, sind folgende Schritte erforderlich: Laden Sie die [Beispieldatei](sample.xlsx), entsperren Sie alle Zellen zuerst (da standardmäßig alle Zellen gesperrt sind, aber erst beim Schutz des Arbeitsblatts wirksam werden), sperren Sie dann die spezifischen Zellen, die Sie schützen möchten, und schützen Sie schließlich das Arbeitsblatt, um das Sperren durchzusetzen.
