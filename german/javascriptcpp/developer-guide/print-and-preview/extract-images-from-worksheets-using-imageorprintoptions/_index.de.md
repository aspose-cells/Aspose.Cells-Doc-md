---
title: Bilder aus Tabellenblättern mit ImageOrPrint Optionen mit JavaScript via C++ extrahieren
linktitle: Bilder aus Arbeitsblättern mit ImageOrPrintOptions extrahieren
type: docs
weight: 140
url: /de/javascript-cpp/extract-images-from-worksheets-using-imageorprintoptions/
description: Erfahren Sie, wie Sie Bilder aus Excel Tabellenblättern extrahieren und mit Aspose.Cells for JavaScript via C++ speichern.
---

{{% alert color="primary" %}} 

Microsoft Excel-Benutzer können Bilder in Tabellen einfügen. Mit Aspose.Cells for JavaScript via C++ ist es möglich, Bilder aus Microsoft Excel-Dateien zu lesen und auf einem lokalen Laufwerk zu speichern. Dieser Artikel zeigt wie.
