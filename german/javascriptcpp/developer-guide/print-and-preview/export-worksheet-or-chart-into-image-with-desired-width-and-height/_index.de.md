---
title: Exportieren Sie Tabellenblatt oder Diagramm in ein Bild mit gewünschter Breite und Höhe via JavaScript
linktitle: Arbeitsblatt oder Diagramm in ein Bild mit gewünschter Breite und Höhe exportieren
type: docs
weight: 290
url: /de/javascript-cpp/export-worksheet-or-chart-into-image-with-desired-width-and-height/
description: Lernen Sie, wie Sie ein Tabellenblatt oder Diagramm mit festgelegter Breite und Höhe mit Aspose.Cells for JavaScript via C++ in ein Bild exportieren.
---

{{% alert color="primary" %}}
 Sie können Aspose.Cells for JavaScript via C++ verwenden, um Ihr Tabellenblatt oder Diagramm in ein Bild mit der gewünschten Breite und Höhe zu exportieren. Es bietet die [**ImageOrPrintOptions.desiredSize(number, number, boolean)**](https://reference.aspose.com/cells/javascript-cpp/imageorprintoptions/#desiredSize-number-number-boolean-)-Methode, um die gewünschte Breite und Höhe des exportierten Bildes festzulegen. Die Breite und Höhe werden in Pixeln angegeben.
{{% /alert %}}
