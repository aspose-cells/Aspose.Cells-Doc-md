---
title: Dynamische Diagramme mit JavaScript via C++ erstellen
linktitle: Dynamische Diagramme erstellen
description: Lernen Sie, wie Sie in Aspose.Cells for JavaScript via C++ dynamische Diagramme erstellen. Diese Anleitung zeigt, wie Sie Diagrammdaten, Serien und Formatierungen je nach Ihren Anforderungen dynamisch aktualisieren, sodass Sie wechselnde Daten visuell in Ihren Arbeitsblättern präsentieren können.
keywords: Aspose.Cells for JavaScript via C++, Diagrammerstellung, dynamische Diagramme, Daten, Serien, Formatierung, Arbeitsblätter, Aktualisierung.
type: docs
weight: 240
url: /de/javascript-cpp/create-dynamic-charts/
---
...
Dieser Artikel zeigt die Verwendung der Aspose.Cells for JavaScript via C++ APIs, um dynamische Diagramme mit beiden der oben genannten Ansätze zu erstellen.  
{{% /alert %}}  

## **Verwendung von Excel-Tabellen**  

{{% alert color="primary" %}}  
 Excel-Tabellen werden aus Sicht von Aspose.Cells als ListObjects bezeichnet, daher verwenden wir den Begriff "ListObject" anstelle von "Tabelle" zur Klarheit. Bitte lesen Sie detailliert, wie man [ListObjects erstellt](/cells/de/javascript-cpp/create-and-format-table/) mit Aspose.Cells for JavaScript via C++.  
{{% /alert %}}  

ListObjects bieten integrierte Funktionen zum Sortieren und Filtern der Daten durch Benutzerinteraktion. Beide Optionen werden über Dropdown-Listen bereitgestellt, die automatisch in die Kopfzeile des [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) eingefügt werden. Durch diese Funktionen (Sortieren und Filtern) erscheint das [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) als idealer Kandidat, um als Datenquelle für ein dynamisches Diagramm zu dienen, da sich die Darstellung im Diagramm ändert, wenn das Sortieren oder Filtern geändert wird, um den aktuellen Zustand des [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) widerzuspiegeln.

Um die Demonstration einfach verständlich zu halten, erstellen wir den [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) von Grund auf neu und gehen Schritt für Schritt vor, wie unten beschrieben.

1. Erstellen Sie ein leeres [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook).
1. Zugriff auf das [**Cells**](https://reference.aspose.com/cells/javascript-cpp/cells) des ersten [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) im [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook).
1. Fügen Sie einige Daten in die Zellen ein.
1. Erstellen Sie [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) basierend auf den eingefügten Daten.
1. Erstellen Sie [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) basierend auf den Datenbereich von [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject).
...
1. Erstellen Sie [**ComboBox**](https://reference.aspose.com/cells/javascript-cpp/combobox) basierend auf dem in der vorherigen Schritt erstellten benannten Bereich.
...
1. Erstellen Sie [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) basierend auf dem im vorherigen Schritt erstellten Bereich.
1. Speichern Sie das Ergebnis auf der Festplatte.  
