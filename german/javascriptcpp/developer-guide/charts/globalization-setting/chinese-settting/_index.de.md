---
title: Diagramm in Bild für chinesische Region mit JavaScript via C++ konvertieren
description: Lernen Sie, wie man Aspose.Cells for JavaScript mittels C++ verwendet, um Diagramme für chinesische Zeichen und Formate zu konfigurieren, einschließlich Schriftarten, Größen, Textrichtung und mehr.
keywords: Aspose.Cells for JavaScript via C++, Diagramme, Chinesische Konfiguration, Schriftarten, Schriftgröße, Textrichtung, Unterstützung.
linktitle: Chinesische Region festlegen
type: docs
weight: 9
url: /de/javascript-cpp/convert-chart-to-image-for-chinese-region/
...
Der erste Schritt besteht darin, eine Klasse "ChartChineseSetttings" zu definieren, die von [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/) erbt.  
