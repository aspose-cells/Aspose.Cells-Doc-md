---
title: Diagramm in lokales Bild mit JavaScript via C++ konvertieren
description: Erfahren Sie, wie Sie Globalisierungskonfigurationen für Diagramme mit Aspose.Cells for JavaScript via C++ festlegen. Unser Leitfaden zeigt, wie Sie das Diagramm so konfigurieren, dass es mehrere Sprachen und regionale Formate unterstützt, um Text, Daten und Zahlen in verschiedenen Sprachen korrekt anzuzeigen.
keywords: Aspose.Cells for JavaScript via C++, Diagramme, Globalisierungseinstellungen, Mehrsprachigkeit, regionale Formate, Anzeige, Text, Daten, Zahlen.
linktitle: Lokalisierten Bereich festlegen
type: docs
weight: 50
url: /de/javascript-cpp/convert-chart-to-localized-image/
...
Wenn Sie eine xlsx-Datei mit einem Diagramm in Excel öffnen, zum Beispiel mit einer regionalen Einstellung in Spanisch, können Sie die Elemente im Diagrammbereich sehen, wie Diagrammtitel, Legende, die ins Spanische übersetzt sind. Wenn Sie dieses Diagramm jedoch mit Aspose.Cells als Bild speichern, kann es zu folgendem Problem kommen: 
...
- [Wie man die chinesische Region für das Diagramm einstellt](/cells/de/javascript-cpp/convert-chart-to-image-for-chinese-region/)
- [Wie man die japanische Region für das Diagramm einstellt](/cells/de/javascript-cpp/convert-chart-to-image-for-japanese-region/)
