---
title: Erstellen eines Kreisdiagramms mit Leiterlinien mit JavaScript über C++
description: Erfahren Sie, wie Sie Aspose.Cells for JavaScript über C++ verwenden, um ein Kreisdiagramm mit Leiterlinien in Microsoft Excel zu erstellen. Unser Leitfaden zeigt, wie man Leiterlinien hinzufügt, die Datenpunkte mit der Legende verbinden und die Übersichtlichkeit Ihres Diagramms verbessern.
keywords: Aspose.Cells for JavaScript über C++, Kreisdiagramm, Leiterlinien, Microsoft Excel, Datenvisualisierung, Diagrammanpassung
linktitle: Tortendiagramm
type: docs
weight: 45
url: /de/javascript-cpp/creating-pie-chart-with-leader-lines/
---

{{% alert color="primary" %}}

Dieser Artikel erklärt, wie man mit der Aspose.Cells for JavaScript API über C++ ein Kreisdiagramm mit Leiterlinien von Grund auf erstellt. In Excel ist die Option 'Leiterlinien anzeigen' standardmäßig aktiviert, daher werden beim Erstellen eines Kreisdiagramms in Excel die Leiterlinien angezeigt. Beim Erstellen eines ähnlichen Diagramms mit Aspose.Cells APIs müssen Sie die Eigenschaft [**Series.hasLeaderLines**](https://reference.aspose.com/cells/javascript-cpp/series/#hasLeaderLines--) explizit setzen.

{{% /alert %}}

Um die Verwendung von Aspose.Cells for JavaScript über C++ API zur Erstellung eines Tortencharts mit Leader-Lines zu demonstrieren, erstellen wir zunächst ein neues [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) und geben einige Daten ein, die als Serien-Datenquelle dienen. Sobald die Daten eingerichtet sind, fügen wir eine [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) vom Typ [**ChartType.Pie**](https://reference.aspose.com/cells/javascript-cpp/charttype) zur Sammlung der Diagramme hinzu und setzen deren verschiedene Aspekte, um die gewünschte Diagrammansicht zu erhalten.
...
## **Erweiterte Themen**
- [Benutzerdefinierte Farben für Tortenstücke oder Sektoren in einem Tortendiagramm](/cells/de/javascript-cpp/custom-slice-or-sector-colors-in-pie-chart/)
- [Herausfinden, ob Datenpunkte in der zweiten Torte oder Balken in einem Tortendiagramm der Torten oder Balken sind](/cells/de/javascript-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)
...
- [Datenformatierung in Diagrammen](/cells/de/javascript-cpp/data-formatting-in-charts/)
