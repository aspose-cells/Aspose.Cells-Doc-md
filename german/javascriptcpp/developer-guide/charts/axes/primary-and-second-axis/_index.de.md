---
title: Primäre und sekundäre Achsen mit JavaScript via C++
description: Lernen Sie, wie man Primär und Sekundärachsen in Aspose.Cells for JavaScript mit C++ versteht und arbeitet. Unser Leitfaden hilft Ihnen, die Unterschiede zwischen Primär und Sekundärachsen zu erkennen und sie effektiv in Ihren Diagrammen zu konfigurieren und zu verwenden.
keywords: Aspose.Cells for JavaScript mit C++, primäre Achsen, sekundäre Achsen, Verständnis, Unterschiede, Konfiguration, Nutzung.
type: docs
weight: 190
url: /de/javascript-cpp/primary-and-second-axis/
---
