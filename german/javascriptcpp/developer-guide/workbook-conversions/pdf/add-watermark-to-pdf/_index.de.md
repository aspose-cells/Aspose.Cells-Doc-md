---
title: Wasserzeichen zu PDF mit JavaScript via C++ hinzufügen
linktitle: Wasserzeichen zu PDF hinzufügen
type: docs
weight: 9
url: /de/javascript-cpp/add-watermark-to-pdf/
description: Lernen Sie, wie man Text und Bild Wasserzeichen zu PDFs hinzufügt, während Excel in PDF umgewandelt wird, mit Aspose.Cells for JavaScript via C++.
---
...
Sie können ganz einfach ein Text-Wasserzeichen zu einem PDF hinzufügen, indem Sie den Text und die entsprechende Schriftart angeben. Außerdem können Sie Ausrichtung, Offset, Rotation, Opazität, Vordergrund/Hintergrund und Skalierung auf die Seite einstellen in [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
...
Sie können ein Bild-Wasserzeichen zu einem PDF hinzufügen, indem Sie nur die Bilddaten angeben. Zudem können Sie Ausrichtung, Offset, Rotation, Opazität, Vordergrund/Hintergrund und Skalierung auf die Seite einstellen in [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
