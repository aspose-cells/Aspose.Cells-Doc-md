---
title: Arbeiten mit Hintergrund in ODS Dateien mit JavaScript über C++
linktitle: Arbeiten mit Hintergrund in ODS Dateien
type: docs
weight: 150
url: /de/javascript-cpp/working-with-background-in-ods-files/
description: Lernen Sie, wie man Hintergründe in ODS Dateien mit Aspose.Cells for JavaScript via C++ verwaltet.
---
...
Aspose.Cells for JavaScript via C++ bietet die Möglichkeit, die Hintergrundinformationen zu lesen und den Hintergrund in ODS-Dateien hinzuzufügen.  

## **Hintergrundinformationen aus ODS-Datei lesen**  

Aspose.Cells for JavaScript via C++ stellt die [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)-Klasse bereit, um Hintergründe in ODS-Dateien zu verwalten. Das folgende Codebeispiel demonstriert die Verwendung der [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)-Klasse, indem die Quelldatei [source ODS](90112030.ods) geladen und die Hintergrundinformationen gelesen werden. Bitte sehen Sie die vom Code generierte Konsolenausgabe zur Referenz.  
...
Aspose.Cells for JavaScript via C++ stellt die [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)-Klasse bereit, um Hintergründe in ODS-Dateien zu verwalten. Das folgende Codebeispiel demonstriert die Verwendung der [**OdsPageBackground.color**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#color--)-Eigenschaft, um einen Farb-Hintergrund in die ODS-Datei einzufügen. Bitte sehen Sie die [Ausgabedatei ODS](90112031.ods), die vom Code generiert wurde, zur Referenz.  
...
Aspose.Cells for JavaScript via C++ stellt die [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)-Klasse bereit, um Hintergründe in ODS-Dateien zu verwalten. Das folgende Codebeispiel demonstriert die Verwendung der [**OdsPageBackground.graphicData**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#graphicData--)-Eigenschaft, um einen grafischen Hintergrund in die ODS-Datei hinzuzufügen. Bitte sehen Sie die [Ausgabedatei ODS](90112030.ods), die vom Code generiert wurde, zur Referenz.  
