---
title: Exportieren Sie ein Diagramm mit viewBox Attribut in SVG mit JavaScript über C++
linktitle: Diagramm als SVG mit viewBox Attribut exportieren
type: docs
weight: 280
url: /de/javascript-cpp/export-chart-to-svg-with-viewbox-attribute/
description: Erfahren Sie, wie Sie ein Diagramm mit viewBox Attribut in SVG Format mit Aspose.Cells for JavaScript über C++ exportieren.
---

{{% alert color="primary" %}}

Standardmäßig ist das **viewBox**-Attribut beim Export des Diagramms ins SVG-Format nicht in seinem XML enthalten. Allerdings bietet Aspose.Cells [**ImageOrPrintOptions.svgFitToViewPort**](https://reference.aspose.com/cells/javascript-cpp/imageorprintoptions/#svgFitToViewPort--) Eigenschaft, die beim Einstellen auf **true** das Diagramm ins SVG mit viewBox-Attribut exportiert.
