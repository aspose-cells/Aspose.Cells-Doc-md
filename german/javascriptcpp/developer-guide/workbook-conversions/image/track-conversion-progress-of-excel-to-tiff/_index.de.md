---
title: Verfolgung des Konvertierungsfortschritts von Excel zu TIFF mit JavaScript über C++
linktitle: Konvertierungsvorgang von Excel nach TIFF verfolgen
type: docs
weight: 190
url: /de/javascript-cpp/track-conversion-progress-of-excel-to-tiff/
description: Erfahren Sie, wie Sie den Fortschritt der Konvertierung von Excel Dateien zu TIFF mit Aspose.Cells for JavaScript über C++ verfolgen. Verbessern Sie die Benutzererfahrung während des Konvertierungsprozesses.
---

## **Mögliche Verwendungsszenarien**

Manchmal kann die Konvertierung großer Excel-Dateien einige Zeit in Anspruch nehmen. Während dieser Zeit möchten Sie möglicherweise den Dokumentenkonvertierungsfortschritt anzeigen, anstatt nur einen Ladescreen, um die Benutzerfreundlichkeit Ihrer Anwendung zu verbessern. Aspose.Cells for JavaScript über C++ unterstützt die Verfolgung des Dokumentenkonvertierungsprozesses durch Bereitstellung der Schnittstelle [**IPageSavingCallback**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback). Die Schnittstelle [**IPageSavingCallback**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback) bietet [**pageStartSaving(PageStartSavingArgs)**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback/#pageStartSaving-pagestartsavingargs-)- und [**pageEndSaving(PageEndSavingArgs)**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback/#pageEndSaving-pageendsavingargs-)-Methoden, die Sie in Ihrer benutzerdefinierten Klasse implementieren können. Sie können auch steuern, welche Seiten gerendert werden, wie im *TestPageSavingCallback*-benutzerdefinierten Klasse demonstriert.
