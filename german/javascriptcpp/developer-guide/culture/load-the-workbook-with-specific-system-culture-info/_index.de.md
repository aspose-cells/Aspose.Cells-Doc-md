---
title: Laden Sie das Workbook mit spezifischen System Kulturinformationen via JavaScript und C++
linktitle: Laden Sie die Arbeitsmappe mit bestimmten Systemkulturinformationen
type: docs
weight: 190
url: /de/javascript-cpp/load-the-workbook-with-specific-system-culture-info/
---

## **Mögliche Verwendungsszenarien**
 Früher mussten Sie die Kulturinformationen des gesamten Threads ändern, um mit Zahlen und Daten in einem bestimmten Kulturformat umzugehen, aber jetzt bietet Aspose.Cells for JavaScript in C++ die Eigenschaft `LoadOptions.CultureInfo`, mit der Sie Ihr Workbook mit spezifischen Kulturinformationen laden können, ohne die Kulturinformationen des ganzen Threads zu ändern.
