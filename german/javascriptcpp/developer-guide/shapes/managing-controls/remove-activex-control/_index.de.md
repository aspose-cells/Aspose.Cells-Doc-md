---
title: ActiveX Steuerelement mit JavaScript über C++ entfernen
linktitle: AktiveX Steuerung entfernen
type: docs
weight: 1000
url: /de/javascript-cpp/remove-activex-control/
description: Lernen Sie, wie Sie ActiveX Steuerelemente aus Arbeitsmappen mit Aspose.Cells for JavaScript über C++ entfernen.
---

## **AktiveX-Steuerung entfernen**

Aspose.Cells bietet die Möglichkeit, ActiveX-Steuerelemente aus Arbeitsmappen zu entfernen. Für diese Funktion bietet die API die Methode [**Shape.removeActiveXControl()**](https://reference.aspose.com/cells/javascript-cpp/shape/#removeActiveXControl--). Das folgende Codebeispiel demonstriert die Verwendung der Methode [**Shape.removeActiveXControl()**](https://reference.aspose.com/cells/javascript-cpp/shape/#removeActiveXControl--), um ein ActiveX-Steuerelement zu entfernen.
