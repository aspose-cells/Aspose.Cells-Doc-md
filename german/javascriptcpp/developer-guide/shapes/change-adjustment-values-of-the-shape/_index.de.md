---
title: Ändern der Anpassungswerte der Form mit JavaScript über C++
linktitle: Anpassung von Formwerten ändern
type: docs
weight: 2000
url: /de/javascript-cpp/change-adjustment-values-of-the-shape/
description: Lernen Sie, wie Sie Anpassungswerte von Formen in Excel mit Aspose.Cells for JavaScript über C++ ändern.
---

{{% alert color="primary" %}}  
Aspose.Cells stellt die Eigenschaft [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) bereit, um Änderungen an den Anpassungspunkten mit Formen vorzunehmen. In der Microsoft Excel-Benutzeroberfläche werden Anpassungen als gelbe Diamantknoten angezeigt. Zum Beispiel:  
...
In diesem Artikel wird die Verwendung der Eigenschaft [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) erklärt, um den Anpassungswert der verschiedenen Formen zu ändern.  
{{% /alert %}}  
