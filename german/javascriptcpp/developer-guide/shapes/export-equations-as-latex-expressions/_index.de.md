...
type: docs
weight: 100
url: /de/javascript-cpp/export-equation/
---
...
Wenn Sie Gleichungen in Excel als LaTeX-Ausdrücke exportieren möchten, können Sie die [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) Methode verwenden. 

Der folgende Beispielcode zeigt, wie man die [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) Methode verwendet und die generierten Ergebnisse in HTML einfügt:
...
Wenn Sie Gleichungen in Excel als MathML-Ausdrücke exportieren möchten, können Sie die [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) Methode verwenden. 

Der folgende Beispielcode zeigt, wie man die [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) Methode verwendet und die generierten Ergebnisse in HTML einfügt:
