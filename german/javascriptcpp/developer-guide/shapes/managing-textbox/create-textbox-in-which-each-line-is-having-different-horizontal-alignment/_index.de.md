---
title: Erstellen eines Textfelds, bei dem jede Zeile eine andere horizontale Ausrichtung hat, mit JavaScript via C++
linktitle: Erstellen Sie ein Textfeld, in dem jede Zeile eine andere horizontale Ausrichtung hat
type: docs
weight: 310
url: /de/javascript-cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Erfahren Sie, wie Sie ein Textfeld erstellen, bei dem jede Zeile eine andere horizontale Ausrichtung haben kann, mit Aspose.Cells for JavaScript via C++.
---

{{% alert color="primary" %}}
Sie können die horizontale Ausrichtung Ihres Absatztextes mit der Eigenschaft [**TextParagraph.alignmentType**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#alignmentType--) festlegen.
{{% /alert %}}
