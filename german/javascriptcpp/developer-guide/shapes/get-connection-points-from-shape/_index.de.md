---
title: Erhalten Sie Verbindungspunkte von Formen mit JavaScript via C++
linktitle: Verbindungspunkte der Form abrufen
type: docs
weight: 3500
url: /de/javascript-cpp/get-connection-points-from-shape/
description: Lernen Sie, wie Sie Verbindungspunkte von Formen in Excel mit Aspose.Cells for JavaScript via C++ abrufen.
---

Aspose.Cells bietet umfangreiche Funktionen zur Verwaltung von Formen in der Tabelle. Manchmal ist es notwendig, die Verbindungspunkte einer Form zum Ausrichten oder Platzieren der Formen an der richtigen Stelle zu erhalten. Für diesen Zweck werden alle Verbindungspunkte benötigt. Der folgende Code kann verwendet werden, um die Liste der Verbindungspunkte einer Form mithilfe der [**Shape.connectionPoints**](https://reference.aspose.com/cells/javascript-cpp/shape/#connectionPoints--) Eigenschaft zu erhalten.
