---
title: OLE Objekte aus Arbeitsmappe mit JavaScript via C++ extrahieren
linktitle: OLE Objekte aus Arbeitsmappe extrahieren
type: docs
weight: 110
url: /de/javascript-cpp/extract-ole-objects-from-workbook/
---
...
Dieser Artikel zeigt, wie man eine Anwendung in JavaScript via C++ erstellt und verschiedene OLE-Objekte aus einer Arbeitsmappe mit wenigen Zeilen Code extrahiert.
{{% /alert %}}
...
1. [Downloaden Sie Aspose.Cells for JavaScript via C++](https://downloads.aspose.com/cells/javascript-cpp).  
...
Starten Sie eine JavaScript-Umgebung und erstellen Sie ein neues Projekt. Dieses Beispiel zeigt eine browserbasierte Anwendung, aber Sie können auch jede JavaScript-kompatible Umgebung verwenden.

1. Abhängigkeiten hinzufügen  
   1. Binden Sie das Aspose.Cells for JavaScript via C++-Skript in Ihre HTML-Seite ein und erstellen Sie eine einfache Benutzeroberfläche, um eine Excel-Datei auszuwählen und OLE-Objekte zu extrahieren:
