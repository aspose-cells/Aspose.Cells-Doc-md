...
Aspose.Cells for JavaScript via C++ bietet die Möglichkeit, Pivot-Tabellen im ODS-Format zu speichern. Dafür konvertieren Sie einfach eine Arbeitsmappe mit einer vorhandenen Pivot-Tabelle oder erstellen eine neue Pivot-Tabelle und speichern die Datei im ODS-Format. Stellen Sie sicher, dass Sie [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) vor dem Speichern aufrufen, um sicherzustellen, dass die Pivot-Tabelle im Ausgabedatei gerendert wird. Das folgende Code-Snippet demonstriert das Speichern einer Pivot-Tabelle im ODS-Format.
