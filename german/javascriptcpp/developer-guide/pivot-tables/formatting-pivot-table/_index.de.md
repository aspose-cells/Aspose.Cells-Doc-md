...
type: docs
weight: 10
url: /de/javascript-cpp/formatting-pivot-table/
description: Wie man eine Pivot Tabelle mit Aspose.Cells for JavaScript via C++ formatiert.
...
Die Klasse [**PivotTable**](https://reference.aspose.com/cells/javascript-cpp/pivottable/) steuert die gesamte Pivot-Tabelle und kann auf verschiedene Arten formatiert werden.
...
1. Setzen Sie [**PivotTable.isAutoFormat(value)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#isAutoFormat-boolean-) auf **true**.
1. Weisen Sie eine Formatierungsoption aus der [**PivotTableAutoFormatType**](https://reference.aspose.com/cells/javascript-cpp/pivottableautoformattype/)-Aufzählung zu.
...
Die Klasse [**PivotField**](https://reference.aspose.com/cells/javascript-cpp/pivotfield/) stellt ein Feld in einer Pivot-Tabelle dar und kann auf verschiedene Arten formatiert werden. Das unten stehende Codebeispiel zeigt, wie:
...
Die Methode [**clear()**](https://reference.aspose.com/cells/javascript-cpp/pivotfieldcollection/#clear--) der [**PivotFieldCollection**](https://reference.aspose.com/cells/javascript-cpp/pivotfieldcollection/)-Klasse ermöglicht es Ihnen, Pivot-Felder zu löschen. Verwenden Sie sie, wenn Sie alle Pivot-Felder in den Bereichen wie Seite, Spalte, Zeile oder Daten löschen möchten.
