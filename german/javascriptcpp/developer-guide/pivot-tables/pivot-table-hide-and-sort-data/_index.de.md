---
title: Pivot Tabelle Daten ausblenden und sortieren
type: docs
weight: 120
url: /de/javascript-cpp/pivot-table-hide-and-sort-data/
---

## **Pivot-Tabelle Daten ausblenden und sortieren**
Aspose.Cells for JavaScript via C++ unterstützt das Verbergen und Sortieren von Daten in der Pivot-Tabelle. Das folgende Code-Snippet demonstriert diese Funktion, indem es die Spalte 'Score' in absteigender Reihenfolge sortiert und dann die Zeilen mit einem Score unter 60 ausblendet.
