...
type: docs
weight: 20
url: /de/javascript-cpp/create-pivot-tables-and-pivot-charts/
description: Wie man Pivot Tabellen und Pivot Diagramme mit Aspose.Cells for JavaScript via C++ hinzufügt.
keywords: Aspose.Cells for JavaSkript via C++ Excel, Excel JavaScript Bibliothek, Pivot Tabellen und Pivot Diagramme mit Aspose.Cells for JavaSkript via C++ Excel Bibliothek hinzufügen.
---
...
Aspose.Cells for JavaSkript via C++ unterstützt [Pivot-Tabellen](/cells/de/javascript-cpp/create-pivot-tables-and-pivot-charts/) und [Pivot-Diagramme](/cells/de/javascript-cpp/create-pivot-tables-and-pivot-charts/).

{{% /alert %}}

## **Pivot-Tabellen und Diagramme mit Aspose.Cells for JavaSkript via C++ hinzufügen**

Aspose.Cells for JavaSkript via C++ stellt eine spezielle Klasse bereit, die zum Erstellen von Pivot-Tabellen verwendet wird. Diese Klassen werden verwendet, um PivotTable-Objekte zu erstellen und zu setzen, die die grundlegenden Bausteine eines PivotTable-Objekts darstellen:
...
### **Bereite die Verwendung von Aspose.Cells for JavaSkript via C++ vor**
1. Installieren Sie Aspose.Cells for JavaSkript via C++ aus NPM, verwenden Sie den Befehl: $ npm install aspose.cells.node.
1. Sie können auch die Schritt-für-Schritt-Anleitung zur Installation von "Aspose.Cells for JavaSkript via C++" in Ihrer Entwicklerumgebung befolgen.


### **So fügen Sie eine Pivot-Tabelle mit Aspose.Cells for JavaSkript via C++ hinzu**

Um eine Pivot-Tabelle mit Aspose.Cells for JavaSkript via C++ zu erstellen:
...
### **So fügen Sie ein Pivot-Diagramm mit Aspose.Cells for JavaSkript via C++ Bibliothek hinzu**

Um ein PivotChart mit Aspose.Cells for JavaSkript via C++ zu erstellen:
