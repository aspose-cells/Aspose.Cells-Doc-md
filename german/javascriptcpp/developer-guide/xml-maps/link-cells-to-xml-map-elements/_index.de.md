---
title: Zellen mit XML Karten Elementen verknüpfen mit JavaScript via C++
linktitle: Zellen mit XML Map Elementen verknüpfen
type: docs
weight: 50
url: /de/javascript-cpp/link-cells-to-xml-map-elements/
---

## **Mögliche Verwendungsszenarien**

Sie können Ihre Zellen mit XML-Karten-Elementen mit Aspose.Cells for JavaScript via C++ verknüpfen. Verwenden Sie dafür die Methode [**Cells.linkToXmlMap(string, number, number, string)**](https://reference.aspose.com/cells/javascript-cpp/cells/#linkToXmlMap-string-number-number-string-).
