---
title: Seitenseitenoptionen mit JavaScript via C++ einstellen
linktitle: Seite einrichten
type: docs
weight: 10
url: /de/javascript-cpp/setting-page-options/
description: Dieser Artikel bietet Beispielcode, um Seiteneinstellungen von Excel Arbeitsblättern programmgesteuert mit JavaScript via C++ festzulegen. Seitenausrichtung, Skalierungsfaktor, FitToPages Optionen, Papiergröße, Druckqualität, Erste Seiten Nummer.
keywords: Excel Seitenausrichtung mit JavaScript via C++ einstellen, Excel Skalierungsfaktor mit JavaScript via C++ einstellen, Papiergröße der Arbeitsblätter mit JavaScript via C++ einstellen
---
...
Die Klasse [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) stellt die Eigenschaft [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) bereit, mit der die Seitenlayoutsoptionen des Arbeitsblatts eingestellt werden. Tatsächlich ist diese Eigenschaft [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) ein Objekt der Klasse [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup), das es ermöglicht, verschiedene Seitenlayout-Optionen für ein gedrucktes Arbeitsblatt festzulegen. Die Klasse [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) bietet verschiedene Eigenschaften, um die Seiteneinrichtung zu steuern. Einige dieser Eigenschaften werden unten erläutert.  

### **Seitenausrichtung**  

Die Seitenorientierung kann mit der Eigenschaft [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) der Klasse [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) auf Hochformat oder Querformat eingestellt werden. Die Eigenschaft [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) akzeptiert einen der vordefinierten Werte im [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype) Enumeration, die unten aufgeführt sind.  
...
Es ist möglich, die Größe eines Arbeitsblatts zu verkleinern oder zu vergrößern, indem der Skalierungsfaktor mit der Eigenschaft [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) eingestellt wird.  
...
Um den Inhalt des Arbeitsblatts auf eine bestimmte Anzahl von Seiten anzupassen, verwenden Sie die Eigenschaften [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) und [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) der Klasse [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Diese Eigenschaften werden auch zum Skalieren von Arbeitsblättern verwendet.  

{{% alert color="primary" %}}  
Sie können entweder die Eigenschaften [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) oder [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) auswählen, aber nicht beide gleichzeitig.  
{{% /alert %}}  
...
Legen Sie die Papiergröße fest, auf der die Arbeitsblätter gedruckt werden sollen, mit der Eigenschaft [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) der Klasse [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Die Eigenschaft [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) akzeptiert einen der vordefinierten Werte im [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype) Enumeration, unten aufgeführt.  
...
Stellen Sie die Druckqualität der Arbeitsblätter mit der [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--) Eigenschaft ein. Die Maßeinheit für die Druckqualität ist Dots Per Inch (DPI).  
...
Beginnen Sie die Nummerierung der Arbeitsblätter mit der Eigenschaft [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) der Klasse [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Die Eigenschaft [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) legt die Seitennummer des ersten Arbeitsblattabschnitts fest, danach werden die Seiten aufsteigend nummeriert.  
