---
title: Wie man die Schriftfarbe des Kommentars mit JavaScript via C++ ändert
linktitle: Wie ändere ich die Kommentarschriftfarbe
type: docs
weight: 180
url: /de/javascript-cpp/how-to-change-the-comment-font-color/
---

{{% alert color="primary" %}}  
Microsoft Excel erlaubt es Benutzern, Kommentare zu Zellen hinzuzufügen, um zusätzliche Informationen bereitzustellen und Daten hervorzuheben. Entwickler müssen möglicherweise den Kommentar anpassen, um Ausrichtungseinstellungen, Textausrichtung, Schriftfarbe usw. festzulegen. Aspose.Cells for JavaSkript via C++ bietet APIs, um diese Aufgabe auszuführen.  
{{% /alert %}}  

Aspose.Cells for JavaSkript via C++ bietet eine [**Shape.textBody**](https://reference.aspose.com/cells/javascript-cpp/shape/#textBody--)-Eigenschaft, um die Schriftfarbe des Kommentars festzulegen. Der folgende Beispielcode zeigt die Verwendung der [**Shape.textBody**](https://reference.aspose.com/cells/javascript-cpp/shape/#textBody--)-Eigenschaft, um die Textausrichtung eines Kommentars zu setzen.  
