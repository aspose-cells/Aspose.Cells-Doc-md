...
type: docs
weight: 10
url: /de/javascript-cpp/format-number-to-date/
description: Dieser Artikel zeigt, wie man Zahlen mit der Aspose.Cells for JavaScript via C++ API in Datumsangaben umwandelt.
...
Um Zahlen in der Aspose.Cells for JavaScript via C++-Bibliothek für die Arbeit mit Excel-Dateien als Datum zu formatieren, können Sie Datumsformatierungen programmatisch auf Zellen anwenden. So geht's mit Aspose.Cells for JavaScript via C++:
