...
type: docs
weight: 10
url: /de/javascript-cpp/how-to-format-number-to-time/
description: Dieser Artikel erklärt, wie man die Zahl in Zeit in Aspose.Cells for JavaScript via C++ formatiert.
...
## **Wie man die Nummer in Zeit in Aspose.Cells for JavaScript via C++ formatiert**
Das Formatieren von Zahlen in Zeit in Aspose.Cells for JavaScript via C++ ist ein einfacher Vorgang, der das Anwenden eines benutzerdefinierten Zahlenformats auf eine Zelle oder einen Zellbereich beinhaltet. Aspose.Cells ist eine leistungsstarke Bibliothek, die es Ihnen ermöglicht, mit Excel-Dateien in Browseranwendungen zu arbeiten, ohne Microsoft Excel installiert zu haben. Hier erfahren Sie, wie Sie Zahlen in Zeit formatieren können:

### Schritt 1: Aspose.Cells for JavaScript via C++ in Ihre Seite einbinden

Holen Sie sich die Aspose.Cells for JavaScript via C++-Distribution und binden Sie das Laufzeitskript in Ihre HTML-Seite ein.

### Schritt 2: Öffnen Sie eine bestehende Arbeitsmappe aus einer Dateieingabe

Verwenden Sie eine Dateieingabe, um eine vorhandene Excel-Datei im Browser zu laden.

### Schritt 3: Zugriff auf das Arbeitsblatt

Greifen Sie auf das Arbeitsblatt zu, auf dem Sie Nummern in Zeitformate umwandeln möchten. Wenn Sie mit einer neuen Arbeitsmappe arbeiten, befinden Sie sich wahrscheinlich im ersten Blatt.

### Schritt 4: Zeitformat auf eine Zelle anwenden

Um eine Zahl als Zeit zu formatieren, verwenden Sie das Style-Objekt, das mit einer Zelle verbunden ist. Geben Sie das Zeitformat mit benutzerdefinierten Nummernformatzeichenfolgen an.

### Schritt 5: Arbeitsmappe speichern und Download bereitstellen

Nachdem Sie die gewünschten Formate angewendet haben, speichern Sie die Arbeitsmappe und stellen Sie dem Benutzer einen Download-Link bereit.
...
### Browser-Beispielcode

Das folgende HTML zeigt, wie eine Excel-Datei geladen, eine numerische Zelle A1 als Zeit (Stunden und Minuten) formatiert und die modifizierte Arbeitsmappe heruntergeladen wird:
