...
{{% alert color="primary" %}}
 ...
 Diese Seite enthält Versionshinweise für[Aspose.Cells for PHP via Java 22.2](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.2/).
