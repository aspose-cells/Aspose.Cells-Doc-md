...
type: docs
weight: 5
url: /de/python-java/features/
keywords: "python, excel, api, merkmale"
description: „Aspose.Cells für Python via Java Funktionen.“
---

{{% alert color="primary" %}} 

Diese Seite fasst die Funktionen von Aspose.Cells für Python via Java zusammen.

{{% /alert %}} 
## **Dateiformate und Konvertierungen**
- XLS, SpreadsheetML (XLSX, XML), kommagetrennte Werte (CSV), HTML, OpenDocument Spreadsheet (ODS), PDF, Tabulatorgetrennte Werte, Klartext (TXT)
## **Rendern und Drucken**
