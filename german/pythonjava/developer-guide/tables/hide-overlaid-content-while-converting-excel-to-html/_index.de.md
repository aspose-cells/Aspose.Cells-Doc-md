...
Der folgende Beispielcode lädt die[Beispiel-Excel-Datei](sampleHidingOverlaidContentWithCrossHideRight.xlsx)und speichert es ab[HTML ausgeben](HTML-outputHidingOverlaidContentWithCrossHideRight.zip)nach dem Einstellen der[HtmlSaveOptions.HtmlCrossStringType](https://reference.aspose.com/cells/python/asposecells.api/htmlsaveoptions#HtmlCrossStringType)wie[KREUZ_AUSBLENDEN_RECHTS](https://reference.aspose.com/cells/python/asposecells.api/htmlcrosstype#CROSS_HIDE_RIGHT). Der Screenshot erklärt wie[KREUZ_AUSBLENDEN_RECHTS](https://reference.aspose.com/cells/python/asposecells.api/htmlcrosstype#CROSS_HIDE_RIGHT)wirkt sich auf die HTML-Ausgabe der Standardausgabe aus.
