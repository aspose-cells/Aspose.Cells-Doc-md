---
title: Öffnen Sie CSV-Dateien
type: docs
weight: 10
url: /de/python-java/open-csv-files/
---
## **Öffnen Sie CSV-Dateien**
Comma Separated Values (CSV)-Dateien enthalten Datensätze, deren Werte durch Kommas getrennt oder begrenzt sind. Sie können Microsoft Excel verwenden, um Ihre Tabelle im CSV-Format zu speichern.
