...
type: docs
weight: 11
url: /de/nodejs-java/aspose-cells-for-node-js-via-java-23-2-release-notes/
---
{{% alert color="primary" %}}

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Node.js via Java 23.2](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.2/).
