---
title: Aspose.Cells für Node.js über Java 22.4 Versionshinweise
type: docs
weight: 9
url: /de/nodejs-java/aspose-cells-for-node-js-via-java-22-4-release-notes/
---
{{% alert color="primary" %}}

 Diese Seite enthält Versionshinweise für[Aspose.Cells für Node.js über Java 22.4](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.4/).
