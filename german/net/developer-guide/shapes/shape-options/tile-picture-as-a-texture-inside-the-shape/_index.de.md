---
title: Kachelbild als Textur innerhalb der Form
type: docs
weight: 1700
url: /de/net/tile-picture-as-a-texture-inside-the-shape/
---
...
## **Kachelbild als Textur innerhalb der Form**
 ...
 Sie können die Formoberfläche mit einem Bild füllen und sie mit kacheln[**Shape.Fill.TextureFill.IstTiling**](https://reference.aspose.com/cells/net/aspose.cells.drawing/texturefill/properties/istiling) Eigenschaft und Einstellung**wahr** . Bitte sehen Sie sich den folgenden Beispielcode an, its[Beispiel-Excel-Datei](46465050.xlsx) sowie den Screenshot als Referenz.

## **Bildschirmfoto**

![todo: Bild_alt_Text](tile-picture-as-a-texture-inside-the-shape_1.png)
