---
title: Intelligentes Importieren von JSON in Excel mit Smart Markern
type: docs
weight: 30
url: /de/net/how-to-import-json-into-excel-with-smart-markers/
alias: [/net/using-json-data-in-smart-markers/]
---

## **Warum JSON-Daten für Smart Marker verwenden**
...
Aspose.Cells for .NET unterstützt JSON-Daten in Smart Markern, JSON-Daten können hierarchisch verschachtelt sein. Bitte prüfen Sie die [Vorlagendatei](smartmarker.xlsx), [JSON-Datei](smartmarker.json) und den Screenshot der erzeugten Ausgabedatei in Excel mit folgendem Code.
...
Aspose.Cells for .NET unterstützt JSON-Daten in Smart Markern, JSON-Daten können hierarchisch verschachtelt sein. Unterzusummen wurden für die Datenstatistik in der Excel-Vorlage verwendet. Bitte prüfen Sie die [Vorlagendatei](jsonExcelTemplate.xlsx), [JSON-Datei](jsonData.json) und den Screenshot der erzeugten Ausgabedatei in Excel mit folgendem Code.
