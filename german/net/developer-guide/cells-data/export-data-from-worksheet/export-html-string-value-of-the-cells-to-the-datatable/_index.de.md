---
title: Exportieren Sie den HTML-Zeichenfolgenwert von Cells in die DataTable
type: docs
weight: 260
...
## **Exportieren Sie den HTML-Zeichenfolgenwert von Cells in die DataTable**
 Der folgende Beispielcode veranschaulicht, wie der Zeichenfolgenwert HTML der Zellen in die DataTable exportiert wird, während Daten aus dem Arbeitsblatt in die DataTable exportiert werden. Bitte sehen Sie sich ... an[Beispiel-Excel-Datei](45056025.xlsx), sein Screenshot und die Konsolenausgabe als Referenz.
## **Bildschirmfoto**
![todo: Bild_alt_Text](export-html-string-value-of-the-cells-to-the-datatable_1.png)
## **Beispielcode**
