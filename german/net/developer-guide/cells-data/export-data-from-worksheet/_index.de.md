...
- [C# XLS in DataTable konvertieren](#csharp-convert-xls-to-datatable)
...
- [C# XLSX in DataTable konvertieren](#csharp-convert-xlsx-to-datatable)
...
- [C# ODS in DataTable konvertieren](#csharp-convert-ods-to-datatable)
...
- **Reihenanzahl**, die Anzahl der zu exportierenden Zeilen.
...
- <a name="csharp-excel-to-datatable" id="csharp-excel-to-datatable"><strong><em>Schritte:</em> Excel zu DataTable in C#</strong></a>
  - <a name="csharp-xls-to-datatable" id="csharp-xls-to-datatable"><strong><em>Schritte:</em> XLS zu DataTable unter C#</strong></a>
...
- <a name="csharp-export-to-datatable-from-excel" id="csharp-export-to-datatable-from-excel"><strong><em>Schritte:</em> Export nach DataTable aus Excel in C#</strong></a>
  - <a name="csharp-export-to-datatable-from-xls" id="csharp-export-to-datatable-from-xls"><strong><em>Schritte:</em> Export in DataTable von XLS in C#</strong></a>
  ...
  - <a name="csharp-export-to-datatable-from-ods" id="csharp-export-to-datatable-from-ods"><strong><em>Schritte:</em> Export in DataTable von ODS in C#</strong></a>
