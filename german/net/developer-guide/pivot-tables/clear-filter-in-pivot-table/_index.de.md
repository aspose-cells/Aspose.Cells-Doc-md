...
type: docs
weight: 130
url: /de/net/clear-filter-in-pivot-table/
...
##  **Filter in der Pivot-Tabelle mit C# löschen**
 Löschen Sie den Filter in der Pivot-Tabelle mit Aspose.Cells. Bitte sehen Sie sich den folgenden Beispielcode an.
1.  Legen Sie die Daten fest und erstellen Sie darauf basierend eine PivotTable.
2. Fügen Sie einen Filter zum Zeilenfeld der Pivot-Tabelle hinzu.
 3. Speichern Sie die Arbeitsmappe unter[Ausgabe XLSX](out_add.xlsx) Format. Nach der Ausführung des Beispielcodes wird dem Arbeitsblatt eine Pivot-Tabelle mit Top10-Filter hinzugefügt.
 4. Löschen Sie den Filter für ein bestimmtes Pivotfeld. Nach der Ausführung des Codes zum Löschen des Filters wird der Filter für das jeweilige Pivotfeld gelöscht. Bitte überprüfen Sie die[Ausgabe XLSX](out_delete.xlsx).
