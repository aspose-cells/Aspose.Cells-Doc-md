...
type: docs
weight: 20
url: /de/net/find-out-if-vba-project-is-protected/
---
## **Finden Sie unter C# heraus, ob das VBA-Projekt geschützt ist**

 Ob das VBA-Projekt (Visual Basic Applications) Ihrer Excel-Datei geschützt ist oder nicht, können Sie mit Aspose.Cells feststellen[**VbaProject.IsProtected**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/properties/isprotected)Eigentum.
