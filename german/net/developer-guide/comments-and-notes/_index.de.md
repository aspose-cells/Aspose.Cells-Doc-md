...
description: Fügen Sie Kommentare oder Notizen ein und verwalten Sie sie mit Aspose.Cells für .Net.
...
## **Themen vorantreiben**
- [Textrichtung des Kommentars ändern](/cells/de/net/change-text-direction-of-the-comment/)
- [So ändern Sie die Schriftfarbe für Kommentare](/cells/de/net/how-to-change-the-comment-font-color/)
- [So legen Sie den Kommentarhintergrund fest](/cells/de/net/how-to-set-comment-background/)
- [Verkettete Kommentare](/cells/de/net/threaded-comments/)
