...
type: docs
weight: 210
url: /de/net/get-the-version-number-of-the-application-that-created-the-excel-document/
---

{{% alert color="primary" %}}

Oft müssen Sie die Versionsnummer der Anwendung kennen, die ein Microsoft Excel-Dokument erstellt hat. Aspose.Cells bietet hierfür die Eigenschaft [**Workbook.BuiltInDocumentProperties.Version**](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/version).
