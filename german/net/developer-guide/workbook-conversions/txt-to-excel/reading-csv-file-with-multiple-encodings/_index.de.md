...
Manchmal enthält Ihre CSV-Datei mehrere Codierungen (Unicode, ANSI, UTF8, UTF7 usw.). Aspose.Cells können Sie solche CSV-Dateien laden und in andere Formate konvertieren, beispielsweise PDF oder XLSX.

{{% /alert %}}

 Aspose.Cells bietet die[**TxtLoadOptions.IsMultiEncoded**](https://reference.aspose.com/cells/net/aspose.cells/txtloadoptions/properties/ismultiencoded)Eigenschaft, die Sie festlegen müssen**Stimmt** um Ihre CSV-Datei mit mehreren Kodierungen richtig zu laden.
