...
type: docs
weight: 50
url: /de/net/link-cells-to-xml-map-elements/
---

## **Mögliche Verwendungsszenarien**

Sie können Ihre Zellen mit XML-Map-Elementen mit Aspose.Cells verknüpfen. Bitte verwenden Sie die Methode [**Cells.LinkToXmlMap()**](https://reference.aspose.com/cells/net/aspose.cells/cells/methods/linktoxmlmap) für diesen Zweck.
