...
<div class="row">
    <div class="col-md-6">
        ...
        <p>Neu</p>
        <ul>
            <li><a href="/cells/de/net/your-first-aspose-cells-application-hello-world/#code-sample-creating-a-new-workbook">Erstellen einer neuen Arbeitsmappe</a></li>
        </ul>
        <p>Offen</p>
        <ul>
            <li><a href="/cells/de/net/different-ways-to-open-files/">Verschiedene Möglichkeiten zum Öffnen von Dateien</a></li>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul>
		 <li><a href="/cells/de/net/accessing-cells-of-a-worksheet/">Zugriff auf Cells eines Arbeitsblatts</a></li>
		 ...
		 <li><a href="/cells/de/net/rows-and-columns/">Reihen und Spalten</a></li>
        </ul>
        ...
        <ul>
          ...
          <li><a href="/cells/de/net/apply-advanced-conditional-formatting/">Wenden Sie die erweiterte bedingte Formatierung an</a></li>
        </ul>       
    </div>
    <div class="col-md-6">        
        <p>Sortieren</p>
        ...
        <p>Cells</p>
        <ul>
		<li><a href="/cells/de/net/inserting-and-deleting-rows-and-columns/">Einfügen und Löschen von Zeilen und Spalten</a></li>
        </ul>		
    </div>
</div>
{{< /tab >}}
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul>
            <li><a href="/cells/de/net/insert-a-linked-picture-from-web-address/">Fügen Sie ein verknüpftes Bild von der Webadresse ein</a></li>
            <li><a href="/cells/de/net/insert-a-picture-based-on-cell-reference/">Fügen Sie ein Bild basierend auf der Referenz Cell ein</a></li>
        ...
        <ul>
            <li><a href="/cells/de/net/insert-shapes/#inserting-a-line-to-worksheet">Einfügen einer Zeile in ein Arbeitsblatt</a></li>
    ...
    <div class="col-md-6">       
        <p><a href="/cells/de/net/managing-ole-objects/">OLE-Objekt</a></p>
        <ul>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <ul>
		<li><a href="/cells/de/net/setting-page-options/#scaling-factor">Skala</a></li>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul>
		 <li><a href="/cells/de/net/xml-maps/">XML-Karten</a></li>
...
<div class="row">
    ...
    <div class="col-md-6">
        <p>Änderungen</p>
        <ul>
         <li><a href="/cells/de/net/convert-revision-of-xlsb-to-xlsm/">Konvertieren Sie die Revision von XLSB in XLSM</a></li>
        </ul>
    </div>
</div>
{{< /tab >}}
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <p>Fenster</p>
        <ul>
        <li><a href="/cells/de/net/working-with-freeze-panes/">Fenster einfrieren</a></li>
        <li><a href="/cells/de/net/split-cells-in-worksheet/">Teilen Sie Cells im Arbeitsblatt auf</a></li>
        </ul>
    </div>
</div>
{{< /tab >}}
...
<div class="row">
    <div class="col-md-6">
        <p>Kontrollen</p>
        <ul>
         <li><a href="/cells/de/net/workbook-vba-project/">Arbeitsmappe VBA-Projekt</a></li>
        </ul>
        <p>XML</p>
         <ul>
		<li><a href="/cells/de/net/xml-maps/">XML-Karten</a></li>
