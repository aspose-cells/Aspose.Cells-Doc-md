...
description: Erfahren Sie, wie Sie primäre und sekundäre Achsen in Aspose.Cells for .NET verstehen und damit arbeiten. Unser Leitfaden hilft Ihnen, die Unterschiede zwischen primären und sekundären Achsen zu verstehen und wie Sie sie effektiv in Ihren Diagrammen konfigurieren und verwenden können.
keywords: Aspose.Cells for .NET, primäre Achsen, sekundäre Achsen, Verständnis, Unterschiede, Konfiguration, Verwendung.
type: docs
weight: 190
url: /de/net/primary-and-second-axis/
---
