...
##  **Rendering-Diagramm bis PDF**
 ...
 Um das Diagramm im Format PDF zu rendern, haben die Aspose.Cells-APIs das bereitgestellt[**Chart.ToPdf**](https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/topdf/index)Methode mit der Möglichkeit, das Ergebnis PDF auf dem Disc-Pfad oder Stream zu speichern.
