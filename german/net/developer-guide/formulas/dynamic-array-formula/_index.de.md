...
description: Verwendung der Aspose.Cells Bibliothek, um dynamische Array Formeln in Microsoft Excel zu berechnen. Durch Laden einer vorhandenen Excel Datei oder Erstellen einer neuen Excel Datei können wir die von Aspose.Cells bereitgestellte Methode verwenden, um die dynamische Array Formel zu berechnen und das Ergebnis zu erhalten. Abschließend speichern wir die modifizierte Excel Datei auf der Festplatte.
...
Bitte sehen Sie sich den folgenden Beispielcode an, der die [Beispieldatei in Excel lädt](dynamicArrayFormula.xlsx), die einige Dummy-Daten enthält. Nach dem Laden der Datei rufen Sie die Funktion [Cell.SetDynamicArrayFormula](https://reference.aspose.com/cells/net/aspose.cells/cell/setdynamicarrayformula/#setdynamicarrayformula) auf, um die dynamische Arrayformel festzulegen, und die Funktion [Workbook.RefreshDynamicArrayFormulas](https://reference.aspose.com/cells/net/aspose.cells/workbook/refreshdynamicarrayformulas/#refreshdynamicarrayformulas) um die dynamische Arrayformeln zu aktualisieren, bevor Sie die Formelberechnung aufrufen und schließlich die Arbeitsmappe als [Ausgabedatei in Excel speichern](out.xlsx). 
