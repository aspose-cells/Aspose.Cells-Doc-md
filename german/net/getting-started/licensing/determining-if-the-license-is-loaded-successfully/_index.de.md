...
## C#-Code, um festzustellen, ob die Lizenz erfolgreich geladen wurde
 ...
 Der folgende Code greift auf die[**Workbook.IsLicensed**](https://reference.aspose.com/cells/net/aspose.cells/workbook/properties/islicensed) -Eigenschaft vor dem Festlegen einer Lizenz und kehrt zurück**FALSCH** . Dann lädt es die Lizenz und greift erneut auf die Eigenschaft zu, die jetzt zurückkehrt**wahr**.
