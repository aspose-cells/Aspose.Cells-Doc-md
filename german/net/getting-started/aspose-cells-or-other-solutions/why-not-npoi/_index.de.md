---
title: Aspose.Cells oder NPOI
linktitle: Warum nicht NPOI
description: "Führen Sie eine große Anzahl von Aufgaben mit Excel Dateien schneller und bequemer als NPOI unter Verwendung von C# aus."
type: docs
weight: 40
url: /de/net/why-not-npoi
---
...
Erkunden Sie [das Plugin mit Beispielen des Quellcodes von Aspose.Cells for .NET-Funktionen im Vergleich zu NPOI](https://github.com/aspose-cells/Aspose.Cells-for-.NET/tree/master/Plugins/NPOI).
...
Aspose-Komponenten bieten viele leistungsstarke Zeit sparende Funktionen. Beispielsweise bietet [Aspose.Cells](https://products.aspose.com/cells/net/) eine Funktion, mit der Entwickler JSON in Excel-Dateien importieren können. Es ist erwähnenswert, dass jeder Bestandteil der Aspose-Familie sein eigenes einzigartiges und leistungsstarkes Funktionsspektrum bietet.
