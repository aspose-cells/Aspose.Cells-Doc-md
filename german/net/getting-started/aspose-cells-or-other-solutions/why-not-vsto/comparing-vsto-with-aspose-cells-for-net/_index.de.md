---
title: Vergleich VSTO mit Aspose.Cells for .NET
type: docs
weight: 20
...
Dieser Artikel vergleicht die Verwendung von VSTO (Visual Studio Tools for Office) mit anderen Ansätzen zum Entwickeln von Microsoft Office-basierten Lösungen. Insbesondere wird die Aspose.Cells betrachtet und ein Vergleich der Funktionsweise der beiden Lösungen bereitgestellt. Die Artikel enthalten Informationen, die Entwickler verwenden können, um verschiedene Optionen zu analysieren, zu vergleichen und zu bewerten, bevor sie eine Lösung annehmen.
...
1. Als Vorlage dient eine Microsoft Excel-Datei (TempBook.xls).
 Die Arbeitsmappe enthält einige Arbeitsblätter mit einigen Zellen, die mit Daten gefüllt sind.
1. Der Beispielcode fügt 1000*20 Datensätze in das erste Arbeitsblatt in der Excel-Vorlagendatei ein.
