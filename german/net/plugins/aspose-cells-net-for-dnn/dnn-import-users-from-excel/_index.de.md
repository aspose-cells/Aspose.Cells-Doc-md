---
title: DNN Benutzer aus Excel importieren
type: docs
weight: 30
url: /de/net/dnn-import-users-from-excel/
---
## **Einführung**
Aspose .NET Benutzer aus Excel importieren Mit dem Modul können Entwickler Massenbenutzer aus einer Excel-Datei importieren. Dieses Modul demonstriert die leistungsstarke Tabellenfunktion von Aspose.Cells.
### **Modulfunktionen**
Diese erste Version des Moduls ist mit den folgenden coolen Funktionen angereichert, um den Importprozess einfach und benutzerfreundlich zu gestalten:

- Ermöglicht das Hochladen einer Excel-Datei und filtert automatisch vorhandene Benutzer heraus.
- Überspringt automatisch die vorhandenen Benutzer, um Verwirrung zu vermeiden.
- Generieren Sie dynamische Passwörter für die neu erstellten Benutzer.
- Weist neu erstellten Benutzern die Sicherheitsrollen „Registrierte Benutzer“ und „Abonnenten“ zu.
...
Sie können das Modul Aspose .NET Cells Import Users from Excel for DNN von einem der folgenden Orte herunterladen
...
1.  Navigieren Sie zum neuesten Quellcode, den Sie heruntergeladen und geöffnet haben**Aspose.DNN.ImportUsersFromExcel.sln**
