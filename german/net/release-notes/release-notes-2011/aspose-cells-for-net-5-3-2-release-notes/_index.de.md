...
type: docs
weight: 80
url: /de/net/aspose-cells-for-net-5-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 5.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.3.2/)
...
|25346 | Formel| XLS-Link VS. XLSX-Link|
...
|24514 | Pdf| Problem bei der Konvertierung von Excel in PDF|
|25149 | Pdf| PDF-Export - Leistungsproblem bei der Garbage Collection|
|25260 | Pdf| Ausgabe von XLS zu PDF|
