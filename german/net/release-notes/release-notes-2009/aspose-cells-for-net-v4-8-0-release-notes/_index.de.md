...
type: docs
weight: 10
url: /de/net/aspose-cells-for-net-v4-8-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET v4.8.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.8.0/)
...
|8881 | XLs| Löst ArgumentOutOfRangeException beim Öffnen einer Datei aus|
