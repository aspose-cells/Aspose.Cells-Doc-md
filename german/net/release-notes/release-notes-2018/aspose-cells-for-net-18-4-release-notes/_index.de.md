...
type: docs
weight: 90
url: /de/net/aspose-cells-for-net-18-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46013|Neuer Kreuztyp mit ausgeblendetem Inhalt beim Speichern als HTML|Erweiterung|
|CELLSNET-45965|Fähigkeit, Standard-LINK-Element während der Rückwärtskonvertierung zu verarbeiten|Erweiterung|
|CELLSNET-46032|Generieren Sie keine einseitige leere PDF-Datei, wenn die Excel-Datei leer ist|Erweiterung|
|CELLSNET-46027|Excel-zu-PDF-Wiedergabe – Kopf-/Fußzeilenproblem|Erweiterung|
...
|CELLSNET-46005|Schriften für verschiedene Blätter im Ausgabe-PDF-Dateiformat umgekehrt|Insekt|
...
|CELLSNET-46034|PivotTables (deren Datenquelle extern ist) können nicht aus dem XLS-Dateiformat entfernt werden|Insekt|
...
|CELLSNET-45990|Die PDF-Ausgabe variiert je nach Optimierungstyp|Insekt|
...
|CELLSNET-46024|Beim Speichern wurde OriginalDataSource mit Slash in Backslash geändert|Insekt|
...
|CELLSNET-46002|Seitenkopfzeilen werden nur auf der ersten Seite in der Ausgabe-PDF angezeigt|Insekt|
...
|CELLSNET-46008|Ungültiger String in der Datei – Ausnahme tritt beim Öffnen der XLS-Datei auf|Ausnahme|
