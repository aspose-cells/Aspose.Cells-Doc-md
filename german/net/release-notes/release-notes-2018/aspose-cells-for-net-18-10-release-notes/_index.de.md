...
type: docs
weight: 30
url: /de/net/aspose-cells-for-net-18-10-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46383|Problem mit der Bildquelle beim Rendern von Excel in das HTML-Dateiformat|Insekt|
|CELLSNET-46367|Die Schriftgröße wurde während der Konvertierung von XLSX in HTML von 6,5 auf 6 geändert|Insekt|
...
|CELLSNET-42681|Die XLSB-Datei wird beim Öffnen und Speichern beschädigt|Insekt|
|CELLSNET-46382|Der CSV-Import erzeugt mit PreferredParsers eine falsche Formatierung|Insekt|
...
|CELLSNET-46321|Das Escape-Zeichen wird wie im PDF angezeigt|Insekt|
|CELLSNET-46376|Seitengröße (und Ränder) der PDF-Ausgabe stimmt nicht mit der MS Excel-Ausgabe überein|Insekt|
|CELLSNET-46373|Die Höhe des Bildes in der Kopfzeile wurde zusammen mit dem fehlerhaften Layout während der XLSM->PDF-Konvertierung abgeschnitten|Insekt|
...
|CELLSNET-46390|Die SourceFullName-Eigenschaft des OLE-Objekts ist beim Zugriff in XLSB leer|Insekt|
|CELLSNET-46385|Kopfzeilenbild/-form wird beim erneuten Speichern einer XLSX-Datei nicht korrekt gerendert|Insekt|
|CELLSNET-46384|Unterschied in OLE-Objekten vor und nach dem Speichern der XLSB-Datei|Insekt|
...
|CELLSNET-46347|Die XLSX-Datei ist nach dem Konvertieren aus einer XML-Datei (SpreadsheetML) beschädigt|Insekt|
