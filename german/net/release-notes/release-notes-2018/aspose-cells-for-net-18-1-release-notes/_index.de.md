---
title: Aspose.Cells for .NET 18.1 Versionshinweise
type: docs
weight: 120
url: /de/net/aspose-cells-for-net-18-1-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 18.1](https://www.nuget.org/packages/Aspose.Cells/18.1.0).

{{% /alert %}} 
## **Wichtige Neuigkeiten**
**Xamarin**

Aspose.Cells für for .NET enthält jetzt auch Aspose.Cells für iOS über Xamarin und Aspose.Cells für Android über Xamarin-Assemblys mit seinen regulären .NET-DLLs.
...
|CELLSNET-45580|Die Diagrammgröße wird in einer bestimmten XLS-Datei geändert|Insekt|
|CELLSNET-45018|Excel-Grafik nach Laden und Speichern geändert|Insekt|
|CELLSNET-44901|Legendeneinträge haben sich nach einfachem Resave leicht nach unten verschoben|Insekt|
|CELLSNET-45775|Beim Konvertieren des Diagramms in ein Bild fehlt die Beschriftung der zweiten vertikalen Achse|Insekt|
|CELLSNET-45850|Fehler beim Kopieren von Blättern von einem Buch in ein anderes|Insekt|
|CELLSNET-45847|SpreadsheetML bis XLSX - Aspose.Cells legt die Schutzeinstellungen fest|Insekt|
|CELLSNET-45846|MS Excel zeigt eine Fehlermeldung an, wenn die neu gespeicherte Datei darin geöffnet wird|Insekt|
|CELLSNET-45838|Linkes Diagramm, dh „saisonale Anpassung“ – die Balkengröße ändert sich in der ausgegebenen Excel-Datei|Insekt|
...
|CELLSNET-45829|Wenn XLSX als HTML gespeichert wird, tritt eine Ausnahme IndexOutOfRangeException auf|Ausnahme|
|CELLSNET-45825|System.OutOfMemoryException beim Rendern des Diagrammbilds|Ausnahme|
|CELLSNET-45844|Die Excel-Datei wird von E-Mail aus geöffnet, aber sie wird nicht mit Aspose.Cells geöffnet|Ausnahme|
|CELLSNET-45823|Ausnahme beim Öffnen einer SpreadsheetML-Datei|Ausnahme|
|CELLSNET-45817|Ausnahme beim Festlegen von HtmlString für eine Zelle auf einen bestimmten Wert|Ausnahme|
|CELLSNET-45832|Ausnahme beim Laden einer XLSM-Datei in GridWeb|Ausnahme|
|CELLSNET-45806|Index außerhalb des Bereichs Ausnahme mit Zeitfeld-Subtraktionsformel in Aspose.Cells.GridDesktop|Ausnahme|
