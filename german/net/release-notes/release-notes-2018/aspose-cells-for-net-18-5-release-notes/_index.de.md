...
type: docs
weight: 80
url: /de/net/aspose-cells-for-net-18-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46087|Page Setup PrintErrorType funktioniert nicht in Excel für die PDF-Wiedergabe|Erweiterung|
|CELLSNET-46084|PageSetup.PrintDraft wird beim Speichern in PDF nicht wirksam|Erweiterung|
...
|CELLSNET-46110|Der Textumbruch ist nicht korrekt, wenn „Ausgabe2 Umbruch-Nr_Brauch_Seitengröße.xlsx“ wird in PDF konvertiert|Insekt|
|CELLSNET-46109|Der Textumbruch ist nicht korrekt, wenn "Issue2 wrap.xlsx" in PDF konvertiert wird|Insekt|
|CELLSNET-46108|Der Textumbruch ist nicht korrekt, wenn „Issue3 Wrapping.xlsx“ in PDF konvertiert wird|Insekt|
|CELLSNET-46088|Der Zoomfaktor der Seiteneinrichtung erzeugt eine falsche Anzahl von Seiten im PDF|Insekt|
...
|CELLSNET-46036|Der Diagrammtitel wird gestaucht, wo die Zeichen alle zusammen in Excel zum PDF-Rendering laufen|Insekt|
...
|CELLSNET-46104|Beim Speichern von XLSB in XLSM wird eine beschädigte MS Excel-Datei erstellt|Insekt|
|CELLSNET-46098|Benannte Bereiche gehen beim Kopieren in eine vorhandene Arbeitsmappe verloren|Insekt|
|CELLSNET-46077|Eingebettete Zeichnungsobjekte sind in der Ausgabedatei beim erneuten Speichern einer XLSX-Datei zu schmal|Insekt|
|CELLSNET-46068|Aspose.Cells gibt eine leere PDF-Datei zurück, wenn eine SpreadsheetML-Datei als PDF gespeichert wird|Insekt|
|CELLSNET-46060|Beim Konvertieren von ODS in das XLSX-Dateiformat tritt ein Datenverlust auf|Insekt|
|CELLSNET-46057|Der benannte Bereich wird nicht mit dem „Shift“-Parameter von Smart Markern erweitert|Insekt|
...
|CELLSNET-46059|Die XLS-Datei kann nicht geöffnet werden, da beim Laden eine Ausnahme ausgelöst wird|Ausnahme|
|CELLSNET-46097|Ausnahme "Ungültige Formel:"'Neuer' Name'!G11:G15"." beim Aktualisieren von Pivot-Diagrammdaten|Ausnahme|
|CELLSNET-46075|Ausnahme beim Rendern einer Excel-Datei in PDF|Ausnahme|
