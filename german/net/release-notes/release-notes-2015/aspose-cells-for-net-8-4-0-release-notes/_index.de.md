...
type: docs
weight: 100
url: /de/net/aspose-cells-for-net-8-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 8.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.0/)
...
(CELLSNET-43362) – Unterstützung zum Löschen einer PivotTable aus dem Arbeitsblatt
 ...
 (CELLSNET-43279) – Inhaltstypeigenschaften werden im XLS-Format nicht angezeigt
...
## **Verbesserungen**
 ...
 (CELLSNET-43368) – Anpassen der Generierung von CSS beim Speichern von Excel in HTML

 (CELLSNET-43361) – Das Zahlenformat von Cell kann nach ImportTwoDimensionArray nicht beibehalten werden

 (CELLSNET-43454) - Aspose.Pdf validiert die PDF/A-1B-Ausgabe nicht

 (CELLSNET-43452) – Die PDFA1B-Konformität der Ausgabe-PDF wurde nicht validiert
...
## **Leistung**
 ...
 (CELLSNET-43438) – Spreadsheet to HTML generiert eine HTML-Datei mit 1 GB

 (CELLSNET-43399) – Leistungsproblem mit der Methode CalculateFormula()
...
(CELLSNET-43414) – Die Lücke zwischen Header und Body ist unterschiedlich
 ...
 (CELLSNET-43410) – Falscher Abstand bei jeder Environment.NewLine in der Ausgabe-PDF
 ...
 (CELLSNET-43352) – Die PDF-Größe verdoppelt sich, wenn sie von XLSX konvertiert wird

 (CELLSNET-43351) – Problem mit Diagrammlegende beim Konvertieren von XLSX in PDF

 (CELLSNET-43350) – Problem mit Diagrammachse beim Konvertieren von XLSX in PDF
...
(CELLSNET-43339) – Diagramme werden in der Ausgabe-PDF nicht richtig gerendert
 ...
 (CELLSNET-42558) – Überlappende Beschriftungen beim Rendern des Kreisdiagramms
 ...
 (CELLSNET-43441) – Die Konvertierung von XLSX zu XLSB erzeugt eine beschädigte Tabelle
...
(CELLSNET-43423) – PageSetup.IsHFAlignMargins wird in der Excel-Ausgabedatei automatisch wahr
 ...
 (CELLSNET-43336) – Problem beim Rendern der bedingten Formatierung – Excel in HTML

(CELLSNET-43335) – Problem beim Rendern der bedingten Formatierung – Excel in PDF
...
## **Ausnahmen**
 ...
 (CELLSNET-43320) – Nullreferenz-Ausnahme beim Speichern als HTML
