...
type: docs
weight: 110
url: /de/net/aspose-cells-for-net-8-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 8.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.3.2/)
...
## **Verbesserungen**
 ...
 (CELLSNET-43305) – Beim Kopieren eines Bereichs mit PasteType.All wird der Hyperlink nicht kopiert
...
(CELLSNET-43263) – Problem beim Rendern von Bildern
 ...
 (CELLSNET-43255) – Diagrammbild wird nicht korrekt gerendert
