...
type: docs
weight: 70
url: /de/net/aspose-cells-for-net-8-5-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 8.5.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.0/)
...
## **Fehler**
 ...
 (CELLSNET-43667) – Falscher Formelwert nach Aufruf von Worksheet.CalculateFormula
