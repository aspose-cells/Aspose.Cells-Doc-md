...
type: docs
weight: 80
url: /de/net/aspose-cells-for-net-8-4-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 8.4.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.2/)
