...
type: docs
weight: 20
url: /de/net/aspose-cells-for-net-8-2-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 8.2.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.2/)
...
## **Leistung**
 ...
 (CELLSNET-43015) – Der Konvertierungsprozess in PDF scheint an einer Tabelle mit 115996 Zeilen zu hängen
...
## **Fehler**
 ...
 (CELLSNET-43002) – Form überlappt den Text, wenn die Tabelle als Bild gerendert wird

 (CELLSNET-42903) – Problem mit dem Texteinzug

 (CELLSNET-42838) – Text im Textfeld wird im resultierenden PDF nicht gerendert
...
(CELLSNET-40921) – Die Formausrichtung ist beim Rendern in ein Bild falsch
 ...
 (CELLSNET-43056) – Gradation und Textur werden im gerenderten PDF-Dateiformat nicht angezeigt
...
(CELLSNET-42819) – Problem mit der Ausrichtung der Kategorieachsenbeschriftung in gestapelten Balkendiagrammen mit mehreren Ebenen
 ...
 (CELLSNET-42641) – Falsche Achsenwerte, wenn Diagramm mit ToImage als EMF gespeichert wird

 (CELLSNET-42639) – Textfelder wurden verlegt

 (CELLSNET-42638) – Legendenmarkierungen haben unterschiedliche Dicken

 (CELLSNET-42637) – Fehlender Achsentitel, wenn Diagramm mit ToImage als EMF gespeichert wird
 ...
 (CELLSNET-43065) – Workbook.CalculateFormula wird mit falschen Werten gefüllt
...
## **Ausnahmen**
 ...
 (CELLSNET-42947) – „Form-zu-Bild-Fehler!“ Ausnahme beim Konvertieren in ein PDF

 (CELLSNET-43076) – Das Ziel-Array ist nicht lang genug, Ausnahme beim Öffnen der XLSB-Datei
