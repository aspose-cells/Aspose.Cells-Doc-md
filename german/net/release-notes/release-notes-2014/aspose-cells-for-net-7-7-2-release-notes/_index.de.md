---
title: Aspose.Cells for .NET 7.7.2 Versionshinweise
type: docs
weight: 100
url: /de/net/aspose-cells-for-net-7-7-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 7.7.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.7.2/)

{{% /alert %}} 

 Aspose.Cells for .NET wurde auf Version 7.7.2 aktualisiert und wir freuen uns, Ihnen mitteilen zu können, dass diese Version über 50 neue nützliche Verbesserungen enthält.
...
## **Fehler**
 ...
 (CELLSNET-42346) – Beim Speichern als HTML werden zu viele br-Tags erstellt
 ...
 (CELLSNET-42285) – Zahlen mit „Allgemein“ als Zahlenformat erscheinen mit Brüchen
 ...
 (CELLSNET-42271) – Bedingte Formatierungsfunktionen wie Symbole, Slicer und Farbverlauf gehen in der XLSB-Ausgabedatei verloren

 (CELLSNET-42261) – Problem beim Speichern als HTML und ausgeblendeten Spalten, wenn sie Zellen als Überschriften verbunden haben
...
(CELLSNET-42163) – Die bedingte Formatierung geht verloren, wenn die Datei geöffnet und erneut gespeichert wird
 ...
 (CELLSNET-40161) – Excel zu HTML – keine Zeilenumbrüche
 ...
 (CELLSNET-42344) – Der Kopfzeilenrand variiert in der Dicke auf verschiedenen Seiten, während XLSX in PDF konvertiert wird

 (CELLSNET-42342) – Umbrüche beim Konvertieren von XLSX in PDF unterstreichen

 (CELLSNET-42304) – Icon Set-Ausrichtung im PDF-Export

 (CELLSNET-42298) – Durch Festlegen von PaperSizeType auf PaperA6 wird die PDF-Datei im Format PaperA4 gerendert
...
(CELLSNET-42289) – CHAR(151) funktioniert in PDF nicht richtig
 ...
 (CELLSNET-42297) – Fehlendes Diagramm im HTML

 (CELLSNET-42296) – Fehlendes Diagramm im PDF

 (CELLSNET-41743) – Problem mit Form in XLSX-zu-Bild-Konvertierung

 (CELLSNET-40467) – Beim Speichern einer XLS-Datei als XLSM und dann zurück in XLS wird das Diagramm in der Datei geändert
 ...
 (CELLSNET-42295) - XLSM zu PDF: Formelfelder werden als #DIV/0 angezeigt!
...
(CELLSNET-42283) - Unterstützung des MS Excel XLT-Formats
