...
type: docs
weight: 60
url: /de/net/aspose-cells-for-net-8-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 8.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.0/)
...
## **Fehler**
 ...
 (CELLSNET-42385) – Die gebogene Verbindungsform wird nicht angezeigt, wenn XLSX in PDF gerendert wird
 ...
 (CELLSNET-42742) - Aspose.Cells Bettet falsche Schriftarten in das PDF ein
...
(CELLSNET-42748) – Legendenlinien sind dünner als in Excel
 ...
 (CELLSNET-42730) – XLSM to PDF neigt dazu, sich aufzuhängen, wenn Änderungen am Cell-Wert und -Format vorgenommen werden
 ...
 (CELLSNET-42716) – XLSM-Bänder gehen nach dem erneuten Speichern der XLSM-Datei verloren

 (CELLSNET-42711) – Row.ApplyStyle funktioniert nicht richtig

 (CELLSNET-42708) – Die grüne Hintergrundfarbe von Zellen verschwindet in HTML
