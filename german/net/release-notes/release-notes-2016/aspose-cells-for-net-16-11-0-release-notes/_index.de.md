...
type: docs
weight: 20
url: /de/net/aspose-cells-for-net-16-11-0-release-notes/
---
...
|CELLSNET-44852 | Die RTL-Richtung wird beim Konvertieren von HTML in Excel in LTR geändert| Insekt|
...
|CELLSNET-44790 | CSS-Stil für Spaltenbreiten, Zeilenhöhen und Zeilenumbruch usw. ignoriert (HTML zu Excel)| Insekt|
...
|CELLSNET-43439 | Erhebliche Erhöhung der Größe der PDF-Ausgabedatei aus einer relativ kleineren Excel-Datei| Insekt|
|CELLSNET-44842 | Beschriftung fehlt, wenn ein Diagramm in ein Bild umgewandelt wird| Insekt|
|CELLSNET-44806 | Die Trendlinie im Diagramm wird im Ausgabe-PDF nicht korrekt wiedergegeben| Insekt|
...
|CELLSNET-44884 | Der Vorgang zum erneuten Speichern beschädigt die Tabelle, wenn der Name des Arbeitsblatts " oder " ist| Insekt|
...
|CELLSNET-44868 | Das Ändern des Hintergrundbilds einer Form beschädigt die XLS-Ausgabedatei| Insekt|
...
|CELLSNET-44792 | Bestimmte Formatierungselemente in der XLSM-Vorlagendatei werden nicht korrekt importiert| Insekt|
...
|CELLSNET-44886 | Als HTML speichern verursacht NullReferenceException| Ausnahme|
|CELLSNET-44875 |Ausnahme beim Speichern von PulseSecure_Preisliste_Flache Datei_Nov2016_ 102816_v1.0.xlsx Excel-Datei in HTML| Ausnahme|
|CELLSNET-44874 |Ausnahme beim Speichern von PulseSecure_Preisliste_EBEN_DATEI_ Oct2016.xlsx Excel-Datei in HTML| Ausnahme|
|CELLSNET-44873 |Ausnahme beim Speichern von PulseSecure_Preisliste_Nov2016_102816_ v1.0.xlsx Excel-Datei in HTML| Ausnahme|
|CELLSNET-44872 |Ausnahme beim Speichern von PulseSecure_Preisliste_Okt2016_093016_ v1.xlsx Excel-Datei in HTML| Ausnahme|
...
|CELLSNET-44725 |JavaScript-Laufzeitfehler: Objekt unterstützt Eigenschaft oder Methode 'fireEvent' nicht| Ausnahme|
