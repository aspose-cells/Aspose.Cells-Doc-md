---
title: Aspose.Cells for .NET 8.8.2 Versionshinweise
type: docs
weight: 90
url: /de/net/aspose-cells-for-net-8-8-2-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44439 | NullReferenceException bei PivotField.IsAscendSort| Ausnahme|
|CELLSNET-44430 | Beim Ausführen komplexer Berechnungen tritt ein Fehler auf| Ausnahme|
### **2) Aspose.Cells Grid-Suite**

|**Taste** |**Zusammenfassung** |**Kategorie** |
|:- |:- |:- |
|CELLSNET-44441 | Wenn in einer neueren Version eine Zeile ausgewählt wird, wird auch die erste Zelle der nächsten Zeile ausgewählt| Insekt|
...
#### **Fügt überschreiben die Methoden Cells.DeleteBlankRows(DeleteOptions options) und Cells.DeleteBlankColumns(DeleteOptions options) hinzu.**
