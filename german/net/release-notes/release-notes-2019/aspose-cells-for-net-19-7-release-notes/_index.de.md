...
type: docs
weight: 60
url: /de/net/aspose-cells-for-net-19-7-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46808|Unterstützt das Lesen von einzelnen Zellen der XLS-Datei.|Neue Funktion|
|CELLSNET-46775|Die Breite der gruppierten Form kann nicht festgelegt werden|Erweiterung|
...
|CELLSNET-46811|Unterstützt HeadingPairs- und TitlesOfParts-Tags der XLS-Datei.|Erweiterung|
...
|CELLSNET-46772|Fehlerhaftes PDF erstellt durch fehlende Grafiken|Insekt|
|CELLSNET-46802|Diagramm wird in XLS anders gerendert als in PDF|Insekt|
|CELLSNET-46806|Kombinationsdiagramm wird falsch in PDF gerendert|Insekt|
...
|CELLSNET-46664|HeadingPairs- und TitlesOfParts-Tags werden nach der Konvertierung von bereinigtem XLS zurück in das XLSM-Dateiformat wiederhergestellt|Insekt|
...
|CELLSNET-46248|Beim Lesen der HTML-Datei wird eine Ausnahme ausgelöst.|Ausnahme|
|CELLSNET-46792|Ausnahme beim Versuch, leere Spalten in einer bestimmten Arbeitsmappe zu löschen|Ausnahme|
|CELLSNET-46799|Beim Konvertieren einer XLSX-Datei in eine PDF-Datei wurde eine Ausnahme ausgelöst|Ausnahme|
|CELLSNET-46803|Ausnahme "Objektverweis nicht auf Objektinstanz gesetzt" beim Laden einer XLSX-Datei|Ausnahme|
...
#### **Aktualisieren Sie den Namespace Aspose.Cells.ODS als Aspose.Cells.Ods und aktualisieren Sie ODS*-Klassen/Enumerationen/Eigenschaften als Ods**
