...
type: docs
weight: 40
url: /de/net/aspose-cells-for-net-19-9-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-46864|Unterstützt das Lesen und Rendern der Kontrolle von ODS-Dateien|Neue Funktion|
...
|CELLSNET-46875|Inhalt läuft während der PDF-Konvertierung von der Seite über|Insekt|
|CELLSNET-46865|Ein Objekt wird nach dem Öffnen und Speichern geändert|Insekt|
|CELLSNET-46866|Das Festlegen von Schriftart und Schriftgröße von Drawing.TextBox funktioniert in ODS nicht|Insekt|
...
|CELLSNET-46876|OLE-Objektverknüpfung aus XLS-Datei nicht zugänglich|Insekt|
...
|CELLSNET-46906|Aspose.Cells hängte sich beim Öffnen einer XLSX-Datei auf|Insekt|
