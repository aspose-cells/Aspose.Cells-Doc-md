...
type: docs
weight: 70
url: /de/net/aspose-cells-for-net-19-6-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45194|Unterstützen Sie das Zeichnen von Slicer beim Rendern in PDF|Neue Funktion|
...
|CELLSNET-46737|Probleme mit mittleren/dicken Linien beim Speichern von XLSX als ODS|Erweiterung|
...
|CELLSNET-46747|Gitterlinien werden beim Rendern in PDF über das eingebettete Objekt gedruckt|Insekt|
...
|CELLSNET-46733|Stil/Format gehen beim Speichern der Pivot-Tabelle als HTML verloren|Insekt|
|CELLSNET-46736|Schriftartproblem bei der Konvertierung von HTML in PDF|Insekt|
|CELLSNET-46751|XLSX kann nicht in HTML konvertiert werden|Insekt|
...
|CELLSNET-46735|Die Seitenzahl beginnt nicht auf jedem Blatt in der Ausgabe-PDF wieder bei 1|Insekt|
|CELLSNET-46739|Der TIFF-Komprimierungstyp ignoriert die Hintergrundschattierung für Diagramme und Formen|Insekt|
|CELLSNET-46749|SheetRender.ToImage erstellt ein falsches EMF-Bild|Insekt|
...
|CELLSNET-46752|Die XLSX-Ausgabedatei wird nach dem Aufruf von InsertCutCells() beschädigt|Insekt|
...
|CELLSNET-46510|Shape-to-Image-Fehler! beim Konvertieren von XLSX in PDF|Ausnahme|
|CELLSNET-46765|Ausnahme "System.StackOverflowException" beim Rendern einer Excel-Datei in das PDF-Dateiformat|Ausnahme|
