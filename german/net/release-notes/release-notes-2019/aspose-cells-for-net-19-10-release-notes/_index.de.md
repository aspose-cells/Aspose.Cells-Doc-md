...
type: docs
weight: 30
url: /de/net/aspose-cells-for-net-19-10-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-46926|PageSavingCallback beim Speichern in TIFF|Neue Funktion|
...
|CELLSNET-46934|Verzögerung und Speicherverbrauch beim Konvertieren in das PDF-Dateiformat|Insekt|
|CELLSNET-43416|Die Sortierung des Pivot-Felds wird nach dem Rendern der Tabelle in PDF geändert|Insekt|
...
|CELLSNET-46882|Problem beim Gruppieren von Pivot-Tabellen nach Datum und Speichern als PDF|Insekt|
|CELLSNET-46935|Text umbrechen, der nicht in HTML gerendert wurde|Insekt|
|CELLSNET-46940|Tabellenrahmen werden in HTML nicht korrekt wiedergegeben|Insekt|
...
|CELLSNET-46919|Beschädigte Datei beim Wechsel zum XLSB-Dateiformat von XLSX|Insekt|
...
|CELLSNET-46941|Als HTML speichern löst eine Ausnahme aus, wenn die Zelle einen Dateiverweis hat|Ausnahme|
