...
type: docs
weight: 120
url: /de/net/aspose-cells-for-net-17-1-0-release-notes/
---
...
|CELLSNET-44597|Die Ausgabe einer Excel-Datei ist nicht gut, wenn eine HTML-Datei in das Excel-Dateiformat konvertiert wird|Erweiterung|
|CELLSNET-44994|Problem mit Datumsformat im deutschen Gebietsschema beim Rendern einer Excel-Datei in PDF|Erweiterung|
...
|CELLSNET-45000|Einige CSS-Regeln werden beim Importieren von HTML ignoriert|Insekt|
...
|CELLSNET-44962|Horizontale und vertikale Linien fehlen in der Pivot-Tabelle nach der Konvertierung der Tabelle in PDF|Insekt|
...
|CELLSNET-43815|WordArt-Objekte werden im Ausgabe-PDF zu bloßen Punkten|Insekt|
|CELLSNET-44976|Das Flächendiagramm ist in der PDF-Ausgabe im Gegensatz zu einer MS-Excel-Datei am Ende abgeschrägt|Insekt|
...
|CELLSNET-44938|Diagramm wird nicht korrekt gerendert, wenn Tabellenkalkulation in PDF konvertiert wird|Insekt|
|CELLSNET-44919|Das von Aspose.Cells generierte Bild wird beim Einfügen in Docx verzerrt|Insekt|
...
|CELLSNET-43733|WordArt-Text in TextBox wird beim Konvertieren von Tabellenkalkulationen in PDF nur als Umriss und nicht als gefüllte Zeichen gerendert|Insekt|
|CELLSNET-43725|Das Ändern der Größe des Listenobjekts in XLSM mit externem Datenbereich macht das Ergebnis beschädigt|Insekt|
...
|CELLSNET-43405|Der Text der Funktion wird beschädigt und WordArt-Text wird weiß, nachdem ein XLS- in ein XLSX-Dateiformat konvertiert wurde|Insekt|
|CELLSNET-43404|Die Formatierung von WordArt-Text in XLS-Dateien wird nach der Konvertierung in das XLSX-Dateiformat geändert|Insekt|
|CELLSNET-41938|Formatierungsprobleme (in Bezug auf WordArt) mit XLS-Datei|Insekt|
|CELLSNET-41708|Problem beim Hinzufügen von 3D-Effekten zu Shapes (TextBox), die mit Aspose.Cells erstellt wurden|Insekt|
|CELLSNET-41164|SmartArt-Unterstützung beim Rendern von Excel in PDF|Insekt|
...
|CELLSNET-45016|Ausnahme beim Öffnen einer XLSX-Vorlagendatei|Ausnahme|
