...
type: docs
weight: 100
url: /de/net/aspose-cells-for-net-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.3.0/).
...
1. [Passen Sie die Globalisierungseinstellungen für die Pivot-Tabelle an](/cells/de/net/customize-globalization-settings-for-pivot-table/)
1. [Ausführen der clientseitigen Funktion beim Wechsel der GridWeb-Seite](/cells/de/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/de/net/execute-client-side-function-on-gridweb-page-change/)
1. [Validieren Sie das gesamte Arbeitsblatt statt nur der aktualisierten Zellen](/cells/de/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
