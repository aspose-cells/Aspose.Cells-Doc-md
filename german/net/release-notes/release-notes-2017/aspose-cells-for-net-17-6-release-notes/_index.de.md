...
type: docs
weight: 70
url: /de/net/aspose-cells-for-net-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.6](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.6/).
...
|CELLSNET-45335|Das Bild des generierten Diagramms ist falsch|Insekt|
...
- [Kachelbild als Textur innerhalb der Form](/cells/de/net/tile-picture-as-a-texture-inside-the-shape/)
- [Verwenden der OnAjaxCallFinishedClient-Funktion von GridWeb](/cells/de/net/using-onajaxcallfinishedclientfunction-of-gridweb/)
...
- [GridWeb zum Webformular hinzufügen](/cells/de/net/add-gridweb-to-web-form/)
- [Zeilen gruppieren und Zwischensumme erstellen](/cells/de/net/group-rows-and-create-subtotal/)
