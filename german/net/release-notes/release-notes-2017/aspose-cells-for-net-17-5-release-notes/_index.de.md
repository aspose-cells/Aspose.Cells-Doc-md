...
type: docs
weight: 80
url: /de/net/aspose-cells-for-net-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.5](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.5/).
...
|CELLSNET-45217|Beim Speichern von Excel als PDF wird das Bild gedreht|Insekt|
|CELLSNET-45306|Falsche Stile beim Speichern in HTML mit CSS-Präfix|Insekt|
|CELLSNET-45304|Die Textausrichtung des vertikal gedrehten Textes ist im Ausgabe-HTML falsch|Insekt|
...
|CELLSNET-45324|Die Position der Zeichen ist beim Rendern einer Excel-Datei in PDF nicht zentriert|Insekt|
...
|CELLSNET-45303|Formen (Rechtecke, Linien usw.) werden beim erneuten Speichern vom XLSX- in das XLS-Dateiformat nicht mehr verbunden|Insekt|
|CELLSNET-45301|Das Öffnen und Speichern der Excel-Datei macht die Ausrichtung falsch|Insekt|
|CELLSNET-45297|Das Öffnen und Speichern der XLSM-Datei mit einer neueren Version beschädigt sie|Insekt|
...
- [Seiteneinrichtungseinstellungen aus dem Quellarbeitsblatt in das Zielarbeitsblatt kopieren](/cells/de/net/copy-page-setup-settings-from-source-worksheet-into-destination-worksheet/)
- [Implementieren Sie die benutzerdefinierte Papiergröße des Arbeitsblatts zum Rendern](/cells/de/net/implement-custom-paper-size-of-worksheet-for-rendering/)
- [Entfernen Sie vorhandene Druckereinstellungen von Arbeitsblättern in einer Excel-Datei](/cells/de/net/remove-existing-printersettings-of-worksheets-in-excel-file/)
...
- [Exportieren Sie den HTML-String-Wert von Cells in die DataTable](/cells/de/net/export-html-string-value-of-the-cells-to-the-datatable/)
