...
type: docs
weight: 90
url: /de/net/aspose-cells-for-net-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.4.0/).
...
- [Setzen Sie den Tipp für die Spaltenüberschrift](/cells/de/net/set-column-header-tip/)
