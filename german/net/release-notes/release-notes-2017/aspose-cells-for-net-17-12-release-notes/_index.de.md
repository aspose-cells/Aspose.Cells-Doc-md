...
type: docs
weight: 10
url: /de/net/aspose-cells-for-net-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-45358|Erhalten Sie CSS separat vom HTML-Markup, wenn Sie mithilfe von Streams in HTML exportieren|Neue Funktion|
|CELLSNET-45697|Implementieren Sie Cell.FormulaLocal ähnlich wie Microsoft Interop FormulaLocal|Neue Funktion|
|CELLSNET-45801|Unterstützung für Office-Add-Ins in Excel zur PDF-Wiedergabe|Neue Funktion|
...
|CELLSNET-45764|Der Status von DataBars in der Ausgabe-PDF ist falsch|Insekt|
...
|CELLSNET-45799|Der absolute Pfad wird beim erneuten Speichern einer XLSX-Datei in einen relativen Pfad geändert|Insekt|
...
|CELLSNET-45777|Beim Konvertieren einer Excel-Datei in eine PDF-Datei tritt ein Form-zu-Bild-Fehler auf|Ausnahme|
...
- [Arbeitsblatt-CSS separat in Ausgabe-HTML exportieren](/cells/de/net/export-worksheet-css-separately-in-output/)
- [Implementieren Sie Cell.FormulaLocal ähnlich wie Excel VBA Range.FormulaLocal](/cells/de/net/implement-cell-formulalocal-similar-to-excel-vba-range-formulalocal/)
- [Stellen Sie den Stilen von Tabellenelementen die HtmlSaveOptions.TableCssId-Eigenschaft voran](/cells/de/net/prefix-table-elements-styles-with-htmlsaveoptions-tablecssid-property/)
...
- [Legen Sie den Formtyp der Datenbeschriftungen des Diagramms fest](/cells/de/net/set-the-shape-type-of-data-labels-of-chart/)
- [Text läuft aus GridDesktop-Zelle über, wenn er zu lang ist](/cells/de/net/text-overflows-from-griddesktop-cell-if-it-is-too-long/)
- [Aktualisieren Sie die Tage, an denen der Verlauf der Revisionsprotokolle in der freigegebenen Arbeitsmappe beibehalten wird](/cells/de/net/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
