---
title: Aspose.Cells for .NET 17.02.0 Versionshinweise
type: docs
weight: 110
url: /de/net/aspose-cells-for-net-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.02.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.02.0/).
...
|CELLSNET-45067|Konvertierung in PDF dauert zu lange|Leistung|
|CELLSNET-45105|Das Laden von HTML schlägt fehl, wenn CultureInfo Französisch ist|Insekt|
|CELLSNET-45089|HTML zu Excel: Excel-Datei ist beschädigt|Insekt|
|CELLSNET-45072|WordArt aus dem XLS wird nicht in HTML gerendert|Insekt|
|CELLSNET-45053|Bestimmte HTML-Tags werden nicht berücksichtigt und einige Inhalte fehlen|Insekt|
|CELLSNET-45039|Die gemischte Stilregel wird beim Rendern des HTML-Codes in Excel nicht berücksichtigt|Insekt|
...
|CELLSNET-45085|Berechneter Wert der Funktion LOGNORM.DIST ist im PDF nicht korrekt|Insekt|
|CELLSNET-44740|Benutzerdefiniertes DateTime-Muster kann nicht auf GridColumn angewendet werden|Insekt|
|CELLSNET-45130|Unterschiedliches Ergebnis mit Excel Export PDF und Aspose.Cells als PDF speichern|Insekt|
|CELLSNET-45095|Bild aus der Tabelle wurde nicht in PDF gerendert|Insekt|
|CELLSNET-45075|Hyperlinks aus der Tabelle werden nicht in PDF exportiert|Insekt|
|CELLSNET-45074|Formatierungsproblem beim Rendern von Excel in PDF|Insekt|
|CELLSNET-45070|3D-Kreisdiagramm wird nicht gerendert, während die Tabelle unter Mono in PDF konvertiert wird|Insekt|
|CELLSNET-41283|PDF anders beim Speichern aus Excel und Aspose.Cells|Insekt|
...
|CELLSNET-45066|Formen werden beim Konvertieren von Tabellenkalkulationen in PDF horizontal komprimiert|Insekt|
|CELLSNET-45064|Achsenbeschriftungen werden beim Konvertieren von Tabellenkalkulationen in PDF nicht gerendert|Insekt|
...
|CELLSNET-45094|Die Textposition wird nach dem Laden und Speichern von XLS geändert|Insekt|
...
|CELLSNET-45088|Ausnahme beim Rendern einer Tabelle in das PDF-Dateiformat|Ausnahme|
|CELLSNET-45080|Ausnahme beim Laden eines HTML-Dateiformats|Ausnahme|
### **Öffentliche API und rückwärts inkompatible Änderungen**
Im Folgenden finden Sie eine Liste aller Änderungen, die an der öffentlichen API vorgenommen wurden, z. B. hinzugefügte, umbenannte, entfernte oder veraltete Mitglieder, sowie alle nicht abwärtskompatiblen Änderungen, die an Aspose.Cells for .NET vorgenommen wurden. Wenn Sie Bedenken zu einer der aufgeführten Änderungen haben, äußern Sie diese bitte das Aspose.Cells Support-Forum.
#### **HTMLLoadOptions.AutoFitColsAndRows-Eigenschaft hinzugefügt**
Diese Version von Aspose.Cells for .NET API hat die Eigenschaft HTMLLoadOptions.AutoFitColsAndRows hinzugefügt, die angibt, ob API Spalten und Zeilen automatisch anpassen soll, während HTML im Objektmodus importiert wird. Die Eigenschaft Boolean type hat den Standardwert false, was bedeutet, dass die Zellenhöhen und -breiten so importiert werden, wie sie sind. Wenn die oben genannte Eigenschaft jedoch auf true gesetzt ist, versucht der API, die Spaltenbreiten und Zeilenhöhen entsprechend dem Inhalt anzupassen .
...
1. [Spalten und Zeilen automatisch anpassen, während HTML in die Arbeitsmappe geladen wird](/cells/de/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Konvertieren Sie Text in Spalten mit Aspose.Cells](/cells/de/net/convert-text-to-columns-using-aspose-cells/)
1. [Rufen Sie eine Liste der Schriftarten ab, die in einer Tabelle oder Arbeitsmappe verwendet werden](/cells/de/net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Erhalten Sie Warnungen beim Laden einer Excel-Datei](/cells/de/net/get-warnings-while-loading-excel-file/)
1. [Lesen und bearbeiten Sie Excel 2016-Diagramme](/cells/de/net/read-and-manipulate-excel-2016-charts/)
1. [Trimmen Sie führende leere Zeilen und Spalten beim Exportieren von Tabellenkalkulationen in das CSV-Format](/cells/de/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
1. [Binden des Arbeitsblatts an ein benutzerdefiniertes Sammlungsobjekt mithilfe von GridWeb](/cells/de/net/binding-worksheet-to-a-customized-collection-object-using-gridweb/)
1. [Benennen Sie doppelte Spalten beim Exportieren von Arbeitsblattdaten automatisch um](/cells/de/net/rename-duplicate-columns-automatically-while-exporting-worksheet-data/)
1. [Geteilte Fenster im GridDesktop-Arbeitsblatt](/cells/de/net/split-panes-in-griddesktop-worksheet/)
