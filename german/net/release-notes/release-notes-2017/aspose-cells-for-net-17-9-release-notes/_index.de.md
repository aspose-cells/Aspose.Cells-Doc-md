...
type: docs
weight: 40
url: /de/net/aspose-cells-for-net-17-9-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.9](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.9/).
...
#### **Fügt die OoxmlSaveOptions.EnableZip64-Eigenschaft hinzu**
...
- [Bestimmen Sie, welche Stapelgröße für eine bestimmte Arbeitsmappe benötigt wird](/cells/de/net/aspose-cells-faqs/#aspose-cellsfaqs-determinewhichstacksizeisneededforacertainworkbook)
