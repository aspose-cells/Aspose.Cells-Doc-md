...
type: docs
weight: 30
url: /de/net/aspose-cells-for-net-17-10-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.10](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.10/).
...
|CELLSNET-45664|Lesen und Schreiben Externe Verbindung der XLSB-Datei|Neue Funktion|
...
|CELLSNET-45651|Die TextBox-Größe ändert sich, wenn chinesische Schriftarten in der Arbeitsmappe beim Rendern in PDF verwendet werden|Insekt|
...
|CELLSNET-45690|Stile scheinen für einige Zellen falsch übertragen zu werden - Konvertierung von SpreadsheetML in XLSX|Insekt|
|CELLSNET-45688|Die Datumsspalte ist nicht richtig sortiert|Insekt|
|CELLSNET-45687|Schutzeigenschaften für Arbeitsblätter werden nicht von SpreadsheetML übertragen|Insekt|
|CELLSNET-45683|Das SpreadsheetML AllowSort-Element funktioniert nicht in der XLSX-Ausgabe|Insekt|
...
|CELLSNET-45703|Ausnahme beim Konvertieren einer XLSM-Datei zurück in das XLS-Dateiformat|Ausnahme|
...
- [Externe Verbindung der XLSB-Datei lesen und schreiben](/cells/de/net/read-and-write-external-connection-of-xls-and-xlsb-files/)
...
- [Geben Sie mithilfe von HtmlCrossType an, wie Zeichenfolgen in Ausgabe-HTML gekreuzt werden](/cells/de/net/specify-how-to-cross-string-in-output-html-using-htmlcrosstype/)
