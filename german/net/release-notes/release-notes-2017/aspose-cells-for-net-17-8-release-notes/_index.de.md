...
type: docs
weight: 50
url: /de/net/aspose-cells-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 17.8](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.8/).
...
|CELLSNET-45560 |Die Fehlermeldung wird in Microsoft Excel angezeigt, nachdem die Methode RemoveMacro() aufgerufen wurde|Insekt|
...
- [Hinzufügen einer digitalen Signatur zu einer bereits signierten Excel-Datei](/cells/de/net/add-digital-signature-to-an-already-signed-excel-file/)
- [Deaktivieren Sie aufgedeckte Kommentare auf niedrigerem Niveau, während Sie unter HTML speichern](/cells/de/net/disable-downlevel-revealed-comments-while-saving-to/)
- [Exportieren Sie Kommentare, während Sie eine Excel-Datei in HTML speichern](/cells/de/net/export-comments-while-saving-excel-file-to/)
- [Leere Seite ausgeben, wenn nichts zu drucken ist](/cells/de/net/output-blank-page-when-there-is-nothing-to-print/)
- [Verwenden von CustomImplementationFactory zum Erstellen einer benutzerdefinierten Implementierung von Memory Stream](/cells/de/net/using-customimplementationfactory-to-create-custom-implementation-of-memory-stream/)
- [GridCell-Kommentare erstellen und abrufen](/cells/de/net/create-remove-and-get-gridcell-comments/)
- [Standardschriftart und Schriftfarbe des GridDesktop](/cells/de/net/default-font-and-font-color-of-the-griddesktop/)
