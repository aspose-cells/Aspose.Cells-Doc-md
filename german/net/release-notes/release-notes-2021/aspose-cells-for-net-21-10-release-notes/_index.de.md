...
type: docs
weight: 3
url: /de/net/aspose-cells-for-net-21-10-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-49132|Öffnen Sie Dateien mit darin enthaltener HTML-Tabelle als XLS-Dateien|Neue Funktion|
...
|CELLSNET-49413|Entfernen Sie unsichtbare Formen beim Rendern von HTML|Erweiterung|
...
|CELLSNET-49195|Die XLSX-zu-HTML-Konvertierung behält keine Folge von unsichtbaren Zeichen bei|Insekt|
|CELLSNET-49245|Bildverschiebungen in bestimmten XLS-Dateien, wenn sie in HTML gerendert werden|Insekt|
...
|CELLSNETCORE-226|Unnötige Leerzeichen, die während der Konvertierung von Excel in EMF gerendert werden|Insekt|
...
|CELLSNET-48613|Eine Ressource, die außerhalb des ausgewählten Bereichs liegt, sollte nicht in HTML exportiert werden|Insekt|
...
|CELLSNET-49366|Problem mit Cell Datenvalidierungs-Eingabefeldern im XLSB-Format|Insekt|
|CELLSNETCORE-269|Falsche Zeile mit großer Höhe wird zur HTML-Tabelle hinzugefügt|Insekt|
...
|CELLSNET-49373|"Die Eingabezeichenfolge hatte kein korrektes Format." Ausnahme beim Öffnen der XLSX-Datei|Ausnahme|
