...
type: docs
weight: 2
url: /de/net/aspose-cells-for-net-21-11-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-48646|StackOverflow-Ausnahme während der Konvertierung von Excel in PDF|Leistung|
|CELLSNET-49378|Problem mit der Konvertierungsleistung von Excel in HTML und leeren Zellen|Leistung|
...
|CELLSNET-49068|Falsche PDF-Datei aus Excel-Datei generiert|Insekt|
...
|CELLSNET-49498|HTML-Stream zu Excel löst bei den neuesten Versionen eine Ausnahme aus|Insekt|
|CELLSNET-49610|XML-Import verliert Vorlagenformatierung|Insekt|
|CELLSNET-49671|Text mit Windings-Schriftarten wird nicht richtig in Bilder/HTML gerendert|Insekt|
|CELLSNETCORE-278|XLSX-zu-PDF-Konvertierungsergebnisse können nicht geöffnet werden, wenn die Kultur auf Norwegisch eingestellt ist|Insekt|
...
|CELLSNET-49654|Makros funktionieren nach der Konvertierung von XLS in XLSM nicht|Insekt|
|CELLSNET-49727|Bilder von Mht-Dateien sind im IE nicht sichtbar.|Insekt|
|CELLSNET-49609|„Form-zu-Bild-Fehler“ beim Konvertieren von Excel-Dateien in PDF|Ausnahme|
|CELLSNET-49608|Aspose.Cells gibt Fehler beim Versuch, bestimmte Bereichsnamen hinzuzufügen|Ausnahme|
|CELLSNET-49697|XLSX zu PDF: Die Eingabezeichenfolge hatte nicht das richtige Format.|Ausnahme|
