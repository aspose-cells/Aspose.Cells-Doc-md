...
type: docs
weight: 9
url: /de/net/aspose-cells-for-net-21-4-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47922|Rendern Sie Daten mit Zellkoordinaten in der Excel-zu-HTML-Konvertierung|Erweiterung|
...
|CELLSNET-47916|Das Tag im HTML-Stil verbraucht 4 GB Speicher und stürzt beim Laden in die Arbeitsmappe ab|Leistung|
...
|CELLSNET-47965| Konvertierung von Excel in PDF - Dokumentseiten durcheinander|Insekt|
|CELLSNET-46161|Schräger Text wird in der Ausgabe-PDF nicht richtig angezeigt|Insekt|
|CELLSNET-47917|Tortendiagramm-Etiketten in PDF-Dateien, die aus Excel-Arbeitsblättern generiert wurden, durcheinander gebracht|Insekt|
...
|CELLSNET-47963|Der Parameter ist keine gültige Ausnahme beim Rendern des Bereichs in PNG|Ausnahme|
...
Bieten Sie Benutzern die Möglichkeit zu entscheiden, wie mit dem führenden einfachen Anführungszeichen des Zellenwerts beim Exportieren/Importieren von CSV/TSV-Dateien verfahren werden soll.
