---
title: Aspose.Cells for .NET 21.8 Versionshinweise
type: docs
weight: 5
url: /de/net/aspose-cells-for-net-21-8-release-notes/
---
{{% alert color="primary" %}}

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 21.8](https://www.nuget.org/packages/Aspose.Cells/21.8.0).
...
|CELLSNET-48205|Fügen Sie eine MS Excel-Funktion zum automatischen Ausfüllen (Muster) für Zahlen, Text oder Datumsangaben usw. hinzu.|Neue Funktion|
|CELLSNET-48435|Mehr Leerzeichen in Ausgabe-HTML zusammenführen.|Erweiterung|
...
|CELLSNET-48374|Die Größe des in ein Excel-Dokument eingefügten Bildes wird geändert, wenn die Standardschriftart geändert wird|Insekt|
|CELLSNET-48384|Setzen von Array auf Range.Value : Es geht außerhalb oder außerhalb der Grenzen des Bereichsbereichs|Insekt|
|CELLSNET-48410|Automatische Ausrichtung an der Mitte, wenn eine Liste von Zeichenfolgen mit intelligenten Markierungen übergeben wird|Insekt|
|CELLSNET-48460|PowerQueries gehen nach dem Austausch verloren|Insekt|
|CELLSNET-48478|Inhalte der XML-Datei werden nicht geladen|Insekt|
|CELLSNET-48492|Problem mit 100 % Stacked Bar und der Haupt- und Nebeneinheit|Insekt|
|CELLSNET-48504|Ungültiger Spaltenindex beim Konvertieren von XLSX|Insekt|
|CELLSNET-48512|Das Löschen des AutoFilters funktioniert nicht richtig|Insekt|
