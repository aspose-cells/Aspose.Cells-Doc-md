...
type: docs
weight: 60
url: /de/net/aspose-cells-for-net-5-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for .NET 5.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.0/)
...
- Enthält Smart-Tags-Unterstützung für XLSX-Dateien.
 ...
 Unterstützt die Verlaufsfüllungen von Cell und das Thema der XLS-Datei.
...
|16207 | Pdf| Fehler beim Speichern der PDF-Datei finden|
...
|17981 | Pdf| Problem bei der Konvertierung von Excel in PDF|
|18021 | Pdf| Als PDF speichern - Probleme mit Schriftarten|
|18038 | Pdf| Das PDF-Dokument scheint beschädigt zu sein|
|18136 | Pdf| Problem beim Speichern von PDF|
...
|18036 | XLSX| Das Problem beim Öffnen der XLSM-Datei.|
|18161 | XLSX| Ungültige Endspaltenindex-Ausnahme bei XLSX-Datei|
