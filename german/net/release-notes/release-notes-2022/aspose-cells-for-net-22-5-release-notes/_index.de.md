...
type: docs
weight: 8
url: /de/net/aspose-cells-for-net-22-5-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-50685|Problem beim Abrufen von verknüpften OLE-Anhängen in der ODS-Datei|
|CELLSNET-50920|Problem bei der Konvertierung von Excel in Tiff|
|CELLSNET-50820| Problem beim Exportieren von JSON-Strings nach Excel|
|CELLSNET-50853|Der Slicers-Filter verschwindet nach dem erneuten Speichern durch Aspose.Cells-APIs|
|CELLSNET-50960|Arbeitsmappe beschädigt beim erneuten Speichern einer XLSM-Datei (mit einer Pivot-Tabelle) von Aspose.Cells|
...
|CELLSNET-50992|Der Datumszeitwert wurde für benutzerdefinierte Dokumenteigenschaften nach dem Speichern in ODS geändert|
|CELLSNET-50953|Deaktivieren Sie das Kopieren/Einfügen der Tastatur in GridDesktop|
|CELLSNET-50771| Die Schriftart wird während der Konvertierung von Excel in PDF fett dargestellt|
...
|CELLSNET-50952|Die XLS-zu-XLSX-Konvertierung ändert den zweifarbigen Verlauf bedingter Formate|
