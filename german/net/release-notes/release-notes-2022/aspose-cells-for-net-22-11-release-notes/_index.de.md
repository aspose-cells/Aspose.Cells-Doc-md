...
type: docs
weight: 2
url: /de/net/aspose-cells-for-net-22-11-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-52156|Deaktivieren Sie zusammengeführte Tabellenzellen beim Speichern von XLSX in HTML|
|CELLSNET-52159|Unterstützung zum Analysieren von reduzierten Eigenschaften beim Konvertieren von HTML in Excel|
|CELLSNET-51939|XLSX zu PDF: Inhaltsfehlausrichtung|
|CELLSNET-51940|XLS zu PDF: Inhaltsfehlausrichtung in Zellen|
|CELLSNET-52068|XLSX zu PDF: Formen fehlen/Layout wird zusammengebrochen|
|CELLSNET-52092|Zeichendruck und Abstände in den Abbildungen von Excel werden abgeschnitten|
|CELLSNET-52186|Formen/Boxen sind leer, wenn XLSX-Dokumente in PDF konvertiert werden|
|CELLSNET-52225|XLSX zu PDF Zeichen in Textfeldern umgekehrt|
...
|CELLSNET-52144|XLS-zu-XLSM-Konvertierung, die den Link-Beziehungstyp ändert|
...
|CELLSNET-52181|XLSX zu HTML: Bereich Cells wird nicht korrekt exportiert|
...
|CELLSNET-52241|Kästen (Formen) im Dokument erscheinen nicht in der Ausgabe-PDF|
