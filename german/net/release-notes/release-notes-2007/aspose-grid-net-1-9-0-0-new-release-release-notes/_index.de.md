...
type: docs
weight: 140
url: /de/net/aspose-grid-net-1-9-0-0-new-release-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Grid .Net 1.9.0.0 Neue Version](https://downloads.aspose.com/cells/net/new-releases/aspose.grid-.net-1.9.0.0-new-release/)
