...
type: docs
weight: 7
url: /de/net/aspose-cells-for-net-20-10-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47614|Einige Symbole fehlen in der Ausgabe-PDF bei der Excel-zu-PDF-Wiedergabe|Insekt|
|CELLSNET-47636|Excel-zu-PDF-Konvertierung - Das Ergebnis wird im Querformat über die Seite übertragen|Insekt|
...
|CELLSNET-47613|LTR und RTL bleiben nach dem Laden und Speichern mit XLSB-Datei nicht erhalten|Insekt|
...
|CELLSNET-47647|Von Excel beim Konvertieren von XLSB->XLSX->XLSB ausgegebene Meldung reparieren|Insekt|
...
|CELLSNETCORE-81|Die Option „Text umbrechen“ wird in der XLSB-Datei nach dem Laden und Speichern nicht beibehalten|Insekt|
|CELLSNETCORE-82|Spezifisches Blatt in der XLSB-Datei bricht nach dem Laden und Speichern ab|Insekt|
...
|CELLSNET-47571|Die HTML-Konvertierung von XLS geht in eine kontinuierliche Konvertierungsschleife|Insekt|
...
|CELLSNET-47620|Shape to image Fehler beim Speichern als PDF|Ausnahme|
...
|CELLSNET-47649|Beim Lesen von DBConnection.PowerQueryFormula aus der XLSX-Datei wird eine Ausnahme ausgelöst|Ausnahme|
|CELLSNET-47655|CellsException während der Konvertierung von Excel in PDF|Ausnahme|
|CELLSNETCORE-80|Die Objektausnahme kann beim Konvertieren von XLSB in XLSM nicht umgewandelt werden|Ausnahme|
...
### **Fügt die ExternalConnection.PowerQueryFormula-Eigenschaft hinzu.**
