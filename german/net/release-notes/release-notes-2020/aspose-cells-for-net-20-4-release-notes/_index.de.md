...
type: docs
weight: 40
url: /de/net/aspose-cells-for-net-20-4-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-47276|XLSX zu CSV, Kommas für leere Zellen erforderlich, auch ähnlich wie bei MS Excel|Neue Funktion|
...
|CELLSNET-47046|Ungeöffnete Anführungszeichen in IMG-HTML-Attributen in generiertem HTML-Markup|Insekt|
...
|CELLSNET-47279|Der erste Spaltentext in allen Zeilen wird beim Exportieren der Datei in HTML nicht tiefgestellt|Insekt|
...
|CELLSNET-47269|XLSX-zu-CSV-Konvertierung - fehlendes Komma in der Ausgabe|Insekt|
...
|CELLSNET-47258|Problem mit Barcode-Bildern beim Rendern von Blatt zu TIFF|Insekt|
|CELLSNET-47216|PowerQueries sind nach dem Austausch der Quelle verschwunden|Insekt|
|CELLSNET-47241|Die ODS-Datei bricht beim Festlegen des Schriftstils und beim Speichern|Insekt|
...
|CELLSNET-47282|Aspose.Cells 20.3: XLSB-zu-XLS-Konvertierungsproblem|Insekt|
...
|CELLSNET-47246|Ausnahme "Zugriff auf einen geschlossenen Stream nicht möglich" beim Speichern einer Excel-Datei als PDF|Ausnahme|
