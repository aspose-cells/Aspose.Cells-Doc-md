---
title: Aspose.Cells für Reporting Services v1.4.0 Versionshinweise
type: docs
weight: 40
url: /de/reportingservices/aspose-cells-for-reporting-services-v1-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells für Reporting Services v1.4.0](https://downloads.aspose.com/cells/reportingservices/new-releases/aspose.cells-for-reporting-services-v1.4.0/)

{{% /alert %}} 

 Wir freuen uns, Aspose.Cells für Reporting Services 1.4.0 bekannt zu geben!

 Was hat sich geändert?

 l Unterstützt Microsoft SQL Server 2008 Reporting Services.
 ...
 Korrekturen und Verbesserungen in Aspose.Cells für Reporting Services 1.4.0
