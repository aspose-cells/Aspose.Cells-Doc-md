---
title: Aspose.Cells Reporting Services 23.3 Versionshinweise
second_title: Aspose.Cells Reporting Services Document
type: docs
url: /de/reportingservices/aspose-cells-for-reporting-services-23-3-release-notes/
...
---
{{% alert color="primary" %}} 
Diese Seite enthält Versionshinweise für Aspose.Cells Reporting Services 23.3
'{{% /alert %}} '
##  **Vollständige Liste der in dieser Version behandelten Probleme und Verbesserungen**

|**ID**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
| 39191 | Optimieren Sie den Aspose.Cells Reporting Services Core.|
