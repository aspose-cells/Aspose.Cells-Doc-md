---
title: Datenvalidierung mit C++
linktitle: Datenvalidierung
type: docs
weight: 90
url: /de/cpp/data-validation/
...
In Aspose.Cells hat jede [**Worksheet**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/)-Klasse eine [**GetValidations()**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/getvalidations/)-Eigenschaft, die eine Sammlung von [**Validation**](https://reference.aspose.com/cells/cpp/aspose.cells/validation/)-Objekten darstellt. Um die Validierung einzurichten, setzen Sie einige der Eigenschaften der [**Validation**](https://reference.aspose.com/cells/cpp/aspose.cells/validation/)-Klasse wie folgt:

- Typ – stellt den Validierungstyp dar, der durch Verwendung einer der vordefinierten Werte in der [**ValidationType**](https://reference.aspose.com/cells/cpp/aspose.cells/validationtype/)-Aufzählung angegeben werden kann.
- Operator – stellt den Operator dar, der bei der Validierung verwendet werden soll und durch Verwendung eines der vordefinierten Werte in der [**OperatorType**](https://reference.aspose.com/cells/cpp/aspose.cells/operatortype/)-Aufzählung angegeben werden kann.
...
Wenn die Eigenschaften des [**Validation**](https://reference.aspose.com/cells/cpp/aspose.cells/validation/)-Objekts konfiguriert wurden, können Entwickler die [**CellArea**](https://reference.aspose.com/cells/cpp/aspose.cells/cellarea/)-Struktur verwenden, um Informationen über den Zellenbereich zu speichern, der mithilfe der erstellten Validierung überprüft wird.

#### **Arten der Datenvalidierung**

Die [**ValidationType**](https://reference.aspose.com/cells/cpp/aspose.cells/validationtype/)-Aufzählung hat die folgenden Elemente:
...
Es ist wichtig, dass Sie die [**Validation.GetInCellDropDown()**](https://reference.aspose.com/cells/cpp/aspose.cells/validation/getincelldropdown/)-Eigenschaft auf **true** setzen.
