---
title: Seiteneinstellungen mit C++
linktitle: Seite einrichten
type: docs
weight: 10
url: /de/cpp/setting-page-options/
description: Dieser Artikel bietet Beispielcode zum programmatischen Einstellen der Seiteneinstellungen von Excel Arbeitsblättern mit der C++ API. Sie können Ausrichtung der Seite, Skalierungsfaktor, Optionen für das Anpassen an Seiten, Papiergröße, Druckqualität und Seitennummerierung festlegen.
keywords: Stellen Sie die Ausrichtung der Excel Seite auf Hochformat oder Querformat mit der Eigenschaft {0} fest, die im Zusammenhang mit {1} verwendet wird. Die Eigenschaft {2} akzeptiert einen der vordefinierten Werte im {3} Enumeration, unten aufgeführt.
---
...
Die Klasse [**Worksheet**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/) stellt die Eigenschaft [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) bereit, mit der die Seitenlayoutsoptionen des Arbeitsblatts eingestellt werden. Tatsächlich ist diese Eigenschaft [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) ein Objekt der Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/), das es ermöglicht, verschiedene Seitenlayout-Optionen für ein gedrucktes Arbeitsblatt festzulegen. Die Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) bietet verschiedene Eigenschaften, um die Seiteneinrichtung zu steuern. Einige dieser Eigenschaften werden unten erläutert.

### **Seitenausrichtung**

Die Seitenorientierung kann mit der Eigenschaft [**GetOrientation()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getorientation/) der Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) auf Hochformat oder Querformat eingestellt werden. Die Eigenschaft [**GetOrientation()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getorientation/) akzeptiert einen der vordefinierten Werte im [**PageOrientationType**](https://reference.aspose.com/cells/cpp/aspose.cells/pageorientationtype/) Enumeration, die unten aufgeführt sind.
...
Es ist möglich, die Größe eines Arbeitsblatts zu verkleinern oder zu vergrößern, indem der Skalierungsfaktor mit der Eigenschaft [**PageSetup.GetZoom()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getzoom/) eingestellt wird.
...
Um den Inhalt des Arbeitsblatts auf eine bestimmte Anzahl von Seiten anzupassen, verwenden Sie die Eigenschaften [**GetFitToPagesTall()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopagestall/) und [**GetFitToPagesWide()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopageswide/) der Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). Diese Eigenschaften werden auch zum Skalieren von Arbeitsblättern verwendet.

{{% alert color="primary" %}}

Sie können entweder die Eigenschaften [**GetFitToPagesTall()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopagestall/)/[**GetFitToPagesWide()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopageswide/) oder [**GetZoom()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getzoom/) auswählen, aber nicht beide gleichzeitig.
...
Legen Sie die Papiergröße fest, auf der die Arbeitsblätter gedruckt werden sollen, mit der Eigenschaft [**GetPaperSize()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getpapersize/) der Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). Die Eigenschaft [**GetPaperSize()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getpapersize/) akzeptiert einen der vordefinierten Werte im [**PaperSizeType**](https://reference.aspose.com/cells/cpp/aspose.cells/papersizetype/) Enumeration, unten aufgeführt.
...
Stellen Sie die Druckqualität der Arbeitsblätter mit der Eigenschaft [**GetPrintQuality()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprintquality/) der Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) ein. Die Einheit für die Druckqualität ist Dots Per Inches (DPI).
...
Beginnen Sie die Nummerierung der Arbeitsblätter mit der Eigenschaft [**GetFirstPageNumber()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfirstpagenumber/) der Klasse [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). Die Eigenschaft [**GetFirstPageNumber()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfirstpagenumber/) legt die Seitennummer des ersten Arbeitsblattabschnitts fest, danach werden die Seiten aufsteigend nummeriert.
