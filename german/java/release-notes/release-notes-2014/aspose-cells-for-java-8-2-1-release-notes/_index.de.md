---
title: Aspose.Cells for Java 8.2.1 Versionshinweise
type: docs
weight: 20
url: /de/java/aspose-cells-for-java-8-2-1-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 8.2.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.2.1/)
...
(CELLSJAVA-40955) – Shape absolute Positionierung
(CELLSJAVA-40943) – Fügen Sie PasteOptions eine Option hinzu, um nur sichtbare Zellen aus dem Bereich einzufügen
...
(CELLSJAVA-40949) – Die horizontale Achse wird im Diagrammbild nicht angezeigt
...
(CELLSJAVA-40985) – CellsException: Dateiende bei Workbook.save erreicht
(CELLSJAVA-40983) – java.lang.NullPointerException bei Workbook.save
(CELLSJAVA-40981) – Aspose.Cells kann passwortgeschützte Excel 2013-Dateien nicht lesen
(CELLSJAVA-40976) – Sparkline löst NullPointerException aus, wenn insertRows verwendet wird
(CELLSJAVA-40969) – Ausnahme: „java.lang.StringIndexOutOfBoundsException: String-Index außerhalb des gültigen Bereichs“ beim Aktualisieren eines Shape-Werts
(CELLSJAVA-40967) – Umwandlung in LineShape nicht möglich
...
Notiz
Da die Codebasis von Aspose.Cells for Java mit dem Code der relevanten .NET-Version übereinstimmt, sind die meisten Änderungen, Verbesserungen und Korrekturen, die in Aspose.Cells for .NET v8.2.1 enthalten sind, auch in dieser Aspose.Cells for Java v8.2.1 enthalten.
