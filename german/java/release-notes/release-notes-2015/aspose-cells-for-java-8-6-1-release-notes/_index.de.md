---
title: Aspose.Cells for Java 8.6.1 Versionshinweise
type: docs
weight: 20
url: /de/java/aspose-cells-for-java-8-6-1-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 8.6.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.6.1/)
...
(CELLSJAVA-41493) – Lange Bindestriche werden in der PDF/Image-Ausgabe des Excel-Diagramms nicht richtig angezeigt
 ...
 (CELLSJAVA-41537) – Ruby wird nicht mit Range.copy() kopiert

 (CELLSJAVA-41534) – Verlust von benutzerdefinierten Bin- und Metadateninformationen während Workbook.copy()

 (CELLSJAVA-41531) – ActiveXControl-Textausrichtung ist vertauscht

 (CELLSJAVA-41525) – Der Bereich wird nach dem Einfügen von Zeilen nicht aktualisiert

 (CELLSJAVA-41522) – Problem mit der bedingten Formatierung von Kopien

 (CELLSJAVA-41507) – Berechnungsproblem bei der Berechnung der Formel basierend auf dem benannten Bereich
...
(CELLSJAVA-41529) – Ausnahme: „java.lang.ArrayIndexOutOfBoundsException“ trat beim Laden einer XLSB-Datei auf
 ...
 (CELLSJAVA-41524) - java.lang.IndexOutOfBoundsException: Index: 14, Größe: 14, beim Kopieren von Arbeitsmappen
...
## **Fehler**
 ...
 (CELLSJAVA-41519) – Das Listenmenü wird an die falsche Position verschoben

 (CELLSJAVA-41495) – Die horizontale Bildlaufleiste bewegt sich nicht
...
## **Öffentliche API und rückwärts inkompatible Änderungen**
 ...
 sind auch in diesem Aspose.Cells for Java v8.6.1 enthalten.
