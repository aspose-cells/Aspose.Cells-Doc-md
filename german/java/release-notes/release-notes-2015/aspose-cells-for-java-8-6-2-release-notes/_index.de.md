...
type: docs
weight: 10
url: /de/java/aspose-cells-for-java-8-6-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 8.6.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.6.2/)
...
## **Fehler**
 ...
 (CELLSJAVA-41554) – Fehlendes Bild beim Konvertieren vom HTML- in das EXCEL-Format

 (CELLSJAVA-41549) – XLSB in Excel 2010 nach dem Speichern durch Aspose.Cells v8.6.1 beschädigt

 (CELLSJAVA-41530) – Die klassische PivotTable-Layouteinstellung ging verloren, wenn die XLSB-Vorlagendatei erneut gespeichert wurde
...
(CELLSJAVA-41544) – Problem mit dem japanischen Datumsformat beim Konvertieren von „XML Spreadsheet 2003“ in XLSX
 ...
 (CELLSJAVA-41567) – Problem mit Webdings-Schriftart in Excel zu PDF-Renderings

 (CELLSJAVA-41559) – Beim Speichern im PDF-Format werden falsche Farbskalenfarben generiert

 (CELLSJAVA-41556) – Beim Drucken der mit Aspose.Cells generierten PDF-Datei wird der eingebettete Barcode in gewissem Umfang geändert

 (CELLSJAVA-41552) – Breite und Höhe eines gedrehten Textwerts scheinen falsch zu sein

 (CELLSJAVA-41578) – Chart to PDF wird nicht direkt nach der Ausführung der Methode chart.toPdf(fileName) generiert

 (CELLSJAVA-41574) – Abstandsproblem zwischen Y-Achse und Legenden

 (CELLSJAVA-41557) – Der Unterschied zwischen den Teilstrichen der Achsenbeschriftung wird von 10 auf 20 geändert, während das Diagramm in PDF gerendert wird

(CELLSJAVA-41553) – Die Diagrammfarben zeigen eine große Verschiebung in der PDF-Ausgabe

 (CELLSJAVA-41539) – Der vertikale Achsenbereich stimmt nicht mit dem Quelldiagramm überein, während die Tabelle in PDF gerendert wird
 ...
 (CELLSJAVA-41509) – Probleme mit Diagrammrändern beim Rendern von Diagrammen in PDF

 (CELLSJAVA-41505) – Rechte und untere Ränder werden beim Rendern von Diagrammen in PDF getrimmt
