...
type: docs
weight: 60
url: /de/java/aspose-cells-for-java-8-4-2-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 8.4.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.4.2/)
...
## **Fehler**
 ...
 (CELLSJAVA-41308) – Die Shape-Position ist beim Rendern der Tabelle im PDF-Format falsch

 (CELLSJAVA-41282) – Pfeilspitzen werden beim Konvertieren einer Tabelle mit Zeichnungen in PDF vergrößert

(CELLSJAVA-41249) – WordArt wird in der Ausgabe-PDF-Datei nicht korrekt gerendert

 (CELLSJAVA-41243) – Horizontaler Text in den Formen wird vertikal gerendert, während die Tabelle in PDF konvertiert wird

 (CELLSJAVA-41242) – Die Zeichnung wird beim Rendern der Tabelle in PDF durcheinander gebracht

 (CELLSJAVA-41241) – Kreisformen werden beim Rendern der Tabelle in PDF in Ovale umgewandelt
...
(CELLSJAVA-41306) – Problem bei der Konvertierung von Excel in PDF – rechte Seite abgeschnitten

 (CELLSJAVA-41316) – Beim Kopieren der Arbeitsmappe fehlen einige DataLabels in der gerenderten HTML-Datei

 (CELLSJAVA-41314) – DataLabels im Diagramm werden im gerenderten EMF-Bild nicht angezeigt

 (CELLSJAVA-41311) – Fehlende Achsenbeschriftungen des Diagramms während der Konvertierung in EMF

 (CELLSJAVA-41301) – Hebräische Zeichen in „Smart Art“, die in Excel vorhanden sind, werden in der PDF-Wiedergabe gespiegelt
 ...
 (CELLSJAVA-41277) – Nur das Rendern von Kreisdiagrammen führt zu einer leeren PDF-Datei

 (CELLSJAVA-41276) – Chart.toImage generiert ein leeres Bild für das Kreisdiagramm

 (CELLSJAVA-41275) – Zwei der Achsenbeschriftungen fehlen im resultierenden EMF beim Konvertieren des Diagramms in ein Bild
