...
type: docs
weight: 100
url: /de/java/aspose-cells-for-java-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 17.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.3.0/).
...
1. [Passen Sie die Globalisierungseinstellungen für die Pivot-Tabelle an](/cells/de/java/customize-globalization-settings-for-pivot-table/)
1. [Ausführen der clientseitigen Funktion beim Wechsel der GridWeb-Seite](/cells/de/java/execute-client-side-function-on-gridweb-page-change/)
1. [Validieren Sie das gesamte Arbeitsblatt statt nur der aktualisierten Zellen](/cells/de/java/validate-entire-worksheet-instead-of-only-the-updated-cells/)
