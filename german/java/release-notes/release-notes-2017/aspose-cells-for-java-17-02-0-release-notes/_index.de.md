---
title: Aspose.Cells for Java 17.02.0 Versionshinweise
type: docs
weight: 110
url: /de/java/aspose-cells-for-java-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 17.02.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.02.0/).
...
1. [Spalten und Zeilen automatisch anpassen, während HTML in die Arbeitsmappe geladen wird](/cells/de/java/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Konvertieren Sie Text in Spalten mit Aspose.Cells](/cells/de/java/convert-text-to-columns-using-aspose-cells/)
