...
type: docs
weight: 30
url: /de/java/aspose-cells-for-java-17-10-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 17.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.10/).
...
- [Externe Verbindung der XLSB-Datei lesen und schreiben](/cells/de/java/read-and-write-external-connection-of-xlsb-or-xls-file/)
...
- [Geben Sie mithilfe von HtmlCrossType an, wie Zeichenfolgen in Ausgabe-HTML gekreuzt werden](/cells/de/java/specify-how-to-cross-string-in-output-html-using-htmlcrosstype/)
