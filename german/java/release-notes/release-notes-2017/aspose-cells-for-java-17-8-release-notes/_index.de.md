...
type: docs
weight: 50
url: /de/java/aspose-cells-for-java-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 17.8](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.8/).
...
- [Hinzufügen einer digitalen Signatur zu einer bereits signierten Excel-Datei](/cells/de/java/add-digital-signature-to-an-already-signed-excel-file/)
...
- [Exportieren Sie Kommentare, während Sie eine Excel-Datei in HTML speichern](/cells/de/java/export-comments-while-saving-excel-file-to-html/)
- [Leere Seite ausgeben, wenn nichts zu drucken ist](/cells/de/java/output-blank-page-when-there-is-nothing-to-print/)
