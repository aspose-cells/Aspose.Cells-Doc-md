...
type: docs
weight: 10
url: /de/java/aspose-cells-for-java-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [Smart-Marker-Daten automatisch in andere Arbeitsblätter einfügen, wenn die Daten zu groß sind](/cells/de/java/auto-populate-smart-marker-data-to-other-worksheets-if-data-is-too-large/)
- [Arbeitsblatt-CSS separat in Ausgabe-HTML exportieren](/cells/de/java/export-worksheet-css-separately-in-output-html/)
- [Implementieren Sie Cell.FormulaLocal ähnlich wie Excel VBA Range.FormulaLocal](/cells/de/java/implement-cell-formulalocal-similar-to-excel-vba-range-formulalocal/)
- [Stellen Sie den Stilen von Tabellenelementen die HtmlSaveOptions.TableCssId-Eigenschaft voran](/cells/de/java/prefix-table-elements-styles-with-htmlsaveoptions-tablecssid-property/)
- [Rendern Sie Office-Add-Ins, während Sie Excel in PDF konvertieren](/cells/de/java/render-office-add-ins-while-converting-excel-to-pdf/)
...
- [Aktualisieren Sie die Tage, an denen der Verlauf der Revisionsprotokolle in der freigegebenen Arbeitsmappe beibehalten wird](/cells/de/java/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
