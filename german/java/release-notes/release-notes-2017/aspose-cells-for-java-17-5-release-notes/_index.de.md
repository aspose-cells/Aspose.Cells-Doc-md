...
type: docs
weight: 80
url: /de/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [Verschieben Sie die erste Zeile nach unten, wenn Sie Cells Datentabellenzeilen einfügen](/cells/de/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
