...
type: docs
weight: 20
url: /de/java/aspose-cells-for-java-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
- [Konvertieren Sie die Smart Art in eine Gruppenform](/cells/de/java/convert-the-smart-art-to-group-shape/)
- [Gemeinsame Arbeitsmappe mit Aspose.Cells erstellen](/cells/de/java/create-shared-workbook-with-aspose-cells/)
- [Bestimmen Sie, ob Shape Smart Art Shape ist](/cells/de/java/determine-if-shape-is-smart-art-shape/)
- [Suchen Sie den Stammelementnamen der XML-Zuordnung](/cells/de/java/find-the-root-element-name-of-xml-map/)
- [Ignorieren Sie Fehler beim Rendern von Excel in PDF](/cells/de/java/ignore-errors-while-rendering-excel-to-pdf/)
- [Schützen Sie die freigegebene Arbeitsmappe mit einem Kennwort oder heben Sie den Schutz auf](/cells/de/java/password-protect-or-unprotect-the-shared-workbook/)
- [Abfrage Cell Areas Mapped to XML Map Path mit Worksheet.XmlMapQuery-Methode](/cells/de/java/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
- [Rendern Sie eine Seitenfolge mithilfe der PageIndex- und PageCount-Eigenschaften von ImageOrPrintOptions](/cells/de/java/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/)
