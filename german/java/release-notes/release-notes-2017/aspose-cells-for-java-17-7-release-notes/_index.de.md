...
type: docs
weight: 60
url: /de/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [Implementieren Sie Fehler und boolesche Werte in Russisch oder einer anderen Sprache](/cells/de/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
