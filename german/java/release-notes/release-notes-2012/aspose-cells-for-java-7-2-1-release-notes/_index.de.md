---
title: Aspose.Cells for Java 7.2.1 Versionshinweise
type: docs
weight: 70
url: /de/java/aspose-cells-for-java-7-2-1-release-notes/
---
{{% alert color="primary" %}} 

 Diese Seite enthält Versionshinweise für[Aspose.Cells for Java 7.2.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.2.1/)

{{% /alert %}} 

Wir sind
 freut sich, Aspose.Cells for Java v7.2.1 ankündigen zu können!

 Neue Eigenschaften

- Pivot-Tabelle mit benutzerdefinierten Stilen für verschiedene Kategorien formatieren (Schnellstil der Pivot-Tabelle ändern)
