...
Sie können die Werte von GridWeb-Zellen auf der Client-Seite mit Hilfe der Methode gridwebinstance.getCellsArray() auslesen. Wenn Sie diese Methode aufrufen, erhalten Sie das Array aller Zellen im aktiven Arbeitsblatt. Anschließend können Sie die folgenden Methoden verwenden, um den Wert und weitere Informationen der Zellen abzurufen.
