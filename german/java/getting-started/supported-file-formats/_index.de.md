...
|[XLAM](https://docs.fileformat.com/spreadsheet/xlam/)|Eine makrofähige Excel-Add-In-Datei, die zum Hinzufügen neuer Funktionen zu Excel verwendet wird.||{{< emoticons/tick >}}|
...
|[Zahlen](https://docs.fileformat.com/spreadsheet/numbers/)|Das Dokument wird von Apples „Numbers“-Anwendung erstellt, die Teil von Apples iWork-Office-Suite ist, einer Reihe von Anwendungen, die auf den Betriebssystemen Mac OS X und iOS ausgeführt werden.|{{< emoticons/tick >}}||
...
|[EMF](https://docs.fileformat.com/image/emf/)|Verbessertes Metafile-Format||{{< emoticons/tick >}}|
...
|[ABDRUCK](https://docs.fileformat.com/word-processing/md/)|Stellt ein Markdown-Dokument dar.||{{< emoticons/tick >}}|
...
|[FODS](https://docs.fileformat.com/spreadsheet/fods/)|Dies ist ein offenes Dokumentformat, das als flaches XML gespeichert wird.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
