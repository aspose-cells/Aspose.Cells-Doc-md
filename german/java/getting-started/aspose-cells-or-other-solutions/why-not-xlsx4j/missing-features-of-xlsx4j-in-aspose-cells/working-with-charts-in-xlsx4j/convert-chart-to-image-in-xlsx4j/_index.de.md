---
title: Diagramm in xlsx4j in Bild umwandeln
type: docs
weight: 10
url: /de/java/convert-chart-to-image-in-xlsx4j/
---
## **Aspose.Cells - Diagramm in Bild konvertieren**
...
{{% alert color="primary" %}} 
 ...
 Weitere Informationen finden Sie unter[Diagramm in Bild umwandeln](/java/converting-chart-to-image).
