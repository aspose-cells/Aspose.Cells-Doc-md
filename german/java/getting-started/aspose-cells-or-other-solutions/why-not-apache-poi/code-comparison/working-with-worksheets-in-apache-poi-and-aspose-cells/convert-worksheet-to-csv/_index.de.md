...
Wenn Entwickler ihre Dateien an einem Speicherort speichern müssen, können sie einfach den Dateinamen (mit seinem vollständigen Speicherpfad) und das gewünschte Dateiformat (unter Verwendung der Enumeration **FileFormatType**) beim Aufrufen der Methode **save** des Objekts **Workbook** angeben.
...
Im folgenden Code wird gezeigt, wie ein Arbeitsblatt mithilfe der Apache POI HSSF und XSSF-API im Vergleich zur Aspose.Cells Java-API in CSV konvertiert werden kann.
...
Downloaden Sie **Arbeitsblatt in CSV konvertieren** von einer der unten genannten sozialen Coding-Websites:
