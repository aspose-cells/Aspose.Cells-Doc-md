...
type: docs
weight: 60
url: /de/java/merge-cells/
---

## **Aspose.Cells - Zellen zusammenführen**
Die Cells-Klasse verfügt über einige nützliche Methoden für die Aufgabe. Zum Beispiel führt die merge-Methode die Zellen in eine einzelne Zelle innerhalb eines bestimmten Bereichs von Zellen zusammen.
...
{{< /highlight >}}
## **Apache POI SS - HSSF XSSF - Zellen zusammenführen**
Sheet.addMergedRegion kann verwendet werden, um Zellen zusammenzuführen.
