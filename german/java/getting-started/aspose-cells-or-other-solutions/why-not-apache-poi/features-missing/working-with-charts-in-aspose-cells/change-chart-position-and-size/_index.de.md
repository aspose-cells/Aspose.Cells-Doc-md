...
Verwenden Sie diese Eigenschaften von Aspose.Cells, um die Position (X-, Y-Koordinaten) und Größe (Höhe, Breite) des Diagramms zu ändern:
...
Für weitere Details besuchen Sie [Ändern der Diagrammposition und -größe](/cells/de/java/change-chart-position-and-size/).
