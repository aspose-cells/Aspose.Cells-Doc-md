...
type: docs
weight: 40
url: /de/java/using-sparklines-and-settings-3d-format/
---
...
Entwickler können Sparklines (in der Vorlagendatei) erstellen, löschen oder lesen, indem sie die von Aspose.Cells bereitgestellte API verwenden. Die Klassen, die Sparklines verwalten, sind im [Aspose.Cells.Charts](https://reference.aspose.com/cells/java/com.aspose.cells/Chart)-Namespace enthalten. Daher müssen Sie diesen Namespace importieren, bevor Sie diese Funktionen verwenden.
