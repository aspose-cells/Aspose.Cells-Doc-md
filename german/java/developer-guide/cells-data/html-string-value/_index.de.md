...
Aspose.Cells unterstützt die Konvertierung von Microsoft Excel-orientiertem HTML in das XLS/XLSX-Format. Das bedeutet, dass das von Microsoft Excel generierte HTML mit Aspose.Cells zurück in das XLS/XLSX-Format konvertiert werden kann.

 Ebenso kann Aspose.Cells einfachen HTML-Code in HTML-Rich-Text umwandeln. Aspose.Cells bietet[**Cell.setHtmlString()**](https://reference.aspose.com/cells/java/com.aspose.cells/cell#HtmlString) -Eigenschaft, die einen so einfachen HTML-Code in formatierten Zellentext konvertieren kann.
...
- [Zeigen Sie Aufzählungszeichen an, indem Sie den Wert Cell mithilfe von HTML festlegen](/cells/de/java/display-bullets-by-setting-cell-value-using/)
