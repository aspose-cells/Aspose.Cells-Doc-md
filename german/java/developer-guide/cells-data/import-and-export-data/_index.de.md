...
Daten können mithilfe der [**exportArray**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#exportArray(int,%20int,%20int,%20int))-Methode der Klasse [**Cells**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#Cells) problemlos in ein Array-Objekt exportiert werden.

#### Spalten, die stark typisierte Daten enthalten

Tabellen speichern Daten als Folge von Zeilen und Spalten. Verwenden Sie die [**exportArray**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#exportArray(int,%20int,%20int,%20int))-Methode, um die Daten von einem Arbeitsblatt in ein Array zu exportieren. [**exportArray**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#exportArray(int,%20int,%20int,%20int)) nimmt die folgenden Parameter an, um Arbeitsblattdaten als *Array*-Objekt zu exportieren:
