...
Der folgende Beispielcode führt eine SQL-Abfrage aus einer Microsoft Access-Datenbank aus und erstellt ein ResultSet-Objekt. Dann importiert er Daten aus dem ResultSet-Objekt in das Arbeitsblatt mit [Worksheet.getCells().importResultSet()](https://reference.aspose.com/cells/java/com.aspose.cells/cells#importResultSet-java.sql.ResultSet-int-int-boolean-) Methode. Zuerst werden Zeilen- und Spaltenindizes verwendet, später dann der Zellname, um Daten in das Arbeitsblatt zu importieren. Schließlich wird die Arbeitsmappe als [Ausgabe-Excel-Datei](48496713.xlsx) gespeichert. Der Screenshot zeigt die Auswirkung des Beispielcodes auf die Ausgabedatei zum Referenzzweck.
