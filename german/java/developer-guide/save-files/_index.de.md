...
|[**XLSM**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#XLSM)|Stellt eine XML-basierte XLSM-Datei dar|
...
|[**EXCEL_97_TO_2003**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#EXCEL_97_TO_2003)|Stellt eine XLS-Datei dar, die das Standardformat für Excel-Revisionen von 1997 bis 2003 ist|
...
|[**XLSB**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#XLSB)|Stellt eine binäre Excel 2007-XLSB-Datei dar|
...
|[**TIFF**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#TIFF)|Stellt eine TIFF-Datei (Tagged Image File Format) dar|
|[**SVG**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#SVG)|Stellt eine XML-basierte SVG-Datei (Scalable Vector Graphics) dar|
...
|[**ABDRUCK**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#MARKDOWN)|Stellt ein Markdown-Dokument dar.|
...
Wenn der Code ausgeführt wird, konvertiert er die Daten aller Blätter in der Arbeitsmappe in das TXT-Format.
 ...
 Sie können dasselbe Beispiel ändern, um Ihre Datei im CSV-Format zu speichern. Standardmäßig,[**TxtSaveOptions.Separator**](https://reference.aspose.com/cells/java/com.aspose.cells/txtsaveoptions#Separator) ist ein Komma, also geben Sie beim Speichern im CSV-Format kein Trennzeichen an.
...
#### **Legen Sie die ContentCopyForAccessibility-Option fest**
 ...
 Mit dem[**PdfSaveOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/PdfSaveOptions) Klasse können Sie das PDF abrufen oder festlegen[**AccessibilityExtractContent**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsecurityoptions#AccessibilityExtractContent) Option zum Steuern des Inhaltszugriffs im konvertierten PDF. Dies bedeutet, dass Screenreader-Software den Text in der PDF-Datei zum Lesen der PDF-Datei verwenden kann. Sie können es deaktivieren, indem Sie ein Kennwort zum Ändern der Berechtigungen anwenden und die beiden Elemente im Screenshot deaktivieren[hier](71630877.png).
...
- [Verfolgen Sie den Konvertierungsfortschritt von Excel in TIFF](/cells/de/java/track-conversion-progress-of-excel-to-tiff/)
