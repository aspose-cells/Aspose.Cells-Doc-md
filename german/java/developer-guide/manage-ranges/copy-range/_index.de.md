...
type: docs
weight: 30
url: /de/java/copy-ranges-of-Excel/
---
...
Aspose.Cells bietet einige Überladungsmethoden für das Kopieren von Bereich [Range.Copy](https://reference.aspose.com/cells/java/com.aspose.cells/range).
## **Bereich kopieren**
