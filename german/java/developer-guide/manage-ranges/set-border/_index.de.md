...
type: docs
weight: 600
url: /de/java/set-range-border/
---

## **Mögliche Verwendungsszenarien**
Wenn Sie die Grenze für einen Bereich festlegen möchten, müssen Sie nicht jede Zelle einzeln festlegen. Sie können die Grenze für den Bereich festlegen. Aspose.Cells bietet diese Funktion.
Dieser Artikel enthält einen Beispielcode, der Aspose.Cells verwendet, um die Bereichsgrenze festzulegen.
...
1. [**Range**](https://reference.aspose.com/cells/java/com.aspose.cells/range/) erstellen.
