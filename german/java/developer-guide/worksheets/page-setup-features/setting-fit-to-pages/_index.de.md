...
type: docs
weight: 200
url: /de/java/how-to-print-excel-as-fitted-pages-wide-and-tall/
...
keywords: Java Wie man FitToPagesWide und FitToPagesTall setzt, Wie man FitToPagesWide und FitToPagesTall in Java hinzufügt, Wie man FitToPagesWide und FitToPagesTall in Excel einstellt, Wie man FitToPagesWide und FitToPagesTall in Excel löscht, Wie man Excel auf zugeschnittenen Seiten breit und hoch druckt, Wie man das Arbeitsblatt in einer Seite druckt, Wie man alle Spalten eines Arbeitsblatts auf einer Seite druckt.
---
...
Um FitToPagesWide und FitToPagesTall in einem bestimmten Arbeitsblatt festzulegen: Laden Sie zuerst die [Beispieldatei](input.xlsx), und rufen Sie dann die [**Worksheet.PageSetup.setFitToPagesTall(int value)**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setFitToPagesTall-int-)- und [**Worksheet.PageSetup.setFitToPagesWide(int value)**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setFitToPagesWide-int-)-Methoden des [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/)-Objekts für das gewünschte Arbeitsblatt auf. Hier ist ein Beispiel in Java:
...
Um das Arbeitsblatt als eine Seite zu drucken: Laden Sie zuerst die [Beispieldatei](sample.xlsx), und rufen Sie dann die [**PdfSaveOptions.setOnePagePerSheet(boolean value)**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/#setOnePagePerSheet-boolean-)-Methode des [**PdfSaveOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/)-Objekts auf. Hier ist ein Beispiel in Java:
...
Um alle Spalten eines Arbeitsblatts auf einer Seite zu drucken: Laden Sie zuerst die [Beispieldatei](sample.xlsx), und rufen Sie dann die [**PdfSaveOptions.setAllColumnsInOnePagePerSheet(boolean value)**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/#setAllColumnsInOnePagePerSheet-boolean-)-Methode des [**PdfSaveOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/)-Objekts auf. Hier ist ein Beispiel in Java:
