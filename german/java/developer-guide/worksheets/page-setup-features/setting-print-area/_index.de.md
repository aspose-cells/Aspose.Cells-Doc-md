...
type: docs
weight: 200
url: /de/java/how-to-set-print-area/
...
keywords: Druckbereich einschränken, Druckbereich festlegen, Druckbereich löschen, Druckbereich setzen und löschen mit Java, Java How to Set Print Area, Druckbereich in Java setzen und löschen, Druckbereich in Java löschen, Druckbereich mit Java hinzufügen, Druckbereich mit Java entfernen, Druckbereich in Excel festlegen, Druckbereich in Excel löschen.
---
...
Um den Druckbereich in einem bestimmten Arbeitsblatt festzulegen: Laden Sie zuerst die [Beispieldatei](input.xlsx), und ändern Sie dann die Eigenschaft [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) des Objekts [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) für das gewünschte Arbeitsblatt. Das Setzen dieser Eigenschaft auf eine Range-Zeichenkette legt den Druckbereich fest.
...
Um den Druckbereich in einem bestimmten Arbeitsblatt zu löschen: Laden Sie zuerst die [Beispieldatei](input.xlsx), und ändern Sie dann die Eigenschaft [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) des Objekts [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) für das gewünschte Arbeitsblatt. Das Setzen dieser Eigenschaft auf einen leeren String löscht den Druckbereich.
