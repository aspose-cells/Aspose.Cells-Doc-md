...
type: docs
weight: 200
url: /de/java/how-to-set-print-titles/
description: Dieser Artikel zeigt Ihnen Code, der erklärt, wie man Drucktitel mit der Aspose.Cells Bibliothek festlegt.
keywords: Druckzeilen und spalten wiederholt, Java, Wie man Drucktitel festlegt, Drucktitel setzen und löschen mit Java, Wie man Drucktitel in Java entfernt, Drucktitel mit Java hinzufügen, Drucktitel mit Java entfernen, Wie man Drucktitel in Excel festlegt, Wie man Drucktitel in Excel löscht.
---
...
Um Drucktitel in einem bestimmten Arbeitsblatt festzulegen: Laden Sie zuerst die [Beispieldatei](input.xlsx) und ändern Sie dann die Eigenschaften [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) und [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) des Objekts [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) für das gewünschte Arbeitsblatt. Das Festlegen dieser Eigenschaften auf einen Range-String setzt die Drucktitel.
