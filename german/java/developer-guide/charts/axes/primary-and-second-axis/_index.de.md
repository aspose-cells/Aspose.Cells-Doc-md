---
title: Primäre und sekundäre Achse
description: Lernen Sie, wie Sie die primäre und sekundäre Achsen in Aspose.Cells for Java verstehen und verwenden. Unser Leitfaden wird Ihnen helfen, die Unterschiede zwischen primären und sekundären Achsen zu verstehen und diese effektiv in Ihren Diagrammen zu konfigurieren und zu verwenden.
keywords: Aspose.Cells for Java, primäre Achsen, sekundäre Achsen, Verständnis, Unterschiede, Konfiguration, Verwendung.
type: docs
weight: 190
...
Der folgende Beispielcode generiert die [Ausgabedatei Excel](PrimaryandSecondaryAxis.xlsx).
