...
type: docs
weight: 10
url: /de/java/format-number-to-date/
description: Dieser Artikel zeigt, wie man Zahlen mithilfe der Aspose.Cells for Java API in Datum umwandelt.
...
Um Zahlen in der Aspose.Cells for Java Bibliothek für die Arbeit mit Excel-Dateien als Datum zu formatieren, können Sie die Datumsformatierung programmatisch auf Zellen anwenden. Hier finden Sie eine Anleitung, wie Sie dies mit Java und Aspose.Cells tun können:
