...
{{% alert color="primary" %}}
 ...
 Wenn Sie die verwenden[**Brauch**](https://reference.aspose.com/cells/java/com.aspose.cells/style#Custom) um das Zahlenformat einzustellen, jedes vorherige Format, das mit eingestellt wurde[**Anzahl**](https://reference.aspose.com/cells/java/com.aspose.cells/style#Number） is overridden and vice versa.
