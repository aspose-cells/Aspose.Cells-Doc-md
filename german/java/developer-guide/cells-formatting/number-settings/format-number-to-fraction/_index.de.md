---
title: Wie man Nummern in Bruchzahlen formatiert
type: docs
weight: 10
url: /de/java/how-to-format-number-to-fraction/
description: Dieser Artikel stellt vor, wie man Nummern mit der Aspose.Cells for Java API in Brüche umwandelt.
...
## **So formatieren Sie Zahlen als Bruch in Aspose.Cells for Java**
Das Formatieren von Zahlen als Brüche in Aspose.Cells for Java ist ein einfacher Prozess. Aspose.Cells ist eine leistungsstarke Bibliothek, die es Ihnen ermöglicht, mit Excel-Dateien in Java-Anwendungen zu arbeiten, ohne Microsoft Excel installiert haben zu müssen. Es bietet eine Vielzahl von Funktionen, einschließlich der Formatierung von Zahlen als Brüche.

Hier ist eine Schritt-für-Schritt-Anleitung, wie man Zahlen in Aspose.Cells for Java als Brüche formatiert:

### Schritt 1: Aspose.Cells for Java installieren
...
Um eine Zelle als Bruch zu formatieren, müssen Sie die Methode `Style.setNumber` mit einem spezifischen Formatcode verwenden. Aspose.Cells unterstützt verschiedene Bruchformate, wie "1/2", "1/4", "2/4" usw.
...
- Die `setCustom`-Methode des Style-Objekts erlaubt es Ihnen, das genaue Bruchformat anzugeben. Zum Beispiel kann "# ??/???" Brüche mit bis zu drei Ziffern im Nenner anzeigen.
...
Indem Sie diese Schritte befolgen, können Sie Zahlen in Aspose.Cells for Java problemlos als Brüche formatieren. Dies ist besonders nützlich für finanzielle, statistische oder pädagogische Anwendungen, bei denen präzise Bruchwerte erforderlich sind.
