...
type: docs
weight: 10
url: /de/java/line-breaks-and-text-wrapping/
---
...
Um Text in einer Zelle umzubrechen, verwenden Sie die Eigenschaft [**Aspose.Cells.Style.setTextWrapped**](https://reference.aspose.com/cells/java/com.aspose.cells/style#IsTextWrapped).

Der folgende Beispielcode zeigt, wie Textumbrüche und explizite Zeilenumbrüche in einer Zelle verwendet werden.
...
In Java können Sie ' \n ' verwenden, um explizite Zeilenumbrüche in einer Zelle einzufügen.
