...
{{% /alert %}} 
 ...
 Aspose.Cells APIs bieten die[**PdfSicherheitsoptionen**](https://reference.aspose.com/cells/java/com.aspose.cells/PdfSecurityOptions)Klasse für die Arbeit mit der Sicherheit des PDF-Dateiformats. Der folgende Beispielcode beschreibt, wie Sie gesicherte PDF-Dateien mit Aspose.Cells for Java API erstellen.
