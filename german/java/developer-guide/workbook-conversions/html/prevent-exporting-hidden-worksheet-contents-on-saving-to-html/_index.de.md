...
Neben der Steuerung, ob ausgeblendete Arbeitsblätter exportiert werden sollen oder nicht, können Sie auch zusätzliche Einstellungen für den Export von Arbeitsmappen in HTML konfigurieren. Die folgenden Artikel demonstrieren andere Funktionen, die von Aspose.Cells zum Exportieren von Arbeitsmappen in HTML unterstützt werden.

- [Konvertieren Sie Excel in HTML mit Überschriften](/cells/de/java/convert-excel-to-html-with-headings/)
- [Schließen Sie nicht verwendete Stile während der Excel-zu-HTML-Konvertierung aus](/cells/de/java/exclude-unused-styles-during-excel-to-html-conversion/)
...
- [Ausblenden von überlagerten Inhalten mit CrossHideRight beim Speichern in HTML](/cells/de/java/hiding-overlaid-content-with-crosshideright-while-saving-to-html/)
