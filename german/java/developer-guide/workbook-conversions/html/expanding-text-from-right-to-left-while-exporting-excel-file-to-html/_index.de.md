...
Der folgende Beispielcode wandelt die [Beispiel-Excel-Datei](5472562.xlsx) in HTML um. Dieser Screenshot zeigt, wie das Beispiel-Excel in Microsoft Excel 2013 aussieht.

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_1.png)

Dieser Screenshot zeigt das [mit der älteren Version generierte Ausgabe-HTML](5472570).

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_2.png)

Dieser Screenshot zeigt das [mit der neueren Version generierte Ausgabe-HTML](5472563).
