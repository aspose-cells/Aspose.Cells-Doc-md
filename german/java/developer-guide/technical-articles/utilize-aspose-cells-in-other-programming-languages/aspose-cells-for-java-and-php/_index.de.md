...
{{% alert color="primary" %}} 
 ...
 PHP-Entwickler können Aspose.Cells for Java in PHP-Anwendungen verwenden. Um mit Aspose.Cells for Java und PHP zu arbeiten, verwenden Sie PHP Version 5 (bekannt als PHP5). PHP4 kann auch verwendet werden, um auf Aspose.Cells for Java zuzugreifen, aber es ist komplexer als die Verwendung von PHP5.
