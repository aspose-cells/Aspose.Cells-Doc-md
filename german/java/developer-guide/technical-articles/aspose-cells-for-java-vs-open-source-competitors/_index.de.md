---
title: Aspose.Cells for Java gegen Open Source Mitbewerber vergleichen
type: docs
weight: 1089
...
Dieser Artikel vergleicht die Funktionen von [Aspose.Cells for Java](https://products.aspose.com/cells/java/) mit seinen Open-Source-Konkurrenten. Das Dokument vergleicht Aspose.Cells for Java mit [JExcelAPI](http://jexcelapi.sourceforge.net/) und [POI](http://poi.apache.org/)'s HSSF für eine gemeinsame Funktionssammlung.
...
Aspose.Cells for Java hat eine große Liste von Funktionen. Um mehr über die Funktionen und den Programmierleitfaden zu erfahren, überprüfen Sie bitte [die Dokumentation](/cells/de/java/) und [Online-Demos](https://github.com/aspose-cells/Aspose.Cells-for-Java).

Bitte versuchen Sie das Component, um den Unterschied zwischen ihm und seinen Konkurrenten zu sehen. Die Evaluierungsversion ist völlig kostenlos ohne zeitliche Begrenzung. [Laden Sie](https://downloads.aspose.com/cells/java) die Evaluierungsversion kostenlos herunter.
