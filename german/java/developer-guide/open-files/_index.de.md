...
Aspose.Cells ermöglicht Entwicklern das Öffnen von Tabellenkalkulationsdateien mit verschiedenen Formaten wie SpreadsheetML, CSV, tabulatorgetrennte Dateien. Um solche Dateien zu öffnen, können Entwickler dieselbe Methode verwenden, die sie zum Öffnen von Dateien verschiedener Microsoft-Excel-Versionen verwenden.
...
- [Behalten Sie Trennzeichen für leere Zeilen bei, während Sie Tabellenkalkulationen in das CSV-Format exportieren](/cells/de/java/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
...
- [CSV-Datei mit mehreren Kodierungen lesen](/cells/de/java/reading-csv-file-with-multiple-encodings/)
