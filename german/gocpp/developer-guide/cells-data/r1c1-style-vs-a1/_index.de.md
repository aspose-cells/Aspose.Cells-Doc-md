---  
title: Excel – R1C1 Referenzstil vs A1 mit Golang über C++  
linktitle: Excel – R1C1 Referenzstil vs. A1  
type: docs  
weight: 30  
url: /de/go-cpp/r1c1-reference-style-vs-a1/  
description: R1C1 Referenzstil vs. A1 Stil mit Aspose.Cells über Golang via C++.  
...
Dies ist der Standard-Referenzstil in Excel. Im A1-Stil werden Spalten durch Buchstaben (A, B, C, ..., Z, AA, AB, ..., ZZ, AAA, AAB, ...) bezeichnet, und Zeilen durch Zahlen (1, 2, 3, ...). Zum Beispiel wird die Zelle in der ersten Spalte und zweiten Zeile als A2 bezeichnet.
...
Zum Beispiel ist R[2]C[3] eine Zelle 2 Zeilen darunter und 3 Spalten nach rechts. R[-1]C[-4] ist eine Zelle 1 Zeile oben und 4 Spalten nach links. Wenn keine Zahl in Klammern angezeigt wird, beziehen Sie sich auf die gleiche Zeile oder Spalte, z. B. R[3]C ist eine Zelle 3 Zeilen unter der aktuellen Zelle in derselben Spalte.  
<br>  
