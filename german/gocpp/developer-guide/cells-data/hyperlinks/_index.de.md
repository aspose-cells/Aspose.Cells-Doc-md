---
title: Hyperlinks in Excel oder OpenOffice mit Golang über C++ einfügen
linktitle: Hyperlinks verwalten
type: docs
weight: 45
url: /de/go-cpp/insert-hyperlinks-to-excel/
...
Die [Worksheet](https://reference.aspose.com/cells/go-cpp/worksheet/) Klasse enthält eine [GetHyperlinks()](https://reference.aspose.com/cells/go-cpp/worksheet/gethyperlinks/) Sammlung. Jeder Eintrag in der [GetHyperlinks()](https://reference.aspose.com/cells/go-cpp/worksheet/gethyperlinks/) Sammlung repräsentiert einen [Hyperlink](https://reference.aspose.com/cells/cpp/aspose.cells/hyperlink/). Fügen Sie Hyperlinks zu URLs hinzu, indem Sie die [Hyperlinks](https://reference.aspose.com/cells/cpp/aspose.cells/hyperlinkcollection/) Sammlung mit der [Add](https://reference.aspose.com/cells/cpp/aspose.cells/hyperlinkcollection/add/) Methode aufrufen. Die [Add](https://reference.aspose.com/cells/cpp/aspose.cells/hyperlinkcollection/add/) Methode benötigt die folgenden Parameter:
...
Es ist möglich, Hyperlinks in Zellen derselben Excel-Datei durch Aufruf der [Hyperlinks](https://reference.aspose.com/cells/go-cpp/hyperlinkcollection/) Sammlung mit der [Add](https://reference.aspose.com/cells/go-cpp/hyperlinkcollection/add/) Methode hinzuzufügen. Die [Add](https://reference.aspose.com/cells/go-cpp/hyperlinkcollection/add/) Methode funktioniert für interne und externe Hyperlinks. Eine Version der überladenen Methode nimmt die folgenden Parameter:
...
Es ist möglich, Hyperlinks zu externen Excel-Dateien durch Aufruf der [Hyperlinks](https://reference.aspose.com/cells/go-cpp/hyperlinkcollection/) Sammlung mit der [Add](https://reference.aspose.com/cells/go-cpp/hyperlinkcollection/add/) Methode hinzuzufügen. Die [Add](https://reference.aspose.com/cells/go-cpp/hyperlinkcollection/add/) Methode benötigt die folgenden Parameter:
