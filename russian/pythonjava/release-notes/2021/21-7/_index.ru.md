---
title: Aspose.Cells для Python через Java 21.7 Примечания к выпуску
type: docs
weight: 6
url: /ru/python-java/aspose-cells-for-python-via-java-21-7-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells для Python через Java 21,7](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.7/).
...
|CELLSJAVA-43482|Верхние и нижние индексы неправильно отформатированы при преобразовании HTML-документа в книгу|
...
|CELLSJAVA-41693|Уравнение в текстовом поле не отображается в PDF|
|CELLSJAVA-43487|Текст не центрирован в выходном PDF-файле при преобразовании Excel в PDF|
|CELLSJAVA-42867|Формы не извлекаются в формате файла ODS|
|CELLSJAVA-42895|Вывод PNG диаграммы MS Excel имеет расхождения|
