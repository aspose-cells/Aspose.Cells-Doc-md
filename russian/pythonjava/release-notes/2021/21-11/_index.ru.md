...
type: docs
weight: 2
url: /ru/python-java/aspose-cells-for-python-via-java-21-11-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Python via Java 21.11](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.11/).
...
|CELLSJAVA-43953|Визуализация определенного текста/части «Cell» и «Комментарий» для перевода на японский язык при преобразовании Excel в PDF|
...
|CELLSJAVA-43954|XLSX в PDF: изображение вызывает исключение «java.lang.OutOfMemoryError: Java куча пространства»|
...
|CELLSJAVA-43519|Объединенные ячейки, включенные в скрытые строки или столбцы, создают неровную HTML-таблицу.|
