---
title: Aspose.Cells для Python через Java 22.3 Примечания к выпуску
type: docs
weight: 10
url: /ru/python-java/aspose-cells-for-python-via-java-22-3-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells для Python через Java 22,3](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.3/).
...
|CELLSJAVA-44341|Cell неправильная ширина в выходном DOCX при преобразовании Excel в DOCX|
...
|CELLSJAVA-44344| Проблема с горизонтальным копированием диапазонов в выходной XLSX|
...
|CELLSJAVA-44328| Некоторые метки данных графиков Excel теряются при сохранении файла Excel в формате HTML.|
|CELLSJAVA-44193|Угол элементов оси категорий на графике отличается при преобразовании Excel в PDF|
