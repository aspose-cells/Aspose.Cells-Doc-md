---
title: Aspose.Cells для Python через Java 22.11 Примечания к выпуску
type: docs
weight: 2
url: /ru/python-java/aspose-cells-for-python-via-java-22-11-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells для Python через Java 22.11](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.11/).
...
|CELLSJAVA-44943|XLSX в PDF: метки диаграмм отображаются неправильно|
|CELLSJAVA-44928|XLS в PDF: недостаточно данных для изображения|
|CELLSJAVA-44910|Преобразование результатов Excel в HTML в тысячи похожих небольших изображений|
