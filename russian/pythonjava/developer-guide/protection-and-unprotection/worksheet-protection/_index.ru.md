...
description: Защитите и снимите защиту рабочего листа файлов Excel с Aspose.Cells для Python через Java.
---
{{% alert color="primary" %}}
...
## **Защитите рабочий лист, используя Aspose.Cell для Python**
...
## **Снять защиту рабочего листа с помощью Aspose.Cell для Python**
