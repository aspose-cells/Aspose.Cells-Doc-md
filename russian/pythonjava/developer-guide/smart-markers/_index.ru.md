---
title: Умный импорт и размещение данных с помощью интеллектуальных маркеров в Python через java
linktitle: Умные маркеры
type: docs
weight: 190
url: /ru/python-java/using-smart-markers/
description: Умный импорт и размещение данных в соответствии с файлами Excel шаблона с Aspose.Cells for Python через библиотеку java.
---
## **Вступление**
...
Обрабатывать умные маркеры очень легко. Далее следует фрагмент кода Python via Java, показывающий, как это делается.
