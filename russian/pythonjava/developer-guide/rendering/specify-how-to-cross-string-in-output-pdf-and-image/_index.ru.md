...
---
## **Укажите, как пересекать строку в выходном PDF-файле и изображении**
 Если ячейка содержит текст или строку, превышающую ширину ячейки, строка переполняется, если следующая ячейка в следующем столбце имеет значение null или пуста. Когда вы сохраняете файл Excel в формате PDF/Image, вы можете управлять этим переполнением, указав перекрестный тип с помощью[ТекстКроссТип](https://reference.aspose.com/cells/python/asposecells.api/TextCrossType) перечисление. Он имеет следующие значения
