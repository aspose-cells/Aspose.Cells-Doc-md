...
Файлы ODS создаются программой Calc, которая является частью Apache OpenOffice Suite. Файлы ODS хранят данные, которые организованы в строки и столбцы и отформатированы с использованием стандарта OASIS OpenDocument на основе XML.

Aspose.Cells для Python через Java поддерживает рабочие файлы ODS. В следующих примерах показано преобразование Excel в файл ODS.
