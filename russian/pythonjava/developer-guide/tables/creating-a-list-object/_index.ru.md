...
В приведенном ниже примере мы создали тот же[**СписокОбъект**](https://reference.aspose.com/cells/python/asposecells.api/ListObject)используя Aspose.Cells для Python через Java API, как мы создали с помощью Microsoft Excel в предыдущем разделе.
