...
![дело:изображение_альтернативный_текст](setting-list-object-comment.png)

Следующий пример кода загружает[исходный файл excel](source.xlsx), устанавливает комментарий к первой таблице или объекту списка внутри рабочего листа
