...
description: Aspose.Cells — это библиотека Python через Java для работы с файлами электронных таблиц, которая поддерживает разделение одного файла Excel на несколько файлов. В этой статье будет рассказано, как разделить файлы Excel путём копирования каждого рабочего листа в отдельную рабочую книгу и путём копирования определённых диапазонов ячеек в другие рабочие книги.
keywords: Aspose.Cells, Python через Java библиотека, электронная таблица, разделить файл Excel, копировать рабочий лист, копировать диапазон, несколько рабочих книг, сохранить как отдельные файлы
type: docs
weight: 195
url: /ru/python-java/splitting-excel-files-into-multiple-files/
...
Aspose.Cells поддерживает разделение одного файла Excel на несколько файлов. Существует два основных способа сделать это: (1) путём копирования каждого рабочего листа исходной рабочей книги в новую рабочую книгу и сохранения каждой в виде отдельного файла, и (2) путём копирования определённого диапазона ячеек из рабочего листа в новую рабочую книгу. Оба подхода полезны, когда вам нужно распределить подмножества данных, создать небольшие отчёты для разных получателей или изолировать данные для индивидуальной обработки.
...
5. Скопируйте содержимое исходного рабочего листа в целевой рабочий лист. Это можно сделать, перебирая ячейки коллекции `Cells` исходного рабочего листа и записывая их значения в соответствующие ячейки целевого рабочего листа, или используя метод `Cells.copy` для переноса всего диапазона сразу.
