---
title: Aspose.Cells для Android через Java 21.6 Примечания к выпуску
type: docs
weight: 7
url: /ru/java/aspose-cells-for-android-via-java-21-6-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для Android через Java 21.6.
...
|CELLSJAVA-43403|Размещение текста смещено влево при сохранении в формате HTML|
|CELLSJAVA-43421|Экранирующие символы и символы разрыва строки неправильно отображаются при преобразовании HTML в Excel|
|CELLSJAVA-43427|Условный формат с гистограммами, отображающими значения при экспорте в HTML|
|CELLSJAVA-43428| Формат учета в сочетании с 6-точечным шрифтом искажает числа в HTML|
...
|CELLSJAVA-43419| Пользовательский числовой формат неправильно отображается в PDF|
...
Предоставьте пользователям возможность решить, как поступить с первой одинарной кавычкой значения ячейки при экспорте/импорте файлов CSV/TSV.
