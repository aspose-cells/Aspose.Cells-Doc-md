---
title: Aspose.Cells для Android через Java 21.3 Примечания к выпуску
type: docs
weight: 10
url: /ru/java/aspose-cells-for-android-via-java-21-3-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для Android через Java 21.3.
...
|CELLSJAVA-43384|Проблема с процентами для некоторых меток при рендеринге в PDF и печати диаграмм|
...
|CELLSJAVA-43379|Возникло исключение при сохранении книги в формате HTML|
