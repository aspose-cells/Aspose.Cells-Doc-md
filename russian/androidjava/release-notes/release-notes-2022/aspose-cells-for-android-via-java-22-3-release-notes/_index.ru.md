---
title: Aspose.Cells для Android через Java 22.3 Примечания к выпуску
type: docs
weight: 10
url: /ru/java/aspose-cells-for-android-via-java-22-3-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для Android через Java 22.3.
...
|CELLSJAVA-44114|XLSX в PDF: данные в формате научных чисел из файла XLSX не совпадают с данными в выходном файле PDF|
...
|CELLSJAVA-44192| Имя элемента оси категорий на графике обрезается при преобразовании Excel в PDF|
|CELLSJAVA-44233|Бесконечный цикл при конвертации файла XLSX|
