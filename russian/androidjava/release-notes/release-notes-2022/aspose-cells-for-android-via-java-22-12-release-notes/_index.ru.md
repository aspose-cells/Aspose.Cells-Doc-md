...
|CELLSJAVA-44884| Номера в списках неверны после преобразования XLSX в HTML или PDF|
...
|CELLSJAVA-44850|При импорте файла XLT текст не отображается полностью с использованием последних демонстраций с последней версией Aspose.Cells.GridWeb с последними файлами ресурсов.|
...
|CELLSJAVA-44903|Воспроизведение SVG не работает должным образом|
