...
type: docs
weight: 20
url: /ru/java/aspose-cells-for-android-via-java-18-9-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSJAVA-41176|Неправильное выравнивание при преобразовании электронной таблицы в формат PDF|Ошибка|
...
|CELLSJAVA-41670|Неверное положение изображения диаграммы в Chrome и FireFox при преобразовании в HTML|Ошибка|
...
|CELLSJAVA-42682|Цвет градиента для негативных пузырей не применяется в выводе PDF|Ошибка|
...
|CELLSJAVA-42715|Формулы не извлекаются так же, как в файле Excel|Ошибка|
...
|CELLSJAVA-42675|NumberFormatException возникает при загрузке HTML-файла в книгу|Исключение|
|CELLSJAVA-42689|Исключение NullPointerException возникает при вызове CalculateFormula|Исключение|
|CELLSJAVA-42678|Исключение при рендеринге рабочего листа в формат файла PNG|Исключение|
