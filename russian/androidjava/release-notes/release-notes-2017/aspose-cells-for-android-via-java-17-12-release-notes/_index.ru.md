---
title: Aspose.Cells для Android via Java 17.12 Примечания к выпуску
type: docs
weight: 10
...
Эта страница содержит примечания к версии Aspose.Cells для Android via Java 17.12.
...
|CELLSJAVA-42476|Microsoft Рабочий лист Excel с поддержкой макросов (.xlsm) повреждается после открытия и сохранения via Aspose.Cells API|Ошибка|
...
Ниже приведен список любых изменений, внесенных в общедоступный API, таких как добавленные, переименованные, удаленные или устаревшие члены, а также любые несовместимые с предыдущими изменениями, внесенные в Aspose.Cells для Android via Java. Если у вас есть сомнения по поводу каких-либо перечисленных изменений, пожалуйста, поднимите его на форуме поддержки Aspose.Cells.
...
Since the code base of Aspose.Cells for Android via Java matches the code of relevant .NET and Java version(s), most of the changes, enhancements and fixes included in the Aspose.Cells for .NET v17.10, Aspose.Cells for .NET v17.11, Aspose.Cells for .NET v17. 12, Aspose.Cells for Java v17.10, Aspose.Cells for Java v17.11 и Aspose.Cells for Java v17.12 также включены в этот Aspose.Cells для 07611934781 v1.8112034
