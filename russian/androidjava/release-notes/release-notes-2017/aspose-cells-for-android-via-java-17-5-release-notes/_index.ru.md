---
title: Aspose.Cells для Android через Java 17.5 Примечания к выпуску
type: docs
weight: 30
url: /ru/java/aspose-cells-for-android-via-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску для[Aspose.Cells для Android через Java 17.5](https://downloads.aspose.com/cells/androidjava/new-releases/aspose.cells-for-android-via-java-17.5/)
...
|CELLSJAVA-42237|Доступ к ячейке создает HTML с пустыми строками|Улучшение|
|CELLSJAVA-42236|Проблема с производительностью в многопоточной среде|Улучшение|
|CELLSJAVA-42226|Ограничьтесь папкой и ее подпапками, чтобы использовать шрифты при рендеринге изображений/PDF.|Улучшение|
...
|CELLSJAVA-42136|Иврит — в таблице строки с переносом слов выравниваются по правому краю в PDF, тогда как они должны располагаться по центру, как в Excel.|Ошибка|
...
|CELLSJAVA-42126|Форма для изображения Ошибка при рендеринге 02.xls в PDF|Ошибка|
|CELLSJAVA-42087|Изображение диаграммы в HTML неверно|Ошибка|
|CELLSJAVA-42079|Неравномерная толщина линий на пересечениях при рендеринге электронной таблицы с диаграммой в PDF|Ошибка|
|CELLSJAVA-42078|Метки диаграмм не отображаются/не отображаются (как в исходном файле Excel) в выходном файле PDF.|Ошибка|
|CELLSJAVA-42076|Неправильный угол меток оси X в PDF-файле диаграммы|Ошибка|
...
|CELLSJAVA-42069|Модуль Vba теряется при повторном сохранении файла XLSM в Linux|Ошибка|
...
|CELLSJAVA-42230|Дополнительный атрибут выравнивания генерируется при преобразовании XLSX в HTML.|Ошибка|
|CELLSJAVA-42229|Экспорт XLSX в HTML — вместо фактических значений Cell генерируются хэш-символы.|Ошибка|
|CELLSJAVA-42218|HTML неправильно конвертируется в файл Excel|Ошибка|
|CELLSJAVA-42210|Часть условного форматирования DataBar отсутствует в выходном HTML.|Ошибка|
|CELLSJAVA-41783|Фоновое изображение должно быть в формате SVG, но оно в формате PNG.|Ошибка|
|CELLSJAVA-42253|Зависимое значение ячейки вызывает ошибку в XLS|Ошибка|
...
|CELLSJAVA-42243|Excel в PDF - квадрат выглядит как прямоугольник|Ошибка|
|CELLSJAVA-42242|Excel в PDF - Круг выглядит как овал|Ошибка|
...
|CELLSJAVA-42246|Excel в HTML - неправильное выравнивание текста в метке оси Y диаграммы|Ошибка|
|CELLSJAVA-42223|Точки диаграммы радара xy px возвращают 0|Ошибка|
|CELLSJAVA-42216|Связанные значения оси Y пузырьковой диаграммы изменяются при преобразовании AxisScalingValuesIssue-2.xlsx в PDF|Ошибка|
|CELLSJAVA-42250|Ошибка компиляции, если код содержит определение переменной с типом CommandBar|Ошибка|
|CELLSJAVA-42241|Excel в PDF - скобки идут в следующей строке|Ошибка|
|CELLSJAVA-42234|Сохранение файла XLSM как XLS устраняет действие макроса с кнопки|Ошибка|
...
|CELLSJAVA-42282|При копировании рабочего листа отображаются отфильтрованные строки в выходном HTML-файле.|Ошибка|
...
|CELLSJAVA-42251|Заголовок скрыт метками тенденций в выходном PDF-файле|Ошибка|
...
Since the code base of Aspose.Cells for Android via Java matches the code of relevant .NET and Java version(s), most of the changes, enhancements and fixes included in the Aspose.Cells for .NET v17.1.0, Aspose.Cells for .NET v17.2.0, Aspose.Cells for .NET v17. 3.0, Aspose.Cells for .NET v17.4.0, Aspose.Cells for .NET v17.5, Aspose.Cells for Java v17.1.0, Aspose.Cells for Java v17.2.0, Aspose.Cells for Java v17.3.0, Aspose.Cells for Java v17.4.0 and Aspose.Cells for Java v17.5 are also included in this Aspose.Cells for Android через Java v17.5.
