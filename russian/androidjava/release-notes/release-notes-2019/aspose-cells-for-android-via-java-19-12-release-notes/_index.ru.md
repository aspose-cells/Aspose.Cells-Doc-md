---
title: Aspose.Cells для Android через Java 19.12 Примечания к выпуску
type: docs
weight: 10
url: /ru/java/aspose-cells-for-android-via-java-19-12-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для Android через Java 19.12.
...
|CELLSJAVA-43019|Радиальный график неправильно отображается в HTML|Ошибка|
|CELLSJAVA-43027|После преобразования в PNG масштабирование оси другое.|Ошибка|
...
|CELLSJAVA-43039|Cell.setHtmlString() не отображает определенные HTML-теги/скрипты для экспорта в Excel|Ошибка|
|CELLSJAVA-41103|Цвет и форматирование данных сводной таблицы отображаются неправильно|Ошибка|
|CELLSJAVA-43007|PDF не создается должным образом|Ошибка|
...
|CELLSJAVA-43054|Проблема с объединением CSV в настройках португальского языка|Ошибка|
...
|CELLSJAVA-42923|Исключения при загрузке документа XLS|Исключение|
...
Получает или задает экспортируемую CellArea текущего активного рабочего листа. Если вы установите этот атрибут, область печати текущего активного рабочего листа будет опущена. Только указанная область будет экспортирована при сохранении файла в формате HTML.
