---
title: Aspose.Cells для Android через Java 19.9 Примечания к выпуску
type: docs
weight: 20
url: /ru/java/aspose-cells-for-android-via-java-19-9-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для Android через Java 19.9.
...
|CELLSJAVA-42929|Изменения заголовка графика при преобразовании XLSX в PDF|Ошибка|
|CELLSJAVA-42933|Изменение цвета графики при преобразовании файла Excel в PDF|Ошибка|
|CELLSJAVA-42946|Неправильный рендеринг линейчатой диаграммы с накоплением с сериями в PDF|Ошибка|
...
|Ошибка|
|CELLSJAVA-42970|Нежелательная расширенная линия границы в рендеринге Excel в PDF|Ошибка|
...
|CELLSJAVA-42957|Недопустимое значение FontUnderlineType выдается при сохранении XLSX|Исключение|
