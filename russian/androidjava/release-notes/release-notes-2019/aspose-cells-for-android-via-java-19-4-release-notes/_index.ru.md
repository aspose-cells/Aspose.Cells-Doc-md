---
title: Aspose.Cells для Android через Java 19.4 Примечания к выпуску
type: docs
weight: 40
url: /ru/java/aspose-cells-for-android-via-java-19-4-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для Android через Java 19.4.
...
|CELLSANDROID-88|Изображение потеряно во время преобразования книги в PDF|Ошибка|
|CELLSJAVA-42852|Метка на обеих осях не отображается|Ошибка|
|CELLSJAVA-42856|Проблема с Excel в HTML|Ошибка|
...
|CELLSJAVA-42874|Потеря столбца при экспорте файла в HTML|Ошибка|
...
|CELLSJAVA-40419|Не удается создать PDF с тегами при экспорте из Excel в PDF|Ошибка|
|CELLSJAVA-40570|Неправильная конвертация в PDF и JPG для страниц разного размера|Ошибка|
...
|CELLSJAVA-42860|java.lang.NullPointerException при загрузке формата файла ODS|Исключение|
