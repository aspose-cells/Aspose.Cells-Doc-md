...
|CELLSJAVA-41810|Текст становится перегруженным и перекрывается в изображении EMF|Ошибка|
|CELLSJAVA-41801|Текстовые метки перекрываются в изображении EMF|Ошибка|
|CELLSJAVA-41834|Исключение возникает при копировании книги|Ошибка|
|CELLSJAVA-41819|Электронная таблица в HTML: неправильное выравнивание текста в форме после копирования темы из исходной электронной таблицы|Ошибка|
|CELLSJAVA-41824|График не отображается в выходном PDF|Ошибка|
|CELLSJAVA-41805|Метки оси X отсутствуют в PDF-файле диаграммы|Ошибка|
|CELLSJAVA-41767|Неправильный числовой формат меток оси X в PDF-файле диаграммы|Ошибка|
|CELLSJAVA-41640|Длинные дефисы не отображаются должным образом в выходном файле PDF/изображении для диаграммы.|Ошибка|
...
|CELLSJAVA-41869|Выравнивание текста изменено после повторного сохранения XLS-файла шаблона|Ошибка|
...
|CELLSJAVA-41840|Aspose.Cells добавляет ноль в конце пути к ресурсам HTML|Ошибка|
...
|CELLSJAVA-41874|Положение символа в обработанном PDF-файле отличается от XLS-файла.|Ошибка|
|CELLSJAVA-41852|Перекрытие текста при преобразовании рабочего листа в EMF в Linux|Ошибка|
|CELLSJAVA-41823|Плотность текста и разрывы строк отличаются от формата PDF, созданного в Excel.|Ошибка|
|CELLSJAVA-41822|Текст обрезается и накладывается при преобразовании электронной таблицы в PDF|Ошибка|
|CELLSJAVA-41856|Проблемы с рендерингом диаграммы в PDF|Ошибка|
...
|CELLSJAVA-41903|Ориентация символов отличается при рендеринге в PDF|Ошибка|
|CELLSJAVA-41896|Некоторые символы отсутствуют или неправильно вставлены при преобразовании Excel в PDF|Ошибка|
...
|CELLSJAVA-41894|Проблема пробелов в символах при рендеринге электронной таблицы в PDF|Ошибки|
|CELLSJAVA-41893|Фоновое изображение искажено или размыто в выходном PDF-файле|Ошибка|
|CELLSJAVA-41892|Фоновое изображение растянуто в выходном PDF|Ошибка|
|CELLSJAVA-41916|Неработающие ссылки на внешние формулы при использовании Cells.copyColumns|Ошибка|
|CELLSJAVA-41915|Поврежденный файл XLSX после замены текста|Ошибка|
...
|CELLSJAVA-41913|Исключение: «IllegalArgumentException: длина» при загрузке файла Excel (XLS)|Исключение|
...
### **Добавляет свойство HTMLLoadOptions.SupportDivTag.**
 Указывает, поддерживает ли макет<div> тег, если файл HTML содержит<div> теги. Значение по умолчанию — false.
