...
|CELLSJAVA-41928|Невозможно перехватить ресурс изображения при рендеринге электронной таблицы в HTML с помощью IStreamProvider|Ошибка|
|CELLSJAVA-41841|Проблема с рендерингом флажков в HTML|Ошибка|
...
|CELLSJAVA-41931|Интервал между символами и разрыв неверны для вертикального текста при рендеринге электронной таблицы в PDF|Ошибка|
|CELLSJAVA-41709|Ширина столбцов в CentOS отличается от ширины Windows.|Ошибка|
|CELLSJAVA-41933|Масштаб диаграммы сместился при рендеринге электронной таблицы в PDF|Ошибка|
|CELLSJAVA-41934|Проблема выравнивания при рендеринге файла Excel в PDF|Ошибка|
|CELLSJAVA-41935|Форматирование записей легенды нарушается при рендеринге электронной таблицы в PDF|Ошибка|
...
|CELLSJAVA-41937|Некоторые значения из файла Excel отсутствуют в выходном HTML — преобразование XLS в HTML|Ошибка|
|CELLSJAVA-41969|Cell отсутствует затенение при преобразовании HTML в XLSX|Ошибка|
|CELLSJAVA-41955|Рабочая книга в HTML показывает «#» в ячейках|Ошибка|
|CELLSJAVA-41942|Отсутствуют границы, затенение ячеек и изображения — рендеринг HTML в Excel|Ошибка|
|CELLSJAVA-41967|Cells отсутствует в PDF, если несколько областей печати определены на одном листе|Ошибка|
...
|CELLSJAVA-41981|Неправильное положение вертикальной линии в PDF-файле диаграммы|Ошибка|
...
Получает или задает IFilePathProvider для отдельного экспорта Worksheet в HTML.
...
Получает или задает идентификатор класса встроенного объекта.
