---
title: Aspose.Cells для Python через .NET 22.11 Примечания к выпуску
type: docs
weight: 6
url: /ru/python-net/aspose-cells-for-python-net-22-11-release-notes/
---
{{% alert color="primary" %}} 

Это первая версия для Aspose.Cells для Python через .NET.
Эта страница содержит примечания к выпуску Aspose.Cells для Python через .NET 22.11.
...
|CELLSNET-51939|XLSX в PDF: несовпадение содержимого|
|CELLSNET-51940|XLS в PDF: несовпадение содержимого в ячейках|
|CELLSNET-52068|XLSX в PDF: фигуры отсутствуют/разворот макета|
...
|CELLSNET-52225|XLSX в PDF Символы в текстовых полях перевернуты|
...
|CELLSNET-52143| Тип отношения ссылки изменяется при преобразовании файла XLS в XLSM.|
|CELLSNET-52144|Преобразование XLS в XLSM с изменением типа связи ссылки|
...
|CELLSNET-52181|XLSX в HTML: диапазон Cells экспортируется неправильно|
...
|CELLSNET-52241|Блоки (фигуры) в документе не отображаются в выходном PDF-файле.|
