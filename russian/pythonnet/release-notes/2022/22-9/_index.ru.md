---
title: Aspose.Cells для Python через .NET 22.9 Примечания к выпуску
type: docs
weight: 8
url: /ru/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 

Это первая версия для Aspose.Cells для Python через .NET.
Эта страница содержит примечания к выпуску Aspose.Cells для Python через .NET 22.9.
...
|CELLSNET-50960|Повторно сохраненный файл XLSM (содержащий сводную таблицу) был поврежден|
|CELLSNET-51506|Внешние соединения повреждены в сгенерированном файле|
|CELLSNET-51735|Неправильный жирный шрифт текста при преобразовании сводной таблицы Excel в PDF|
...
|CELLSNET-51800|Значения из XLSX неверны в выходном PDF|
...
|CELLSNET-51187|Вертикальные пунктирные линии не совпадают с метками на оси на диаграмме для рендеринга SVG|
|CELLSNET-51734|Для зависимости System.Security.Cryptography.Pkcs 6.0.1 требуется .NET Core 3.1|
|CELLSNET-51912|При преобразовании Excel в PDF результирующий PDF-файл неправильно отображает ось|
|CELLSNET-51744|Gridweb продолжает прыгать назад|
|CELLSNET-51608|Число скрыто за красным/зеленым кружком при экспорте Excel в HTML в докере (Azure Cloud kubernetes)|
|CELLSNET-51864|Проблема с вычислением "PageSetup.Zoom" с HorizontalPageBreaks|
|CELLSNET-51938|XLSX в PDF: неверный интервал между символами|
|CELLSNET-51226|Добавить атрибут идентификатора для диаграммы/группы в книге Excel|
|CELLSNET-51461|Добавлены ненужные границы для преобразования данных в Excel в DOCX|
...
|CELLSNET-51778|Преобразование файла XLS в XLSM удаляет несколько символов в конце ссылки в именованных диапазонах.|
...
|CELLSNET-51865|На листе XLS нет данных, хотя вы можете видеть заполненные строки в Excel|
...
|CELLSNET-51961|Исключение «Индекс был вне допустимого диапазона» при рендеринге ODS в PDF|
