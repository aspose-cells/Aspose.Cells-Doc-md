...
type: docs
weight: 250
url: /ru/python-net/aspose-cells-gridjs/highlight/
...
keywords: выделение,таблица,исправление,замечания,эксель,комментарий	
---
...
- Установить выделение всех объектов в активном рабочем листе, включая все формы и изображения, а также всю область листа
```javascript
...
- Очистить настройки выделения для активного рабочего листа
```javascript
...
- скрыть/показать содержимое текста в объекте текстового поля
```javascript
    hideText(boolvalue)
    // the parameters are:
...
Больше информации можно найти на нашей странице демонстрации github https://github.com/aspose-cells/Aspose.Cells.Grid-for-Python-via-.NET/blob/main/Examples.GridJs/templates/index.html
