---
title: как настроить внешний вид пользовательского интерфейса для модального окна в GridJs  
type: docs
weight: 250
url: /ru/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Эта статья описывает, как настроить внешний вид пользовательского интерфейса для модального окна в GridJs.
keywords: GridJs,настройка,модальное окно,интерфейс,внешний вид,визуальный,окно
aliases:
aliases:
...
# Руководство по стилизации модальных окон для GridJs

## Оглавление

- [Обзор](#overview)
- [Именование CSS-классов](#css-class-naming)
- [Быстрый старт](#quick-start)
- [Примеры красивых стилей](#beautiful-style-examples)
...
### Доступные имена модальных окон

| Тип модального окна | Название | CSS Класс |
|------------|------|-----------|
| Сортировка | `sort` | `.x-spreadsheet-modal-sort` |
| Валидация | `validation` | `.x-spreadsheet-modal-validation` |
| Поиск | `search` | `.x-spreadsheet-modal-search` |
| Контроль | `control` | `.x-spreadsheet-modal-control` |
| Загрузка | `download` | `.x-spreadsheet-modal-download` |
| Электронная почта | `email` | `.x-spreadsheet-modal-email` |
| Предложение ввода | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| Вставить URL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| Ссылка | `link` | `.x-spreadsheet-modal-link` |
| Печать | `print` | `.x-spreadsheet-modal-print` |
| Поворот текста | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| Проверка данных | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| Больше форматов чисел | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| Предупреждение проверки | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| Вставить/Удалить | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Пример 2: Минималистичная чистая тема 🤍

Идеально подходит для профессиональных и корпоративных приложений.
...
### Пример 3: Тема темного режима 🌙

Отлично для приложений с поддержкой темного режима.
...
### Пример 4: Игривая цветная тема 🌈

Идеально для творческих и развлекательных приложений.
...
### Пример 5: Корпоративная профессиональная тема 💼

Подходит для бизнес и корпоративных приложений.
...
### Пользовательский полосы прокрутки
...
### 7. Поддержание визуальной иерархии
