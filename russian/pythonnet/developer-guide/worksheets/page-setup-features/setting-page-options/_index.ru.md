...
type: docs
weight: 10
url: /ru/python-net/setting-page-options/
description: В этой статье приведен образец кода для установки параметров страниц листов Excel программно с использованием API Aspose.Cells для Python via .NET. Вы сможете установить ориентацию страницы, коэффициент масштабирования, параметры FitToPages, формат бумаги, качество печати, номер первой страницы.
keywords: Библиотека Excel для Python, Установка ориентации страницы Excel в Python, Установка коэффициента масштабирования Excel с помощью Python, Установка размера бумаги для листов Excel в Python, Как установить ориентацию страницы в Python, Как установить коэффициент масштабирования в Python, Как установить параметры FitToPages в Python, Как установить размер бумаги в Python, Как установить качество печати в Python, Как установить номер первой страницы в Python.
---
...
Параметры настройки страниц полностью поддерживаются в Aspose.Cells для Python via .NET. В этой статье объясняется, как настроить параметры страницы с помощью Aspose.Cells для Python via .NET и приводятся примеры кода для настройки:
...
Класс [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet) предоставляет свойство [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup), которое используется для установки параметров настройки страницы листа. Фактически, это свойство [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup) является объектом класса [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup), используемым для установки различных параметров макета страницы для печатного листа. Класс [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup) предоставляет различные свойства, используемые для установки параметров настройки страницы. Рассмотрим некоторые из этих свойств ниже.

## **Как установить ориентацию страницы**

Ориентацию страницы можно установить в книжную или альбомную с помощью свойства [**orientation**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/orientation) класса [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup). Свойство [**orientation**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/orientation) принимает одно из предопределенных значений в перечислении [**PageOrientationType**](https://reference.aspose.com/cells/python-net/aspose.cells/pageorientationtype), перечисленных ниже.
...
## **Как установить коэффициент масштабирования**

Можно уменьшить или увеличить размер листа, изменив фактор масштабирования с помощью свойства [**PageSetup.zoom**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/zoom).

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Worksheets-PageSetupFeatures-ScalingFactor-1.py" >}}

## **Как установить параметры FitToPages**

Для расположения содержимого листа на определенное количество страниц используйте свойства [**fit_to_pages_tall**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/fit_to_pages_tall/) и [**fit_to_pages_wide**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/fit_to_pages_wide/) класса [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup). Эти свойства также используются для масштабирования листов.

{{% alert color="primary" %}}

Вы можете выбрать либо [**fit_to_pages_tall**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/fit_to_pages_tall/) и [**fit_to_pages_wide**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/fit_to_pages_wide/), либо свойство [**zoom**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/zoom), но не оба одновременно.

{{% /alert %}}

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Worksheets-PageSetupFeatures-FitToPagesOptions-1.py" >}}

## **Как установить размер бумаги**

Установите размер бумаги, на которую будут напечатаны листы, используя свойство [**paper_size**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/paper_size/) класса [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup). Свойство [**paper_size**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/paper_size/) принимает одно из предопределенных значений в перечислении [**PaperSizeType**](https://reference.aspose.com/cells/python-net/aspose.cells/papersizetype/), перечисленных ниже.
...
## **Как установить качество печати**

Установите качество печати листов, используя свойство [**print_quality**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/print_quality/) класса [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/). Единица измерения качества печати - точек на дюйм (DPI).

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Worksheets-PageSetupFeatures-SetPrintQuality-1.py" >}}

## **Как установить номер первой страницы**
