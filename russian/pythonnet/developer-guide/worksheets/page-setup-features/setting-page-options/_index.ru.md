...
description: В этой статье предоставляется пример кода для программного установления параметров страниц листов Excel с помощью API Aspose.Cells для Python via .NET. Вы сможете установить ориентацию страницы, коэффициент масштабирования, параметры FitToPages, размер бумаги, качество печати, номер первой страницы.
keywords: Библиотека Excel для Python, установка ориентации страницы Excel с помощью Python, установка коэффициента масштабирования Excel с помощью Python, установка размера бумаги листов Excel в Python, Как установить ориентацию страницы с помощью Python, Как установить коэффициент масштабирования, Как установить параметры FitToPages, Как выбрать размер бумаги, Как установить качество печати, Как задать номер первой страницы.
---
...
Параметры настройки страницы полностью поддерживаются в Aspose.Cells для Python via .NET. В этой статье объясняется, как установить параметры страницы с помощью Aspose.Cells для Python via .NET, и показаны образцы кода для установки:
