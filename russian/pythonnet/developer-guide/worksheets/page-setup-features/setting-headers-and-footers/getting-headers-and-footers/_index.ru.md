...
description: В этой статье объясняется, как программно получить заголовки и нижние колонтитулы из файлов Excel или OpenOffice с использованием API Aspose.Cells для Python via .NET.
keywords: Библиотека Python Excel, Python получить заголовки и нижние колонтитулы, Разбор заголовков и нижних колонтитулов в список команд с помощью Python.
---
...
## **Как получить заголовки и нижние колонтитулы в MS Excel**
...
## **Как получить заголовки и нижние колонтитулы с использованием библиотеки Excel для Python Aspose.Cells**
...
## **Как разбирать заголовки и нижние колонтитулы в список команд**
...
Aspose.Cells для Python via .NET предоставляет метод [**Worksheet.page_setup.get_commands**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/get_commands/#str) для разбора заголовков и нижних колонтитулов как списка команд.
