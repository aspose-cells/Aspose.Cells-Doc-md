...
description: В этой статье объясняется, как программно вставить изображение в заголовок и нижний колонтитул листов Excel, установив заголовок и нижний колонтитул с помощью команд сценария с использованием API Aspose.Cells для Python via .NET.
keywords: Библиотека Python Excel, вставка изображения в заголовок и нижний колонтитул Excel, установка команд сценария заголовка и колонтитула Excel с использованием Python.
---
