...
description: В данной статье объясняется, как использовать образец кода Aspose.Cells для Python via .NET для программного определения того, является ли размер бумаги листа автоматическим.
keywords: Библиотека Python Excel, определение в Python является ли размер бумаги листа автоматическим.
---
