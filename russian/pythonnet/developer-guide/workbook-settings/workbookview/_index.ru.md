---
title: Как управлять видом книги
type: docs
weight: 600
url: /ru/python-net/how-to-control-workbook-view/
description: Узнайте, как управлять отображением рабочей книги через API Aspose.Cells для Python via .NET.
...
Когда вам нужно настроить отображение страниц Excel, вам нужно знать, как управлять каждым модулем, таким как горизонтальные и вертикальные полосы прокрутки, скрывать или открывать файлы Excel и так далее. Aspose.Cells предлагает эту функцию. Aspose.Cells предоставляет следующие свойства и методы, чтобы помочь вам достичь ваших целей.
