---
title: Заменить тег текстом в текстовом поле внутри листа с помощью Python.NET
linktitle: Замена тега текстом в текстовом поле внутри Рабочей Книги
type: docs
weight: 1100
url: /ru/python-net/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Узнайте, как заменить теги на текст в текстовых полях внутри листов Excel с помощью Aspose.Cells для Python via .NET.
---
...
## **Образец кода**
В следующем образце кода заменяются теги TAG_1 и TAG_2 на некоторый текст, скажем 'ys' и '1'. Образец файла для тестирования нижеуказанного кода можно загрузить по следующей ссылке:
