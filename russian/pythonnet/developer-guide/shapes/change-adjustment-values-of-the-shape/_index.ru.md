...
В данной статье будет объяснено использование свойства [**Shape.geometry.shape_adjust_values**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/geometry/shape_adjust_values/) для изменения значения корректировки различных форм.
