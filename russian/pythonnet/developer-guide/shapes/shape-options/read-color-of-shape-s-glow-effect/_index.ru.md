---
title: Чтение цвета эффекта свечения фигуры
type: docs
weight: 330
url: /ru/python-net/read-color-of-shape-s-glow-effect/
---

## Возможные сценарии использования

Если вы хотите узнать цвет эффекта свечения любой фигуры, пожалуйста, используйте свойство [**Shape.glow.color**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/gloweffect/color). Это поможет вам найти различные свойства, относящиеся к цвету эффекта свечения фигуры.
...
## Код C# для чтения цвета свечения фигур
