---
title: Ось дат
description: Узнайте, как управлять датированной осью в Aspose.Cells для Python via .NET. Наше руководство поможет вам понять, как работать с различными форматами дат, шкалами времени и частотой меток делений.
keywords: Aspose.Cells для Python via .NET, дата ось, управление, форматы дат, шкалы времени, частота меток делений.
type: docs
weight: 200
url: /ru/python-net/date-axis/
---
...
Затем мы добавляем диаграмму и устанавливаем тип [**Axis**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/axis) 
на [**TIME_SCALE**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/categorytype/), а затем устанавливаем базовые единицы в Дни.
