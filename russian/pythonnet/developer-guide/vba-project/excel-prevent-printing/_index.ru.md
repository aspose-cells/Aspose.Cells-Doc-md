...
type: docs
weight: 600
url: /ru/python-net/how-to-prevent-printing-excel/
description: Узнайте, как можно предотвратить печать Excel через API Aspose.Cells для Python via .NET.
...
## **Как предотвратить печать Excel-файла с помощью Aspose.Cells для Python via .NET**
