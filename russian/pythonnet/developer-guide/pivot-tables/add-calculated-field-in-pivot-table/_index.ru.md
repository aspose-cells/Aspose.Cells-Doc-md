...
5. В поле «Формула» введите формулу расчета, который вы хотите выполнить, используя соответствующие имена полей сводной таблицы и математические операторы.
<br>
...
##  **Добавьте вычисляемое поле в сводную таблицу, используя C#**
Добавьте вычисляемое поле в файл Excel, используя Aspose.Cells for Python via .NET. См. следующий пример кода. После выполнения примера кода на лист добавляется сводная таблица с вычисляемым полем.
...
2. Создайте вычисляемое поле в соответствии с существующим PivotField в сводной таблице.
 ...
 4. Наконец, книга сохраняется в[вывод XLSX](out.xlsx) формат.
