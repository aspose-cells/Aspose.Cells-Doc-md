...
## **Открытие файла только с данными**
 ...
 Чтобы открыть файл только с данными, используйте**Параметры загрузки** и**Загрузить фильтр**классы, чтобы установить связанные атрибуты и параметры классов для загружаемого файла шаблона.
