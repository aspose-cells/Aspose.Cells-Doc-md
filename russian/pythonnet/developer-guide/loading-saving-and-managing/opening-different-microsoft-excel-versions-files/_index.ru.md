...
## **Открытие файлов разных версий Microsoft Excel**
 ...
 Приложение часто должно иметь возможность открывать файлы Excel Microsoft, созданные в разных версиях, например, Microsoft Excel 95,97 или Microsoft Excel 2007/2010/2013/2016/2019 и Office 365. Вам может понадобиться загрузить файл в любом из нескольких форматов, включая XLS, XLSX, XLSM, XLSB, SpreadsheetML, TabDelimited или TSV, CSV, ODS и так далее. Используйте конструктор или укажите**Рабочая тетрадь** учебный класс'**формат файла**атрибут типа, который определяет формат с помощью**FileFormatType**перечисление.
...
|XLTX|Представляет файл Excel 2007/2010/2013/2016/2019 и Office 365 с поддержкой макросов XLTM.|
...
Чтобы открыть формат Microsoft Excel 2007/2010/2013/2016/2019 и Office 365, то есть XLSX или XLSB, укажите путь к файлу. Вы также можете использовать**Параметры загрузки** и установите соответствующий атрибут/параметры**Параметры загрузки**class для загружаемого файла шаблона.
