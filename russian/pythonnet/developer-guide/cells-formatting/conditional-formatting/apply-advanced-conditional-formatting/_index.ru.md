...
- Полосы данных для визуализации числовых значений
- Цветовые шкалы для градиентного затенения ячеек
- Наборы значков для графических индикаторов
- Правила для верхних/нижних значений
- Форматирование по временным периодам

Этот пример демонстрирует различные типы расширенного условного форматирования с помощью Python.NET:
