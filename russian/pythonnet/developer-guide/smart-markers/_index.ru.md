---
title: Умный импорт и размещение данных с помощью умных маркеров в Python через .Net
linktitle: Умные маркеры
type: docs
weight: 190
url: /ru/python-net/using-smart-markers/
description: Умный импорт и размещение данных в соответствии с шаблонными файлами Excel с помощью библиотеки Aspose.Cells для Python через .Net.
---
...
Очень легко обрабатывать умные маркеры. Далее приведен фрагмент кода на Python через .Net, который показывает, как это делается.
