---
title: Aspose.Cells для PHP через Java 21.10 Примечания к выпуску
type: docs
weight: 3
...
{{% alert color="primary" %}}
 ...
 Эта страница содержит примечания к выпуску для[Aspose.Cells для PHP через Java 21.10](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-21.10/).
