---
title: Aspose.Cells для PHP через Java 20.2 Примечания к выпуску
type: docs
weight: 10
url: /ru/php-java/aspose-cells-for-php-via-java-20-2-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для PHP через Java 20.2.
