---
title: Aspose.Cells для PHP через Java 19.8 Примечания к выпуску
type: docs
weight: 10
url: /ru/php-java/aspose-cells-for-php-via-java-19-8-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.Cells для PHP через Java 19.8.
