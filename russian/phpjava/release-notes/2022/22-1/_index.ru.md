---
title: Aspose.Cells для PHP через Java 22.1 Примечания к выпуску
type: docs
weight: 12
url: /ru/php-java/aspose-cells-for-php-via-java-22-1-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells для PHP через Java 22.1](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.1/).
