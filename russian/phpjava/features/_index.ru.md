...
description: "Характеристики Aspose.Cells для PHP via Java."
---

## **Обзор характеристик Aspose.Cells для PHP via Java**
Этот раздел предоставляет сравнение доступности функций между Aspose.Cells for Java и Aspose.Cells для PHP via Java.
...
|**Характеристика**|**Описание**|**Aspose.Cells for Java**|**Aspose.Cells для PHP via Java**|
| :- | :- | :- | :- |
...
|**Характеристика**|**Aspose.Cells for Java**|**Aspose.Cells для PHP via Java**|
| :- | :- | :- |
