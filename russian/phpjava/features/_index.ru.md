...
type: docs
weight: 5
url: /ru/php-java/features/
keywords: php, excel, api, feature
description: Aspose.Cells for PHP via Java особенности
---
## **Aspose.Cells for PHP via Java Обзор функций**
В этом разделе представлено сравнение доступности функций между Aspose.Cells for Java и Aspose.Cells for PHP via Java.
...
|**Особенность**|**Описание**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
|:- |:- |:- |:- |
...
|Электронная таблицаML (XLSX, XML)| Aspose.Cells поддерживает OOXML, Flat OPC, а также Excel 2003 XML. Более того,<br>компонент поддерживает все основные форматы файлов Excel 2007 и более поздних версий, например XLSX, XLTX, XLSM, XLTM и т. д.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Особенность**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
|:- |:- |:- |
...
|Преобразование страниц рабочего листа в растровые изображения (многостраничный TIFF, GIF).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
