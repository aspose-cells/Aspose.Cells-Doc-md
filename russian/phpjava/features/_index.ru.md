...
description: Aspose.Cells для PHP через функции Java
---
## **Aspose.Cells для PHP через Java Обзор функций**
В этом разделе представлено сравнение доступности функций между Aspose.Cells for Java и Aspose.Cells для PHP через Java.
...
|**Особенность**|**Описание**|**Aspose.Cells for Java**|**Aspose.Cells для PHP через Java**|
|:- |:- |:- |:- |
...
|**Особенность**|**Aspose.Cells for Java**|**Aspose.Cells для PHP через Java**|
|:- |:- |:- |
