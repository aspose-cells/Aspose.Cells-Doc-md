...
|[ODS](https://docs.fileformat.com/spreadsheet/ods/)|ODS (таблица OpenDocument).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|SpreadsheetML|XML-файл Excel 2003.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[Numbers](https://docs.fileformat.com/spreadsheet/numbers/)|Документ создан приложением Apple «Numbers», которое является частью офисного пакета Apple iWork — набора приложений, работающих в операционных системах Mac OS X и iOS.|{{< emoticons/tick >}}||
...
|[MARKDOWN](https://docs.fileformat.com/word-processing/md/)|Представляет документ уценки.| |{{< emoticons/tick >}}|
