...
## **Ограничения ознакомительной версии**
 Бесплатную ознакомительную версию Aspose.Cells for C++ можно загрузить из раздела загрузок веб-сайта Aspose по адресу:<https://downloads.aspose.com/cells/cpp>.
## **Применить лицензию с помощью файлового или потокового объекта**
Лицензия может быть загружена из файла или потокового объекта. Aspose.Cells for C++ попытается найти лицензию в следующих местах:
