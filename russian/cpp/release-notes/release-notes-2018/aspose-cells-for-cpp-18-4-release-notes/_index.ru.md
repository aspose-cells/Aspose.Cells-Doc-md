...
type: docs
weight: 30
url: /ru/cpp/aspose-cells-for-cpp-18-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSCPP-69|Решите проблемы в тестовых примерах C++|Новая особенность|
...
|CELLSCPP-75|Реализовать функцию C++: рисовать изображение из потока|Новая особенность|
|CELLSCPP-76|Реализовать классы C++: ComIStreamWrapper, Metafile|Новая особенность|
|CELLSCPP-77|Тестовый пример Debug C++: Копии|Новая особенность|
|CELLSCPP-78|Решить задачи в C++ тестовых примерах: модули DigitalSignature, EnumTypes, Finds, Formulas, Hyperlinks|Новая особенность|
|CELLSCPP-79|Решить проблему со ссылкой версии выпуска C++|Новая особенность|
...
|CELLSCPP-97|Отладка и устранение проблем, связанных с рендерингом XLSX/XLS в PDF|Новая особенность|
