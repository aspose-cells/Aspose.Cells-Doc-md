...
type: docs
weight: 10
url: /ru/cpp/aspose-cells-for-cpp-16-12-0-release-notes/
---
...
|CELLSPORTINGC-426|Проблема с лицензией Aspose.Cells для C++ API|Ошибка|
|CELLSPORTINGC-425|Оптимизация производительности сохранения файлов XLS|Улучшение|
