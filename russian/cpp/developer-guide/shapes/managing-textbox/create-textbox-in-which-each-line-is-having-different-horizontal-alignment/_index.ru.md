---
title: Создайте TextBox, в котором каждая строка имеет разное горизонтальное выравнивание с помощью C++
linktitle: Создайте TextBox с разным горизонтальным выравниванием
type: docs
weight: 310
url: /ru/cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Узнайте, как создавать TextBox с разным горизонтальным выравниванием для каждой строки с помощью Aspose.Cells и C++.
---

{{% alert color="primary" %}}

Вы можете установить горизонтальное выравнивание текста абзаца, используя свойство [**TextParagraph.GetAlignmentType()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.texts/textparagraph/getalignmenttype/).
