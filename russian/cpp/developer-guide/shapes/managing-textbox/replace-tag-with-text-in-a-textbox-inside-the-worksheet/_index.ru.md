---
title: Замените тег на текст в текстовом поле внутри Рабочего листа с помощью C++
linktitle: Замена тега текстом в текстовом поле внутри Рабочей Книги
type: docs
weight: 1100
url: /ru/cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Программно заменяйте теги в текстовых полях листа, используя Aspose.Cells for C++.
---
