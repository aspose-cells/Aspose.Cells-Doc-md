...
Вы можете использовать Aspose.Cells для поиска или поиска данных различными способами, используя следующий метод. Эти методы находят данные по их именам.

- [FindNumber](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_cell#a7f90de51db6984956b5ed0b33b73a111)
- [НайтиФормулу](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_cell#ae3a8a9cfe7f8dc84ea590a8472e194f1)
...
- [FindStringEndsWith](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_cell#a7d0c58798771b7bc220fb162c30f247b)
 ...
 Следующий пример кода иллюстрирует использование вышеуказанных методов с помощью[образец эксель файла](21266434.xlsx) как показано на этом снимке экрана.
...
## **Консольный вывод**
 Это консольный вывод приведенного выше примера кода при выполнении с заданным[образец эксель файла](21266434.xlsx).
