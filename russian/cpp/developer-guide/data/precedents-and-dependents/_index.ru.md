...
{{% /alert %}} 
## **Введение**
- **Предыдущие ячейки** это ячейки, на которые ссылается формула в другой ячейке. Например, если ячейка D10 содержит формулу =B5, ячейка B5 является предшествующей ячейке D10.
