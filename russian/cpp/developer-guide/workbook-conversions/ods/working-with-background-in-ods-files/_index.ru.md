---
title: Работа с фоном в файлах ODS с помощью C++
linktitle: Работа с фоном в файлах ODS
type: docs
weight: 150
url: /ru/cpp/working-with-background-in-ods-files/
description: Узнайте, как управлять цветными и графическими фонами в файлах ODS с использованием Aspose.Cells на C++.
---
...
Aspose.Cells предоставляет класс [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/) для управления фоном в файлах ODS. Следующий пример демонстрирует использование класса [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/), загружая исходный файл [ODS](90112030.ods) и считывая информацию о фоне. Посмотрите вывод консоли, сгенерированный этим кодом, для справки.
...
Aspose.Cells предоставляет класс [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/) для управления фоном в файлах ODS. Следующий пример демонстрирует использование свойства [**OdsPageBackground.Color**](https://reference.aspose.com/cells/cpp/aspose.cells/color/) для добавления цветового фона в файл ODS. Посмотрите сгенерированный этим кодом [выходной файл ODS](90112031.ods) для справки.
...
Aspose.Cells предоставляет класс [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/) для управления фоном в файлах ODS. Следующий пример демонстрирует использование свойства [**OdsPageBackground.GetGraphicData()**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/getgraphicdata/) для добавления графического фона в файл ODS. Посмотрите сгенерированный этим кодом [выходной файл ODS](90112030.ods) для справки.
