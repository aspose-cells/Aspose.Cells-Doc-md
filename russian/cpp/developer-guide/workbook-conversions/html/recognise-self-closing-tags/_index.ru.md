---
title: Распознавать теги само closing в C++
linktitle: Различает самозакрывающиеся теги
type: docs
weight: 120
url: /ru/cpp/recognise-self-closing-tags/
description: Узнайте, как обрабатывать теги самостоятельно закрывающие в HTML с помощью Aspose.Cells и C++.
---
