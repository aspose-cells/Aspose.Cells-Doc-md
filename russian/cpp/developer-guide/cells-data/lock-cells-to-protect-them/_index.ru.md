---
title: Как заблокировать ячейки для их защиты с помощью C++
linktitle: Как заблокировать ячейки для их защиты
type: docs
weight: 130
url: /ru/cpp/how-to-lock-cells-to-protect-them/
description: В этой статье приведен пример кода, объясняющий, как заблокировать ячейки для их защиты с использованием библиотеки Aspose.Cells на C++.
