---
title: Получить диапазон ячеек с помощью C++
linktitle: Получить диапазон ячеек
type: docs
weight: 600
url: /ru/cpp/get-cells-range/
description: Узнайте, как получить диапазон ячеек через API Aspose.Cells for C++.
...
1. Получить ячейки [**Range**](https://reference.aspose.com/cells/cpp/aspose.cells/range/).
