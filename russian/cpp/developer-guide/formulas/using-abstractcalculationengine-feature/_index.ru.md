...
---
##  Функции все еще находятся в стадии разработки, поэтому следите за обновлениями.


##  **Введение**
 Эта статья дает представление о том, как использовать[АннотацияРасчетДвигатель](https://reference.aspose.com/cells/cpp/aspose.cells/abstractcalculationengine/) функция реализации пользовательских функций с помощью API Aspose.Cells.
