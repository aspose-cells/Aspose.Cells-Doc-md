---
title: Экспорт листа или графика в изображение с желаемой шириной и высотой via JavaScript
linktitle: Экспорт рабочего листа или диаграммы в изображение с желаемой шириной и высотой
type: docs
weight: 290
url: /ru/javascript-cpp/export-worksheet-or-chart-into-image-with-desired-width-and-height/
description: Узнайте, как экспортировать лист или график в изображение с заданной шириной и высотой с помощью Aspose.Cells for JavaScript через C++.
---

{{% alert color="primary" %}}
Вы можете использовать Aspose.Cells for JavaScript через C++, чтобы экспортировать ваш лист или график в изображение нужной ширины и высоты. Он предоставляет метод [**ImageOrPrintOptions.desiredSize(number, number, boolean)**](https://reference.aspose.com/cells/javascript-cpp/imageorprintoptions/#desiredSize-number-number-boolean-) для установки желаемой ширины и высоты экспортированного изображения. Ширина и высота указываются в пикселях.
{{% /alert %}}
