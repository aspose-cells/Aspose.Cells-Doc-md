...
type: docs
weight: 120
url: /ru/javascript-cpp/pivot-table-hide-and-sort-data/
---

## **Скрытие и сортировка данных в сводной таблице**
Aspose.Cells for JavaScript через C++ поддерживает скрытие и сортировку данных в сводной таблице. Следующий фрагмент кода демонстрирует эту функцию, сортируя колонку Score по убыванию, а затем скрывая строки со значением менее 60.
