...
type: docs
weight: 150
url: /ru/javascript-cpp/save-pivot-table-in-ods-file/
---

Aspose.Cells for JavaScript через C++ предоставляет возможность сохранять сводные таблицы в файлах ODS. Для этого просто преобразуйте книгу с существующей сводной таблицей или создайте новую и сохраните файл в формате ODS. Обязательно вызовите [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) перед сохранением, чтобы убедиться, что сводная таблица отображается в выходном файле ODS. Следующий пример демонстрирует сохранение сводной таблицы в файл ODS.
