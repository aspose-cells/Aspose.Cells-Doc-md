---
title: Копирование высоты строк исходного диапазона в целевой диапазон с помощью JavaScript через C++
linktitle: Копировать высоту строк исходного диапазона в целевой диапазон
type: docs
weight: 590
url: /ru/javascript-cpp/copy-row-heights-of-source-range-to-destination-range/
---

{{% alert color="primary" %}}

Иногда пользователи нуждаются в копировании высот строк из исходного диапазона в целевой диапазон. Script через C++ предоставляет перечисление [**PasteType.RowHeights**](https://reference.aspose.com/cells/javascript-cpp/pastetype/) для этой цели. Устанавливая свойство [**PasteOptions.pasteType**](https://reference.aspose.com/cells/javascript-cpp/pasteoptions/#pasteType--) в [**PasteType.RowHeights**](https://reference.aspose.com/cells/javascript-cpp/pastetype/), вы копируете высоты всех строк внутри исходного диапазона в целевой диапазон.

{{% /alert %}}

Следующий пример кода объясняет, как использовать перечисление [**PasteType.RowHeights**](https://reference.aspose.com/cells/javascript-cpp/pastetype/) для копирования высот строк исходного диапазона в целевой. После открытия сгенерированного файла Excel в Microsoft Excel вы увидите, что высоты строк целевого диапазона точно такие же, как и исходного.
