---
title: Копировать стиль диапазона только с помощью JavaScript через C++
linktitle: Копировать только стиль диапазона
type: docs
weight: 620
url: /ru/javascript-cpp/copy-range-style-only/
description: Узнайте, как копировать только стиль диапазона, управляя данными в Aspose.Cells for JavaScript через C++. 
---

{{% alert color="primary" %}}

[Копировать только данные диапазона](/cells/ru/javascript-cpp/copy-range-data-only/) и [Копировать данные с стилем](/cells/ru/javascript-cpp/copy-range-data-with-style/) объясняют, как копировать данные из диапазона в другой либо отдельно, либо полностью с форматированием. Также возможно копировать только форматирование. В этой статье показано как.
