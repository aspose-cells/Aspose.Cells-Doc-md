---
title: Конвертация графика в изображение для Японии с помощью JavaScript через C++
description: Узнайте, как использовать Aspose.Cells for JavaScript через C++, чтобы настроить японскую конфигурацию графика. Наше руководство покажет, как настроить графики для поддержки японских символов и форматирования, включая шрифты, размеры, направление текста и многое другое.  
keywords: Aspose.Cells for JavaScript с помощью C++, графики, японская конфигурация, шрифт, размер шрифта, направление текста, поддержка.  
linktitle: Установить японский регион  
type: docs  
weight: 10  
url: /ru/javascript-cpp/convert-chart-to-image-for-japanese-region/  
...
Первый шаг — определить класс "ChartJapaneseSettings", наследующий от [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
