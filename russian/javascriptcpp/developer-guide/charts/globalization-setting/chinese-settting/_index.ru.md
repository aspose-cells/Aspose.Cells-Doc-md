---
title: Конвертация графика в изображение для Китая с помощью JavaScript через C++
description: Узнайте, как использовать Aspose.Cells for JavaScript через C++, чтобы настроить графики для китайских символов и форматов, включая шрифты, размеры, направления текста и многое другое.
keywords: Aspose.Cells for JavaScript с помощью C++, графики, конфигурация для Китая, шрифты, размер шрифта, направление текста, поддержка.
linktitle: Установить китайский регион
type: docs
weight: 9
url: /ru/javascript-cpp/convert-chart-to-image-for-chinese-region/
...
Первый шаг — определить класс "ChartChineseSetttings", который наследуется от [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
