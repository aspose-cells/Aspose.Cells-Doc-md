---
title: Создание круговой диаграммы с направляющими линиями с помощью JavaScript через C++
description: Узнайте, как использовать Script Aspose.Cells for Java через C++ для создания круговой диаграммы с направляющими линиями в Microsoft Excel. Наш гид покажет, как добавить направляющие линии, соединяющие точки данных с легендой и повышающие ясность вашей диаграммы.
keywords: Script Aspose.Cells for Java через C++, круговая диаграмма, направляющие линии, Microsoft Excel, визуализация данных, настройка диаграммы.
linktitle: Круговая диаграмма
type: docs
weight: 45
url: /ru/javascript-cpp/creating-pie-chart-with-leader-lines/
---

{{% alert color="primary" %}}

Этот журнал объясняет, как создать круговую диаграмму с направляющими линиями с нуля с использованием API Script Aspose.Cells for Java через C++. В Excel по умолчанию установлена опция 'Показать направляющие линии', поэтому при создании круговой диаграммы линии отображаются. Однако при создании аналогичной диаграммы с помощью API Aspose.Cells, необходимо явно установить свойство [**Series.hasLeaderLines**](https://reference.aspose.com/cells/javascript-cpp/series/#hasLeaderLines--). 

{{% /alert %}}

Чтобы продемонстрировать использование Aspose.Cells for JavaScript через C++ API для создания круговой диаграммы с направляющими линиями, сначала создадим новый [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) и введем некоторые данные, которые будут служить источником данных серии. После того как данные будут установлены, мы добавим [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) типа [**ChartType.Pie**](https://reference.aspose.com/cells/javascript-cpp/charttype) в коллекцию диаграмм и настроим его различные аспекты для получения желаемого вида диаграммы.
...
## **Продвинутые темы**
- [Пользовательские цвета секторов в круговой диаграмме](/cells/ru/javascript-cpp/custom-slice-or-sector-colors-in-pie-chart/)
- [Определение того, находятся ли точки данных во втором сегменте или в столбце на круговой из кругов или столбчатой из кругов диаграмме](/cells/ru/javascript-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)

## Связанные статьи

- [Создание диаграмм](/cells/ru/javascript-cpp/creating-charts/)
- [Настройка диаграмм](/cells/ru/javascript-cpp/customizing-charts/)
- [Форматирование данных в диаграммах](/cells/ru/javascript-cpp/data-formatting-in-charts/)
