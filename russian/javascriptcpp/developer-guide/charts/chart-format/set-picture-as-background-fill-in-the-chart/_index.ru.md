---
title: Установка изображения как фона заливки в графике с помощью JavaScript через C++
linktitle: Установить изображение как заполнение фона в графике
description: Узнайте, как установить изображение в качестве фона заливки в графике, используя Aspose.Cells for JavaScript через C++. Наш гид покажет вам, как импортировать и позиционировать изображение, изменять его размер и цвет, а также применять параметры форматирования для улучшения внешнего вида вашего графика.
keywords: Aspose.Cells for JavaScript через C++, построение графиков, заливка фона, изображение, импорт, позиционирование, размер, цвет, форматирование.
type: docs
weight: 30
url: /ru/javascript-cpp/set-picture-as-background-fill-in-the-chart/
---
...
Для этого Aspose.Cells предоставляет свойство [**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--). Приведенный ниже образец кода демонстрирует использование свойства [**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--) для установки изображения в качестве фона заполнения на диаграмме.

## Код JavaScript для установки изображения как фона заливки в графике
