---
title: Три метода фильтрации данных диаграммы с помощью JavaScript через C++
linktitle: Три метода фильтрации данных диаграммы
description: Узнайте, как фильтровать диаграммы в Excel с помощью Aspose.Cells for JavaScript через C++. Наш комплексный гид покажет, как применять фильтры к диаграммам, настраивать элементы диаграмм и использовать инструменты анализа данных для получения лучших инсайтов и обоснованных решений.
keywords: Aspose.Cells for JavaScript через C++, фильтрация диаграмм в Excel, анализ данных, принятие решений, визуализация.
type: docs
weight: 2210
url: /ru/javascript-cpp/filtering-charts-in-excel/
---
...
В Excel мы можем фильтровать определённые серии на диаграмме, из-за чего эти фильтрованные серии не отображаются в диаграмме. Исходная диаграмма показана на **Рисунке 1**. Однако, когда мы фильтруем **Testseries2** и **Testseries4**, диаграмма будет выглядеть как на **Рисунке 2**.
 ...
 В Aspose.Cells for JavaScript через C++ мы можем выполнить аналогичную операцию. Для файла [примера](seriesFiltered.xlsx), если нужно исключить **Testseries2** и **Testseries4**, можно выполнить следующий код. Также мы будем поддерживать два списка: один ([Chart.nSeries](https://reference.aspose.com/cells/javascript-cpp/chart/#nSeries--)) — список для хранения всех выбранных серий.
