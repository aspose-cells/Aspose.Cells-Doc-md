---
title: Объединение нескольких листов в один с помощью JavaScript через C++
linktitle: Совместить несколько листов в один лист
type: docs
weight: 160
url: /ru/javascript-cpp/combine-multiple-worksheets-into-a-single-worksheet/
description: Узнайте, как объединить несколько листов в один с помощью Script через C++. 
---
