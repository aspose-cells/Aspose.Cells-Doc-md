---
title: Проверка валидности цифровой подписи VBA кода с помощью JavaScript через C++
linktitle: Проверить, действителен ли цифровой подпись кода VBA
type: docs
weight: 120
url: /ru/javascript-cpp/check-if-digital-signature-of-vba-code-is-valid/
description: Научитесь проверять действительность цифровой подписи VBA кода с помощью Aspose.Cells for JavaScript через C++.
--- 
...
## **Проверка действительности цифровой подписи VBA-кода в JavaScript**
