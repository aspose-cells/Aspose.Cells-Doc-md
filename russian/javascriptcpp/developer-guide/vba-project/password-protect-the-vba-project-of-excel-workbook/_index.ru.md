---
title: Зашифровать VBA проект книги Excel паролем с помощью JavaScript через C++
linktitle: Защита паролем проекта VBA книги Excel
type: docs
weight: 10
url: /ru/javascript-cpp/password-protect-the-vba-project-of-excel-workbook/
description: Узнайте, как защитить паролем VBA проект книги Excel с помощью Aspose.Cells for JavaScript через C++.
---

## **Защитить паролем VBA-проект книги Excel с помощью JavaScript через C++**

Вы можете защитить паролем VBA (Visual Basic for Applications) проект книги с помощью Aspose.Cells for JavaScript через C++, используя метод [**VbaProject.protect(boolean, string)**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#protect-boolean-string-).  
