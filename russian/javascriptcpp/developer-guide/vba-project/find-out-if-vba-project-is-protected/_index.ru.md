---
title: Узнайте, защищён ли VBA проект с помощью JavaScript через C++
linktitle: Определение, защищен ли проект VBA
type: docs
weight: 20
url: /ru/javascript-cpp/find-out-if-vba-project-is-protected/
---

## **Узнайте, защищён ли VBA-проект в JavaScript**

Вы можете определить, защищен ли проект VBA (Visual Basic Applications) вашего файла Excel, используя свойство [**VbaProject.isProtected()**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#isProtected--) Aspose.Cells.
