---
title: Получить точки соединения формы с помощью JavaScript через C++
linktitle: Получить точки подключения фигуры
type: docs
weight: 3500
url: /ru/javascript-cpp/get-connection-points-from-shape/
description: Узнайте, как получать точки соединения форм в Excel с помощью Aspose.Cells for JavaScript через C++.
---

Aspose.Cells предоставляет богатый набор функций для управления формами в таблице. Иногда необходимо получить точки соединения формы для выравнивания или размещения форм в нужном месте. Для этого нужны все точки соединения. Следующий код можно использовать для получения списка точек соединения формы с помощью свойства [**Shape.connectionPoints**](https://reference.aspose.com/cells/javascript-cpp/shape/#connectionPoints--).
