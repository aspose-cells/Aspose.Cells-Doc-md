---
title: Настройка межстрочного интервала в параграфе фигуры или текстовом поле с помощью JavaScript через C++
linktitle: Установить интервал между строками абзаца в фигуре или текстовом поле
type: docs
weight: 290
url: /ru/javascript-cpp/set-line-spacing-of-the-paragraph-in-a-shape-or-textbox/
description: Узнайте, как установить межстрочный интервал в параграфах фигур или текстовых полей с помощью Script Aspose.Cells for JavaScript через C++.
---

{{% alert color="primary" %}}

Вы можете установить межстрочный интервал параграфа, его отступ перед и после с помощью свойств [**TextParagraph.lineSpace**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#lineSpace--), [**TextParagraph.spaceBefore**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#spaceBefore--) и [**TextParagraph.spaceAfter**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#spaceAfter--) класса [**TextParagraph**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/).
