---
title: Изменение межсимвольного интервала текста в Excel или фигуре с помощью JavaScript через C++
linktitle: Изменение межсимвольного интервала текстового поля или формы Excel
type: docs
weight: 280
url: /ru/javascript-cpp/change-character-spacing-of-excel-textbox-or-shape/
description: Измените межсимвольный интервал текста в Excel контейнерах или фигурах с помощью Script Aspose.Cells for JavaScript через C++. 
---

{{% alert color="primary" %}}

Вы можете изменить межсимвольный интервал текстового поля или формы Excel, используя свойство [**TextOptions.spacing**](https://reference.aspose.com/cells/javascript-cpp/textoptions/#spacing--).
