---
title: Извлечение OLE объектов из книги с помощью JavaScript через C++
linktitle: Извлечение объектов OLE из книги
type: docs
weight: 110
url: /ru/javascript-cpp/extract-ole-objects-from-workbook/
---
...
Эта статья показывает, как создать приложение на JavaScript через C++ и извлечь разные OLE-объекты из книги с помощью нескольких строк кода.
{{% /alert %}}
...
Запустите среду JavaScript и создайте новый проект. В этом примере будет показано приложение на базе браузера, но вы можете использовать любую среду, совместимую с JavaScript.

1. Добавьте зависимости  
   1. Включите скрипт Aspose.Cells for JavaScript через C++ в вашу HTML-страницу и создайте простое пользовательское интерфейс для выбора файла Excel и извлечения OLE-объектов:
