---
title: Изменение значений регулировки фигуры с помощью JavaScript через C++
linktitle: Изменение значений коррекции формы
type: docs
weight: 2000
url: /ru/javascript-cpp/change-adjustment-values-of-the-shape/
description: Научитесь изменять значения регулировки фигур в Excel с помощью Aspose.Cells for JavaScript через C++.
---

{{% alert color="primary" %}}  
Aspose.Cells предоставляет свойство [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) для изменения точек корректировки с формами. В пользовательском интерфейсе Microsoft Excel корректировки отображаются в виде желтых алмазных узлов. Например:  
...
В данной статье будет объяснено использование свойства [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) для изменения значения корректировки различных форм.  
{{% /alert %}}  
