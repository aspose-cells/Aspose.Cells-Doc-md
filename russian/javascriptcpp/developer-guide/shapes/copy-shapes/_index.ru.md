---
title: Копирование фигур между листами с помощью JavaScript через C++
linktitle: Копирование форм
type: docs
weight: 200
url: /ru/javascript-cpp/copy-shapes-between-worksheets/
description: Узнайте, как копировать фигуры, такие как изображения и графики, между листами с помощью Aspose.Cells for JavaScript через C++.
---

{{% alert color="primary" %}}

Иногда, необходимо копировать элементы на листе, например, изображения, графики и другие объекты рисования, между различными листами. Aspose.Cells for JavaScript через C++ поддерживает эту функцию. Графики, изображения и другие объекты могут быть скопированы с максимальной точностью.
...
Чтобы скопировать изображение с одного рабочего листа на другой, используйте метод [**PictureCollection.add(number, number, number, number, Uint8Array)**](https://reference.aspose.com/cells/javascript-cpp/picturecollection/#add-number-number-number-number-uint8array-), как показано в приведенном ниже образце кода.
...
Следующий код демонстрирует использование метода [**ShapeCollection.addCopy(Shape, number, number, number, number)**](https://reference.aspose.com/cells/javascript-cpp/shapecollection/#addCopy-shape-number-number-number-number-) для копирования диаграммы с одного листа на другой.
...
Для копирования элементов управления и других объектов чертежа используйте метод [**ShapeCollection.addCopy(Shape, number, number, number, number)**](https://reference.aspose.com/cells/javascript-cpp/shapecollection/#addCopy-shape-number-number-number-number-), как показано в примере ниже.
