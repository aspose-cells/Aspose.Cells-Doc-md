...
type: docs
weight: 100
url: /ru/javascript-cpp/export-equation/
---
...
Если вы хотите экспортировать уравнения в Excel в виде LaTeX выражений, используйте метод [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--). 

Следующий пример показывает, как использовать метод [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) и вставлять полученные результаты в HTML:
...
Если вы хотите экспортировать уравнения в Excel в виде MathML выражений, используйте метод [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--). 

Следующий пример показывает, как использовать метод [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) и вставлять полученные результаты в HTML:
