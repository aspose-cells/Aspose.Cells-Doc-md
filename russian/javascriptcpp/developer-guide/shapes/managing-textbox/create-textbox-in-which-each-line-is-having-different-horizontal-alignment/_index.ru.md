---
title: Создать TextBox, в котором каждая строка имеет разное горизонтальное выравнивание, с помощью JavaScript через C++
linktitle: Создание текстового поля, в котором каждая строка имеет различное горизонтальное выравнивание
type: docs
weight: 310
url: /ru/javascript-cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Узнайте, как создать TextBox, в котором каждая строка может иметь разное горизонтальное выравнивание, с помощью Aspose.Cells for JavaScript через C++.
---

{{% alert color="primary" %}}
Вы можете установить горизонтальное выравнивание текста абзаца, используя свойство [**TextParagraph.alignmentType**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#alignmentType--).
{{% /alert %}}
