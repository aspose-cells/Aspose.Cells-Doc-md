---
title: Загрузите рабочую книгу с определенной информацией о системе с помощью via JavaScript и C++
linktitle: Загрузите книгу с использованием определенной информации о культуре системы
type: docs
weight: 190
url: /ru/javascript-cpp/load-the-workbook-with-specific-system-culture-info/
---

## **Возможные сценарии использования**
 Ранее приходилось менять информацию о культуре всего потока для работы с числами и датами в определенном формате культуры, но теперь Aspose.Cells for JavaScript через C++ предоставляет свойство `LoadOptions.CultureInfo`, которое можно использовать для загрузки книги с конкретной информацией о культуре без изменения культуры всего потока.
