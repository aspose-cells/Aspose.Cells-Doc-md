---
title: Реализуйте метки subtotal или итоговые суммы на других языках с помощью JavaScript через C++
linktitle: Реализуйте метки Подитог или Итог в других языках
type: docs
weight: 50
url: /ru/javascript-cpp/implement-subtotal-or-grand-total-labels-in-other-languages/
---

## **Возможные сценарии использования**  

 Иногда нужно отображать метки подсумм и итоговых сумм на нерусских языках, таких как китайский, японский, арабский, хинди и т. д. Aspose.Cells for JavaScript через C++ позволяет делать это с помощью класса [**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings) и свойства [**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings/). См. статью о том, как использовать класс [**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings).  

- [Использование класса GlobalizationSettings для пользовательских меток итогов и других меток круговой диаграммы](/cells/ru/javascript-cpp/using-globalizationsettings-class-for-custom-subtotal-labels-and-other-label-of-pie-chart/)  

## ** Реализуйте метки Подитог или Итог в других языках**  

 Следующий пример кода загружает [пример файла Excel](5115151.xlsx) и реализует названия подитогов и итогов на китайском языке. Проверьте созданный по этому коду [выходной файл Excel](5115152.xlsx). Сначала создайте класс [**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings), а затем используйте его в нашем коде.  
