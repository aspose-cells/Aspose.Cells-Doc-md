---
title: Поддержка подписи XAdES с помощью JavaScript и C++
linktitle: Поддержка подписи XAdES
type: docs
weight: 110
url: /ru/javascript-cpp/support-for-xades-signature/
description: Эта статья описывает поддержку подписи XAdES с помощью JavaScript и C++ с Aspose.Cells.
keywords: Поддержка подписи XAdES с помощью JavaScript и C++, как подписать Excel с помощью подписи XAdES JavaScript и C++, как добавить подпись XAdES с помощью JavaScript и C++.  
---  

## **Введение**  

Aspose.Cells обеспечивает поддержку подписания рабочих книг с помощью XAdES Signature. Для этого API предоставляет класс [**DigitalSignature**](https://reference.aspose.com/cells/javascript-cpp/digitalsignature) и перечисление [**XAdESType**](https://reference.aspose.com/cells/javascript-cpp/xadestype).  

## **Как добавить подпись XAdES для Excel**  

Следующий пример кода демонстрирует использование класса [**DigitalSignature**](https://reference.aspose.com/cells/javascript-cpp/digitalsignature) для подписи рабочей книги [source](101089323.xlsx).  
