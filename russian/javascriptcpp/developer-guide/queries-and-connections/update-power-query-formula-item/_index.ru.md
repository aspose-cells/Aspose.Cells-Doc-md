---
title: Обновление элемента формулы Power Query с помощью JavaScript через C++
linktitle: Обновление элемента формулы Power Query
type: docs
weight: 120
url: /ru/javascript-cpp/update-power-query-formula-item/
description: Узнайте, как обновить источник данных элемента формулы Power Query в файле Excel с помощью Aspose.Cells for JavaScript через C++.
---

## **Сценарий использования**

Возможно, возникнут ситуации, когда файлы источника данных были перемещены, и Excel не может найти файл. В таких случаях API Aspose.Cells предоставляет возможность обновить элемент формулы Power Query, используя класс [*PowerQueryFormulaItem*](https://reference.aspose.com/cells/javascript-cpp/powerqueryformulaitem) для обновления расположения исходного файла.

## **Обновление элемента формулы Power Query**

API Aspose.Cells позволяет обновлять элементы формулы Power Query. Следующий пример кода демонстрирует обновление местоположения файла источника данных в файле Excel с помощью свойства [**PowerQueryFormulaItem.value**](https://reference.aspose.com/cells/javascript-cpp/powerqueryformulaitem/#value--). В файлы для примера приложены исходный и итоговый файлы.
