---
title: Добавить фоновое изображение в Excel с помощью JavaScript через C++
linktitle: Вставить фоновое изображение в Excel
type: docs
weight: 90
url: /ru/javascript-cpp/insert-background-image-to-excel/
description: "Как вставить фоновое изображение в Excel с помощью Aspose.Cells for JavaScript через C++."
---
...
## **Настройка фона листа с помощью Aspose.Cells for JavaScript через C++**
