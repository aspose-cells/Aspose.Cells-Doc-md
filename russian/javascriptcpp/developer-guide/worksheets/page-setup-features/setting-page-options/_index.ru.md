---
title: Установка параметров страницы с помощью JavaScript через C++
linktitle: Настройки страницы
type: docs
weight: 10
url: /ru/javascript-cpp/setting-page-options/
description: В этой статье приведен пример кода для программной установки параметров страницы листов Excel с помощью JavaScript через C++. Установка ориентации страницы, коэффициента масштабирования, параметров по умолчанию, размера бумаги, качества печати, первого номера страницы.
keywords: Установка ориентации страницы Excel JavaScript через C++, установка коэффициента масштабирования Excel JavaScript через C++, установка размера бумаги листов Excel JavaScript через C++
---
...
Класс [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) предоставляет свойство [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup), которое используется для установки параметров настройки страницы листа. В частности, это свойство [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) — объект класса [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup), используемый для установки различных параметров макета страницы для распечатываемого листа. Класс [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) содержит различные свойства, используемые для установки параметров настройки страницы. Некоторые из них рассмотрены ниже.  

### **Ориентация страницы**  

Ориентацию страницы можно установить как портретную или альбомную с помощью свойства [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) класса [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Свойство [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) принимает одно из заранее определенных значений перечисления [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype), приведенного ниже.  
...
Можно уменьшить или увеличить размер листа, изменяя масштабный коэффициент с помощью свойства [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--).  
...
Чтобы уместить содержимое листа на определенное количество страниц, используйте свойства [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) и [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) класса [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Эти свойства также используются для масштабирования листов.  

{{% alert color="primary" %}}  
Вы можете выбрать либо свойство [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--), либо свойство [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--), но не оба одновременно.  
{{% /alert %}}  
...
Установите размер бумаги, на который будут печататься листы, с помощью свойства [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) класса [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Свойство [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) принимает одно из предопределенных значений перечисления [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype), приведенного ниже.  
...
Установите качество печати листов для печати с помощью свойства [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--). Размер измерения для качества печати — это точки на дюйм (DPI).  
...
Начинайте нумерацию страниц листа с помощью свойства [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) класса [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Свойство [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) задает номер первой страницы листа, а последующие страницы нумеруются по возрастанию.  
