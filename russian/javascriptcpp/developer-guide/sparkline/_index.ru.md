---
title: Вставка Sparkline с помощью JavaScript через C++
linktitle: Sparklines
type: docs
weight: 160
url: /ru/javascript-cpp/creating-sparklines/
description: Создайте Sparkline для Excel с помощью Aspose.Cells for JavaScript через C++.
---
...
Создать Sparkline с помощью Aspose.Cells for JavaScript через C++ очень просто с использованием следующих примерных кодов:
...
## **Продвинутые темы**
- [Использование мерных линий и настройка 3D-формата](/cells/ru/javascript-cpp/using-sparklines-and-settings-3d-format/)
