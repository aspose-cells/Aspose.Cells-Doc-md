---
title: Загрузить исходный файл Excel без диаграмм с помощью JavaScript через C++
linktitle: Загрузить исходный файл Excel без диаграмм
type: docs
weight: 420
url: /ru/javascript-cpp/load-source-excel-file-without-charts/
description: Узнайте, как загрузить файл Excel без диаграмм с помощью Script Aspose.Cells for Java через C++. 
---

{{% alert color="primary" %}}

Aspose.Cells позволяет загружать ваши файлы Excel без диаграмм. Используйте свойство [**LoadOptions.loadFilter**](https://reference.aspose.com/cells/javascript-cpp/loadoptions/#loadFilter--) для этого.
