---
title: Загрузить определенные листы в рабочей книге с помощью JavaScript через C++
linktitle: Загрузка конкретных листов в книге
type: docs
weight: 100
url: /ru/javascript-cpp/load-specific-worksheets-in-a-workbook/
description: Узнайте, как загрузить определенные листы в рабочей книге с помощью Script Aspose.Cells for Java через C++. Повышайте производительность и уменьшайте использование памяти.
---
