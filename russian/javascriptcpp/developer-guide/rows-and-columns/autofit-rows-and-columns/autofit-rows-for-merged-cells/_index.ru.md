---
title: Автоматическая подгонка строк для объединенных ячеек с помощью JavaScript через C++
linktitle: Автоподгонка строк для объединенных ячеек
type: docs
weight: 120
url: /ru/javascript-cpp/autofit-rows-for-merged-cells/
description: узнайте, как автоматически подгонять строки для объединенных ячеек с помощью Aspose.Cells for JavaScript через C++. Реализуйте автоматическую подгонку для объединенных ячеек в таблицах.
---
...
Aspose.Cells for JavaScript через C++ поддерживает эту функцию через API [**AutoFitterOptions.autoFitMergedCellsType**](https://reference.aspose.com/cells/javascript-cpp/autofitmergedcellstype/). Используя этот API, можно автоматически подгонять строки в листе, включая объединенные ячейки. Ниже приводится список всех возможных типов автоматической подгонки объединенных ячеек:
