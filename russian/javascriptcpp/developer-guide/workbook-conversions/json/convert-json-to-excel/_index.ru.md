---
title: Конвертация JSON в Excel с помощью JavaScript через C++
linktitle: Конвертировать JSON в Excel
type: docs
weight: 300
url: /ru/javascript-cpp/convert-json-to-excel/
description: Узнайте, как конвертировать JSON в файл Excel с помощью Aspose.Cells for JavaScript через C++.
keywords: Импорт JSON без Office 2013, Office 2016, Office 2019 и Office 365 с помощью JavaScript через C++.
---
...
Нет необходимости гадать, как конвертировать JSON в файл Excel, потому что Aspose.Cells for JavaScript через C++ предоставляет лучшее решение. API Aspose.Cells поддерживает преобразование JSON в таблицы. Используйте класс [**JsonLoadOptions**](https://reference.aspose.com/cells/javascript-cpp/jsonloadoptions) для задания дополнительных настроек при импорте JSON в рабочую книгу.
