---
title: Добавление водяного знака в PDF с помощью JavaScript через C++
linktitle: Добавление водяного знака в PDF
type: docs
weight: 9
url: /ru/javascript-cpp/add-watermark-to-pdf/
description: Узнайте, как добавить водяной знак текста и изображения в PDF при преобразовании Excel в PDF с помощью Script Aspose.Cells for Java через C++.
---
...
Вы можете легко добавить текстовый водяной знак в PDF, указав текст и соответствующий шрифт. Также вы можете установить выравнивание, сдвиг, поворот, непрозрачность, передний/задний план и масштаб на странице в [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
...
Вы можете добавить водяной знак изображения в PDF, просто указав байты изображения. Также можно настроить выравнивание, сдвиг, поворот, непрозрачность, передний/задний план и масштаб на странице в [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
