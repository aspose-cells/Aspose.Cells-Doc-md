---
title: Конвертация Excel в CSV, TSV и Txt с помощью JavaScript через C++
linktitle: Сохранить как CSV, TSV и Txt
type: docs
weight: 40
url: /ru/javascript-cpp/convert-excel-to-csv-tsv-and-txt/
description: Узнайте, как конвертировать файлы Excel в форматы CSV, TSV и TXT с помощью Aspose.Cells for JavaScript через C++.
---
...
Вы можете изменить тот же пример, чтобы сохранить свой файл в CSV. По умолчанию, [**TxtSaveOptions.separator**](https://reference.aspose.com/cells/javascript-cpp/txtsaveoptions/#separator--) это запятая, поэтому не указывайте разделитель при сохранении в формат CSV.
...
## **Продвинутые темы**
- [Сохранять разделители для пустых строк при экспорте таблиц в формат CSV](/cells/ru/javascript-cpp/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
- [Обрезать ведущие пустые строки и столбцы при экспорте электронных таблиц в формат CSV](/cells/ru/javascript-cpp/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
