---
title: Добавление условных форматирований 2 цветной шкалы и 3 цветной шкалы 
linktitle: Добавление условных форматирований 2 цветной шкалы и 3 цветной шкалы  
description: Как использовать библиотеку Aspose.Cells в JavaScript через C++, чтобы добавить условное форматирование для двух цветовых схем и трех цветовых схем. Настроив эти параметры, вы получите больший контроль над внешним видом и отображением ячеек.  
keywords: Aspose.Cells, Условное форматирование, JavaScript через C++, Цветовой коэффициент, Масштаб двух цветов, Масштаб трех цветов  
type: docs  
weight: 20  
url: /ru/javascript-cpp/adding-2-color-scale-and-3-color-scale-conditional-formattings/  
---

{{% alert color="primary" %}}  
**Двухцветная шкала** и **Трёхцветная шкала** условные форматы добавляются одинаковым образом, отличаясь только методом [**ColorScale.is3ColorScale(boolean)**](https://reference.aspose.com/cells/javascript-cpp/colorscale/#is3ColorScale-boolean-). Этот метод **false** для двууцветной шкалы и **true** для трёхцветной шкалы условных форматов.  
{{% /alert %}}  
