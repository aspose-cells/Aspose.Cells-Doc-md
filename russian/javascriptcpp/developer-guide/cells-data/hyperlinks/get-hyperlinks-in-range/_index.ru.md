...
type: docs
weight: 100
url: /ru/javascript-cpp/get-hyperlinks-in-range/
description: Узнайте, как получать гиперссылки в диапазоне через Aspose.Cells for JavaScript через C++ API.
keywords: Получить гиперссылки в диапазоне JavaScript через C++, Получить все гиперссылки в выбранном диапазоне JavaScript через C++, Удалить гиперссылку в диапазоне JavaScript через C++, Удалить гиперссылки в выбранном диапазоне JavaScript через C++
---

## **Получение гиперссылок в диапазоне**

Класс [**Range**](https://reference.aspose.com/cells/javascript-cpp/range) предоставляет метод [**hyperlinks**](https://reference.aspose.com/cells/javascript-cpp/range/#hyperlinks--), который возвращает все гиперссылка в выбранном диапазоне. Вы также можете удалить гиперссылку, вызвав метод [**Hyperlink.delete()**](https://reference.aspose.com/cells/javascript-cpp/hyperlink/#delete--).
