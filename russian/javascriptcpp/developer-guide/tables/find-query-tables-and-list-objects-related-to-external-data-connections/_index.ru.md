---
title: Найдите Query Tables и List Objects, связанные с внешними подключениями данных, с помощью JavaScript через C++
linktitle: Поиск таблиц запросов и объектов списка, связанных с внешними подключениями к данным
type: docs
weight: 20
url: /ru/javascript-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: Изучите, как найти Query Tables и List Objects, связанные с внешними подключениями данных, с помощью Aspose.Cells for JavaScript через C++.
---
