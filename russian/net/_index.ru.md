...
**![Aspose.Cells for .NET Логотип продукта](home_1.png)**

**Добро пожаловать в Aspose.Cells for .NET**

 Aspose.Cells for .NET — это библиотека классов программирования, которая позволяет разработчикам программного обеспечения манипулировать и обрабатывать файлы электронных таблиц в своих собственных приложениях.
...
<div class="row">
	...
	<div class="col-md-4">
		<p><b>Начать</b></p>
			<hr><p><a href="/cells/ru/net/getting-started/">Начиная</a></p></hr>
			<ul>
			...
			<p>Учиться</p>
			<ul>
				<li><a href="/cells/ru/net/how-to-run-the-examples/">Как запускать примеры</a></li>
	...
	<div class="col-md-4">
		<p><b>Функции разработки</b></p>
			...
			<ul>
				...
				<li><a href="https://helpdesk.aspose.com/">Aspose.Cells for .NET Платная служба поддержки</a></li>
			</ul>
	</div>
</div>
