...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-net-4-9-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 4.9.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-4.9.1/)
...
|16499 | PDF| PDF не встраивает шрифты|
...
|16393 | XL| Проблема с удалением валидации|
