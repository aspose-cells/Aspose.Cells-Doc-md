...
type: docs
weight: 40
url: /ru/net/aspose-cells-for-net-5-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 5.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.2/)
...
|19170 | PDF| Сохранить как PDF-файл — поврежденный PDF-файл|
