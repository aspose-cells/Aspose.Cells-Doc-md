...
type: docs
weight: 60
url: /ru/net/aspose-cells-for-net-5-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 5.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.0/)
...
- Включает поддержку смарт-тегов для файлов XLSX.
 ...
 Визуализирует шаблон Cell, заполняющий сгенерированный PDF-файл.
 Добавлена поддержка соответствия Pdf/A-1b.
 Улучшает производительность и качество сгенерированных PDF-файлов.
...
|16207 | PDF| Найти ошибку при сохранении файла PDF|
|17535 | PDF| Один шрифт в XLSX дает два шрифта в PDF|
|17537 | PDF| Пустые ячейки в формате валюты|
|17776 | PDF| Проблема конвертации Excel в PDF|
|17804 | PDF| Десятичные значения не отображаются, если есть только нули|
|17821 | PDF| Встроенные свойства|
|17981 | PDF| Проблема преобразования Excel в PDF|
|18021 | PDF| Сохранение в PDF - Проблемы со шрифтом|
|18038 | PDF| PDF-документ поврежден|
|18136 | PDF| Проблема с сохранением PDF|
...
|18258 | PDF| Расчетные формулы не обновляются при преобразовании из Cells в PDF|
|18316 | PDF| Проблема преобразования с данными, отображаемыми в виде числовых знаков|
|18239 | Электронная таблицаML| Недопустимое исключение индекса конечного столбца|
...
|16656 | XLSX| Теряются макросы при сохранении в XLSM-формате|
...
|18036 | XLSX| Проблема с открытием XLSM файла.|
