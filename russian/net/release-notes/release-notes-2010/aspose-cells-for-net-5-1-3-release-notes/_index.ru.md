...
type: docs
weight: 30
url: /ru/net/aspose-cells-for-net-5-1-3-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 5.1.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.3/)
...
-  Повышает производительность сохранения файлов PDF.
...
|19721 | HTML| Сохранение документа Excel в виде HTML занимает очень много времени|
|17485 | PDF| Отсутствует логотип и нечеткий/светлый текст|
|18114 | PDF| Проблема с конвертацией PDF|
|19237 | PDF|Разница в печати из Excel и выводе в PDF|
|19392 | PDF| Ширина изображения уменьшилась при преобразовании в PDF|
|19409 | PDF| Внешний вид PDF отличается от XLSX|
|19420 | PDF| Формат даты|
|19425 | PDF| Размер файла = 0 при преобразовании в PDF|
|19546 | PDF| Преобразовать этот файл в PDF|
...
|19942 | SpreadML| Проблема открытия документа SpreadsheetML с атрибутами пространства имен|
