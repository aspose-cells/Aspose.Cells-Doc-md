...
type: docs
weight: 20
url: /ru/net/aspose-cells-for-net-5-1-4-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 5.1.4](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.4/)
...
|:- |:- |:- |
|20247 | ОРВ| Ошибка в формуле при сохранении как ODS|
...
|20057 | PDF| Проблема с преобразованием Excel в PDF|
|20070 | PDF| Многобайтовый шрифт|
|20071 | PDF| Цвет многобайтового шрифта|
|20450 | PDF| Недопустимый индекс строки|
|20590 | PDF| Обрезанный текст в некоторых ячейках после преобразования в PDF|
...
|20181 | Электронная таблицаML| Ячейка, использующая функцию гиперссылки, выдает исключение|
|20519 | Электронная таблицаML| Не удалось получить содержимое Excel 2007 в виде XML|
