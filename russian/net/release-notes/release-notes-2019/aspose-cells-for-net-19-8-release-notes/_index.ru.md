...
type: docs
weight: 50
url: /ru/net/aspose-cells-for-net-19-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46804|Повышение производительности при вычислении большой матрицы с двойными значениями.|Производительность|
|CELLSNET-46856|Документ не сохраняется при сохранении более 10 раз|Производительность|
|CELLSNET-46827|Контент отсутствует при преобразовании XLSX в ODS|Ошибка|
|CELLSNET-46833|Формы искажаются при преобразовании Excel в PDF|Ошибка|
|CELLSNET-46835|Фигуры чертежа не отображаются должным образом при преобразовании Excel в PDF|Ошибка|
|CELLSNET-46848|Проблема с арабским текстом при преобразовании Excel в PDF|Ошибка|
...
|CELLSNET-46853|Некоторые столбцы отображаются красным цветом при преобразовании Excel в PDF.|Ошибка|
...
|CELLSNET-46831|Исключение при преобразовании файла Excel в PDF|Исключение|
