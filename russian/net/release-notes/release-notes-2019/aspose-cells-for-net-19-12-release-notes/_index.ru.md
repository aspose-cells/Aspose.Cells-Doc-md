...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-19-12-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-47056|Диаграммы не отображаются при загрузке и сохранении файла ODS|Улучшение|
|CELLSNET-46679|Неверный рендеринг при экспорте XLSX в PDF|Ошибка|
...
|CELLSNET-47013|Числа на графике воронки исчезают при преобразовании файла Excel в PDF|Ошибка|
...
|CELLSNET-46757|Проблемы при конвертации XLSX в PDF|Ошибка|
|CELLSNET-46976|Некоторые линии границ исчезают при преобразовании Excel в PDF|Ошибка|
