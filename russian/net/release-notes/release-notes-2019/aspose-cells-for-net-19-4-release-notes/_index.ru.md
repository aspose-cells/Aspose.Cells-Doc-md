...
type: docs
weight: 90
url: /ru/net/aspose-cells-for-net-19-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46649|Создан большой PDF-файл по сравнению с онлайн-инструментом iLovePDF|Улучшение|
|CELLSNET-46093|Диаграммы не учитывают параметры страницы Черное и белое|Улучшение|
|CELLSNET-46677|При экспорте Excel в PDF арабские тексты не отображаются точно в диаграммах.|Улучшение|
|CELLSNET-46639|Поддержка вертикального разрыва страницы для файла ODS.|Улучшение|
|CELLSNET-46631|Исключение OutOfMemoryException при рендеринге|Производительность|
...
|CELLSNET-46678|PivotField.IsRepeatItemLabels не поддерживается в выходном XLSB|Ошибка|
...
|CELLSNET-45698|Метод Worksheet.AutoFitColumns обрезает длинный текст при рендеринге в PDF|Ошибка|
|CELLSNET-46661|Меньшее количество страниц, отображаемых в формате PDF, по сравнению с Excel 365.|Ошибка|
|CELLSNET-46673|Проблема с размером файла при конвертации Excel в PDF|Ошибка|
|CELLSNET-46632|ChartPoint.Datalabels.ShowValue не работает должным образом|Ошибка|
|CELLSNET-46655|Метки многоуровневой оси категорий теряются при сохранении с RefreshChartCache = true|Ошибка|
...
|CELLSNET-46669|Shape to image Ошибка при преобразовании файла Excel в PDF|Исключение|
