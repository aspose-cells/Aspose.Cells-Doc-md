...
|CELLSNET-46693|Поддержка фона ODS|Новая особенность|
...
|CELLSNET-46719|Исключение при настройке строки HTML с использованием цветовой модели RGBA|Улучшение|
...
|CELLSNET-46689|Сохранение книги в формате PDF отличается от собственного вывода Excel.|Ошибка|
...
|CELLSNET-46727|Неправильная нумерация страниц при сохранении книги в формате PDF|Ошибка|
|CELLSNET-46700|Метки данных круговой диаграммы перекрываются друг с другом|Ошибка|
|CELLSNET-46696|Преобразование XLS с графической диаграммой Microsoft в XLSX и XLSM вызывает ошибку нечитаемого содержимого.|Ошибка|
|CELLSNET-46697|Преобразование XLSM с объектом OLE в XLS вызывает ошибку|Ошибка|
|CELLSNET-46712|Преобразование XLS с графической диаграммой Microsoft в XLSX и XLSM вызывает ошибку нечитаемого содержимого.|Ошибка|
...
|CELLSNET-46683|Исключение при преобразовании файла Excel в PDF|Исключение|
