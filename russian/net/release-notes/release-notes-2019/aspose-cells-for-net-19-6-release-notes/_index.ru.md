...
type: docs
weight: 70
url: /ru/net/aspose-cells-for-net-19-6-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-41277|Комментарии в HTML-экспорте файлов XLS/XLSX|Новая особенность|
|CELLSNET-45194|Поддержка рисования слайсера при рендеринге в PDF|Новая особенность|
...
|CELLSNET-46722|Предупреждение безопасности после повторного сохранения формата файла XLS|Улучшение|
...
|CELLSNET-46731|Worksheet.Copy() зависает приложение|Производительность|
|CELLSNET-46770|Недостаточно памяти при обновлении сводной таблицы с большим источником данных|Производительность|
|CELLSNET-46730|Chart.ToImage() зависает приложение|Производительность|
...
|CELLSNET-46733|Стиль/формат потерян при сохранении сводной таблицы в виде HTML|Ошибка|
|CELLSNET-46736|Проблема со шрифтом при преобразовании HTML в PDF|Ошибка|
|CELLSNET-46751|XLSX не может быть преобразован в HTML|Ошибка|
...
|CELLSNET-46592|Проблемы с рендерингом текста при преобразовании XLSX в PDF|Ошибка|
|CELLSNET-46735|Номер страницы не сбрасывается до 1 на каждом листе выходного PDF-файла.|Ошибка|
...
|CELLSNET-46510|Ошибка формы изображения! при конвертации XLSX в PDF|Исключение|
