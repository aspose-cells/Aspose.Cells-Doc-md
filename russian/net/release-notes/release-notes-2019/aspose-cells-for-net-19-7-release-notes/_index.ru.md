...
type: docs
weight: 60
url: /ru/net/aspose-cells-for-net-19-7-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46808|Поддержка чтения отдельных ячеек таблицы XLS-файла.|Новая особенность|
...
|CELLSNET-46783|CalculateFormula очень медленный|Производительность|
|CELLSNET-46746|CalculateFormula — формулы не влияют на диаграммы|Ошибка|
|CELLSNET-46772|Ошибочный PDF-файл, созданный из-за отсутствия графики|Ошибка|
|CELLSNET-46802|Диаграмма отображается в XLS иначе, чем в PDF|Ошибка|
...
|CELLSNET-46794|Cells сдвиг при преобразовании HTML в XLSX|Ошибка|
...
|CELLSNET-46774|Текст в строках искажается при преобразовании большого файла в PDF|Ошибка|
...
|CELLSNET-46784|Смарт-маркеры — проблема с отображением объектов списка JSON со свойствами|Ошибка|
