...
type: docs
weight: 240
url: /ru/net/aspose-cells-net-4-0-0-0-new-release-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells Новая версия .Net 4.0.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-.net-4.0.0.0-new-release/)
...
- Исправлена ошибка при сохранении файла в поток в формате CSV.
