...
type: docs
weight: 190
url: /ru/net/aspose-cells-net-3-7-2-0-hot-fix-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells Исправление .Net 3.7.2.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-.net-3.7.2.0-hot-fix/)
...
- Исправлена ошибка экспорта файлов в формате SpreadsheetML.
