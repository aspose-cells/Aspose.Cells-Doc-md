...
type: docs
weight: 7
url: /ru/net/aspose-cells-for-net-20-10-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47623|Медленная операция сохранения с большим количеством формул в файле|Производительность|
|CELLSNET-47606|Приложение зависает при преобразовании Excel в PDF|Производительность|
...
|CELLSNET-47614|Некоторые символы отсутствуют в выходном PDF-файле при преобразовании Excel в PDF|Ошибка|
|CELLSNET-47636|Преобразование Excel в PDF — результат отображается на странице в альбомной ориентации.|Ошибка|
|CELLSNET-47637|Преобразование Excel в PDF с помощью Calibri Light|Ошибка|
...
|CELLSNET-47648|Файл XLSB поврежден после преобразования (XLSB->XLSX-XLSB)|Ошибка|
...
|CELLSNET-47584|Aspose.Cells Преобразование HTML в Excel не отображало изображения|Ошибка|
...
|CELLSNET-47624|System.ArgumentException при загрузке зашифрованного файла в XLAM|Исключение|
|CELLSNET-47630|Указанный аргумент был вне диапазона допустимых значений исключения при удалении столбца|Исключение|
|CELLSNET-47649|Исключение возникает при чтении DBConnection.PowerQueryFormula из файла XLSX|Исключение|
