...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-20-7-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47433|Worksheet.Cells.RemoveDuplicates не работает или занимает слишком много времени.|Производительность|
|CELLSNET-46753|WorkbookDesigner.Process() зависает для больших данных|Производительность|
|CELLSNET-47379|Преобразование HTML в Excel — границы отсутствуют при определении в CSS|Ошибка|
|CELLSNET-47394|Легенда диаграммы, содержащая даты, имеет другой формат в формате PDF|Ошибка|
...
|CELLSNET-47427|Содержимое смещается при экспорте в HTML|Ошибка|
...
|CELLSNET-47417|Недостаточная высота ячейки при преобразовании Excel в PDF|Ошибка|
|CELLSNET-47437|PDF, преобразованный из XLS, вызывает ошибку в Acrobat Reader|Ошибка|
|CELLSNET-47423|Метки осей значений и осей категорий на диаграммах не отображаются при преобразовании Excel в PDF|Ошибка|
...
|CELLSNET-47438|Цвет точечной диаграммы Преобразование Excel в PDF|Ошибка|
...
|CELLSNET-47465|Стиль таблицы теряется при сохранении файла XLS|Ошибка|
