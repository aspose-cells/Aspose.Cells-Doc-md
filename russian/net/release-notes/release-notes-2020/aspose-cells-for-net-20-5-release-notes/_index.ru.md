...
type: docs
weight: 30
url: /ru/net/aspose-cells-for-net-20-5-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47308|Несколько свойств отсутствуют в выходном HTML после установки Cell.HtmlString.|Ошибка|
...
|CELLSNET-47324|Ошибка значка при преобразовании Excel в PDF|Ошибка|
...
|CELLSNET-47326|Стиль гиперссылок теряется при сохранении книги ODS в формате PDF или HTML.|Ошибка|
...
|CELLSNET-47348|Формат даты изменен в файле ODS после его загрузки и сохранения|Ошибка|
