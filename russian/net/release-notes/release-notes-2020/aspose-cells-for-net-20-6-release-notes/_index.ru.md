...
type: docs
weight: 20
url: /ru/net/aspose-cells-for-net-20-6-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47384|Улучшить производительность загрузки изображения/фигуры|Производительность|
|CELLSNET-47382|Преобразование HTML в Excel теряет форматирование|Ошибка|
|CELLSNET-47390|Неправильный цвет некоторых слов при рендеринге HTML в ODS|Ошибка|
...
|CELLSNET-47366|Точки не отображаются в файл PDF|Ошибка|
