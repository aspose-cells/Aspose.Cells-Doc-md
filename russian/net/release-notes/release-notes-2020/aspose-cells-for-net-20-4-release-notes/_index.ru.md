...
|:- |:- |:- |
|CELLSNET-47276|XLSX в CSV, запятые требуются для пустых ячеек, также как в MS Excel|Новая особенность|
...
|CELLSNET-47217|Поддержка панели данных, цветовой шкалы и условного форматирования наборов иконок ODS.|Улучшение|
...
|CELLSNET-47224|Улучшите производительность обновления сводных данных.|Производительность|
|CELLSNET-47243|Зависание GetDisplayStyle для рабочего листа со строками 65536|Производительность|
|CELLSNET-47289|CalculateFormula() никогда не возвращает значение|Производительность|
|CELLSNET-47263|Зависание при попытке открыть документ ODP в конструкторе рабочей книги|Производительность|
|CELLSNET-42556|Сортировка PivotField не работает|Ошибка|
|CELLSNET-47046|Неоткрытые разделители кавычек в HTML-атрибутах IMG в сгенерированной HTML-разметке|Ошибка|
...
|CELLSNET-47261|Преобразование Excel в HTML - неправильный размер шрифта в экспортированной таблице|Ошибка|
...
|CELLSNET-47258|Проблема с изображениями штрих-кода при рендеринге из листа в TIFF|Ошибка|
|CELLSNET-47216|PowerQueries исчезли после замены исходного кода|Ошибка|
|CELLSNET-47241|Файл ODS ломается при установке стиля шрифта и сохранении|Ошибка|
...
|CELLSNET-47271|Сохранение XLSX со встроенным Visio повреждает файл|Ошибка|
...
Задает диапазон данных ячеек для экспорта. Пользователи могут использовать этот параметр, чтобы получить тот же результат со старыми версиями для измененного поведения TxtSaveOptions.TrimLeadingBlankRowAndColumn и пустых строк/столбцов.
