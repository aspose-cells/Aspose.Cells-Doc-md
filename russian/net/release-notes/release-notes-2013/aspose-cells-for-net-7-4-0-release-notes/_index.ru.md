...
type: docs
weight: 100
url: /ru/net/aspose-cells-for-net-7-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.4.0/)
...
- Зависание при сохранении в формате PDF
