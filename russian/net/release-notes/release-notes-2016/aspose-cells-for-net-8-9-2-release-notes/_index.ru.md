...
type: docs
weight: 50
url: /ru/net/aspose-cells-for-net-8-9-2-release-notes/
---
### **1) Aspose.Cells**

|**Ключ** |**Резюме** |**Категория** |
|:- |:- |:- |
|CELLSNET-44274 |Поддержка типа шрифта TTE при рендеринге электронных таблиц в PDF| Новая особенность|
|CELLSNET-42277 | Используйте закрытые символы в рендеринге PDF| Улучшение|
|CELLSNET-44630 | Форматирование чисел (DateTime) теряется при импорте данных из DataGrid (.NET)| Улучшение|
...
|CELLSNET-44625 | Colspan as 2 значительно увеличивает время загрузки и преобразования HTML.| Производительность|
|CELLSNET-44338 | Снижение производительности при рендеринге электронных таблиц в PDF| Производительность|
|CELLSNET-44610 | Атрибут жирного шрифта теряется при преобразовании HTML в XLSX| Ошибка|
|CELLSNET-44609 | Направление содержимого изменяется при преобразовании HTML в XLSX| Ошибка|
|CELLSNET-44608 | Отсутствуют границы при преобразовании HTML в XLSX| Ошибка|
|CELLSNET-44607 | Cell отсутствует затенение при преобразовании HTML в XLSX| Ошибка|
...
|CELLSNET-44579 | MHTML в XLS/XLSX возвращается как пустой документ| Ошибка|
...
|CELLSNET-44603 | Проблема с выравниванием по вертикали, когда содержимое ячейки касается верхней границы при отображении электронных таблиц в PDF| Ошибка|
|CELLSNET-44602 | Проблема горизонтального выравнивания со значениями, которым предшествует знак $, при рендеринге электронных таблиц в PDF| Ошибка|
|CELLSNET-42715 | Потерянные шрифты в PDF| Ошибка|
...
|CELLSNET-44635 | Неверная диаграмма в sample2.xlsx (преобразование Excel в PDF)| Ошибка|
...
|CELLSNET-44623 | Измененный маркер лепестковой диаграммы не конвертируется в PDF должным образом| Ошибка|
|CELLSNET-44601 | Метки горизонтальной оси отсутствуют в рендеринге диаграммы для изображения| Ошибка|
|CELLSNET-44570 | Проблема с форматированием формы WordArt в обработанном PDF-файле| Ошибка|
...
|CELLSNET-44657 | Преобразование из HTML в XLSX в результирующей электронной таблице| Ошибка|
...
|CELLSNET-44584 | System.FormatException возникло при импорте HTML-файла| Исключение|
|CELLSNET-44643 | Возникает исключение при открытии файла| Исключение|
|CELLSNET-44612 | CellsException: ошибка в Cell: O93-недопустимая формула при загрузке XLSM, который был сохранен с Aspose.Cells| Исключение|
