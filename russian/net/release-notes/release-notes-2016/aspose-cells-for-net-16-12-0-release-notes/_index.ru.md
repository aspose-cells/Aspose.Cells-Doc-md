...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-16-12-0-release-notes/
---
...
|CELLSNET-44899|Низкая производительность при вычислении формул во второй раз|Производительность|
|CELLSNET-44967|Вопросы производительности для метода NameCollection.Remove|Производительность|
|CELLSNET-44964|Aspose.Cells зависает, когда CalculateFormula() используется в рабочей книге.|Производительность|
|CELLSNET-44819|Невозможно сохранить исходный файл Excel в HTML, и время истекло|Производительность|
|CELLSNET-44960|Форматирование сводной таблицы теряется при преобразовании электронной таблицы в формат файла PDF|Ошибка|
|CELLSNET-44951|Данные строки теряются при преобразовании электронной таблицы в PDF после обновления сводной таблицы|Ошибка|
|CELLSNET-44950|Cell отсутствует затенение при преобразовании электронной таблицы в PDF после обновления сводной таблицы|Ошибка|
|CELLSNET-44949|Пустые столбцы отсутствуют при преобразовании электронной таблицы в PDF после обновления сводной таблицы|Ошибка|
...
|CELLSNET-44974|Cell затенение искажается при обновлении сводной таблицы и рендеринге в PDF|Ошибка|
|CELLSNET-44972|Cell Затенение применено к неправильной ячейке при обновлении сводной таблицы и рендеринге в PDF|Ошибка|
|CELLSNET-44963|Сохранение в PDF создает дополнительные границы для строк|Ошибка|
...
|CELLSNET-44910|При преобразовании файла ODS в формат PDF появляется дополнительный символ 4.|Ошибка|
|CELLSNET-44958|Замена шрифта не происходит, если FontConfigs.PreferSystemFontSubstitutes имеет значение true|Ошибка|
|CELLSNET-44937|Преобразование Excel в PDF — некоторые слова разрезаются на две части в объединенной области|Ошибка|
|CELLSNET-44933|Экспорт диаграмм Excel в SVG|Ошибка|
|CELLSNET-44914|Поле с правой стороны больше, чем в MS Excel при печати или сохранении в формате PDF|Ошибка|
|CELLSNET-44931|При сохранении в PDF создается дополнительная пустая страница.|Ошибка|
|CELLSNET-44926|Изображение диаграммы в формате PNG не соответствует диаграмме MS-Excel|Ошибка|
|CELLSNET-44912|Время, необходимое для преобразования XLS в XLSX, велико|Ошибка|
|CELLSNET-44905|Экспорт PDF отображает 0 на диаграммах стека|Ошибка|
|CELLSNET-44902|Проблема с рядом данных диаграммы при преобразовании Excel в PDF|Ошибка|
...
|CELLSNET-44883|Ось X (таблица данных) не совпадает с визуализированным PDF-файлом.|Ошибка|
|CELLSNET-44833|Неправильная отрисовка строк при преобразовании электронной таблицы в PDF|Ошибка|
...
|CELLSNET-44893|Aspose.Cell ArithmeticException при вызове Chart.ToImage через CLR-совместимую библиотеку DLL C++|Исключение|
