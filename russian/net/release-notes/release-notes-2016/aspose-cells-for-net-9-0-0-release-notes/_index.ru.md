...
type: docs
weight: 40
url: /ru/net/aspose-cells-for-net-9-0-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44681 | Импорт HTML завершается сбоем, когда тег скрипта использует CDATA| Улучшение|
...
|CELLSNET-44644 | Результирующий файл повреждается при открытии и сохранении файла XLS.| Ошибка|
|CELLSNET-44622 | В финальном файле XLSX отсутствуют стили подписи, в то время как они присутствуют во входном XLSX и промежуточном HTML.| Ошибка|
...
|CELLSNET-44716 | Результат PDF не соответствует Excel для печати строк заголовков| Ошибка|
...
|CELLSNET-44717 | Электронная таблица в XPS: процесс никогда не завершается и занимает слишком много памяти| Ошибка|
|CELLSNET-44678 | Спарклайны отображаются неправильно при преобразовании электронной таблицы в PDF/изображение| Ошибка|
|CELLSNET-44654 | Метод Chart.Calculate() портит изображение графика| Ошибка|
|CELLSNET-44714 | Сохранение в поток памяти (SpreadsheetML), процесс зависает и занимает много времени| Ошибка|
...
|CELLSNET-44696 | Линия со стрелкой не отображается полностью в форматах XLSX и PDF.| Ошибка|
...
|CELLSNET-44658 | Размер текста меток вертикальной оси диаграммы изменяется после загрузки и сохранения файла XLS.| Ошибка|
|CELLSNET-44691 | NullReferenceException в рабочей книге из-за display:none в исходном HTML| Исключение|
