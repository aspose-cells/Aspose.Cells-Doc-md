...
type: docs
weight: 130
url: /ru/net/aspose-cells-for-net-8-7-1-release-notes/
---
...
|CELLSNET-44187 | Cell значения неправильно заменяются на # при преобразовании в HTML| Ошибка|
|CELLSNET-44161 | Aspose.Cells сгенерированный XLSX заставляет Excel 2007 восстанавливать электронную таблицу| Ошибка|
...
|CELLSNET-44193 | Затенение наклонных ячеек неправильно отображается в PDF| Ошибка|
...
|CELLSNET-44218 | При повторном сохранении XLSX файл xl\embeddings\oleObject1.bin переименовывается.| Ошибка|
