...
type: docs
weight: 20
url: /ru/net/aspose-cells-for-net-16-11-0-release-notes/
---
...
|CELLSNET-44847 | Проблема производительности с функцией GetPivotData| Производительность|
|CELLSNET-44832 | Проблема с SheetRender.PageCount, которая занимает много времени для расчета страниц рабочего листа| Производительность|
|CELLSNET-44861 |Метод Range.Copy() зависает для больших диапазонов Excel| Производительность|
|CELLSNET-44854 | Электронная таблица повреждается, когда имена рабочих книг добавляются к именованному диапазону| Ошибка|
|CELLSNET-44852 | Направление RTL изменяется на LTR при преобразовании HTML в Excel| Ошибка|
...
|CELLSNET-44790 | Стиль CSS игнорируется для ширины столбцов, высоты строк, переноса слов и т. д. (HTML в Excel)| Ошибка|
|CELLSNET-44786 | Проблема с шрифтом и выравниванием текста в ячейках TD и TH| Ошибка|
|CELLSNET-44448 | Содержимое сводной таблицы неправильно отображается в выходном PDF-файле| Ошибка|
...
|CELLSNET-44806 | Линия тренда на диаграмме неправильно отображается в выходном PDF-файле| Ошибка|
...
|CELLSNET-44868 | Изменение фонового изображения фигуры повреждает выходной XLS-файл| Ошибка|
...
|CELLSNET-44792 | Некоторые элементы форматирования в файле XLSM шаблона импортируются неправильно| Ошибка|
...
|CELLSNET-44875 |Исключение при сохранении PulseSecure_Прайс-лист_ПЛОСКИЙ НАПИЛЬНИК_ноябрь 2016 г._ 102816_v1.0.xlsx Файл Excel в HTML| Исключение|
|CELLSNET-44874 |Исключение при сохранении PulseSecure_Прайс-лист_ПЛОСКИЙ_ФАЙЛ_ Oct2016.xlsx Файл Excel в HTML| Исключение|
|CELLSNET-44873 |Исключение при сохранении PulseSecure_Прайс-лист_ноябрь 2016 г._102816_ v1.0.xlsx файл Excel в HTML| Исключение|
|CELLSNET-44872 |Исключение при сохранении PulseSecure_Прайс-лист_октябрь 2016 г._093016_ v1.xlsx файл Excel в HTML| Исключение|
