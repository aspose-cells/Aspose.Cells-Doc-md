...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-net-8-8-3-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44512 | Проблема с производительностью в методе Cells.CopyRows()| Производительность|
...
|CELLSNET-44467 | Невозможно экспортировать весь HTML-контент в Excel, если в HTML есть вложенные элементы div.| Ошибка|
...
|CELLSNET-44521 | Преобразование в PDF приводит к 2 страницам PDF, а не к предварительному просмотру в Excel.| Ошибка|
|CELLSNET-44489 | Преобразование Excel в PDF - при форматировании теряется символ по ширине| Ошибка|
|CELLSNET-44481 | Преобразование Excel в PDF — положение разрыва страницы было изменено| Ошибка|
...
|CELLSNET-40572 | Область диаграммы становится бессвязной при преобразовании в PDF .NET| Ошибка|
...
|CELLSNET-44498 | Строки заголовков не повторяются при преобразовании электронной таблицы в PDF с турецким языком.| Ошибка|
...
|CELLSNET-44271 | ODS в PDF: первые 2 страницы содержат синий оттенок| Ошибка|
