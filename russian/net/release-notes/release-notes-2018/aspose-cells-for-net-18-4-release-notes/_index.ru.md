...
type: docs
weight: 90
url: /ru/net/aspose-cells-for-net-18-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46013|Новый перекрестный тип со скрытым наложенным содержимым при сохранении в формате HTML|Улучшение|
|CELLSNET-45965|Возможность обработки стандартного элемента LINK при обратном преобразовании|Улучшение|
|CELLSNET-46032|Не создавать пустой PDF-файл с одной страницей, если файл Excel пуст|Улучшение|
|CELLSNET-46027|Преобразование Excel в PDF — проблема с верхним/нижним колонтитулом|Улучшение|
...
|CELLSNET-46005|Записи перевернуты для разных листов в выходном формате PDF-файла|Ошибка|
|CELLSNET-45958|Неправильное форматирование при сохранении XLSX в виде HTML|Ошибка|
|CELLSNET-45907|Отсутствующие значения при отображении диаграммы|Ошибка|
|CELLSNET-46034|Не удается удалить сводные таблицы (с внешним источником данных) из файла формата XLS|Ошибка|
...
|CELLSNET-45990|Вывод PDF зависит от типа оптимизации|Ошибка|
...
|CELLSNET-46002|Строки заголовков страниц отображаются только на первой странице выходного PDF-файла.|Ошибка|
