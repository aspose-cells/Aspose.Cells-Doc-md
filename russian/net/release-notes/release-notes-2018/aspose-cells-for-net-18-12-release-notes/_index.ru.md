...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-18-12-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-42414|Отслеживаемые изменения теряются при преобразовании из XLSB в XLSM и из XLS в XLSM.|Улучшение|
|CELLSNET-46090|Текст немного сдвинулся после разгруппировки фигуры при сохранении XLS в XLSX.|Улучшение|
|CELLSNET-46439|Оптимизация производительности памяти: выпуск исходного потока после загрузки книги|Производительность|
|CELLSNET-46371|Линии сетки не отображаются на некоторых листах при преобразовании XLSX->HTML->XLSX|Ошибка|
|CELLSNET-46447|Форматирование теряется при рендеринге HTML в XLS|Ошибка|
...
|CELLSNET-46466|Нижний текст под штрих-кодом отсутствует при преобразовании MS Excel в PDF|Ошибка|
|CELLSNET-46470|Изображение отсутствует после преобразования в формат TIFF.|Ошибка|
...
|CELLSNET-46451|Проблема при преобразовании файла шаблона (содержащего диаграмму) в формат файла PDF|Ошибка|
...
|CELLSNET-42729|Текст смещается, когда диаграммы SmartArt визуализируются в формате файла HTML.|Ошибка|
|CELLSNET-46462|Текст повторяется при замене тега текстом|Ошибка|
|CELLSNET-46483|Ошибка после преобразования документа с Custom UI xml из XLSB в XLSM|Ошибка|
