...
type: docs
weight: 40
url: /ru/net/aspose-cells-for-net-18-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46290|Неправильные цвета отображаются для фигур при преобразовании Excel в PDF|Ошибка|
|CELLSNET-46282|Довольно маленькие изображения в формате PDF|Ошибка|
...
|CELLSNET-46313|Проблемы в выходном PDF-файле при использовании ключевых слов на немецком языке в верхних и нижних колонтитулах сценариев|Ошибка|
...
|CELLSNET-46305|Текст вне области печати, отображаемый в формате PDF|Ошибка|
