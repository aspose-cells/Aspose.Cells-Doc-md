...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-net-18-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46087|Настройка страницы PrintErrorType не работает при преобразовании Excel в PDF|Улучшение|
|CELLSNET-46084|PageSetup.PrintDraft не действует при сохранении в PDF|Улучшение|
|CELLSNET-46100|System.OutOfMemoryException при преобразовании файла Excel в PDF|Производительность|
...
|CELLSNET-46109|Обтекание текстом неверно, когда «Issue2 wrapping.xlsx» преобразуется в PDF|Ошибка|
|CELLSNET-46108|Обтекание текстом неверно, когда «Issue3 wrapping.xlsx» преобразуется в PDF|Ошибка|
...
|CELLSNET-46036|Заголовок диаграммы сжат, когда все символы идут вместе при рендеринге Excel в PDF|Ошибка|
...
|CELLSNET-46068|Aspose.Cells возвращает пустой PDF-файл при сохранении файла SpreadsheetML в формате PDF|Ошибка|
|CELLSNET-46060|Потеря данных происходит при преобразовании ODS в формат файла XLSX.|Ошибка|
...
|CELLSNET-46075|Исключение при преобразовании файла Excel в PDF|Исключение|
