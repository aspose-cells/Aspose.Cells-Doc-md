...
type: docs
weight: 5
url: /ru/net/aspose-cells-for-net-21-8-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-48372|Подождите, сохраните в html файл XLSB|Производительность|
...
|CELLSNET-47839|Shape to image Ошибка при сохранении XLSX в PDF|Ошибка|
...
|CELLSNET-48333| Столбцы таблицы в диапазоне с выравниванием по нижнему краю объединяются в преобразованном HTML|Ошибка|
|CELLSNET-48365| Срезы, созданные из базовых полей сводной таблицы, не работают|Ошибка|
|CELLSNET-48359|Макросы удаляются после перехода с XLS на XLSM|Ошибка|
|CELLSNET-48448|Источник данных диаграммы с именованным диапазоном анализируется неправильно|Ошибка|
|CELLSNET-47369|Точка диаграммы отсутствует, а форма сжата в сгенерированном изображении EMF|Ошибка|
...
|CELLSNET-48385|XLSX в TIFF: гистограммы не отображаются на выходе|Ошибка|
