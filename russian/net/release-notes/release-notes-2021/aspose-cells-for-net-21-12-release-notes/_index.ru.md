...
type: docs
weight: 1
url: /ru/net/aspose-cells-for-net-21-12-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-49825|Проблема производительности с атрибутом ExportImagesAsBase64 при преобразовании Excel в HTML|Производительность|
...
|CELLSNET-49864|Слова, отображаемые в обратном порядке для текста справа налево при преобразовании XLSX в PDF|Ошибка|
|CELLSNET-49873|Xlsx в pdf: разрыв страницы отличается от сгенерированного Excel pdf|Ошибка|
|CELLSNET-49922|Символы не помещаются на одной странице, а положение печати изменяется в Excel на рендеринг PDF|Ошибка|
|CELLSNET-49998|Не удается просмотреть определенный файл XLS с разметкой HTML|Ошибка|
|CELLSNET-49742|Различия в chart1.xml после сохранения|Ошибка|
|CELLSNET-49875|XLSX в EMF, перекрывающие деления|Ошибка|
|CELLSNET-49904|Даты диаграммы в PNG не преобразованы должным образом|Ошибка|
...
|CELLSNET-49924|Aspose-сгенерированные файлы XLSX открываются с ошибкой|Ошибка|
