...
type: docs
weight: 30
url: /ru/net/aspose-cells-for-net-21-1-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47653|Diagram блоки сдвинуты при преобразовании в HTML|Ошибка|
|CELLSNET-47720|Недопустимая разметка CSS и HTML при преобразовании XLSX в HTML|Ошибка|
...
|CELLSNET-47797|Неверная ссылка при отображении файла XLSM в формате HTML|Ошибка|
...
|CELLSNET-47784|Исключение при импорте документа HTML с помощью IStreamProvider|Исключение|
