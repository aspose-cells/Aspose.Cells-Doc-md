...
type: docs
weight: 9
url: /ru/net/aspose-cells-for-net-21-4-release-notes/
---
{{% alert color="primary" %}}
...
|:- |:- |:- |
|CELLSNET-47891|Поддержка получения стиля отображения с включением кеша|Новая особенность|
|CELLSNET-47922|Визуализация данных с координатами ячеек в преобразовании Excel в HTML|Улучшение|
...
|CELLSNET-47916|Тег стиля HTML потребляет 4 ГБ памяти и аварийно завершает работу при загрузке в книгу|Производительность|
...
|CELLSNET-47858|Фигуры не отображаются должным образом в HTML и PDF|Ошибка|
...
|CELLSNET-47965| Преобразование Excel в PDF - Страницы документа перепутаны|Ошибка|
|CELLSNET-46161|Наклонный текст неправильно отображается в выходном PDF-файле|Ошибка|
|CELLSNET-47917|Перепутались метки круговой диаграммы в PDF, сгенерированном из листа Excel|Ошибка|
...
|CELLSNET-47963|Параметр недействителен, исключение при рендеринге диапазона в PNG|Исключение|
