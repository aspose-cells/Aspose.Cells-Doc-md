...
type: docs
weight: 6
url: /ru/net/aspose-cells-for-net-21-7-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-48196|Сохранение форматирования текста при преобразовании из HTML в XLSX|Улучшение|
|CELLSNET-48213|Стили форматированного текста теряются при преобразовании из HTML в XLSX|Улучшение|
...
|CELLSNET-43625|Проблема рендеринга фигур в преобразовании Excel в PDF|Ошибка|
|CELLSNET-43749|Положение выноски изменено при рендеринге электронной таблицы в PDF|Ошибка|
|CELLSNET-43766|Символы в круглых формах немного смещены влево в выходном PDF-файле.|Ошибка|
...
|CELLSNET-43464|Преобразование XLSX в PDF создает более длинный документ с большим количеством страниц, чем должно|Ошибка|
|CELLSNET-44706|Электронная таблица в PDF: фигуры либо неуместны, либо искажены|Ошибка|
|CELLSNET-45259|Отсутствует текстовое пространство в визуализируемом изображении emf|Ошибка|
|CELLSNET-45744|Aspose.Cells не использует установленные на машине шрифты при рендеринге PDF|Ошибка|
...
|CELLSNET-46796|Встроенное изображение Gif отображается как черный ящик при преобразовании Excel в TIFF.|Ошибка|
|CELLSNET-47090|Проблема с рендерингом XLSX в PDF|Ошибка|
...
|CELLSNET-48199|Возникло исключение при загрузке HTML-файла без использования «HtmlLoadOptions.AutoFitColsAndRows = true»|Исключение|
...
|CELLSNET-48266|"Параметр недействителен." исключение при рендеринге XLSX в HTML|Исключение|
|
