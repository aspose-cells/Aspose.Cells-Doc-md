...
type: docs
weight: 100
url: /ru/net/aspose-cells-for-net-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 17.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.3.0/).
...
|CELLSNET-45136|Ячейки поворачиваются при преобразовании Excel в PDF|Ошибка|
...
|CELLSNET-45135|Изображения перекрываются при импорте HTML в формате XLSX|Ошибка|
...
|CELLSNET-45127|Стиль и размер шрифта изменяются после импорта HTML в формате XLSX.|Ошибка|
...
|CELLSNET-45076|Выравнивание не работает, и текст выходит за пределы ячейки при преобразовании Excel в HTML|Ошибка|
|CELLSNET-45057|Преобразование HTML в XLSX некорректно|Ошибка|
|CELLSNET-45040|Некоторые элементы сводного поля отображаются как значения даты, а не числа.|Ошибка|
...
|CELLSNET-45196|Распечатка искажена в экспортированном XPS|Ошибка|
...
|CELLSNET-43732|Рендеринг в EMF и вставка в Word приводит к перекрытию текста в результирующем PDF-файле.|Ошибка|
|CELLSNET-45186|Диаграмма с областями не отображается при экспорте в PDF|Ошибка|
...
|CELLSNET-45151|Диаграммы теряют все форматирование при преобразовании электронной таблицы в PDF|Ошибка|
|CELLSNET-45147|Диаграмма отсутствует при рендеринге электронной таблицы в PDF|Ошибка|
|CELLSNET-44998|Метки данных диаграммы меняются после преобразования электронной таблицы в PDF|Ошибка|
|CELLSNET-44984|Линия тренда на второй диаграмме неправильно отображается в выходном PDF-файле.|Ошибка|
|CELLSNET-41539|Текст/изображение в виде зеленого эллипса неправильно отображается вокруг диаграммы в PDF-файле|Ошибка|
...
|CELLSNET-45175|Форматирование изображений не работает для файлов XLSX|Ошибка|
|CELLSNET-45174|Диапазон Print_Area прервался после DeleteRange|Ошибка|
|CELLSNET-45173|Файл XLSX поврежден после сохранения|Ошибка|
...
|CELLSNET-45199|Excel в PDF — исключение «Индекс вне массива»|Исключение|
...
1. [Настройка параметров глобализации для сводной таблицы](/cells/ru/net/customize-globalization-settings-for-pivot-table/)
1. [Выполнение функции на стороне клиента при изменении страницы GridWeb](/cells/ru/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/ru/net/execute-client-side-function-on-gridweb-page-change/)
1. [Проверять весь рабочий лист, а не только обновленные ячейки](/cells/ru/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
