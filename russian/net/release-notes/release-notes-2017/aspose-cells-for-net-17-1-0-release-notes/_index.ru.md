...
type: docs
weight: 120
url: /ru/net/aspose-cells-for-net-17-1-0-release-notes/
---
...
|CELLSNET-44994|Проблема с форматом даты в немецком языке при преобразовании файла Excel в PDF|Улучшение|
|CELLSNET-44986|Представление двойных чисел в Aspose.Cells|Улучшение|
|CELLSNET-45023|PivotTable.RefreshData занимает много времени|Производительность|
|CELLSNET-45012|Производительность GETPIVOTDATA|Производительность|
...
|CELLSNET-43815|Объекты WordArt становятся простыми точками в выходном PDF-файле|Ошибка|
...
|CELLSNET-44938|График отображается неправильно при преобразовании электронной таблицы в PDF|Ошибка|
...
|CELLSNET-43725|Изменение размера ListObject в XLSM с использованием диапазона внешних данных приводит к искажению результата.|Ошибка|
|CELLSNET-43580|Этот водяной знак WordArt печатается неправильно, так как цвет/стиль изменены в выходном PDF-файле.|Ошибка|
|CELLSNET-43562|Фильтрация по столбцам теряется при преобразовании XLSX в ODS|Ошибка|
...
|CELLSNET-41164|Поддержка SmartArt при рендеринге из Excel в PDF|Ошибка|
