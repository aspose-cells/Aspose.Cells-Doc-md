---
title: Aspose.Cells for .NET 17.02.0 Примечания к выпуску
type: docs
weight: 110
url: /ru/net/aspose-cells-for-net-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 17.02.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.02.0/).

{{% /alert %}} 

|**Ключ**|**Резюме**|**Категория**|
|:- |:- |:- |
|CELLSNET-45049|Обрезайте пустые строки и столбцы при экспорте электронных таблиц в формат CSV.|Новая особенность|
...
|CELLSNET-45026|Метод CalculateFormula() занимает слишком много времени для возврата|Производительность|
|CELLSNET-45071|CellsException: Недостаточно памяти при преобразовании книги в TIFF|Производительность|
|CELLSNET-45067|Преобразование в PDF занимает слишком много времени|Производительность|
|CELLSNET-45105|Загрузка HTML завершается сбоем, если значение CultureInfo установлено на французском языке.|Ошибка|
...
|CELLSNET-45039|Правило смешанного стиля не учитывается при рендеринге HTML в Excel.|Ошибка|
...
|CELLSNET-44336|Невозможно правильно преобразовать Html в XLSX|Ошибка|
...
|CELLSNET-45085|Расчетное значение функции ЛОГНОРМ.РАСП неверно в формате PDF.|Ошибка|
|CELLSNET-44740|Пользовательский шаблон DateTime не может быть применен к GridColumn|Ошибка|
|CELLSNET-45130|Другой результат с использованием экспорта Excel в PDF и Aspose.Cells сохранения в формате PDF|Ошибка|
|CELLSNET-45095|Изображение из электронной таблицы не было преобразовано в PDF|Ошибка|
|CELLSNET-45075|Гиперссылки из электронной таблицы не экспортируются в PDF|Ошибка|
|CELLSNET-45074|Проблема форматирования в рендеринге Excel в PDF|Ошибка|
...
|CELLSNET-45118|Электронная таблица повреждается после сохранения в формате XLSM|Ошибка|
...
|CELLSNET-45094|Положение текста изменяется после загрузки и сохранения XLS|Ошибка|
...
|CELLSNET-45112|При вызове Pictures.Clear(), а затем при сохранении XLS возникает System.ArgumentOutOfRangeException|Исключение|
...
|CELLSNET-45088|Исключение при преобразовании электронной таблицы в формат файла PDF|Исключение|
...
В этой версии Aspose.Cells for .NET представлено свойство TrimLeadingBlankRowAndColumn логического типа для класса TxtSaveOptions, которое указывает, следует ли обрезать ведущие пустые строки и столбцы, как это делает Excel, при экспорте данных в форматы CSV или с разделителями табуляции. Значение по умолчанию для вышеупомянутого свойства — false. Если данные на листе не начинаются с первой ячейки, то есть: A1, приложение Excel удаляет начальные пустые строки и столбцы при экспорте данных в форматы CSV или с разделителями табуляции, однако API Aspose.Cells по умолчанию сохраняют пустые строки и столбцы для одного и того же образца, чтобы сохранить местоположение данных, если экспортированные файлы CSV или файлы с разделителями табуляцией должны быть импортированы обратно с использованием API Aspose.Cells.
...
1. [Автоподбор столбцов и строк при загрузке HTML в книгу](/cells/ru/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Преобразование текста в столбцы с помощью Aspose.Cells](/cells/ru/net/convert-text-to-columns-using-aspose-cells/)
1. [Получить список шрифтов, используемых в электронной таблице или книге](/cells/ru/net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Получать предупреждения при загрузке файла Excel](/cells/ru/net/get-warnings-while-loading-excel-file/)
1. [Чтение и обработка диаграмм Excel 2016](/cells/ru/net/read-and-manipulate-excel-2016-charts/)
1. [Обрезать начальные пустые строки и столбцы при экспорте электронных таблиц в формат CSV](/cells/ru/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
1. [Привязка рабочего листа к настраиваемому объекту коллекции с помощью GridWeb](/cells/ru/net/binding-worksheet-to-a-customized-collection-object-using-gridweb/)
1. [Автоматическое переименование повторяющихся столбцов при экспорте данных листа](/cells/ru/net/rename-duplicate-columns-automatically-while-exporting-worksheet-data/)
1. [Разделение панелей на рабочем листе GridDesktop](/cells/ru/net/split-panes-in-griddesktop-worksheet/)
