...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-net-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 17.5](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.5/).
...
|CELLSNET-45350|Ошибка OutOfMemory при рендеринге изображения|Производительность|
|CELLSNET-45341|Преобразование XLS в SpreadsheetML с фильтрами приводит к повреждению выходного файла.|Производительность|
...
|CELLSNET-45304|Неправильное выравнивание текста вертикально повернутого текста в выходном HTML|Ошибка|
|CELLSNET-45299|Текст не помещается в ячейку при сохранении в формате HTML|Ошибка|
...
|CELLSNET-45339|Преобразованный из ODS в XML (SpreadsheetML) файл не открывается в MS Excel|Ошибка|
...
|CELLSNET-45303|Фигуры (прямоугольники, линии и т. д.) больше не связываются при повторном сохранении из формата файла XLSX в формат XLS.|Ошибка|
...
- [Скопируйте настройки параметров страницы из исходного листа в рабочий лист назначения](/cells/ru/net/copy-page-setup-settings-from-source-worksheet-into-destination-worksheet/)
- [Реализовать пользовательский размер бумаги рабочего листа для рендеринга](/cells/ru/net/implement-custom-paper-size-of-worksheet-for-rendering/)
- [Удалить существующие настройки принтера для рабочих листов в файле Excel](/cells/ru/net/remove-existing-printersettings-of-worksheets-in-excel-file/)
