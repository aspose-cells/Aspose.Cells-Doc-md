...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-v4-8-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET v4.8.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.8.0/)
...
{{% /alert %}} 
 ...
 l Добавление фигур WordArt в файл XLS
...
|8984 | HTML| Низкая производительность при сохранении книги в формате HTML|
|7915 | PDF| Проблема конвертации ячеек в pdf|
|8669 | PDF| Проблема преобразования Excel в PDF|
|8672 | PDF| Разница в выводе при создании файла Excel в файл Pdf|
|8678 | PDF| Cells В PDF изображение нижнего колонтитула размыто|
|8749 | PDF| Диаграммы не отображаются в Excel PDF|
|8986 | PDF| Преобразование из Excel в PDF|
|8988 | PDF|сохранение книги в формате PDF не работает|
|9608 | PDF| Проблема преобразования XLS (отрицательная длина?)|
