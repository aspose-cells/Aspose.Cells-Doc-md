...
type: docs
weight: 20
url: /ru/net/aspose-cells-for-net-v4-7-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET v4.7.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.7.1/)
...
|8420 | HTML| Проблема с форматом экспорта HTML|
|7718 | PDF| Поддерживает гиперссылку при прямом преобразовании ячеек в pdf.|
|7723 | PDF| Проблемы со шрифтом при конвертации Aspose.Cells в PDF|
...
|7838 | PDF| Excel в PDF создает поврежденный файл PDF|
...
|8116 | SpreadML| Bad SpreadsheetML при удалении листа|
