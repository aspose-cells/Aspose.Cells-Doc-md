...
type: docs
weight: 20
url: /ru/net/aspose-cells-for-net-7-0-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.0.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.0.2/)
...
29692 Проблема при преобразовании Excel в PDF
 ...
 30270 Проблема с печатью — числа отображаются как «#######»

 30533 Проблема с функцией DeleteRange

 30603 Проблема с EMF и PNG
 ...
 30980 Загрузка и обновление XLSM с последующим сохранением вызывает ОШИБКИ
...
31068 Сбой при сохранении файла после использования метода DeleteRange в некоторых случаях
 ...
 31277 Сохранение в формате XLSX документа с защитой от записи
