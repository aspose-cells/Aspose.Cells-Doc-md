...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-7-0-3-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.0.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.0.3/)
...
40010 Снимите флажок «Многоуровневые метки категорий» при форматировании оси диаграммы
 ...
 31266 XLS в PDF или XPS занимает так много времени

 40053 Производительность преобразования Excel в PDF снижается по мере увеличения количества рабочих листов
...
30651 Cell.SetStyle (стиль стиля, логическое явное флаг) не работает должным образом
 ...
 40009 Проблема с открытием файла XLSM
 ...
 40014 При открытии и сохранении файла XLSM удаляются макросы и ленты
