...
type: docs
weight: 50
url: /ru/net/aspose-cells-for-net-6-0-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 6.0.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-6.0.1/)
...
### **Исключения**
 ...
 28867 Недопустимый параметр при преобразовании Excel в TIFF
### **Ошибки**
...
28460 Функция ДВССЫЛ не оценивается в функции ВПР
 ...
 28571 Смещенные ячейки в HTML

 24963 Изображение с прозрачным фоном в формате PDF

 28697 Проблема с водяным знаком при преобразовании в PDF

 28610 Группа объектов исчезает при преобразовании Excel в PDF

 28815 Неверное преобразование из XLS в PDF
...
29058 Проблема рендеринга
 ...
 28782 Проблема генерации XLSB, когда рабочий лист содержит проверку данных
...
26751 Визуализировать изображения формы в формате EMF вместо формата JPEG
### **Ошибки**
