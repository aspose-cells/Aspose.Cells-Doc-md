...
type: docs
weight: 70
url: /ru/net/aspose-cells-for-net-5-3-3-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 5.3.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.3.3/)
...
### **Улучшения**
 ...
 26082 Поддержка выравнивания по ширине при рендеринге в формате PDF

 26341 Улучшение преобразования Excel в PDF для Mono

 26342 Внешние веб-ссылки содержат странные символы

 25332 Улучшение различных пользовательских свойств в документах XLS, XLSX/XLSM

 26472 Поддержка функции/формулы STDEV.S
### **Производительность**
 25774 Преобразование Excel в PDF
### **Исключения**
...
### **Ошибки**
 ...
 19318 Неправильный текст в экспорте PDF

 24011 Сохранить в PDF (ошибки)

 26727 Несколько проблем при сохранении созданного файла Excel в формате PDF
...
26711 Вычисляемая ячейка содержит «#ЗНАЧ!» после использования метода Workbook.CalculateFormula()
 ...
 26308 Формула XLSB возвращает значение, отличное от формулы XLSX
