...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-net-5-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 5.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.3.2/)
...
|24514 | PDF| Проблема с преобразованием Excel в PDF|
|25149 | PDF| Экспорт в PDF — проблема с производительностью сборки мусора|
|25260 | PDF| Проблема с XLS в PDF|
...
|25615 | PDF| проблема с конвертацией пдф|
