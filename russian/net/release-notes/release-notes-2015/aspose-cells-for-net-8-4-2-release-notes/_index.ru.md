...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-net-8-4-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.4.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.2/)
...
## **Ошибки**
 ...
 (CELLSNET-43581) — текст перемещается из баннера при преобразовании файла Excel в PDF.
 ...
 (CELLSNET-43571) - Неправильный разрыв страницы в сгенерированном PDF-файле через Aspose.Cells.
...
## **Исключения**
 ...
 (CELLSNET-43609) — Исключение при преобразовании файла Excel в формат файла PDF.
...
(CELLSNET-43583) — Ошибка GDI в методе SheetRender.ToImage
 ...
 (CELLSNET-43564) — исключение NullReferenceException при сохранении файла XLSB обратно.
