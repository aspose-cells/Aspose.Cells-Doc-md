...
type: docs
weight: 90
url: /ru/net/aspose-cells-for-net-8-4-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.4.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.1/)
...
## **Ошибки**
 ...
 (CELLSNET-43474) — сводная таблица не обновляется при рендеринге в HTML.
...
(CELLSNET-43422) — Удаление исходного листа вызывает исключение при сохранении.
 ...
 (CELLSNET-43413) - Неправильное преобразование из файла HTML в PDF

 (CELLSNET-43340) — Повторное сохранение электронной таблицы XLS приводит к повреждению результата.

 (CELLSNET-43545) — Дата перекрывается с текстом в левом нижнем колонтитуле в обработанном формате PDF-файла.
 ...
 (CELLSNET-43508) — при преобразовании электронной таблицы в PDF создается пустой PDF-файл.

 (CELLSNET-43507) — немного ухудшились пиксели изображения в выходном PDF-файле.
...
(CELLSNET-43412) — установка для CategoryAxis CategoryType значения TimeScale приводит к зависанию метода Chart.Calculate.
 ...
 (CELLSNET-42614) — Диаграмма, экспортированная в PDF, содержит дополнительные строки.
