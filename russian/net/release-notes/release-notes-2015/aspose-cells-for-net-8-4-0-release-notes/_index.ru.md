...
type: docs
weight: 100
url: /ru/net/aspose-cells-for-net-8-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.0/)
...
## **Улучшения**
 ...
 (CELLSNET-43454) - Aspose.Pdf не проверяет выходной PDF/A-1B

 (CELLSNET-43452) — соответствие PDFA1B выходного файла PDF не было подтверждено.
...
## **Производительность**
 ...
 (CELLSNET-43438) — при преобразовании электронной таблицы в HTML создается HTML-файл размером 1 ГБ.
...
(CELLSNET-43460) - Цвет фона: rgba(0, 0, 0, 0); делает цвет фона черным
 ...
 (CELLSNET-43328) - неправильное расположение изображений в выходном PDF-файле.
...
(CELLSNET-43414) — разрыв между заголовком и телом отличается
 ...
 (CELLSNET-43410) - Неверный интервал между каждым Environment.NewLine в выходном PDF-файле.
...
(CELLSNET-43339) — диаграммы неправильно отображаются в выходном PDF-файле.
 ...
 (CELLSNET-43441) — преобразование из XLSX в XLSB приводит к повреждению электронной таблицы.
...
(CELLSNET-43423) — PageSetup.IsHFAlignMargins автоматически становится истинным в выходном файле Excel.
 ...
 (CELLSNET-43336) - Проблема с визуализацией условного форматирования - Excel в HTML

(CELLSNET-43335) - Проблема с визуализацией условного форматирования - Excel в PDF
