...
type: docs
weight: 60
url: /ru/net/aspose-cells-for-net-8-5-1-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.5.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.1/)
...
(CELLSNET-43199) — Содержимое и формы меняются при сохранении Excel в PDF.
...
(CELLSNET-43716) - Ошибка преобразования формы в изображение при преобразовании в PDF
