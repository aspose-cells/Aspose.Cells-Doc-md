...
type: docs
weight: 110
url: /ru/net/aspose-cells-for-net-8-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.3.2/)
...
## **Улучшения**
 ...
 (CELLSNET-43305) — Копирование диапазона с помощью PasteType.All не копирует гиперссылку.
