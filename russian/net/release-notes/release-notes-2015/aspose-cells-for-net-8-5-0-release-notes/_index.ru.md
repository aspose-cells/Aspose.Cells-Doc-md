...
type: docs
weight: 70
url: /ru/net/aspose-cells-for-net-8-5-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.5.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.0/)
...
## **Ошибки**
 ...
 (CELLSNET-43584) — Метки диаграмм теряются при преобразовании в PDF.
...
(CELLSNET-43329) - Вычисление формулы с СУММЕСЛИ дает результат, отличный от результата Excel.
 ...
 (CELLSNET-43715) — Cell Заполнение узором — при преобразовании PDF создаются большие файлы
 ...
 (CELLSNET-43676) - Выходной PDF-файл имеет неправильное количество страниц

 (CELLSNET-43672) — Плохое качество изображения при рендеринге рабочего листа в PNG.

 (CELLSNET-43661) — текст усекается при преобразовании электронной таблицы в PDF.

 (CELLSNET-43644) — текст отображается неправильно.

 (CELLSNET-43600) — файл Excel отображается неправильно.

 (CELLSNET-43593) — Текст находится над линией и другие проблемы с форматированием при преобразовании Excel в PDF
...
(CELLSNET-43481) - Cells со словами на иврите потеряли согласованность RTL
 ...
 (CELLSNET-42832) — текст за пределами разрыва страницы отображается в PDF как завернутый текст.
 ...
 (CELLSNET-42542) — Объединенный и деформированный текст обрезается при преобразовании XLSX в PDF.

 (CELLSNET-42537) - Подчеркивание перекрытий двойной нижней границей

 (CELLSNET-42474) - Размер шрифта изменился после преобразования в PDF

 (CELLSNET-42260) — Сравнение PDF, созданного с помощью Aspose.Cells, с MS Excel
...
(CELLSNET-41519) — страницы не выстраиваются в линию при преобразовании файла XLSX в PDF.
 ...
 (CELLSNET-43680) - Цвет легенды отсутствует в выходном файле PDF при преобразовании Excel в PDF.

 (CELLSNET-43679) — Горизонтальное масштабирование диаграммы по оси X отсутствует в отображаемом формате PDF-файла.

 (CELLSNET-43677) - невозможно установить ось категорий на текстовую ось.

 (CELLSNET-43668) — Трехмерная круговая диаграмма не отображается нормально при преобразовании Excel в PDF.
 ...
 (CELLSNET-42376) — текст обрезается из TextBox при преобразовании XLSX в PDF.

 (CELLSNET-42369) - PDF-файл отображается неправильно
...
(CELLSNET-43714) — Пользовательская лента удаляется при обработке файла XLSM.
 ...
 (CELLSNET-43665) — при сохранении XLS в XLSX текстовые поля были удалены с рабочего листа.

 (CELLSNET-43664) — символ евро заменяется на знак доллара при сохранении в формате ODS.
