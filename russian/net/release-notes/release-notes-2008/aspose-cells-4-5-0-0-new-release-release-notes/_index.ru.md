...
type: docs
weight: 20
url: /ru/net/aspose-cells-4-5-0-0-new-release-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells 4.5.0.0 Новая версия](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-4.5.0.0-new-release/)
