...
|CELLSNET-50041| Файлы изображений BMP не отображаются в верхнем/нижнем колонтитуле|Улучшение|
|CELLSNET-50108|XLS в PDF: Преобразование останавливается из-за нехватки памяти|Производительность|
...
|CELLSNET-50094|Содержимое листа не отображается должным образом при преобразовании Excel в PDF|Ошибка|
|CELLSNET-50129|Позиция печати поднимается по мере просмотра страницы - преобразование Excel в PDF|Ошибка|
...
|CELLSNET-50137|XLSX в HTML необъявленная переменная «узел» в скрипте|Ошибка|
...
|CELLSNET-50071|Исключение преобразования в HTML "Неподдерживаемая функция: КУБМНОЖ"|Исключение|
...
|CELLSNET-50016|Диаграмма для EMF неверные значения оси|Регрессия|
|
