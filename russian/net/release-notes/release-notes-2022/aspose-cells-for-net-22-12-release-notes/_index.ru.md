...
type: docs
weight: 1
url: /ru/net/aspose-cells-for-net-22-12-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47895|Изображения искажаются при преобразовании Excel в PDF/HTML|
...
|CELLSNET-52301|XLSX Chart to Image: Пользовательские столбцы комбинированных диаграмм отображаются неправильно|
|CELLSNET-52336|Диаграмма гистограммы не отображается должным образом при преобразовании XLSX в HTML/PDF|
|CELLSNET-52292|Текст отображается не на той странице в выходном PDF - Преобразование Excel в PDF|
|CELLSNET-52367|AutofitRows приводит к обрезанию текста в выходных данных преобразования PDF|
...
|CELLSNET-52332|Числа отображаются как «#» или научное число при преобразовании в html|
|CELLSNET-52338| Выходной HTML недетерминирован|
