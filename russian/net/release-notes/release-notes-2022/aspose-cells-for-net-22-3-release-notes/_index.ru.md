...
type: docs
weight: 10
url: /ru/net/aspose-cells-for-net-22-3-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-50334|Регрессия: XLS в PDF: заголовок отображается неправильно|
|CELLSNET-50367|Преобразование .XLSX в PDF занимает много времени и приводит к появлению дополнительных страниц.|
...
|CELLSNET-50554|Содержимое не отображается должным образом при преобразовании Excel в PDF|
|CELLSNET-50316|Обернутые тексты не работают с диаграммами при создании PDF|
|CELLSNET-50411|Метки горизонтальной оси диаграммы неправильно отображаются в выходном PDF-файле.|
