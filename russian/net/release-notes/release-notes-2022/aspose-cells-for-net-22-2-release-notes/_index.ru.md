...
type: docs
weight: 11
url: /ru/net/aspose-cells-for-net-22-2-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-50152| Различное форматирование и другие проблемы с отображением фигур в файлах PDF и HTML файлов Excel.|
|CELLSNET-50300|Некоторые фигуры не отображаются должным образом при преобразовании Excel в PDF|
...
|CELLSNET-50268|Пустой массив CellsArea, возвращенный для файлов CSV/TSV|
|CELLSNET-50269|Финский язык. В числах, отформатированных как проценты, отсутствует пробел перед символом процента.|
