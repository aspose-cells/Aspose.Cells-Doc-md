...
type: docs
weight: 6
url: /ru/net/aspose-cells-for-net-22-7-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-51472|Метки диаграммы отсутствуют в SVG, если они установлены на внешний конец|
|CELLSNET-51491|Неправильные значения, используемые в сериях диаграмм при отображении в изображение или HTML|
