...
type: docs
weight: 90
url: /ru/net/aspose-cells-for-net-8-0-0-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.8.0/)
...
(CELLSNET-42413) — Сценарии теряются при преобразовании XLSB в XLSM.
...
(CELLSNET-42367) — проблема с вертикальным текстом в выходном PDF-файле.
...
(CELLSNET-42357) — в выходном HTML-коде отсутствуют некоторые флажки.

(CELLSNET-42352) — Отсутствуют границы при преобразовании XLSX в HTML.
...
(CELLSNET-42410) — Дополнительный разрыв страницы при преобразовании Excel в PDF

(CELLSNET-42338) — расхождения и проблемы со значениями и диаграммами в выходных XPS.

(CELLSNET-41853) - Дизайны со страницы XLS полностью потеряны

(CELLSNET-41803) — отрицательная панель данных не отображается в выходном PDF-файле.

(CELLSNET-42473) - Диаграмма не содержит маркеров в выходном PDF-файле.
...
(CELLSNET-42412) — Некоторые формулы не работают в выходном PDF-файле после вызова CalculateFormula().
