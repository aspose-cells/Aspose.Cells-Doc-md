...
type: docs
weight: 50
url: /ru/net/aspose-cells-for-net-8-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 8.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.2/)
...
## **Ошибки**
 ...
 (CELLSNET-42800) — Общее название отсутствует при преобразовании сводной таблицы в PDF.
...
(CELLSNET-42799) — Cell Проблема слияния при преобразовании сводной таблицы в PDF
 ...
 (CELLSNET-42438) Содержимое объединенных ячеек исчезает при фильтрации строк и преобразовании электронной таблицы в HTML.

 (CELLSNET-42353) - Aspose.Cells сделать стрелку двойной толщины при преобразовании XLS в PDF
...
## **Исключения**
 ...
 (CELLSNET-42812) — CellsException при преобразовании электронной таблицы в PDF
