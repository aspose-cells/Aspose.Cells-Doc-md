...
type: docs
weight: 110
url: /ru/net/aspose-cells-for-net-7-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.1.0/)
...
- Невозможно включить заголовки строк/столбцов и комментарии в файл TIFF
...
- Ошибка в выходном PDF-документе
...
- Файл XLS приводит к сбою MS Excel 2007
...
- Книга Excel 2007 с несколькими цветными таблицами не отображается в преобразованном файле PDF
 ...
 -Использование параметра «Подгонка листа на одной странице» в Excel для преобразования в PDF не работает.
...
- Импорт файла XLSX в задачи GridWeb
