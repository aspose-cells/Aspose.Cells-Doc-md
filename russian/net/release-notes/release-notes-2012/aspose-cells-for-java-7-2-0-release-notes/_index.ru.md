...
type: docs
weight: 80
url: /ru/net/aspose-cells-for-java-7-2-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 7.2.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-java-7.2.0/)
...
- Невозможно преобразовать некоторые файлы XLSX в формат TIFF.
