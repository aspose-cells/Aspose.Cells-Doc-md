...
type: docs
weight: 50
url: /ru/net/aspose-cells-for-net-7-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.3.0/)
...
- Проблема с XPS и пользовательским числовым форматом в SheetRender
...
- PDF-рендеринг бизнес-форм (текст внутри) не очень хорош
- Проблема с оглавлением XLS в зависимости от количества напечатанных страниц

 -Преобразование PDF пропускает значения именованных областей
