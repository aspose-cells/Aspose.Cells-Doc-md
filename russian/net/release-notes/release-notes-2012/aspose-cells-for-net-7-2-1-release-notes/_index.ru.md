...
type: docs
weight: 70
url: /ru/net/aspose-cells-for-net-7-2-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.2.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.2.1/)
...
- Макрос исчез после сохранения файла XLSM в формате XLS
...
- Вызов «Сохранить» повреждает файл XLSM.
...
- Проблемы с преобразованием XLSX в PDF
...
- Имя формы изменено после сохранения файла XLSM в новую книгу
