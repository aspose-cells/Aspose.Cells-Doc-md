...
type: docs
weight: 30
url: /ru/net/aspose-cells-for-net-7-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.3.2/)
...
- Сохранение книги (файл XLSM) удаляет формулы массива таблицы MS Excel.
