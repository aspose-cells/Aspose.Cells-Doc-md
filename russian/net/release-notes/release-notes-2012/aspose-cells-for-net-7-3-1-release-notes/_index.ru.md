...
type: docs
weight: 40
url: /ru/net/aspose-cells-for-net-7-3-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for .NET 7.3.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.3.1/)
...
- Проблема с размером файла XLSB в MS Excel
...
- Форма для изображения Ошибка в функции Excel в PDF
...
- Чтение/запись CSV не выполняется для некоторых входных данных
...
- Проблемы с форматированием HTML (относительно дополнительных границ)

 -SheetRender XPS и проблема с пользовательским числовым форматом

 -Сохранить как PDF не сохраняет форматирование

- Проблемы с форматированием XLSX в выходных данных Excel и PDF
- Сводная таблица Excel, преобразованная в PDF, неверна
