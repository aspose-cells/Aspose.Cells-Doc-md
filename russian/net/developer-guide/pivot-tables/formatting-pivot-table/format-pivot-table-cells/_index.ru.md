...
type: docs
weight: 30
url: /ru/net/format-pivot-table-cells/
---
{{% alert color="primary" %}}
...
[**Сводная таблица.FormatAll()**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivottable/methods/formatall) применяет стиль ко всей сводной таблице, в то время как[**Сводная Таблица.Формат()**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivottable/methods/format) применяет стиль к одной ячейке сводной таблицы.

{{% /alert %}}

 Следующий пример кода загружает[образец файла Excel](pivot_format.xlsx) который содержит две сводные таблицы, и выполняет операцию форматирования всей сводной таблицы и форматирования отдельных ячеек в сводной таблице.
