...
Добавление комментария в ячейку, вызвав метод [**Add**](https://reference.aspose.com/cells/net/aspose.cells/commentcollection/methods/add/index) коллекции [**Comments**](https://reference.aspose.com/cells/net/aspose.cells/commentcollection) (инкапсулированный в объекте [**Worksheet**](https://reference.aspose.com/cells/net/aspose.cells/worksheet)). Новый объект [**Comment**](https://reference.aspose.com/cells/net/aspose.cells/comment) может быть получен из коллекции [**Comments**](https://reference.aspose.com/cells/net/aspose.cells/commentcollection), передав индекс комментария. После доступа к объекту [**Comment**](https://reference.aspose.com/cells/net/aspose.cells/comment), настроить заметку комментария можно, используя свойство [**Note**](https://reference.aspose.com/cells/net/aspose.cells/comment/properties/note) объекта [**Comment**](https://reference.aspose.com/cells/net/aspose.cells/comment).
...
## **Продвинутые темы**
- [Изменение направления текста комментария](/cells/ru/net/change-text-direction-of-the-comment/)
