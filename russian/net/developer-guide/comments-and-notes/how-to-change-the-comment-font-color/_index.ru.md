...
type: docs
weight: 180
url: /ru/net/how-to-change-the-comment-font-color/
---
...
Aspose.Cells предоставляет свойство [**Shape.TextBody**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shape/properties/textbody) для цвета шрифта комментария. В следующем образце кода демонстрируется использование свойства [**Shape.TextBody**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shape/properties/textbody) для установки направления текста комментария.
