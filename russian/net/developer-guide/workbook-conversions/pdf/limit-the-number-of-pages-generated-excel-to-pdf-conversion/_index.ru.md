...
Иногда вы хотите напечатать диапазон страниц в выходной файл PDF. Aspose.Cells имеет возможность установить ограничение на количество страниц, создаваемых при преобразовании электронной таблицы Excel в формат файла PDF.
