...
Используя Aspose.Cells, вы можете преобразовать файл CSV в Excel, OpenOffice, Pdf, Json и многие другие форматы.
...
- [Загрузите или импортируйте файл CSV с формулами](/cells/ru/net/load-or-import-csv-file-with-formulas/)
