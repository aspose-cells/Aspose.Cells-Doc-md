...
description: Как использовать библиотеку Aspose.Cells для вычисления динамических массивных формул в Microsoft Excel. Загружая существующий файл Excel или создавая новый файл Excel, мы можем использовать метод, предоставленный Aspose.Cells, для вычисления динамической массивной формулы и получения результата. Наконец, мы сохраняем измененный файл Excel на диск.
...
Пожалуйста, ознакомьтесь с следующим примером кода, который загружает [образец файла Excel](dynamicArrayFormula.xlsx), содержащий фиктивные данные. После загрузки файла вызовите функцию [Cell.SetDynamicArrayFormula](https://reference.aspose.com/cells/net/aspose.cells/cell/setdynamicarrayformula/#setdynamicarrayformula) для установки динамической формулы массива и функцию [Workbook.RefreshDynamicArrayFormulas](https://reference.aspose.com/cells/net/aspose.cells/workbook/refreshdynamicarrayformulas/#refreshdynamicarrayformulas) для обновления динамических формул массива перед вызовом расчета формулы и, наконец, сохраните книгу как [выходной файл Excel](out.xlsx). 
