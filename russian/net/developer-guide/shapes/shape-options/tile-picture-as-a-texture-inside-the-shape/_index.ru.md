...
type: docs
weight: 1700
url: /ru/net/tile-picture-as-a-texture-inside-the-shape/
---
...
Вы можете заполнить поверхность фигуры некоторым изображением и наложить на нее плитки, используя свойство [**Shape.Fill.TextureFill.IsTiling**](https://reference.aspose.com/cells/net/aspose.cells.drawing/texturefill/properties/istiling) и установить его **true**. Пожалуйста, ознакомьтесь с следующим образцом кода, [образцом файла Excel](46465050.xlsx), а также снимком экрана для справки.
