...
- [**Ценность**](https://reference.aspose.com/cells/net/aspose.cells.drawing/checkbox/properties/value) Свойство указывает, установлен ли флажок или нет.
...
-  Чтобы запустить форму, в главном меню нажмите*Вид* , с последующим*Панели инструментов* а также*Формы*.
