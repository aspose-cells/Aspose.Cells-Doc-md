...
- Числа целые, то есть не имеют десятичной части.
...
|Свидание|Обозначает тип проверки для дат.|
...
- [Получить Cell Проверка в файлах ODS](/cells/ru/net/get-cell-validation-in-ods-files/)
