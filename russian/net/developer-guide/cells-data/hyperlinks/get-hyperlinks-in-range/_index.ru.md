...
type: docs
weight: 100
url: /ru/net/get-hyperlinks-in-range/
---
## **Получить гиперссылки в диапазоне**

[**Спектр**](https://reference.aspose.com/cells/net/aspose.cells/range) класс предоставляет[**Гиперссылки**](https://reference.aspose.com/cells/net/aspose.cells/range/properties/hyperlinks) свойство, которое возвращает все гиперссылки в выбранном диапазоне. Вы также можете удалить гиперссылку, вызвав[**Гиперссылка.Удалить**](https://reference.aspose.com/cells/net/aspose.cells/hyperlink/methods/delete) метод.
