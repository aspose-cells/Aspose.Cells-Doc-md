...
В приведенном ниже примере кода показано, как добавить в ячейку форматированный HTML-текст. Пожалуйста, посмотрите на скриншот выходного файла Excel.

![дело:изображение_альтернативный_текст](adding-html-rich-text-inside-the-cell_1)
...
- [Отобразите маркеры, установив значение Cell с помощью HTML](/cells/ru/net/display-bullets-by-setting-cell-value-using/)
- [Получить строку HTML5 от Cell](/cells/ru/net/get-html5-string-from-cell/)
