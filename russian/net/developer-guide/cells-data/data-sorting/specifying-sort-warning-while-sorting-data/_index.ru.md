...
description: Узнайте, как указать предупреждение о сортировке при сортировке данных, используя код Aspose.Cells for .NET API.
...
Пожалуйста, примите во внимание эти текстовые данные, т.е. {11, 111, 22}. Эти текстовые данные отсортированы, потому что с точки зрения текста 111 предшествует 22. Но если вы хотите отсортировать эти данные не как текст, а как числа, тогда они станут {11, 22, 111}, потому что численно 111 идет после 22. Aspose.Cells обеспечивает[**DataSorter.SortAsNumber**](https://reference.aspose.com/cells/net/aspose.cells/datasorter/properties/sortasnumber)имущество для решения этой проблемы. Пожалуйста, установите это свойство**истинный**и ваши текстовые данные будут отсортированы как числовые данные. На следующем снимке экрана показано предупреждение о сортировке, отображаемое Excel Microsoft при сортировке текстовых данных, которые выглядят как числовые данные.

![задача: image_alt_text](specifying-sort-warning-while-sorting-data_1.png)

##  **Образец кода**

 Следующий пример кода иллюстрирует использование[**DataSorter.SortAsNumber**](https://reference.aspose.com/cells/net/aspose.cells/datasorter/properties/sortasnumber) собственность, как объяснялось ранее. Пожалуйста, проверьте его[образец файла Excel](43352075.xlsx) и[выходной файл Excel](43352076.xlsx) для получения дополнительной помощи.
