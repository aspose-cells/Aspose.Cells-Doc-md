---
title: Получите диапазон Cells
type: docs
weight: 600
url: /ru/net/get-cells-range/
---
##  **Возможные сценарии использования**
Когда вам нужно только манипулировать некоторыми данными на листе, вам нужно знать диапазон данных всего листа. Aspose.Cells предлагает эту функцию. Aspose.Cells предоставляет следующие свойства и методы, которые помогут вам достичь ваших целей.
...
##  **Получите диапазон Cells, используя Aspose.Cells**
В этом примере показано, как:

1. Создайте рабочую книгу.
1. Добавьте данные в ячейки на первом листе.
1.  Получить Cells[**Диапазон**](https://reference.aspose.com/cells/net/aspose.cells/range).
