...
|XLTM|Представляет XLTM-файл Excel 2007 с поддержкой макросов.|
|XLSB|Представляет двоичный файл Excel 2007 XLSB.|
|Электронная таблицаML|Представляет XML-файл электронной таблицы.|
...
|XPS|Представляет XPS-документ|
|ТИФФ|Представляет формат файла изображения с тегами (TIFF)|
...
Мы можем сохранять файлы в формате открытого офиса: ODS, SXC, FODS, OTS и т. д.

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-Excel-to-ODS.cs" >}}

## **Сохранение файла Excel в формате JSON или XML**
