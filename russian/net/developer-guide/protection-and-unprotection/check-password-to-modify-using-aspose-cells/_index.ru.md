...
Вы можете назначить**Пароль для открытия** а также**Пароль для изменения** при создании книг в Microsoft Excel. Посмотрите этот снимок экрана, на котором показан интерфейс Microsoft, который Excel предоставляет для указания этих паролей.
