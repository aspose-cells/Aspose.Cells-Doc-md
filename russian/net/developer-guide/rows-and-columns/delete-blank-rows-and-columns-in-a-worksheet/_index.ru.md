...
Можно удалить все пустые строки и столбцы с рабочего листа. Это полезно, например, если вы создаете файл PDF из файла Excel Microsoft и хотите преобразовать только те строки и столбцы, которые содержат данные.

Используйте следующие методы Aspose.Cells для удаления пустых строк и столбцов:

1.  Чтобы удалить пустые строки, используйте[**Cells.DeleteBlankRows()**](https://reference.aspose.com/cells/net/aspose.cells/cells/methods/deleteblankrows) метод.
