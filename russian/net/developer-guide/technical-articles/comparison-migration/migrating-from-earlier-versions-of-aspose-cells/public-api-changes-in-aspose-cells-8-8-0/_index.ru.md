...
{{% alert color="primary" %}} 
 ...
 Дополнительные сведения об этой функции см. в подробной статье о[Удалить лишние пробелы из HTML](/cells/ru/net/delete-redundant-spaces-after-line-break-while-importing/)
