...
[Копировать только данные диапазона](/cells/ru/net/copy-range-data-only/) и[Копировать данные диапазона со стилем](/cells/ru/net/copy-range-data-with-style/) объяснил, как копировать данные из диапазона в другой самостоятельно или в комплекте с форматированием. Также возможно скопировать только форматирование. В этой статье показано, как.
