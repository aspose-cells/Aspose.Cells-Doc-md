...
type: docs
weight: 105
url: /ru/net/insert-ranges-to-Excel/
---
...
Aspose.Cells предоставляет метод [Cells.InsertRange](https://reference.aspose.com/cells/net/aspose.cells/cells/insertrange/) для вставки диапазона.
