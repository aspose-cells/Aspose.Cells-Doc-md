...
description: В этой статье объясняется, как программно вставить изображение в верхний и нижний колонтитулы листов Excel, установив верхний и нижний колонтитулы с помощью команд сценария с помощью библиотеки C# API или .NET.
...
1.  На**Файл** выберите *Параметры страницы**. Отобразится диалоговое окно.
