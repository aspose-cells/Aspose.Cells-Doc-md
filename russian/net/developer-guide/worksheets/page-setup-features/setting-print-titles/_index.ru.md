...
type: docs
weight: 200
url: /ru/net/how-to-set-print-titles/
...
keywords: Печать строк и столбцов многократно, как установить заголовки для печати в C#, как установить и очистить заголовки для печати, как добавить заголовки для печати, как удалить заголовки, как установить заголовки для печати в Excel, как их очистить.
---
...
Чтобы установить заголовки печати в указанном листе: сначала загрузите [образец файла](input.xlsx), затем необходимо изменить свойства [**Worksheet.PageSetup.PrintTitleRows**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlerows/) и [**Worksheet.PageSetup.PrintTitleColumns**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlecolumns/) объекта [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) для нужного листа. Установка этих свойств в строку диапазона установит заголовки печати.
...
Чтобы удалить заголовки печати в указанном листе: сначала загрузите [образец файла](input.xlsx), затем необходимо изменить свойства [**Worksheet.PageSetup.PrintTitleRows**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlerows/) и [**Worksheet.PageSetup.PrintTitleColumns**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlecolumns/) объекта [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) для нужного листа. Установка этих свойств в пустую строку очистит заголовки печати.
