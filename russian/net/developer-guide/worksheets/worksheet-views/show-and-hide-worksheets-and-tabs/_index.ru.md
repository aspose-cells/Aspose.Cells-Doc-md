...
description: В этой статье представлен пример кода для использования библиотеки C# API или .NET для программного отображения и скрытия рабочего листа Excel. Кроме того, как отображать и скрывать вкладки книги Excel.
---
{{% alert color="primary" %}}
