...
- **масштаб высоты** – масштаб высоты изображения, процентное значение.
 ...
 Метод возвращает[**Aspose.Cells.Drawing.Picture**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture) объект.[**Рисунок**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture)класс представляет объект изображения на диаграмме.
