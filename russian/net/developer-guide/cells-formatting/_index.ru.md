...
1.  Установите желаемые свойства/атрибуты[**Стиль**](https://reference.aspose.com/cells/net/aspose.cells/style)объект для применения желаемых параметров форматирования
...
1.  Установить[**Стиль**](https://reference.aspose.com/cells/net/aspose.cells/style)свойства объекта для применения настроек форматирования.
