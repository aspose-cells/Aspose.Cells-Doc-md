...
type: docs
weight: 10
url: /ru/net/format-number-to-currency/
description: Эта статья познакомит с методом форматирования числа в валюту с помощью API Aspose.Cells for .NET.
...
Чтобы форматировать числа как валюту в библиотеке Aspose.Cells for .NET для работы с файлами Excel, можно применять форматирование валюты к ячейкам программно. Вот как это сделать с помощью C# и Aspose.Cells:
