...
---
## **Настройка форматов отображения чисел и дат**
...
1.  Выбирать**Формат Cells**. Появится диалоговое окно, которое используется для установки форматов отображения любых значений.
 ...
 В левой части диалогового окна есть много категорий значений, таких как**Общий**, **Число**, **Валюта**, **Бухгалтерский учет**, **Свидание**, **Время**, **Процент,**и т. д. Aspose.Cells поддерживает все эти форматы отображения.
