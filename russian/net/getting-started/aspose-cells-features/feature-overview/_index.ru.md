...
В таблицах ниже приведены сводные данные о функциях Aspose.Cells for .NET и приведены ссылки на подробные описания функций.
...
Многие клиенты по всему миру полагаются на подробные функции импорта и экспорта документов, предоставляемые по телефону Aspose.Cells for .NET.

|**Особенность**|**Описание**|**.NET**|**.NET Стандарт 2.0** |
|:- |:- |:- |:- |
...
Aspose.Cells for .NET предоставляет богатую объектную модель, состоящую из более чем 100 общедоступных классов, которые позволяют программно генерировать, комбинировать, изменять, анализировать или иным образом исследовать загруженные электронные таблицы. Некоторые ключевые характеристики приведены в таблице ниже.

|**Особенность**|**.NET**|**.NET Стандарт 2.0** |
|:- |:- |:- |
|Импорт/экспорт данных из DataTable, DataView, Array, DataGrid и т. д.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Защитить/снять защиту с рабочих листов|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Реализовать параметры транспонирования|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Реализовать Microsoft спарклайны Excel 2010|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Шифровать файлы|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
## **Возможности форматирования электронных таблиц**
Aspose.Cells for .NET обеспечивает подробный программный доступ к свойствам форматирования всех элементов электронной таблицы.
...
|Примените к ячейкам все параметры числового формата, поддерживаемые Microsoft Excel.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Установите все типы настроек выравнивания текста.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Применяйте различные настройки шрифта для ячеек.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
Вы можете использовать Aspose.Cells for .NET для реализации параметров PageSetup для ваших рабочих листов.
