...
1. Microsoft Excel 2010 хранит документы в SpreadsheetML версии 2010, как определено в обновленном стандарте OOXML.
## **Электронная таблицаML в Aspose.Cells**
Доступны три «версии» SpreadsheetML:

|**Электронная таблицаML «Версия»**|**Применимый стандарт/спецификация**|**Поддерживается в Aspose.Cells for .NET**|
|:- |:- |:- |
