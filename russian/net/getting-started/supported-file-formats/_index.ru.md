...
|[XLSX](https://docs.fileformat.com/spreadsheet/xlsx/)|Файл книги или шаблона Office Open XML SpreadsheetML с макросами или без них.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Электронная таблицаML|XML-файл Excel 2003.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[Числа](https://docs.fileformat.com/spreadsheet/numbers/)|Документ создается с помощью приложения Apple Numbers, которое является частью офисного пакета Apple iWork, набора приложений, работающих в операционных системах Mac OS X и iOS.|{{< emoticons/tick >}}||
...
|[ТИФФ](https://docs.fileformat.com/image/tiff/)|Формат файла изображения с тегами||{{< emoticons/tick >}}|
|[PNG](https://docs.fileformat.com/image/png/)|Формат переносимой сетевой графики||{{< emoticons/tick >}}|
|[БМП](https://docs.fileformat.com/image/bmp/)|Формат растрового изображения||{{< emoticons/tick >}}|
|[ЭДС](https://docs.fileformat.com/image/emf/)|Расширенный формат метафайла||{{< emoticons/tick >}}|
