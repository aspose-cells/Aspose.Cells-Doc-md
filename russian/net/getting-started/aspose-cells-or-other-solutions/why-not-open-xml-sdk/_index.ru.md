...
- Высококачественное преобразование между всеми популярными Microsoft форматами Excel, включая преобразование в PDF, HTML, TIFF и печать.
...
**Вывод**: Open XML SDK и Aspose.Cells не конкурируют друг с другом, потому что они ориентированы на совершенно разные потребности и аудитории.
...
- Преобразуйте документ в формат PDF или XPS, чтобы он выглядел точно так же, как Microsoft Excel преобразовал бы его.
