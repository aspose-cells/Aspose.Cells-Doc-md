---
title: Получить заголовок столбца
type: docs
weight: 40
url: /ru/net/get-a-column-heading/
---
## **Опенксмл Excel**
{{< highlight "csharp" >}}
...
- [Источникфорж](https://sourceforge.net/projects/asposeopenxml/files/Aspose.Cells%20Vs%20OpenXML/Get%20a%20column%20heading%20\(Aspose.Cells\).zip/скачать)
- [Битбакет](https://bitbucket.org/asposemarketplace/aspose-for-openxml/downloads/Get%20a%20column%20heading%20\(Aspose.Cells\).zip)
