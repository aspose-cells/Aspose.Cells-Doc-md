...
{{< /highlight >}}
## **Удаление строки**
 Разработчики могут удалить строку из рабочего листа в любом месте, вызвав метод**УдалитьРов** метод коллекции Cells.**УдалитьРов** Метод принимает индекс строки, которую необходимо удалить.
