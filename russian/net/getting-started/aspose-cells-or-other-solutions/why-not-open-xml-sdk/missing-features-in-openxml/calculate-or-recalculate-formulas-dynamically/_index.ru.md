...
Aspose.Cells позволяет отключить создание цепочки вычислений, что полезно в сценариях, когда вы хотите вычислить формулы вашего файла только один раз.
 ...
 Если вы хотите повысить производительность вычислений по формуле по номеру Aspose.Cells и не хотите создавать цепочку вычислений по формуле, установите**FormulaSettings.EnableCalculationChain** в качестве**ЛОЖЬ** . По умолчанию установлено как**истинный**.
