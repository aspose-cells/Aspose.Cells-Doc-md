...
## **Установить заголовки для печати**
 Aspose.Cells позволяет указать заголовки строк и столбцов, которые должны повторяться на всех страницах печатного листа. Для этого разработчики могут использовать набор**PrintTitleColumns** и**setPrintTitleRows** методы**Настройка страницы** учебный класс.
