---
title: Создайте круговую диаграмму
type: docs
weight: 110
...
Диаграммы представляют данные в простом для понимания виде. Пользователи, работающие с Microsoft Excel, могут создавать различные диаграммы и настраивать их. Те же функции доступны для разработчиков, которые работают с Aspose.Cells for .NET.
...
1. Сохранение электронной таблицы.
 ...
 Примеры кода в этой статье показывают, как добавить круговую диаграмму с[ВСТО](/cells/ru/net/create-a-pie-chart/) , используя либо C#, либо Visual Basic, по сравнению с созданием с помощью[Aspose.Cells](/cells/ru/net/create-a-pie-chart/), снова используя либо C#, либо Visual Basic.

### **Создание круговой диаграммы с помощью VSTO**

В приведенных ниже примерах кода показано, как добавить круговую диаграмму в электронную таблицу с помощью VSTO.
...
![дело:изображение_альтернативный_текст](create-a-pie-chart_1.png)

### **Создание круговой диаграммы с Aspose.Cells for .NET**

В приведенных ниже примерах кода показано, как добавить круговую диаграмму в электронную таблицу с помощью Aspose.Cells.
...
![дело:изображение_альтернативный_текст](create-a-pie-chart_2.png)
