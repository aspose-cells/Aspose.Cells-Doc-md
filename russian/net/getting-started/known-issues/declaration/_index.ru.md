---
title: Доверенные разрешения на веб сервере
type: docs
weight: 30
...
<br/>
На платформах .NET Core и .NET 5+ средний уровень доверия был удален. Средний доверие — механизм безопасности эпохи .NET Framework. Средний уровень доверия постепенно заменяется более гибкими политиками безопасности. Мы рекомендуем пользователям обновляться до .NET 5+ и переходить к контейнеризированному развертыванию вместо использования традиционных уровней доверия.
