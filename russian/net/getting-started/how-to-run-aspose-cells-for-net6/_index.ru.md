...
2. «SkiaSharp» или «System.Drawing.Common» будут установлены автоматически как зависимость от Aspose.Cells 22.10.1 или более поздней версии для платформ .Net6, что зависит от конфигурации «Целевая ОС» в вашем проекте.
...
- Установите для «Целевой ОС» значение «Нет» или другие параметры для вашего проекта, вы будете использовать «SkiaSharp» в качестве зависимости от вашей системы Windows для проекта .Net6.*Обратите внимание, что версия, использующая «SkiaSharp» в качестве зависимости, не поддерживает функцию печати на принтер.*
...
- Система.Текст.Кодировка.Кодовые страницы, 4.7.0.
 ...
 Таким образом, вы будете использовать «SkiaSharp» в качестве зависимости от вашей системы Windows для проекта .Net6.*Обратите внимание, что версия, использующая «SkiaSharp» в качестве зависимости, не поддерживает функцию печати на принтер.*
