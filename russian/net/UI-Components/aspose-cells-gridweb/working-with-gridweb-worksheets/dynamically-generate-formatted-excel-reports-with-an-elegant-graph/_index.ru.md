...
{{< /highlight >}}
## **Создание отформатированного отчета (файл .XLS) с графиком с использованием компонента Aspose.Cells**
