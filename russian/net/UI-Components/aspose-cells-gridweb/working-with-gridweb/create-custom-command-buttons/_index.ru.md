...
{{% alert color="primary" %}} 
 ...
 Aspose.Cells.GridWeb содержит специальные кнопки, такие как**Представлять на рассмотрение**, **Сохранять** и**Отменить**. Все эти кнопки выполняют определенные задачи для Aspose.Cells.GridWeb.
