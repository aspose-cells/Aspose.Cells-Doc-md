...
## **Сохранение файла**
 Создайте настольное приложение и добавьте в форму две кнопки с элементом управления GridControl. Установите текстовые свойства кнопок как**Сохранить как файл** а также**Сохранить как поток** соответственно.
