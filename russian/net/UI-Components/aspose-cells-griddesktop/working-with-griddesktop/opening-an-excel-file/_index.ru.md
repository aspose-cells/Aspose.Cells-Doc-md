...
### **Открытие файла CSV**
Aspose.Cells. Элемент управления GridDesktop также поддерживает загрузку файла CSV. Создайте событие Click для**Открыть файл CSV** кнопку и вставьте в нее следующий код.
