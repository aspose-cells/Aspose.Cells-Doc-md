...
1.  Нажми на**Ящик для инструментов**
1.  Выбирать**Общие элементы управления**, щелкните правой кнопкой мыши и выберите "**Выбрать товары...**"из контекстного меню.
1.  в**.NET Компоненты платформы** вкладка**Выберите элементы панели инструментов** окно, прокрутите и выберите**GridDesktop** а также**Панель формул** составные части.
