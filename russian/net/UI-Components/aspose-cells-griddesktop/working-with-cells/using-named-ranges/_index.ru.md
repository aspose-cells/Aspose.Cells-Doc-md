...
Элемент управления GridDesktop поддерживает импорт/экспорт именованных диапазонов в файлах Excel, он предоставляет два класса (**Имя** а также**НазваниеКоллекция**) для работы с именованными диапазонами.
