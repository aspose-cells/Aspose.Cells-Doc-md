...
1. Перетащите четыре кнопки из панели инструментов в нижнюю часть формы и установите для их текстового свойства значение**Связать рабочий лист**, **Добавить ряд**, **Удалить строку** а также**Обновление базы данных** соответственно.
