...
### **Настройка столбцов привязки дочерних таблиц**
 ...
 необходимо отобразить детали заказа'**Цена за единицу товара** поле в формате валюты. Добавьте обработчик событий, чтобы изменить числовой формат столбца привязки.
