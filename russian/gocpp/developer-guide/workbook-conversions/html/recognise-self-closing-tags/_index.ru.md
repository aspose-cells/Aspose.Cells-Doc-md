---
title: Распознавайте самозакрывающиеся теги в HTML с помощью Golang через C++
linktitle: Различает самозакрывающиеся теги
type: docs
weight: 120
url: /ru/go-cpp/recognise-self-closing-tags/
description: Узнайте, как обрабатывать самозакрывающиеся теги в HTML с помощью Aspose.Cells и Golang через C++.
---
