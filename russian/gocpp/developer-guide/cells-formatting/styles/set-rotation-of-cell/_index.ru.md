---
title: Как повернуть текст ячейки с помощью Golang через C++
linktitle: Как повернуть текст ячейки
type: docs
weight: 80
url: /ru/go-cpp/how-to-rotate-text-of-cell/
...
Свойство [**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/) упрощает вращение ячеек. Чтобы вращать ячейки в Aspose.Cells, вам нужно выполнить следующие шаги:
