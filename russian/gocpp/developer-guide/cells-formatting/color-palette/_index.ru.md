---
title: Как использовать палитру цветов с Golang через C++
linktitle: Как использовать цветовую палитру
type: docs
weight: 80
url: /ru/go-cpp/excel-color-palette/
...
Aspose.Cells предоставляет класс [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/), который представляет файл Microsoft Excel. Класс [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) содержит метод [**ChangePalette**](https://reference.aspose.com/cells/go-cpp/workbook/changepalette/), который принимает следующие параметры для добавления пользовательского цвета для изменения палитры:
