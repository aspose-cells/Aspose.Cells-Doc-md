...
{{% alert color="primary" %}} 
 ...
 Чтобы удалить лицензию Aspose.Cells for SharePoint, выполните следующие действия с консоли сервера.
...
1. Дождитесь завершения отвода.
 Вы можете использовать центр администрирования, чтобы проверить, завершен ли отзыв, перейдя к**Центральное управление** , тогда**Операции** и**Управление решениями**.
