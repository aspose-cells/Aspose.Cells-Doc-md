---
title: Aspose.Cells для Node.js через Java 19.8 Примечания к выпуску
type: docs
weight: 10
url: /ru/nodejs-java/aspose-cells-for-node-js-via-java-19-8-release-notes/
---
{{% alert color="primary" %}} 

На этой странице содержатся примечания к выпуску Aspose.Cells для Node.js через Java 19.8.
