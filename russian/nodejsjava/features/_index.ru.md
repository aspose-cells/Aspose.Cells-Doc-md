...
description: "Aspose.Cells для Node.js via Java функции."
---

## **Обзор функций Aspose.Cells для Node.js via Java**
В этом разделе приводится сравнение доступности функций между Aspose.Cells for Java и Aspose.Cells для Node.js via Java.
...
|**Функция**|**Описание**|**Aspose.Cells for Java**|**Aspose.Cells для Node.js via Java**|
| :- | :- | :- | :- |
...
|**Особенность**|**Aspose.Cells for Java**|**Aspose.Cells для Node.js via Java**|
| :- | :- | :- |
...
|Применение настроек формата на лист электронной таблицы, строку, столбец или диапазон ячеек и т. д.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
