---
title: Вычисление формулы массива таблиц данных
type: docs
weight: 550
...
## **Вычисление формулы массива таблиц данных**
 В следующем примере кода мы использовали это[исходный файл excel](5472579.xlsx) что также показано на следующем изображении.

![дело:изображение_альтернативный_текст](calculation-of-array-formula-of-data-tables_1.png)

 Если вы измените значение ячейки B1 на 100, значения таблицы данных, которые заполнены желтым цветом, станут 120. Пример кода генерирует[вывод PDF](5472577.pdf) который показывает 120 как значения в таблице данных, как показано на этом изображении.
