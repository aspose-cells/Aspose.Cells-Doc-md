...
- **масштаб высоты** – масштаб высоты изображения, процентное значение.
 ...
 Метод возвращает объект[**Картина**](https://reference.aspose.com/cells/java/com.aspose.cells/Picture) класс, где[**Картина**](https://reference.aspose.com/cells/java/com.aspose.cells/Picture)класс представляет объект изображения на диаграмме.
