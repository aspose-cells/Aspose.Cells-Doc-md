...
В следующем образце кода демонстрируется использование [**Chart.hasAxis(int axisType, boolean isPrimary)**](https://reference.aspose.com/cells/java/com.aspose.cells/chart#hasAxis-int-boolean-) для определения, имеет ли образецная диаграмма основную и вторичную категориальные и числовые оси.
...
Приведенный ниже образец кода демонстрирует использование [**Chart.hasAxis(int axisType, boolean isPrimary)**](https://reference.aspose.com/cells/java/com.aspose.cells/chart#hasAxis-int-boolean-) для определения, если у образца диаграммы есть основные и вторичные категории и оси значений. Результат работы кода отображается ниже на экране, который показывает true для основной категории и оси значений, и false - для вторичной категории и оси значений.
