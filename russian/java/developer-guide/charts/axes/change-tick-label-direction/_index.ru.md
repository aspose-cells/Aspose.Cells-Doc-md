...
type: docs
weight: 90
url: /ru/java/change-tick-label-direction/
---

## **Изменение направления меток делений**

Aspose.Cells предоставляет вам возможность изменить направление меток деления осей диаграммы, используя свойство [**TickLabels.DirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ticklabels#DirectionType). Свойство [**TickLabels.DirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ticklabels#DirectionType) принимает значение перечисления [**ChartTextDirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ChartTextDirectionType). Перечисление [**ChartTextDirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ChartTextDirectionType) предоставляет следующие элементы
