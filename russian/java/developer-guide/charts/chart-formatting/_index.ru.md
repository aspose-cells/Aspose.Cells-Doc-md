...
- Площадь участка
- Область диаграммы
- [**СерияКоллекция**](https://reference.aspose.com/cells/java/com.aspose.cells/SeriesCollection) область
...
Во-первых, взгляните на линейный график конструктора.
