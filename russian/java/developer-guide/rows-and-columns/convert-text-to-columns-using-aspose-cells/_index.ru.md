...
В следующем образце кода объясняется использование метода [TextToColumns](https://reference.aspose.com/cells/java/com.aspose.cells/cells#textToColumns\(int,%20int,%20int,%20com.aspose.cells.TxtLoadOptions\)). Код сначала добавляет имена людей в столбец A на первом рабочем листе. Имя и фамилия разделены пробелом. Затем он применяет метод [TextToColumns](https://reference.aspose.com/cells/java/com.aspose.cells/cells#textToColumns\(int,%20int,%20int,%20com.aspose.cells.TxtLoadOptions\)) к столбцу A и сохраняет его как выходной файл Excel. Если вы откроете [выходной файл Excel](25395230.xlsx), вы увидите, что имена находятся в столбце A, а фамилии - в столбце B, как показано на этом скриншоте.
