...
type: docs
weight: 10
url: /ru/java/populate-data-first-by-row-then-by-column/
---
...
## Сначала заполните данные по строкам, а затем по столбцам
...
## Код Java для заполнения данных сначала по строкам, а затем по столбцам
