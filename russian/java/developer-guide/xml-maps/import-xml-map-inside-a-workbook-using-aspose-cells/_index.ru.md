---
title: Импорт XML схемы внутри книги с помощью Aspose.Cells
type: docs
weight: 40
url: /ru/java/import-xml-map-inside-a-workbook-using-aspose-cells/
---
...
Вам нужно будет предоставить свои XML-данные для завершения импорта. Вот пример [XML-данных](5472501.txt), которые вы можете использовать для тестирования.
