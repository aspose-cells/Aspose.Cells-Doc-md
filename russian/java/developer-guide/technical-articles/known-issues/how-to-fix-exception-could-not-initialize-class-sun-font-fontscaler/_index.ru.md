---
title: Как исправить исключение - Не удалось инициализировать класс sun.font.FontScaler
type: docs
weight: 40
url: /ru/java/how-to-fix-exception-could-not-initialize-class-sun-font-fontscaler/
---
## **Возможные сценарии использования**
В этой статье объясняется, как исправить ошибку «Не удалось инициализировать класс sun.font.FontScaler». Исключение выглядит примерно так
...
## **Системная среда**
Системная среда может быть примерно такой
...
{{< /highlight >}}
## **Возможное решение**
Вы, вероятно, решите проблему, интегрировав следующий JAR в свой путь к классам:

- ae-awt.jar
## **Ссылка для скачивания файла ae-awt.jar**
