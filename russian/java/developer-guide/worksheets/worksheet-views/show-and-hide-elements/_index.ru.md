...
Линии сетки применяются ко всему листу. Чтобы «скрыть» линии сетки в разделе рабочего листа, используйте[форматирование границы](/cells/ru/java/create-table-by-using-border-lines-for-a-range/) чтобы установить для границ цвет, который сочетается с цветовой схемой листа.
