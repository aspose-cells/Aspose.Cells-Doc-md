...
type: docs
weight: 200
url: /ru/java/how-to-set-print-area/
description: В этой статье приведен код, показывающий, как установить область печати с помощью библиотеки Aspose.Cells.
keywords: Ограничение диапазона печати, установка области печати, очистка области печати, установка и очистка области печати с помощью Java, как установить область печати, установить и очистить область печати с помощью Java, как очистить область печати в Java, как добавить область печати с помощью Java, как удалить область печати с помощью Java, как установить область печати в Excel, как очистить область печати в Excel.
---
...
Чтобы установить область печати в указанном листе: сначала загрузите [пример файла](input.xlsx), затем необходимо изменить свойство [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) объекта [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) для нужного листа. Установка этого свойства в диапазонную строку задаст область печати.
...
Чтобы очистить область печати в указанном листе: сначала загрузите [пример файла](input.xlsx), затем необходимо изменить свойство [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) объекта [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) для нужного листа. Присвоение этому свойству пустой строки очистит область печати.
