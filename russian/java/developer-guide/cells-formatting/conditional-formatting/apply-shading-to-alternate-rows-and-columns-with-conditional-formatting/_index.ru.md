...
![дело:изображение_альтернативный_текст](apply-shading-to-alternate-rows-and-columns-with-conditional-formatting_1.png)
 ...
 Чтобы применить затенение к альтернативным столбцам, все, что вам нужно сделать, это изменить формулу**= ОСТАТ (СТРОКА (), 2) = 0** как**= ОСТАТ (СТОЛБЦ (), 2) = 0** , это; вместо получения индекса строки измените формулу, чтобы получить индекс столбца.
