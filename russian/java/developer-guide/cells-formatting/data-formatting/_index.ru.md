...
- [Выравнивание текста](/cells/ru/java/data-formatting/) (горизонтальная вертикальная)
...
{{% alert color="primary" %}} 
 ...
 Пожалуйста, ознакомьтесь с подробной статьей о[Настройка форматов отображения Numbers и [Даты]](/cells/ru/java/data-formatting/).
