...
type: docs
weight: 10
url: /ru/java/format-number-to-currency/
description: В этой статье будет описано, как форматировать число как валюту с помощью API Aspose.Cells for Java.
...
Чтобы форматировать числа как валюту в библиотеке Aspose.Cells for Java для работы с файлами Excel, вы можете применить формат валюты к ячейкам программно. Вот как это сделать с помощью Aspose.Cells for Java:
