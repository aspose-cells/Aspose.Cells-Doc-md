...
type: docs
weight: 930
url: /ru/java/working-with-the-reflection-effect-of-shape-or-chart/
---

## **Возможные сценарии использования**
Aspose.Cells предоставляет свойство [Shape.ReflectionEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#Reflection) для работы с эффектом отражения формы или диаграммы. Оно содержит следующие подсвойства, которые можно установить для достижения различных результатов в соответствии с вашими требованиями.
...
Следующий снимок экрана показывает интерфейс Microsoft Excel для установки *эффекта отражения* формы.
