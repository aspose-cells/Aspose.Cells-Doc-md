...
type: docs
weight: 940
url: /ru/java/working-with-the-shadow-effect-of-shape-or-chart/
---

## **Возможные сценарии использования**
Aspose.Cells предоставляет [Shape.ShadowEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#ShadowEffect) свойство для работы с эффектом тени формы или диаграммы. Оно содержит следующие под-свойства, которые можно установить для достижения различных результатов в соответствии с вашими требованиями.
...
Следующий снимок экрана показывает интерфейс Microsoft Excel для установки *эффекта тени* формы.

![todo:image_alt_text](working-with-the-shadow-effect-of-shape-or-chart_1.png)
## **Работа с теневым эффектом формы или диаграммы**
Приведенный ниже образец кода загружает [исходный файл Excel](5472531.xlsx), обращается к первой форме на первом листе и устанавливает подсвойства свойства [Shape.ShadowEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#ShadowEffect), а затем сохраняет книгу в [выходной файл Excel](5472530.xlsx).
## **Образец кода**
