...
Бывают случаи, когда вы хотите создать Microsoft отчеты Excel со сводными таблицами, которые берут данные из разных источников данных (например, из базы данных), которые неизвестны во время разработки. В этой статье представлен подход к динамическому изменению источника данных сводной таблицы.
...
Выполнение приведенного ниже примера кода изменяет исходные данные сводной таблицы, и сводная таблица будет выглядеть так, как показано ниже.

**Динамически изменяемая сводная таблица** 

![дело:изображение_альтернативный_текст](pivot-table-and-source-data_5.png)
