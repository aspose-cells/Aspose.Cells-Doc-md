...
| Сохранить данные|Истинно, если внешние данные, полученные через соединение для заполнения таблицы, должны быть сохранены.<br> с рабочей тетрадью; в противном случае ложно.|
