...
{{% /alert %}}
 ...
 В следующих примерах кода показано, как создавать диапазоны имен рабочей книги и рабочего листа с помощью[**Диапазон**](https://reference.aspose.com/cells/java/com.aspose.cells/Range) учебный класс.
