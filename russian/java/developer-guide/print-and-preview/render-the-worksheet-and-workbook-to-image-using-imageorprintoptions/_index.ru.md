...
Этот документ предназначен для подробного понимания того, как преобразовать рабочий лист или книгу в файл изображения и применить к изображению различные параметры изображения и печати, такие параметры, как разрешение, сжатие TIFF, формат изображения и качество страницы.
