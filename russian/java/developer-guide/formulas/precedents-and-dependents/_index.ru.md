...
Aspose.Cells предоставляет метод [GetDependents](https://reference.aspose.com/cells/java/com.aspose.cells/Cell#getDependents(boolean)) для трассировки зависимостей ячейки. Например, в Book1.xlsx есть формулы: "=A1+20" и "=A1+30" в ячейках B2 и C2 соответственно. В следующем примере показано, как отслеживать зависимости для ячейки A1 с использованием шаблонного файла Book1.xlsx.
