...
## **Вычислить ширину и высоту значения Cell в единицах пикселей**
 Следующий код объясняет использование[Cell.getWidthOfValue()](https://reference.aspose.com/cells/java/com.aspose.cells/cell#getWidthOfValue\(\) )  а также[Cell.getHeightOfValue()](https://reference.aspose.com/cells/java/com.aspose.cells/cell#getHeightOfValue\(\)) методы.
