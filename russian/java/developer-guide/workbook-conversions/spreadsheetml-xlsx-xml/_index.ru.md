---
title: Электронная таблицаML — XLSX, XML
type: docs
weight: 10
url: /ru/java/spreadsheetml-xlsx-xml/
---
## **О SpreadsheetML**
SpreadsheetML — это название семейства форматов электронных таблиц на основе XML. Существует несколько версий SpreadsheetML:

1. SpreadsheetML версии 2003 был представлен в Microsoft Word 2003. SpreadsheetML стал важным шагом к Microsoft на пути к тому, чтобы сделать формат документа открытым.
...
1. Microsoft Excel 2010 и более поздние версии хранят документы в SpreadsheetML версии 2010, как определено в обновленном стандарте OOXML.
## **Электронная таблицаML в Aspose.Cells**
Доступны три «версии» SpreadsheetML:

|**Электронная таблицаML «Версия»**|**Применимый стандарт/спецификация**|**Поддерживается в Aspose.Cells for Java**|
|:- |:- |:- |
...
|Microsoft Excel 2010 и более поздние версии|OOXML ISO/IEC DIS 29500|Да|
Документы OOXML SpreadsheetML чаще всего поставляются в виде файлов XLSX, которые представляют собой пакеты ZIP. Кроме XLSX. Aspose.Cells обеспечивает расширенную поддержку загрузки, сохранения и преобразования документов SpreadsheetML. Такая всеобъемлющая реализация возможна, потому что Aspose.Cells был разработан с учетом структуры Microsoft документов Excel (а известно, что SpreadsheetML имитирует внутреннее представление Microsoft документов Excel).

**Документ XLSX, созданный Aspose.Cells и открытый в Microsoft Excel** 

![дело:изображение_альтернативный_текст](spreadsheetml-xlsx-xml_1.png)

**Документ XLSX, сгенерированный Aspose.Cells, соответствует соглашению об открытой упаковке и может быть открыт в приложении с поддержкой ZIP.** 

![дело:изображение_альтернативный_текст](spreadsheetml-xlsx-xml_2.png)
...
Реализовать даже простую операцию поиска и замены в документе Office Open XML сложно.

**Наш совет:** помните, что открытый и стандартный не означает простой и используйте Aspose.Cells.
