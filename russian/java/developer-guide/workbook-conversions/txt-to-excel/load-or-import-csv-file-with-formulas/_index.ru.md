...
## **Загрузить или импортировать файл CSV с формулами**
 В следующем коде показано, как можно загружать и импортировать CSV-файл с формулами. Вы можете использовать любой CSV-файл. Для наглядности мы используем[простой CSV-файл](5472505.csv) который содержит эти данные. Как видите, он содержит формулу.
...
{{< /highlight >}}
 ...
 Код сначала загружает CSV-файл, а затем снова импортирует его в ячейку D4. Наконец, он сохраняет объект книги в формате XSLX.[выходной файл XLSX](5472503.xlsx) выглядит так. Как видите, ячейки C3 и F4 содержат формулу и ее результат 800.
