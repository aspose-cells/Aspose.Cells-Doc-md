...
Иногда вам нужно напечатать диапазон страниц в выходной PDF-файл. Aspose.Cells имеет возможность установить ограничение на количество страниц, создаваемых при преобразовании электронной таблицы Excel в PDF.
