...
Если вам нужно сохранить каждый рабочий лист в файле шаблона Excel для создания разных файлов PDF. Этого можно легко добиться. Вы можете попытаться скрыть листы в файле и сделать видимым один лист за раз, в зависимости от того, как вы будете отображать PDF-файлы.
