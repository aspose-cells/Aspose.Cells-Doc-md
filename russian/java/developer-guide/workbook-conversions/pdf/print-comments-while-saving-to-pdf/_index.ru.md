...
Aspose.Cells предоставляет следующие перечисления для поддержки печати комментариев при сохранении PDF
...
## Фрагмент кода
 ...
 В следующем примере кода показано, как использовать[**PrintCommentsType**](https://reference.aspose.com/cells/java/com.aspose.cells/printcommentstype)enum для печати комментариев при сохранении в PDF.
