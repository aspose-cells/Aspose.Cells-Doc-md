...
Вы можете добавить изображение водяного знака в PDF, просто указав байты изображения. Кроме того, вы можете установить выравнивание, смещение, поворот, непрозрачность, передний/задний план и масштабирование на страницу в [RenderingWatermark](https://reference.aspose.com/cells/java/com.aspose.cells/renderingwatermark/).
