...
- [ТОП](https://reference.aspose.com/cells/java/com.aspose.cells/htmllinktargettype#TOP)

{{% /alert %}} 
## **Изменить тип цели ссылки HTML**
 Следующий код иллюстрирует использование[HtmlSaveOptions.setLinkTargetType()](https://reference.aspose.com/cells/java/com.aspose.cells/htmlsaveoptions#LinkTargetType) имущество. Он изменяет тип цели ссылки на**пустой**. По умолчанию это**родитель** . Вы можете получить[исходный файл excel](5472932.xlsx) по этой ссылке, однако вы можете использовать любой файл Excel, который содержит гиперссылку HTML внутри него, чтобы запустить этот код.
