...
Помимо контроля над тем, следует ли экспортировать скрытые рабочие листы или нет, вы также можете настроить дополнительные параметры для экспорта рабочей книги на номер HTML. В следующих статьях демонстрируются другие функции, поддерживаемые Aspose.Cells для экспорта рабочих книг на номер HTML.
...
- [Экспорт комментариев при сохранении файла Excel на номер HTML](/cells/ru/java/export-comments-while-saving-excel-file-to-html/)
