...
Когда вы сохраняете файл Excel в формате HTML, Aspose.Cells показывает условные комментарии более низкого уровня. Эти условные комментарии в основном относятся к старым версиям Internet Explorer и не имеют отношения к современным веб-браузерам. Подробно о них можно прочитать по следующей ссылке.
