...
## **Aspose.Cells - Hello World**
 Чтобы настроить рабочий лист для предварительного просмотра разрыва страницы, используя**Aspose.Cells Java для Python** , просто вызовите**PageBreakПредварительный просмотр** модуль.
