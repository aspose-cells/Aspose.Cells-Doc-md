---
title: Открытие файлов в Python
type: docs
weight: 10
url: /ru/java/opening-files-in-python/
---

## **Aspose.Cells - Открытие файлов в Python**
Чтобы открыть файл с использованием Aspose.Cells Java в Python, просто вызовите метод openfile() класса Document и укажите второй документ для добавления в конец.
...
Загрузить **Открытие файла (Aspose.Cells)** с любого из нижеперечисленных сайтов социального кодирования:
