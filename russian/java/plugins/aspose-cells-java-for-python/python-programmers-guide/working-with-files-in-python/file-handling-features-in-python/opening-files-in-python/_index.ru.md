...
Чтобы открыть файл, используя Aspose.Cells Java в Python, просто вызовите метод openfile() класса Document и укажите второй документ для добавления в конец.
...
{{< /highlight >}}
## **Скачать рабочий код**
 Скачать**Открытие файла (Aspose.Cells)** с любого из нижеперечисленных сайтов социального кодирования:
