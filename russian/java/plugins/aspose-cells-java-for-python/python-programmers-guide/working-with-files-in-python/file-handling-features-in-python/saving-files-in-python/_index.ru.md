...
### **Сохранение файла в какое-то место**
 Если разработчикам необходимо сохранить свои файлы с помощью**Aspose.Cells Java для Python** в какое-либо место хранения, то они могут просто указать имя файла (с его полным путем хранения) и желаемый формат файла (используя**FileFormatType**перечисление) при вызове**спасти**метод**Рабочая тетрадь**объект.
