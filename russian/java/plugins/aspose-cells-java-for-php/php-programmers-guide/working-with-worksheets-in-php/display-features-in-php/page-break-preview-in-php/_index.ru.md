...
## **Aspose.Cells - Предварительный просмотр разрыва страницы**
 Чтобы настроить рабочий лист для предварительного просмотра разрыва страницы, используя**Aspose.Cells Java для PHP** , просто вызовите**PageBreakПредварительный просмотр** модуль.
