...
{{% alert color="primary" %}} 
 ...
 Когда вы довольны своей оценкой**Aspose.Cells** , ты можешь[купить лицензию](https://purchase.aspose.com)на сайте Aspose. Ознакомьтесь с различными предлагаемыми типами подписки. Если у вас есть какие-либо вопросы, не стесняйтесь обращаться к отделу продаж Aspose.
...
{{% /alert %}} {{% alert color="primary" %}} 
 ...
 Если вы хотите протестировать**Aspose.Cells** без ограничений ознакомительной версии запросите временную лицензию на 30 дней. Пожалуйста, обратитесь к[Как получить временную лицензию?](https://purchase.aspose.com/temporary-license) для дополнительной информации.
