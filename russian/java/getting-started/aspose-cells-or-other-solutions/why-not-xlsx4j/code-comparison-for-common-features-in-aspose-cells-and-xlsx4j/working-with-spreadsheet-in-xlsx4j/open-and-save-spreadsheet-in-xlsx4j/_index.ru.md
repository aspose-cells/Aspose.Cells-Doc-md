...
Разработчики используют Aspose.Cells для открытия файлов для разных целей. Например, откройте файл, чтобы получить из него данные, или используйте предопределенный файл электронной таблицы дизайнера, чтобы ускорить процесс разработки. Aspose.Cells позволяет разработчикам открывать различные типы исходных файлов. Этими исходными файлами могут быть Microsoft отчеты Excel, SpreadsheetML, CSV или файлы с разделителями табуляции.
