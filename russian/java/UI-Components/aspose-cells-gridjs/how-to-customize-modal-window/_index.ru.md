---
title: как настроить внешний вид интерфейса для модального окна в GridJs  
type: docs
weight: 250
url: /ru/java/aspose-cells-gridjs/how-to-customize-ui-window/
description: Эта статья описывает, как настроить внешний вид интерфейса для модального окна в GridJs.
keywords: GridJs,настройка,модальное окно,UI,внешний вид,визуальный,окно
aliases:
aliases:
...
# Руководство по стилю модальных окон для GridJs

## Оглавление

- [Обзор](#overview)
- [Названия CSS классов](#css-class-naming)
- [Быстрый старт](#quick-start)
- [Примеры красивого оформления](#beautiful-style-examples)
- [Галерея тем](#theme-gallery)
- [Расширенные техники](#advanced-techniques)
...
| Вставка URL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
...
| Валидация данных | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| Форматы чисел | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| Оповещение о валидации | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| ВставкаУдаление | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
Идеально для профессиональных и корпоративных приложений.
...
Отлично подходит для приложений с поддержкой темного режима.
...
### Пример 4: Цветная игривая тема 🌈

Идеально для креативных и веселых приложений.
...
Подходит для бизнес-а and корпоративных приложений.
...
### 4. Последовательные межстрочные интервалы
