...
1.  Выбирать**Сдвиг Cells Вверх** или же**Сдвиг Cells Левый** кнопка.
...
**Сдвиг Cells Вверх** а также**Сдвиг Cells Левый** обрабатываются внутренним компонентом JSF**Вид рабочего листа**. Исходный код соответствующих методов выглядит следующим образом:
#### **WorksheetView.removeCellShiftUp**
{{< highlight "java" >}}
...
1.  Выбирать**Форматы**, **Содержание** или же**Оба** вариант.

Редактор очистит выбранную ячейку.

**Как это работает?**

**Форматы**, **Содержание** а также**Оба** обрабатываются внутренним компонентом JSF**Вид рабочего листа**. Исходный код соответствующих методов выглядит следующим образом:
#### **WorksheetView.clearCurrentCellFormatting**
{{< highlight "java" >}}
