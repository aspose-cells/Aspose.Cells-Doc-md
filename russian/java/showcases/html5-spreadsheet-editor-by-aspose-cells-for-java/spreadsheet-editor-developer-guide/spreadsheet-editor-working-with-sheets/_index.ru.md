...
**Как это работает?**
 ...
 Когда пользователь нажимает на** +** (плюс) и**-** кнопка (минус) нажата, внутренний компонент JSF**Вид рабочего листа** обрабатывает события с помощью**WorksheetView.onAddNewSheet** а также**Методы WorksheetView.onRemoveActiveSheet**.
#### **WorksheetView.onAddNewSheet**
{{< highlight "java" >}}
