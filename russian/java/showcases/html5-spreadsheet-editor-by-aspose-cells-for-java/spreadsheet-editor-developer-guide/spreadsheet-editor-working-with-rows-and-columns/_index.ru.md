...
**Добавить строку выше** а также**Добавить строку ниже** обрабатываются внутренним компонентом JSF**Вид рабочего листа**. Исходный код соответствующих методов выглядит следующим образом:
#### **WorksheetView.addRowAbove**
{{< highlight "java" >}}
...
**Добавить столбец перед** а также**Добавить столбец после** обрабатываются внутренним компонентом JSF**Вид рабочего листа**. Исходный код соответствующих методов выглядит следующим образом:
#### **WorksheetView.addColumnBefore**
{{< highlight "java" >}}
...
**Как это работает?**
 ...
 Когда пользователь отправляет значение ширины и высоты, эти значения обрабатываются на стороне сервера**setCurrentRowHeight** а также**setCurrentColumnWidth** методы внутреннего компонента JSF**Вид рабочего листа**.
#### **WorksheetView.setCurrentRowHeight**
{{< highlight "java" >}}
...
1.  Выбирать**Сдвиг Cells Вправо** или же**Сдвиг Cells Вниз** кнопка.
...
**Сдвиг Cells Вправо** а также**Сдвиг Cells Вниз** обрабатываются внутренним компонентом JSF**Вид рабочего листа**. Исходный код соответствующих методов выглядит следующим образом:
#### **WorksheetView.addCellShiftRight**
{{< highlight "java" >}}
