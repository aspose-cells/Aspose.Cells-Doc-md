...
type: docs
weight: 70
url: /ru/java/aspose-cells-for-java-2-5-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 2.5.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.5.2/)
...
- Поддерживает чтение сводных таблиц из файлов шаблонов.
 ...
 Улучшено чтение фигур из файлов XLSX.
