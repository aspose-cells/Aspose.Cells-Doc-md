...
type: docs
weight: 70
url: /ru/java/aspose-cells-for-java-8-0-0-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 8.0.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.0.0/)
...
(CELLSJAVA-40770) - Установите время создания в сгенерированном PDF
...
(CELLSJAVA-40738) — setExportActiveWorksheetOnly изменяет выравнивание таблицы в HTML
(CELLSJAVA-40747) — фоновое изображение не копируется в целевую книгу при вызове Workbook.copy.
(CELLSJAVA-40276) — Текст внутри изображения отображается зеркально при сохранении книги Excel в формате PDF.
...
(CELLSJAVA-40737) - Проблема форматирования фигур/элементов управления в преобразовании Excel в PDF
(CELLSJAVA-40742) — Неправильный перенос меток оси при преобразовании XLSX в PDF.
...
(CELLSJAVA-40585) — Aspose.Cells: встроенная сигма-диаграмма неправильно отображается в PDF/изображениях
(CELLSJAVA-40742) — Неправильный перенос меток оси при преобразовании XLSX в PDF.
...
(CELLSJAVA-40766) — XLSX в HTML: проблема с hideColumn, создающим нулевые значения в HTML.
