...
type: docs
weight: 10
url: /ru/java/aspose-cells-for-java-8-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 8.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.3.0/)
...
(CELLSJAVA-41070) — Проблема с преобразованием HTML в XLS — отформатированное число отображается как пустое
...
(CELLSJAVA-41060) — Изменение цветовой палитры рабочей книги при сохранении XLSX в XLS приводит к тому, что MS Excel открывает результирующую электронную таблицу в защищенном режиме.
(CELLSJAVA-41059) — изменение порядка правил условного форматирования при сохранении XLSX в XLS с изменением поддона.
...
(CELLSJAVA-41054) - Копирование вставленного изображения не отображается в PDF-файле
(CELLSJAVA-41044) - Aspose.Cells сгенерированный PDF-файл не проходит тест на соответствие PDF/A-1b
(CELLSJAVA-41015) - Aspose.Cells Сгенерированный документ PD/A-1b не проходит предварительную проверку
(CELLSJAVA-40951) — PDF-документ поврежден и не может быть открыт в Acrobat Reader после преобразования из файла шаблона Excel.
...
(CELLSJAVA-41047) - Разделитель данных столбчатой диаграммы с накоплением имеет разную толщину при преобразовании электронной таблицы в формат PDF.
(CELLSJAVA-41045) — Столбцы диаграммы перекрываются с нижней осью при преобразовании электронной таблицы в формат PDF.
(CELLSJAVA-40989) — гистограмма имеет дополнительные вертикальные линии справа от столбцов при отображении в формате PDF.
(CELLSJAVA-40988) — Метка данных диаграммы обрезана в подготовленном PDF-файле.
(CELLSJAVA-40987) - Метки осей диаграммы и легенда перекрываются в визуализируемом PDF-файле.
