...
type: docs
weight: 60
url: /ru/java/aspose-cells-for-java-2-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 2.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.3.0/)
...
- Чтение файлов шаблонов XLS оптимизировано.
...
|17107 | ОРВ| Сохранение диаграмм в файлах ODS|
