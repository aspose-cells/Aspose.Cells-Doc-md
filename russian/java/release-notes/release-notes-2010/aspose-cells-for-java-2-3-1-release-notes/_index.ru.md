...
type: docs
weight: 50
url: /ru/java/aspose-cells-for-java-2-3-1-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 2.3.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.3.1/)
...
|18257 | PDF| Области печати в экспортированном PDF|
