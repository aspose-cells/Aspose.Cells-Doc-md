...
type: docs
weight: 80
url: /ru/java/aspose-cells-for-java-8-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 8.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.4.0/)
...
(CELLSJAVA-41169) — Удаление поддельных нулевых атрибутов в сгенерированном HTML-файле.
(CELLSJAVA-41179) - поддержка японского календаря

Ошибки

(CELLSJAVA-41222) — неправильное поле сортировки сводной таблицы в выходных данных XLSX.
...
(CELLSJAVA-41215) - EMF, сгенерированный с помощью Aspose.Cells, отображается по-разному в разных средствах просмотра.
...
(CELLSJAVA-41224) — Ошибка преобразования изображения при преобразовании Excel в PDF.
(CELLSJAVA-41223) - Не удается подписать экспортированные PDF-файлы.
...
(CELLSJAVA-40813) — Метки данных круговой диаграммы перекрываются в отображаемом HTML.
