...
type: docs
weight: 90
url: /ru/java/aspose-cells-for-java-8-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 8.3.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.3.2/)
