...
type: docs
weight: 20
url: /ru/java/aspose-cells-for-java-7-3-3-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 7.3.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.3.3/)
...
- Добавляйте кавычки к пустым значениям ячеек при экспорте CSV с помощью
...
- Подчеркивание шрифта исчезло в обработанном PDF-файле
- Установка стилей шрифта не повлияла на XLSX в режиме LightCells.
- Часть нижнего колонтитула была потеряна при сохранении в PDF
