...
- Встроенные OLE-файлы OOXML в XLS выходят как упакованные файлы OLE, а не распакованные файлы.
...
- Повторно сохраненный файл XLSX вызывает ошибку «Excel обнаружил нечитаемый контент…»
