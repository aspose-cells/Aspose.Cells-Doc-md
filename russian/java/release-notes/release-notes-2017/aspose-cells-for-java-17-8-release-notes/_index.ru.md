...
type: docs
weight: 50
url: /ru/java/aspose-cells-for-java-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.8](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.8/).
...
- [Добавить цифровую подпись к уже подписанному файлу Excel](/cells/ru/java/add-digital-signature-to-an-already-signed-excel-file/)
...
- [Вывод пустой страницы, когда нечего печатать](/cells/ru/java/output-blank-page-when-there-is-nothing-to-print/)
