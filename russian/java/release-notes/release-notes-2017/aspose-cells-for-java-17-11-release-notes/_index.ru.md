...
type: docs
weight: 20
url: /ru/java/aspose-cells-for-java-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
- [Преобразование смарт-арта в форму группы](/cells/ru/java/convert-the-smart-art-to-group-shape/)
- [Создать общую книгу с Aspose.Cells](/cells/ru/java/create-shared-workbook-with-aspose-cells/)
- [Определите, является ли фигура фигурой Smart Art](/cells/ru/java/determine-if-shape-is-smart-art-shape/)
- [Найдите имя корневого элемента карты Xml](/cells/ru/java/find-the-root-element-name-of-xml-map/)
- [Игнорировать ошибки при рендеринге Excel в PDF](/cells/ru/java/ignore-errors-while-rendering-excel-to-pdf/)
- [Защита паролем или снятие защиты общей книги](/cells/ru/java/password-protect-or-unprotect-the-shared-workbook/)
- [Запрос Cell Области сопоставлены с путем карты Xml с использованием метода Worksheet.XmlMapQuery](/cells/ru/java/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
- [Визуализация последовательности страниц с использованием свойств PageIndex и PageCount в ImageOrPrintOptions](/cells/ru/java/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/)
