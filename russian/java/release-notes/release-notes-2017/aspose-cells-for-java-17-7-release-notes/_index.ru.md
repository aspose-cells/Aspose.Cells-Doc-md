...
type: docs
weight: 60
url: /ru/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [Реализовать ошибки и логическое значение на русском или любом другом языке](/cells/ru/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
