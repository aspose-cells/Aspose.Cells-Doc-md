...
type: docs
weight: 90
url: /ru/java/aspose-cells-for-java-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.4.0/).
...
- [Защита паролем проекта VBA книги Excel](/cells/ru/java/password-protect-the-vba-project-of-excel-workbook/)
- [Узнайте, защищен ли проект VBA](/cells/ru/java/find-out-if-vba-project-is-protected/)
- [Проверьте, защищен ли проект VBA и заблокирован для просмотра](/cells/ru/java/check-if-vba-project-is-protected-and-locked-for-viewing/)
- [Указание форматирования пользовательского шаблона DBNum](/cells/ru/java/specifying-dbnum-custom-pattern-formatting/)
