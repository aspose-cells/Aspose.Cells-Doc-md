...
type: docs
weight: 80
url: /ru/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [Сдвинуть первую строку вниз при вставке Cells строк таблицы данных](/cells/ru/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
