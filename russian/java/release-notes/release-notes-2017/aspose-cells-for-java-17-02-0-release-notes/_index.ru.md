---
title: Aspose.Cells for Java 17.02.0 Примечания к выпуску
type: docs
weight: 110
url: /ru/java/aspose-cells-for-java-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.02.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.02.0/).
...
|CELLSJAVA-42158|Привязанные значения вертикальной оси изменены при рендеринге электронной таблицы в PDF|Ошибка|
|CELLSJAVA-42157|Привязанные значения горизонтальной и вертикальной осей изменены при рендеринге диаграммы в EMF|Ошибка|
|CELLSJAVA-42133|Иврит - в PDF отсутствует пробел|Ошибка|
...
|CELLSJAVA-42084|В выходном PDF-файле отсутствуют метки/условные обозначения оси пробела ч/б диаграммы (иврит).|Ошибка|
...
|CELLSJAVA-42169|Преобразование Excel в PDF — арабский текст переворачивается|Ошибка|
...
|CELLSJAVA-40511|Страницы PDF-файла, сгенерированного Aspose.Cells, все черные.|Ошибка|
...
1. [Автоподбор столбцов и строк при загрузке HTML в книгу](/cells/ru/java/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Преобразование текста в столбцы с помощью Aspose.Cells](/cells/ru/java/convert-text-to-columns-using-aspose-cells/)
1. [Получить список шрифтов, используемых в электронной таблице или книге](/cells/ru/java/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Получать предупреждения при загрузке файла Excel](/cells/ru/java/get-warnings-while-loading-excel-file/)
1. [Чтение и обработка диаграмм Excel 2016](/cells/ru/java/read-and-manipulate-excel-2016-charts/)
1. [Обрезать начальные пустые строки и столбцы при экспорте электронных таблиц в формат CSV](/cells/ru/java/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
