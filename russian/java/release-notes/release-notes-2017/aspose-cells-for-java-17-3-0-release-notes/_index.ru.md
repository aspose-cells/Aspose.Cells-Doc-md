...
type: docs
weight: 100
url: /ru/java/aspose-cells-for-java-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.3.0/).
...
|CELLSJAVA-42204|Пунктирные границы из электронной таблицы не отображаются в HTML|Ошибка|
...
|CELLSJAVA-42208|Комментарии (в конце) обрезаются по вертикали при создании PDF по номеру Aspose.Cells.|Ошибка|
|CELLSJAVA-42206|Пунктирные линии ряда для диаграмм неправильно отображаются в выходном PDF-файле|Ошибка|
...
1. [Настройка параметров глобализации для сводной таблицы](/cells/ru/java/customize-globalization-settings-for-pivot-table/)
1. [Выполнение функции на стороне клиента при изменении страницы GridWeb](/cells/ru/java/execute-client-side-function-on-gridweb-page-change/)
1. [Проверять весь рабочий лист, а не только обновленные ячейки](/cells/ru/java/validate-entire-worksheet-instead-of-only-the-updated-cells/)
