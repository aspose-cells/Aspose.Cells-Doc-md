...
type: docs
weight: 40
url: /ru/java/aspose-cells-for-java-17-9-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 17.9](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.9/).
...
|CELLSJAVA-42379|Реализовать именованный пункт назначения при рендеринге в формат PDF (запрос закладок)|Новая особенность|
...
- [Добавление закладок PDF с именованными местами назначения](/cells/ru/java/add-pdf-bookmarks-with-named-destinations/)
- [Управление загрузкой внешних ресурсов в книгу MS Excel при рендеринге в PDF](/cells/ru/java/control-loading-of-external-resources-in-ms-excel-workbook-while-rendering-to-pdf/)
- [Скопируйте VBA Macro UserForm DesignerStorage из шаблона в целевую книгу](/cells/ru/java/copy-vba-macro-userform-designerstorage-from-template-to-target-workbook/)
- [Создать Удалить и получить комментарии GridCell](/cells/ru/java/create-remove-and-get-gridcell-comments/)
- [Отправить фигуру спереди или сзади внутри рабочего листа](/cells/ru/java/send-shape-front-or-back-inside-the-worksheet/)
