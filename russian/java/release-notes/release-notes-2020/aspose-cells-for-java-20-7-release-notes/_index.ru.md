...
type: docs
weight: 9
url: /ru/java/aspose-cells-for-java-20-7-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 20.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.7/).
...
|CELLSJAVA-43223|Исключение «java.lang.IllegalStateException: неверная кодировка: null» при загрузке файла XLS|Улучшение|
...
|CELLSJAVA-43215|Невозможно преобразовать файл XLSM в PDF|Ошибка|
...
|CELLSJAVA-43217|При печати XLSX в XPS фоновое форматирование теряется|Ошибка|
...
|CELLSJAVA-43214|При переводе XLS в XLSX выдает битый файл XLSX|Ошибка|
|CELLSJAVA-43216|Преобразование XLS в XLSX - жирность шрифта и положение изменены для фигуры|Ошибка|
|CELLSJAVA-43228|Сгенерированный XLS находится в защищенном режиме|Ошибка|
