...
type: docs
weight: 6
url: /ru/java/aspose-cells-for-java-20-10-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 20.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.10/).
