...
type: docs
weight: 40
url: /ru/java/aspose-cells-for-java-20-3-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 20.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.3/).
...
|CELLSJAVA-42068|GIF на листе неверен, когда книга конвертируется в HTML|Ошибка|
...
|CELLSJAVA-43143|После WorkbookDesigner.process Chart выводит null в HTML|Ошибка|
