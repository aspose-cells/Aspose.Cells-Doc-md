...
type: docs
weight: 30
url: /ru/java/aspose-cells-for-java-20-4-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 20.4](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.4/).
