...
type: docs
weight: 10
url: /ru/java/aspose-cells-for-java-20-6-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 20.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.6/).
...
|CELLSJAVA-43185|Качество JPEG всегда равно 75 в setImageResample в Linux.|Ошибка|
...
|CELLSJAVA-43193|Возникло исключение NullPointerException при загрузке некоторых файлов XLSX.|Исключение|
