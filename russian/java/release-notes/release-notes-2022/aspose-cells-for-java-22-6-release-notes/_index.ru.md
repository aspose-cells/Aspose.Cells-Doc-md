...
type: docs
weight: 7
url: /ru/java/aspose-cells-for-java-22-6-release-notes/
---
{{% alert color="primary" %}}

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java 22.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.6/).
