...
type: docs
weight: 20
url: /ru/java/aspose-cells-for-java-v2-0-1-hotfix-release-notes/
---
{{% alert color="primary" %}} 

 Эта страница содержит примечания к выпуску для[Aspose.Cells for Java Исправление версии 2.0.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-v2.0.1-hotfix/)
...
{{% /alert %}} 
 ...
 l Поддерживает R/W файл электронной таблицы открытого документа (ODS): Cell данные и стиль, стиль строки/столбца, объединенный Cells, свойства рабочего листа/книги, свойства документа, формула/имя.
...
|:- |:- |:- |
|6722 | ОРВ| Чтение/запись ODS-файла|
