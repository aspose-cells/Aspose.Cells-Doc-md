...
type: docs
weight: 10
url: /ru/java/aspose-cells-for-java-v2-1-0-release-notes/
---
{{% alert color="primary" %}} 
...
Включить атрибуты автофильтра при копировании книги/листа.

l Поддержка гиперссылок в преобразовании xls2pdf.
...
|9264|CSV|импорт/экспорт файла формата CSV|
