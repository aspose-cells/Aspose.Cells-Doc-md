---
title: Aspose.Cells for Java 19.5 Примечания к выпуску
type: docs
weight: 80
url: /ru/java/aspose-cells-for-java-19-5-release-notes/
---
{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску для Aspose.Cells for Java 19.5.
...
|CELLSJAVA-42893|Диаграмма отсутствует при преобразовании Excel в HTML|Ошибка|
