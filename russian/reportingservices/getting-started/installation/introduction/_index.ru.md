...
1. Он делает все необходимые записи в системном реестре, чтобы открыть Microsoft Excel для COM-приложений.
1. Он содержит демонстрационные проекты, позволяющие получить образцы кода.
