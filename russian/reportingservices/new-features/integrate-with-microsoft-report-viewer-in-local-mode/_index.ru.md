...
- В удаленном режиме средство просмотра отчетов может экспортировать отчеты во все форматы, установленные на сервере отчетов, к которому оно подключено. Таким образом, чтобы экспортировать отчеты в другие форматы Microsoft Excel, вам нужно всего лишь установить Aspose.Cells for Reporting Services на сервер.
...
Установив Aspose.Cells for Reporting Services на компьютере для разработки и выполнив следующие шаги, вы сможете экспортировать в другие форматы Excel Microsoft из средства просмотра отчетов, работающего в локальном режиме.

{{% /alert %}} 
### **Работа с Aspose.Cells в локальном режиме**
1.  Справка**Aspose.Cells.ReportingServices.dll** в проекте:
 ...
 (куда<InstallDir> это каталог, в который вы установили или распаковали Aspose.Cells for Reporting Services.
...
1.  Вызовите метод AddExtension из кода.
 Вы можете вызывать AddExtension (показано на предыдущем шаге) всякий раз, когда вам нужно добавить форматы экспорта Aspose.Cells for Reporting Services в экземпляр элемента управления средства просмотра отчетов. Рассмотрите возможность вызова из формы_Загрузить или Страница_Загрузить обработчик событий приложения WinForms или ASP .NET.
 - Вы можете добавить все или только некоторые форматы экспорта Aspose.Cells for Reporting Services экспорта. Вы можете указать любое отображаемое имя для форматов, которые будут отображаться в средстве просмотра отчетов.
 Чтобы добавить форматы экспорта Aspose.Cells for Reporting Services в средство просмотра отчетов Microsoft в локальном режиме, используйте следующий код:
