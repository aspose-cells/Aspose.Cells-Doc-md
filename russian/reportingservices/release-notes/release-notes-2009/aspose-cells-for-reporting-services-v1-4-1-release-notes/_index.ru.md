...
{{% /alert %}} 
 ...
 l Добавлена поддержка нового расширения рендеринга (Xlsm).

 l Поддерживаются шаблоны Excel с макросами.

 l Расширенная поддержка SSRS2008.

 l Улучшена производительность рендеринга.
...
|:- |:- |:- |
|8431 | Оказывать| Ошибка форматирования|
|8211 | Оказывать| Усовершенствования SSRS2008|
