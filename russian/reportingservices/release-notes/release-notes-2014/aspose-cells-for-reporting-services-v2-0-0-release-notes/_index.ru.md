...
- ` ` (SSRS-40128) Экспорт SSRS в XLSX с сокращением заголовков столбцов
...
- ` ` (SSRS-40109) Проблемы с визуализацией XLSX в Excel 2007
...
- ` ` (SSRS-40105) Произошла ошибка при экспорте отчета в службы отчетов XLSX.
