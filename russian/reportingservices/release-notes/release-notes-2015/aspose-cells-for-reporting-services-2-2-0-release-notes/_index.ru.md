...
(SSRS-40184) Отчет об индексе целостности — отчет не экспортируется в XLSX, выдается ошибка: «Произошла ошибка при экспорте отчета».
...
(SSRS-40168) Группы строк теряются в отображаемом формате файла XLSX.
