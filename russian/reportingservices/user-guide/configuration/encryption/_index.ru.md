...
---
 Aspose.Cells для служб Reporting Services поддерживает три типа шифрования: XOR, WEAK ENCRYPTION и Microsoft Strong Cryptographic Provider. См. информацию о конфигурации шифрования в**Aspose.Cells.ReportingServices.xml** файл.

 Когда значение шифрования равно**выключенный**, Aspose.Cells для служб Reporting Services отключает функции шифрования.
...
{{< /highlight >}}
 ...
 Когда значение шифрования равно**на**, Aspose.Cells для служб Reporting Services включает шифрование.
