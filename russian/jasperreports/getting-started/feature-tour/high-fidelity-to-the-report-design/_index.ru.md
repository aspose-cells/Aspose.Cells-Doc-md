...
{{% alert color="primary" %}}
 ...
 Aspose.Cells для JasperReports экспортирует отчеты как электронные таблицы Excel Microsoft, которые выглядят идентично отчетам, экспортируемым встроенными экспортерами[ДжасперРепортс](https://community.jaspersoft.com/project/jasperreports-library).

**Пример отчета XLS, экспортированного с использованием Aspose.Cells для JasperReports** 
