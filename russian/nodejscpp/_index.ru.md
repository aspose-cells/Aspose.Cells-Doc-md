...
url: /ru/nodejs-cpp/
is_root: true
description: Aspose.Cells for Node.js via C++ поддерживает популярные форматы файлов Excel (XLS, XLSX, XLSM, XLSB, XLTX, XLTM, SpreadsheetML, CSV), OpenOffice (ODS), HTML и JSON, а также позволяет экспортировать файлы Excel в PDF, DOCX, PPTX, JSON, XPS, HTML, MHTML, простым текстом и популярными изображениями, включая TIFF, JPG, PNG, BMP и SVG.
keywords: Aspose.Cells for Node.js via C++ создает, исправляет, модифицирует, парсит, объединяет, конвертирует JSON, Excel, XML, PDF, HTML, TSV, SQL, TXT, PNG, JPEG и другие форматы.
---
