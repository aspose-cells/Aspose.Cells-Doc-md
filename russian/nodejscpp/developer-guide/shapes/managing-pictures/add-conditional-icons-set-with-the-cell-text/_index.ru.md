---
title: Добавить условный набор иконок с текстом ячейки с помощью Node.js via C++
linktitle: Добавление условных значков к тексту ячейки
type: docs
weight: 160
url: /ru/nodejs-cpp/add-conditional-icons-set-with-the-cell-text/
description: Узнайте, как добавлять условные иконки рядом с текстом в ячейке с помощью Aspose.Cells for Node.js via C++. Улучшение значения данных через иконки.
---

{{% alert color="primary" %}} 

Иногда вы хотите добавить условные иконки рядом с текстом в ячейке, чтобы сделать данные более значимыми для читателей. Можно использовать некоторые типы условных значков форматирования, но без применения условного форматирования к ячейкам. Aspose.Cells for Node.js via C++ поддерживает эту функцию.
