---
title: Установка формулы для именованного диапазона с помощью Node.js через C++
linktitle: Установка формулы для именованного диапазона
type: docs
weight: 20
url: /ru/nodejs-cpp/setting-formula-for-named-range/
description: Узнайте, как устанавливать формулы для именованных диапазонов в таблицах с помощью Aspose.Cells for Node.js via C++.
---

## **Установка формулы для именованного диапазона**
Как приложение Excel, API Aspose.Cells обеспечивает возможность указания формулы для именованного диапазона с использованием его свойства [Range.getRefersTo()](https://reference.aspose.com/cells/nodejs-cpp/range/#getRefersTo--). Этот функционал имеет множество сценариев использования, некоторые из которых подробно описаны ниже.
