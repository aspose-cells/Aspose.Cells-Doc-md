...
type: docs
weight: 10
url: /ru/nodejs-cpp/format-number-to-currency/
description: В этой статье рассказывается о том, как форматировать число как валюту с помощью API Aspose.Cells for Node.js via C++.
...
## **Как форматировать число как валюту в Aspose.Cells**
 ...
 Чтобы форматировать числа как валюту в библиотеке Aspose.Cells for Node.js via C++ для работы с файлами Excel, вы можете программно применить формат валюты к ячейкам. Вот как это сделать с помощью Aspose.Cells for Node.js via C++:
