...
Per scoprire quale versione di Aspose.Cells stai utilizzando tramite l'API, utilizza il metodo statico GetVersion della classe CellsHelper per ottenere il numero di versione di Aspose.Cells.
