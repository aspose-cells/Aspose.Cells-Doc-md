...
type: docs
weight: 10
url: /it/python-net/format-number-to-currency/
description: Questo articolo introdurrà come formattare un numero come valuta usando l API Aspose.Cells per Python via .NET.
...
## **Come formattare un numero come valuta in Aspose.Cells per Python via .NET**

Per formattare i numeri come valuta in Aspose.Cells per Python .NET, puoi applicare la formattazione valuta alle celle programmaticamente. Ecco come farlo usando Python con Aspose.Cells:
