...
type: docs
weight: 10
url: /it/python-net/how-to-format-number-to-time/
description: Questo articolo illustrerà come formattare un numero in formato ora usando l API Aspose.Cells per Python via .NET.
...
## **Come formattare un numero in ora in Aspose.Cells per Python via .NET**
Formattare numeri come ora in Aspose.Cells per Python via .NET è un processo semplice che implica l'applicazione di un formato numerico personalizzato a una cella o un intervallo di celle. Aspose.Cells è una libreria potente che permette di lavorare con file Excel in applicazioni .NET senza la necessità di installare Microsoft Excel. Ecco come puoi formattare numeri come ora:
