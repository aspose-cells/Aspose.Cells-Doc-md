...
type: docs
weight: 10
url: /it/python-net/format-number-to-date/
description: Questo articolo introdurrà come formattare un numero come data usando l API Aspose.Cells per Python via .NET.
...
## **Come formattare un numero come data in Aspose.Cells per Python via .NET**

Per formattare i numeri come data in Aspose.Cells per Python via .NET, puoi applicare la formattazione data alle celle programmaticamente. Ecco come farlo usando Python con Aspose.Cells:
