...
- Barre dei dati per visualizzare valori numerici
- Scale di colore per ombreggiatura gradiente delle celle
- Set di icone per indicatori grafici
- Regole superiore/inferiore
- Formattazione basata su periodi di tempo

Questo esempio mostra vari tipi di formattazione condizionale avanzata con Python.NET:
