...
description: Questo articolo spiega come inserire programmaticamente un immagine nell intestazione e nel piè di pagina dei fogli di lavoro di Excel impostando l intestazione e il piè di pagina con comandi script utilizzando l API Aspose.Cells per Python via .NET.
keywords: Libreria Excel Python, inserisci immagine nell intestazione/piè di pagina di Excel, imposta comandi script per intestazione e piè di pagina di Excel usando Python.
---
