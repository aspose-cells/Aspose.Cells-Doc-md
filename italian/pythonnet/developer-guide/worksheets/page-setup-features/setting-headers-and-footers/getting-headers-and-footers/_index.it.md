...
description: Questo articolo spiega come ottenere in modo programmato intestazioni e piè di pagina da file Excel o OpenOffice utilizzando l API Aspose.Cells per Python via .NET.
keywords: Libreria Excel Python, Ottenere intestazioni e piè di pagina Python, Analizzare Intestazioni e Piè di Pagina per Command List utilizzando Python.
---
...
## **Come Ottenere Intestazioni e Piè di Pagina utilizzando Aspose.Cells per Libreria Excel Python**
...
## **Come Analizzare Intestazioni e Piè di Pagina in un Elenco di Comandi**
...
Aspose.Cells per Python via .NET fornisce un metodo [**Worksheet.page_setup.get_commands**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/get_commands/#str) per analizzare intestazioni e piè di pagina come elenco di comandi.
