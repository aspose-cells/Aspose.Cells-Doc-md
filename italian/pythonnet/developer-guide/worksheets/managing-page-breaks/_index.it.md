...
description: Questo articolo fornisce codice di esempio e spiega come aggiungere interruzioni di pagina, cancellare interruzioni di pagina specifiche o eliminarle in modo programmato nei fogli di lavoro di Excel utilizzando Aspose.Cells per API Python via .NET.
keywords: Libreria Excel Python, Interruzioni di pagina Python, Interruzioni di pagina Excel in Python, Elimina interruzione di pagina in Python.
---
...
La posizione della cella in cui viene aggiunta l'interruzione di pagina, la pagina si conclude e il resto dei dati dopo l'interruzione di pagina viene stampato nella pagina successiva durante la stampa. In parole semplici, le interruzioni di pagina dividono il tuo foglio di lavoro in più pagine secondo le tue specifiche. È inoltre possibile aggiungere interruzioni di pagina ai fogli di lavoro in tempo reale utilizzando Aspose.Cells per API Python via .NET. Aspose.Cells per Python via .NET consente ai programmatori di aggiungere due tipi di interruzioni di pagina:

- Interruzione di pagina orizzontale
- Interruzione di pagina verticale

Nel resto della discussione, descriveremo come è possibile aggiungere interruzioni di pagina orizzontali o verticali nei fogli di lavoro utilizzando Aspose.Cells per API Python via .NET.

{{% /alert %}}

## **Interruzioni di pagina**

Aspose.Cells for Python via .NET fornisce una classe che rappresenta un file Excel. La classe contiene una raccolta che consente l'accesso a ciascun foglio di lavoro nel file Excel.
