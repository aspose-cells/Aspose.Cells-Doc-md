...
type: docs
weight: 60
url: /it/python-net/setting-strong-encryption-type/
---
...
Puoi anche crittografare e proteggere con password i file Excel con un tipo di crittografia forte utilizzando l'API di Aspose.Cells per Python via .NET.
