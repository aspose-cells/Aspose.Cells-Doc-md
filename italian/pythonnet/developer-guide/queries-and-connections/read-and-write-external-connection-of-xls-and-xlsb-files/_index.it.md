...
type: docs
weight: 80
url: /it/python-net/read-and-write-external-connection-of-xls-and-xlsb-files/
---
...
Il seguente esempio di codice carica il file di esempio XLSB (è possibile caricare anche XLS) e legge la sua prima Connessione Esterna che è effettivamente una connessione Microsoft Access DB. Modifica quindi la proprietà [**DBConnection.name**](https://reference.aspose.com/cells/python-net/aspose.cells.externalconnections/externalconnection/name) e la salva come file di output XLS/XLSB. La schermata mostra l'effetto del codice sul [file di esempio XLSB](51740722.xlsb) e sul [file di output XLSB](51740723.xlsb) dopo la sua esecuzione. Si prega di consultare anche l'output della console del codice di esempio riportato di seguito per un riferimento.
