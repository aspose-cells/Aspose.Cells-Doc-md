...
type: docs
weight: 600
url: /it/python-net/how-to-prevent-printing-excel/
description: Impara come come evitare che gli utenti stampino Excel tramite l API Aspose.Cells per Python via .NET.
...
## **Come impedire agli utenti di stampare il file Excel usando Aspose.Cells per Python via .NET**
