...
type: docs
weight: 50
url: /it/python-net/link-cells-to-xml-map-elements/
---

## **Possibili Scenari di Utilizzo**

Puoi collegare le celle agli elementi della mappa XML usando Aspose.Cells for Python via .NET. Per questo, usa il metodo [**Cells.link_to_xml_map()**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/link_to_xml_map).
