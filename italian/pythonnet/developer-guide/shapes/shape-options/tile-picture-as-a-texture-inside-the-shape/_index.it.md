...
type: docs
weight: 1700
url: /it/python-net/tile-picture-as-a-texture-inside-the-shape/
---
...
È possibile riempire la superficie della forma con un'immagine e ripetere l'immagine utilizzando la proprietà [**Shape.fill.texture_fill.is_tiling**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/texturefill/is_tiling) e impostandola su **true**. Si prega di vedere il seguente codice di esempio, il [file Excel di esempio](46465050.xlsx) e la schermata per un riferimento.
