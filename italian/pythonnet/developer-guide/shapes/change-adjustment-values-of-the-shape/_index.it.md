...
Questo articolo spiegherà l'uso della proprietà [**Shape.geometry.shape_adjust_values**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/geometry/shape_adjust_values/) per cambiare il valore di regolazione delle diverse forme.
