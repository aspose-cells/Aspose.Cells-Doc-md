...
description: Questo articolo spiega come aprire diversi file di versioni Excel usando l API di Aspose.Cells per Python via .NET.
keywords: Apri diversi file Microsoft Excel con Python, Come posso aprire file Excel criptati.
---

{{% alert color="primary" %}}

Aspose.Cells for Python via .NET può aprire diversi file di versioni Microsoft Excel, come Microsoft Excel 95/97 - 2003, SpreadsheetML, aprire Microsoft Excel 2007/2010/2013/2016/2019 e Office 365 XLSX o file Excel crittografati.

{{% /alert %}}

## **Come aprire file di diverse versioni di Microsoft Excel**

Un'applicazione deve spesso essere in grado di aprire file di Microsoft Excel creati in diverse versioni, ad esempio, Microsoft Excel 95, 97, o Microsoft Excel 2007/2010/2013/2016/2019 e Office 365. Potrebbe essere necessario caricare un file in uno qualsiasi dei diversi formati, tra cui XLS, XLSX, XLSM, XLSB, SpreadsheetML, tabella delimitata o TSV, CSV, ODS e così via. Utilizzare il costruttore, o specificare l'attributo di tipo della classe [**Workbook**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook) che specifica il formato usando l'enumerazione [**FileFormatType**](https://reference.aspose.com/cells/python-net/aspose.cells/fileformattype).

L'enumerazione [**FileFormatType**](https://reference.aspose.com/cells/python-net/aspose.cells/fileformattype) contiene molti formati di file predefiniti alcuni dei quali sono elencati di seguito.
...
Per aprire un file di Microsoft Excel 95/5.0, utilizza [**LoadOptions**](https://reference.aspose.com/cells/python-net/aspose.cells/loadoptions) e imposta l'attributo relativo per la classe [**LoadOptions**](https://reference.aspose.com/cells/python-net/aspose.cells/loadoptions) per il file modello da caricare. Un file di esempio per testare questa funzionalità può essere scaricato dal seguente link:
...
Per aprire un file di Microsoft Excel 97 - 2003, utilizza [**LoadOptions**](https://reference.aspose.com/cells/python-net/aspose.cells/loadoptions) e imposta l'attributo relativo per la classe [**LoadOptions**](https://reference.aspose.com/cells/python-net/aspose.cells/loadoptions) per il file modello da caricare.
