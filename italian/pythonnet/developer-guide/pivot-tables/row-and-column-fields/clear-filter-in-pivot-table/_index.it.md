...
type: docs
weight: 130
url: /it/python-net/clear-filter-in-pivot-table/
description: Come eliminare il filtro PivotFilter dal campo PivotField specifico nella tabella pivot con Aspose.Cells per Python via .NET.
keywords: Aspose.Cells per Python Excel, libreria Python Excel, Elimina il filtro PivotFilter nella tabella pivot utilizzando Aspose.Cells per Python Excel Library.
---

## **Possibili Scenari di Utilizzo**
Quando crei una tabella pivot con dati conosciuti e desideri filtrare la tabella pivot, devi imparare e utilizzare il filtro. Può aiutarti a filtrare i dati desiderati in modo efficace. Utilizzando l'API Aspose.Cells per Python via .NET, puoi operare il filtro sui valori dei campi nelle tabelle pivot. 
...
## **Come eliminare il filtro nella tabella pivot utilizzando Aspose.Cells per Python Excel Library**
Elimina filtro nella tabella pivot utilizzando Aspose.Cells per Python via .NET. Si prega di vedere il seguente codice di esempio. 
