...
type: docs
weight: 10
url: /it/python-net/how-to-manage-pivotchart-with-pivotoptions/
...
Usando Aspose.Cells per Python via .NET, puoi usare [**PivotOptions**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/pivotoptions) per gestire PivotChart.
