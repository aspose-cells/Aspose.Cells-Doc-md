...
description: Scopri i vari tipi di grafici supportati da Aspose.Cells per Python via .NET. La nostra guida ti guiderà attraverso i diversi tipi di grafici disponibili e ti mostrerà come crearli e modificarli per migliorare i tuoi fogli di lavoro.
keywords: Aspose.Cells per Python via .NET, creazione grafici, tipi di grafici, supportati, creazione, modifica, fogli di lavoro.
type: docs
weight: 5
url: /it/python-net/chart-types/
---

## **Introduzione**
Un grafico è una visualizzazione informativa. Aspose.Cells per Python via .NET permette agli sviluppatori di visualizzare le informazioni tramite grafici come fa Microsoft Excel. Presentare le informazioni sui grafici è sempre utile per i decisori per prendere decisioni rapide e tempestive. È più facile confrontare, individuare pattern e tendenze nei dati con i grafici rispetto ai numeri grezzi. Creare grafici a runtime, basandosi sui dati di un foglio di calcolo, è una delle caratteristiche più potenti di Aspose.Cells.

## **Tipi di Grafico**
Aspose.Cells per Python via .NET supporta quasi tutti i tipi di grafici supportati in Microsoft Excel. I grafici sono categorizzati in due categorie principali:
...
I seguenti grafici a colonne sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a barre sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a linee sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a torta sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a dispersione sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici ad area sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a ciambella sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a radar sono supportati in Aspose.Cells per Python via .NET:
...
#### **Grafico a imbuto**
Un grafico a imbuto mostra i valori attraverso varie fasi in un processo. Ad esempio, potresti utilizzare un grafico a imbuto per mostrare il numero di prospettive di vendita in ogni fase in un pipeline di vendita. Tipicamente, i valori diminuiscono gradualmente, consentendo alle barre di assomigliare a un imbuto.

Il grafico a imbuto è supportato in Aspose.Cells per Python via .NET.

#### **Grafici tridimensionali a superficie**
Come gli altri grafici tridimensionali, i grafici tridimensionali a superficie sono basati sugli assi X, Y e Z. Questi grafici sono utili per mostrare una variazione nella variabile "Z" in base alle altre due variabili, "X" e "Y".

I seguenti grafici di superficie 3D sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a bolle sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici azionari sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a cilindro sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a cono sono supportati in Aspose.Cells per Python via .NET:
...
I seguenti grafici a piramide sono supportati in Aspose.Cells per Python via .NET:
...
Il grafico a mappa ad alberi è supportato in Aspose.Cells per Python via .NET.
...
Il grafico a raggi di sole è supportato in Aspose.Cells per Python via .NET.
...
Il grafico a scatola e baffi è supportato in Aspose.Cells per Python via .NET.
...
Il grafico a cascata è supportato in Aspose.Cells per Python via .NET.
### **Tipi di grafico personalizzati**
I grafici personalizzati ti consentono di creare grafici con formattazione personalizzata che può essere applicata anche ad altri grafici. Qui abbiamo discusso solo i grafici standard. Se vuoi conoscere più dettagli sui grafici personalizzati, leggi l'articolo Creazione di grafici personalizzati che descrive come creare grafici personalizzati.
