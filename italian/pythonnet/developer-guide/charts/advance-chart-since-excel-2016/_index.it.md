...
description: Impara come leggere e manipolare grafici di Excel 2016 usando Aspose.Cells per Python via .NET. La nostra guida ti mostrerà come accedere e modificare varie proprietà del grafico, inclusi le etichette dei dati, i colori delle serie e il layout.
keywords: Aspose.Cells per Python via .NET, grafici di Excel 2016, leggere, manipolare, etichette dei dati, colori delle serie, layout, grafici gerarchici, grafici circolari.
type: docs
weight: 48
url: /it/python-net/read-and-manipulate-excel-2016-charts/
---

## **Possibili Scenari di Utilizzo**
Aspose.Cells per Python via .NET ora supporta la lettura e la manipolazione di grafici di Microsoft Excel 2016 che non sono presenti in Microsoft Excel 2013 o versioni precedenti.
