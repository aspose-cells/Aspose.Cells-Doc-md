...
description: Impara come comprendere e lavorare con gli assi primari e secondari in Aspose.Cells per Python via .NET. La nostra guida ti aiuterà a capire le differenze tra assi primari e secondari e come configurarli e usarli efficacemente nei tuoi grafici.
keywords: Aspose.Cells per Python via .NET, assi primari, assi secondari, comprensione, differenze, configurazione, utilizzo.
type: docs
weight: 190
url: /it/python-net/primary-and-second-axis/
---
