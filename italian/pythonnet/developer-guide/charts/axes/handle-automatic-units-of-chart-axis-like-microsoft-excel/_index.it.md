...
description: Scopri come gestire le unità automatiche sugli assi del grafico in Aspose.Cells per Python via .NET, simile a Microsoft Excel. La nostra guida ti mostrerà come configurare e personalizzare le unità automatiche su un asse del grafico, inclusa la visualizzazione della notazione scientifica e la regolazione della scala.
keywords: Aspose.Cells per Python via .NET, assi del grafico, unità automatiche, Microsoft Excel, configurazione, personalizzazione, notazione scientifica, scalatura.
type: docs
weight: 120
url: /it/python-net/handle-automatic-units-of-chart-axis-like-microsoft-excel/
---
