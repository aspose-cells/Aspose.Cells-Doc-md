...
Aggiungi un commento a una cella chiamando il metodo [**add**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection/add) della raccolta [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) (incapsulato nell'oggetto [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet)). Il nuovo oggetto [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) può essere accessibile dalla raccolta [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) passando l'indice del commento. Dopo aver accesso all'oggetto [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment), personalizza la nota del commento utilizzando la proprietà [**note**](https://reference.aspose.com/cells/python-net/aspose.cells/comment/note) dell'oggetto [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment).
...
## **Argomenti avanzati**
- [Cambia la Direzione del Testo del Commento](/cells/it/python-net/change-text-direction-of-the-comment/)
- [Come cambiare il Colore del Testo del Commento](/cells/it/python-net/how-to-change-the-comment-font-color/)
