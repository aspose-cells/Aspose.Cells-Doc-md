...
type: docs
weight: 20
url: /it/python-net/convert-an-excel-chart-to-image/
description: Converti un grafico Excel in un immagine utilizzando Aspose.Cells for Python via .NET API.
keywords: Converti un grafico Excel in un immagine Python, esporta un grafico Excel in un immagine in Python via NET, salva un grafico Excel in un immagine in Python.
---
...
Prima, creare un grafico a torta in Microsoft Excel e poi convertirlo in un file immagine con Aspose.Cells for Python via .NET. Il codice in questo esempio crea un'immagine EMF basata sul grafico a torta nel file modello Microsoft Excel.
...
Noi ospitiamo i nostri pacchetti Python nei repository PyPi.

Installare Aspose.Cells for Python da pypi, usare il comando: $ pip install aspose-cells-python.

E puoi anche seguire le istruzioni passo dopo passo su come installare “Aspose.Cells for Python via .NET” nell'ambiente di sviluppo.
1. Scarica e installa Aspose.Cells for Python via .NET:
   ...
   1. E puoi anche seguire le [istruzioni passo dopo passo](https://docs.aspose.com/cells/python-net/getting-started/) su come installare "Aspose.Cells for Python via .NET" nell'ambiente di sviluppo.
