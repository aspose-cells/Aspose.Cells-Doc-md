...
Per scoprire quale versione di Aspose.Cells stai utilizzando tramite API, utilizza il metodo statico GetVersion della classe CellsHelper per ottenere il numero di versione di Aspose.Cell.
