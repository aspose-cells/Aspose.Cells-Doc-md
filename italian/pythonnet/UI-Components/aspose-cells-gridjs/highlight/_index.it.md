...
type: docs
weight: 250
url: /it/python-net/aspose-cells-gridjs/highlight/
description: Questo articolo descrive come utilizzare GridJs per evidenziare il testo della cella, intervalli di celle, forme e immagini.
keywords: evidenziare, foglio elettronico, redazione, annotazioni, excel, commento	
---
...
- impostare se evidenziare tutti gli oggetti nel foglio di lavoro attivo, inclusi tutte le forme e le immagini e tutta l'area del foglio di lavoro
```javascript
...
Puoi trovare di più nella nostra pagina demo su github https://github.com/aspose-cells/Aspose.Cells.Grid-for-Python-via-.NET/blob/main/Examples.GridJs/templates/index.html
