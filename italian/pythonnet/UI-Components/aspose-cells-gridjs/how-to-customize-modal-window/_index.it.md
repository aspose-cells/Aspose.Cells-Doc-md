---
title: come personalizzare l aspetto dell UI per la finestra modale in GridJs  
type: docs
weight: 250
url: /it/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Questo articolo descrive come personalizzare l aspetto dell UI per la finestra modale in GridJs.
keywords: GridJs,personalizza,modale,UI,aspettato,visivo,finestra
aliases:
aliases:
...
- [Panoramica](#overview)
- [Nome delle classi CSS](#css-class-naming)
...
| SuggerimentoInserimento | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
...
| PiùFormatiNumero | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
...
Ottimo per applicazioni con supporto modalità scura.
...
### Esempio 4: Tema Colorato Giocoso 🌈
...
### Esempio 5: Tema Aziendale Professionale 💼
 ...
 Adatto per applicazioni aziendali e di impresa.
