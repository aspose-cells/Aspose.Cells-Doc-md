...
type: docs
weight: 250
url: /it/python-net/aspose-cells-gridjs/how-to-customize-menus/
...
## Personalizza gli elementi della barra dei menu 
...
## Personalizza effetto hover della barra degli strumenti

apri la finestra di ispezione del browser, seleziona il pulsante della barra degli strumenti,

![todo:schermata per selezionare il pulsante di ispezione della barra degli strumenti](gridjs_hover_toolbar_button_inspect.png)

quindi possiamo trovare la chiave CSS correlata a questo pulsante: freeze

![todo:schermata per trovare la chiave CSS del pulsante della barra degli strumenti](gridjs_hover_toolbar_button_csskey.png)
...
![todo:schermata per effetto hover del pulsante della barra degli strumenti](gridjs_hover_toolbar_button_hover.png)
...
3. Modifica il comportamento del pulsante
