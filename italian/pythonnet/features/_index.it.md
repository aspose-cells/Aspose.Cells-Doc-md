...
description: "Aspose.Cells for Python via .NET funzionalità."
---

{{% alert color="primary" %}} 

Questa pagina riassume Aspose.Cells for Python via .NET funzionalità.

{{% /alert %}} 
## **Formati di file e conversioni**
- XLS, SpreadsheetML (XLSX, XML),XLSB, XLSM, DOCX, PPTX, JSON, Valori Separati da Virgola (CSV), HTML, Foglio di calcolo OpenDocument (ODS), PDF, Delimitato da tabulazione, Testo normale (TXT) e formati di immagine popolari tra cui TIFF, JPG, PNG, BMP e SVG.
## **Rendering e stampa**
