---
title: Aspose.Cells per Python tramite .NET 22.8 Note di rilascio
type: docs
weight: 9
url: /it/python-net/aspose-cells-for-python-net-22-8-release-notes/
---
{{% alert color="primary" %}} 

Questa è la prima versione per Aspose.Cells per Python tramite .NET.
Questa pagina contiene le note di rilascio per Aspose.Cells per Python tramite .NET 22.8.
...
|CELLSNET-51595|Allineamento verticale errato del testo della cella durante la conversione in PDF da file Excel con tabella pivot|
|CELLSNET-51621|Le formule condivise sono state copiate in modo errato per diversi formati di file|
|CELLSNET-51524|A capo automatico errato durante la conversione in PDF da file Excel con tabella pivot|
|CELLSNET-51675|La forma viene persa durante la conversione in pdf|
|CELLSNET-51435|Quando si converte una cartella di lavoro XLSB in XLSM, vengono aggiunte nuove relazioni tra i fogli di lavoro|
...
|CELLSNET-51558|La conversione di file XLS con collegamento di tipo xlAlternateStartup in XLSM produce file danneggiati|
...
|CELLSNET-51627|Impossibile caricare un file XLSM specifico|
...
|CELLSNET-51559|Conversione di un file XLSB in XLSM che lancia l'eccezione "startIndex non può essere maggiore della lunghezza della stringa"|
