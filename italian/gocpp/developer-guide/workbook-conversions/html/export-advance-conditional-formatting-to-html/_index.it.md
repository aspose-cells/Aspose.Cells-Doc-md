---
title: Esporta formattazione condizionale DataBar, ColorScale e IconSet durante la conversione da Excel a HTML con Golang via C++
linktitle: Esporta formattazione condizionale in HTML
type: docs
weight: 30
url: /it/go-cpp/export-databar-colorscale-and-iconset-conditional-formatting-while-excel-to-html-conversion/
