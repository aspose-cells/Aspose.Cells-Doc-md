...
type: docs
weight: 20
url: /it/go-cpp/copying-rows-and-columns/
---
...
Aspose.Cells fornisce il metodo CopyColumn della classe ICells, che copia tutti i tipi di dati, comprese le formule - con riferimenti aggiornati - e i valori, commenti, formati delle celle, celle nascoste, immagini e altri oggetti di disegno dalla colonna di origine a quella di destinazione.
