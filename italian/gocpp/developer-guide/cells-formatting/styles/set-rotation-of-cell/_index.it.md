---
title: Come ruotare il testo di una cella con Golang tramite C++
linktitle: Come ruotare il testo della cella
type: docs
weight: 80
url: /it/go-cpp/how-to-rotate-text-of-cell/
...
La proprietà [**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/) rende comodo ruotare le celle. Per ruotare le celle in Aspose.Cells, è necessario seguire questi passaggi:
