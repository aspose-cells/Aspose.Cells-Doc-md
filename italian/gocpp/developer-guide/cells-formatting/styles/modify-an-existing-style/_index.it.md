---
title: Modifica uno stile esistente con Golang tramite C++
...
type: docs
weight: 90
url: /it/go-cpp/modify-an-existing-style/
---
...
Gli esempi seguenti dimostrano come utilizzare il metodo [**Style.Update**](https://reference.aspose.com/cells/go-cpp/style/update/).

### **Creazione e modifica di uno stile**

Questo esempio crea un oggetto [**Style**](https://reference.aspose.com/cells/go-cpp/style/), lo applica a un'intervallo di celle e modifica l'oggetto [**Style**](https://reference.aspose.com/cells/go-cpp/style/). Le modifiche vengono applicate automaticamente alle celle e all'intervallo a cui lo stile è stato applicato.
