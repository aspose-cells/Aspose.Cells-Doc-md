---
title: Imposta formattazioni condizionali di file Excel e ODS con Golang via C++
linktitle: Formati Condizionali
type: docs
weight: 60
url: /it/go-cpp/conditional-formatting/
...
Aspose.Cells consente ai programmatori di copiare le impostazioni della formattazione condizionale da una cella a un'altra nel foglio di lavoro chiamando il metodo [**Range.Copy()**](https://reference.aspose.com/cells/go-cpp/range/copy_range_pasteoptions/).
