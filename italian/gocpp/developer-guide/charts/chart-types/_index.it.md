---
title: Tipi di grafici con Golang tramite C++
linktitle: Tipi di Grafico
description: Scopri i vari tipi di grafici supportati da Aspose.Cells for C++. La nostra guida ti guiderà attraverso i diversi tipi di grafici disponibili e ti mostrerà come crearli e modificarli per migliorare i tuoi fogli di lavoro.
keywords: Aspose.Cells for C++, grafici, tipi di grafico, supportati, creazione, modifica, fogli di lavoro.
type: docs
weight: 5
url: /it/go-cpp/chart-types/
---

## **Introduzione**
Un grafico è una visualizzazione delle informazioni. Aspose.Cells permette agli sviluppatori di visualizzare le informazioni nei grafici proprio come fa Microsoft Excel. Presentare le informazioni tramite grafici è sempre utile ai decisori per prendere decisioni rapide e tempestive. È più facile vedere rapidamente confronti, modelli e tendenze nei dati con i grafici rispetto ai numeri grezzi. Creare grafici in fase di esecuzione, basati sui dati di un foglio di calcolo, è una delle funzionalità più potenti di Aspose.Cells.
...
I marcatori di dati vengono usati per rappresentare i punti dati, i valori individuali tracciati in un grafico. I marcatori di dati dello stesso colore costituiscono una serie di dati.
...
Il grafico a imbuto è supportato in Aspose.Cells.
