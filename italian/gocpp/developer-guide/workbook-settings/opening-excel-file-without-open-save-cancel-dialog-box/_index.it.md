---
title: Aprire un file Excel senza la finestra di dialogo Salva Annulla con Golang via C++
linktitle: Apertura file Excel senza finestra di dialogo Apri Salva Annulla
type: docs
weight: 150
url: /it/go-cpp/opening-excel-file-without-open-save-cancel-dialog-box/
