---
title: Specificare l avviso di ordinamento durante l ordinamento dei dati con Golang tramite C++
linktitle: Specificare avviso di ordinamento durante l ordinamento dei dati
type: docs
weight: 140
url: /it/go-cpp/specifying-sort-warning-while-sorting-data/
...
Il seguente codice di esempio illustra l'uso della proprietà [**DataSorter.GetSortAsNumber()**](https://reference.aspose.com/cells/go-cpp/datasorter/getsortasnumber/) come spiegato in precedenza. Si prega di controllare il [file di esempio Excel](43352075.xlsx) e l' [output Excel file](43352076.xlsx) per ulteriori informazioni.
