---
title: Come bloccare le celle per proteggerle con Golang tramite C++
linktitle: Come Bloccare le Celle per Proteggerle
type: docs
weight: 130
url: /it/go-cpp/how-to-lock-cells-to-protect-them/
description: Questo articolo mostra il codice che spiega come bloccare le celle per proteggerle usando la libreria Aspose.Cells con Golang tramite C++.
