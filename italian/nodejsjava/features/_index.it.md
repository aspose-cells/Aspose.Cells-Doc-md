...
type: docs
weight: 5
url: /it/nodejs-java/features/
keywords: nodejs, excel, api, feature
description: Aspose.Cells per Node.js tramite le funzionalità Java
---
## **Aspose.Cells per Node.js tramite Java Panoramica delle funzionalità**
Questa sezione fornisce un confronto della disponibilità delle funzionalità tra Aspose.Cells for Java e Aspose.Cells per Node.js tramite Java.
...
|**Caratteristica**|**Descrizione**|**Aspose.Cells for Java**|**Aspose.Cells per Node.js tramite Java**|
|:- |:- |:- |:- |
...
|**Caratteristica**|**Aspose.Cells for Java**|**Aspose.Cells per Node.js tramite Java**|
|:- |:- |:- |
...
|Stampa pagine di fogli di calcolo utilizzando l'infrastruttura di stampa Java.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|**Caratteristica**|**Aspose.Cells for Java**|**Aspose.Cells per Node.js tramite Java**|
|:- |:- |:- |
|Importa/esporta dati da Array, ArrayList, ResultSet ecc.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Unisci/dividi Cells|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Supporta la formattazione condizionale avanzata supportata in Microsoft Excel 2007 e versioni successive|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Implementa gli sparkline|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Applica le impostazioni di formato su un foglio di lavoro, una riga, una colonna o un intervallo di celle, ecc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
