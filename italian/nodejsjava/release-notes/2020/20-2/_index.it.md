---
title: Aspose.Cells for Node.js via Java 20.2 Note di rilascio
type: docs
weight: 10
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-20-2-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells for Node.js via Java 20.2.
