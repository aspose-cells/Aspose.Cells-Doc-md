---
title: Aspose.Cells per Node.js tramite Java 22.10 Note di rilascio
type: docs
weight: 3
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-22-10-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per Node.js via Java 22.10](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.10/).
