---
title: Aspose.Cells for Node.js via Java 22.2 Note di rilascio
type: docs
weight: 11
...
{{% alert color="primary" %}}
 ...
 Questa pagina contiene le note di rilascio per[Aspose.Cells for Node.js via Java 22.2](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.2/).
