---
title: Aspose.Cells per Node.js tramite Java 22.7 Note di rilascio
type: docs
weight: 6
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-22-7-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per Node.js tramite Java 22.7](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.7/).
