---
title: Aspose.Cells per Node.js tramite Java 21.7 Note di rilascio
type: docs
weight: 6
...
{{% alert color="primary" %}}
 ...
 Questa pagina contiene le note di rilascio per[Aspose.Cells per Node.js tramite Java 21.7](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.7/).
