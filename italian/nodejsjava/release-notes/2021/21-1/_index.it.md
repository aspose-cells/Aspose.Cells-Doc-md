---
title: Aspose.Cells per Node.js tramite Java 21.1 Note di rilascio
type: docs
weight: 12
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-21-1-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells per Node.js tramite Java 21.1.
