---
title: Aspose.Cells per Node.js tramite Java 21.11 Note di rilascio
type: docs
weight: 2
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-21-11-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per Node.js tramite Java 21.11](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.11/).
