---
title: Aspose.Cells for Node.js via Java 23.4 Note di rilascio
type: docs
weight: 9
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-23-4-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Node.js via Java 23.4](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.4/).
