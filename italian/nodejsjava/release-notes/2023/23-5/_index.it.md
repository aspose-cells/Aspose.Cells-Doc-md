---
title: Aspose.Cells for Node.js via Java 23.5 Note di rilascio
type: docs
weight: 8
url: /it/nodejs-java/aspose-cells-for-node-js-via-java-23-5-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Node.js via Java 23.5](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.5/).
