...
Aspose.Cells rende semplice il caricamento dei dati da un file DBF in un oggetto Workbook. La libreria utilizza la classe `LoadOptions` per specificare il formato di origine, assicurando che i dati vengano interpretati correttamente durante il processo di caricamento.
...
### Tipi di cella e tipi di campo DBF
