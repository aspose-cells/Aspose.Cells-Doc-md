---
title: Aspose.Cells per PHP tramite Java 22.5 Note di rilascio
type: docs
weight: 8
...
{{% alert color="primary" %}}
 ...
 Questa pagina contiene le note di rilascio per[Aspose.Cells per PHP tramite Java 22.5](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.5/).
