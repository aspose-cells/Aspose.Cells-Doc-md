---
title: Aspose.Cells per PHP tramite Java 22.10 Note di rilascio
type: docs
weight: 3
url: /it/php-java/aspose-cells-for-php-via-java-22-10-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per PHP tramite Java 22.10](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.10/).
