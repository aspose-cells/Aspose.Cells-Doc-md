---
title: Aspose.Cells per PHP tramite Java 21.2 Note di rilascio
type: docs
weight: 10
url: /it/php-java/aspose-cells-for-php-via-java-21-2-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells per PHP tramite Java 21.2.
