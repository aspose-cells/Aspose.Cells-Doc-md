---
title: Aspose.Cells per PHP tramite Java 21.12 Note di rilascio
type: docs
weight: 1
url: /it/php-java/aspose-cells-for-php-via-java-21-12-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per PHP tramite Java 21.12](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-21.12/).
