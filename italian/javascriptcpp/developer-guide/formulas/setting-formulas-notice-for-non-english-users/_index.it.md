---
title: Impostare formule  Avviso per utenti non anglofoni con JavaScript tramite C++
linktitle: Impostazione Formule  Avviso per gli Utenti Non Anglofoni
type: docs
weight: 10
url: /it/javascript-cpp/setting-formulas-notice-for-non-english-users/
---  

{{% alert color="primary" %}} 

Aspose.Cells supporta la maggior parte delle formule/funzioni che fanno parte di Microsoft Excel. Gli sviluppatori possono usare queste formule con l'API o [designer di fogli di calcolo](/cells/it/javascript-cpp/what-is-a-designer-spreadsheet/). Aspose.Cells supporta un ampio set di formule matematiche, stringa, booleane, data/orario, statistiche, database, ricerca e riferimenti. Le formule devono essere specificate in stile inglese (USA).
