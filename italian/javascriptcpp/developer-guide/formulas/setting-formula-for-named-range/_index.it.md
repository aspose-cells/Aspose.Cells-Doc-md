---
title: Impostare la formula per un intervallo nominato con JavaScript tramite C++
linktitle: Impostazione della formula per Intervallo con Nome
type: docs
weight: 20
url: /it/javascript-cpp/setting-formula-for-named-range/
description: Impara come impostare le formule per intervalli nominati nei fogli di calcolo usando Aspose.Cells for JavaScript tramite C++.
---

## **Impostazione della formula per il intervallo nominato**
Come l'applicazione Excel, le API di Aspose.Cells consentono di specificare una formula per un intervallo nominato utilizzando la proprietà [Range.refersTo](https://reference.aspose.com/cells/javascript-cpp/range/#refersTo--). Ci sono numerosi scenari di usabilità per questa funzione, alcuni dei quali sono descritti di seguito.
