---
title: Come aggiungere/inserire una casella di testo nel foglio di lavoro con JavaScript tramite C++
linktitle: Aggiungi una casella di testo al foglio di lavoro
type: docs
weight: 10
url: /it/javascript-cpp/add-text-box-to-worksheet-in-aspose-cells/
description: Come aggiungere/inserire una casella di testo nel foglio di lavoro in Aspose.Cells for JavaScript tramite C++.
keywords: aggiungi/inserisci testo nella casella di testo della Casella di testo nel foglio di lavoro Excel Aspose JavaScript tramite C++
---
