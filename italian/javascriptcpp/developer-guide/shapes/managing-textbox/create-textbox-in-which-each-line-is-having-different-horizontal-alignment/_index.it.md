---
title: Crea una casella di testo in cui ogni riga ha un allineamento orizzontale diverso con JavaScript tramite C++
linktitle: Crea TextBox in cui ogni riga ha un diverso Allineamento Orizzontale
type: docs
weight: 310
url: /it/javascript-cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Impara come creare una casella di testo in cui ogni riga può avere un allineamento orizzontale diverso usando Aspose.Cells for JavaScript via C++.
---

{{% alert color="primary" %}}
È possibile impostare l'allineamento orizzontale del testo del paragrafo utilizzando la proprietà [**TextParagraph.alignmentType**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#alignmentType--).
{{% /alert %}}
