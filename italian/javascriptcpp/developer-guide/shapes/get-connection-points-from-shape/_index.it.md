---
title: Ottenere punti di connessione dalla forma con JavaScript tramite C++
linktitle: Ottenere i punti di connessione da una Forma
type: docs
weight: 3500
url: /it/javascript-cpp/get-connection-points-from-shape/
description: Impara come recuperare i punti di connessione dalle forme in Excel usando Aspose.Cells for JavaScript tramite C++.
---

Aspose.Cells offre funzionalità ricche per gestire le forme nel foglio di calcolo. A volte è necessario ottenere i punti di connessione di una forma per allineare o posizionare le forme nel punto appropriato. Per questo scopo, sono necessari tutti i punti di connessione. Il seguente codice può essere usato per ottenere la lista dei punti di connessione di una forma usando la proprietà [**Shape.connectionPoints**](https://reference.aspose.com/cells/javascript-cpp/shape/#connectionPoints--).
