---
title: Inserire un file WAV come Oggetto OLE con JavaScript tramite C++
linktitle: Inserimento di un file WAV come Oggetto OLE
type: docs
weight: 70
url: /it/javascript-cpp/inserting-a-wav-file-as-an-ole-object/
description: Impara come inserire un file WAV come oggetto OLE nei fogli di lavoro Excel utilizzando Aspose.Cells for JavaScript tramite C++. 
---
