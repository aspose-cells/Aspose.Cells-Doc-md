---
title: Dati in forma non primitiva con JavaScript tramite C++
linktitle: Dati in Forma Non Primitiva
type: docs
weight: 300
url: /it/javascript-cpp/data-in-non-primitive-shape/
description: Impara come accedere e manipolare le forme non primitive in Aspose.Cells for JavaScript tramite C++.
---
...
In Aspose.Cells for JavaScript tramite C++, le forme non primitive vengono assegnate al tipo [**AutoShapeType.NotPrimitive**](https://reference.aspose.com/cells/javascript-cpp/autoshapetype/). Puoi verificare il loro tipo usando la proprietà [**Shape.autoShapeType**](https://reference.aspose.com/cells/javascript-cpp/shape/#autoShapeType--).  

Accedi ai dati della forma usando la proprietà [**Shape.paths**](https://reference.aspose.com/cells/javascript-cpp/shape/#paths--). Ritorna tutti i percorsi collegati che compongono la forma non primitiva. Questi percorsi sono di tipo [**ShapePath**](https://reference.aspose.com/cells/javascript-cpp/shapepath) che contiene un elenco di tutti i segmenti che a loro volta contengono i punti in ciascun segmento.  
