---
title: Carica il Workbook con informazioni specifiche sulla cultura del sistema via JavaScript e C++
linktitle: Carica il Workbook con informazioni specifiche sulle impostazioni regionali del sistema
type: docs
weight: 190
url: /it/javascript-cpp/load-the-workbook-with-specific-system-culture-info/
---

## **Possibili Scenari di Utilizzo**
In passato, dovevi modificare le impostazioni di cultura dell'intero thread per gestire numeri e date in un formato culturale specifico, ma ora Aspose.Cells for JavaScript tramite C++ fornisce la proprietà `LoadOptions.CultureInfo` che puoi usare per caricare il tuo workbook con informazioni sulla cultura specifica senza modificare l'intera cultura del thread.
