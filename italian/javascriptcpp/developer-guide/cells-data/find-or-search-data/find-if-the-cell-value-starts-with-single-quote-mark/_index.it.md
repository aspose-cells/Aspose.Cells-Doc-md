...
type: docs
weight: 270
url: /it/javascript-cpp/find-if-the-cell-value-starts-with-single-quote-mark/
description: Scopri come verificare se il valore della cella inizia con un apostrofo singolo tramite l API Aspose.Cells for JavaScript via C++.
keywords: Trova il valore della cella che inizia con un apostrofo singolo JavaScript tramite C++, ricerca il valore della cella che inizia con un apostrofo singolo JavaScript tramite C++
---

{{% alert color="primary" %}}

Aspose.Cells ora fornisce la proprietà [**Style.quotePrefix**](https://reference.aspose.com/cells/javascript-cpp/style/#quotePrefix-boolean-) per trovare se il valore della cella inizia con un singolo segno di citazione. Prima di questa proprietà, non c'era modo di distinguere tra stringhe come campione e 'campione ecc.

{{% /alert %}}

Il seguente esempio di codice spiega che le stringhe come 'sample' e 'sample' non possono essere differenziate con la proprietà [**Cell.stringValue**](https://reference.aspose.com/cells/javascript-cpp/cell/#stringValue--). Pertanto, dobbiamo usare la proprietà [**Style.quotePrefix**](https://reference.aspose.com/cells/javascript-cpp/style/#quotePrefix-boolean-) per distinguerle.
