...
type: docs
weight: 30
url: /it/javascript-cpp/r1c1-reference-style-vs-a1/
description: Stile di riferimento R1C1 vs stile A1 usando Aspose.Cells for JavaScript in C++.
keywords: Stile di riferimento R1C1 vs stile A1 JavaScript in C++, Stile di riferimento R1C1 JavaScript in C++, Come passare tra stile di riferimento R1C1 e stile di riferimento A1 JavaScript in C++, stile di riferimento A1 JavaScript in C++.
---
