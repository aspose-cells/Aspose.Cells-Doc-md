...
type: docs
weight: 600
url: /it/javascript-cpp/get-cells-range/
description: Scopri come ottenere l intervallo di celle tramite l API Aspose.Cells for JavaScript attraverso C++.
...
Quando hai bisogno solo di manipolare alcuni dati nel foglio di lavoro, devi conoscere l'intervallo di dati dell'intero foglio. Aspose.Cells for JavaScript attraverso C++ offre questa funzione. Aspose.Cells for JavaScript tramite C++ fornisce le seguenti proprietà e metodi per aiutarti a raggiungere i tuoi obiettivi.
...
## **Ottieni l'intervallo di celle usando Aspose.Cells for JavaScript attraverso C++**
Questo esempio mostra come:

1. Crea un libro di lavoro.
1. Aggiungi dati alle celle nel primo foglio di lavoro.
1. Ottieni celle [**Range**](https://reference.aspose.com/cells/javascript-cpp/range).
