...
type: docs
weight: 140
url: /it/javascript-cpp/specifying-sort-warning-while-sorting-data/
description: Impara come specificare l avviso di ordinamento durante l ordinamento dei dati usando lo script Aspose.Cells for Java tramite API C++.
...
Il seguente codice di esempio illustra l'uso della proprietà [**DataSorter.sortAsNumber**](https://reference.aspose.com/cells/javascript-cpp/datasorter/#sortAsNumber-boolean-) come spiegato in precedenza. Si prega di controllare il [file di esempio Excel](43352075.xlsx) e l' [output Excel file](43352076.xlsx) per ulteriori informazioni.
