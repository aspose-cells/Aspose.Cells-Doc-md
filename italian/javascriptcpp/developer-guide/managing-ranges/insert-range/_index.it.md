---
title: Inserisci intervalli con JavaScript tramite C++
linktitle: Inserisci intervalli
type: docs
weight: 105
url: /it/javascript-cpp/insert-ranges-to-excel/
description: Impara come inserire intervalli in Excel e spostare altri dati usando Aspose.Cells for JavaScript tramite C++.
---
...
## **Inserisci intervalli usando Aspose.Cells for JavaScript tramite C++**

Aspose.Cells for JavaScript tramite C++ fornisce il metodo [Cells.insertRange(CellArea, numero, ShiftType, boolean)](https://reference.aspose.com/cells/javascript-cpp/cells/#insertRange-cellarea-number-shifttype-boolean-) per inserire un intervallo.
