---
title: Formatta e modifica intervalli denominati con JavaScript tramite C++
linktitle: Formattare e modificare intervalli con nome
type: docs
weight: 85
url: /it/javascript-cpp/format-and-modify-named-ranges/
description: Impara come formattare e modificare intervalli denominati usando Aspose.Cells for JavaScript tramite C++. 
---
...
Per applicare la formattazione, definisci un oggetto [**Style**](https://reference.aspose.com/cells/javascript-cpp/style) per specificare le impostazioni di stile e applicalo all'oggetto [**Range**](https://reference.aspose.com/cells/javascript-cpp/range).
...
È possibile aggiungere bordi a un intervallo di celle invece di una singola cella. L'oggetto [**Range**](https://reference.aspose.com/cells/javascript-cpp/range) offre un metodo [**outlineBorder(BorderType, CellBorderType, CellsColor)**](https://reference.aspose.com/cells/javascript-cpp/range/#outlineBorder-bordertype-cellbordertype-cellscolor-) che accetta i seguenti parametri per aggiungere un bordo all'intervallo di celle:

- Tipo di bordo, il tipo di bordo, selezionato dall'enumerazione [**BorderType**](https://reference.aspose.com/cells/javascript-cpp/bordertype).
- Stile linea, lo stile della linea, selezionato dall'enumerazione [**CellBorderType**](https://reference.aspose.com/cells/javascript-cpp/cellbordertype).
...
Aspose.Cells consente di rinominare un intervallo denominato secondo le proprie esigenze. Puoi ottenere l'intervallo denominato e rinominarlo utilizzando l'attributo [**Name.text**](https://reference.aspose.com/cells/javascript-cpp/name/#text--). Il seguente esempio mostra come rinominare un intervallo denominato.
...
Aspose.Cells fornisce il metodo [**Range.unionRang(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#unionRang-range-) per unire intervalli; il metodo restituisce un oggetto [*Array*]. Il seguente esempio mostra come unire intervalli.
...
Aspose.Cells fornisce il metodo [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-) per l'intersezione di due intervalli. Il metodo restituisce un oggetto [**Range**](https://reference.aspose.com/cells/javascript-cpp/range). Per verificare se un intervallo interseca un altro, usa il metodo [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-) che restituisce un valore Booleano. Il seguente esempio mostra come intersectare gli intervalli.
...
Aspose.Cells fornisce il metodo [**Range.merge()**](https://reference.aspose.com/cells/javascript-cpp/range/#merge--) per unire le celle nell'intervallo. Il seguente esempio mostra come unire le singole celle di un intervallo denominato.
