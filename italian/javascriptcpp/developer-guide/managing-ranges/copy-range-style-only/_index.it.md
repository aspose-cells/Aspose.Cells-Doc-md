---
title: Copia solo lo stile dell intervallo con JavaScript via C++
linktitle: Copia solo lo stile dell intervallo
type: docs
weight: 620
url: /it/javascript-cpp/copy-range-style-only/
description: Impara come copiare solo lo stile di un intervallo mentre manipoli i dati in Aspose.Cells for JavaScript via C++. 
---

{{% alert color="primary" %}}

[Copia solo i dati dell'intervallo](/cells/it/javascript-cpp/copy-range-data-only/) e [Copia i dati dell'intervallo con stile](/cells/it/javascript-cpp/copy-range-data-with-style/) spiegano come copiare i dati da un intervallo a un altro da solo o completo di formattazione. È anche possibile copiare solo la formattazione. Questo articolo mostra come.
