...
type: docs
weight: 10
url: /it/javascript-cpp/changing-the-layout-of-pivot-table/
description: Come modificare il layout della tabella pivot con Aspose.Cells for JavaScript via C++.
keywords: Aspose.Cells for JavaScript tramite C++ Excel, libreria Excel JavaScript, modifica del layout della tabella pivot usando Aspose.Cells for JavaScript via C++ Excel.
---
...
## **Come modificare il layout della tabella pivot usando Aspose.Cells for JavaScript via C++**
La libreria Aspose.Cells for JavaScript via C++ fornisce anche i metodi [**PivotTable.showInCompactForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInCompactForm--), [**PivotTable.showInOutlineForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInOutlineForm--) e [**PivotTable.showInTabularForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInTabularForm--) per cambiare il layout della tabella pivot in queste tre forme.
