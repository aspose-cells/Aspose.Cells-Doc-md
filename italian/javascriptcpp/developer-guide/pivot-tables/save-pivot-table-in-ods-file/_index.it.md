...
type: docs
weight: 150
url: /it/javascript-cpp/save-pivot-table-in-ods-file/
---

Aspose.Cells for JavaScript tramite C++ offre la possibilità di salvare la tabella pivot in file ODS. Per fare questo, basta convertire un workbook con tabella pivot esistente o crearne una nuova e salvare il file in formato ODS. Assicurati di chiamare [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) prima di salvare per garantire che la tabella pivot venga renderizzata nel file ODS di output. Il seguente esempio di codice dimostra come salvare la tabella pivot in un file ODS.
