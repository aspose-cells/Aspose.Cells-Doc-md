---
title: Verifica se il Workbook contiene collegamenti esterni nascosti con JavaScript tramite C++
linktitle: Controllare se il foglio di lavoro contiene collegamenti esterni nascosti
type: docs
weight: 230
url: /it/javascript-cpp/check-if-workbook-contains-hidden-external-links/
description: Impara come verificare se un workbook contiene collegamenti esterni nascosti usando Aspose.Cells for JavaScript tramite C++.
---
...
Il seguente esempio di codice carica il [file excel di origine](5115413.xlsx) che contiene collegamenti esterni nascosti. Questi collegamenti non sono visibili in Microsoft Excel ma sono presenti all’interno del workbook. Dopo aver stampato le proprietà [ExternalLink.dataSource](https://reference.aspose.com/cells/javascript-cpp/externallink/#dataSource--) e [ExternalLink.isReferred()](https://reference.aspose.com/cells/javascript-cpp/externallink/#isReferred--), viene stampata la proprietà [ExternalLink.isVisible()](https://reference.aspose.com/cells/javascript-cpp/externallink/#isVisible--). Nell'output della console di seguito, puoi vedere che tutti i collegamenti esterni non sono visibili.
