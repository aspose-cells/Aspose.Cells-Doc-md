---
title: Rilevare celle unite in un foglio di lavoro con JavaScript via C++
linktitle: Rilevare celle unite in un foglio di lavoro
description: Scopri come rilevare celle unite in un foglio di lavoro usando Aspose.Cells for JavaScript via C++. Questo articolo ti mostrerà come usare la libreria per identificare e manipolare le celle unite.
keywords: Aspose.Cells, Foglio di lavoro, Celle unite, Rilevare, Identificare, Operare JavaScript via C++
type: docs
weight: 80
url: /it/javascript-cpp/detect-merged-cells-in-a-worksheet/
---
...
Aspose.Cells for JavaScript via C++ ti consente di ottenere le aree di celle unite in un foglio di lavoro. Puoi anche disattivare l'unione (dividerle). Questo articolo mostra il codice più semplice usando **Aspose.Cells API** per eseguire questa operazione.

{{% /alert %}}

Il componente fornisce il metodo [**Cells.mergedAreas**](https://reference.aspose.com/cells/javascript-cpp/cells/#mergedAreas--) che può ottenere tutte le celle unificate. Il seguente esempio di codice mostra come rilevare celle unificate in un foglio di lavoro.
