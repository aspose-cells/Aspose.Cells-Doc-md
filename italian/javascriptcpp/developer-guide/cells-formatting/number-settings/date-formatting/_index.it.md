...
type: docs
weight: 10
url: /it/javascript-cpp/format-number-to-date/
description: Questo articolo introdurrà come formattare un numero in data usando Aspose.Cells for JavaScript via C++ API.
...
Per formattare i numeri come data nella libreria Aspose.Cells for JavaScript via C++ per lavorare con file Excel, puoi applicare la formattazione data alle celle in modo programmato. Ecco come farlo usando Aspose.Cells for JavaScript via C++:
