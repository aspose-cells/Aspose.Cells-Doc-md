---
title: Verifica se la Firma Digitale del Codice VBA è valida con JavaScript tramite C++
linktitle: Verifica se la Firma Digitale del Codice VBA è Valida
type: docs
weight: 120
url: /it/javascript-cpp/check-if-digital-signature-of-vba-code-is-valid/
description: Impara come verificare la validità di una firma digitale del codice VBA usando Aspose.Cells for JavaScript tramite C++.
--- 
...
## **Verifica se la Firma Digitale del Codice VBA è valida in JavaScript**
