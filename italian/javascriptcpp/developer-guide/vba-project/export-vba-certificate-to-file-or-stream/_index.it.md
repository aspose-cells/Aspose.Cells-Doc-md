---
title: Esporta il certificato VBA su file o stream con JavaScript via C++
linktitle: Esporta il certificato VBA su File o Stream
type: docs
weight: 90
url: /it/javascript-cpp/export-vba-certificate-to-file-or-stream/
description: Impara come esportare il certificato digitale VBA su un file o stream usando Aspose.Cells for JavaScript via C++. Accedi ai dati raw dei certificati digitali VBA.
---

{{% alert color="primary" %}}

Aspose.Cells ti consente di esportare il certificato digitale VBA su un flusso come file o memory stream. Puoi accedere ai dati grezzi del certificato digitale VBA utilizzando la proprietà [**VbaProject.certRawData**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#certRawData--).

{{% /alert %}}

## ** Esporta il certificato VBA su file o stream in JavaScript**
