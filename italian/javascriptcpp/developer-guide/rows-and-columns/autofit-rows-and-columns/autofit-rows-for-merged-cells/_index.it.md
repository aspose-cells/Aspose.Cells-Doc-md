---
title: Adattare automaticamente le righe per celle unite con JavaScript tramite C++
linktitle: Adattare automaticamente le righe per le celle unite
type: docs
weight: 120
url: /it/javascript-cpp/autofit-rows-for-merged-cells/
description: Impara come adattare automaticamente le righe per celle unite usando Aspose.Cells for JavaScript via C++. Implementa la funzionalità di adattamento automatico per celle unite nei fogli di calcolo.
---
...
Aspose.Cells for JavaScript tramite C++ supporta questa funzione tramite l'API [**AutoFitterOptions.autoFitMergedCellsType**](https://reference.aspose.com/cells/javascript-cpp/autofitmergedcellstype/). Utilizzando questa API, è possibile adattare automaticamente le righe in un foglio di lavoro, comprese le celle unite. Ecco un elenco di tutti i tipi possibili di adattamento automatico delle celle unite:
