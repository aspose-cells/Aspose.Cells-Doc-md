---
title: Aprire un file Excel senza la finestra di dialogo di Open Save Cancel usando JavaScript tramite C++
linktitle: Apertura file Excel senza finestra di dialogo Apri Salva Annulla
type: docs
weight: 150
url: /it/javascript-cpp/opening-excel-file-without-open-save-cancel-dialog-box/
--- 
