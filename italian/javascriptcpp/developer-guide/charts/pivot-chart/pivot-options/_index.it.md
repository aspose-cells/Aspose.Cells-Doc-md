---
title: Come gestire PivotChart con PivotOptions per JavaScript via C++
linktitle: Opzioni Pivot
type: docs
weight: 10
url: /it/javascript-cpp/how-to-manage-pivotchart-with-pivotoptions/
description: Come gestire PivotChart con PivotOptions in JavaScript via C++.
...
Utilizzando Aspose.Cells for JavaScript via C++, puoi usare [**PivotOptions**](https://reference.aspose.com/cells/javascript-cpp/pivotoptions/) per gestire PivotChart.
