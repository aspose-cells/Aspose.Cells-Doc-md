---
title: Come aggiungere un PivotChart usando Aspose.Cells for JavaScript tramite C++
linktitle: Grafico pivot
type: docs
weight: 100
url: /it/javascript-cpp/how-to-add-pivot-chart/
description: Come aggiungere un PivotChart usando Aspose.Cells for JavaScript tramite C++.
keywords: PivotChart JavaScript tramite C++
---
...
## Come aggiungere un PivotChart usando Aspose.Cells for JavaScript tramite C++

### **Aggiunta di una tabella pivot**

 Per creare una tabella pivot usando Aspose.Cells for JavaScript tramite C++:
...
### **Aggiunta di un grafico pivot**
 ...
 Per creare un PivotChart usando Aspose.Cells for JavaScript tramite C++:
