---
title: Convertire il grafico in immagine per la regione cinese con JavaScript tramite C++
description: Impara come usare Aspose.Cells for JavaScript tramite C++ per configurare grafici per caratteri e formati cinesi, inclusi font, dimensioni, direzioni del testo e altro.
keywords: Aspose.Cells for JavaScript tramite C++, grafici, configurazione cinese, font, dimensione font, direzione del testo, supporto.
linktitle: Imposta la regione cinese
type: docs
weight: 9
url: /it/javascript-cpp/convert-chart-to-image-for-chinese-region/
...
## **Definisce una classe di ereditarietà**  
 ...
 Primo passo, devi definire una classe "ChartChineseSetttings" che eredita da [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
