---
title: Converti un grafico in immagine localizzata con JavaScript tramite C++
description: Impara come impostare le configurazioni di globalizzazione per i grafici usando Script via C++. La nostra guida dimostra come configurare il grafico per supportare più lingue e formati regionali per visualizzare correttamente testo, date e numeri in diverse lingue.
keywords: Script via C++, grafici, impostazioni di globalizzazione, più lingue, formati regionali, visualizzazione, testo, date, numeri.
linktitle: Imposta la regione localizzata
type: docs
weight: 50
url: /it/javascript-cpp/convert-chart-to-localized-image/
...
- [Come Impostare la Regione Cinese per il Grafico](/cells/it/javascript-cpp/convert-chart-to-image-for-chinese-region/)
- [Come Impostare la Regione Giapponese per il Grafico](/cells/it/javascript-cpp/convert-chart-to-image-for-japanese-region/)
