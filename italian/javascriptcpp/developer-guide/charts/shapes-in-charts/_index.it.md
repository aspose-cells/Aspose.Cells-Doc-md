---
title: Forme nei Grafici con JavaScript tramite C++
linktitle: Forme nei grafici
description: Impara come usare Aspose.Cells for JavaScript tramite C++ per aggiungere controlli e personalizzare grafici in Microsoft Excel. Questa guida dimostra come manipolare gli elementi del grafico, regolare la formattazione e migliorare l aspetto e l usabilità complessivi dei tuoi grafici.
keywords: Aspose.Cells for JavaScript tramite C++, Controlli del Grafico, Personalizzazione del Grafico, Microsoft Excel, Elementi del Grafico, Formattazione.
type: docs
weight: 70
url: /it/javascript-cpp/controls-in-charts/
---
...
La classe [**ShapeCollection**](https://reference.aspose.com/cells/javascript-cpp/shapecollection/) fornisce un metodo chiamato [**addLabelInChart(number, number, number, number)**](https://reference.aspose.com/cells/javascript-cpp/shapecollection/#addLabelInChart-number-number-number-number-), utilizzato per aggiungere un controllo etichetta a un grafico. Di seguito è riportato un elenco dei parametri utilizzati per il metodo:
...
Il metodo restituisce l'oggetto [**Label**](https://reference.aspose.com/cells/javascript-cpp/label/). La classe [**Label**](https://reference.aspose.com/cells/javascript-cpp/label/) rappresenta un'etichetta nel grafico. Ha alcuni membri importanti:

- [**text**](https://reference.aspose.com/cells/javascript-cpp/shape/#text--) (proprietà) – specifica una stringa di sottotitolo dell'etichetta.
- [**fill**](https://reference.aspose.com/cells/javascript-cpp/shape/#fill--) (proprietà) – specifica gli attributi del colore di riempimento.
...
Il metodo restituisce un oggetto [**TextBox**](https://reference.aspose.com/cells/javascript-cpp/textbox/). La classe [**TextBox**](https://reference.aspose.com/cells/javascript-cpp/textbox/) rappresenta una casella di testo nel grafico.
...
La classe [**ShapeCollection**](https://reference.aspose.com/cells/javascript-cpp/shapecollection/) fornisce un metodo chiamato [**addPictureInChart(number, number, Uint8Array, number, number)**](https://reference.aspose.com/cells/javascript-cpp/shapecollection/#addPictureInChart-number-number-uint8array-number-number-), che viene utilizzato per aggiungere un oggetto immagine al grafico. Di seguito è riportato l'elenco dei parametri utilizzati per il metodo:
...
Il metodo restituisce un oggetto [**Picture**](https://reference.aspose.com/cells/javascript-cpp/picture/). La classe [**Picture**](https://reference.aspose.com/cells/javascript-cpp/picture/) rappresenta un oggetto immagine nel grafico.
...
Aspose.Cells consente di inserire caselle di controllo in un foglio grafico utilizzando l'enumerazione [**MsoDrawingType**](https://reference.aspose.com/cells/javascript-cpp/msodrawingtype/). L'esempio seguente illustra come aggiungere una casella di controllo a un foglio grafico.
...
## **Argomenti avanzati**
- [Aggiungi WordArt Watermark al grafico](/cells/it/javascript-cpp/add-wordart-watermark-to-chart/)
