---
title: Copia e sposta fogli di lavoro all interno e tra i fogli di lavoro con JavaScript tramite C++
linktitle: Copiare e Spostare Fogli di Lavoro All interno e Tra Workbooks
type: docs
weight: 80
url: /it/javascript-cpp/copy-and-move-worksheets-within-and-between-workbooks/
description: Scopri come copiare e spostare fogli di lavoro all interno e tra i fogli di lavoro usando Aspose.Cells for JavaScript via C++. Gestisci efficacemente le strutture del tuo libro di lavoro.
---
...
Aspose.Cells for JavaScript via C++ supporta la copia o lo spostamento di fogli di lavoro all'interno o tra i libri di lavoro. I fogli di lavoro, inclusi dati, formattazione, tabelle, matrici, grafici, immagini e altri oggetti, vengono copiati con il massimo grado di precisione.
