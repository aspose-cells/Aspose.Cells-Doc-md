---
title: Sostituisci testo in un workbook usando espressione regolare con JavaScript tramite C++
linktitle: Sostituire il testo in un libro di lavoro utilizzando le espressioni regolari
type: docs
weight: 90
url: /it/javascript-cpp/replace-text-in-a-workbook-using-regular-expression/
description: Sostituisci testo in un workbook usando espressione regolare in JavaScript tramite C++.
---

Aspose.Cells fornisce la funzionalità di sostituire testo in un workbook usando un’espressione regolare. Per questo, l’API fornisce la proprietà [**ReplaceOptions.regexKey**](https://reference.aspose.com/cells/javascript-cpp/replaceoptions/#regexKey--) della classe [**ReplaceOptions**](https://reference.aspose.com/cells/javascript-cpp/replaceoptions). Impostare [**ReplaceOptions.regexKey**](https://reference.aspose.com/cells/javascript-cpp/replaceoptions/#regexKey--) su **true** indica che la chiave cercata sarà un’espressione regolare.
