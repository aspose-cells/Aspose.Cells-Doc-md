...
type: docs
weight: 40
url: /it/net/using-sparklines-and-settings-3d-format/
---
...
Gli sviluppatori possono creare, eliminare o leggere le linee di tendenza (nel file di modello) utilizzando l'API fornita da Aspose.Cells. Le classi che gestiscono le linee di tendenza sono contenute nel namespace [Aspose.Cells.Charts](https://reference.aspose.com/cells/net/aspose.cells.charts) quindi è necessario importare questo namespace prima di utilizzare queste funzionalità
