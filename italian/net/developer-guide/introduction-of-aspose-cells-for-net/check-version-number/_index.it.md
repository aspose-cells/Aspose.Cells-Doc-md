...
## **Controllare il numero di versione utilizzando l'API Aspose.Cells**
 ...
 Per scoprire quale versione di Aspose.Cells stai usando tramite l'API, usa il file[CellsHelper](https://reference.aspose.com/cells/net/aspose.cells/cellshelper) class GetVersion metodo statico per ottenere il numero di versione di Aspose.Cell.
