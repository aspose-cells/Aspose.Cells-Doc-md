...
{{% alert color="primary" %}} 
 ...
 Per maggiori dettagli su questa funzione, consultare l'articolo dettagliato su[Supporta i tag DIV interni durante il caricamento di HTML](/cells/it/net/support-the-layout-of-div-tags-while-loading-html-to-excel-workbook/).
...
{{% alert color="primary" %}} 
 ...
 Per maggiori dettagli su questa funzione, consultare l'articolo dettagliato su[Renderizza le linee della griglia a HTML](/cells/it/net/export-excel-to-html-with-gridlines/).
