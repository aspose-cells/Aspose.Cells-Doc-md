...
{{% alert color="primary" %}} 
 ...
 Per maggiori dettagli su questa funzione, consultare l'articolo dettagliato su[Eliminazione di righe e colonne vuote con riferimenti aggiornati](/cells/it/net/update-references-in-other-worksheets-while-deleting-blank-columns-and-rows-in-a-worksheet/).
