...
Aspose.Cells Le API hanno già fornito la possibilità di eseguire il rendering dei grafici in PDF durante l'utilizzo del metodo Chart.ToPdf. Con questa versione, lo API ha esposto un'altra versione sovraccaricata del suddetto metodo che potrebbe accettare un'istanza di Stream, consentendo agli utenti di salvare il PDF del grafico in un'istanza di MemoryStream.
