...
{{% alert color="primary" %}} 
 ...
 Per maggiori dettagli su questa funzione, consultare l'articolo su[Impostazione del carattere predefinito per il rendering dei fogli di calcolo sul formato HTML](/cells/it/net/set-default-font-while-rendering-spreadsheet-to/).
