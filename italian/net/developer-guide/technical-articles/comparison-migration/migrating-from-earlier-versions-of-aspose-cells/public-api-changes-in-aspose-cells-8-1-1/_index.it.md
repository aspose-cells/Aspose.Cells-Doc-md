...
La classe HtmlSaveOptions ha esposto la proprietà PresentationPreference che può essere utilizzata per eseguire il rendering dei risultati con un layout migliore durante l'esportazione di fogli di calcolo in HTML o MHTML. Il valore predefinito è falso. mentre se impostato su true, Aspose.Cells API esporterà il contenuto del foglio di lavoro con una migliore presentazione.
