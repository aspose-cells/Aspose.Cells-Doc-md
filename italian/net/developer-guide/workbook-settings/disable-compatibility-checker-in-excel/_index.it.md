...
---
## Disabilita Verifica compatibilità nei fogli di lavoro Excel in C#

{{% alert color="primary" %}}

I contrassegni di Verifica compatibilità di Microsoft Excel durante il salvataggio di un file in un formato di file precedente potrebbero causare problemi di funzionalità o perdita di fedeltà. Verifica compatibilità è una funzionalità di Microsoft Office Excel 2007 e Microsoft Excel 2010.
...
volte, è necessario disabilitare Verifica compatibilità per un particolare foglio di calcolo. Con le API Aspose.Cells puoi farlo a livello di programmazione in modo che gli utenti non siano frustrati o confusi dalla finestra di dialogo Verifica compatibilità che si apre quando salvano nuovamente il file in Microsoft Excel manualmente.
...
## **Utilizzo delle API Aspose.Cells**
 ...
 Impostare il[**Workbook.Settings.CheckComptiliblity**](https://reference.aspose.com/cells/net/aspose.cells/workbooksettings/properties/checkcompatibility) proprietà a**Falso** per disabilitare Verifica compatibilità di Microsoft Excel.
