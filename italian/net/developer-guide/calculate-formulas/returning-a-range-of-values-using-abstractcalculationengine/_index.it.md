...
{{% alert color="primary" %}}
 ...
 Aspose.Cells fornisce[**Motore di calcolo astratto**](https://reference.aspose.com/cells/net/aspose.cells/abstractcalculationengine) classe utilizzata per implementare funzioni personalizzate o definite dall'utente che non sono supportate da Microsoft Excel come funzioni predefinite.
