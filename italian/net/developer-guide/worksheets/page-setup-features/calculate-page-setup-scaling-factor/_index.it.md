...
Quando si imposta il ridimensionamento dell'impostazione di pagina utilizzando**Adatta a n pagine di larghezza per m di altezza** opzione, Microsoft Excel calcola il fattore di scala dell'impostazione di pagina. Puoi calcolare la stessa cosa usando[**SheetRender.PageScale**](https://reference.aspose.com/cells/net/aspose.cells.rendering/sheetrender/properties/pagescale) proprietà. Questa proprietà restituisce un valore double che può essere convertito in valore percentuale. Ad esempio, se restituisce 0,5, significa che il fattore di scala è del 50%.
