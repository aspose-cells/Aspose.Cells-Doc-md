...
description: Questo articolo include codice di esempio e descrive come copiare e spostare i fogli di lavoro a livello di codice sia all'interno di una cartella di lavoro di Excel che tra cartelle di lavoro di Excel usando la libreria C# API o .NET.
...
1.  Sul**Modificare** menu, fai clic su *Sposta o copia foglio**.
1.  Nel**Prenotare** finestra di dialogo, fare clic sulla cartella di lavoro per ricevere i fogli.
1. Per spostare o copiare i fogli selezionati in una nuova cartella di lavoro, fai clic su *Nuovo libro**.
1.  Nel**Prima foglio** fare clic sul foglio prima del quale si desidera inserire i fogli spostati o copiati.
1.  Per copiare i fogli invece di spostarli, selezionare il file**Crea una copia** casella di controllo.
