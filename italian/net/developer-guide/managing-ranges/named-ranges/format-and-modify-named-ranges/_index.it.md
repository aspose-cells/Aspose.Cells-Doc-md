...
### **Impostazione del colore di sfondo e degli attributi dei caratteri su un intervallo denominato**
 ...
 Per applicare la formattazione, definire a[**Stile**](https://reference.aspose.com/cells/net/aspose.cells/style) oggetto per specificare le impostazioni di stile e applicarlo al[**Allineare**](https://reference.aspose.com/cells/net/aspose.cells/range)oggetto.
