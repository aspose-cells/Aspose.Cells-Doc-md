...
type: docs
weight: 40
url: /it/net/setting-pivot-table-option-for-empty-cells-show/
---
...
Aspose.Cells fornisce le proprietà [**PivotTable.DisplayNullString**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivottable/properties/displaynullstring) e [**PivotTable.NullString**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivottable/properties/nullstring) per impostare l'opzione della tabella pivot "Per le celle vuote mostrare".
