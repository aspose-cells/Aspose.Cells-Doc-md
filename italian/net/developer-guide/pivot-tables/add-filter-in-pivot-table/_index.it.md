...
type: docs
weight: 130
url: /it/net/add-filter-in-pivot-table/
description: Scopri come aggiungere un filtro nella tabella pivot con Aspose.Cells.
keywords: Adding a filter in pivot table without office 2013, office 2016, office 2019 and office 365.
---
## **Possibili scenari di utilizzo**
Quando crei una tabella pivot con dati noti e desideri filtrare la tabella pivot, devi imparare e utilizzare il filtro. Può aiutarti a filtrare i dati che desideri in modo efficace. Utilizzando Aspose.Cells API, è possibile aggiungere filtri sui valori dei campi nelle tabelle pivot.
