...
Aspose.Cells fornisce la possibilità di impostare l'opzione di formato di visualizzazione per i campi pivot. A questo scopo, l'API fornisce la proprietà [**PivotField.ShowValuesSetting.CalculationType**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivotshowvaluessetting/calculationtype/). Per classificare dal più grande al più piccolo, è possibile impostare la proprietà [**PivotField.ShowValuesSetting.CalculationType**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivotshowvaluessetting/calculationtype/) a [**PivotFieldDataDisplayFormat.RankLargestToSmallest**](https://reference.aspose.com/cells/net/aspose.cells.pivot/pivotfielddatadisplayformat). Il seguente frammento di codice dimostra come impostare le opzioni di formato di visualizzazione.
