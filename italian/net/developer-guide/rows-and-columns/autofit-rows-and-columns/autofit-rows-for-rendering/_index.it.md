...
Se vuoi evitare che il testo venga tagliato nel file PDF salvato, puoi adattare automaticamente la riga con il comando[AutoFitterOptions.ForRendering](https://reference.aspose.com/cells/net/aspose.cells/autofitteroptions/forrendering/) opzione.
