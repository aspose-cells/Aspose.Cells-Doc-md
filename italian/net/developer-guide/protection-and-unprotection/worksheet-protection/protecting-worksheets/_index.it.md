...
Le opzioni di protezione generali in Microsoft Excel sono:
...
|:- |:- |
|Tutto|L'utente non può modificare nulla in questo foglio di lavoro|
...
|finestre|La protezione viene applicata alle finestre|
...
|![cose da fare:immagine_alt_testo](protecting-worksheets_1.png)|
 ...
 Per lavorare sul foglio di lavoro, rimuovere la protezione del foglio di lavoro selezionando il file**Protezione** , poi**Foglio non protetto** dal**Strumenti** elemento del menu.
...
Questo sblocca tutte le celle del foglio di lavoro
 Se la**Cells** comando non è disponibile, parti del foglio di lavoro potrebbero già essere bloccate. Sul**Strumenti** menu, punta a**Protezione** e quindi fare clic su**Foglio non protetto**.
...
1.  Sul**Strumenti** menu, punta a**Protezione** , fare clic**Proteggi Foglio** e quindi fare clic**OK**.
