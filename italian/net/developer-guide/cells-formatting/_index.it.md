...
### **Formattazione dei caratteri selezionati**
 ...
 Il[**Cell**](https://reference.aspose.com/cells/net/aspose.cells/cell) la classe fornisce il[**Caratteri**](https://reference.aspose.com/cells/net/aspose.cells/cell/methods/characters)metodo che accetta i seguenti parametri per selezionare un intervallo di caratteri all'interno di una cella:
...
- [Impostare i formati condizionali dei file Excel e ODS.](/cells/it/net/conditional-formatting/)
