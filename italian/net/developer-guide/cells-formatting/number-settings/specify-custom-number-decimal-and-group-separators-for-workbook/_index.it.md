...
description: Modifica il numero decimale e il separatore di gruppo in MS Excel e con il codice C# utilizzando Aspose.Cells for .NET API.
...
Il seguente codice di esempio illustra come specificare i separatori personalizzati utilizzando Aspose.Cells API. Specifica i separatori numerici personalizzati e di gruppo rispettivamente come punto e spazio.

### C# per specificare numeri decimali personalizzati e separatori di gruppo
