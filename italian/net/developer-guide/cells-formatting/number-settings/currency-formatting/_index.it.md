...
type: docs
weight: 10
url: /it/net/format-number-to-currency/
description: Questo articolo introdurrà come formattare il numero in valuta usando l API Aspose.Cells for .NET.
...
Per formattare i numeri come valuta nel library Aspose.Cells for .NET per lavorare con file Excel, puoi applicare la formattazione valuta alle celle programmaticamente. Ecco come farlo usando C# con Aspose.Cells:
