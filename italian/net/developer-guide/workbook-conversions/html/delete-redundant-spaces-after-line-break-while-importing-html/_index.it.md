...
### Esempio di programmazione
 ...
 Il codice di esempio seguente mostra l'utilizzo di[**HTMLLoadOptions.DeleteRedundantSpaces**](https://reference.aspose.com/cells/net/aspose.cells/htmlloadoptions/properties/deleteredundantspaces) proprietà. Si prega di impostarlo**VERO** o**falso** per ottenere l'output come mostrato nello screenshot sopra.
