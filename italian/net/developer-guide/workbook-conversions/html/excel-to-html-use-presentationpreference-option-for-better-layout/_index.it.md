...
type: docs
weight: 220
url: /it/net/excel-to-html-use-presentationpreference-option-for-better-layout/
---
{{% alert color="primary" %}} 
...
Consultare il codice di esempio riportato di seguito che mostra come eseguire il rendering di un file HTML da un report Excel con la preferenza di presentazione attiva.
