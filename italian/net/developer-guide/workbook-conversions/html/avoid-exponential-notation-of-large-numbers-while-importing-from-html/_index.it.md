...
{{% /alert %}}
 ...
 Il seguente codice di esempio spiega l'utilizzo di[**HTMLLoadOptions.KeepPrecision**](https://reference.aspose.com/cells/net/aspose.cells/abstracttextloadoptions/properties/keepprecision)proprietà. L'API importerà il numero così com'è senza convertirlo in notazione esponenziale.
