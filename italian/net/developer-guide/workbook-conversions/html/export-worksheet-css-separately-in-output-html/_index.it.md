...
Il seguente codice di esempio crea un file Excel, aggiunge del testo nella cella**B5** in**Rosso**color e quindi lo salva nel formato HTML utilizzando[**HtmlSaveOptions.ExportWorksheetCSSSeparately**](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/exportworksheetcssseparately) proprietà. Si prega di consultare il[uscita HTML](60489766.zip) generato dal codice per riferimento. Troverai**foglio di stile.css**al suo interno come risultato del codice di esempio.
