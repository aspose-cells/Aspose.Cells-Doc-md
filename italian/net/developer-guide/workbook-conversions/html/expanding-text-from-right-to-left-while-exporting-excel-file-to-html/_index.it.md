...
type: docs
weight: 60
url: /it/net/expanding-text-from-right-to-left-while-exporting-excel-file-to/
---
{{% alert color="primary" %}} 
...
![cose da fare:immagine_alt_testo](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_2.png)
 ...
 Questo screenshot mostra il[output HTML generato con la versione più recente](5115508).
