...
È possibile modificare lo stesso esempio per salvare il file in CSV. Per impostazione predefinita,**[TxtSaveOptions.Separator](https://reference.aspose.com/cells/net/aspose.cells/txtsaveoptions/properties/separator)**è una virgola, quindi non specificare un separatore se si salva nel formato CSV.
...
## **Argomenti avanzati**
- [Mantieni i separatori per le righe vuote durante l'esportazione dei fogli di calcolo nel formato CSV](/cells/it/net/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
