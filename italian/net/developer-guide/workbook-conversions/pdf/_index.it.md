...
{{% alert color="primary" %}}
 ...
 Aspose.Cells for .NET scrive direttamente le informazioni su API e il numero di versione nei documenti di output. Ad esempio, dopo aver reso Document to PDF, Aspose.Cells for .NET popola**Applicazione** campo con valore 'Aspose.Cells' e**PDF Produttore**campo con valore, ad esempio 'Aspose.Cells v17.9'.
...
- [Converti un file XLS nel formato PDF](/cells/it/net/convert-an-xls-file-to-pdf-format/)
