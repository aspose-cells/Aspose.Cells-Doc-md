...
## **Possibili scenari di utilizzo**
 ...
 Aspose.Cells fornisce una classe astratta[**DrawObjectEventHandler**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobjecteventhandler) che ha un[**Disegno()**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobjecteventhandler/methods/draw)metodo. L'utente può implementare[**DrawObjectEventHandler**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobjecteventhandler) e utilizzare il[**Disegno()**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobjecteventhandler/methods/draw) metodo per ottenere il[**DisegnaOggetto**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobject)e Bound durante il rendering di Excel in PDF o immagine. Ecco una breve descrizione dei parametri del[**Disegno()**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobjecteventhandler/methods/draw)metodo.
