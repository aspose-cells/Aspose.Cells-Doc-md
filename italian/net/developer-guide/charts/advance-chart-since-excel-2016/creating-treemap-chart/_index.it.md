...
description: Scopri come creare un grafico Treemap in Aspose.Cells for .NET. La nostra guida ti aiuterà a comprendere le varie opzioni di formattazione e proprietà disponibili per i grafici Treemap, inclusi colori, etichette e rappresentazione dei dati.
keywords: Aspose.Cells for .NET, grafico Treemap, creare, proprietà, formattazione, colori, etichette, rappresentazione dati, grafico circolare, creazione di grafici gerarchici.
type: docs
weight: 161
url: /it/net/creating-treemap-chart/
---
