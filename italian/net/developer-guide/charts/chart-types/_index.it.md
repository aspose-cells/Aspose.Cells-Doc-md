...
#### **Grafico a imbuto**
Un grafico a imbuto mostra i valori in più fasi di un processo. Ad esempio, puoi utilizzare un grafico a imbuto per mostrare il numero di potenziali clienti in ogni fase di una pipeline di vendita. In genere, i valori diminuiscono gradualmente, consentendo alle barre di assomigliare a un imbuto.

Il grafico a imbuto è supportato in Aspose.Cells.

#### **Grafici di superficie 3D**
Come altri grafici 3D, anche i grafici 3D di superficie si basano sugli assi X, Y e Z. Questi grafici sono utili per mostrare una variazione della variabile "Z" in funzione delle altre due variabili, "X" e "Y".
