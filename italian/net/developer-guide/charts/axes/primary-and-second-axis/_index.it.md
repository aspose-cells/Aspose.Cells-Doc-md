---
title: Asse primario e secondo
description: Scopri come comprendere e lavorare con gli assi primari e secondari allo Aspose.Cells for .NET. La nostra guida ti aiuterà a comprendere le differenze tra gli assi primari e secondari e come configurarli e utilizzarli in modo efficace nei tuoi grafici.
keywords: Aspose.Cells for .NET, primary axes, secondary axes, understanding, differences, configuration, usage.
type: docs
weight: 190
url: /it/net/primary-and-second-axis/
---
##  **Possibili scenari di utilizzo**
Quando i numeri in un grafico variano notevolmente da una serie di dati all'altra o quando disponi di tipi di dati misti (prezzo e volume), traccia una o più serie di dati su un asse verticale secondario (valore). La scala dell'asse verticale secondario mostra i valori delle serie di dati associate. Un asse secondario funziona bene in un grafico che mostra una combinazione di grafici a colonne e a linee.
