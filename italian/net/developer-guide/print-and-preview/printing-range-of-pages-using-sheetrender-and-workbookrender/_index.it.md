...
Microsoft Excel consente di stampare un intervallo di pagine della cartella di lavoro o del foglio di lavoro. Lo screenshot seguente mostra l'interfaccia di Excel Microsoft per specificare l'intervallo di pagine.
...
{{% /alert %}} 
## **Microsoft Interfaccia Excel per specificare l'intervallo di pagine da stampare**
