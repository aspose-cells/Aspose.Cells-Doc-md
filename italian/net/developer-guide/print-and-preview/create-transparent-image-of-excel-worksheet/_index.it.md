...
{{% alert color="primary" %}}
 ...
 volte, devi generare l'immagine del tuo foglio di lavoro come immagine trasparente. Vuoi applicare la trasparenza a tutte le celle che non hanno colori di riempimento. Aspose.Cells fornisce il[**ImageOrPrintOptions.Transparent**](https://reference.aspose.com/cells/net/aspose.cells.rendering/imageorprintoptions/properties/transparent) proprietà per applicare la trasparenza all'immagine del foglio di lavoro. Quando questa proprietà è *false**, le celle senza colori di riempimento vengono disegnate con il colore bianco e quando è *true**, le celle senza colori di riempimento vengono disegnate trasparenti.
...
| :- |
|![cose da fare:image_alt_text](create-transparent-image-of-excel-worksheet_1.png)|
...
| :- |
|![cose da fare:image_alt_text](create-transparent-image-of-excel-worksheet_2.png)|
