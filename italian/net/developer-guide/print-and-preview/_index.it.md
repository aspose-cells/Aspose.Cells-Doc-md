...
Microsoft Excel presuppone che si desideri stampare l'intera area del foglio di lavoro a meno che non si specifichi una selezione. Per stampare utilizzando Aspose.Cells, importare prima lo spazio dei nomi Aspose.Cells.Rendering nel programma. Ha diverse classi utili, ad esempio,[**FoglioRendering**](https://reference.aspose.com/cells/net/aspose.cells.rendering/sheetrender) e[**Workbook Render**](https://reference.aspose.com/cells/net/aspose.cells.rendering/workbookrender).
