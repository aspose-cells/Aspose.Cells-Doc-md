...
type: docs
weight: 50
url: /it/net/link-cells-to-xml-map-elements/
---

## **Possibili Scenari di Utilizzo**

È possibile collegare le tue celle agli elementi della mappa XML utilizzando Aspose.Cells. Si prega di utilizzare il metodo [**Cells.LinkToXmlMap()**](https://reference.aspose.com/cells/net/aspose.cells/cells/methods/linktoxmlmap) a questo scopo.
