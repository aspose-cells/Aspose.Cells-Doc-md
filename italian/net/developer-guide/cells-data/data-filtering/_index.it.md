...
description: Scopri come aggiungere il filtro dati utilizzando Aspose.Cells for .NET API.
...
1.  Dal**Dati** menu, selezionare**Filtro** e poi *Filtro automatico**.
...
1. [DataFiltered.xlsx](72417318.xlsx)
...
1. [TestoFiltrato.xlsx](72417323.xlsx)
...
- [Ottieni tutti gli indici delle righe nascoste dopo aver aggiornato il filtro automatico](/cells/it/net/get-all-hidden-rows-indices-after-refreshing-autofilter/)
