...
description: Scopri come ordinare i dati utilizzando Aspose.Cells for .NET API.
keywords: Sort data in ascending or descending order, Sort data based on the background color
---
{{% alert color="primary" %}}

L'ordinamento dei dati è una delle tante funzionalità utili di Microsoft Excel. Consente agli utenti di ordinare i dati per semplificarne la scansione. Aspose.Cells consente agli sviluppatori di ordinare i dati del foglio di lavoro in ordine alfabetico o numerico, funzionando allo stesso modo di Microsoft Excel per ordinare i dati.
...
##  **Ordinamento dati con Aspose.Cells**
 ...
 IL[**Ordinare**](https://reference.aspose.com/cells/net/aspose.cells.datasorter/sort/methods/1)il metodo accetta i seguenti parametri:

- [**Aspose.Cells.Cells**](https://reference.aspose.com/cells/net/aspose.cells/cells), le celle del foglio di lavoro sottostante.
...
{{% alert color="primary" %}}
 ...
 Se vuoi ordinare *Da sinistra a destra*, usa il comando[**DataSorter.SortLeftToRight**](https://reference.aspose.com/cells/net/aspose.cells/datasorter/properties/sortlefttoright) attributo.

{{% /alert %}}

###  **Ordinamento dei dati con colore di sfondo**

Excel fornisce funzionalità per ordinare i dati in base al colore di sfondo. La stessa funzionalità viene fornita utilizzando Aspose.Cells utilizzando DataSorter dove[**Ordina su tipo**](https://reference.aspose.com/cells/net/aspose.cells/sortontype) .CellColor può essere utilizzato in[**AddKey()**](https://reference.aspose.com/cells/net/aspose.cells/datasorter/methods/addkey) per ordinare i dati in base al colore di sfondo. Tutte le celle che contengono il colore specificato nel file[**AddKey()**](https://reference.aspose.com/cells/net/aspose.cells/datasorter/methods/addkey), le funzioni vengono posizionate in alto o in basso in base all'impostazione Ordinamento e l'ordine del resto delle celle non viene modificato affatto.

Di seguito sono riportati i file di esempio che possono essere scaricati per testare questa funzionalità:

[campioneBackGroundFile.xlsx](81920906.xlsx)
