...
Si prega di vedere il seguente codice di esempio, carica il file[esempio di file Excel](64716810.xlsx)che contiene l'oggetto Ole. Il codice accede all'oggetto Ole e cambia la sua etichetta da API di esempio ad API Aspose. Si prega di consultare l'output della console fornito di seguito che mostra l'effetto del codice di esempio sul file Excel di esempio per un riferimento.
