...
## **Manipolazione dei controlli della casella di testo nei fogli di calcolo di Designer**
 ...
 Aspose.Cells consente inoltre di accedere alle caselle di testo nei fogli di lavoro del designer e di manipolarle. Usa il[**Foglio di lavoro.Caselle di testo**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/textboxes) property per ottenere la raccolta di caselle di testo nel foglio.

L'esempio seguente utilizza il file Excel Microsoft creato nell'esempio precedente. Ottiene le stringhe di testo delle due caselle di testo e modifica il testo della seconda casella di testo per salvare il file.
