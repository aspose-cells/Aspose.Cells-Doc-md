---
title: Carica un'immagine Web da un URL in un foglio di lavoro Excel
type: docs
weight: 30
...
{{% alert color="primary" %}}
 ...
 Potrebbero esserci casi in cui desideri sempre l'immagine aggiornata da un URL. Per raggiungere questo obiettivo, è possibile seguire le istruzioni fornite nel[Inserisci un'immagine collegata dall'indirizzo web](/cells/it/net/insert-a-linked-picture-from-web-address/) articolo. Seguendo questo metodo, l'immagine viene caricata dall'URL ogni volta che viene aperto il foglio di lavoro.
