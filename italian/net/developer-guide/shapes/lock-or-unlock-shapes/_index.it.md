...
description: Questo articolo ti mostra del codice che spiega come bloccare o sbloccare le forme per proteggerle usando la libreria Aspose.Cells.
keywords: C# Blocca le Forme per Proteggerle, Come Bloccare o Sbloccare le forme usando C#, Blocca o sblocca le forme per proteggerle in C#.
---
...
A volte, potrebbe essere necessario modificare alcune forme in alcuni fogli di lavoro protetti, in tal caso, sarà necessario sbloccare queste forme. Questo articolo introdurrà in dettaglio come bloccare e sbloccare le forme specificate.
