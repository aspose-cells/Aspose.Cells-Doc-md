---
title: Nessun sovraccarico per il metodo Save accetta 4 argomenti
type: docs
weight: 70
url: /it/net/no-overload-for-method-save-takes-4-arguments/
---
## **Sintomo**

"Utilizzando la versione Aspose.Cells, ottengo questo errore quando utilizzo il metodo Save quando provo a salvare la cartella di lavoro nell'oggetto Response. Trovo questo frammento di codice documentato nella documentazione online."

### **Schermata dell'errore**

![cose da fare:immagine_alt_testo](no-overload-for-method-save-takes-4-arguments_1.png)
