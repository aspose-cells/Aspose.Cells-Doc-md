---
title: Aspose.Cells per iOS tramite le funzionalità Xamarin
type: docs
weight: 70
url: /it/net/aspose-cells-for-ios-via-xamarin-features/
---
## **Aspose.Cells per iOS tramite Panoramica delle funzionalità Xamarin**
Questa sezione fornisce un confronto della disponibilità delle funzionalità tra Aspose.Cells for .NET e Aspose.Cells per iOS tramite Xamarin.
...
|Crea interruzioni di pagina personalizzate|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Implementa marcatori intelligenti|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Conserva o rimuovi componenti aggiuntivi, VBA, macro|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Applica colori diversi a celle, caratteri, griglie, oggetti grafici, ecc.|{{< emoticons/tick >}}|{{< emoticons/tick >}} (Gli oggetti grafici non sono supportati)|
...
|Crea o modifica l'intestazione e/o il piè di pagina.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
