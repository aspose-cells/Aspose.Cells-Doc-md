...
1. Microsoft Excel 2010 memorizza i documenti nella versione SpreadsheetML 2010 come definito nello standard OOXML aggiornato.
...
I documenti OOXML SpreadsheetML vengono spesso come file XLSX, che sono pacchetti ZIP. Oltre a XLSX. Aspose.Cells fornisce un ampio supporto per il caricamento, il salvataggio e la conversione di documenti SpreadsheetML. Tale implementazione onnicomprensiva è possibile perché Aspose.Cells è stato progettato tenendo presente la struttura dei documenti di Microsoft Excel (e SpreadsheetML è noto per imitare la rappresentazione interna dei documenti di Microsoft Excel).
