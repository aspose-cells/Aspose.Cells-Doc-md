...
-  Assicurati che IIS sia installato su Vista prima dell'installazione**Aspose.Cells** . È obbligatorio perché**Aspose.Cells** il programma di installazione deve creare una cartella virtuale su IIS per la distribuzione delle Web Demo (Asp.NET Demo).
