...
{{% /alert %}} 
## **Distribuzione**
Aspose.Cells supporta sia ambienti a 32 bit che a 64 bit. Quando si installa il componente Aspose.Cells for .NET utilizzando il programma di installazione MSI Aspose.Cells, diverse DLL vengono aggiunte a cartelle diverse nelle cartelle Aspose.Cells ${installation_Path}. Vedere la descrizione nella tabella quale cartella contiene gli assembly da usare con una particolare versione di .NET Framework.

|**Cartella**|**Descrizione**|
|:- |:- |
|net2.0|Contiene assembly da utilizzare con .NET Framework 2.0, 3.0, 3.5, 4.0 e Mono. Questi sono gli assembly che dovresti usare normalmente sia per gli ambienti a 32 bit che per quelli a 64 bit.|
...
|net3.5_ClientProfile|Contiene assembly da usare con .NET Framework 3.5 o 4.0 Client Profile.|
...
|netto3.5|Contiene assembly da usare con .NET Framework 3.5 o 4.0.|
...
|net4.0|Contiene assembly da usare con .NET Framework 4.0 e 4.5.|
...
Nei progetti VS.NET (ad esempio 2005, 2008, 2010, 2012 ecc.), quando si aggiunge un riferimento a Aspose.Cells, la finestra di dialogo Aggiungi riferimento fa riferimento ai file Aspose.Cells.dll nelle cartelle net2.0 o net3.5 rispettivamente . (Per ulteriori riferimenti, leggere Riferimento a Aspose.Cells da un progetto .NET.) È possibile modificare il riferimento alla libreria in base al proprio ambiente. Si noti che se il framework di destinazione del progetto è .NET Framework 3.5/4 Client Profile, utilizzare il file del componente Aspose.Cells.dll che si trova nella cartella net_ClientProfile.
