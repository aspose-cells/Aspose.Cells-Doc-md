...
- Imposta "Sistema operativo di destinazione" su "Nessuno" o altre opzioni per il tuo progetto, utilizzerai "SkiaSharp" come dipendenza dal tuo sistema Windows per il progetto .Net6.*Si noti che la versione che utilizza "SkiaSharp" come dipendenza non supporta la funzione di stampa su stampante.*
...
- System.Text.Encoding.CodePages, 4.7.0.
 ...
 In questo modo, utilizzerai "SkiaSharp" come dipendenza dal tuo sistema Windows per il progetto .Net6.*Si noti che la versione che utilizza "SkiaSharp" come dipendenza non supporta la funzione di stampa su stampante.*
