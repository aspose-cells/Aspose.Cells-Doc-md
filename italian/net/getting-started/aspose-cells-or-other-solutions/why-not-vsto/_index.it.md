...
linktitle: Perché non VSTO
type: docs
weight: 10
url: /it/net/why-not-vsto
description: Aspose.Cells for .NET è una libreria avanzata per l'elaborazione di file Excel che fornisce un ottimo supporto per tutti i Microsoft Excel e altri formati di file. VSTO e Aspose.Cells non competono tra loro perché risolvono attività utente leggermente diverse utilizzando C#
---
Quando devi confrontare quale prodotto è il migliore per la tua soluzione, ci sono molti criteri da valutare, ma l'obiettivo principale sarà spesso la funzionalità e l'impegno richiesto per utilizzare il prodotto.
...
{{% alert color="primary" %}}
 ...
 Esplorare[gli esempi di codice sorgente delle funzionalità Aspose.Cells for .NET rispetto a VSTO](https://github.com/aspose-cells/Aspose.Cells-for-.NET/releases/tag/MissingFeaturesAsposeCellsForVSTO1.1). Per utilizzare questi esempi di codice sorgente, dovrai fare riferimento a Aspose.Cells for .NET nel tuo progetto.

{{% /alert %}}

## Stabilità

Aspose.Cells è accuratamente testato e impacchettato in una singola DLL senza richiedere l'installazione di parti aggiuntive per funzionare.
...
- [Stampa e visualizza in anteprima la cartella di lavoro](/cells/it/net/print-and-preview/)
- E altro.
