...
description: "Aspose.Cells for .NET è una libreria avanzata di elaborazione file Excel che fornisce un grande supporto per tutti i formati di file di Microsoft Excel e altri. VSTO e Aspose.Cells non competono tra loro perché risolvono compiti dell utente leggermente differenti utilizzando C#."
---
...
Esplora [gli esempi di codice sorgente delle funzionalità Aspose.Cells for .NET in confronto con VSTO](https://github.com/aspose-cells/Aspose.Cells-for-.NET/releases/tag/MissingFeaturesAsposeCellsForVSTO1.1). Per utilizzare questi esempi di codice sorgente, sarà necessario fare riferimento a Aspose.Cells for .NET nel tuo progetto.
