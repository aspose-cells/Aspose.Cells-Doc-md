---
title: Confrontare VSTO con Aspose.Cells for .NET
type: docs
weight: 20
...
Questo articolo confronta l'uso di VSTO (Visual Studio Tools for Office) con altri approcci per lo sviluppo di soluzioni basate su Microsoft Office. In particolare, esamina Aspose.Cells e fornisce un confronto su come lavorano le due soluzioni. Gli articoli forniscono informazioni che gli sviluppatori possono utilizzare per analizzare, confrontare ed valutare diverse opzioni prima di adottare una soluzione.
...
D'altra parte, Aspose.Cells for .NET è confezionato in un singolo DLL quindi non c'è bisogno di installare app aggiuntive. Il componente è utilizzato solo dalle applicazioni .NET e nessuna parte del codice del componente è progettata per attendere una risposta umana. Visita la [pagina di download](https://downloads.aspose.com/cells/net) di Aspose.Cells e scarica l'ultimo programma di installazione di Aspose.Cells. Esegui il file scaricato e segui le istruzioni del programma di installazione. Successivamente, per utilizzare il componente, fai riferimento ad esso nel tuo progetto.
...
1. Viene utilizzato un file Microsoft Excel (TempBook.xls) come modello.
   Il workbook contiene alcune schede con alcune celle compilate con dati.
1. Il codice di esempio inserisce 1000*20 record nella prima scheda del file Excel di modello.
   La scheda viene riempita con dati costanti (fittizi) nelle celle.
