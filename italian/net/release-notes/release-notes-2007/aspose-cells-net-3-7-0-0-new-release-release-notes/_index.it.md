---
title: Aspose.Cells .Net 3.7.0.0 Nuova versione Note sulla versione
type: docs
weight: 170
url: /it/net/aspose-cells-net-3-7-0-0-new-release-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells .Net 3.7.0.0 Nuova versione](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-.net-3.7.0.0-new-release/)

{{% /alert %}} 

 Cari clienti,

 Abbiamo rilasciato Aspose.Cells 3.7 for .NET!
...
- Le demo di WinForm sono incluse nel pacchetto di installazione.
 Le prestazioni e l'utilizzo della memoria sono ottimizzati.
...
Intervallo denominato e altri problemi nella conversione da file Excel a file SpreadsheetML
 ...
 Errore di riferimento ricorsivo nelle celle durante il calcolo delle formule
