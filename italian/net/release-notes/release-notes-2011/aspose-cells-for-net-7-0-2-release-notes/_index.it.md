---
title: Aspose.Cells for .NET 7.0.2 Note di rilascio
type: docs
weight: 20
url: /it/net/aspose-cells-for-net-7-0-2-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 7.0.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.0.2/)

{{% /alert %}} 

 Siamo felici di annunciare Aspose.Cells for .NET v7.0.2! In questa versione, abbiamo apportato diversi miglioramenti e corretto il numero di problemi/bug degli utenti. Inoltre, ora abbiamo rimosso alcuni metodi obsoleti e non necessari per la funzione Foglio-immagine.

\1) Aspose.Cells 

 Nuove caratteristiche

 30970 Accedere alle proprietà del documento di un file XLS crittografato
...
30609 Il costruttore della cartella di lavoro genera NullReferenceException
 ...
 30755 Il salvataggio come SaveFormat.XLSM provoca errori

 30785 Impossibile modificare lo stile della linea di un ChartPoint

 30787 Forme interrotte nel foglio di lavoro copiato

 30843 Le formule che utilizzano intervalli intersecati non funzionano
...
30949 Cell il contenuto si divide parzialmente in una parola durante la conversione da XLS a PDF
 ...
 31003 Problema con AutoFitRow e AutoFitMergedCells
 ...
 31095 AutoFitRows non funziona correttamente

 31098 SheetRender esporta doppi spazi / spaziatura incoerente

 31099 Problema con gli elementi della legenda del grafico che vanno a capo durante il salvataggio come immagine

 31102 Sono presenti troppi formati nel foglio di lavoro

 31195 SheetRender esporta il grafico con un'altezza errata
 ...
 31051 Problema di GridDesktop durante il caricamento di un documento Excel
