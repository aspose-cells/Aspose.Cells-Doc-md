---
title: Aspose.Cells for .NET 5.3.2 Note di rilascio
type: docs
weight: 80
url: /it/net/aspose-cells-for-net-5-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 5.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.3.2/)

{{% /alert %}} 

 Siamo felici di annunciare Aspose.Cells for .NET v5.3.2!

 Cosa è cambiato in Aspose.Cells:

- Inserisce un valore comune in tutte le celle dell'intervallo utilizzando Range.Value.
- Supporta la crittografia MS Excel 2010.
- Fornisce supporto per disabilitare/nascondere la finestra di dialogo Processo di stampa
- Supporta la modifica dell'origine della carta durante la stampa.
- 43 miglioramenti e correzioni.

 Cosa è cambiato in Aspose.Cells.GridWeb:

- Supporta l'impostazione dello stato delle righe raggruppate su "Espanso" o "Comprimito" sul lato client.
- 1 correzione.
...
|25423 | XL| Scrivi una stringa nella cella unita|
|25426 | Formula| Impossibile calcolare la cartella di lavoro|
|25506 | XL| Problema durante il salvataggio del formato XLSX|
|25554 | XL| Cella copiata non valida|
|25904 | XL| Alcune formattazioni non verranno copiate|
|25919 | XL| Cells nell'intervallo non può essere unito|
|24912 | Xlsb| Salvataggio XLSB con filtro dati|
|25675 | Xlsb| Aspose.Cells rimuove le bitmap|
|25229 | Xlsx| Problemi con grafici a barre complessi|
|25287 | Xlsx| Strano problema con le forme dopo il salvataggio|
|25317 | Xlsx| Ottieni ListObject per nome|
|25327 | Xlsx| Problema con le aree di intestazione e piè di pagina|
|25332 | Xlsx| Vari problemi relativi alle proprietà personalizzate|
|25390 | Xlsx| Apertura e copia foglio problema|
|25391 | Xlsx| Il pulsante scorre a sinistra dopo ogni salvataggio|
