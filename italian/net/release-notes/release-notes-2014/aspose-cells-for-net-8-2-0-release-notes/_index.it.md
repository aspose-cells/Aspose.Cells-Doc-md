...
## **Insetti**
 ...
 (CELLSNET-42866) - Manca il testo verticale nel foglio di calcolo nel risultante PDF

 (CELLSNET-42835) - Il testo non è allineato a lato della forma quando XLS viene visualizzato in PDF
...
(CELLSNET-42322) - L'eliminazione di righe e l'aggiornamento della tabella pivot causano l'arresto anomalo del file di output
 ...
 (CELLSNET-42833) - Forma sovrapposta al testo nel risultante PDF

 (CELLSNET-42829) - Le caselle di controllo non sono allineate correttamente nel risultante PDF
 ...
 (CELLSNET-42831) - La forma si è spostata nel risultante PDF

(CELLSNET-42830) - Modifica della direzione della freccia nel risultante PDF

 (CELLSNET-42828) - Il risultato PDF ha una forma tagliata con una parte della croce non mostrata

 (CELLSNET-42798) - L'immagine del grafico a bolle non viene creata correttamente (dal grafico all'immagine)

 (CELLSNET-42920) - Il salvataggio di un file Excel XLSM crea un errore di contenuto illeggibile

 (CELLSNET-42909) - Le linee guida vengono nascoste quando si salva nuovamente il file modello XLSX
