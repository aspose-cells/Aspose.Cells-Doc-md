---
title: Aspose.Cells for .NET 8.0.0 Note di rilascio
type: docs
weight: 90
url: /it/net/aspose-cells-for-net-8-0-0-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 8.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.8.0/)
