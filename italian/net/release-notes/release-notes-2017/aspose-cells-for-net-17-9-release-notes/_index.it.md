---
title: Aspose.Cells for .NET 17.9 Note di rilascio
type: docs
weight: 40
url: /it/net/aspose-cells-for-net-17-9-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 17.9](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.9/).
...
|CELLSNET-44353|Controlla il caricamento delle risorse esterne nella cartella di lavoro di MS Excel|Nuova caratteristica|
|CELLSNET-40787|Perdi le revisioni dopo la conversione (XLS --> XLSM)|Nuova caratteristica|
|CELLSNET-45607|Mostra commento Cell come descrizione comando Excel - Aspose.Cells.GridWeb|Nuova caratteristica|
|CELLSNET-45559|L'etichetta della serie del prezzo delle azioni non è posizionata correttamente|Aumento|
|CELLSNET-45626|Eccezione: "Troppe voci. Prendi in considerazione l'impostazione di ZipOutputStream.Enable Zip64" durante l'unione dei file|Aumento|
|CELLSNET-45622|Perché FitToPagesWide 1 deve impostare FitToPagesTall 0 per Adatta tutte le colonne su una pagina|Aumento|
|CELLSNET-45576|Quando RecommendReadOnly è vero, anche IsWriteProtected è vero|Aumento|
...
|CELLSNET-45617|La larghezza della colonna viene modificata dopo il caricamento e il salvataggio di un file XLS|Insetto|
|CELLSNET-45616|Il grafico circolare e il grafico a colonne vengono modificati drasticamente dopo il ricaricamento e il salvataggio|Insetto|
|CELLSNET-45613|Workbook.RemoveUnusedStyles non funziona come previsto negli stili di tabella|Insetto|
|CELLSNET-45598|Indicatori intelligenti: più gruppi con salta sovrapposizione riga totale generale|Insetto|
|CELLSNET-45588|Excel deve riparare il file macro - Parte rimossa: parte /xl/vbaProject.bin|Insetto|
|CELLSNET-45623|Impossibile modificare le celle unite quando si imposta lo stato attivo con il clic del mouse - Aspose.Cells.GridDesktop|Insetto|
|CELLSNET-45565|Problema nell'utilizzo di righe/colonne raggruppate in GridWeb|Insetto|
|CELLSNET-45537|L'icona dell'immagine viene persa dopo aver modificato la cella B3|Insetto|
|CELLSNET-45448|Le colonne di gruppo non funzionano in GridWeb|Insetto|
|CELLSNET-45627|Il metodo PivotTable.CalculateData() genera System.IndexOutOfRangeException|Eccezione|
|CELLSNET-45610|NullReferenceException durante la lettura di XLSX utilizzando LoadFilter contenente la tabella pivot|Eccezione|
|CELLSNET-42702|Errore "Contenuto illeggibile" durante la creazione della tabella pivot|Eccezione|
|CELLSNET-45635|La stringa di input non era in un formato corretto - Eccezione all'apertura del file MS Excel|Eccezione|
...
#### **Aggiunge la proprietà OoxmlSaveOptions.EnableZip64**
...
- [Determina quale dimensione dello stack è necessaria per una determinata cartella di lavoro](/cells/it/net/aspose-cells-faqs/#aspose-cellsfaqs-determinewhichstacksizeisneededforacertainworkbook)
