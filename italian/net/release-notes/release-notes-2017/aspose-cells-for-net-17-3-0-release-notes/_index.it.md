---
title: Aspose.Cells for .NET 17.3.0 Note di rilascio
type: docs
weight: 100
url: /it/net/aspose-cells-for-net-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 17.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.3.0/).
...
1. [Personalizza le impostazioni di globalizzazione per la tabella pivot](/cells/it/net/customize-globalization-settings-for-pivot-table/)
1. [Esegui la funzione lato client al cambio di pagina GridWeb](/cells/it/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/it/net/execute-client-side-function-on-gridweb-page-change/)
1. [Convalida l'intero foglio di lavoro anziché solo le celle aggiornate](/cells/it/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
