---
title: Aspose.Cells for .NET 17.1.0 Note di rilascio
type: docs
weight: 120
...
|CELLSNET-45012|Prestazioni di GETPIVOTDATA|Prestazione|
|CELLSNET-45009|Le formule con GETPIVOTDATA non vengono ricalcolate nel file di output|Insetto|
|CELLSNET-45000|Alcune regole CSS ignorate durante l'importazione di HTML|Insetto|
|CELLSNET-44993|Le immagini nella tabella hanno una posizione errata|Insetto|
|CELLSNET-44990|Il colore del contenuto è stato cambiato|Insetto|
|CELLSNET-44989|Lo stile del contenuto è stato modificato|Insetto|
|CELLSNET-44987|I contenuti sono stati spostati|Insetto|
|CELLSNET-44982|Problema con l'override dello stile predefinito degli elementi TH|Insetto|
|CELLSNET-44980|La posizione della colonna è stata modificata durante l'aggiornamento della tabella pivot|Insetto|
|CELLSNET-44968|Le celle unite in XLSX non vengono visualizzate come unite in HTML|Insetto|
|CELLSNET-44962|Linee orizzontali e verticali mancano nella tabella pivot dopo la conversione del foglio di calcolo in PDF|Insetto|
|CELLSNET-44997|LoadOptions.LoadFilter non funziona come previsto|Insetto|
...
|CELLSNET-45008|Il colore del collegamento ipertestuale non cambia quando si fa clic in MS Excel|Insetto|
|CELLSNET-45007|Il foglio di calcolo viene danneggiato dopo un semplice caricamento e un nuovo salvataggio|Insetto|
|CELLSNET-44999|WorksheetCollection.CreateRange non sembra creare un intervallo|Insetto|
|CELLSNET-44996|I collegamenti freccia vengono interrotti tra gli oggetti nel flusso di processo quando si utilizzano le API Aspose.Cells|Insetto|
|CELLSNET-44992|Excel mostra il messaggio "Il nome non può essere uguale a un nome integrato" dopo il salvataggio con Aspose.Cells|Insetto|
