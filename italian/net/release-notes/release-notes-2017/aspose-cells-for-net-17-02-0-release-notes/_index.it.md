...
1. [Adatta colonne e righe durante il caricamento di HTML nella cartella di lavoro](/cells/it/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
...
1. [Taglia righe e colonne vuote iniziali durante l'esportazione di fogli di calcolo nel formato CSV](/cells/it/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
