---
title: Aspose.Cells for .NET 17.02.0 Note di rilascio
type: docs
weight: 110
url: /it/net/aspose-cells-for-net-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 17.02.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.02.0/).

{{% /alert %}} 

|**Chiave**|**Riepilogo**|**Categoria**|
|:- |:- |:- |
|CELLSNET-45049|Taglia righe e colonne vuote durante l'esportazione di fogli di calcolo in formato CSV|Nuova caratteristica|
...
|CELLSNET-45048|Il file PDF risultante non è compatibile con PDFA1B|Aumento|
...
|CELLSNET-45067|La conversione in PDF richiede troppo tempo|Prestazione|
|CELLSNET-45105|Il caricamento dell'HTML non riesce quando CultureInfo è francese|Insetto|
|CELLSNET-45089|Da HTML a Excel: il file Excel è corrotto|Insetto|
...
|CELLSNET-45039|La regola di stile misto non viene presa in considerazione durante il rendering dell'HTML in Excel|Insetto|
...
|CELLSNET-45130|Risultato diverso utilizzando Excel esporta PDF e Aspose.Cells salva come PDF|Insetto|
|CELLSNET-45095|L'immagine del foglio di calcolo non è stata convertita in PDF|Insetto|
|CELLSNET-45075|I collegamenti ipertestuali dal foglio di calcolo non vengono esportati in PDF|Insetto|
|CELLSNET-45074|Problema di formattazione nel rendering da Excel a PDF|Insetto|
...
1. [Adatta colonne e righe durante il caricamento dell'HTML nella cartella di lavoro](/cells/it/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Converti testo in colonne usando Aspose.Cells](/cells/it/net/convert-text-to-columns-using-aspose-cells/)
1. [Ottieni un elenco di caratteri utilizzati in un foglio di calcolo o in una cartella di lavoro](/cells/it/net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Ricevi avvisi durante il caricamento del file Excel](/cells/it/net/get-warnings-while-loading-excel-file/)
1. [Leggi e manipola i grafici di Excel 2016](/cells/it/net/read-and-manipulate-excel-2016-charts/)
1. [Taglia righe e colonne vuote iniziali durante l'esportazione di fogli di calcolo in formato CSV](/cells/it/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
1. [Associazione del foglio di lavoro a un oggetto raccolta personalizzato utilizzando GridWeb](/cells/it/net/binding-worksheet-to-a-customized-collection-object-using-gridweb/)
1. [Rinomina automaticamente le colonne duplicate durante l'esportazione dei dati del foglio di lavoro](/cells/it/net/rename-duplicate-columns-automatically-while-exporting-worksheet-data/)
1. [Dividi riquadri nel foglio di lavoro GridDesktop](/cells/it/net/split-panes-in-griddesktop-worksheet/)
