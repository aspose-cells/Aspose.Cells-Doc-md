...
|CELLSNET-44417 | API si blocca durante la conversione di un foglio di calcolo danneggiato e infetto in PDF| Prestazione|
...
|CELLSNET-44309 | Parentesi non mostrate ruotate nell'output PDF (conversione da Excel a PDF)| Insetto|
|CELLSNET-44302 | SheetRender.ToImage non esegue il rendering del bordo delle celle| Insetto|
|CELLSNET-43237 | I simboli verticali non vengono visualizzati correttamente durante la conversione dei fogli di calcolo in PDF| Insetto|
...
|CELLSNET-44398 | EMF il rendering del grafico non funziona correttamente nella versione più recente| Insetto|
...
|CELLSNET-44403 | La filigrana di sfondo viene rimossa durante il salvataggio da XLS a XLSX| Insetto|
