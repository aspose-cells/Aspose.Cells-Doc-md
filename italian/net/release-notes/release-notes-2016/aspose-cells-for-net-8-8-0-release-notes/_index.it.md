...
|CELLSNET-44342 | Il processo sembra bloccarsi con l'utilizzo della CPU al 100% per la conversione del foglio di calcolo a pagina singola in PDF| Prestazione|
|CELLSNET-44324 | XLSM viene danneggiato dopo aver ripopolato i dati e aggiornato la tabella pivot| Insetto|
|CELLSNET-44312 | Le interruzioni di riga vengono perse durante l'importazione di HTML e l'esportazione in un foglio di calcolo| Insetto|
|CELLSNET-44311 | I bordi vengono persi durante l'importazione di HTML e l'esportazione nel foglio di calcolo| Insetto|
...
|CELLSNET-44347 |API esegue il rendering di due PDF pagine per un foglio di lavoro indipendentemente dall'impostazione di OnePagePerSheet su true| Insetto|
...
|CELLSNET-44348 | Il numero viene arrotondato durante la conversione di HTML in formato foglio di calcolo| Insetto|
...
|CELLSNET-44355 |L'indice era al di fuori dei limiti dell'eccezione di matrice durante la conversione di Excel in PDF| Eccezione|
|CELLSNET-44354 | Errore da forma a immagine durante la conversione di Excel in PDF| Eccezione|
...
|CELLSNET-44326 | Facendo clic su una cella, il testo formattato viene modificato nella sua origine HTML| Insetto|
