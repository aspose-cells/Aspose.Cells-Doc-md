...
|CELLSNET-46220|Imposta l'opzione ContentCopyForAccessibility durante la conversione del foglio di calcolo in formato file PDF|Nuova caratteristica|
...
|CELLSNET-46209|Supporta la lettura e la scrittura DConn di file XLS|Nuova caratteristica|
...
|CELLSNET-44761|Il testo in una forma non è stato visualizzato correttamente nel PDF|Insetto|
|CELLSNET-43916|Manca l'ombreggiatura della forma durante la conversione del foglio di calcolo in HTML|Insetto|
|CELLSNET-46251|L'applicazione si blocca durante la conversione di XLSX in HTML|Insetto|
|CELLSNET-46241|Problema con le multilinee in HTML|Insetto|
|CELLSNET-46219|La larghezza del tag HTML non viene seguita durante la conversione da HTML a XLSX|Insetto|
...
|CELLSNET-46275|PDF di grandi dimensioni creato da XLS|Insetto|
|CELLSNET-46259|La conversione di Excel in PDF aggiunge una linea retta|Insetto|
|CELLSNET-46255|Problema del numero di pagina (nel piè di pagina) nel rendering da Excel a PDF|Insetto|
|CELLSNET-46238|Caricamento del file ODS crittografato non riuscito|Insetto|
|CELLSNET-46231|Il testo nelle celle della colonna A non viene visualizzato correttamente nel PDF di output|Insetto|
|CELLSNET-46165|Aspose.Cells smette di rispondere quando si tenta di convertire un file Excel in formato file PDF|Insetto|
|CELLSNET-46236|File MS Excel danneggiato dopo l'anonimizzazione|Insetto|
|CELLSNET-45192|Il file XLS salvato viene visualizzato in modalità protetta|Insetto|
|CELLSNET-46235|L'immagine non può essere visualizzata durante il salvataggio in formato XLS|Insetto|
