...
|CELLSNET-46383|Problema con l'origine dell'immagine durante il rendering del formato di file da Excel a HTML|Insetto|
|CELLSNET-46367|La dimensione del carattere è cambiata da 6,5 a 6 durante la conversione di XLSX in HTML|Insetto|
|CELLSNET-46353| Riconosci i tag vuoti come<td /> durante la conversione da HTML a formato di file MS Excel|Insetto|
...
|CELLSNET-42681|Il file XLSB viene danneggiato all'apertura e al salvataggio|Insetto|
|CELLSNET-46382|L'importazione CSV crea una formattazione errata utilizzando PreferredParsers|Insetto|
...
|CELLSNET-46321|Il carattere di escape viene visualizzato così com'è nel PDF|Insetto|
|CELLSNET-46376|Le dimensioni della pagina di output PDF (e i margini) non corrispondono all'output di MS Excel|Insetto|
...
|CELLSNET-46357|I file XLSB non possono essere aperti utilizzando LoadDataFilterOption diverso da LoadDataFilterOption.All|Insetto|
