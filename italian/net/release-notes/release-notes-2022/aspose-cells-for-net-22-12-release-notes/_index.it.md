...
|CELLSNET-47895|Le immagini sono distorte in Excel al rendering PDF/HTML|
...
|CELLSNET-52330|Forme di disegno non rese correttamente in HTML|
...
|CELLSNET-52301|XLSX Da grafico a immagine: barre del grafico combinate personalizzate visualizzate in modo errato|
|CELLSNET-52336|Il grafico dell'istogramma non viene visualizzato correttamente nella conversione da XLSX a HTML/PDF|
|CELLSNET-52292|Il testo viene visualizzato nella pagina errata nell'output PDF - Conversione da Excel a PDF|
|CELLSNET-52367|AutofitRows genera un testo ritagliato nell'output di conversione PDF|
...
|CELLSNET-52298|L'opzione Ordinamento automatico è abilitata per il campo pivot quando si salva nuovamente XLSX|
|CELLSNET-52299| L'attributo HasRevisions non è corretto dopo il salvataggio di una cartella di lavoro|
|CELLSNET-52332|Numbers vengono visualizzati come '#' o numero scientifico durante la conversione in html|
|CELLSNET-52338| L'output HTML non è deterministico|
