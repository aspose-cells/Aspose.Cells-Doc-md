---
title: Aspose.Cells for .NET 5.0.0 Note di rilascio
type: docs
weight: 70
url: /it/net/aspose-cells-for-net-5-0-0-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 5.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.0.0/)

{{% /alert %}} 

 Siamo felici di rilasciare Aspose.Cells for .NET v5.0.0!

 Cosa è cambiato in Aspose.Cells:

- Include il supporto del formato di file XLSB di MS Excel 2007.
 Fornisce la funzione Copia e incolla speciale.
 Supporta l'ordinamento dei marcatori intelligenti.
37 miglioramenti e correzioni.

 Cosa è cambiato in Aspose.Cells.GridWeb:

- Supporta l'occultamento del menu contestuale.
...
- Supporta la copia di ComboBox e fornisce un gestore eventi per confrontare elementi e valori dei due ComboBox.
 Include la funzione di rotazione del testo per i dati delle celle.
 Ottiene la posizione della cella in base alle coordinate/punti del cliente.

 Problemi risolti in Aspose.Cells for .NET v5.0.0.
...
- Aspose.Cells
 ...
 Aspose.Cells.Disegno
 Aspose.Cells.Rendering
 Aspose.Cells.Pivot
 Aspose.Cells.Tavoli
 Aspose.Cells.Proprietà
