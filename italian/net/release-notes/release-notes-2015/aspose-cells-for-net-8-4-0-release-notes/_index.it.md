---
title: Aspose.Cells for .NET 8.4.0 Note di rilascio
type: docs
weight: 100
url: /it/net/aspose-cells-for-net-8-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 8.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.0/)
...
## **Miglioramenti**
 ...
 (CELLSNET-43368) - Personalizzazione della generazione di CSS durante il salvataggio di Excel in HTML
 ...
 (CELLSNET-43408) - L'intera cartella di lavoro avrà il testo in grassetto

 (CELLSNET-43357) - Excel ha trovato contenuto illeggibile dopo aver impostato la password
...
(CELLSNET-43460) - Colore di sfondo: rgba(0, 0, 0, 0); rende il colore di sfondo nero
 ...
 (CELLSNET-43390) - I dati nelle tabelle pivot statiche vengono riorganizzati

 (CELLSNET-43369) - Le tabelle pivot etichettano sempre la prima colonna come "Etichette riga"

 (CELLSNET-43358) - La specifica dell'attributo BaseItemPosition produce un file non valido

 (CELLSNET-43354) - Problema relativo al calcolo della tabella pivot: il valore della cella viene troncato

 (CELLSNET-43337) - PivotTable.RefreshData danneggia il contenuto
...
(CELLSNET-43414) - Lo spazio tra l'intestazione e il corpo è diverso
 ...
 (CELLSNET-43385) - Rendering errato del titolo del grafico durante la conversione del grafico in immagine

 (CELLSNET-43378) - Rendering errato del titolo del grafico durante la conversione del grafico in immagine
...
(CELLSNET-43339) - I grafici non vengono visualizzati correttamente nel PDF di output
 ...
 (CELLSNET-42558) - Etichette sovrapposte durante il rendering del grafico a torta

 (CELLSNET-41725) - Etichette dati grafico a torta sovrapposte

 (CELLSNET-41001) - Problema con i grafici a torta OLE Etichette dati/linee direttrici

 (CELLSNET-43466) - Problema con la formula dell'array

 (CELLSNET-43463) - I valori Cell vengono sostituiti dai valori di altre celle
...
(CELLSNET-43423) - PageSetup.IsHFAlignMargins diventa automaticamente true nel file Excel di output
 ...
 (CELLSNET-43407) - Formattazione condizionale - Cells non dovrebbe avere lo sfondo rosso

 (CELLSNET-43401) - Errore "Formato dati non valido" dopo la manipolazione dei codici VBA

 (CELLSNET-43398) - La formula aggiornata non viene salvata quando contiene un riferimento esterno

 (CELLSNET-43396) - Si è verificato un errore con le immagini nel file modello

 (CELLSNET-43363) - Il valore della formula non viene calcolato correttamente da Workbook.CalculateFormula

 (CELLSNET-43355) - Incoerenza della proprietà del documento incorporata nel foglio di calcolo "Versione"

 (CELLSNET-43346) - Il formato del collegamento ipertestuale cambia durante la copia dell'intervallo
...
(CELLSNET-43335) - Problema con il rendering della formattazione condizionale - Da Excel a PDF
 ...
 (CELLSNET-43293) - La rimozione del bordo non funziona nel file Excel di output


## **Eccezioni**


 (CELLSNET-43459) - Colore di sfondo: rgba(255, 255, 255, 0.1); genera un'eccezione.

 (CELLSNET-43442) - L'elemento RGBA all'interno di TD genera un'eccezione

 (CELLSNET-43406) - System.IndexOutOfRangeException in PivotTable.CalculateData

 (CELLSNET-43373) - PivotTable.RefreshData genera un'eccezione

 (CELLSNET-43320) - Eccezione di riferimento null durante il salvataggio come html

 (CELLSNET-43314) - Eccezione generata durante l'apertura di un file XLS

 (CELLSNET-43312) - L'indice non rientrava nell'intervallo durante l'aggiornamento della tabella pivot
...
## **Insetti**
 ...
 (CELLSNET-43437) - Manca WebCells.SetRowCaption()

 (CELLSNET-43435) - Problema con il colore di sfondo di Grid - GridWeb

 (CELLSNET-43430) - L'allineamento delle righe GridWeb non è corretto
