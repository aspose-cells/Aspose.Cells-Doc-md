---
title: Aspose.Cells for .NET 7.1.0 Note di rilascio
type: docs
weight: 110
url: /it/net/aspose-cells-for-net-7-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for .NET 7.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.1.0/)

{{% /alert %}} 

 Siamo felici di annunciare Aspose.Cells per .NETv7.1.0!
...
- NullReferenceException quando si apre un documento con una tabella pivot con formattazione automatica
- Filtraggio della tabella pivot in MS Excel 2007 e versioni successive
- Problema di formattazione del grafico
- La copia del foglio di lavoro non funziona
- Conversione di tag marcatori intelligenti
- Proprietà mancanti (tabella pivot)

 -Proprietà mancanti (campo pivot)
...
- Problema di prestazioni durante l'aggiunta di nomi di intervalli
- Eccezione di memoria e calcoli di formule sulle celle

 Eccezioni

- Impossibile copiare un determinato foglio di lavoro in un'altra cartella di lavoro

 -La tabella pivot genera un'eccezione durante l'aggiornamento

- ListBox con intervallo di input assegnato provoca la compressione di Aspose.Cells
...
- Errore del metodo Workbook.CalculateFormula()
- Diversi problemi rilevati durante l'aggiornamento da v5.2.1.0 a v7.0.3.0
- Impossibile includere intestazioni riga/colonna e commenti nel file TIFF
...
- Il file XLS blocca MS Excel 2007
...
- Funzionalità di raggruppamento dei dati di MS Excel durante l'importazione in GridDesktop
