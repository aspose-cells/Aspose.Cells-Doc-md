---
title: Funzionamento di GridWeb quando la modalità stato sessione ASP.NET è SQL Server
type: docs
weight: 160
...
## **Funzionamento di GridWeb quando la modalità stato sessione ASP.NET è SQL Server**
