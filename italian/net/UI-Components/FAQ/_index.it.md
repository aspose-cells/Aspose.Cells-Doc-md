...
Sì, Aspose.Cells I controlli della griglia sono completamente supportati in Visual Studio.NET 2005 e versioni successive.
## **Sto usando il controllo Aspose.Cells.GridWeb nel mio sito web usando Visual Studio.NET 2005. Ma non funziona affatto. Qual è il problema?**
 Aspose.Cells.GridWeb supporta entrambi**Sistema di file** e**http** modalità di Visual Studio.NET 2005. Se sei ancora confuso, dai un'occhiata a una guida passo passo per Lavorare con Aspose.Cells.GridWeb utilizzando Visual Studio.NET 2005.
