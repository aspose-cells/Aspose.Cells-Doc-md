---
title: come personalizzare l aspetto dell UI per il messaggio toast in GridJs  
type: docs
weight: 250
url: /it/net/aspose-cells-gridjs/how-to-customize-toast/
description: Questo articolo descrive come personalizzare l aspetto dell UI per i toast dei messaggi in GridJs.
keywords: GridJs,personalizzare,toast,UI,apparecchio,visivo,messaggio,avviso
aliases:
aliases:
...
- [Esempi di Integrazione](#integration-examples)
  - [Bellissimo Toast Personalizzato](#1-beautiful-custom-toast)
...
**Parametri:**
- `title` (stringa): Titolo della notifica toast
- `content` (stringa): Contenuto del messaggio toast
...
- `progressBar`: Visualizza una barra di progresso countdown
