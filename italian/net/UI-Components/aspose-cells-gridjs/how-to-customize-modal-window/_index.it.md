---
title: come personalizzare l aspetto dell interfaccia utente per la finestra modale in GridJs  
type: docs
weight: 250
url: /it/net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Questo articolo descrive come personalizzare l aspetto dell interfaccia utente per la finestra modale in GridJs.
keywords: GridJs,personalizza,finestra,interfaccia utente,aspett,visivo,finestra
aliases:
aliases:
...
# Guida allo stile delle modali per GridJs

## Indice dei Contenuti

- [Panoramica](#overview)
- [Naming delle classi CSS](#css-class-naming)
- [Avvio rapido](#quick-start)
- [Esempi di stile belli](#beautiful-style-examples)
- [Galleria dei temi](#theme-gallery)
...
## Naming delle classi CSS

### Nomi modali disponibili

| Tipo di Modale | Nome | Classe CSS |
|------------|------|-----------|
| Ordinamento | `sort` | `.x-spreadsheet-modal-sort` |
| Validazione | `validation` | `.x-spreadsheet-modal-validation` |
| Ricerca | `search` | `.x-spreadsheet-modal-search` |
| Controllo | `control` | `.x-spreadsheet-modal-control` |
| Scarica | `download` | `.x-spreadsheet-modal-download` |
| Email | `email` | `.x-spreadsheet-modal-email` |
| SuggerimentoInput | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| InserisciURL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| Collegamento | `link` | `.x-spreadsheet-modal-link` |
| Stampa | `print` | `.x-spreadsheet-modal-print` |
| RotazioneTesto | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| ValidazioneDati | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| FormatiNumeriAvanzati | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| AvvisoValidazione | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| InserisciElimina | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Esempio 2: Tema Minimalista Pulito 🤍

Ideale per applicazioni professionali ed enterprise.
...
### Esempio 3: Tema Modalità Scura 🌙

Perfetto per applicazioni con supporto alla modalità scura.
...
### Esempio 4: Tema Giocoso e Colorato 🌈

Perfetto per applicazioni creative e divertenti.
...
### Esempio 5: Tema Aziendale Professionale 💼

Adatto per applicazioni business e aziendali.
...
### 7. Mantenere la Gerarchia Visiva
