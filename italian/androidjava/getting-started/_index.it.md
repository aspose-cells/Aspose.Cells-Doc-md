...
|Microsoft Cartella di lavoro di Excel (XLS/XLSB)|L'implementazione del formato XLS/XLSB più veloce e completa che puoi trovare.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Renderizza le pagine del foglio di lavoro in immagini raster (multipagina TIFF, GIF).|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
