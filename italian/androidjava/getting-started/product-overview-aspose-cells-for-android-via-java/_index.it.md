---
title: Panoramica del prodotto - Aspose.Cells per Android tramite Java
type: docs
weight: 60
url: /it/java/product-overview-aspose-cells-for-android-via-java/
---
{{% alert color="primary" %}} 

![cell-logo](50528297.png)

Benvenuti allo Aspose.Cells per Android tramite la documentazione Java!
...
- Imposta il livello di zoom di un foglio di lavoro.
- Rendi visibili i dati selezionati durante lo scorrimento utilizzando i riquadri di blocco.
## **Protezione del foglio di lavoro**
- Proteggi i contenuti del foglio di lavoro, gli oggetti e gli scenari.
## **Opzioni di impostazione della pagina**
- Imposta l'orientamento della pagina, il ridimensionamento, il formato della carta e la qualità di stampa.
- Imposta i margini della pagina in alto, a sinistra, a destra e in basso.
- Imposta intestazioni e piè di pagina.
- Impostare l'area di stampa e il titolo di stampa.
...
- Applicare diversi tipi di**Impostazioni carattere** per lo Cells
- Applica colori diversi a Cells, caratteri, griglia, oggetti grafici ecc.
...
-  Supporti**Calcoli di formule** utilizzando un robusto motore di calcolo delle formule
-  Modificare**Dati di origine di una tabella pivot** in fase di esecuzione
