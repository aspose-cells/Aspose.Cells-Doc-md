...
|CELLSJAVA-43234|Dati precedenti al 2014 non letti dalla tabella pivot|Insetto|
...
|CELLSJAVA-43288|Il file XLSB risultante è danneggiato durante il salvataggio del file in XLSB|Insetto|
...
Questa interfaccia a volte causa ambiguità e incomprensioni per gli utenti. L'utente dovrebbe invece utilizzare AbstractCalculationEngine che fornisce API più convenienti e flessibili per la manipolazione di funzioni personalizzate.

### **Contrassegna la proprietà CalculationOptions.CustomFunction come obsoleta.**

 Si prega di utilizzare**Motore di calcolo astratto** invece di**IFunzione personalizzata** di**CalculationOptions.CustomEngine** proprietà.
...
### **Aggiunge il metodo Cells.RemoveDuplicates().**
 ...
 Metodo sovraccarico di**Cells. Rimuovi duplicati (...)** per comodità dell'utente per rimuovere le righe duplicate nell'intero foglio.
...
### **Proprietà Filter.Visibledropdown obsoleta.**
 ...
 Uso**FilterColumn.IsDropdownVisible** invece.
