---
title: Barre di comando
type: docs
weight: 10
url: /it/reportingservices/command-bars/
---
La tabella seguente mostra le icone e gli strumenti delle barre dei comandi sulla barra degli strumenti del componente aggiuntivo Aspose.Cells.Report.Designer.
...
| Imposta attributo|![cose da fare:immagine_alt_testo](command-bars_9.png)| Imposta alcuni degli attributi del report: nome del report, intervallo del report, campi del gruppo, campi dell'ordine e così via.|
| Modifica attributo|![cose da fare:immagine_alt_testo](command-bars_10.png)| Modifica alcuni degli attributi del report: nome del report, intervallo del report, campi del gruppo, campi dell'ordine e così via.|
| Imposta piè di pagina|![cose da fare:immagine_alt_testo](command-bars_11.png)| Inserisce '##footer' nella cella.|
