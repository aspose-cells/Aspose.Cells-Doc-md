...
---
 Aspose.Cells per Reporting Services supporta tre tipi di crittografia: XOR, WEAK ENCRYPTION e Microsoft Strong Cryptographic Provider. Vedere le informazioni sulla configurazione della crittografia nel file**Aspose.Cells.ReportingServices.xml** file.

 Quando il valore di Encryption è**spento**, Aspose.Cells per Reporting Services disattiva le funzionalità di crittografia.
...
{{< /highlight >}}
 ...
 Quando il valore di Encryption è**Su**, Aspose.Cells per Reporting Services attiva la crittografia.
