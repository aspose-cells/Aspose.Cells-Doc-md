...
Aspose.Cells per Reporting Services contiene principalmente due componenti: Aspose.Cells.Report.Designer e Aspose.Cells.Renderer per Reporting Services. Il primo viene utilizzato per progettare report direttamente in Microsoft Excel e il secondo è responsabile del rendering di un report RDL in Microsoft Excel.
...
Quando si seleziona un report per l'anteprima sul server di report, viene richiesto di specificare il formato file in cui esportarlo (ad esempio Microsoft formato XLS binario Excel 97-2003, SpreadsheetML o Microsoft formato XLSX Excel 2007) e gli eventuali parametri del report di input creati durante la progettazione del rapporto. Successivamente, il report viene popolato con i dati forniti da Reporting Services.
