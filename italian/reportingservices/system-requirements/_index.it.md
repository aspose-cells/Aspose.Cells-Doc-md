...
Aspose.Cells per Reporting Services (incluso il client Aspose.Cells.ReportingServices, i componenti aggiuntivi per Microsoft Excel e Aspose.Cells.ReportingServices Server) deve essere installato correttamente. Inoltre, Microsoft SQL Server deve essere installato prima di installare Aspose.Cells per Reporting Services.
