...
- Funzionalità/modulo della tabella pivot
 è ulteriormente ottimizzato



 Fissazione generale e miglioramenti



 Abbiamo corretto i seguenti bug interni/generali e migliorato i moduli:



- Insetto del colore di sfondo del pastore
- Nascondi problema colonna
- Modulo algoritmo di unione di righe
- Problema di interruzioni di pagina
- Bug dei collegamenti ipertestuali e dei collegamenti ai segnalibri
- Errore/problema dell'ETA
- Modulo algoritmo di riga
- Output di Excel 2007 (solo dati).
 insetto
...
- ServerComponent: genera un file XLSX anziché CSV se un utente seleziona il tipo di esportazione CSV
- ServerComponent: impossibile esportare un report a schede incrociate in MS Excel 2007
- Componente server - Problema di codifica dell'esportazione CSV
