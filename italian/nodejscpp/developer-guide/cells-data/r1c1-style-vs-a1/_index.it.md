...
type: docs
weight: 30
url: /it/nodejs-cpp/r1c1-reference-style-vs-a1/
description: Riferimento stile R1C1 VS. stile A1 usando Aspose.Cells for Node.js via C++.
keywords: Riferimento stile R1C1 VS. stile A1 Node.js via C++, Riferimento stile R1C1 Node.js via C++, Come passare tra stile R1C1 e stile A1 Node.js via C++, Stile A1 Node.js via C++.
---
