...
type: docs
weight: 130
url: /it/nodejs-cpp/how-to-insert-picture-in-cell/
description: Scopri come inserire un immagine in una cella con Aspose.Cells.
...
## **Come inserire una foto in una cella usando Aspose.Cells for Node.js via C++**
