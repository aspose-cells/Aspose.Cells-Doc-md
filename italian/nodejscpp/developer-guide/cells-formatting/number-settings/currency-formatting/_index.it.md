...
type: docs
weight: 10
url: /it/nodejs-cpp/format-number-to-currency/
description: Questo articolo introdurrà come formattare il numero in valuta utilizzando l API Aspose.Cells for Node.js via C++.
...
Per formattare i numeri come valuta nella libreria Aspose.Cells for Node.js via C++ per lavorare con i file Excel, puoi applicare la formattazione valuta alle celle programmaticamente. Ecco come puoi farlo usando Aspose.Cells for Node.js via C++:
