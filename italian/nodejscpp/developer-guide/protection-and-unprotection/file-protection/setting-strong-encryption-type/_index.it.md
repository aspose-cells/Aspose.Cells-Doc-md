---  
title: Impostare il tipo di crittografia forte con Node.js tramite C++  
linktitle: Impostazione del tipo di crittografia forte  
type: docs  
weight: 60  
url: /it/nodejs-cpp/setting-strong-encryption-type/  
description: Impara come impostare tipi di crittografia forti per i file Excel usando Aspose.Cells for Node.js via C++.  
---  
