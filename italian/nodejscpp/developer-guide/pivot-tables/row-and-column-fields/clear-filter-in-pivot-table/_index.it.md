...
type: docs
weight: 130
url: /it/nodejs-cpp/clear-filter-in-pivot-table/
description: Come cancellare il PivotFilter da un campo pivot specifico nella tabella pivot con Aspose.Cells for Node.js via C++.
keywords: Aspose.Cells for Node.js via C++ Excel, libreria Excel Node.js, cancella il PivotFilter nella tabella pivot usando la libreria Excel Aspose.Cells for Node.js via C++.
---

## **Possibili Scenari di Utilizzo**
Quando crei una tabella pivot con dati noti e vuoi filtrarla, devi imparare e usare il filtro. Può aiutarti a filtrare efficacemente i dati desiderati. Usando l'API Aspose.Cells for Node.js via C++, puoi operare il filtro sui valori dei campi nelle tabelle pivot. 
...
## **Come cancellare il filtro in una tabella pivot usando Aspose.Cells for Node.js via C++**
Cancella il filtro in una tabella pivot usando Aspose.Cells for Node.js via C++. Consulta il seguente esempio di codice. 
