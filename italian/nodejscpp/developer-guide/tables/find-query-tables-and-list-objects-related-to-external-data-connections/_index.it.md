---
title: Trova tabelle di query e oggetti di elenco relativi a connessioni di dati esterni con Node.js tramite C++
linktitle: Trova Tabelle di Query e Oggetti Elenco relativi a Connessioni Dati Esterne
type: docs
weight: 20
url: /it/nodejs-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: Impara come trovare Query Tables e Oggetti Liste correlati alle Connessioni a Dati Esterni usando Aspose.Cells for Node.js via C++.
---
