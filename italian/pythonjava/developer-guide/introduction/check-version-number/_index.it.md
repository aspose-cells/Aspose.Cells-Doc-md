...
## **Controllare il numero di versione utilizzando Aspose.Cells API**
 ...
 Per scoprire quale versione di Aspose.Cells stai usando attraverso lo API, usa il[CellsHelper](https://reference.aspose.com/cells/python-java/asposecells.api/cellshelper) class GetVersion metodo statico per ottenere il numero di versione di Aspose.Cell.
