...
Quando il file Excel viene convertito in HTML, Aspose.Cells aggiunge commenti condizionali rivelati di livello inferiore nel file di output HTML. Questi commenti condizionali sono per lo più rilevanti per le vecchie versioni di Internet Explorer e sono irrilevanti nei browser moderni. Per ulteriori informazioni sui commenti condizionali rivelati di livello inferiore, visitare il seguente collegamento
