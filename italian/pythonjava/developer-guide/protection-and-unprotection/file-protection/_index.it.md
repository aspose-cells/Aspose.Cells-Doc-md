...
description: Come crittografare e decrittografare i file Excel utilizzando Python. Blocca e sblocca i file Excel.
---
{{% alert color="primary" %}}
...
Aspose.Cells for Python consente di crittografare e proteggere con password i file di Microsoft Excel con il tipo di crittografia desiderato.
