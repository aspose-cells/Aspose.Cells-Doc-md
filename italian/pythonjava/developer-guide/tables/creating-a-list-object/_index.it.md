...
## **Creazione di un oggetto elenco utilizzando l'API Aspose.Cells**
...
Nell'esempio fornito di seguito, abbiamo creato lo stesso[**ElencoOggetto**](https://reference.aspose.com/cells/python/asposecells.api/ListObject)utilizzando l'API Aspose.Cells for Python via Java come abbiamo creato utilizzando Microsoft Excel nella sezione precedente.
