---
title: Aspose.Cells per Python tramite Java 22.7 Note di rilascio
type: docs
weight: 6
url: /it/python-java/aspose-cells-for-python-via-java-22-7-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per Python tramite Java 22,7](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.7/).
