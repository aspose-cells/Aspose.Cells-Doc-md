---
title: Aspose.Cells for Python via Java 22.5 Note di rilascio
type: docs
weight: 8
...
{{% alert color="primary" %}}
 ...
 Questa pagina contiene le note di rilascio per[Aspose.Cells for Python via Java 22.5](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.5/).
