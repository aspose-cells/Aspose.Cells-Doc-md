---
title: Aspose.Cells for Python via Java 21.12 Note di rilascio
type: docs
weight: 1
...
{{% alert color="primary" %}}
 ...
 Questa pagina contiene le note di rilascio per[Aspose.Cells for Python via Java 21.12](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.12/).
