---
title: Aspose.Cells per Python tramite Java 21.11 Note di rilascio
type: docs
weight: 2
url: /it/python-java/aspose-cells-for-python-via-java-21-11-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells per Python via Java 21.11](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.11/).
