---
title: Aspose.Cells for Python via Java Note sulla versione 21.11
type: docs
weight: 2
...
{{% alert color="primary" %}}
 ...
 Questa pagina contiene le note di rilascio per[Aspose.Cells for Python via Java 21.11](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.11/).
