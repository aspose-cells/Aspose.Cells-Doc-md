---
title: Aspose.Cells for Python via Java 20.2 Note di rilascio
type: docs
weight: 10
url: /it/python-java/aspose-cells-for-python-via-java-20-2-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells for Python via Java 20.2.
...
|CELLSJAVA-43107|Conversione in PDF - com.aspose.cells.CellsException: errore da forma a immagine|Insetto|
...
Di seguito è riportato un elenco di eventuali modifiche apportate al pubblico API come membri aggiunti, rinominati, rimossi o deprecati, nonché qualsiasi modifica non compatibile con le versioni precedenti apportata a Aspose.Cells for Python via Java. In caso di dubbi su qualsiasi modifica elencata, si prega di segnalarlo sul forum di supporto Aspose.Cells.
