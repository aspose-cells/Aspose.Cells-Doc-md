---
title: Gestisci i titoli dei grafici di Excel
linktitle: Titoli
type: docs
weight: 50
...
Nei grafici di Excel, ci sono 2 tipi di titolo:
1.  Titolo grafico
1. Titoli degli assi
...
## **Opzioni titolo**
 Aspose.Cells permette anche di gestire i titoli dei grafici in fase di esecuzione，con[Titolo](https://reference.aspose.com/cells/java/com.aspose.cells/Title) oggetto, è possibile modificare il testo, il carattere e il formato di riempimento dei titoli.
