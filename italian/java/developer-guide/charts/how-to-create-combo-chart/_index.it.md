...
type: docs
weight: 73
url: /it/java/create-combo-chart/
description: Come creare un grafico combinato, come aggiungere un grafico di mercato con un grafico a linee, come generare un grafico combinato.
keywords: Aggiungi grafico a combinazione, Crea grafico azionario con grafico a linee, Genera grafico a combinazione, aggiungi grafico azionario con grafico a linee.
---
...
Prendendo il seguente set di dati come esempio, possiamo osservare che questi dati sono piuttosto simili ai dati citati in [**VHCL**](https://docs.aspose.com/cells/java/create-volume-high-low-close-stock-chart/). Se vogliamo visualizzare series0, che corrisponde a "Ricavo totale," come un grafico a Linee, come dovremmo procedere?
