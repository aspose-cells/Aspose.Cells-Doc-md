...
description: Scopri come distinguere tra l'asse X e l'asse delle categorie in Aspose.Cells for Java. La nostra guida ti aiuterà a comprendere le differenze nel loro utilizzo e proprietà e come configurarli in base alle tue esigenze.
...
![cose da fare:immagine_alt_testo](compare.png)
 ...
 Il seguente codice di esempio genera il file[file Excel di output](XAxis.xlsx).
