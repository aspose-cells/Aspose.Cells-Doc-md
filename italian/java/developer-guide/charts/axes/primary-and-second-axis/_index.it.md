---
title: Asse primario e secondario
description: Scopri come comprendere e lavorare con assi primari e secondari in Aspose.Cells for Java. La nostra guida ti aiuterà a capire le differenze tra assi primari e secondari e come configurarli e usarli in modo efficace nei tuoi grafici.
keywords: Aspose.Cells for Java, assi primari, assi secondari, comprensione, differenze, configurazione, utilizzo.
type: docs
weight: 190
url: /it/java/primary-and-second-axis/
---
...
Il seguente codice di esempio genera il [file Excel di output](PrimaryandSecondaryAxis.xlsx).
