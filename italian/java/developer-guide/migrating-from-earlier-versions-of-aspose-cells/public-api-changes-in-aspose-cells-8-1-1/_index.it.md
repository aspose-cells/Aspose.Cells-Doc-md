...
La classe HtmlSaveOptions ha esposto getter/setter per la proprietà PresentationPreference che può essere utilizzata per eseguire il rendering dei risultati con un layout migliore durante l'esportazione di fogli di calcolo in HTML o MHTML. Il valore predefinito è false. mentre se impostato su true, Aspose.Cells API esporta il contenuto del foglio di lavoro con una migliore presentazione.
