...
Puoi riempire la superficie della forma con un'immagine e affiancarla usando il[**Shape.Fill.TextureFill.IsTiling**](https://reference.aspose.com/cells/java/com.aspose.cells/texturefill#IsTiling) proprietà e impostarla**VERO** . Si prega di vedere il seguente codice di esempio, its[esempio di file Excel](46465055.xlsx) , suo[file Excel di output](46465056.xlsx) così come lo screenshot per riferimento.
