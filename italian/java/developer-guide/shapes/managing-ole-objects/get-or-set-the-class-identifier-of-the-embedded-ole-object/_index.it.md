...
## **Ottenere o impostare l'identificatore di classe dell'oggetto OLE incorporato**
 Lo screenshot seguente mostra l'Ole Object Class Identifier, ovvero il GUID che è stato letto dal file[file excel di esempio](5473378.xls) contenente l'oggetto ole PowerPoint incorporato.
