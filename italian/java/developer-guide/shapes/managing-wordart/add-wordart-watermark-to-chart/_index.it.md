---
title: Aggiungi filigrana WordArt al grafico
type: docs
weight: 40
url: /it/java/add-wordart-watermark-to-chart/
---
{{% alert color="primary" %}}
...
![cose da fare:immagine_alt_testo](add-wordart-watermark-to-chart_1.png)
