...
description: Scopri come trovare la posizione assoluta della forma all'interno del foglio di lavoro tramite le API Aspose.Cells for Java.
...
##  **Spiegazione delle proprietà Shape.getLeftToCorner() e Shape.getTopToCorner()**
 ...
 Questa schermata spiega quali sono le distanze[**Shape.getLeftToCorner()**](https://reference.aspose.com/cells/java/com.aspose.cells/shape#LeftToCorner) E[**Shape.getTopToCorner()**](https://reference.aspose.com/cells/java/com.aspose.cells/shape#TopToCorner)misura delle proprietà.
...
Nell'esempio di codice seguente viene visualizzata la posizione assoluta della prima forma in un foglio di lavoro in pixel. Il codice visualizza il seguente output nella console:
