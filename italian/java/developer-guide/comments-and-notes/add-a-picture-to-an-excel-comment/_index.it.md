---
title: Aggiungere un immagine a un commento di Excel
type: docs
weight: 60
url: /it/java/add-a-picture-to-an-excel-comment/
---
...
1. Scegliere **Mostra/Nascondi commenti** e cancellare eventuali testi dal commento.
1. Fare clic sul bordo del commento per selezionarlo.
1. Scegliere **Formato**, quindi **Commento**.
...
1. Trova e seleziona l'immagine
1. Fai clic su **OK**.
