...
- Obsoleto il metodo *PivotItem.move(int count)*, pertanto, si consiglia di utilizzare il nuovo metodo [**PivotItem.move(int count, boolean isSameParent)**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotitem#move(int,%20boolean)) al suo posto.
