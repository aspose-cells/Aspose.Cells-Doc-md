...
4. Nel campo "Nome", inserire un nome per il campo calcolato.
 5. Nel campo "Formula", immettere la formula che si desidera eseguire utilizzando i nomi dei campi della tabella pivot e gli operatori matematici appropriati.
<br>
...
Vedere il seguente codice di esempio. Il codice imposta prima i dati originali e crea una tabella pivot. Quindi crea il campo calcolato in base al PivotField esistente nella tabella pivot e aggiungi il campo calcolato all'area dati. Infine, salva la cartella di lavoro in[uscita XLSX](out.xlsx) formato. Dopo aver eseguito il codice di esempio, al foglio di lavoro viene aggiunta una tabella pivot con campo calcolato.
