...
---
{{% alert color="primary" %}}
Se i file Excel (xlsx, xlsb, xls, xlsm) e Open Office (ODS) sono bloccati con password, Aspose.Cells for Java supporta la semplice verifica della password senza analizzare dati specifici dei file.
{{% /alert %}}
