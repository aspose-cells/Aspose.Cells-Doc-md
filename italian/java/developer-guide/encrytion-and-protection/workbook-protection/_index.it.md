...
description: Proteggere e difendere la struttura del workbook dei file di Excel utilizzando codici Java. Bloccare e sbloccare i file di Excel (xlsx, xls, xsb) e Open office calc (ODS) utilizzando Aspose.Cells for Java.
---
...
## **Proteggere la Struttura della Cartella di Lavoro Utilizzando Aspose.Cell per Java**
...
## **Sbloccare la Struttura della Cartella di Lavoro Utilizzando Aspose.Cell per Java**
