...
type: docs
weight: 10
url: /it/java/format-number-to-date/
description: Questo articolo introdurrà come formattare un numero come data usando l API Aspose.Cells for Java.
...
Per formattare i numeri come data nella libreria Aspose.Cells for Java per lavorare con file Excel, puoi applicare programmaticamente la formattazione data alle celle. Ecco come farlo usando Java con Aspose.Cells:
