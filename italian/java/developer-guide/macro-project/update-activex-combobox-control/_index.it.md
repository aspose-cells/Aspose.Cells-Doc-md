...
È possibile leggere o scrivere i valori del controllo ComboBox ActiveX usando Aspose.Cells. Accedere al controllo ActiveX tramite la proprietà [Shape.ActiveXControl](https://reference.aspose.com/cells/java/com.aspose.cells/shape#ActiveXControl) e verificare il suo tipo tramite la proprietà [ActiveXControl.Type](https://reference.aspose.com/cells/java/com.aspose.cells/activexcontrol#Type); dovrebbe restituire il valore [ControlType.ComboBox](https://reference.aspose.com/cells/java/com.aspose.cells/controltype#COMBO-BOX) e quindi effetuare un cast al modulo [ComboBoxActiveXControl](https://reference.aspose.com/cells/java/com.aspose.cells/ComboBoxActiveXControl) per leggere o modificare le sue varie proprietà.
