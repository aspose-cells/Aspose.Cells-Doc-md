...
description: Questo articolo mostra come trovare celle con uno stile specifico utilizzando MS Excel e Aspose.Cells for Java API.
...
A volte, devi trovare le celle con uno stile particolare. Questo articolo illustra come ottenere ciò utilizzando Microsoft Excel e Aspose.Cells for Java API.
...
## Utilizzando Aspose.Cells for Java
 ...
 Aspose.Cells for Java fornisce la funzione per trovare le celle nel foglio di lavoro con uno stile specifico. Per questo, lo API fornisce[**FindOptions.setStyle()**](https://reference.aspose.com/cells/java/com.aspose.cells/findoptions#Style) proprietà.
