...
Aspose.Cells fornisce la collezione [Worksheet.getQueryTables()](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#QueryTables) che restituisce la collezione [QueryTableCollection](https://reference.aspose.com/cells/java/com.aspose.cells/QueryTableCollection). Per ottenere un [QueryTable](https://reference.aspose.com/cells/java/com.aspose.cells/QueryTable) specifico, usa la proprietà [QueryTableCollection.get()](https://reference.aspose.com/cells/java/com.aspose.cells/querytablecollection#Item%20-int-) e passa l'indice del QueryTable. La classe [QueryTable](https://reference.aspose.com/cells/java/com.aspose.cells/QueryTable) ha le seguenti due proprietà per regolare il QueryTable.
