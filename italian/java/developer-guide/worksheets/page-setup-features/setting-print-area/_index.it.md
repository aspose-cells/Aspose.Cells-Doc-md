...
type: docs
weight: 200
url: /it/java/how-to-set-print-area/
description: Questo articolo ti mostra come impostare l area di stampa utilizzando la libreria Aspose.Cells.
keywords: Limita l intervallo di stampa, imposta l intervallo di stampa, cancella l intervallo di stampa, imposta e annulla l intervallo di stampa utilizzando Java, Come impostare l area di stampa in Java, Imposta e cancella l area di stampa in Java, Come cancellare l area di stampa in Java, Come aggiungere l area di stampa in Java, come rimuovere l area di stampa in Java, Come impostare l area di stampa in Excel, Come cancellare l area di stampa in Excel.
---
...
Per impostare l'area di stampa in un foglio di lavoro specificato: Innanzitutto, carica il [file di esempio](input.xlsx), e poi devi modificare la proprietà [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) dell'oggetto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) per il foglio desiderato. Impostare questa proprietà a una stringa di intervallo definirà l'area di stampa.
...
Per eliminare l'area di stampa in un foglio di lavoro specificato: Innanzitutto, carica il [file di esempio](input.xlsx), e poi devi modificare la proprietà [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) dell'oggetto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) per il foglio desiderato. Impostare questa proprietà a una stringa vuota eliminerà l'area di stampa.
