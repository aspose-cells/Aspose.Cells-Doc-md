...
Non c'è un'opzione diretta disponibile per creare dimensioni della carta personalizzate in MS Excel, tuttavia è possibile impostare la dimensione della carta personalizzata dei fogli di lavoro desiderati durante la resa del file di Excel nel formato PDF. Questo documento spiega come impostare una dimensione della carta personalizzata di un foglio di lavoro utilizzando le API di Aspose.Cells.
