...
type: docs
weight: 200
url: /it/java/how-to-set-print-titles/
...
keywords: Stampa righe e colonne ripetutamente, Java Come impostare i titoli di stampa, Imposta e elimina i titoli di stampa usando Java, Come eliminare i titoli di stampa in Java, Come aggiungere titoli di stampa usando Java, come rimuovere titoli di stampa usando Java, Come impostare i titoli di stampa in Excel, Come eliminare i titoli di stampa in Excel.
---
...
Per impostare i titoli di stampa in un foglio di lavoro specificato: Prima, carica il [file di esempio](input.xlsx), e poi devi modificare le proprietà [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) e [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) dell'oggetto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) per il foglio di lavoro desiderato. Impostando queste proprietà a una stringa di intervallo, si impostano i titoli di stampa.
