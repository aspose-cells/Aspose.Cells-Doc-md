---
title: "Come correggere l'eccezione: impossibile inizializzare la classe sun.font.FontScaler"
type: docs
weight: 40
url: /it/java/how-to-fix-exception-could-not-initialize-class-sun-font-fontscaler/
---
## **Possibili scenari di utilizzo**
Questo articolo spiegherà come correggere l'eccezione: impossibile inizializzare la classe sun.font.FontScaler. L'eccezione ha un aspetto simile a questo
...
## **Ambiente di sistema**
L'ambiente di sistema potrebbe essere qualcosa di simile
...
- ae-awt.jar
## **Link per il download del file ae-awt.jar**
