...
---
Aspose.Cells for Java API dipende da alcune librerie aggiuntive, se mancano, può essere generata un'eccezione come "java.lang.ClassNotFoundException".
...
### **Riepilogo**
Aspose.Cells for Java API dipende da Bouncy Castle per le funzionalità di crittografia e decrittografia, ovvero, se il programma deve caricare o salvare fogli di calcolo crittografati, è necessario aggiungere il riferimento a bcprov-jdk16-146.jar nel percorso di classe del progetto.
### **Sintomi**
