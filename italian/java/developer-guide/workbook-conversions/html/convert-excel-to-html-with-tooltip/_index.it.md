...
L'esempio di codice seguente carica il file[file excel di origine](AddTooltipToHtmlSample.xlsx)e genera il[file HTML di output](AddTooltipToHtmlSample_out.zip)con il tooltip.
