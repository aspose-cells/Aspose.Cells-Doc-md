...
Quando si salva il file Excel in HTML, quindi Aspose.Cells rivela i commenti condizionali di livello inferiore. Questi commenti condizionali sono per lo più rilevanti per le vecchie versioni di Internet Explorer e sono irrilevanti per i browser Web moderni. Puoi leggerli in dettaglio al seguente link.
