---
title: Espansione del testo da destra a sinistra durante l esportazione di un file Excel in HTML
type: docs
weight: 820
...
Il seguente codice di esempio converte il [file Excel di esempio](5472562.xlsx) in HTML. Questo screenshot mostra come appare il file Excel di esempio in Microsoft Excel 2013.

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_1.png)

Questo screenshot mostra l'[HTML generato con una versione precedente](5472570).

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_2.png)

Questo screenshot mostra l'[HTML generato con una versione più recente](5472563).
