...
{{% alert color="primary" %}} 
 ...
 Per impostazione predefinita, Aspose.Cells salva Excel in PDF con dimensioni standard. Tuttavia puoi anche salvarlo con Dimensione minima usando il file[PdfSaveOptions.OptimizationType](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#OptimizationType) proprietà. Accetta i seguenti valori
...
## **Salva Excel in PDF con dimensione standard o minima utilizzando Aspose.Cells**
 Il seguente codice di esempio mostra come salvare Excel in PDF con dimensioni standard o minime utilizzando[PdfSaveOptions.OptimizationType](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#OptimizationType)proprietà.
