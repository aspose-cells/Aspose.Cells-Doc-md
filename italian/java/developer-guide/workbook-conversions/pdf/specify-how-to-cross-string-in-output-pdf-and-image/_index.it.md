...
- [**TextCrossType. CROSS_KEEP**](https://reference.aspose.com/cells/java/com.aspose.cells/textcrosstype#CROSS_KEEP): Visualizza la stringa come in MS Excel esportando PDF/immagine

- [**TextCrossType.CROSS_OVERRIDE**](https://reference.aspose.com/cells/java/com.aspose.cells/textcrosstype#CROSS_OVERRIDE): Visualizza tutto il testo incrociando altre celle e sovraiscrivendo il testo delle celle incrociate

- [**TextCrossType.STRICT_IN_CELL**](https://reference.aspose.com/cells/java/com.aspose.cells/textcrosstype#STRICT_IN_CELL): Visualizzazione solo della stringa all'interno della larghezza della cella.
