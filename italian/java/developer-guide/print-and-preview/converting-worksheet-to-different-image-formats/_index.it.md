...
Aspose.Cells for Java supporta anche la conversione in formato TIFF. Per convertire un foglio di lavoro in un'immagine TIFF, aggiungi la libreria JAI al tuo classpath.
...
Dal rilascio della v7.1.0,**Aspose.Cells for Java** può convertire i fogli di lavoro in immagini SVG.
...
Il**[com.aspose.cells.ImageOrPrintOptions](https://reference.aspose.com/cells/java/com.aspose.cells/ImageOrPrintOptions)** class specifica che il foglio di lavoro verrà salvato in formato SVG.
...
Un modo semplice per convertire il foglio di lavoro attivo in una cartella di lavoro è impostare l'indice del foglio attivo e quindi salvare la cartella di lavoro come SVG. Renderà il foglio attivo in SVG. Il seguente codice di esempio dimostra questa funzionalità:
