...
È possibile creare un intervallo di nomi chiamando il metodo sovraccaricato [createRange](https://reference.aspose.com/cells/java/com.aspose.cells/cells#createRange-java.lang.String-java.lang.String-) della collezione [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells). Una versione tipica del metodo [createRange](https://reference.aspose.com/cells/java/com.aspose.cells/cells#createRange-java.lang.String-java.lang.String-) prende i seguenti parametri:
...
Quando viene chiamato il metodo [createRange](https://reference.aspose.com/cells/java/com.aspose.cells/cells#createRange-java.lang.String-java.lang.String-), esso restituisce il nuovo intervallo di nomi come un'istanza della classe [Range](https://reference.aspose.com/cells/java/com.aspose.cells/range).
...
Chiama il metodo [getNamedRanges](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#getNamedRanges--) della collezione [WorksheetCollection](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection) per ottenere tutti gli intervalli di nomi in un foglio di calcolo. Il metodo [getNamedRanges](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#getNamedRanges--) restituisce un array di tutti gli intervalli di nomi nella [WorksheetCollection](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection).
...
Chiama il metodo [getRangeByName](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#getRangeByName-java.lang.String-) della collezione [WorksheetCollection](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection) per ottenere un intervallo specificato per nome. Un metodo [getRangeByName](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#getRangeByName-java.lang.String-) tipico prende il nome dell'intervallo di nomi e restituisce l'intervallo di nomi specificato come un'istanza della classe [Range](https://reference.aspose.com/cells/java/com.aspose.cells/range).
...
È possibile aggiungere bordi a un intervallo di celle invece di una singola cella. L'oggetto [Range](https://reference.aspose.com/cells/java/com.aspose.cells/range) offre un metodo [setOutlineBorders](https://reference.aspose.com/cells/java/com.aspose.cells/range#setOutlineBorders-int-com.aspose.cells.Color-) che prende i seguenti parametri per aggiungere un bordo all'intervallo di celle:
...
A volte, si desidera applicare uno stile alle celle di un [Range](https://reference.aspose.com/cells/java/com.aspose.cells/range). Per questo, puoi iterare sulle celle dell'intervallo e usare il metodo [Cell.setStyle](https://reference.aspose.com/cells/java/com.aspose.cells/cell#setStyle-com.aspose.cells.Style-) per applicare lo stile alla cella.
