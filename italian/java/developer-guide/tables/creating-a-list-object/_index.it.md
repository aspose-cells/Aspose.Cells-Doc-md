...
## **Creazione di una tabella utilizzando l'API Aspose.Cells**
 ...
 Nell'esempio fornito di seguito, abbiamo creato lo stesso[**ElencoOggetto**](https://reference.aspose.com/cells/java/com.aspose.cells/ListObject)utilizzando l'API Aspose.Cells come abbiamo creato utilizzando Microsoft Excel nella sezione precedente.
