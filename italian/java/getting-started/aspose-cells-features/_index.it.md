---
title: Aspose.Cells Caratteristiche
type: docs
weight: 30
url: /it/java/aspose-cells-features/
description: Riepiloga le funzionalità di Aspose.Cells for Java e fornisci collegamenti a descrizioni dettagliate delle funzionalità.
---
{{% alert color="primary" %}} 

Le tabelle seguenti riepilogano le caratteristiche di Aspose.Cells for Java e forniscono collegamenti a descrizioni dettagliate delle caratteristiche.

{{% /alert %}} 
## **Piattaforme supportate**
Il prodotto Aspose.Cells for Java copre la maggior parte degli ambienti di sviluppo e delle piattaforme di distribuzione più diffusi che supportano Java.
...
|Microsoft Cartella di lavoro di Excel (XLS)|L'implementazione del formato XLS più veloce e completa che puoi trovare.|sì|
...
|ApriDocumento (ODS)|Aspose.Cells può caricare e salvare documenti nel formato OpenDocument Spreadsheet (.ods).|sì|
...
|**Caratteristica**|**Aspose.Cells for Java**|
|:- |:- |
|Importa/esporta dati da Array, ArrayList, ResultSet ecc.|sì|
|Aggiungi una copia del foglio di lavoro esistente (tutti i contenuti incluse immagini, grafici, altri oggetti ecc.)|sì|
...
|Trova e sostituisci il testo|sì|
|Unisci/dividi Cells|sì|
|Raggruppa/separa righe e colonne|sì|
...
|Conserva o rimuovi componenti aggiuntivi, VBA, macro|sì|
|Manipolare intervalli denominati|sì|
|Crea grafici personalizzati|sì|
|Aggiungi, conserva o estrai oggetti OLE dai fogli di calcolo.|sì|
|Implementa gli sparkline|sì|
|Crittografare i file|sì|
...
|**Caratteristica**|**Aspose.Cells for Java**|
|:- |:- |
|Applica la formattazione di tutti i caratteri nelle celle inclusi caratteri, colori, effetti, bordi e ombreggiatura.|sì|
|Applicare tutte le impostazioni del formato numerico (supportate in Microsoft Excel) per le celle.|sì|
|Imposta tutti i tipi di impostazioni di allineamento del testo.|sì|
|Applicare diversi tipi di impostazioni dei caratteri per le celle.|sì|
|Applica colori diversi a celle, caratteri, griglie, oggetti grafici, ecc.|sì|
|Applicare diverse formattazioni RTF in una singola cella.|sì|
|Applicare diverse impostazioni del bordo sulle celle.|sì|
|Applica motivi di sfondo diversi alle celle.|sì|
|Applica le impostazioni di formato su un foglio di lavoro, una riga, una colonna o un intervallo di celle, ecc.|sì|
...
|**Caratteristica**|**Aspose.Cells for Java**|
|:- |:- |
|Regola l'orientamento della pagina, il ridimensionamento, il formato della carta.|sì|
|Specifica i margini e la centratura della pagina.|sì|
|Crea o modifica l'intestazione e/o il piè di pagina.|sì|
|Imposta l'area di stampa, stampa i titoli o attiva la griglia ecc.|sì|
