...
Il codice seguente mostra come il foglio di lavoro può essere convertito in CSV utilizzando l'API Apache POI HSSF e XSSF rispetto all'API Java Aspose.Cells.
...
\* Un rudimentale processore XLSX -> CSV modellato sul formato
