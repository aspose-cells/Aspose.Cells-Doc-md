...
Se gli sviluppatori hanno bisogno di salvare i loro file in una posizione di archiviazione, possono semplicemente specificare il nome del file (con il percorso di archiviazione completo) e il formato del file desiderato (utilizzando l'enumerazione **FileFormatType**) durante la chiamata al metodo **save** dell'oggetto **Workbook**.
...
{{< /highlight >}}
## **Apache POI SS - HSSF & XSSF - Converti foglio di lavoro in CSV**
Il codice sottostante mostra come il foglio di lavoro può essere convertito in CSV utilizzando Apache POI HSSF e XSSF API rispetto all'API Java di Aspose.Cells.
...
Scarica **Converti foglio di lavoro in CSV** da uno dei siti di codici sociali menzionati di seguito:
