---
title: come personalizzare l aspetto UI della finestra modale in GridJs  
type: docs
weight: 250
url: /it/java/aspose-cells-gridjs/how-to-customize-ui-window/
description: Questo articolo descrive come personalizzare l aspetto UI della finestra modale in GridJs.
keywords: GrigliaJs, personalizza, modal, UI, aspetto, visivo, finestra
aliases:
aliases:
...
# Guida allo stile del Modal per GridJs

## Indice dei Contenuti

- [Panoramica](#overview)
- [Nomenclatura delle classi CSS](#css-class-naming)
...
## Nomenclatura delle classi CSS

### Nomi dei modali disponibili
...
| Suggerimento_Input | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
...
| Validazione Dati | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| FormatiNumero | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
...
Ideale per applicazioni professionali e aziendali.
...
Ottimo per applicazioni con supporto alla modalità scura.
...
### Esempio 4: Tema allegro e colorato 🌈
...
### Tema aziendale professionale 💼

Adatto per applicazioni aziendali e corporate.
...
### 5. Testare la modalità notturna
