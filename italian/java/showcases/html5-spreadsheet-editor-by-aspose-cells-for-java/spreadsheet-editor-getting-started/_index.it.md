...
requisiti hardware variano in base all'application server Java che scegliamo di distribuire HTML5 Spreadsheet Editor e al numero di fogli di calcolo che apriamo contemporaneamente. Di seguito è riportato un preventivo, che aiuterà inizialmente a configurare l'ambiente.
