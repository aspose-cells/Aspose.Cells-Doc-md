---
title: Aspose.Cells for Java 21.12 Note di rilascio
type: docs
weight: 1
url: /it/java/aspose-cells-for-java-21-12-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 21.12](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-21.12/).
