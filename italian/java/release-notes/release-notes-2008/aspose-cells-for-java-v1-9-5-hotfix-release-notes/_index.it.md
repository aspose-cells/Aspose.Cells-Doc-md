---
title: Aspose.Cells for Java v1.9.5 Note sulla versione dell'aggiornamento rapido
type: docs
weight: 10
url: /it/java/aspose-cells-for-java-v1-9-5-hotfix-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java v1.9.5 Aggiornamento rapido](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-v1.9.5-hotfix/)

{{% /alert %}} 

 Cari clienti,

 Abbiamo rilasciato Aspose.Cells for Java V1.9.5!
...
- La conversione di Excel in Pdf è stata migliorata* Quando si salva la cartella di lavoro come formato di file Excel2003, Aspose.Cells taglierà automaticamente quelle celle la cui colonna o riga supera il limite di 65536 righe e 256 colonne.* Quando non viene specificata la codifica, la lettura del file CSV tenterà di ottenere e utilizzare la codifica predefinita del sistema
