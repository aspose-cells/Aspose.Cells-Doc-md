---
title: Aspose.Cells for Java 20.5 Note di rilascio
type: docs
weight: 20
url: /it/java/aspose-cells-for-java-20-5-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 20.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.5/).
...
|CELLSJAVA-43166|Il testo ruotato non viene riprodotto correttamente nella conversione da XLSX a HTML|Insetto|
