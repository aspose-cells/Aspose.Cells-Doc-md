---
title: Aspose.Cells for Java 20.10 Note di rilascio
type: docs
weight: 6
url: /it/java/aspose-cells-for-java-20-10-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 20.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.10/).

{{% /alert %}}

|**Chiave**|**Sommario**|**Categoria**|
|:- |:- |:- |
|CELLSJAVA-40913|La direzione della freccia è cambiata nel risultante PDF|Insetto|
...
|CELLSJAVA-43308|HTML alla conversione in Excel con la proprietà wrapText|Insetto|
...
|CELLSJAVA-43304|Alcune etichette dati del grafico mancano nell'output PDF|Insetto|
