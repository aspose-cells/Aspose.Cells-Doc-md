---
title: Aspose.Cells for Java 20.2 Note di rilascio
type: docs
weight: 50
url: /it/java/aspose-cells-for-java-20-2-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 20.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.2/).
