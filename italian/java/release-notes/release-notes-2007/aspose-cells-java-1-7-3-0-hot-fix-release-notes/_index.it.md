...
{{% /alert %}} 
 ...
 Abbiamo rilasciato Aspose.Cells for Java V1.7.3! Sono inclusi i seguenti miglioramenti e correzioni:

- Supporta l'inserimento/eliminazione di un intervallo.
 Supporta l'apertura e il salvataggio di file Excel crittografati.
 Migliora il metodo Cell.getStringValue() per supportare più formati di data/numero.
 Aggiornate le demo web.
