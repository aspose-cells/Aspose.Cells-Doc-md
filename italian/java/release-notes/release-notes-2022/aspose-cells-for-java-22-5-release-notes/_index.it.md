---
title: Aspose.Cells for Java 22.5 Note di rilascio
type: docs
weight: 8
url: /it/java/aspose-cells-for-java-22-5-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 22.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.5/).
