---
title: Aspose.Cells for Java 22.4 Note di rilascio
type: docs
weight: 9
url: /it/java/aspose-cells-for-java-22-4-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 22.4](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.4/).
