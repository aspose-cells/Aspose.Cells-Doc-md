---
title: Aspose.Cells for Java 22.7 Note di rilascio
type: docs
weight: 6
url: /it/java/aspose-cells-for-java-22-7-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 22.7](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.7/).
