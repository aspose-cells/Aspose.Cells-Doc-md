---
title: Aspose.Cells for Java 22.9 Note di rilascio
type: docs
weight: 4
url: /it/java/aspose-cells-for-java-22-9-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 22.9](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.9/).
