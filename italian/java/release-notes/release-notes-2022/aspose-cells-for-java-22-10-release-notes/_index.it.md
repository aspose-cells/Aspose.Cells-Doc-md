---
title: Aspose.Cells for Java 22.10 Note di rilascio
type: docs
weight: 3
url: /it/java/aspose-cells-for-java-22-10-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 22.10](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.10/).
