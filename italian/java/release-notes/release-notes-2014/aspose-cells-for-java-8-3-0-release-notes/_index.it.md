...
(CELLSJAVA-41060) - La modifica della tavolozza dei colori della cartella di lavoro durante il salvataggio da XLSX a XLS fa sì che MS Excel apra il foglio di calcolo risultante in visualizzazione protetta
(CELLSJAVA-41059) - Modifica dell'ordine delle regole di formattazione condizionale durante il salvataggio da XLSX a XLS con Cambio pallet
(CELLSJAVA-41057) - Quote in perdita per determinati intervalli denominati
(CELLSJAVA-41056) - Il metodo Cells.copyRows() non copia i grafici sparkline nel formato file XLSX
...
(CELLSJAVA-41054) - Copia incolla Immagine non resa nel PDF
(CELLSJAVA-41044) - Aspose.Cells generato PDF non supera il test di conformità PDF/A-1b
...
(CELLSJAVA-41047) - Il separatore dati dell'istogramma in pila ha uno spessore diverso durante il rendering del foglio di calcolo nel formato PDF
(CELLSJAVA-41045) - Le colonne del grafico si sovrappongono all'asse inferiore durante il rendering del foglio di calcolo nel formato PDF
(CELLSJAVA-40989) - Il grafico a barre ha linee verticali extra sulla destra delle barre quando viene visualizzato come PDF
(CELLSJAVA-40988) - L'etichetta dei dati del grafico è tagliata nel rendering PDF
(CELLSJAVA-40987) - Le etichette e la legenda degli assi del grafico si sovrappongono nel rendering PDF
...
(CELLSJAVA-41078) - Supporto per l'esportazione del file SpreadsheetML (.xml) - GridWeb (JAVA)
