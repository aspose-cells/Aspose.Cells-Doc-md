...
(CELLSJAVA-40823) - Limita l'API all'utilizzo della directory dei caratteri specificata utilizzando il metodo CellsHelper.setFontDir
...
(CELLSJAVA-40814) - Le immagini mancano nel PDF risultante quando il foglio di calcolo viene convertito su Ubuntu
(CELLSJAVA-40826) - Mancano le impostazioni della griglia e dei caratteri nell'HTML di output
