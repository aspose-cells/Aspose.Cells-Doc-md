...
(CELLSJAVA-40854) - HtmlHiddenRowDisplayType.HIDDEN provoca lo spostamento delle celle nel risultante HTML (problema di spanning)
...
(CELLSJAVA-40910) - Le immagini vengono perse quando viene eseguito il rendering di PDF utilizzando PdfSaveOptions.setImageType(ImageFormat.getPng())
...
(CELLSJAVA-40860) - Le proprietà della bolla sono state modificate nel grafico durante il nuovo salvataggio del file modello XLSX
(CELLSJAVA-40859) - Le proprietà della bolla sono state modificate nel grafico durante il nuovo salvataggio del file modello XLSX
...
(CELLSJAVA-40901) - Eccezione: "Errore da forma a immagine!" durante il rendering nel formato file PDF
