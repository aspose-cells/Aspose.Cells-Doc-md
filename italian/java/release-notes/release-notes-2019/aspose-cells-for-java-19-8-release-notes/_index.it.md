---
title: Aspose.Cells for Java 19.8 Note di rilascio
type: docs
weight: 50
url: /it/java/aspose-cells-for-java-19-8-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells for Java 19.8.

{{% /alert %}} 

|**Chiave**|**Riepilogo**|**Categoria**|
|:- |:- |:- |
|CELLSJAVA-42949|Supporto per algoritmi ECDSA e RSA|Nuova caratteristica|
...
|Insetto|
|CELLSJAVA-42970|Borderline esteso indesiderato nel rendering da Excel a PDF|Insetto|
...
|CELLSJAVA-42959|Eccezione "Errore da forma a immagine" durante il rendering di un file XLSX in PDF|Eccezione|
