---
title: Aspose.Cells for Java 19.5 Note di rilascio
type: docs
weight: 80
url: /it/java/aspose-cells-for-java-19-5-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells for Java 19.5.
...
|CELLSJAVA-42893|Il grafico manca in Excel per il rendering HTML|Insetto|
