---
title: Aspose.Cells for Java 23.5 Note di rilascio
type: docs
weight: 8
url: /it/java/aspose-cells-for-java-23-5-release-notes/
---
{{% alert color="primary" %}}

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 23.5](https://releases.aspose.com/cells/java/).
