---
title: Aspose.Cells for Java 8.9.1 Note di rilascio
type: docs
weight: 60
url: /it/java/aspose-cells-for-java-8-9-1-release-notes/
---
## **1) Aspose.Cells**
...
|CELLSJAVA-41841|Problema con il rendering delle caselle di controllo su HTML|Insetto|
...
Poiché la base di codice di Aspose.Cells for Java corrisponde al codice della versione .NET pertinente, la maggior parte delle modifiche, miglioramenti e correzioni inclusi in Aspose.Cells for .NET v8.9.1 sono inclusi anche in questo Aspose.Cells for Java v8.9.1.
