---
title: Aspose.Cells for Java 8.8.2 Note di rilascio
type: docs
weight: 90
url: /it/java/aspose-cells-for-java-8-8-2-release-notes/
---
## **Aspose.Cells**
...
Poiché la base di codice di Aspose.Cells for Java corrisponde al codice della versione .NET pertinente, la maggior parte delle modifiche, miglioramenti e correzioni inclusi in Aspose.Cells for .NET v8.8.2 sono inclusi anche in questo Aspose.Cells for Java v8.8.2.
