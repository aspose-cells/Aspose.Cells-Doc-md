---
title: Aspose.Cells for Java 7.0.3 Note di rilascio
type: docs
weight: 10
url: /it/java/aspose-cells-for-java-7-0-3-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 7.0.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.0.3/)

{{% /alert %}} 

 Siamo felici di annunciare Aspose.Cells for Java v7.0.3!
...
40015 - Rendi la libreria compatibile con webservices-rt.jar
 ...
 40033 - Ricevi un'eccezione "Password non valida" durante la lettura del file modello XLSX
 ...
 40003 - Orientamento del testo delle celle unite modificato nel file PDF generato

 40002 - La tabella pivot salvata causa un errore in MS Excel

 40010 - L'inserimento di righe causa l'interruzione delle celle unite
...
40014 - Le linee della griglia non venivano visualizzate nell'immagine generata per un foglio
 ...
 40024 - Rimuove i collegamenti ipertestuali durante la cancellazione del contenuto per un intervallo di celle

 40028 - Color.equals() non restituisce true quando i valori RGB sono uguali

 40031 - SortNames() distrugge gli intervalli denominati

 40032 - L'impostazione delle etichette dei dati del punto del grafico perde le impostazioni ereditate dalle etichette dei dati della serie
