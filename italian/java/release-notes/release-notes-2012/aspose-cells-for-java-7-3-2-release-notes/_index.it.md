---
title: Aspose.Cells for Java 7.3.2 Note di rilascio
type: docs
weight: 30
url: /it/java/aspose-cells-for-java-7-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Questa pagina contiene le note di rilascio per[Aspose.Cells for Java 7.3.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.3.2/)

{{% /alert %}} 

Noi siamo
 felice di annunciare Aspose.Cells for Java v7.3.2!

 Nuove caratteristiche

- Shape.getRight()/getBottom() per ottenere un offset della forma dall'angolo inferiore destro alla cella
- Imposta il colore della scheda del foglio di lavoro sul colore predefinito
...
- Il salvataggio in PDF ha causato un'eccezione -II
- Il salvataggio in PDF ha causato un'eccezione -III
- Il salvataggio in PDF ha causato un'eccezione -IV
- Eccezione quando si apre il file modello HTM
- IllegalArgumentException all'apertura di un file XLS
