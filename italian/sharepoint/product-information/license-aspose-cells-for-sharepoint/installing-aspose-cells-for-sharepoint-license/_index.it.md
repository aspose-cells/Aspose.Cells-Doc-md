...
- **Aspose.Cells.SharePoint.License.wsp** – File del pacchetto della soluzione SharePoint. La licenza Aspose.Cells for SharePoint è confezionata come soluzione SharePoint per facilitare la distribuzione e il ritiro nella server farm.
