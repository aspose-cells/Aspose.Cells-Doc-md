---
title: Aspose.Cells per le note di rilascio di CPP 18.5
type: docs
weight: 20
url: /it/cpp/aspose-cells-for-cpp-18-5-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells per CPP 18.5.
