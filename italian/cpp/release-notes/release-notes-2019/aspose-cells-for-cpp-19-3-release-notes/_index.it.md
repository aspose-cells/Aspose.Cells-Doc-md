---
title: Aspose.Cells per CPP 19.3 Note di rilascio
type: docs
weight: 50
url: /it/cpp/aspose-cells-for-cpp-19-3-release-notes/
---
{{% alert color="primary" %}} 

Questa pagina contiene le note di rilascio per Aspose.Cells per CPP 19.3.
