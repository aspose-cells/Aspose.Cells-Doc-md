---
title: Apertura di un file Excel senza la finestra di dialogo di apertura/salvataggio/cancel con C++
linktitle: Apertura file Excel senza finestra di dialogo Apri Salva Annulla
type: docs
weight: 150
url: /it/cpp/opening-excel-file-without-open-save-cancel-dialog-box/
description: Impara come aprire un file Microsoft Excel nel browser senza mostrare la finestra di dialogo Apri Salva Annulla usando Aspose.Cells for C++.
---
