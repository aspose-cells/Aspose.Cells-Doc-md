---
title: Come impostare i titoli di stampa con C++
linktitle: Come impostare i titoli di stampa
type: docs
weight: 200
url: /it/cpp/how-to-set-print-titles/
description: Questo articolo mostra un codice che spiega come impostare i titoli di stampa usando la libreria Aspose.Cells con C++.
keywords: Stampare righe e colonne ripetutamente, Come impostare i titoli di stampa con C++, impostare e cancellare i titoli di stampa usando C++, come cancellare i titoli di stampa in C++, come aggiungere titoli di stampa con C++, come rimuovere titoli di stampa con C++, Come impostare i titoli di stampa in Excel, Come cancellare i titoli di stampa in Excel.
---
...
Per impostare i titoli di stampa in un foglio di lavoro specificato: Prima, carica il [file di esempio](input.xlsx), e poi devi modificare le proprietà [**Worksheet.GetPrintTitleRows()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprinttitlerows/) e [**Worksheet.GetPrintTitleColumns()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprinttitlecolumns/) dell'oggetto [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) per il foglio di lavoro desiderato. Impostando queste proprietà a una stringa di intervallo, si impostano i titoli di stampa.
