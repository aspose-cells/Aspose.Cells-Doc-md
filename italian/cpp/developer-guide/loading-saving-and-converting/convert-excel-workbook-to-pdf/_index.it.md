...
{{% alert color="primary" %}} 
 ...
 Aspose.Cells scrive direttamente le informazioni su API e il numero di versione nei documenti di output. Ad esempio, dopo aver reso Documento a PDF, Aspose.Cells for C++ popola il**Applicazione** campo con valore 'Aspose.Cells' e**PDF Produttore** campo con valore, ad esempio 'Aspose.Cells v18.5.0'.
...
Il formato del file deve essere PDF, quindi seleziona il relativo PDF (un valore predefinito) dall'enumerazione SaveFormat per generare il documento finale PDF
