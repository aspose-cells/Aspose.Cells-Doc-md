...
Con Aspose.Cells è possibile aprire file, ad esempio per recuperare dati, oppure utilizzare un template designer per velocizzare il processo di sviluppo. Aspose.Cells può aprire una gamma di file diversi, come fogli di calcolo Excel Microsoft (XLS, XLSX, XLSM, XLSB), file CSV o TabDelimited.
