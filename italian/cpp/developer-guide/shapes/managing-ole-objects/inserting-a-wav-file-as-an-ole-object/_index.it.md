---
title: Inserire un file WAV come oggetto Ole con C++
linktitle: Inserimento di un file WAV come Oggetto OLE
type: docs
weight: 70
url: /it/cpp/inserting-a-wav-file-as-an-ole-object/
description: Impara come inserire un file WAV come oggetto OLE nei fogli di lavoro Excel usando Aspose.Cells con C++.
---

{{% alert color="primary" %}} 

Aspose.Cells offre la possibilità di aggiungere diversi tipi di oggetti OLE ai fogli di lavoro Excel. Vedremo nei seguenti esempi di codice come aggiungere un file WAV come oggetto OLE usando le API semplici fornite da Aspose.Cells. 
