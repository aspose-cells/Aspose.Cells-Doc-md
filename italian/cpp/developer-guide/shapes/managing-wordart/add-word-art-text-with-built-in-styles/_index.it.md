---
title: Aggiungi testo Word Art con stili predefiniti con C++
linktitle: Aggiungi testo Word Art con stili incorporati
type: docs
weight: 270
url: /it/cpp/add-word-art-text-with-built-in-styles/
description: Impara come aggiungere testo Word Art con stili predefiniti usando Aspose.Cells for C++.
---

## **Possibili Scenari di Utilizzo**
Puoi aggiungere testo Word Art con stili predefiniti usando Aspose.Cells. Usa il metodo [ShapeCollection.AddWordArt()](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addwordart/) per questo scopo.
