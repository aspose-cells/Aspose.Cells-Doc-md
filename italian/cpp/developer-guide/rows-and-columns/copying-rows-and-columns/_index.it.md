...
{{% /alert %}} 
### **Copia di colonne**
Aspose.Cells fornisce il metodo CopyColumn della classe Aspose::Cells::ICells, questo metodo copia tutti i tipi di dati, incluse formule - con riferimenti aggiornati - e valori, commenti, formati di celle, celle nascoste, immagini e altri oggetti di disegno dalla sorgente colonna alla colonna di destinazione.
