---
title: Come impostare un punto come totale con C++
linktitle: Come impostare un punto come totale
description: In alcuni grafici Excel, ad esempio il grafico WaterFall, potrebbe essere necessario impostare un punto come totale. Questo articolo descrive come usare Aspose.Cells con C++ per farlo.
keywords: Grafico WaterFall, Punto, Imposta come totale.
type: docs
weight: 72
url: /it/cpp/how-to-set-point-as-total/
---
