...
Nell'esempio fornito di seguito, abbiamo creato lo stesso `[IListObject]` utilizzando Aspose.Cells API che abbiamo creato utilizzando Microsoft Excel nella sezione precedente.
