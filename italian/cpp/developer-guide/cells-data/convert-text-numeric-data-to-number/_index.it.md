---
title: Converti dati numerici come testo in numero con C++
linktitle: Converti dati numerici testuali in numeri
type: docs
weight: 900
url: /it/cpp/convert-text-numeric-data-to-number/
...
Aspose.Cells fornisce il metodo [**Cells.ConvertStringToNumericValue()**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/convertstringtonumericvalue/) che può essere utilizzato per convertire tutti i dati numerici di stringhe o testo in numeri.

La seguente immagine mostra numeri di stringa nelle celle **A1:A17**. I numeri di stringa sono allineati a sinistra.
<br>
<img src="5.png" width=70% />

Questi numeri di stringa sono stati convertiti in numeri utilizzando [**Cells.ConvertStringToNumericValue()**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/convertstringtonumericvalue/) nella schermata seguente. Come puoi vedere, ora sono allineati a destra.
<br>
