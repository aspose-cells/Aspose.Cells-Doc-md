...
1. Creare un progetto Microsoft Visual Studio for C++.
2. Includere il file di intestazione "Aspose.Cells.h".
3. Aprire Microsoft Visual Studio e il gestore pacchetti NuGet.
...
[Aspose.Cells for C++ Pacchetto NuGet](https://www.nuget.org/packages/Aspose.Cells.Cpp/)
...
[Scarica Aspose.Cells for C++ (finestre)](https://downloads.aspose.com/cells/cpp/)
...
L'esempio seguente apre un file modello di Microsoft Excel esistente, ottiene una cella e controlla il valore nella cella A1.
