...
You will discover in this article how to get the Excel Worksheet Page Setup Paper Width and Paper Height using C# code programmatically with .NET API or Library.
