...
This article compares [hiding](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/) and [unhiding](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/) worksheets with [VSTO](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/), using either C# or Visual Basic, to performing the same task with [Aspose.Cells](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/), again using either C# or Visual Basic. Aspose.Cells lets you work without Microsoft Excel installed.
The steps to hide a worksheet are:
1. Open a file.
1. Get a worksheet.
1. Hide the worksheet.
1. Save the file.
To [unhide](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/) a worksheet again, simply toggle visibility on for the hidden sheet.
The code samples below first show how to hide a worksheet. The first samples show the process with [VSTO](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/), using either C# or Visual Basic, compared to using [Aspose.Cells](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/), again using either C# or Visual Basics.
The second set of code samples show the line used to unhide the worksheet in [VSTO](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/) or [Aspose.Cells](https://docs.aspose.com/cells/net/hide-and-unhide-worksheets-in-a-workbook/).
## **Hiding Worksheets**
