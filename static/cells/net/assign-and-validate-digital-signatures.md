...
- [Add Signature line to the worksheet](https://docs.aspose.com/cells/net/add-signature-line/)
- [Support for XAdES Signature](https://docs.aspose.com/cells/net/support-for-xades-signature/)
