...
1. Name the range.
1. Save the file.
The code examples below show how to perform these steps using [VSTO](https://docs.aspose.com/cells/net/creating-a-named-range/) with either C# or Visual Basic. The code examples that follow show how to do the same thing using [Aspose.Cells for .NET](https://docs.aspose.com/cells/net/creating-a-named-range/), again with either C# or Visual Basic.
