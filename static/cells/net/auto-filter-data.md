...
The code samples in this article show how to perform these steps using [VSTO](https://docs.aspose.com/cells/net/auto-filter-data/) with either C# or Visual Basic, or using [Apose.Cells](https://docs.aspose.com/cells/net/auto-filter-data/), again with either C# or Visual Basic.
