...
This article explains how to use the C# API or .NET Library sample code to set custom paper size of your desired worksheets when rendering Excel file to PDF file format programmatically.
