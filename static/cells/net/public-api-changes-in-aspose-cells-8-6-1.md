...
Aspose.Cells for .NET 8.6.1 has exposed the VbaProject.IsSigned property that can be used to [test if a VbaProject in a Workbook is signed or not](https://docs.aspose.com/cells/net/check-if-vba-project-in-a-workbook-is-signed/). Boolean type property returns true if the project is signed.
Following is the simple usage scenario.
**C#**
//Load a spreadsheet
Workbook workbook = new Workbook(inputFilePath);
