...
Smartly importing and placing data accoding to the template Excel files with Aspose.Cells library.
...
- [Adding Anonymous or Custom Object into SmartMarkers](https://docs.aspose.com/cells/net/adding-anonymous-or-custom-object-into-smartmarkers/)
...
- [Formatting Smart Markers](https://docs.aspose.com/cells/net/formatting-smart-markers/)
- [Getting Notifications while Merging Data with Smart Markers](https://docs.aspose.com/cells/net/getting-notifications-while-merging-data-with-smart-markers/)
- [Set custom DataSource for WorkbookDesigner](https://docs.aspose.com/cells/net/set-custom-datasource-for-workbookdesigner/)
- [Show leading apostrophe in cells](https://docs.aspose.com/cells/net/show-leading-apostrophe-in-cells/)
...
- [Smartly Importing Array Element by Index into Excel With Smart Markers](https://docs.aspose.com/cells/net/how-to-import-array-element-by-index-with-smart-markers/)
- [Smartly Importing Array Element by Slicer into Excel With Smart Markers](https://docs.aspose.com/cells/net/how-to-import-array-element-by-slicer-with-smart-markers/)
- [Smartly Importing JSON into Excel With Smart Markers](https://docs.aspose.com/cells/net/how-to-import-json-into-excel-with-smart-markers/)
- [Smartly Importing Nested Objects into Excel With Smart Markers](https://docs.aspose.com/cells/net/how-to-import-nested-objects-with-smart-markers/)
- [Smartly Importing Variable Arrays into Excel With Smart Markers](https://docs.aspose.com/cells/net/how-to-import-variable-arrays-with-smart-markers/)
- [How to Use Image Markers in Smart Markers](https://docs.aspose.com/cells/net/how-to-use-image-markers-in-smart-markers/)
- [How to Group Data in Smart Markers](https://docs.aspose.com/cells/net/how-to-group-data-in-smart-markers/)
