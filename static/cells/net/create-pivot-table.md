##Insert Pivot Table
Create and format pivot tables of Excel spreadsheet files.
## **Create Pivot Table**
...
## **Advance topics**
- [Consolidation Function](https://docs.aspose.com/cells/net/consolidation-function/)
- [Custom sorting in Pivot Table](https://docs.aspose.com/cells/net/custom-sorting-in-pivot-table/)
- [Customize Globalization Settings for Pivot Table](https://docs.aspose.com/cells/net/customize-globalization-settings-for-pivot-table/)
- [Disable Pivot Table Ribbons](https://docs.aspose.com/cells/net/disable-pivot-table-ribbons/)
- [Find and Refresh the Nested or Children Pivot Tables of Parent Pivot Table](https://docs.aspose.com/cells/net/find-and-refresh-the-nested-or-children-pivot-tables-of-parent-pivot-table/)
- [Formatting Pivot Table](https://docs.aspose.com/cells/net/formatting-pivot-table/)
- [Get External Connection Data Source of Pivot Table](https://docs.aspose.com/cells/net/get-external-connection-data-source-of-pivot-table/)
- [Get Pivot Table refresh date and refresh by who information](https://docs.aspose.com/cells/net/get-pivot-table-refresh-date-and-refresh-by-who-information/)
- [Group Pivot Fields in the Pivot Table](https://docs.aspose.com/cells/net/group-pivot-fields-in-the-pivot-table/)
- [Parsing Pivot Cached Records while loading Excel file](https://docs.aspose.com/cells/net/parsing-pivot-cached-records-while-loading-excel-file/)
- [Pivot Table and Source Data](https://docs.aspose.com/cells/net/pivot-table-and-source-data/)
- [Pivot Table Hide and Sort data](https://docs.aspose.com/cells/net/pivot-table-hide-and-sort-data/)
- [Refresh and Calculate Pivot Table having Calculated Items](https://docs.aspose.com/cells/net/refresh-and-calculate-pivot-table-having-calculated-items/)
- [Save Pivot Table in ODS file](https://docs.aspose.com/cells/net/save-pivot-table-in-ods-file/)
- [Show report filter pages option](https://docs.aspose.com/cells/net/show-report-filter-pages-option/)
- [Working with data display formats of DataField in Pivot Table](https://docs.aspose.com/cells/net/working-with-data-display-formats-of-datafield-in-pivot-table/)
