...
## **Advance topics**
- [Add ActiveX Controls using Aspose.Cells](https://docs.aspose.com/cells/net/add-activex-controls-using-aspose-cells/)
- [Remove ActiveX Control](https://docs.aspose.com/cells/net/remove-activex-control/)
- [Update ActiveX ComboBox Control](https://docs.aspose.com/cells/net/update-activex-combobox-control/)
