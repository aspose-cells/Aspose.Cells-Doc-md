...
Aspose.Cells supports [pivot tables](https://docs.aspose.com/cells/net/create-pivot-tables-and-pivot-charts/) and [pivot charts](https://docs.aspose.com/cells/net/create-pivot-tables-and-pivot-charts/).
