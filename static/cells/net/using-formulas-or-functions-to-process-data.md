...
Aspose.Cells can simply get, set and calculate formulas of excel files.
Learn how to Manage formulas of Excel files through the Aspose.Cells for NET APIs.
## **Introduction**
...
## **Advance topics**
- [Precedents and Dependents](https://docs.aspose.com/cells/net/precedents-and-dependents/)
- [Set External Links in Formulas](https://docs.aspose.com/cells/net/set-external-links-in-formulas/)
- [Propagate Formula in Table or List Object automatically while entering data in new rows](https://docs.aspose.com/cells/net/propagate-formula-in-table-or-list-object-automatically-while-entering-data-in-new-rows/)
- [Setting Formula for Named Range](https://docs.aspose.com/cells/net/setting-formula-for-named-range/)
- [Setting Formulas - Notice for Non English Users](https://docs.aspose.com/cells/net/setting-formulas-notice-for-non-english-users/)
- [Setting Shared Formula](https://docs.aspose.com/cells/net/setting-shared-formula/)
- [Specify Maximum Rows of Shared Formula](https://docs.aspose.com/cells/net/specify-maximum-rows-of-shared-formula/)
- [Supported Excel Functions](https://docs.aspose.com/cells/net/supported-formula-functions/)
