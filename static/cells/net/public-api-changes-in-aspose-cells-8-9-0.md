...
For more details on this feature, please review the article on [Setting Default Font for Rendering Spreadsheets to HTML Format](https://docs.aspose.com/cells/net/set-default-font-while-rendering-spreadsheet-to/).
...
For more details on this feature, please review the article on [Setting Default Font for Rendering Spreadsheets in Image Formats](https://docs.aspose.com/cells/net/set-default-font-while-rendering-spreadsheet-to-images/).
Following is the simple usage scenario.
**C#**
