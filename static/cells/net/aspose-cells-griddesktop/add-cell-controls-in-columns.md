...
This article introduces how to add control in column in GridDesktop.
...
**IMPORTANT:** If you want to add cell controls to a single cell instead of the whole column then you can refer to [Adding Cell Controls in Worksheets.](https://docs.aspose.com/cells/net/adding-cell-controls-in-worksheets/)
### **Adding Button**
...
Above code snippet adds checkboxes to all cells of the specified column. For more information about the event handling of checkboxes, please refer to the [Event Handling of a CheckBox Control.](https://docs.aspose.com/cells/net/adding-cell-controls-in-worksheets/#event-handling-of-checkbox)
### **Adding ComboBox**
...
Above code snippet adds comboboxes to all cells of the specified column. Whenever any cell of that specific column is selected, a combobox becomes visible. For more information about the event handling of comboboxes, please refer to the [Event Handling of a ComboBox Control.](https://docs.aspose.com/cells/net/adding-cell-controls-in-worksheets/#event-handling-of-combobox)
