...
This article introduces how to add control in worksheet in GridDesktop.
...
**IMPORTANT:** If you want to add cell controls to all cells of a column instead of adding one by one then you can refer to [Managing Cell Controls in Columns.](https://docs.aspose.com/cells/net/aspose-cells-griddesktop/adding-cell-controls-in-worksheets/)
### **Adding Button**
