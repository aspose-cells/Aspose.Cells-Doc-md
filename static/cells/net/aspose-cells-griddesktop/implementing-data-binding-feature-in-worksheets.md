...
This article introduce how to do data binding in GridDesktop.
...
1. Drop four buttons from toolbox on the bottom of the form and set their text property as **Bind Woksheet**, **Add Row**, **Delete Row** and **Update to Database** respectively.
...
1. Bind the worksheet with the DataSet's Products table.
...
1. Assign the captions to the headers of worksheet columns.
...
1. Perform some operations on the worksheet data, maybe adding new rows and editing or removing existing data.
1. Then click **Update to Database** to save the changes to the database.
1. Check the database to see that the table records have been updated accordingly.
