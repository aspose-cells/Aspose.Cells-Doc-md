...
This article looks at how to rotate text in cells using [Aspose.Cells for .NET](https://docs.aspose.com/cells/net/rotating-cell-text/) compared to doing the same thing with [VSTO](https://docs.aspose.com/cells/net/rotating-cell-text/).
...
1. Save the file.
The code samples that follow show how to perform these steps first in [VSTO](https://docs.aspose.com/cells/net/rotating-cell-text/), using either C# or Visual Basic, and then in [Aspose.Cells](https://docs.aspose.com/cells/net/rotating-cell-text/), again using either C# or Visual Basic.
