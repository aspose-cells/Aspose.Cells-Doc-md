##Insert Slicer
Manage slicers of Excel files with Aspose.Cells.
...
### **Sample Code**
## **Advance topics**
- [Change Slicer Properties](https://docs.aspose.com/cells/net/change-slicer-properties/)
- [Draw Slicer while rendering Excel to PDF](https://docs.aspose.com/cells/net/draw-slicer-while-rendering-excel-to-pdf/)
- [Formatting Slicer](https://docs.aspose.com/cells/net/formatting-slicer/)
- [Removing Slicer](https://docs.aspose.com/cells/net/removing-slicer/)
- [Rendering Slicer](https://docs.aspose.com/cells/net/rendering-slicer/)
- [Updating Slicer](https://docs.aspose.com/cells/net/updating-slicer/)
