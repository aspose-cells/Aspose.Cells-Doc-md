##DNN Export Users and Roles to Excel
## **Introduction**
...
1. From the list, select ‘Aspose Export Users and Roles to Excel’ and drag it into position.
...
1. Browse to the latest source code that you have downloaded and open **Aspose.DNN.ExportUsersAndRolesToExcel.sln**
