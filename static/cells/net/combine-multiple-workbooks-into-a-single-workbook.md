...
## **Advance topics**
- [Combine Multiple Worksheets into a Single Worksheet](https://docs.aspose.com/cells/net/combine-multiple-worksheets-into-a-single-worksheet/)
- [Merge Files](https://docs.aspose.com/cells/net/merge-files/)
