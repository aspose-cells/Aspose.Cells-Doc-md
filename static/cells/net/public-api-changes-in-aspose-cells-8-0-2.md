##Public API Changes in Aspose.Cells 8.0.2
...
Please check the detailed article on [Changing Text Direction of the Comment](https://docs.aspose.com/cells/net/change-text-direction-of-the-comment/)
