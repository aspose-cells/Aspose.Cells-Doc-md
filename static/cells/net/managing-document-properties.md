...
Learn how to Manage Document Properties through the Aspose.Cells for NET APIs.
## **Introduction**
...
## **Advance topics**
- [Adding Custom Properties visible inside Document Information Panel](https://docs.aspose.com/cells/net/adding-custom-properties-visible-inside-document-information-panel/)
- [Setting ScaleCrop and LinksUpToDate properties of Built-In Document Properties](https://docs.aspose.com/cells/net/setting-scalecrop-and-linksuptodate-properties-of-built-in-document-properties/)
- [Specify Document Version of the Excel File using BuiltIn Document Properties](https://docs.aspose.com/cells/net/specify-document-version-of-the-excel-file-using-builtin-document-properties/)
- [Specify the Language of the Excel File using BuiltIn Document Properties](https://docs.aspose.com/cells/net/specify-the-language-of-the-excel-file-using-builtin-document-properties/)
