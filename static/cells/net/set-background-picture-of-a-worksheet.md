...
1. Save the workbook.
The code samples that follow show how to do this first with [VSTO](https://docs.aspose.com/cells/net/set-background-picture-of-a-worksheet/), using either C# or Visual Basic, and then with [Aspose.Cells for .NET](https://docs.aspose.com/cells/net/set-background-picture-of-a-worksheet/), again using either C# or Visual Basic.
