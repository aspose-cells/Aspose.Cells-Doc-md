##Public API Changes in Aspose.Cells 16.10.0
...
Check the detailed article on [Working with Reflection Effects](https://docs.aspose.com/cells/net/working-with-the-reflection-effect-of-shape-or-chart/)
**C#**
...
Check the detailed article on [Working with Shadow Effects](https://docs.aspose.com/cells/net/working-with-the-shadow-effect-of-shape-or-chart/)
**C#**
// Load a sample spreadsheet containing a shape
// Alternatively create a new spreadsheet and add a shape
var book = new Workbook("sample.xlsx");
...
Check the detailed article on [Working with Glow Effect](https://docs.aspose.com/cells/net/working-with-the-glow-effect-of-shape-or-chart/)
**C#**
// Load a sample spreadsheet containing a shape
// Alternatively create a new spreadsheet and add a shape
var book = new Workbook("sample.xlsx");
...
Check the detailed article on [Working with 3D Formatting](https://docs.aspose.com/cells/net/working-with-the-threedformat-of-shape-or-chart/)
**C#**
// Load a sample spreadsheet containing a shape
// Alternatively create a new spreadsheet and add a shape
var book = new Workbook("sample.xlsx");
...
Check the detailed article on [Working with WordArt Styles](https://docs.aspose.com/cells/net/set-preset-wordart-style-to-the-text-of-the-shape/)
**C#**
...
Check the detailed article on [Add WordArt with Built-in Styles](https://docs.aspose.com/cells/net/add-word-art-text-with-built-in-styles/)
**C#**
...
Check the detailed article on [Add XML Map to Spreadsheet](https://docs.aspose.com/cells/net/add-xml-map-inside-the-workbook-using-xmlmapcollection-add-method/)
**C#**
// Create an instance of Workbook
var book = new Workbook();
...
Check the detailed article on [Link Cells to XML Map Elements](https://docs.aspose.com/cells/net/link-cells-to-xml-map-elements/)
**C#**
...
Check the detailed article on [Automatically Propagate Formula in List Object](https://docs.aspose.com/cells/net/propagate-formula-in-table-or-list-object-automatically-while-entering-data-in-new-rows/)
**C#**
// Create an instance of Workbook
var book = new Workbook();
// Access first worksheet from the collection
...
Check the detailed article on [Calculating Custom Functions with GridWeb](https://docs.aspose.com/cells/net/calculate-custom-functions-in-gridweb/)
**C#**
