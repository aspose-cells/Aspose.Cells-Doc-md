...
The code samples below show how to perform these steps using [VSTO](https://docs.aspose.com/cells/net/wrapping-cell-text/) with either C# or Visual Basic. Code samples that show how to do the same thing using [Aspose.Cells for .NET](https://docs.aspose.com/cells/net/wrapping-cell-text/), again using either C# or Visual Basic follow immediately after.
