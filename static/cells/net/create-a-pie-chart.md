...
The code samples in this article show how to add a pie chart with [VSTO](https://docs.aspose.com/cells/net/create-a-pie-chart/), using either C# or Visual Basic, compared to creating one with [Aspose.Cells](https://docs.aspose.com/cells/net/create-a-pie-chart/), again using either C# or Visual Basic.
