##Calculate Formulas
This article introduces how to use Aspose.Cells library to calculate formulas in Microsoft Excel. By loading an existing Excel file or creating a new Excel file, we can use the methods provided by Aspose.Cells to calculate the formula and get the result. Finally, we save the modified Excel file to disk.
...
## **Advance topics**
- [Add Cells to Microsoft Excel Formula Watch Window](https://docs.aspose.com/cells/net/add-cells-to-microsoft-excel-formula-watch-window/)
- [Calculating IFNA function using Aspose.Cells](https://docs.aspose.com/cells/net/calculating-ifna-function-using-aspose-cells/)
- [Calculation of Array Formula of Data Tables](https://docs.aspose.com/cells/net/calculation-of-array-formula-of-data-tables/)
- [Calculation of Excel 2016 MINIFS and MAXIFS functions](https://docs.aspose.com/cells/net/calculation-of-excel-2016-minifs-and-maxifs-functions/)
- [Decrease the Calculation Time of Cell.Calculate method](https://docs.aspose.com/cells/net/decrease-the-calculation-time-of-cell-calculate-method/)
- [Detecting Circular Reference](https://docs.aspose.com/cells/net/detecting-circular-reference/)
- [Direct calculation of custom function without writing it in a worksheet](https://docs.aspose.com/cells/net/direct-calculation-of-custom-function-without-writing-it-in-a-worksheet/)
- [Implement Custom Calculation Engine to extend the Default Calculation Engine of Aspose.Cells](https://docs.aspose.com/cells/net/implement-custom-calculation-engine-to-extend-the-default-calculation-engine-of-aspose-cells/)
...
- [Returning a Range of Values using ICustomFunction](https://docs.aspose.com/cells/net/returning-a-range-of-values-using-icustomfunction/)
- [Setting Formula Calculation Mode of Workbook](https://docs.aspose.com/cells/net/setting-formula-calculation-mode-of-workbook/)
- [Using FormulaText function in Aspose.Cells](https://docs.aspose.com/cells/net/using-formulatext-function-in-aspose-cells/)
- [Using ICustomFunction Feature](https://docs.aspose.com/cells/net/using-icustomfunction-feature/)
