...
## **Advance topics**
- [Custom Slice or Sector Colors in Pie Chart](https://docs.aspose.com/cells/net/custom-slice-or-sector-colors-in-pie-chart/)
- [Find if Data Points are in the Second Pie or Bar on a Pie of Pie or Bar of Pie Chart](https://docs.aspose.com/cells/net/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)
## Related Articles
- [Creating Charts](https://docs.aspose.com/cells/net/creating-charts/)
- [Cusomizing Charts](https://docs.aspose.com/cells/net/customizing-charts/)
- [Data Formatting in Charts](https://docs.aspose.com/cells/net/data-formatting-in-charts/)
