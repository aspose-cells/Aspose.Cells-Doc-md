...
## **Advance topics**
- [Change Adjustment Values of the Shape](https://docs.aspose.com/cells/net/change-adjustment-values-of-the-shape/)
- [Copy Shapes between Worksheets](https://docs.aspose.com/cells/net/copy-shapes-between-worksheets/)
- [Data in Non-Primitive Shape](https://docs.aspose.com/cells/net/data-in-non-primitive-shape/)
- [Finding Absolute Position of Shape inside the Worksheet](https://docs.aspose.com/cells/net/finding-absolute-position-of-shape-inside-the-worksheet/)
- [Get Connection points from shape](https://docs.aspose.com/cells/net/get-connection-points-from-shape/)
- [Managing Controls](https://docs.aspose.com/cells/net/managing-controls/)
- [Add Icons to Worksheet](https://docs.aspose.com/cells/net/insert-svg-to-excel/)
- [Managing OLE Objects](https://docs.aspose.com/cells/net/managing-ole-objects/)
- [Managing Pictures](https://docs.aspose.com/cells/net/managing-pictures/)
- [Manage Smart Art](https://docs.aspose.com/cells/net/managing-smartart/)
- [Managing TextBox](https://docs.aspose.com/cells/net/managing-textbox-of-excel/)
- [Add WordArt Watermark to Worksheet](https://docs.aspose.com/cells/net/add-wordart-watermark-to-worksheet/)
- [Refresh Values of Linked Shapes](https://docs.aspose.com/cells/net/refresh-values-of-linked-shapes/)
...
- [Manage Shape Options](https://docs.aspose.com/cells/net/managing-shape-options/)
- [Manage Shape Text Options](https://docs.aspose.com/cells/net/managing-shape-text-options/)
- [Web Extensions - Office Add-ins](https://docs.aspose.com/cells/net/web-extensions-office-add-ins/)
