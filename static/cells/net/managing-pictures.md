...
## **Advance topics**
- [Add Conditional Icons Set with the Cell Text](https://docs.aspose.com/cells/net/add-conditional-icons-set-with-the-cell-text/)
- [Insert a Linked Picture from Web Address](https://docs.aspose.com/cells/net/insert-a-linked-picture-from-web-address/)
- [Insert a Picture Based on Cell Reference](https://docs.aspose.com/cells/net/insert-a-picture-based-on-cell-reference/)
- [Load a Web Image from a URL into an Excel Worksheet](https://docs.aspose.com/cells/net/load-a-web-image-from-a-url-into-an-excel-worksheet/)
