##Worksheet Views
This article will describe how to use C# and the .NET API to interact with the page break preview of an Excel workbook and worksheets. Work with split panes, frozen panes, and zoom factor as well.
## **Page Break Preview**
...
## **Advance topics**
- [Hiding the Display of Zero Values in the Worksheet](https://docs.aspose.com/cells/net/hiding-the-display-of-zero-values-in-the-worksheet/)
- [Set Worksheet Tab Color](https://docs.aspose.com/cells/net/set-worksheet-tab-color/)
- [Show and Hide Gridlines and Row Column Headers](https://docs.aspose.com/cells/net/show-and-hide-gridlines-and-row-column-headers/)
- [Show and Hide Rows Columns and Scroll Bars](https://docs.aspose.com/cells/net/show-and-hide-rows-columns-and-scroll-bars/)
- [Show and Hide Worksheets and Tabs](https://docs.aspose.com/cells/net/show-and-hide-worksheets-and-tabs/)
- [Show Formulas Instead of Values in a Worksheet](https://docs.aspose.com/cells/net/show-formulas-instead-of-values-in-a-worksheet/)
- [Use Error Checking Options](https://docs.aspose.com/cells/net/use-error-checking-options/)
