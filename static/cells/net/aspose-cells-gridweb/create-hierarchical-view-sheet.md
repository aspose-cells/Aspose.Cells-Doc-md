...
This article introduce how to create hierarchical view in GridWeb.
...
As described in [Binding Worksheet to a DataSet using GridWeb's Worksheets Designer](https://docs.aspose.com/cells/net/binding-worksheet-to-a-dataset-using-gridwebs-worksheets-designer/),
