...
This article introduces how to export file in GridWeb.
...
If you don't know about how to add Aspose.Cells.GridWeb control to your web form then you should refer to [Add GridWeb to Web Form](https://docs.aspose.com/cells/net/aspose-cells-gridweb/add-gridweb-to-web-form/)
...
If you are working in Visual Studio you can easily create the SaveCommand event's event handler by double-clicking the event in the **Properties** pane. To learn more about this, please refer to [Working with GridWeb Events](https://docs.aspose.com/cells/net/aspose-cells-gridweb/working-with-gridweb-events/)
### **Export as a Stream**
