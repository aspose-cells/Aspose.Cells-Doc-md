##Format Cell
This article introduces how to set or apply style format for a cell (GridCell) in GridWeb.
...
Cells can be formatted [programmatically](https://docs.aspose.com/cells/net/aspose-cells-gridweb/format-cells/) but the easiest way to format cells in the Aspose.Cells.GridWeb control in a WYSIWYG way, is using the Style dialog.
...
Aspose.Cells.GridWeb supports setting number formats. There are 59 built-in number formats. To see them, please refer to this [list of supported number formats](https://docs.aspose.com/cells/net/aspose-cells-gridweb/list-of-supported-number-formats/).
