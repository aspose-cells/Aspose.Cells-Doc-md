...
This article introduces how to handle column filter event in GridWeb.
...
Check introduction to all [Working with GridWeb Events](https://docs.aspose.com/cells/net/aspose-cells-gridweb/working-with-gridweb-events/) along with some details on how to handle these event.
