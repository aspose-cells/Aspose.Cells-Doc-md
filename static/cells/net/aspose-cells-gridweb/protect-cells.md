##Protect Cells
This article introduces how to protect cells in GridWeb.
...
## **Protecting Cells**
Aspose.Cells.GridWeb provides a few different techniques for controlling the protection level on cells when the control is in [Edit mode](https://docs.aspose.com/cells/net/aspose-cells-gridweb/enable-different-gridweb-modes/#edit-mode) (the default mode). This protects cells from being modified by end users.
