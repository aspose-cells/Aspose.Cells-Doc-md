##Data Filtering
Learn how to add data filter by using the Aspose.Cells for .NET API.
...
- [Get All Hidden Rows Indices after Refreshing AutoFilter](https://docs.aspose.com/cells/net/get-all-hidden-rows-indices-after-refreshing-autofilter/)
