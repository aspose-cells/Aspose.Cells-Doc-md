...
Adding worksheets and setting which sheet is active are common and simple tasks that developers need to know how to perform. In this article, we carry out these tasks using [VSTO](https://docs.aspose.com/cells/net/adding-new-worksheets-to-workbook-and-activating-a-sheet/) and [Aspose.Cells for .NET](https://docs.aspose.com/cells/net/adding-new-worksheets-to-workbook-and-activating-a-sheet/).
