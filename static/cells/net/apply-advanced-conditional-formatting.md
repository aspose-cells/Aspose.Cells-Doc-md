...
How to use the Aspose.Cells library in C# to apply advanced conditional formatting. By adjusting these criteria, you have more control over how cells look and appear.
...
- [**Adding Color Scale Conditional Formattings**](https://docs.aspose.com/cells/net/adding-2-color-scale-and-3-color-scale-conditional-formattings/)
- [**Adding Above Average Conditional Formattings**](https://docs.aspose.com/cells/net/how-to-add-above-average-conditional-formatting/)
- [**Adding DataBars Conditional Formattings**](https://docs.aspose.com/cells/net/how-to-add-databars-conditional-formatting/)
- [**Adding IonSets Conditional Formattings**](https://docs.aspose.com/cells/net/how-to-add-icon-sets-conditional-formatting/)
- [**Adding Text Conditional Formattings**](https://docs.aspose.com/cells/net/how-to-add-text-conditional-formatting/)
- [**Adding TimePeriods Conditional Formattings**](https://docs.aspose.com/cells/net/how-to-add-time-periods-conditional-formatting/)
- [**Adding Top10 Conditional Formattings**](https://docs.aspose.com/cells/net/how-to-add-top10-conditional-formatting/)
