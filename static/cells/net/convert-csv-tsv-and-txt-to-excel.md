...
## **Advance topics**
- [Load or Import CSV file with Formulas](https://docs.aspose.com/cells/net/load-or-import-csv-file-with-formulas/)
- [Reading CSV File with Multiple Encodings](https://docs.aspose.com/cells/net/reading-csv-file-with-multiple-encodings/)
