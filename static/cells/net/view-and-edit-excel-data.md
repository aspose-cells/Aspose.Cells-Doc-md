...
This article describes how to view and edit data of Excel files with Aspose.Cells library.
In [Accessing Cells of a Worksheet](https://docs.aspose.com/cells/net/accessing-cells-of-a-worksheet/), we discussed basic approaches for accessing cells in a worksheet. This article uses one of those approaches to add different types of data to cells.
...
## **Advance topics**
- [Accessing Cells of a Worksheet](https://docs.aspose.com/cells/net/accessing-cells-of-a-worksheet/)
- [Convert Text Numeric Data to Number](https://docs.aspose.com/cells/net/convert-text-numeric-data-to-number/)
- [Creating Subtotals](https://docs.aspose.com/cells/net/creating-subtotals/)
- [Data Filtering](https://docs.aspose.com/cells/net/data-filtering/)
- [Data Sorting](https://docs.aspose.com/cells/net/sort-data-of-excel/)
- [Data Validation](https://docs.aspose.com/cells/net/data-validation/)
- [Export Data from Worksheet](https://docs.aspose.com/cells/net/export-data-from-worksheet/)
- [Find or Search Data](https://docs.aspose.com/cells/net/find-or-search-data/)
- [Get Cell String Value with and without Formatting](https://docs.aspose.com/cells/net/get-cell-string-value-with-and-without-formatting/)
- [Adding HTML Rich Text inside the Cell](https://docs.aspose.com/cells/net/adding-html-rich-text-inside-the-cell/)
- [Insert Hyperlinks into Excel or OpenOffice](https://docs.aspose.com/cells/net/insert-hyperlinks-to-excel/)
- [Import Data into Worksheet](https://docs.aspose.com/cells/net/import-data-into-worksheet/)
- [How and Where to Use Enumerators](https://docs.aspose.com/cells/net/how-and-where-to-use-enumerators/)
- [Measure the Width and Height of the Cell Value in Unit of Pixels](https://docs.aspose.com/cells/net/calculate-the-width-and-height-of-the-cell-value-in-unit-of-pixels/)
- [Reading Cell Values in Multiple Threads Simultaneously](https://docs.aspose.com/cells/net/reading-cell-values-in-multiple-threads-simultaneously/)
- [Conversion between cell name and row/column index](https://docs.aspose.com/cells/net/names-and-indices/)
- [Populate Data First by Row then by Column](https://docs.aspose.com/cells/net/populate-data-first-by-row-then-by-column/)
- [Preserve Single Quote Prefix of Cell Value or Range](https://docs.aspose.com/cells/net/preserve-single-quote-prefix-of-cell-value-or-range/)
- [Access and Update the Portions of Rich Text of Cell](https://docs.aspose.com/cells/net/access-and-update-the-portions-of-rich-text-of-cell/)
