...
## **Advance topics**
- [Encrypt And Decrypt ODS files](https://docs.aspose.com/cells/net/encrypt-and-decrypt-ods-files/)
- [Setting Strong Encryption Type](https://docs.aspose.com/cells/net/setting-strong-encryption-type/)
- [Specify Author while Write Protecting Workbook](https://docs.aspose.com/cells/net/specify-author-while-write-protecting-workbook/)
- [Verify Password of Encrypted Files](https://docs.aspose.com/cells/net/verify-password-of-encrypted-excel-and-ods-files/)
