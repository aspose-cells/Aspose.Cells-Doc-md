...
### **Smart Markers**
Additionally, Aspose.Cells lets you add [smart markers](https://docs.aspose.com/cells/python-java/smart-markers/) to the designer spreadsheet. Smart markers are processed at runtime using the [**WorkbookDesigner**](https://reference.aspose.com/cells/python-java/asposecells.api/WorkbookDesigner) class's Process method. This can help you write less code and still get great result.
[Find out more about smart markers](https://docs.aspose.com/cells/python-java/smart-markers/).
