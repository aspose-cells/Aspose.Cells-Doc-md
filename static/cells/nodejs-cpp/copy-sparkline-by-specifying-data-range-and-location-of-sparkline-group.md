##Copy Sparkline by Specifying Data Range and Location of Sparkline Group with Node.js via C++
Learn how to copy a sparkline in Excel by specifying data range and location of sparkline group using Aspose.Cells for Node.js via C++.
