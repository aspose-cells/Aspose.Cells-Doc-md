##Setting Chart Appearance with Node.js via C++
Learn how to configure the appearance of charts in Aspose.Cells for Node.js via C++. Our guide will show you how to modify chart layouts, colors, fonts, and effects to achieve the desired visual style and enhance your worksheets.
...
```
### **Setting Chart Lines**
Developers can also apply different kinds of styles on the lines or data markers of the [SeriesCollection](https://reference.aspose.com/cells/nodejs-cpp/seriescollection/). The following code snippet demonstrates how to set chart lines using Aspose.Cells API.
```javascript
const path = require("path");
const AsposeCells = require("aspose.cells.node");
// The path to the documents directory.
...
```
## **Advance topics**
- [Set the Values Format Code of Chart Series](https://docs.aspose.com/cells/nodejs-cpp/set-the-values-format-code-of-chart-series/)
- [Set Picture as Background Fill in the Chart](https://docs.aspose.com/cells/nodejs-cpp/set-picture-as-background-fill-in-the-chart/)
