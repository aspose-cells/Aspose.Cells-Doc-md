##Data Sorting
Learn how to sort data by using the Aspose.Cells for Node.js via C++ API.
...
## **Advance topics**
- [Sort Data in Column with Custom Sort List](https://docs.aspose.com/cells/nodejs-cpp/sort-data-in-column-with-custom-sort-list/)
- [Specifying Sort Warning While Sorting Data](https://docs.aspose.com/cells/nodejs-cpp/specifying-sort-warning-while-sorting-data/)
