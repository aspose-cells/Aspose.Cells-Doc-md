##Setting Shadow of Text Effects of Shape or TextBox with Node.js via C++
Learn how to set the shadow of text effects for any shape or TextBox using Aspose.Cells for Node.js via C++.
