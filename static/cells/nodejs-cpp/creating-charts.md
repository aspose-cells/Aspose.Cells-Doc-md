##Create and Manage Chart with Node.js via C++
Learn how to use Aspose.Cells for Node.js to create charts in Microsoft Excel. Our guide will demonstrate various chart types and how to customize their appearance and formatting.
...
```
## **Advance topics**
- [Read and Manipulate Excel 2016 Charts](https://docs.aspose.com/cells/nodejs-cpp/read-and-manipulate-excel-2016-charts/)
- [Manage Axes of Excel Charts](https://docs.aspose.com/cells/nodejs-cpp/chart-axes/)
- [Setting Chart Appearance](https://docs.aspose.com/cells/nodejs-cpp/setting-chart-appearance/)
- [Chart Types](https://docs.aspose.com/cells/nodejs-cpp/chart-types/)
- [Customizing Charts](https://docs.aspose.com/cells/nodejs-cpp/customizing-charts/)
- [Set Data source for the chart](https://docs.aspose.com/cells/nodejs-cpp/data-formatting-in-charts/)
- [Manage DataLabels of Excel Charts](https://docs.aspose.com/cells/nodejs-cpp/insert-datalabels-to-chart/)
- [Get Worksheet of the Chart](https://docs.aspose.com/cells/nodejs-cpp/get-worksheet-of-the-chart/)
- [Manage Legend of Excel Charts](https://docs.aspose.com/cells/nodejs-cpp/chart-legend/)
- [Manipulate Position Size and Designer Chart](https://docs.aspose.com/cells/nodejs-cpp/manipulate-position-size-and-designer-chart/)
- [Creating Pie Chart with Leader Lines](https://docs.aspose.com/cells/nodejs-cpp/creating-pie-chart-with-leader-lines/)
- [Shapes in Charts](https://docs.aspose.com/cells/nodejs-cpp/controls-in-charts/)
- [Manage Titles of Excel Charts](https://docs.aspose.com/cells/nodejs-cpp/chart-and-axis-titles/)
- [Chart Rendering](https://docs.aspose.com/cells/nodejs-cpp/chart-rendering/)
- [Get Equation Text of Chart Trendline](https://docs.aspose.com/cells/nodejs-cpp/get-equation-text-of-chart-trendline/)
