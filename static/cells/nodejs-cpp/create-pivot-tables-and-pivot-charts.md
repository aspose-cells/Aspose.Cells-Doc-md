...
How to add Pivot Tables and Pivot Charts with Aspose.Cells for Node.js via C++.
...
Aspose.Cells for Node.js via C++ supports [pivot tables](https://docs.aspose.com/cells/nodejs-cpp/create-pivot-tables-and-pivot-charts/) and [pivot charts](https://docs.aspose.com/cells/nodejs-cpp/create-pivot-tables-and-pivot-charts/).
