...
How to convert Excel to Ods (OpenOffice / LibreOffice Calc) or convert Ods (OpenOffice / LibreOffice Calc) to Excel with Aspose.Cells for Node.js via C++.
## **About OpenDocument**
...
```
## **Advance topics**
- [Save ODS File in ODF 1.1 and 1.2 Specifications](https://docs.aspose.com/cells/nodejs-cpp/save-ods-file-in-odf-1-1-and-1-2-specifications/)
- [Working with Background in ODS Files](https://docs.aspose.com/cells/nodejs-cpp/working-with-background-in-ods-files/)
