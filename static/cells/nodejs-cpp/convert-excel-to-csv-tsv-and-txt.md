##Convert Excel to CSV, TSV and Txt with Node.js via C++
Learn how to convert Excel files to CSV, TSV, and TXT formats using Aspose.Cells for Node.js via C++.
...
```
## **Advance topics**
- [Keep Separators for Blank Rows while exporting spreadsheets to CSV format](https://docs.aspose.com/cells/nodejs-cpp/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
- [Trim Leading Blank Rows and Columns while exporting spreadsheets to CSV format](https://docs.aspose.com/cells/nodejs-cpp/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
