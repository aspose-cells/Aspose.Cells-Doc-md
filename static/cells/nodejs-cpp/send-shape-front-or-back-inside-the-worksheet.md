##Send Shape Front or Back inside the Worksheet with Node.js via C++
Learn how to send a shape to the front or back in a worksheet using Aspose.Cells for Node.js via C++.
