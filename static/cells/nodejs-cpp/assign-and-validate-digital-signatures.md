##Assign and Validate Digital Signatures with Node.js via C++
Excel file digital signature and verification using Aspose.Cells for Node.js via C++. Protect the authenticity of workbook content with digital signatures.
...
```
## **Advance topics**
- [Add Digital Signature to an already signed Excel file](https://docs.aspose.com/cells/nodejs-cpp/add-digital-signature-to-an-already-signed-excel-file/)
- [Add Signature line to the worksheet](https://docs.aspose.com/cells/nodejs-cpp/add-signature-line/)
- [Support for XAdES Signature](https://docs.aspose.com/cells/nodejs-cpp/support-for-xades-signature/)
