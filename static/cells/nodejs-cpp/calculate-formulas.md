##Calculate Formulas with Node.js via C++
This article introduces how to use Aspose.Cells library to calculate formulas in Microsoft Excel using Node.js via C++. By loading an existing Excel file or creating a new Excel file, we can use the methods provided by Aspose.Cells to calculate the formula and get the result. Finally, we save the modified Excel file to disk.
...
## **Advance topics**
- [Add Cells to Microsoft Excel Formula Watch Window](https://docs.aspose.com/cells/nodejs-cpp/add-cells-to-microsoft-excel-formula-watch-window/)
- [Calculating IFNA function using Aspose.Cells](https://docs.aspose.com/cells/nodejs-cpp/calculating-ifna-function-using-aspose-cells/)
- [Calculation of Array Formula of Data Tables](https://docs.aspose.com/cells/nodejs-cpp/calculation-of-array-formula-of-data-tables/)
- [Calculation of Excel 2016 MINIFS and MAXIFS functions](https://docs.aspose.com/cells/nodejs-cpp/calculation-of-excel-2016-minifs-and-maxifs-functions/)
- [Decrease the Calculation Time of Cell.calculate method](https://docs.aspose.com/cells/nodejs-cpp/decrease-the-calculation-time-of-cell-calculate-method/)
- [Detecting Circular Reference](https://docs.aspose.com/cells/nodejs-cpp/detecting-circular-reference/)
...
- [Implement Custom Calculation Engine to extend the Default Calculation Engine of Aspose.Cells](https://docs.aspose.com/cells/nodejs-cpp/implement-custom-calculation-engine-to-extend-the-default-calculation-engine-of-aspose-cells/)
- [Interrupt or Cancel the Formula Calculation of Workbook](https://docs.aspose.com/cells/nodejs-cpp/interrupt-or-cancel-the-formula-calculation-of-workbook/)
- [Returning a Range of Values using AbstractCalculationEngine](https://docs.aspose.com/cells/nodejs-cpp/returning-a-range-of-values-using-abstractcalculationengine/)
- [Setting Formula Calculation Mode of Workbook](https://docs.aspose.com/cells/nodejs-cpp/setting-formula-calculation-mode-of-workbook/)
- [Using FormulaText function in Aspose.Cells](https://docs.aspose.com/cells/nodejs-cpp/using-formulatext-function-in-aspose-cells/)
