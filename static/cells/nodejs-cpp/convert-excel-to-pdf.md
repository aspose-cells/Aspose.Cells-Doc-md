...
Learn how to convert Excel Workbook into PDF using Aspose.Cells for Node.js via C++.
...
## **Advance topics**
- [Add PDF Bookmarks with Named Destinations](https://docs.aspose.com/cells/nodejs-cpp/add-pdf-bookmarks-with-named-destinations/)
- [Avoid Blank Page in Output PDF when there is Nothing to Print](https://docs.aspose.com/cells/nodejs-cpp/avoid-blank-page-in-output-pdf-when-there-is-nothing-to-print/)
- [Change the Font on just the specific Unicode characters while saving to PDF](https://docs.aspose.com/cells/nodejs-cpp/change-the-font-on-just-the-specific-unicode-characters-while-saving-to-pdf/)
- [Convert XLSX File to PDF Format](https://docs.aspose.com/cells/nodejs-cpp/convert-xlsx-file-to-pdf-format/)
- [Convert Excel file to PDF format compatible with PDFA-1a](https://docs.aspose.com/cells/nodejs-cpp/convert-excel-file-to-pdf-format-compatible-with-pdfa-1a/)
- [Convert XLS File with Images or Charts to PDF](https://docs.aspose.com/cells/nodejs-cpp/convert-xls-file-with-images-or-charts-to-pdf/)
- [Create PdfBookmarkEntry for Chart Sheet](https://docs.aspose.com/cells/nodejs-cpp/create-pdfbookmarkentry-for-chart-sheet/)
- [Fit All Worksheet Columns on Single PDF Page](https://docs.aspose.com/cells/nodejs-cpp/fit-all-worksheet-columns-on-single-pdf-page/)
- [Get DrawObject and Bound while rendering to PDF using DrawObjectEventHandler class](https://docs.aspose.com/cells/nodejs-cpp/get-drawobject-and-bound-while-rendering-to-pdf-using-drawobjecteventhandler-class/)
- [Get Warnings for Font Substitution while Rendering Excel File](https://docs.aspose.com/cells/nodejs-cpp/get-warnings-for-font-substitution-while-rendering-excel-file/)
- [Ignore Errors while Rendering Excel to PDF](https://docs.aspose.com/cells/nodejs-cpp/ignore-errors-while-rendering-excel-to-pdf/)
- [Limit the Number of Pages Generated - Excel to PDF Conversion](https://docs.aspose.com/cells/nodejs-cpp/limit-the-number-of-pages-generated-excel-to-pdf-conversion/)
- [Print Comments while saving to PDF](https://docs.aspose.com/cells/nodejs-cpp/print-comments-while-saving-to-pdf/)
- [Render Office Add-Ins while converting Excel to PDF](https://docs.aspose.com/cells/nodejs-cpp/render-office-add-ins-while-converting-excel-to-pdf/)
- [Render One PDF Page Per Excel Worksheet - Excel to PDF Conversion](https://docs.aspose.com/cells/nodejs-cpp/render-one-pdf-page-per-excel-worksheet-excel-to-pdf-conversion/)
- [Render Unicode Supplementary characters in output PDF by Aspose.Cells](https://docs.aspose.com/cells/nodejs-cpp/render-unicode-supplementary-characters-in-output-pdf-by-aspose-cells/)
- [Resampling Added Images - Excel to PDF Conversion](https://docs.aspose.com/cells/nodejs-cpp/resampling-added-images-excel-to-pdf-conversion/)
- [Save Each Worksheet to a Different PDF File](https://docs.aspose.com/cells/nodejs-cpp/save-each-worksheet-to-a-different-pdf-file/)
- [Save Excel into PDF with Standard or Minimum Size](https://docs.aspose.com/cells/nodejs-cpp/save-excel-into-pdf-with-standard-or-minimum-size/)
- [Save Specified Worksheets to PDF](https://docs.aspose.com/cells/nodejs-cpp/save-specified-worksheets-to-pdf/)
- [Secure PDF Documents](https://docs.aspose.com/cells/nodejs-cpp/secure-pdf-documents/)
- [Specify how to cross string in output PDF and image](https://docs.aspose.com/cells/nodejs-cpp/specify-how-to-cross-string-in-output-pdf-and-image/)
