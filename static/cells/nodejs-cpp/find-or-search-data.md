##Find or Search Data
Learn how to find or search cells in a worksheet that contains specified data through the Aspose.Cells for Node.js via C++ API.
...
## **Advance topics**
- [Find Cells with Specific Style](https://docs.aspose.com/cells/nodejs-cpp/find-cells-with-specific-style/)
- [Find if the cell value starts with single quote mark](https://docs.aspose.com/cells/nodejs-cpp/find-if-the-cell-value-starts-with-single-quote-mark/)
- [Search Data using Original Values](https://docs.aspose.com/cells/nodejs-cpp/search-data-using-original-values/)
