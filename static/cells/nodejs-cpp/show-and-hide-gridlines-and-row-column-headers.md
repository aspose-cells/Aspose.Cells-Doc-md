##Show and Hide Gridlines and Row Column Headers with Node.js via C++
This article provides sample code for using the Node.js API via C++ to programmatically hide or show gridlines, row, and column headers of an Excel worksheet.
