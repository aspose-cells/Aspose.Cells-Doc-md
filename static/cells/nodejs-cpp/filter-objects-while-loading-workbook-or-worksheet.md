##Filter Objects while loading Workbook or Worksheet with Node.js via C++
Learn how to filter data while loading workbooks or worksheets using Aspose.Cells for Node.js via C++.
