##Managing Ranges with Node.js via C++
Learn how to manage ranges in Excel using Aspose.Cells for Node.js via C++. Create ranges, set values, styles, and perform various operations.
## **Introduction**
...
```
## **Advance topics**
- [AutoFill range of Excel file](https://docs.aspose.com/cells/nodejs-cpp/autofill-ranges/)
- [Copy Ranges of Excel](https://docs.aspose.com/cells/nodejs-cpp/copy-ranges-of-Excel/)
- [Copy Range Data Only](https://docs.aspose.com/cells/nodejs-cpp/copy-range-data-only/)
- [Copy Range Data with Style](https://docs.aspose.com/cells/nodejs-cpp/copy-range-data-with-style/)
- [Copy Range Style Only](https://docs.aspose.com/cells/nodejs-cpp/copy-range-style-only/)
- [Create Union Range](https://docs.aspose.com/cells/nodejs-cpp/create-union-range/)
- [Cut and Paste Range](https://docs.aspose.com/cells/nodejs-cpp/cut-and-paste-cells/)
- [Delete Ranges](https://docs.aspose.com/cells/nodejs-cpp/delete-ranges-from-Excel/)
- [Get Address Cell Count Offset Entire Column and Entire Row of the Range](https://docs.aspose.com/cells/nodejs-cpp/get-address-cell-count-offset-entire-column-and-entire-row-of-the-range/)
- [Insert Ranges](https://docs.aspose.com/cells/nodejs-cpp/insert-ranges-to-Excel/)
- [Merge or Unmerge Range of Cells](https://docs.aspose.com/cells/nodejs-cpp/merge-or-unmerge-range-of-cells/)
- [Move Range of Cells in a Worksheet](https://docs.aspose.com/cells/nodejs-cpp/move-range-of-cells-in-a-worksheet/)
- [Create Workbook and Worksheet Scoped Named Ranges](https://docs.aspose.com/cells/nodejs-cpp/create-workbook-and-worksheet-scoped-named-ranges/)
- [Search and Replace Data in a Range](https://docs.aspose.com/cells/nodejs-cpp/search-and-replace-data-in-a-range/)
