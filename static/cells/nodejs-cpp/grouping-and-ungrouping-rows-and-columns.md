##Grouping and Ungrouping Rows and Columns with Node.js via C++
Discover how to group and ungroup rows and columns in Excel using Aspose.Cells for Node.js via C++.
## **Introduction**
