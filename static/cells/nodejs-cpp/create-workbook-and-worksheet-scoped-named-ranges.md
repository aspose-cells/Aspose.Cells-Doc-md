##Create Workbook and Worksheet Scoped Named Ranges with Node.js via C++
Learn how to create workbook and worksheet scoped named ranges using Aspose.Cells for Node.js via C++.
...
```
## **Advance topics**
- [Create Access and Copy Named Ranges](https://docs.aspose.com/cells/nodejs-cpp/create-access-and-copy-named-ranges/)
- [Format and Modify Named Ranges](https://docs.aspose.com/cells/nodejs-cpp/format-and-modify-named-ranges/)
- [Get Range with External Links](https://docs.aspose.com/cells/nodejs-cpp/get-range-with-external-links/)
- [Implementing Non-Sequential Ranges](https://docs.aspose.com/cells/nodejs-cpp/implementing-non-sequential-ranges/)
