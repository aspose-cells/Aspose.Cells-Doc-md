##Support for German Locale in Named Range Formulae with Node.js via C++
Learn how to support German locale in named range formulae using Aspose.Cells for Node.js via C++.
