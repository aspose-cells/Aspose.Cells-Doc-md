##Get or Set the Class Identifier of the Embedded OLE Object with Node.js via C++
Learn how to get or set the class identifier of embedded OLE objects in Node.js using Aspose.Cells via C++.
