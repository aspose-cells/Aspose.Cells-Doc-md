##Count number of cells in the Worksheet with Node.js via C++
Learn how to programmatically count the number of cells in an Excel worksheet using Aspose.Cells for Node.js via C++.
