##Specify how to cross string in output PDF and image with Node.js via C++
Learn to control text overflow in output PDF/Image by specifying the cross type using Aspose.Cells for Node.js via C++.
