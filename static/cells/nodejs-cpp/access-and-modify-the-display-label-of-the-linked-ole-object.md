##Access and Modify the Display Label of the Linked Ole Object with Node.js via C++
Learn how to access and modify the display label of a linked Ole object using Aspose.Cells for Node.js via C++.
