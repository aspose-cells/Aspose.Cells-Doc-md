##Extract Text from the Gear Type SmartArt Shape with Node.js via C++
Learn how to extract text from the Gear Type SmartArt Shape using Aspose.Cells for Node.js via C++.
