##Chart to Image with Node.js via C++
Learn how to use Aspose.Cells for Node.js via C++ to convert a chart to an image format, such as JPEG or PNG. Our guide will demonstrate how to export a chart from Microsoft Excel and save it as a standalone image for further use and manipulation.
## **Rendering Charts**
...
## **Advance topics**
- [Convert Chart to PDF](https://docs.aspose.com/cells/nodejs-cpp/chart-to-pdf/)
