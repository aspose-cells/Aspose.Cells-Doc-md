##Copy Range Style Only with Node.js via C++
Learn how to copy only the style of a range while manipulating data in Aspose.Cells for Node.js via C++.
[Copy Range Data Only](https://docs.aspose.com/cells/nodejs-cpp/copy-range-data-only/) and [Copy Range Data with Style](https://docs.aspose.com/cells/nodejs-cpp/copy-range-data-with-style/) explained how to copy data from a range to another on its own or complete with formatting. It is also possible to copy only the formatting. This article shows how.
