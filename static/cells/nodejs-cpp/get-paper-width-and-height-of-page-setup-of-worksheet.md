##Get Paper Width and Height of Page Setup of Worksheet with Node.js via C++
Discover how to get the Excel Worksheet Page Setup Paper Width and Height using Node.js via C++ programmatically.
