##Disable Exporting Frame Scripts and Document Properties with Node.js via C++
Learn how to disable exporting frame scripts and document properties when converting a workbook to HTML using Aspose.Cells for Node.js via C++.
