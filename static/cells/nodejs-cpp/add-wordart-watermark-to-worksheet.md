##Add WordArt Watermark to Worksheet with Node.js via C++
Learn how to add WordArt as a background watermark to a worksheet using Aspose.Cells for Node.js via C++.
...
```
## **Advance topics**
- [Add Word Art Text with Built-in Styles](https://docs.aspose.com/cells/nodejs-cpp/add-word-art-text-with-built-in-styles/)
- [Locking WordArt Watermark](https://docs.aspose.com/cells/nodejs-cpp/locking-wordart-watermark/)
- [Set preset WordArt style to the text of the shape](https://docs.aspose.com/cells/nodejs-cpp/set-preset-wordart-style-to-the-text-of-the-shape/)
