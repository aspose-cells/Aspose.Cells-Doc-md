##Format cells with Node.js via C++
Learn how to format and style cells in Aspose.Cells for Node.js via C++, including number formatting, date formatting, font styles, and other cell style options. Our guide will help you create attractive and professional-looking spreadsheets.
## **Introduction**
...
```
## **Advance topics**
- [Alignment Settings](https://docs.aspose.com/cells/nodejs-cpp/cells-alignment-settings/)
- [Border Settings](https://docs.aspose.com/cells/nodejs-cpp/cells-border-settings/)
- [Set Conditional Formats of Excel and ODS files.](https://docs.aspose.com/cells/nodejs-cpp/conditional-formatting/)
- [Excel Themes and Colors](https://docs.aspose.com/cells/nodejs-cpp/excel-themes-and-colors/)
- [Fill Settings](https://docs.aspose.com/cells/nodejs-cpp/cells-fill-settings/)
- [Font Settings](https://docs.aspose.com/cells/nodejs-cpp/cells-font-settings/)
- [Format Worksheet Cells in a Workbook](https://docs.aspose.com/cells/nodejs-cpp/format-worksheet-cells-in-a-workbook/)
- [Implement 1904 Date System](https://docs.aspose.com/cells/nodejs-cpp/implement-1904-date-system/)
- [Merging and Unmerging Cells](https://docs.aspose.com/cells/nodejs-cpp/merging-and-unmerging-cells/)
- [Number Settings](https://docs.aspose.com/cells/nodejs-cpp/cells-number-settings/)
- [Get and Set Style for cells](https://docs.aspose.com/cells/nodejs-cpp/evaluating-cell-getstyle-and-setstyle-methods-against-cell-style-property/)
