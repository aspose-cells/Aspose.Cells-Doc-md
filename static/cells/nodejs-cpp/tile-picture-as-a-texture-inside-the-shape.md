##Tile Picture as a Texture inside the Shape with Node.js via C++
Learn how to tile a small picture as a texture inside a shape using Aspose.Cells for Node.js via C++.
