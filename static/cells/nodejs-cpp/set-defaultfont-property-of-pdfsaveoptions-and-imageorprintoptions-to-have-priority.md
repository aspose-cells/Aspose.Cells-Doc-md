##Set DefaultFont property of PdfSaveOptions and ImageOrPrintOptions to have priority with Node.js via C++
Discover how to set the DefaultFont property of PdfSaveOptions and ImageOrPrintOptions using Aspose.Cells for Node.js via C++. Ensure proper font rendering when fonts are missing.
