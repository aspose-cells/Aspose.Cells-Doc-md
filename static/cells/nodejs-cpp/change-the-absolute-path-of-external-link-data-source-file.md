##Change the Absolute Path of External Link Data Source File with Node.js via C++
Learn how to change the absolute path of the external link data source file using Aspose.Cells for Node.js via C++.
