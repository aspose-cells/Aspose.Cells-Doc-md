...
Learn how to Manage formulas of Excel files through the Aspose.Cells for Node.js via C++. Aspose.Cells can simply get, set and calculate formulas of excel files.
## **Introduction**
...
Built-in functions or formulas are provided as ready-made functions to reduce developers' efforts and time. See [a list of built-in functions](https://docs.aspose.com/cells/nodejs-cpp/supported-formula-functions/) supported by Aspose.Cells. The functions are listed in alphabetical order. More functions will be supported in future.
...
```
## **Advance topics**
- [Precedents and Dependents](https://docs.aspose.com/cells/nodejs-cpp/precedents-and-dependents/)
- [Set External Links in Formulas](https://docs.aspose.com/cells/nodejs-cpp/set-external-links-in-formulas/)
- [Propagate Formula in Table or List Object automatically while entering data in new rows](https://docs.aspose.com/cells/nodejs-cpp/propagate-formula-in-table-or-list-object-automatically-while-entering-data-in-new-rows/)
- [Setting Formula for Named Range](https://docs.aspose.com/cells/nodejs-cpp/setting-formula-for-named-range/)
- [Setting Formulas - Notice for Non English Users](https://docs.aspose.com/cells/nodejs-cpp/setting-formulas-notice-for-non-english-users/)
- [Setting Shared Formula](https://docs.aspose.com/cells/nodejs-cpp/setting-shared-formula/)
- [Specify Maximum Rows of Shared Formula](https://docs.aspose.com/cells/nodejs-cpp/specify-maximum-rows-of-shared-formula/)
- [Supported Excel Functions](https://docs.aspose.com/cells/nodejs-cpp/supported-formula-functions/)
