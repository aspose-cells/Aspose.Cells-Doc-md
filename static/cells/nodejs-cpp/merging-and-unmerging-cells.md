##Merging and Unmerging Cells with Node.js via C++
Aspose.Cells is a Node.js library for working with spreadsheet files, which supports merging and unmerging cells. This article will introduce how to merge and unmerge cells using the Aspose.Cells library, with options for customizing the merged cell style.
...
```
## **Advance topics**
- [Detect Merged Cells in a Worksheet](https://docs.aspose.com/cells/nodejs-cpp/detect-merged-cells-in-a-worksheet/)
