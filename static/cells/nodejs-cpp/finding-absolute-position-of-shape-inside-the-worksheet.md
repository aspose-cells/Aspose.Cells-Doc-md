##Finding Absolute Position of Shape inside the Worksheet with Node.js via C++
Learn how to find the absolute position of a shape inside a worksheet using Aspose.Cells for Node.js via C++.
