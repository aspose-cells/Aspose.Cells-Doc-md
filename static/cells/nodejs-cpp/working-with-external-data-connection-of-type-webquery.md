##Working with External Data Connection of type WebQuery with Node.js via C++
Learn how to work with external data connections of type WebQuery using Aspose.Cells for Node.js via C++.
