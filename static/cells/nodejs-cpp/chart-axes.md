...
Learn how to configure chart axes in Aspose.Cells for Node.js via C++. Our guide will show you how to adjust the primary and secondary axes, set their ranges, and modify their properties to enhance your charts.
...
```
## **Advance topics**
- [Change Tick Label Direction](https://docs.aspose.com/cells/nodejs-cpp/change-tick-label-direction/)
- [Determine which Axis exists in the Chart](https://docs.aspose.com/cells/nodejs-cpp/determine-which-axis-exists-in-the-chart/)
- [Handle Automatic Units of Chart Axis like Microsoft Excel](https://docs.aspose.com/cells/nodejs-cpp/handle-automatic-units-of-chart-axis-like-microsoft-excel/)
- [Read Axis Labels after Calculating the Chart](https://docs.aspose.com/cells/nodejs-cpp/read-axis-labels-after-calculating-the-chart/)
- [How to Set Category Axis in Excel Chart](https://docs.aspose.com/cells/nodejs-cpp/how-to-set-category-axis/)
