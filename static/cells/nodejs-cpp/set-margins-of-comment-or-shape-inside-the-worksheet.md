##Set Margins of Comment or Shape inside the Worksheet with Node.js via C++
Learn how to set margins of comments or shapes within an Excel worksheet using Aspose.Cells for Node.js via C++.
