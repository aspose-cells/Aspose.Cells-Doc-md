...
Protect and unprotect worksheet of Excel files with Aspose.Cells for Node.js via C++.
...
```
## **Advance topics**
- [Advanced Protection Settings since Excel XP](https://docs.aspose.com/cells/nodejs-cpp/advanced-protection-settings-since-excel-xp/)
- [Detect if Worksheet is Password Protected](https://docs.aspose.com/cells/nodejs-cpp/detect-if-worksheet-is-password-protected/)
- [Protecting Worksheets](https://docs.aspose.com/cells/nodejs-cpp/protecting-worksheets/)
- [Unprotect a Worksheet](https://docs.aspose.com/cells/nodejs-cpp/unprotect-a-worksheet/)
- [Verify Password Used to Protect the Worksheet](https://docs.aspose.com/cells/nodejs-cpp/verify-password-used-to-protect-the-worksheet/)
