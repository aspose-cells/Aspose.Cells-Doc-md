...
Import data from XML files into Excel using Aspose.Cells for Node.js via C++.
...
```
## **Advanced topics**
- [Add XML Map inside the Workbook using XmlMapCollection.add() method](https://docs.aspose.com/cells/nodejs-cpp/add-xml-map-inside-the-workbook-using-xmlmapcollection-add-method/)
- [Export XML Data linked to XML Map inside the Workbook](https://docs.aspose.com/cells/nodejs-cpp/export-xml-data-linked-to-xml-map-inside-the-workbook/)
- [Find the Root Element Name of XML Map](https://docs.aspose.com/cells/nodejs-cpp/find-the-root-element-name-of-xml-map/)
- [Link Cells to XML Map Elements](https://docs.aspose.com/cells/nodejs-cpp/link-cells-to-xml-map-elements/)
