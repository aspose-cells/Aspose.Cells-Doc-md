##Create and manage tables of Microsoft Excel files with Node.js via C++
Insert, resize, edit, delete, and format tables of Excel files using Aspose.Cells for Node.js via C++.
## **Create Table**
...
```
## **Advance topics**
- [Convert Table to ODS](https://docs.aspose.com/cells/nodejs-cpp/convert-table-to-ods/)
- [Find Query Tables and List Objects related to External Data Connections](https://docs.aspose.com/cells/nodejs-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/)
- [Read and Write Table with Query Table Data Source](https://docs.aspose.com/cells/nodejs-cpp/read-and-write-table-with-query-table-data-source/)
- [Set the Comment of Table or List Object inside the Worksheet](https://docs.aspose.com/cells/nodejs-cpp/set-the-comment-of-table-or-list-object-inside-the-worksheet/)
- [Tables and Ranges](https://docs.aspose.com/cells/nodejs-cpp/tables-and-ranges/)
