##Detecting Empty Worksheets with Node.js via C++
This article shows you code explaining how to detect empty worksheets of Excel workbooks programmatically using the Node.js API with C++ library.
