##Freeze First Column(s) of Excel Worksheet with Node.js via C++
Learn how to freeze left columns of Excel Worksheets programmatically using Aspose.Cells for Node.js via C++.
## **Introduction**
