...
Aspose.Cells supports printing and previewing Excel files without Microsoft Excel installation using Node.js via C++.
## **Print Preview**
...
## **Advance topics**
- [Configuring Fonts for Rendering Spreadsheets](https://docs.aspose.com/cells/nodejs-cpp/configuring-fonts-for-rendering-spreadsheets/)
- [Convert Worksheet to Image - Remove whitespace around data](https://docs.aspose.com/cells/nodejs-cpp/convert-worksheet-to-image-remove-whitespace-around-data/)
- [Converting Worksheet to Image and Worksheet to Image by Page](https://docs.aspose.com/cells/nodejs-cpp/converting-worksheet-to-image-and-worksheet-to-image-by-page/)
- [Converting Worksheet to Image using ImageOrPrint Options](https://docs.aspose.com/cells/nodejs-cpp/converting-worksheet-to-image-using-imageorprint-options/)
- [Export Range of Cells in a Worksheet to Image](https://docs.aspose.com/cells/nodejs-cpp/export-range-of-cells-in-a-worksheet-to-image/)
- [Export Worksheet or Chart into Image with Desired Width and Height](https://docs.aspose.com/cells/nodejs-cpp/export-worksheet-or-chart-into-image-with-desired-width-and-height/)
- [Extract Images from Worksheets using ImageOrPrintOptions](https://docs.aspose.com/cells/nodejs-cpp/extract-images-from-worksheets-using-imageorprintoptions/)
- [Generate Thumbnail of the Worksheet](https://docs.aspose.com/cells/nodejs-cpp/generate-thumbnail-of-the-worksheet/)
- [Output Blank Page when there is Nothing to Print](https://docs.aspose.com/cells/nodejs-cpp/output-blank-page-when-there-is-nothing-to-print/)
- [Page Setup and Printing Options](https://docs.aspose.com/cells/nodejs-cpp/page-setup-and-printing-options/)
- [Render Sequence of Pages using PageIndex and PageCount Properties of ImageOrPrintOptions](https://docs.aspose.com/cells/nodejs-cpp/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/)
- [Render Worksheet to Graphic Context](https://docs.aspose.com/cells/nodejs-cpp/render-worksheet-to-graphic-context/)
- [Specify Individual or Private Set of Fonts for Workbook Rendering](https://docs.aspose.com/cells/nodejs-cpp/specify-individual-or-private-set-of-fonts-for-workbook-rendering/)
