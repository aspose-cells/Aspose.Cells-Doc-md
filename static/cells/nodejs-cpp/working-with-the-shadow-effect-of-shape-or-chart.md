##Working with the Shadow Effect of Shape or Chart with Node.js via C++
Learn how to work with the shadow effect of shapes or charts using Aspose.Cells for Node.js via C++.
