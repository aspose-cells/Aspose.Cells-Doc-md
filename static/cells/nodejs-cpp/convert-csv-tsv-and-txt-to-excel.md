##Convert CSV, TSV and TXT to Excel with Node.js via C++
...
```
## **Advance topics**
- [Load or Import CSV file with Formulas](https://docs.aspose.com/cells/nodejs-cpp/load-or-import-csv-file-with-formulas/)
- [Reading CSV File with Multiple Encodings](https://docs.aspose.com/cells/nodejs-cpp/reading-csv-file-with-multiple-encodings/)
