##Setting ScaleCrop and LinksUpToDate properties of Built-In Document Properties with Node.js via C++
Learn how to set ScaleCrop and LinksUpToDate properties of built-in document properties using Aspose.Cells for Node.js via C++.
