##Copy Page Setup Settings from Source Worksheet into Destination Worksheet with Node.js via C++
This article explains how to use the Node.js API or C++ Library sample code to copy Page Setup settings from a source Worksheet into a destination Worksheet programmatically.
