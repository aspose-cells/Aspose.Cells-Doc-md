##Check if Workbook contains hidden External Links with Node.js via C++
Learn how to check if a workbook contains hidden external links using Aspose.Cells for Node.js via C++.
