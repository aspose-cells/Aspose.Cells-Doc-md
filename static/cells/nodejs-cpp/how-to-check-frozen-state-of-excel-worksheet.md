##How to check Frozen State without Excel using Node.js via C++
In this article, you will learn how to check the frozen state of an Excel worksheet programmatically using Node.js with C++ library.
## **Introduction**
