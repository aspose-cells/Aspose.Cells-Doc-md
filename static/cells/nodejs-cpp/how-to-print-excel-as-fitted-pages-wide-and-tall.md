##How to Print Excel as Fitted Pages Wide and Tall with Node.js via C++
This article shows you code explaining how to set FitToPagesWide and FitToPagesTall using Aspose.Cells for Node.js via C++.
## **Introduction**
