##Configuring Fonts for Rendering Spreadsheets with Node.js via C++
Learn how to configure fonts for rendering spreadsheets using Aspose.Cells for Node.js via C++. Ensure fonts are available for optimal conversion fidelity.
...
## **Advance topics**
- [Set Default Font while rendering spreadsheet to images](https://docs.aspose.com/cells/nodejs-cpp/set-default-font-while-rendering-spreadsheet-to-images/)
- [Set DefaultFont property of PdfSaveOptions and ImageOrPrintOptions to have priority](https://docs.aspose.com/cells/nodejs-cpp/set-defaultfont-property-of-pdfsaveoptions-and-imageorprintoptions-to-have-priority/)
- [Supported Font Formats](https://docs.aspose.com/cells/nodejs-cpp/supported-font-formats/)
- [Worksheet to Image - Set Pixel Format for the Rendered Image](https://docs.aspose.com/cells/nodejs-cpp/worksheet-to-image-set-pixel-format-for-the-rendered-image/)
