##How to change background in comment in Excel with Node.js via C++
How to change color in comment and insert picture or image in comment in Excel using Aspose.Cells for Node.js via C++.
