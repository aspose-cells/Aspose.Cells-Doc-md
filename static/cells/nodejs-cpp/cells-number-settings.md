##Number Settings
Aspose.Cells is a Node.js library for working with spreadsheet files that supports many different cell number settings. This article introduces how to use the Aspose.Cells library to manage the number settings of cells for adjusting number formats in spreadsheets.
...
## **Advance topics**
- [Check Custom Number Format when Setting Style.Custom Property](https://docs.aspose.com/cells/nodejs-cpp/check-custom-number-format-when-setting-style-custom-property/)
- [List of Supported Number Formats](https://docs.aspose.com/cells/nodejs-cpp/list-of-supported-number-formats/)
- [Render Custom Date Format Pattern g and ge mm dd](https://docs.aspose.com/cells/nodejs-cpp/render-custom-date-format-pattern-g-and-ge-mm-dd/)
- [Specify Custom Number Decimal and Group Separators for Workbook](https://docs.aspose.com/cells/nodejs-cpp/specify-custom-number-decimal-and-group-separators-for-workbook/)
- [Specifying DBNum Custom Pattern Formatting](https://docs.aspose.com/cells/nodejs-cpp/specifying-dbnum-custom-pattern-formatting/)
