##Converting Worksheet to Image using ImageOrPrint Options with Node.js via C++
Learn how to convert a worksheet to an image file and apply various image and print options using Aspose.Cells for Node.js via C++.
