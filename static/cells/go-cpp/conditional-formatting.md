##Set Conditional Formats of Excel and ODS files with Golang via C++
How to apply conditional formats to Excel and ODS files in C++.
## **Introduction**
...
### **Set Pattern**
## **Advance topics**
- [Adding 2-Color Scale and 3-Color Scale Conditional Formattings](https://docs.aspose.com/cells/cpp/adding-2-color-scale-and-3-color-scale-conditional-formattings/)
- [Apply Advanced Conditional Formatting](https://docs.aspose.com/cells/cpp/apply-advanced-conditional-formatting/)
- [Apply Conditional Formatting in Worksheets](https://docs.aspose.com/cells/cpp/apply-conditional-formatting-in-worksheets/)
- [Apply Shading to Alternate Rows and Columns with Conditional Formatting](https://docs.aspose.com/cells/cpp/apply-shading-to-alternate-rows-and-columns-with-conditional-formatting/)
- [Generate Conditional Formatting DataBars Images](https://docs.aspose.com/cells/cpp/generate-conditional-formatting-databars-images/)
- [Get Icon Sets, Data Bars or Color Scales Objects used in Conditional Formatting](https://docs.aspose.com/cells/cpp/get-icon-sets-data-bars-or-color-scales-objects-used-in-conditional-formatting/)
