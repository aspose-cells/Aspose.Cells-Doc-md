##Alignment Settings with Golang via C++
...
## **Advance topics**
- [Change Cells Alignment and Keep Existing Formatting](https://docs.aspose.com/cells/cpp/change-cells-alignment-and-keep-existing-formatting/)
- [Line Breaks and Text Wrapping](https://docs.aspose.com/cells/cpp/line-breaks-and-text-wrapping/)
