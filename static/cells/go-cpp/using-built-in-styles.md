##Using Built-in Styles with Golang via C++
C++ code to use Excel built-in styles with Aspose.Cells for C++ API
...
The method [**Workbook.CreateBuiltinStyle**](https://reference.aspose.com/cells/go-cpp/workbook/createbuiltinstyle/) and the enumeration [**BuiltinStyleType**](https://reference.aspose.com/cells/cpp/aspose.cells/builtinstyletype/) make it convenient to use built-in styles. Here is a list of all possible built-in styles:
