...
## **Advance topics**
- [Change Cells Alignment and Keep Existing Formatting](https://docs.aspose.com/cells/java/change-cells-alignment-and-keep-existing-formatting/)
- [Line Breaks and Text Wrapping](https://docs.aspose.com/cells/java/line-breaks-and-text-wrapping/)
