...
- [Standard types](https://docs.aspose.com/cells/java/chart-types/).
- [Custom types](https://docs.aspose.com/cells/java/chart-types/).
### **Standard Types**
Standard charts are those normally used with standard formatting:
|<p>- [Column](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Bar](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Line](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Pie](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Scatter](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Area](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Doughnut](https://docs.aspose.com/cells/java/chart-types/)</p>|<p>- [Radar](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Surface 3D](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Bubble](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Stock](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Cylinder](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Cone](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Pyramid](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Treemap](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Sunburst](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Histogram](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Box and Whisker](https://docs.aspose.com/cells/java/chart-types/)</p><p>- [Waterfall](https://docs.aspose.com/cells/java/chart-types/)</p>|
| :- | :- |
