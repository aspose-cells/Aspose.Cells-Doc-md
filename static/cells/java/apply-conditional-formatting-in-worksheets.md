...
1. [Using Aspose.Cells to apply conditional formatting based on cell value](https://docs.aspose.com/cells/java/apply-conditional-formatting-in-worksheets/#task-1-using-asposecells-to-apply-conditional-formatting-based-on-cell-value).
1. [Using Aspose.Cells to apply conditional formatting based on a formula](https://docs.aspose.com/cells/java/apply-conditional-formatting-in-worksheets/#task-2-using-asposecells-to-apply-conditional-formatting-based-on-a-formula).
