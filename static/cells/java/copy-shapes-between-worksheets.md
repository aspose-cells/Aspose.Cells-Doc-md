...
- [Copy a picture from one worksheet to another](https://docs.aspose.com/cells/java/copy-shapes-between-worksheets/#copying-a-picture-from-one-worksheet-to-another).
- [Copy a chart from one worksheet to another](https://docs.aspose.com/cells/java/copy-shapes-between-worksheets/#task-2-copying-a-chart-from-one-worksheet-to-another).
- [Copy controls and other drawing objects from one worksheet to another](https://docs.aspose.com/cells/java/copy-shapes-between-worksheets/#task-3-copying-controls-and-other-drawing-objects-from-one-worksheet-to-another).
