...
Aspose.Cells for Java 8.6.2 has exposed the Workbook.removeUnusedStyles method that can be used to [remove all unused Style objects from the pool of styles](https://docs.aspose.com/cells/java/remove-unused-styles-inside-the-workbook/).
Following is the simple usage scenario.
**Java**
//Load spreadsheet
Workbook workbook = new Workbook(inputFilePath);
