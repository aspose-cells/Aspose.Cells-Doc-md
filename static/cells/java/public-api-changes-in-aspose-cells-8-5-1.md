##Public API Changes in Aspose.Cells 8.5.1
This document describes the changes to the Aspose.Cells API from version 8.5.0 to 8.5.1 that may be of interest to module/application developers. It includes not only new and updated public methods, [added classes etc.](https://docs.aspose.com/cells/java/public-api-changes-in-aspose-cells-8-5-1/), but also a description of any changes in the behavior behind the scenes in Aspose.Cells.
## **Added APIs**
...
Aspose.Cells for Java 8.5.1 has exposed the Cell.getHeightOfValue method to get the height of cell value. By using this method you can calculate height of the cell value and then set the height of the row of that cell respectively. Check the detailed article on [how to calculate the cell height & width](https://docs.aspose.com/cells/java/calculate-the-width-and-height-of-the-cell-value-in-unit-of-pixels/).
