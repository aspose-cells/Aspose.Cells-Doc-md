...
To fit the contents of the worksheet to a specific number of pages, use the [PageSetup](https://docs.aspose.com/cells/java/page-setup-fit-to-page-setting/) class' setFitToPagesTall and setFitToPagesWide methods. These methods are also used to scale worksheets.
**Java**
