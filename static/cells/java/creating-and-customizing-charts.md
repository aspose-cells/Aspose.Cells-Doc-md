...
Currently Aspose.Cells only supports custom charts that combine pie, line, column and column stack charts but more charts will be supported in future releases. For a full list of the standard charts that Aspose.Cells supports, read the [Chart Types](https://docs.aspose.com/cells/java/chart-types/) article.
...
**Programming Example**
To see a list of supported chart types, read the [Chart Types](https://docs.aspose.com/cells/java/chart-types/) article.
