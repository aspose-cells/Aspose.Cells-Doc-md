...
Create Pivot Tables and Pivot Charts with Aspose.Cells for Java API.
...
Aspose.Cells supports [pivot tables](https://docs.aspose.com/cells/java/create-pivot-tables-and-pivot-charts/#creating-a-pivot-table) and [pivot charts](https://docs.aspose.com/cells/java/create-pivot-tables-and-pivot-charts/#creating-a-pivot-chart-based-on-the-pivot-table).
...
## Related Articles
- [Custom sorting in Pivot Table](https://docs.aspose.com/cells/java/custom-sorting-in-pivot-table/)
- [Formatting Pivot Table](https://docs.aspose.com/cells/java/formatting-pivot-table/)
- [Refresh and Calculate Pivot Table having Calculated Items](https://docs.aspose.com/cells/java/refresh-and-calculate-pivot-table-having-calculated-items/)
- [Disable Pivot Table Ribbons](https://docs.aspose.com/cells/java/disable-pivot-table-ribbons/)
