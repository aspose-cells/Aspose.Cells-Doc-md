...
- [Numbers are whole](https://docs.aspose.com/cells/java/data-validation/), that is, that they don't have a decimal part.
- [Decimal numbers follow the right structure](https://docs.aspose.com/cells/java/data-validation/). The code example defines that a range of cells should have two decimal spaces.
- [Values are restricted to a list of values](https://docs.aspose.com/cells/java/data-validation/). List validation defines a separate list of values that can be applied to a cell, or cell range.
- [Dates fall within a specific range](https://docs.aspose.com/cells/java/data-validation/).
- [Time is within a specific range](https://docs.aspose.com/cells/java/data-validation/).
- [A text is within a given character length](https://docs.aspose.com/cells/java/data-validation/).
...
## **Advance topics**
- [Get Cell Validation in ODS Files](https://docs.aspose.com/cells/java/get-cell-validation-in-ods-files/)
- [Get Validation Applied on a Cell](https://docs.aspose.com/cells/java/get-validation-applied-on-a-cell/)
- [Verify that Cell Value Satisfies Data Validation Rules](https://docs.aspose.com/cells/java/verify-that-cell-value-satisfies-data-validation-rules/)
