...
This document describes the changes to the Aspose.Cells API from version 8.4.0 to 8.4.1 that may be of interest to module/application developers. It includes not only new and updated public methods, [added classes etc.](https://docs.aspose.com/cells/java/public-api-changes-in-aspose-cells-8-4-1/) and [removed classes etc.](https://docs.aspose.com/cells/java/public-api-changes-in-aspose-cells-8-4-1/), but also a description of any changes in the behavior behind the scenes in Aspose.Cells.
## **Added APIs**
