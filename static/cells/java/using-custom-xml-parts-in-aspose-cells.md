...
## **Related Article**
- [Adding Custom Properties visible inside Document Information Panel](https://docs.aspose.com/cells/java/adding-custom-properties-visible-inside-document-information-panel/)
