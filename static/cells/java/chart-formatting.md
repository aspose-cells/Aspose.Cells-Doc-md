...
In [Chart Types](https://docs.aspose.com/cells/java/chart-types/), we gave a brief introduction to the types of charts and charting objects offered by Aspose.Cells.
In this article, we discuss how to customize the appearance of charts by setting a number of different properties:
- [Setting the chart area](https://docs.aspose.com/cells/java/chart-formatting/#setting-chart-area).
- [Setting chart lines](https://docs.aspose.com/cells/java/chart-formatting/#setting-chart-lines).
- [Applying themes](https://docs.aspose.com/cells/java/chart-formatting/#applying-microsoft-excel-20072010-themes-to-charts).
- [Setting titles to charts and axes](https://docs.aspose.com/cells/java/chart-formatting/#setting-the-titles-of-charts-or-axes).
- [Working with gridlines](https://docs.aspose.com/cells/java/chart-formatting/#setting-major-gridlines).
- [Setting borders for back and side walls](https://docs.aspose.com/cells/java/chart-formatting/#setting-borders-for-back-and-side-walls).
### **Setting Chart Area**
...
For a full list of which 2D and 3D charts are supported, see [Supported chart types for rendering](https://docs.aspose.com/cells/java/chart-rendering/#supported-chart-types-for-rendering).
## **Advance topics**
- [Set Picture as Background Fill in the Chart](https://docs.aspose.com/cells/java/set-picture-as-background-fill-in-the-chart/)
