...
## **Advance topics**
- [Hiding the Display of Zero Values in the Worksheet](https://docs.aspose.com/cells/java/hiding-the-display-of-zero-values-in-the-worksheet/)
- [Set Worksheet Tab Color](https://docs.aspose.com/cells/java/set-worksheet-tab-color/)
- [Show and Hide Elements](https://docs.aspose.com/cells/java/show-and-hide-elements/)
- [Show Formulas instead of Values in a Worksheet](https://docs.aspose.com/cells/java/show-formulas-instead-of-values-in-a-worksheet/)
- [Use Error Checking Options](https://docs.aspose.com/cells/java/use-error-checking-options/)
