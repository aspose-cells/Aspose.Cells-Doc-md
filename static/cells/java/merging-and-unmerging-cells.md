...
## **Related Articles**
- [Finding and splitting merged cells](https://docs.aspose.com/cells/java/detect-merged-cells-in-a-worksheet/).
- [Merge and splitting a cell range using the Range.merge() and Range.unMerge() methods](https://docs.aspose.com/cells/java/merge-or-unmerge-range-of-cells/).
