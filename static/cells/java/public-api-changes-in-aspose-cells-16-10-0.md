...
Check the detailed article on [Working with Reflection Effects](https://docs.aspose.com/cells/java/working-with-the-reflection-effect-of-shape-or-chart/)
**Java**
...
Check the detailed article on [Working with Shadow Effects](https://docs.aspose.com/cells/java/working-with-the-shadow-effect-of-shape-or-chart/)
**Java**
//Load a sample spreadsheet containing a shape
//Alternatively create a new spreadsheet and add a shape
Workbook book = new Workbook("sample.xlsx");
...
Check the detailed article on [Working with Glow Effect](https://docs.aspose.com/cells/java/working-with-the-glow-effect-of-shape-or-chart/)
**Java**
//Load a sample spreadsheet containing a shape
//Alternatively create a new spreadsheet and add a shape
Workbook book = new Workbook("sample.xlsx");
...
Check the detailed article on [Working with 3D Formatting](https://docs.aspose.com/cells/java/working-with-the-threedformat-of-shape-or-chart/)
**Java**
//Load a sample spreadsheet containing a shape
//Alternatively create a new spreadsheet and add a shape
Workbook book = new Workbook("sample.xlsx");
...
Check the detailed article on [Add WordArt with Built-in Styles](https://docs.aspose.com/cells/java/add-word-art-text-with-built-in-styles/)
**Java**
...
Check the detailed article on [Add XML Map to Spreadsheet](https://docs.aspose.com/cells/java/add-xml-map-inside-the-workbook-using-xmlmapcollection-add-method/)
**Java**
//Create an instance of Workbook
Workbook book = new Workbook();
...
Check the detailed article on [Link Cells to XML Map Elements](https://docs.aspose.com/cells/java/link-cells-to-xml-map-elements/)
**Java**
...
Check the detailed article on [Automatically Propagate Formula in List Object](https://docs.aspose.com/cells/java/propagate-formula-in-table-or-list-object-automatically-while-entering-data-in-new-rows/)
**Java**
//Create an instance of Workbook
Workbook book = new Workbook();
//Access first worksheet from the collection
