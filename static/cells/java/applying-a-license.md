...
In Aspose.Cells for Android via Java, the license can be [embedded as a resource](https://docs.aspose.com/cells/java/applying-a-license/#applying-a-license-from-an-embedded-resource), or loaded from a stream:
