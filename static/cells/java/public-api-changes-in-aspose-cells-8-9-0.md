...
For more details on this feature, please review the article on [Setting Default Font for Rendering Spreadsheets to HTML Format](https://docs.aspose.com/cells/java/set-default-font-while-rendering-spreadsheet-to/).
...
For more details on this feature, please review the article on [Setting Default Font for Rendering Spreadsheets in Image Formats](https://docs.aspose.com/cells/java/set-default-font-while-rendering-spreadsheet-to-images/).
Following is the simple usage scenario.
**Java**
...
For more details on this feature, please review the article on [Compatibility for Excel 2003 for Refreshing Pivot Tables](https://docs.aspose.com/cells/java/specify-whether-the-pivottable-is-compatible-for-excel2003-while-refreshing-pivottable/).
Following is the simple usage scenario.
**Java**
//Load a spreadsheet in an instance of Workbook
Workbook book = new Workbook(dir + "sample.xlsx");
