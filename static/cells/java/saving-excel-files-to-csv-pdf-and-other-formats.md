...
## **Advance topics**
- [Adjust workbook compression level](https://docs.aspose.com/cells/java/adjust-workbook-compression-level/)
- [Converting Workbook to Different Formats](https://docs.aspose.com/cells/java/converting-workbook-to-different-formats/)
- [Save Workbook to Strict Open XML Spreadsheet Format](https://docs.aspose.com/cells/java/save-workbook-to-strict-open-xml-spreadsheet-format/)
- [Track Conversion Progress of Excel to TIFF](https://docs.aspose.com/cells/java/track-conversion-progress-of-excel-to-tiff/)
- [Track Document Conversion Progress](https://docs.aspose.com/cells/java/track-document-conversion-progress/)
