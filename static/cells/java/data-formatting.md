...
### **Formatting Cells**
Developers can format cells and their contents using the flexible API of Aspose.Cells. Aspose.Cells provides a class, [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook), that represents a Microsoft Excel file. The [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook) class contains a [WorksheetCollection](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection) that allows access to each worksheet in an Excel file. A worksheet is represented by the [Worksheet](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet) class. The [Worksheet](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet) class provides a Cells collection. Each item in the [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/cells) collection represents an object of **Cell** class.
Aspose.Cells provides the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) property in the [Cell](https://reference.aspose.com/cells/java/com.aspose.cells/cell) class, used to set the formatting style of a cell. Moreover, Aspose.Cells also provides a [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) class that is used to serve the same purpose. Apply different kinds of formatting styles on the cells to set their background or foreground colors, borders, fonts, horizontal and vertical alignments, indentation level, text direction, rotation angle and much more.
#### **Using the setStyle Method**
When applying different formatting styles to different cells then it's better to use the setStyle method of the [Cell](https://reference.aspose.com/cells/java/com.aspose.cells/cell) class. An example is given below to demonstrate the use of setStyle method to apply various formatting settings on a cell.
#### **Using the Style Object**
When applying the same formatting style to different cells, use the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object.
1. Add a [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object to the Styles collection of the [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook) class by calling the createStyle method of the Workbook class.
...
- [Text alignment](https://docs.aspose.com/cells/java/data-formatting/) (horizontal & vertical)
- [Indentation](https://docs.aspose.com/cells/java/data-formatting/).
- [Orientation](https://docs.aspose.com/cells/java/data-formatting/).
- [Text control](https://docs.aspose.com/cells/java/data-formatting/).
- [Text direction](https://docs.aspose.com/cells/java/data-formatting/).
...
The Worksheet class provides a Cells collection. Each item in the Cells collection represents an object of the [Cell](https://reference.aspose.com/cells/java/com.aspose.cells/cell) class.
Aspose.Cells provides the setStyle method in the [Cell](https://reference.aspose.com/cells/java/com.aspose.cells/cell) class that is used a cell's formatting. The [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) class provides useful properties for configuring font settings.
...
Use the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's setHorizontalAlignment method to align the text horizontally.
...
#### **Vertical Alignment**
Use the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's setVerticalAlignment mehod to align the text vertically.
...
### **Indentation**
It is possible to set the indentation level of the text in a cell by using the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's setIndentLevel method.
...
### **Orientation**
Set the orientation (rotation) of the text in a cell with the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's setRotationAngle method.
...
Set text wrapping on or off with the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's setTextWrapped method.
...
#### **Shrinking to Fit**
An option to wrapping text in a field is to shrink the text size to fit a cell's dimensions. This is done by setting the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's IsTextWrapped property to **true**.
...
Use the [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/cells) collection's Merge method to merge cells. The Merge method takes the following parameters:
...
The reading order is set with the [Style](https://reference.aspose.com/cells/java/com.aspose.cells/style) object's TextDirection property. Aspose.Cells provides pre-defined text direction types in the TextDirectionType enumeration.
...
[Dealing with Font Settings](https://docs.aspose.com/cells/java/dealing-with-font-settings/) explained how to format cells but only how to format the content of the wntire cells. What if you want to format only selected characters?
Aspose.Cells supports this feature. This topic explains how to use this feature.
### **Formatting Selected Characters**
Aspose.Cells provides a class, [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook), that represents a Microsoft Excel file. The Workbook class contains a Worksheets collection that allows access to each worksheet in the Excel file. A worksheet is represented by the [Worksheet](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet) class. The Worksheet class provides a Cells collection. Each item in the Cells collection represents an object of the [Cell](https://reference.aspose.com/cells/java/com.aspose.cells/cell) class.
...
Aspose.Cells provides a class, [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook) that represents a Microsoft Excel file. The [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook) class contains a WorksheetCollection that allows access to each worksheet in the Excel file. A worksheet is represented by the Worksheet class. The [Worksheet](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet) class provides the Cells collection. The Cells collection provides a Rows collection.
#### **Formatting a Row**
