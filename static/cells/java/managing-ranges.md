...
## **Advance topics**
- [AutoFill range of Excel file](https://docs.aspose.com/cells/java/autofill-ranges/)
- [Change Data Source of the Chart to Destination Worksheet while Copying Rows or Range](https://docs.aspose.com/cells/java/change-data-source-of-the-chart-to-destination-worksheet-while-copying-rows-or-range/)
- [Copy Ranges of Excel](https://docs.aspose.com/cells/java/copy-ranges-of-Excel/)
- [Copy Range Data Only](https://docs.aspose.com/cells/java/copy-range-data-only/)
- [Copy Range Data with Style](https://docs.aspose.com/cells/java/copy-range-data-with-style/)
- [Copy Range Style Only](https://docs.aspose.com/cells/java/copy-range-style-only/)
- [Copy Row Heights of Source Range to Destination Range](https://docs.aspose.com/cells/java/copy-row-heights-of-source-range-to-destination-range/)
- [Create Union Range](https://docs.aspose.com/cells/java/create-union-range/)
- [Cut and Paste Ranges](https://docs.aspose.com/cells/java/cut-and-paste-cells/)
- [Delete Ranges](https://docs.aspose.com/cells/java/delete-ranges-from-Excel/)
- [Detect Merged Cells in a Worksheet](https://docs.aspose.com/cells/java/detect-merged-cells-in-a-worksheet/)
- [Get Address Cell Count Offset Entire Column and Entire Row of the Range](https://docs.aspose.com/cells/java/get-address-cell-count-offset-entire-column-and-entire-row-of-the-range/)
- [Get Range with External Links](https://docs.aspose.com/cells/java/get-range-with-external-links/)
- [Implementing Non-Sequential Ranges](https://docs.aspose.com/cells/java/implementing-non-sequential-ranges/)
- [Insert Ranges](https://docs.aspose.com/cells/java/insert-ranges-to-Excel/)
- [Merge or Unmerge Range of Cells](https://docs.aspose.com/cells/java/merge-or-unmerge-range-of-cells/)
- [Move Range of Cells in a Worksheet](https://docs.aspose.com/cells/java/move-range-of-cells-in-a-worksheet/)
- [Named Ranges](https://docs.aspose.com/cells/java/named-ranges/)
- [Search and Replace Data in a Range](https://docs.aspose.com/cells/java/search-and-replace-data-in-a-range/)
