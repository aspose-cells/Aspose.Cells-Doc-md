...
## **Advance topics**
- [Converting Chart to Image in SVG Format](https://docs.aspose.com/cells/java/converting-chart-to-image-in-svg-format/)
- [Create Chart PDF with Desired Page Size](https://docs.aspose.com/cells/java/create-chart-pdf-with-desired-page-size/)
- [Export Chart to SVG with viewBox attribute](https://docs.aspose.com/cells/java/export-chart-to-svg-with-viewbox-attribute/)
