...
Aspose.Cells for Java 8.6.0 has exposed the Shape.MarcoName property that can be used to [assign a VBA module to a form control](https://docs.aspose.com/cells/java/assign-macro-code-to-form-control/) such a Button in order to provide the interaction. The property is of type string therefore it can accept the module name and assigns it to the control.
Following is the simple usage scenario.
**Java**
