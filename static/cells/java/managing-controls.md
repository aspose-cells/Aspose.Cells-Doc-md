...
## **Advance topics**
- [Add ActiveX Controls using Aspose.Cells](https://docs.aspose.com/cells/java/add-activex-controls-using-aspose-cells/)
- [Remove ActiveX Control](https://docs.aspose.com/cells/java/remove-activex-control/)
