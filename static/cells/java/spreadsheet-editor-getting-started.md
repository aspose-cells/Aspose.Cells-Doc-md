...
1. Open the ***Import*** dialog from File menu.
1. Select ***Maven Project*** from import dialog.
1. Click ***Next***.
1. Click ***Browse*** to select the location of source code.
1. Select ***pom.xml*** from the list below.
1. Click ***Finish***.
...
**Aspose License**
The product works without Aspose license, [with limitations](https://docs.aspose.com/cells/java/licensing/). To remove limitations, you can acquire a [free temporary license](https://purchase.aspose.com/temporary-license) or [buy full license](https://purchase.aspose.com/buy).
