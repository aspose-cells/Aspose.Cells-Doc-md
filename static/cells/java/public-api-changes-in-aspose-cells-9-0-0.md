...
Check the detailed article on [Finding a DataPoint resides on the Second Plot](https://docs.aspose.com/cells/java/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)
**Java**
