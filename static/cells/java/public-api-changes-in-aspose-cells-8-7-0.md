...
Newly exposed VbaProject.isSigned property can be used to in [detect if the VBA project in a Workbook is digitally signed](https://docs.aspose.com/cells/java/check-if-vba-code-is-signed/). The VbaProject.isSigned property is of type Boolean, which returns true if the VBA project is digitally signed and vice versa.
Following is the simple usage scenario.
**Java**
...
This release of Aspose.Cells for Java has also exposed the Protection.isProtectedWithPassword field that can be useful in [detecting if a Worksheet is password protected or not](https://docs.aspose.com/cells/java/detect-if-worksheet-is-password-protected/).
Following is the simple usage scenario.
**Java**
//Create an instance of Workbook and load an existing spreadsheet
Workbook book = new Workbook(inFilePath);
...
Another useful feature that Aspose.Cells for Java 8.7.0 has exposed is the DataLabels.ResizeShapeToFitText property that can enable the [resize shape to fit text](https://docs.aspose.com/cells/java/resize-chart-s-data-label-shape-to-fit-text/) feature of Excel application for chart's data labels.
Following is the simple usage scenario.
**Java**
