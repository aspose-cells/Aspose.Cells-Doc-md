...
- [Copy a worksheet within a workbook](https://docs.aspose.com/cells/java/copy-and-move-worksheets-within-and-between-workbooks/#copying-a-worksheet-within-a-workbook).
- [Move a worksheet within a workbook](https://docs.aspose.com/cells/java/copy-and-move-worksheets-within-and-between-workbooks/#moving-a-worksheet-with-in-a-workbook).
- [Copy a worksheet between workbooks](https://docs.aspose.com/cells/java/copy-and-move-worksheets-within-and-between-workbooks/#copying-a-worksheet-between-workbooks).
- [Move a worksheet between workbooks](https://docs.aspose.com/cells/java/copy-and-move-worksheets-within-and-between-workbooks/#moving-a-worksheet-between-workbooks).
...
1. Select **Java Build Path** in the left side of the dialog, then select the Libraries tab,
