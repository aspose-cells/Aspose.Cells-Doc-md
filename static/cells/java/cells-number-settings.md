...
## **Advance topics**
- [Check Custom Number Format when Setting Style.Custom Property](https://docs.aspose.com/cells/java/check-custom-number-format-when-setting-style-custom-property/)
- [Specify Custom Number Decimal and Group Separators for Workbook](https://docs.aspose.com/cells/java/specify-custom-number-decimal-and-group-separators-for-workbook/)
