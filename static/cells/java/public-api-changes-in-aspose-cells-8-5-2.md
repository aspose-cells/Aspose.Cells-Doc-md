...
With the release of v8.5.2, the Aspose.Cells API has exposed the Geometry.getShapeAdjustValues method that can be used to [access and make changes to the adjustment points of different shapes](https://docs.aspose.com/cells/java/change-adjustment-values-of-the-shape/).
