##How to Format Number as Date
This article will introduce how to format number to date using Aspose.Cells for Java API.
...
To format numbers as date in Aspose.Cells for Java library for working with Excel files, you can apply date formatting to cells programmatically. Here's how you can do it using Java with Aspose.Cells:
