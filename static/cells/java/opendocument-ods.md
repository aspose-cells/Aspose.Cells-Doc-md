...
## **ODS in Aspose.Cells**
Aspose.Cells supports loading OpenDocument 1.1 and 1.2 documents. Aspose.Cells saves documents in the OpenDocument 1 .1 format. You can also see the [detailed specification](https://docs.aspose.com/cells/java/opendocument-ods/) about what OpenDocument features are supported.
