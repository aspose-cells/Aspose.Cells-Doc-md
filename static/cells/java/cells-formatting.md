...
[Dealing with Font Settings](https://docs.aspose.com/cells/java/dealing-with-font-settings/) explained how to format cells but only how to format the content of the entire cells. What if you want to format only selected characters?
...
## **Advance topics**
- [Alignment Settings](https://docs.aspose.com/cells/java/cells-alignment-settings/)
- [Conditional Formatting](https://docs.aspose.com/cells/java/conditional-formatting/)
- [Data Formatting](https://docs.aspose.com/cells/java/data-formatting/)
- [Excel Themes and Colors](https://docs.aspose.com/cells/java/excel-2007-themes-and-colors/)
- [Dealing with Font Settings](https://docs.aspose.com/cells/java/dealing-with-font-settings/)
- [Format Worksheet Cells in a Workbook](https://docs.aspose.com/cells/java/format-worksheet-cells-in-a-workbook/)
- [Implement 1904 Date System](https://docs.aspose.com/cells/java/implement-1904-date-system/)
- [Merging and Unmerging Cells](https://docs.aspose.com/cells/java/merging-and-unmerging-cells/)
- [Number Settings](https://docs.aspose.com/cells/java/cells-number-settings/)
- [Preserve Single Quote Prefix of Cell Value or Range](https://docs.aspose.com/cells/java/preserve-single-quote-prefix-of-cell-value-or-range/)
- [Styling and Data Formatting](https://docs.aspose.com/cells/java/styling-and-data-formatting/)
