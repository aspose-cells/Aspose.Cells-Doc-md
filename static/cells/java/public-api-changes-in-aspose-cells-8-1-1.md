...
This document describes changes to the Aspose.Cells API from version 8.1.0 to 8.1.1, that may be of interest to module and application developers. It includes not only [new and updated public methods](https://docs.aspose.com/cells/java/public-api-changes-in-aspose-cells-8-1-1/), but also a description of any [changes in the behavior](https://docs.aspose.com/cells/java/public-api-changes-in-aspose-cells-8-1-1/) behind the scenes in Aspose.Cells.
...
Please check the detailed article on [Use PresentationPreference Option for Better Layout](https://docs.aspose.com/cells/java/excel-to-html-use-presentationpreference-option-for-better-layout/)
...
Please check the detailed article on [How to Create, Manipulate or Remove Scenarios from Worksheets](https://docs.aspose.com/cells/java/create-manipulate-or-remove-scenarios-from-worksheets/).
