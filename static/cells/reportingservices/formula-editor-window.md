...
([Adding Reporting Services Formulas](https://docs.aspose.com/cells/reportingservices/adding-reporting-services-formulas/) walks through an example that edits a formula.)
...
Related topics:
- [Formula List](https://docs.aspose.com/cells/reportingservices/formula-list/) - a list of fields and operators.
