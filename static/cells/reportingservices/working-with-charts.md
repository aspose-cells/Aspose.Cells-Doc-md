...
Please refer to [Data Sources and Queries](https://docs.aspose.com/cells/reportingservices/data-sources-and-queries/) to learn more about how to create a data source and dataset in Aspose.Cells.Report.Designer.
1. Create a tabular report according to the instructions in [Creating Tabular Report](https://docs.aspose.com/cells/reportingservices/creating-tabular-report/). The report we've created for this example is below. The table is the chart's data source.
