...
Please refer to [Data Sources and Queries](https://docs.aspose.com/cells/reportingservices/data-sources-and-queries/) to learn more about how to create a data source and dataset with Aspose.Cells.Report.Designer.
1. Create a table report according to the instruction in [Creating Tabular Report](https://docs.aspose.com/cells/reportingservices/creating-tabular-report/), as shown below.
