##Get External Connection Data Source of Pivot Table with C++
Learn how to retrieve the external connection data source of a pivot table using Aspose.Cells for C++.
