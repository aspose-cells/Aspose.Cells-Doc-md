...
Add VBA Module and Modify VBA or Macro with Aspose.Cells library in C++.
...
```
## **Advance Topics**
- [Add a Library Reference to VBA Project in Workbook](https://docs.aspose.com/cells/cpp/add-a-library-reference-to-vba-project-in-workbook/)
- [Assign Macro to Form Control](https://docs.aspose.com/cells/cpp/assign-macro-to-form-control/)
- [Check if Digital Signature of VBA Code is Valid](https://docs.aspose.com/cells/cpp/check-if-digital-signature-of-vba-code-is-valid/)
- [Check if VBA Code is Signed](https://docs.aspose.com/cells/cpp/check-if-vba-code-is-signed/)
- [Check if VBA Project in a Workbook is Signed](https://docs.aspose.com/cells/cpp/check-if-vba-project-in-a-workbook-is-signed/)
- [Check if VBA Project is Protected and Locked for Viewing](https://docs.aspose.com/cells/cpp/check-if-vba-project-is-protected-and-locked-for-viewing/)
- [Copy VBA Macro UserForm DesignerStorage from Template to Target Workbook](https://docs.aspose.com/cells/cpp/copy-vba-macro-userform-designerstorage-from-template-to-target-workbook/)
- [Digitally Sign a VBA Code Project with Certificate](https://docs.aspose.com/cells/cpp/digitally-sign-a-vba-code-project-with-certificate/)
- [Export VBA Certificate to File or Stream](https://docs.aspose.com/cells/cpp/export-vba-certificate-to-file-or-stream/)
- [Filter VBA Project while Loading a Workbook](https://docs.aspose.com/cells/cpp/filter-vba-project-while-loading-a-workbook/)
- [Find out if VBA Project is Protected](https://docs.aspose.com/cells/cpp/find-out-if-vba-project-is-protected/)
- [Password Protect the VBA Project of Excel Workbook](https://docs.aspose.com/cells/cpp/password-protect-the-vba-project-of-excel-workbook/)
