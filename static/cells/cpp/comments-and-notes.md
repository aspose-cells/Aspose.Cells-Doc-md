##Manage Comments and Notes with C++
Insert and manage comments or notes with Aspose.Cells for C++.
## **Introduction**
...
```
## **Advance topics**
- [Change Text Direction of the Comment](https://docs.aspose.com/cells/cpp/change-text-direction-of-the-comment/)
- [How to change the Comment Font Color](https://docs.aspose.com/cells/cpp/how-to-change-the-comment-font-color/)
- [How to set comment background](https://docs.aspose.com/cells/cpp/how-to-set-comment-background/)
- [Threaded Comments](https://docs.aspose.com/cells/cpp/threaded-comments/)
