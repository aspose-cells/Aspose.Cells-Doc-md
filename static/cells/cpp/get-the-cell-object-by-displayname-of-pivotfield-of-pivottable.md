##Get the Cell Object by DisplayName of PivotField of PivotTable with C++
Learn how to retrieve the cell object by the display name of a pivot field and apply formatting using Aspose.Cells for C++.
