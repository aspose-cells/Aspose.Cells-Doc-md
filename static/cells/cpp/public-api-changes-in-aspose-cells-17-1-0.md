...
Aspose.Cells for C++ now supports creation as well as the manipulation of the Named Ranges. The following code snippet demonstrates how simple is to use Aspose.Cells for C++ API to [create named ranges](https://docs.aspose.com/cells/cpp/create-named-range-in-a-workbook/).
**C++**
...
Besides creating new Named Ranges, Aspose.Cells for C++ APIs also support to manipulate existing Named Ranges. The following code snippet uses the Aspose.Cells for C++ API to [manipulate an existing named range](https://docs.aspose.com/cells/cpp/manipulate-named-range-in-a-workbook/).
**C++**
//Path of your directory where you want to read or write files from
StringPtr dirPath = new String("D:\\Downloads\\");
