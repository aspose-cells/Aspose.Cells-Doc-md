...
Learn to create workbook and worksheet scoped named ranges with C++ using Aspose.Cells.
...
```
## **Advance topics**
- [Create Access and Copy Named Ranges](https://docs.aspose.com/cells/cpp/create-access-and-copy-named-ranges/)
- [Format and Modify Named Ranges](https://docs.aspose.com/cells/cpp/format-and-modify-named-ranges/)
- [Get Range with External Links](https://docs.aspose.com/cells/cpp/get-range-with-external-links/)
- [Implementing Non-Sequential Ranges](https://docs.aspose.com/cells/cpp/implementing-non-sequential-ranges/)
