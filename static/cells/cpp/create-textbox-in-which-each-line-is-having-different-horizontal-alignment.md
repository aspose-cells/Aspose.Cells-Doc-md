##Create TextBox in which each line is having different Horizontal Alignment with C++
Learn how to create a TextBox with different horizontal alignment for each line using Aspose.Cells with C++.
