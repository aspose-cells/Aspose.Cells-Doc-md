##Create, Manipulate or Remove Scenarios from Worksheets with C++
In this article, you will learn how to create, manipulate or remove Scenarios from Excel Worksheets programmatically using C++ Library with Aspose.Cells API.
