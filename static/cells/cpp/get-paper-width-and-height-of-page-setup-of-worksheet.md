##Get Paper Width and Height of Page Setup of Worksheet with C++
Learn how to get the Excel Worksheet Page Setup Paper Width and Paper Height using C++ code programmatically with Aspose.Cells for C++ API.
