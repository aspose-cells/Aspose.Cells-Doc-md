##Convert Excel workbook to Ods,Sxc and Fods (OpenOffice / LibreOffice calc) with C++
How to convert Excel to Ods (OpenOffice / LibreOffice Calc) or convert Ods (OpenOffice / LibreOffice Calc) to Excel with Aspose.Cells with C++.
## **About OpenDocument**
...
```
## **Advance topics**
- [Save ODS File in ODF 1.1 and 1.2 Specifications](https://docs.aspose.com/cells/cpp/save-ods-file-in-odf-1-1-and-1-2-specifications/)
