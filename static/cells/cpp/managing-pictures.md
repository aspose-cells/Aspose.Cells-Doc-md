##Managing Pictures with C++
Add, position, and manage images in spreadsheets using Aspose.Cells for C++ API.
...
```
## **Advance topics**
- [Add Conditional Icons Set with the Cell Text](https://docs.aspose.com/cells/cpp/add-conditional-icons-set-with-the-cell-text/)
- [Insert a Linked Picture from Web Address](https://docs.aspose.com/cells/cpp/insert-a-linked-picture-from-web-address/)
- [Insert a Picture Based on Cell Reference](https://docs.aspose.com/cells/cpp/insert-a-picture-based-on-cell-reference/)
- [Load a Web Image from a URL into an Excel Worksheet](https://docs.aspose.com/cells/cpp/load-a-web-image-from-a-url-into-an-excel-worksheet/)
