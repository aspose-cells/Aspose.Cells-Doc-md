...
Learn how to export DataBar, ColorScale, and IconSet conditional formatting while converting Excel files to HTML using Aspose.Cells for C++.
...
### **Sample Code**
The following sample code converts the sample excel file into HTML, which is just a normal [Excel to HTML conversion](https://docs.aspose.com/cells/cpp/convert-workbook-to-different-formats/#convertworkbooktodifferentformats-convertingexcelworkbooktohtml).
```c++
#include <iostream>
