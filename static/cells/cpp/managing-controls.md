##Managing Controls with C++
Learn how to add and manage various controls like lines, rectangles, arcs, ovals, spinners, scroll bars, and group boxes in worksheets using Aspose.Cells with C++.
## **Introduction**
...
Aspose.Cells also lets you access textboxes in the designer worksheets and manipulate them. Use the [**Worksheet.GetTextBoxes()**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/gettextboxes/) property to get the textboxes collection in the sheet.
...
```
## **Advance topics**
- [Add ActiveX Controls using Aspose.Cells](https://docs.aspose.com/cells/cpp/add-activex-controls-using-aspose-cells/)
- [Remove ActiveX Control](https://docs.aspose.com/cells/cpp/remove-activex-control/)
- [Update ActiveX ComboBox Control](https://docs.aspose.com/cells/cpp/update-activex-combobox-control/)
