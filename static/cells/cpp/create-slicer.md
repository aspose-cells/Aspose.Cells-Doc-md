##Insert Slicer with C++
Manage slicers of Excel files with Aspose.Cells using C++.
...
```
## **Advance Topics**
- [Change Slicer Properties](https://docs.aspose.com/cells/cpp/change-slicer-properties/)
- [Draw Slicer while rendering Excel to PDF](https://docs.aspose.com/cells/cpp/draw-slicer-while-rendering-excel-to-pdf/)
- [Formatting Slicer](https://docs.aspose.com/cells/cpp/formatting-slicer/)
- [Removing Slicer](https://docs.aspose.com/cells/cpp/removing-slicer/)
- [Rendering Slicer](https://docs.aspose.com/cells/cpp/rendering-slicer/)
- [Updating Slicer](https://docs.aspose.com/cells/cpp/updating-slicer/)
