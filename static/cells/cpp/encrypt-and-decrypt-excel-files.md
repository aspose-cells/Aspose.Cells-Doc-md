##Encrypt and Decrypt Excel files with C++
How to encrypt and decrypt Excel files using C++. Lock and unlock Excel files.
...
```
## **Advance topics**
- [Encrypt And Decrypt ODS files](https://docs.aspose.com/cells/cpp/encrypt-and-decrypt-ods-files/)
- [Setting Strong Encryption Type](https://docs.aspose.com/cells/cpp/setting-strong-encryption-type/)
- [Specify Author while Write Protecting Workbook](https://docs.aspose.com/cells/cpp/specify-author-while-write-protecting-workbook/)
- [Verify Password of Encrypted Files](https://docs.aspose.com/cells/cpp/verify-password-of-encrypted-excel-and-ods-files/)
