...
Learn how to add custom properties visible in the Document Information Panel using Aspose.Cells with C++.
...
```
### **Related Article**
- [Use Custom XML Parts in Aspose.Cells](https://docs.aspose.com/cells/cpp/use-custom-xml-parts-in-aspose-cells/)
