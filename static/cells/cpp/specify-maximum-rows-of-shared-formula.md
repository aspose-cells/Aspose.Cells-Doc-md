...
Learn how to specify the maximum rows of shared formula in Excel files using Aspose.Cells for C++.
## **Possible Usage Scenarios**
The default maximum rows of the shared formula are 64. It could be any number e.g., it could be 1000. The performance of the shared formula changes with a different number of rows. Therefore, Aspose.Cells provides the [**GetMaxRowsOfSharedFormula()**](https://reference.aspose.com/cells/cpp/aspose.cells/workbooksettings/getmaxrowsofsharedformula/) property that can be used to specify the maximum rows of the shared formula. The shared formula will be split into several shared formulae if the total rows of the shared formula are greater than it, as shown in the following screenshot.
