##How to export Excel equations to other types of expressions with C++
Export Excel formulas to LaTeX and MathML using Aspose.Cells for C++.
...
To export equations as LaTeX expressions, use the [ToLaTeX()](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.equations/equationnode/tolatex/) method.
The following sample demonstrates using [ToLaTeX()](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.equations/equationnode/tolatex/) and inserting results into HTML:
### C++-To-LaTeX
```c++
#include <iostream>
#include <fstream>
...
To export equations as MathML expressions, use the [ToMathML()](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.equations/equationnode/tomathml/) method.
The following sample demonstrates using [ToMathML()](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.equations/equationnode/tomathml/) and inserting results into HTML:
### C++-To-MathML
```c++
#include <iostream>
#include <fstream>
