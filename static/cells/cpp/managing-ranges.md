##Managing Ranges with C++
Learn how to manage ranges in Excel files using Aspose.Cells with C++. Create, modify, and style ranges programmatically.
## **Introduction**
...
```
## **Advance topics**
- [AutoFill range of Excel file](https://docs.aspose.com/cells/cpp/autofill-ranges/)
- [Copy Ranges of Excel](https://docs.aspose.com/cells/cpp/copy-ranges-of-Excel/)
- [Copy Range Data Only](https://docs.aspose.com/cells/cpp/copy-range-data-only/)
- [Copy Range Data with Style](https://docs.aspose.com/cells/cpp/copy-range-data-with-style/)
- [Copy Range Style Only](https://docs.aspose.com/cells/cpp/copy-range-style-only/)
- [Create Union Range](https://docs.aspose.com/cells/cpp/create-union-range/)
- [Cut and Paste Range](https://docs.aspose.com/cells/cpp/cut-and-paste-cells/)
- [Delete Ranges](https://docs.aspose.com/cells/cpp/delete-ranges-from-Excel/)
- [Get Address Cell Count Offset Entire Column and Entire Row of the Range](https://docs.aspose.com/cells/cpp/get-address-cell-count-offset-entire-column-and-entire-row-of-the-range/)
- [Insert Ranges](https://docs.aspose.com/cells/cpp/insert-ranges-to-Excel/)
- [Merge or Unmerge Range of Cells](https://docs.aspose.com/cells/cpp/merge-or-unmerge-range-of-cells/)
- [Move Range of Cells in a Worksheet](https://docs.aspose.com/cells/cpp/move-range-of-cells-in-a-worksheet/)
- [Create Workbook and Worksheet Scoped Named Ranges](https://docs.aspose.com/cells/cpp/create-workbook-and-worksheet-scoped-named-ranges/)
- [Search and Replace Data in a Range](https://docs.aspose.com/cells/cpp/search-and-replace-data-in-a-range/)
