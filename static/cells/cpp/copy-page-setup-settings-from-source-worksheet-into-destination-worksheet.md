##Copy Page Setup Settings from Source Worksheet into Destination Worksheet with C++
This article explains how to use the C++ API or Library sample code to copy Page Setup settings from source Worksheet into destination Worksheet programmatically.
