##Set DefaultFont property of PdfSaveOptions and ImageOrPrintOptions to have priority with C++
Learn to prioritize font settings when saving documents with Aspose.Cells in C++.
