##Implement Subtotal or Grand Total Labels in Other Languages with C++
Learn how to implement subtotal and grand total labels in non-English languages using Aspose.Cells for C++.
...
- [Using GlobalizationSettings Class for Custom Subtotal Labels and Other Label of Pie Chart](https://docs.aspose.com/cells/cpp/using-globalizationsettings-class-for-custom-subtotal-labels-and-other-label-of-pie-chart/)
