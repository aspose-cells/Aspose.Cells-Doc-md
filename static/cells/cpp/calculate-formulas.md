##Calculate Formulas with C++
This article introduces how to use Aspose.Cells library to calculate formulas in Microsoft Excel with C++. By loading an existing Excel file or creating a new Excel file, we can use the methods provided by Aspose.Cells to calculate the formula and get the result. Finally, we save the modified Excel file to disk.
...
Aspose.Cells supports most of the formulas or functions that are part of Microsoft Excel (Read [a list of the functions supported by the calculation engine](https://docs.aspose.com/cells/cpp/supported-formula-functions/)). Those functions can be used through the APIs or designer spreadsheets. Aspose.Cells supports a huge set of mathematical, string, boolean, date/time, statistical, database, lookup, and reference formulas.
...
## **Advance Topics**
- [Add Cells to Microsoft Excel Formula Watch Window](https://docs.aspose.com/cells/cpp/add-cells-to-microsoft-excel-formula-watch-window/)
- [Calculating IFNA function using Aspose.Cells](https://docs.aspose.com/cells/cpp/calculating-ifna-function-using-aspose-cells/)
- [Calculation of Array Formula of Data Tables](https://docs.aspose.com/cells/cpp/calculation-of-array-formula-of-data-tables/)
- [Calculation of Excel 2016 MINIFS and MAXIFS functions](https://docs.aspose.com/cells/cpp/calculation-of-excel-2016-minifs-and-maxifs-functions/)
- [Decrease the Calculation Time of Cell.Calculate method](https://docs.aspose.com/cells/cpp/decrease-the-calculation-time-of-cell-calculate-method/)
- [Direct calculation of custom function without writing it in a worksheet](https://docs.aspose.com/cells/cpp/direct-calculation-of-custom-function-without-writing-it-in-a-worksheet/)
...
- [Returning a Range of Values using AbstractCalculationEngine](https://docs.aspose.com/cells/cpp/returning-a-range-of-values-using-abstractcalculationengine/)
- [Setting Formula Calculation Mode of Workbook](https://docs.aspose.com/cells/cpp/setting-formula-calculation-mode-of-workbook/)
- [Using FormulaText function in Aspose.Cells](https://docs.aspose.com/cells/cpp/using-formulatext-function-in-aspose-cells/)
