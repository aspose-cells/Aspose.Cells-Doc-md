##Applying Subtotal and Changing Direction of Outline Summary Rows below Detail with C++
Learn how to apply subtotal and change direction of outline summary Rows below Detail by using the Aspose.Cells for C++ API.
