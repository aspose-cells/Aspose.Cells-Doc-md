##Change the HTML Link Target Type with C++
Learn how to change the HTML link target type using Aspose.Cells for C++. Control the target attribute in HTML links programmatically.
