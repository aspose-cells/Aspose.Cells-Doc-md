...
Learn how to convert Excel workbooks to PDF format using Aspose.Cells with C++.
...
The file format should be PDF, so select *Pdf* (a pre-defined value) from the [**SaveFormat**](https://reference.aspose.com/cells/cpp/aspose.cells/saveformat/) enumeration to generate the final PDF document.
```c++
#include <iostream>
...
The below-provided code snippet demonstrates how to use the [**PdfSaveOptions**](https://reference.aspose.com/cells/cpp/aspose.cells/pdfsaveoptions/) class to save Excel files to PDF/A compliant PDF format.
```c++
#include <iostream>
#include "Aspose.Cells.h"
using namespace Aspose::Cells;
...
## **Advance topics**
- [Add PDF Bookmarks with Named Destinations](https://docs.aspose.com/cells/cpp/add-pdf-bookmarks-with-named-destinations/)
- [Change the Font on just the specific Unicode characters while saving to PDF](https://docs.aspose.com/cells/cpp/change-the-font-on-just-the-specific-unicode-characters-while-saving-to-pdf/)
- [Convert XLSX File to PDF Format](https://docs.aspose.com/cells/cpp/convert-xlsx-file-to-pdf-format/)
- [Convert Excel file to PDF format compatible with PDFA-1a](https://docs.aspose.com/cells/cpp/convert-excel-file-to-pdf-format-compatible-with-pdfa-1a/)
- [Convert XLS File with Images or Charts to PDF](https://docs.aspose.com/cells/cpp/convert-xls-file-with-images-or-charts-to-pdf/)
- [Create PdfBookmarkEntry for Chart Sheet](https://docs.aspose.com/cells/cpp/create-pdfbookmarkentry-for-chart-sheet/)
- [Fit All Worksheet Columns on Single PDF Page](https://docs.aspose.com/cells/cpp/fit-all-worksheet-columns-on-single-pdf-page/)
- [Get DrawObject and Bound while rendering to PDF using DrawObjectEventHandler class](https://docs.aspose.com/cells/cpp/get-drawobject-and-bound-while-rendering-to-pdf-using-drawobjecteventhandler-class/)
- [Get Warnings for Font Substitution while Rendering Excel File](https://docs.aspose.com/cells/cpp/get-warnings-for-font-substitution-while-rendering-excel-file/)
- [Ignore Errors while Rendering Excel to PDF](https://docs.aspose.com/cells/cpp/ignore-errors-while-rendering-excel-to-pdf/)
- [Limit the Number of Pages Generated - Excel to PDF Conversion](https://docs.aspose.com/cells/cpp/limit-the-number-of-pages-generated-excel-to-pdf-conversion/)
- [Print Comments while saving to PDF](https://docs.aspose.com/cells/cpp/print-comments-while-saving-to-pdf/)
- [Render Office Add-Ins while converting Excel to PDF](https://docs.aspose.com/cells/cpp/render-office-add-ins-while-converting-excel-to-pdf/)
- [Render One PDF Page Per Excel Worksheet - Excel to PDF Conversion](https://docs.aspose.com/cells/cpp/render-one-pdf-page-per-excel-worksheet-excel-to-pdf-conversion/)
- [Render Unicode Supplementary characters in output PDF by Aspose.Cells](https://docs.aspose.com/cells/cpp/render-unicode-supplementary-characters-in-output-pdf-by-aspose-cells/)
- [Resampling Added Images - Excel to PDF Conversion](https://docs.aspose.com/cells/cpp/resampling-added-images-excel-to-pdf-conversion/)
- [Save Each Worksheet to a Different PDF File](https://docs.aspose.com/cells/cpp/save-each-worksheet-to-a-different-pdf-file/)
- [Save Excel into PDF with Standard or Minimum Size](https://docs.aspose.com/cells/cpp/save-excel-into-pdf-with-standard-or-minimum-size/)
- [Save Specified Worksheets to PDF](https://docs.aspose.com/cells/cpp/save-specified-worksheets-to-pdf/)
- [Secure PDF Documents](https://docs.aspose.com/cells/cpp/secure-pdf-documents/)
- [Specify how to cross string in output PDF and image](https://docs.aspose.com/cells/cpp/specify-how-to-cross-string-in-output-pdf-and-image/)
