##Count number of cells in the Worksheet with C++
In this article, you will learn how to programmatically count number of cells in the Excel worksheet using C++ API with Aspose.Cells.
