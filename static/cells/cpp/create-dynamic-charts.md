##Create Dynamic Charts with C++
Learn how to create dynamic charts in Aspose.Cells for C++. Our guide will show you how to dynamically update chart data, series, and formatting based on your requirements, allowing you to present changing data visually in your worksheets.
...
## **Using Excel Tables**
Excel tables are referred to as ListObjects in Aspose.Cells' perspective, therefore, we will use the term "ListObject" instead of "Table" for clarity. Please read in detail on how to [create ListObjects](https://docs.aspose.com/cells/cpp/create-and-format-table/) with Aspose.Cells for C++ API.
