##Hiding the Display of Zero Values in the Worksheet with C++
This article will show you sample code explaining how to programmatically hide the zero values in an Excel spreadsheet using the C++ library or API.
