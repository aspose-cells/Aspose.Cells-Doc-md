##Set Worksheet Tab Color with C++
This article demonstrates sample code that sets the Excel worksheet Tab Color programmatically using the C++ API or Library.
