##Apply Superscript and Subscript Effects on Fonts with C++
The C++ code to apply superscript and subscript effect to text in excel with the use of Aspose.Cells for C++ API.
