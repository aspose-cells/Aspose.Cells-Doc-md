##Export Worksheet or Chart into Image with Desired Width and Height with C++
Use Aspose.Cells to export worksheet or chart into image with desired width and height in C++.
