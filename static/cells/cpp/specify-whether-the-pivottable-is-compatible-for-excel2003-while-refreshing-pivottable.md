##Specify whether the PivotTable is compatible for Excel2003 while refreshing PivotTable with C++
Learn how to specify PivotTable compatibility for Excel2003 using Aspose.Cells for C++ while refreshing the PivotTable.
