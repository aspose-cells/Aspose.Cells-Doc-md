##Export Document Workbook and Worksheet Properties in Excel to HTML Conversion with C++
Learn how to export or avoid exporting Document, Workbook, and Worksheet properties when converting Excel files to HTML using Aspose.Cells for C++.
