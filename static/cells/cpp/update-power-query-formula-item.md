##Update Power Query Formula Item with C++
Learn how to update Power Query Formula Items using Aspose.Cells for C++ to modify data source file locations in Excel files.
## **Usage Scenario**
