##Import XML to Excel Workbook with C++
Import data from an XML data file to Microsoft Excel using Aspose.Cells with C++.
...
```
## **Advanced Topics**
- [Add XML Map inside the Workbook using XmlMapCollection.Add method](https://docs.aspose.com/cells/cpp/add-xml-map-inside-the-workbook-using-xmlmapcollection-add-method/)
- [Export XML Data linked to XML Map inside the Workbook](https://docs.aspose.com/cells/cpp/export-xml-data-linked-to-xml-map-inside-the-workbook/)
- [Find the Root Element Name of XML Map](https://docs.aspose.com/cells/cpp/find-the-root-element-name-of-xml-map/)
- [Link Cells to XML Map Elements](https://docs.aspose.com/cells/cpp/link-cells-to-xml-map-elements/)
