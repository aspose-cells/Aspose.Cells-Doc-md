##Add WordArt Watermark to Worksheet with C++
Learn how to add WordArt watermarks to Excel worksheets using Aspose.Cells for C++.
...
```
## **Advance topics**
- [Add Word Art Text with Built-in Styles](https://docs.aspose.com/cells/cpp/add-word-art-text-with-built-in-styles/)
- [Locking WordArt Watermark](https://docs.aspose.com/cells/cpp/locking-wordart-watermark/)
- [Set preset WordArt style to the text of the shape](https://docs.aspose.com/cells/cpp/set-preset-wordart-style-to-the-text-of-the-shape/)
