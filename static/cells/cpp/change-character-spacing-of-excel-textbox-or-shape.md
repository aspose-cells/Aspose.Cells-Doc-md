##Change Character Spacing of Excel TextBox or Shape with C++
Learn how to change the character spacing of Excel textbox or shape using Aspose.Cells with C++.
