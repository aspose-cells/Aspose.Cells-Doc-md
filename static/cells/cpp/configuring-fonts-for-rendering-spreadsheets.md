##Configuring Fonts for Rendering Spreadsheets with C++
Learn how to configure fonts for rendering spreadsheets to images, PDF, and XPS formats using Aspose.Cells for C++.
...
## **Advance Topics**
- [Set Default Font while rendering spreadsheet to images](https://docs.aspose.com/cells/cpp/set-default-font-while-rendering-spreadsheet-to-images/)
- [Set DefaultFont property of PdfSaveOptions and ImageOrPrintOptions to have priority](https://docs.aspose.com/cells/cpp/set-defaultfont-property-of-pdfsaveoptions-and-imageorprintoptions-to-have-priority/)
- [Supported Font Formats](https://docs.aspose.com/cells/cpp/supported-font-formats/)
