##Specify the Far East and Latin Name of the Font in Text Options of Shape with C++
Learn how to specify the Far East and Latin font names in text options of a shape using Aspose.Cells for C++.
