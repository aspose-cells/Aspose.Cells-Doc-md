...
You can easily download Aspose.Cells for JasperReports for evaluation from the [download page](https://downloads.aspose.com/cells/jasperreports). The evaluation download is same as the purchased download. The evaluation version simply becomes licensed after [applying a license](https://docs.aspose.com/cells/jasperreports/licensing/).
