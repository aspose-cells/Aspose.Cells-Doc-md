...
How to change color in comment in Excel.How to insert picture or image in comment in Excel.
...
The following code will guide you how to use [**Aspose.Cells for Python via .NET**](https://products.aspose.com/cells/python-net/) to add your favorite background color to comments of your own choice.
