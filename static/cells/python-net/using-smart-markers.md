##Smartly importing and placing data with Smart markers in Python via .Net
Smartly importing and placing data accoding to the template Excel files with Aspose.Cells for Python via .Net library.
## **Introduction**
