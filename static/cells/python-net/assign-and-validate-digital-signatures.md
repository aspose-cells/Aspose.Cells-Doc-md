...
Excel file digital signature, verification. To protect the authenticity of a workbook's content of Excel file, you can add a digital signature using C# codes with Aspose.Cells for Python via .NET.
...
## **Advance topics**
- [Add Digital Signature to an already signed Excel file](https://docs.aspose.com/cells/python-net/add-digital-signature-to-an-already-signed-excel-file/)
- [Add Signature line to the worksheet](https://docs.aspose.com/cells/python-net/add-signature-line/)
- [Support for XAdES Signature](https://docs.aspose.com/cells/python-net/support-for-xades-signature/)
