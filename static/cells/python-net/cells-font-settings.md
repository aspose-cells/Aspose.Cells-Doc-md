##Font Settings
Aspose.Cells is a Python library for working with spreadsheet files. It supports setting the font settings of cells, allowing users to customize the font style and properties of cells. This article will introduce how to use the Aspose.Cells for Python via .NET library to set cell font settings.
...
## **Advance topics**
- [Apply Superscript and Subscript Effects on Fonts](https://docs.aspose.com/cells/python-net/apply-superscript-and-subscript-effects-on-fonts/)
- [Get a List of Fonts used in a Spreadsheet or Workbook](https://docs.aspose.com/cells/python-net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
