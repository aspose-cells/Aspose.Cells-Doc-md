...
This topic show you how to Delete redundant spaces after line break while importing HTML using Aspose.Cells for Python via NET.
...
## Effect of setting the HTMLLoadOptions.delete_redundant_spaces property to false and true
