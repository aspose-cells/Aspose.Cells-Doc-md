##Data Validation
Learn how to add data validation through the Aspose.Cells for Python via .NET API.
...
## **Advance topics**
- [Get Cell Validation in ODS Files](https://docs.aspose.com/cells/python-net/get-cell-validation-in-ods-files/)
- [Get Validation Applied on a Cell](https://docs.aspose.com/cells/python-net/get-validation-applied-on-a-cell/)
- [Verify that Cell Value Satisfies Data Validation Rules](https://docs.aspose.com/cells/python-net/verify-that-cell-value-satisfies-data-validation-rules/)
