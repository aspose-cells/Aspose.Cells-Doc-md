...
How to apply conditional formats to Excel and ODS files in Python.
## **Introduction**
...
### **Using the Copy Method**
Aspose.Cells for Python via .NET allows developers to copy conditional format settings from one cell to another in the worksheet by calling the [**Range.copy()**](https://reference.aspose.com/cells/python-net/aspose.cells/range/copy) method.
...
### **Set Pattern**
## **Advance topics**
- [Adding 2-Color Scale and 3-Color Scale Conditional Formattings](https://docs.aspose.com/cells/python-net/adding-2-color-scale-and-3-color-scale-conditional-formattings/)
- [Apply Conditional Formatting in Worksheets](https://docs.aspose.com/cells/python-net/apply-conditional-formatting-in-worksheets/)
- [Apply Shading to Alternate Rows and Columns with Conditional Formatting](https://docs.aspose.com/cells/python-net/apply-shading-to-alternate-rows-and-columns-with-conditional-formatting/)
- [Generate Conditional Formatting DataBars Images](https://docs.aspose.com/cells/python-net/generate-conditional-formatting-databars-images/)
- [Get Icon Sets, Data Bars or Color Scales Objects used in Conditional Formatting](https://docs.aspose.com/cells/python-net/get-icon-sets-data-bars-or-color-scales-objects-used-in-conditional-formatting/)
