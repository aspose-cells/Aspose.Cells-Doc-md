...
Manage pictures, oleobject, shapes into Excel files.
...
## **Advance topics**
- [Change Adjustment Values of the Shape](https://docs.aspose.com/cells/python-net/change-adjustment-values-of-the-shape/)
- [Copy Shapes between Worksheets](https://docs.aspose.com/cells/python-net/copy-shapes-between-worksheets/)
- [Data in Non-Primitive Shape](https://docs.aspose.com/cells/python-net/data-in-non-primitive-shape/)
- [Finding Absolute Position of Shape inside the Worksheet](https://docs.aspose.com/cells/python-net/finding-absolute-position-of-shape-inside-the-worksheet/)
- [Get Connection points from shape](https://docs.aspose.com/cells/python-net/get-connection-points-from-shape/)
- [Managing Controls](https://docs.aspose.com/cells/python-net/managing-controls/)
- [Add Icons to Worksheet](https://docs.aspose.com/cells/python-net/insert-svg-to-excel/)
- [Managing OLE Objects](https://docs.aspose.com/cells/python-net/managing-ole-objects/)
- [Managing Pictures](https://docs.aspose.com/cells/python-net/managing-pictures/)
- [Manage Smart Art](https://docs.aspose.com/cells/python-net/managing-smartart/)
- [Managing TextBox](https://docs.aspose.com/cells/python-net/managing-textbox-of-excel/)
- [Add WordArt Watermark to Worksheet](https://docs.aspose.com/cells/python-net/add-wordart-watermark-to-worksheet/)
- [Refresh Values of Linked Shapes](https://docs.aspose.com/cells/python-net/refresh-values-of-linked-shapes/)
- [Send Shape Front or Back inside the Worksheet](https://docs.aspose.com/cells/python-net/send-shape-front-or-back-inside-the-worksheet/)
- [Manage Shape Options](https://docs.aspose.com/cells/python-net/managing-shape-options/)
- [Manage Shape Text Options](https://docs.aspose.com/cells/python-net/managing-shape-text-options/)
- [Web Extensions - Office Add-ins](https://docs.aspose.com/cells/python-net/web-extensions-office-add-ins/)
