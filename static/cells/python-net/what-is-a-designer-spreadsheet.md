...
### **Smart Markers**
Additionally, Aspose.Cells lets you add [smart markers](https://docs.aspose.com/cells/python-net/smart-markers/) to the designer spreadsheet. Smart markers are processed at runtime using the WorkbookDesigner class's Process method. This can help you write less code and still get great result.
[Find out more about smart markers](https://docs.aspose.com/cells/python-net/smart-markers/).
