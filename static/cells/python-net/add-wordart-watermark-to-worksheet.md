...
## **Advance topics**
- [Add Word Art Text with Built-in Styles](https://docs.aspose.com/cells/python-net/add-word-art-text-with-built-in-styles/)
- [Locking WordArt Watermark](https://docs.aspose.com/cells/python-net/locking-wordart-watermark/)
- [Set preset WordArt style to the text of the shape](https://docs.aspose.com/cells/python-net/set-preset-wordart-style-to-the-text-of-the-shape/)
