##Number Settings
Aspose.Cells is a Python library for working with spreadsheet files that supports many different cell number settings. This article will introduce how to use Aspose.Cells library to manage the number settings of cells so that users can adjust the number format in the spreadsheet as needed.
...
## **Advance topics**
- [Check Custom Number Format when Setting Style.Custom Property](https://docs.aspose.com/cells/python-net/check-custom-number-format-when-setting-style-custom-property/)
- [List of Supported Number Formats](https://docs.aspose.com/cells/python-net/list-of-supported-number-formats/)
- [Render Custom Date Format Pattern g and ge mm dd](https://docs.aspose.com/cells/python-net/render-custom-date-format-pattern-g-and-ge-mm-dd/)
- [Specify Custom Number Decimal and Group Separators for Workbook](https://docs.aspose.com/cells/python-net/specify-custom-number-decimal-and-group-separators-for-workbook/)
- [Specifying DBNum Custom Pattern Formatting](https://docs.aspose.com/cells/python-net/specifying-dbnum-custom-pattern-formatting/)
