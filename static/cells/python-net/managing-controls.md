...
## **Advance topics**
- [Add ActiveX Controls](https://docs.aspose.com/cells/python-net/add-activex-controls-using-aspose-cells/)
- [Remove ActiveX Control](https://docs.aspose.com/cells/python-net/remove-activex-control/)
- [Update ActiveX ComboBox Control](https://docs.aspose.com/cells/python-net/update-activex-combobox-control/)
