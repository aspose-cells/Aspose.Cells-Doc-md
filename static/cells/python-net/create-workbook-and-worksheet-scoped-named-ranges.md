...
This article shows how to Create Workbook and Worksheet Scoped Named Ranges by the Aspose.Cells for Python via .NET API.
...
## **Advance topics**
- [Create Access and Copy Named Ranges](https://docs.aspose.com/cells/python-net/create-access-and-copy-named-ranges/)
- [Format and Modify Named Ranges](https://docs.aspose.com/cells/python-net/format-and-modify-named-ranges/)
- [Get Range with External Links](https://docs.aspose.com/cells/python-net/get-range-with-external-links/)
- [Implementing Non-Sequential Ranges](https://docs.aspose.com/cells/python-net/implementing-non-sequential-ranges/)
