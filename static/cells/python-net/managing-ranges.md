##Managing Ranges
This article shows how to manage ranges by the Aspose.Cells for Python via .NET API.
## **Introduction**
...
## **Advance topics**
- [AutoFill range of Excel file](https://docs.aspose.com/cells/python-net/autofill-ranges/)
- [Copy Ranges of Excel](https://docs.aspose.com/cells/python-net/copy-ranges-of-excel/)
- [Copy Range Data Only](https://docs.aspose.com/cells/python-net/copy-range-data-only/)
- [Copy Range Data with Style](https://docs.aspose.com/cells/python-net/copy-range-data-with-style/)
- [Copy Range Style Only](https://docs.aspose.com/cells/python-net/copy-range-style-only/)
- [Create Union Range](https://docs.aspose.com/cells/python-net/create-union-range/)
- [Cut and Paste Range](https://docs.aspose.com/cells/python-net/cut-and-paste-cells/)
- [Delete Ranges](https://docs.aspose.com/cells/python-net/delete-ranges-from-excel/)
- [Get Address Cell Count Offset Entire Column and Entire Row of the Range](https://docs.aspose.com/cells/python-net/get-address-cell-count-offset-entire-column-and-entire-row-of-the-range/)
- [Insert Ranges](https://docs.aspose.com/cells/python-net/insert-ranges-to-excel/)
- [Merge or Unmerge Range of Cells](https://docs.aspose.com/cells/python-net/merge-or-unmerge-range-of-cells/)
- [Move Range of Cells in a Worksheet](https://docs.aspose.com/cells/python-net/move-range-of-cells-in-a-worksheet/)
- [Create Workbook and Worksheet Scoped Named Ranges](https://docs.aspose.com/cells/python-net/create-workbook-and-worksheet-scoped-named-ranges/)
- [Search and Replace Data in a Range](https://docs.aspose.com/cells/python-net/search-and-replace-data-in-a-range/)
