...
## **Advance topics**
- [Change Text Direction of the Comment](https://docs.aspose.com/cells/python-net/change-text-direction-of-the-comment/)
- [How to change the Comment Font Color](https://docs.aspose.com/cells/python-net/how-to-change-the-comment-font-color/)
- [How to set comment background](https://docs.aspose.com/cells/python-net/how-to-set-comment-background/)
- [Threaded Comments](https://docs.aspose.com/cells/python-net/threaded-comments/)
