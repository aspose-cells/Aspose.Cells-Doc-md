##Convert Excel to CSV,TSV and Txt
Convert Excel to CSV,TSV and Txt by using Aspose.Cells for Python via .NET API.
...
## **Advance topics**
- [Keep Separators for Blank Rows while exporting spreadsheets to CSV format](https://docs.aspose.com/cells/python-net/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
- [Trim Leading Blank Rows and Columns while exporting spreadsheets to CSV format](https://docs.aspose.com/cells/python-net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
