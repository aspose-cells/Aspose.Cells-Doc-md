##Creating Subtotals
Learn how to create subtotals for any repeating values in a spreadsheet by using the Aspose.Cells for Python via .NET API.
...
## **Advance topics**
- [Applying Subtotal and Changing Direction of Outline Summary Rows below Detail](https://docs.aspose.com/cells/python-net/applying-subtotal-and-changing-direction-of-outline-summary-rows-below-detail/)
