...
(CELLSJAVA-41145) - الجيل الذكي من CSS أثناء تصدير جداول البيانات إلى HTML
...
(CELLSJAVA-41129) - تظهر سطور إضافية عند عرض إخراج HTML في Chrome
(CELLSJAVA-41122) - فتح المالية وادخارها_بيان - تصريح_إدخال_تقرير_Withdata.xlsb يجعلها تالفة
(CELLSJAVA-41098) - يزيل تحديث الجدول المحوري تنسيق Pivot Table عند التحويل إلى PDF
...
(CELLSJAVA-41166) - لا يستطيع عارض XPS فتح Aspose.Cells XPS الذي تم إنشاؤه
...
(CELLSJAVA-41128) - لا يتم عرض الرسوم البيانية بشكل جيد عند إعادة حفظ ملف XLSX
...
(CELLSJAVA-41131) - يتعطل الحفظ في PDF ومشكلة في الذاكرة مع ملف XLSB المصدر
