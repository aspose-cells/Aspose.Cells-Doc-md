...
(CELLSJAVA-41169) - إزالة السمات الفارغة الزائفة في ملف HTML الذي تم إنشاؤه
...
(CELLSJAVA-41215) - يتم إنشاء EMF باستخدام Aspose.Cells بشكل مختلف في العارضين المختلفين
(CELLSJAVA-41196) - تلف XLSB بعد إضافة ورقة عمل وقيمة خلية
(CELLSJAVA-41227) - API لا يمكن استبدال الخط Arial بخطوط Liberation
(CELLSJAVA-41224) - خطأ في تحويل الصورة عند تحويل Excel إلى PDF
...
(CELLSJAVA-41192) - استثناء: "java.lang.Exception: تم الوصول إلى نهاية الدفق" عند فتح ملف XLS
