---
title: Aspose.Cells for Java 8.5.0 ملاحظات الإصدار
type: docs
weight: 50
url: /ar/java/aspose-cells-for-java-8-5-0-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 8.5.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.5.0/)
...
## **ميزات جديدة**
 ...
 (CELLSJAVA-41335) - تحسين آلية PasteOptions / PasteType للسماح بنسخ ارتفاعات الصف أثناء نسخ النطاقات

 (CELLSJAVA-41053) - إعادة حساب عامل تحجيم إعداد الصفحة


## **التحسينات**


 (CELLSJAVA-41334) - صيغة / وظيفة HYPERLINK - السماح للمستخدم بمعالجة معلمات الارتباط التشعبي

 (CELLSJAVA-41357) - CELLSJAVA-41225 تم إرجاع لون خلفية خاطئ بواسطة Aspose.Cells
...
(CELLSJAVA-41355) - التحويل إلى HTML يلحق سلسلة # في نهاية قيم العمود
 ...
 (CELLSJAVA-41342) - نقلت البيانات إلى اليمين في ملف القالب

 (CELLSJAVA-41341) - النص متداخل مع خلفية بيضاء في ملف القالب

 (CELLSJAVA-41340) - Cell المحاذاة لليسار بدلاً من اليمين في ملف القالب

 (CELLSJAVA-41339) - تم إفساد محاذاة النص والنص في ملف القالب

 (CELLSJAVA-41336) - خطأ JavaScript عند التصدير إلى HTML

 (CELLSJAVA-41327) - فقدان النص في ملف القالب
...
(CELLSJAVA-41206) - تحويل ملف Excel يحتوي على ارتباطات تشعبية إلى HTML - لا تعمل الارتباطات التشعبية المشار إليها Cell
 ...
 (CELLSJAVA-41345) - فشلت الوظيفة المخصصة التي تتضمن صيغة Excel (INDIRECT)

 (CELLSJAVA-41320) - إصدار بالقيمة المتلقاة في CustomFunction

 (CELLSJAVA-40734) - مشكلة مع RefferedArea كنتيجة لحساب المعلمة
...
(CELLSJAVA-40479) - عرض مشكلة تخطيط الصفحة (RTL)
 ...
 (CELLSJAVA-41358) - الرسم البياني يستخدم ليكون قادرًا على قبول صيغة متسلسلة بقيم فارغة ولكنه الآن يطرح استثناء

 (CELLSJAVA-41356) - عرض المشاكل أثناء تحويل الرسم البياني إلى صورة

 (CELLSJAVA-41351) - مشكلة في عرض تسميات محور المخطط عند تحويل ورقة عمل Excel إلى صورة

 (CELLSJAVA-40607) - مشكلة خصائص تسمية بيانات المخطط

 (CELLSJAVA-40613) - مشكلة النسبة المئوية للمخطط الدائري


## **استثناءات**


 (CELLSJAVA-41377) - استثناء عند استدعاء cell.getPrecedents
...
## **API العام والتغييرات غير المتوافقة مع الإصدارات السابقة**
 ...
 يضيف Enum PasteType.RowHeights

 يتم استخدامه لنسخ ارتفاعات النطاق.
...
يضيف خاصية SheetRender.PageScale.
 ...
 يضيف الأسلوب Cell.GetStingValue (CellValueFormatStrategy).

 يتم استخدامه للحصول على قيمة سلسلة الخلية من خلال إستراتيجية محددة منسقة.



 يضيف خاصية ExportTableOptions.FormatStrategy.

 الحصول على استراتيجية التنسيق وتعيينها عند تصدير القيمة كقيمة سلسلة.



 يضيف Class CalculationOptions.

 يمثل خيارات لحساب الصيغ.



إضافة طرق لحساب الصيغ باستخدام CalculationOptions: Cell.Calculate (CalculationOptions) ،
 Workbook.CalculateFormula (CalculationOptions) ، Worksheet.CalculateFormula (CalculationOptions options ، bool recursive).

 اسمح للمستخدم بحساب الصيغ بخيارات أكثر مرونة وقابلة للتوسيع.
...
التغييرات لمعلمات ICustomFunction.CalculateCustomFunction (سلسلة functionName ، ArrayList paramsList ، ArrayList ContextObjects)
 ...
 نظرًا لأن قاعدة الكود Aspose.Cells for Java تطابق رمز إصدار .NET ذي الصلة ، فإن معظم التغييرات والتحسينات والإصلاحات المضمنة في Aspose.Cells for .NET v8.5.0 مدرجة أيضًا في Aspose.Cells for Java v8.5.0.
