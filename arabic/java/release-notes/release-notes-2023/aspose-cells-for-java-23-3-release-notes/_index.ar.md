---
title: Aspose.Cells for Java 23.3 ملاحظات الإصدار
type: docs
weight: 10
url: /ar/java/aspose-cells-for-java-23-3-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 23.3](https://releases.aspose.com/cells/java/).
