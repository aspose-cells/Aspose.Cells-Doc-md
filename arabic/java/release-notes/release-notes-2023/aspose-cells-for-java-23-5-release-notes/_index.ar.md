---
title: Aspose.Cells for Java 23.5 ملاحظات الإصدار
type: docs
weight: 8
url: /ar/java/aspose-cells-for-java-23-5-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 23.5](https://releases.aspose.com/cells/java/).
