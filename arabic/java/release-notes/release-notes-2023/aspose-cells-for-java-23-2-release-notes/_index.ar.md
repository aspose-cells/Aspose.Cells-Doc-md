---
title: Aspose.Cells for Java 23.2 ملاحظات الإصدار
type: docs
weight: 11
url: /ar/java/aspose-cells-for-java-23-2-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 23.2](https://releases.aspose.com/cells/java/).
