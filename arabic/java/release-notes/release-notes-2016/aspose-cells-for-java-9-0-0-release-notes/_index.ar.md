...
|CELLSJAVA-41969 | التظليل Cell مفقود أثناء تحويل تنسيق ملف HTML إلى XLSX| خلل برمجي|
|CELLSJAVA-41955 | يظهر المصنف إلى HTML "#" في الخلايا| خلل برمجي|
|CELLSJAVA-41942 | الحدود المفقودة وتظليل الخلية والصور - HTML لعرض Excel| خلل برمجي|
|CELLSJAVA-41967 | يكون Cells مفقودًا في PDF عند تحديد مساحات طباعة متعددة في ورقة واحدة| خلل برمجي|
...
|CELLSJAVA-41981 | وضع غير صحيح للخط العمودي في PDF على الرسم البياني| خلل برمجي|
