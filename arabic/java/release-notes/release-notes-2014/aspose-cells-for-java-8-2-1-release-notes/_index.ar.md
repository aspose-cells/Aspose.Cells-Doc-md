...
(CELLSJAVA-40944) - تلف PDF مضمن بعد دمج المصنفات
(CELLSJAVA-40979) - يتم إرفاق بعض المربعات بملصقات البيانات في المخطط الدائري في PDF المعروض
(CELLSJAVA-40975) - XLSX لتحويل Jpeg - الأداء
(CELLSJAVA-40973) - تعطيل setExtractContentPermission - خيار "إذن نسخ المحتوى أو استخراجه" لا يعمل
(CELLSJAVA-40965) - Cells تصطدم ببعضها البعض في PDF
...
(CELLSJAVA-40821) - يكون مربع النص مفقودًا عند حفظ الرسم البياني باسم EMF باستخدام ToImage
(CELLSJAVA-40819) - قيم المحور خاطئة عند حفظ الرسم البياني كـ EMF باستخدام ToImage
(CELLSJAVA-40818) - عنوان المحور مفقود عند حفظ الرسم البياني كـ EMF باستخدام ToImage
(CELLSJAVA-40830) - مؤشر z معكوس في مخطط مساحي مكدس وشريطي عند التصدير إلى PDF
