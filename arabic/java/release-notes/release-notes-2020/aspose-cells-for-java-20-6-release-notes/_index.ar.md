...
|CELLSJAVA-43181|الفرق في ارتفاع الصف في تحويل Excel إلى HTML|حشرة|
|CELLSJAVA-43188|لا يتم الاحتفاظ بنمط لون الخلفية أثناء تحويل HTML إلى Excel|حشرة|
|CELLSJAVA-43196|تم اكتشاف عدد مختلف من وحدات VBA باستخدام Aspose.Cells for Java 20.4 و 20.5|حشرة|
|CELLSJAVA-43202|لم يتم تحرير الموارد عند اكتمال إنشاء المصنف|حشرة|
