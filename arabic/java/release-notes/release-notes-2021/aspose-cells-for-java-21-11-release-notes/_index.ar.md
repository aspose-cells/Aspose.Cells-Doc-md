---
title: Aspose.Cells for Java 21.11 ملاحظات الإصدار
type: docs
weight: 2
url: /ar/java/aspose-cells-for-java-21-11-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 21.11](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-21.11/).
