---
title: Aspose.Cells for Java 21.10 ملاحظات الإصدار
type: docs
weight: 3
url: /ar/java/aspose-cells-for-java-21-10-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 21.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-21.10/).
