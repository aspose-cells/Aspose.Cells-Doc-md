---
title: Aspose.Cells for Java 22.2 ملاحظات الإصدار
type: docs
weight: 11
url: /ar/java/aspose-cells-for-java-22-2-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 22.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.2/).
