---
title: Aspose.Cells for Java 22.12 ملاحظات الإصدار
type: docs
weight: 1
url: /ar/java/aspose-cells-for-java-22-12-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 22.12](https://releases.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.12/).
