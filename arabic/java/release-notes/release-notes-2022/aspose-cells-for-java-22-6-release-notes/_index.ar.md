---
title: Aspose.Cells for Java 22.6 ملاحظات الإصدار
type: docs
weight: 7
url: /ar/java/aspose-cells-for-java-22-6-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 22.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.6/).
