---
title: Aspose.Cells for Java 22.3 ملاحظات الإصدار
type: docs
weight: 10
url: /ar/java/aspose-cells-for-java-22-3-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Java 22.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.3/).
