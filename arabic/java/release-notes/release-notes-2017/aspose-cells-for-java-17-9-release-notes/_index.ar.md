...
|CELLSJAVA-42393|تسميات محور الفئة مفقودة عند تحويل Excel إلى PDF|حشرة|
...
|CELLSJAVA-42364|لا تأتي علامات البيانات من نطاق الخلايا عند تصديرها إلى PDF|حشرة|
...
- [أضف إشارات مرجعية بتنسيق PDF مع الوجهات المحددة](/cells/ar/java/add-pdf-bookmarks-with-named-destinations/)
