---
title: فتح الملفات في Python
type: docs
weight: 10
url: /ar/java/opening-files-in-python/
---
## **Aspose.Cells - فتح الملفات في Python**
لفتح ملف باستخدام Aspose.Cells Java في Python ، ما عليك سوى استدعاء طريقة openfile () لفئة المستند وتحديد المستند الثاني الذي سيتم إلحاقه في النهاية.
...
## **قم بتنزيل كود التشغيل**
 تحميل**فتح ملف (Aspose.Cells)** من أي من مواقع الترميز الاجتماعي المذكورة أدناه:
