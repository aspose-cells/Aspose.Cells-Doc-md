...
لفتح ملف باستخدام Aspose.Cells Java في Python ، قم ببساطة بدعوة الطريقة openfile() من فئة Document وحدد الوثيقة الثانية لإلحاقها في النهاية.
...
{{< /highlight >}}
## **تحميل رمز التشغيل**
تنزيل **فتح الملف (Aspose.Cells)** من أي من مواقع الترميز الاجتماعية المذكورة أدناه:
