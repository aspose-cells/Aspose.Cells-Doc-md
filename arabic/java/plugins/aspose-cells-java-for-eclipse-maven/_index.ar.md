...
[Aspose.Cells for Java ](http://goo.gl/gtvhlQ)هو مكون جداول بيانات Excel حائز على جوائز يسمح لمطوري Java بتضمين القدرة على قراءة جداول بيانات Excel® وكتابتها ومعالجتها (XLS و XLSX و XLSM و XLSB و XLTX و SpreadsheetML و CSV و ODS) و HTML و MHTML و PDF والصورة تنسيقات الملفات في تطبيقات Java الخاصة بهم دون الحاجة إلى الاعتماد على Microsoft Excel®.
...
-  يوفر المكون الإضافي الميزات التالية للعمل معها[Aspose.Cells for Java API](http://goo.gl/gtvhlQ) داخل**كسوف IDE** مريح:
...
-  او اذهب الى**مساعدة** > **تثبيت برنامج جديد ...** > أدخل عنوان URL لموقع التحديث التالي في**يعمل مع**:
 cdn.aspose.com/marketplace/eclipse/java/maven/asposecells
 ثم حدد "Aspose.Cells Java لـ Eclipse (Maven)" و**إنهاء**. اقبل اتفاقية الترخيص وقم بتثبيت البرنامج المساعد.
## **التثبيت**
...
1. يختار**ملف** > **استيراد> عام> المشاريع الحالية إلى مساحة العمل**
