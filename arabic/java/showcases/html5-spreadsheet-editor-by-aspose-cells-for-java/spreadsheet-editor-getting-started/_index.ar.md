...
**تقرير الشوائب**
 ...
 لإرسال تقرير خطأ ، أنشئ مشكلة جديدة في[صفحة مشروع جيثب](https://github.com/AsposeShowcase/Html5_Spreadsheet_Editor_by_Aspose.Cells_for_Java/issues) وتطبيق الملصق***حشرة***.
