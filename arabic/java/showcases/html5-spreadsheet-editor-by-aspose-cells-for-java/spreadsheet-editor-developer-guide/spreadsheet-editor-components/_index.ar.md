...
**فيه**
 ...
 ال**فيه** هو**PostConstruct** الطريقة التي يتم تنفيذها مباشرة بعد اكتمال إنشاء الكائن بواسطة Java Application Server. تحقق من**عنوان url**المعلمة في تعيين معلمات الطلب وتحميل جدول البيانات المقابل من موقع معين ، إن أمكن.
