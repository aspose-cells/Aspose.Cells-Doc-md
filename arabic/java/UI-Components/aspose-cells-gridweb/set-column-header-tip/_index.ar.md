...
قد تحتاج إلى تعيين تلميح أداة لعمودك المخصص أثناء إنشاء الجدول في ورقة العمل. Aspose.Cells.GridWeb يسمح لك بإعادة تسمية التسمية التوضيحية للعمود ويمكنك تعيين تلميح الأداة على العمود، بحيث يمكن للمستخدمين فهم الغرض من العمود بسهولة.
##  **تعيين تلميح رأس العمود**
يوجد أدناه مثال كامل لتوضيح كيفية تغيير التسميات التوضيحية للأعمدة وتطبيق نص تلميح الأدوات. بعد تنفيذ رمز المثال، سيظهر نص تلميح الأداة عندما تضع مؤشر الماوس فوق رأس العمود المحدد.

##  **عينة من الرموز**
هنا هو رمز عينة من**test.jsp** ملف.
