---
title: كيفية تخصيص مظهر واجهة المستخدم لنافذة مودال في GridJs  
type: docs
weight: 250
url: /ar/java/aspose-cells-gridjs/how-to-customize-ui-window/
description: تصف هذه المقالة كيفية تخصيص مظهر واجهة المستخدم لنافذة مودال في GridJs.
keywords: شبكة Js، تخصيص، نافذة منبثقة، واجهة المستخدم، المظهر، الصورة، نافذة
aliases:
aliases:
...
# دليل تصميم النافذة المنبثقة لشبكة Js

## جدول المحتويات

- [نظرة عامة](#overview)
- [تسمية فئة CSS](#css-class-naming)
- [ابدء سريع](#quick-start)
- [أمثلة أنيقة على التصميم](#beautiful-style-examples)
- [معرض السمة](#theme-gallery)
...
### أسماء النوافذ المنبثقة المتاحة

| نوع النافذة | الاسم | فئة CSS |
|------------|------|-----------|
| فرز | `sort` | `.x-spreadsheet-modal-sort` |
| التحقق | `validation` | `.x-spreadsheet-modal-validation` |
| بحث | `search` | `.x-spreadsheet-modal-search` |
| عنصر تحكم | `control` | `.x-spreadsheet-modal-control` |
| تنزيل | `download` | `.x-spreadsheet-modal-download` |
| البريد الإلكتروني | `email` | `.x-spreadsheet-modal-email` |
| اقتراح الإدخال | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| إدراج رابط | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| ارتباط | `link` | `.x-spreadsheet-modal-link` |
| طباعة | `print` | `.x-spreadsheet-modal-print` |
| تدوير النص | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| التحقق من البيانات | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| مزيد من تنسيقات الأرقام | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| تنبيه التحقق | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| الإدراج/الحذف | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### المثال 2: سمة نظيفة وبسيطة 🤍

مثالي للتطبيقات المهنية والمؤسسية.
...
### المثال 3: سمة الوضع الداكن 🌙

رائع للتطبيقات التي تدعم الوضع الداكن.
...
### المثال 4: سمة ملونة ومرحة 🌈

مثالية للتطبيقات الإبداعية والمسلية.
...
### المثال 5: سمة الشركات الرسمية 💼

مناسبة للتطبيقات التجارية والمؤسسية.
...
### 7. الحفاظ على التسلسل الهرمي البصري
