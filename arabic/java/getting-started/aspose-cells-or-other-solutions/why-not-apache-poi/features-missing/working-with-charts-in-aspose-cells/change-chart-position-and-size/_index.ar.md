---
title: تغيير موقع المخطط وحجمه
type: docs
weight: 20
url: /ar/java/change-chart-position-and-size/
---

## **أسبوز.سيلز - تغيير موقع المخطط وحجمه**
لتغيير موقع المخطط (إحداثيات X و Y) وحجمه (الارتفاع والعرض)، استخدم هذه الخصائص باستخدام أسبوز.سيلز:
