...
إذا كان المطورون بحاجة إلى حفظ ملفاتهم في مكان تخزين ما، فيمكنهم ببساطة تحديد اسم الملف (مع مسار تخزينه الكامل) وتنسيق الملف المرغوب (باستخدام تعداد **FileFormatType**) أثناء استدعاء طريقة **حفظ** من كائن **الورقة العمل**.
...
الكود أدناه يوضح كيف يمكن تحويل ورقة العمل إلى CSV باستخدام واجهة برمجة التطبيقات Apache POI HSSF و XSSF مقارنة بواجهة برمجة التطبيقات Aspose.Cells Java.
...
{{< /highlight >}}
## **تحميل رمز التشغيل**
تنزيل **تحويل ورقة العمل إلى CSV** من أي من المواقع البرمجية الاجتماعية المذكورة أدناه:
...
لمزيد من التفاصيل، قم بزيارة [حفظ الملفات](/cells/ar/java/saving-excel-files-to-csv-pdf-and-other-formats/)
