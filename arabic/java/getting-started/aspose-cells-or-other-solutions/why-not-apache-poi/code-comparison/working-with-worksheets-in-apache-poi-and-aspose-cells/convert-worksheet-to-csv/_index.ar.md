...
إذا احتاج المطورون إلى حفظ ملفاتهم في بعض مواقع التخزين ، فيمكنهم ببساطة تحديد اسم الملف (بمسار التخزين الكامل) وتنسيق الملف المطلوب (باستخدام**نوع الملف**تعداد) أثناء استدعاء**حفظ**طريقة**دفتر العمل**هدف.
...
\ * XLSX بدائي -> معالج CSV مصمم على طراز
