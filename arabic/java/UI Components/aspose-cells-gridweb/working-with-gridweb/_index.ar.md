...
|CellDoubleClick|يحدث عندما يتم النقر نقرًا مزدوجًا فوق الخلية.|
...
عندما يكون عنصر التحكم GridWeb في وضع العرض ، لا يمكن للمستخدمين تحرير محتوى الشبكة أو تعديله ، مما يعني أنه يمكن للمستخدمين عرض محتوى الشبكة فقط. لهذا السبب يسمى هذا الوضع وضع العرض. في وضع العرض ، هناك بعض الأزرار (**يُقدِّم**, **يحفظ** و**الغاء التحميل** ) مخفية والقائمة التي تظهر عند النقر بزر الماوس الأيمن تحتوي فقط على ملف**ينسخ** و**يجد** اختيار.
