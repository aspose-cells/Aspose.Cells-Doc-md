...
* دعم تقديم التحكم في مربع الاختيار كعنصر تحكم تفاعلي بدلاً من صورة ثابتة في GridWeb
...
* دعم لقراءة ملفات قالب تنسيق OOXML التي تحتوي على بيانات مضغوطة غير طبيعية ولا يمكن معالجتها بواسطة ZipInputStream من جافا
