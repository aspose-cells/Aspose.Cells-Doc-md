...
#### **استخدام كائن النمط**
 عند تطبيق نفس نمط التنسيق على خلايا مختلفة ، استخدم ملحق[أسلوب](https://reference.aspose.com/cells/java/com.aspose.cells/style) هدف.
...
- [توجيه](/cells/ar/java/data-formatting/).
...
من الممكن ضبط ترتيب قراءة النص في الخلايا. ترتيب القراءة هو الترتيب المرئي الذي يتم به عرض الأحرف والكلمات وما إلى ذلك. على سبيل المثال ، اللغة الإنجليزية هي لغة من اليسار إلى اليمين بينما اللغة العربية هي لغة من اليمين إلى اليسار.
 ...
 يتم تعيين ترتيب القراءة مع[أسلوب](https://reference.aspose.com/cells/java/com.aspose.cells/style) خاصية TextDirection للكائن. يوفر Aspose.Cells أنواع اتجاهات النص المحددة مسبقًا في تعداد TextDirectionType.
...
#### **ضبط تنسيق عرض الأرقام والتواريخ للصفوف والأعمدة**
...
{{% alert color="primary" %}} 
 ...
 يرجى مراجعة المقال المفصل على[تعيين تنسيقات عرض الأرقام و [التواريخ]](/cells/ar/java/data-formatting/).
