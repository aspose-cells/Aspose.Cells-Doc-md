...
type: docs
weight: 10
url: /ar/java/how-to-format-number-to-scientific/
description: هذه المقالة ستقدم طريقة تنسيق الرقم إلى العلمي باستخدام API Aspose.Cells for Java.
...
## **كيفية تنسيق رقم إلى علمي في Aspose.Cells for Java**
لتنسيق الأرقام إلى الصيغة العلمية في Aspose.Cells for Java، يمكنك استخدام طريقة `Style.setCustom` لخلية. تتيح لك Aspose.Cells تحديد التنسيق المخصص لبياناتك في أوراق العمل، بما في ذلك الصيغة العلمية.
...
باتباع هذه الخطوات، يمكنك تنسيق الأرقام إلى الصيغة العلمية في Aspose.Cells for Java. تذكر أنه يمكنك تخصيص سلسلة التنسيق (`"0.00E+00"`) حسب الحاجة لضبط عدد الأماكن العشرية أو الجوانب الأخرى لعرض الصيغة العلمية.
