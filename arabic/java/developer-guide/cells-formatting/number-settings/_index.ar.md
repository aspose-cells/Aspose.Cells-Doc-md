...
{{% alert color="primary" %}}
 ...
 إذا كنت تستخدم ملف[**العادة**](https://reference.aspose.com/cells/java/com.aspose.cells/style#Custom) لتعيين تنسيق الأرقام ، يتم تعيين أي تنسيق سابق باستخدام[**رقم**](https://reference.aspose.com/cells/java/com.aspose.cells/style#Number） is overridden and vice versa.
