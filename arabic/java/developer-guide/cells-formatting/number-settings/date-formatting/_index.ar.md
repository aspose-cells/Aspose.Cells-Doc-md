...
type: docs
weight: 10
url: /ar/java/format-number-to-date/
description: ستقدم هذه المقالة شرح كيفية تنسيق الرقم إلى تاريخ باستخدام API Aspose.Cells for Java.
...
لتهيئة الأرقام كتاريخ باستخدام مكتبة Aspose.Cells for Java للعمل مع ملفات إكسل، يمكنك تطبيق تنسيق التاريخ على الخلايا برمجياً. إليك كيف تفعل ذلك باستخدام جافا مع Aspose.Cells:
