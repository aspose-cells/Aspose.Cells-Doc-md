...
## **تحديد الفواصل المخصصة باستخدام Aspose.Cells**
 ...
 يوضح نموذج الكود التالي كيفية تحديد الفواصل المخصصة باستخدام Aspose.Cells API. وهو يحدد الرقم العشري المخصص وفواصل المجموعة كنقطة ومسافة على التوالي. إذن الرقم**123,456.789** سيتم عرضها على شكل**123 456.789** كما هو موضح في لقطة الشاشة التي توضح الإخراج PDF الناتج عن الكود.
