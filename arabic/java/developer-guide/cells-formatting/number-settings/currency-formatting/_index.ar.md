...
type: docs
weight: 10
url: /ar/java/format-number-to-currency/
description: سيقدم هذا المقال كيفية تنسيق الرقم إلى نقدي باستخدام واجهة برمجة التطبيقات Aspose.Cells for Java.
...
لتنسيق الأرقام كعملة في مكتبة Aspose.Cells for Java للعمل مع ملفات Excel، يمكنك تطبيق تنسيق العملة على الخلايا برمجياً. إليك كيف يمكنك فعل ذلك باستخدام Aspose.Cells for Java:
