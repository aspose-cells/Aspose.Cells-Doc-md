...
type: docs
weight: 10
url: /ar/java/how-to-format-number-to-fraction/
description: ستلخص هذه المقالة كيفية تنسيق الرقم إلى كسر باستخدام API Aspose.Cells for Java.
...
## **كيفية تنسيق الرقم إلى كسر في Aspose.Cells for Java**
تعد عملية تنسيق الأرقام إلى كسور في Aspose.Cells for Java بسيطة جدًا. مكتبة Aspose.Cells هي مكتبة قوية تسمح لك بالعمل مع ملفات إكسل في تطبيقات جافا بدون الحاجة إلى تثبيت ميكروسوفت إكسل. توفر مجموعة واسعة من الميزات، بما في ذلك تنسيق الأرقام ككسور.

إليك دليل خطوة بخطوة حول كيفية تنسيق الأرقام إلى كسور في Aspose.Cells for Java:

### الخطوة 1: تثبيت Aspose.Cells for Java
...
لتنسيق خلية إلى كسر، تحتاج إلى استخدام طريقة `Style.setNumber` لرمز تنسيق رقم محدد. يدعم Aspose.Cells العديد من تنسيقات الكسور، مثل "1/2"، "1/4"، "2/4"، وهكذا.
...
- تتيح لك طريقة `setCustom` في كائن النمط تحديد صيغة الكسر الدقيقة. على سبيل المثال، `"# ??/???"` يمكن أن تعرض الكسور مع ما يصل إلى ثلاثة أرقام في المقام.
...
باتباع هذه الخطوات، يمكنك بسهولة تنسيق الأرقام ككسور في Aspose.Cells for Java. يمكن أن يكون هذا مفيدًا بشكل خاص للتطبيقات المالية والإحصائية والتعليمية التي تتطلب قيمًا كسرية دقيقة.
