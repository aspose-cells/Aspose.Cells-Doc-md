...
type: docs
weight: 10
url: /ar/java/how-to-format-number-to-percentage/
description: ستقدم هذه المقالة شرحًا لكيفية تنسيق الرقم إلى نسبة مئوية باستخدام API الخاص بـ Aspose.Cells for Java.
...
## **كيفية تنسيق رقم كنسبة مئوية في Aspose.Cells for Java**
تنسيق الأرقام كنسب مئوية في Aspose.Cells for Java هو عملية مباشرة. مكتبة Aspose.Cells قوية تتيح لك إنشاء وتغيير وتحويل ملفات إكسل في تطبيقات جافا بدون الحاجة إلى تثبيت إكسل من مايكروسوفت. إليك كيف يمكنك تنسيق الأرقام كنسب مئوية باستخدام Aspose.Cells for Java:
...
باتباع هذه الخطوات، يمكنك بسهولة تنسيق الأرقام كنسب مئوية في Aspose.Cells for Java. تقدم Aspose.Cells مجموعة واسعة من الميزات لمعالجة ملفات إكسل، بما في ذلك تنسيق الخلايا، والعمل مع الصيغ، وأكثر من ذلك، مما يجعلها أداة قوية لمطوري الجافا العاملين مع بيانات إكسل.
