...
يمكن للمطورين إنشاء، حذف أو قراءة سباركلاين (في ملف القالب) باستخدام واجهة برمجة التطبيقات المقدمة من Aspose.Cells. تحتوي الفئات التي تدير السباركلاين في [Aspose.Cells.Charts](https://reference.aspose.com/cells/java/com.aspose.cells/Chart) على اسم الفئة. لذا، يجب استيراد هذا النطاق قبل استخدام هذه الميزات.
