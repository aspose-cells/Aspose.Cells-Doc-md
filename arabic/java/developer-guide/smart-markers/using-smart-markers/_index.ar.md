...
يوضح نموذج التعليمات البرمجية التالي استخدام خاصية HTML للعلامات الذكية. عندما تتم معالجتها ، ستظهر "World" في "Hello World" بالخط العريض بسبب HTML \<b>بطاقة شعار.
