...
يوفر Aspose.Cells القدرة على تحديد اختيار نسق العرض للمجالات المحورية. لهذا ، يوفر API الامتداد[**PivotField.DataDisplayFormat**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotfield#DataDisplayFormat) خاصية. لترتيب من الأكبر إلى الأصغر ، يمكنك تعيين[**PivotField.DataDisplayFormat**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotfield#DataDisplayFormat)ملكية ل[**PivotFieldDataDisplayFormat.RANK_LARGEST_TO_SMALLEST**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotfielddatadisplayformat#RANK_LARGEST_TO_SMALLEST). يوضح مقتطف التعليمات البرمجية التالي تعيين خيارات تنسيق العرض.
