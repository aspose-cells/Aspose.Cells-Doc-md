---
title: إدارة عناوين مخططات Excel
linktitle: الألقاب
type: docs
weight: 50
...
يوجد نوعان من العناوين في مخططات Excel:
1.  عنوان التخطيط
1. عناوين المحور
...
## **خيارات العنوان**
 يسمح Aspose.Cells أيضًا بإدارة عناوين الرسم البياني في وقت التشغيل ， مع[لقب](https://reference.aspose.com/cells/java/com.aspose.cells/Title) كائن ، يمكنك تغيير تنسيق النص والخط وتعبئة العناوين.

|![ما يجب القيام به: image_بديل_نص](chart_title.png)|

## **تحديد عناوين المخططات أو المحاور**
يمكنك استخدام Microsoft Excel لتعيين عناوين المخطط ومحاوره في بيئة WYSIWYG. يسمح Aspose.Cells أيضًا للمطورين بتعيين عناوين المخطط ومحاوره في وقت التشغيل. تحتوي جميع المخططات ومحاورها على ملف[لقب](https://reference.aspose.com/cells/java/com.aspose.cells/Title) كائن يمكن استخدامه لتعيين عناوينهم كما هو موضح أدناه في مثال.
...
## **موضوعات مسبقة**
- [قراءة العنوان الفرعي للمخطط من ملف ODS](/cells/ar/java/read-chart-subtitle-from-ods-file/)
