...
توفر Aspose.Cells فئة [Cell](https://reference.aspose.com/cells/java/com.aspose.cells/Cell) وطريقتها [GetDependents](https://reference.aspose.com/cells/java/com.aspose.cells/Cell#getDependents-boolean-) لتتبع المتغيرات التابعة لخلية. على سبيل المثال، في Book1.xlsx هناك صيغ: "=A1+20" و "=A1+30" في الخليتين B2 و C2 على التوالي. يوضح المثال التالي كيفية تتبع المتغيرات التابعة لخلية A1 باستخدام النموذج Book1.xlsx.
