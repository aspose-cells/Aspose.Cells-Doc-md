...
يشرح نموذج التعليمات البرمجية التالي استخدام ملف[**المصنف.الإعدادات. MaxRowsOfSharedFormula**](https://reference.aspose.com/cells/java/com.aspose.cells/workbooksettings#MaxRowsOfSharedFormula)خاصية. يقوم بتعيين الحد الأقصى لصفوف الصيغة المشتركة إلى 5 ويضيف الصيغة المشتركة في الخلية D1 لـ 100 صف ويحفظ في[إخراج ملف Excel](61767869.xlsx). إذا قمت باستخراج محتويات ملف Excel الناتج وتحقق من ملف*ورقة 1.xml*، سترى انقسام الصيغة المشتركة بعد كل 5 صفوف كما هو موضح في لقطة الشاشة أعلاه.
