...
بدءًا من الإصدار 8.0.0 من Aspose.Cells for Java ، قمنا بتوفير خيارات استخدام الذاكرة لاعتبارات الأداء. خاصية MemorySetting متاحة الآن في فئات LoadOptions & WorkbookSettings.
### **مثال**
...
{{% alert color="primary" %}} 
 ...
 يرجى مراجعة المقال المفصل على[تحسين الذاكرة أثناء العمل مع الملفات الكبيرة](/cells/ar/java/optimizing-memory-usage-while-working-with-big-files-having-large-datasets/)س.
...
من الآن فصاعدًا ، يمكن للمستخدمين استخدام الخاصية المنطقية ShowFormulas التي تقدمها ورقة العمل لتبديل طريقة العرض بين الصيغة وقيمة ورقة عمل معينة.
...
باستخدام Aspose.Cells for Java ، تم تمييز طريقة getFilterColumnCollection بأنها قديمة. يُقترح استخدام طريقة AuotFilter.getFilterColumns بدلاً من ذلك.
## **تم استبدال SeriesCollection.SecondCatergoryData بـ SeriesCollection.SecondCategoryData**
لقد قمنا بشكل أساسي بتصحيح الخطأ المطبعي في اسم الطريقة لـ SeriesCollection.getSecondCatergoryData. يمكنك استخدام طريقة SeriesCollection.getSecondCategoryData الآن فصاعدًا ، بينما تم وضع علامة على الطريقة الأصلية SeriesCollection.getSecondCatergoryData عفا عليها الزمن.
