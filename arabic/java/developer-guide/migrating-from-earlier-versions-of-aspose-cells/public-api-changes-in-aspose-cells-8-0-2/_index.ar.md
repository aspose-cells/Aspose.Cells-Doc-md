...
تم وضع علامة على HtmlSaveOptions.ExportChartImageFormat على أنها قديمة اعتبارًا من Aspose.Cells for Java 8.0.2. يُنصح باستخدام HtmlSaveOptions.ImageOptions بدلاً منها لإعدادات صيغة الصورة أثناء تصدير جداول البيانات إلى تنسيق HTML.
