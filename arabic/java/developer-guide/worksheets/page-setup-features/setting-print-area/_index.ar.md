---
title: كيفية تعيين منطقة الطباعة
type: docs
weight: 200
url: /ar/java/how-to-set-print-area/
description: يُظهر لك هذا المقال رمز يشرح كيفية تعيين منطقة الطباعة باستخدام مكتبة Aspose.Cells.
keywords: تقييد نطاق الطباعة، تعيين منطقة الطباعة، مسح منطقة الطباعة، تعيين ومسح منطقة الطباعة باستخدام جافا، كيف تحدد منطقة الطباعة في جافا، تعيين ومسح منطقة الطباعة باستخدام جافا، كيفية مسح منطقة الطباعة في جافا، كيفية إضافة منطقة الطباعة باستخدام جافا، كيفية إزالة منطقة الطباعة باستخدام جافا، كيفية تعيين منطقة الطباعة في Excel، كيفية مسح منطقة الطباعة في Excel.
---
...
لضبط مجال الطباعة في ورقة عمل محددة: أولاً، قم بتحميل [الملف النموذجي](input.xlsx)، ثم عليك تعديل خاصية [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) من كائن [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) لورقة العمل المرغوبة. إعداد هذه الخاصية إلى سلسلة نطاق سيُحدد مجال الطباعة.
...
لمسح مجال الطباعة في ورقة عمل محددة: أولاً، قم بتحميل [الملف النموذجي](input.xlsx)، ثم عليك تعديل خاصية [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) من كائن [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) لورقة العمل المرغوبة. تعيين هذه الخاصية إلى سلسلة فارغة سيمسح مجال الطباعة.
