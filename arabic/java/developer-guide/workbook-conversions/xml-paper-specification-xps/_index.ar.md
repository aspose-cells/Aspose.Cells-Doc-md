...
| :- | :- |
## **XPS في Aspose.Cells**
يمكن تحويل أي مستند تحمله Aspose.Cells إلى XPS.

تستخدم Aspose.Cells نفس محرك تخطيط الصفحة والتقديم عالي الدقة لإنتاج الإخراج في جميع التنسيقات ثابتة التصميم المعتمدة التي يدعمها، مثل PDF، XPS وما إلى ذلك.

**الصور أدناه تظهر درجة الوفاء العالية التي حولت Aspose.Cells وثيقة من XLS إلى XPS.**
