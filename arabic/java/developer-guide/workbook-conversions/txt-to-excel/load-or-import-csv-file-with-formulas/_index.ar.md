...
{{< /highlight >}}
 ...
 يقوم الرمز أولاً بتحميل ملف CSV ، ثم استيراده مرة أخرى في الخلية D4. أخيرًا ، يحفظ كائن المصنف بتنسيق XSLX. ال[إخراج ملف XLSX](5472503.xlsx) يشبه هذا. كما ترى ، تحتوي الخلية C3 و F4 على صيغة ونتائجها 800.
