...
تُظهر لقطة الشاشة التالية ملف HTML الناتج Aspose.Cells الذي يُظهر DataBar و ColorScale و IconSet Conditional Formatting. كما ترى ، يبدو تمامًا مثل ملف[نموذج ملف اكسل](5473447.xlsx).

![ما يجب القيام به: image_بديل_نص](conversion_2.png)
## **عينة من الرموز**
 يحول نموذج التعليمات البرمجية التالي نموذج ملف Excel إلى HTML وهو مجرد ملف عادي[Excel لتحويل HTML](/cells/ar/java/converting-workbook-to-different-formats/#convertingworkbooktodifferentformats-convertingexcelfilestohtml).
