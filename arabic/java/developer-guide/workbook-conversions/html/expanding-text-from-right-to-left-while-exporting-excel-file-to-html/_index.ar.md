...
يحول الكود العيني التالي [ملف Excel عيني](5472562.xlsx) إلى HTML. تُظهر هذه اللقطة الشاشة مظهر ملف Excel العيني في Microsoft Excel 2013.

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_1.png)

تُظهر هذه اللقطة الشاشة [HTML الناتج الذي تم إنشاؤه باستخدام الإصدار القديم](5472570).

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_2.png)

تُظهر هذه اللقطة الشاشة [HTML الناتج الذي تم إنشاؤه باستخدام الإصدار الجديد](5472563).
