---
title: قم بتوفير مسار ملف HTML لورقة العمل المصدرة عبر واجهة IFilePathProvider
type: docs
weight: 870
...
## **قم بتوفير مسار ملف HTML لورقة العمل المصدرة عبر واجهة IFilePathProvider**
 يرجى تنزيل ملف[نموذج ملف اكسل](5473417.zip) المستخدمة في الكود التالي وملفات HTML المصدرة. كل هذه الملفات داخل ملف*مؤقت* الدليل. يجب عليك استخراجه*ج:* قطع. ثم سيصبح*C: \ Temp*الدليل. ثم سوف تفتح ملف*Sheet1.html* ملف في المتصفح وانقر على الرابطين بداخله. تشير هذه الروابط إلى ورقتي عمل HTML المصدرتين والموجودة داخل ملف*C: \ Temp \ OtherSheets*الدليل.
