...
1. لحذف الصفوف الفارغة، استخدم طريقة [Cells.deleteBlankRows()](https://reference.aspose.com/cells/java/com.aspose.cells/cells#deleteBlankRows--).
1. لحذف الأعمدة الفارغة، استخدم طريقة [Cells.deleteBlankColumns()](https://reference.aspose.com/cells/java/com.aspose.cells/cells#deleteBlankColumns--).
