...
مقاربة أخرى هي استخدام **الصيغة المشتركة**. مع الصيغة المشتركة، يتم تحديث الصيغ تلقائيًا لمراجع الخلايا في كل صف بحيث يتم حساب الضريبة بشكل صحيح. طريقة [Cell.setSharedFormula](https://reference.aspose.com/cells/java/com.aspose.cells/cell#setSharedFormula-java.lang.String-int-int-) أكثر كفاءة من الطريقة الأولى.
