...
يوضح الكود أدناه كيفية تحويل ورقة عمل في ملف إكسل Microsoft إلى ملف PNG.
...
## **تحويل ورقة العمل إلى SVG**
 ...
 SVG تعني**الرسومات المتجهات قابلة لل**. SVG هي مواصفات تستند إلى معايير XML للرسومات المتجهة ثنائية الأبعاد. إنه معيار مفتوح قيد التطوير من قبل World Wide Web Consortium (W3C) منذ 1999.
...
هناك طريقة بسيطة لتحويل ورقة العمل النشطة في المصنف وهي تعيين فهرس الورقة النشط ثم حفظ المصنف باسم SVG. سيعرض الورقة النشطة إلى SVG. يوضح نموذج التعليمات البرمجية التالي هذه الميزة:
