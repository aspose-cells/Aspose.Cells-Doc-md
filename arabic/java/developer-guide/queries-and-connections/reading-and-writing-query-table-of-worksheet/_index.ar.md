...
يوفر Aspose.Cells مجموعة [Worksheet.getQueryTables()](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#QueryTables) والتي تعيد [QueryTableCollection](https://reference.aspose.com/cells/java/com.aspose.cells/QueryTableCollection). لاسترجاع [QueryTable](https://reference.aspose.com/cells/java/com.aspose.cells/QueryTable) معين، استخدم خاصية [QueryTableCollection.get()](https://reference.aspose.com/cells/java/com.aspose.cells/querytablecollection#Item%20-int-) ومرر فهرس الـ QueryTable. يمتلك كائن [QueryTable](https://reference.aspose.com/cells/java/com.aspose.cells/QueryTable) الخاص بهذه الفئة الخاصيتين التاليتين لضبط استعلام الجدول.
