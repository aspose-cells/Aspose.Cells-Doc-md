...
type: docs
weight: 930
url: /ar/java/working-with-the-reflection-effect-of-shape-or-chart/
---

## **سيناريوهات الاستخدام المحتملة**
توفر Aspose.Cells خاصية [Shape.ReflectionEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#Reflection) للعمل مع تأثير الانعكاس للشكل أو المخطط. تحتوي على الخصائص الفرعية التالية التي يمكنك ضبطها لتحقيق نتائج مختلفة وفقًا لمتطلباتك.
