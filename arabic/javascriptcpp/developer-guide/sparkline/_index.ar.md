---
title: إدراج خط Sparkline باستخدام جافا سكريبت عبر C++
linktitle: Sparklines
type: docs
weight: 160
url: /ar/javascript-cpp/creating-sparklines/
description: إنشاء Sparkline لملفات إكسل باستخدام Aspose.Cells for JavaScript عبر C++.
---
...
من السهل إنشاء Sparkline باستخدام Aspose.Cells for JavaScript عبر C++ باستخدام الأمثلة التالية:
...
## **مواضيع متقدمة**
- [استخدام الشرائط الإشارية وإعدادات تنسيق ثلاثي الأبعاد](/cells/ar/javascript-cpp/using-sparklines-and-settings-3d-format/)
