---
title: استفد من خاصية Sheet.SheetId في OpenXml باستخدام Aspose.Cells for JavaScript عبر C++
linktitle: استخدام خاصية Sheet.SheetId في OpenXml باستخدام Aspose.Cells
type: docs
weight: 200
url: /ar/javascript-cpp/utilize-sheet-sheetid-property-of-openxml-using-aspose-cells/
description: توضح هذه المقالة كيفية استخدام خاصية Sheet.SheetId من OpenXml باستخدام Excel manipulation مع Aspose.Cells for JavaScript عبر برنامج C++ برمجيًا.
keywords: معرف ورقة العمل الخاص بـ openxml JavaScript عبر C++، معرف ورقة العمل إكسل JavaScript عبر C++
---

## **سيناريوهات الاستخدام المحتملة**

خاصية *Sheet.SheetId* متاحة داخل وحدة *DocumentFormat.OpenXml.Spreadsheet* وهي جزء من OpenXml. يمكنك رؤية هذه الخاصية وقيمتها داخل *workbook.xml* كما هو موضح في لقطة الشاشة التالية. توفر Aspose.Cells الخاصية المعادلة [**Worksheet.tabId**](https://reference.aspose.com/cells/javascript-cpp/worksheet/#tabId--).
