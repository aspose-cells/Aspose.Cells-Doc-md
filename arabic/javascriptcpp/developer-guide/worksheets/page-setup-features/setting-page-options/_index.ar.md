---
title: تعيين خيارات الصفحة مع JavaScript عبر C++
linktitle: ضبط خيارات الصفحة
type: docs
weight: 10
url: /ar/javascript-cpp/setting-page-options/
description: يقدم هذا المقال رمزًا عينة لضبط خيارات صفحة أوراق عمل Excel برمجيًا باستخدام JavaScript عبر C++. ضبط اتجاه الصفحة، معامل التحجيم، خيارات FitToPages، حجم الورق، جودة الطباعة، رقم الصفحة الأولى.
keywords: ضبط اتجاه صفحة Excel JavaScript عبر C++, ضبط معامل التحجيم في Excel JavaScript عبر C++, ضبط حجم ورق العمل في Excel JavaScript عبر C++
---
...
توفر Aspose.Cells فئة، [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook)، التي تمثل ملف Microsoft Excel. تحتوي فئة [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) على مجموعة [**worksheets**](https://reference.aspose.com/cells/javascript-cpp/workbook/#worksheets--) التي تتيح الوصول إلى كل ورقة عمل في ملف Excel. تمثل ورقة عمل بفئة [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet).  
 ...
 توفر فئة [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) الخاصية [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) التي تُستخدم لتعيين خيارات إعداد الصفحة لورقة العمل. في الواقع، هذه الخاصية [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) عبارة عن كائن من فئة [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) يُستخدم لتعيين خيارات تخطيط الصفحة المختلفة لورقة عمل مطبوعة. توفر فئة [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) خصائص مختلفة تُستخدم لتعيين إعدادات الصفحة. بعض هذه الخصائص مذكورة أدناه.  

### **اتجاه الصفحة**  

يمكن تعيين اتجاه الصفحة إلى عمودي أو أفقي باستخدام الخاصية [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) من فئة [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). تقبل الخاصية [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) إحدى القيم المعتمدة في تعداد [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype)، المدرجة أدناه.  
...
من الممكن تقليل أو تكبير حجم ورقة العمل عن طريق ضبط معامل التكبير باستخدام الخاصية [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--).  
...
لتتناسب محتويات ورقة العمل مع عدد معين من الصفحات، استخدم الخاصيتين [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) و [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) من فئة [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). كما تُستخدم هذه الخاصيتين أيضًا لضبط مقياس ورقة العمل.  

{{% alert color="primary" %}}  
يمكنك إما اختيار الخاصية [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) أو الخاصية [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) ولكن ليس كلاهما معاً.  
{{% /alert %}}  
...
حدد حجم الورق الذي ستطبع عليه أوراق العمل باستخدام الخاصية [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) من فئة [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). تقبل الخاصية [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) إحدى القيم المعتمدة في تعداد [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype)، المدرجة أدناه.  
...
### **جودة الطباعة**  
 ...
 ضبط جودة طباعة الأوراق المراد طباعتها باستخدام الخاصية [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--). وحدة القياس لجودة الطباعة هي نقاط في البوصة (DPI).  
...
ابدأ ترقيم صفحات ورقة العمل باستخدام الخاصية [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) من فئة [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). تحدد الخاصية [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) رقم صفحة ورقة العمل الأولى، وتُرقم الصفحات التالية بترتيب تصاعدي.  
