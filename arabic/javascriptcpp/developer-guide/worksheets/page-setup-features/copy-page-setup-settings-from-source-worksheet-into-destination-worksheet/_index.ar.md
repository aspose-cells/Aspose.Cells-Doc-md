---
title: نسخ إعدادات إعداد الصفحة من ورقة العمل المصدر إلى ورقة العمل الوجهة باستخدام جافا سكريبت عبر C++
linktitle: نسخ إعدادات إعداد الصفحة من ورقة العمل المصدر إلى ورقة العمل الهدف
type: docs
weight: 80
url: /ar/javascript-cpp/copy-page-setup-settings-from-source-worksheet-into-destination-worksheet/
description: تشرح هذه المقالة كيفية استخدام API جافا سكريبت أو رمز عينة مكتبة C++ لنسخ إعدادات إعداد الصفحة من ورقة عمل المصدر إلى ورقة العمل الوجهة برمجيًا.
keywords: نسخ إعدادات إعداد الصفحة جافا سكريبت عبر C++، نسخ إعدادات إعداد الصفحة إلى ورقة العمل الهدف جافا سكريبت عبر C++
---

## **سيناريوهات الاستخدام المحتملة**

 عند إضافة ورقة جديدة إلى مصنف، تحتوي على إعدادات إعداد الصفحة الافتراضية. قد يكون هناك أوقات تحتاج فيها إلى نقل الإعدادات ([**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup)) من ورقة عمل إلى أخرى. يوضح هذا المستند كيفية نسخ إعدادات إعداد الصفحة من ورقة عمل إلى أخرى باستخدام APIs Aspose.Cells for JavaScript عبر C++.

## **نسخ إعدادات إعداد الصفحة من ورقة العمل المصدر إلى ورقة العمل الوجهة**

الشيفرة النموذجية التالية توضح كيفية نسخ إعدادات إعداد الصفحة من ورقة عمل واحدة إلى أخرى باستخدام طريقة [**PageSetup.copy(PageSetup, CopyOptions)**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#copy-pagesetup-copyoptions-). يُرجى الاطلاع على الشيفرة النموذجية التالية وإخراجها إلى وحدة التحكم كمرجع.
