...
type: docs
weight: 130
url: /ar/javascript-cpp/display-bullets-by-setting-cell-value-using/
description: إضافة النقاط في خلايا إكسل باستخدام HTML مع Aspose.Cells for JavaScript سهلة الاستخدام عبر C++.
keywords: إضافة نقاط في إكسل باستخدام JavaScript عبر C++، عرض النقاط في إكسل JavaScript عبر C++، إضافة نقاط في إكسل باستخدام HTML JavaScript، عرض النقاط في إكسل باستخدام HTML JavaScript، إضافة نقاط في إكسل باستخدام HTML JavaScript عبر C++
---

{{% alert color="primary" %}}

يدعم Aspose.Cells عرض النقاط باستخدام كود HTML. ستوضح هذه المقالة كيفية عرض النقاط عن طريق تعيين قيمة الخلية باستخدام HTML. سنستخدم طريقة [**Cell.htmlString(string)**](https://reference.aspose.com/cells/javascript-cpp/cell/#htmlString-string-) لضبط قيمة الخلية مع HTML الخاص بنا.

{{% /alert %}}

## كود JavaScript لعرض النقاط من خلال تعيين قيمة الخلية باستخدام HTML
