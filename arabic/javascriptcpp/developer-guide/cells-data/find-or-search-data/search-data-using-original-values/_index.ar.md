...
type: docs
weight: 380
url: /ar/javascript-cpp/search-data-using-original-values/
description: تعلم كيفية البحث عن البيانات باستخدام القيم الأصلية من خلال API Aspose.Cells for JavaScript عبر C++.
keywords: البحث عن البيانات باستخدام القيم الأصلية جافا سكريبت عبر C++، العثور على البيانات باستخدام القيم الأصلية جافا سكريبت عبر C++، البحث عن البيانات بواسطة القيم الأصلية جافا سكريبت عبر C++، العثور على البيانات بواسطة القيم الأصلية جافا سكريبت عبر C++
---
...
## كود جافا سكريبت للبحث عن البيانات باستخدام القيم الأصلية  
