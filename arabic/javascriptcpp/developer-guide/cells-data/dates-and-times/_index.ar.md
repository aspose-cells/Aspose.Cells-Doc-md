...
type: docs
weight: 600
url: /ar/javascript-cpp/how-to-manage-dates-and-times/
description: تعلم كيف تدير التواريخ والأوقات عبر Aspose.Cells for JavaScript عبر واجهة برمجة التطبيقات C ++.
...
## **كيفية تخزين التواريخ والأوقات في إكسل**  
 يتم تخزين التواريخ والأوقات في الخلايا كن 숫. لذلك، فإن قيم الخلايا التي تحتوي على تواريخ وأوقات تكون من النوع الرقمي. يتكون الرقم الذي يحدد التاريخ والوقت من مكونات التاريخ (الجزء الصحيح) والوقت (الجزء الكسري). يرجع خاصية Cell.doubleValue هذا الرقم.  

## **كيفية عرض التواريخ والأوقات في Aspose.Cells**  
لعرض رقم كتاريخ ووقت، طبق تنسيق التاريخ والوقت المطلوب على الخلية باستخدام خاصية [Style.number](https://reference.aspose.com/cells/javascript-cpp/style/#number--) أو [Style.Custom]() . ترجع خاصية CellValue.dateTimeValue كائن DateTime، والذي يحدد التاريخ والوقت الممثّل بواسطة الرقم الموجود في الخلية.  
<br>  
...
1. نظام التاريخ 1900. اليوم الأول هو 1 يناير 1900، وقيمته المتسلسلة هي 1. أما آخر يوم فهو 31 ديسمبر 9999، وقيمته المتسلسلة هي 2،958،465. يُستخدم هذا النظام في جدول العمل افتراضيًا.  
 1. نظام التاريخ 1904. التاريخ الأول هو 1 يناير 1904، وقيمته التسلسلية 0. التاريخ الأخير هو 31 ديسمبر 9999، وقيمته التسلسلية 2,957,003. لاستخدام هذا النظام في دفتر العمل، اضبط الخاصية [WorkbookSettings.date1904](https://reference.aspose.com/cells/javascript-cpp/workbooksettings/#date1904--) إلى true.  
