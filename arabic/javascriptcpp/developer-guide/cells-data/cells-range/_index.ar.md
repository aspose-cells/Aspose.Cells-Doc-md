...
type: docs
weight: 600
url: /ar/javascript-cpp/get-cells-range/
description: تعلم كيفية الحصول على نطاق الخلايا من خلال واجهة برمجة تطبيقات Aspose.Cells for Javaسكريبت عبر C++.
...
عندما تحتاج فقط إلى التلاعب ببعض البيانات على ورقة العمل، عليك معرفة نطاق البيانات بالكامل. Aspose.Cells for Javaسكريبت عبر C++ يوفر هذه الميزة. كما يوفر الخصائص والطرق التالية لمساعدتك على تحقيق أهدافك.
...
## **الحصول على نطاق الخلايا باستخدام Aspose.Cells for Javaسكريبت عبر C++**
يوضح هذا المثال كيف:

1. إنشاء دفتر عمل.
1. إضافة بيانات إلى الخلايا في ورقة العمل الأولى.
3. الحصول على الخلايا [**Range**](https://reference.aspose.com/cells/javascript-cpp/range).
