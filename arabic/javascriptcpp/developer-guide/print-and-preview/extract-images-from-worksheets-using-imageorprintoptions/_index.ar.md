---
title: استخراج الصور من أوراق العمل باستخدام خيارات الصورة أو الطباعة مع JavaScript عبر C++
linktitle: استخراج الصور من الأوراق العمل باستخدام خيارات الصورة أو الطباعة
type: docs
weight: 140
url: /ar/javascript-cpp/extract-images-from-worksheets-using-imageorprintoptions/
description: تعلم كيفية استخراج الصور من أوراق عمل Excel وحفظها باستخدام Aspose.Cells for JavaScript عبر C++.
---

{{% alert color="primary" %}} 

يمكن لمستخدمي Microsoft Excel إضافة صور إلى جداول البيانات. مع Aspose.Cells for JavaScript عبر C++، من الممكن قراءة الصور من ملفات Microsoft Excel وحفظها على القرص المحلي. يوضح هذا المقال كيفية القيام بذلك.
