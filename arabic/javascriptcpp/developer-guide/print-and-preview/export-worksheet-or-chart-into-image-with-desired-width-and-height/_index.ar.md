---
title: تصدير ورقة العمل أو الرسم البياني إلى صورة بالعرض والطول المطلوب via JavaScript
linktitle: تصدير ورقة العمل أو الرسم البياني إلى صورة بالعرض والارتفاع المطلوبين
type: docs
weight: 290
url: /ar/javascript-cpp/export-worksheet-or-chart-into-image-with-desired-width-and-height/
description: تعلم كيفية تصدير ورقة عمل أو رسم بياني إلى صورة بعرض وارتفاع محددين باستخدام Aspose.Cells for JavaScript عبر C++.
---

{{% alert color="primary" %}}
 يمكنك استخدام Aspose.Cells for JavaScript عبر C++ لتصدير ورقة العمل أو الرسم البياني إلى صورة بالعرض والارتفاع المطلوبين. يوفر [**ImageOrPrintOptions.desiredSize(number, number, boolean)**](https://reference.aspose.com/cells/javascript-cpp/imageorprintoptions/#desiredSize-number-number-boolean-) طريقة لضبط العرض والارتفاع المطلوبين للصورة المصدر. يتم تحديد العرض والارتفاع بوحدة البكسل.
{{% /alert %}}
