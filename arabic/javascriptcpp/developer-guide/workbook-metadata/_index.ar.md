---
title: استخدام البيانات الوصفية للدليل باستخدام جافا سكريبت عبر C++
linktitle: بيانات السجل الحصري
type: docs
weight: 320
url: /ar/javascript-cpp/using-workbookmetadata/
description: تعلم كيفية تحرير بيانات وصفية للدليل باستخدام Aspose.Cells for JavaScript عبر C++.
---

{{% alert color="primary" %}}  
يتيح لك Aspose.Cells تحميل نسخة خفيفة من ملف العمل إلى الذاكرة لتحرير معلومات البيانات الوصفية الخاصة به. يرجى استخدام فئة [**WorkbookMetadata**](https://reference.aspose.com/cells/javascript-cpp/workbookmetadata) لتحميل ملف العمل.  
{{% /alert %}}  

يستخدم المثال التالي للفئة [**WorkbookMetadata**](https://reference.aspose.com/cells/javascript-cpp/workbookmetadata) لتحرير خصائص المستند المخصصة لملف العمل. بمجرد فتح ملف العمل باستخدام فئة [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook)، ستتمكن من قراءة خصائص المستند. إليك مثال على الكود باستخدام فئة [**WorkbookMetadata**](https://reference.aspose.com/cells/javascript-cpp/workbookmetadata).  
