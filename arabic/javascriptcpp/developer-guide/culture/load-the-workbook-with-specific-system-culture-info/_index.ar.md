---
title: تحميل دفتر العمل باستخدام معلومات ثقافة النظام محددة via JavaScript و C++
linktitle: تحميل سجل العمل بمعلومات الثقافة النظامية المحددة
type: docs
weight: 190
url: /ar/javascript-cpp/load-the-workbook-with-specific-system-culture-info/
---

## **سيناريوهات الاستخدام المحتملة**
 سابقًا، كان عليك تغيير معلومات الثقافة للموضوع بأكمله للتعامل مع الأرقام والتواريخ بصيغة ثقافة معينة، لكن الآن يوفر Aspose.Cells for JavaScript عبر C++ الخاصية `LoadOptions.CultureInfo` والتي يمكنك استخدامها لتحميل دفتر العمل مع معلومات الثقافة المحددة دون تغيير ثقافة الموضوع بالكامل.
