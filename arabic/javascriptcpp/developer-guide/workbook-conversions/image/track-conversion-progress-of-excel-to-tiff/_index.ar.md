---
title: تتبع تقدم تحويل Excel إلى TIFF باستخدام JavaScript عبر C++
linktitle: تتبع تقدم التحويل من إكسيل إلى TIFF
type: docs
weight: 190
url: /ar/javascript-cpp/track-conversion-progress-of-excel-to-tiff/
description: تعلم كيفية تتبع تقدم تحويل ملفات Excel إلى TIFF باستخدام Aspose.Cells for JavaScript عبر C++. عزز تجربة المستخدم أثناء عملية التحويل.
---

## **سيناريوهات الاستخدام المحتملة**

أحيانًا، قد يستغرق تحويل ملفات Excel الكبيرة بعض الوقت. خلال هذا الوقت، قد ترغب في عرض تقدم تحويل المستند بدلاً من شاشة التحميل فقط لتحسين تجربة المستخدم في التطبيق الخاص بك. Aspose.Cells for JavaScript عبر C++ يدعم تتبع عملية تحويل المستند من خلال توفير واجهة [**IPageSavingCallback**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback). توفر واجهة [**IPageSavingCallback**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback) [**pageStartSaving(PageStartSavingArgs)**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback/#pageStartSaving-pagestartsavingargs-) و[**pageEndSaving(PageEndSavingArgs)**](https://reference.aspose.com/cells/javascript-cpp/ipagesavingcallback/#pageEndSaving-pageendsavingargs-) الطرق التي يمكنك تنصيبها في صفك المخصص. يمكنك أيضًا التحكم في الصفحات التي يتم عرضها كما هو موضح في الفئة المخصصة *TestPageSavingCallback*.
