---
title: العمل مع الخلفية في ملفات ODS باستخدام جافا سكريبت عبر C++
linktitle: العمل مع الخلفية في ملفات ODS
type: docs
weight: 150
url: /ar/javascript-cpp/working-with-background-in-ods-files/
description: تعرّف على كيفية إدارة الخلفيات في ملفات ODS باستخدام Aspose.Cells for JavaScript عبر C++.
---
...
يوفر Aspose.Cells for JavaScript عبر C++ القدرة على قراءة معلومات الخلفية وإضافة خلفية في ملفات ODS.  

## **قراءة معلومات الخلفية من ملف ODS**  

يوفر Aspose.Cells for JavaScript عبر C++ فئة [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) لإدارة الخلفية في ملفات ODS. يعرض عينة الشفرة التالية استخدام فئة [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) بتحميل ملف [source ODS](90112030.ods) وقراءة معلومات الخلفية. يرجى الاطلاع على الإخراج في وحدة التحكم الذي أنشأه الكود للمراجعة.  
...
يوفر Aspose.Cells for JavaScript عبر C++ فئة [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) لإدارة الخلفية في ملفات ODS. تُظهر عينة الشفرة التالية استخدام الخاصية [**OdsPageBackground.color**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#color--) لإضافة خلفية لون إلى ملف ODS. يرجى الاطلاع على ملف [الإخراج ODS](90112031.ods) الذي أنشأه الكود للمراجعة.  
...
يوفر Aspose.Cells for JavaScript عبر C++ فئة [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) لإدارة الخلفية في ملفات ODS. تُظهر عينة الشفرة التالية استخدام الخاصية [**OdsPageBackground.graphicData**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#graphicData--) لإضافة خلفية رسومية إلى ملف ODS. يرجى الاطلاع على ملف [الإخراج ODS](90112030.ods) الذي أنشأه الكود للمراجعة.  
