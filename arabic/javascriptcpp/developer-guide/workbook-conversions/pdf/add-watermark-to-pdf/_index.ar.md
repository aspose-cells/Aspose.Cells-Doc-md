---
title: إضافة علامة مائية إلى PDF باستخدام جافا سكريبت عبر C++
linktitle: إضافة علامة مائية إلى ملف PDF
type: docs
weight: 9
url: /ar/javascript-cpp/add-watermark-to-pdf/
description: تعلم كيفية إضافة علامة مائية نصية وصورة إلى PDF أثناء تحويل Excel إلى PDF باستخدام Aspose.Cells for Javaسكريبت عبر C++.
---
...
يمكنك إضافة علامة مائية نصية إلى PDF بسهولة من خلال تحديد النص والخط المقابل. أيضًا، يمكنك تعيين المحاذاة، الإزاحة، الدوران، الشفافية، المقدمة/الخلفية، والتحجيم للصفحة في [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
...
يمكنك إضافة علامة مائية صورة إلى PDF فقط عن طريق تحديد بايتات الصورة. أيضًا، يمكنك تعيين المحاذاة، الإزاحة، الدوران، الشفافية، المقدمة/الخلفية، والتحجيم للصفحة في [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
