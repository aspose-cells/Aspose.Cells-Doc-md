---
title: استخراج النص من شكل ذكي من نوع Gear باستخدام جافا سكريبت عبر C++
linktitle: استخراج النص من شكل SmartArt نوع الحركة
type: docs
weight: 500
url: /ar/javascript-cpp/extract-text-from-the-gear-type-smartart-shape/
description: تعلم كيفية استخراج النص من شكل ذكي من نوع Gear باستخدام Aspose.Cells for JavaScript عبر C++.
---

## **سيناريوهات الاستخدام المحتملة**

 يمكن لـ Aspose.Cells استخراج النص من شكل ذكي من نوع Gear. للقيام بذلك، يجب أولاً تحويل الشكل الذكي إلى شكل مجموعة باستخدام خاصية [**Shape.resultOfSmartArt**](https://reference.aspose.com/cells/javascript-cpp/shape/#resultOfSmartArt--). ثم يجب الحصول على مصفوفة جميع الأشكال الفردية التي تكوّن المجموعة باستخدام الخاصية [**GroupShape.groupedShapes**](https://reference.aspose.com/cells/javascript-cpp/groupshape/#groupedShapes--). أخيرًا، يمكنك التكرار عبر جميع الأشكال الفردية واحدة تلو الأخرى في حلقة واستخراج نصها باستخدام الخاصية [**Shape.text**](https://reference.aspose.com/cells/javascript-cpp/shape/#text--).
