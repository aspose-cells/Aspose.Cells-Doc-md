---
title: استخراج كائنات OLE من دفتر العمل باستخدام JavaScript عبر C++
linktitle: استخراج كائنات Ole من الدفتر
type: docs
weight: 110
url: /ar/javascript-cpp/extract-ole-objects-from-workbook/
---

{{% alert color="primary" %}}
 في بعض الأحيان، تحتاج إلى استخراج كائنات OLE من دفتر العمل. يدعم Aspose.Cells استخراج وحفظ تلك الكائنات.

تتضمن هذه المقالة شرح كيفية إنشاء تطبيق باستخدام JavaScript عبر C++ واستخراج كائنات OLE المختلفة من دفتر عمل باستخدام بضعة أسطر برمجية بسيطة.
{{% /alert %}}
...
ابدأ بيئة جافا سكريبت وإنشاء مشروع جديد. سيُظهر هذا المثال تطبيقًا يعتمد على المتصفح، لكن يمكن أيضًا استخدام أي بيئة متوافقة مع جافا سكريبت.

1. إضافة الاعتمادات  
   1. أدخل سكربت Aspose.Cells for JavaScript عبر C++ في صفحة HTML الخاصة بك وأنشئ واجهة مستخدم بسيطة لاختيار ملف Excel واستخراج كائنات OLE،.
