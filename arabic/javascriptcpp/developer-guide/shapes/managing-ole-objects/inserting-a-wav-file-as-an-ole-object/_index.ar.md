---
title: إدراج ملف WAV ككائن OLE باستخدام JavaScript عبر C++
linktitle: إدراج ملف WAV ككائن Ole
type: docs
weight: 70
url: /ar/javascript-cpp/inserting-a-wav-file-as-an-ole-object/
description: تعلم كيفية إدراج ملف WAV ككائن OLE في أوراق عمل إكسل باستخدام Aspose.Cells for JavaScript عبر C++. 
---

{{% alert color="primary" %}} 

يوفر Aspose.Cells وظيفة لإضافة أنواع مختلفة من كائنات OLE إلى أوراق عمل إكسل. سنرى في الأمثلة التالية كيفية إضافة ملف WAV ككائن OLE باستخدام واجهات برمجة التطبيقات البسيطة التي يوفرها Aspose.Cells. 
