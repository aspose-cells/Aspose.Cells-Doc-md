...
type: docs
weight: 100
url: /ar/javascript-cpp/export-equation/
---
...
إذا كنت تريد تصدير المعادلات في إكسل كتعابير LaTeX، يمكنك استخدام دالة [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--). 

يعرض الكود النموذجي التالي كيف تستخدم دالة [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) وتدرج النتائج المُنشأة في HTML:

### جافا سكريبت-إلى-LaTeX
...
إذا كنت تريد تصدير المعادلات في إكسل كتعابير MathML، يمكنك استخدام دالة [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--). 

يعرض الكود النموذجي التالي كيفية استخدام دالة [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) وإدراج النتائج المُنشأة في HTML:

### جافا سكريبت-إلى MathML
