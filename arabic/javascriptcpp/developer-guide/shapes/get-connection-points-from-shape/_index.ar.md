---
title: الحصول على نقاط الاتصال من الشكل باستخدام جافا سكريبت عبر ++C
linktitle: الحصول على نقاط الاتصال من الشكل
type: docs
weight: 3500
url: /ar/javascript-cpp/get-connection-points-from-shape/
description: تعلم كيفية استرجاع نقاط الاتصال من الأشكال في إكسل باستخدام Aspose.Cells for Javaسكريبت عبر ++C.
---

يوفر Aspose.Cells ميزات غنية لإدارة الأشكال في جدول البيانات. أحيانًا يكون من الضروري الحصول على نقاط الاتصال للشكل لمحاذاته أو وضع الأشكال في المكان المناسب. لهذا الغرض، تتطلب جميع نقاط الاتصال. يمكن استخدام الكود التالي للحصول على قائمة نقاط الاتصال للشكل باستخدام خاصية [**Shape.connectionPoints**](https://reference.aspose.com/cells/javascript-cpp/shape/#connectionPoints--).
