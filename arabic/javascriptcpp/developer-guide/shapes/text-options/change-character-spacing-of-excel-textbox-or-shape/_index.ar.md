---
title: تغيير تباعد الأحرف لنص مربع إكسل أو شكل باستخدام جافا سكريبت عبر C++
linktitle: تغيير تباعد الأحرف لصندوق النص أو الشكل في Excel
type: docs
weight: 280
url: /ar/javascript-cpp/change-character-spacing-of-excel-textbox-or-shape/
description: تغيير تباعد الأحرف لنصوص إكسل أو أشكال باستخدام Script Aspose.Cells for Java عبر C++. 
---

{{% alert color="primary" %}}

يمكنك تغيير تباعد الأحرف لنص في مربع نص إكسل أو شكل باستخدام الخاصية [**TextOptions.spacing**](https://reference.aspose.com/cells/javascript-cpp/textoptions/#spacing--).
