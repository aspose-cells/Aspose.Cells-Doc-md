---
title: إضافة مجموعة رموز شرطية مع نص الخلية باستخدام JavaScript عبر C++
linktitle: إضافة مجموعة رموز شرطية مع نص الخلية
type: docs
weight: 160
url: /ar/javascript-cpp/add-conditional-icons-set-with-the-cell-text/
description: تعلم كيفية إضافة رموز شرطية بجانب نص الخلية باستخدام Aspose.Cells for JavaScript عبر C++. تعزيز معنى البيانات من خلال الأيقونات.
---

{{% alert color="primary" %}} 

 أحيانًا، ترغب في إضافة رموز شرطية بجانب نص في خلية لجعل البيانات أكثر معنى للقراء. تريد استخدام بعض أنواع رموز التنسيق الشرطي ولكن بدون تطبيق التنسيق الشرطي على الخلايا. يدعم هذا الميزة Aspose.Cells for JavaScript عبر C++.
