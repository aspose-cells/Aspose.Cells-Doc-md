---
title: تغيير قيم تعديل الشكل باستخدام جافا سكريبت عبر ++C
linktitle: تغيير قيم التعديل للشكل
type: docs
weight: 2000
url: /ar/javascript-cpp/change-adjustment-values-of-the-shape/
description: تعلم كيفية تغيير قيم التعديل للأشكال في Excel باستخدام سكريبت Aspose.Cells for Java عبر ++C.
---

{{% alert color="primary" %}}  
توفر Aspose.Cells خاصية [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) لإجراء تغييرات على نقاط التعديل مع الأشكال. في واجهة مستخدم Microsoft Excel، تعرض عمليات التعديل على شكل نقاط ماسية صفراء. على سبيل المثال:  
...
سيشرح هذا المقال استخدام خاصية [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) لتغيير قيمة التعديل لأشكال مختلفة.  
{{% /alert %}}  
