---
title: استبدال العلامة ب نص في مربع نص داخل ورقة العمل باستخدام جافا سكريبت عبر C++
linktitle: استبدال العلامة بالنص في مربع نص داخل ورقة البيانات
type: docs
weight: 1100
url: /ar/javascript-cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: تعلم كيفية استبدال العلامات بالنص داخل مربع نص في ورقة العمل باستخدام Aspose.Cells for JavaScript عبر C++. 
---
