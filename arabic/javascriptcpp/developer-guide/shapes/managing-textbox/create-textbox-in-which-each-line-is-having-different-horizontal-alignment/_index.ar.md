---
title: إنشاء مربع نص يحتوي كل سطر على محاذاة أفقية مختلفة باستخدام جافا سكريبت عبر C++
linktitle: إنشاء مربع نص يحتوي كل سطر على محاذاة أفقية مختلفة
type: docs
weight: 310
url: /ar/javascript-cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: تعلم كيفية إنشاء مربع نص يمكن أن يكون لكل سطر محاذاة أفقية مختلفة باستخدام Aspose.Cells for JavaScript عبر C++.
---

{{% alert color="primary" %}}
يمكنك تحديد محاذاة النص الأفقية لنص فقرتك باستخدام خاصية [**TextParagraph.alignmentType**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#alignmentType--).
{{% /alert %}}
