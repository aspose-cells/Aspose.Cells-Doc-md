---
title: إضافة علامة مائية WordArt إلى ورقة العمل باستخدام جافا سكريبت عبر C++
linktitle: إدارة كلمة اللهن
type: docs
weight: 180
url: /ar/javascript-cpp/add-wordart-watermark-to-worksheet/
description: تعلم كيف تضيف WordArt كعلامة مائية خلفية إلى ورقة العمل باستخدام Aspose.Cells for JavaScript عبر C++.
---
...
## **مواضيع متقدمة**
- [إضافة نص Word Art بأنماط مدمجة](/cells/ar/javascript-cpp/add-word-art-text-with-built-in-styles/)
- [تأمين علامة مائية WordArt](/cells/ar/javascript-cpp/locking-wordart-watermark/)
- [تعيين نمط WordArt المحدد مسبقًا لنص الشكل](/cells/ar/javascript-cpp/set-preset-wordart-style-to-the-text-of-the-shape/)
