---
title: إضافة نص فن الكلمة مع الأنماط المدمجة باستخدام جافا سكريبت عبر C++
linktitle: إضافة نص فني بأنماط مضمنة
type: docs
weight: 270
url: /ar/javascript-cpp/add-word-art-text-with-built-in-styles/
description: تعلم إضافة نص فن الكلمة مع الأنماط المدمجة باستخدام Aspose.Cells for JavaScript عبر C++. أنشئ نصًا جذابًا من الناحية البصرية في إكسل باستخدام الأنماط المدمجة.
---

## **سيناريوهات الاستخدام المحتملة**
يمكنك إضافة نص فن الكلمة مع الأنماط المدمجة باستخدام Aspose.Cells for JavaScript عبر C++. يرجى استخدام [ShapeCollection.addWordArt()](https://reference.aspose.com/cells/javascript-cpp/shapecollection/#addWordArt-presetwordartstyle-string-number-number-number-number-number-number-) لهذا الغرض.
