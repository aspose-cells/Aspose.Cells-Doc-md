---
title: نسيج الصورة كشكل في داخل الشكل باستخدام جافا سكريبت عبر C++
linktitle: صورة البلاط كقشرة داخل الشكل
type: docs
weight: 1700
url: /ar/javascript-cpp/tile-picture-as-a-texture-inside-the-shape/
description: تعلم كيفية تنسيق صورة صغيرة كنقش داخل شكل باستخدام Aspose.Cells for JavaScript عبر C++.
---
...
يمكنك ملء سطح الشكل بصورة محددة وتجانسها باستخدام خاصية [**Shape.isTiling()**](https://reference.aspose.com/cells/javascript-cpp/texturefill/#isTiling--) وتعيينها إلى **true**. يرجى مراجعة الكود النموذجي التالي، وملف Excel النموذجي ([ملف Excel](46465050.xlsx))، والصورة المصغرة كمثال.  
