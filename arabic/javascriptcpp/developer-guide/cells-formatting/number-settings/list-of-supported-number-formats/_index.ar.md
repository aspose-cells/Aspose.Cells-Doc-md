...
linktitle: قائمة صيغ الأرقام المدعومة
description: Aspose.Cells هي مكتبة جافا سكريبت لمعالجة ملفات جداول البيانات، التي تدعم مجموعة من تنسيقات الأرقام. تقدم هذه المقالة قائمة بتنسيقات الأرقام المدعومة حتى يتمكن المستخدمون من اختيار التنسيق المناسب وفقًا لاحتياجاتهم.
keywords: مكتبة Aspose.Cells، جافا سكريبت، جدول بيانات، تنسيق الرقم، قائمة، مدعوم
type: docs
weight: 30
url: /ar/javascript-cpp/list-of-supported-number-formats/
---

## **Aspose.Cells**
يقدم مكون Aspose.Cells بعض تنسيقات الأرقام المدمجة لتكوين طرق عرض الأرقام والتواريخ. يمكن تطبيق هذه التنسيقات المدمجة باستخدام خاصية **Number** لكائن **Style**. تُعطى جميع تنسيقات الأرقام المدمجة قيم رقمية فريدة. يمكن للمطورين تعيين أي قيمة رقمية يرغبون بها إلى خاصية **Number** لكائن **Style** وبذلك يتم تطبيق تنسيق العرض. هذه الطريقة أسرع. تتضمن تنسيقات الأرقام المدمجة التي يدعمها مكون Aspose.Cells ما يلي:
...
في بعض تنسيقات الأرقام، قد تلاحظ بعض الأحرف مثل 月. هذه في الواقع حروف صينية ويمكن استخدامها في إصدارات MS Excel الصينية واليابانية.
