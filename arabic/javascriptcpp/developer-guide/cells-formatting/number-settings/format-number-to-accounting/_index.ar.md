...
type: docs
weight: 10
url: /ar/javascript-cpp/how-to-format-number-to-accounting/
description: سيقدم هذا المقال كيفية تنسيق الرقم إلى محاسبة باستخدام Script عبر C++.
...
## **كيفية تنسيق الرقم إلى محاسبة في Script عبر C++**
لتنسيق الأرقام إلى تنسيق محاسبة في Script عبر C++، يمكنك استخدام كائن `Style` المرتبط بخلية أو مجموعة خلايا. يتيح لك كائن `Style` ضبط خيارات تنسيق مختلفة، بما في ذلك تنسيقات الأرقام. عادةً، يتضمن تنسيق المحاسبة رمز تنسيق يمكن أن يختلف وفقًا للمتطلبات المحددة (مثل ما إذا كنت تريد عرض رموز العملة، الفواصل العشرية، وما إلى ذلك).

إليك مثالًا أساسيًا على كيفية تطبيق تنسيق رقم محاسبي على خلية في Script عبر C++:

1. **مرجع Aspose.Cells**: تأكد من أن لديك Script عبر C++ مرجعي في مشروعك. يمكنك الحصول عليه من موقع Aspose الإلكتروني.
...
يعرض هذا المثال كيفية تنسيق خلية واحدة لعرض الأرقام بتنسيق محاسبة بالدولار الأمريكي. يمكن تعديل سلسلة التنسيق لتتناسب مع رموز عملة أو تنسيقات محاسبة مختلفة حسب الحاجة. الجزء الرئيسي هو طريقة `style.custom`، حيث تحدد رمز تنسيق الرقم المخصص للمحاسبة.
