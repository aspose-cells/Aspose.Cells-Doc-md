---
title: الكشف عن الخلايا المدموجة في ورقة عمل باستخدام جافا سكريبت عبر C++
linktitle: الكشف عن الخلايا المدمجة في ورقة البيانات
description: تعلم كيفية اكتشاف الخلايا المدموجة في ورقة العمل باستخدام Aspose.Cells for JavaScript عبر C++. ستوضح لك هذه المقالة كيفية استخدام المكتبة لتحديد والتعامل مع الخلايا المدموجة.
keywords: Aspose.Cells، ورقة العمل، دمج الخلايا، الكشف، التحديد، التشغيل جافا سكريبت عبر C++
type: docs
weight: 80
url: /ar/javascript-cpp/detect-merged-cells-in-a-worksheet/
---
...
يتيح لك Script عبر C++ الحصول على مساحات الخلايا المندمجة في ورقة العمل. يمكنك إلغاء الدمج (تفكيكها) أيضًا. يوضح هذا المقال أبسط رمز باستخدام **API Aspose.Cells** لتنفيذ المهمة.

{{% /alert %}}

يوفر المكون طريقة [**Cells.mergedAreas**](https://reference.aspose.com/cells/javascript-cpp/cells/#mergedAreas--) التي يمكنها الحصول على جميع الخلايا المدمجة. يظهر لك نموذج الشفرة التالي كيفية اكتشاف الخلايا المدمجة في ورقة العمل.
