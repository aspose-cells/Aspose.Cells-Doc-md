---
title: تحويل الرسم إلى صورة للمنطقة اليابانية باستخدام JavaScript عبر C++
description: تعلم كيفية استخدام Aspose.Cells for JavaScript عبر C++ لضبط تكوينات اليابانية للرسوم البيانية. سيُوضح دليلنا كيفية تكوين الرسوم البيانية لدعم الأحرف والتنسيقات اليابانية، بما في ذلك الخطوط، الحجم، اتجاه النص، وأكثر.  
keywords: Aspose.Cells for JavaScript عبر C++، الرسوم البيانية، التكوين الياباني، الخط، حجم الخط، اتجاه النص، الدعم.  
linktitle: تعيين منطقة يابانية  
type: docs  
weight: 10  
url: /ar/javascript-cpp/convert-chart-to-image-for-japanese-region/  
...
الخطوة الأولى، تحتاج إلى تعريف فئة "ChartJapaneseSettings" الوريثة من [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
