---
title: تحويل الرسم إلى صورة للمنطقة الصينية باستخدام JavaScript عبر C++
description: تعلم كيفية استخدام Aspose.Cells for JavaScript عبر C++ لتكوين الرسوم البيانية للحروف الصينية والتنسيقات، بما في ذلك الخطوط، الأحجام، اتجاه النص، وأكثر.
keywords: Aspose.Cells for JavaScript عبر C++، الرسوم البيانية، تكوين الصينية، الخطوط، حجم الخط، اتجاه النص، الدعم.
linktitle: تحديد المنطقة الصينية
type: docs
weight: 9
url: /ar/javascript-cpp/convert-chart-to-image-for-chinese-region/
...
الخطوة الأولى، تحتاج إلى تعريف فئة "ChartChineseSetttings" الوريثة من [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
