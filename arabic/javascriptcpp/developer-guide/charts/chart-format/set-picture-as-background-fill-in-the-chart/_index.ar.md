---
title: تعيين الصورة كخلفية التعبئة في الرسم البياني باستخدام JavaScript عبر C++
linktitle: تعيين الصورة كخلفية ملء في الرسم البياني
description: تعلم كيفية تعيين صورة كخلفية تعبئة في رسم بياني باستخدام Aspose.Cells for Javaسكريبت عبر C++. سيعرض دليلك كيفية استيراد الصورة وتحديد موضعها، وضبط حجمها ولونها، وتطبيق خيارات التنسيق لتعزيز مظهر الرسم البياني الخاص بك.
keywords: Aspose.Cells for Javaسكريبت عبر C++، رسومات، تعبئة خلفية، صورة، استيراد، تحديد موضع، حجم، لون، تنسيق.
type: docs
weight: 30
url: /ar/javascript-cpp/set-picture-as-background-fill-in-the-chart/
---
...
لتحقيق ذلك، يوفر Aspose.Cells خاصية [**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--). يوضح الكود النموذجي التالي استخدام الخاصية [**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--) لتعيين صورة كتعبئة خلفية في الرسم البياني.

## كود جافا سكريبت لتعيين الصورة كخلفية تعبئة في الرسم البياني
