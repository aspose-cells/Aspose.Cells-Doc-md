---
title: كيفية إنشاء مخطط مركب باستخدام JavaScript عبر C++
linktitle: كيفية إنشاء رسم بياني مختلط
description: تعلم كيفية إنشاء مخطط مركب باستخدام Aspose.Cells for Javaسكريبت عبر C++. يُظهر دليلنا الشامل كيفية دمج أنواع مخططات مختلفة في مخطط مركب واحد لعرض بيانات أكثر فاعلية.
keywords: Aspose.Cells for Javaسكريبت عبر C++، مخطط مركب، دمج أنواع المخططات، عرض البيانات، تصوّر فعال.
type: docs
weight: 73
url: /ar/javascript-cpp/create-combo-chart/
---
...
من خلال اعتبار مجموعة البيانات التالية كمثال، يمكننا ملاحظة أن هذه البيانات مشابهة تمامًا للبيانات المذكورة في [**VHCL**](https://docs.aspose.com/cells/javascript-cpp/create-volume-high-low-close-stock-chart/). إذا كنا نريد تصوير series0، والتي تتوافق مع "إجمالي الإيرادات"، كرسم بياني خطي، فكيف يجب أن نقدم؟
