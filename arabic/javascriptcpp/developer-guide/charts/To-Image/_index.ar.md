---
title: تحويل المخطط إلى صورة باستخدام JavaScript عبر C++
description: تعلم كيفية استخدام Aspose.Cells for JavaScript عبر C++ لتحويل مخطط إلى تنسيق صورة مثل JPEG أو PNG. يوضح دليلنا كيفية تصدير مخطط من Microsoft Excel وحفظه كصورة مستقلة للاستخدام والمعالجة لاحقًا.
keywords: Aspose.Cells for JavaScript عبر C++، تحويل المخطط إلى صورة، Microsoft Excel، تحويل الصور، التصدير، صورة مستقلة.
linktitle: تحويل الرسم البياني إلى صورة
type: docs
weight: 46
url: /ar/javascript-cpp/chart-to-image/
---

## **عرض الرسوم البيانية**

 تدعم واجهات برمجة التطبيقات Aspose.Cells تحويل مخططات Excel إلى تنسيقات الصور دون الحاجة إلى أدوات أو تطبيقات إضافية. لضمان دعم التصيير، تكشف فئة [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) عن طرق [**toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) مع مجموعة من التحميلات المفرطة التي تلبي متطلبات التطبيق.

### **عرض الرسوم البيانية كصور**

 طريقة [**Chart.toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) لديها مجموعة متنوعة من التحميلات لدعم التصيير البسيط والمتقدم. إذا كان متطلب التطبيق هو تصيير المخطط بأبعاده الافتراضية، نوصي باستخدام طريقة [**Chart.toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) كما يلي.
...
من الممكن أيضًا تصيير المخططات إلى صور مع إعدادات متقدمة. تكشف APIات Aspose.Cells عن نسخة تحميل مفرطة من طريقة [**Chart.toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) التي تقبل كائن [**ImageOrPrintOptions**](https://reference.aspose.com/cells/javascript-cpp/imageorprintoptions)، مع السماح بتحديد معلمات مثل الدقة، وضع التنعيم، صيغة الصورة، وغيرها.
...
## **مواضيع متقدمة**  
- [تحويل الرسم البياني إلى PDF](/cells/ar/javascript-cpp/chart-to-pdf/)
