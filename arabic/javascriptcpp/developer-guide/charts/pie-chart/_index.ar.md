---
title: إنشاء مخطط دائري بخطوط قياد باستخدام جافا سكريبت عبر C++
description: تعلم كيفية استخدام Aspose.Cells for JavaScript عبر C++ لإنشاء مخطط دائري بخطوط قياد في إكسل. سيُظهر دليلنا كيفية إضافة خطوط قياد تربط نقاط البيانات بالأسطورة وتعزز وضوح المخطط بشكل عام.
keywords: Aspose.Cells for JavaScript عبر C++، مخطط دائري، خطوط قياد، إكسل، تصور البيانات، تخصيص المخطط.
linktitle: رسم بياني دائري
type: docs
weight: 45
url: /ar/javascript-cpp/creating-pie-chart-with-leader-lines/
---

{{% alert color="primary" %}}

تشرح هذه المقالة كيفية إنشاء مخطط دائري بخطوط قياد من البداية باستخدام واجهة برمجة تطبيقات Aspose.Cells for JavaScript عبر C++. في إكسل، يتم تعيين خيار 'عرض خطوط القيادة' بشكل افتراضي، لذا عند إنشاء مخطط دائري في إكسل، تظهر خطوط القيادة. ومع ذلك، عند إنشاء مخطط مماثل باستخدام واجهات برمجة التطبيقات Aspose.Cells، يجب عليك تحديد الخاصية [**Series.hasLeaderLines**](https://reference.aspose.com/cells/javascript-cpp/series/#hasLeaderLines--) صراحةً.

{{% /alert %}}

للتوضيح كيفية استخدام Aspose.Cells for JavaScript عبر واجهة برمجة التطبيقات C++ لإنشاء مخطط دائري مع خطوط الرصاص، سنقوم أولاً بإنشاء [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) وإدخال بعض البيانات التي ستعمل كمصدر سلسلة البيانات. بمجرد وضع البيانات، سنضيف [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) من نوع [**ChartType.Pie**](https://reference.aspose.com/cells/javascript-cpp/charttype) إلى مجموعة المخططات ونعيّن جوانبها المختلفة للحصول على العرض المطلوب للمخطط.
...
## **مواضيع متقدمة**
- [لون قطاع مخصص أو ألوان في الرسم البياني الدائري](/cells/ar/javascript-cpp/custom-slice-or-sector-colors-in-pie-chart/)
- [العثور على ما إذا كانت نقاط البيانات في الفقاعة الثانية أو العمود على مخطط 'بي of بي' أو 'عمود من بي'](/cells/ar/javascript-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)

## مقالات ذات صلة

- [إنشاء الرسوم البيانية](/cells/ar/javascript-cpp/creating-charts/)
- [تخصيص المخططات](/cells/ar/javascript-cpp/customizing-charts/)
- [تنسيق البيانات في الرسوم البيانية](/cells/ar/javascript-cpp/data-formatting-in-charts/)
