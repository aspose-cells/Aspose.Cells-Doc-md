---
title: تعيين روابط خارجية في الصيغ باستخدام جافا سكريبت عبر C++
linktitle: تحديد الروابط الخارجية في الصيغ
type: docs
weight: 20
url: /ar/javascript-cpp/set-external-links-in-formulas/
description: تعلم كيفية تعيين روابط خارجية في الصيغ باستخدام Aspose.Cells for JavaScript عبر C++. 
keywords: تعيين روابط خارجية في الصيغ جافا سكريبت عبر C++، تضمين ملفات خارجية في الصيغ جافا سكريبت عبر C++ 
---
