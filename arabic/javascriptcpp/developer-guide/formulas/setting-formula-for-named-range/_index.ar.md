---
title: تعيين الصيغة لنطاق مسمى باستخدام JavaScript عبر C++
linktitle: وضع صيغة لنطاق مسمى
type: docs
weight: 20
url: /ar/javascript-cpp/setting-formula-for-named-range/
description: تعلم كيفية تعيين الصيغ للنطاقات المسماة في جداول البيانات باستخدام Script Aspose.Cells for Java عبر C++.
---

## **وضع صيغة لنطاق مسمى**
مثل تطبيق Excel، توفر API الخاصة بـ Aspose.Cells القدرة على تحديد صيغة لنطاق مسمى أثناء استخدام خاصية [Range.refersTo](https://reference.aspose.com/cells/javascript-cpp/range/#refersTo--). قد توجد العديد من سيناريوهات الاستخدام لهذه الميزة، وإليك بعضها مفصلًا.
