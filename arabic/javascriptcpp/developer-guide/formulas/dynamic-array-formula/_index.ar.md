---
title: إعداد صيغ المصفوفة الديناميكية باستخدام جافا سكريبت عبر C++
linktitle: ضبط صيغ الصفائف الديناميكية
description: كيفية استخدام مكتبة Aspose.Cells لحساب صيغ المصفوفة الديناميكية في Excel باستخدام جافا سكريبت عبر C++. تحميل، حساب، وحفظ ملفات Excel بسهولة.
keywords: صيغ المصفوفة الديناميكية، صيغ المصفوفة الديناميكية في Excel، إعداد صيغ المصفوفة الديناميكية باستخدام جافا سكريبت عبر C++، حساب صيغ المصفوفة الديناميكية باستخدام جافا سكريبت عبر C++، تشغيل صيغ المصفوفة الديناميكية في Excel.
type: docs
weight: 70
url: /ar/javascript-cpp/calculation-of-dynamic-array-formulas/
---
...
يرجى الاطلاع على الكود النموذجي أدناه الذي يحمل [ملف Excel النموذجي](dynamicArrayFormula.xlsx) الذي يحتوي على بعض البيانات الوهمية. بعد تحميل الملف، استدعِ وظيفة [Cell.dynamicArrayFormula(string, FormulaParseOptions, boolean)](https://reference.aspose.com/cells/javascript-cpp/cell/#dynamicArrayFormula-string-formulaparseoptions-boolean-) لضبط صيغة المصفوفة الديناميكية واستدعِ وظيفة [Workbook.refreshDynamicArrayFormulas(boolean)](https://reference.aspose.com/cells/javascript-cpp/workbook/#refreshDynamicArrayFormulas-boolean-) لتحديث صيغ المصفوفة الديناميكية قبل استدعاء حساب الصيغة، وأخيراً، قم بحفظ المصنف كملف إكسل النتيجة [ملف الإخراج](out.xlsx).  
