---
title: طرق مختلفة لفتح الملفات باستخدام JavaScript عبر C++
linktitle: طرق مختلفة لفتح الملفات
type: docs
weight: 10
url: /ar/javascript-cpp/different-ways-to-open-files/
description: يشرح هذا المقال كيفية فتح ملف إكسل باستخدام Aspose.Cells for JavaScript عبر واجهة برمجة التطبيقات C++.
keywords: فتح ملف إكسل باستخدام JavaScript بدون إكسل، كيف أفتح ملف إكسل باستخدام JavaScript.
---
...
يمكن للمطورين فتح ملف Microsoft Excel باستخدام مسار الملف على الكمبيوتر المحلي عن طريق تحديده في منشئ فئة [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook). ببساطة قم بتمرير المسار كسلسلة نصية. ستقوم Aspose.Cells تلقائيًا باكتشاف نوع تنسيق الملف.
...
لفتح ملف يحتوي فقط على البيانات، استخدم فئتي [**LoadOptions**](https://reference.aspose.com/cells/javascript-cpp/loadoptions) و [**LoadFilter**](https://reference.aspose.com/cells/javascript-cpp/loadfilter) لضبط السمات والخيارات ذات الصلة بالفئة لملف القالب الذي سيتم تحميله.
...
أثناء تحميل [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook)، أحيانًا قد تحتاج فقط إلى البيانات في أوراق العمل المرئية في المصنف. يسمح لك Aspose.Cells بتخطي البيانات في أوراق العمل غير المرئية أثناء تحميل المصنف. للقيام بذلك، أنشئ دالة مخصصة ترث من فئة [**LoadFilter**](https://reference.aspose.com/cells/javascript-cpp/loadfilter) ومرر كائنها إلى خاصية [**LoadOptions.loadFilter**](https://reference.aspose.com/cells/javascript-cpp/loadoptions/#loadFilter--).
...
هناك احتمالات عادلة أن يُلقى منشئ [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) خطأ *OutOfMemoryError* أثناء تحميل جداول بيانات كبيرة. تشير هذه الاستثناء إلى أن الذاكرة المتاحة غير كافية لتحميل الجدول بالكامل في الذاكرة؛ لذلك، يجب تحميل الجدول مع تمكين تفضيلات الذاكرة.
