---
title: تحميل أوراق عمل محددة في دفتر العمل باستخدام JavaScript عبر C++
linktitle: تحميل الأوراق العمل المحددة في كتيب عمل
type: docs
weight: 100
url: /ar/javascript-cpp/load-specific-worksheets-in-a-workbook/
description: تعلّم كيفية تحميل أوراق عمل محددة في دفتر العمل باستخدام Aspose.Cells for JavaScript عبر C++. تحسين الأداء وتقليل استهلاك الذاكرة.
---
