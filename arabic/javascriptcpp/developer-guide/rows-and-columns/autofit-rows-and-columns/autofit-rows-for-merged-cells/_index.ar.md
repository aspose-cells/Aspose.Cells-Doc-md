---
title: التلقائي لضبط صفوف الخلايا المدمجة باستخدام جافا سكريبت عبر C++
linktitle: إعداد الصفوف تلقائياً للخلايا المدمجة
type: docs
weight: 120
url: /ar/javascript-cpp/autofit-rows-for-merged-cells/
description: تعلم كيفية التلقائي لضبط الصفوف للخلايا المدمجة باستخدام Aspose.Cells for JavaScript عبر C++. تنفيذ وظيفة التلقائي لضبط الصفوف للخلايا المدمجة في جداول البيانات.
---
...
يدعم Aspose.Cells for JavaScript عبر C++ هذه الميزة من خلال واجهة برمجة التطبيقات [**AutoFitterOptions.autoFitMergedCellsType**](https://reference.aspose.com/cells/javascript-cpp/autofitmergedcellstype/). باستخدام هذه الواجهة، من الممكن ضبط تلقائي لصفوف ورقة العمل بما في ذلك الخلايا المدمجة. إليك قائمة بجميع أنواع التلقائية المحتملة لضبط خلايا مدمجة:
