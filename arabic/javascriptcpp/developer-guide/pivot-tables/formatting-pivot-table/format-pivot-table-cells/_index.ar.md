...
type: docs
weight: 30
url: /ar/javascript-cpp/format-pivot-table-cells/
description: كيفية تنسيق خلايا الجدول المحوري باستخدام Aspose.Cells for JavaScript عبر C++.
keywords: تنسيق خلايا جدول الدوران
---

{{% alert color="primary" %}}

أحيانًا، ترغب في تنسيق خلايا الجدول المحوري. على سبيل المثال، تريد تطبيق لون خلفية على خلايا الجدول المحوري. يوفر Aspose.Cells for JavaScript عبر C++ طريقتين [**PivotTable.formatAll(style)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#formatAll-style-) و [**PivotTable.format(row, column, style)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#format-number-number-style-)، يمكن استخدامهما لهذا الغرض.

[**PivotTable.formatAll(style)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#formatAll-style-) تطبق النمط على جدول المحور بأكمله بينما [**PivotTable.format(row, column, style)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#format-number-number-style-) يطبق النمط على خلية واحدة في جدول المحور.
...
- [تنسيق جدول الجدول المحوري](/cells/ar/javascript-cpp/formatting-pivot-table/)
- [العمل مع تنسيقات عرض البيانات لحقل البيانات في الجدول المحوري](/cells/ar/javascript-cpp/working-with-data-display-formats-of-datafield-in-pivot-table/)
