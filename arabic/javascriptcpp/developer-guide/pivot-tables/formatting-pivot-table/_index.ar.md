...
type: docs
weight: 10
url: /ar/javascript-cpp/formatting-pivot-table/
description: كيفية تنسيق الجدول المحوري باستخدام Aspose.Cells for JavaScript عبر C++.
...
تتحكم فئة [**PivotTable**](https://reference.aspose.com/cells/javascript-cpp/pivottable/) في الجدول الدوري الكلي ويمكن تهيئتها بعدة طرق.

#### **كيفية تعيين نوع التنسيق التلقائي**

يقدم Microsoft Excel عددًا من تنسيقات التقارير المسبقة. يدعم Aspose.Cells for JavaScript عبر C++ هذه الخيارات التنسيقية أيضًا. للوصول إليها:

1. قم بتعيين [**PivotTable.isAutoFormat(value)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#isAutoFormat-boolean-) إلى **صحيح**.
1. قم بتعيين خيار التنسيق من تعداد [**PivotTableAutoFormatType**](https://reference.aspose.com/cells/javascript-cpp/pivottableautoformattype/) .
...
لتنسيق كيفية ظهور تقرير الجدول المحوري يدويًا، بدلاً من استخدام تنسيقات التقرير المُعدة مسبقًا، استخدم الأساليب [**PivotTable.formatAll(style)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#formatAll-style-) و [**PivotTable.format(row, column, style)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#format-number-number-style-). أنشئ كائن نمط للتنسيق المطلوب، على سبيل المثال:
...
تمثل فئة [**PivotField**](https://reference.aspose.com/cells/javascript-cpp/pivotfield/) حقلًا في جدول دور ، ويمكن تهيئته بعدة طرق. تُظهر العينة البرمجية أدناه كيفية:
...
تحتوي فئة [**PivotFieldCollection**](https://reference.aspose.com/cells/javascript-cpp/pivotfieldcollection/) على طريقة تسمى [**clear()**](https://reference.aspose.com/cells/javascript-cpp/pivotfieldcollection/#clear--) تتيح لك مسح حقول الجدول الدوري. استخدمها عندما ترغب في مسح جميع حقول الجدول الدوري في المناطق، على سبيل المثال، الصفحة، العمود، الصف أو البيانات.
