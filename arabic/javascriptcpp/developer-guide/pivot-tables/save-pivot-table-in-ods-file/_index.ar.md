...
type: docs
weight: 150
url: /ar/javascript-cpp/save-pivot-table-in-ods-file/
---

يوفر Aspose.Cells for JavaScript عبر C++ القدرة على حفظ جدول المحوري في ملفات ODS. لهذا، يمكنك ببساطة تحويل مصنف يحتوي على جدول محوري موجود أو إنشاء جدول محوري جديد وحفظ الملف بصيغة ODS. تأكد من استدعاء [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) قبل الحفظ لضمان عرض جدول المحوري في ملف ODS الناتج. يوضح الرمز التالي حفظ جدول محوري في ملف ODS.
