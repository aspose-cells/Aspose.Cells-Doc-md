---
title: تخصيص إعدادات التعريب للجدول المحوري باستخدام جافا سكريبت عبر C++
linktitle: تخصيص إعدادات العالمية لجدول محوري
type: docs
weight: 50
url: /ar/javascript-cpp/customize-globalization-settings-for-pivot-table/
---
...
الشيفرة التالية تشرح كيفية تخصيص إعدادات التدويل للجدول المحوري. تُنشئ فئة *CustomPivotTableGlobalizationSettings* المشتقة من فئة الأساس [**PivotGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/pivotglobalizationsettings/) وتُعيد تعريف جميع طرقها الضرورية. هذه الطرق تُرجع النص المُخصص لـ *إجمالي المحور، فرعي، الإجمالي الكلي، جميع العناصر، عناصر متعددة، تسميات الأعمدة، تسميات الصفوف، القيم الفارغة*. ثم تُعيّن كائن هذه الفئة إلى الخاصية [**WorkbookSettings.pivotSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings/#pivotSettings--). الشيفرة تقوم بتحميل ملف إكسل المصدر ([40468488.xlsx]) الذي يحتوي على الجدول المحوري، تحديثه وحسابه، وحفظه كملف [PDF الناتج](40468487.pdf). تُظهر الصورة التالية تأثير الشيفرة على ملف PDF الناتج. كما ترى في الصورة، الأجزاء المختلفة من الجدول المحوري أصبحت تحتوي على نص مخصص يُرجعه الطرق المُعرفة في فئة [**PivotGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/pivotglobalizationsettings/)،
