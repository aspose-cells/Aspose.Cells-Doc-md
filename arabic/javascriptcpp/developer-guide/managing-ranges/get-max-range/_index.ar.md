---
title: الحصول على النطاق الأقصى في ورقة عمل باستخدام JavaScript عبر C++
linktitle: الحصول على أقصى مجال في ورقة العمل
type: docs
weight: 360
url: /ar/javascript-cpp/get-max-range-in-a-worksheet/
description: تصف هذه المقالة كيفية الحصول على النطاق الأقصى، والنطاق الأقصى للبيانات، والنطاق الأقصى للعرض لملفات Excel باستخدام Aspose.Cells for JavaScript عبر C++.
---
...
يحتوي Aspose.Cells for JavaScript عبر C++ على طرق مختلفة للعثور على النطاق الأقصى في ورقة عمل.

{{% /alert %}}

## **الحصول على أقصى مجال**
في Aspose.Cells، إذا تم تهيئة كائنات [**row**](https://reference.aspose.com/cells/javascript-cpp/row/) و [**column**](https://reference.aspose.com/cells/javascript-cpp/column/)، فسيتم حساب هذه الصفوف والأعمدة ضمن الحد الأقصى للمنطقة، حتى لو لم تكن هناك بيانات في الصفوف أو الأعمدة الفارغة.
