---
title: إدراج النطاقات باستخدام JavaScript عبر C++
linktitle: إدراج المجالات
type: docs
weight: 105
url: /ar/javascript-cpp/insert-ranges-to-excel/
description: تعلم كيفية إدراج النطاقات في Excel وتحويل البيانات الأخرى باستخدام Aspose.Cells for JavaScript عبر C++.
---
...
## **إدراج النطاقات باستخدام Aspose.Cells for JavaScript عبر C++**

يوفر Aspose.Cells for JavaScript عبر C++ طريقة [Cells.insertRange(CellArea, number, ShiftType, boolean)] لإدراج نطاق.
