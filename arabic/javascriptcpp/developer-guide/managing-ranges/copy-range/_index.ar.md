---
title: نسخ نطاقات Excel باستخدام JavaScript عبر C++
linktitle: نسخ النطاقات
type: docs
weight: 105
url: /ar/javascript-cpp/copy-ranges-of-Excel/
---
...
## **نسخ النطاقات باستخدام Script Aspose.Cells for Java عبر C++**

يوفر Script Aspose.Cells for Java عبر C++ بعض الطرق [Range.copy(Range, PasteOptions)](https://reference.aspose.com/cells/javascript-cpp/range/#copy-range-pasteoptions-) لنسخ النطاق. و[Range.copyStyle(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyStyle-range-) ينسخ فقط نمط النسخة؛ [Range.copyData(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyData-range-) ينسخ فقط قيمة النطاق.
...
ي دعم النسخ من خلال C++ لنطاق معين بأنواع محددة.
...
## **مواضيع متقدمة**
- [نسخ أطوال الصفوف من النطاق المصدر إلى النطاق الهدف](/cells/ar/javascript-cpp/copy-row-heights-of-source-range-to-destination-range/)
