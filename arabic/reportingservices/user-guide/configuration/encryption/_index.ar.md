...
---
 يدعم Aspose.Cells لخدمات التقارير ثلاثة أنواع من التشفير: XOR و WEAK ENCRYPTION و Microsoft مزود تشفير قوي. راجع معلومات تكوين التشفير في ملف**Aspose.Cells.ReportingServices.xml** ملف.

 عندما تكون قيمة التشفير**إيقاف**، Aspose.Cells لخدمات التقارير يقوم بإيقاف تشغيل ميزات التشفير.
...
{{< /highlight >}}
 ...
 عندما تكون قيمة التشفير**على**، Aspose.Cells لـ Reporting Services يقوم بتشغيل التشفير.
