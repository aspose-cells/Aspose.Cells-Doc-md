---
title: Aspose.Cells لـ Node.js عبر Java 21.9 ملاحظات الإصدار
type: docs
weight: 4
...
{{% alert color="primary" %}}
 ...
 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells لـ Node.js عبر Java 21.9](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.9/).
