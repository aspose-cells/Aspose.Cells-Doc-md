---
title: Aspose.Cells for Node.js via Java 21.10 ملاحظات الإصدار
type: docs
weight: 3
url: /ar/nodejs-java/aspose-cells-for-node-js-via-java-21-10-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Node.js via Java 21.10](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.10/).
