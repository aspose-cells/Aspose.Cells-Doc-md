---
title: Aspose.Cells for Node.js via Java 22.10 ملاحظات الإصدار
type: docs
weight: 3
url: /ar/nodejs-java/aspose-cells-for-node-js-via-java-22-10-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Node.js via Java 22.10](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.10/).
