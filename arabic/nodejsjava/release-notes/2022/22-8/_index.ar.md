---
title: Aspose.Cells for Node.js via Java 22.8 ملاحظات الإصدار
type: docs
weight: 5
url: /ar/nodejs-java/aspose-cells-for-node-js-via-java-22-8-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Node.js via Java 22.8](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.8/).
