---
title: كيفية تنسيق الرقم إلى نسبة مئوية مع Golang عبر C++
linktitle: كيفية تنسيق الرقم إلى النسبة المئوية
type: docs
weight: 10
url: /ar/go-cpp/how-to-format-number-to-percentage/
description: سيعرض هذا المقال كيفية تنسيق الرقم إلى نسبة مئوية باستخدام واجهة برمجة تطبيقات Aspose.Cells for C++.
...
## **كيفية تنسيق رقم إلى نسبة مئوية في Aspose.Cells for C++**
تعد عملية تنسيق الأرقام إلى نسب مئوية في Aspose.Cells for C++ عملية مباشرة. توفر Aspose.Cells مكتبة قوية تتيح لك إنشاء، ومعالجة، وتحويل ملفات إكسل في تطبيقات C++ بدون الحاجة إلى تثبيت Microsoft Excel على نظامك. إليك كيفية تنسيق الأرقام إلى نسب مئوية باستخدام Aspose.Cells for C++:

### الخطوة 1: تثبيت Aspose.Cells for C++

أولاً، تأكد من تثبيت Aspose.Cells for C++ في مشروعك. إذا لم تقم بتثبيته بعد، يمكنك الحصول عليه عبر NuGet. قم بتنفيذ الأمر التالي في وحدة تحكم مدير حزم NuGet:
...
باتباع هذه الخطوات، يمكنك بسهولة تنسيق الأرقام إلى نسب مئوية في Aspose.Cells for C++. تقدم Aspose.Cells مجموعة واسعة من الميزات للتعامل مع ملفات Excel، بما في ذلك تنسيق الخلايا والعمل مع الصيغ والكثير من الميزات، مما يجعله أداة قوية لمطوري C++ الذين يتعاملون مع بيانات Excel.
