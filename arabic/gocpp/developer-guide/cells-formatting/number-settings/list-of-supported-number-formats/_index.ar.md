---
title: قائمة تنسيقات الأرقام المدعومة مع Golang عبر C++
description: Aspose.Cells عبارة عن مكتبة C++ لمعالجة ملفات جداول البيانات، وتدعم مجموعة من تنسيقات الأرقام. توفر هذه المقالة قائمة بالتنسيقات المدعومة لتساعد المستخدمين على اختيار التنسيق الملائم وفقًا لاحتياجاتهم.
keywords: Aspose.Cells، مكتبة C++، جداول بيانات، تنسيق رقم، قائمة، مدعوم
type: docs
weight: 30
url: /ar/go-cpp/list-of-supported-number-formats/
---
