---
title: تغيير خصائص البثق باستخدام Golang عبر C++
linktitle: تغيير خصائص المنقي
type: docs
weight: 70
url: /ar/go-cpp/change-slicer-properties/
description: غير خصائص البثق في ملفات Excel باستخدام Aspose.Cells مع Golang عبر C++.
---
