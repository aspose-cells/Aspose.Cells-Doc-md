---
title: التعرف على علامات الإغلاق الذاتي باستخدام جولانغ عبر C++
linktitle: التعرف على العلامات الفارغة الذاتيًا
type: docs
weight: 120
url: /ar/go-cpp/recognise-self-closing-tags/
description: تعلم كيفية التعامل مع علامات الإغلاق الذاتي في HTML باستخدام Aspose.Cells مع جولانغ عبر C++.
---
