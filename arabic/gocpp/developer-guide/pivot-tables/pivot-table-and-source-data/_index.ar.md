---
title: الجدول المحوري وبيانات المصدر باستخدام Golang عبر C++
linktitle: جدول محوري وبيانات المصدر
type: docs
weight: 30
url: /ar/go-cpp/pivot-table-and-source-data/
description: تعلم كيفية تغيير مصدر بيانات جدول محوري ديناميكيًا باستخدام Aspose.Cells مع Golang عبر C++.
---
