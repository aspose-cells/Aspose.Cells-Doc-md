...
إرجاع الوقت بالمنطقة الزمنية المحلية.
...
يشير إلى ما إذا كان يتم تصدير علامة التبويب المفردة عندما يكون الملف يحتوي على ورقة عمل واحدة فقط. القيمة الافتراضية هي كاذبة.
...
استخدم Workbook.CreateStyle () لإنشاء نمط المصنف ومعالجته بدلاً من StyleCollection.Add () ؛
استخدم Workbook.GetNamedStyle (سلسلة) للحصول على نمط مسمى بدلاً من StyleCollection
...
خيار تجاهل مشاريع VBA أثناء تحميل ملف القالب.
...
استخدم Cells. أوجد طريقة (كائن ، Cell ، FindOptions) بدلاً من ذلك. للحصول على نفس النتيجة باستخدام الطرق FindNumber و FindString ، يرجى تعيين FindOptions.ValueTypeSensitive على أنه صحيح.
