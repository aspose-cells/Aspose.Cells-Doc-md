...
|CELLSANDROID-88|فقدت الصورة أثناء تحويل المصنف PDF|خلل برمجي|
|CELLSJAVA-42852|لا يتم عرض التسمية الموجودة على كلا المحورين|خلل برمجي|
|CELLSJAVA-42856|Excel مشكلة HTML|خلل برمجي|
...
|CELLSJAVA-42874|فقدان العمود عند تصدير ملف إلى HTML|خلل برمجي|
