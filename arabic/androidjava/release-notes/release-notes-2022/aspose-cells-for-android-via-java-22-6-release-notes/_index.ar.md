---
title: Aspose.Cells لنظام Android عبر Java 22.6 ملاحظات الإصدار
type: docs
weight: 7
url: /ar/java/aspose-cells-for-android-via-java-22-6-release-notes/
---
{{% alert color="primary" %}} 

تحتوي هذه الصفحة على ملاحظات إصدار Aspose.Cells لنظام Android عبر Java 22.6.
