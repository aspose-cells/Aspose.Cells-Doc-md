...
|CELLSJAVA-41952|نتيجة الحساب غير صحيحة|حشرة|
|CELLSJAVA-41941|لم يتم حساب صيغة الصفيف بشكل صحيح|حشرة|
|CELLSJAVA-41937|بعض القيم من ملف Excel مفقودة في تحويل HTML - XLS إلى HTML|حشرة|
|CELLSJAVA-41969|التظليل Cell مفقود أثناء تحويل HTML إلى XLSX|حشرة|
...
|CELLSJAVA-41967|Cells مفقود في PDF عند تحديد مناطق طباعة متعددة في ورقة واحدة|حشرة|
