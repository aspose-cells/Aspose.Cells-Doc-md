...
|CELLSJAVA-43403|تم تحويل موضع النص إلى اليسار عند الحفظ كـ HTML|
|CELLSJAVA-43421|لم يتم عرض أحرف التخطي وفاصل الأسطر بشكل صحيح عند تحويل HTML إلى Excel|
|CELLSJAVA-43427|التنسيق الشرطي مع أشرطة البيانات إظهار القيم في HTML تصدير|
|CELLSJAVA-43428| يعمل تنسيق المحاسبة مع خط 6 نقاط على تشويه الأرقام في HTML|
...
|CELLSJAVA-43374|يتم تكرار تسميات المخططات أثناء تحويل ملفات Excel المرفقة إلى PDF|
...
|CELLSJAVA-43433|لم يتم عرض الصورة المشار إليها في PDF|
...
قم بتزويد المستخدمين بالقدرة على تحديد كيفية التعامل مع الاقتباس الفردي البادئ لقيمة الخلية عند تصدير / استيراد ملفات CSV/TSV.
