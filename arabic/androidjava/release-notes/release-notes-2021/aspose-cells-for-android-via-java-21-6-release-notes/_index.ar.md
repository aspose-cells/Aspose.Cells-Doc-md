---
title: Aspose.Cells for Android via Java 21.6 ملاحظات الإصدار
type: docs
weight: 7
url: /ar/java/aspose-cells-for-android-via-java-21-6-release-notes/
---
{{% alert color="primary" %}} 

تحتوي هذه الصفحة على ملاحظات إصدار Aspose.Cells for Android via Java 21.6.
