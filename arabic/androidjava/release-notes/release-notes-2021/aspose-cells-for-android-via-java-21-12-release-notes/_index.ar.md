---
title: Aspose.Cells لنظام Android عبر Java 21.12 ملاحظات الإصدار
type: docs
weight: 1
url: /ar/java/aspose-cells-for-android-via-java-21-12-release-notes/
---
{{% alert color="primary" %}} 

تحتوي هذه الصفحة على ملاحظات إصدار Aspose.Cells لنظام Android عبر Java 21.12.
