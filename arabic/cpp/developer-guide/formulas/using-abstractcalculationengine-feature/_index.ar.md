...
---
##  الميزات لا تزال قيد التطوير، لذلك لا تنزعج.


##  **مقدمة**
 توفر هذه المقالة فهمًا لكيفية استخدام[AbstractCalculationEngine](https://reference.aspose.com/cells/cpp/aspose.cells/abstractcalculationengine/) ميزة لتنفيذ وظائف مخصصة مع Aspose.Cells APIs.
