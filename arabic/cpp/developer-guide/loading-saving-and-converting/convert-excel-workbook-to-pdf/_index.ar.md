---
title: تحويل Excel Workbook إلى PDF
type: docs
weight: 80
...
يجب أن يكون تنسيق الملف PDF ، لذا حدد ملف PDF ذي الصلة (قيمة محددة مسبقًا) من تعداد SaveFormat لإنشاء مستند PDF النهائي
 ...
 يرجى الاطلاع على نموذج التعليمات البرمجية التالي ، الخاص به[نموذج لملف Excel](67338368.xlsx) و[إخراج PDF](67338369.pdf) للرجوع اليها.
...
يوضح مقتطف الشفرة التالي كيفية استخدام ملف**IPdfSaveOptions**فئة لحفظ ملفات Excel بتنسيق PDF متوافق مع PDF / A
 ...
 يرجى الاطلاع على نموذج التعليمات البرمجية التالي وملف[إخراج PDF](67338370.pdf) للرجوع اليها.
...
مع ال**IPdfSaveOptions** فئة ، يمكنك الحصول على وقت إنشاء PDF أو تعيينه.
 ...
 يرجى الاطلاع على نموذج التعليمات البرمجية التالي وملف[إخراج PDF](67338371.pdf) للرجوع اليها.
