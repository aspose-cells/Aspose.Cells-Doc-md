---
title: إعدادات الأرقام باستخدام C++
...
type: docs
weight: 10
url: /ar/cpp/cells-number-settings/
---
...
إذا استخدمت خاصية [**Custom**](https://reference.aspose.com/cells/cpp/aspose.cells/style/getcustom/) لتعيين تنسيق الأرقام، سيتم استبدال أي تنسيق سابق تم تعيينه باستخدام خاصية [**Number**](https://reference.aspose.com/cells/cpp/aspose.cells/style/getnumber/) والعكس صحيح.
