---
title: عرض الخطوط الشبكية الصلبة أثناء تحويل Excel إلى PDF باستخدام C++
linktitle: عرض خطوط الشبكة الصلبة
type: docs
weight: 390
url: /ar/cpp/render-solid-gridline-while-converting-excel-to-pdf/
description: تعلم كيفية عرض خطوط شبكة صلبة أثناء تحويل Excel إلى PDF باستخدام Aspose.Cells مع C++.
---
...
مع خيار [PdfSaveOptions.PaginatedSaveOptions(PaginatedSaveOptions_Impl* impl)](https://reference.aspose.com/cells/cpp/aspose.cells/paginatedsaveoptions/~paginatedsaveoptions/)، يمكن لـ Aspose.Cells أيضًا عرض خطوط الشبكة كخطوط صلبة.
