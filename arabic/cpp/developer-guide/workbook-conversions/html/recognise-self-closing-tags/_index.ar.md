---
title: تمييز علامات الإغلاق الذاتية باستخدام C++
linktitle: التعرف على العلامات الفارغة الذاتيًا
type: docs
weight: 120
url: /ar/cpp/recognise-self-closing-tags/
description: تعلم كيفية التعامل مع علامات الإغلاق الذاتية في HTML باستخدام Aspose.Cells مع C++.
---
