---
title: استبدال النص في الفن الذكي باستخدام C++
linktitle: استبدال النص في شكل ذكاء ذكي
type: docs
weight: 1200
url: /ar/cpp/replace-text-in-smart-art/
description: تعلم كيف تقوم بتحديث النص في الفن الذكي باستخدام Aspose.Cells for C++ عن طريق تعيين خاصية Shape.Text.
---

## **سيناريوهات الاستخدام المحتملة**

الفن الذكي هو أحد الكائنات الرئيسية في دفتر العمل. في كثير من الأحيان يوجد حاجة لتحديث النص في الفن الذكي. تقدم Aspose.Cells هذه الميزة عن طريق تعيين الخاصية [**Shape.Text**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shape/gettext/).
