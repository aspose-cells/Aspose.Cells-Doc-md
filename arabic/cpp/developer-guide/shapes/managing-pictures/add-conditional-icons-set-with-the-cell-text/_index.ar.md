---
title: إضافة مجموعة أيقونات شرطية مع نص الخلية باستخدام C++
linktitle: إضافة مجموعة رموز شرطية مع نص الخلية
type: docs
weight: 160
url: /ar/cpp/add-conditional-icons-set-with-the-cell-text/
description: تعلم كيفية إضافة أيقونات شرطية بجانب نص الخلية في Excel باستخدام Aspose.Cells مع C++.
---
