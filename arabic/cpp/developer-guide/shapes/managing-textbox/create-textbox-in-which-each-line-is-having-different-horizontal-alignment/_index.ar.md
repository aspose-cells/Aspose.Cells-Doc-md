---
title: إنشاء مربع نص يملك كل سطر محاذاة أفقية مختلفة باستخدام C++
linktitle: إنشاء مربع نص مع محاذاة أفقية مختلفة
type: docs
weight: 310
url: /ar/cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: تعلم كيفية إنشاء مربع نص بمحاذاة أفقية مختلفة لكل سطر باستخدام Aspose.Cells مع C++.
---

{{% alert color="primary" %}}

يمكنك تحديد محاذاة النص الأفقية لنص فقرتك باستخدام خاصية [**TextParagraph.GetAlignmentType()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.texts/textparagraph/getalignmenttype/).
