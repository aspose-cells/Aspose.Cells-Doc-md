---
title: ألوان شرائح أو قطاعات مخصصة في مخطط الفطيرة باستخدام C++
linktitle: ألوان شريحة أو قطاع مخصصة في الرسم البياني الدائري
description: تعلم كيفية استخدام Aspose.Cells for C++ لتخصيص ألوان الشرائح والقطاعات في مخطط الفطيرة. سيُظهر دليلنا كيفية تعيين ألوان فريدة لكل شريحة، قطاع، أو فرقة لتحسين المظهر العام وتمثيل البيانات.
keywords: Aspose.Cells for C++، مخطط فطيرة، ألوان شرائح مخصصة، ألوان قطاعات مخصصة، جاذبية بصرية، تمثيل البيانات.
type: docs
weight: 60
url: /ar/cpp/custom-slice-or-sector-colors-in-pie-chart/
---
...
1. الوصول إلى [**Series**](https://reference.aspose.com/cells/cpp/aspose.cells.charts/series/) و[**ChartPoint**](https://reference.aspose.com/cells/cpp/aspose.cells.charts/chartpoint/).
1. تعيين اللون الذي تختاره باستخدام [**ChartPoint.GetForegroundColor()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/area/getforegroundcolor/).
...
[**ChartPoint.GetForegroundColor()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/area/getforegroundcolor/) ليس محددًا لرسومات الدائرة الدائرية ولكن يمكن استخدامه لجميع أنواع الرسوم البيانية.
