---
title: تعيين الصورة كملء خلفية في الرسم البياني باستخدام C++
linktitle: تعيين الصورة كخلفية ملء في الرسم البياني
description: تعلم كيفية تعيين صورة كملء خلفية في رسم بياني باستخدام Aspose.Cells for C++. سيعرض لك دليلنا كيفية استيراد الصورة وتحديد موقعها، وضبط حجمها ولونها، وتطبيق خيارات التنسيق لتحسين مظهر مخططك.
keywords: Aspose.Cells for C++، التخطيط، ملء الخلفية، الصورة، الاستيراد، التحديد، الحجم، اللون، التنسيق.
type: docs
weight: 30
url: /ar/cpp/set-picture-as-background-fill-in-the-chart/
---
...
{{% /alert %}}
 ...
 لتحقيق ذلك، توفر Aspose.Cells الخاصية [**Chart.GetImageData()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/fillformat/getimagedata/). يوضح رمز العينة التالي استخدام الخاصية [**Chart.GetImageData()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/fillformat/getimagedata/) لتعيين صورة كملء خلفية في الرسم البياني.

## كود C++ لتعيين الصورة كملء خلفي في الرسم البياني
