---
title: إضافة تسميات مخصصة لنقاط البيانات في سلسلة المخطط باستخدام C++
linktitle: إضافة تسميات مخصصة إلى نقاط البيانات في سلسلة الرسم البياني
description: تعلم كيف تضيف تسميات مخصصة لنقاط البيانات في سلسلة مخطط باستخدام Aspose.Cells for C++. دليلنا سيظهر لك كيفية تعديل مظهر التسمية، موقعها، وتنسيقها، بالإضافة إلى ربطها بمصدر بياناتك لعرض دقيق للبيانات.
type: docs
weight: 100
url: /ar/cpp/adding-custom-labels-to-data-points-in-the-series-of-the-chart/
---

{{% alert color="primary" %}}

 يمكنك إضافة تسميات مخصصة لنقاط البيانات في سلسلة المخطط. يوفر Aspose.Cells طريقة [**DataLabel::getText()**](https://reference.aspose.com/cells/cpp/aspose.cells.charts/datalabels/gettext/) لإضافة هذه التسميات المخصصة. ستشرح هذه المقالة كيفية استخدام هذه الطريقة لإضافة تسميات مخصصة لنقاط البيانات في السلسلة.
