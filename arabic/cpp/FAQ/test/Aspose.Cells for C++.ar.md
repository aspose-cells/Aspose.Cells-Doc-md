...
![الإصدار 23.11.0](https://img.shields.io/badge/nuget-v23.11.0-blue) ![NuGet](https://img.shields.io/nuget/dt/Aspose.Cells.Cpp)

[![راية](https://raw.githubusercontent.com/Aspose/aspose.github.io/master/img/banners/aspose_cells-for-cpp-banner.png)](https://releases.aspose.com/cells/cpp/)
...
[Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) هي مكتبة C++ أصلية لإنشاء ومعالجة وتحويل ملفات Microsoft Excel، من دون الحاجة إلى Microsoft Office أو التشغيل التلقائي. يدعم واجهة برمجة التطبيقات C++ لـ Excel Excel 97-2003 (XLS)، Excel 2007-2013/2016 (XLSX، XLSM، XLSB)، OpenOffice XML، وتنسيقات أخرى مثل CSV، TSV، وأكثر من ذلك.
...
- فتح ملف جدول بيانات بدون استخدام Microsoft Excel.
- [فتح ملف Excel](https://docs.aspose.com/cells/cpp/different-ways-to-open-files/) عن طريق مسار في الكمبيوتر المحلي أو باستخدام تيار (Stream).
- [تحويل جدول العمل](https://docs.aspose.com/cells/cpp/converting-worksheet-to-different-image-formats/) إلى تنسيقات صور مختلفة.
- [تطبيق التنسيق الشرطي](https://docs.aspose.com/cells/cpp/apply-conditional-formatting-in-worksheet/) حسب اختيارك.
- [تلاعب بجداول البيانات المحورية](https://docs.aspose.com/cells/cpp/manipulate-pivot-table/) في جداول البيانات الخاصة بك.
- [تحويل الجدول إلى مجموعة](https://docs.aspose.com/cells/cpp/tables-and-ranges/) دون فقدان التنسيق.
- الحصول على اسم الخلية عن طريق توفير مؤشر الصف والعمود، بالإضافة إلى ذلك، [الحصول على مؤشر الصف والعمود للخلية](https://docs.aspose.com/cells/cpp/names-and-indices/) من خلال اسمها.
- إنشاء [رسم بياني هرمي، رسم بياني خطي، رسم بياني فقاعي](https://docs.aspose.com/cells/cpp/creating-and-customizing-charts/)، أو رسم بياني مخصص.
- [تقديم](https://docs.aspose.com/cells/cpp/chart-rendering/) أنواع الرسوم البيانية المدعومة إلى صور أو PDF.
- [إدراج كائن OLE في الجدول](https://docs.aspose.com/cells/cpp/inserting-ole-objects-into-the-worksheet/).
- الوصول إلى جميع كائنات OLE الواردة في الجدول للـ [استخراجها](https://docs.aspose.com/cells/cpp/extracting-ole-objects-from-worksheet/).
...
جرب تنفيذ قطعة الأكواد أدناه لرؤية كيفية عمل الواجهة البرمجية للتطبيق في بيئتك، أو قم بالتحقق من [مستودع GitHub](https://github.com/aspose-cells/Aspose.Cells-for-C) لأنماط الاستخدام الشائعة الأخرى.
