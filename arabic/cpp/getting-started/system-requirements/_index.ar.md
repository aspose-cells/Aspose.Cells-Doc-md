...
<table>  
	<tr>
			...
			<td style="font-weight: bold; width:400px">إصدارات</td>
		</tr>
  <tr>
			<td>Microsoft Windows</td>
			<td><ul><li>Windows 2008 Server (x64، x86)</li><li>Windows 2012 Server (x64، x86)</li><li>Windows 2012 R2 Server (x64، x86)</li><li>Windows 2016 الخادم (x64 ، x86)</li><li>Windows 2019 Server (x64، x86)</li><li>Windows Vista (x64، x86)</li><li>Windows 7 (x64، x86)</li><li>Windows 8، 8.1 (x64، x86)</li><li>Windows 10 (x64، x86)</li></ul></td>
		</tr>
  <tr>
			<td>لينكس</td>
			<td><ul><li>Ubuntu 18.04 أو أحدث</li><li>فيدورا</li><li>OpenSUSE</li><li>CentOS</li><li>و اخرين</li></ul></td>
		</tr>
</table>
...
<table>  
  ...
  <tr>
			<td><ul><li>دول مجلس التعاون الخليجي 7.5.0 أو أحدث</li><li>CMake 3.0.0 أو أحدث</li></ul></td>
			</tr>
</table>
