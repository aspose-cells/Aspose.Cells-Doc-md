...
|CELLSCPP-69|حل المشكلات في حالات الاختبار C++|ميزة جديدة|
...
|CELLSCPP-75|نفذ الوظيفة C++: رسم صورة من الدفق|ميزة جديدة|
|CELLSCPP-76|تنفيذ فئات C++: ComIStreamWrapper و Metafile|ميزة جديدة|
|CELLSCPP-77|حالة اختبار التصحيح C++: نُسخ|ميزة جديدة|
|CELLSCPP-78|حل المشكلات في حالات الاختبار C++: التوقيع الرقمي وأنواع التعداد والبحث والصيغ والوحدات النمطية للارتباطات التشعبية|ميزة جديدة|
|CELLSCPP-79|حل مشكلة الارتباط لنسخة إصدار C++|ميزة جديدة|
