...
|CELLSCPP-97|تصحيح وإصلاح المشكلات المتعلقة بالتقديم XLSX/XLS إلى PDF|ميزة جديدة|
...
|CELLSCPP-102|لا يتم تحليل المخططات (الاحتفاظ) عند فتح / حفظ تنسيق ملف XLSX|ميزة جديدة|
...
|CELLSCPP-106|مشكلة تسرب الذاكرة|خلل برمجي|
