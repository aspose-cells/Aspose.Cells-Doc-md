---
title: Aspose.Cells الخاص بـ CPP 23.1 ملاحظات الإصدار Windows
type: docs
weight: 12
url: /ar/cpp/aspose-cells-for-cpp-23-1-release-notes-windows/
---
{{% alert color="primary" %}}

تحتوي هذه الصفحة على ملاحظات إصدار Aspose.Cells for C++ 23.1 لـ Windows.
