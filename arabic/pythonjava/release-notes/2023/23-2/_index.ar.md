---
title: Aspose.Cells for Python via Java 23.2 ملاحظات الإصدار
type: docs
weight: 11
url: /ar/python-java/aspose-cells-for-python-via-java-23-2-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Python via Java 23.2](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.2/).
