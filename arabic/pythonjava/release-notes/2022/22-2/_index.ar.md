---
title: Aspose.Cells for Python via Java 22.2 ملاحظات الإصدار
type: docs
weight: 11
url: /ar/python-java/aspose-cells-for-python-via-java-22-2-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Python via Java 22.2](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.2/).
...
|CELLSJAVA-44271|عند تحويل Excel إلى PDF ، يتغير موضع الإخراج مقارنةً بحالة التحويل اليدوي|
...
|CELLSJAVA-44114|XLSX إلى PDF: البيانات بتنسيق الأرقام العلمية من ملف XLSX لا تتطابق مع البيانات الموجودة في ملف PDF الناتج|
...
|CELLSJAVA-44192| تم قطع اسم عنصر محور الفئة في الرسم البياني في تحويل Excel إلى PDF|
...
|CELLSJAVA-44274|هل تنسيق SVG مدعوم للقراءة أو التقديم إلى PDF|
