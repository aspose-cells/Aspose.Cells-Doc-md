---
title: Aspose.Cells لـ Python عبر Java 22.11 ملاحظات الإصدار
type: docs
weight: 2
...
{{% alert color="primary" %}}
 ...
 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells لـ Python عبر Java 22.11](https://releases.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.11/).
