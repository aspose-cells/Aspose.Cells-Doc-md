---
title: Aspose.Cells for Python via Java 22.3 ملاحظات الإصدار
type: docs
weight: 10
url: /ar/python-java/aspose-cells-for-python-via-java-22-3-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Python via Java 22.3](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.3/).
...
|CELLSJAVA-44341|عرض Cell غير صحيح في الإخراج DOCX في تحويل Excel إلى DOCX|
...
|CELLSJAVA-44328| يتم فقد بعض ملصقات البيانات الخاصة برسوم Excel عند حفظ ملف Excel كـ HTML|
|CELLSJAVA-44193|تختلف زاوية عناصر محور الفئة في الرسم البياني في Excel عن تحويل PDF|
