---
title: Aspose.Cells for Python via Java 21.7 ملاحظات الإصدار
type: docs
weight: 6
url: /ar/python-java/aspose-cells-for-python-via-java-21-7-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for Python via Java 21.7](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.7/).

{{% /alert %}}

|**مفتاح**|**ملخص**|**فئة**|
|:- |:- |:- |
|CELLSJAVA-43477|قم بالتوقيع رقميًا على مشروع رمز VBA باستخدام الشهادة باستخدام Aspose.Cells for Java|
...
|CELLSJAVA-43510|تم إفساد المخطط عند إعادة حفظ ملف Excel باستخدام Aspose.Cells for Java|
...
|CELLSJAVA-43506|استثناء كلمة المرور غير صالح|
...
### **يضيف طريقة PivotFormatCondition.AddRowAreaCondition (String fieldName).**

يضيف حد تنسيق PivotTable الشرطي في حقول الصف.

### **يضيف أسلوب PivotFormatCondition.AddDataAreaCondition (حقل بيانات PivotField).**

يضيف حد تنسيق شرطي لـ PivotTable في حقول البيانات.

### **يضيف أسلوب PivotFormatCondition.AddDataAreaCondition (String fieldName).**

يضيف حد تنسيق شرطي لـ PivotTable في حقول البيانات.

### **يضيف طريقة PivotFormatCondition.SetConditionalAreas ().**

يضبط المساحات الشرطية لكائن PivotFormatCondition.

### **يضيف طريقة SeriesCollection.Add (منطقية ، منطقية).**

يضيف سلسلة بنطاق.

### **يضيف طريقة SetSeriesNames ().**

يعين النطاق كاسم للسلسلة.
