...
Aspose.Cells لـ Python عبر Java يدعم تشغيل ملفات ODS. توضح الأمثلة التالية تحويل Excel إلى ملف ODS.
### **التحويل المباشر**
