...
Aspose.Cells for Python via Java يدعم تصدير مساحة الطباعة فقط ، على سبيل المثال ، نطاق الخلايا المحدد بدلاً من المجموعة بأكملها إلى HTML. لهذا ، يوفر API[HtmlSaveOptions.ExportPrintAreaOnly](https://reference.aspose.com/cells/python/asposecells.api/htmlsaveoptions#ExportPrintAreaOnly) خاصية. تعيين هذه الخاصية إلى**حقيقي** سيتم تصدير منطقة الطباعة فقط.
