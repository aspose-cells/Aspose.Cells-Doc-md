---
title: إدراج ملف WAV ككائن Ole باستخدام Node.js عبر C++
linktitle: إدراج ملف WAV ككائن Ole
type: docs
weight: 70
url: /ar/nodejs-cpp/inserting-a-wav-file-as-an-ole-object/
description: تعلم كيفية إدراج ملف WAV ككائن OLE في أوراق عمل إكسل باستخدام Aspose.Cells for Node.js via C++. 
---
