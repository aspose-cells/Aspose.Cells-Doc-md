...
description: Aspose.Cells for Node.js via C++ هي مكتبة للعمل مع ملفات جداول البيانات، تدعم قراءة وكتابة ملفات dBASE III و IV (DBF). تشرح هذه المقالة كيفية استيراد البيانات من وتصدير البيانات إلى ملفات DBF باستخدام Aspose.Cells، بما في ذلك تفاصيل تنسيق الملف والميزات المدعومة وأمثلة خطوة بخطوة.
keywords: Aspose.Cells, Node.js via C++, DBF, dBASE, قراءة DBF, كتابة DBF, استيراد DBF, تصدير DBF, تنسيق الملف, .dbf
type: docs
weight: 200
url: /ar/nodejs-cpp/reading-and-writing-dbf-files/
...
يوفر Aspose.Cells دعمًا كاملاً لقراءة وكتابة ملفات DBF (dBASE). يمكنك تحميل ملفات dBASE III و dBASE IV الموجودة في كائن Workbook، ومعالجة البيانات باستخدام واجهة برمجة التطبيقات الغنية لـ Aspose.Cells، ثم حفظ المصنف مرة أخرى بتنسيق DBF لاستخدامه مع تطبيقات قواعد البيانات القديمة.
...
عند كتابة البيانات إلى ملف DBF، تأكد من أن بياناتك تتوافق مع قيود التنسيق. يجب ألا يتجاوز طول أسماء الحقول 10 أحرف ولا يجب أن تحتوي على مسافات. لن يتم حفظ السجلات التي يتجاوز حجمها الإجمالي 4000 بايت بشكل صحيح. يجب أن تكون التواريخ قيم تاريخ صالحة يمكن تمثيلها بتنسيق YYYYMMDD.
