---  
title: إنشاء صورة شفافة لورقة عمل اكسل باستخدام Node.js عبر C++  
linktitle: Create Transparent Image of Excel Worksheet  
type: docs  
weight: 170  
url: /ar/nodejs-cpp/create-transparent-image-of-excel-worksheet/  
description: تعلم كيفية إنشاء صورة شفافة لورقة عمل Excel باستخدام Aspose.Cells for Node.js via C++.  
---  
