---
title: تحويل المخطط إلى صورة مترجمة مع Node.js عبر C++
description: تعلم كيفية إعداد تكوينات العولمة للمخططات باستخدام Aspose.Cells for Node.js via C++. يوضح دليلنا كيفية تكوين المخطط لدعم لغات متعددة وتنسيقات إقليمية لعرض النصوص والتواريخ والأرقام بشكل صحيح بمختلف اللغات.
keywords: Aspose.Cells for Node.js via C++، المخططات، إعدادات العولمة، لغات متعددة، تنسيقات إقليمية، عرض، النص، التواريخ، الأرقام.
linktitle: تعيين منطقة معربة
type: docs
weight: 50
url: /ar/nodejs-cpp/convert-chart-to-localized-image/
...
- [كيفية تعيين المنطقة الصينية للرسم البياني](/cells/ar/nodejs-cpp/convert-chart-to-image-for-chinese-region/)
- [كيفية تعيين المنطقة اليابانية للرسم البياني](/cells/ar/nodejs-cpp/convert-chart-to-image-for-japanese-region/)
