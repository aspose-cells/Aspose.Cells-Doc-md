---
title: كيفية إنشاء مخطط السلسلة المائية مع Node.js عبر C++
linktitle: كيفية إنشاء رسم بياني Waterfall
type: docs
weight: 160
url: /ar/nodejs-cpp/creating-waterfall-chart/
description: إنشاء مخططات السلسلة المائية في Excel باستخدام Node.js وAspose.Cells for Node.js via C++.
keywords: إنشاء مخطط السلسلة المائية في Excel باستخدام Node.js عبر C++، كيفية إنشاء مخطط السلسلة المائية في Excel باستخدام Node.js عبر C++
---
...
{{% /alert %}} 
 ...
 تتيح واجهات برمجة Aspose.Cells إنشاء مخطط سلسة مائية بمساعدة مخطط خطي. كما تتيح الواجهة تخصيص مظهر المخطط لمنحه شكل السلسلة المائية من خلال ضبط خصائص [**Series.getUpBars()**](https://reference.aspose.com/cells/nodejs-cpp/series/#getUpBars--) و [**Series.getDownBars()**](https://reference.aspose.com/cells/nodejs-cpp/series/#getDownBars--).

 يوضح مثال الكود المقدم أدناه كيفية استخدام Aspose.Cells for Node.js via C++ لإنشاء مخطط سلسة مائية من الصفر.
