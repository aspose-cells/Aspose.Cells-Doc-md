...
description: تعلم كيفية استخراج بيانات الثيم من ملفات Excel باستخدام Aspose.Cells for Node.js via C++. احصل على معلومات التنسيق والنمط بشكل فعال.  
keywords: Aspose.Cells، ملف Excel، بيانات الثيم، نمط، تنسيق، Node.js عبر C++  
type: docs  
weight: 120  
url: /ar/nodejs-cpp/extract-theme-data-from-excel-file/  
---  
