...
type: docs
weight: 10
url: /ar/nodejs-cpp/how-to-format-number-to-fraction/
description: سيتعرف هذا المقال على كيفية تنسيق الرقم إلى كسر باستخدام API الخاص بـ Aspose.Cells for Node.js via C++.
...
## **كيفية تنسيق الرقم إلى كسر في Aspose.Cells for Node.js via C++**
تحويل الأرقام إلى كسور في Aspose.Cells for Node.js via C++ عملية سهلة. تعتبر مكتبة Aspose.Cells مكتبة قوية تتيح لك العمل مع ملفات إكسل في تطبيقات Node.js بدون الحاجة لتثبيت Microsoft Excel. توفر مجموعة واسعة من الميزات، بما في ذلك تنسيق الأرقام على شكل كسور.

إليك دليل خطوة بخطوة حول كيفية تنسيق الأرقام إلى كسور في Aspose.Cells for Node.js via C++:
...
باتباع هذه الخطوات، يمكنك بسهولة تنسيق الأرقام ككسور في Aspose.Cells for Node.js via C++. هذا مفيد بشكل خاص للتطبيقات المالية، والإحصائية، والتعليمية التي تتطلب قيمًا كسرية دقيقة.
