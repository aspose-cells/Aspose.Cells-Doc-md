...
description: Aspose.Cells مكتبة Node.js لمعالجة ملفات الجدول البيانات، والتي تدعم مجموعة من تنسيقات الأرقام. تقدم هذه المقالة قائمة بتنسيقات الأرقام المدعومة ليتمكن المستخدمون من اختيار التنسيق المناسب وفقًا لاحتياجاتهم.
keywords: Aspose.Cells، مكتبة Node.js، جدول البيانات، تنسيق الرقم، قائمة، مدعوم
type: docs
weight: 30
url: /ar/nodejs-cpp/list-of-supported-number-formats/
---
