...
type: docs
weight: 10
url: /ar/nodejs-cpp/how-to-format-number-to-scientific/
description: سيتعرف هذا المقال على كيفية تنسيق الرقم إلى علمي باستخدام API الخاص بـ Aspose.Cells for Node.js via C++.
...
## **كيفية تنسيق الرقم إلى علمي في Aspose.Cells for Node.js via C++**
لتنسيق الأرقام إلى صيغة علمية في Aspose.Cells for Node.js via C++، يمكنك استخدام طريقة `Style.setCustom` الخاصة بكائن الخلية. تسمح لك Aspose.Cells بتحديد تنسيق مخصص لبيانات أوراقك، بما في ذلك الصيغة العلمية.
...
باتباع هذه الخطوات، يمكنك تنسيق الأرقام إلى صيغة علمية في Aspose.Cells for Node.js via C++. تذكر أن تعدل سلسلة التنسيق (`"0.00E+00"`) حسب الحاجة لتتناسب مع عدد الأرقام بعد العشرية أو جوانب أخرى من العرض العلمي.
