...
type: docs
weight: 10
url: /ar/nodejs-cpp/format-number-to-date/
description: ستقدم هذه المقالة شرحًا لكيفية تنسيق الرقم ليكون بتاريخ باستخدام API Aspose.Cells for Node.js via C++.
