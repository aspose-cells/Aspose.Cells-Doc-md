---
title: البحث عن جداول الاستعلام والكائنات القائمة المرتبطة باتصالات البيانات الخارجية باستخدام Node.js عبر C++
linktitle: العثور على جداول الاستعلام وكائنات القائمة المتعلقة باتصالات البيانات الخارجية
type: docs
weight: 20
url: /ar/nodejs-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: تعلم كيفية العثور على جداول الاستعلام والكائنات القائمة المرتبطة باتصالات البيانات الخارجية باستخدام Aspose.Cells for Node.js via C++.
---
