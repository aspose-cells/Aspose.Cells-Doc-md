...
{{% alert color="primary" %}}
 ...
 يوفر Aspose.Cells الآن امتداد[**النمط**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/quoteprefix) لمعرفة ما إذا كانت قيمة الخلية تبدأ بعلامة اقتباس مفردة. قبل هذه الخاصية ، لم تكن هناك طريقة للتمييز بين سلاسل مثل العينة و "العينة وما إلى ذلك.
