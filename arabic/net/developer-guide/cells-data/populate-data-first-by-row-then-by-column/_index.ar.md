...
type: docs
weight: 1000
url: /ar/net/populate-data-first-by-row-then-by-column/
description: تعلم كيفية ملء البيانات أولاً حسب الصف ثم حسب العمود من خلال واجهة برمجة التطبيقات Aspose.Cells for .NET.
