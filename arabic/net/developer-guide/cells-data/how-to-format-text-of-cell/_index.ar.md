...
description: تعلم كيفية تنسيق النص في الخلية وتنسيقات متعددة داخل خلية واحدة باستخدام Aspose.Cells.
keywords: تنسيق نص الخلية، تنسيق أحرف جزئية من الخلية، كيفية إضافة تنسيقات متعددة لنص الخلية، تمييز جزء من الخلية، تنسيق جزء من الخلية، أنماط متعددة داخل خلية واحدة، تنسيق النص في الخلايا، تنسيق النص في الخلية.
---
