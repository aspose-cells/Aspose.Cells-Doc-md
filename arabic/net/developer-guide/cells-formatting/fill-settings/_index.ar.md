...
|ThinHorizontalStripe|يمثل نمط شريطي أفقي رقيق|
...
-  عند استرداد لون التظليل / التعبئة للخلية ، إذا كان[**أسلوب. نمط**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/pattern) هو*نوع الخلفية*, [**Style.ForegroundColor**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/foregroundcolor) سيعود*اللون فارغ*.
