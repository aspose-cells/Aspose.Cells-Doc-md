...
description: Aspose.Cells هو مكتبة .NET للعمل مع ملفات جداول البيانات. تدعم تنفيذ نظام التاريخ 1904، مما يسمح للمستخدمين بحساب وتنسيق بناءً على نظام التاريخ 1 يناير 1904. يقوم هذا المقال بوصف كيفية تنفيذ نظام التاريخ 1904 باستخدام مكتبة Aspose.Cells.
keywords: Aspose.Cells, نظام التاريخ 1904, جدول بيانات, حساب, تنسيق
type: docs
weight: 7000
url: /ar/net/implement-1904-date-system/
---
