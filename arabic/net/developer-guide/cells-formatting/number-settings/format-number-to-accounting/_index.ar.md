...
type: docs
weight: 10
url: /ar/net/how-to-format-number-to-accounting/
description: سيقدم هذا المقال كيفية تنسيق الرقم إلى محاسبة باستخدام API Aspose.Cells for .NET.
...
## **كيفية تنسيق الرقم إلى محاسبة في Aspose.Cells for .NET**
لتنسيق الأرقام إلى تنسيق محاسبة في Aspose.Cells for .NET، يمكنك استخدام كائن `Style` المرتبط بخلية أو نطاق خلايا. يتيح لك كائن `Style` ضبط خيارات تنسيق متعددة، بما في ذلك تنسيقات الأرقام. عادةً ما يكون تنسيق المحاسبة له رمز تنسيق يمكن أن يختلف اعتماداً على المتطلبات الخاصة (مثل ما إذا كانت ستُظهر رموز العملة، أماكن العشر، إلخ).

إليك مثال أساسي لكيفية تطبيق تنسيق رقم محاسبة على خلية في Aspose.Cells for .NET:
