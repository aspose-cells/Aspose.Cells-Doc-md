...
type: docs
weight: 10
url: /ar/net/how-to-format-number-to-fraction/
description: سيقدم هذا المقال كيفية تنسيق الرقم إلى كسر باستخدام Aspose.Cells for .NET.
...
## **كيفية تنسيق الرقم ليصبح كسر في Aspose.Cells for .NET**
تنسيق الأرقام إلى كسور في Aspose.Cells for .NET هو عملية مباشرة. Aspose.Cells هي مكتبة قوية تتيح لك العمل مع ملفات إكسل في تطبيقات .NET بدون الحاجة لتثبيت ميكروسوفت إكسل. توفر مجموعة واسعة من الميزات، بما في ذلك تنسيق الأرقام ككسور.

إليك دليل خطوة بخطوة حول كيفية تنسيق الأرقام إلى كسور في Aspose.Cells for .NET:
...
باتباع هذه الخطوات، يمكنك بسهولة تنسيق الأرقام ككسور في Aspose.Cells for .NET. هذا مفيد بشكل خاص للتطبيقات المالية، الإحصائية، أو التعليمية حيث تكون القيم الكسرية الدقيقة ضرورية.
