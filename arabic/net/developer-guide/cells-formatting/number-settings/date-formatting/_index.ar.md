...
type: docs
weight: 10
url: /ar/net/format-number-to-date/
description: سيقدم هذا المقال كيفية تنسيق الرقم إلى تاريخ باستخدام API Aspose.Cells for .NET.
...
لتنسيق الأرقام كتاريخ في مكتبة Aspose.Cells for .NET للعمل مع ملفات إكسل، يمكنك تطبيق تنسيق التاريخ على الخلايا برمجياً. إليك كيف يمكنك القيام بذلك باستخدام C# مع Aspose.Cells:
