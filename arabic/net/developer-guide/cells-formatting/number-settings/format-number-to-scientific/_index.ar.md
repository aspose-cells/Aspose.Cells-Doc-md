...
type: docs
weight: 10
url: /ar/net/how-to-format-number-to-scientific/
description: ستقدم هذه المقالة كيفية تنسيق الرقم إلى علمي باستخدام API الخاص بـ Aspose.Cells for .NET.
...
## **كيفية تنسيق الرقم إلى علمي في Aspose.Cells for .NET**
لتنسيق الأرقام إلى التدوين العلمي في Aspose.Cells for .NET، يمكنك استخدام خاصية `Style.Custom` لخلية. يسمح لك Aspose.Cells بتعريف تنسيق مخصص للبيانات في أوراق العمل الخاصة بك، بما في ذلك التدوين العلمي.

إليك دليل خطوة بخطوة على كيفية القيام بذلك:

### الخطوة 1: تثبيت Aspose.Cells

أولاً، تأكد من تثبيت Aspose.Cells for .NET في مشروعك. إذا لم تقم بتثبيته بعد، يمكنك الحصول عليه عبر NuGet. نفذ الأمر التالي في وحدة تحكم مدير الحزم:
...
باتباع هذه الخطوات، يمكنك تنسيق الأرقام إلى التدوين العلمي في Aspose.Cells for .NET. تذكر أنه يمكنك تعديل سلسلة التنسيق (`"0.00E+00"`) حسب الحاجة لضبط عدد الأرقام العشرية أو الجوانب الأخرى لعرض التدوين العلمي.
