...
type: docs
weight: 320
url: /ar/net/using-workbookmetadata/
---

{{% alert color="primary" %}}

تسمح Aspose.Cells لك بتحميل نسخة خفيفة من سجل العمل إلى الذاكرة لتحرير معلومات السجل الوصفية. يرجى استخدام الفئة [**WorkbookMetadata**](https://reference.aspose.com/cells/net/aspose.cells.metadata/workbookmetadata) لتحميل السجل.
