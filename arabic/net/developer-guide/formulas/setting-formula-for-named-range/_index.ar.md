...
## **إعداد الصيغة لنطاق مسمى**
 مثل تطبيق Excel ، توفر واجهات برمجة تطبيقات Aspose.Cells القدرة على تحديد صيغة لنطاق مسمى أثناء استخدام[يعود الى](https://reference.aspose.com/cells/net/aspose.cells/range/properties/refersto)خاصية. يمكن أن يكون هناك العديد من سيناريوهات الاستخدام لهذه الميزة ، بعضها مفصل على النحو التالي.
