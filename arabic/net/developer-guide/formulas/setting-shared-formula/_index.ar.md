...
|![ما يجب القيام به: image_بديل_نص](setting-shared-formula_1.png)|
 ...
 Aspose.Cells يتيح لك تحديد معادلة باستخدام[**Cell.Formula**](https://reference.aspose.com/cells/net/aspose.cells/cell/properties/formula)خاصية. يوجد خياران لإضافة الصيغ إلى الخلايا الأخرى (B3 و B4 و B5 وما إلى ذلك) في العمود.
