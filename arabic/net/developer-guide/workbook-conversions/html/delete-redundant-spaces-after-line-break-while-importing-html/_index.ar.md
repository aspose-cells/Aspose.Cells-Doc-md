---
title: احذف المسافات الزائدة بعد فاصل الأسطر أثناء استيراد HTML
type: docs
weight: 20
...
## احذف المسافات الزائدة بعد فاصل الأسطر أثناء استيراد HTML

### عينة البرمجة

 يُظهر نموذج التعليمات البرمجية التالي استخدام امتداد الملف[**HTMLLoadOptions.DeleteRedundantSpaces**](https://reference.aspose.com/cells/net/aspose.cells/htmlloadoptions/properties/deleteredundantspaces) منشأه. يرجى ضبطه**حقيقي** أو**خاطئة** للحصول على الإخراج كما هو موضح في الصورة أعلاه.
