...
إذا كنت بحاجة إلى حفظ كل ورقة عمل في ملف Excel النموذجي الخاص بك لإنشاء ملفات PDF مختلفة ، فيمكنك تحقيق ذلك بسهولة. يمكنك محاولة إخفاء الأوراق في الملف وجعل ورقة واحدة مرئية في كل مرة لتقديمها إلى PDF.
