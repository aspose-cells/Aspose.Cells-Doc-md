...
description: قم بتحويل ملفات Excel إلى Word و Excel و PowerPoint و PDF و CSV و JPG و HTML و MHT و ODS و BMP و PNG و SVG و TIFF و XPS و JSON و SQL و XML والمزيد.
---
{{% alert color="primary" %}}
...
لغة الترميز الخاصة بـ XPS هي مجموعة فرعية من XAML تسمح لها بدمج عناصر الرسومات المتجهة في المستندات ، باستخدام XAML لتمييز العناصر الأولية Windows Presentation Foundation (WPF). يتم وصف العناصر المستخدمة من حيث المسارات والأوليات الهندسية الأخرى.

ملف XPS هو ، في الواقع ، أرشيف بتنسيق ZIP بتنسيق Unicode يستخدم اتفاقية Open Packaging Conventions ، والتي تحتوي على الملفات التي يتكون منها المستند. يتضمن ذلك ملف ترميز XML لكل صفحة ، ونص ، وخطوط مضمنة ، وصور نقطية ، ورسومات متجهة ثنائية الأبعاد ، بالإضافة إلى معلومات إدارة الحقوق الرقمية. يمكن فحص محتويات ملف XPS ببساطة عن طريق فتحه في تطبيق يدعم ملفات ZIP.

من Aspose.Cells 6.0.0 ، Microsoft يتم دعم تحويل Excel إلى XPS.
...
## **تحويل مصنف Excel إلى HTML**
 ...
 يوفر Aspose.Cells API دعمًا لتصدير جداول البيانات إلى تنسيق HTML. لهذا الغرض ، يستخدم Aspose.Cells الامتداد**[HtmlSaveOptions] (https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions)**class لتوفير المرونة للتحكم في العديد من جوانب HTML الناتج.
...
## **تعيين تفضيلات الصور لـ HTML**
 ...
 بدءًا من 8.0.2 ، تم كشف Aspose.Cells**[ImageOptions] (https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/imageoptions)** ل**[HtmlSaveOptions] (https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions)**class ، مما يسمح للمطورين بتحديد تفضيلات الصور عند حفظ جداول البيانات بتنسيق HTML.

فيما يلي تفاصيل بعض إعدادات الصورة التي يمكن تطبيقها ،

- **[نوع الصورة] (https://reference.aspose.com/cells/net/aspose.cells.drawing/imagetype)**: يحدد نوع الصورة. يرجى ملاحظة أن جميع الأشكال ، بما في ذلك الرسوم البيانية ، يتم عرضها كصور في ملف HTML الناتج.
...
- [لغة البرمجة](/cells/ar/net/convert-excel-to-html/)
...
- [تحويل ملفات Excel إلى CSV و TSV و Txt](/cells/ar/net/convert-excel-to-csv-tsv-and-txt/)
- [تتبع تقدم تحويل المستند](/cells/ar/net/track-document-conversion-progress/)
- [تحويل CSV و TSV و TXT إلى Excel](/cells/ar/net/convert-csv-tsv-and-txt-to-excel/)
