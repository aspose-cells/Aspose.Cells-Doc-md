---
title: قم بتحويل Excel إلى CSV،TSV و Txt
linktitle: حفظ باسم CSV،TSV و Txt
type: docs
weight: 40
...
## **موضوعات مسبقة**
- [احتفظ بالفواصل للصفوف الفارغة أثناء تصدير جداول البيانات بتنسيق CSV](/cells/ar/net/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
