...
{{% alert color="primary" %}} 
 ...
 تحقق من المقال المفصل على[قراءة أنواع مخططات Excel 2016](/cells/ar/net/read-and-manipulate-excel-2016-charts/)
...
{{% alert color="primary" %}} 
 ...
 تحقق من المقال المفصل على[تصفية القالب المخصص](/cells/ar/net/filter-objects-while-loading-workbook-or-worksheet/)
...
{{% alert color="primary" %}} 
 ...
 تحقق من المقال المفصل على[تحديد عدد الأرقام المهمة](/cells/ar/net/specifying-significant-digits-to-be-stored-in-excel-file/)
...
{{% alert color="primary" %}} 
 ...
 تحقق من المقال المفصل على[قراءة لون توهج الشكل](/cells/ar/net/read-color-of-shape-s-glow-effect/)
...
{{% alert color="primary" %}} 
 ...
 تحقق من المقال المفصل على[استرجاع حجم ورق ورقة العمل](/cells/ar/net/get-paper-width-and-height-of-page-setup-of-worksheet/)
...
{{% alert color="primary" %}} 
 ...
 تحقق من المقال المفصل على[التحقق من التنسيق المخصص](/cells/ar/net/check-custom-number-format-when-setting-style-custom-property/)
