...
كشف هذا الإصدار من Aspose.Cells for .NET API الخاصية ImportTableOptions.IsHtmlString التي توجه API لتحليل علامات HTML أثناء استيراد البيانات إلى ورقة العمل وتعيين النتيجة المحللة كقيمة خلية. يرجى ملاحظة أن واجهات برمجة التطبيقات Aspose.Cells توفر بالفعل Cell.HtmlString لأداء هذه المهمة لخلية واحدة ، ومع ذلك ، أثناء استيراد البيانات المجمعة مثل من DataTable ، تحاول خاصية ImportTableOptions.IsHtmlString (عند تعيينها إلى true) تحليل كل العناصر المدعومة علامات HTML وتعيين النتائج التي تم تحليلها على الخلايا المقابلة.
