...
هذه هي صورة PNG الناتجة بعد ضبط ملف**[ImageOrPrintOptions.DefaultFont] (https://reference.aspose.com/cells/net/aspose.cells.rendering/imageorprintoptions/defaultfont/)**الملكية إلى "Times New Roman".

![ما يجب القيام به: image_بديل_نص](set-defaultfont-property-of-pdfsaveoptions-and-imageorprintoptions-to-have-priority_2.png)

 انظر الإخراج[شجار](48496672.tiff) الصورة بعد ضبط ملف**[ImageOrPrintOptions.DefaultFont] (https://reference.aspose.com/cells/net/aspose.cells.rendering/imageorprintoptions/defaultfont/)**الملكية إلى "Times New Roman".

انظر الإخراج[بي دي إف](48496673.pdf)ملف بعد ضبط ملف**[PdfSaveOptions.DefaultFont] (https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions/properties/defaultfont)**الملكية إلى "Times New Roman".
