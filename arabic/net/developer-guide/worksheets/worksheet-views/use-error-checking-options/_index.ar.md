...
description: في هذه المقالة ، ستجد نموذج التعليمات البرمجية التي ستستخدم برمجيًا خيارات التحقق من الأخطاء في أوراق عمل Excel ، مثل Numbers المخزنة كنص باستخدام C# API أو .NET Library.
