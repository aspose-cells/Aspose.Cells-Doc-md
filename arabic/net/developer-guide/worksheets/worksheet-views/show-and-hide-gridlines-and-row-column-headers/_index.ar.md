...
#### **جعل خطوط الشبكة مرئية**
 ...
 اجعل خطوط الشبكة مرئية عن طريق تعيين ملف[**ورقة عمل**](https://reference.aspose.com/cells/net/aspose.cells/worksheet) صف دراسي[**IsGridlinesVisible**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/isgridlinesvisible) الملكية ل**حقيقي**.

#### **إخفاء خطوط الشبكة**

 إخفاء خطوط الشبكة عن طريق تعيين[**ورقة عمل**](https://reference.aspose.com/cells/net/aspose.cells/worksheet) صف دراسي[**IsGridlinesVisible**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/isgridlinesvisible) الملكية ل**خاطئة**.
...
#### **جعل رؤوس الصفوف / الأعمدة مرئية**
 ...
 اجعل رؤوس الصفوف والأعمدة مرئية عن طريق تعيين[**ورقة عمل**](https://reference.aspose.com/cells/net/aspose.cells/worksheet) صف دراسي[**IsRowColumnHeadersVisible**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/isrowcolumnheadersvisible) الملكية ل**حقيقي**.

#### **إخفاء رؤوس الصفوف / الأعمدة**

 إخفاء رؤوس الصفوف والأعمدة عن طريق تعيين ملف[**ورقة عمل**](https://reference.aspose.com/cells/net/aspose.cells/worksheet) صف دراسي[**IsRowColumnHeadersVisible**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/isrowcolumnheadersvisible) الملكية ل**خاطئة**.
