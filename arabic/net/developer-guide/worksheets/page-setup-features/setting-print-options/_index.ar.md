...
- تحديد ترتيب الصفحة.
 ...
 يدعم Aspose.Cells جميع خيارات الطباعة التي يوفرها Microsoft Excel ويمكن للمطورين بسهولة تكوين هذه الخيارات لأوراق العمل باستخدام الخصائص التي يوفرها[**اعداد الصفحة**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup)صف دراسي. تتم مناقشة كيفية استخدام هذه الخصائص أدناه بمزيد من التفصيل.
