...
لا يوجد خيار مباشر متاح لإنشاء أحجام ورق مخصصة في MS Excel ، ومع ذلك ، يمكنك تعيين حجم ورق مخصص لأوراق العمل التي تريدها عند تحويل ملف Excel إلى تنسيق ملف PDF. يشرح هذا المستند كيفية تعيين حجم ورق مخصص لورقة العمل باستخدام Aspose.Cells APIs.

## **تنفيذ حجم الورق المخصص لورقة العمل للعرض**

 Aspose.Cells يسمح لك بتنفيذ حجم الورق المطلوب لورقة العمل. يمكنك استخدام ملف[**حجم الورق المخصص**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/methods/custompapersize) طريقة[**اعداد الصفحة**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup) فئة لتحديد حجم صفحة مخصص. يوضح نموذج التعليمات البرمجية التالي كيفية تحديد حجم ورق مخصص لورقة العمل الأولى في المصنف. يرجى أيضًا الاطلاع على ملف[إخراج PDF](45056028.pdf) ولدت مع الكود التالي كمرجع.
