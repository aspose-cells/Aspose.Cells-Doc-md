...
type: docs
weight: 200
url: /ar/net/how-to-set-print-area/
description: يُظهر لك هذا المقال رمز يشرح كيفية تعيين منطقة الطباعة باستخدام مكتبة Aspose.Cells.
keywords: تحديد نطاق الطباعة، تعيين نطاق الطباعة، مسح نطاق الطباعة، تعيين ومسح نطاق الطباعة باستخدام C#، كيف تعيين منطقة الطباعة في C#، تعيين ومسح منطقة الطباعة باستخدام C#، كيفية مسح منطقة الطباعة في C#، كيف تضيف منطقة الطباعة باستخدام C#، كيفية إزالة منطقة الطباعة باستخدام C#، كيفية تعيين منطقة الطباعة في Excel، كيفية مسح منطقة الطباعة في Excel.
---
...
لضبط مجال الطباعة في ورقة عمل محددة: أولاً، قم بتحميل [الملف النموذجي](input.xlsx)، ثم عليك تعديل خاصية [**Worksheet.PageSetup.PrintArea**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printarea/) من كائن [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) لورقة العمل المرغوبة. إعداد هذه الخاصية إلى سلسلة نطاق سيُحدد مجال الطباعة.
...
لمسح مجال الطباعة في ورقة عمل محددة: أولاً، قم بتحميل [الملف النموذجي](input.xlsx)، ثم عليك تعديل خاصية [**Worksheet.PageSetup.PrintArea**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printarea/) من كائن [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) لورقة العمل المرغوبة. تعيين هذه الخاصية إلى سلسلة فارغة سيمسح مجال الطباعة.
