...
{{% alert color="primary" %}}
 ...
 يمكنك التوقيع رقميًا على مشروع كود VBA الخاص بك باستخدام Aspose.Cells به[**Workbook.VbaProject.Sign ()**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/methods/sign)طريقة. يرجى اتباع هذه الخطوات للتحقق مما إذا كان ملف Excel الخاص بك قد تم توقيعه رقميًا بشهادة.
...
## **قم بالتوقيع رقميًا على مشروع رمز VBA باستخدام الشهادة في C#**
 ...
 يوضح نموذج التعليمات البرمجية التالي كيفية الاستفادة من[**Workbook.VbaProject.Sign ()**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/methods/sign)طريقة. فيما يلي ملفات الإدخال والإخراج لعينة التعليمات البرمجية. يمكنك استخدام أي ملف إكسل وأي شهادة لاختبار هذا الرمز.
