...
## **اكتشف ما إذا كان VBA Project محميًا في C#**
 ...
 يمكنك معرفة ما إذا كان مشروع VBA (تطبيقات Visual Basic) لملف Excel الخاص بك محميًا أم لا باستخدام Aspose.Cells[**VbaProject. محمي**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/properties/isprotected)منشأه.
