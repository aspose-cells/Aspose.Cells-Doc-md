...
يقوم نموذج التعليمات البرمجية التالي بإنشاء مصنف جديد وتعيين رمز ماكرو إلى "زر النموذج" وحفظ الإخراج بتنسيق XLSM. بمجرد فتح ملف XLSM الناتج في Microsoft Excel ، سترى رمز الماكرو التالي.
...
فيما يلي نموذج التعليمات البرمجية لإنشاء ملف XLSM الناتج مع رمز الماكرو.
