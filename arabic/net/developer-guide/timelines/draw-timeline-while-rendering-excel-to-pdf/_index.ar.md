...
إذا كان لديك ملف Excel تم تطبيق جدول زمني عليه وتريد تصدير ملف Excel إلى PDF باستخدام إعدادات الخط الزمني ، فإن Aspose.Cells يدعم ذلك افتراضيًا الآن. يمكنك ببساطة تصدير ملف Excel مع الجدول الزمني إلى PDF ، وسيعرض ملف PDF الذي تم إنشاؤه الجدول الزمني المطبق.
