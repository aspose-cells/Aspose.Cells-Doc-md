...
- **العرض** - عرض الملصق بوحدات 1/4000 من مساحة الرسم البياني.
 ...
 طريقة إرجاع[**Aspose.Cells.Drawing.Label**](https://reference.aspose.com/cells/net/aspose.cells.drawing/label)هدف. ال[**مُلصَق**](https://reference.aspose.com/cells/net/aspose.cells.drawing/label) فئة تمثل تسمية في الرسم البياني. لها بعض الأعضاء المهمين:
...
- **العرض** - عرض مربع النص بوحدات 1/4000 من مساحة الرسم البياني.
 ...
 طريقة إرجاع[**Aspose.Cells.Drawing.TextBox**](https://reference.aspose.com/cells/net/aspose.cells.drawing/textbox) هدف. ال[**مربع الكتابة**](https://reference.aspose.com/cells/net/aspose.cells.drawing/textbox)يمثل class مربع نص في الرسم البياني.
...
- **الارتفاع** - مقياس ارتفاع الصورة ، قيمة النسبة المئوية.
 ...
 تقوم الطريقة بإرجاع ملف[**Aspose.Cells.Drawing.Picture**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture) هدف. ال[**صورة**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture)فئة تمثل كائن صورة في الرسم البياني.
