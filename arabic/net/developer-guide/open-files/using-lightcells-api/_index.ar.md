...
تحتاج أحيانًا إلى قراءة وكتابة ملفات إكسل Microsoft كبيرة بقائمة ضخمة من البيانات أو المحتوى في ورقة العمل. تعتبر LightCells API مفيدة لإنشاء جداول بيانات Excel ضخمة: باستخدامها ، تحتاج إلى ذاكرة أقل وتحصل على أداء وكفاءة أفضل.
...
يقوم البرنامج بقراءة ملف ضخم به ملايين السجلات في ورقة عمل. يستغرق الأمر بعض الوقت لقراءة كل ورقة في المصنف. يقرأ نموذج التعليمة البرمجية الملف ويسترد العدد الإجمالي للخلايا وعدد السلسلة وعدد الصيغة في كل ورقة عمل.
