...
### **خطوط الشرارة باستخدام Aspose.Cells**
 يمكن للمطورين إنشاء خطوط مؤشر أو حذفها أو قراءتها (في ملف القالب) باستخدام API المقدم بواسطة Aspose.Cells. وترد الفئات التي تدير خطوط المؤشرات في[Aspose.Cells.Charts](https://reference.aspose.com/cells/net/aspose.cells.charts)مساحة الاسم لذلك تحتاج إلى استيراد مساحة الاسم هذه قبل استخدام هذه الميزات.
