...
- [إضافة روابط تشعبية لربط البيانات في Aspose.Cells](/cells/ar/net/adding-hyperlinks-to-link-data-in-aspose-cells/)
...
- [عرض أو إخفاء رؤوس الصفوف والأعمدة في Aspose.Cells](/cells/ar/net/display-or-hide-row-column-headers-in-aspose-cells/)
...
- [حفظ الدفتر إلى تنسيق النص أو CSV في Aspose.Cells](/cells/ar/net/save-workbook-to-text-or-csv-format-in-aspose-cells/)
