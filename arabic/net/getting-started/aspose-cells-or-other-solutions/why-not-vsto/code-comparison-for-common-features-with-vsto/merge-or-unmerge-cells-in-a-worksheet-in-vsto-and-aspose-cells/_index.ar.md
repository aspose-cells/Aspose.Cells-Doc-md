---
title: دمج أو إلغاء دمج الخلايا في ورقة عمل في VSTO و Aspose.Cells
type: docs
weight: 170
...
{{< /highlight >}}
## **إلغاء دمج الخلايا**
لإلغاء دمج الخلية(ات)، استخدم الأسطر التالية من الشفرة لـ VSTO (C#) و Aspose.Cells for .NET (C#).
### **VSTO**
{{< highlight csharp >}}
