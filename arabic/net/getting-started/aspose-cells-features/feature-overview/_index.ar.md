...
|TSV|قم بتحميل وحفظ المستندات بتنسيق ملف TSV.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|HTML|حفظ باسم HTML متاح.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[مستند مفتوح - ODS](/cells/ar/net/opendocument-ods/)|يمكن Aspose.Cells تحميل وحفظ الوثائق بتنسيق OpenDocument Spreadsheet (.ods).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|التحويل إلى PDF ملفات|قم بتحويل أي جدول بيانات إلى PDF بدقة عالية.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[وثيقة XPS](/cells/ar/net/convert-workbook-to-different-formats/#convertworkbooktodifferentformats-convertingexcelworkbooktoxps)|تحويل جدول بيانات Excel إلى وثيقة XPS|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|تقديم صفحات ورقة العمل إلى صور نقطية (TIFF ، متعدد الصفحات TIFF ، PNG ، JPEG ، BMP).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
