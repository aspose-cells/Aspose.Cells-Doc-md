...
- عيّن "Target OS" إلى "None" أو خيارات أخرى لمشروعك ، ستستخدم "SkiaSharp" كاعتماد على نظام windows الخاص بك لمشروع .Net6.*يرجى ملاحظة أن الإصدار الذي يستخدم "SkiaSharp" باعتباره تبعية لا يدعم الطباعة إلى ميزة الطابعة.*
...
- System.Text.Encoding.CodePages، 4.7.0.
 ...
 بهذه الطريقة ، سوف تستخدم "SkiaSharp" كإعتماد على نظام windows الخاص بك لمشروع .Net6.*يرجى ملاحظة أن الإصدار الذي يستخدم "SkiaSharp" باعتباره تبعية لا يدعم الطباعة إلى ميزة الطابعة.*
