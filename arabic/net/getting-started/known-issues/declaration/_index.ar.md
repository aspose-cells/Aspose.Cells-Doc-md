---
title: أذونات الثقة على خادم الويب
type: docs
weight: 30
...
<br/>
تمت إزالة الثقة المتوسطة في .NET Core و .NET 5+. الثقة المتوسطة هي آلية الأمان في عصر إطار عمل .NET. تم استبدال الثقة المتوسطة تدريجياً بسياسات أمان أكثر مرونة. نقترح على المستخدمين الترقية إلى .NET 5+ واعتماد النشر داخل الحاوية بدلاً من الاعتماد على مستويات الثقة التقليدية.
