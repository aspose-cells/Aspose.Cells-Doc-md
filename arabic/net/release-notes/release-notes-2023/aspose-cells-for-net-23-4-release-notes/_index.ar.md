---
title: Aspose.Cells for .NET 23.4 ملاحظات الإصدار
type: docs
weight: 9
url: /ar/net/aspose-cells-for-net-23-4-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 23.4](https://www.nuget.org/packages/Aspose.Cells/23.4.0).
...
###  **يضيف Aspose.Cells.Drawing.Equations مساحة الاسم**
