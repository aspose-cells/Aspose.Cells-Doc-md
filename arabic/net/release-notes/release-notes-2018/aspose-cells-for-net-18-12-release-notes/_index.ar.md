...
|CELLSNET-42414|التغييرات المتعقبة المفقودة أثناء التحويل من XLSB إلى XLSM ومن XLS إلى XLSM|التعزيز|
...
|CELLSNET-46371|لم يتم عرض خطوط الشبكة في بعض الأوراق أثناء التحويل XLSX-> HTML-> XLSX|خلل برمجي|
|CELLSNET-46447|فقدت التنسيقات في عرض HTML إلى XLS|خلل برمجي|
|CELLSNET-46494|تحويل MHT إلى XLSX - مشكلة محتوى الخلية|خلل برمجي|
|CELLSNET-46468|يطالب MS Excel بخطأ عند فتح ملف الإخراج|خلل برمجي|
|CELLSNET-46487|صيغة اللغة غير الإنجليزية لا تعمل|خلل برمجي|
|CELLSNET-46489|يؤدي حذف صف به فهرس وقراءة الصف الذي له نفس الفهرس إلى إرجاع Cell.ValuType: IsNull|خلل برمجي|
|CELLSNET-46406|تعذر فتح مستند ODS المحمي بكلمة مرور|خلل برمجي|
|CELLSNET-46466|النص السفلي الموجود أسفل الرمز الشريطي مفقود في MS Excel لعرض PDF|خلل برمجي|
|CELLSNET-46470|الصورة مفقودة بعد التسليم لإخراج TIFF|خلل برمجي|
|CELLSNET-46499|لا يتم عرض الصور بشكل صحيح عند تحويلها من Excel إلى PDF|خلل برمجي|
|CELLSNET-46443|ظهر نص إضافي في الصورة المقدمة من مخطط MS Excel|خلل برمجي|
|CELLSNET-46450|تحتوي الصورة المعروضة من مخطط MS Excel على وحدات محور أكثر من المخطط الأصلي|خلل برمجي|
|CELLSNET-46451|مشكلة عند تحويل ملف القالب (الذي يحتوي على الرسم البياني) إلى تنسيق ملف PDF|خلل برمجي|
|CELLSNET-46454|تم عرض ترتيب وسيلة الإيضاح بشكل مختلف عن مخطط Excel في الجلسة 0 مقابل الجلسة 1|خلل برمجي|
|CELLSNET-46471|لا يمكن تعيين علامة اللون LineWithDataMarkers بتنسيق ملف XLS|خلل برمجي|
|CELLSNET-42729|يتم إزاحة النص عندما يتم تقديم مخططات SmartArt كتنسيق ملف HTML|خلل برمجي|
|CELLSNET-46462|يتكرر النص أثناء استبدال العلامة بالنص|خلل برمجي|
|CELLSNET-46483|خطأ بعد تحويل المستند باستخدام Custom UI xml من XLSB إلى XLSM|خلل برمجي|
|CELLSNET-46495|تم العثور على مشاكل أثناء تحويل الرسم البياني إلى صورة|خلل برمجي|
