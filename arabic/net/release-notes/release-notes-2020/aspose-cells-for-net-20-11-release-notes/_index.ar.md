...
|CELLSNET-47641|تم رفع تحذير أثناء إضافة 29 ورقة وفتح ملف XLS الناتج في MS Excel|أداء|
|CELLSNET-46716|تم قطع النص عند تقديم ملف PDF|البق|
...
|CELLSNET-47642|ملف XLSB تالف بعد التحميل والحفظ|البق|
|CELLSNET-47660|حقل الرسم البياني الذي يحتوي على التواريخ له تنسيق مختلف في تنسيق PDF|البق|
|CELLSNET-47661|يقوم Aspose.Cells بإنشاء علامات HTML غير صالحة لورقة عمل معينة لوثيقة Cells معينة|البق|
...
|CELLSNET-47698|قم بتغيير موضع الشعار أثناء تحويل ملف XLS إلى PDF|البق|
...
|CELLSNET-47697|تخرج بعض قيم المحور ص خارج المخطط في ملف PDF الناتج|البق|
|CELLSNET-43579|يتم تغيير انحناء نص WortArt أثناء التحويل من Excel إلى PDF|البق|
|CELLSNET-47675|يتم تغيير محتوى ملف XLS بعد التحميل والحفظ|البق|
...
|CELLSNET-47689|استثناء عند تحويل XLSB إلى PNG و HTML|استثناءات|
|CELLSNET-47701|فشل إنشاء نسخة من مصنف XLTX|استثناءات|
...
|CELLSNET-47694|استثناء عند فتح ملف مستند XLSX|استثناءات|
