...
|CELLSNET-47382|HTML لتحويل Excel يفقد التنسيق|خلل برمجي|
|CELLSNET-47390|لون بعض الكلمات خطأ في التصيير HTML إلى ODS|خلل برمجي|
|CELLSNET-47385|Cells.InsertCutCells فواصل على المصنفات مع تقاطع نطاق|خلل برمجي|
|CELLSNET-47389|حساب HLOOKUP غير صحيح|خلل برمجي|
|CELLSNET-47352|بعد النقر على النص يختفي النص|خلل برمجي|
|CELLSNET-47380|العمود غير محاذاة|خلل برمجي|
|CELLSNET-47366|لم يتم تحويل النقاط إلى ملف PDF|خلل برمجي|
|CELLSNET-47364|يتم عرض تسميات المحور بشكل غير صحيح إذا تم تقديم ورقة العمل كصورة|خلل برمجي|
|CELLSNET-47370|نقطة الرسم البياني مفقودة والشكل مضغوط أثناء تحميل ملف Excel وحفظه|خلل برمجي|
|CELLSNET-47367|اتجاه سهم المحور الخاطئ عند تحويل الرسم البياني إلى صورة|خلل برمجي|
|CELLSNET-47362|SourceFullName و ImageType غير صحيحين|خلل برمجي|
|CELLSNET-47375|XLSX تم تحويله إلى ملف XLS تالف.|خلل برمجي|
|CELLSNET-47398|ورقة عمل Cells. تتخطى بيانات الاستيراد الصفوف عند تقسيم البيانات إلى أوراق متعددة|خلل برمجي|
