---
title: Aspose.Cells for .NET 8.7.0 ملاحظات الإصدار
type: docs
weight: 140
url: /ar/net/aspose-cells-for-net-8-7-0-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 8.7.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.7.0/)
...
## **ميزات جديدة**
 ...
 (CELLSNET-43938) - دعم تصدير شهادة VBA إلى ملف أو دفق

 (CELLSNET-43920) - دعم API للتحقق من توقيع رمز VBA

 (CELLSNET-43867) - التوقيع رقميًا على مشاريع / وحدات الماكرو VBA
...
## **أداء**
 ...
 (CELLSNET-44156) - تعطل تطبيق وحدة التحكم في Workbook.CalculateFormula

 (CELLSNET-44120) - Workbook.CalculateFormula يستغرق وقتًا أطول لحساب الصيغ في المصنف.

 (CELLSNET-43896) - تم إنهاء العملية عند استدعاء Workbook.CalculateFormula
...
(CELLSNET-44138) - Cell التظليل يتداخل مع الحد مما يتسبب في ترقق الحد
 ...
 (CELLSNET-43587) - Cell تتداخل المنطقة مع حدود Cell أثناء تحويل جدول البيانات إلى PDF
 ...
 (CELLSNET-44146) - لا يتم عرض نتائج التنسيق الشرطي بشكل صحيح في PDF

 (CELLSNET-44144) - تؤدي إضافة خصائص مخصصة إلى إزالة محتويات ورقة العمل
...
## **استثناءات**
 ...
 (CELLSNET-44119) - خطأ في الحساب في Workbook.CalculateFormula
 ...
 (CELLSNET-44179) - استثناء أثناء تحميل ملف HTML (تم إنشاؤه من XSLT)
...
يحذف خاصية Workbook.SaveOptions القديمة.
 ...
 إضافة خاصية VbaProject.IsValidSigned.

 يشير إلى ما إذا كان توقيع مشروع VBA صالحًا أم لا.



 يضيف خاصية VbaProject.CertRawData.
