---
title: Aspose.Cells for .NET 8.0.2 ملاحظات الإصدار
type: docs
weight: 70
url: /ar/net/aspose-cells-for-net-8-0-2-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 8.0.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.0.2/)
...
## **ميزات جديدة**
 ...
 (CELLSNET-42585) - تغيير اتجاه نص التعليق
...
(CELLSNET-42235) - مشكلة في تحجيم مربع النص التلقائي
 ...
 (CELLSNET-42612) - ميزة الملاءمة التلقائية للأعمدة لا تعمل مع الأعمدة المنسدلة التي تمت تصفيتها في Pivot
...
(CELLSNET-42567) - يختفي الرسم البياني عند تحويله إلى PDF
 ...
 (CELLSNET-42595) - تظهر خطوط الشبكة في MS-Excel Print Preview عند حفظ المصنف بتنسيق Xlsb

 (CELLSNET-42591) - لا يعمل AutoFitColumns مع ListObjects عند إضافة صفوف جديدة.

 (CELLSNET-42590) - xml: space = "الحفاظ على" السمة المفقودة لـ Excel Cell's v (القيمة) عقدة OpenXML

 (CELLSNET-42588) - غير قادر على إدراج جدول في ملف XLSB
 ...
 (CELLSNET-42568) - العمود المسمى حجم المنخل يظهر # N / A
...
(CELLSNET-42576) - استثناء مرجعي فارغ عند حفظ xls بصيغة pdf
 ...
 (CELLSNET-42609) - Cell. فشل GetDispalyStyle () لبعض قواعد التنسيق الشرطي

 (CELLSNET-42587) - System.NullReferenceException عند فتح الملف

 (CELLSNET-42577) - NullReferenceException - أثناء استرداد النمط الشرطي لخلية
...
## **البق**
 ...
 (CELLSNET-42572) - لا يتم حفظ لون علامة تبويب الورقة داخل GridWeb

 (CELLSNET-42302) - قائمة سياق WebGrid - فشل البحث عن IE11 بسبب خطأ JS: تعذر الحصول على الخاصية 'acwFindReplaceDialog_Element' لمرجع غير محدد أو فارغ
 ...
 (CELLSNET-42623) - خطأ في إنشاء عنصر تحكم لـ GridWeb
