---
title: Aspose.Cells for .NET 8.1.0 ملاحظات الإصدار
type: docs
weight: 60
url: /ar/net/aspose-cells-for-net-8-1-0-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 8.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.0/)
...
## **البق**
 ...
 (CELLSNET-42523) - يفشل SheetRender عند استخدام UpdateSelectedValue
 ...
 (CELLSNET-42752) - يحتوي PivotTable Sub-Totals على دمج خلايا غير صحيح

 (CELLSNET-42703) - تحويل جدول البيانات الذي يحتوي على PivotTable إلى PDF به مشكلات متعلقة بالنمط
 ...
 (CELLSNET-42756) - لا يتم عرض النقاط النقطية بشكل صحيح إذا كانت داخل مربع نص
...
(CELLSNET-42748) - خطوط الأسطورة أرق مما في Excel
 ...
 (CELLSNET-42375) - لم يتم تحويل قائمة الرموز النقطية الموجودة أسفل عنوان الدورة بشكل صحيح إلى ملف pdf

 (CELLSNET-42779) - لا يفتح ملف Xlam في Excel بعد فتحه وإعادة حفظه

 (CELLSNET-42766) - يؤدي فتح الملف وحفظه إلى حدوث خطأ في طرق العرض المخصصة
 ...
 (CELLSNET-42695) - خطأ في العرض المحمي في ملف MS Excel - التحقيق مطلوب
...
(CELLSNET-42758) - التمثيل المحدد ليس استثناءً صالحًا على Cell. GetDisplayStyle ()
 ...
 (CELLSNET-42710) - صيغة غير صالحة عند تحميل جدول بيانات قد يكون تالفًا

 (CELLSNET-42706) - System.OutOfMemoryException في DetectFileFormat
...
## **API العام والتغييرات غير المتوافقة مع الإصدارات السابقة**
 ...
 إضافة خاصية HtmlSaveOptions.PresentationPreference
...
Public ScenarioCollection، Scenario، ScenarioInputCellCollection، ScenarioInputCell و الخاصية Worksheet.Scenarios.

 يدعم إضافة وتعديل وحذف إعدادات السيناريو.
