...
## **API العام والتغييرات غير المتوافقة مع الإصدارات السابقة**
 ...
 بدءًا من هذا الإصدار ، لم يعد يتم توزيع Aspose.Cells مع DLL للاستخدام في .NET Framework 1.1. تم إسقاط دعم هذا الإصدار من إطار العمل لتسهيل الميزات والإصلاحات بشكل أفضل حيث يصعب إضافة بعض الميزات إلى هذا الإصدار القديم من إطار العمل.
