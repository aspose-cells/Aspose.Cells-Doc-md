---
title: Aspose.Cells for .NET 7.7.2 ملاحظات الإصدار
type: docs
weight: 100
url: /ar/net/aspose-cells-for-net-7-7-2-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 7.7.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.7.2/)
...
(CELLSNET-42289) - CHAR (151) لا يعمل بشكل صحيح في PDF
 ...
 (CELLSNET-42319) - عدم اتساق حساب الصيغة

 (CELLSNET-42318) - يتم فقد التنسيق الشرطي عند حذف الصف

 (CELLSNET-42295) - XLSM إلى PDF: يتم عرض حقول الصيغة بالشكل # DIV / 0!

 (CELLSNET-42294) - لا يحتفظ SheetRender في الاعتبار بالقيم المحددة في ComboBoxes
...
## **استثناءات**
 ...
 (CELLSNET-42345) - NullReferenceException أثناء تحميل ملف Excel 2013

 (CELLSNET-42330) - ArgumentOutOfRangeException في مُنشئ المصنف

 (CELLSNET-42362) - استثناء مرجعي فارغ عند الحفظ

 (CELLSNET-42350) - ArgumentException: المعلمة غير صالحة

 (CELLSNET-42348) - NullReferenceException أثناء حفظ المصنف في MemoryStream باستخدام SaveFormat.Xlsx

 (CELLSNET-42333) - System.ArgumentException في Cells.ExportDataTableAsString

 (CELLSNET-42290) - لا يتم إنشاء الصور لملفات Excel ويؤدي إلى استثناء مرجع فارغ

 (CELLSNET-42268) - كان الفهرس خارج حدود خطأ المصفوفة

 (CELLSNET-42311) - ArgumentNullException: لا يمكن أن يكون المخزن المؤقت فارغًا. اسم المعلمة: المخزن المؤقت في Workbook.Save
...
إضافة خاصية WorkbookSettings.RemovePersonalInformation
 ...
 يضيف خاصية Style.IsJustifyDistributed.

 يشير إلى ما إذا كانت الخلايا مبررة أو يجب استخدام المحاذاة الموزعة في السطر الأخير من النص.
