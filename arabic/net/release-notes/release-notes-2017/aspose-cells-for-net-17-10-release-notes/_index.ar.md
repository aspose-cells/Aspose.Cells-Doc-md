...
|CELLSNET-45664|قراءة وكتابة وصلة خارجية لملف XLSB|ميزة جديدة|
|CELLSNET-45660|عرض الورقة إلى الصورة - مشكلة المحاذاة للخطوط الآسيوية|التعزيز|
|CELLSNET-45408|تختفي القيمة أو يتغير لونها عند التحويل إلى PDF|خلل برمجي|
|CELLSNET-45696|القطاعة لا تتحرك لأسفل في الورقة عند إدخال الصفوف|خلل برمجي|
|CELLSNET-45675|خطأ في حساب الصيغ (التي تتضمن "SUMPRODUCT" و "TRANSPOSE")|خلل برمجي|
|CELLSNET-45651|يتغير حجم TextBox عند استخدام الخط الصيني في المصنف في التقديم إلى PDF|خلل برمجي|
|CELLSNET-45678|الأحرف المفقودة جزئيًا عند التحويل إلى صورة|خلل برمجي|
|CELLSNET-45667|لا يتم تحديث تسميات خط الاتجاه في MS Excel عندما نغير قيمة المصدر يدويًا في الخلايا|خلل برمجي|
|CELLSNET-45620|يختلف اللون والفاصل الزمني بين المقياس للمخطط ثلاثي الأبعاد|خلل برمجي|
|CELLSNET-45397|يتعرف Aspose.Cells على الخطوط في المخطط بشكل غير صحيح|خلل برمجي|
|CELLSNET-45700|تمت إزالة جزء الوظيفة الإضافية لبرنامج MS Excel 2016 من الملف بعد فتحه / حفظه بواسطة Aspose.Cells|خلل برمجي|
|CELLSNET-45693|لم تعد ورقة العمل محمية في ملف الإخراج في تحويل SpreadsheetML إلى XLSX|خلل برمجي|
|CELLSNET-45691|المستند تالف عند إعادة حفظه|خلل برمجي|
|CELLSNET-45690|يبدو أن الأنماط يتم نقلها بشكل خاطئ لبعض الخلايا - تحويل من SpreadsheetML إلى XLSX|خلل برمجي|
|CELLSNET-45688|لم يتم فرز عمود التاريخ بشكل صحيح|خلل برمجي|
|CELLSNET-45687|لا يتم نقل خصائص حماية أوراق العمل من SpreadsheetML|خلل برمجي|
|CELLSNET-45683|SpreadsheetML لا يعمل عنصر AllowSort في الإخراج XLSX|خلل برمجي|
|CELLSNET-45682|يطالبك MS Excel برسالة خطأ "عثر Excel على محتوى غير قابل للقراءة ...."|خلل برمجي|
|CELLSNET-45676|المستند تالف عند إعادة الحفظ بسبب عدم وجود مساحة في اسم ورقة العمل|خلل برمجي|
|CELLSNET-45673|يتم تطبيق نمط المحاذاة على SpredsheetML|خلل برمجي|
|CELLSNET-45670|Cells يتم فقد اللون عند التحويل إلى صورة|خلل برمجي|
|CELLSNET-45692|لا يقوم GridWeb بفك تجميع الصفوف عند النقر فوق الزر "+"|خلل برمجي|
|CELLSNET-45654|لا يتم استرداد التعليق المضاف إلى الخلية من جانب العميل - Aspose.Cells.GridWeb|خلل برمجي|
|CELLSNET-45645|يحدث الاستثناء عند فتح BUDGET RH 3_0.xlsm في GridWeb|خلل برمجي|
...
- [حدد كيفية عبور السلسلة في الإخراج HTML باستخدام HtmlCrossType](/cells/ar/net/specify-how-to-cross-string-in-output-html-using-htmlcrosstype/)
