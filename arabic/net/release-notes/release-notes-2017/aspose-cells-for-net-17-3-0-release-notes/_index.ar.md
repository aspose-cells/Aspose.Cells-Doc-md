---
title: Aspose.Cells for .NET 17.3.0 ملاحظات الإصدار
type: docs
weight: 100
url: /ar/net/aspose-cells-for-net-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 17.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.3.0/).
...
|CELLSNET-45168|الشكل مائل / مائل قليلاً مع تغيير موضع النص "1"|حشرة|
|CELLSNET-45163|يتم عكس النص في الشكل أثناء تحويل ورقة العمل إلى صورة|حشرة|
|CELLSNET-45161|زاوية الصورة في جدول البيانات مختلفة قليلاً|حشرة|
|CELLSNET-45159|تم عرض كائنات الشكل التلقائي بشكل غير صحيح|حشرة|
|CELLSNET-45138|PrintArea لا يتمكن من تحويل الصور بشكل صحيح|حشرة|
|CELLSNET-45136|يتم تدوير المربعات عند تحويل Excel إلى PDF|حشرة|
|CELLSNET-45182|لا يمكن تحميل جدول البيانات الناتج في Excel دون إصلاح|حشرة|
|CELLSNET-45143|ينتج Aspose.Cells جدولاً محوريًا تالفًا مع مرشح التقرير عند حفظه في XLSB|حشرة|
|CELLSNET-45135|تتداخل الصور أثناء استيراد HTML كـ XLSX|حشرة|
|CELLSNET-45134|يتم فقد عرض العمود أثناء استيراد HTML كـ XLSX|حشرة|
|CELLSNET-45133|يتم فقد نمط المحتوى أثناء استيراد HTML كـ XLSX|حشرة|
|CELLSNET-45132|يتم فقد WrapText الممكّن في HTML عند حفظه بتنسيق XLSX|حشرة|
|CELLSNET-45127|تم تغيير نمط الخط وحجمه بعد استيراد HTML كـ XLSX|حشرة|
|CELLSNET-45115|يؤدي تحديث الجدول المحوري بعد إضافة بعض البيانات إلى إنشاء ملف Excel تالف|حشرة|
|CELLSNET-45109|خطأ في تحديث الجدول المحوري المجمّع حسب عمود التاريخ|حشرة|
|CELLSNET-45081|لا تعمل ميزة تسميات الدمج في Pivot Table|حشرة|
|CELLSNET-45076|لا تعمل المحاذاة ويخرج النص من الخلية في تحويل Excel إلى HTML|حشرة|
|CELLSNET-45057|تحويل HTML إلى XLSX غير صحيح|حشرة|
|CELLSNET-45040|يتم تقديم بعض عناصر الحقول المحورية كقيم تاريخ بدلاً من أرقام|حشرة|
|CELLSNET-40265|مشكلة مع ثقافة ملفات الإدخال|حشرة|
|CELLSNET-45142|مشكلة في وظيفة VLOOKUP عند استخدام النطاق الخارجي|حشرة|
|CELLSNET-45150|من المستحيل توسيع أو طي الصفوف الأخيرة من ورقة العمل|حشرة|
|CELLSNET-45139|لا يعمل الترحيل مع اثنين من GridWebs على صفحة واحدة|حشرة|
|CELLSNET-45137|تحتوي الصفوف أو الأعمدة المجمعة على مشكلات في GridWeb عند تشغيلها على Internet Explorer 11|حشرة|
|CELLSNET-45203|تتداخل الأحرف عند تحويل ملف Excel إلى PDF|حشرة|
|CELLSNET-45196|المطبوعات مشوهة في XPS المُصدَّر|حشرة|
|CELLSNET-45187|يجب أن تكون العلامات بترتيب تصاعدي وفقًا لمواصفات TrueType|حشرة|
|CELLSNET-45169|تحذير: الحد الأقصى لحجم المنطقة هو 262144 بايت ، في SheetRender. إلى الصورة على Mono|حشرة|
|CELLSNET-45167|SheetRender.ToImage يجعل المحتويات مشوهة وغير كاملة على Mono|حشرة|
|CELLSNET-45166|يعرض SheetRender.ToImage رأس الصفحة وتذييلها فقط في Mono|حشرة|
|CELLSNET-43732|يؤدي التقديم إلى EMF واللصق في Word إلى تداخل النص في ملف PDF الناتج|حشرة|
|CELLSNET-45186|مخطط المنطقة لا يظهر في تصدير PDF|حشرة|
|CELLSNET-45178|يتم قطع تسميات المحاور أثناء عرض المخطط على الصورة|حشرة|
|CELLSNET-45177|تسميات المحاور مفقودة أثناء عرض المخطط على الصورة - II|حشرة|
|CELLSNET-45151|تفقد المخططات كل التنسيقات أثناء تقديم جدول البيانات إلى PDF|حشرة|
|CELLSNET-45147|المخطط مفقود أثناء عرض جدول البيانات على PDF|حشرة|
|CELLSNET-44998|تتغير تسميات بيانات المخطط بعد تحويل جدول البيانات إلى PDF|حشرة|
|CELLSNET-44984|لا يتم تقديم خط الاتجاه في الرسم التخطيطي الثاني بشكل صحيح في ملف PDF الناتج|حشرة|
|CELLSNET-41539|يتم تقديم صورة / رسم كلمة بيضاوي أخضر بشكل خاطئ حول المخطط في PDF|حشرة|
|CELLSNET-45197|لا ينقل Range.MoveTo التحقق من صحة البيانات والتنسيق الشرطي|حشرة|
|CELLSNET-45183|لم يتم تغيير السمة "مؤمن" لعنصر تحكم ActiveX (مربع تحرير وسرد)|حشرة|
|CELLSNET-45179|إعداد CodeName على ملف XLSX لا يعمل بشكل جيد|البق|
|CELLSNET-45175|لا يعمل تنسيق الصورة مع ملفات XLSX|حشرة|
|CELLSNET-45174|تعطل نطاق Print_Area بعد DeleteRange|حشرة|
|CELLSNET-45173|ملف XLSX تالف بعد الحفظ|حشرة|
|CELLSNET-45171|يؤدي نقل النطاق إلى تقليص النطاقات الداخلية لخلية واحدة|حشرة|
|CELLSNET-45162|لم يتم حساب / تحديث الرسم البياني بشكل صحيح بعد حذف النطاق|حشرة|
|CELLSNET-45155|Cells.InsertColumns / DeleteColumns يتسبب "#REF" في ListObject / الجدول|حشرة|
|CELLSNET-45154|لا يؤدي نقل النطاق إلى تحديث المراجع على ورقة أخرى|حشرة|
|CELLSNET-45145|لا يمكن حذف كائن CameraTool|حشرة|
|CELLSNET-45060|تم تغيير إعدادات خط الزر بعد عملية تحميل وحفظ بسيطة|حشرة|
|CELLSNET-43722|خطأ في الملف: ربما تكون البيانات قد فُقدت ، وألقى بها Excel أثناء فتح XLS|حشرة|
...
1. **يضيف أسلوب GlobalizationSettings.GetPivotGrandTotalName ()** - تحصل على اسم علامة "الإجمالي الكلي" في PivotTable.
...
1. [تخصيص إعدادات العولمة للجدول المحوري](/cells/ar/net/customize-globalization-settings-for-pivot-table/)
1. [تنفيذ وظيفة جانب العميل عند تغيير صفحة GridWeb](/cells/ar/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/ar/net/execute-client-side-function-on-gridweb-page-change/)
1. [تحقق من صحة ورقة العمل بأكملها بدلاً من الخلايا المحدثة فقط](/cells/ar/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
