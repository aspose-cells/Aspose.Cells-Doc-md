---
title: Aspose.Cells for .NET 8.6.0 ملاحظات الإصدار
type: docs
weight: 40
url: /ar/net/aspose-cells-for-net-8-6-0-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 8.6.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.0/)
...
## **ميزات جديدة**
 ...
 (CELLSNET-43880) - تعيين ماكرو لتشكيل عناصر التحكم


## **التحسينات**


 (CELLSNET-43832) - ورقة عمل الأشكال. تحديث محدد قيمة رمي الخلايا استثناء في بعض الأحيان

 (CELLSNET-43823) - لا يبدو أن تضمين دليل الخطوط مع CellsHelper يعمل
...
(CELLSNET-42377) - يتداخل عنوان تخطيط SmartArt مع تسطير تحت عنوان الصورة.
 ...
 (CELLSNET-43876) - قراءة مزدوجة لخلاصات سطر إرجاع السطر

 (CELLSNET-43864) - ينتج عن الجمع بين مصنفين XLSM مصنف تالف

 (CELLSNET-43839) - لا يتم عرض الصور الموجودة في جدول البيانات أثناء التحويل إلى PDF

 (CELLSNET-43837) - الصورة المرتبطة ليست داخل المخطط بعد إنشاء مثيل لكائن المصنف وحفظه
...
## **استثناءات**
 ...
 (CELLSNET-43866) - CellsException أثناء تقديم جدول بيانات إلى PDF

 (CELLSNET-43847) - يحدث استثناء عند محاولة استدعاء RefreshPivotTables
 ...
 (CELLSNET-43835) - System.OutOfMemoryException عند تحويل ملف XLS إلى تنسيق ملف PDF

 (CELLSNET-43865) - ArgumentException أثناء تقديم جدول البيانات إلى PDF و HTML

 (CELLSNET-43862) - NullReferenceException في Workbook.Save
...
## **البق**
 ...
 (CELLSNET-43875) - لا تعمل طباعة Gridweb على Chrome بشكل صحيح
...
يتم استخدامه لقراءة وحفظ البيانات الوصفية للملف.
 ...
 يضيف HtmlSaveOptions. ExportFrameScriptsAndProperties

 الإشارة إلى ما إذا كان يتم تصدير البرامج النصية للإطار وخصائص المستند. القيمة الافتراضية هي الحقيقية.



 يضيف خاصية Shape.MarcoName

 يتم استخدامه للحصول على اسم الماكرو وتعيينه.
