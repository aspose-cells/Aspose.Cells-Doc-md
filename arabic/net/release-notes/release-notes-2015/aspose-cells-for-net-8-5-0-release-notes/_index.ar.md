---
title: Aspose.Cells for .NET 8.5.0 ملاحظات الإصدار
type: docs
weight: 70
url: /ar/net/aspose-cells-for-net-8-5-0-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 8.5.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.0/)
...
## **ميزات جديدة**
 ...
 (CELLSNET-43640) - لا يمكن تقديم نموذج تنسيق التاريخ المخصص g و ge.mm.dd

 (CELLSNET-43682) - يجب أن تقوم الدالة ExportDataTableAsString بتصدير قيم الخلية مثل StringValueWithoutFormat

 (CELLSNET-41619) - تحويل مراجعة XLSB إلى XLSM

 (CELLSNET-40366) - كيفية معرفة ما إذا كان الترخيص مسجلاً


## **أداء**


 (CELLSNET-41836) - حدث System.StackOverflowException في Aspose.Cells.dll
...
## **البق**
 ...
 (CELLSNET-43667) - قيمة صيغة غير صحيحة بعد استدعاء ورقة العمل.

 (CELLSNET-43584) - تُفقد ملصقات المخططات عند التحويل إلى PDF
...
(CELLSNET-43658) - حدث خطأ في حساب استثناء الخلية في حساب الصيغة
 ...
 (CELLSNET-43693) - وضع نص في غير محله أثناء عرض جدول البيانات على الصورة

 (CELLSNET-43691) - يتم اقتطاع النص من الأسفل
...
(CELLSNET-43600) - لم يتم تقديم ملف Excel بشكل صحيح
 ...
 (CELLSNET-43453) - يتم قص النص

 (CELLSNET-43365) - لا يتم عرض الخط الأفقي
 ...
 (CELLSNET-42721) - إخراج pdf يحتوي على صفحة إضافية واحدة

 (CELLSNET-42720) - يتم قطع النص في ملف pdf الناتج
...
(CELLSNET-42474) - تم تغيير حجم الخط بعد التحويل إلى PDF
 ...
 (CELLSNET-43668) - لا يتم عرض المخطط الدائري ثلاثي الأبعاد بشكل جيد في تحويل Excel إلى PDF

 (CELLSNET-43657) - تم إنشاء المخطط بشكل غير صحيح بعد الحفظ باستخدام OoxmlSaveOptions.RefreshChartCache = true
...
(CELLSNET-42922) - يتم إخفاء خطوط البادئة عند التقديم إلى تنسيق ملف PDF
 ...
 (CELLSNET-43659) - تختلف بعض أنماط الخطوط

 (CELLSNET-43650) - Cells.CopyColumns لا ينسخ التنسيق الشرطي
...
## **استثناءات**
 ...
 (CELLSNET-43671) - لم يتم تعيين مرجع الكائن إلى مثيل استثناء كائن
...
## **ميزات جديدة**
 ...
 (CELLSNET-43692) - أنشئ منزلق تكبير في GridDesktop مثل ذلك الموجود في Excel
