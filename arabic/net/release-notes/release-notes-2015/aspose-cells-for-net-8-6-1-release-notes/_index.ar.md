---
title: Aspose.Cells for .NET 8.6.1 ملاحظات الإصدار
type: docs
weight: 30
url: /ar/net/aspose-cells-for-net-8-6-1-release-notes/
---
{{% alert color="primary" %}} 

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 8.6.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.1/)
...
## **ميزات جديدة**
 ...
 (CELLSNET-43935) - تجاهل العمود المخفي مع ضبط ExportTableOptions.PlotVisibleColumns على صحيح

 (CELLSNET-43925) - إضافة مرجع إلى وحدات ماكرو VBA في المصنف
...
## **التحسينات**
 ...
 (CELLSNET-42518) - القدرة على الوصول إلى الكائنات الفرعية عبر علامات ذكية
...
(CELLSNET-43973) - فقدت كلمة المرور للتعديل بعد إعادة حفظ XLSM
 ...
 (CELLSNET-43966) - تُرجع صيغة ISNONTEXT قيمة خاطئة بعد CalculateFormula

 (CELLSNET-43965) - DetectFileFormat (FileStream) يستهلك الكثير من الذاكرة لملف مضغوط

 (CELLSNET-43951) - تُفقد كلمة مرور التعديل في ملفات OOXML
...
(CELLSNET-43927) - #REF في صيغة قائمة مرجعية للكائن في ورقة عمل أخرى
 ...
 (CELLSNET-43737) - FileFormatInfo.IsEncrypted يحتوي على قيمة خاطئة للتنسيقات القديمة
...
## **استثناءات**
 ...
 (CELLSNET-43932) - خطأ في الشكل على الصورة! أثناء تقديم جدول بيانات إلى PDF
...
## **ميزات جديدة**
 ...
 (CELLSNET-44004) - دعم تحميل وحفظ ملف SpreasheetML (XML) - GridDesktop
...
## **البق**
 ...
 (CELLSNET-43970) - مشكلة الانحدار أثناء الترقية من 8.4.2.0 إلى 8.6.0
