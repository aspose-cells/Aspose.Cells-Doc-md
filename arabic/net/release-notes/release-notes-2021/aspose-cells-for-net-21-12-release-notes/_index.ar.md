...
|CELLSNET-49825|مشكلة في الأداء مع سمة ExportImagesAsBase64 في تحويل Excel إلى HTML|أداء|
|CELLSNET-49827|تم تخطي النطاق المحدد بشكل غير صحيح|حشرة|
|CELLSNET-49759|لا يزال يتم تصدير الخلايا الفارغة كعناصر XML فارغة|حشرة|
|CELLSNET-49817|لم يتم محاذاة النص إلى الوسط مع خط "Credit Suisse Type Light" أثناء تقديمه إلى Emf|حشرة|
|CELLSNET-49864|تظهر الكلمات بترتيب عكسي للنص من اليمين إلى اليسار في تحويل XLSX إلى PDF|حشرة|
|CELLSNET-49873|من Xlsx إلى pdf: يختلف فاصل الصفحة عن ملف pdf الذي تم إنشاؤه بواسطة Excel|حشرة|
|CELLSNET-49922|لا تلائم الأحرف صفحة واحدة ويتم تغيير موضع الطباعة في عرض Excel إلى PDF|حشرة|
|CELLSNET-49998|لا يمكن عرض ملف XLS محدد بعلامات HTML|حشرة|
|CELLSNET-49742|الاختلافات في chart1.xml بعد الحفظ|حشرة|
|CELLSNET-49875|علامات التجزئة المتداخلة من XLSX إلى EMF|حشرة|
|CELLSNET-49904|لم يتم تحويل مخطط إلى تواريخ PNG بشكل صحيح|حشرة|
|CELLSNET-49905|الانحدار: مشكلة عند تحويل الرسم البياني إلى PNG|حشرة|
|CELLSNET-49969|خطأ تجاوز عند حفظ مستند XLS في XLSX / XSLM|حشرة|
|CELLSNET-49760|تظهر المنطقة المدمجة بشكل خاطئ عند التحويل إلى html.|حشرة|
|CELLSNET-49789|لا ينبغي تغيير شبكة Excel الأصلية عند حفظ ملف html|حشرة|
|CELLSNET-49850|الصورة: معلمة FitToCell لا تعمل في العلامات الذكية للصور|حشرة|
|CELLSNET-49870|يصبح العنوان أوسع عند دمج أوراق متعددة في جداول بيانات Excel|حشرة|
|CELLSNET-49898|إظهار حدود الخلايا أثناء ملائمة الصور للخلايا باستخدام العلامات الذكية|حشرة|
|CELLSNET-49924|Aspose تم فتح ملفات XLSX التي تم إنشاؤها مع وجود خطأ|حشرة|
|CELLSNETCORE-301|تفشل إضافة ورقة العمل عندما يكون للارتباط التشعبي عنوان فارغ|حشرة|
