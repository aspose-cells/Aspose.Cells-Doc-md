...
|CELLSNET-47895|تم تشويه الصور في Excel إلى عرض PDF/HTML|
...
|CELLSNET-52126|تم تغيير بعض الأشكال بعد تحويل ملف Excel إلى PDF|
|CELLSNET-52197|تم تغيير المربعات عند تحويل مستند XLSX إلى PDF|
|CELLSNET-52330|لم يتم تقديم رسم الأشكال بشكل جيد في HTML|
...
|CELLSNET-52301|XLSX تخطيط إلى صورة: تم تقديم أشرطة مخطط مختلط مخصصة بشكل غير صحيح|
|CELLSNET-52336|لم يتم تقديم مخطط المدرج التكراري بشكل صحيح في التحويل من XLSX إلى HTML/PDF|
|CELLSNET-52292|يتم عرض النص على صفحة خاطئة في الإخراج PDF - تحويل Excel إلى PDF|
...
|CELLSNET-52332|يتم عرض Numbers كـ "#" أو رقم علمي أثناء التحويل إلى html|
|CELLSNET-52338| الناتج HTML غير محدد|
|CELLSNET-52344|الروابط التشعبية مفقودة في التحويل HTML إلى JSON|
