...
|CELLSNET-50041| لا يتم عرض ملفات صور BMP في الرأس / التذييل|التعزيز|
|CELLSNET-50108|XLS إلى PDF: أكشاك التحويل مع نفاد الذاكرة|أداء|
|CELLSNET-50128|يصبح تباعد الأسطر أضيق - تحويل Excel إلى PDF|حشرة|
|CELLSNET-50086|Cell ألوان تختفي بعد التحويل إلى PDF|حشرة|
|CELLSNET-49996|قد تضيع قيم النص المنسق للخلايا مع وضع MemoryPreference|حشرة|
|CELLSNET-50042| يتم تغيير اسم الخلايا أثناء التسجيل|حشرة|
|CELLSNET-50055|لا يتم تخطي خاصية اسم النطاق المحلي FullText إذا كانت ورقة العمل الأصلية تحتوي على علامة اقتباس أحادية|حشرة|
|CELLSNET-50154|فشل GridWeb في تحميل / حفظ من ذاكرة التخزين المؤقت لملف .csv|حشرة|
|CELLSNET-50063|تؤدي طباعة ملف Excel إلى عرض صفحتين بدلاً من صفحة واحدة|حشرة|
|CELLSNET-50094|لا يتم تقديم محتويات ورقة العمل بشكل صحيح في تحويل Excel إلى PDF|حشرة|
|CELLSNET-50129|يرتفع موضع الطباعة مع اتباع الصفحة - تحويل Excel إلى PDF|حشرة|
|CELLSNET-50131|الأحرف مفقودة - تحويل Excel إلى PDF|حشرة|
|CELLSNET-49578| تم حساب قيمة الحد الأقصى / الأدنى الخطأ من الرسوم البيانية بواسطة Aspose.Cells|حشرة|
|CELLSNET-50087|لا يتم عرض مخطط الإخراج بشكل صحيح بعد تغيير نوع السلسلة|حشرة|
|CELLSNET-50197|لا يمكن حذف وسيلة الإيضاح في مخطط الشلال أو إخفاؤها|حشرة|
|CELLSNET-50065|سلوك مختلف بخصوص طي وتوسيع مجموعات الصفوف متعددة المستويات|حشرة|
|CELLSNET-50137|XLSX إلى HTML "عقدة" متغير غير معرّف في البرنامج النصي|حشرة|
|CELLSNET-50157|AutoFitMergedCellsType.EachLine لا يعمل مع الأعمدة الملائمة تلقائيًا|حشرة|
|CELLSNET-50165|تم تغيير خط الدليل الصوتي بعد حفظ الملف|حشرة|
|CELLSNET-50208|يتم فقد بعض النصوص عند الحفظ بتنسيق Html|حشرة|
...
|CELLSNET-50016|رسم بياني لقيم محور EMF غير صحيحة|تراجع|
|
