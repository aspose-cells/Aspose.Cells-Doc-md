...
|CELLSNET-50334|الانحدار: XLS إلى PDF: لم يتم عرض العنوان بشكل صحيح|
...
|CELLSNET-50554|لا يتم تقديم المحتوى بشكل صحيح في تحويل Excel إلى PDF|
|CELLSNET-50316|لا تعمل النصوص الملتفة على المخططات عند إنشاء ملف PDF|
|CELLSNET-50411|لا يتم تقديم تسميات المحور الأفقي للمخطط بشكل صحيح في ملف PDF الناتج|
|CELLSNET-50341|مشكلة في طي وتوسيع المجموعات متعددة المستويات|
|CELLSNET-50368| تحويل مادة ODS إلى PDF غير صحيح|
|CELLSNET-50377|لا يتم تطبيق تنسيق "النص" المخصص في ملف XLS|
...
|CELLSNET-50494|مشكلة في لون الخلايا المنسقة شرطيًا في ملف XLSX الناتج|
