...
|CELLSNET-50152| مشاكل عرض التنسيقات المختلفة والأشكال الأخرى في ملف PDF و HTML لملف Excel|
|CELLSNET-50300|لا يتم عرض بعض الأشكال بشكل صحيح في تحويل Excel إلى PDF|
|CELLSNET-50301|قيمة غير صالحة للمرجع الخارجي في حقل DataSource في Pivot Table|
|CELLSNET-50241|الانحدار: تحويل CSV إلى PDF لا يعمل|
|CELLSNET-50268|تم إرجاع مصفوفة CellsArea فارغة لملفات CSV / TSV|
|CELLSNET-50269|اللغة الفنلندية - تفتقد الأرقام التي تم تنسيقها على أنها النسبة المئوية المسافة قبل رمز النسبة المئوية|
...
|CELLSNET-50302|الانحدار: التحويل إلى أرقام HTML لم يتم تقديمه بشكل صحيح|
|CELLSNET-50328|Cell تصبح الخلفية سوداء بعد التحويل إلى pdf|
|CELLSNET-50225|يتم إرجاع وسيلة إيضاح الرسم البياني عند حفظ Excel في PDF|
...
|CELLSNET-50308|النطاق إلى PNG: الإخراج ليس كما هو متوقع|
...
|CELLSNET-50294|يتم تحويل أزرار تحكم ActiveX إلى أشكال ويتم إتلاف الملف من أجل XLS إلى XLSM ثم العودة إلى XLS|
