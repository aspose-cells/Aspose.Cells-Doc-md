...
|CELLSNET-51491|تم استخدام القيم الخاطئة في سلسلة المخططات عند التقديم إلى صورة أو HTML|
|CELLSNET-51525|يختلف المخطط الانحداري عند تصديره إلى HTML / PNG أو PDF|
...
|CELLSNET-51507|يتم قراءة القيم الرقمية من ملف XLSX كـ 0|
