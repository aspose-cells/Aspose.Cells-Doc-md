---
title: Aspose.Cells for .NET 22.9 ملاحظات الإصدار
type: docs
weight: 4
url: /ar/net/aspose-cells-for-net-22-9-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for .NET 22.9](https://www.nuget.org/packages/Aspose.Cells/22.9.0).
