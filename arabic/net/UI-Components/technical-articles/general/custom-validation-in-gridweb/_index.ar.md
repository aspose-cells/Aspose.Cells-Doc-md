...
type: docs
weight: 90
url: /ar/net/custom-validation-in-gridweb/
keywords: validation,custom,server
---
##  **سيناريوهات الاستخدام المحتملة**
Aspose.Cells.GridWeb يوفر أنواعًا من التحقق من الصحة أكثر من المعتاد المحدد في واجهة برمجة تطبيقات التحقق من صحة الخلايا.
نوع التحقق الطبيعي في الخلايا:<https://docs.aspose.com/cells/net/data-validation/>

 استخدام التحقق العادي في عرض GridWeb:<https://github.com/aspose-cells/Aspose.Cells-for-.NET/blob/master/Examples_GridWeb/GridWeb.Net4/CSharp/Miscellaneous/Common/DataValidation.aspx.cs>

 هنا يمكننا التحقق من GridValidationType:<https://reference.aspose.com/cells/net/aspose.cells.gridweb.data/gridvalidationtype/>

يوجد أدناه التحقق الموسع الذي يمكننا استخدامه في GridWeb
...
نتيجة:
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_dropdownlist.png) 
...
نتيجة:
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_freelist.png)  
...
```
إضافة وظيفة جافا سكريبت في صفحة العميل
```javascript
...
نتيجة:
بعد إدخال قيمة غير صالحة
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_customexpression.png)  
...
نتيجة:
 بعد إدخال قيمة غير صالحة
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_bool.png)  

 بعد إدخال القيمة الحقيقية
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_bool2.png)  
...
نتيجة:
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_datetime.png)  
...
نتيجة:
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_checkbox.png)  
...
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_customfunction.png)  
...
```
النتيجة: بعد إدخال القيمة عند g6
![ما يجب القيام به: نتيجة التحقق من الصحة](gridvalidation_customserverfunction.png) 
