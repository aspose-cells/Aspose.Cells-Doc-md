...
{{% alert color="primary" %}} 
 ...
 يؤدي تعيين AltText للارتباط التشعبي للصورة إلى ملء وظيفة مماثلة لتعيين ملف<ALT> علامة في HTML. يتم عرض النص فقط في حالة عدم عرض الصورة التي تم ربطها تشعبيًا. (على سبيل المثال ، إذا لم تكن الصورة في الموقع المحدد.) إذا لم يتم العثور على صورة الارتباط التشعبي الثاني ، فسيبدو إخراج مقتطف الشفرة أدناه على النحو التالي.
