...
**مهم:**لمزيد من المعلومات حول أنواع التحقق من الصحة (أو أوضاع التحقق مثل**مطلوب التحقق من الصحة**, **التحقق من صحة التعبيرات العادية** و**التحقق المخصص** ) والتنفيذ**التحقق المخصص** ، يرجى الرجوع إلى[العمل مع عمليات التحقق من الصحة في أوراق العمل.](/cells/ar/net/working-with-validations-in-worksheets/)
...
## **الوصول إلى التحقق من صحة العمود**
...
-  يحرر**تصديق** السمات ، إذا رغبت في ذلك
