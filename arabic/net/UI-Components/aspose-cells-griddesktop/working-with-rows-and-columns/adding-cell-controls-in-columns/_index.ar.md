...
**الأهمية:** إذا كنت ترغب في إضافة عناصر تحكم الخلية إلى خلية واحدة بدلاً من العمود بأكمله ، فيمكنك الرجوع إلى[إضافة Cell ضوابط في أوراق العمل.](/cells/ar/net/adding-cell-controls-in-worksheets/)
### **إضافة زر**
...
-  يضيف**زر** لأي محدد**عمود** التابع**ورقة عمل**
...
-  أضف Aspose.Cells.GridDesktop control إلى ملف**استمارة**
-  الوصول إلى أي ملفات**ورقة عمل**
-  يضيف**خانة الاختيار** لأي محدد**عمود** التابع**ورقة عمل**
...
-  يضيف**صندوق التحرير** (تحتوي على عناصر أو قيم) لأي محدد**عمود** التابع**ورقة عمل**
