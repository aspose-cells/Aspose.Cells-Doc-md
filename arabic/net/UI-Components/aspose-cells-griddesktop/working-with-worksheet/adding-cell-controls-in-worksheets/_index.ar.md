...
**مهم:**إذا كنت ترغب في إضافة عناصر تحكم الخلية إلى جميع خلايا العمود بدلاً من إضافة واحدة تلو الأخرى ، فيمكنك الرجوع إليها[إدارة Cell عناصر التحكم في الأعمدة.](/cells/ar/net/adding-cell-controls-in-worksheets/)
### **إضافة زر**
...
**مهم:**تحتوي جميع أحداث عناصر التحكم في الخلية على ملف**CellControlEventArgs**الوسيطة التي توفر أرقام الصفوف والأعمدة للخلية التي تحتوي على عنصر تحكم الخلية (الذي يتم تشغيل الحدث الخاص به).
### **إضافة CheckBox**
