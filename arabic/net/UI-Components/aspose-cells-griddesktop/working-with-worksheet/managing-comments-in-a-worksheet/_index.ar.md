...
## **إزالة التعليقات**
 لإزالة تعليق موجود ، يمكن للمطورين ببساطة الوصول إلى ورقة العمل المطلوبة وبعد ذلك**إزالة** تعليق من**تعليقات** جمع**ورقة عمل** من خلال تحديد الخلية (باستخدام اسمها أو الصف ورقم العمود) التي تحتوي على تعليق.
