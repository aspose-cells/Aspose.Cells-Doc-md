...
##  0. قم بتعيين مسار المجلد الصحيح في Config
 **"Config.FileCacheDirectory"** لملف ذاكرة التخزين المؤقت للمصنف.
 **"Config.PictureCacheDirectory"** لذاكرة التخزين المؤقت لملفات الصور في المصنف.

 للحصول على تفاصيل التخزين ، يرجى التحقق من هذا[مرشد](/net/aspose-cells-gridjs/storage/)
