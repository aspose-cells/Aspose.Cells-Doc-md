---
title: Aspose.Cells for Python via .NET 23.1 ملاحظات الإصدار
type: docs
weight: 12
url: /ar/python-net/aspose-cells-for-python-net-23-1-release-notes/
---
{{% alert color="primary" %}} 

هذه هي النسخة الأولى لـ Aspose.Cells for Python via .NET.
تحتوي هذه الصفحة على ملاحظات إصدار Aspose.Cells for Python via .NET 23.1.
