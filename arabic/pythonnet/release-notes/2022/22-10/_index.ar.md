...
|CELLSNET-51419|تم حذف الارتباط الخارجي للجدول المحوري عند تحويل ملف XLS إلى XLSM|
|CELLSNET-51984|XLSX الملف الذي يحتوي على ملف PivotTable تالف بعد إعادة الحفظ|
...
|CELLSNET-52073|مشكلة تتعلق بخط Arial Tur في Excel لعرض PDF|
...
|CELLSNET-52081|يؤدي فتح XLSX ملف تمت إزالة أنماطه إلى حدوث استثناء|
