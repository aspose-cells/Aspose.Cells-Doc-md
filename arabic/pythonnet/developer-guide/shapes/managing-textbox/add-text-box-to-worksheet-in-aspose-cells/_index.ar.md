...
type: docs
weight: 10
url: /ar/python-net/add-text-box-to-worksheet-in-aspose-cells/
description: كيفية إضافة/إدراج مربع نص إلى ورقة عمل في Aspose.Cells for Python via .NET.
...
## إضافة مربع نص إلى ورقة عمل في Aspose.Cells for Python via .NET
