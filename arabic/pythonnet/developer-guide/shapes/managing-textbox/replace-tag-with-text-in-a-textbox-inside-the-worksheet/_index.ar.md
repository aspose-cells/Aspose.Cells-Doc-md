---
title: استبدال العلامة بالنص في مربع نص داخل ورقة العمل باستخدام Python.NET
linktitle: استبدال العلامة بالنص في مربع نص داخل ورقة البيانات
type: docs
weight: 1100
url: /ar/python-net/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: تعرّف على كيفية استبدال العلامات بالنصوص في مربعات النص داخل أوراق عمل إكسل باستخدام Aspose.Cells for Python via .NET.
---
