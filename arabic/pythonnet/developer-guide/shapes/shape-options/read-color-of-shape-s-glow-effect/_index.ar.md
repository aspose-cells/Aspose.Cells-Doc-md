---
title: قراءة لون تأثير إضاءة الشكل
type: docs
weight: 330
url: /ar/python-net/read-color-of-shape-s-glow-effect/
---

## سيناريوات الاستخدام المحتملة

إذا كنت ترغب في قراءة لون تأثير الإضاءة لأي شكل، يرجى استخدام الخاصية [**Shape.glow.color**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/gloweffect/color). ستساعدك في العثور على الخصائص المتعلقة بلون تأثير الإضاءة للشكل.
