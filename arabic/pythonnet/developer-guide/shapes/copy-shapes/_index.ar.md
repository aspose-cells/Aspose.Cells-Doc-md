...
type: docs
weight: 200
url: /ar/python-net/copy-shapes-between-worksheets/
description: يعرض هذا المقال كيفية نسخ الأشكال بين أوراق العمل من خلال API الخاص بـ Aspose.Cells لـ Python via .NET.
keywords: مكتبة بايثون لإكسل، نسخ الأشكال بين أوراق العمل في بايثون، كيفية نسخ صورة من ورقة عمل إلى أخرى في بايثون، كيفية نسخ مخطط من ورقة عمل إلى أخرى في بايثون، كيفية نسخ عناصر التحكم والكائنات الرسومية الأخرى من ورقة عمل إلى أخرى في بايثون.
---

{{% alert color="primary" %}}

أحيانًا، تحتاج إلى نسخ عناصر على ورقة عمل، على سبيل المثال، الصور، المخططات وغيرها من الكائنات الرسومية، بين أوراق العمل. يدعم Aspose.Cells لـ بايثون via .NET هذه الميزة. يمكن نسخ المخططات، الصور، والكائنات الأخرى بدقة عالية.
