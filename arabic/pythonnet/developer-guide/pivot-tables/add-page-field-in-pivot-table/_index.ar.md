...
عندما تعمل بالفعل مع مثيل `PivotField`، يمكنك تمريره مباشرة إلى `PivotTable.page_fields.add`. يتم إنشاء الجدول المحوري وحقل الصفحة تماماً كما في السيناريو السابق؛ فقط تسجيل منطقة الصفحة النهائية يتم استبداله باستدعاء واجهة المستوى المنخفض.
...
يؤدي تعيين `current_page_item` إلى فهرس حقيقي إلى اختيار عنصر الصفحة هذا فقط. الفهرس هو موضع العنصر في قائمة العناصر المرتبة لحقل الصفحة، فعلى سبيل المثال يحدد `1` العنصر الثاني بعد الفرز.
