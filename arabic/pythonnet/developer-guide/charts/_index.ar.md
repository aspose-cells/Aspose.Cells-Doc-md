...
description: تعلم كيفية استخدام Aspose.Cells لبايثون via .NET لإنشاء رسومات بيانية في إكسل من مايكروسوفت. سيُظهر دليلنا أنواع الرسوم البيانية التي يمكن إنشاؤها، بالإضافة إلى كيفية تخصيص مظهرها وتنسيقها.
keywords: Aspose.Cells لبايثون via .NET، إنشاء الرسوم البيانية، إكسل من مايكروسوفت، أنواع الرسوم البيانية، التخصيص، المظهر، التنسيق.
linktitle: رسوم بيانية
type: docs
weight: 130
url: /ar/python-net/creating-charts/
...
من الممكن إضافة مجموعة متنوعة من الرسوم البيانية إلى جداول البيانات باستخدام Aspose.Cells لبايثون via .NET. يوفر Aspose.Cells لبايثون via .NET العديد من كائنات الرسم البياني المرنة. يناقش هذا الموضوع كائنات الرسم البياني في Aspose.Cells.
...
يوفر Aspose.Cells لبايثون via .NET مجموعة خاصة من الفئات في مساحة الأسماء [**Aspose.Cells.Charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts) تُستخدم لإنشاء الرسوم المدعومة بواسطة Aspose.Cells لبايثون via .NET. تُستخدم هذه الفئات لإنشاء **كائنات الرسم البياني**، التي تعمل كعناصر بناء الرسوم. تُدرج كائنات الرسم البياني أدناه:
...
إضافة أي نوع من الرسم البياني إلى ورقة العمل باستخدام مجموعة [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/charts). كل عنصر في مجموعة [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/charts) يمثل كائن [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart). الكائن [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) يغلف جميع كائنات الرسم البياني الأخرى المطلوبة لتخصيص مظهر الرسم البياني. يوضح القسم التالي كيفية استخدام بعض كائنات الرسم البياني الأساسية لإنشاء رسم بياني بسيط.

### **إنشاء رسم بياني باستخدام Aspose.Cells لبايثون via .NET**

**الخطوات:**

1. أضف بعض البيانات إلى خلايا ورقة العمل باستخدام الطريقة [**put_value**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/put_value) لكائن [**Cell**](https://reference.aspose.com/cells/python-net/aspose.cells/cell).
   سيتم استخدام هذا كمصدر بيانات للرسم البياني.
1. أضف رسم بياني إلى ورقة العمل عن طريق استدعاء الطريقة [**add**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection/add) لمجموعة الكائنات [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection)، التي تم تغليفها في الكائن [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet).
1. حدد نوع الرسم البياني بتعداد [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype).
   على سبيل المثال، يستخدم المثال أدناه القيمة [**ChartType.PYRAMID**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype/) كنوع للرسم البياني.
1. اصطحب الكائن [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) المكون حديثًا من مجموعة [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection) عن طريق تمرير فهرسه.
1. استخدم أي من كائنات الرسم البياني المغلفة في الكائن [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) لإدارة الرسم البياني.
   يستخدم المثال أدناه كائن الرسم البياني [**SeriesCollection**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/seriescollection) لتحديد مصدر بيانات الرسم البياني.
...
من الممكن إنشاء العديد من أنواع الرسوم البيانية باستخدام Aspose.Cells لبايثون via .NET. جميع الرسوم البيانية القياسية المدعومة بواسطة Aspose.Cells لبايثون via .NET محددة مسبقًا في تعداد يسمى [**Aspose.Cells.Charts.ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype).
...
في المثال أعلاه، ببساطة تغيير [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) إلى *Line* يُنشئ رسم بياني خطي. يتم توفير المصدر الكامل أدناه. عند تنفيذ الشيفرة، يتم إضافة رسم بياني خطي إلى ورقة العمل.

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Charts-ManipulateChart-HowToCreateLineChart-1.py" >}}

#### **رسم بياني فقاعي**

لإنشاء رسم بياني فقاعي، يجب تعيين [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) إلى [**ChartType.BUBBLE**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) وضبط خصائص إضافية بمثابة BubbleSizes, Values & XValues وفقًا لذلك. عند تنفيذ الشيفرة التالية، يتم إضافة رسم بياني فقاعي إلى ورقة العمل.

#### **رسم بياني خطي بمؤشرات البيانات**

لإنشاء خط برسم بياني البيانات، يجب ضبط [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) على *ChartType.LineWithDataMarkers* ويجب ضبط بعض الخصائص الإضافية مثل منطقة الخلفية، علامات السلاسل، القيم والقيم السينية وفقًا لذلك. عند تنفيذ الشفرة التالية، يتم إضافة خط برسم بياني البيانات إلى ورقة العمل.

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Charts-CreateLineWithDataMarkerChart-1.py" >}}

## **مواضيع متقدمة**
- [قراءة وتلاعب شكل بيانات Excel 2016](/cells/ar/python-net/read-and-manipulate-excel-2016-charts/)
- [إدارة محاور مخططات Excel](/cells/ar/python-net/chart-axes/)
- [ضبط مظهر الرسم البياني](/cells/ar/python-net/setting-chart-appearance/)
- [أنواع المخططات](/cells/ar/python-net/chart-types/)
- [تخصيص المخططات](/cells/ar/python-net/customizing-charts/)
- [تعيين مصدر البيانات للمخطط](/cells/ar/python-net/data-formatting-in-charts/)
- [إدارة تسميات البيانات في مخططات Excel](/cells/ar/python-net/insert-datalabels-to-chart/)
- [إنشاء مخطط بمعالجة العلامات الذكية](/cells/ar/python-net/generate-chart-by-processing-smart-markers/)
- [الحصول على ورقة العمل من المخطط](/cells/ar/python-net/get-worksheet-of-the-chart/)
- [إدارة الأسطورة في مخططات Excel](/cells/ar/python-net/chart-legend/)
- [تلاعب بموقع وحجم وتصميم المخطط](/cells/ar/python-net/manipulate-position-size-and-designer-chart/)
- [إنشاء مخطط دائري مع خطوط قيادة](/cells/ar/python-net/creating-pie-chart-with-leader-lines/)
- [الأشكال في المخططات](/cells/ar/python-net/controls-in-charts/)
