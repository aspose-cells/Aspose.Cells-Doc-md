---
title: استيراد البيانات ووضعها بذكاء باستخدام العلامات الذكية في Python عبر .Net
linktitle: علامات ذكية
type: docs
weight: 190
url: /ar/python-net/using-smart-markers/
description: استيراد البيانات ووضعها بذكاء في ملفات Excel النموذجية باستخدام Aspose.Cells for Python عبر .Net library.
---
## **مقدمة**
...
- **تصاعدي:** أو**تنازلي:** - فرز البيانات في علامات ذكية. إذا كان n هو 1 ، فإن العمود هو المفتاح الأول للفرز. يتم فرز البيانات بعد معالجة مصدر البيانات. على سبيل المثال: & = Table1.Field3 (تصاعدي: 1).
...
من السهل جدًا معالجة العلامات الذكية. ما يلي هو مقتطف رمز في Python عبر .Net ، يوضح كيف يتم ذلك.
