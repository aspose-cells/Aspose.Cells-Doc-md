...
- أشرطة البيانات لتصور القيم الرقمية
- موازنات الألوان للتظليل المتدرج للخلايا
- مجموعات الرموز للمؤشرات الرسومية
- قواعد أعلى/أسفل
- تنسيق فترات زمنية محددة

يعرض هذا المثال أنواعًا مختلفة من التنسيق الشرطي المتقدم باستخدام Python.NET:
