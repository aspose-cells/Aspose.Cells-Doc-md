...
description: كيفية استخدام مكتبة Aspose.Cells لـ Python via .NET لتطبيق تنسيق الرموز الشرطي. من خلال تعديل هذه المعايير، يكون لديك مزيد من التحكم في مظهر الخلايا ومظهرها.
keywords: Aspose.Cells، تنسيق الرموز الشرطي باستخدام رموز الأيقونات، بايثون، شرطي، تنسيق
type: docs
weight: 70
url: /ar/python-net/how-to-add-icon-sets-conditional-formatting/
---
...
## **كيفية إضافة تنسيق الرموز الشرطي باستخدام رموز الأيقونات باستخدام Aspose.Cells لـ Python via .NET**

يدعم Aspose.Cells لـ Python via .NET تمامًا التنسيق الشرطي المقدم من قبل Microsoft Excel 2007 والإصدارات اللاحقة بصيغة XLSX على الخلايا عند التشغيل. يُظهر هذا المثال تمرينًا لتنسيق الرموز باستخدام رموز الأيقونات مع مجموعات مختلفة من السمات.
