...
type: docs
weight: 10
url: /ar/python-net/how-to-format-number-to-percentage/
description: سوف تقدم هذه المقالة شرحًا لكيفية تنسيق الرقم إلى نسبة مئوية باستخدام واجهة برمجة تطبيقات Aspose.Cells للبايثون via .NET.
...
## **كيفية تنسيق الرقم إلى نسبة مئوية في Aspose.Cells للبايثون via .NET**
تشكيل الأرقام إلى نسب مئوية في Aspose.Cells للبايثون via .NET هو عملية مباشرة. تعتبر Aspose.Cells مكتبة قوية تتيح لك إنشاء وتعديل وتحويل ملفات Excel في تطبيقات .NET دون الحاجة إلى تثبيت Microsoft Excel على نظامك. إليك كيفية تشكيل الأرقام إلى نسب مئوية باستخدام Aspose.Cells للبايثون via .NET:
