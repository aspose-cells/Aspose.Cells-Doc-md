...
type: docs
weight: 10
url: /ar/python-net/how-to-format-number-to-fraction/
description: سوف تقدم هذه المقالة شرحًا لكيفية تنسيق الأرقام إلى كسر باستخدام واجهة برمجة تطبيقات Aspose.Cells للبايثون via .NET.
...
## **كيفية تنسيق الرقم إلى كسر في Aspose.Cells للبايثون via .NET**
تنسيق الأرقام إلى كسور في Aspose.Cells للبايثون via .NET هو عملية مباشرة. تعد Aspose.Cells للبايثون via .NET مكتبة قوية تتيح لك العمل مع ملفات Excel في تطبيقات .NET دون الحاجة إلى تثبيت Microsoft Excel. توفر مجموعة واسعة من الميزات، بما في ذلك تنسيق الأرقام ككسور.

إليك دليل خطوة بخطوة لكيفية تنسيق الأرقام إلى كسور في Aspose.Cells للبايثون via .NET:

### الخطوة 1: تثبيت Aspose.Cells للبايثون via .NET
