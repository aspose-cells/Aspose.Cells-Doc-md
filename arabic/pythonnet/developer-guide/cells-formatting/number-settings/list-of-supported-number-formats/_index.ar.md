...
description: Aspose.Cells هي مكتبة بايثون لمعالجة ملفات الجدول الإلكتروني، والتي تدعم مجموعة من تنسيقات الأرقام. تقدم هذه المقالة قائمة بتنسيقات الأرقام المدعومة لتساعد المستخدمين على اختيار التنسيق المناسب حسب احتياجاتهم.
keywords: Aspose.Cells، مكتبة بايثون لملفات إكسل، جدول إلكتروني، تنسيق رقم، قائمة، مدعوم
type: docs
weight: 30
url: /ar/python-net/list-of-supported-number-formats/
---

## **Aspose.Cells for Python via .NET**
يقدم مكون Aspose.Cells لبايثون via .NET بعض تنسيقات الأرقام المدمجة لتكوين عرض الأرقام والتواريخ. يمكن تطبيق هذه التنسيقات المدمجة باستخدام خاصية **Number** لكائن **Style**. تُعطى جميع التنسيقات الموحدة أرقامًا فريدة. يمكن للمطورين تخصيص رقم معين الخاص بهم إلى خاصية *Number* من كائن **Style** وبالتالي يتم تطبيق تنسيق العرض. هذه الطريقة أسرع. إليك تنسيقات الأرقام المدمجة المدعومة من قبل مكون Aspose.Cells لبايثون via .NET:
