...
type: docs
weight: 50
url: /ar/python-net/link-cells-to-xml-map-elements/
---

## **سيناريوهات الاستخدام المحتملة**

يمكن ربط خلاياك بعناصر خريطة XML باستخدام Aspose.Cells لـ بايثون via .NET. يرجى استخدام طريقة [**Cells.link_to_xml_map()**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/link_to_xml_map) لهذا الغرض.
