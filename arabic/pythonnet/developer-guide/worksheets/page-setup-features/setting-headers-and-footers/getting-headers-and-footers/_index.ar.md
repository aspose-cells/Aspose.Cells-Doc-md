...
description: تشرح هذه المقالة كيفية الحصول على رؤوس وتذييلات بصورة برمجية من ملفات Excel أو OpenOffice باستخدام واجهة برمجة تطبيقات Aspose.Cells for Python via .NET.
keywords: مكتبة Excel Python، الحصول على رؤوس وتذييلات بواسطة Python، تحليل رؤوس وتذييلات إلى قائمة أوامر باستخدام Python.
---
...
## **كيفية الحصول على رؤوس وتذييلات في MS Excel**
...
## **كيفية الحصول على رؤوس وتذييلات باستخدام مكتبة Aspose.Cells for Python Excel**
...
## **كيفية تحليل رؤوس وتذييلات إلى قائمة أوامر**
...
توفر Aspose.Cells for Python via .NET الطريقة [**Worksheet.page_setup.get_commands**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/get_commands/#str) لتحليل رؤوس الصفحات والقوائم كأمر.
