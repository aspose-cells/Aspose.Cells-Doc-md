...
description: يشرح هذا المقال كيفية استخدام رمز العينات Aspose.Cells لـ Python via .NET لتحديد ما إذا كان حجم الورق لجدول العمل هو تلقائي برمجياً.
keywords: مكتبة Excel الخاصة ببيثون، بيثون تحديد ما إذا كان حجم الورق لجدول العمل تلقائياً.
---
