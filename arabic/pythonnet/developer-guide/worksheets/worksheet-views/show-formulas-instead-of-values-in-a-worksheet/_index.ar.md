...
description: تقدم هذه المقالة رمزًا تجريبيًا لاستخدام واجهة برمجة التطبيقات Aspose.Cells لـ Python via .NET لعرض الصيغ بشكل برمجي بدلاً من القيم في ورقة عمل أو جدول بيانات Excel.
keywords: مكتبة Excel بلغة Python، عرض الصيغ بدلاً من القيم في ورقة العمل، كيفية إظهار الصيغ باستخدام Python.
---
