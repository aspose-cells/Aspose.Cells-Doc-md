---
title: كيفية التحكم في عرض دفتر العمل
type: docs
weight: 600
url: /ar/python-net/how-to-control-workbook-view/
description: تعلم كيفية التحكم في طريقة عرض المصنف عبر واجهة برمجة التطبيقات Aspose.Cells for Python via .NET.
