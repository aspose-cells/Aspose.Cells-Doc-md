...
### **مرحبًا بك في Aspose.Cells لوثائق JasperReports!**
...
Aspose.Cells لـ JasperReports هو حل مرن يسهل تصدير التقارير من JasperReports و JasperServer إلى تنسيقات ملفات Excel Microsoft. يتم تحويل كافة ميزات التقرير إلى جداول بيانات Microsoft Excel بأعلى درجة من الدقة.
...
**يتم إنشاء نموذج تقرير باستخدام Aspose.Cells لـ JasperReports** 
