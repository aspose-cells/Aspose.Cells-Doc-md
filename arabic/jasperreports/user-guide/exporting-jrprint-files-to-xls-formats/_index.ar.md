...
يوفر Aspose.Cells لـ JasperReports فئة تسمى ACXlsExporter لتصدير التقارير إلى ملفات XLS. يأخذ ملف jrprint أو كائن JasperPrint كمدخل له ، ويصدره إلى ملف XLS.
