---
title: Aspose.Cells لـ PHP عبر Java 22.9 ملاحظات الإصدار
type: docs
weight: 4
...
{{% alert color="primary" %}}
 ...
 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells لـ PHP عبر Java 22.9](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.9/).
