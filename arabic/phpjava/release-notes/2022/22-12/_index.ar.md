---
title: Aspose.Cells for PHP via Java 22.12 ملاحظات الإصدار
type: docs
weight: 1
url: /ar/php-java/aspose-cells-for-php-via-java-22-12-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for PHP via Java 22.12](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.12/).
