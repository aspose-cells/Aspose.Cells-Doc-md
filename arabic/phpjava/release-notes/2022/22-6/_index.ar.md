---
title: Aspose.Cells for PHP via Java 22.6 ملاحظات الإصدار
type: docs
weight: 7
url: /ar/php-java/aspose-cells-for-php-via-java-22-6-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for PHP via Java 22.6](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.6/).
