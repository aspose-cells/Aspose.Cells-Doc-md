---
title: Aspose.Cells لـ PHP عبر Java 22.4 ملاحظات الإصدار
type: docs
weight: 9
...
{{% alert color="primary" %}}
 ...
 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells لـ PHP عبر Java 22.4](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.4/).
