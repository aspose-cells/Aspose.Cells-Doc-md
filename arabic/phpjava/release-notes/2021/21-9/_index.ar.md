---
title: Aspose.Cells لـ PHP عبر Java 21.9 ملاحظات الإصدار
type: docs
weight: 5
...
{{% alert color="primary" %}}
 ...
 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells لـ PHP عبر Java 21.9](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-21.9/).
