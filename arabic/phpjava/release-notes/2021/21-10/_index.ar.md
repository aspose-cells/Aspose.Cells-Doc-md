---
title: Aspose.Cells لـ PHP عبر Java 21.10 ملاحظات الإصدار
type: docs
weight: 3
...
{{% alert color="primary" %}}
 ...
 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells لـ PHP عبر Java 21.10](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-21.10/).
