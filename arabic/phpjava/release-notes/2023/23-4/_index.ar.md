---
title: Aspose.Cells for PHP via Java 23.4 ملاحظات الإصدار
type: docs
weight: 9
url: /ar/php-java/aspose-cells-for-php-via-java-23-4-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for PHP via Java 23.4](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.4/).
