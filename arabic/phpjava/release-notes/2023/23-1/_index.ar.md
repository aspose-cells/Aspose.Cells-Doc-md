---
title: Aspose.Cells for PHP via Java 23.1 ملاحظات الإصدار
type: docs
weight: 12
url: /ar/php-java/aspose-cells-for-php-via-java-23-1-release-notes/
---
{{% alert color="primary" %}}

 تحتوي هذه الصفحة على ملاحظات الإصدار لـ[Aspose.Cells for PHP via Java 23.1](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.1/).
