...
type: docs
weight: 5
url: /ar/php-java/features/
keywords: "php, excel, api, features"
description: "ميزات Aspose.Cells for PHP via Java."
---

## **نظرة عامة على ميزات Aspose.Cells for PHP via Java**
تقدم هذا القسم مقارنة بين توفر الميزات بين Aspose.Cells for Java و Aspose.Cells لـ PHP via Java.
...
|**الميزة**|**الوصف**|**Aspose.Cells for Java**|**Aspose.Cells لـ PHP via Java**|
| :- | :- | :- | :- |
...
|**الميزة**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
| :- | :- | :- |
...
|إدراج/حذف أو إخفاء الصفوف، الأعمدة والأوراق| {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
|**الميزة**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
| :- | :- | :- |
|تطبيق تنسيق جميع الخصائص الخطية في الخلايا بما في ذلك الخطوط، الألوان، التأثيرات، الحدود والتظليل.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|تطبيق إعدادات التنسيق على ورقة عمل، صف، عمود أو مجموعة خلايا الخ.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
### **ميزات إعداد الصفحة**
