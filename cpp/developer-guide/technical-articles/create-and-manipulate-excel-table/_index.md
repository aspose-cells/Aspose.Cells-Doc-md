...
The following sample code loads the [sample excel file](attachments/22970935/23167015.xlsx) and then creates a list object or table in a range A1:H10, then it makes use of its various methods and sets show subtotal. Then it sets the total functions of 3rd, 4th and 5th columns to Min, Max and Count respectively and writes the [output excel file](attachments/22970935/23167016.xlsx). The following screenshot shows the effect of the sample code on the [sample excel file](attachments/22970935/23167015.xlsx) after execution.

![todo:image_alt_text](create-and-manipulate-excel-table_1.png)
## **Sample Code**
{{< gist "aspose-com-gists" "0edd1c91ebaa6cd099be1200b1ec7480" "Examples-CellsCPP-TechnicalArticles-CreateAndManipulateExcelTable.cpp" >}}
