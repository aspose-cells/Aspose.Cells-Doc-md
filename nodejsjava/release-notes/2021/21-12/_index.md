...
type: docs
weight: 1
url: /nodejs-java/aspose-cells-for-node-js-via-java-21-12-release-notes/
aliases: [/nodejsjava/aspose-cells-for-node-js-via-java-21-12-release-notes/]
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for Node.js via Java 21.12](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.12/).
