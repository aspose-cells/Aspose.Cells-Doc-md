...
type: docs
weight: 7
url: /nodejsjava/aspose-cells-for-node-js-via-java-21-6-release-notes/
aliases: [/java/aspose-cells-for-node-js-via-java-21.6-release-notes/]
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for Node.js via Java 21.6](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.6/).
