...
type: docs
weight: 9
url: /nodejs-java/aspose-cells-for-node-js-via-java-22-4-release-notes/
aliases: [/nodejsjava/aspose-cells-for-node-js-via-java-22-4-release-notes/]
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for Node.js via Java 22.4](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.4/).
