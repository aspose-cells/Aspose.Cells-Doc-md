...
The following code snippet loads the [sample Excel file](attachments/106201882/106364966.xlsx) that contains the pivot table. It then creates the slicer based on the first base pivot field. Finally, it saves the workbook in [output XLSX](attachments/106201882/106364967.xlsx) format. The following screenshot shows the slicer created by Aspose.Cells in the output Excel file.
