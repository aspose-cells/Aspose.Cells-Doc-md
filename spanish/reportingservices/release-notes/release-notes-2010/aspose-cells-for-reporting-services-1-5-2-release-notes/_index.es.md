---
title: Aspose.Cells para Reporting Services 1.5.2 Notas de la versión
type: docs
weight: 20
url: /es/reportingservices/aspose-cells-for-reporting-services-1-5-2-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells para servicios de informes 1.5.2](https://downloads.aspose.com/cells/reportingservices/new-releases/aspose.cells-for-reporting-services-1.5.2/)

{{% /alert %}} 

 ¡Nos complace anunciar Aspose.Cells para Reporting Services 1.5.2!
...
-  Reduce la tasa de uso de la memoria.
 ...
 Problemas resueltos en Aspose.Cells para Reporting Services 1.5.2.
...
|16170 | Componente de servidor| Aspose.Cells para servicios de informes: varios problemas|
