...
Al seleccionar un informe para obtener una vista previa en el servidor de informes, se le solicita que especifique a qué formato de archivo exportarlo (por ejemplo, Microsoft Excel 97-2003 formato binario XLS, SpreadsheetML o Microsoft Excel 2007 formato XLSX), y cualquier parámetro de informe de entrada creado durante el diseño del informe. Después de esto, el informe se completa con los datos proporcionados por Reporting Services.
