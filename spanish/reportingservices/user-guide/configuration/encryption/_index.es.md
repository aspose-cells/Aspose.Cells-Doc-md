...
---
 Aspose.Cells para Reporting Services admite tres tipos de cifrado: XOR, CIFRADO DÉBIL y Microsoft Proveedor criptográfico fuerte. Consulte la información de configuración de cifrado en el**Aspose.Cells.ReportingServices.xml** expediente.

 Cuando el valor de Cifrado es**apagado**, Aspose.Cells para Reporting Services desactiva las funciones de cifrado.
...
{{< /highlight >}}
 ...
 Cuando el valor de Cifrado es**en**, Aspose.Cells para Reporting Services activa el cifrado.
