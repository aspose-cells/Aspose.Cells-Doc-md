---
title: Verificar si el proyecto VBA está protegido y bloqueado para vista con Golang mediante C++
linktitle: Verifique si el Proyecto VBA está Protegido y Bloqueado para Visualización
type: docs
weight: 30
url: /es/go-cpp/check-if-vba-project-is-protected-and-locked-for-viewing/
