---
title: Cómo Bloquear Celdas para Protegerlas con Golang vía C++
linktitle: Cómo bloquear celdas para protegerlas
type: docs
weight: 130
url: /es/go-cpp/how-to-lock-cells-to-protect-them/
description: Este artículo muestra código explicando cómo bloquear celdas para protegerlas usando la biblioteca Aspose.Cells con Golang vía C++.
