---
title: Cómo filtrar valores en blanco o no en blanco con Golang a través de C++
linktitle: Cómo filtrar celdas en blanco o no en blanco
type: docs
weight: 85
url: /es/go-cpp/how-to-filter-blanks-and-non-blanks/
...
Si una columna contiene texto y algunas celdas están en blanco, y se requiere un filtro para seleccionar solo aquellas filas donde hay celdas en blanco, se pueden usar las funciones [AutoFilter.MatchBlanks(int fieldIndex)](https://reference.aspose.com/cells/go-cpp/autofilter/matchblanks/) y [AutoFilter.AddFilter(int fieldIndex, string criteria)](https://reference.aspose.com/cells/cpp/aspose.cells/autofilter/addfilter/) como se muestra a continuación. 
