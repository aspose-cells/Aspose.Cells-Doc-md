---
title: Convertir un gráfico en una imagen localizada con Golang mediante C++
description: Aprenda cómo configurar las configuraciones de globalización para gráficos usando Aspose.Cells for C++. Nuestra guía demuestra cómo configurar el gráfico para soportar múltiples idiomas y formatos regionales para mostrar correctamente texto, fechas y números en diferentes idiomas.
keywords: Aspose.Cells for C++, Gráficos, Configuraciones de globalización, Múltiples idiomas, Formatación regional, Visualización, Texto, Fechas, Números.
linktitle: Establecer Región Localizada
type: docs
weight: 50
url: /es/go-cpp/convert-chart-to-localized-image/
...
Cuando abres un archivo xlsx con un gráfico en Excel, en este caso, supón que lo abres con una configuración regional en español en Excel, puedes ver los elementos en el área del gráfico, como el Título del gráfico y la Leyenda, traducidos al español. Pero cuando guardas este gráfico como una imagen con Aspose.Cells, puede que encuentres el siguiente problema: 
...
- [Cómo establecer la región china para el gráfico](/cells/es/cpp/convert-chart-to-image-for-chinese-region/)
- [Cómo establecer la región japonesa para el gráfico](/cells/es/cpp/convert-chart-to-image-for-japanese-region/)
