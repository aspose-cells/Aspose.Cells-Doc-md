---
title: Abrir archivo de Excel sin cuadro de diálogo de Abrir/Guardar/Cancelar con Golang vía C++
linktitle: Abrir archivo de Excel sin mostrar el cuadro de diálogo de Abrir Guardar Cancelar
type: docs
weight: 150
url: /es/go-cpp/opening-excel-file-without-open-save-cancel-dialog-box/
description: Aprende cómo abrir un archivo de Microsoft Excel en un navegador sin mostrar la caja de diálogo Abrir Guardar Cancelar usando Aspose.Cells for C++.
---
