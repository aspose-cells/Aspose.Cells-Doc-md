---
title: Encontrar el número máximo de filas y columnas soportadas por los formatos XLS y XLSX con Golang vía C++
linktitle: Encontrar el máximo de filas y columnas
type: docs
weight: 20
url: /es/go-cpp/find-maximum-rows-and-columns-supported-by-xls-and-xlsx-formats/
