---
title: Cómo formatear números a formato de contabilidad con Golang a través de C++
linktitle: Cómo formatear número a contabilidad
type: docs
weight: 10
url: /es/go-cpp/how-to-format-number-to-accounting/
description: Este artículo presentará cómo formatear números a contabilidad usando la API Aspose.Cells for C++.
...
## **Cómo dar formato a un número como contabilidad en Aspose.Cells for C++**
Para formatear números en formato de contabilidad en Aspose.Cells for C++, puedes usar el objeto `Estilo` asociado a una celda o rango de celdas. El objeto `Estilo` te permite establecer varias opciones de formato, incluyendo los formatos numéricos. El formato de contabilidad generalmente tiene un código de formato que puede variar según los requisitos específicos (como mostrar símbolos de moneda, decimales, etc.).

Aquí tienes un ejemplo básico de cómo aplicar un formato de número de contabilidad a una celda en Aspose.Cells for C++:

1. **Referencia Aspose.Cells**: Asegúrate de tener referenciado Aspose.Cells for C++ en tu proyecto. Puedes obtenerlo desde NuGet o desde el sitio web de Aspose.
