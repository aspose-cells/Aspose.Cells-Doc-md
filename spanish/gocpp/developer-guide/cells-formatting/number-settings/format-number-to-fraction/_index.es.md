---
title: Cómo formatear números a fracción con Golang a través de C++
linktitle: Cómo formatear números a fracciones
type: docs
weight: 10
url: /es/go-cpp/how-to-format-number-to-fraction/
...
Primero, asegúrese de tener Aspose.Cells for C++ instalado en su proyecto. Puede descargar la biblioteca desde el sitio web de [Aspose.Cells for C++](https://products.aspose.com/cells/go-cpp/)
