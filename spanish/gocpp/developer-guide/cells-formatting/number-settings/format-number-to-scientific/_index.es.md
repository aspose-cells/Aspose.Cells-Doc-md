---
title: Cómo formatear números en notación científica con Golang a través de C++
linktitle: Cómo formatear número a notación científica
type: docs
weight: 10
url: /es/go-cpp/how-to-format-number-to-scientific/
description: Este artículo presentará cómo formatear números a científico usando la API de Aspose.Cells for C++.
...
## **Cómo dar formato a un número en científico en Aspose.Cells for C++**
Para dar formato a números en notación científica en Aspose.Cells for C++, puedes usar la propiedad `Style.Custom` de una celda. Aspose.Cells permite definir un formato personalizado para los datos en tus hojas de cálculo, incluyendo notación científica.

Aquí tienes una guía paso a paso sobre cómo hacerlo:

### Paso 1: Instalar Aspose.Cells

Primero, asegúrate de tener instalado Aspose.Cells for C++ en tu proyecto. Si aún no lo has instalado, puedes obtenerlo a través de NuGet Package Manager. Ejecuta el siguiente comando en la consola del gestor de paquetes:
