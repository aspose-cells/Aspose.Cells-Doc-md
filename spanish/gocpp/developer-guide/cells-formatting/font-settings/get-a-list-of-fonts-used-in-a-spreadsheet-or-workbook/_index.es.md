---
title: Obtener una lista de fuentes utilizadas en una hoja de cálculo o libro de trabajo con Golang a través de C++
linktitle: Obtener una lista de fuentes
description: Aspose.Cells es una biblioteca C++ para trabajar con archivos de hojas de cálculo. Soporta obtener una lista de fuentes usadas en una hoja de cálculo o libro, permitiendo a los usuarios obtener información sobre las fuentes usadas en un documento. Este artículo mostrará cómo usar la biblioteca Aspose.Cells para obtener una lista de fuentes.
keywords: Aspose.Cells, Hoja de cálculo, Libro de trabajo, Fuente, Lista
type: docs
weight: 20
url: /es/go-cpp/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/
---
...
Aspose.Cells proporciona el método [**Workbook.GetFonts**](https://reference.aspose.com/cells/go-cpp/workbook/getfonts/) que devuelve la lista de todas las fuentes utilizadas en tu libro de trabajo o hoja de cálculo.
