---
title: Modificar un estilo existente con Golang a través de C++
...
type: docs
weight: 90
url: /es/go-cpp/modify-an-existing-style/
---
...
Los siguientes ejemplos muestran cómo usar el método [**Style.Update**](https://reference.aspose.com/cells/go-cpp/style/update/).

### **Creación y Modificación de un Estilo**

Este ejemplo crea un objeto [**Style**](https://reference.aspose.com/cells/go-cpp/style/), lo aplica a un rango de celdas y modifica el objeto [**Style**](https://reference.aspose.com/cells/go-cpp/style/). Las modificaciones se aplican automáticamente a la celda y al rango al que se aplicó el estilo.
