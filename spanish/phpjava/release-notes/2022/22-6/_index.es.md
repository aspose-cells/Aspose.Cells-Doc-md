---
title: Aspose.Cells para PHP a través de Java 22.6 Notas de la versión
type: docs
weight: 7
url: /es/php-java/aspose-cells-for-php-via-java-22-6-release-notes/
---
{{% alert color="primary" %}}

 Esta página contiene notas de la versión para[Aspose.Cells para PHP vía Java 22.6](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.6/).
