...
{{% alert color="primary" %}}
 ...
 Esta página contiene notas de la versión para[Aspose.Cells for PHP via Java 22.1](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.1/).
