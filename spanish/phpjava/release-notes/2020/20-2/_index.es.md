---
title: Aspose.Cells para PHP a través de Java 20.2 Notas de la versión
type: docs
weight: 10
url: /es/php-java/aspose-cells-for-php-via-java-20-2-release-notes/
---
{{% alert color="primary" %}} 

Esta página contiene notas de la versión Aspose.Cells para PHP a través de Java 20.2.
