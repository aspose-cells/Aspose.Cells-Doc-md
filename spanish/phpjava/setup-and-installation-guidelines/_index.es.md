...
description: configure Aspose.Cells para PHP a través de Java y las pautas de instalación
---
## **Requisitos del sistema**
Aspose.Cells para PHP a través de Java es independiente de la plataforma API y se puede usar en cualquier plataforma (Windows, Linux, MacOS, etc.) donde[PHP](https://www.php.net/downloads.php)o versiones superiores están instaladas. La máquina debe tener Oracle JDK 7 o versiones superiores antes de configurar la instalación.
## **Instalación y uso**
Aspose.Cells para PHP a través de Java se distribuye como un archivo ZIP.

Para configurar el entorno, instale y use Aspose.Cells para PHP a través de Java, siga las instrucciones:
### **Linux:**
...
- Descargue/Obtenga "Aspose.Cells para PHP a través de Java" API y extráigalo. Habrá una carpeta llamada "aspose.cells".
...
- Descargue "Aspose.Cells para PHP a través de Java" API y extráigalo. Habrá una carpeta llamada "aspose.cells".
- Descargue PHP/Java Bridge binary (JavaBridge.jar) desde http://php-java-bridge.sourceforge.net/pjb/download.php y guárdelo en la carpeta "aspose.cells".
- Descargue la biblioteca PHP java/Java.inc (Java.inc) de http://php-java-bridge.sourceforge.net/pjb/download.php y guárdela en la carpeta "aspose.cells".
