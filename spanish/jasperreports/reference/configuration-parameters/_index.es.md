...
|ES_UNA_PÁGINA_POR_ HOJA| Un valor booleano que especifica si cada página del informe debe escribirse en una hoja de trabajo XLS diferente.|
...
|ES_BLANCO_ FONDO DE LA PÁGINA| Un valor booleano que especifica si el fondo de la página debe ser blanco o el color de fondo predeterminado XLS. El color de fondo XLS puede variar según las propiedades del visor XLS o el esquema de color del sistema operativo.|
...
|ES_IGNORAR_ GRÁFICOS| Indicador para ignorar elementos gráficos y exportar solo elementos de texto.|
|ES_COLAPSO_ ROW_SPAN| Marque para colapsar el intervalo de filas y evite fusionar celdas entre filas.|
|ES_IGNORAR_ CELL_BORDER| Indicador para ignorar el borde de la celda.|
