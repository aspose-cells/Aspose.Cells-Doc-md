---
title: Configuración de la apariencia del gráfico con Node.js mediante C++
description: Aprende cómo configurar la apariencia de los gráficos en Aspose.Cells for Node.js via C++. Nuestra guía te mostrará cómo modificar los diseños del gráfico, colores, fuentes y efectos para lograr el estilo visual deseado y mejorar tus hojas de cálculo.
keywords: Aspose.Cells for Node.js via C++, gráficos, apariencia del gráfico, diseños, colores, fuentes, efectos, hojas de cálculo.
linktitle: Formato del Gráfico
type: docs
weight: 20
url: /es/nodejs-cpp/setting-chart-appearance/
---
...
### **Configurando las líneas del gráfico**
Los desarrolladores también pueden aplicar diferentes estilos en las líneas o marcadores de datos de la [SeriesCollection](https://reference.aspose.com/cells/nodejs-cpp/seriescollection/). El siguiente fragmento de código demuestra cómo establecer las líneas del gráfico usando la API de Aspose.Cells.
...
Los desarrolladores pueden aplicar diferentes temas/colores de Microsoft Excel a la [SeriesCollection](https://reference.aspose.com/cells/nodejs-cpp/seriescollection/) u otros objetos del gráfico como se muestra en el ejemplo a continuación.
...
Los desarrolladores pueden controlar la visibilidad de las líneas de cuadrícula principales estableciendo la propiedad [isVisible()](https://reference.aspose.com/cells/nodejs-cpp/line/#isVisible--) del objeto [Line](https://reference.aspose.com/cells/nodejs-cpp/line/) en **true** o **false**.
...
## **Temas avanzados**
- [Establecer el código de formato de valores de la serie del gráfico](/cells/es/nodejs-cpp/set-the-values-format-code-of-chart-series/)
