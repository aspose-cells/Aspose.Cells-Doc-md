---
title: Cómo establecer área de impresión con Node.js vía C++
linktitle: Cómo definir el área de impresión
type: docs
weight: 200
url: /es/nodejs-cpp/how-to-set-print-area/
description: Este artículo muestra cómo configurar el área de impresión usando la biblioteca Aspose.Cells para Node.js vía C++.
keywords: Limitar rango de impresión, establecer rango de impresión, limpiar rango de impresión, establecer y limpiar rango de impresión usando Node.js vía C++, Cómo establecer área de impresión en Node.js vía C++, Cómo eliminar área de impresión en Node.js vía C++, Cómo agregar área de impresión usando Node.js vía C++, Cómo quitar área de impresión usando Node.js vía C++, Cómo establecer área de impresión en Excel, Cómo limpiar área de impresión en Excel.
---
...
## **Cómo establecer área de impresión usando Aspose.Cells for Node.js via C++**

Para establecer el área de impresión en una hoja de cálculo específica: Primero, carga el [archivo de ejemplo](input.xlsx), y luego debes modificar la propiedad [**PageSetup.getPrintArea()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintArea--) del objeto [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/) para la hoja de cálculo deseada. Establecer esta propiedad a una cadena de rango establecerá el área de impresión.
...
## **Cómo limpiar área de impresión usando Aspose.Cells for Node.js via C++**

Para borrar el área de impresión en una hoja de cálculo específica: Primero, cargue el [archivo de ejemplo](input.xlsx), y luego necesita modificar la propiedad [**PageSetup.getPrintArea()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintArea--) del objeto [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/) para la hoja deseada. Configurar esta propiedad con una cadena vacía borrará el área de impresión.
