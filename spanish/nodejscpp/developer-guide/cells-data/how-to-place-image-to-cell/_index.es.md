...
type: docs
weight: 130
url: /es/nodejs-cpp/how-to-insert-picture-in-cell/
description: Aprenda a insertar una imagen en una celda con Aspose.Cells
...
## **Cómo insertar una imagen en una celda usando Aspose.Cells for Node.js via C++**
