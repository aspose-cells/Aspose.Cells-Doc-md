...
type: docs
weight: 30
url: /es/nodejs-cpp/r1c1-reference-style-vs-a1/
description: Estilo de referencia R1C1 frente a estilo A1 usando Aspose.Cells for Node.js via C++.
keywords: Estilo de referencia R1C1 frente a estilo A1 en Node.js vía C++, Estilo de referencia R1C1 en Node.js vía C++, Cómo cambiar entre Estilo de Referencia R1C1 y Estilo A1 en Node.js vía C++, Estilo de referencia A1 en Node.js vía C++.
---
