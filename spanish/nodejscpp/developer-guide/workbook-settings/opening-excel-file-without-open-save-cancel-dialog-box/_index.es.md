---
title: Abrir archivo de Excel sin cuadro de diálogo de Guardar y Cancelar usando Node.js a través de C++
linktitle: Abrir archivo de Excel sin mostrar el cuadro de diálogo de Abrir Guardar Cancelar
type: docs
weight: 150
url: /es/nodejs-cpp/opening-excel-file-without-open-save-cancel-dialog-box/
--- 
