...
type: docs
weight: 60
url: /es/nodejs-cpp/draw-slicer-while-rendering-excel-to-pdf/
---

## **Dibujar un rebanador al renderizar Excel a PDF**
Si tienes un archivo Excel con un segmentador y deseas exportarlo a PDF con las configuraciones del segmentador, Aspose.Cells for Node.js via C++ ahora soporta esto por defecto. Simplemente exporta el archivo Excel con el segmentador a PDF, el PDF generado mostrará el segmentador aplicado.
