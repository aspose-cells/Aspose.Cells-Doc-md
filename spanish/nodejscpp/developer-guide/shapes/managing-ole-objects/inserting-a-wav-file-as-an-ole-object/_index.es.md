---
title: Insertar un archivo WAV como Objeto OLE con Node.js mediante C++
linktitle: Insertar un archivo WAV como un objeto Ole
type: docs
weight: 70
url: /es/nodejs-cpp/inserting-a-wav-file-as-an-ole-object/
description: Aprenda cómo insertar un archivo WAV como objeto OLE en hojas de cálculo de Excel usando Aspose.Cells for Node.js via C++. 
---
