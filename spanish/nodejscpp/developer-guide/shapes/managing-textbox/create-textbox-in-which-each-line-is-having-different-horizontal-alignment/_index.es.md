---
title: Crear TextBox en el que cada línea tiene una alineación horizontal diferente con Node.js mediante C++
linktitle: Crear un cuadro de texto en el que cada línea tenga una alineación horizontal diferente
type: docs
weight: 310
url: /es/nodejs-cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Aprende cómo crear un TextBox en el que cada línea puede tener una alineación horizontal diferente usando Aspose.Cells for Node.js via C++.
---

{{% alert color="primary" %}}
Puede establecer la alineación horizontal de su texto de párrafo usando la propiedad [**TextParagraph.getAlignmentType()**](https://reference.aspose.com/cells/nodejs-cpp/textparagraph/#getAlignmentType--)
{{% /alert %}}
