...
type: docs
weight: 10
url: /es/nodejs-cpp/how-to-format-number-to-scientific/
description: Este artículo introducirá cómo formatear números a notación científica usando la API de Aspose.Cells for Node.js via C++.
...
## **Cómo Formatear Números a Científico en Aspose.Cells for Node.js via C++**
Para formatear números en notación científica en Aspose.Cells for Node.js via C++, puedes usar el método `Style.setCustom` de una celda. Aspose.Cells te permite definir un formato personalizado para los datos en tus hojas de cálculo, incluyendo la notación científica.
