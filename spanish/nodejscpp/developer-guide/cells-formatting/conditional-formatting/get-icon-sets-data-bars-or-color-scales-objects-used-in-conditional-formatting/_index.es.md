...
description: Aprende cómo usar Aspose.Cells for Node.js via C++ para recuperar conjuntos de íconos, barras de datos y objetos de escala de colores en formato condicional desde archivos de hojas de cálculo.  
keywords: Aspose.Cells, Formato condicional, Conjunto de íconos, Barra de datos, Escala de colores, Hoja de cálculo, Node.js vía C++  
type: docs  
weight: 10  
url: /es/nodejs-cpp/get-icon-sets-data-bars-or-color-scales-objects-used-in-conditional-formatting/  
---  
