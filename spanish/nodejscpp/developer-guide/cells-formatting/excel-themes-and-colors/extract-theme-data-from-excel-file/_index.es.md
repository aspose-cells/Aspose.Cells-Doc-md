...
description: Aprende cómo extraer datos de tema de archivos de Excel usando Aspose.Cells for Node.js via C++. Obtén información de estilo y formato de manera efectiva.  
keywords: Aspose.Cells, Archivo de Excel, Datos de tema, Estilo, Formato, Node.js vía C++  
type: docs  
weight: 120  
url: /es/nodejs-cpp/extract-theme-data-from-excel-file/  
---  
