---
title: Formatear y modificar rangos con nombre con Node.js mediante C++
linktitle: Formatear y modificar rangos con nombre
type: docs
weight: 85
url: /es/nodejs-cpp/format-and-modify-named-ranges/
description: Aprende cómo formatear y modificar rangos con nombre usando Aspose.Cells for Node.js via C++. 
---
...
Para aplicar formato, define un objeto [**Style**](https://reference.aspose.com/cells/nodejs-cpp/style) para especificar la configuración de estilo y aplícalo al objeto [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range).
...
Es posible agregar bordes a un rango de celdas en lugar de solo una celda. El objeto [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range) proporciona un método [**setOutlineBorder(BorderType, CellBorderType, CellsColor)**](https://reference.aspose.com/cells/nodejs-cpp/range/#setOutlineBorder-bordertype-cellbordertype-cellscolor-) que toma los siguientes parámetros para agregar un borde al rango de celdas:

- Tipo de borde, el tipo de borde, seleccionado del enumerado [**BorderType**](https://reference.aspose.com/cells/nodejs-cpp/bordertype).
- Estilo de línea, el estilo de línea, seleccionado del enumerado [**CellBorderType**](https://reference.aspose.com/cells/nodejs-cpp/cellbordertype).
...
Aspose.Cells permite cambiar el nombre de un rango con nombre según sea necesario. Puedes obtener el rango con nombre y cambiarle el nombre usando el atributo [**Name.getText()**](https://reference.aspose.com/cells/nodejs-cpp/name/#getText--). El siguiente ejemplo muestra cómo renombrar un rango con nombre.
...
Aspose.Cells proporciona el método [**Range.unionRang(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#unionRang-range-) para unir rangos; el método devuelve un objeto *Array*. El siguiente ejemplo muestra cómo unir rangos.
...
Aspose.Cells proporciona el método [**Range.intersect(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#intersect-range-) para intersectar dos rangos. El método devuelve un objeto [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range). Para verificar si un rango interseca con otro, usa el método [**Range.intersect(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#intersect-range-) que devuelve un valor booleano. El siguiente ejemplo muestra cómo intersectar los rangos.
...
Aspose.Cells proporciona el método [**Range.merge()**](https://reference.aspose.com/cells/nodejs-cpp/range/#merge--) para fusionar las celdas en el rango. El siguiente ejemplo muestra cómo fusionar las celdas individuales de un rango con nombre.
