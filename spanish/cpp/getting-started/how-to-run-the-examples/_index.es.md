...
-  Puede clonar el repositorio usando su cliente GitHub favorito o descargar el archivo ZIP desde[aquí](https://github.com/aspose-cells/Aspose.Cells-for-C/archive/master.zip).
...
- **Datos** carpeta en la carpeta raíz de**Ejemplos** contiene archivos de entrada. Es obligatorio que descargues el**Datos** carpeta junto con el proyecto de ejemplos.
- Abra main.cpp, todos los ejemplos se llaman desde aquí.
