...
|[XLSM](https://docs.fileformat.com/spreadsheet/xlsm/)|Libro de Excel habilitado para macros.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[XLTM](https://docs.fileformat.com/spreadsheet/xltm/)|Plantilla de Excel habilitada para macros.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLAM](https://docs.fileformat.com/spreadsheet/xlam/)|Un archivo de complemento habilitado para macros de Excel que se usa para agregar nuevas funciones a Excel.||{{< emoticons/tick >}}|
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|CSV (valores separados por comas) archivo.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[TSV](https://docs.fileformat.com/spreadsheet/tsv/)|TSV (valores separados por tabuladores) archivo.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|TabDelimited|Archivo de texto delimitado por tabuladores, igual que el archivo TSV.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[MHTML](https://docs.fileformat.com/web/mhtml/)|MHTML expediente.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[Numbers](https://docs.fileformat.com/spreadsheet/numbers/)|El documento es creado por la aplicación "Numbers" de Apple que forma parte de la suite ofimática iWork de Apple, un conjunto de aplicaciones que se ejecutan en los sistemas operativos Mac OS X e iOS.|{{< emoticons/tick >}}||
...
|[MARKDOWN](https://docs.fileformat.com/word-processing/md/)|Representa un documento de descuento.||{{< emoticons/tick >}}|
