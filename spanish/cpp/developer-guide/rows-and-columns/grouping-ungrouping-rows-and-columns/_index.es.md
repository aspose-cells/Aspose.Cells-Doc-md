...
## **Gestión de grupos de filas y columnas**
 ...
 Él[ICélulas](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_cell)collection proporciona varios métodos para administrar filas o columnas en una hoja de trabajo, algunos de estos se analizan a continuación con más detalle.
