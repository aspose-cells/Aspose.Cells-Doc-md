...
## **Accediendo al Cells**
 ...
 Nosotros podemos usar[Cells](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_cell)colección para acceder a las celdas de una hoja de trabajo. Aspose.Cells proporciona tres enfoques básicos para acceder a las celdas en una hoja de trabajo:
