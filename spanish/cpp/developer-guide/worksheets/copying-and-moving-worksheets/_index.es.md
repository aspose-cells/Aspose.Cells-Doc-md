...
Aspose.Cells proporciona un método sobrecargado [AddCopy()](https://reference.aspose.com/cells/cpp/aspose.cells/worksheetcollection/addcopy/) que se utiliza para agregar una hoja de cálculo a la colección y copiar datos de una hoja de cálculo existente. Una versión del método toma el índice de la hoja de cálculo de origen como parámetro. La otra versión toma el nombre de la hoja de cálculo de origen. El siguiente ejemplo muestra cómo copiar una hoja de cálculo existente dentro de un libro.
