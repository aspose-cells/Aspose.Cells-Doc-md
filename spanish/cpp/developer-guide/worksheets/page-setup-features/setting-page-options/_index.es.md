---
title: Configuración de opciones de página con C++
linktitle: Estableciendo Opciones de Página
type: docs
weight: 10
url: /es/cpp/setting-page-options/
description: Este artículo proporciona código de ejemplo para establecer las opciones de página de las hojas de cálculo de Excel programáticamente usando la API de C++. Podrás establecer la orientación de la página, el factor de escala, las opciones de ajuste a páginas, tamaño del papel, calidad de impresión, número de página inicial.
keywords: establecer orientación de página de excel c++, establecer factor de escala de excel c++, establecer tamaño de papel de hojas de cálculo c++
---
...
La clase [**Worksheet**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/) proporciona la propiedad [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) que se utiliza para establecer las opciones de configuración de la página de la hoja de cálculo. De hecho, esta propiedad [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) es un objeto de la clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) que se usa para establecer diferentes opciones de diseño de página para una hoja impresa. La clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/) ofrece varias propiedades utilizadas para configurar las opciones de configuración de página. Algunas de estas propiedades se discuten a continuación.

### **Orientación de Página**

La orientación de página puede establecerse en retrato o paisaje usando la propiedad [**GetOrientation()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getorientation/) de la clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). La propiedad [**GetOrientation()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getorientation/) acepta uno de los valores predefinidos en la enumeración [**PageOrientationType**](https://reference.aspose.com/cells/cpp/aspose.cells/pageorientationtype/), listados a continuación.
...
Es posible reducir o ampliar el tamaño de una hoja ajustando el factor de escala con la propiedad [**PageSetup.GetZoom()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getzoom/).
...
Para ajustar el contenido de la hoja a un número específico de páginas, usa las propiedades [**GetFitToPagesTall()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopagestall/) y [**GetFitToPagesWide()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopageswide/) de la clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). Estas propiedades también se usan para escalar las hojas de cálculo.

{{% alert color="primary" %}}

Puedes elegir entre la propiedad [**GetFitToPagesTall()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopagestall/)/[**GetFitToPagesWide()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopageswide/) o la propiedad [**GetZoom()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getzoom/), pero no ambas al mismo tiempo.
...
Establece el tamaño del papel en el que se imprimirán las hojas usando la propiedad [**GetPaperSize()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getpapersize/) de la clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). La propiedad [**GetPaperSize()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getpapersize/) acepta uno de los valores predefinidos en la enumeración [**PaperSizeType**](https://reference.aspose.com/cells/cpp/aspose.cells/papersizetype/), listados a continuación.
...
Establece la calidad de impresión de las hojas a través de la propiedad [**GetPrintQuality()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprintquality/) de la clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). La unidad de medida para la calidad de impresión son Puntos Por Pulgada (DPI).
...
Comienza la numeración de las páginas de la hoja de cálculo usando la propiedad [**GetFirstPageNumber()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfirstpagenumber/) de la clase [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/). La propiedad [**GetFirstPageNumber()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfirstpagenumber/) establece el número de página de la primera página y las siguientes se numeran en orden ascendente.
