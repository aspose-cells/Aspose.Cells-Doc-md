---
title: Uso de la función AbstractCalculationEngine
type: docs
weight: 20
url: /es/cpp/using-abstractcalculationengine-feature/
---
##  Las funciones aún están en desarrollo, así que estad atentos.


##  **Introducción**
 Este artículo proporciona una comprensión de cómo utilizar el[ResumenCálculoMotor](https://reference.aspose.com/cells/cpp/aspose.cells/abstractcalculationengine/) Característica para implementar funciones personalizadas con API Aspose.Cells.
