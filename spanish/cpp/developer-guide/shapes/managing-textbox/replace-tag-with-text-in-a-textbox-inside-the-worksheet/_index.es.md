---
title: Reemplazar etiquetas con texto en un cuadro de texto dentro de la hoja de cálculo con C++
linktitle: Reemplazar etiqueta con texto en un cuadro de texto dentro de la hoja de cálculo
type: docs
weight: 1100
url: /es/cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Reemplace programáticamente las etiquetas en los cuadros de texto de la hoja de cálculo usando Aspose.Cells for C++.
---
