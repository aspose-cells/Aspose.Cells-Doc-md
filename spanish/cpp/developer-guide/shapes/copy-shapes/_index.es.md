---
title: Copiar formas entre hojas de cálculo con C++
linktitle: Copiar formas
type: docs
weight: 200
url: /es/cpp/copy-shapes-between-worksheets/
description: Aprenda cómo copiar formas, gráficos y otros objetos de dibujo entre hojas de cálculo usando Aspose.Cells con C++.
---

{{% alert color="primary" %}}

A veces, necesitas copiar elementos en una hoja de cálculo, por ejemplo, imágenes, gráficos y otros objetos de dibujo, entre hojas de cálculo. Aspose.Cells soporta esta función. Los gráficos, imágenes y otros objetos se pueden copiar con el mayor grado de precisión.
...
Para copiar una imagen de una hoja de cálculo a otra, utiliza el método [**Worksheet.Pictures.Add**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/picturecollection/add/) como se muestra en el código de ejemplo a continuación.
...
El siguiente código demuestra el uso del método [**Worksheet.Shapes.AddCopy**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addcopy/) para copiar un gráfico de una hoja de cálculo a otra.
...
Para copiar controles y otros objetos de dibujo, usa el método [**Worksheet.Shapes.AddCopy**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shapecollection/addcopy/) como se muestra en el ejemplo a continuación.
