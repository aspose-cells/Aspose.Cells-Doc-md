---
title: Aspose.Cells para Android a través de Java 18.6 Notas de la versión
type: docs
weight: 30
url: /es/java/aspose-cells-for-android-via-java-18-6-release-notes/
---
{{% alert color="primary" %}}

Esta página contiene notas de la versión para Aspose.Cells para Android a través de Java 18.6.
...
Dado que el código base de Aspose.Cells para Android a través de Java coincide con el código de las versiones .NET y Java relevantes, la mayoría de los cambios, mejoras y correcciones se incluyen en Aspose.Cells for .NET v18.4, Aspose.Cells for .NET v18.183 4816, 4816 6, Aspose.Cells for Java v18.4, Aspose.Cells for Java v18.5 y Aspose.Cells for Java v18.6 también se incluyen en este Aspose.Cells para Android a través de Java v18.6.
