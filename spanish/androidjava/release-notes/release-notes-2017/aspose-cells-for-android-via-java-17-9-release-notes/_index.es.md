...
|CELLSJAVA-42379|Implementación de destino con nombre al renderizar a salida PDF (consulta de marcador)|Nueva caracteristica|
...
|CELLSJAVA-42308|Problemas de tabla dinámica (filas faltantes, encabezados de campo dinámico impresos dos veces, fecha convertida a valores numéricos, etc.) para la representación de HTML|Insecto|
...
|CELLSJAVA-42364|Las etiquetas de datos del rango de celdas no vienen cuando se exportan a Pdf|Insecto|
