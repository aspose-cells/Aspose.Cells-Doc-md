...
|CELLSJAVA-42379|Implementación de destino con nombre al renderizar a la salida PDF (consulta de marcador)|Nueva caracteristica|
...
|CELLSJAVA-42308|Problemas de tabla dinámica (filas faltantes, encabezados de campo dinámico impresos dos veces, fecha convertida a valores numéricos, etc.) para la representación HTML|Insecto|
