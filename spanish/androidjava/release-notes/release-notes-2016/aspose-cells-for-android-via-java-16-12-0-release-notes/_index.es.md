...
Obtiene y establece la ruta absoluta del archivo. Solo para enlaces externos.
...
### **Deja obsoleto el constructor Style y agrega la clase CellsFactory.**
...
### **Agrega el método GridHyperlinkCollection.GetHyperlink(int fila,int columna).**
Obtiene el objeto Hipervínculo de la celda. Si no hay hipervínculo de la celda, devuelve nulo.
