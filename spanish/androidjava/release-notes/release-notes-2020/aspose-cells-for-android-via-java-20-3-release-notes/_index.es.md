...
|CELLSJAVA-42068|El GIF en la hoja de trabajo es incorrecto cuando el libro de trabajo se convierte a HTML|Insecto|
...
|CELLSJAVA-43122|Problema con el orden de los comentarios encadenados después de la importación al formato de archivo XLSX de Office365|Insecto|
...
Los usuarios pueden anular esta propiedad para especificar las hojas y el orden en que se cargarán al importar un libro de trabajo desde un archivo de plantilla.
