...
|CELLSJAVA-43234|Datos anteriores a 2014 no leídos de la tabla dinámica|Insecto|
...
|CELLSJAVA-43288|El archivo XLSB resultante está dañado al guardar el archivo en XLSB|Insecto|
...
Esta interfaz a veces provoca ambigüedad y malentendidos para los usuarios. El usuario debe usar AbstractCalculationEngine en su lugar, que proporciona API más convenientes y flexibles para manipular funciones personalizadas.

### **Marca la propiedad CalculationOptions.CustomFunction como obsoleta.**

 Por favor use**ResumenCálculoMotor** en vez de**IFunciónPersonalizada** por**CalculationOptions.CustomEngine** propiedad.
...
### **Agrega el método Cells.RemoveDuplicates().**
 ...
 Método sobrecargado de**Cells.Eliminar duplicados(...)** para comodidad del usuario para eliminar filas duplicadas en toda la hoja.
...
Agrega un nuevo tipo de hoja: macro internacional.
...
### **Obsoleta la propiedad Filter.Visibledropdown.**
 ...
 Usar**FilterColumn.IsDropdownVisible** en cambio.
