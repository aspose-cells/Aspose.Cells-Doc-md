---
title: Instalando Aspose.Cells for SharePoint Licencia
type: docs
weight: 10
...
- **Aspose.Cells.SharePoint.License.wsp** – Archivo de paquete de solución de SharePoint. La licencia Aspose.Cells for SharePoint se empaqueta como una solución de SharePoint para facilitar la implementación y la retirada en toda la granja de servidores.
