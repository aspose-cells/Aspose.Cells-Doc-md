...
1.  Ir a**Administración central de SharePoint** seleccione el**Gestión de aplicaciones** pestaña.
1.  Escoger**Política para la aplicación web** bajo la**Seguridad de la aplicación** grupo.
...
1.  Escoger**Todas las zonas** por defecto en el**Agregar usuarios** pantalla y haga clic**Próximo**.
