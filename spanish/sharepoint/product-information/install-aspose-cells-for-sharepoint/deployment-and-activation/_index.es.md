...
[Instalación de Aspose.Cells para SharePoint](/cells/es/sharepoint/installing-aspose-cells-for-sharepoint/) lo guía a través del proceso de instalación. Este artículo explica cuál es el proceso de instalación que se implementa y activa.

{{% /alert %}} 
### **Despliegue**
Aspose.Cells para SharePoint realiza las siguientes acciones durante la implementación:
...
### **Activación**
 Aspose.Cells para SharePoint se empaqueta como una función de nivel de sitio (colección de sitios) y se puede activar y desactivar en las colecciones de sitios.
