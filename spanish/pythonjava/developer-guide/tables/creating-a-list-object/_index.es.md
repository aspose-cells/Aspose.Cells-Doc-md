...
En el ejemplo dado a continuación, hemos creado el mismo[**ListObject**](https://reference.aspose.com/cells/python/asposecells.api/ListObject)usando Aspose.Cells para Python a través de Java API como creamos usando Microsoft Excel en la sección anterior.
