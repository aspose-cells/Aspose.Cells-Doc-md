...
- [Tipo de turno](https://reference.aspose.com/cells/python/asposecells.api/ShiftType): La dirección de cambio de las columnas.

El siguiente fragmento de código muestra cómo cortar y pegar celdas dentro de una hoja de trabajo.
