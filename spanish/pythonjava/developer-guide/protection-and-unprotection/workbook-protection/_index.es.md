...
type: docs
weight: 40
url: /es/python-java/protect-and-unprotect-workbook-structure/
description: Proteja y desproteja la estructura del libro de trabajo de los archivos de Excel usando los códigos Python.
---
{{% alert color="primary" %}}
