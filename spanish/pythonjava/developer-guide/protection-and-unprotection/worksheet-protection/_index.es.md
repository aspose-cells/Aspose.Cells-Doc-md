...
type: docs
weight: 40
url: /es/python-java/protect-and-unprotect-worksheet/
description: Proteja y desproteja la hoja de trabajo de los archivos de Excel con Aspose.Cells for Python via Java.
---
{{% alert color="primary" %}}
