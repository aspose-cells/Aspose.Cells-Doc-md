...
{{% alert color="primary" %}}
Aspose.Cells para Python ofrece una amplia gama de protección y desprotección desde el nivel de archivo hasta el nivel de datos como MS Excel:
{{% /alert %}}


## [**Encrypt and decrypt Excel files**](/cells/es/python-java/encrypt-and-decrypt-excel-files/)
Para evitar que otros accedan a los datos en archivos de Excel, proteja el archivo de Excel con una contraseña.

## [**Protect and unprotect workbook**](/cells/es/python-java/protect-and-unprotect-workbook-structure/)
...
## [**Protect and unprotect worksheet**](/cells/es/python-java/protect-and-unprotect-worksheet/)
