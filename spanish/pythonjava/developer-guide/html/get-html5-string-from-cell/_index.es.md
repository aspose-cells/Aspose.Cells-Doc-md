...
Usando Aspose.Cells para Python a través de Java, puede obtener la cadena HTML de la celda. Esto se puede lograr usando el[getHtmlString(booleano html5)](https://reference.aspose.com/cells/python/asposecells.api/cell#getHtmlString\(boolean\)) método proporcionado por el API. Si pasa**falso**como parámetro, le devolverá HTML normal, pero si pasa**verdadero**como parámetro, devolverá una cadena HTML5.
