...
Cuando el archivo de Excel se convierte a HTML, Aspose.Cells agrega comentarios condicionales revelados de nivel inferior en el archivo HTML de salida. Estos comentarios condicionales son en su mayoría relevantes para las versiones antiguas de Internet Explorer y son irrelevantes en los navegadores modernos. Para obtener información adicional sobre los comentarios condicionales revelados de nivel inferior, visite el siguiente enlace
