---
title: Abrir CSV Archivos
type: docs
weight: 10
url: /es/python-java/open-csv-files/
---
## **Abrir CSV Archivos**
Los archivos de valores separados por comas (CSV) contienen registros cuyos valores están delimitados o separados por comas. Puede usar Microsoft Excel para guardar su hoja de cálculo en formato CSV.
...
El siguiente fragmento de código muestra cómo abrir el archivo CSV con Aspose.Cells for Python via Java API.
