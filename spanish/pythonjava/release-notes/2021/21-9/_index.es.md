---
title: Aspose.Cells para Python a través de Java 21.9 Notas de la versión
type: docs
weight: 5
url: /es/python-java/aspose-cells-for-python-via-java-21-9-release-notes/
---
{{% alert color="primary" %}}

 Esta página contiene notas de la versión para[Aspose.Cells para Python vía Java 21.9](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.9/).
...
|CELLSJAVA-43309|Los detalles cambiaron en la conversión de Excel a HTML|
...
|CELLSJAVA-43709|El archivo XLSM vuelto a guardar causa una ventana emergente de corrupción de archivos cuando se abre con MS Excel|
...
|CELLSJAVA-43724|No se puede convertir HTML complejo en CSV|
|CELLSJAVA-43728| La orientación del texto cambió durante la conversión de Excel a PDF|
|CELLSJAVA-43752|Representación de Excel a HTML: problema con el formato condicional para ocultar bordes|
|CELLSJAVA-43792|La fuente es incorrecta al configurar HtmlLoadOptions para la conversión de HTML a Excel|
...
|CELLSJAVA-43422|Conversión de HTML a Excel: "mso-ignore: padding" en CSS no tiene efecto|
