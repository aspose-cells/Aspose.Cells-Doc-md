...
type: docs
weight: 30
url: /es/python-java/your-first-aspose-cells-application-hello-world/
---
{{% alert color="primary" %}}
...
1.  Crear una instancia de la**[Libro de trabajo](https://reference.aspose.com/cells/python-java/asposecells.api/Workbook)**clase.
