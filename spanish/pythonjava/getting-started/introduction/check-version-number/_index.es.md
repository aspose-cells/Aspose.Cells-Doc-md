...
Para descubrir qué versión de Aspose.Cells estás utilizando a través de la API, utiliza el método estático GetVersion de la clase [CellsHelper](https://reference.aspose.com/cells/python-java/asposecells.api/cellshelper) para obtener el número de versión de Aspose.Cell.
