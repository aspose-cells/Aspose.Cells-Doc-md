---
title: Ajuste automático de filas para celdas combinadas con JavaScript a través de C++
linktitle: Ajustar automáticamente las filas para celdas fusionadas
type: docs
weight: 120
url: /es/javascript-cpp/autofit-rows-for-merged-cells/
description: Aprende cómo ajustar automáticamente filas para celdas combinadas usando Aspose.Cells for JavaScript a través de C++. Implementa la funcionalidad de ajuste automático para celdas combinadas en hojas de cálculo.
---
...
Aspose.Cells for JavaScript a través de C++ soporta esta función a través de la API [**AutoFitterOptions.autoFitMergedCellsType**](https://reference.aspose.com/cells/javascript-cpp/autofitmergedcellstype/). Usando esta API, es posible ajustar automáticamente filas en una hoja de trabajo incluyendo celdas combinadas. Aquí hay una lista de todos los tipos posibles de ajuste automático de celdas combinadas:
