---
title: Extraer imágenes de hojas de cálculo usando Opciones de ImagenoImpresión con JavaScript a través de C++
linktitle: Extraer imágenes de hojas de cálculo utilizando ImageOrPrintOptions
type: docs
weight: 140
url: /es/javascript-cpp/extract-images-from-worksheets-using-imageorprintoptions/
description: Aprende cómo extraer imágenes de hojas de cálculo de Excel y guardarlas usando Aspose.Cells for JavaScript a través de C++. 
---

{{% alert color="primary" %}} 

Los usuarios de Microsoft Excel pueden agregar imágenes a las hojas de cálculo. Con Aspose.Cells for JavaScript via C++, es posible leer imágenes de archivos de Microsoft Excel y guardarlas en una unidad local. Este artículo muestra cómo.
