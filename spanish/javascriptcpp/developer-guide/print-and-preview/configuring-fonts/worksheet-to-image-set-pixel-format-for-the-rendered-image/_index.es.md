---
title: Hoja de trabajo a Imagen  Establecer el formato de píxel para la imagen renderizada con JavaScript a través de C++
linktitle: Hoja de Cálculo a Imagen  Establecer Formato de Píxel para la Imagen Renderizada
type: docs
weight: 200
url: /es/javascript-cpp/worksheet-to-image-set-pixel-format-for-the-rendered-image/
---
