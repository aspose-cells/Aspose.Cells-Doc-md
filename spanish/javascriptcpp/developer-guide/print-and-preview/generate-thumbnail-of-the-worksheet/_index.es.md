---
title: Generar miniatura de la hoja de cálculo con JavaScript via C++
linktitle: Generar miniatura de la hoja de cálculo
type: docs
weight: 110
url: /es/javascript-cpp/generate-thumbnail-of-the-worksheet/
description: Aprende cómo generar una imagen miniatura de una hoja de cálculo usando Aspose.Cells for JavaScript via C++. Crea imágenes pequeñas para vistas previas en documentos y presentaciones.
---
...
Aspose.Cells for JavaScript via C++ permite exportar hojas de cálculo a archivos de imagen, por lo que crear una miniatura es fácil. El código de ejemplo a continuación muestra cómo exportar hojas de cálculo a archivos de imagen.
