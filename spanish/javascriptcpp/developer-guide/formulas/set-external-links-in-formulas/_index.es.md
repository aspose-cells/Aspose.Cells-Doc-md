---
title: Establecer enlaces externos en fórmulas con JavaScript vía C++
linktitle: Establecer vínculos externos en fórmulas
type: docs
weight: 20
url: /es/javascript-cpp/set-external-links-in-formulas/
description: Aprende cómo establecer enlaces externos en fórmulas usando Aspose.Cells for JavaScript vía C++. 
keywords: Establecer enlaces externos en fórmulas JavaScript vía C++, incluir archivos externos en fórmulas JavaScript vía C++ 
---

{{% alert color="primary" %}} 

A veces, es necesario incluir enlaces a archivos externos en fórmulas, por ejemplo, para evaluar un valor de celda o rango en relación con ellos. Aspose.Cells for JavaScript vía C++ proporciona esta función y este documento explica cómo usarla.
