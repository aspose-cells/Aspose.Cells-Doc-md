---
title: Configurando fórmula para rango con nombre con JavaScript a través de C++
linktitle: Estableciendo fórmula para rango con nombre
type: docs
weight: 20
url: /es/javascript-cpp/setting-formula-for-named-range/
description: Aprende cómo establecer fórmulas para rangos con nombre en hojas de cálculo usando Aspose.Cells for JavaScript a través de C++.
---

## **Estableciendo fórmula para rango con nombre**
Al igual que la aplicación Excel, las APIs de Aspose.Cells proporcionan la capacidad de especificar una fórmula para un rango con nombre usando su propiedad [Range.refersTo](https://reference.aspose.com/cells/javascript-cpp/range/#refersTo--). Podría haber numerosos escenarios de usabilidad para esta función, algunos de los cuales se detallan a continuación.
