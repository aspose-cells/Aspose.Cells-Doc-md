---
title: Cómo cambiar el color de fuente del comentario con JavaScript vía C++
linktitle: Cómo cambiar el color de fuente del comentario
type: docs
weight: 180
url: /es/javascript-cpp/how-to-change-the-comment-font-color/
---

{{% alert color="primary" %}}  
 Microsoft Excel permite a los usuarios añadir comentarios a las celdas para proporcionar información adicional y resaltar datos. Los desarrolladores pueden necesitar personalizar el comentario para especificar la configuración del alineamiento, la dirección del texto, el color de la fuente, etc. Aspose.Cells for JavaScript vía C++ ofrece API para realizar esta tarea.  
{{% /alert %}}  

 Aspose.Cells for JavaScript vía C++ proporciona una propiedad [**Shape.textBody**](https://reference.aspose.com/cells/javascript-cpp/shape/#textBody--) para establecer el color de fuente del comentario. El siguiente código de ejemplo demuestra el uso de la propiedad [**Shape.textBody**](https://reference.aspose.com/cells/javascript-cpp/shape/#textBody--) para configurar la dirección del texto en un comentario.  
