---
title: Calcular la función IFNA usando Aspose.Cells for JavaScript via C++
description: Cómo calcular funciones IFNA usando la biblioteca Aspose.Cells para JavaScript vía C++. Carga un archivo de Excel existente o crea uno nuevo, y calcula la función IFNA para obtener el resultado. Finalmente, guarda el archivo Excel modificado en el disco.
keywords: Aspose.Cells, Excel, funciones IFNA, cálculos JavaScript vía C++
type: docs
weight: 40
url: /es/javascript-cpp/calculating-ifna-function-using-aspose-cells/
---
...
{{% /alert %}} 
## **Calcular la función IFNA usando Aspose.Cells for JavaScript vía C++**
El siguiente código de ejemplo ilustra el cálculo de la función IFNA usando Aspose.Cells for JavaScript vía C++. 
