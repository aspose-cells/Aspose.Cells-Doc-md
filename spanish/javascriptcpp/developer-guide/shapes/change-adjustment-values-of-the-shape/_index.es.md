---
title: Cambiar valores de ajuste de la forma con JavaScript vía C++
linktitle: Cambiar los valores de ajuste de la forma
type: docs
weight: 2000
url: /es/javascript-cpp/change-adjustment-values-of-the-shape/
description: Aprende cómo cambiar los valores de ajuste de las formas en Excel usando Aspose.Cells for JavaScript vía C++.
---

{{% alert color="primary" %}}  
Aspose.Cells proporciona la propiedad [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) para realizar cambios en los puntos de ajuste con formas. En la interfaz de usuario de Microsoft Excel, los ajustes se muestran como nodos de diamante amarillos. Por ejemplo:  
...
Este artículo explicará el uso de la propiedad [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) para cambiar el valor de ajuste de las diferentes formas.  
{{% /alert %}}  
