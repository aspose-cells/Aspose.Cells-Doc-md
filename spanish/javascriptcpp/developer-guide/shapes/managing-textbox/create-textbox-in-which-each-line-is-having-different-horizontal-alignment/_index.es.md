---
title: Crear una caja de texto en la que cada línea tenga una alineación horizontal diferente con JavaScript a través de C++
linktitle: Crear un cuadro de texto en el que cada línea tenga una alineación horizontal diferente
type: docs
weight: 310
url: /es/javascript-cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Aprende cómo crear una caja de texto en la que cada línea puede tener una alineación horizontal diferente usando Aspose.Cells for JavaScript a través de C++.
---

{{% alert color="primary" %}}
Puede establecer la alineación horizontal de su texto de párrafo usando la propiedad [**TextParagraph.alignmentType**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#alignmentType--)
{{% /alert %}}
