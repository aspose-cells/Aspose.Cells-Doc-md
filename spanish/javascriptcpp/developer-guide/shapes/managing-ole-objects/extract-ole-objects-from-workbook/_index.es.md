---
title: Extrae objetos OLE de un libro de trabajo con JavaScript a través de C++
linktitle: Extraer objetos OLE del libro de trabajo
type: docs
weight: 110
url: /es/javascript-cpp/extract-ole-objects-from-workbook/
---
...
Este artículo muestra cómo crear una aplicación en JavaScript a través de C++ y extraer diferentes objetos OLE de un libro de trabajo con unas pocas líneas de código.
{{% /alert %}}
...
1. [Descarga Aspose.Cells for JavaScript vía C++](https://downloads.aspose.com/cells/javascript-cpp).  
...
Inicia un entorno de JavaScript y crea un nuevo proyecto. Este ejemplo mostrará una aplicación basada en navegador, pero también puedes usar cualquier entorno compatible con JavaScript.

1. Agregar Dependencias  
   1. Incluye el script Aspose.Cells for JavaScript vía C++ en tu página HTML y crea una interfaz sencilla para seleccionar un archivo de Excel y extraer objetos OLE:
