---
title: Elimina un control ActiveX con JavaScript vía C++
linktitle: Eliminar Control ActiveX
type: docs
weight: 1000
url: /es/javascript-cpp/remove-activex-control/
description: Aprende cómo eliminar controles ActiveX de libros de trabajo usando Aspose.Cells for JavaScript a través de C++.
---

## **Eliminar control ActiveX**

Aspose.Cells proporciona la capacidad de eliminar controles ActiveX de libros de trabajo. Para ello, la API ofrece el método [**Shape.removeActiveXControl()**](https://reference.aspose.com/cells/javascript-cpp/shape/#removeActiveXControl--). El siguiente fragmento de código demuestra el uso del método [**Shape.removeActiveXControl()**](https://reference.aspose.com/cells/javascript-cpp/shape/#removeActiveXControl--) para eliminar un control ActiveX.
