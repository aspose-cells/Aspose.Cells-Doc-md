---
title: Establecer el espaciado de línea del párrafo en una forma o cuadro de texto con JavaScript a través de C++
linktitle: Establecer espaciado de línea del párrafo en una forma o cuadro de texto
type: docs
weight: 290
url: /es/javascript-cpp/set-line-spacing-of-the-paragraph-in-a-shape-or-textbox/
description: Aprenda cómo establecer el espaciado de línea de los párrafos en formas o cuadros de texto usando Aspose.Cells for JavaScript a través de C++.
---

{{% alert color="primary" %}}

Puedes establecer el espacio entre líneas del párrafo, su espacio antes y espacio después usando las propiedades [**TextParagraph.lineSpace**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#lineSpace--), [**TextParagraph.spaceBefore**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#spaceBefore--) y [**TextParagraph.spaceAfter**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#spaceAfter--) de la clase [**TextParagraph**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/).
