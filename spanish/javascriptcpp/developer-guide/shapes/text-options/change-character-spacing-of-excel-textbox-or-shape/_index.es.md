---
title: Cambiar el espaciado de caracteres del cuadro de texto o forma de Excel con JavaScript a través de C++
linktitle: Cambiar Espaciado de Caracteres de Cuadro de Texto o Forma de Excel
type: docs
weight: 280
url: /es/javascript-cpp/change-character-spacing-of-excel-textbox-or-shape/
description: Cambiar el espaciado de caracteres de cuadros de texto o formas de Excel usando Aspose.Cells for JavaScript a través de C++. 
---

{{% alert color="primary" %}}

Puede cambiar el espaciado de caracteres de un cuadro de texto o forma de Excel usando la propiedad [**TextOptions.spacing**](https://reference.aspose.com/cells/javascript-cpp/textoptions/#spacing--).
