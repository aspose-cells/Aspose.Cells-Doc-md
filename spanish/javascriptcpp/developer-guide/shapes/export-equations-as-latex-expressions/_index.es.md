...
type: docs
weight: 100
url: /es/javascript-cpp/export-equation/
---
...
Si deseas exportar ecuaciones en Excel como expresiones LaTeX, puedes usar el método [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--). 

El siguiente código de ejemplo muestra cómo usar el método [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) e insertar los resultados generados en HTML:
...
Si deseas exportar ecuaciones en Excel como expresiones MathML, puedes usar el método [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--). 

El siguiente código de ejemplo muestra cómo usar el método [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) e insertar los resultados generados en HTML:
