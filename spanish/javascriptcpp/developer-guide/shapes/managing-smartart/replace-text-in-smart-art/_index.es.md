---
title: Reemplazar texto en SmartArt con JavaScript a través de C++
linktitle: Reemplazar texto en el arte inteligente
type: docs
weight: 1200
url: /es/javascript-cpp/replace-text-in-smart-art/
description: Aprende cómo reemplazar texto en SmartArt usando Aspose.Cells for JavaScript a través de C++.
---

## **Escenarios de uso posibles**  

SmartArt es uno de los objetos principales en un libro de trabajo. Muchas veces es necesario actualizar el texto en SmartArt. Aspose.Cells for JavaScript proporciona esta función configurando la propiedad [**Shape.text**](https://reference.aspose.com/cells/javascript-cpp/shape/#text--).  
