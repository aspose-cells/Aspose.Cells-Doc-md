---
title: Soporte para firma XAdES con JavaScript mediante C++
linktitle: Soporte para Firma XAdES
type: docs
weight: 110
url: /es/javascript-cpp/support-for-xades-signature/
description: Este artículo describe el soporte para firma XAdES usando JavaScript mediante C++ con Aspose.Cells.
keywords: Soporte para firma XAdES JavaScript mediante C++, Cómo firmar Excel con firma XAdES JavaScript mediante C++, Cómo agregar firma XAdES JavaScript mediante C++.  
---  

## **Introducción**  

Aspose.Cells ofrece soporte para firmar libros de trabajo con firma XAdES. Para esto, la API proporciona la clase [**DigitalSignature**](https://reference.aspose.com/cells/javascript-cpp/digitalsignature) y la enumeración [**XAdESType**](https://reference.aspose.com/cells/javascript-cpp/xadestype).  

## **Cómo agregar firma XAdES a Excel**  

El siguiente fragmento de código demuestra el uso de la clase [**DigitalSignature**](https://reference.aspose.com/cells/javascript-cpp/digitalsignature) para firmar el libro de trabajo [origen](101089323.xlsx).  
