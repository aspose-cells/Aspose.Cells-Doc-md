...
type: docs
weight: 10
url: /es/javascript-cpp/format-number-to-date/
description: Este artículo explicará cómo formatear números a fecha usando Aspose.Cells for JavaScript vía C++ API.
...
Para formatear números como fecha en Aspose.Cells for JavaScript vía C++ biblioteca para trabajar con archivos de Excel, puedes aplicar formato de fecha a las celdas programáticamente. Aquí se explica cómo hacerlo usando Aspose.Cells for JavaScript vía C++:
