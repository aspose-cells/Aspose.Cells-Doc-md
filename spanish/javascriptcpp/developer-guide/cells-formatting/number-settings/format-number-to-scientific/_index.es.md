...
type: docs
weight: 10
url: /es/javascript-cpp/how-to-format-number-to-scientific/
description: Este artículo introducirá cómo formatear números a notación científica usando la API de Aspose.Cells for JavaScript via C++.
...
## **Cómo formatear número a científico en Aspose.Cells for JavaScript via C++**
Para formatear números en notación científica en Aspose.Cells for JavaScript via C++, puedes usar la propiedad `Style.custom` de una celda. Aspose.Cells te permite definir un formato personalizado para los datos en tus hojas de cálculo, incluyendo la notación científica.
...
Siguiendo estos pasos, puedes formatear números en notación científica en Aspose.Cells for JavaScript via C++. Recuerda que puedes personalizar la cadena de formato (`"0.00E+00"`) según sea necesario para ajustar los decimales u otros aspectos de la visualización en notación científica.
