...
description: Cómo usar la biblioteca Aspose.Cells en JavaScript vía C++ para agregar formato condicional para ratios de dos colores y ratios de tres colores. Ajustando estos criterios, tendrás mayor control sobre la apariencia de las celdas.  
keywords: Aspose.Cells, Formato condicional, JavaScript vía C++, Ratios de color, Escala de dos colores, Escala de tres colores  
type: docs  
weight: 20  
url: /es/javascript-cpp/adding-2-color-scale-and-3-color-scale-conditional-formattings/  
---

{{% alert color="primary" %}}  
El formateo condicional de escalas de **2 colores** y **3 colores** se agrega de la misma manera, salvo que se diferencian con el método [**ColorScale.is3ColorScale(boolean)**](https://reference.aspose.com/cells/javascript-cpp/colorscale/#is3ColorScale-boolean-). Este método es **falso** para la escala de 2 colores y **verdadero** para la escala de 3 colores.  
{{% /alert %}}  
