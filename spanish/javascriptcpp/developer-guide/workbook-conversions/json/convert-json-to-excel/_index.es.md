---
title: Convertir JSON a Excel con JavaScript vía C++
linktitle: Convertir JSON a Excel
type: docs
weight: 300
url: /es/javascript-cpp/convert-json-to-excel/
description: Aprenda cómo convertir JSON a archivo Excel con Aspose.Cells for JavaScript vía C++.
keywords: Importar JSON sin Office 2013, Office 2016, Office 2019 y Office 365 usando JavaScript vía C++.
---
...
No es necesario preguntarse cómo convertir JSON a archivo Excel, porque Aspose.Cells for JavaScript vía C++ ofrece la mejor solución. La API Aspose.Cells soporta la conversión de formato JSON a hojas de cálculo. Puede usar la clase [**JsonLoadOptions**](https://reference.aspose.com/cells/javascript-cpp/jsonloadoptions) para especificar configuraciones adicionales para importar JSON a Libro de trabajo.
