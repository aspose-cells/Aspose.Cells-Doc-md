---
title: Agregar marcadores PDF con destinos nombrados usando JavaScript vía C++
linktitle: Agregar marcadores PDF con Destinos Nominados
type: docs
weight: 20
url: /es/javascript-cpp/add-pdf-bookmarks-with-named-destinations/
description: Aprenda cómo agregar marcadores PDF con destinos nombrados usando Aspose.Cells for JavaScript vía C++. Asegure que los marcadores permanezcan intactos sin importar los cambios de página.
---
