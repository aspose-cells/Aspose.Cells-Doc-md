---
title: Agregar marca de agua a PDF con JavaScript vía C++
linktitle: Agregar Marca de Agua al PDF
type: docs
weight: 9
url: /es/javascript-cpp/add-watermark-to-pdf/
description: Aprende cómo agregar marca de agua de texto e imagen a PDF mientras conviertes Excel a PDF usando Aspose.Cells for JavaScript vía C++.
---
...
Puedes agregar fácilmente una marca de agua de texto a un PDF especificando el texto y la fuente correspondiente. Además, puedes ajustar alineación, desplazamiento, rotación, opacidad, primer plano/fondo y escala a la página en [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
...
Puedes agregar una marca de agua de imagen a un PDF simplemente especificando los bytes de la imagen. Además, puedes ajustar alineación, desplazamiento, rotación, opacidad, primer plano/fondo y escala a la página en [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
