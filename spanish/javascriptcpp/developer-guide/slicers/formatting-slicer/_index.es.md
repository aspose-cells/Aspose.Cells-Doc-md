---
title: Formatear segmentador con JavaScript vía C++
linktitle: Formato de filtro
type: docs
weight: 20
url: /es/javascript-cpp/formatting-slicer/
---

## **Escenarios de uso posibles**

Puedes formatear el segmentador en Microsoft Excel configurando su número de columnas o su estilo, etc. Aspose.Cells for JavaScript vía C++ también permite hacer esto usando las propiedades [**Slicer.numberOfColumns**](https://reference.aspose.com/cells/javascript-cpp/slicer/#numberOfColumns--) y [**Slicer.styleType**](https://reference.aspose.com/cells/javascript-cpp/slicer/#styleType--).
