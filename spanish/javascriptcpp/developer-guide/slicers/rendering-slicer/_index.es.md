---
title: Renderizar segmentador con JavaScript a través de C++
linktitle: Renderizado de Slicer
type: docs
weight: 40
url: /es/javascript-cpp/rendering-slicer/
---  

## **Escenarios de uso posibles**  
Aspose.Cells for JavaScript a través de C++ soporta la renderización de formas de segmentador. Si conviertes tu hoja de cálculo en una imagen o guardas tu libro en formato PDF o HTML, verás que los segmentadores se representan correctamente.  
