---
title: Crear gráficos dinámicos con JavaScript vía C++
linktitle: Crear Gráficos Dinámicos
description: Aprende cómo crear gráficos dinámicos en Aspose.Cells for JavaScript vía C++. Esta guía mostrará cómo actualizar dinámicamente los datos del gráfico, series y formatos según tus requisitos, permitiéndote presentar datos cambiantes visualmente en tus hojas de cálculo.
keywords: Aspose.Cells for JavaScript vía C++, gráficos, gráficos dinámicos, datos, series, formato, hojas de cálculo, actualización.
type: docs
weight: 240
url: /es/javascript-cpp/create-dynamic-charts/
---
...
Este artículo demuestra el uso de las API de Aspose.Cells for JavaScript vía C++ para crear gráficos dinámicos usando ambos enfoques mencionados.  
{{% /alert %}}  

## **Uso de Tablas de Excel**  

{{% alert color="primary" %}}  
Las tablas de Excel se denominan ListObjects en la perspectiva de Aspose.Cells, por lo tanto, usaremos el término "ListObject" en lugar de "Tabla" para mayor claridad. Lee en detalle cómo [crear ListObjects](/cells/es/javascript-cpp/create-and-format-table/) con Aspose.Cells for JavaScript vía C++.  
{{% /alert %}}  

ListObjects proporciona la funcionalidad incorporada para ordenar y filtrar los datos mediante la interacción del usuario. Ambas opciones de ordenamiento y filtrado se ofrecen a través de listas desplegables que se añaden automáticamente a la fila de encabezado de [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject). Gracias a estas funciones (ordenamiento y filtrado), [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) parece ser el candidato perfecto para servir como fuente de datos para un gráfico dinámico, ya que cuando cambian el orden o el filtrado, la representación de los datos en el gráfico se modificará para reflejar el estado actual de [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject).

Para mantener la demostración simple y comprensible, crearemos [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) desde cero y avanzaremos paso a paso según lo descrito a continuación.

1. Crear un [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) vacío.
1. Acceder a [**Cells**](https://reference.aspose.com/cells/javascript-cpp/cells) del primer [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) en [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook).
1. Insertar algunos datos en las celdas.
1. Crear [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) basado en los datos insertados.
1. Crear [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) basado en el rango de datos de [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject).
...
1. Crear [**ComboBox**](https://reference.aspose.com/cells/javascript-cpp/combobox) basado en el rango nombrado creado en el paso anterior.
...
1. Crear [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) basado en el rango creado en el paso anterior.
1. Guardar el resultado en el disco.  
