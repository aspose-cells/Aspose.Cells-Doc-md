---
title: Crear gráfico de pastel con líneas de líder usando JavaScript vía C++
description: Aprende a usar Aspose.Cells for JavaScript vía C++ para crear un gráfico de pastel con líneas de líder en Microsoft Excel. Nuestra guía demostrará cómo añadir líneas de líder que conectan puntos de datos con la leyenda y mejoran la claridad general de tu gráfico.
keywords: Aspose.Cells for JavaScript vía C++, Gráfico de Pastel, Líneas de Líder, Microsoft Excel, Visualización de datos, Personalización del gráfico.
linktitle: Gráfico circular
type: docs
weight: 45
url: /es/javascript-cpp/creating-pie-chart-with-leader-lines/
---

{{% alert color="primary" %}}

Este artículo explica cómo crear un gráfico de pastel con líneas de líder desde cero usando la API Aspose.Cells for JavaScript vía C++. En Excel, la opción 'Mostrar líneas de líder' está configurada por defecto, por lo que cuando creas un gráfico de pastel en Excel, las líneas de líder se muestran. Sin embargo, al crear un gráfico similar con las API de Aspose.Cells, debes establecer explícitamente la propiedad [**Series.hasLeaderLines**](https://reference.aspose.com/cells/javascript-cpp/series/#hasLeaderLines--).

{{% /alert %}}

Para demostrar el uso de Aspose.Cells for JavaScript a través de la API de C++ para crear un gráfico circular con líneas de líder, primero crearemos un [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) nuevo e ingresaremos algunos datos que servirán como fuente de datos de la serie. Una vez que los datos estén en su lugar, agregaremos un [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) de tipo [**ChartType.Pie**](https://reference.aspose.com/cells/javascript-cpp/charttype) a la colección de gráficos y configuraremos sus diferentes aspectos para obtener la vista de gráfico deseada.
...
## **Temas avanzados**
- [Personalizar Colores de Sector en Gráfico de Pastel](/cells/es/javascript-cpp/custom-slice-or-sector-colors-in-pie-chart/)
- [Encontrar si los Puntos de Datos están en el Segundo Pastel o Barra en un Gráfico de Pastel de Pastel o de Barra de Pastel](/cells/es/javascript-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)

## Artículos relacionados

- [Creando gráficos](/cells/es/javascript-cpp/creating-charts/)
- [Personalizar gráficos](/cells/es/javascript-cpp/customizing-charts/)
- [Formato de Datos en Gráficos](/cells/es/javascript-cpp/data-formatting-in-charts/)
