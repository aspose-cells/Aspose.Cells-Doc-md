---
title: Cómo crear un gráfico Waterfall con JavaScript vía C++
linktitle: Cómo crear un gráfico de cascada
type: docs
weight: 160
url: /es/javascript-cpp/creating-waterfall-chart/
description: Crear gráficos Waterfall en Excel con JavaScript y Aspose.Cells for JavaScript vía C++.
keywords: crear gráfico waterfall en excel JavaScript vía C++, creando gráfico waterfall en excel JavaScript vía C++, cómo crear gráfico waterfall en excel JavaScript vía C++
---
...
Las API de Aspose.Cells permiten crear un gráfico de cascada con la ayuda del gráfico de líneas. La API también permite personalizar la apariencia del gráfico para darle forma de cascada configurando las propiedades [**Series.upBars**](https://reference.aspose.com/cells/javascript-cpp/series/#upBars--) y [**Series.downBars**](https://reference.aspose.com/cells/javascript-cpp/series/#downBars--).

El fragmento de código proporcionado a continuación demuestra el uso de Aspose.Cells for JavaScript vía C++ para crear un gráfico Waterfall desde cero.
