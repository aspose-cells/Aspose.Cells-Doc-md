---
title: Convertir gráfico en imagen localizada con JavaScript vía C++
description: Aprende cómo configurar las opciones de globalización para gráficos usando Aspose.Cells for JavaScript vía C++. Nuestra guía demuestra cómo configurar el gráfico para soportar múltiples idiomas y formatos regionales para mostrar correctamente texto, fechas y números en diferentes idiomas.
keywords: Aspose.Cells for JavaScript vía C++, gráficos, configuraciones de globalización, múltiples idiomas, formatos regionales, visualización, texto, fechas, números.
linktitle: Establecer Región Localizada
type: docs
weight: 50
url: /es/javascript-cpp/convert-chart-to-localized-image/
...
- [Cómo establecer la región china para el gráfico](/cells/es/javascript-cpp/convert-chart-to-image-for-chinese-region/)
- [Cómo establecer la región japonesa para el gráfico](/cells/es/javascript-cpp/convert-chart-to-image-for-japanese-region/)
