---
title: Insertar Rangos con JavaScript vía C++
linktitle: Insertar Rangos
type: docs
weight: 105
url: /es/javascript-cpp/insert-ranges-to-excel/
description: Aprende cómo insertar rangos en Excel y desplazar otros datos usando Aspose.Cells for JavaScript vía C++.
---
...
## **Insertar rangos usando Aspose.Cells for JavaScript vía C++**

Aspose.Cells for JavaScript vía C++ proporciona el método [Cells.insertRange(CeldaÁrea, número, ShiftType, boolean)](https://reference.aspose.com/cells/javascript-cpp/cells/#insertRange-cellarea-number-shifttype-boolean-) para insertar un rango.
