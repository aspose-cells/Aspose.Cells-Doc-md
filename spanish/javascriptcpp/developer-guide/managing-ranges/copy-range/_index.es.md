---
title: Copiar Rangos de Excel con JavaScript a través de C++
linktitle: Copiar Rangos
type: docs
weight: 105
url: /es/javascript-cpp/copy-ranges-of-Excel/
---
...
## **Copiar Rangos usando Aspose.Cells for JavaScript a través de C++**

Aspose.Cells for JavaScript a través de C++ proporciona algunas sobrecargas [Range.copy(Range, PasteOptions)](https://reference.aspose.com/cells/javascript-cpp/range/#copy-range-pasteoptions-) para copiar el rango. Y [Range.copyStyle(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyStyle-range-) solo copia el estilo del rango; [Range.copyData(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyData-range-) solo copia el valor del rango.
...
Aspose.Cells for JavaScript vía C++ soporta pegar el rango con tipos específicos.
...
## **Temas avanzados**
- [Copiar alturas de fila del rango de origen al rango de destino](/cells/es/javascript-cpp/copy-row-heights-of-source-range-to-destination-range/)
