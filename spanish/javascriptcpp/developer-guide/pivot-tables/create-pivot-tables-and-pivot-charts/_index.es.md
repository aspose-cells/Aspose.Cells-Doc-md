...
type: docs
weight: 20
url: /es/javascript-cpp/create-pivot-tables-and-pivot-charts/
description: Cómo agregar tablas dinámicas y gráficos dinámicos con Aspose.Cells for JavaScript vía C++. 
keywords: Script via C++ para Excel, biblioteca de Excel JavaScript, Agregar tablas dinámicas y gráficos dinámicos usando Script via C++ para Excel.
---
...
Script via C++ para Excel soporta [tablas dinámicas](/cells/es/javascript-cpp/create-pivot-tables-and-pivot-charts/) y [gráficos dinámicos](/cells/es/javascript-cpp/create-pivot-tables-and-pivot-charts/).

{{% /alert %}}

## **Agregar tablas dinámicas y gráficos usando Script via C++ para Excel**

Script via C++ para Excel proporciona un conjunto especial de clases utilizadas para crear tablas dinámicas. Estas clases se usan para crear y configurar objetos de tabla dinámica, que actúan como los bloques básicos de un objeto de tabla dinámica:
...
### **Prepárate para usar Script via C++ para Excel**
1. Instala Script via C++ para Excel desde NPM, usa el comando:  $ npm install aspose.cells.node.
1. También puedes seguir las instrucciones paso a paso sobre cómo instalar “Script via C++ para Excel” en tu entorno de desarrollo.


### **Cómo agregar una tabla dinámica usando Script via C++ para Excel**

Para crear una tabla dinámica usando Script via C++ para Excel:
...
### **Cómo agregar un gráfico dinámico usando la biblioteca Script via C++ para Excel**

Para crear un gráfico dinámico usando Script via C++ para Excel:
