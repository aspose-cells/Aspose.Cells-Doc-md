...
type: docs
weight: 150
url: /es/javascript-cpp/save-pivot-table-in-ods-file/
---

Aspose.Cells for JavaScript vía C++ proporciona la capacidad de guardar la tabla dinámica en archivos ODS. Para ello, simplemente convierte un libro con una tabla dinámica existente o crea una nueva y guarda el archivo en formato ODS. Asegúrate de llamar a [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) antes de guardar para garantizar que la tabla dinámica se represente en el archivo ODS de salida. El siguiente fragmento de código demuestra cómo guardar una tabla dinámica en archivo ODS.
