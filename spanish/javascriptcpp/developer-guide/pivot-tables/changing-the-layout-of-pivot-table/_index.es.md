...
type: docs
weight: 10
url: /es/javascript-cpp/changing-the-layout-of-pivot-table/
description: Cómo cambiar la disposición de la tabla dinámica con Aspose.Cells for JavaScript vía C++.
keywords: Aspose.Cells for JavaScript vía C++ Excel, biblioteca JavaScript de Excel, cambiar la disposición de la tabla dinámica usando Aspose.Cells for JavaScript vía C++ Excel Library.
---
...
La biblioteca Aspose.Cells for JavaScript vía C++ también proporciona los métodos [**PivotTable.showInCompactForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInCompactForm--), [**PivotTable.showInOutlineForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInOutlineForm--) y [**PivotTable.showInTabularForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInTabularForm--) para cambiar la disposición de la tabla dinámica en estas tres formas.
