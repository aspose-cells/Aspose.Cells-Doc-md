...
type: docs
weight: 120
url: /es/javascript-cpp/pivot-table-hide-and-sort-data/
---

## **Ocultar y ordenar datos de la tabla dinámica**
Aspose.Cells for JavaScript vía C++ soporta ocultar y ordenar datos en la tabla dinámica. El siguiente fragmento de código demuestra esta función ordenando la columna Score en orden descendente y luego ocultando las filas con una puntuación menor a 60.
