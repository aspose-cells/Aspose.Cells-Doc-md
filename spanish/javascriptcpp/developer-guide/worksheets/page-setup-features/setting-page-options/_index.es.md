---
title: Configurar opciones de página con JavaScript vía C++
linktitle: Estableciendo Opciones de Página
type: docs
weight: 10
url: /es/javascript-cpp/setting-page-options/
description: Este artículo proporciona código de ejemplo para establecer programáticamente las opciones de página de las hojas de cálculo de Excel usando JavaScript vía C++. Configurar orientación de página, factor de escalado, opciones de ajuste a páginas, tamaño de papel, calidad de impresión, primer número de página.
keywords: configurar orientación de página de Excel JavaScript vía C++, establecer factor de escalado de Excel JavaScript vía C++, establecer tamaño de papel de hojas de cálculo de Excel JavaScript vía C++
---
...
La clase [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) proporciona la propiedad [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) que se utiliza para establecer las opciones de configuración de la página de la hoja de cálculo. De hecho, esta propiedad [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) es un objeto de la clase [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) que se usa para establecer diferentes opciones de diseño de página para una hoja impresa. La clase [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) ofrece varias propiedades utilizadas para configurar las opciones de configuración de página. Algunas de estas propiedades se discuten a continuación.  

### **Orientación de Página**  

La orientación de página puede establecerse en retrato o paisaje usando la propiedad [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) de la clase [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). La propiedad [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) acepta uno de los valores predefinidos en la enumeración [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype), listados a continuación.  
...
Es posible reducir o ampliar el tamaño de una hoja ajustando el factor de escala con la propiedad [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--).  
...
Para ajustar el contenido de la hoja a un número específico de páginas, usa las propiedades [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) y [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) de la clase [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Estas propiedades también se usan para escalar las hojas de cálculo.  

{{% alert color="primary" %}}  
Puedes elegir entre la propiedad [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) o la propiedad [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--), pero no ambas al mismo tiempo.  
{{% /alert %}}  
...
Establece el tamaño del papel en el que se imprimirán las hojas usando la propiedad [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) de la clase [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). La propiedad [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) acepta uno de los valores predefinidos en la enumeración [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype), listados a continuación.  
...
Establecer la calidad de impresión de las hojas de cálculo para imprimir con la propiedad [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--). La unidad de medida para la calidad de impresión es Dots Per Inches (DPI).  
...
Comienza la numeración de las páginas de la hoja de cálculo usando la propiedad [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) de la clase [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). La propiedad [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) establece el número de página de la primera página y las siguientes se numeran en orden ascendente.  
