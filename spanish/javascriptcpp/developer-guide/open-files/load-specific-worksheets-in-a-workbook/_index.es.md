---
title: Cargar hojas de cálculo específicas en un libro con JavaScript a través de C++
linktitle: Cargar hojas de cálculo específicas en un libro de Excel
type: docs
weight: 100
url: /es/javascript-cpp/load-specific-worksheets-in-a-workbook/
description: Aprenda a cargar hojas de cálculo específicas en un libro usando Aspose.Cells for JavaScript a través de C++. Mejore el rendimiento y reduzca el consumo de memoria.
---
