...
type: docs
weight: 30
url: /es/javascript-cpp/r1c1-reference-style-vs-a1/
description: Referencia de estilo R1C1 vs. estilo A1 usando Aspose.Cells for JavaScript via C++.
keywords: Referencia de estilo R1C1 vs. estilo A1 JavaScript via C++, Referencia de estilo R1C1 JavaScript via C++, Cómo cambiar entre el estilo de referencia R1C1 y el estilo de referencia A1 JavaScript via C++, Estilo de referencia A1 JavaScript.
---
