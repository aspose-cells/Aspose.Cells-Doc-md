...
type: docs
weight: 600
url: /es/javascript-cpp/get-cells-range/
description: Aprende cómo obtener el rango de celdas a través de la API Aspose.Cells for JavaScript vía C++.
...
Cuando solo necesitas manipular algunos datos en la hoja de cálculo, debes conocer el rango de datos de toda la hoja. Aspose.Cells for JavaScript vía C++ ofrece esta función. Aspose.Cells for JavaScript vía C++ proporciona las siguientes propiedades y métodos para ayudarte a lograr tus objetivos.
...
## **Obtener rango de celdas usando Aspose.Cells for JavaScript vía C++**
Este ejemplo muestra cómo:

1. Crear un libro de trabajo.
1. Agregar datos a las celdas en la primera hoja de cálculo.
1. Obtener celdas [**Range**](https://reference.aspose.com/cells/javascript-cpp/range).
