---
title: Obtención de datos de conexión SQL con JavaScript a través de C++
linktitle: Recuperación de datos de conexión SQL
type: docs
weight: 10
url: /es/javascript-cpp/retrieving-sql-connection-data/
---
...
1. Utilice el asistente de conexiones para conectarse a la base de datos y crear una consulta de base de datos.
 ...
 Aspose.Cells for JavaScript a través de C++ proporciona la propiedad `Workbook.dataConnections` para recuperar conexiones externas. Devuelve un array de objetos ExternalConnection en el libro de trabajo.
