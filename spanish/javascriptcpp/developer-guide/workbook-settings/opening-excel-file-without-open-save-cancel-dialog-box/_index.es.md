---
title: Abrir archivo de Excel sin cuadro de diálogo de Guardar, Guardar, Cancelar usando JavaScript vía C++
linktitle: Abrir archivo de Excel sin mostrar el cuadro de diálogo de Abrir Guardar Cancelar
type: docs
weight: 150
url: /es/javascript-cpp/opening-excel-file-without-open-save-cancel-dialog-box/
--- 
...
Como se explicó anteriormente, permitir que un archivo se abra o ejecute en tu sistema sin confirmación de que realmente quieres hacerlo representa un riesgo de seguridad. Algunos archivos contienen virus y algunos sitios intentarán descargar archivos dañinos en tu máquina sin solicitarlo. Por lo tanto, no se recomienda permitir la descarga de archivos sin el aviso de descarga para que los usuarios tengan que verificar el archivo y su fuente antes de descargarlo o ejecutarlo. Desactivar el cuadro de diálogo de descarga hace que el sistema sea vulnerable a virus, troyanos y hackers que pueden afectar silenciosamente tu sistema. 
