...
- Establezca el "SO de destino" en "Ninguno" u otras opciones para su proyecto, utilizará "SkiaSharp" como una dependencia en su sistema de Windows para el proyecto .Net6.*Tenga en cuenta que la versión que utiliza "SkiaSharp" como dependencia no admite la función de impresión en impresora.*
...
- System.Text.Encoding.CodePages, 4.7.0.
 ...
 De esta forma, usará "SkiaSharp" como una dependencia en su sistema Windows para el proyecto .Net6.*Tenga en cuenta que la versión que utiliza "SkiaSharp" como dependencia no admite la función de impresión en impresora.*
