...
Para .netcore31 o anterior, por compatibilidad y estabilidad, actualmente todavía utilizamos la biblioteca de gráficos "System.Drawing.Common". Las dependencias para .netcore31 o anteriores son las siguientes:
...
1.  Busque Aspose.Cells desde NuGet:[Aspose.Cells for .NET NuGet Paquete](https://www.nuget.org/packages/Aspose.Cells/). 
También puede instalar Aspose.Cells desde el administrador de paquetes Nuget en VS2022.

2. "SkiaSharp" o "System.Drawing.Common" se instalarán automáticamente como una dependencia de Aspose.Cells 22.10.1 o posterior para plataformas .Net6, que depende de la configuración del "SO de destino" en su proyecto.
- Configure el "SO de destino" en "Windows" para su proyecto; utilizará "System.Drawing.Common" como una dependencia de su sistema Windows para el proyecto .Net6. En esta configuración, el resultado del dibujo es más cercano a .netcore31 o anterior.
**![Configurar sistema operativo de destino](TargetOS.png)**
-  Configure el "SO de destino" en "Ninguno" u otras opciones para su proyecto; utilizará "SkiaSharp" como una dependencia de su sistema Windows para el proyecto .Net6.*Tenga en cuenta que la versión que utiliza "SkiaSharp" como dependencia no admite la función de impresión en impresora.*

###  Instalar a través de msi o DLL

1. [Descargue Aspose.Cells.msi o DLL](https://releases.aspose.com/cells/net/)

2. Abra el directorio de instalación o el directorio DLL, luego seleccione el paso 3 o 4 a continuación:

3. Ubique el subdirectorio "net6.0-windows", agregue el Aspose.Cells.dll a su aplicación .net6. Agregue manualmente los siguientes paquetes nuget a su proyecto .net6:
- System.Drawing.Common, 4.7.0.
- Sistema.Seguridad.Criptografía.Pkcs, 6.0.3.
- System.Text.Encoding.CodePages, 4.7.0.

De esta manera, utilizará "System.Drawing.Common" como una dependencia de su sistema Windows para el proyecto .Net6. En esta configuración, el resultado del dibujo es más cercano a .netcore31 o anterior.

4. Ubique el subdirectorio "net6.0", agregue el Aspose.Cells.dll a su aplicación .net6. Agregue manualmente los siguientes paquetes nuget a su proyecto .net6:
- SkiaSharp, 2.88.6.
- Sistema.Seguridad.Criptografía.Pkcs, 6.0.3.
- System.Text.Encoding.CodePages, 4.7.0.

 De esta manera, utilizará "SkiaSharp" como una dependencia de su sistema Windows para el proyecto .Net6.*Tenga en cuenta que la versión que utiliza "SkiaSharp" como dependencia no admite la función de impresión en impresora.*
