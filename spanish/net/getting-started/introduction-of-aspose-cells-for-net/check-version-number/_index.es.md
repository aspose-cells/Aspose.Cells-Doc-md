...
## **Verifique el número de versión usando el Aspose.Cells API**
 ...
 Para averiguar qué versión de Aspose.Cells está usando a través del API, use el[CellsHelper](https://reference.aspose.com/cells/net/aspose.cells/cellshelper) método estático de clase GetVersion para obtener el número de versión de Aspose.Cell.
