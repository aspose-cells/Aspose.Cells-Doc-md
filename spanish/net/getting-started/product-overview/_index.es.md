...
Aspose.Cells API tiene una serie de características únicas, como soporte para formatos CSV y SpreadsheetML, agregando una copia de una hoja de trabajo existente (con contenido completo, imágenes y gráficos) a un archivo, configurando un fondo degradado para gráficos, creando comentarios, filtros automáticos y saltos de página, configuración de fórmulas complejas, soporte de formato condicional, soporte de opciones de protección introducidas en Microsoft Excel XP o superior, manipulación de rangos con nombre, soporte de gráfico personalizado API y un potente motor de cálculo de fórmulas.
