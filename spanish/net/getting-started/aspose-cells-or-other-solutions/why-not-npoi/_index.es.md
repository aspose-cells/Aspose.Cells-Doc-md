---
title: Aspose.Cells o NPOI
linktitle: Por qué no NPOI
description: "Realice una gran cantidad de tareas con archivos de Excel de forma más rápida y conveniente que NPOI utilizando C#."
type: docs
weight: 40
url: /es/net/why-not-npoi
---
...
Explora [el complemento con ejemplos de código fuente de las características de Aspose.Cells for .NET en comparación con NPOI](https://github.com/aspose-cells/Aspose.Cells-for-.NET/tree/master/Plugins/NPOI).
...
Los componentes de Aspose ofrecen muchas funciones poderosas que ahorran tiempo. Por ejemplo, [Aspose.Cells](https://products.aspose.com/cells/net/) ofrece una característica que permite a los desarrolladores importar JSON a archivos de Excel. Vale la pena mencionar que cada componente de la familia Aspose ofrece su propio conjunto de características únicas y poderosas.
