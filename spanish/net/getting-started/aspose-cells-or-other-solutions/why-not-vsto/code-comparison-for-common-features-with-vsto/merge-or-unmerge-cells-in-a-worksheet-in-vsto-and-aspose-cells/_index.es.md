---
title: Combinar o descombinar celdas en una hoja de cálculo en VSTO y Aspose.Cells
type: docs
weight: 170
...
## **Combinar celdas**
### **VSTO**
A continuación se muestran los fragmentos de código paralelo para VSTO (C#) y Aspose.Cells for .NET (C#).
...
{{< /highlight >}}
## **Descombinar celdas**
Para descombinar la(s) celda(s), use las siguientes líneas de código para VSTO (C#) y Aspose.Cells for .NET (C#).
### **VSTO**
{{< highlight csharp >}}
