---
title: Copiar fragmentos y hojas de cálculo entre libros de trabajo
type: docs
weight: 20
url: /es/net/copy-fragments-and-worksheets-between-workbooks/
---
...
1. En el menú Editar, haz clic en Mover o Copiar Hoja.
1. En el cuadro de diálogo A libro, haz clic en el libro de trabajo que recibirá las hojas.
1. Para mover o copiar las hojas seleccionadas a un nuevo libro de trabajo, haz clic en Libro Nuevo.
1. En el cuadro Antes de hoja, haz clic en la hoja antes de la cual deseas insertar las hojas movidas o copiadas.
1. Para copiar las hojas en lugar de moverlas, selecciona la casilla de verificación Crear una copia.
