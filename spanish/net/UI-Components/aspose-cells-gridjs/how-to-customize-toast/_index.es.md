---
title: cómo personalizar la apariencia de la interfaz de usuario para la notificación emergente de mensajes en GridJs  
type: docs
weight: 250
url: /es/net/aspose-cells-gridjs/how-to-customize-toast/
description: Este artículo describe cómo personalizar la apariencia de la interfaz de usuario para las notificaciones emergentes en GridJs.
keywords: GridJs,personalizar,notificación,interfaz de usuario,apariencia,visual,mensaje,alerta
aliases:
aliases:
...
# Guía de Notificaciones Personalizadas para GridJs

## Resumen

GridJs ofrece un sistema flexible de notificaciones emergentes personalizadas que te permite reemplazar los mensajes de alerta predeterminados con tu propia implementación de notificación. Esta guía demuestra varias formas de personalizar las notificaciones emergentes según las necesidades de tu aplicación.

## Tabla de Contenidos

- [Uso Básico](#basic-usage)
- [Ejemplos de integración](#integration-examples)
  - [Hermosa notificación personalizada](#1-beautiful-custom-toast)
...
- [Casos de Uso Avanzados](#advanced-use-cases)
  ...
  - [Toast adaptable a dispositivos móviles](#7-mobile-friendly-toast)
...
**Parámetros:**
- `title` (cadena): Título de la notificación toast
- `content` (cadena): Contenido del mensaje toast
- `callback` (función, opcional): Función de devolución de llamada a ejecutar después de cerrar el toast
...
- `progressBar`: Muestra una barra de progreso regresiva
- `positionClass`: Controla la posición del toast (arriba-derecha, abajo-izquierda, etc.)
- `timeOut`: Duración de cierre automático en milisegundos
...
Para una mejor experiencia de usuario, usa notificaciones tipo toast no bloqueantes en lugar de alertas modales:
...
Elige duraciones automáticas de descarte apropiadas según la longitud del contenido:
...
Siempre limpia los elementos DOM y los listeners de eventos:
...
Proporcione una manera de restaurar el comportamiento predeterminado de las notificaciones emergentes:
...
**Problema:** La página se vuelve lenta después de muchas notificaciones emergentes.

**Solución:** Limpiar los elementos DOM y los oyentes de eventos:
```javascript
const remove = () => {
  document.body.removeChild(toast);
...
### Problemas de Pantalla Móvil

**Problema:** La notificación parece mal en dispositivos móviles.

**Soluciones:**
1. Usa anchos en porcentajes: `maxWidth: '80%'`
