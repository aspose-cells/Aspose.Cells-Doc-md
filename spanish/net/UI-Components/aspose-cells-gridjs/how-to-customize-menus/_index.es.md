...
type: docs
weight: 250
url: /es/net/aspose-cells-gridjs/how-to-customize-menus/
...
![por hacer: la pantalla para seleccionar el botón de inspección de la barra de herramientas](gridjs_hover_toolbar_button_inspect.png)

entonces podemos encontrar la clave CSS relacionada para este botón: freeze

![por hacer: la pantalla para encontrar la clave CSS del botón de la barra de herramientas](gridjs_hover_toolbar_button_csskey.png)
...
![por hacer: la pantalla para el efecto hover en el botón de la barra de herramientas](gridjs_hover_toolbar_button_hover.png)
...
2. &zwnj;**Botón Seleccionar Hoja de Trabajo**&zwnj; (`ellipsis` clase) - Gestiona la selección de hojas de trabajo
