...
## **Eliminación de hipervínculos**
 Para eliminar un hipervínculo existente, los desarrolladores simplemente pueden acceder a la hoja de trabajo deseada y luego**Remover** hipervínculo de la**hipervínculos** colección de la**Hoja de cálculo** especificando la celda hipervinculada (usando su nombre o número de fila y columna).
