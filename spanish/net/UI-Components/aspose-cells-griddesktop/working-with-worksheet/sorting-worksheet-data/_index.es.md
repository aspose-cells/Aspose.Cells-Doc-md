...
-  Ahora podemos llamar**Clasificar** método de**ordenarrango** objeto para realizar la clasificación de datos. En**Clasificar** método, podemos especificar el índice de la columna o fila a ordenar y el orden de clasificación (que puede ser**ascendente** o**Descendente** según sus requisitos)
