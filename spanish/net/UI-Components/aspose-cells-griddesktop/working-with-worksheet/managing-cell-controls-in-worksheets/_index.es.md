...
## **Extracción de los controles Cell**
 Para eliminar un control de celda existente, los desarrolladores simplemente pueden acceder a la hoja de trabajo deseada y luego**Eliminar** el control celular desde el**Control S** colección de la**Hoja de cálculo** especificando la celda (usando su nombre o número de fila y columna) que contiene el control de celda.
