...
type: docs
weight: 40
url: /es/net/aspose-cells-gridjs-features/
---
## **Aspose.Cells.GridJs**
...
- Agregar/eliminar/renombrar hojas de trabajo.
...
- Admite configuraciones de formato de número, fecha, moneda y hora.
- Admite configuraciones de formato personalizadas.
- Admite configuraciones de color de fondo.
- Admite autocompletar.
- Controla la alineación del texto.
- Controle el ajuste de texto.
...
- Soporta formateo de celdas.

### **Funciones de utilidad**
- Admite validaciones de listas desplegables.
- Añadir/eliminar/buscar comentarios.
- Rotar/Redimensionar/Mover imágenes/formas.
