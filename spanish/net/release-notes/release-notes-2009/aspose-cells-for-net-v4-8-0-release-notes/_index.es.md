...
type: docs
weight: 10
url: /es/net/aspose-cells-for-net-v4-8-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET v4.8.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.8.0/)
...
|8881 | xls| Lanza ArgumentOutOfRangeException al abrir un archivo|
