...
type: docs
weight: 100
url: /es/net/aspose-cells-for-net-19-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46597|Valor incorrecto en PDF en la representación de Excel a PDF|Insecto|
|CELLSNET-46613|Problemas al obtener y crear rangos con nombre|Insecto|
|CELLSNET-46625|Fondo de tabla incorrecto en PDF y HTML de salida|Insecto|
|CELLSNET-46628|Diferencia en el PDF de salida|Insecto|
|CELLSNET-46589|Aparecieron líneas de cuadrícula inesperadas en SVG convertido de la hoja de cálculo de MS Excel|Insecto|
|CELLSNET-46600|El subrayado doble desaparece al convertir un archivo de Excel a PDF|Insecto|
|CELLSNET-46626|Problemas de formato de espacio al convertir un archivo XLSX a PDF|Insecto|
...
|CELLSNET-46624|Problema de carga de archivos XLSX|Insecto|
|CELLSNET-46635|Demasiados saltos de página en el archivo ODS (representación de XLSX a ODS)|Insecto|
