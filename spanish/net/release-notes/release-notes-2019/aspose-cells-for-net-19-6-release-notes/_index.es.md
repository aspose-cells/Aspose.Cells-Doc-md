...
type: docs
weight: 70
url: /es/net/aspose-cells-for-net-19-6-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-41277|Comentarios en la exportación HTML de archivos XLS/XLSX|Nueva caracteristica|
...
|CELLSNET-46731|Worksheet.Copy() cuelga la aplicación|Actuación|
|CELLSNET-46770|Memoria insuficiente al actualizar la tabla dinámica con un origen de datos grande|Actuación|
|CELLSNET-46730|Chart.ToImage() cuelga la aplicación|Actuación|
|CELLSNET-46670|El contenido del archivo de Excel se superpone después de agregar propiedades personalizadas|Insecto|
|CELLSNET-46747|Las líneas de cuadrícula se imprimen sobre el objeto incrustado mientras se procesa en PDF|Insecto|
|CELLSNET-41479|Configuración de segmentación en PDF generado|Insecto|
...
|CELLSNET-46736|Problema de fuente cuando HTML se convierte a PDF|Insecto|
...
|CELLSNET-46735|El número de página no se reinicia a 1 en cada hoja del PDF de salida|Insecto|
...
|CELLSNET-46752|El archivo XLSX de salida se corrompe después de llamar a InsertCutCells()|Insecto|
