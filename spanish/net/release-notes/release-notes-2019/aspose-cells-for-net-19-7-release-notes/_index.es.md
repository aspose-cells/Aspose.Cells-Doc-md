...
type: docs
weight: 60
url: /es/net/aspose-cells-for-net-19-7-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46783|CalculateFormula es muy lento|Actuación|
|CELLSNET-46746|CalculateFormula: las fórmulas no afectan a los gráficos|Insecto|
|CELLSNET-46772|PDF erróneo creado por falta de gráficos|Insecto|
|CELLSNET-46802|Gráfico representado de manera diferente en XLS que en PDF|Insecto|
|CELLSNET-46806|Combo Chart se procesa en PDF incorrectamente|Insecto|
|CELLSNET-41449|XLSB con archivos de tabla dinámica complejos|Insecto|
|CELLSNET-43921|Renderizar XLSX a XLSB produce un archivo dañado|Insecto|
|CELLSNET-44593|El archivo de salida de Excel no es bueno al convertir HTML a Excel|Insecto|
|CELLSNET-46794|Cells cambio cuando HTML se convierte a XLSX|Insecto|
...
|CELLSNET-46664|Las etiquetas HeadingPairs y TitlesOfParts se restauran nuevamente después de convertir el XLS limpio al formato de archivo XLSM|Insecto|
|CELLSNET-46782|Smart Marker no actualiza la referencia de fórmula de hoja cruzada|Insecto|
|CELLSNET-46784|Marcadores inteligentes: problema al mostrar objetos de lista JSON con propiedades|Insecto|
...
|CELLSNET-46248|Se lanza una excepción al leer un archivo HTML.|Excepción|
|CELLSNET-46792|Excepción al intentar eliminar columnas en blanco en un libro de trabajo específico|Excepción|
|CELLSNET-46799|Se produjo una excepción al convertir un archivo XLSX a PDF|Excepción|
...
#### **Actualice el espacio de nombres Aspose.Cells.ODS como Aspose.Cells.Ods y actualice las clases/enumeraciones/propiedades de ODS* como Ods**
