...
type: docs
weight: 80
url: /es/net/aspose-cells-for-net-19-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46695|Establecer el fondo del archivo ODS|Nueva caracteristica|
|CELLSNET-46706|Orden de números no válido al convertir fuente árabe a PDF.|Mejora|
...
|CELLSNET-46719|Excepción al configurar una cadena HTML usando el modelo de color RGBA|Mejora|
...
|CELLSNET-46720|La estructura de la página está dañada en la última página en la conversión de Excel a PDF|Insecto|
...
|CELLSNET-46696|La conversión de XLS con gráfico Microsoft a XLSX y XLSM provoca un error de contenido ilegible|Insecto|
|CELLSNET-46697|La conversión de XLSM con objeto OLE a XLS provoca un error|Insecto|
|CELLSNET-46712|La conversión de XLS con gráfico Microsoft a XLSX y XLSM provoca un error de contenido ilegible|Insecto|
