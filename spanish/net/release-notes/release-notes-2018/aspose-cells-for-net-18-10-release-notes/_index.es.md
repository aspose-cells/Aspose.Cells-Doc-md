...
type: docs
weight: 30
url: /es/net/aspose-cells-for-net-18-10-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46383|Problema con la fuente de la imagen al renderizar Excel a formato de archivo HTML|Insecto|
...
|CELLSNET-46382|La importación de CSV crea un formato incorrecto usando PreferredParsers|Insecto|
...
|CELLSNET-46376|El tamaño de la página de salida del PDF (y los márgenes) no coincide con la salida de MS Excel|Insecto|
...
|CELLSNET-46357|Los archivos XLSB no se pueden abrir con LoadDataFilterOption que no sea LoadDataFilterOption.All|Insecto|
...
|CELLSNET-46350|La vista cambia a protegida al convertir XLS -> XLSM -> XLS|Insecto|
