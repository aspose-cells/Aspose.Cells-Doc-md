...
type: docs
weight: 60
url: /es/net/aspose-cells-for-net-18-7-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-46046|Las imágenes redondas se convierten en imágenes cuadradas en el PDF de salida|Nueva caracteristica|
...
|CELLSNET-46163|Admite el cifrado y descifrado de archivos ODS|Nueva caracteristica|
...
|CELLSNET-45921|El círculo se convierte en cuadrado en la representación de Excel a PDF|Insecto|
...
|CELLSNET-46189|El documento PDF de salida no es lo mismo que la salida de MS Excel|Insecto|
...
|CELLSNET-46195|La conversión de XLSX adjunto a PDF genera una excepción|Insecto|
