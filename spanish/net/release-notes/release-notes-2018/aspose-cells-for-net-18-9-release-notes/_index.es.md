...
type: docs
weight: 40
url: /es/net/aspose-cells-for-net-18-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46308|Exportar propiedades de documentos personalizados a PDF|Nueva caracteristica|
...
|CELLSNET-46290|Colores incorrectos representados para formas en la conversión de Excel a PDF|Insecto|
...
|CELLSNET-46327|Los rangos con nombre cuando se convierten en SVG, no capturan las fuentes y el espaciado exactos|Insecto|
|CELLSNET-46313|Problemas en el PDF de salida al usar palabras clave alemanas en encabezados y pies de página de secuencias de comandos|Insecto|
...
|CELLSNET-46332|Faltan almacenamientos y transmisiones del paquete OLE después de volver a guardar un archivo XLSX cifrado|Insecto|
...
|CELLSNET-46283|Borde faltante en la salida de ODS Excel|Insecto|
|CELLSNET-46331|Excepción al convertir un archivo XLSX a formato de archivo PDF|Excepción|
