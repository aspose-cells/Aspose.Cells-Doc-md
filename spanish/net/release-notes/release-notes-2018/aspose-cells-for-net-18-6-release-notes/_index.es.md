---
title: Aspose.Cells for .NET 18.6 Notas de la versión
type: docs
weight: 70
url: /es/net/aspose-cells-for-net-18-6-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 18.6](https://www.nuget.org/packages/Aspose.Cells/18.6.0).
...
|CELLSNET-46145|Mejorar la conversión de llamada de línea a imagen|Mejora|
|CELLSNET-46174|Métodos WorkbookRender.ToImage(pageIndex, fileName/stream) y Bitmap WorkbookRender.ToImage(int pageIndex) incluidos|Mejora|
...
|CELLSNET-46141|Forma estandarizada para los últimos tres números en el nombre de la forma de la firma|Insecto|
|CELLSNET-46131|Cambiar el tamaño de la tabla sin cabeza corrompe el archivo de salida de MS Excel|Insecto|
|CELLSNET-46128|El archivo de Excel de salida está dañado después de crear un objeto de lista|Insecto|
|CELLSNET-46134|Cuando renderiza un documento de Excel a PDF, el proceso nunca termina|Insecto|
|CELLSNET-46175|Aspose.Cells.CellsException en Aspose.Cells.Libro de trabajo.Guardar()|Excepción|
|CELLSNET-46147|Error al inicializar un archivo XLSX|Excepción|
|CELLSNET-46138|EndOfStreamException cuando se fusiona Aspose.Cells.Dll (último ensamblaje)|Excepción|
|CELLSNET-46173|Excepción: "El archivo está dañado" al cargar un archivo XLS|Excepción|
|CELLSNET-46137|ArgumentOutOfRangeException cuando se fusiona Aspose.Cells (último ensamblaje)|Excepción|
