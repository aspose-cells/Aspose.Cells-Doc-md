...
type: docs
weight: 90
url: /es/net/aspose-cells-for-net-18-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46013|Nuevo tipo cruzado con contenido superpuesto oculto al guardar como HTML|Mejora|
|CELLSNET-45965|Capacidad para procesar el elemento LINK estándar durante la conversión hacia atrás|Mejora|
|CELLSNET-46032|No genere PDF en blanco de una sola página cuando el archivo de Excel está vacío|Mejora|
...
|CELLSNET-46005|Escrituras invertidas para diferentes hojas en el formato de archivo PDF de salida|Insecto|
...
|CELLSNET-45990|La salida de PDF varía según el tipo de optimización|Insecto|
...
|CELLSNET-46002|Las filas de encabezado de página se muestran solo en la primera página en el PDF de salida|Insecto|
