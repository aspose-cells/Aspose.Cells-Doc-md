...
type: docs
weight: 10
url: /es/net/aspose-grid-for-net-1-9-3-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Grid para .Net 1.9.3](https://downloads.aspose.com/cells/net/new-releases/aspose.grid-for-.net-1.9.3/)
