...
type: docs
weight: 30
url: /es/net/aspose-cells-for-net-5-1-3-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 5.1.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.3/)
