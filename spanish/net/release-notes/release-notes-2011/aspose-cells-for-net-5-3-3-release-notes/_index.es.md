...
type: docs
weight: 70
url: /es/net/aspose-cells-for-net-5-3-3-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 5.3.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.3.3/)
