...
type: docs
weight: 30
url: /es/net/aspose-cells-for-net-17-10-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 17.10](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.10/).
...
|CELLSNET-45664|Lectura y escritura Conexión externa de archivo XLSB|Nueva caracteristica|
|CELLSNET-45660|Representación de hoja a imagen: problema de alineación para fuentes asiáticas|Mejora|
|CELLSNET-45408|El valor desaparece o cambia de color al convertir a PDF|Insecto|
...
|CELLSNET-45651|El tamaño del cuadro de texto cambia cuando se usa una fuente china en el libro de trabajo al renderizar a PDF|Insecto|
...
|CELLSNET-45693|La hoja de trabajo ya no está protegida en el archivo de salida en la conversión de SpreadsheetML a XLSX|Insecto|
...
|CELLSNET-45687|Las propiedades de protección de las hojas de trabajo no se transmiten desde SpreadsheetML|Insecto|
|CELLSNET-45683|El elemento SpreadsheetML AllowSort no funciona en la salida XLSX|Insecto|
...
|CELLSNET-45703|Excepción al convertir un archivo XLSM de nuevo al formato de archivo XLS|Excepción|
...
- [Lectura y escritura de la conexión externa del archivo XLSB](/cells/es/net/read-and-write-external-connection-of-xls-and-xlsb-files/)
