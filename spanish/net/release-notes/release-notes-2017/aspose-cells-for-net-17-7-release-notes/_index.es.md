...
type: docs
weight: 60
url: /es/net/aspose-cells-for-net-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 17.7](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.7/).
...
- [Determinar si el tamaño de papel de la hoja de trabajo es automático](/cells/es/net/determine-if-paper-size-of-worksheet-is-automatic/)
- [Renderizar tabla dinámica en GridDesktop](/cells/es/net/render-pivottable-in-griddesktop/)
- [Fila personalizada y título de columna personalizado de la hoja de trabajo de GridDesktop](/cells/es/net/custom-row-and-custom-column-caption-of-griddesktop-worksheet/)
- [Encuentra la versión de GridDesktop en tiempo de ejecución](/cells/es/net/find-griddesktop-version-at-runtime/)
- [Cambiar el tamaño de GridWeb en la ventana del navegador](/cells/es/net/resize-gridweb-in-the-browser-window/)
