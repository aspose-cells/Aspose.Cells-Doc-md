...
type: docs
weight: 90
url: /es/net/aspose-cells-for-net-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 17.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.4.0/).
...
- [Establecer sugerencia de encabezado de columna](/cells/es/net/set-column-header-tip/)
