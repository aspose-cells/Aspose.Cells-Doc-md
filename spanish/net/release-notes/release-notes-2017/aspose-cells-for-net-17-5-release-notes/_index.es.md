...
type: docs
weight: 80
url: /es/net/aspose-cells-for-net-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 17.5](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.5/).
...
|CELLSNET-45350|Error OutOfMemory durante la representación de imágenes|Actuación|
|CELLSNET-45341|Convertir XLS a SpreadsheetML con filtros corrompe el archivo de salida|Actuación|
...
|CELLSNET-45304|La alineación del texto girado verticalmente es incorrecta en el HTML de salida|Insecto|
|CELLSNET-45299|El texto no cabe en la celda al guardar como HTML|Insecto|
...
|CELLSNET-45324|La posición de los caracteres no está alineada al centro cuando se procesa un archivo de Excel a PDF|Insecto|
...
|CELLSNET-45303|Las formas (rectángulos, líneas, etc.) ya no se unen cuando se vuelven a guardar de formato de archivo XLSX a XLS|Insecto|
...
- [Copie la configuración de configuración de página de la hoja de trabajo de origen a la hoja de trabajo de destino](/cells/es/net/copy-page-setup-settings-from-source-worksheet-into-destination-worksheet/)
- [Implementar el tamaño de papel personalizado de la hoja de trabajo para la representación](/cells/es/net/implement-custom-paper-size-of-worksheet-for-rendering/)
- [Eliminar la configuración de impresora existente de las hojas de trabajo en el archivo de Excel](/cells/es/net/remove-existing-printersettings-of-worksheets-in-excel-file/)
