...
type: docs
weight: 70
url: /es/net/aspose-cells-for-net-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 17.6](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.6/).
...
|CELLSNET-45391|El pie de página de Excel en el PDF de salida no está en cursiva, debe ser Arial 9 y cursiva|Mejora|
...
|CELLSNET-45344|El texto del subíndice se desplaza un poco hacia la derecha: representación de Excel a PDF|Insecto|
|CELLSNET-44595|El archivo de salida de Excel no es bueno al convertir un archivo HTML a formato de archivo de Excel|Insecto|
|CELLSNET-44596|El archivo de salida de Excel no es bueno cuando se convierte un archivo HTML a formato de archivo de Excel - I|Insecto|
|CELLSNET-45409|Excepción lanzada después de cargar y guardar múltiples archivos XLS|Insecto|
...
|CELLSNET-45414|El PDF de salida debe tener una página en lugar de dos páginas|Insecto|
|CELLSNET-45399|Imagen procesada incorrectamente cuando una celda tiene un nombre de moneda árabe|Insecto|
|CELLSNET-45389|La forma de los paréntesis se representa incorrectamente en la imagen/PDF de salida|Insecto|
|CELLSNET-45376|Aspose.Cells el PDF guardado no es como el PDF guardado de MS Excel|Insecto|
...
|CELLSNET-45335|La imagen del gráfico generado es incorrecta|Insecto|
|CELLSNET-45424|La clasificación personalizada se pierde cuando las API Aspose.Cells las guardan en XLS|Insecto|
...
|CELLSNET-45375|Excepción al abrir el archivo XLS de la plantilla a través de las API Aspose.Cells|Insecto|
...
|CELLSNET-45369|El formato de texto cambió (espaciado aumentado) después de cargar y guardar el XLS|Insecto|
...
|CELLSNET-45365|El formato de celda perdido después de renderizar a formato PDF|Insecto|
...
- [Imagen en mosaico como una textura dentro de la forma](/cells/es/net/tile-picture-as-a-texture-inside-the-shape/)
- [Usando OnAjaxCallFinishedClientFunction de GridWeb](/cells/es/net/using-onajaxcallfinishedclientfunction-of-gridweb/)
...
- [Agregar GridWeb al formulario web](/cells/es/net/add-gridweb-to-web-form/)
- [Agrupar filas y crear subtotales](/cells/es/net/group-rows-and-create-subtotal/)
