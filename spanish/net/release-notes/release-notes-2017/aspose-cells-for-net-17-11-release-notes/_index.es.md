...
type: docs
weight: 20
url: /es/net/aspose-cells-for-net-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45720|La tabla dinámica tarda demasiado en actualizar los datos|Actuación|
|CELLSNET-45680|La dirección de la forma es incorrecta cuando se convierte a formato de imagen|Insecto|
|CELLSNET-45679|Las formas de estrella no se muestran correctamente en el PDF de salida|Insecto|
...
|CELLSNET-43912|La posición de los objetos de línea cambió al representar la hoja de cálculo en PDF|Insecto|
...
|CELLSNET-45712|Falta la leyenda del gráfico en el PDF de salida|Insecto|
...
|CELLSNET-45749|La cadena HTML que tiene varias fuentes corrompe el archivo de salida de Excel|Insecto|
...
|CELLSNET-45753|Cuando XLSB se convierte a PDF, se produce System.ArgumentOutOfRangeException|Excepción|
...
|CELLSNET-45726|Excepción al cargar el archivo XLS de salida (con objetos OLE, imágenes, etc. excluidos)|Excepción|
...
- [Convierta el arte inteligente en forma de grupo](/cells/es/net/convert-the-smart-art-to-group-shape/)
- [Crear libro de trabajo compartido con Aspose.Cells](/cells/es/net/create-shared-workbook-with-aspose-cells/)
- [Determinar si la forma es Smart Art Shape](/cells/es/net/determine-if-shape-is-smart-art-shape/)
- [Encuentre el nombre del elemento raíz del mapa Xml](/cells/es/net/find-the-root-element-name-of-xml-map/)
- [Ignorar errores al renderizar Excel a PDF](/cells/es/net/ignore-errors-while-rendering-excel-to-pdf/)
- [Proteger con contraseña o desproteger el libro de trabajo compartido](/cells/es/net/password-protect-or-unprotect-the-shared-workbook/)
- [Consulta Cell Áreas asignadas a la ruta del mapa Xml mediante el método Worksheet.XmlMapQuery](/cells/es/net/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
...
- [Comportamiento de copiar y pegar de las propiedades EnableClipboardCopyPaste y PasteType GridDesktop](/cells/es/net/copy-paste-behavior-of-enableclipboardcopypaste-and-pastetype-griddesktop-properties/)
