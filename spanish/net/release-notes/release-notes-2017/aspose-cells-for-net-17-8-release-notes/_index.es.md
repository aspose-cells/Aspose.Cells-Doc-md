...
type: docs
weight: 50
url: /es/net/aspose-cells-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 17.8](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.8/).
...
|CELLSNET-45330 |Renderizar comentarios al guardar como imagen, HTML o PDF|Nueva caracteristica|
...
|CELLSNET-45530 |MS Excel consume más memoria (aproximadamente 2 GB) para abrir el archivo de salida|Actuación|
|CELLSNET-45531 |La posición del texto de la forma es incorrecta en el PDF de salida: conversión de Excel a PDF|Insecto|
...
|CELLSNET-45512 |Aspose.Cells crea un archivo EMF masivo al representar la hoja en un archivo de imagen|Insecto|
...
|CELLSNET-45553 |El gráfico en el PDF resultante tiene valores inesperados|Insecto|
|CELLSNET-45551 |La imagen se vuelve negra cuando se procesa en formato de archivo PDF|Insecto|
|CELLSNET-45547 |Los minigráficos no son más suaves en la imagen EMF de salida|Insecto|
...
|CELLSNET-45560 |El mensaje de error se muestra en Microsoft Excel después de llamar al método RemoveMacro()|Insecto|
...
|CELLSNET-45549 |El archivo XLS de salida está dañado al abrir y guardar el archivo Source Xls|Insecto|
|CELLSNET-45548 |El elemento SpreadsheetML AllowFilter no funciona en la salida XLSX|Insecto|
...
|CELLSNET-45520 |Los campos de comentarios no se abren correctamente desde SpreadsheetML|Insecto|
|CELLSNET-45518 |La validación de datos en el archivo de salida de Excel no funciona|Insecto|
|CELLSNET-45509 |Los objetos/imágenes incrustados no se procesan en la conversión de Excel a PDF|Insecto|
...
|CELLSNET-45472 |Excepción: "Error de forma a imagen" al renderizar un archivo XLSX a formato de archivo PDF|Excepción|
...
|CELLSNET-45519 |Excepción al abrir el archivo XLSB de plantilla (Office 365 (actualización 1707))|Excepción|
...
- [Uso de CustomImplementationFactory para crear una implementación personalizada de Memory Stream](/cells/es/net/using-customimplementationfactory-to-create-custom-implementation-of-memory-stream/)
- [Crear quitar y obtener comentarios de GridCell](/cells/es/net/create-remove-and-get-gridcell-comments/)
- [Fuente predeterminada y color de fuente de GridDesktop](/cells/es/net/default-font-and-font-color-of-the-griddesktop/)
