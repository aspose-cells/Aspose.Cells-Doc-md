...
type: docs
weight: 30
url: /es/net/aspose-cells-for-net-16-10-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44695 | La carga desde HTML ignora el estilo en negrita del bloque de estilo| Insecto|
|CELLSNET-44779 | El valor calculado de la celda D5 es incorrecto| Insecto|
|CELLSNET-44775 | Conversión de Excel a PDF: aumento del número de páginas en el formato de archivo PDF de salida| Insecto|
...
|CELLSNET-44730 | La lista justificada no se muestra correctamente en el PDF de salida| Insecto|
|CELLSNET-44729 | Las listas numeradas en Excel no se muestran correctamente al exportar a PDF| Insecto|
|CELLSNET-44720 | Los extremos del arco son cuadrados, no redondos en el PDF de salida| Insecto|
...
|CELLSNET-44757 | System.NullReferenceException al abrir el archivo XLSB de origen| Excepción|
