...
type: docs
weight: 40
url: /es/net/aspose-cells-for-net-9-0-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44681 | La importación de HTML falla cuando la etiqueta del script usa CDATA| Mejora|
...
|CELLSNET-44622 | El archivo XLSX final carece de los estilos de subtítulos, mientras que estos están presentes en el XLSX de entrada y el HTML intermedio| Insecto|
|CELLSNET-44581 | Problema con la conversión de hoja de cálculo a HTML: etiqueta STYLE entre las etiquetas BODY y HTML| Insecto|
...
|CELLSNET-44716 | El resultado de PDF no coincide con Excel para imprimir filas de título| Insecto|
...
|CELLSNET-44717 | Hoja de cálculo a XPS: el proceso nunca se completa y requiere demasiada memoria| Insecto|
...
|CELLSNET-44696 | La línea con punta de flecha no se representa por completo en los formatos XLSX y PDF| Insecto|
|CELLSNET-44689 | La configuración de la impresora se cambia al abrir y volver a guardar el archivo XLS de origen| Insecto|
...
|CELLSNET-44691 | NullReferenceException en Workbook ctor debido a la visualización: ninguna en el código fuente HTML| Excepción|
