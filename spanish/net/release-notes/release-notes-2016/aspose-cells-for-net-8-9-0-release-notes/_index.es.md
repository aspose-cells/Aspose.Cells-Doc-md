...
type: docs
weight: 70
url: /es/net/aspose-cells-for-net-8-9-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44561 | Capacidad para establecer la fuente predeterminada al representar la hoja de cálculo en HTML| Nueva caracteristica|
...
|CELLSNET-44542 |El archivo de Excel no se representa correctamente en formato de archivo HTML| Insecto|
...
|CELLSNET-43656 | Algunos elementos de texto están ligeramente truncados en el HTML de salida| Insecto|
...
|CELLSNET-44589 | Aspose.Cells EMF generado muestra etiquetas de eje incorrectas cuando se inserta en un documento de Word y se convierte a PDF| Insecto|
|CELLSNET-44586 | Menos de espacio simple no se exporta a PDF correctamente| Insecto|
|CELLSNET-44564 | El EMF del gráfico generado en la Sesión 0 no muestra todo el contenido| Insecto|
|CELLSNET-44559 | Chart.HasAxis muestra un valor incorrecto| Insecto|
|CELLSNET-44538 | Archivo PNG 0KB vacío generado al convertir XLSX a HTML| Insecto|
...
|CELLSNET-44546 | Excepción: "Contraseña no válida" al abrir un archivo Excel XLS encriptado por Aspose.Cells API| Excepción|
