...
type: docs
weight: 110
url: /es/net/aspose-cells-for-net-8-8-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44312 |Los saltos de línea se pierden al importar HTML y exportar a una hoja de cálculo| Insecto|
|CELLSNET-44311 | Los bordes se pierden al importar HTML y exportar a una hoja de cálculo| Insecto|
...
|CELLSNET-44368 | Problema de formato de un millón de números al convertir Excel a PDF| Insecto|
|CELLSNET-44347 | API representa dos páginas de PDF para una hoja de trabajo independientemente de configurar OnePagePerSheet en verdadero| Insecto|
...
|CELLSNET-44348 | El número se redondea al convertir HTML a formato de hoja de cálculo| Insecto|
