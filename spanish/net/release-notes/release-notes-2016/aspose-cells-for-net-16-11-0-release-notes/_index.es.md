...
type: docs
weight: 20
url: /es/net/aspose-cells-for-net-16-11-0-release-notes/
---
...
|CELLSNET-44847 | Problema de rendimiento con la función GetPivotData| Actuación|
|CELLSNET-44832 | Problema con SheetRender.PageCount que lleva mucho tiempo calcular las páginas de la hoja de trabajo| Actuación|
|CELLSNET-44861 |El método Range.Copy() se congela para grandes rangos de Excel| Actuación|
...
|CELLSNET-44448 | El contenido de la tabla dinámica no se muestra correctamente en el PDF de salida| Insecto|
...
|CELLSNET-43623 |Problema con el tamaño del archivo convertido (Conversión de Excel a PDF)| Insecto|
|CELLSNET-43439 | Aumento considerable en el tamaño del archivo PDF de salida a partir de un archivo de Excel relativamente más pequeño| Insecto|
|CELLSNET-44842 | Falta la etiqueta cuando un gráfico se convierte en imagen| Insecto|
|CELLSNET-44806 | La línea de tendencia en el gráfico no se muestra bien en el PDF de salida| Insecto|
...
|CELLSNET-44884 | La operación de volver a guardar corrompe la hoja de cálculo cuando el nombre de la hoja de trabajo es "o"| Insecto|
...
|CELLSNET-44868 | Cambiar la imagen de fondo de una forma corrompe el archivo XLS de salida| Insecto|
...
|CELLSNET-44873 |Excepción al guardar PulseSecure_Lista de precios_noviembre de 2016_102816_ v1.0.xlsx Archivo de Excel a HTML| Excepción|
|CELLSNET-44872 |Excepción al guardar PulseSecure_Lista de precios_octubre de 2016_093016_ v1.xlsx Archivo de Excel a HTML| Excepción|
...
|CELLSNET-44725 |Error de tiempo de ejecución de JavaScript: el objeto no admite la propiedad o el método 'fireEvent'| Excepción|
