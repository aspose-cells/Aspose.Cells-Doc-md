---
title: Aspose.Cells for .NET 8.5.0 Notas de la versión
type: docs
weight: 70
url: /es/net/aspose-cells-for-net-8-5-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 8.5.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.0/)
...
## **Nuevas características**
 ...
 (CELLSNET-43640): no se puede representar el patrón de formato de fecha personalizado g y ge.mm.dd
...
## **Insectos**
 ...
 (CELLSNET-43702): hoja de cálculo dañada después de abrir y guardar el archivo de plantilla XLSX

 (CELLSNET-43669) - Agregar más de 14 campos al filtro de informe de la tabla dinámica genera un error
...
(CELLSNET-43658) - Se produce un error al calcular la excepción de celda al calcular la fórmula
 ...
 (CELLSNET-43693): texto fuera de lugar al procesar la hoja de cálculo en la imagen

 (CELLSNET-43691) - El texto se trunca en la parte inferior
...
(CELLSNET-43600) - El archivo de Excel no se representa correctamente
 ...
 (CELLSNET-43453) - El texto se recorta

 (CELLSNET-43365) - La línea horizontal no se procesa

 (CELLSNET-43102) - Diferencia en el espaciado de fuentes

 (CELLSNET-42832): el texto fuera del salto de página se representa en PDF como texto ajustado.

 (CELLSNET-42751): el texto sobrepasa la celda y se corta

 (CELLSNET-42721) - El pdf de salida tiene una página adicional

 (CELLSNET-42720) - El texto está cortado en el pdf de salida

 (CELLSNET-42696) - Personajes que se tocan después de la conversión

 (CELLSNET-42542) - El texto fusionado y distorsionado se corta al convertir XLSX a PDF
...
(CELLSNET-42922) - Las líneas guía están ocultas cuando se renderiza al formato de archivo PDF
 ...
 (CELLSNET-43650) - Cells.CopyColumns no copia el formato condicional
...
## **Excepciones**
 ...
 (CELLSNET-43671): la referencia de objeto no se establece en una instancia de una excepción de objeto
...
## **Nuevas características**
 ...
 (CELLSNET-43692): cree un control deslizante de zoom en GridDesktop como el de Excel
