...
type: docs
weight: 110
url: /es/net/aspose-cells-for-net-8-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 8.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.3.2/)
...
## **Mejoras**
 ...
 (CELLSNET-43305) - Copiar un rango con PasteType.All no copia el hipervínculo
...
(CELLSNET-43263) - Problema en la representación de la imagen
 ...
 (CELLSNET-43212): diferencias en la representación de etiquetas de datos de texto enriquecido en Excel y PDF
