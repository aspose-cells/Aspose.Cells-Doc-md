...
type: docs
weight: 40
url: /es/net/aspose-cells-for-net-8-6-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 8.6.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.0/)
...
## **Mejoras**
 ...
 (CELLSNET-43892) - El tamaño del documento XLSX aumenta con cada guardado
...
(CELLSNET-43750): cambios en el gráfico en la hoja de cálculo resultante después de actualizar el gráfico
 ...
 (CELLSNET-43879): caracteres superpuestos y convertidos a ######## en la representación de Excel a PDF
 ...
 (CELLSNET-42384) - Los cuadros de WordArt se bloquean cuando XLSX se convierte a PDF
...
(CELLSNET-43893): CellsException al representar una hoja de cálculo en formato PDF
 ...
 (CELLSNET-43835) - System.OutOfMemoryException al convertir un archivo XLS a formato de archivo PDF
