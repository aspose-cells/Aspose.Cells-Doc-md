...
type: docs
weight: 3
url: /es/net/aspose-cells-for-net-21-10-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-49132|Abra archivos con una tabla HTML dentro como archivos XLS|Nueva caracteristica|
...
|CELLSNETCORE-135|La aplicación se detiene mientras calcula archivos grandes y UDF|Actuación|
...
|CELLSNET-49245|Cambios de imagen en archivos XLS específicos cuando se procesan en HTML|Insecto|
|CELLSNET-49246|La imagen no es visible al convertir un archivo XLSX específico a HTML|Insecto|
...
|CELLSNET-48613|Un recurso que está fuera del rango seleccionado no debe exportarse a HTML|Insecto|
...
|CELLSNET-49239|El efecto de sombra se aplica a las imágenes al convertir de XLSM a XLS|Insecto|
...
|CELLSNETCORE-269|Se agrega una fila incorrecta con gran altura a la tabla HTML|Insecto|
|CELLSNETCORE-270|Problemas con la fuente HtmlString cuando Excel se guarda como HTML una vez|Insecto|
