...
type: docs
weight: 28
url: /es/net/aspose-cells-for-net-21-3-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47842|Rendimiento lento al actualizar una tabla dinámica grande|Actuación|
...
|CELLSNET-47872|MS Excel muestra un mensaje de error al abrir un archivo XLTM vuelto a guardar antes del Aspose.Cells|Insecto|
...
|CELLSNET-47863|Agregar etiquetas HTML a la celda arroja System.FormatException|Excepción|
|CELLSNET-47868|Excepción de índice de fila final no válida al abrir el archivo XLS de Office 2000|Excepción|
