...
type: docs
weight: 5
url: /es/net/aspose-cells-for-net-21-8-release-notes/
---
{{% alert color="primary" %}}
...
|:- |:- |:- |
|CELLSNET-48470|Admite el escalado de páginas de hojas de trabajo al exportar archivos a HTML|Nueva caracteristica|
...
|CELLSNET-48372|Espere guardar en html para el archivo XLSB|Actuación|
...
|CELLSNET-47839|Error de forma a imagen al guardar XLSX en PDF|Insecto|
...
|CELLSNET-48333| Las columnas de la tabla en el rango con alineación inferior se combinan en HTML convertido|Insecto|
...
|CELLSNET-47369|Falta el punto del gráfico y la forma está comprimida en la imagen EMF generada|Insecto|
...
|CELLSNET-48385|XLSX a TIFF: las barras gráficas no se representan en la salida|Insecto|
...
|CELLSNET-48172|"Error de forma a imagen" al convertir un archivo de Excel a PDF|Excepción|
