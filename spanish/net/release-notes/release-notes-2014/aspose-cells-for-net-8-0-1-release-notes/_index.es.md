...
type: docs
weight: 80
url: /es/net/aspose-cells-for-net-8-0-1-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 8.0.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.0.1/)
