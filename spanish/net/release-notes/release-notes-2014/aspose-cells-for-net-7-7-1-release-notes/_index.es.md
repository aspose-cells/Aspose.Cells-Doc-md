...
type: docs
weight: 110
url: /es/net/aspose-cells-for-net-7-7-1-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 7.7.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.7.1/)
...
(CELLSNET-40910) - Lea archivos grandes de MS Excel en modo de celdas ligeras - (LightCells API)
 ...
 (CELLSNET-42229): representación de celdas sin colores como celdas transparentes en la función Hoja a imagen
...
## **Insectos**
 ...
 (CELLSNET-42220): problema con la representación de la forma de flecha en el archivo PDF de salida
...
(CELLSNET-42217) - MS Excel muestra el mensaje "Contenido ilegible"
 ...
 (CELLSNET-42184) - Unicode/Doble byte/JPN - Problemas de conversión de HTML
...
(CELLSNET-41342) - Tabla dinámica - Valor faltante para el campo "RowHeaderCaption" (*.xlsb)
 ...
 (CELLSNET-41341) - Tabla dinámica: valor faltante del origen de datos para tablas dinámicas con varios rangos de consolidación (*.xlsb)
...
(CELLSNET-41330) - Tabla dinámica - Estado incorrecto "Permitir varios filtros por campo" (*.xlsb)
 ...
 (CELLSNET-41847) - Problema de pérdida de datos y alineación incorrecta de etiquetas cuando el archivo de Excel se convierte a formato PDF

 (CELLSNET-42112): problema de formato de generación de PDF con los datos

 (CELLSNET-42266) - Las filas de título aparecen dos veces en la primera página en el pdf de salida

 (CELLSNET-42097) - Generación de PDF - Problema de formato de datos

(CELLSNET-41435) - La alineación de celda vertical no se mantiene al representar Excel en una imagen PNG para celdas con formato condicional

 (CELLSNET-42267) - No se puede obtener la imagen de un gráfico

 (CELLSNET-42221) - Problema de flecha de representación en el formato de archivo HTML de salida
 ...
 (CELLSNET-42275): problema de altura de fila de ajuste automático en MS Excel 2007
...
(CELLSNET-42238): la celda vinculada no se actualiza desde la lista desplegable
 ...
 (CELLSNET-42225) - Problema de formato condicional en formato de archivo XPS
 ...
 (CELLSNET-41918) - Aspose Cells daña los libros de trabajo XLSB que contienen objetos incrustados
 ...
 (CELLSNET-41789): problema de Guardar como XLSX por Aspose.Cells y Open Xml SDK
...
## **Public API y cambios incompatibles con versiones anteriores**
 ...
 A partir de esta versión, Aspose.Cells ya no se distribuye con una DLL para usar en .NET Framework 1.1. Se eliminó la compatibilidad con esta versión del marco para facilitar mejor las funciones y las correcciones, ya que es difícil agregar algunas funciones a esta versión anterior del marco.
