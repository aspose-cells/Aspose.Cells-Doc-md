---
title: Aspose.Cells for .NET 8.2.2 Notas de la versión
type: docs
weight: 20
url: /es/net/aspose-cells-for-net-8-2-2-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 8.2.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.2/)
...
(CELLSNET-43061) - Valor incorrecto calculado en comparación con MS Excel
 ...
 (CELLSNET-43003) - El texto en forma se representa al revés cuando la hoja de cálculo se convierte en imagen

 (CELLSNET-43002) - Forma superpuesta al texto cuando la hoja de cálculo se representa como imagen

 (CELLSNET-42903): problema de sangría de texto

 (CELLSNET-42838): el texto del cuadro de texto no se muestra en el PDF resultante.

 (CELLSNET-41658): la tabla dinámica no conserva el formato condicional
...
(CELLSNET-42999) - Las flechas de formato condicional son más pequeñas
 ...
 (CELLSNET-42987) - El color de la forma cambia cuando se abre y se vuelve a guardar el archivo de origen

 (CELLSNET-42960) - El texto de DataLabels está envuelto en el formato de archivo de imagen de salida

 (CELLSNET-42957): el cuarto gráfico de la página 10 no se parece a Excel

 (CELLSNET-42956) - El cuarto gráfico de la página 8 no se parece a Excel

 (CELLSNET-42955) - El segundo gráfico de la página 8 no se parece a Excel

 (CELLSNET-42905): línea adicional sobre la barra en el gráfico de barras
...
(CELLSNET-42646): la opción RefreshChartCache del libro de trabajo no tiene en cuenta la configuración regional y de idioma.
 ...
 (CELLSNET-42639) - Los cuadros de texto se han extraviado

 (CELLSNET-42638) - Las marcas de leyenda tienen un grosor diferente

 (CELLSNET-42637) - Falta el título del eje cuando el gráfico se guarda como EMF mediante ToImage

 (CELLSNET-42636) - Faltan valores de eje cuando el gráfico se guarda como EMF mediante ToImage

 (CELLSNET-42613): faltan elementos al extraer gráficos complejos

 (CELLSNET-43073): cambia el formato previo del gráfico de los iconos de puntos de datos personalizados
...
(CELLSNET-43048) - ListObject Resize elimina CalculatedColumnFormula
 ...
 (CELLSNET-43024): error de valor de estilo de dispersión no válido en la hoja de cálculo "Alarm Volume_Sep152013.xlsx"

 (CELLSNET-43023): error de valor de estilo de dispersión no válido en la hoja de cálculo de alarma "Performance_Sep152013.xlsx"

 (CELLSNET-43022) - Los nombres de rango no se eliminan después de eliminar hojas
...
(CELLSNET-42981): valor incorrecto de una función de valor después de CalculateFormula
 ...
 (CELLSNET-42740): las entradas de etiquetas de datos en el gráfico de burbujas son incorrectas
...
## **Excepciones**
 ...
 (CELLSNET-43034) - Error en Cell: excepción al abrir el libro de Excel

 (CELLSNET-43013): excepción de referencia nula al abrir el documento
...
Obtiene la hoja de cálculo que contiene este gráfico.
 ...
 Aspose.Cells. Actualización de las propiedades de GridWeb.Data.RowFilterSettings

 Elimine propiedades: StartRow/EndRow y agregue propiedades: StartColumn/EndColumn.
