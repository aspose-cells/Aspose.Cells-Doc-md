---
title: Aspose.Cells for .NET 8.0.0 Notas de la versión
type: docs
weight: 90
url: /es/net/aspose-cells-for-net-8-0-0-release-notes/
---
{{% alert color="primary" %}}

 Esta página contiene notas de la versión para[Aspose.Cells for .NET 8.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.8.0/)
