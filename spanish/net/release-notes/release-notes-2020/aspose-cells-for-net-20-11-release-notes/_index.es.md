...
type: docs
weight: 2
url: /es/net/aspose-cells-for-net-20-11-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47641|Advertencia generada al agregar 29 hojas y abrir el archivo XLS de salida en MS Excel|Actuación|
|CELLSNET-46716|El texto se cortó al renderizar PDF|Insectos|
...
|CELLSNET-47660|El campo del gráfico que contiene fechas tiene un formato diferente en formato PDF|Insectos|
|CELLSNET-47661|Aspose.Cells genera marcado HTML no válido para una hoja de trabajo particular de un documento Cells particular|Insectos|
...
|CELLSNET-47698|Cambie la posición del logotipo al convertir un archivo XLS a PDF|Insectos|
...
|CELLSNET-47697|Algunos valores del eje Y salen del gráfico en el PDF de salida|Insectos|
|CELLSNET-43579|La curvatura del texto de WortArt cambia al convertir de Excel a PDF|Insectos|
|CELLSNET-47675|El contenido del archivo XLS se cambia después de cargar y guardar|Insectos|
|CELLSNET-47704|Las propiedades personalizadas desaparecieron después de editar/guardar un archivo XLS protegido con contraseña (cifrado)|Insectos|
...
|CELLSNET-47669|Se lanza una ArgumentException de índice de columna no válida al convertir la primera hoja de trabajo a HTML|Excepciones|
...
|CELLSNET-47694|Excepción al abrir el archivo XLSX del documento|Excepciones|
|CELLSNET-47695|Nombre de celda no válido después de DeleteRange|Excepciones|
|CELLSNET-47699|Excepción al abrir un archivo ODS|Excepciones|
