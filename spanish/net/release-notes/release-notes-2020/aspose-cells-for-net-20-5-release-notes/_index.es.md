...
type: docs
weight: 30
url: /es/net/aspose-cells-for-net-20-5-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47308|Faltan pocas propiedades en el HTML de salida después de configurar Cell.HtmlString|Insecto|
...
|CELLSNET-47324|Error de icono en la conversión de Excel a PDF|Insecto|
...
|CELLSNET-47351|Formato condicional que causa StackOverflowException al guardar en PDF|Excepción|
|CELLSNET-47319|NullReferenceException en archivo de Excel con imagen SVG vinculada|Excepción|
