...
type: docs
weight: 10
url: /es/net/aspose-cells-for-net-v4-5-1-hotfix-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells para revisión de .Net V4.5.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.5.1-hotfix/)
