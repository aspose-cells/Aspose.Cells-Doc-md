---
title: DNN Importar Usuarios desde Excel
type: docs
weight: 30
url: /es/net/dnn-import-users-from-excel/
---
## **Introducción**
Aspose .NET Importar usuarios desde el módulo de Excel permite a los desarrolladores importar usuarios a granel desde un archivo de Excel. Este módulo demuestra la poderosa función de hoja de cálculo por Aspose.Cells.
### **Características del módulo**
Esta versión inicial del módulo está enriquecida con las siguientes características geniales para que el proceso de importación sea simple y fácil de usar:

- Le permite cargar un archivo de Excel y filtra automáticamente los usuarios existentes.
- Salta automáticamente a los usuarios existentes para evitar confusiones.
- Genere contraseñas dinámicas para los usuarios recién creados.
- Asigna los roles de seguridad "Usuarios registrados" y "Suscriptores" a los usuarios recién creados.
...
No dude en contactarnos si desea instalar estos módulos en otras versiones de DNN.
## **Descargando**
Puede descargar Aspose .NET Cells Importar usuarios de Excel para el módulo DNN desde una de las siguientes ubicaciones
...
1. De la lista, seleccione 'Aspose Importar usuarios del módulo Excel para DNN' y arrástrelo a su posición.

Ha agregado con éxito Aspose .NET Cells Importar usuarios del módulo Excel para el módulo DNN a su página. Los controles de carga de archivos estarán visibles junto con el enlace "Archivo de plantilla". Puede descargar el archivo de plantilla y formatear su contenido según el archivo de plantilla. Una vez que cargue su archivo de Excel, procesará automáticamente a todos los usuarios y filtrará a los usuarios existentes. Puede seleccionar los usuarios que desea importar y presionar el botón "Importar usuarios".
