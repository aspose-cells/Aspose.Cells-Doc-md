---
title: DNN Exportar Usuarios y Roles a Excel
type: docs
weight: 20
url: /es/net/dnn-export-users-and-roles-to-excel/
---
## **Introducción**
Aspose .NET El módulo Exportar usuarios y roles a Excel permite a los desarrolladores exportar usuarios DNN junto con sus roles a Microsoft Excel u OpenOffice Spreadsheet. Este módulo demuestra la potente función de creación de hojas de cálculo proporcionada por Aspose.Cells.
...
- Opción para exportar todos o los usuarios seleccionados al formato de documento de salida seleccionado.
...
No dude en contactarnos si desea instalar estos módulos en otras versiones de DNN.
## **Descargando**
Puede descargar Aspose .NET Cells Exportar usuarios y roles a Excel para el módulo DNN desde una de las siguientes ubicaciones
...
1. De la lista, seleccione 'Aspose Exportar usuarios y roles a Excel' y arrástrelo a su posición.

Ha agregado con éxito el módulo Aspose .NET Exportar usuarios y roles a Excel para DNN a su página. Todos los usuarios de dnn estarán visibles en la cuadrícula y puede elegir usuarios para exportar y hacer clic en el botón "Exportar" después de seleccionar el formato de salida deseado del menú desplegable. El archivo deseado se descargará automáticamente.
