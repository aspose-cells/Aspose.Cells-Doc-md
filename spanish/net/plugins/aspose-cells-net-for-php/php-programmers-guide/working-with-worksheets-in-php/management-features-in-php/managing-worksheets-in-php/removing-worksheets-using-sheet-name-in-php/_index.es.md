...
## **Descargar código de ejecución**
 Descargar**Eliminación de hojas de trabajo usando el nombre de la hoja (Aspose.Cells)**de cualquiera de los sitios de codificación social mencionados a continuación:
