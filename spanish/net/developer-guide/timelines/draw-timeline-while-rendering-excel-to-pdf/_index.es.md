...
type: docs
weight: 60
url: /es/net/draw-timeline-while-rendering-excel-to-pdf/
...
Si tiene un archivo de Excel al que se le ha aplicado una línea de tiempo y desea exportar el Excel a PDF con la configuración de la línea de tiempo, Aspose.Cells ahora lo admite de manera predeterminada. Simplemente exporte el archivo de Excel con la línea de tiempo a PDF, el PDF generado mostrará la línea de tiempo aplicada.
