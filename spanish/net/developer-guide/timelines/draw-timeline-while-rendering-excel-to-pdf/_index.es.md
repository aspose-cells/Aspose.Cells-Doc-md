...
description: Gestionar líneas de tiempo de archivos de Excel con Aspose.Cells.
...
Si tiene un archivo de Excel al que se le ha aplicado una línea de tiempo y desea exportar el archivo de Excel a PDF con la configuración de la línea de tiempo, Aspose.Cells ahora admite esto de forma predeterminada. Simplemente exporte el archivo de Excel con la línea de tiempo a PDF, el PDF generado mostrará la línea de tiempo aplicada.
