...
type: docs
weight: 20
url: /es/net/modify-existing-sql-data-connection-using-aspose-cells/
---
...
Similarmente, Aspose.Cells proporciona los medios para acceder y modificar las conexiones de datos utilizando la colección Workbook.DataConnections.
