...
- **ancho** – el ancho de la etiqueta, en unidades de 1/4000 del área del gráfico.
 ...
 El método vuelve[**Aspose.Cells.Drawing.Label**](https://reference.aspose.com/cells/net/aspose.cells.drawing/label)objeto. los[**Etiqueta**](https://reference.aspose.com/cells/net/aspose.cells.drawing/label) class representa una etiqueta en el gráfico. Tiene algunos miembros importantes:
...
- **ancho** – el ancho del cuadro de texto, en unidades de 1/4000 del área del gráfico.
 ...
 El método vuelve[**Aspose.Cells.Drawing.TextBox**](https://reference.aspose.com/cells/net/aspose.cells.drawing/textbox) objeto. los[**Caja de texto**](https://reference.aspose.com/cells/net/aspose.cells.drawing/textbox)class representa un cuadro de texto en el gráfico.
...
- **corriente** – un objeto de flujo que contiene los datos de la imagen.
...
- **alturaEscala** – la escala de altura de la imagen, un valor porcentual.
 ...
 El método devuelve un[**Aspose.Cells.Drawing.Picture**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture) objeto. los[**Imagen**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture)class representa un objeto de imagen en el gráfico.
...
![todo:imagen_alternativa_texto](controls-in-charts_1.jpg)
 ...
 los[archivo de salida](101089316.xlsx)generado por el siguiente fragmento de código se adjunta para su referencia.
