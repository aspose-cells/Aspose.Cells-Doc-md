...
description: Aprenda cómo leer y manipular gráficos de Excel 2016 utilizando Aspose.Cells for .NET. Nuestra guía le mostrará cómo acceder y modificar varias propiedades del gráfico, incluidas las etiquetas de datos, los colores de las series y el diseño.
keywords: Aspose.Cells for .NET, gráficos de Excel 2016, leer, manipular, etiquetas de datos, colores de series, diseño, gráficos jerárquicos, gráficos circulares.
type: docs
weight: 48
url: /es/net/read-and-manipulate-excel-2016-charts/
---
...
## **Temas avanzados**
- [Creación de gráfico de cascada](/cells/es/net/creating-waterfall-chart/)
- [Creación de gráfico de mapa de árbol](/cells/es/net/creating-treemap-chart/)
- [Creación de gráfico de ráfaga solar](/cells/es/net/creating-sunburst-chart/)
