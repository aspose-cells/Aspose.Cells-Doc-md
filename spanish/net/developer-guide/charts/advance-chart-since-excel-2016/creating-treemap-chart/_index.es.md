...
description: Aprenda a crear un gráfico de Treemap en Aspose.Cells for .NET. Nuestra guía le ayudará a entender las diversas opciones de propiedades y formatos disponibles para los gráficos de Treemap, incluidos colores, etiquetas y representación de datos.
keywords: Aspose.Cells for .NET, gráfico de Treemap, crear, propiedades, formato, colores, etiquetas, representación de datos, gráfico circular, representación jerárquica.
type: docs
weight: 161
url: /es/net/creating-treemap-chart/
---
