...
description: Aprenda a crear un gráfico de anillo solar en Aspose.Cells for .NET, un gráfico que presenta datos en un círculo. Nuestra guía le ayudará a configurar varias propiedades y formatos de su gráfico, incluidas etiquetas de datos, leyendas, colores y más.
keywords: Aspose.Cells for .NET, gráfico de anillo solar, crear, configurar propiedades, etiquetas de datos, leyenda, formato, color, círculo, representación de datos.
type: docs
weight: 162
