...
description: Aprenda a manejar unidades automáticas en los ejes del gráfico en Aspose.Cells for .NET, similar a Microsoft Excel. Nuestra guía le mostrará cómo configurar y personalizar las unidades automáticas en un eje del gráfico, incluyendo la visualización de notación científica y ajuste de la escala.
keywords: Aspose.Cells for .NET, ejes de gráfico, unidades automáticas, Microsoft Excel, configuración, personalización, notación científica, escalado.
type: docs
weight: 120
