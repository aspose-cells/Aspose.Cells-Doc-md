...
description: Aprenda cómo entender y trabajar con ejes primarios y secundarios en Aspose.Cells for .NET. Nuestra guía le ayudará a comprender las diferencias entre los ejes primarios y secundarios, y cómo configurar y utilizarlos de manera efectiva en sus gráficos.
keywords: Aspose.Cells for .NET, ejes primarios, ejes secundarios, comprensión, diferencias, configuración, uso.
type: docs
weight: 190
url: /es/net/primary-and-second-axis/
---
