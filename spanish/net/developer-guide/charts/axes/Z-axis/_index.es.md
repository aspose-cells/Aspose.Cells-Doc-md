...
## **Manejar eje primario y segundo como Microsoft Excel**
 Consulte el siguiente código de muestra que crea un nuevo archivo de Excel y coloca los valores del gráfico en la primera hoja de cálculo. Luego agregamos un gráfico y establecemos el tipo de gráfico en Column3D, luego puede ver el eje Z, también llamado eje de profundidad.
