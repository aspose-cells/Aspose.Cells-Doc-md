...
Es posible eliminar todas las filas y columnas en blanco de una hoja de trabajo. Esto es útil cuando, por ejemplo, genera un archivo PDF a partir de un archivo de Excel Microsoft y desea convertir solo filas y columnas que contienen datos.
