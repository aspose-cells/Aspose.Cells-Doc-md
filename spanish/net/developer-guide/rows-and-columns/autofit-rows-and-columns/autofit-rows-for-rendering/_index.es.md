...
Si desea evitar que el texto se recorte en el archivo PDF guardado, puede ajustar automáticamente la fila con el[AutoFitterOptions.ForRendering](https://reference.aspose.com/cells/net/aspose.cells/autofitteroptions/forrendering/) opción.
