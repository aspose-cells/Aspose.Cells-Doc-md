...
Puede establecer el comentario de la Tabla u Objeto de Lista dentro de la hoja de cálculo utilizando la propiedad [**ListObject.Comment**](https://reference.aspose.com/cells/net/aspose.cells.tables/listobject/properties/comment). El comentario será visible dentro del archivo xl/tables/tableName.xml.
