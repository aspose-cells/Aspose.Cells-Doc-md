...
type: docs
weight: 330
url: /es/net/read-color-of-shape-s-glow-effect/
---

## Posibles Escenarios de Uso

Si desea leer el color del efecto de resplandor de cualquier forma, utilice la propiedad [**Shape.Glow.Color**](https://reference.aspose.com/cells/net/aspose.cells.drawing/gloweffect/properties/color). Le ayudará a encontrar varias propiedades relacionadas con el color del efecto de resplandor de la forma.
