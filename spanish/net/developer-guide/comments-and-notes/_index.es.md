...
description: Insertar y gestionar comentarios o notas con Aspose.Cells para .Net
...
Agregar un comentario a una celda llamando al método [**Add**](https://reference.aspose.com/cells/net/aspose.cells/commentcollection/methods/add/index) de la colección [**Comments**](https://reference.aspose.com/cells/net/aspose.cells/commentcollection) (encapsulado en el objeto [**Worksheet**](https://reference.aspose.com/cells/net/aspose.cells/worksheet)). El nuevo objeto [**Comment**](https://reference.aspose.com/cells/net/aspose.cells/comment) se puede acceder desde la colección [**Comments**](https://reference.aspose.com/cells/net/aspose.cells/commentcollection) pasando el índice del comentario. Después de acceder al objeto [**Comment**](https://reference.aspose.com/cells/net/aspose.cells/comment), personalice la nota del comentario utilizando la propiedad [**Note**](https://reference.aspose.com/cells/net/aspose.cells/comment/properties/note) del objeto [**Comment**](https://reference.aspose.com/cells/net/aspose.cells/comment).
