...
_Formato_: **SAO**
- [C# SAO a tabla de datos](#csharp-ods-to-datatable)
...
- <a name="csharp-convert-excel-to-datatable" id="csharp-convert-excel-to-datatable"><strong><em>Pasos:</em> Convertir Excel a DataTable en C#</strong></a>
  ...
  - <a name="csharp-convert-xlsx-to-datatable" id="csharp-convert-xlsx-to-datatable"><strong><em>Pasos:</em> Convierta XLSX a DataTable en C#</strong></a>
