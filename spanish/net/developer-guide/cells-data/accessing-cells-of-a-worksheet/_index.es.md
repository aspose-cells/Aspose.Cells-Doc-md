...
## **Accediendo al Cells**
 ...
 Nosotros podemos usar[**Cells**](https://reference.aspose.com/cells/net/aspose.cells/cells)colección para acceder a las celdas de una hoja de cálculo. Aspose.Cells proporciona tres enfoques básicos para acceder a las celdas en una hoja de trabajo:
