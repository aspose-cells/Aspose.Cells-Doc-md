...
type: docs
weight: 130
url: /es/net/add-calculated-field-in-pivot-table/
...
4. En el campo "Nombre", ingrese un nombre para el campo calculado.
 5. En el campo "Fórmula", ingrese la fórmula para el cálculo que desea realizar utilizando los nombres de campo de tabla dinámica y los operadores matemáticos apropiados.
<br>
...
Agregue el campo calculado al archivo de Excel usando Aspose.Cells. Consulte el siguiente código de ejemplo. Después de ejecutar el código de ejemplo, se agrega a la hoja de cálculo una tabla dinámica con un campo calculado.
