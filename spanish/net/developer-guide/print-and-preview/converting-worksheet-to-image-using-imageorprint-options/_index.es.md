...
###  **Descargar e Instalar Aspose.Cells**
 ...
 Primero, necesitas[descargar](https://downloads.aspose.com/cells/net) Aspose.Cells para .Net. Instálalo en tu computadora de desarrollo. Todo[Aspose](http://www.aspose.com/)Los componentes, cuando están instalados, funcionan en modo de evaluación. El modo de evaluación no tiene límite de tiempo y solo inyecta marcas de agua en los documentos producidos.
...
Una imagen TIFF puede contener más de un marco. Puede guardar todo el libro de trabajo en una sola imagen TIFF con marcos o páginas múltiples:
