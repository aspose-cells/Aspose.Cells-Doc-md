...
type: docs
weight: 120
url: /es/net/set-worksheet-tab-color/
description: Este artículo muestra un código de ejemplo que establece programáticamente el color de la pestaña de la hoja de cálculo de Excel utilizando la API C# o la biblioteca .NET.
keywords: establecer color de la pestaña de excel c#, código para establecer color de pestaña de excel c#
---
