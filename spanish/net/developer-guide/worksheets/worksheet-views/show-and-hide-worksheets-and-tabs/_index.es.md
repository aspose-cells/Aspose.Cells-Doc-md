...
continuación se muestra un ejemplo completo que abre un archivo de Excel (libro1.xls), oculta sus pestañas y guarda el archivo modificado como salida.xls. Después de la ejecución del código, verá que las pestañas del libro de trabajo están ocultas.
