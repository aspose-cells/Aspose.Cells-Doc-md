...
description: Este artículo muestra cómo mostrar y ocultar mediante programación filas y columnas de hojas de cálculo de Excel utilizando el lenguaje C# y .NET API o Biblioteca. La visibilidad de las barras de desplazamiento se puede ajustar y se pueden ocultar varias filas y columnas.
---
{{% alert color="primary" %}}
