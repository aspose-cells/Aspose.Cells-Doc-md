...
description: Este artículo proporciona código de muestra y explica cómo agregar saltos de página, borrar saltos de página o eliminar saltos de página específicos en hojas de cálculo de Excel mediante programación usando la biblioteca C# API o .NET.
