...
description: Este artículo explica cómo usar el código de muestra de la biblioteca C# API o .NET para determinar si el tamaño de papel de la hoja de trabajo es automático mediante programación.
...
![todo:imagen_alt_texto](determine-if-paper-size-of-worksheet-is-automatic_1.png)
