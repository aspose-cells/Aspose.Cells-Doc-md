...
description: Este artículo explica cómo insertar mediante programación una imagen en el encabezado y el pie de página de las hojas de cálculo de Excel configurando el encabezado y el pie de página con comandos de secuencia de comandos utilizando la biblioteca C# API o .NET.
