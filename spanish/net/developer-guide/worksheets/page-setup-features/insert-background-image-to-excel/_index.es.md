...
type: docs
weight: 90
url: /es/net/insert-background-image-to-excel/
description: Cómo insertar una imagen de fondo en Excel usando Aspose.Cells for .NET
---
{{% alert color="primary" %}} 
...
![todo:imagen_alternativa_texto](insert-background-to-excel.jpg)
