...
type: docs
weight: 200
url: /es/net/how-to-set-print-titles/
...
keywords: Imprimir filas y columnas repetidamente, Cómo establecer títulos de impresión en C#, Configurar y borrar títulos de impresión usando C#, Cómo borrar títulos de impresión en C#, Cómo agregar títulos de impresión en C#, Cómo eliminar títulos de impresión en C#, Cómo establecer títulos de impresión en Excel, Cómo borrar títulos de impresión en Excel.
---
...
Para establecer títulos de impresión en una hoja de cálculo específica: Primero, carga el [archivo de muestra](input.xlsx), y luego debes modificar las propiedades [**Worksheet.PageSetup.PrintTitleRows**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlerows/) y [**Worksheet.PageSetup.PrintTitleColumns**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlecolumns/) del objeto [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) para la hoja deseada. Configurar estas propiedades con una cadena de rango establecerá los títulos de impresión.
...
Para borrar los títulos de impresión en una hoja de cálculo específica: Primero, carga el [archivo de muestra](input.xlsx), y luego debes modificar las propiedades [**Worksheet.PageSetup.PrintTitleRows**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlerows/) y [**Worksheet.PageSetup.PrintTitleColumns**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlecolumns/) del objeto [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) para la hoja deseada. Configurar estas propiedades con una cadena vacía borrará los títulos de impresión.
