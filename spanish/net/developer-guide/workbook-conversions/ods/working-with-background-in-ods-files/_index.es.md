...
## **Leer información de antecedentes del archivo ODS**

Aspose.Cells proporciona el[**OdsPageFondo**](https://reference.aspose.com/cells/net/aspose.cells.ods/odspagebackground)clase para administrar el fondo en archivos ODS. El siguiente ejemplo de código demuestra el uso de[**OdsPageFondo**](https://reference.aspose.com/cells/net/aspose.cells.ods/odspagebackground) clase cargando el[SAO fuente](90112030.ods) archivo y leer la información de fondo. Consulte la salida de la consola generada por el código como referencia.
...
Aspose.Cells proporciona el[**OdsPageFondo**](https://reference.aspose.com/cells/net/aspose.cells.ods/odspagebackground)clase para administrar el fondo en archivos ODS. El siguiente ejemplo de código demuestra el uso de[**OdsPageBackground.GraphicData**](https://reference.aspose.com/cells/net/aspose.cells.ods/odspagebackground/properties/graphicdata)propiedad para agregar un fondo gráfico al archivo ODS. Por favor vea el[SAO de salida](90112030.ods)archivo generado por el código como referencia.
