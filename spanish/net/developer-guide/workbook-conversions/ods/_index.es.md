...
Aspose.Cells admite la carga de Ods, Sxc y Fods que son compatibles con OpenOffice / LibreOffice Calc, y convertir [Ods](book1.ods), [Sxc](book1.sxc) y [Fods](book1.fods) a archivos de Excel.
...
Aspose.Cells admite la conversión de archivos de Excel a archivos Ods, Sxc y Fods. El siguiente ejemplo de código muestra cómo convertir la [plantilla](book1.xlsx) a archivo Ods, Sxc y Fods.
