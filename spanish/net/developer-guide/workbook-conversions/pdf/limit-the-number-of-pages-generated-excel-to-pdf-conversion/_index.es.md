...
A veces, desea imprimir un rango de páginas en un archivo PDF de salida. Aspose.Cells tiene la capacidad de establecer un límite en la cantidad de páginas que se generan al convertir una hoja de cálculo de Excel al formato de archivo PDF.
...
{{% alert color="primary" %}}
 ...
 Si la hoja de cálculo contiene fórmulas, es mejor llamar[**Libro de trabajo. Calcular fórmula ()**](https://reference.aspose.com/cells/net/aspose.cells/workbook/methods/calculateformula) justo antes de convertirlo en PDF. Al hacerlo, se asegura que los valores dependientes de la fórmula se vuelvan a calcular y que los valores correctos se representen en el archivo de salida.
