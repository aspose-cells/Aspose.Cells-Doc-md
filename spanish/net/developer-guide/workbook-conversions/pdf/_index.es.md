...
{{% alert color="primary" %}}
 ...
 Aspose.Cells for .NET escribe directamente la información sobre API y el número de versión en los documentos de salida. Por ejemplo, al renderizar Documento a PDF, Aspose.Cells for .NET se rellena**PDF Productor** campo con valor, por ejemplo, 'Aspose.Cells v23.2'.

 Tenga en cuenta que puede cambiar esta información en los documentos de salida por**[PdfSaveOptions.Producer](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions/producer/)** propiedad.
...
![todo:imagen_alt_texto](convert-excel-workbook-to-pdf_1.png)
...
- [Convierta el archivo XLSX al formato PDF](/cells/es/net/convert-xlsx-file-to-pdf-format/)
...
- [Guardar hojas de trabajo especificadas en PDF](/cells/es/net/save-specified-worksheets-to-pdf/)
