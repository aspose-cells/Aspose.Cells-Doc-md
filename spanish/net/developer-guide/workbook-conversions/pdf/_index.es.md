...
Aspose.Cells admite la conversión de Excel Workbook a PDF. En este ejemplo, veremos la conversión completa de un libro de Excel a PDF.
...
{{% alert color="primary" %}}
 ...
 Aspose.Cells for .NET escribe directamente la información sobre API y el número de versión en los documentos de salida. Por ejemplo, al renderizar Documento a PDF, Aspose.Cells for .NET se completa**Solicitud** campo con valor 'Aspose.Cells' y**Productor de PDF**campo con valor, por ejemplo, 'Aspose.Cells v17.9'.
...
### **Conversión avanzada**
 ...
 También puede optar por utilizar el**[PdfSaveOptions](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions)** class para establecer diferentes atributos para la conversión. Configuración de diferentes propiedades del**[PdfSaveOptions](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions)** class le brinda control sobre la configuración de impresión, fuente, seguridad y compresión para el PDF de salida. La propiedad más importante es**[Cumplimiento](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions/properties/compliance)**que le permite guardar los archivos de Excel en archivos PDF compatibles con PDF/A.

#### **Guardar libro de trabajo en archivos PDF/A compilados**

 El fragmento de código proporcionado a continuación demuestra cómo usar el**[PdfSaveOptions](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions)**clase para guardar archivos de Excel en formato PDF compatible con PDF/A.
...
Trabajamos para mejorar las funciones de conversión con cada nuevo lanzamiento. La conversión de Excel a PDF de Aspose.Cell todavía tiene un par de limitaciones. Es posible que se pierda parte del formato de la hoja de cálculo al convertir a formato PDF. Además, algunos objetos de dibujo aún no son compatibles.
...
- [Agregar marcadores de PDF con destinos con nombre](/cells/es/net/add-pdf-bookmarks-with-named-destinations/)
- [Evite la página en blanco en el PDF de salida cuando no hay nada que imprimir](/cells/es/net/avoid-blank-page-in-output-pdf-when-there-is-nothing-to-print/)
...
- [Convertir un archivo XLS a formato PDF](/cells/es/net/convert-an-xls-file-to-pdf-format/)
- [Convierta un archivo de Excel a formato PDF compatible con PDFA-1a](/cells/es/net/convert-excel-file-to-pdf-format-compatible-with-pdfa-1a/)
- [Convierta archivos XLS con imágenes o gráficos a PDF](/cells/es/net/convert-xls-file-with-images-or-charts-to-pdf/)
...
- [Imprimir comentarios mientras se guarda en PDF](/cells/es/net/print-comments-while-saving-to-pdf/)
...
- [Renderizar una página PDF por hoja de cálculo de Excel - Conversión de Excel a PDF](/cells/es/net/render-one-pdf-page-per-excel-worksheet-excel-to-pdf-conversion/)
- [Representar caracteres complementarios Unicode en PDF de salida por Aspose.Cells](/cells/es/net/render-unicode-supplementary-characters-in-output-pdf-by-aspose-cells/)
...
- [Especifique cómo cruzar la cadena en el PDF de salida y la imagen](/cells/es/net/specify-how-to-cross-string-in-output-pdf-and-image/)
