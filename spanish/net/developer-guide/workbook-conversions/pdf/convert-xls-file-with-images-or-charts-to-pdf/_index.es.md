...
{{% alert color="primary" %}} 
 ...
 Si la hoja de cálculo contiene fórmulas, es mejor llamar al[Workbook.CalculateFormula](https://reference.aspose.com/cells/net/aspose.cells/workbook/methods/calculateformula) justo antes de representar a PDF. Al hacerlo, se asegura que los valores dependientes de la fórmula se vuelvan a calcular y los valores correctos se representen en PDF.
