...
## Conversión de libro de trabajo a TIFF
 ...
 El siguiente fragmento de código muestra cómo convertir Excel a TIFF con varias páginas. los[archivo fuente de Excel](workbook-to-tiff-with-mulitiple-pages.xlsx) y[imagen TIFF generada](workbook-to-tiff-with-mulitiple-pages.tiff) se adjuntan para su referencia.
...
Aspose.Cells for .NET ha podido convertir hojas de trabajo a imágenes SVG desde la versión 7.1.0. El siguiente fragmento de código muestra cómo convertir una hoja de trabajo en un archivo de Excel a un archivo de imagen SVG.
...
- [Seguimiento del progreso de la conversión de Excel a TIFF](/cells/es/net/track-conversion-progress-of-excel-to-tiff/)
