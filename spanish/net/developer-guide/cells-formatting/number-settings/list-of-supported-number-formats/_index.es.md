...
description: Aspose.Cells es una biblioteca .NET para procesar archivos de hojas de cálculo, que admite una variedad de formatos de números. Este artículo proporciona una lista de formatos de números admitidos para que los usuarios puedan seleccionar el formato apropiado según sus necesidades.
keywords: Aspose.Cells, biblioteca .NET, hoja de cálculo, formato de números, lista, admitido
type: docs
weight: 30
