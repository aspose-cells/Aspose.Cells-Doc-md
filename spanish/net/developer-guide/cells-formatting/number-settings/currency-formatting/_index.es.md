...
type: docs
weight: 10
url: /es/net/format-number-to-currency/
description: Este artículo introducirá cómo formatear números a moneda usando la API Aspose.Cells for .NET.
...
Para formatear números como moneda en la biblioteca Aspose.Cells for .NET para trabajar con archivos de Excel, puedes aplicar formateo de moneda a las celdas programáticamente. Aquí te mostramos cómo hacerlo usando C# con Aspose.Cells:
