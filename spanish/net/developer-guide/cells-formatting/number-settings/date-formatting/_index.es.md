...
type: docs
weight: 10
url: /es/net/format-number-to-date/
description: Este artículo introducirá cómo formatear números a fecha usando la API Aspose.Cells for .NET.
...
Para formatear números como fecha en la biblioteca Aspose.Cells for .NET para trabajar con archivos de Excel, puedes aplicar formateo de fecha a las celdas programáticamente. Así es como puedes hacerlo usando C# con Aspose.Cells:
