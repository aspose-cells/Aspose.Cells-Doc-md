...
type: docs
weight: 10
url: /es/net/how-to-format-number-to-time/
description: Este artículo introducirá cómo formatear un número a hora usando la API Aspose.Cells for .NET.
...
Formatear números a tiempo en Aspose.Cells for .NET implica establecer un formato personalizado para las celdas donde deseas mostrar el tiempo. Siguiendo los pasos descritos arriba, puedes aplicar fácilmente formatos de tiempo a las celdas en tus archivos de Excel usando Aspose.Cells. Recuerda, la clave es usar la cadena de formato personalizada correcta que coincida con el formato de tiempo deseado.
