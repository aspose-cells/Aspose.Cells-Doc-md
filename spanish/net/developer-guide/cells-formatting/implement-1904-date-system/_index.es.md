...
description: Aspose.Cells es una biblioteca .NET para trabajar con archivos de hojas de cálculo. Soporta la implementación del sistema de fecha 1904, permitiendo a los usuarios calcular y formatear basado en el sistema de fecha del 1 de enero de 1904. Este artículo describe cómo implementar el sistema de fecha 1904 usando la biblioteca Aspose.Cells.
keywords: Aspose.Cells, sistema de fecha 1904, hoja de cálculo, cálculo, formato
type: docs
weight: 7000
url: /es/net/implement-1904-date-system/
---
