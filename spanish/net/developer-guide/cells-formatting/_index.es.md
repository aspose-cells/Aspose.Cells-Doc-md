...
### **Dar formato a los caracteres seleccionados**
 ...
 Él[**Cell**](https://reference.aspose.com/cells/net/aspose.cells/cell) la clase proporciona la[**Caracteres**](https://reference.aspose.com/cells/net/aspose.cells/cell/methods/characters)método que toma los siguientes parámetros para seleccionar un rango de caracteres dentro de una celda:
