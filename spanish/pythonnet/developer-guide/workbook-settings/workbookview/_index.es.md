---
title: Cómo Controlar la Vista del Libro de Trabajo
type: docs
weight: 600
url: /es/python-net/how-to-control-workbook-view/
description: Aprende cómo controlar la vista del libro de trabajo a través de la API Aspose.Cells para Python via .NET.
...
Cuando necesite ajustar la visualización de las páginas de Excel, deberá saber cómo controlar cada módulo, como las barras de desplazamiento horizontal y vertical, si ocultar los archivos de Excel abiertos, y más. Aspose.Cells ofrece esta función. Aspose.Cells proporciona las siguientes propiedades y métodos para ayudarlo a lograr sus objetivos.
...
## **Cómo Controlar la Vista del Libro de Trabajo mediante Aspose.Cells for .NET**
