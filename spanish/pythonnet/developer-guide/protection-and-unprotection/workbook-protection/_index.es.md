---
title: Proteger y desproteger la estructura del libro
type: docs
weight: 40
url: /es/python-net/protect-and-unprotect-workbook-structure/
description: Proteger y desproteger la estructura de los libros de Excel utilizando códigos CSharp.
---
...
## **Proteger la estructura del libro usando Aspose.Cells para Python via .NET**
...
## **Desproteger la estructura del libro usando Aspose.Cells para Python via .NET**
Desproteger la estructura del libro es sencillo con la API Aspose.Cells para Python via .NET.
