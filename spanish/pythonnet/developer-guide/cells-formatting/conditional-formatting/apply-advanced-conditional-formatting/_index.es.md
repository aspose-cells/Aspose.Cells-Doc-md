...
- Barras de datos para visualización numérica
- Escalas de color para sombreado de celdas basado en gradientes
- Conjuntos de iconos para indicadores gráficos
- Reglas de arriba/abajo
- Formato basado en periodos de tiempo

Este ejemplo demuestra varios tipos de formato condicional avanzado con Python.NET:
