...
description: Cómo usar la biblioteca Aspose.Cells para Python via .NET para aplicar formato condicional de Periodos de Tiempo. Ajustando estos criterios, tienes más control sobre cómo se ven y aparecen las celdas.
keywords: Aspose.Cells, Formato condicional de Periodos de Tiempo, Python, Condicional, Formato
type: docs
weight: 70
url: /es/python-net/how-to-add-time-periods-conditional-formatting/
---
