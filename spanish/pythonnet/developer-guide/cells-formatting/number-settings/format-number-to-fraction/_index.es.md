...
type: docs
weight: 10
url: /es/python-net/how-to-format-number-to-fraction/
description: Este artículo presentará cómo Formatear Número a Fracción usando la API Aspose.Cells para Python via .NET.
...
## **Cómo formatear un número como fracción en Aspose.Cells para Python via .NET**
Formatear números a fracciones en Aspose.Cells para Python via .NET es un proceso sencillo. Aspose.Cells para Python via .NET es una biblioteca potente que te permite trabajar con archivos de Excel en aplicaciones .NET sin necesidad de tener instalado Microsoft Excel. Ofrece una amplia gama de funciones, incluyendo el formateo de números como fracciones.

Aquí tienes una guía paso a paso sobre cómo formatear números como fracciones en Aspose.Cells para Python via .NET:
