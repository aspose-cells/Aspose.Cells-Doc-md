...
type: docs
weight: 10
url: /es/python-net/how-to-format-number-to-accounting/
description: Este artículo introducirá cómo formatear números a contabilidad usando la API Aspose.Cells para Python via .NET.
...
## **Cómo formatear números en formato contable en Aspose.Cells para Python via .NET**
Para formatear números en formato contable en Aspose.Cells para Python via .NET, puedes usar el objeto `Style` asociado a una celda o rango de celdas. El objeto `Style` te permite establecer varias opciones de formato, incluyendo los formatos numéricos. El formato contable generalmente tiene un código de formato que puede variar dependiendo de los requisitos específicos (como si mostrar símbolos de moneda, decimales, etc.).

Aquí tienes un ejemplo básico de cómo aplicar un formato de número contable a una celda en Aspose.Cells para Python via .NET:

1. **Referenciar Aspose.Cells**: Asegúrate de tener Aspose.Cells para Python via .NET referenciado en tu proyecto.
