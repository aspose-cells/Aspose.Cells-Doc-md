...
type: docs
weight: 10
url: /es/python-net/format-number-to-date/
description: Este artículo introduce cómo formatear un número como fecha usando la API Aspose.Cells para Python via .NET.
...
## **Cómo formatear número a fecha en Aspose.Cells para Python via .NET**

Para formatear números como fecha en la biblioteca Aspose.Cells para Python via .NET para trabajar con archivos de Excel, puedes aplicar formateo de fecha a las celdas programáticamente. Aquí te mostramos cómo hacerlo usando Python con Aspose.Cells:
