...
description: Aspose.Cells es una biblioteca de Python para procesar archivos de hojas de cálculo, que soporta una variedad de formatos numéricos. Este artículo proporciona una lista de los formatos numéricos soportados para que los usuarios puedan seleccionar el formato adecuado según sus necesidades.
keywords: Aspose.Cells, biblioteca Python, hoja de cálculo, formato numérico, lista, soportado
type: docs
weight: 30
url: /es/python-net/list-of-supported-number-formats/
---

## **Aspose.Cells for Python via .NET**
El componente Aspose.Cells para Python via .NET ofrece algunos formatos de número integrados para configurar los formatos de visualización de los números y fechas. Estos formatos de número integrados se aplican usando la propiedad **Number** del objeto **Style**. Todos los formatos de número integrados tienen valores numéricos únicos. Los desarrolladores pueden asignar cualquier valor numérico deseado a la propiedad *Number* del objeto **Style** y así aplicar el formato de visualización. Este método es más rápido. Los formatos de número integrados soportados por el componente Aspose.Cells para Python via .NET son los siguientes:
