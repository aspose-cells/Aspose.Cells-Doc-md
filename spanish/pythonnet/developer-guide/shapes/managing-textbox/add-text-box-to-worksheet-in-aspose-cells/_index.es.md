...
type: docs
weight: 10
url: /es/python-net/add-text-box-to-worksheet-in-aspose-cells/
description: Cómo agregar/insertar un cuadro de texto en la hoja de cálculo en Aspose.Cells para Python via .NET.
...
## Agregar cuadro de texto a la hoja de cálculo en Aspose.Cells para Python via .NET
