...
type: docs
weight: 290
url: /es/python-net/set-line-spacing-of-the-paragraph-in-a-shape-or-textbox/
---

{{% alert color="primary" %}}

Puedes establecer el espaciado de línea del párrafo, su espacio antes y espacio después usando las propiedades [**TextParagraph.line_space**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing.texts/textparagraph/line_space), [**TextParagraph.space_before**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing.texts/textparagraph/space_before) y [**TextParagraph.space_after**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing.texts/textparagraph/space_after) de la clase [**TextParagraph**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing.texts/textparagraph/).
