---
title: Excel  Estilo de Referencia R1C1 vs. A1
type: docs
weight: 30
url: /es/python-net/r1c1-reference-style-vs-a1/
description: Estilo de Referencia R1C1 vs. Estilo A1 utilizando la API de Aspose.Cells for Python via .NET.
keywords: Biblioteca de Excel de Python, Estilo de Referencia R1C1 de Python vs. Estilo A1, Estilo de Referencia R1C1 de Python, Cómo cambiar entre el Estilo de Referencia R1C1 y el Estilo de Referencia A1 de Python, Estilo de Referencia A1 de Python.
---
...
Este es el estilo de referencia predeterminado en Excel. En el estilo A1, las columnas se identifican por letras (A, B, C, ..., Z, AA, AB, ..., ZZ, AAA, AAB, ...) y las filas se identifican por números (1, 2, 3, ...).
Por ejemplo, la celda en la primera columna y segunda fila se denomina A2.
...
Por ejemplo, R[2]C[3] es una celda 2 filas abajo y 3 columnas a la derecha. R[-1]C[-4] es una celda 1 fila arriba y 4 columnas a la izquierda. Si no se muestra ningún número entre corchetes, entonces se está refiriendo a la misma fila o columna, es decir, R[3]C será una celda 3 filas debajo de la celda actual en la misma columna.
<br>
