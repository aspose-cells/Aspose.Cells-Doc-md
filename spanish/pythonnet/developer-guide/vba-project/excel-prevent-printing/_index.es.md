...
type: docs
weight: 600
url: /es/python-net/how-to-prevent-printing-excel/
description: Aprender cómo prevenir que los usuarios impriman Excel a través de la API Aspose.Cells para Python via .NET.
...
## **Cómo prevenir que los usuarios impriman archivos de Excel usando Aspose.Cells para Python via .NET**
