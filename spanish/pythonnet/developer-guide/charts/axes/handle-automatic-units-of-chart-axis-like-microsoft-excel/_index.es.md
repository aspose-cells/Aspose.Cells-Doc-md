...
description: Aprende cómo manejar las unidades automáticas en los ejes de gráficos en Aspose.Cells para Python via .NET, similar a Microsoft Excel. Nuestra guía te mostrará cómo configurar y personalizar las unidades automáticas en un eje de gráfico, incluyendo la visualización en notación científica y ajuste de escala.
keywords: Aspose.Cells para Python via .NET, ejes de gráficos, unidades automáticas, Microsoft Excel, configuración, personalización, notación científica, escala.
type: docs
weight: 120
url: /es/python-net/handle-automatic-units-of-chart-axis-like-microsoft-excel/
---
