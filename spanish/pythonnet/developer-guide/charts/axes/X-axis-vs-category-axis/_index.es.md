...
description: Aprende cómo diferenciar entre el eje X y el eje de Categoría en Aspose.Cells para Python via .NET. Nuestra guía te ayudará a entender las diferencias en su uso y propiedades, y cómo configurarlos según tus necesidades.
keywords: Aspose.Cells para Python via .NET, eje X, eje de Categoría, diferencia, uso, propiedades, configuración.
type: docs
weight: 180
url: /es/python-net/X-axis-vs-category-axis/
---
