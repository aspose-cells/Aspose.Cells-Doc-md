...
description: Aprende cómo entender y trabajar con los ejes primario y secundario en Aspose.Cells para Python via .NET. Nuestra guía te ayudará a entender las diferencias entre los ejes primario y secundario, y cómo configurarlos y usarlos eficazmente en tus gráficos.
keywords: Aspose.Cells para Python via .NET, ejes primarios, ejes secundarios, comprensión, diferencias, configuración, uso.
type: docs
weight: 190
url: /es/python-net/primary-and-second-axis/
---
