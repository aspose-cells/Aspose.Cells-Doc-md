---
title: Cómo gestionar el Gráfico Dinámico con Opciones de Gráfico Dinámico
linktitle: Opciones de Gráfico Dinámico
type: docs
weight: 10
url: /es/python-net/how-to-manage-pivotchart-with-pivotoptions/
description: Cómo gestionar el Gráfico Dinámico con Opciones de Gráfico Dinámico.
keywords: PivotChart
---
...
Usando Aspose.Cells para Python via .NET, puedes usar [**PivotOptions**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/pivotoptions) para gestionar PivotChart.
