...
description: Aprende sobre los diversos tipos de gráficos soportados por Aspose.Cells para Python via .NET. Nuestra guía te acompañará a través de los diferentes tipos de gráficos disponibles y te mostrará cómo crearlos y modificarlos para mejorar tus hojas de cálculo.
keywords: Aspose.Cells para Python via .NET, gráficos, tipos de gráficos, soportados, creación, modificación, hojas de cálculo.
type: docs
weight: 5
url: /es/python-net/chart-types/
---

## **Introducción**
Un gráfico es una representación visual de información. Aspose.Cells para Python via .NET permite a los desarrolladores visualizar información en gráficos igual que lo hace Microsoft Excel. Presentar información en gráficos siempre es útil para que los tomadores de decisiones tomen decisiones rápidas y oportunas. Es más fácil ver comparaciones, patrones y tendencias en los datos con gráficos que con números en bruto. Crear gráficos en tiempo de ejecución, basados en los datos de una hoja de cálculo, es una de las funciones más poderosas de Aspose.Cells.

## **Tipos de gráficos**
Aspose.Cells para Python via .NET soporta casi todos los tipos de gráficos soportados en Microsoft Excel. Los gráficos se dividen en dos categorías principales:
...
Los siguientes gráficos de columnas son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de barras son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de líneas son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de torta son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de dispersión son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de área son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de rosquilla son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de radar son compatibles en Aspose.Cells para Python via .NET:
...
El gráfico de embudo es soportado en Aspose.Cells para Python via .NET.
...
Los siguientes gráficos de superficie 3D son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de burbujas son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de acciones son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de cilindro son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de cono son soportados en Aspose.Cells para Python via .NET:
...
Los siguientes gráficos de pirámide son soportados en Aspose.Cells para Python via .NET:
...
El gráfico de mapa de árbol (treemap) es soportado en Aspose.Cells para Python via .NET.
...
El gráfico de torta en explosión es compatible en Aspose.Cells para Python via .NET.
...
El gráfico de caja y bigotes es compatible en Aspose.Cells para Python via .NET.
...
El gráfico de cascada es compatible en Aspose.Cells para Python via .NET.
