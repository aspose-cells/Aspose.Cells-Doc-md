---
title: Agregar marca de agua WordArt al gráfico
description: Aprende cómo usar Aspose.Cells para Python via .NET para agregar una marca de agua WordArt a un gráfico en Microsoft Excel. Nuestra guía demostrará cómo crear y colocar una marca de agua WordArt para mejorar el atractivo visual y la singularidad de tu gráfico.
keywords: Aspose.Cells para Python vía.NET, Marca de agua WordArt, Marca de agua de gráfico, Microsoft Excel, Atractivo visual, Singularidad del gráfico.
type: docs
weight: 50
url: /es/python-net/add-wordart-watermark-to-chart/
---
