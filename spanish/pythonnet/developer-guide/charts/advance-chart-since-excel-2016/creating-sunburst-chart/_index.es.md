---
title: Cómo crear un gráfico de anillo solar
description: Aprende cómo crear un gráfico de anillo en Aspose.Cells para Python via .NET, un gráfico que presenta datos en un círculo. Nuestra guía le ayudará a configurar varias propiedades y formatos de su gráfico, incluyendo etiquetas de datos, leyendas, colores y más.
keywords: Aspose.Cells para Python via .NET, gráfico de anillo, crear, establecer propiedades, etiquetas de datos, leyenda, formato, color, círculo, renderizado de datos.
type: docs
weight: 162
url: /es/python-net/creating-sunburst-chart/
---
