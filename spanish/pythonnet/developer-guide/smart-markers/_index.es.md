---
title: Importación inteligente y colocación de datos con marcadores inteligentes en Python a través de .Net
linktitle: Marcadores inteligentes
type: docs
weight: 190
url: /es/python-net/using-smart-markers/
description: Importación e colocación inteligente de datos según los archivos de plantilla Excel con la biblioteca Aspose.Cells para Python a través de .Net.
---
...
Es muy fácil procesar los marcadores inteligentes. A continuación se muestra un fragmento de código en Python a través de .Net, que muestra cómo se realiza.
