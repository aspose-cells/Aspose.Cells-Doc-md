...
type: docs
weight: 90
url: /es/python-net/insert-background-image-to-excel/
description: Este artículo explica cómo insertar una imagen de fondo en Excel usando el código de ejemplo de Aspose.Cells para Python via .NET.
keywords: Biblioteca de Excel para Python, cómo establecer fondo en una hoja, insertar imagen de fondo en Excel usando Python.
---

{{% alert color="primary" %}} 

Puedes hacer que una hoja sea más atractiva agregando una imagen como fondo de la hoja. Esta característica puede ser bastante efectiva si tienes un gráfico corporativo especial que agrega un toque de fondo sin ocultar los datos en la hoja. Puedes establecer la imagen de fondo en una hoja usando las APIs de Aspose.Cells para Python via .NET.
