...
description: Cómo borrar el filtro en un campo específico de la tabla dinámica con Aspose.Cells para Python via .NET.
keywords: Aspose.Cells for Python Excel, biblioteca de Python de Excel, Limpiar filtro de PivotTable utilizando la biblioteca Aspose.Cells para Python Excel.
---

## **Escenarios de uso posibles**
Cuando creas una tabla dinámica con datos conocidos y quieres filtrar la tabla dinámica, necesitas aprender y utilizar el filtro. Puede ayudarte a filtrar los datos que quieres de manera efectiva. Al usar la API de Aspose.Cells para Python via .NET, puedes operar el filtro en los valores del campo en las Tablas Dinámicas. 
...
## **Cómo borrar el filtro en tabla dinámica utilizando la biblioteca Aspose.Cells para Python Excel**
Borrar filtro en tabla dinámica utilizando Aspose.Cells para Python via .NET. Por favor, consulta el siguiente código de muestra. 
