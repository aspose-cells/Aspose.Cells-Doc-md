---
title: Aspose.Cells para Python a través de .NET 22.8 Notas de la versión
type: docs
weight: 9
url: /es/python-net/aspose-cells-for-python-net-22-8-release-notes/
---
{{% alert color="primary" %}} 

Esta es la primera versión para Aspose.Cells para Python a través de .NET.
Esta página contiene notas de la versión para Aspose.Cells para Python a través de .NET 22.8.
...
|CELLSNET-51524|Ajuste de texto incorrecto al convertir a PDF desde un archivo de Excel con tabla dinámica|
...
|CELLSNET-51550|Los enlaces en rangos con nombre se eliminan en la conversión de XLS a XLSM|
|CELLSNET-51551|Los archivos se corrompieron y el enlace externo cambió a un enlace DDE al convertir archivos XLS a XLSM|
...
|CELLSNET-51574|Un cuadro de texto que tiene dos columnas se procesa con una columna solo cuando se vuelve a guardar un archivo XLSX|
|CELLSNET-51580|Un enlace externo de tipo xlPathMissing se cambia al tipo externalLinkPath normal en la conversión de XLS a XLSM|
|CELLSNET-51599|Nombres muy largos para recursos de tipo de imagen mientras se guardan como Html|
|CELLSNET-51627|No se puede cargar un archivo XLSM específico|
