---
title: Aspose.Cells para Python a través de .NET 22.9 Notas de la versión
type: docs
weight: 8
url: /es/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 

Esta es la primera versión para Aspose.Cells para Python a través de .NET.
Esta página contiene notas de la versión para Aspose.Cells para Python a través de .NET 22.9.
...
|CELLSNET-51743|Algunos símbolos cambiaron después de convertir un archivo de Excel a PDF|
...
|CELLSNET-51735|Estilo de negrita de texto incorrecto al convertir una tabla dinámica de Excel a PDF|
|CELLSNET-51761|Cuando el archivo XLS con tabla dinámica se convierte a XLSM, los detalles de las conexiones de datos se eliminan|
|CELLSNET-51899|Conversión de XLS a XLSM: MS Excel no pudo abrir el archivo XLSM de salida|
...
|CELLSNET-51800|Los valores de XLSX son incorrectos en el PDF de salida|
...
|CELLSNET-51736| Cell los bordes se perdieron en el PDF resultante|
...
|CELLSNET-51772|La información de conexión se cambia al convertir un archivo XLS a XLSM|
|CELLSNET-51778|Convertir un archivo XLS a XLSM elimina algunos caracteres al final del enlace en rangos con nombre|
...
|CELLSNET-51865|La hoja de trabajo XLS no tiene datos, mientras que puede ver filas completas en Excel|
|CELLSNET-51880|Conversión de XLSB a XLSM: el archivo XLSM de salida está dañado|
|CELLSNET-51898|Conversión de XLS a XLSM: el archivo XLSM de salida está dañado|
|CELLSNET-51921|No se puede aplicar un estilo copiado sin establecer sus banderas en explícito o usar una bandera|
|CELLSNET-51922|Cell la protección se pierde después de abrir y volver a guardar el archivo XLSX|
...
|CELLSNET-51961|Excepción "El índice estaba fuera de rango" al renderizar un ODS a PDF|
