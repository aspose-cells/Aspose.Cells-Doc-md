...
|Hoja de cálculoML|Archivo XML de Excel 2003.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[Números](https://docs.fileformat.com/spreadsheet/numbers/)|El documento es creado por la aplicación "Numbers" de Apple que forma parte de la suite ofimática iWork de Apple, un conjunto de aplicaciones que se ejecutan en los sistemas operativos Mac OS X e iOS.|{{< emoticons/tick >}}||
...
|[PELEA](https://docs.fileformat.com/image/tiff/)|Formato de archivo de imagen etiquetado||{{< emoticons/tick >}}|
...
|[campos electromagnéticos](https://docs.fileformat.com/image/emf/)|Formato de metarchivo mejorado||{{< emoticons/tick >}}|
