...
keywords: personalizado, logotipo, ajuste, api, gridjs, python, editar, hoja de cálculo, vista, visor, editor, excel
---
...
## llamada de evento
- podemos hacer seguimiento de los siguientes eventos
```javascript
