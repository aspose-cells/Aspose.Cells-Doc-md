...
type: docs
weight: 250
url: /es/python-net/aspose-cells-gridjs/how-to-customize-menus/
...
## Personalizar elementos en la barra de menú 
...
abrir la ventana de inspección del navegador, seleccionar el botón de la barra de herramientas,

![todo: la pantalla para seleccionar el botón de inspección de la barra de herramientas](gridjs_hover_toolbar_button_inspect.png)

luego podemos encontrar la clave CSS relacionada para este botón es:freeze
...
![todo: la pantalla para efecto hover en el botón de la barra de herramientas](gridjs_hover_toolbar_button_hover.png)
...
1. &zwnj;**Botón Agregar Hoja de trabajo**&zwnj; (`add` clase) - Crea nuevas hojas de trabajo
2. &zwnj;**Botón Seleccionar Hoja de trabajo**&zwnj; (`ellipsis` clase) - Gestiona la selección de hoja de trabajo
...
2. Cambiar íconos
Puedes reemplazar los íconos utilizando archivos SVG externos o datos SVG en línea.
```javascript
const addButton = document.querySelector('.x-spreadsheet-icon-img.add');
