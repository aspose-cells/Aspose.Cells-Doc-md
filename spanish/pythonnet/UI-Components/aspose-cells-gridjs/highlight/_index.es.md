...
type: docs
weight: 250
url: /es/python-net/aspose-cells-gridjs/highlight/
description: Este artículo describe cómo usar GridJs para resaltar texto de celda, rangos de celdas, formas e imágenes.
keywords: resaltar, hoja de cálculo, redacción, observaciones, excel, comentario	
---
...
- establecer si resaltar todos los objetos en la hoja de cálculo activa, incluir todas las formas e imágenes y toda el área de la hoja de cálculo
```javascript
...
- Limpiar configuración de resaltado para la hoja de cálculo activa
```javascript
...
Puedes encontrar más en nuestra página de demostración de github https://github.com/aspose-cells/Aspose.Cells.Grid-for-Python-via-.NET/blob/main/Examples.GridJs/templates/index.html
