---
title: cómo personalizar la apariencia de la UI para la ventana modal en GridJs  
type: docs
weight: 250
url: /es/java/aspose-cells-gridjs/how-to-customize-ui-window/
description: Este artículo describe cómo personalizar la apariencia de la UI para la ventana modal en GridJs.
keywords: CuadrículaJs,personalizar,modal,UI,apariencia,visual,ventana
aliases:
aliases:
...
# Guía de Estilo de Modalidad para GridJs

## Tabla de Contenidos

- [Visión general](#overview)
- [Naming de Clases CSS](#css-class-naming)
...
### Nombres de Modalidad Disponibles

| Tipo de Modalidad | Nombre | Clase CSS |
|------------|------|-----------|
| Ordenar | `sort` | `.x-spreadsheet-modal-sort` |
| Validación | `validation` | `.x-spreadsheet-modal-validation` |
| Buscar | `search` | `.x-spreadsheet-modal-search` |
...
| Sugerencia de entrada | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| Insertar URL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
...
| Validación de Datos | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| OtrosFormatosNumericos | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
...
Excelente para aplicaciones con soporte para modo oscuro.
