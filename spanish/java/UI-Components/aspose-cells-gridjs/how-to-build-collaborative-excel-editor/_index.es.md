---
title: cómo construir un editor de Excel colaborativo con GridJs
type: docs
weight: 260
url: /es/java/aspose-cells-gridjs/how-to-build-collaborative-excel-editor/
keywords: GridJs, colaborativo, editor de Excel, hoja de cálculo, Java
description: Este artículo presenta cómo construir un editor de Excel colaborativo usando Aspose.Cells.GridJs para Java.
aliases:
...
El siguiente diagrama muestra cómo GridJs permite la edición colaborativa con múltiples usuarios, 
un backend de Spring Boot, comunicación WebSocket y una base de datos MySQL para la gestión del estado.

![Arquitectura Colaborativa de GridJs](gridjs_collaborative_architecture.png)
...
- Una **licencia Aspose.Cells** válida (o [licencia temporal](https://purchase.aspose.com/temporary-license))  
...
Si ejecutas en Docker, edita la línea 10 de [`docker-compose.yml`](https://github.com/aspose-cells/Aspose.Cells.Grid-for-Java/blob/master/Examples.GridJs.Collabrative/docker-compose.yml) para mapear el archivo de licencia.  
...
En la configuración del lado del servidor [`/src/main/java/com/aspose/gridjsdemo/filemanagement/FileConfig.java`](https://github.com/aspose-cells/Aspose.Cells.Grid-for-Java/blob/master/Examples.GridJs.Collabrative/src/main/java/com/aspose/gridjsdemo/filemanagement/FileConfig.java):
...
En las opciones de carga del lado del cliente [`/src/main/resources/templates/file/index.html`](https://github.com/aspose-cells/Aspose.Cells.Grid-for-Java/blob/master/Examples.GridJs.Collabrative/src/main/resources/templates/file/index.html):
...
En [`/src/main/java/com/aspose/gridjsdemo/filemanagement/MyCustomUser.java`](https://github.com/aspose-cells/Aspose.Cells.Grid-for-Java/blob/master/Examples.GridJs.Collabrative/src/main/java/com/aspose/gridjsdemo/filemanagement/MyCustomUser.java):
...
El documento de detalles para setCollaborativeSetting se puede encontrar [aquí](https://docs.aspose.com/cells/java/aspose-cells-gridjs/how-to-use-gridjs-client-api/)
