...
## **Eliminar estilos no utilizados dentro del libro de trabajo**
 El siguiente código explica el uso de[Workbook.removeUnusedStyles()](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#removeUnusedStyles\(\) ). El código carga el[plantilla de archivo de Excel](5473451.xlsx) que puede descargar desde el enlace proporcionado. Contiene un estilo no utilizado llamado**AsposeEstilo**este estilo y todos los demás estilos no utilizados se eliminarán después de la ejecución del código. Consulte la siguiente captura de pantalla para ver más ilustraciones.
