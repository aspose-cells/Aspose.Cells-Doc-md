...
El siguiente código explica el uso de [Workbook.removeUnusedStyles()](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#removeUnusedStyles\(\)). El código carga el [archivo de Excel de plantilla](5473451.xlsx) que se puede descargar desde el enlace proporcionado. Contiene un estilo no utilizado llamado **AsposeStyle**, este estilo y todos los demás estilos no utilizados se eliminarán después de la ejecución del código. Consulte la siguiente captura de pantalla para obtener más ilustración.
