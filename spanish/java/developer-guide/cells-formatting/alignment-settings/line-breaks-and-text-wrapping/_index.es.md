...
type: docs
weight: 10
url: /es/java/line-breaks-and-text-wrapping/
---
...
Para ajustar texto en una celda, usa la propiedad [**Aspose.Cells.Style.setTextWrapped**](https://reference.aspose.com/cells/java/com.aspose.cells/style#IsTextWrapped).

El siguiente código de muestra muestra cómo usar el ajuste de texto y los saltos de línea explícitos en una celda.
