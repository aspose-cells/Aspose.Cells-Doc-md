...
El siguiente fragmento de código demuestra el uso de la[**Clave Regex**](https://reference.aspose.com/cells/java/com.aspose.cells/replaceoptions#RegexKey)propiedad usando el[ejemplo de archivo de Excel](SampleRegexReplace.xlsx). los[archivo de salida](RegexReplace_out.xlsx)generado por el siguiente fragmento de código se adjunta como referencia.
