---
title: Cómo establecer títulos de impresión
type: docs
weight: 200
url: /es/java/how-to-set-print-titles/
description: Este artículo te muestra un código que explica cómo establecer títulos de impresión usando la biblioteca Aspose.Cells.
keywords: Imprimir filas y columnas repetidamente, Cómo establecer títulos de impresión en Java, Establecer y limpiar títulos de impresión usando Java, Cómo limpiar títulos de impresión en Java, Cómo agregar títulos de impresión usando Java, cómo eliminar títulos de impresión usando Java, Cómo configurar títulos de impresión en Excel, Cómo limpiar títulos de impresión en Excel.
---
...
Para establecer títulos de impresión en una hoja de cálculo específica: Primero, carga el [archivo de muestra](input.xlsx), y luego debes modificar las propiedades [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) y [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) del objeto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) para la hoja deseada. Configurar estas propiedades con una cadena de rango establecerá los títulos de impresión.
...
Para borrar los títulos de impresión en una hoja de cálculo específica: Primero, carga el [archivo de muestra](input.xlsx), y luego debes modificar las propiedades [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) y [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) del objeto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) para la hoja deseada. Configurar estas propiedades con una cadena vacía borrará los títulos de impresión.
