...
type: docs
weight: 200
url: /es/java/how-to-set-print-area/
...
keywords: Limitar el rango de impresión, establecer rango de impresión, borrar rango de impresión, establecer y borrar rango de impresión usando Java, Cómo configurar el área de impresión en Java, Establecer y borrar área de impresión en Java, Cómo borrar el área de impresión en Java, Cómo agregar área de impresión usando Java, cómo quitar área de impresión en Java, Cómo configurar el área de impresión en Excel, Cómo borrar el área de impresión en Excel.
---
...
Para establecer el área de impresión en una hoja de cálculo específica: Primero, cargue el [archivo de ejemplo](input.xlsx), y luego necesita modificar la propiedad [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) del objeto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) para la hoja deseada. Configurar esta propiedad con una cadena de rango establecerá el área de impresión.
...
Para borrar el área de impresión en una hoja de cálculo específica: Primero, cargue el [archivo de ejemplo](input.xlsx), y luego necesita modificar la propiedad [**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-) del objeto [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) para la hoja deseada. Configurar esta propiedad con una cadena vacía borrará el área de impresión.
