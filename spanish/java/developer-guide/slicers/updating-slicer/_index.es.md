...
Si desea actualizar un filtro en Microsoft Excel, seleccione o deseleccione sus elementos, luego actualizará la tabla del filtro o la tabla dinámica en consecuencia. Utilice [Slicer.SlicerCache.SlicerCacheItems](https://reference.aspose.com/cells/java/com.aspose.cells/slicercache#SlicerCacheItems) para seleccionar o deseleccionar elementos del filtro con Aspose.Cells y luego llame al método [Slicer.refresh()](https://reference.aspose.com/cells/java/com.aspose.cells/slicer#refresh\(\)) para actualizar la tabla del filtro o la tabla dinámica. 
