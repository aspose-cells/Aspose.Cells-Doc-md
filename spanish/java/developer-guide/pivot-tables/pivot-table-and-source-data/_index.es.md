...
Ejecutar el código de ejemplo a continuación cambia los datos de origen de la tabla dinámica y la tabla dinámica se verá como la siguiente.

**Tabla dinámica cambiada dinámicamente** 

![todo:imagen_alternativa_texto](pivot-table-and-source-data_5.png)
