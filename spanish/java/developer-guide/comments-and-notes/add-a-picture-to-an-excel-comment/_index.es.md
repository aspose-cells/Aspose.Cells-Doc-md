...
1. Haz clic derecho en la celda que contiene el comentario.
1. Elige **Mostrar/Ocultar Comentarios** y borra cualquier texto del comentario.
1. Haga clic en el borde del comentario para seleccionarlo.
1. Elige **Formato**, luego **Comentario**.
1. En la pestaña Colores y Líneas, haz clic en la flecha de **Color**.
1. Haga clic en **Efectos de relleno**.
1. En la pestaña Imagen, haz clic en **Seleccionar Imagen**.
