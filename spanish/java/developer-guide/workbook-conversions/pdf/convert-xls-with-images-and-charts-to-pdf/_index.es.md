---
title: Convierta XLS con Imágenes y Gráficos a PDF
type: docs
weight: 230
url: /es/java/convert-xls-with-images-and-charts-to-pdf/
description: El código Java para convertir archivos de Excel con imágenes y gráficos a formato PDF utilizando el Aspose.Cells for Java API.
...
Aspose.Cells admite la conversión de archivos XLS que contienen imágenes y gráficos a documentos PDF. Aspose.Cells for Java puede funcionar de forma independiente para convertir una hoja de cálculo a PDF: Aspose.PDF No se requieren API para la conversión.

{{% /alert %}}

El proceso se puede realizar en memoria ya que el proceso no depende de archivos XML temporales o intermediarios. Esto significa que los archivos grandes de Excel, por ejemplo, los que contienen imágenes, gráficos y otros objetos de dibujo, se pueden convertir de forma rápida y eficiente.

{{% alert color="primary" %}}

 Si la hoja de cálculo contiene fórmulas, es mejor llamar al[**Workbook.calculateFormula**](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#calculateFormula()) justo antes de renderizar a PDF. Si lo hace, se asegurará de que los valores dependientes de la fórmula se vuelvan a calcular y los valores correctos se representen en el PDF.
