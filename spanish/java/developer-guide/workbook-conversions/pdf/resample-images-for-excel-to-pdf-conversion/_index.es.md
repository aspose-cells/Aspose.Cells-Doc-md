---
title: Volver a muestrear imágenes para Excel a PDF Conversión
type: docs
weight: 250
...
{{% alert color="primary" %}}
 ...
 Utilizando la[**PdfSaveOptions.setImageResample**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#setImageResample(int,%20int)) minimiza el tamaño de la salida PDF pero puede afectar un poco la calidad de la imagen.
