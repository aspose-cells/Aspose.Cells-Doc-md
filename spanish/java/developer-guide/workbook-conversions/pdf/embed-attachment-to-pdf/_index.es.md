...
Generalmente, al convertir a PDF, el Objeto Ole se representará como un ícono o una miniatura sin los datos de origen del Objeto Ole. Con la opción [PdfSaveOptions.EmbedAttachments](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/#setEmbedAttachments-boolean-), puedes incrustar los datos de origen del Objeto Ole como un adjunto en PDF. Puedes hacer doble clic en el ícono o la miniatura en el PDF para abrir el archivo fuente del Objeto Ole.
