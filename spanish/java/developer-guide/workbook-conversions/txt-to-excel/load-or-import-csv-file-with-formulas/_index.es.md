...
## **Cargue o importe el archivo CSV con fórmulas**
 El siguiente código ilustra cómo puede cargar e importar un archivo CSV con fórmulas. Puede usar cualquier archivo CSV. Con fines ilustrativos, utilizamos el[archivo csv sencillo](5472505.csv) que contiene estos datos. Como ves contiene una fórmula.
...
El código primero carga el archivo CSV, luego lo importa nuevamente en la celda D4. Finalmente, guarda el objeto del libro de trabajo en formato XSLX. Él[archivo de salida XLSX](5472503.xlsx) Se ve como esto. Como ve, las celdas C3 y F4 contienen fórmula y su resultado 800.
