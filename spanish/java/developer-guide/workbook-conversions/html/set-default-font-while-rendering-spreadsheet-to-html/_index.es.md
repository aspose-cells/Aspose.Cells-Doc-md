---
title: Establezca la fuente predeterminada al representar la hoja de cálculo en HTML
type: docs
weight: 830
...
![todo:imagen_alternativa_texto](set-default-font-while-rendering-spreadsheet-to-html_1.png)
 ...
 El código genera el[salida de archivo HTML con Courier New](5472568) , la[salida HTML con Arial](5472567) y el[archivo HTML de salida con Times New Roman](5472565).
