...
1.  Seleccione**Datos** desde el**Tipo** menú.
...
## **Clasificación de datos con Aspose.Cells**
 ...
 Él[**tipo**](https://reference.aspose.com/cells/java/com.aspose.cells/datasorter#sort()) método acepta los siguientes parámetros:
