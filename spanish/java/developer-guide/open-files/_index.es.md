...
veces, el archivo de Excel que desea abrir se almacena como una secuencia. En ese caso, similar a abrir un archivo usando la ruta del archivo, pase la secuencia como un parámetro mientras crea una instancia del**[Libro de trabajo](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook)** clase. El siguiente código de ejemplo muestra cómo abrir un archivo de Excel mediante stream.
...
### **Abrir archivos de diferentes versiones de Excel Microsoft**
 ...
 Él**[LoadFormat](https://reference.aspose.com/cells/java/com.aspose.cells/LoadFormat)**La enumeración contiene muchos formatos de archivo predefinidos, algunos de los cuales se indican a continuación.
...
- [Mantenga separadores para filas en blanco al exportar hojas de cálculo al formato CSV](/cells/es/java/keep-separators-for-blank-rows-while-exporting-spreadsheets-to-csv-format/)
...
- [Lectura del archivo CSV con múltiples codificaciones](/cells/es/java/reading-csv-file-with-multiple-encodings/)
