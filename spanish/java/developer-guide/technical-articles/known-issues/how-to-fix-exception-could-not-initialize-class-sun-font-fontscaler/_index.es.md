---
title: "Cómo corregir la excepción: no se pudo inicializar la clase sun.font.FontScaler"
type: docs
weight: 40
url: /es/java/how-to-fix-exception-could-not-initialize-class-sun-font-fontscaler/
---
## **Posibles escenarios de uso**
Este artículo explicará cómo solucionar la excepción: no se pudo inicializar la clase sun.font.FontScaler. La excepción se parece a esto
...
## **Entorno del sistema**
El entorno del sistema podría ser algo como esto.
...
{{< /highlight >}}
## **Solución posible**
Es probable que resuelva el problema integrando el siguiente JAR en su classpath:
