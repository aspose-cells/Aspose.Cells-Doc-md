...
description: Proteger y desproteger la estructura del libro de Excel utilizando códigos de Java. Bloquear y desbloquear archivos de Excel (xlsx, xls, xsb) y de Open office calc (ODS) con la API Aspose.Cells for Java.
---
...
## **Proteger la Estructura del Libro Utilizando Aspose.Cell para Java**
...
## **Desproteger la Estructura del Libro Utilizando Aspose.Cell para Java**
