---
title: Proteger y desproteger la estructura del libro de trabajo
type: docs
weight: 40
url: /es/java/protect-and-unprotect-workbook-structure/
description: Proteja y desproteja la estructura del libro de trabajo de los archivos de Excel usando códigos Java. Bloquee y desbloquee archivos de Excel (xlsx, xls, xsb) y Open Office calc (ODS) usando Aspose.Cells for Java.
---
{{% alert color="primary" %}}
...
## **Proteger y desproteger la estructura del libro de trabajo en MS Excel**
...
## **Desproteger la estructura del libro de trabajo usando Aspose.Cell for Java**
