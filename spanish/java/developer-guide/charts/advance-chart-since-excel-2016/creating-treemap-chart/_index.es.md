...
description: Aprenda cómo crear un gráfico Treemap en Aspose.Cells for Java. Nuestra guía le ayudará a entender las diversas propiedades y opciones de formato disponibles para gráficos Treemap, incluyendo colores, etiquetas y representación de datos.
keywords: Aspose.Cells for Java, gráfico Treemap, crear, propiedades, formato, colores, etiquetas, representación de datos, gráfico circular, gráficos jerárquicos.
type: docs
weight: 161
url: /es/java/creating-treemap-chart/
---
