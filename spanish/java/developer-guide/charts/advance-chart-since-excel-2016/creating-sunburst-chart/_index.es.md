...
description: Aprende a crear un gráfico de anillo solar en el Aspose.Cells for Java, un gráfico que presenta datos en un círculo. Nuestra guía te ayudará a configurar varias propiedades y formato de tu gráfico, incluyendo etiquetas de datos, leyendas, colores y más.
keywords: Aspose.Cells for Java, gráfico de ráfaga solar, crear, establecer propiedades, etiquetas de datos, leyenda, formato, color, círculo, representación de datos.
type: docs
weight: 162
url: /es/java/creating-sunburst-chart/
---
