...
type: docs
weight: 10
url: /es/java/how-to-manage-pivotchart-with-pivotoptions/
...
Usando Aspose.Cells, puedes usar [**PivotOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotoptions/) para gestionar el Gráfico Dinámico.
