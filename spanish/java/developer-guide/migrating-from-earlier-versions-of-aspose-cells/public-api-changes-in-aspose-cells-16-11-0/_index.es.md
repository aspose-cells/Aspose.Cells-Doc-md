...
El siguiente fragmento carga una hoja de cálculo existente y agrega el Subtotal de tipo Promedio en los datos ya disponibles en la hoja de cálculo. La clase CustomSettings y sus métodos getTotalName y getGrandTotalName se llamarán en el momento de agregar Subtotal a la hoja de trabajo.
