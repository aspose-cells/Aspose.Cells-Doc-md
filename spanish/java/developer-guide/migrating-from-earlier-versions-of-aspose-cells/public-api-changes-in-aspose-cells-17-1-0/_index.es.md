...
{{% alert color="primary" %}} 
 ...
 Consulte el artículo detallado sobre[Recuperación del tamaño de papel de la hoja de trabajo](/cells/es/java/get-paper-width-and-height-from-pagesetup-of-worksheet/)
