...
type: docs
weight: 260
url: /es/java/extract-ole-objects-from-workbook/
---
...
1. Creado una hoja de cálculo en Microsoft Excel.
1. Agregue un documento de Microsoft Word, un libro de Excel y un documento PDF como objetos OLE en la primera hoja de cálculo.
