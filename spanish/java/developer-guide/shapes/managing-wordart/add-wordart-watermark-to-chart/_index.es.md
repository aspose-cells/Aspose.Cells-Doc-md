...
type: docs
weight: 40
url: /es/java/add-wordart-watermark-to-chart/
---
...
## Agregar una marca de agua de WordArt a un gráfico
...
### Imágenes de comparación antes y después de la ejecución del código
