...
Es posible eliminar todas las filas y columnas en blanco de una hoja de cálculo. Esto es útil, por ejemplo, al generar un archivo PDF a partir de un archivo de Microsoft Excel y desea convertir solo las filas y columnas que contienen datos.
