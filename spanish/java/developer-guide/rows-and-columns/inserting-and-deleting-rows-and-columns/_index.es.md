...
## **Gestión de filas/columnas**
 ...
 Él[Cells](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#Cells)colección proporciona varios métodos para administrar filas y columnas en una hoja de trabajo. Algunos de éstos se discuten a continuación.
...
- Actualizar Referencia: Parámetro booleano para indicar si actualizar referencias en otras hojas de cálculo.
