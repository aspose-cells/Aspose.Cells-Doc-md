...
### **Ajuste de altura de fila**
 ...
 Él[Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells)colección proporciona varios métodos para administrar filas o columnas en una hoja de trabajo. Algunos de estos se discuten a continuación con más detalle.
### **Configuración de la altura de la fila**
 Es posible establecer la altura de una sola fila llamando al[Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells) colección[establecerRowHeight](https://reference.aspose.com/cells/java/com.aspose.cells/cells#setRowHeight\(int,%20double\) ) método. Él[establecerRowHeight](https://reference.aspose.com/cells/java/com.aspose.cells/cells#setRowHeight\(int,%20double\)) método toma los siguientes parámetros:
