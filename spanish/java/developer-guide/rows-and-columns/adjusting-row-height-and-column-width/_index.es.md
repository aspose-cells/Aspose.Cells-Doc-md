...
Es posible establecer la altura de una fila individual llamando al método [setRowHeight](https://reference.aspose.com/cells/java/com.aspose.cells/cells#setRowHeight-int-double-) de la colección [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells). El método [setRowHeight](https://reference.aspose.com/cells/java/com.aspose.cells/cells#setRowHeight-int-double-) acepta los siguientes parámetros:
...
Establezca el ancho de una columna llamando al método [setColumnWidth](https://reference.aspose.com/cells/java/com.aspose.cells/cells#setColumnWidth-int-double-) de la colección [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells). El método [setColumnWidth](https://reference.aspose.com/cells/java/com.aspose.cells/cells#setColumnWidth-int-double-) acepta los siguientes parámetros:
