...
###  **Copia de estilos de Cells con marcadores inteligentes**
 ...
 Este ejemplo utiliza un[archivo de plantilla](template1.xlsx)con algunos marcadores en las celdas. Al ejecutar el código, Aspose.Cells copia el formato a todos los registros en la columna B pero no mantiene el formato en la columna A.
...
###  **Adición de etiquetas personalizadas para concatenar con las filas de subtotal en marcadores inteligentes**
 Este ejemplo utiliza un[archivo de plantilla](template.xlsx) con algunos marcadores en las células. Al ejecutar el código, Aspose.Cells agrega algunas etiquetas personalizadas a las filas de resumen de los datos agrupados.
