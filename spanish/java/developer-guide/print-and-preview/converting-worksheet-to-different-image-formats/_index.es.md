...
Él**[com.aspose.cells.ImageOrPrintOptions](https://reference.aspose.com/cells/java/com.aspose.cells/ImageOrPrintOptions)** class especifica que la hoja de trabajo se guardará en formato SVG.

Él**[SheetRender](https://reference.aspose.com/cells/java/com.aspose.cells/sheetrender)**la clase toma el objeto de**[ImageOrPrintOptions](https://reference.aspose.com/cells/java/com.aspose.cells/ImageOrPrintOptions)** como un parámetro que establece el formato de guardado en el formato SVG.
