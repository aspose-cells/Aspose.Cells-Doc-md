...
type: docs
weight: 40
url: /es/java/evaluation-version-limitations/
description: Este artículo puede ayudarlo a comprender cómo obtener versiones de evaluación y conocer las limitaciones de las versiones de evaluación.
...
Puede descargar una versión de evaluación de **Aspose.Cells** para Java desde [su página de descarga](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) @ Maven repos. La versión de evaluación proporciona absolutamente las mismas capacidades que la versión con licencia del producto. Además, la versión de evaluación simplemente se convierte en licenciada cuando compra una licencia y agrega un par de líneas de código para aplicar la licencia.
...
En el archivo PDF o de imagen de Aspose.Cells, se pegaría una marca de agua de evaluación en la parte superior del documento/imagen.
<br>
