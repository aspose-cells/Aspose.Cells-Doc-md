...
type: docs
weight: 10
url: /es/java/aspose-cells-for-java-2-4-3-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 2.4.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.4.3/)
...
- Se han realizado mejoras para la función Direct Excel to PDF.
...
|21481 | SAO| Referencia de fila/columna completa como "B:B" o "1:1"|
