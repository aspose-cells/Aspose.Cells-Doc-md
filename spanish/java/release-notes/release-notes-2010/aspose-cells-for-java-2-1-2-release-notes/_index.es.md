...
type: docs
weight: 90
url: /es/java/aspose-cells-for-java-2-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 2.1.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.1.2/)
...
Admite la exportación de objetos de nombre con referencias externas para el archivo SpreadSheetML.
 ...
 Establece la posición de una Forma en el centro de un rango determinado.
...
|11891 | cuadro| Propiedad LogarithmicBase de ValueAxis|
...
|12080 | cuadro| Valor formateado de ChartFrame|
|12105 | xls| Leer altura de fila|
|12128 | cuadro| Obtener marcador|
|12138 | cuadro| Leer marcador|
...
|12238 | xlsx| Rendimiento de la lectura del archivo de plantilla|
|12243 | cuadro| Tipo de serie A|
|12253 | xls| Tipo de enlace del hipervínculo|
|12271 | cuadro| Etiquetas de datos|
|12275 | xls| Celdas de luz|
|12317 | cuadro| texto del titulo|
|12324 | Gráfico2Imagen| ImageOption|
|12347 | Hoja de cálculoML| Hipervínculo|
|12434 | cuadro| Relleno degradado|
|12477 | xlsx| Celdas de luz|
|12493 | xlsx| Leer formato condicional|
|12498 | cuadro| Colección ChartPoints y LegendEntries|
|12575 | cuadro| Tamaño de PlotArea|
|12576 | cuadro|Barra de error|
...
|14056 | cuadro| Relleno degradado|
