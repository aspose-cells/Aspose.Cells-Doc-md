...
type: docs
weight: 60
url: /es/java/aspose-cells-for-java-2-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 2.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.3.0/)
...
- Incluye soporte de formato de imagen EMF para la función Chart-to-Image.
...
|17107 | SAO| Guardar gráficos en archivos ODS|
