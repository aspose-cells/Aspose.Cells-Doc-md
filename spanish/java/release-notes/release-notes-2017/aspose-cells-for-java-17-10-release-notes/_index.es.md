...
type: docs
weight: 30
url: /es/java/aspose-cells-for-java-17-10-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.10/).
...
- [Lectura y escritura de la conexión externa del archivo XLSB](/cells/es/java/read-and-write-external-connection-of-xlsb-or-xls-file/)
...
- [Especifique cómo cruzar una cadena en el HTML de salida usando HtmlCrossType](/cells/es/java/specify-how-to-cross-string-in-output-html-using-htmlcrosstype/)
