...
type: docs
weight: 100
url: /es/java/aspose-cells-for-java-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.3.0/).
...
1. [Personalizar la configuración de globalización para la tabla dinámica](/cells/es/java/customize-globalization-settings-for-pivot-table/)
1. [Ejecutar la función del lado del cliente en el cambio de página de GridWeb](/cells/es/java/execute-client-side-function-on-gridweb-page-change/)
1. [Valide toda la hoja de trabajo en lugar de solo las celdas actualizadas](/cells/es/java/validate-entire-worksheet-instead-of-only-the-updated-cells/)
