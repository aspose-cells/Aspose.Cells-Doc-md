...
type: docs
weight: 50
url: /es/java/aspose-cells-for-java-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.8](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.8/).
...
- [Agregar firma digital a un archivo de Excel ya firmado](/cells/es/java/add-digital-signature-to-an-already-signed-excel-file/)
...
- [Salida de página en blanco cuando no hay nada que imprimir](/cells/es/java/output-blank-page-when-there-is-nothing-to-print/)
