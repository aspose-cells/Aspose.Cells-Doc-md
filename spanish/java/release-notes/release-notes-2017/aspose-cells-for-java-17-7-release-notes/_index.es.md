...
type: docs
weight: 60
url: /es/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [Implementar errores y valor booleano en ruso o cualquier otro idioma](/cells/es/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
