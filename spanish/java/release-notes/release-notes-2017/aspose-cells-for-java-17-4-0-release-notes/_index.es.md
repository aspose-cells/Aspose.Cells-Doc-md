...
type: docs
weight: 90
url: /es/java/aspose-cells-for-java-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.4.0/).
...
- [Proteger con contraseña el proyecto VBA del libro de Excel](/cells/es/java/password-protect-the-vba-project-of-excel-workbook/)
- [Averigüe si el proyecto VBA está protegido](/cells/es/java/find-out-if-vba-project-is-protected/)
- [Compruebe si el proyecto VBA está protegido y bloqueado para su visualización](/cells/es/java/check-if-vba-project-is-protected-and-locked-for-viewing/)
