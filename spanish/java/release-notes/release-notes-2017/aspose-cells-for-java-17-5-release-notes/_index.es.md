...
type: docs
weight: 80
url: /es/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [Desplace la primera fila hacia abajo al insertar Cells Filas de la tabla de datos](/cells/es/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
