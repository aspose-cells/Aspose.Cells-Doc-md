...
type: docs
weight: 70
url: /es/java/aspose-cells-for-java-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 17.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.6/).
...
- [Imagen en mosaico como una textura dentro de la forma](/cells/es/java/tile-picture-as-a-texture-inside-the-shape/)
- [Usando OnAjaxCallFinishedClientFunction de GridWeb](/cells/es/java/using-onajaxcallfinishedclientfunction-of-gridweb/)
- [Uso del parámetro Fórmula en el campo Marcador inteligente](/cells/es/java/using-formula-parameter-in-smart-marker-field/)
