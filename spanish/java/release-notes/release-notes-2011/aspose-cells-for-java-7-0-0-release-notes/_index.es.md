...
type: docs
weight: 40
url: /es/java/aspose-cells-for-java-7-0-0-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 7.0.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.0.0/)
...
- Uso de las API de LightCells
 ...
 Preservar macros al leer el archivo ODS y guardar las macros nuevamente en el archivo ODS
