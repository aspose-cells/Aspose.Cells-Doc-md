---
title: Aspose.Cells for Java 7.7.1 Notas de la versión
type: docs
weight: 90
url: /es/java/aspose-cells-for-java-7-7-1-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 7.7.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.7.1/)
...
Refactorizar la tabla dinámica de lectura y escritura de xlsb

Características menores

Nuevas características

(CELLSJAVA-40409): lectura de archivos de plantilla grandes con LightCells
(CELLSJAVA-40269): lectura de archivos de plantilla grandes con LightCells
(CELLSJAVA-40696) - Compatibilidad con ActiveX (leer controles ActiveX, como botones)
(CELLSJAVA-40372) - Compatibilidad con ActiveX (leer controles ActiveX, como botones)
(CELLSJAVA-40373): distinguir entre imagen ActiveX o imagen normal

Mejoras

(CELLSJAVA-40688): no se puede establecer el ancho de columna predeterminado
(CELLSJAVA-40391): uso de Aspose en un entorno OSGi
(CELLSJAVA-40418): cómo configurar la calidad en los gráficos guardados
...
(CELLSJAVA-40697) - Aspose.cells genera una excepción al copiar un gráfico realizado en Excel 2013
(CELLSJAVA-40706) - ArrayIndexOutOfBoundsException al abrir el archivo
(CELLSJAVA-40422) - ArrayIndexOutOfBoundsException al abrir el archivo


Nota
Dado que el código base de Aspose.Cells for Java coincide con el código de la versión .NET relevante, la mayoría de los cambios, mejoras y correcciones incluidos en Aspose.Cells for .NET v7.7.1 también se incluyen en este Aspose.Cells for Java v7.7.1.
