---
title: Aspose.Cells for Java 7.7.2 Notas de la versión
type: docs
weight: 80
url: /es/java/aspose-cells-for-java-7-7-2-release-notes/
---
{{% alert color="primary" %}} 

 Esta página contiene notas de la versión para[Aspose.Cells for Java 7.7.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.7.2/)
...
(CELLSJAVA-40475): imprimir comentarios en un documento de Excel
(CELLSJAVA-40732): compatibilidad con la configuración de alineación distribuida justificada

Mejoras

(CELLSJAVA-40719): elimine el uso de código fijo de com.sun.image.codec.jpeg.JPEGCodec
(CELLSJAVA-40708) - Mostrar fila con altura previamente asignada
...
(CELLSJAVA-40707): algunas columnas son estrechas para contener el texto correctamente
(CELLSJAVA-40720): IStreamProvider.setCustomPath no afecta al archivo tabstrip.htm
(CELLSJAVA-40729): extracción de un problema de fecha en chino con formato
(CELLSJAVA-40728) - ¡getStringValue() devuelve #VALOR!
(CELLSJAVA-40722): la validación no funciona después de convertir al formato XLS
(CELLSJAVA-40690) - XLSX a PDF: el subrayado debajo del hipervínculo se extiende a posiciones de caracteres adyacentes

Excepciones

(CELLSJAVA-40629): excepción al abrir xlsx convertido a xls
(CELLSJAVA-40630): excepción al abrir xlsx convertido a xls
