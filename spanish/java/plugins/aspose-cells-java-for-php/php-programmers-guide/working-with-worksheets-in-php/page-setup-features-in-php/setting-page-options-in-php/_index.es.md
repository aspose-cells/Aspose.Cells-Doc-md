...
### **Orientación de la página**
 Para aplicar la configuración de orientación de la página usando**Aspose.Cells Java para PHP** , llamar**orientación de la página** método de**configuración de página** módulo.
...
{{< /highlight >}}
### **Factor de escala**
 Para aplicar la escala usando**Aspose.Cells Java para PHP** , llamar**escalada** método de**configuración de página** módulo.
