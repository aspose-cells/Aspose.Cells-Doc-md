---
title: Apertura de Archivos en Python
type: docs
weight: 10
...
Para abrir un archivo usando Aspose.Cells Java en Python, simplemente llama al método openfile() de la clase Document y especifica el segundo documento que se desea añadir al final.
...
Descargar **Apertura de Archivo (Aspose.Cells)** desde cualquiera de los sitios de codificación social mencionados a continuación:
