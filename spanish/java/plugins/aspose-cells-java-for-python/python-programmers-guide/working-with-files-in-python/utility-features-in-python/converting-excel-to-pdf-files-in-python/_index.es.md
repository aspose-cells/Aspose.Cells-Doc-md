---
title: Convertir archivos de Excel a PDF en Python
type: docs
weight: 20
url: /es/java/converting-excel-to-pdf-files-in-python/
---
## **Aspose.Cells - Conversión de Excel a PDF**
Para convertir archivos de Excel a Pdf usando Aspose.Cells for Java en Python, simplemente invoque Excel_a_Método pdf() del módulo Converter.
