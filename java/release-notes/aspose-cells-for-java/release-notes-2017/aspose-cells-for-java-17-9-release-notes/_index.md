...
type: docs
weight: 40
url: /java/aspose-cells-for-java-17-9-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes for [Aspose.Cells for Java 17.9](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.9/).
...
- [Control loading of External Resources in MS Excel Workbook while rendering to PDF](/cells/java/control-loading-of-external-resources-in-ms-excel-workbook-while-rendering-to-pdf/)
- [Copy VBA Macro UserForm DesignerStorage from Template to Target Workbook](/cells/java/copy-vba-macro-userform-designerstorage-from-template-to-target-workbook/)
- [Create Remove and Get GridCell Comments](/cells/java/create-remove-and-get-gridcell-comments/)
- [Send Shape Front or Back inside the Worksheet](/cells/java/send-shape-front-or-back-inside-the-worksheet/)
