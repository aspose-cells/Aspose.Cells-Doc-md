...
type: docs
weight: 110
url: /java/aspose-cells-for-java-17-02-0-release-notes/
---
...
1. [Convert Text to Columns using Aspose.Cells](/cells/java/convert-text-to-columns-using-aspose-cells/)
1. [Get a List of Fonts used in a Spreadsheet or Workbook](/cells/java/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Get Warnings while Loading Excel File](/cells/java/get-warnings-while-loading-excel-file/)
1. [Read and Manipulate Excel 2016 Charts](/cells/java/read-and-manipulate-excel-2016-charts/)
1. [Trim Leading Blank Rows and Columns while exporting spreadsheets to CSV format](/cells/java/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
