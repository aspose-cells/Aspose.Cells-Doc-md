...
type: docs
weight: 60
url: /java/aspose-cells-for-java-17-7-release-notes/
---
...
- [Set DefaultFont property of PdfSaveOptions and ImageOrPrintOptions to have priority](/cells/java/set-defaultfont-property-of-pdfsaveoptions-and-imageorprintoptions-to-have-priority/)
...
- [Implement Errors and Boolean Value in Russian or Any Other Language](/cells/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
