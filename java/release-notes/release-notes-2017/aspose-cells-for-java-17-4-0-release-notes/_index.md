...
type: docs
weight: 90
url: /java/aspose-cells-for-java-17-4-0-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes for [Aspose.Cells for Java 17.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.4.0/).
...
- [Password Protect the VBA Project of Excel Workbook](/cells/java/password-protect-the-vba-project-of-excel-workbook/)
- [Find out if VBA Project is Protected](/cells/java/find-out-if-vba-project-is-protected/)
- [Check if VBA Project is Protected and Locked for Viewing](/cells/java/check-if-vba-project-is-protected-and-locked-for-viewing/)
