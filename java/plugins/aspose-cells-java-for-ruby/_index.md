...
- [Download and Configure Aspose.Cells in Ruby](/cells/java/download-and-configure-aspose-cells-in-ruby-html/)
- [Ruby Programmers Guide](/cells/java/ruby-programmers-guide-html/)
  ...
  - [Working With Files in Ruby](/cells/java/working-with-files-in-ruby-html/)
    - [File Handling Features in Ruby](/cells/java/file-handling-features-in-ruby-html/)
      - [Opening Files in Ruby](/cells/java/opening-files-in-ruby-html/)
      - [Saving Files in Ruby](/cells/java/saving-files-in-ruby-html/)
    - [Utility Features in Ruby](/cells/java/utility-features-in-ruby-html/)
      - [Converting Chart to Image in Ruby](/cells/java/converting-chart-to-image-in-ruby-html/)
      - [Converting Excel Files to HTML in Ruby](/cells/java/converting-excel-files-to-html-in-ruby-html/)
      - [Converting Excel to PDF Files in Ruby](/cells/java/converting-excel-to-pdf-files-in-ruby-html/)
      - [Converting HTML files to Excel Spreadsheets in Ruby](/cells/java/converting-html-files-to-excel-spreadsheets-in-ruby-html/)
      - [Converting to MHTML Files in Ruby](/cells/java/converting-to-mhtml-files-in-ruby-html/)
      - [Converting Worksheet to Image in Ruby](/cells/java/converting-worksheet-to-image-in-ruby-html/)
      - [Converting Worksheet to SVG in Ruby](/cells/java/converting-worksheet-to-svg-in-ruby-html/)
      - [Encrypting Excel Files in Ruby](/cells/java/encrypting-excel-files-in-ruby-html/)
      - [Managing Document Properties in Ruby](/cells/java/managing-document-properties-in-ruby-html/)
  - [Working With Worksheets in Ruby](/cells/java/working-with-worksheets-in-ruby-html/)
    - [Display Features in Ruby](/cells/java/display-features-in-ruby-html/)
      - [Display or Hide Gridlines in Ruby](/cells/java/display-or-hide-gridlines-in-ruby-html/)
      - [Display or Hide Row Column Headers in Ruby](/cells/java/display-or-hide-row-column-headers-in-ruby-html/)
      - [Display or Hide Scroll Bars in Ruby](/cells/java/display-or-hide-scroll-bars-in-ruby-html/)
      - [Display or Hide Tabs in Ruby](/cells/java/display-or-hide-tabs-in-ruby-html/)
      - [Freeze Panes in Ruby](/cells/java/freeze-panes-in-ruby-html/)
      - [Hide or Unhide a Worksheet in Ruby](/cells/java/hide-or-unhide-a-worksheet-in-ruby-html/)
      - [Page Break Preview in Ruby](/cells/java/page-break-preview-in-ruby-html/)
      - [Split Panes in Ruby](/cells/java/split-panes-in-ruby-html/)
      - [Zoom Factor in Ruby](/cells/java/zoom-factor-in-ruby-html/)
    - [Management Features in Ruby](/cells/java/management-features-in-ruby-html/)
      - [Managing Worksheets in Ruby](/cells/java/managing-worksheets-in-ruby-html/)
    - [Page Setup Features in Ruby](/cells/java/page-setup-features-in-ruby-html/)
      - [Setting Page Options in Ruby](/cells/java/setting-page-options-in-ruby-html/)
    - [Security Features in Ruby](/cells/java/security-features-in-ruby-html/)
    ...
    - [Value Features in Ruby](/cells/java/value-features-in-ruby-html/)
      - [Copying and Moving Worksheets in Ruby](/cells/java/copying-and-moving-worksheets-in-ruby-html/)
      - [Managing Page Breaks in Ruby](/cells/java/managing-page-breaks-in-ruby-html/)
  - [Working With Rows And Columns in Ruby](/cells/java/working-with-rows-and-columns-in-ruby-html/)
    - [Adjusting Row Height and Column Width in Ruby](/cells/java/adjusting-row-height-and-column-width-in-ruby-html/)
    - [Autofit Rows and Columns in Ruby](/cells/java/autofit-rows-and-columns-in-ruby-html/)
    - [Copying Rows and Columns in Ruby](/cells/java/copying-rows-and-columns-in-ruby-html/)
    - [Grouping and Ungrouping Rows and Columns in Ruby](/cells/java/grouping-and-ungrouping-rows-and-columns-in-ruby-html/)
    - [Hiding and Showing Rows and Columns in Ruby](/cells/java/hiding-and-showing-rows-and-columns-in-ruby-html/)
    - [Inserting and Deleting Rows and Columns in Ruby](/cells/java/inserting-and-deleting-rows-and-columns-in-ruby-html/)
- [Support, Extend and Contribute to Aspose.Cells in Ruby](/cells/java/support-2c-extend-and-contribute-to-aspose-cells-in-ruby-html/)
