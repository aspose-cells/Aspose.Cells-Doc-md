...
- [Download and Configure Aspose.Cells in Ruby](/cells/java/download-and-configure-aspose-cells-in-ruby/)
- [Ruby Programmers Guide](/cells/java/ruby-programmers-guide/)
  ...
  - [Working With Worksheets in Ruby](/cells/java/working-with-worksheets-in-ruby/)
    - [Display Features in Ruby](/cells/java/display-features-in-ruby/)
      - [Display or Hide Gridlines in Ruby](/cells/java/display-or-hide-gridlines-in-ruby/)
      - [Display or Hide Row Column Headers in Ruby](/cells/java/display-or-hide-row-column-headers-in-ruby/)
      - [Display or Hide Scroll Bars in Ruby](/cells/java/display-or-hide-scroll-bars-in-ruby/)
      - [Display or Hide Tabs in Ruby](/cells/java/display-or-hide-tabs-in-ruby/)
      - [Freeze Panes in Ruby](/cells/java/freeze-panes-in-ruby/)
      - [Hide or Unhide a Worksheet in Ruby](/cells/java/hide-or-unhide-a-worksheet-in-ruby/)
      - [Page Break Preview in Ruby](/cells/java/page-break-preview-in-ruby/)
      - [Split Panes in Ruby](/cells/java/split-panes-in-ruby/)
      - [Zoom Factor in Ruby](/cells/java/zoom-factor-in-ruby/)
    - [Management Features in Ruby](/cells/java/management-features-in-ruby/)
  ...
  - [Working With Rows And Columns in Ruby](/cells/java/working-with-rows-and-columns-in-ruby/)
    - [Adjusting Row Height and Column Width in Ruby](/cells/java/adjusting-row-height-and-column-width-in-ruby/)
    - [Autofit Rows and Columns in Ruby](/cells/java/autofit-rows-and-columns-in-ruby/)
    - [Copying Rows and Columns in Ruby](/cells/java/copying-rows-and-columns-in-ruby/)
