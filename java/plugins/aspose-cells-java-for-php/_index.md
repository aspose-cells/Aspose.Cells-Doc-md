...
Project Aspose.Cells for PHP shows how different tasks can be performed using Aspose.Cells Java APIs in PHP. This project is aimed to provide useful examples for PHP Developers who want to utilise Aspose.Cells for Java in their PHP Projects using [PHP/Java Bridge](http://php-java-bridge.sourceforge.net/pjb/).

**This section includes the following topics:**

- [Download and Configure Aspose.Cells in PHP](/cells/java/download-and-configure-aspose-cells-in-php-html/)
- [PHP Programmers Guide](/cells/java/php-programmers-guide-html/)
  - [Introduction in PHP](/cells/java/introduction-in-php-html/)
    - [Hello World](/cells/java/hello-world-html/)
  - [Working With Files in PHP](/cells/java/working-with-files-in-php-html/)
    - [File Handling Features in PHP](/cells/java/file-handling-features-in-php-html/)
      - [Opening Files in PHP](/cells/java/opening-files-in-php-html/)
      - [Saving Files in PHP](/cells/java/saving-files-in-php-html/)
    - [Utility Features in PHP](/cells/java/utility-features-in-php-html/)
      - [Converting Chart to Image in PHP](/cells/java/converting-chart-to-image-in-php-html/)
      - [Converting Excel Files to HTML in PHP](/cells/java/converting-excel-files-to-html-in-php-html/)
      - [Converting Excel to PDF Files in PHP](/cells/java/converting-excel-to-pdf-files-in-php-html/)
      - [Converting to MHTML Files in PHP](/cells/java/converting-to-mhtml-files-in-php-html/)
      - [Converting Worksheet to Image in PHP](/cells/java/converting-worksheet-to-image-in-php-html/)
      - [Converting Worksheet to SVG in PHP](/cells/java/converting-worksheet-to-svg-in-php-html/)
      - [Managing Document Properties in PHP](/cells/java/managing-document-properties-in-php-html/)
  - [Working With Rows And Columns in PHP](/cells/java/working-with-rows-and-columns-in-php-html/)
    - [Adjusting Row Height and Column Width in PHP](/cells/java/adjusting-row-height-and-column-width-in-php-html/)
    - [Autofit Rows and Columns in PHP](/cells/java/autofit-rows-and-columns-in-php-html/)
    - [Copying Rows and Columns in PHP](/cells/java/copying-rows-and-columns-in-php-html/)
    - [Grouping and Ungrouping Rows and Columns in PHP](/cells/java/grouping-and-ungrouping-rows-and-columns-in-php-html/)
    - [Hiding and Showing Rows and Columns in PHP](/cells/java/hiding-and-showing-rows-and-columns-in-php-html/)
    - [Inserting and Deleting Rows and Columns in PHP](/cells/java/inserting-and-deleting-rows-and-columns-in-php-html/)
  - [Working With Worksheets in PHP](/cells/java/working-with-worksheets-in-php-html/)
    - [Display Features in Php](/cells/java/display-features-in-php-html/)
      - [Display or Hide Gridlines in Php](/cells/java/display-or-hide-gridlines-in-php-html/)
      - [Display or Hide Scroll Bars in Php](/cells/java/display-or-hide-scroll-bars-in-php-html/)
      - [Display or Hide Tabs in Php](/cells/java/display-or-hide-tabs-in-php-html/)
      - [Freeze Panes in Php](/cells/java/freeze-panes-in-php-html/)
      - [Hide or Unhide a Worksheet in Php](/cells/java/hide-or-unhide-a-worksheet-in-php-html/)
      - [Page Break Preview in Php](/cells/java/page-break-preview-in-php-html/)
      - [Split Panes in Php](/cells/java/split-panes-in-php-html/)
    - [Management Features in Php](/cells/java/management-features-in-php-html/)
      - [Managing Worksheets in Php](/cells/java/managing-worksheets-in-php-html/)
    - [Page Setup Features in Php](/cells/java/page-setup-features-in-php-html/)
      - [Setting Page Options in Php](/cells/java/setting-page-options-in-php-html/)
    - [Security Features in Php](/cells/java/security-features-in-php-html/)
    ...
    - [Value Features in Php](/cells/java/value-features-in-php-html/)
...
- [Support, Extend and Contribute to Aspose.Cells in PHP](/cells/java/support-2c-extend-and-contribute-to-aspose-cells-in-php-html/)
...
Aspose.Cells Java for PHP is open source and its source code is available on the major social coding websites listed below. Developers are encouraged to download the source code and contribute by suggesting or adding new feature or improving the existing ones, so that others could also benefit from it.
### **Source Code**
