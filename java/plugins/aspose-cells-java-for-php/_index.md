...
- [Download and Configure Aspose.Cells in PHP](/cells/java/download-and-configure-aspose-cells-in-php/)
- [PHP Programmers Guide](/cells/java/php-programmers-guide/)
  ...
  - [Working With Files in PHP](/cells/java/working-with-files-in-php/)
    ...
    - [Utility Features in PHP](/cells/java/utility-features-in-php/)
      - [Converting Chart to Image in PHP](/cells/java/converting-chart-to-image-in-php/)
      - [Converting Excel Files to HTML in PHP](/cells/java/converting-excel-files-to-html-in-php/)
      - [Converting Excel to PDF Files in PHP](/cells/java/converting-excel-to-pdf-files-in-php/)
      - [Converting to MHTML Files in PHP](/cells/java/converting-to-mhtml-files-in-php/)
      - [Converting Worksheet to Image in PHP](/cells/java/converting-worksheet-to-image-in-php/)
      - [Converting Worksheet to SVG in PHP](/cells/java/converting-worksheet-to-svg-in-php/)
      - [Managing Document Properties in PHP](/cells/java/managing-document-properties-in-php/)
  - [Working With Rows And Columns in PHP](/cells/java/working-with-rows-and-columns-in-php/)
    - [Adjusting Row Height and Column Width in PHP](/cells/java/adjusting-row-height-and-column-width-in-php/)
    - [Autofit Rows and Columns in PHP](/cells/java/autofit-rows-and-columns-in-php/)
    - [Copying Rows and Columns in PHP](/cells/java/copying-rows-and-columns-in-php/)
    - [Grouping and Ungrouping Rows and Columns in PHP](/cells/java/grouping-and-ungrouping-rows-and-columns-in-php/)
    - [Hiding and Showing Rows and Columns in PHP](/cells/java/hiding-and-showing-rows-and-columns-in-php/)
    - [Inserting and Deleting Rows and Columns in PHP](/cells/java/inserting-and-deleting-rows-and-columns-in-php/)
  - [Working With Worksheets in PHP](/cells/java/working-with-worksheets-in-php/)
    - [Display Features in Php](/cells/java/display-features-in-php/)
      - [Display or Hide Gridlines in Php](/cells/java/display-or-hide-gridlines-in-php/)
      - [Display or Hide Scroll Bars in Php](/cells/java/display-or-hide-scroll-bars-in-php/)
      - [Display or Hide Tabs in Php](/cells/java/display-or-hide-tabs-in-php/)
      - [Freeze Panes in Php](/cells/java/freeze-panes-in-php/)
      - [Hide or Unhide a Worksheet in Php](/cells/java/hide-or-unhide-a-worksheet-in-php/)
      - [Page Break Preview in Php](/cells/java/page-break-preview-in-php/)
      - [Split Panes in Php](/cells/java/split-panes-in-php/)
    - [Management Features in Php](/cells/java/management-features-in-php/)
      - [Managing Worksheets in Php](/cells/java/managing-worksheets-in-php/)
    - [Page Setup Features in Php](/cells/java/page-setup-features-in-php/)
      - [Setting Page Options in Php](/cells/java/setting-page-options-in-php/)
    - [Security Features in Php](/cells/java/security-features-in-php/)
...
6.Go to **localhost:8080/JavaBridge/test.php** to check if php works. You can find other examples in there

7.Copy your [Aspose.Cells Java](https://downloads.aspose.com/cells/java) jar file to C:\Program Files\Apache Software Foundation\Tomcat 8.0\webapps\JavaBridge\WEB-INF\lib
