...
The following code sample demonstrates the use of [JsonLayoutOptions](https://apireference.aspose.com/java/cells/com.aspose.cells/JsonLayoutOptions) and [JsonUtility](https://apireference.aspose.com/java/cells/com.aspose.cells/JsonUtility) classes to load the [source JSON file](SampleJson.json) and generates the [output CSV file](SampleJson_out.csv).
