...
The following code example demonstrates exporting active worksheet to Markdown by using [**SaveFormat.Markdown**](https://apireference.aspose.com/cells/java/com.aspose.cells/saveformat#MARKDOWN) enumeration member. Please see the [output Markdown file](Book1.txt) generated by the code for reference.
