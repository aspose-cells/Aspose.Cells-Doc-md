...
The following sample code explains the usage of [LoadOptions.ParsingPivotCachedRecords](https://apireference.aspose.com/java/cells/com.aspose.cells/loadoptions#ParsingPivotCachedRecords) property. It loads the [sample Excel file](attachments/61541007/61767786.xlsx) while parsing the pivot cached records. Then it refreshes the pivot table and saves it as the [output Excel file](attachments/61541007/61767785.xlsx).
## **Sample Code**
{{< gist "aspose-com-gists" "439a68a5e4305388c50ca306ef238de5" "PivotTables-ParsingPivotCachedRecordsWhileLoadingExcelFile.java" >}}
