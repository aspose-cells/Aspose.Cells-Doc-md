...
The following sample code explains the usage of [LoadOptions.ParsingPivotCachedRecords](https://apireference.aspose.com/java/cells/com.aspose.cells/loadoptions#ParsingPivotCachedRecords) property. It loads the [sample Excel file](61767786.xlsx) while parsing the pivot cached records. Then it refreshes the pivot table and saves it as the [output Excel file](61767785.xlsx).
## **Sample Code**
