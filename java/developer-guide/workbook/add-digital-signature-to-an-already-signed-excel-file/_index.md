...
The following sample code explains how to make use of [Workbook.addDigitalSignature(DigitalSignatureCollection digitalSignatureCollection)](https://apireference.aspose.com/java/cells/com.aspose.cells/workbook#addDigitalSignature\(com.aspose.cells.DigitalSignatureCollection\)) method to add a digital signature to already signed Excel file. Please check the [sample Excel file](attachments/50266413/50528287.xlsx) used in this code. This file is already digitally signed. Please check the [output Excel file](attachments/50266413/50528288.xlsx) generated by the code. We have used the demo certificate named [AsposeTest.pfx](attachments/50266413/50528289.pfx) in this code which has a password *aspose*. The screenshot shows the effect of the sample code on the sample Excel file after execution.
