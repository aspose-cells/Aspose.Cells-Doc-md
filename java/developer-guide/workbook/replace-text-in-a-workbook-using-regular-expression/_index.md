...
The following code snippet demonstrates the use of the [RegexKey](https://apireference.aspose.com/java/cells/com.aspose.cells/replaceoptions#RegexKey) property by using the [sample excel file](SampleRegexReplace.xlsx). The [output file](RegexReplace_out.xlsx) generated by the following code snippet is attached for reference.
### **Sample Code**
