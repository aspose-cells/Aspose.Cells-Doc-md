...
Please see the following sample code. It loads the [sample Excel file](attachments/66948420/67338498.xlsx) that contains the pivot table. It then creates the slicer based on the first base pivot field. Finally, it saves the workbook in [output XLSX](attachments/66948420/67338497.xlsx) and [output XLSB](attachments/66948420/67338496.xlsb) format. The following screenshot shows the slicer created by Aspose.Cells in the output Excel file.
