...
Aspose.Cells provides the [Cell](https://apireference.aspose.com/cells/java/com.aspose.cells/Cell) class' [GetPrecedents](https://apireference.aspose.com/cells/java/com.aspose.cells/Cell#getPrecedents()) method used to trace a cell's precedents. It returns a [ReferredAreaCollection](https://apireference.aspose.com/cells/java/com.aspose.cells/ReferredAreaCollection). As you can see above, in Book1.xls, cell B7 contains a formula "=SUM(A1:A3)". So cells A1:A3 are the precedent cells to cell B7. The following example demonstrates the tracing precedents feature using the template file Book1.xls.
