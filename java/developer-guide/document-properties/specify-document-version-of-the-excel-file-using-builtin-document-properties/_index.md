...
The following sample code creates a workbook and changes its built-in document properties that include *Title*, *Authors* and *Version number*. Please see the [output Excel file](attachments/64454890/64716836.xlsx) generated by the code and screenshot that shows the modified *Version number* by [BuiltInDocumentPropertyCollection.DocumentVersion](https://apireference.aspose.com/java/cells/com.aspose.cells/builtindocumentpropertycollection#DocumentVersion) property.
