...
The method returns an object of the [**Label**](https://apireference.aspose.com/cells/java/com.aspose.cells/Label) class, where the [**Label**](https://apireference.aspose.com/cells/java/com.aspose.cells/Label) class represents a label in the chart. It has some important members as detailed below:

- [**Text**](https://apireference.aspose.com/cells/java/com.aspose.cells/label#Text) property specifies a label's caption string.
- [**Fill**](https://apireference.aspose.com/cells/java/com.aspose.cells/label#Fill) property specifies the fill color attributes.
...
One way to highlight important information in a report is to use a text box. For example, enter text to highlight the company name or to indicate the geographic region with the highest sales. The [**ShapeCollection**](https://apireference.aspose.com/cells/java/com.aspose.cells/ShapeCollection) class provides a method named [**addTextBoxInChart**](https://apireference.aspose.com/cells/java/com.aspose.cells/shapecollection#addTextBoxInChart(int,%20int,%20int,%20int)), which is used to add a text box control to a chart. Following is the parameters list used for the method:
...
The method returns an object of the [**TextBox**](https://apireference.aspose.com/cells/java/com.aspose.cells/TextBox) class where the [**TextBox**](https://apireference.aspose.com/cells/java/com.aspose.cells/TextBox) class represents a text box in the chart.
...
The method returns an object of the [**Picture**](https://apireference.aspose.com/cells/java/com.aspose.cells/Picture) class where the [**Picture**](https://apireference.aspose.com/cells/java/com.aspose.cells/Picture) class represents a picture object in the chart.
...
Aspose.Cells allows you to insert checkboxes into a chart sheet by using [**MsoDrawingType**](https://apireference.aspose.com/cells/java/com.aspose.cells/MsoDrawingType) enumeration. The following example demonstrates adding a checkbox to a chart sheet.
