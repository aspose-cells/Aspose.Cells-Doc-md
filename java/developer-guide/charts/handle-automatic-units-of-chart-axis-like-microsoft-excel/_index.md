...
The following sample code loads the [sample Excel file](attachments/61540754/61767769.xlsx) and generates the [output PDF chart](attachments/61540754/61767768.pdf). The screenshot shows the automatic units of chart axis in red rectangles and also compares the sample Excel file chart with output PDF chart. Both are exactly similar.

![todo:image_alt_text](handle-automatic-units-of-chart-axis-like-microsoft-excel_1.png)
## **Sample Code**
{{< gist "aspose-com-gists" "a20e8fa273e7cfa37d032b8211fcf8bf" "Charts-HandleAutomaticUnitsOfChartAxisLikeMicrosoftExcel.java" >}}
