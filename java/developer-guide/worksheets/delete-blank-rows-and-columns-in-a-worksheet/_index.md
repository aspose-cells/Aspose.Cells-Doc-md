...
1. To delete blank rows, use the [Cells.deleteBlankRows()](https://apireference.aspose.com/cells/java/com.aspose.cells/cells#deleteBlankRows\(\)) method.
1. To delete blank columns, use the [Cells.deleteBlankColumns()](https://apireference.aspose.com/cells/java/com.aspose.cells/cells#deleteBlankColumns\(\)) method.
