...
The following screenshot shows the HTML source. As you can see that the links are now referring to *C:\Temp\OtherSheets* directory. This was achieved using the [IFilePathProvider](https://apireference.aspose.com/cells/java/com.aspose.cells/IFilePathProvider) interface.
