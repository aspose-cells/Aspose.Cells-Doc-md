...
The following code explains the usage of [Workbook.removeUnusedStyles()](https://apireference.aspose.com/java/cells/com.aspose.cells/workbook#removeUnusedStyles\(\)). The code loads the [template excel file](attachments/5275811/5473451.xlsx) which you can download from the provided link. It contains an unused style named **AsposeStyle**, this style and all other unused styles will be removed after the execution of the code. Please see the following screenshot for more illustration.
