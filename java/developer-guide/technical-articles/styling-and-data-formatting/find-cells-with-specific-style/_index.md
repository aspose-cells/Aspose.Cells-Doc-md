...
Aspose.Cells for Java provides the feature to find cells in worksheet with some specific style. For this, the API provides [**FindOptions.setStyle()**](https://apireference.aspose.com/cells/java/com.aspose.cells/findoptions#Style) property.
