...
The following code illustrates how you can load as well as import a CSV file with formulas. You can use any CSV file. For illustration purpose, we use the [simple csv file](attachments/5276090/5472505.csv) which contains this data. As you see it contains a formula.
...
The code first loads the CSV file, then import it again at cell D4. Finally, it saves the workbook object in XSLX format. The [output XLSX file](attachments/5276090/5472503.xlsx) looks like this. As you see cell C3 and F4 contains formula and its result 800.
