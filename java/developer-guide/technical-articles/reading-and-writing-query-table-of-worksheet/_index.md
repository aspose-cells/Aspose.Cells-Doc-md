...
The following screenshot shows the [source excel file](attachments/5275858/5472578.xlsx) used in the code and its properties showing both of the [QueryTable](https://apireference.aspose.com/java/cells/com.aspose.cells/QueryTable) values.

![todo:image_alt_text](reading-and-writing-query-table-of-worksheet_1.png)

The following screenshot shows the [output excel file](attachments/5275858/5472574.xlsx) generated by the code and its properties showing both of the [QueryTable](https://apireference.aspose.com/java/cells/com.aspose.cells/QueryTable) values. As you can see the Preserved Formatting checkbox is checked now.

![todo:image_alt_text](reading-and-writing-query-table-of-worksheet_2.png)

{{< gist "aspose-com-gists" "a20e8fa273e7cfa37d032b8211fcf8bf" "Examples-src-main-java-com-aspose-cells-examples-articles-ReadingAndWritingQueryTable-ReadingAndWritingQueryTable.java" >}}
#### **Console Output**
