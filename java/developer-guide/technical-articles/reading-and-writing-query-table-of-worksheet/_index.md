...
The following screenshot shows the [output excel file](5472574.xlsx) generated by the code and its properties showing both of the [QueryTable](https://apireference.aspose.com/java/cells/com.aspose.cells/QueryTable) values. As you can see the Preserved Formatting checkbox is checked now.
