...
Please download the [sample excel file](attachments/5276183/5473374.xlsx) used in the following sample code and the [output excel file](attachments/5276183/5473375.xlsx) generated by it.
## **Update ActiveX ComboBox Control**
The following screenshot shows the effect of the sample code on the [sample excel file](attachments/5276183/5473374.xlsx). As you can see, the ActiveX ComboBox value has been updated to "This is combo box control".

![todo:image_alt_text](update-activex-combobox-control_1.png)
## **Sample Code**
The following sample code updates the value of ActiveX ComboBox Control present inside the [sample excel file](attachments/5276183/5473374.xlsx).
