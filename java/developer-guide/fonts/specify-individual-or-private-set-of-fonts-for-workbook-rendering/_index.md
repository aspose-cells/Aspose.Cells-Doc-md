...
The following sample code loads the [sample Excel file](67338304.xlsx) with its individual or private set of fonts which are specified using the [IndividualFontConfigs](https://apireference.aspose.com/java/cells/com.aspose.cells/individualfontconfigs) class. Please see the [sample font](67338302.zip) used inside the code as well as the [output PDF](67338303.pdf) generated by it. The following screenshot shows how the output PDF looks if the font is found successfully.
