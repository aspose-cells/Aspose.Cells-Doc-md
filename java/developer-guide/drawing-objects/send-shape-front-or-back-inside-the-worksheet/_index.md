...
The following sample code explains the usage of [Shape.ToFrontOrBack()](https://apireference.aspose.com/java/cells/com.aspose.cells/shape#toFrontOrBack\(int\)) method. Please see the [sample Excel file](50528362.xlsx) used inside the code and the [output Excel file](50528361.xlsx) generated by it. The screenshot shows the effect of the code on the sample Excel file on execution.
