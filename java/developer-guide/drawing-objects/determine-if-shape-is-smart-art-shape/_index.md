...
The following sample code loads the [sample Excel file](attachments/54690182/55541805.xlsx) containing a smart art shape as shown in this screenshot. It then prints the value of [Shape.IsSmartArt](https://apireference.aspose.com/java/cells/com.aspose.cells/shape#IsSmartArt) property of the first shape. Please see the console output of the sample code given below.
