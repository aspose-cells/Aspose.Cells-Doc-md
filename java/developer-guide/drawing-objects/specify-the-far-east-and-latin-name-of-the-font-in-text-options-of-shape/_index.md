...
Sometimes you want to display text in Far East language font e.g. Japanese, Chinese, Thai, etc. Aspose.Cells provides [**TextOptions.FarEastName**](https://apireference.aspose.com/cells/java/com.aspose.cells/textoptions#FarEastName) property that can be used to specify the font name of Far East language. Besides, you can also specify the Latin font name using [**TextOptions.LatinName**](https://apireference.aspose.com/cells/java/com.aspose.cells/textoptions#LatinName) property.
