...
| :- | :- | :- | :- |
|**File formats**|  |  |  |
|Read and write file formats (XLS, XLT, XLSX, CSV, SpreadsheetML, Tab Delimited, TXT, <br>XML and HTML) |Partially Supported |Partially Supported |Supported |
...
|Page setup features (top, left, bottom, right, header and footer margins, orientation - <br>portrait or landscape, scaling, paper size, printing area, repeating rows and columns) |Partially Supported |Supported |Supported |
...
|Create standard charts (column, bar, line, pie, scatter, area, doughnut, radar, surface 3D, <br>bubble, stock, cylinder, cone, pyramid etc.) | | |Supported |
