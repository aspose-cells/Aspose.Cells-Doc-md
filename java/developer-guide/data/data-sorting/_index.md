...
Excel provides the feature to sort data based on the background color. The same feature is provided using Aspose.Cells using [DataSorter](https://apireference.aspose.com/java/cells/com.aspose.cells/DataSorter) where [SortOnType.CELL_COLOR](https://apireference.aspose.com/java/cells/com.aspose.cells/sortontype#CELL_COLOR) can be used in [addKey()](https://apireference.aspose.com/java/cells/com.aspose.cells/datasorter#addKey\(int,%20int\)) to sort data based on the background color. All the cells which contain specified color in the [addKey()](https://apireference.aspose.com/java/cells/com.aspose.cells/datasorter#addKey\(int,%20int\)), function are placed on top or bottom according to the SortOrder setting and order of the rest of the cells is not changed at all.
