...
type: docs
weight: 170
url: /java/specifying-dbnum-custom-pattern-formatting/
---
...
## **Sample Code**
The following sample code illustrates how to specify *DBNum* custom pattern formatting. Please check its [output PDF](attachments/42730033/43352082.pdf) for more help.

{{< gist "aspose-com-gists" "a20e8fa273e7cfa37d032b8211fcf8bf" "Examples-src-main-java-com-aspose-cells-examples-data-SpecifyingDBNumCustomPatternFormatting.java" >}}
