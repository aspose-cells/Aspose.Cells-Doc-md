...
- [FIRST_LINE](https://apireference.aspose.com/java/cells/com.aspose.cells/autofitmergedcellstype#FIRST_LINE): Only expands the height of the first row.
- [LAST_LINE](https://apireference.aspose.com/java/cells/com.aspose.cells/autofitmergedcellstype#LAST_LINE): Only expands the height of the last row.
- [EACH_LINE](https://apireference.aspose.com/java/cells/com.aspose.cells/autofitmergedcellstype#EACH_LINE): Only expands the height of each row.
...
1. autoFitColumns(int firstColumn, int lastColumn, [AutoFitterOptions](https://apireference.aspose.com/java/cells/com.aspose.cells/AutoFitterOptions) options)
## **Important to Know**
{{% alert color="primary" %}} 
