...
## **Aspose.Cells Android via Java 機能の概要**
このセクションでは、Aspose.Cells for Java と Aspose.Cells for Android via Java の機能の利用可能性を比較します。
### **ファイル形式と変換**
Aspose.Cellsが提供する文書のインポートおよびエクスポート機能に多くの世界中の顧客が依存しています。

|**機能**|**説明**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- | :- |
|高品質の変換|いくつかの一般的な文書形式間で迅速かつ信頼性の高い変換を行います。|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Microsoft Excel Workbook (XLS/XLSB)|最速で最も完全なXLS/XLSB形式の実装が見つかります。|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**機能**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- |
...
|ワークシートページをラスタ画像（マルチページTIFF、GIF）にレンダリングします。|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|**機能**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- |
|配列、ArrayList、ResultSetなどからデータのインポート/エクスポート|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
