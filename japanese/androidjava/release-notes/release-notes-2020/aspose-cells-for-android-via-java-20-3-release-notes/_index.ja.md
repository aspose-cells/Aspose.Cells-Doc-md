---
title: Aspose.Cells for Android via Java 20.3 リリースノート
type: docs
weight: 20
url: /ja/java/aspose-cells-for-android-via-java-20-3-release-notes/
---
{{% alert color="primary" %}} 

このページには、Aspose.Cells for Android via Java 20.3 のリリース ノートが含まれています。
...
|CELLSJAVA-43132|チャートを画像にエクスポートする際に、一部のチャートからデータラベルが失われる|バグ|
|CELLSJAVA-43143|WorkbookDesigner.process の後、チャートの出力が HTML で null になる|バグ|
...
検索されたキーが正規表現かどうかを示します。 true の場合、検索されたキー (置換される部分) はユーザー指定の正規表現として取得されます。
