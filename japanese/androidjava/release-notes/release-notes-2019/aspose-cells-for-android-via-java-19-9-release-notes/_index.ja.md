...
type: docs
weight: 20
url: /ja/java/aspose-cells-for-android-via-java-19-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSJAVA-42929|XLSX から PDF への変換時のグラフ タイトルの変更|バグ|
|CELLSJAVA-42933|Excel ファイルを PDF に変換中にグラフィックスの色が変わる|バグ|
|CELLSJAVA-42946|シリーズを含む積み上げ棒グラフの PDF への不適切なレンダリング|バグ|
...
|バグ|
|CELLSJAVA-42970|Excel から PDF へのレンダリングでの不要な拡張境界線|バグ|
...
|CELLSJAVA-42945|ExportImagesAsBase64 が設定されている場合、HTML として保存すると例外がスローされます|例外|
...
|CELLSJAVA-42954|XLSX のロードおよび保存中に発生した例外|例外|
|CELLSJAVA-42957|XLSX の保存時に無効な FontUnderlineType 値がスローされる|例外|
