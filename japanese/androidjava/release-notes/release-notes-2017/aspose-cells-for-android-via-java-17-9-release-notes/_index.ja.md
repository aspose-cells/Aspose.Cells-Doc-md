...
type: docs
weight: 20
url: /ja/java/aspose-cells-for-android-via-java-17-9-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Android via Java 17.9](https://downloads.aspose.com/cells/androidjava/new-releases/aspose.cells-for-android-via-java-17.9/).
...
|CELLSJAVA-42379|PDF 出力へのレンダリング時の名前付き宛先の実装 (ブックマーク クエリ)|新機能|
...
|CELLSJAVA-42308|HTML レンダリングのピボットテーブルの問題 (欠落している行、ピボット フィールド ヘッダーが 2 回印刷される、日付が数値に変換されるなど)|バグ|
