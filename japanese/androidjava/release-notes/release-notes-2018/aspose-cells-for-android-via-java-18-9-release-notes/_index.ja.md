---
title: Aspose.Cells for Android via Java 18.9 リリースノート
type: docs
weight: 20
url: /ja/java/aspose-cells-for-android-via-java-18-9-release-notes/
---
{{% alert color="primary" %}}

このページには、Aspose.Cells for Android via Java 18.9 のリリース ノートが含まれています。
...
|CELLSJAVA-42672|出力 PDF ドキュメントが大きすぎます|バグ|
|CELLSJAVA-42671|出力された Excel ファイルを MS Excel 日本語版で表示する際のハイパーリンクの問題|バグ|
|CELLSJAVA-42667|「#NUM!」を取得中IRR機能を持つ細胞の場合|バグ|
