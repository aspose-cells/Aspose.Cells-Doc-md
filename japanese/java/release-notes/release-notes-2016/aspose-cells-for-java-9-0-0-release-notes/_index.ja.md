...
type: docs
weight: 40
url: /ja/java/aspose-cells-for-java-9-0-0-release-notes/
---
## **1) Aspose.Cells**
...
|CELLSJAVA-41969 |Cell HTML を XLSX ファイル形式に変換中にシェーディングが失われる|バグ|
...
|CELLSJAVA-41953 |HTML 形式に変換した後、ダイアグラム内のテキストが正しく配置されない|バグ|
