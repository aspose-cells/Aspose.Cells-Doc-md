...
type: docs
weight: 80
url: /ja/java/aspose-cells-for-java-7-1-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 7.1.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.1.2/)
...
- 散布図の最大値を正しく設定できない
- 形状内のテキストが失われたか、生成された PDF ファイルの形状範囲外に移動しました
