...
type: docs
weight: 50
url: /ja/java/aspose-cells-for-java-2-5-4-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 2.5.4](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.5.4/)
...
26655 - HTML ファイル用のアニメーション GIF 画像のエクスポート
