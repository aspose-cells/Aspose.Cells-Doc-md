...
type: docs
weight: 40
url: /ja/java/aspose-cells-for-java-7-0-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 7.0.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.0.0/)
...
ODS ファイルの読み取り時にマクロを保持し、マクロを ODS ファイルに保存する
