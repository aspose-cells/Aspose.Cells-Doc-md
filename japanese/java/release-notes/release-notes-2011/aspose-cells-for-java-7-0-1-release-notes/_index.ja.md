...
type: docs
weight: 30
url: /ja/java/aspose-cells-for-java-7-0-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 7.0.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.0.1/)
...
30103 XLSX ファイルの再保存後にグラフのフォントが変更される
