...
type: docs
weight: 40
url: /ja/java/aspose-cells-for-java-8-1-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 8.1.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.1.1/)
...
(CELLSJAVA-40852) - ImageOrPrintOptions の透過性を設定すると、黒い背景で PNG がレンダリングされます
