...
type: docs
weight: 20
url: /ja/java/aspose-cells-for-java-8-2-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 8.2.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.2.1/)
...
(CELLSJAVA-40959) - HTML 出力の追加の align 属性。
(CELLSJAVA-40954) - HTML出力での列の不一致
...
(CELLSJAVA-40944) - 埋め込まれた PDF が、ワークブックをマージした後に破損する
(CELLSJAVA-40979) - レンダリングされた PDF の円グラフのデータ ラベルにいくつかの四角形が添付されます
...
(CELLSJAVA-40818) - ToImage を使用してグラフを EMF として保存すると、軸のタイトルが表示されない
