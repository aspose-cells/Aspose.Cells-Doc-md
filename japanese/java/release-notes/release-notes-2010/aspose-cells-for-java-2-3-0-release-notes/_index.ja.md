...
type: docs
weight: 60
url: /ja/java/aspose-cells-for-java-2-3-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 2.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.3.0/)
...
- Chart-to-Image 機能の EMF 画像形式のサポートが含まれます。
