...
type: docs
weight: 20
url: /ja/java/aspose-cells-for-java-2-4-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 2.4.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.4.2/)
...
- Excel から PDF へのダイレクト機能が強化されました。
