...
type: docs
weight: 70
url: /ja/java/aspose-cells-for-java-2-2-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 2.2.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.2.1/)
...
- XLSファイル用にMS Excel 2007で保存された条件付き書式の拡張レコードをサポート
