...
type: docs
weight: 80
url: /ja/java/aspose-cells-for-java-2-2-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 2.2.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.2.0/)
...
MS Excel 2007 で保存された XLS ファイル用の拡張スタイルを提供
