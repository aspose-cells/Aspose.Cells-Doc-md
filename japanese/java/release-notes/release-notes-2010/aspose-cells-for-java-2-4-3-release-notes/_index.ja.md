...
type: docs
weight: 10
url: /ja/java/aspose-cells-for-java-2-4-3-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 2.4.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.4.3/)
...
- チャート/シェイプを HTML ファイル変換用の画像としてエクスポートします。
...
- Direct Excel to PDF 機能が強化されました。
- 14 の修正と機能強化。
