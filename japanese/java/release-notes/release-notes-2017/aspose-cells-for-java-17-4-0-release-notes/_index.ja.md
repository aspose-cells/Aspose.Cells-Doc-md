...
type: docs
weight: 90
url: /ja/java/aspose-cells-for-java-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 17.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.4.0/).
...
- [Excel ワークブックの VBA プロジェクトをパスワードで保護する](/cells/ja/java/password-protect-the-vba-project-of-excel-workbook/)
- [VBA プロジェクトが保護されているかどうかを調べる](/cells/ja/java/find-out-if-vba-project-is-protected/)
- [VBA プロジェクトが保護され、表示用にロックされているかどうかを確認する](/cells/ja/java/check-if-vba-project-is-protected-and-locked-for-viewing/)
