...
type: docs
weight: 100
url: /ja/java/aspose-cells-for-java-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 17.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.3.0/).
...
1. [ピボット テーブルのグローバリゼーション設定のカスタマイズ](/cells/ja/java/customize-globalization-settings-for-pivot-table/)
1. [GridWebのページ変更時にクライアントサイド関数を実行する](/cells/ja/java/execute-client-side-function-on-gridweb-page-change/)
1. [更新されたセルだけではなく、ワークシート全体を検証する](/cells/ja/java/validate-entire-worksheet-instead-of-only-the-updated-cells/)
