...
type: docs
weight: 10
url: /ja/java/aspose-cells-for-java-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [データが大きすぎる場合、スマート マーカー データを他のワークシートに自動入力](/cells/ja/java/auto-populate-smart-marker-data-to-other-worksheets-if-data-is-too-large/)
- [出力 HTML でワークシート CSS を個別にエクスポートする](/cells/ja/java/export-worksheet-css-separately-in-output-html/)
- [Excel VBA Range.FormulaLocal と同様の Cell.FormulaLocal を実装します。](/cells/ja/java/implement-cell-formulalocal-similar-to-excel-vba-range-formulalocal/)
- [HtmlSaveOptions.TableCssId プロパティを使用してテーブル要素スタイルをプレフィックスする](/cells/ja/java/prefix-table-elements-styles-with-htmlsaveoptions-tablecssid-property/)
- [Excel を Pdf に変換しながら Office アドインをレンダリングする](/cells/ja/java/render-office-add-ins-while-converting-excel-to-pdf/)
- [グラフのデータ ラベルの形状タイプを設定する](/cells/ja/java/set-the-shape-type-of-data-labels-of-chart/)
- [共有ワークブックのリビジョン ログの履歴を保持する更新日数](/cells/ja/java/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
