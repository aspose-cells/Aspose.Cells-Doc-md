...
type: docs
weight: 80
url: /ja/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [Cells データ テーブル行を挿入するときに最初の行を下にシフトする](/cells/ja/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
