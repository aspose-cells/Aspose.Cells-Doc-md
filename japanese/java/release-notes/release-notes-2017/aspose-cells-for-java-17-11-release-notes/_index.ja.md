...
type: docs
weight: 20
url: /ja/java/aspose-cells-for-java-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
- [Smart Art をグループ シェイプに変換する](/cells/ja/java/convert-the-smart-art-to-group-shape/)
- [Aspose.Cells で共有ワークブックを作成](/cells/ja/java/create-shared-workbook-with-aspose-cells/)
- [シェイプがスマート アート シェイプかどうかを判断する](/cells/ja/java/determine-if-shape-is-smart-art-shape/)
- [Xml マップのルート要素名を見つける](/cells/ja/java/find-the-root-element-name-of-xml-map/)
- [Excel を Pdf にレンダリングする際のエラーを無視する](/cells/ja/java/ignore-errors-while-rendering-excel-to-pdf/)
- [共有ワークブックをパスワードで保護または保護解除する](/cells/ja/java/password-protect-or-unprotect-the-shared-workbook/)
- [Worksheet.XmlMapQuery メソッドを使用して Xml マップ パスにマップされた Cell 領域のクエリ](/cells/ja/java/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
- [ImageOrPrintOptions の PageIndex および PageCount プロパティを使用したページのシーケンスのレンダリング](/cells/ja/java/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/)
