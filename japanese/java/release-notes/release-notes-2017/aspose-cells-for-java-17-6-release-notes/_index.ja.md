...
type: docs
weight: 70
url: /ja/java/aspose-cells-for-java-17-6-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 17.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.6/).
...
- [シェイプ内のテクスチャとして画像を並べて表示](/cells/ja/java/tile-picture-as-a-texture-inside-the-shape/)
- [GridWebのOnAjaxCallFinishedClientFunctionを利用する](/cells/ja/java/using-onajaxcallfinishedclientfunction-of-gridweb/)
- [Smart Marker フィールドで Formula パラメータを使用する](/cells/ja/java/using-formula-parameter-in-smart-marker-field/)
