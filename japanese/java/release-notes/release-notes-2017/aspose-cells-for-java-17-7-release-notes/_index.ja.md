...
type: docs
weight: 60
url: /ja/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [ロシア語またはその他の言語でエラーとブール値を実装する](/cells/ja/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
