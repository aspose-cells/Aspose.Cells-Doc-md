---
title: Python でファイルを開く
type: docs
weight: 10
url: /ja/java/opening-files-in-python/
---
## **Aspose.Cells - Python でファイルを開く**
Python で Aspose.Cells Java を使用してファイルを開くには、Document クラスの openfile() メソッドを呼び出し、最後に追加する 2 番目のドキュメントを指定するだけです。
