---
title: xlsx4j のスプレッドシートに画像を追加する
type: docs
weight: 20
url: /ja/java/add-images-in-spreadsheet-in-xlsx4j/
---
## **Aspose.Cells - スプレッドシートに画像を追加する**
...
{{< /highlight >}}
## **xlsx4j - スプレッドシートに画像を追加する**
ワークシート内の画像を扱うための描画クラスが利用可能
