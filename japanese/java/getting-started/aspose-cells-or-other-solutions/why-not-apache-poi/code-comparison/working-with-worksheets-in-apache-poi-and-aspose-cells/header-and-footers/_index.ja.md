...
---
## **Aspose.Cells - ヘッダーとフッター**
PageSetup クラスは、ワークシートにヘッダーを追加するための setHeader メソッドと、フッターを追加するための setFooter メソッドを提供します。スクリプトは、上記のすべてのメソッドの引数として使用されます。ヘッダーまたはフッターに使用されるスクリプトを表します。
...
{{< /highlight >}}
## **Apache POI SS - HSSF XSSF - ヘッダーとフッター**
ヘッダー クラスは、スプレッドシートのヘッダーを調整するために使用できます。
...
詳細については、次を参照してください。[ヘッダーとフッターの設定](/java/setting-headers-and-footers).
