...
description: 純粋な Java ライブラリである Aspose.Cells for Java を使用して ODS ファイルをパスワードで保護し、暗号化します。
---
{{% alert color="primary" %}}
