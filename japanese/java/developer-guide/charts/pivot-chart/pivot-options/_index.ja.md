...
type: docs
weight: 10
url: /ja/java/how-to-manage-pivotchart-with-pivotoptions/
...
Aspose.Cellsを使用すると、PivotChartを管理するために[**PivotOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotoptions/)を使用できます。
