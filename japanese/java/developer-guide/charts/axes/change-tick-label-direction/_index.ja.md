...
type: docs
weight: 90
url: /ja/java/change-tick-label-direction/
---

## **目盛りラベル方向の変更**

Aspose.Cellsは、[**TickLabels.DirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ticklabels#DirectionType)プロパティを使用してチャートの目盛りラベル方向を変更する機能を提供します。[**TickLabels.DirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ticklabels#DirectionType)プロパティは、[**ChartTextDirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ChartTextDirectionType)列挙値を受け入れます。[**ChartTextDirectionType**](https://reference.aspose.com/cells/java/com.aspose.cells/ChartTextDirectionType)列挙は、以下のメンバーを提供します。
