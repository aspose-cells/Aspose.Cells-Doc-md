---
title: 日付軸
description: Aspose.Cells for Java で日付軸を管理する方法を学習します。このガイドは、さまざまな日付形式、タイム スケール、目盛りラベルの頻度を操作する方法を理解するのに役立ちます。
...
次に、チャートを追加し、チャートのタイプを設定します。[**軸**](https://reference.aspose.com/cells/java/com.aspose.cells/axis/) 
に[**タイムスケール**](https://reference.aspose.com/cells/java/com.aspose.cells/categorytype/#TIME-SCALE)次に、基本単位を「日」に設定します。

![todo:image_alt_text](excel.png)

次のサンプル コードは、[Excelファイルを出力](DateAxis.xlsx).
