...
type: docs
weight: 30
url: /ja/java/xml-paper-specification-xps/
---
...
| :- | :- |
## **Aspose.CellsのXPS**
Aspose.Cellsにロードされた任意のドキュメントをXPSに変換できます。

Aspose.Cellsは、すべてのサポートされる固定レイアウト形式（PDF、XPSなど）で出力するために同じ高度なページレイアウトとレンダリングエンジンを使用しています。

以下の画像は、Aspose.CellsがXLSからXPSにドキュメントを変換した際の高い再現度を示しています。
