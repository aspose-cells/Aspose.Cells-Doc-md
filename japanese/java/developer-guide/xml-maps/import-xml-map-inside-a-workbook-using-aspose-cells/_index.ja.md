---
title: Aspose.Cellsを使用してワークブックにXML Mapをインポートする
type: docs
weight: 40
url: /ja/java/import-xml-map-inside-a-workbook-using-aspose-cells/
---
...
インポートを完了するには、XMLデータを提供する必要があります。こちらの[サンプルXMLデータ](5472501.txt)を使用してテストできます。
