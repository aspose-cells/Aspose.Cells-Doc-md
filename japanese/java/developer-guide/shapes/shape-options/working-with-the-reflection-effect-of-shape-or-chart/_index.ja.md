...
type: docs
weight: 930
url: /ja/java/working-with-the-reflection-effect-of-shape-or-chart/
---

## **可能な使用シナリオ**
Aspose.Cellsは、図形やグラフの反射効果を操作するための[Shape.ReflectionEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#Reflection)プロパティを提供します。これには、異なる結果を得るために設定できる次のサブプロパティが含まれています。
...
以下のスクリーンショットは、Shapeの*反射効果*の設定を示しています。
