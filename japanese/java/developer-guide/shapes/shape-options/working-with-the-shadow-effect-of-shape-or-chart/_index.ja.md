...
type: docs
weight: 940
url: /ja/java/working-with-the-shadow-effect-of-shape-or-chart/
---

## **可能な使用シナリオ**
Aspose.Cellsは、図形やグラフの影効果を操作するための[Shape.ShadowEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#ShadowEffect)プロパティを提供します。これには、異なる結果を得るために設定できる次のサブプロパティが含まれています。
...
以下のスクリーンショットは、Shapeの*影効果*の設定を示しています。
