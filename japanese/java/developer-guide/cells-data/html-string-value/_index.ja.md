...
次のスクリーンショットは、Aspose.Cells で生成された出力 Excel ファイルを示しています。[**Cell.setHtmlString()**](https://reference.aspose.com/cells/java/com.aspose.cells/cell#HtmlString)財産。

![todo:画像_代替_文章](adding-html-rich-text-inside-the-cell_1.png)

これは、上記のスクリーンショット内に示されている出力 Excel ファイルを生成したサンプル コードです。
