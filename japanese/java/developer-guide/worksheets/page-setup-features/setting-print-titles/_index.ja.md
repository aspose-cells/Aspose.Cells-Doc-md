...
type: docs
weight: 200
url: /ja/java/how-to-set-print-titles/
description: この資料は、Aspose.Cellsライブラリを使用して印刷タイトルを設定するコード例を紹介しています。
keywords: 繰り返し印刷する行と列の設定方法、Javaでの印刷タイトルの設定とクリア、印刷タイトルの追加と削除の方法、Excelでの印刷タイトルの設定とクリアについてです。
---
...
指定したシートにプリントタイトルを設定するには、まず[サンプルファイル](input.xlsx)を読み込み、次に望むシートの[**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/)オブジェクトの[**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-)と[**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-)のプロパティを変更します。これらのプロパティに範囲文字列を設定するとプリントタイトルが設定されます。
