...
## **可能な使用シナリオ**
Microsoft Excelでスライサーを更新したい場合は、そのアイテムを選択または選択解除すると、それに応じてスライサーテーブルまたはピボットテーブルが更新されます。Aspose.Cellsを使用してこれを行うには、[Slicer.SlicerCache.SlicerCacheItems](https://reference.aspose.com/cells/java/com.aspose.cells/slicercache#SlicerCacheItems)を使用してスライサーアイテムを選択または選択解除し、[Slicer.refresh()](https://reference.aspose.com/cells/java/com.aspose.cells/slicer#refresh())メソッドを呼び出してスライサーテーブルまたはピボットテーブルを更新してください。 
## **スライサーを更新する**
