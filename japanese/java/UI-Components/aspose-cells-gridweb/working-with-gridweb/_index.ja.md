...
|ColumnDeleting|クライアント側のメニューを使用して、ワークシートから列を削除しようとしたときに発生します。
|ColumnDoubleClick|：列ヘッダーをダブルクリックしたときに発生します。|
|ColumnInserted|：クライアント側メニューを使用してワークシートに列を挿入したときに発生します。|
|CustomCommand|：ユーザーがカスタムコマンドボタンをクリックしたときに発生します。|
|LoadCustomData|：コントロールの EnableSession プロパティが false に設定されている場合で、ワークシートデータをロードする必要があるときに発生します。このイベントはセッションレスモードでファイルまたはデータベースからワークシートデータをロードするためにハンドルできます。|
|PageIndexChanged|：コントロールのシートページインデックスが変更されたときに発生します。|
|RowDeleted|：ユーザーがクライアント側メニューを使用してワークシートから行を削除したときに発生します。
|RowDeleting|クライアント側のメニューを使用してワークシートから行を削除しようとしたときに発生します。|
|RowDoubleClick|行ヘッダーをダブルクリックしたときに発生します。|
