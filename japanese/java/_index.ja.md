...
url: /ja/java/
is_root: true
description: Aspose.Cells for Java は、Excel ファイルの作成、更新、保存をサポートするクラス ライブラリです。また、Aspose.Cells for Java は、ファイルを PDF、DOCX、PPTX、JSON、XPS、HTML、MHTML、プレーン テキスト、および TIFF, JPG, PNG, BMP and SVG を含む一般的な画像形式に変換することもサポートしています。
---
{{% alert color="primary" %}}
...
**Aspose.Cells for Java へようこそ**
 ...
 Aspose.Cells for Java は、ソフトウェア開発者が独自のアプリケーション内でスプレッドシート ファイルを操作および処理できるようにするプログラミング クラス ライブラリです。

Aspose.Cells for Java を API および GUI コントロールと組み合わせると、Microsoft Excel® のプログラミングと変換が高速化されます。

Aspose.Cells for Java は、ビジネスで毎日使用する一般的なスプレッドシート (XLS, XLSX, XLSM, XLSB, XLTX, XLTM, CSV, SpreadsheetML, ODS) ファイル形式をサポートしています。また、Excel ファイルを PDF, DOCX, PPTX, JSON, XPS, HTML, MHTML、プレーン テキスト、および TIFF, JPG, PNG, BMP and SVG を含む一般的な画像形式にエクスポートすることもできます。
