...
|[Numbers](https://docs.fileformat.com/spreadsheet/numbers/)|このドキュメントは、Apple の「Numbers」アプリケーションによって作成されます。このアプリケーションは、Apple の iWork オフィス スイートの一部であり、Mac OS X および iOS オペレーティング システムで実行される一連のアプリケーションです。|{{< emoticons/tick >}}||
