...
linktitle: なぜNPOIを選択しないのか
description: 「C#を使用して、NPOIよりも迅速かつ便利にExcelファイルで多数のタスクを実行します。」
type: docs
weight: 40
...
**HSSF**は、Excel 97(-2007)ファイル形式のPOIプロジェクトの純粋なJava実装です。
...
[NPOIとの比較でAspose.Cells for .NETの機能をソースコード例とともに探索](https://github.com/aspose-cells/Aspose.Cells-for-.NET/tree/master/Plugins/NPOI)してください。
...
Aspose コンポーネントは、多くの強力な時間短縮機能を提供します。例えば、[Aspose.Cells](https://products.aspose.com/cells/net/) では、JSON を Excel ファイルにインポートする機能があります。Aspose ファミリーの各コンポーネントが固有の強力な機能を持っていることに留意する価値があります。
