...
Workbook オブジェクト内に Excel ファイルをロードするときに、ピボット キャッシュのレコードもロードするかどうかを決定できます。[**LoadOptions.ParsingPivotCachedRecords**](https://reference.aspose.com/cells/net/aspose.cells/loadoptions/properties/parsingpivotcachedrecords)財産。このプロパティのデフォルト値は**間違い**.ピボット キャッシュが非常に大きい場合は、パフォーマンスが向上する可能性があります。ただし、Pivot Cache のレコードもロードする場合は、このプロパティを次のように設定する必要があります。**真実**.

## **Excel ファイルの読み込み中にピボット キャッシュ レコードを解析する**

次のサンプル コードは、[**LoadOptions.ParsingPivotCachedRecords**](https://reference.aspose.com/cells/net/aspose.cells/loadoptions/properties/parsingpivotcachedrecords)財産。それは[サンプル Excel ファイル](61767773.xlsx)ピボット キャッシュ レコードの解析中。次に、ピボット テーブルを更新して、[出力エクセルファイル](61767774.xlsx).
