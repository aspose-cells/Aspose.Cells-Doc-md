...
type: docs
weight: 10
url: /ja/net/how-to-manage-pivotchart-with-pivotoptions/
...
Aspose.Cellsを使用すると、PivotChartを管理するために[**Aspose.Cells.Charts.PivotOptions**](https://reference.aspose.com/cells/net/aspose.cells.charts/pivotoptions/)を使用できます。
