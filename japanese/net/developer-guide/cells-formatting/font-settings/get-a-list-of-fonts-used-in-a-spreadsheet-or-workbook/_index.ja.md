...
description: Aspose.Cells は、スプレッドシートファイルを操作するための .NET ライブラリです。スプレッドシートやワークブックで使用されているフォントのリストを取得し、ドキュメントで使用されているフォント情報を取得することができます。この記事では、Aspose.Cells ライブラリを使用してフォントのリストを取得する方法について説明します。
...
Aspose.Cells では、ワークブックやスプレッドシートで使用されているフォントのリストを返す [**Workbook.GetFonts**](https://reference.aspose.com/cells/net/aspose.cells/workbook/methods/getfonts) メソッドが提供されています。
