...
type: docs
weight: 40
url: /ja/net/using-sparklines-and-settings-3d-format/
---
## **スパークラインの使用**
...
開発者は、Aspose.Cells によって提供される API を使用して、(テンプレート ファイル内の) スパークラインを作成、削除、または読み取ることができます。スパークラインを管理するクラスは、[Aspose.Cells.Charts](https://reference.aspose.com/cells/net/aspose.cells.charts)これらの機能を使用する前に、この名前空間をインポートする必要があります。
