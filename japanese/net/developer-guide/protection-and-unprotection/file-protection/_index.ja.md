...
description: C# を使用して Excel ファイルを暗号化および復号化する方法。Excel ファイルのロックとロック解除。
---
{{% alert color="primary" %}}
...
## **先行トピック**
- [ODS ファイルの暗号化と復号化](/cells/ja/net/encrypt-and-decrypt-ods-files/)
- [強力な暗号化タイプの設定](/cells/ja/net/setting-strong-encryption-type/)
- [ワークブックの書き込み保護中に作成者を指定する](/cells/ja/net/specify-author-while-write-protecting-workbook/)
- [暗号化ファイルのパスワードを確認する](/cells/ja/net/verify-password-of-encrypted-excel-and-ods-files/)
