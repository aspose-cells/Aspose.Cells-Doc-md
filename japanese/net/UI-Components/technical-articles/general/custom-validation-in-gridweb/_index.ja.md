---
title: GridWeb でのカスタム検証
type: docs
weight: 90
url: /ja/net/custom-validation-in-gridweb/
keywords: validation,custom,server
---
##  **考えられる使用シナリオ**
Aspose.Cells.GridWeb は、セル検証 API で定義されている通常の検証とは異なる種類の検証を提供します。
セル内の通常の検証タイプ:<https://docs.aspose.com/cells/net/data-validation/>

 GridWeb デモでの通常の検証の使用法:<https://github.com/aspose-cells/Aspose.Cells-for-.NET/blob/master/Examples_GridWeb/GridWeb.Net4/CSharp/Miscellaneous/Common/DataValidation.aspx.cs>

ここで GridValidationType を確認できます。<https://reference.aspose.com/cells/net/aspose.cells.gridweb.data/gridvalidationtype/>

以下は GridWeb で使用できる拡張検証です。
...
結果：
![todo:検証結果](gridvalidation_dropdownlist.png) 
...
結果：
![todo:検証結果](gridvalidation_freelist.png)  
...
結果：
無効な値を入力した後
![todo:検証結果](gridvalidation_customexpression.png)  
...
結果：
無効な値を入力した後
![todo:検証結果](gridvalidation_bool.png)  

真の値を入力した後
![todo:検証結果](gridvalidation_bool2.png)  
...
結果：
![todo:検証結果](gridvalidation_datetime.png)  
...
結果：
![todo:検証結果](gridvalidation_checkbox.png)  
...
結果: d4 に無効な値を入力した後
![todo:検証結果](gridvalidation_customfunction.png)  
...
```
結果: g6 に値を入力した後
![todo:検証結果](gridvalidation_customserverfunction.png) 
