...
type: docs
weight: 60
url: /ja/net/aspose-cells-for-net-7-2-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.2.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.2.2/)
...
-PDFチャートへのエクスポートはExcel版とは異なります

- PDF チャートへのエクスポートは Excel バージョン -2 とは異なります
