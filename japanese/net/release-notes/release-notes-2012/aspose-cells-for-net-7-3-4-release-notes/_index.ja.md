...
type: docs
weight: 10
url: /ja/net/aspose-cells-for-net-7-3-4-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.3.4](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.3.4/)
...
- このファイルは保存後に破損しています
 ...
 XLS を XLSX に変換して戻すと、不適切な XLS ファイルが作成される

-XLS を XLSX に変換すると、不適切なドキュメントが作成される
