...
type: docs
weight: 70
url: /ja/net/aspose-cells-for-net-7-2-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.2.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.2.1/)
...
- PDF に変換した後、図形の線が正しくファイリングされない
- XLSM ファイルを XLS 形式で保存した後、マクロが消えた
- リスト ボックスのオプションが互いに重なっています
- Aspose.Cells Workbook.Save() メソッドの呼び出し後に XLSM ファイルが破損する
...
- SharePoint から XLSX スプレッドシートをロード中に例外が発生する
...
-Aspose.Cells 保存を 2 回呼び出した後に XLSM ファイルが破損する
...
- XLSM ファイルを新しいワークブックに保存した後にシェイプ名が変更された
