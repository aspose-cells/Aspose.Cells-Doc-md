...
type: docs
weight: 110
url: /ja/net/aspose-cells-for-net-7-1-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.1.0/)
...
- XLS ファイルで MS Excel 2007 がクラッシュする
- Ms Excel を使用してファイルを開くときにエラーが発生しました
- 新しい Aspose.Cells DLL (バージョン) での HTML 出力の問題

 ピボット テーブルを使用して XLSX ファイルを更新すると、Excel でエラーが表示される

-生成された画像に余分な列を生成する ToImage 関数 (Sheet-to-Imageissue)

- 複数の色のテーブルを含む Excel 2007 ブックが、変換された PDF ファイルに表示されない
