...
type: docs
weight: 20
url: /ja/net/aspose-cells-for-net-7-3-3-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.3.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.3.3/)
...
- 一部の条件付き書式が正しく表示されない
- サイズの異なるフォントが混在する PDF でテキストの位置が正しくない
- Excel ファイルから PDF にエクスポートすると数式が変更される
