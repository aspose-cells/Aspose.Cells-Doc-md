...
type: docs
weight: 10
url: /ja/net/aspose-cells-for-net-v4-8-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET v4.8.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.8.0/)
...
|8749 |Chart2Image|グラフが Excel PDF に表示されない|
...
|8678 | PDF|Cells PDFへ、フッター画像がぼやける|
|8749 | PDF|グラフが Excel PDF に表示されない|
|8986 | PDF|Excel から PDF への変換|
|8988 | PDF|ワークブックを破損した PDF として保存する|
