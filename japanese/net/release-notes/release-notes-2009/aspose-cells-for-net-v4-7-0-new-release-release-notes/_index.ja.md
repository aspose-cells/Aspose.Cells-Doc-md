...
type: docs
weight: 40
url: /ja/net/aspose-cells-for-net-v4-7-0-new-release-release-notes/
---
{{% alert color="primary" %}}

このページには、[Aspose.Cells for .Net V4.7.0 新規リリース](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.7.0-new-release/)
...
- Excel ファイルから PDF への直接変換をサポートします。
...
|7507 |XLS|一部の特殊な XLS ファイルを開く際のバグ|
...
|6856 |XLSX| XLSX を XLS に変換した後、OleObject を開くことができなかったバグ|
