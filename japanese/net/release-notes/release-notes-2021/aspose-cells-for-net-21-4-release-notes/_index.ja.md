...
type: docs
weight: 9
url: /ja/net/aspose-cells-for-net-21-4-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47922|Excel から HTML への変換でセル座標を使用してデータをレンダリングする|強化|
...
|CELLSNET-47916|HTML スタイルのタグが 4 GB のメモリを消費し、ワークブックへの読み込み中にクラッシュする|パフォーマンス|
|CELLSNET-46869|ワードアートと図形が PDF で正しくレンダリングされない|バグ|
|CELLSNET-47890|Pdf 変換中に行がずれる|バグ|
|CELLSNET-47858|HTML および PDF で形状が正しくレンダリングされない|バグ|
|CELLSNET-47907|Excel から HTML への変換中にチャートの配置が変更される|バグ|
...
|CELLSNET-46161|出力 PDF で斜体テキストが正しく表示されない|バグ|
|CELLSNET-47917|Excel ワークシートから生成された PDF で円グラフのラベルがめちゃくちゃになる|バグ|
...
|CELLSNET-47963|範囲を PNG にレンダリングするときのパラメーターは有効な例外ではありません|例外|
