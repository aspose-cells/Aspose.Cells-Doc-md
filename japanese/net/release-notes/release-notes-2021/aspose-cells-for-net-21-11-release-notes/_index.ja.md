...
type: docs
weight: 2
url: /ja/net/aspose-cells-for-net-21-11-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-48646|Excel から PDF への変換中の StackOverflow 例外|パフォーマンス|
|CELLSNET-49378|Excel から HTML への変換パフォーマンスと空のセルに関する問題|パフォーマンス|
...
|CELLSNET-49068|Excel ファイルから生成された間違った PDF|バグ|
...
|CELLSNET-49498|HTML ストリームから Excel への最新バージョンで例外が発生する|バグ|
|CELLSNET-49610|Xml インポートでテンプレートの書式が失われる|バグ|
|CELLSNET-49671|Windings フォントのテキストが画像/HTML に正しくレンダリングされない|バグ|
|CELLSNETCORE-278|カルチャがノルウェー語に設定されている場合、XLSX から PDF への変換結果を開くことができない|バグ|
...
|CELLSNET-49697|XLSX から PDF: 入力文字列の形式が正しくありませんでした。|例外|
