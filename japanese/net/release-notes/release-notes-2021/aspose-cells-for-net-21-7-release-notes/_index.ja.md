---
title: Aspose.Cells for .NET 21.7 リリースノート
type: docs
weight: 6
url: /ja/net/aspose-cells-for-net-21-7-release-notes/
---
{{% alert color="primary" %}}

このページには、[Aspose.Cells for .NET 21.7](https://www.nuget.org/packages/Aspose.Cells/21.7.0).
...
|CELLSNET-45640|MS Excel とまったく同じようにセル コメント (リッチ テキスト) を表示する|強化|
|CELLSNET-47233|GridWebのパターン表示に対応|強化|
|CELLSNET-40295|プリンターへのワークブックのレンダリング|強化|
|CELLSNET-46642|Excel ファイルから PDF を作成する際に WCAG 2.0 をサポート|強化|
|CELLSNET-48175|フォントを表示できない場合のテキストの長さの測定を改善|強化|
...
|CELLSNET-46717|Chart.ToImageの問題|バグ|
...
|CELLSNET-48162|シェイプからイメージへの変換に失敗しました|例外|
|CELLSNET-48238|Docker環境で例外を発生させる形状から画像へ|例外|
|CELLSNET-48199|「HtmlLoadOptions.AutoFitColsAndRows = true」を使用せずに HTML ファイルをロード中に例外が発生しました|例外|
|CELLSNET-48200|OperatorType 文字列値が無効です|例外|
...
### **SeriesCollection.Add(System.String,System.Boolean,System.Boolean) メソッドを追加します。**
