...
type: docs
weight: 20
url: /ja/net/aspose-cells-for-net-5-1-4-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 5.1.4](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.4/)
...
|**問題ID** |**成分** |**概要** |
|:- |:- |:- |
|20247 |ODS| ODS として保存するときの式のエラー|
|18357 | PDF|PIE グラフの変換の問題|
|18925 | PDF|問題 Excel から PDF への変換|
...
|20590 | PDF|PDF への変換後に一部のセルのテキストが切り捨てられる|
...
|20181 |スプレッドシートML|ハイパーリンク機能を使用するセルが例外をスローする|
|20519 |スプレッドシートML|Excel 2007 コンテンツを XML として取得できませんでした|
