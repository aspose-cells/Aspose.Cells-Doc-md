...
type: docs
weight: 40
url: /ja/net/aspose-cells-for-net-5-1-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 5.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.2/)
...
|19065 | PDF|Aspose.Cells で PDF に変換 テキストを縮小|
|19024 | PDF|生成された PDF のルック アンド フィールが Excel と異なる|
|19170 | PDF|PDF に名前を付けて保存の問題 - 破損した PDF|
