...
type: docs
weight: 70
url: /ja/net/aspose-cells-for-net-5-0-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 5.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.0.0/)
...
- MS Excel 2007 XLSB ファイル形式のサポートが含まれています。
