...
type: docs
weight: 60
url: /ja/net/aspose-cells-for-net-5-1-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 5.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.0/)
...
生成された PDF ファイルに Cell のパターン塗りつぶしをレンダリングします。
...
|18258 | PDF|Cells から PDF への変換時に計算式が更新されない|
|18316 | PDF|データが数字記号として表示される変換の問題|
|18239 |スプレッドシートML|無効な終了列インデックスの例外|
...
|18004 | xlsx|小計の問題|
|18036 | xlsx|XLSM ファイルを開く際の問題。|
|18161 | xlsx| XLSX ファイルでの無効な終了列インデックスの例外|
