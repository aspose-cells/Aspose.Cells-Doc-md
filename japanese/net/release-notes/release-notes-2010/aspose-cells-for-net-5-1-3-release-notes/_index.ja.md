...
type: docs
weight: 30
url: /ja/net/aspose-cells-for-net-5-1-3-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 5.1.3](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.3/)
...
|19721 |HTML|Excel ドキュメントを HTML として保存すると、非常に時間がかかります|
|17485 | PDF|ロゴがない、ぼやけている、テキストが薄い|
|18114 | PDF|PDF 変換の問題|
|19237 | PDF|Excelからの印刷とPDFへの出力の違い|
|19392 | PDF|PDF変換で画像幅が縮む|
...
|19430 |ピボットテーブル|2003 ピボットテーブルが破損した XLS|
|19542 |ピボットテーブル| DataBordyRange が正しい領域を返さない|
|19852 |ピボットテーブル|ピボット テーブルは XLSX ファイルではエラーを引き起こしますが、XLS では問題なく動作します|
|19942 | SpreadML|名前空間属性に関する SpreadsheetML ドキュメントを開く際の問題|
