...
type: docs
weight: 90
url: /ja/net/aspose-cells-for-net-8-4-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 8.4.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.4.1/)
...
(CELLSNET-43545) - レンダリングされた PDF ファイル形式で日付が左フッターのテキストと重なっている
...
(CELLSNET-43492) - Workbook.CalculateFormula が Excel とは異なる結果を返す
