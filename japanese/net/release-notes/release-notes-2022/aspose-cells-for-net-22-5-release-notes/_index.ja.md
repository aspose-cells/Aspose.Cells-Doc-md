...
type: docs
weight: 8
url: /ja/net/aspose-cells-for-net-22-5-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-50685|ODS ファイルでリンクされた OLE 添付ファイルを取得する際の問題|
...
|CELLSNET-50960|XLSM ファイル (ピボット テーブルを含む) を再保存するとワークブックが破損する (Aspose.Cells)|
...
|CELLSNET-50992|ODS に保存した後、カスタム ドキュメント プロパティの日時の値が変更されました|
...
|CELLSNET-50951|Excel を HTML の結果に変換すると問題が発生する|
...
|CELLSNET-50952|XLS から XLSX への変換は、条件付き書式の 2 色グラデーションを変更します|
