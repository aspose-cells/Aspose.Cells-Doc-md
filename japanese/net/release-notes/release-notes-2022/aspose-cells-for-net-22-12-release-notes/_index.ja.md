...
type: docs
weight: 1
url: /ja/net/aspose-cells-for-net-22-12-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47895|Excel から PDF/HTML へのレンダリングで画像が歪む|
...
|CELLSNET-52330|HTML でうまくレンダリングされない形状の描画|
...
|CELLSNET-52367|AutofitRows により、PDF 変換出力でテキストが切り取られる|
|CELLSNET-52242|Excel から JSON へ、またはその逆の変換中に親子階層が正しくない|
...
|CELLSNET-52332|html への変換中に数値が「#」または科学数として表示される|
