...
type: docs
weight: 120
url: /ja/net/aspose-cells-for-net-17-1-0-release-notes/
---
|**鍵**|**概要**|**カテゴリー**|
|:- |:- |:- |
|CELLSNET-44747|ウォーターフォール チャートを含む MS Excel 2016 XLSX ファイルを Aspose.Cells API 経由で開くことができない|新機能|
...
|CELLSNET-44994|Excel ファイルを PDF にレンダリングする際のドイツ語ロケールの日付形式に関する問題|強化|
...
|CELLSNET-45000|HTML のインポート時に一部の CSS ルールが無視される|バグ|
...
|CELLSNET-43815|出力 PDF でワードアート オブジェクトが単なるドットになる|バグ|
|CELLSNET-44976|MS Excel ファイルとは異なり、PDF 出力で面グラフが最後に傾く|バグ|
...
|CELLSNET-44919|Aspose.Cells によって生成された画像を Docx に挿入すると歪む|バグ|
...
|CELLSNET-45027|XLSX を ODS に変換する際に、セルの点線が保持されない|バグ|
...
|CELLSNET-43733|スプレッドシートを PDF に変換するときに、TextBox のワードアート テキストが塗りつぶされた文字ではなくアウトラインのみとしてレンダリングされる|バグ|
|CELLSNET-43725|外部データ範囲を使用して XLSM で ListObject のサイズを変更すると、結果が破損する|バグ|
|CELLSNET-43580|出力 PDF で色/スタイルが変更されるため、このワードアートの透かしは正しく印刷されません。|バグ|
|CELLSNET-43562|XLSX が ODS に変換されると、列のフィルタリングが失われる|バグ|
|CELLSNET-43405|XLS を XLSX ファイル形式に変換すると、関数のテキストが破損し、ワードアートのテキストが白くなる|バグ|
|CELLSNET-43404|XLSX ファイル形式に変換すると、XLS ファイルのワードアート テキストの書式が変更される|バグ|
|CELLSNET-41938|XLS ファイルの書式設定の問題 (ワードアートに関する)|バグ|
