...
type: docs
weight: 60
url: /ja/net/aspose-cells-for-net-17-7-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 17.7](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.7/).
...
図形のテキストを置き換えます。
#### **Cells.importResultSet(ResultSet rs, int rowIndex, int columnIndex, ImportTableOptions options)/Cells.importResultSet(ResultSet rs, String startCell, ImportTableOptions options) を追加 (for Java のみ)**
...
- [ワークシートの用紙サイズが自動かどうかを判断する](/cells/ja/net/determine-if-paper-size-of-worksheet-is-automatic/)
- [GridDesktop でピボットテーブルをレンダリングする](/cells/ja/net/render-pivottable-in-griddesktop/)
- [GridDesktop ワークシートのカスタム行とカスタム列のキャプション](/cells/ja/net/custom-row-and-custom-column-caption-of-griddesktop-worksheet/)
- [実行時に GridDesktop のバージョンを見つける](/cells/ja/net/find-griddesktop-version-at-runtime/)
- [ブラウザ ウィンドウで GridWeb のサイズを変更する](/cells/ja/net/resize-gridweb-in-the-browser-window/)
