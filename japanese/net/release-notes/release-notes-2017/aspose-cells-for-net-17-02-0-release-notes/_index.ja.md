---
title: Aspose.Cells for .NET 17.02.0 リリースノート
type: docs
weight: 110
url: /ja/net/aspose-cells-for-net-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 17.02.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.02.0/).

{{% /alert %}} 

|**鍵**|**概要**|**カテゴリー**|
|:- |:- |:- |
|CELLSNET-45049|スプレッドシートを CSV 形式にエクスポートする際に空白の行と列をトリミングする|新機能|
...
1. [ワークブックに HTML をロードする際の列と行の自動調整](/cells/ja/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Aspose.Cells を使用してテキストを列に変換します](/cells/ja/net/convert-text-to-columns-using-aspose-cells/)
1. [スプレッドシートまたはワークブックで使用されているフォントのリストを取得する](/cells/ja/net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Excel ファイルの読み込み中に警告を受け取る](/cells/ja/net/get-warnings-while-loading-excel-file/)
1. [Excel 2016 グラフの読み取りと操作](/cells/ja/net/read-and-manipulate-excel-2016-charts/)
1. [スプレッドシートを CSV 形式にエクスポートする際に、先頭の空白の行と列をトリミングする](/cells/ja/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
1. [GridWeb を使用してワークシートをカスタマイズされたコレクション オブジェクトにバインドする](/cells/ja/net/binding-worksheet-to-a-customized-collection-object-using-gridweb/)
1. [ワークシート データのエクスポート中に重複する列の名前を自動的に変更する](/cells/ja/net/rename-duplicate-columns-automatically-while-exporting-worksheet-data/)
1. [GridDesktop ワークシートでペインを分割する](/cells/ja/net/split-panes-in-griddesktop-worksheet/)
