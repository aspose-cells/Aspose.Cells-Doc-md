...
type: docs
weight: 50
url: /ja/net/aspose-cells-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 17.8](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.8/).
...
|CELLSNET-45560 |RemoveMacro() メソッドを呼び出した後、Microsoft Excel にエラー メッセージが表示される|バグ|
...
- [GridDesktop のデフォルトのフォントとフォントの色](/cells/ja/net/default-font-and-font-color-of-the-griddesktop/)
