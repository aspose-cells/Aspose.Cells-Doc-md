...
type: docs
weight: 10
url: /ja/net/aspose-cells-for-net-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [Excel VBA Range.FormulaLocal と同様の Cell.FormulaLocal を実装します。](/cells/ja/net/implement-cell-formulalocal-similar-to-excel-vba-range-formulalocal/)
...
- [グラフのデータ ラベルの形状タイプを設定する](/cells/ja/net/set-the-shape-type-of-data-labels-of-chart/)
- [テキストが長すぎると GridDesktop セルからはみ出す](/cells/ja/net/text-overflows-from-griddesktop-cell-if-it-is-too-long/)
- [共有ワークブックのリビジョン ログの履歴を保持する更新日数](/cells/ja/net/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
