...
type: docs
weight: 20
url: /ja/net/aspose-cells-for-net-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
- [Smart Art をグループ シェイプに変換する](/cells/ja/net/convert-the-smart-art-to-group-shape/)
- [Aspose.Cells で共有ワークブックを作成](/cells/ja/net/create-shared-workbook-with-aspose-cells/)
- [シェイプがスマート アート シェイプかどうかを判断する](/cells/ja/net/determine-if-shape-is-smart-art-shape/)
...
- [共有ワークブックをパスワードで保護または保護解除する](/cells/ja/net/password-protect-or-unprotect-the-shared-workbook/)
- [Worksheet.XmlMapQuery メソッドを使用して Xml マップ パスにマップされた Cell 領域のクエリ](/cells/ja/net/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
...
- [EnableClipboardCopyPaste および PasteType GridDesktop プロパティのコピー貼り付け動作](/cells/ja/net/copy-paste-behavior-of-enableclipboardcopypaste-and-pastetype-griddesktop-properties/)
