...
|CELLSNET-46209|XLS ファイルの DConn の読み書きをサポート|新機能|
...
|CELLSNET-46263|XLS を PDF に変換中にアプリケーションがハングする|パフォーマンス|
|CELLSNET-46262|Cell 出力でセルのテキストの向きが傾いていると背景が正しくない PDF|バグ|
|CELLSNET-44761|PDF でシェイプ内のテキストが正しくレンダリングされない|バグ|
|CELLSNET-43916|スプレッドシートを HTML に変換中にシェイプの影が表示されない|バグ|
|CELLSNET-46251|XLSX を HTML に変換中にアプリケーションがハングする|バグ|
|CELLSNET-46241|HTML の複数行の問題|バグ|
|CELLSNET-46219|HTML から XLSX への変換中に、HTML タグからの幅が追跡されない|バグ|
...
|CELLSNET-46275|大 XLS から作成 PDF|バグ|
