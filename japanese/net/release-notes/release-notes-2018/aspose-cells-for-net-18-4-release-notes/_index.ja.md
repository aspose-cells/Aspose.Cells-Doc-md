...
|CELLSNET-46032|Excel ファイルが空の場合、単一ページの空白 PDF を生成しない|強化|
...
|CELLSNET-46005|出力 PDF ファイル形式で異なるシートの書き込みが逆になる|バグ|
|CELLSNET-45958|XLSX を HTML として保存する際のフォーマットが正しくない|バグ|
...
|CELLSNET-45990|PDF 最適化タイプによって出力が異なります|バグ|
