...
type: docs
weight: 40
url: /ja/net/aspose-cells-for-net-18-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46308|カスタム ドキュメント プロパティを PDF にエクスポート|新機能|
|CELLSNET-46301|リスト オブジェクト/テーブルから XML パスを取得する|新機能|
|CELLSNET-46315|ODS ファイルでの株価チャートのサポート|新機能|
...
|CELLSNET-46290|Excel から PDF への変換で、図形に間違った色がレンダリングされる|バグ|
|CELLSNET-46282|PDFでレンダリングされた非常に小さな画像|バグ|
...
|CELLSNET-46327|SVG に変換されたときの名前付き範囲、正確なフォントと間隔をキャプチャしない|バグ|
...
|CELLSNET-46305|PDF でレンダリングされたテキストの印刷外領域|バグ|
|CELLSNET-46296|グループ化された図形を乱す列または行を自動調整する|バグ|
|CELLSNET-46292|XMLファイルの違い|バグ|
|CELLSNET-46283|ODS Excel 出力に境界線がありません|バグ|
