...
type: docs
weight: 130
url: /ja/net/aspose-cells-for-net-8-7-1-release-notes/
---
### **その他の改善と変更**
...
|CELLSNET-44187 |Cell HTML に変換すると、値が誤って # に置き換えられる|バグ|
...
|CELLSNET-44218 |XLSX を再保存すると、xl\embeddings\oleObject1.bin ファイルの名前が変更されます|バグ|
...
|CELLSNET-44226 |ODS 形式で保存中に Workbook.Save で System.ArgumentException|例外|
