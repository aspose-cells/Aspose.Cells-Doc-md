...
type: docs
weight: 90
url: /ja/net/aspose-cells-for-net-8-8-2-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44476 |HTMLファイル形式で保存する場合、テキストの方向は無視されます|バグ|
|CELLSNET-44457 |HTML ファイルに変換すると、テーブルの下枠が失われる|バグ|
|CELLSNET-44446 |HTML として保存するときに、すべての CSS スタイルにプレフィックスが付けられない|バグ|
|CELLSNET-44444 |ピボット テーブルを含むファイルを開いて保存すると、スプレッドシートが破損する|バグ|
|CELLSNET-44443 |PDF へのピボット グラフ - セカンダリ y 軸が台無しになる|バグ|
|CELLSNET-44450 |結果の PDF で画像の回転が正しくない|バグ|
...
|CELLSNET-44463 |TextBox の黒いテキストが PDF で白くレンダリングされる|バグ|
