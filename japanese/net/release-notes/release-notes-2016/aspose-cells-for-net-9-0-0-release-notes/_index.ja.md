...
type: docs
weight: 40
url: /ja/net/aspose-cells-for-net-9-0-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44716 |PDF の結果がタイトル行の印刷で Excel と一致しない|バグ|
|CELLSNET-44713 |PDFの変換結果にデータが隠されている|バグ|
|CELLSNET-44675 |ワークシートの画像ファイルへのレンダリングが失敗する|バグ|
|CELLSNET-44717 |スプレッドシートから XPS: プロセスが完了せず、大量のメモリを消費する|バグ|
|CELLSNET-44678 |スプレッドシートを PDF/画像にレンダリングする際に、スパークラインが正しくレンダリングされない|バグ|
...
|CELLSNET-44658 |XLS ファイルを読み込んで保存すると、グラフの縦軸ラベルのテキスト サイズが変更されます。|バグ|
