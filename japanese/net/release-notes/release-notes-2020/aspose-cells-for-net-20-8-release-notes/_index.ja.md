---
title: Aspose.Cells for .NET 20.8 リリースノート
type: docs
weight: 9
url: /ja/net/aspose-cells-for-net-20-8-release-notes/
---
{{% alert color="primary" %}}

このページには、[Aspose.Cells for .NET 20.8](https://www.nuget.org/packages/Aspose.Cells/20.8.0).

{{% /alert %}}

|**鍵**|**概要**|**カテゴリー**|
|:- |:- |:- |
|CELLSNET-47524|Excel テーブルでのスライサーのサポート|新機能|
|CELLSNET-47512|GridWeb の直接フォント設定用クライアント API|新機能|
|CELLSNET-47513|GridWeb のハイパーリンクを追加/削除するためのクライアント API|新機能|
|CELLSNET-47514|GridWeb のワークシートの追加/削除をサポートする ShowAddButton プロパティを追加|新機能|
