...
type: docs
weight: 40
url: /ja/net/aspose-cells-for-net-20-4-release-notes/
---
{{% alert color="primary" %}} 
...
|**鍵**|**概要**|**カテゴリー**|
|:- |:- |:- |
|CELLSNET-47276|XLSX から CSV、空白のセルに必要なコンマも MS Excel に似ています|新機能|
...
|CELLSNET-47217|ODS のデータバー、カラー スケール、およびアイコンセットの条件付き書式設定をサポートします。|強化|
...
|CELLSNET-47261|Excel から HTML へのレンダリング - エクスポートされた表のフォント サイズが間違っている|バグ|
|CELLSNET-47279|ファイルを HTML にエクスポートするときに、すべての行の最初の列のテキストに下付き文字が付けられない|バグ|
...
|CELLSNET-47258|Sheet to TIFF レンダリングのバーコード イメージに関する問題|バグ|
|CELLSNET-47216|ソースの置き換え後に PowerQuery がなくなった|バグ|
|CELLSNET-47241|フォント スタイルの設定と保存中に ODS ファイルが壊れる|バグ|
...
|CELLSNET-47246|Excel ファイルを PDF に保存するときの例外「閉じたストリームにアクセスできません」|例外|
