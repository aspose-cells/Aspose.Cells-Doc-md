...
type: docs
weight: 90
url: /ja/net/aspose-cells-for-net-19-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46649|オンライン ツール iLovePDF と比較して生成される大きな PDF|強化|
...
|CELLSNET-46678|出力 XLSB で PivotField.IsRepeatItemLabels が維持されない|バグ|
|CELLSNET-46671|Range.CopyData 後の Range.Copy によってワークブックが破損する|バグ|
|CELLSNET-42423|PDF に保存すると、行データがトリミングされます|バグ|
|CELLSNET-45698|Worksheet.AutoFitColumns メソッドは、PDF へのレンダリング中に長いテキストを切り取ります|バグ|
...
|CELLSNET-46663|XLS から PDF への変換中に画像サイズが変更されました|バグ|
|CELLSNET-46667|PlotVisibleRows = true の場合、非表示の行がフェッチされます|バグ|
|CELLSNET-46668|XLSXをODSで保存すると点線が実線になります|バグ|
