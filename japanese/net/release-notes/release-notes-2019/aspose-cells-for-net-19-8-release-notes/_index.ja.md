...
type: docs
weight: 50
url: /ja/net/aspose-cells-for-net-19-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46835|Excel から PDF へのレンダリングで図形の描画が正しくレンダリングされない|バグ|
|CELLSNET-46848|Excel から PDF へのレンダリングでのアラビア語テキストの問題|バグ|
|CELLSNET-44973|ピボット テーブル セルの塗りつぶしの色を設定できません|バグ|
|CELLSNET-46818|HTML への保存時にすべてのスタイルがエクスポートされるわけではありません|バグ|
...
|CELLSNET-46858|XLSX から ODS への変換で教科書のテキスト フォントが変更される|バグ|
|CELLSNET-46859|XLSX から変換された ODS ファイルで印刷プレビューにテキストボックスが表示されない|バグ|
...
|CELLSNET-46814|XLSX から PDF への変換中に例外「インデックスが配列の範囲外でした」|例外|
...
|CELLSNET-46832|XLSX ファイル形式の読み込み時の例外「MsoLineDashStyle 文字列値が無効です」|例外|
