...
type: docs
weight: 80
url: /ja/net/aspose-cells-for-net-19-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46693|ODSのサポートの背景|新機能|
|CELLSNET-46695|ODS ファイルの背景を設定する|新機能|
...
|CELLSNET-46719|RGBA カラー モデルを使用して HTML 文字列を設定するときの例外|強化|
...
|CELLSNET-46704|Aspose.Cells を使用して Excel を PDF に変換した場合の出力が Excel と異なる|バグ|
|CELLSNET-46720|Excel から PDF への変換の最後のページでページ構造が壊れている|バグ|
|CELLSNET-46727|ワークブックを PDF として保存する際の間違ったページ番号付け|バグ|
|CELLSNET-46700|円グラフのデータ ラベルが重なり合う|バグ|
|CELLSNET-46696|Microsoft グラフ チャートを含む XLS を XLSX および XLSM に変換すると、読み取り不能コンテンツ エラーが発生する|バグ|
|CELLSNET-46697|OLE オブジェクトを含む XLSM を XLS に変換するとエラーが発生する|バグ|
|CELLSNET-46712|Microsoft グラフ チャートを含む XLS を XLSX および XLSM に変換すると、読み取り不能コンテンツ エラーが発生する|バグ|
