...
type: docs
weight: 20
url: /ja/net/aspose-cells-for-net-19-11-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46852|データ ソースが XLS ファイルのクエリ テーブルであるテーブルの読み取りと書き込みをサポートします。|新機能|
...
|CELLSNET-46905|XLS ファイルに保存されたリンク ソースの変更なし|強化|
...
|CELLSNET-46955|HTML から Excel ファイルへの変換で「アイテムは既に追加されています」という例外が発生する|バグ|
...
|CELLSNET-45362|XLS ファイルのチャート背景でタイル画像オプションが機能しない|バグ|
...
|CELLSNET-46912|XLSX から HTML への変換中に StackOverflowException がスローされる|例外|
