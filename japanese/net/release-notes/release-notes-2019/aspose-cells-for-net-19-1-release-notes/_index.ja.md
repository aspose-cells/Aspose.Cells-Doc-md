...
type: docs
weight: 120
url: /ja/net/aspose-cells-for-net-19-1-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46014|PDF および画像として保存する際のオーバーフロー セル コンテンツの処理のサポート|新機能|
|CELLSNET-46490|Excel95/5.0 XLSファイルに対応|新機能|
|CELLSNET-46500|セルの背景色で並べ替え|新機能|
|CELLSNET-46544|生成された MHT ファイルがワークシートかどうかを検出する|新機能|
|CELLSNET-46538|XLSX を PDF または TIFF として保存すると、テキストの下部が欠落します|バグ|
...
|CELLSNET-46529|XLSX から PDF への変換後に画像が見つからない|バグ|
...
|CELLSNET-46485|XLSB ファイル形式の読み込み時の例外|例外|
