...
30020 サポート Cell PDF ドキュメントへの変換中にグラデーション カラーが正しく設定されない
...
パフォーマンス
 ...
 31266 XLS から PDF または XPS への変換には非常に時間がかかります

40053 ワークシートの数が増えると Excel から PDF のパフォーマンスが低下する
...
40029 問題: シート内のハイパーリンクに関する「サイトのアドレスが無効です」
 ...
 40051 ImportFromExcelFile で、MemoryStream から XLSX ファイル (セルが結合されたもの) をロード中に問題が発生する
