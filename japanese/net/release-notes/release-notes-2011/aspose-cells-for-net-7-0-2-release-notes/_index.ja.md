...
type: docs
weight: 20
url: /ja/net/aspose-cells-for-net-7-0-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.0.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.0.2/)
...
25224 SpreadsheetML ファイルへの XLS 制限のないデータのエクスポート
...
30980 XLSM をロードして更新してから保存するとエラーが発生する
...
31277 ドキュメントを XLSX に保存すると、書き込み禁止になっています
