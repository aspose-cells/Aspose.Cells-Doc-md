...
type: docs
weight: 80
url: /ja/net/aspose-cells-for-net-5-3-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 5.3.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.3.2/)
...
|24912 | Xlsb|データフィルターを使用した XLSB の保存|
