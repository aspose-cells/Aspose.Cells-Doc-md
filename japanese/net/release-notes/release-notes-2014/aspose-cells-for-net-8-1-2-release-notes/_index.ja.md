...
type: docs
weight: 50
url: /ja/net/aspose-cells-for-net-8-1-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 8.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.2/)
...
(CELLSNET-42799) - Cell ピボットテーブルを PDF に変換する際のマージの問題

(CELLSNET-42775) - 小計に関するピボットテーブルのバグ

(CELLSNET-42749) - 矢印の線が Excel よりも太すぎる

(CELLSNET-42438) - 行がフィルタリングされ、スプレッドシートが HTML に変換されると、結合されたセルの内容が消える

(CELLSNET-42353) - Aspose.Cells XLS を PDF に変換すると、矢印の太さが 2 倍になる
...
(CELLSNET-42812) - スプレッドシートを PDF に変換中の CellsException
