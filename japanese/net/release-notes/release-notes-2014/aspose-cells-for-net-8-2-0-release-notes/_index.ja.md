---
title: Aspose.Cells for .NET 8.2.0 リリースノート
type: docs
weight: 40
url: /ja/net/aspose-cells-for-net-8-2-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 8.2.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.0/)
...
## **機能強化**
 ...
 (CELLSNET-42892) - AutoFitRows のオーバーロードが必要

(CELLSNET-42868) - データバリデータリストが期待値を返さない

(CELLSNET-42862) - サポートされていない Excel 2013 関数 - 日数


## **パフォーマンス**


(CELLSNET-42876) - Workbook.Save() メソッドで Aspose.Cells がハングする

(CELLSNET-42840) - 45,000 行を超える行が追加されると、大きな Excel ファイルが破損する
...
(CELLSNET-42526) - 矢印オブジェクトが出力 PDF で正しく配置されない

(CELLSNET-42322) - 行を削除してピボット テーブルを更新すると、出力ファイルがクラッシュする

(CELLSNET-42827) - ワークシート内のセルのマルチスレッド読み取り値に関する問題
...
(CELLSNET-42856) - #REF!チャート データ ソース参照のエラー
...
(CELLSNET-42907) - Aspose.Cells は期間フィルターを削除しました

(CELLSNET-42904) - ハイパーリンク コレクションの DeleteRange の問題

(CELLSNET-42900) - 組み込みおよびカスタムのドキュメント プロパティが失われる
...
(CELLSNET-42874) - Worksheet.Copy がチャートを正しく保存しない

(CELLSNET-42872) - ワークブックから折れ線グラフを読み取る際の値が正しくない

(CELLSNET-42851) - MS Excel ではなく、VLOOKUP 関数が 0 として評価される
...
(CELLSNET-42755) - チャート ラベルの位置/配置が変更された
...
(CELLSNET-42891) - CellsException: そのようなヘッダーまたはフッターはまだサポートされていません!
 ...
 (CELLSNET-42863) - ワークブックを開くときの NullReferenceException
...
## **バグ**
 ...
 (CELLSNET-42895) - GridWeb 内で Page.IsPostBack が常に false になる

(CELLSNET-42881) - GridWeb がすべての Web ワークシートで同じ画像を表示する


## **例外**


(CELLSNET-42879) - GridWeb で画像付きの Excel を保存すると例外が発生する
...
Cells.MultiThreadReading プロパティを追加

セル データ モデルがマルチスレッド読み取りをサポートする必要があるかどうかを示します。
