...
type: docs
weight: 110
url: /ja/net/aspose-cells-for-net-7-7-1-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for .NET 7.7.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.7.1/)
...
(CELLSNET-41330) - ピボットテーブル - 「フィールドごとに複数のフィルターを許可する」状態が正しくない (*.xlsb)
...
(CELLSNET-41636) - XLSX ファイルを保存した後、条件付き書式が維持されない
