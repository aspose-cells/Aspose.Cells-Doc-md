---
title: チャートをローカライズされた画像に変換する方法をNode.jsとC++で
description: Aspose.Cells for Node.js via C++を使用してグローバリゼーション設定をチャートに設定する方法を学びます。多言語や地域フォーマットをサポートするようにチャートを設定し、異なる言語で正しくテキスト、日付、数字を表示させる方法を紹介します。
keywords: Aspose.Cells for Node.js via C++、チャート、グローバリゼーション設定、多言語、地域フォーマット、表示、テキスト、日付、数字。
linktitle: ローカライズされた地域を設定する
type: docs
weight: 50
url: /ja/nodejs-cpp/convert-chart-to-localized-image/
...
- [チャートの中国地域を設定する方法](/cells/ja/nodejs-cpp/convert-chart-to-image-for-chinese-region/)
