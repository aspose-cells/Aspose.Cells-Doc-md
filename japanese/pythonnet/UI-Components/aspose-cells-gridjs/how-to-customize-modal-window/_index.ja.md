---
title: GridJsのモーダルウィンドウのUI見た目をカスタマイズする方法  
type: docs
weight: 250
url: /ja/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: この記事では、GridJsのモーダルウィンドウのUI見た目をカスタマイズする方法について説明します。
keywords: GridJs、カスタマイズ、モーダル、UI、外観、視覚、ウィンドウ
aliases:
aliases:
...
# GridJs用モーダルスタイリングガイド

## 目次

- [概要](#overview)
- [CSSクラス命名](#css-class-naming)
- [クイックスタート](#quick-start)
- [美しいスタイルの例](#beautiful-style-examples)
...
| モーダルタイプ | 名前 | CSSクラス |
|------------|------|-----------|
| ソート | `sort` | `.x-spreadsheet-modal-sort` |
...
| 文字回転 | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| データ検証 | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| 数値書式 | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
...
プロフェッショナルおよびエンタープライズアプリケーションに理想的です。
