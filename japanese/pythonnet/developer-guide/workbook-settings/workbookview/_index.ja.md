---
title: ワークブックビューの制御方法
type: docs
weight: 600
url: /ja/python-net/how-to-control-workbook-view/
description: Aspose.Cells for Python via .NETを使用してワークブックビューを制御する方法を学びます。
keywords: ワークブックビューの制御方法、Excelビューの設定、ワークブックビューの操作、ワークブックビューの設定、Excelビューの制御方法 
---

## **可能な使用シナリオ**
Excelページの表示を調整する必要がある場合、水平および垂直のスクロールバーのような各モジュールの制御方法、開いているExcelファイルの非表示化の有無などを知る必要があります。Aspose.Cellsはこの機能を提供します。Aspose.Cellsは、あなたの目標を達成するのに役立つ以下のプロパティやメソッドを提供します。
