...
type: docs
weight: 8
url: /ja/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-51938|XLSX から PDF: 文字間隔が間違っています|
|CELLSNET-51226|Excel ワークブックにグラフ/グループの識別子属性を追加する|
|CELLSNET-51461|Excel から DOCX への変換でデータに不要な枠線が追加される|
|CELLSNET-51736|Cell 結果の PDF で境界線が失われました|
...
|CELLSNET-51772|XLS ファイルを XLSM に変換すると接続情報が変更される|
|CELLSNET-51778|XLS ファイルを XLSM に変換すると、名前付き範囲のリンクの末尾にあるいくつかの文字が削除される|
...
|CELLSNET-51865|XLS ワークシートにデータがありませんが、Excel で塗りつぶされた行が表示されます。|
...
|CELLSNET-51965|Accounting 形式の XLSX ファイルを Aspose.Cells.GridDesktop にインポートすると例外が発生する|
|CELLSNET-51961|ODS を PDF にレンダリングするときの例外「インデックスが範囲外でした」|
