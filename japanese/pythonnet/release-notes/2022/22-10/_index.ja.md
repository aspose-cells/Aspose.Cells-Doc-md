---
title: Aspose.Cells for Python via .NET 22.10 リリースノート
type: docs
weight: 7
url: /ja/python-net/aspose-cells-for-python-net-22-10-release-notes/
---
{{% alert color="primary" %}} 

これは、Aspose.Cells for Python via .NET の最初のバージョンです。
このページには、Aspose.Cells for Python via .NET 22.10 のリリース ノートが含まれています。

{{% /alert %}} 

|**鍵**|**概要**|**カテゴリー**|
|:- |:- |:- |
|CELLSPYTHONNET-79|サポートMacOSバージョン|
...
|CELLSNET-51419|XLS ファイルを XLSM に変換すると、ピボット テーブルの外部リンクが削除される|
|CELLSNET-51984|ピボットテーブル ファイルを含む XLSX ファイルが再保存後に破損する|
...
|CELLSNET-52049|XLSX から PDF: テキストが正しくフォーマットされていません|
|CELLSNET-52073|Excel から PDF へのレンダリングでの Arial Tur フォントに関する問題|
...
|CELLSNET-52001|破損したファイルを生成した XLSX ファイルを再保存する|
...
|CELLSNET-52074|HTML から XLSX: セルのコンテンツがありません|
