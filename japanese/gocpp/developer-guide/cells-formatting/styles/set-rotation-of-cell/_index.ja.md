---
title: C++経由でGolangを使ったセルのテキスト回転方法
linktitle: セルのテキストの回転方法
type: docs
weight: 80
url: /ja/go-cpp/how-to-rotate-text-of-cell/
...
[**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/)プロパティを使用すると、セルを回転させることが簡単になります。Aspose.Cellsでセルを回転させるには、次の手順に従う必要があります:
1. Excelワークブックをロードする
<br>
