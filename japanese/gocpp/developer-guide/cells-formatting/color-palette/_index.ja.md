---
title: GolangをC++経由で使ってカラーパレットを使用する方法
linktitle: カラーパレットの使用方法
type: docs
weight: 80
url: /ja/go-cpp/excel-color-palette/
...
Aspose.Cells は、Microsoft Excel ファイルを表す [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) クラスを提供します。[**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) クラスには、パレットを変更するための [**ChangePalette**](https://reference.aspose.com/cells/go-cpp/workbook/changepalette/) メソッドがあり、カスタム色を追加するために次のパラメータを取ります:
