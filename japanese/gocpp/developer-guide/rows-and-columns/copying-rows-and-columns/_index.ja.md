...
type: docs
weight: 20
url: /ja/go-cpp/copying-rows-and-columns/
---
...
Aspose.Cellsは、ICellsクラスのCopyColumnメソッドを提供し、これにより数式（更新された参照を含む）、値、コメント、セルのフォーマット、非表示セル、画像、その他の描画オブジェクトをソース列から宛先列にコピーします。
