---
title: Golang を使った C++ によるチャートタイプ
linktitle: チャートタイプ
description: Aspose.Cells for C++がサポートするさまざまなチャートタイプについて学習します。ガイドは、利用可能な異なるタイプのチャートと、それらを作成・修正してワークシートを強化する方法を案内します。
keywords: Aspose.Cells for C++、チャート作成、チャートタイプ、サポート、作成、修正、ワークシート。
type: docs
weight: 5
url: /ja/go-cpp/chart-types/
---

## **紹介**
チャートは情報の視覚的表示です。Aspose.Cellsを使用すれば、Microsoft Excelと同様に情報をチャートで視覚化できます。情報をチャートで提示することは、意思決定者にとって迅速かつタイムリーな決定を下すのに役立ちます。チャートを使うと、生の数値よりも比較、パターン、傾向をすぐに確認できるため、比較が容易です。スプレッドシートのデータに基づいてランタイムにチャートを作成するのは、Aspose.Cellsの最も強力な機能の一つです。
...
データマーカーは、チャート内にプロットされた各値、すなわちデータポイントを表すために使用されます。同じ色のデータマーカーは、データ系列を構成します。
...
ファネルチャートは Aspose.Cells でサポートされています。
