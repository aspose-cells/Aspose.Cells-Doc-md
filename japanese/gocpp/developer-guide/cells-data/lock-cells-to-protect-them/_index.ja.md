---
title: Golang経由のC++でセルをロックして保護する方法
linktitle: セルをロックして保護する方法
type: docs
weight: 130
url: /ja/go-cpp/how-to-lock-cells-to-protect-them/
description: この記事では、Golang経由のC++でAspose.Cellsライブラリを使ってセルをロックして保護するコード例を紹介します。
