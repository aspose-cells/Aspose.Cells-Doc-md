...
type: docs
weight: 20
url: /ja/reportingservices/aspose-cells-for-reporting-services-1-5-2-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Reporting Services 1.5.2](https://downloads.aspose.com/cells/reportingservices/new-releases/aspose.cells-for-reporting-services-1.5.2/)
...
|16248 |サーバー コンポーネント|XLSX エクスポートが正しく機能しない|
