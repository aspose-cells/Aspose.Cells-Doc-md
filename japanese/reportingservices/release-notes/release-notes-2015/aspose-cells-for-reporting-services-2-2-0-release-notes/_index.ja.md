...
type: docs
weight: 10
url: /ja/reportingservices/aspose-cells-for-reporting-services-2-2-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[Aspose.Cells for Reporting Services 2.2.0](https://downloads.aspose.com/cells/reportingservices/new-releases/aspose.cells-for-reporting-services-2.2.0/)
...
(SSRS-40184) Integrity Index Report - レポートが XLSX でエクスポートされず、次のエラーが表示されます:「レポートのエクスポート中にエラーが発生しました。」
...
(SSRS-40169) エクスポートされた Excel ファイル (XLSX) で非表示のグループ化された行セットが表示される

(SSRS-40168) レンダリングされたXLSXファイル形式で行グループが失われる
