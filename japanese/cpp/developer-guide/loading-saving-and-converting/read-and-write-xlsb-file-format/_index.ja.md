...
## **XLSB ファイル形式の読み取りと書き込み**
次のサンプル コードは、[ソース XLSB ファイル](23166992.xlsb)セル A1 を読み取り、その内容をセル C4 にコピーして、次のように保存します。[出力XLSBファイル](23166993.xlsb).
## **サンプルコード**
