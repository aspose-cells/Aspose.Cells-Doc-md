---
title: C++で印刷タイトルを設定する方法
linktitle: 印刷タイトルの設定方法
type: docs
weight: 200
url: /ja/cpp/how-to-set-print-titles/
description: この記事では、C++のAspose.Cellsライブラリを使って印刷タイトルを設定する方法を説明するコード例を示しています。
keywords: 行と列を繰り返して印刷（C++）、印刷タイトルを設定およびクリア（C++）、C++で印刷タイトルをクリアする方法、C++で印刷タイトルを追加する方法、C++で印刷タイトルを削除する方法、Excelで印刷タイトルを設定する方法、Excelで印刷タイトルをクリアする方法。
---
...
指定したシートにプリントタイトルを設定するには、まず[サンプルファイル](input.xlsx)を読み込み、次に望むシートの[**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)オブジェクトの[**Worksheet.GetPrintTitleRows()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprinttitlerows/)と[**Worksheet.GetPrintTitleColumns()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprinttitlecolumns/)のプロパティを変更します。これらのプロパティに範囲文字列を設定するとプリントタイトルが設定されます。
...
指定したシートのプリントタイトルをクリアするには、まず[サンプルファイル](input.xlsx)を読み込み、次に望むシートの[**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)オブジェクトの[**Worksheet.GetPrintTitleRows()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprinttitlerows/)と[**Worksheet.GetPrintTitleColumns()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprinttitlecolumns/)のプロパティを変更します。これらのプロパティを空文字に設定するとプリントタイトルがクリアされます。
