---
title: 外部データ接続に関連するクエリテーブルとリストオブジェクトをC++で見つける
linktitle: クエリテーブルとリストオブジェクトを見つける
type: docs
weight: 20
url: /ja/cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: Aspose.Cellsを使用して、外部データ接続に関連するクエリテーブルとリストオブジェクトを見つける方法を学びます。
---
