---
title: C++を使って、ワークシート内のテキストボックスのタグをテキストに置き換えます。
linktitle: ワークシート内のテキストボックスでタグをテキストに置き換える
type: docs
weight: 1100
url: /ja/cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Aspose.Cells for C++を使用して、ワークシートのテキストボックス内のタグをプログラムによって置き換えます。
---
