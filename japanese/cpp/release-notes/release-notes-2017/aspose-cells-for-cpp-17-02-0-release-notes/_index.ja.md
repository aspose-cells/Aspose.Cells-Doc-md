...
type: docs
weight: 30
url: /ja/cpp/aspose-cells-for-cpp-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

このページには、[CPP 17.02.0 の場合は Aspose.Cells](https://downloads.aspose.com/cells/cpp/new-releases/aspose.cells-for-c---17.02.0/).
...
1. [式の追加と結果の計算](/cells/ja/cpp/ways-to-calculate-formulas#waystocalculateformulas-addingformulas&calculatingresults)
1. [数式の直接計算](/cells/ja/cpp/ways-to-calculate-formulas#waystocalculateformulas-directcalculationofformula)
1. [数式を一度だけ計算する](/cells/ja/cpp/ways-to-calculate-formulas#waystocalculateformulas-calculatingformulasonceonly)
1. [ICustomFunction 機能の使用](/cells/ja/cpp/using-icustomfunction-feature#usingicustomfunctionfeature-usingicustomfunctionfeature) 
