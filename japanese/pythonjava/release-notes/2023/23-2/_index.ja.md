...
type: docs
weight: 11
url: /ja/python-java/aspose-cells-for-python-via-java-23-2-release-notes/
---
{{% alert color="primary" %}}

このページには、次のリリースノートが含まれています[Aspose.Cells for Python via Java 23.2](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.2/).
