...
type: docs
weight: 40
url: /ja/python-java/evaluate-aspose-cells/
---

{{% alert color="primary" %}}

[pypi](https://pypi.org/project/aspose-cells/) からAspose.Cellsを評価用に簡単にダウンロードできます。 評価版のダウンロードはフルバージョンのダウンロードと同じです：評価版にライセンスを適用すると、ライセンスされた製品になります。
