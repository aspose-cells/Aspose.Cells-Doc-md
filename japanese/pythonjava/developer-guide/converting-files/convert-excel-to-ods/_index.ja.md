...
### **直接変換**
Excel ファイルを ODS に変換する最も簡単な方法は、ワークブックを読み込んで保存することです。[SaveFormat.ODS](https://reference.aspose.com/cells/python/asposecells.api/saveformat#ODS)の 2 番目のパラメータとして[Workbook.save](https://reference.aspose.com/cells/python/asposecells.api/workbook#save\(java.lang.String,%20int\)） 方法。
