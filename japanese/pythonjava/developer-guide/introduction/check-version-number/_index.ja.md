...
API を使用して、使用している Aspose.Cells のバージョンを確認するには、[セルヘルパー](https://reference.aspose.com/cells/python-java/asposecells.api/cellshelper)クラス GetVersion 静的メソッドを使用して、Aspose.Cell のバージョン番号を取得します。
