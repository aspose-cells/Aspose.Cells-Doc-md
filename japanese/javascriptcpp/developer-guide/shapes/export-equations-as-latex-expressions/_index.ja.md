...
type: docs
weight: 100
url: /ja/javascript-cpp/export-equation/
---
...
Excelの方程式をLaTeX式としてエクスポートしたい場合は、[EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--)メソッドを使用できます。 

次のサンプルコードは、[EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--)メソッドを使用し、生成された結果をHTMLに挿入する方法を示しています：
...
Excelの方程式をMathML式としてエクスポートしたい場合は、[EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--)メソッドを使用できます。 

次のサンプルコードは、[EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--)メソッドを使い、生成された結果をHTMLに挿入する方法を示しています：
