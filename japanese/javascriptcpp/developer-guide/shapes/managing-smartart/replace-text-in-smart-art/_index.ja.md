---
title: JavaScriptを使用してC++経由でSmart artのテキストを置換する
linktitle: スマートアート内のテキストの置換
type: docs
weight: 1200
url: /ja/javascript-cpp/replace-text-in-smart-art/
description: Aspose.Cells for JavaScriptを使用してC++経由でSmart artのテキストを置換する方法を学ぶ。
---

## **可能な使用シナリオ**  

Smart artはワークブックの主要なオブジェクトの一つです。多くの場合、Smart art内のテキストを更新する必要があります。Aspose.Cells for JavaScriptを使用して、[**Shape.text**](https://reference.aspose.com/cells/javascript-cpp/shape/#text--)プロパティを設定することでこの機能を提供します。  
