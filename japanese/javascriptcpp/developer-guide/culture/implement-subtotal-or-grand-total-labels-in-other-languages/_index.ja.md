---
title: JavaScriptをC++経由で、他の言語でサブトータルまたはグランドトータルのラベルを実装します。
linktitle: 他の言語で小計または合計ラベルを実装する
type: docs
weight: 50
url: /ja/javascript-cpp/implement-subtotal-or-grand-total-labels-in-other-languages/
---

## **可能な使用シナリオ**  

時には、中国語、日本語、アラビア語、ヒンディー語などの非英語の言語でサブトータルやグランドトータルのラベルを表示したい場合があります。Aspose.Cells for JavaScriptをC++で使用すると、[**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings)クラスと[**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings/)プロパティを使ってこれを実現できます。詳細については、[**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings)クラスの使い方に関するこの記事をご覧ください。  

- [ピーグラフのカスタムサブトータルラベルおよびその他のラベル用のGlobalizationSettingsクラスの使用](/cells/ja/javascript-cpp/using-globalizationsettings-class-for-custom-subtotal-labels-and-other-label-of-pie-chart/)  

## **他の言語で小計または合計ラベルを実装する**  

以下のサンプルコードは、[サンプルエクセルファイル](5115151.xlsx)を読み込み、中国語で小計と合計の名前を実装しています。参考のために、このコードで生成された[出力Excelファイル](5115152.xlsx)を確認してください。まず[**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings)クラスを作成し、それをコード内で使用します。  
