---
title: JavaScript via C++によるXAdES署名のサポート
linktitle: XAdES署名のサポート
type: docs
weight: 110
url: /ja/javascript-cpp/support-for-xades-signature/
description: この記事では、Aspose.Cellsを使用したJavaScriptとC++によるXAdES署名のサポートについて説明します。
keywords: XAdES署名のサポート JavaScript via C++、XAdES署名を使ってExcelに署名する方法、JavaScriptを使ったXAdES署名の追加方法。  
---  

## **紹介**  

Aspose.CellsはXAdES署名を用いたワークブックの署名サポートを提供します。これには[**DigitalSignature**](https://reference.aspose.com/cells/javascript-cpp/digitalsignature)クラスと[**XAdESType**](https://reference.aspose.com/cells/javascript-cpp/xadestype)列挙型が含まれています。  

## **ExcelにXAdES Signatureを追加する方法**  

次のコードスニペットは、[**DigitalSignature**](https://reference.aspose.com/cells/javascript-cpp/digitalsignature)クラスを使用して[source](101089323.xlsx)ワークブックに署名する方法を示しています。  
