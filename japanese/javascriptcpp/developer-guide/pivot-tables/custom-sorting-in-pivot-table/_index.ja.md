...
type: docs
weight: 130
url: /ja/javascript-cpp/custom-sorting-in-pivot-table/
description: Aspose.Cells for JavaScriptをC++でフィールド値によるピボットテーブルのソート方法。
keywords: Aspose.Cells for JavaScriptをC++ Excel、Excel JavaScriptライブラリ経由で、フィールド値によるピボットテーブルのソートを行う。
---

## **Aspose.Cells for JavaScriptをC++ライブラリを使用してピボットテーブルのカスタムソートを設定する方法**
Aspose.Cells for JavaScriptをC++ APIを使用してピボットテーブルをフィールド値でソートできます。以下のコードスニペットはサンプルのExcelファイルを読み込み、3つのピボットテーブルを追加します。最初のピボットテーブルはカスタムソートなし、2番目は「SeaFood」行フィールド値でソート、3番目は「28/07/2000」列フィールド値でソートしています。
