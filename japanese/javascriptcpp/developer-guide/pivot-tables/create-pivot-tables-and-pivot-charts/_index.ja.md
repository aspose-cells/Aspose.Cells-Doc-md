...
type: docs
weight: 20
url: /ja/javascript-cpp/create-pivot-tables-and-pivot-charts/
description: C++を使用したAspose.Cells for JavaScriptでピボットテーブルとピボットチャートを追加する方法。
keywords: Aspose.Cells for JavaScriptをC++ Excel、Excel JavaScriptライブラリ経由で使用し、ピボットテーブルとピボットチャートを追加します。
---
...
Aspose.Cells for JavaScriptをC++経由でサポートし、[ピボットテーブル](/cells/ja/javascript-cpp/create-pivot-tables-and-pivot-charts/)と[ピボットチャート](/cells/ja/javascript-cpp/create-pivot-tables-and-pivot-charts/)を作成します。

{{% /alert %}}

## **Aspose.Cells for JavaScriptをC++経由で使用してピボットテーブルとチャートを追加します**

Aspose.Cells for JavaScriptをC++は、ピボットテーブルを作成および設定するために使用される特殊なクラス群を提供します。これらは、ピボットテーブルオブジェクトを作成し設定するためのものであり、ピボットテーブルの基本的な構成要素として機能します：
...
### **Aspose.Cells for JavaScriptをC++で使用する準備**
1. NPMからAspose.Cells for JavaScriptをC++用にインストールし、次のコマンドを使用します： $ npm install aspose.cells.node.
1. 「Aspose.Cells for JavaScriptをC++にインストールする」手順をステップバイステップで確認することもできます。


### **Aspose.Cells for JavaScriptをC++で使用してピボットテーブルを追加する方法**

Aspose.Cells for JavaScriptをC++を使ってピボットテーブルを作成するには：
...
### **Aspose.Cells for JavaScriptをC++ライブラリを使用してピボットチャートを追加する方法**

Aspose.Cells for JavaScriptをC++を使ってピボットチャートを作成するには：
