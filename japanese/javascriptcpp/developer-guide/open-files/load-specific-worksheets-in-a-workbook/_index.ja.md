---
title: JavaScriptとC++を使用して特定のワークシートのみを読み込む
linktitle: ワークブック内の特定のワークシートのみをロードする
type: docs
weight: 100
url: /ja/javascript-cpp/load-specific-worksheets-in-a-workbook/
description: Aspose.Cells for JavaScriptを使用してワークブック内の特定のワークシートを読み込む方法を学び、パフォーマンスを向上させ、メモリ消費を削減します。
---
