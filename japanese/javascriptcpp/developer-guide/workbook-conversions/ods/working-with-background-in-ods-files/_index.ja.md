---
title: JavaScript経由のC++で背景のあるODSファイルの操作
linktitle: ODSファイルでの背景の処理
type: docs
weight: 150
url: /ja/javascript-cpp/working-with-background-in-ods-files/
description: Aspose.Cells for JavaScriptを使用してODSファイルの背景管理方法を学ぶ
---
...
Aspose.Cells for JavaScriptは、背景情報の読み取りと、ODSファイルへの背景追加機能を提供します。  

## **ODSファイルの背景を読み込む**  

Aspose.Cells for JavaScriptは、ODSファイルの背景管理に[**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)クラスを提供します。次のコード例は、[**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)クラスを使用して[source ODS](90112030.ods)ファイルを読み込み、背景情報を取得する例です。コードが生成したコンソール出力を参照してください。  
...
Aspose.Cells for JavaScriptは、ODSファイルの背景管理に[**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)クラスを提供します。次の例は、背景に色を追加するための[**OdsPageBackground.color**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#color--)プロパティの使用例です。生成された[出力ODS](90112031.ods)ファイルを参照してください。  
...
Aspose.Cells for JavaScriptは、背景にグラフィックを追加するための[**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground)クラスを提供します。次のコードは、[**OdsPageBackground.graphicData**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#graphicData--)プロパティを使用してODSファイルにグラフィック背景を追加する例です。コードによって生成された[出力ODS](90112030.ods)を参照してください。  
