...
type: docs
weight: 600
url: /ja/javascript-cpp/get-cells-range/
description: Aspose.Cells for JavaScript via C++ APIを使用してセル範囲を取得する方法を学びます。
keywords: セルの最大表示範囲を取得、セルの最大行を取得、セルの最大データ行を取得、セルの最大列を取得、セルの最大データ列を取得します。 
---

## **可能な使用シナリオ**
ワークシート上のいくつかのデータだけを操作する必要があるとき、ワークシート全体のデータ範囲を知る必要があります。Aspose.Cells for JavaScript via C++はこの機能を提供します。
...
## **Aspose.Cells for JavaScript via C++を使用したセル範囲の取得**
この例では、次のことができます:

1. ワークブックを作成する。
1. 最初のワークシートのセルにデータを追加する。
1. セル[**Range**](https://reference.aspose.com/cells/javascript-cpp/range)を取得。
