---
title: JavaScriptを介してC++でVBAプロジェクトが保護されロックされているかどうかを確認する
linktitle: VBA（Visual Basic for Applications）プロジェクトが保護されて表示ロックされているかどうかを確認
type: docs
weight: 30
url: /ja/javascript-cpp/check-if-vba-project-is-protected-and-locked-for-viewing/
description: Aspose.Cells for JavaScriptを使用して、Excelファイル内のVBAプロジェクトが保護されていて閲覧ロックされているかどうかをC++で確認する方法を学びます。
---

## JavaScriptを通じてC++でVBAプロジェクトが保護されていて閲覧ロックされているか確認する

Aspose.Cellsを使用すると、ExcelファイルのVBA（Visual Basic for Applications）プロジェクトが保護されているかつ、閲覧のためにロックされているかどうかを確認できます。そのためにAPIは[**VbaProject.islockedForViewing**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#islockedForViewing--)プロパティを提供します。閲覧用にロックされている場合、[**VbaProject.islockedForViewing**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#islockedForViewing--)プロパティは**true**を返します。
