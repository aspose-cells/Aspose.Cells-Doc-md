---
title: JavaScriptを使った一次軸と二次軸のC++対応
description: C++を使用したAspose.Cells for JavaScriptで一次軸と二次軸について理解し、効果的に設定・使用する方法を学びましょう。ガイドは、それらの違いと設定方法について詳しく解説します。
keywords: C++を用いたAspose.Cells for JavaScriptで一次軸、二次軸、理解、違い、設定、使用法
type: docs
weight: 190
url: /ja/javascript-cpp/primary-and-second-axis/
---
