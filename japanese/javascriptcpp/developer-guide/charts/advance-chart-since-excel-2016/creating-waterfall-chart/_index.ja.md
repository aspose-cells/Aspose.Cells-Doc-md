---
title: JavaScriptを使用したC++によるウォーターフォールチャート作成方法
linktitle: ウォーターフォールチャートの作成方法
type: docs
weight: 160
url: /ja/javascript-cpp/creating-waterfall-chart/
description: JavaScriptとAspose.Cells for JavaScriptを使用したExcelのウォーターフォールチャートの作成方法。
keywords: Excelでのウォーターフォールチャートの作成（JavaScriptでC++を使用）、C++によるExcelでのウォーターフォールチャートの作成、C++を用いたExcelのウォーターフォールチャートの作成方法
---
...
{{% /alert %}} 
 ...
 Aspose.Cells APIは、ラインチャートを利用してウォーターフォールチャートを作成できます。APIはまた、[**Series.upBars**](https://reference.aspose.com/cells/javascript-cpp/series/#upBars--) & [**Series.downBars**](https://reference.aspose.com/cells/javascript-cpp/series/#downBars--)のプロパティ設定により、ウォーターフォールの形状にチャートの外観をカスタマイズ可能です。

 以下のコードスニペットは、C++を使用してゼロからウォーターフォールチャートを作成する例を示しています。
