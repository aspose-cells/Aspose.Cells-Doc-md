---
title: JavaScript経由のC++を使ったグラフの背景に画像を設定する方法
linktitle: チャートに背景として画像を設定する
description: Aspose.Cells for Javaスクリプトを使用したチャートの背景に画像を設定する方法を学びます。写真のインポートと配置、サイズや色の調整、フォーマット設定方法を紹介し、チャートの外観を向上させるためのヒントを提供します。
keywords: Aspose.Cells for Javaスクリプト、C++、チャート作成、背景塗りつぶし、画像、インポート、位置調整、サイズ調整、色調整、フォーマット。
type: docs
weight: 30
url: /ja/javascript-cpp/set-picture-as-background-fill-in-the-chart/
---
...
これを実現するために、Aspose.Cellsは[**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--)プロパティを提供しています。次のコードサンプルは、チャートの背景に画像を設定するために[**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--)プロパティを使用する方法を示しています。

## JavaScriptコード：チャートの背景に画像を設定する
