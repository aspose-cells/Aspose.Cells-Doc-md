...
type: docs
weight: 8
url: /ja/nodejs-java/aspose-cells-for-node-js-via-java-22-5-release-notes/
---
{{% alert color="primary" %}}

このページには、[Aspose.Cells for Node.js via Java 22.5](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.5/).
