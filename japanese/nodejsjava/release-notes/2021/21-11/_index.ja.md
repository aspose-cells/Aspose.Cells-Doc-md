...
type: docs
weight: 2
url: /ja/nodejs-java/aspose-cells-for-node-js-via-java-21-11-release-notes/
---
{{% alert color="primary" %}}

このページには、[Aspose.Cells for Node.js via Java 21.11](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.11/).
