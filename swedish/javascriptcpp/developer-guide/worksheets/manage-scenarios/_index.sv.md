---
title: Skapa, manipulera eller ta bort scenarier från ark med JavaScript via C++
linktitle: Hantera scenarier
type: docs
weight: 190
url: /sv/javascript-cpp/create-manipulate-or-remove-scenarios-from-worksheets/
description: Lär dig hur man skapar, manipulerar eller tar bort scenarier från Excel ark programmässigt med hjälp av JavaScript via C++ API.
keywords: skapa scenario i ark JavaScript via C++, ta bort scenario i Excel ark JavaScript via C++, manipulera scenario i JavaScript via C++
---
