---
title: Ställa in sidalternativ med JavaScript via C++
linktitle: Inställning av sidalternativ
type: docs
weight: 10
url: /sv/javascript-cpp/setting-page-options/
description: Denna artikel ger exempel på kod för att ställa in sidalternativ för Excel kalkylblad programmatiskt med JavaScript via C++. Ställ in sidorientering, skalningsfaktor, anpassa till flera sidor, pappersstorlek, utskriftskvalitet, första sidnummer.
keywords: Ställ in excel sidorientering JavaScript via C++, ställ in excel skalningsfaktor JavaScript via C++, ställ in excel kalkylbladets pappersstorlek JavaScript via C++
---
...
Aspose.Cells tillhandahåller en klass, [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook), som representerar en Microsoft Excel-fil. [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook)-klassen innehåller en [**worksheets**](https://reference.aspose.com/cells/javascript-cpp/workbook/#worksheets--)-kollektion som möjliggör åtkomst till varje kalkylblad i Excel-filen. Ett kalkylblad representeras av [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet)-klassen.  

Klassen [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) erbjuder egenskapen [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) som används för att ställa in sidinställningsalternativ för arbetsbladet. Faktum är att egenskapen [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) är ett objekt av klassen [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) som används för att ställa in olika sidlayouter för ett utskrivet arbetsblad. Klassen [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) tillhandahåller olika egenskaper för att ställa in sidinställningar. Några av dessa egenskaper diskuteras nedan.  

### **Sidorientering**  

Sidorienteringen kan ställas in till porträtt eller landskap med hjälp av [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup)s [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--)-egenskap. [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--)-egenskapen accepterar ett av de fördefinierade värdena i [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype)-uppräknelsen, listade nedan.  
...
Det är möjligt att minska eller förstora storleken på ett arbetsblad genom att justera skalningsfaktorn med [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--)-egenskapen.  
...
För att anpassa innehållet i arbetsbladet till ett specifikt antal sidor, använd [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup)s [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) och [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--)-egenskaper. Dessa egenskaper används också för att skala arbetsblad.  

{{% alert color="primary" %}}  
Du kan antingen välja [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--)- eller [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--)-egenskapen, men inte båda samtidigt.  
{{% /alert %}}  
...
Ställ in pappersstorleken som arbetsbladen ska skrivas ut till med hjälp av [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup)-klassens [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--)-egenskap. [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--)-egenskapen accepterar ett av de fördefinierade värdena i [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype)-uppräknelsen, listade nedan.  
...
Ställ in utskriftskvaliteten för kalkylbladen att skrivas ut med [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--)-egenskapen. Enheten för utskriftskvalitet är punkter per tum (DPI).  
...
Börja numrera arbetsbladets sidor med hjälp av [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup)-klassens [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--)-egenskap. [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--)-egenskapen sätter sidnummer för den första arbetsbladssidan, och de följande numreras i stigande ordning.  
