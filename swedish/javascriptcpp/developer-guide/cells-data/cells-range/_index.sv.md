...
type: docs
weight: 600
url: /sv/javascript-cpp/get-cells-range/
description: Lär dig hur du får cellområden genom Aspose.Cells for JavaScript via C++ API.
...
När du bara behöver manipulera viss data i arbetsbladet, måste du känna till dataområdet för hela arbetsbladet. Aspose.Cells for JavaScript via C++ erbjuder denna funktion. Aspose.Cells for JavaScript via C++ tillhandahåller följande egenskaper och metoder för att hjälpa dig att uppnå dina mål.
...
## **Hämta cellområde med Aspose.Cells for JavaScript via C++**
Detta exempel visar hur man:

1. Skapa en arbetsbok.
1. Lägga till data till celler i den första arbetsboken.
1. Få celler [**Range**](https://reference.aspose.com/cells/javascript-cpp/range).
