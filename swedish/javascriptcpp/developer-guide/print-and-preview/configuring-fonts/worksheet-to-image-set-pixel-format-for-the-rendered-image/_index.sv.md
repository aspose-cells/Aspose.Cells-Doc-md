---
title: Kalkylblad till bild  Sätt pixelformat för den renderade bilden med JavaScript via C++
linktitle: Kalkylblad till bild  Ställ in bildpunktsformat för den renderade bilden
type: docs
weight: 200
url: /sv/javascript-cpp/worksheet-to-image-set-pixel-format-for-the-rendered-image/
---
