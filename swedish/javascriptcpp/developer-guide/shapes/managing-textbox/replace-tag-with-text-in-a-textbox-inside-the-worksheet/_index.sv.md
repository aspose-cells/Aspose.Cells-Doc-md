---
title: Ersätt tag med text i en textruta i kalkbladet med JavaScript via C++
linktitle: Ersätt taggen med text i en textruta på arbetsbladet
type: docs
weight: 1100
url: /sv/javascript-cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Lär dig att ersätta taggar med text i en textruta inom ett kalkblad med hjälp av Aspose.Cells for JavaScript via C++. 
---
...
## **Exempelkod**
 Följande exempel ersätter etiketter TAG_1 och TAG_2 med viss text, säg 'ys' och '1'. Exempel på fil för testning av nedanstående kod kan laddas ner från följande länk:
