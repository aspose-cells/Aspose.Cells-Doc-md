...
type: docs
weight: 100
url: /sv/javascript-cpp/export-equation/
---
...
Om du vill exportera ekvationer i Excel som LaTeX-uttryck kan du använda metoden [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--). 

Följande exempel visar hur man använder metoden [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) och infogar de genererade resultaten i HTML:

### JavaScript-till-LaTeX
...
Om du vill exportera ekvationer i Excel som MathML-uttryck kan du använda metoden [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--). 

Följande exempel visar hur man använder metoden [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) och infogar de genererade resultaten i HTML:
