---
title: Ställ in radavstånd för paragraf i en form eller textruta med JavaScript via C++
linktitle: Ställ in radavstånd för stycket i en shape eller textbox
type: docs
weight: 290
url: /sv/javascript-cpp/set-line-spacing-of-the-paragraph-in-a-shape-or-textbox/
description: Lär dig att ställa in radavstånd för paragrafer i former eller textrutor med Aspose.Cells for JavaScript via C++.
---

{{% alert color="primary" %}}

Du kan ställa in radavstånd för paragrafen, avstånd före och efter med hjälp av [**TextParagraph.lineSpace**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#lineSpace--), [**TextParagraph.spaceBefore**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#spaceBefore--) och [**TextParagraph.spaceAfter**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/#spaceAfter--) egenskaperna i [**TextParagraph**](https://reference.aspose.com/cells/javascript-cpp/textparagraph/)-klassen.
