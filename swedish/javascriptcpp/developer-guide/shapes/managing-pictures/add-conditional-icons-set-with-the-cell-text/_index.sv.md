---
title: Lägg till villkorsstyrda ikoner i celltexten med JavaScript via C++
linktitle: Lägg till villkorliga ikoner med celltexten
type: docs
weight: 160
url: /sv/javascript-cpp/add-conditional-icons-set-with-the-cell-text/
description: Lär dig hur du lägger till villkorsstyrda ikoner bredvid celltexten med Aspose.Cells for JavaScript via C++. Förbättra datans betydelse genom ikoner.
---

{{% alert color="primary" %}} 

Ibland vill du lägga till villkorsstyrda ikoner bredvid texten i en cell för att göra data mer meningsfull för läsare. Du vill använda några av de villkorsstyrda formateringsikontypen men utan att tillämpa villkorsstyrd formatering på cellerna. Aspose.Cells for JavaScript via C++ stöder denna funktion.
