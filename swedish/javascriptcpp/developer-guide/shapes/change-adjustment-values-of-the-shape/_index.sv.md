---
title: Ändra justeringsvärden för formen med JavaScript via C++
linktitle: Ändra justeringsvärden för formen
type: docs
weight: 2000
url: /sv/javascript-cpp/change-adjustment-values-of-the-shape/
description: Lär dig hur du ändrar justeringsvärden för former i Excel med Aspose.Cells for JavaScript via C++.
---

{{% alert color="primary" %}}  
Aspose.Cells tillhandahåller egenskapen [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) för att göra ändringar av justeringspunkter med former. I Microsoft Excel-gränssnittet visas justeringar som gula diamantnoder. Till exempel:  
...
Den här artikeln förklarar användningen av [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) egenskapen för att ändra justeringsvärdet för olika former.  
{{% /alert %}}  
