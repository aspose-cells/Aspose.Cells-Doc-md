---
title: Ställ in bild som bakgrundsfyllning i diagrammet med JavaScript via C++
linktitle: Ange bild som bakgrundsfyllning i diagrammet
description: Lär dig att ställa in en bild som bakgrundsfyllning i ett diagram med Aspose.Cells for JavaScript via C++. Vår guide visar hur du importerar och positionerar bilden, justerar dess storlek och färg, samt tillämpar formateringsalternativ för att förbättra diagrammets utseende.
keywords: Aspose.Cells for JavaScript via C++, diagram, bakgrundsfyllning, bild, importering, positionering, storlek, färg, formatering.
type: docs
weight: 30
url: /sv/javascript-cpp/set-picture-as-background-fill-in-the-chart/
---
