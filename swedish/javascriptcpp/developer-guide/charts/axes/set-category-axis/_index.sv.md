---
title: Hur man sätter kategoriaxel med JavaScript via C++
linktitle: Hur man ställer in kategori axeln
description: Lär dig hur du sätter kategoriaxeln i Aspose.Cells for JavaScript via C++. Vår guide hjälper dig att förstå hur du definierar kategoriaxelns intervall, justerar dess egenskaper och formaterar dess etiketter.
keywords: Aspose.Cells for JavaScript via C++, kategoriaxel, inställning, intervall, egenskaper, formatering.
type: docs
weight: 205
url: /sv/javascript-cpp/how-to-set-category-axis/
---

## **Möjliga användningsscenario**
Efter att du skapat ett diagram i ett arbetsblad kan du sätta kategoriaxeln för det. I denna artikel visar vi hur du kan sätta kategoriaxeln för ett Excel-diagram med hjälp av Aspose.Cells for JavaScript via C++ med exempel.
