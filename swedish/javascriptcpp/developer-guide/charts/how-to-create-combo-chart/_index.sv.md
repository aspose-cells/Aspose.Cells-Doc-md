---
title: Hur man skapar kombinationsdiagram med JavaScript via C++
linktitle: Hur du skapar kombinationsdiagram
description: Lär dig skapa ett kombinationsdiagram med Aspose.Cells for JavaScript via C++. Vår fullständiga guide visar hur man kombinerar olika diagramtyper till ett kombinationsdiagram för en mer effektiv datavisualisering.
keywords: Aspose.Cells for JavaScript via C++, Kombinationsdiagram, Kombinera diagramtyper, Datapresentation, Effektiv visualisering.
type: docs
weight: 73
url: /sv/javascript-cpp/create-combo-chart/
---
...
Med det följande datasättet som exempel kan vi konstatera att dessa data är ganska lika de data som nämns i [**VHCL**](https://docs.aspose.com/cells/javascript-cpp/create-volume-high-low-close-stock-chart/). Om vi vill visualisera serie0, som motsvarar "Total Revenue," som ett Linjediagram, hur ska vi gå tillväga?
