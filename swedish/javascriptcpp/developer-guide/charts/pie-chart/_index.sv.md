---
title: Skapa pajdiagram med ledarlinjer med JavaScript via C++
description: Lär dig hur du använder Aspose.Cells for JavaScript via C++ för att skapa ett pajdiagram med ledarlinjer i Microsoft Excel. Vår guide visar hur man lägger till ledarlinjer som kopplar data punkter till legenden och förbättrar diagrammets totala tydlighet.
keywords: Aspose.Cells for JavaScript via C++, Pajdiagram, Ledarlinjer, Microsoft Excel, Data Visualisering, Diagramanpassning.
linktitle: Cirkeldiagram
type: docs
weight: 45
url: /sv/javascript-cpp/creating-pie-chart-with-leader-lines/
---

{{% alert color="primary" %}}

Denna artikel förklarar hur man skapar ett pajdiagram med ledarlinjer från grunden med hjälp av Aspose.Cells for JavaScript via C++-API. I Excel är alternativet 'Visa ledarlinjer' förinställt så när du skapar ett pajdiagram i Excel visas ledarlinjerna. Men när du skapar en liknande diagram med Aspose.Cells API:er måste du uttryckligen sätta egenskapen [**Series.hasLeaderLines**](https://reference.aspose.com/cells/javascript-cpp/series/#hasLeaderLines--).

{{% /alert %}}

För att visa användningen av Aspose.Cells for JavaScript via C++ API för att skapa ett tårtdiagram med ledare, kommer vi först att skapa ett [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) och mata in några data som kommer att fungera som serie datakälla. När datan är på plats, lägger vi till ett [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) av typ [**ChartType.Pie**](https://reference.aspose.com/cells/javascript-cpp/charttype) till diagramsamlingen och ställer in dess olika aspekter för att få den önskade diagramvisningen.
...
## **Fortsatta ämnen**
- [Anpassade färgval för skiv- eller sektorfärger i cirkeldiagram](/cells/sv/javascript-cpp/custom-slice-or-sector-colors-in-pie-chart/)
- [Ta reda på om datapunkterna finns i den andra pajen eller stapeln på ett paj- eller stapeldiagram](/cells/sv/javascript-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)

## Relaterade artiklar

- [Skapa diagram](/cells/sv/javascript-cpp/creating-charts/)
- [Anpassa diagram](/cells/sv/javascript-cpp/customizing-charts/)
- [Dataformatering i diagram](/cells/sv/javascript-cpp/data-formatting-in-charts/)
