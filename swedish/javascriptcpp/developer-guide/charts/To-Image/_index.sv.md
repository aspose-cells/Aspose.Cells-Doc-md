---
title: Diagram till Bild med JavaScript via C++
description: Lär dig hur man använder Aspose.Cells for JavaScript via C++ för att konvertera ett diagram till ett bildformat, såsom JPEG eller PNG. Vår guide visar hur man exporterar ett diagram från Microsoft Excel och sparar det som en fristående bild för vidare användning och manipulation.
keywords: Aspose.Cells for JavaScript via C++, Diagram till Bild, Microsoft Excel, bildkonvertering, export, fristående bild.
linktitle: Diagram till Bild
type: docs
weight: 46
url: /sv/javascript-cpp/chart-to-image/
---

## **Rendering av diagram**

Aspose.Cells API:er stödjer konvertering av Excel-diagram till bildformat utan att kräva ytterligare verktyg eller applikationer. För att möjliggöra rendering erbjuder [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart)-klassen [**toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) metoder med olika överlagrade versioner för att bäst passa applikationsbehoven.

### **Rendera diagram till bilder**

Metoden [**Chart.toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) har olika överlagringar för att stödja enkel samt avancerad rendering. Om applikationskravet är att rendera diagrammet i dess standardmått rekommenderar vi att du använder metoden [**Chart.toImage(string)**](https://reference.aspose.com/cells/javascript-cpp/chart/#toImage-string-) som följer.
...
## **Fortsatta ämnen**  
- [Konvertera Diagram till PDF](/cells/sv/javascript-cpp/chart-to-pdf/)
