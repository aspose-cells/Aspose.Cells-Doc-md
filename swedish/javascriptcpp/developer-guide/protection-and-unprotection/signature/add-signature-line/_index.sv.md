---
title: Lägg till signaturlinje i arbetsblad med JavaScript via C++
linktitle: Lägg till signaturlinje i kalkylarket
type: docs
weight: 200
url: /sv/javascript-cpp/add-signature-line/
description: Denna artikel beskriver hur man lägger till en signaturlinje i arbetsbladet med JavaScript och Aspose.Cells for JavaScript via C++.
keywords: Lägg till signaturlinje i arbetsbladet JavaScript via C++, Hur man lägger till en signaturlinje i arbetsbladet JavaScript via C++, Hur man lägger till signaturlinjen i arbetsbladet JavaScript via C++.
---

## **Introduktion**

Aspose.Cells tillhandahåller egenskapen [**Picture.signatureLine**](https://reference.aspose.com/cells/javascript-cpp/picture/#signatureLine--) för att lägga till signaturlinjen i kalkylarket.

## **Hur man lägger till signeringsrad i arket**

 Följande exempel visar hur man använder [**Picture.signatureLine**](https://reference.aspose.com/cells/javascript-cpp/picture/#signatureLine--)-egenskapen för att lägga till underskriftslinjen i arbetsbladet. Skärmbilden visar effekten av exempel-koden på exempel-Excel-filen efter körning.
