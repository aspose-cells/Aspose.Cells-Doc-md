...
type: docs
weight: 10
url: /sv/javascript-cpp/format-number-to-date/
description: Denna artikel introducerar hur man formaterar nummer till datum med hjälp av Aspose.Cells for JavaScript via C++ API.
...
För att formatera nummer som datum i Aspose.Cells for JavaScript via C++ bibliotek för att arbeta med Excel-filer, kan du programmera tillämpningen att använda datumformat på celler. Så här gör du med Aspose.Cells for JavaScript via C++:
