...
type: docs
weight: 20
url: /sv/javascript-cpp/create-pivot-tables-and-pivot-charts/
description: Hur man lägger till pivottabeller och pivottabell diagram med Aspose.Cells for JavaScript via C++.
keywords: Aspose.Cells for JavaScript via C++ Excel, Excel JavaScript bibliotek, Lägg till pivottabeller och pivottabelldiagram med Aspose.Cells for JavaScript via C++ Excel bibliotek.
---
...
Aspose.Cells for JavaScript via C++ stöder [pivot tabeller](/cells/sv/javascript-cpp/create-pivot-tables-and-pivot-charts/) och [pivot diagram](/cells/sv/javascript-cpp/create-pivot-tables-and-pivot-charts/).

{{% /alert %}}

## **Lägg till pivottabeller och diagram med Aspose.Cells for JavaScript via C++**

Aspose.Cells for JavaScript via C++ tillhandahåller en särskild uppsättning klasser som används för att skapa pivottabeller. Dessa klasser används för att skapa och ställa in PivotTable-objekt, som fungerar som grundläggande byggstenar för en PivotTable:
...
### **Förbered dig för att använda Aspose.Cells for JavaScript via C++**
1. Installera Aspose.Cells for JavaScript via C++ från NPM, använd kommandot: $ npm install aspose.cells.node.
1. Du kan också följa steg-för-steg instruktionerna för hur du installerar “Aspose.Cells for JavaScript via C++” i din utvecklarmiljö.


### **Hur man lägger till en pivottabell med Aspose.Cells for JavaScript via C++**
...
### **Hur man lägger till ett pivottabelldiagram med Aspose.Cells for JavaScript via C++ bibliotek**
