...
type: docs
weight: 120
url: /sv/javascript-cpp/pivot-table-hide-and-sort-data/
---

## **Pivottabell Dölj och Sortera data**
Aspose.Cells for JavaScript via C++ stöder att dölja och sortera data i pivottabellen. Följande kod visar denna funktion genom att sortera Score-kolumnen i fallande ordning och sedan dölja rader med ett poäng mindre än 60.
