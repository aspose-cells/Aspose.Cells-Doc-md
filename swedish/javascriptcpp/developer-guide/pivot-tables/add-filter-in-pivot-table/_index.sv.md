...
type: docs
weight: 130
url: /sv/javascript-cpp/add-filter-in-pivot-table/
description: Lär dig hur du lägger till ett filter i pivottabell med Aspose.Cells for JavaScript via C++.
keywords: Aspose.Cells for JavaScript via C++ Excel, Excel JavaScript bibliotek, Lägg till ett filter i pivottabell med Aspose.Cells for JavaScript Excel bibliotek.
---

## **Möjliga användningsscenario**
När du skapar en pivottabell med kända data och vill filtrera pivottabellen måste du lära dig och använda filter. Det kan hjälpa dig att filtrera ut data på ett effektivt sätt. Genom att använda API:et Aspose.Cells for JavaScript via C++ kan du lägga till filter på fältvärden i pivottabeller. 

## **Lägg till filter i pivottabell med Aspose.Cells for JavaScript via C++**
