...
type: docs
weight: 150
url: /sv/javascript-cpp/save-pivot-table-in-ods-file/
---

Aspose.Cells for JavaScript via C++ ger möjlighet att spara pivottabellen i ODS-filer. För detta, konvertera bara en arbetsbok med befintlig pivottabell eller skapa en ny pivottabell och spara filen i ODS-format. Se till att anropa [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) innan du sparar för att säkerställa att pivottabellen renderas i output ODS-filen. Följande kodsnutt visar hur man sparar pivottabellen i ODS-fil.
