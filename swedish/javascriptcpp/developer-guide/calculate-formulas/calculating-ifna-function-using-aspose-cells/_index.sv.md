---
title: Beräkna IFNA funktionen med Aspose.Cells for JavaScript via C++
description: Hur man beräknar IFNA funktioner med Aspose.Cells biblioteket för JavaScript via C++. Ladda en befintlig Excel fil eller skapa en ny och beräkna IFNA funktionen för att få resultatet. Slutligen spara den modifierade Excel filen till disk.
keywords: Aspose.Cells, Excel, IFNA funktioner, beräkningar JavaScript via C++
type: docs
weight: 40
url: /sv/javascript-cpp/calculating-ifna-function-using-aspose-cells/
---
...
{{% /alert %}} 
## **Beräkna IFNA-funktionen med Aspose.Cells for JavaScript via C++**
 Följande exempel visar beräkningen av IFNA-funktionen med Aspose.Cells for JavaScript via C++. 
