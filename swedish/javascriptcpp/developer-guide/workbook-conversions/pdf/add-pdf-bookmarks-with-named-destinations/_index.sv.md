---
title: Lägg till PDF bokmärken med namngivna destinationer med JavaScript via C++
linktitle: Lägg till PDF bokmärken med namngivna destinationer
type: docs
weight: 20
url: /sv/javascript-cpp/add-pdf-bookmarks-with-named-destinations/
description: Lär dig hur man lägger till PDF bokmärken med namngivna destinationer med Aspose.Cells for JavaScript via C++. Säkerställ att bokmärken förblir intakta oavsett sidändringar.
---
