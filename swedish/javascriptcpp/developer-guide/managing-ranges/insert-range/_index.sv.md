---
title: Infoga områden med JavaScript via C++
linktitle: Infoga intervall
type: docs
weight: 105
url: /sv/javascript-cpp/insert-ranges-to-excel/
description: Lär dig hur du infogar områden i Excel och flyttar andra data med Aspose.Cells for JavaScript via C++.
---
...
## **Infoga områden med Aspose.Cells for JavaScript via C++**

Aspose.Cells for JavaScript via C++ tillhandahåller metoden [Cells.insertRange(CellArea, number, ShiftType, boolean)](https://reference.aspose.com/cells/javascript-cpp/cells/#insertRange-cellarea-number-shifttype-boolean-) för att infoga ett område.
