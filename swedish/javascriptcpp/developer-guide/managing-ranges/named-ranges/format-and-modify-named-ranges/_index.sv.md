---
title: Formatera och modifiera namngivna områden med JavaScript via C++
linktitle: Format och ändra namngivna områden
type: docs
weight: 85
url: /sv/javascript-cpp/format-and-modify-named-ranges/
description: Lär dig hur du formaterar och modifierar namngivna områden med Aspose.Cells for JavaScript via C++. 
---
...
För att tillämpa formatering, definiera ett [**Style**](https://reference.aspose.com/cells/javascript-cpp/style)-objekt för att specificera stilinställningarna och tillämpa det på [**Range**](https://reference.aspose.com/cells/javascript-cpp/range)-objektet.
...
Aspose.Cells tillåter dig att byta namn på ett namngivet område efter behov. Du kan hämta det namngivna området och döpa om det med hjälp av [**Name.text**](https://reference.aspose.com/cells/javascript-cpp/name/#text--)-attributet. Följande exempel visar hur man döper om ett namngivet område.
...
Aspose.Cells tillhandahåller [**Range.unionRang(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#unionRang-range-)-metoden för att ta unionen av områden; metoden returnerar ett [*Array*]-objekt. Följande exempel visar hur man tar unionen av områden.
...
Aspose.Cells tillhandahåller [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-)-metoden för att skära mellan två områden. Metoden returnerar ett [**Range**](https://reference.aspose.com/cells/javascript-cpp/range)-objekt. För att kontrollera om ett område skär ett annat, använd [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-)-metoden som returnerar ett boolean-värde. Följande exempel visar hur man skär mellan områdena.
...
Aspose.Cells tillhandahåller [**Range.merge()**](https://reference.aspose.com/cells/javascript-cpp/range/#merge--)-metoden för att slå samman cellerna i området. Följande exempel visar hur man slår samman de individuella cellerna i ett namngivet område.
