---
title: Radera områden med JavaScript via C++
linktitle: Radera områden
type: docs
weight: 105
url: /sv/javascript-cpp/delete-ranges-from-Excel/
description: Lär dig hur du tar bort områden i Excel och skiftar celler till vänster eller uppåt med Aspose.Cells for JavaScript via C++.
---
...
## **Radera områden med Aspose.Cells for JavaScript via C++**  

Aspose.Cells tillhandahåller metoden [Cells.deleteRange(number, number, number, number, ShiftType)](https://reference.aspose.com/cells/javascript-cpp/cells/#deleteRange-number-number-number-number-shifttype-) för att ta bort ett område.  

## **Radera områden och flytta celler åt vänster**  

Ta bort ett område och flytta celler till vänster som följande kodexempel med Aspose.Cells for JavaScript via C++:  
...
Ta bort ett område och flytta celler uppåt som följande kodexempel med Aspose.Cells for JavaScript via C++:  
