---
title: Kopiera områden av Excel med JavaScript via C++
linktitle: Kopiera områden
type: docs
weight: 105
url: /sv/javascript-cpp/copy-ranges-of-Excel/
---
...
## **Kopiera områden med Aspose.Cells for JavaScript via C++**

Aspose.Cells for JavaScript via C++ erbjuder några överlagrade [Range.copy(Range, PasteOptions)](https://reference.aspose.com/cells/javascript-cpp/range/#copy-range-pasteoptions-) metoder för att kopiera området. Och [Range.copyStyle(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyStyle-range-) kopierar endast stilen för området; [Range.copyData(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyData-range-) kopierar endast värdet i området.
...
Aspose.Cells for JavaScript via C++ stöder att klistra in området med specifika typer.
...
## **Fortsatta ämnen**
- [Kopiera radhöjder från källspann till destinationspann](/cells/sv/javascript-cpp/copy-row-heights-of-source-range-to-destination-range/)
