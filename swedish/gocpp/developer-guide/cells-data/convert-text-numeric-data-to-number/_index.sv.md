---
title: Konvertera text numeriska data till nummer med Golang via C++
linktitle: Konvertera numerisk textdata till nummer
type: docs
weight: 900
url: /sv/go-cpp/convert-text-numeric-data-to-number/
...
Aspose.Cells tillhandahåller metoden [**Cells.ConvertStringToNumericValue()**](https://reference.aspose.com/cells/go-cpp/cells/convertstringtonumericvalue/) som kan användas för att konvertera all text- eller strängnumriska data till nummer.

Följande skärmdump visar strängnumren i cellerna **A1:A17**. Strängnumren är vänsterjusterade.
<br>
<img src="5.png" width=70% />

Dessa strängnummer har konverterats till nummer med [**Cells.ConvertStringToNumericValue()**](https://reference.aspose.com/cells/go-cpp/cells/convertstringtonumericvalue/) i följande skärmdump. Som du kan se är de nu högerjusterade.
<br>
