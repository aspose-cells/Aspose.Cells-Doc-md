---  
title: Excel – R1C1 referensstil vs. A1 med Golang via C++  
linktitle: Excel – R1C1 Referenstyp mot A1  
type: docs  
weight: 30  
url: /sv/go-cpp/r1c1-reference-style-vs-a1/  
description: R1C1 referensstil kontra A1 stil genom att använda Aspose.Cells med Golang via C++.  
keywords: R1C1 Referensstil VS. A1 stil, R1C1 Referensstil, Hur man växlar mellan R1C1 Referensstil och A1 Referensstil, A1 Referensstil.  
---  
...
Detta är den standardreferensstil i Excel. I A1-stil identifieras kolumner av bokstäver (A, B, C, ..., Z, AA, AB, ..., ZZ, AAA, AAB, ...), och rader av siffror (1, 2, 3, ...). Till exempel är cellen i den första kolumnen och andra raden kallad A2.
...
Till exempel är R[2]C[3] en cell 2 rader ned och 3 kolumner åt höger. R[-1]C[-4] är en cell 1 rad upp och 4 kolumner till vänster. Om inget nummer visas i parentesen hänvisar du till samma rad eller kolumn, dvs R[3]C kommer att vara en cell 3 rader under den aktuella i samma kolumn.  
<br>  
