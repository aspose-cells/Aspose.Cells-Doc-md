---
title: Hur man roterar texten i cellen med Golang via C++
linktitle: Hur man roterar text i en cell
type: docs
weight: 80
url: /sv/go-cpp/how-to-rotate-text-of-cell/
...
[**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/)-egenskapen gör det bekvämt att rotera celler. För att rotera celler i Aspose.Cells måste du följa dessa steg:
