---
title: Hämta en lista över typsnitt som används i ett kalkylblad eller arbetsbok med Golang via C++
...
type: docs
weight: 20
url: /sv/go-cpp/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/
---
...
Aspose.Cells tillhandahåller metoden [**Workbook.GetFonts**](https://reference.aspose.com/cells/go-cpp/workbook/getfonts/) som returnerar en lista över alla de typsnitt som används i din arbetsbok eller kalkylblad.
