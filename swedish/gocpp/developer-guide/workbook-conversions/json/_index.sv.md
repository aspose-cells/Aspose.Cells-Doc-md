---
title: Konvertera arbetsbok till JSON med Golang via C++
linktitle: Konvertera arbetsbok till JSON
type: docs
weight: 300
url: /sv/go-cpp/convert-workbook-to-json/
...
Följande kodexempel visar hur man exporterar det aktiva arbetsbladet till JSON med hjälp av [**SaveFormat::Json**](https://reference.aspose.com/cells/go-cpp/saveformat/) enum-medlem. Se koden för att konvertera [källfilen](book1.xlsx) till [utdata JSON-fil](book1.json) som genereras av koden för referens.
