---
title: Diagramtyper med Golang via C++
linktitle: Diagramtyper
description: Lär dig om de olika diagramtyper som stöds av Aspose.Cells for C++. Vår guide visar dig de olika typerna av diagram som finns och hur du skapar och ändrar dem för att förbättra dina kalkylblad.
keywords: Aspose.Cells for C++, diagram, diagramtyper, stöds, skapande, ändring, kalkylblad.
type: docs
weight: 5
url: /sv/go-cpp/chart-types/
---

## **Introduktion**
Ett diagram är en visuell presentation av information. Aspose.Cells gör det möjligt för utvecklare att visualisera information i diagram precis som Microsoft Excel. Att presentera information i diagram är alltid till hjälp för beslutsfattare att fatta snabba och rättvisa beslut. Det är enklare att snabbt se jämförelser, mönster och trender i data med diagram än med råa siffror. Att skapa diagram i realtid baserat på data i ett kalkylblad är en av Aspose.Cells mest kraftfulla funktioner.
...
Datamarkörer används för att representera datapunkter, de enskilda värdena som plottas i ett diagram. Datamarkörer av samma färg utgör en data serie.
...
Tratt-digrammet stöds i Aspose.Cells.
