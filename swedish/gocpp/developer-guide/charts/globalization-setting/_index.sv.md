---
title: Konvertera diagram till lokaliserad bild med Golang via C++
description: Lär dig hur du ställer in globaliseringskonfigurationer för diagram med hjälp av Aspose.Cells for C++. Vår guide visar hur man konfigurerar diagrammet för att stödja flera språk och regionala format för att korrekt visa text, datum och nummer på olika språk.
keywords: Aspose.Cells for C++, Diagram, Globaliseringsinställningar, Flera språk, Regionala format, Visning, Text, Datum, Nummer.
linktitle: Ställ in lokaliserad region
type: docs
weight: 50
url: /sv/go-cpp/convert-chart-to-localized-image/
...
När du öppnar en xlsx-fil med ett diagram i Excel, i detta fall, anta att du öppnar den med spanska regionala inställningar i Excel, kan du se elementen i diagramområdet, som Diagramtitel och Legend, översatta till spanska. Men när du sparar detta diagram som en bild med Aspose.Cells kan du stöta på följande problem: 
