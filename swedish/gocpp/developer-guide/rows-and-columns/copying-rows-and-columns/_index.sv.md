...
type: docs
weight: 20
url: /sv/go-cpp/copying-rows-and-columns/
---
...
Aspose.Cells tillhandahåller CopyColumn-metoden i ICells-klassen, denna metod kopierar all typ av data, inklusive formler - med uppdaterade referenser - och värden, kommentarer, cellformat, dolda celler, bilder och andra ritobjekt från källkolumnen till målkolumnen.
