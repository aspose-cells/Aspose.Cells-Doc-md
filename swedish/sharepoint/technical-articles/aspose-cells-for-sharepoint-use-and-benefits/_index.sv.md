...
{{% /alert %}} 
### **En kort notering om SharePoint-dokumentbibliotek**
Innehållet på SharePoint-webbplatser är i form av dokument som delas på en centraliserad plats som kallas SharePoint-dokumentbibliotek (ibland känt som ett "delat dokumentbibliotek"). Auktoriserade användare kan ladda upp dokument från sin lokala dator till SharePoint-webbplatsen. Dessa dokument lagras i binärt format i en SQL Server-databas som används av SharePoint-webbplatsen. Dokument blir tillgängliga för andra SharePoint-användare i form av en lista med hyperlänkar som visas nedan:

**Ett dokumentbibliotek** 
...
1.  När konverteringen är klar visas ett framgångsmeddelande.

   **Lyckad konvertering** 



1.  Klick**Lämna tillbaka** för att komma tillbaka till dokumentbiblioteket.
1.  Det konverterade dokumentet listas i SharePoint-dokumentbiblioteket.

   **Den konverterade filen listas i dokumentbiblioteket** 
