---
title: Konvertera en fil
type: docs
weight: 10
url: /sv/sharepoint/convert-one-file/
---
{{% alert color="primary" %}} 

 En av de vanligaste uppgifterna som användare använder Aspose.Cells för är att konvertera enskilda filer.
...
1.  Välj**Konvertera med Aspose.Cells.SharePoint** i dokumentets redigeringskontrollblock (ECB).
   ...
   **Välj "Konvertera via Aspose.Cells" i dokumentets ECB** 

![todo:image_alt_text](convert-one-file_1.png)



Skärmen för konverteringsinställningar visas. Här kan du finjustera konverteringen:
...
**Skärmen Konverteringsinställningar för en filkonvertering** 
