---  
title: Ange sidalternativ med Node.js via C++  
linktitle: Inställning av sidalternativ  
type: docs  
weight: 10  
url: /sv/nodejs-cpp/setting-page-options/  
description: Denna artikel tillhandahåller exempel på kod för att programmässigt ställa in sidalternativ för Excel ark med Node.js via C++. Ställ in sidorientering, skalningsfaktor, anpassning till sidor, papperstorlek, utskriftskvalitet, första sidnumret.  
keywords: ställ in Excel sidorientering med node.js via C++, ställ in skalningsfaktor för Excel med node.js via C++, ställ in pappersstorlek för Excel ark med node.js via C++  
---  
...
Klassen [**Worksheet**](https://reference.aspose.com/cells/nodejs-cpp/worksheet) erbjuder egenskapen [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) som används för att ställa in sidinställningsalternativ för arbetsbladet. Faktum är att egenskapen [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) är ett objekt av klassen [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) som används för att ställa in olika sidlayouter för ett utskrivet arbetsblad. Klassen [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) tillhandahåller olika egenskaper för att ställa in sidinställningar. Några av dessa egenskaper diskuteras nedan.  

### **Sidorientering**  

Sidorienteringen kan ställas in till porträtt eller landskap med hjälp av [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup)s [**getOrientation()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getOrientation--)-egenskap. [**getOrientation()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getOrientation--)-egenskapen accepterar ett av de fördefinierade värdena i [**PageOrientationType**](https://reference.aspose.com/cells/nodejs-cpp/pageorientationtype)-uppräknelsen, listade nedan.  
...
Det är möjligt att minska eller förstora storleken på ett arbetsblad genom att justera skalningsfaktorn med [**PageSetup.getZoom()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getZoom--)-egenskapen.  
...
Ställ in pappersstorleken som arbetsbladen ska skrivas ut till med hjälp av [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup)-klassens [**getPaperSize()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPaperSize--)-egenskap. [**getPaperSize()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPaperSize--)-egenskapen accepterar ett av de fördefinierade värdena i [**PaperSizeType**](https://reference.aspose.com/cells/nodejs-cpp/papersizetype)-uppräknelsen, listade nedan.  
...
Ställ in utskriftskvaliteten för arbetsbladen att skriva ut med hjälp av [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup)-klassens [**getPrintQuality()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintQuality--)-egenskap. Enheten för utskriftskvalitet är punkter per tum (DPI).  
...
Börja numrera arbetsbladets sidor med hjälp av [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup)-klassens [**getFirstPageNumber()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFirstPageNumber--)-egenskap. [**getFirstPageNumber()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFirstPageNumber--)-egenskapen sätter sidnummer för den första arbetsbladssidan, och de följande numreras i stigande ordning.  
