...
type: docs
weight: 30
url: /sv/nodejs-cpp/r1c1-reference-style-vs-a1/
description: R1C1 referensstil VS. A1 stil genom att använda Aspose.Cells for Node.js via C++.
keywords: R1C1 referensstil VS. A1 stil Node.js via C++, R1C1 referensstil Node.js via C++, Hur man växlar mellan R1C1 referensstil och A1 referensstil Node.js via C++, A1 referensstil Node.js via C++.
---
