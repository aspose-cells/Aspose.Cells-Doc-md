...
description: Lär dig hur du använder Aspose.Cells for Node.js via C++ för att hämta ikonset, datastaplar och färgskalobjekt i villkorsstyrd formatering från kalkylbladsfiler.  
keywords: Aspose.Cells, Villkorsstyrd formatering, Ikonuppsättning, Datastapel, Färgschema, Kalkylblad, Node.js via C++  
type: docs  
weight: 10  
url: /sv/nodejs-cpp/get-icon-sets-data-bars-or-color-scales-objects-used-in-conditional-formatting/  
---  
