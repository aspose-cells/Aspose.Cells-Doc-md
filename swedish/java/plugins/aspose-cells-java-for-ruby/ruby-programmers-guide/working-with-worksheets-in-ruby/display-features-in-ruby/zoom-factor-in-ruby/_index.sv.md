...
För att ställa in zoomfaktor med **Aspose.Cells Java för Ruby**, helt enkelt använd **ZoomFactor**-modulen.
...
Ladda ner **Zoom-faktor (Aspose.Cells)** från någon av nedan nämnda sociala kodbaser:
