---
title: Hantera dokumentegenskaper i Ruby
type: docs
weight: 90
...
För att lägga till anpassade dokumentegenskaper med Aspose.Cells Java för Ruby, ring**add_custom_property** metod för**Dokumentera** modul.
...
{{< /highlight >}}
## **Aspose.Cells - Ta bort anpassade egenskaper**
 För att ta bort anpassade dokumentegenskaper med Aspose.Cells Java för Ruby, ring**remove_custom_property** metod för**Dokumentera** modul.
