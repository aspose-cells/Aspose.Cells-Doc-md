...
**Aspose.Cells Java för Eclipse (Maven)** plugin kan enkelt installeras från Available**Plugin** fliken i dialogrutan Plugin.

- För att öppna den, välj**Plugins**från**Verktyg** menyn i Eclipse.
...
1. Förse**Projektnamn, Plats, GroupId, ArtifactId**och**Version**för ditt Maven-projekt och klicka**Avsluta.**
...
För att använda exempel, bara:

1. Klick**Nytt -> Annat** i**Förmörkelse**.
1. Välj**Aspose.Cells Kodexempel**i**Java**kategori.
1. Klick**Nästa**.  

![todo:image_alt_text](example_1.png)

1.  Välj ditt projekt och expandera sedan trädet för att välja**Kodexempel** kategori och klicka**Avsluta**.
