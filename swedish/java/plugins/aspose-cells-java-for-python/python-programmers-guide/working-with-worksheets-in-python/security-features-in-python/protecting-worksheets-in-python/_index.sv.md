...
För att skydda ett arbetsblad med **Aspose.Cells Java för Python**, anropa metoden **protect_worksheet** inom modulen **protection**.
...
Ladda ner **Skydda arbetsblad (Aspose.Cells)** från någon av de nedan angivna sociala kodningssidorna:
