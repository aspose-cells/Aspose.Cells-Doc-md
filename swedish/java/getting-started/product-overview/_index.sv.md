...
{{% /alert %}} 
## **Produktbeskrivning**
Aspose.Cells kan användas med alla typer av applikationer, oavsett om det är Java Web Application eller en Java Desktop Application. Dessutom kan biblioteket också användas med vissa andra lösningar som PHP etc. Aspose.Cells tillhandahåller demos och fungerande exempel skrivna i Java för att utvecklare ska få en bättre förståelse av funktionerna som exponeras av komponenten.
...
Dessutom finns det också ett antal unika funktioner som utvecklarna bara kan hitta i Aspose.Cells såsom stöd för CSV- och SpreadsheetML-format, lägga till kopian av ett befintligt kalkylblad (med fullständigt innehåll, bilder och diagram etc.) till en fil, ställa in gradientbakgrund för diagram via API, skapa kommentarer, autofilter och sidbrytningar genom API, ställa in komplexa formler, stödja villkorlig formatering, stödja skyddsalternativ som introducerats i Microsoft Excel XP eller högre, manipulera namngivna intervall, lokalisera API:er, stödja anpassade diagram API och formelberäkningsmotor etc.
## **Dokumentfunktioner**
