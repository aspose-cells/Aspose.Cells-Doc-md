...
type: docs
weight: 40
url: /sv/java/evaluation-version-limitations/
description: Den här artikeln kan hjälpa dig att förstå hur du kan skaffa utvärderingsversioner och känna till begränsningarna för utvärderingsversioner.
...
Du kan ladda ner en utvärderingsversion av **Aspose.Cells** för Java från [dess nedladdningssida](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) @ Maven-repos. Utvärderingsversionen tillhandahåller exakt samma funktionalitet som den licensierade versionen av produkten. Dessutom blir utvärderingsversionen helt enkelt licensierad när du köper en licens och lägger till ett par rader kod för att tillämpa licensen.
...
I den utdata-PDF eller bildfilen av Aspose.Cells kommer en utvärderingsvattenstämpel att klistras in överst på dokumentet/bilden.
<br>
