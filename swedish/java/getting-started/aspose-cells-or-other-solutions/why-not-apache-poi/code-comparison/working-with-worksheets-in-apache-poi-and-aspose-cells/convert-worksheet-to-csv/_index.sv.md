---
title: Konvertera kalkylblad till CSV
type: docs
weight: 30
...
Om utvecklare behöver spara sina filer till någon lagringsplats kan de enkelt ange filnamnet (med dess fullständiga lagringsväg) och önskat filformat (genom att använda **FileFormatType**-uppräkningen) medan de anropar **spara**-metoden i **Workbook**-objektet.
...
{{< /highlight >}}
## **Apache POI SS - HSSF & XSSF - Konvertera kalkylblad till CSV**
Nedan visas hur kalkylblad kan konverteras till CSV med hjälp av Apache POI HSSF och XSSF API jämfört med Aspose.Cells Java API.
...
Ladda ner **Konvertera kalkylblad till CSV** från någon av nedan angivna sociala kodningssajter:
