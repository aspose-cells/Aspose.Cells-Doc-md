...
{{% alert color="primary" %}}
 ...
 Den här artikeln har tagit upp nyckelpunkterna om varför Aspose-komponenter är ett bättre val än Office-automation. Alla de olika Aspose komponenterna erbjuder en riskfri, ingen förpliktelse[utvärderingsversion](https://products.aspose.com/total/). Vi uppmuntrar dig att dra nytta av den utvärderingen för att bättre se vad Aspose kan göra för dina ansökningar.

För mer information, se följande internetartiklar:

- [Överväganden för Server-Side Automation of Office](https://support.microsoft.com/en-us/topic/considerations-for-server-side-automation-of-office-48bcfe93-8a89-47f1-0bce-017433ad79e2)
