---
title: Lägg till kommentarer i kalkylbladet i xlsx4j
type: docs
weight: 10
url: /sv/java/add-comments-in-spreadsheet-in-xlsx4j/
---
## **Aspose.Cells - Lägg till kommentarer i kalkylark**
...
{{< /highlight >}}
## **xlsx4j - Lägg till kommentarer i kalkylblad**
CommentsPart-klassen är tillgänglig för att lägga till kommentarer i kalkylarket med xlsx4j.
...
{{% alert color="primary" %}} 
 ...
 För mer information, besök[Lägger till kommentarer](/java/adding-comments).
