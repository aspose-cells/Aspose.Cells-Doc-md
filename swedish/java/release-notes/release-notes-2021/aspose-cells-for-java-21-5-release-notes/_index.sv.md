---
title: Aspose.Cells för Java 21.5 Release Notes
type: docs
weight: 8
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för Java 21.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-21.5/).
