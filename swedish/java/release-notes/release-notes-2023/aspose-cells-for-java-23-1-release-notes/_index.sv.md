...
type: docs
weight: 12
url: /sv/java/aspose-cells-for-java-23-1-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells for Java 23.1](https://releases.aspose.com/cells/java/).
