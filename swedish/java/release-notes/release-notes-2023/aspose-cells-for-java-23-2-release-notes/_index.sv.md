...
type: docs
weight: 11
url: /sv/java/aspose-cells-for-java-23-2-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells for Java 23.2](https://releases.aspose.com/cells/java/).
