...
type: docs
weight: 9
url: /sv/java/aspose-cells-for-java-23-4-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells for Java 23.4](https://releases.aspose.com/cells/java/).
