---
title: Aspose.Cells Java 1.8.2.0 Utgivningsinformation om hotfix
type: docs
weight: 30
url: /sv/java/aspose-cells-java-1-8-2-0-hot-fix-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Cells Java 1.8.2.0 Hot Fix](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-java-1.8.2.0-hot-fix/)

{{% /alert %}} 

 Kära kunder,

 Vi har släppt Aspose.Cells for Java V1.8.2!
