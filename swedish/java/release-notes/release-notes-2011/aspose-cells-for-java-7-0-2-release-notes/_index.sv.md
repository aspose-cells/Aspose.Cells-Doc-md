...
{{% /alert %}} 
 ...
 Stöd LightCellsDataProvider för att spara XLSX-filer

 Stöd J2SE7.0 version
 ...
 30504 - Synkronisera värdetyp för egenskapen Cells.StandardHeightPixels

 30738 - Stöd för att ställa in kalkylblad som dolt under körning även om det är det enda bladet i arbetsboken

 29151 - Stöd för gruppering av datafunktion i smarta markörer
...
30733 - Få ett undantag när du använder vetenskapliga värden för Validations formel
 ...
 30477 - "#NA"-värden förlorade i diagram-till-bild-funktionen
 ...
 30777 - Texten centrerades istället för vänster i den resulterande PDF-filen
...
30972 - Innehållet i textrutan återgavs inte korrekt i PDF-filen
 ...
 31007 - Formler visades som "#NAME" i den genererade XLS-filen

 31194 - MROUND-formeln beräknades inte korrekt

 31147 - Formeln beräknades som "#VALUE" -1

 31237 - Formeln beräknades som "#VALUE" -2

 31005 - Parenteser gick förlorade för de negativa värdena i den genererade PDF-filen

 31312 - RUND-formeln beräknades felaktigt
