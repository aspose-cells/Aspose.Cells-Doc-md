...
type: docs
weight: 10
url: /sv/java/aspose-cells-for-java-7-0-3-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Cells for Java 7.0.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.0.3/)

{{% /alert %}} 

 Vi är glada att meddela Aspose.Cells for Java v7.0.3!
...
40015 - Gör biblioteket kompatibelt med webservices-rt.jar
 ...
 40033 - Få ett undantag "Ogiltigt lösenord" när du läser XLSX mallfil
 ...
 40010 - Infogning av rader gör att sammanslagna celler går sönder
...
40014 - Rutnätslinjer visades inte i den genererade bilden för ett ark
 ...
 40024 - Ta bort hyperlänkar när du rensar innehåll för ett cellområde

 40028 - Color.equals() returnerar inte sant när RGB-värdena är desamma

 40031 - SortNames() förstör namngivna intervall

 40032 - Inställning av dataetiketter för sjökortspunkt förlorar ärvda inställningar från seriedataetiketter
