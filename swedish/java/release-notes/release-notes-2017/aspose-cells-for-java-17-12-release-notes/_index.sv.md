...
|CELLSJAVA-42465|Vissa CSS-klassdeklarationer har inte prefixet i utgången HTML|Insekt|
|CELLSJAVA-42456|HTML utdata är inkonsekvent med källan - Excel till HTML konvertering|Insekt|
|CELLSJAVA-42478|Import av långa värden från HSQL DB ger ett undantag|Insekt|
|CELLSJAVA-42466|Ekvationen renderas inte bra i utgången PDF|Insekt|
|CELLSJAVA-42475|Diagram saknas i utgången PDF|Insekt|
|CELLSJAVA-42459|Dataetiketter för diagrammet saknas i utgången PDF/bild|Insekt|
|CELLSJAVA-42453|Diagrambilden är inte likadan Microsoft Excel|Insekt|
|CELLSJAVA-42447|Dataetiketter visas fel i utdatafilformatet HTML|Insekt|
...
|CELLSJAVA-42462|Genom att läsa filen XLSB skapas NullPointerException|Undantag|
