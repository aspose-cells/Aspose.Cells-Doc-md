...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells for Java 17.9](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.9/).

{{% /alert %}} 

|**Nyckel**|**Sammanfattning**|**Kategori**|
|:- |:- |:- |
|CELLSJAVA-42391|Cell bredd som visas i den resulterande PDF är inte densamma som i Excel-filen när du använder funktionen "Visa formel"|Ny funktion|
|CELLSJAVA-42379|Implementera namngiven destination vid rendering till PDF-utgång (bokmärkesfråga)|Ny funktion|
...
|CELLSJAVA-42366|Att spara "2.2 CompleteEmail.html" i formatet XLSX genererar korrupt fil|Insekt|
...
|CELLSJAVA-42378|Stapelfärgen ändrades när Excel konverterades till PDF när setCrossAt() användes|Insekt|
...
|CELLSJAVA-42314|Diagrammet är tomt i utgången PNG|Insekt|
|CELLSJAVA-42313|Diagrammet är tomt i utgången PDF|Insekt|
...
- [Kontrollera laddningen av externa resurser i MS Excel Workbook under rendering till PDF](/cells/sv/java/control-loading-of-external-resources-in-ms-excel-workbook-while-rendering-to-pdf/)
