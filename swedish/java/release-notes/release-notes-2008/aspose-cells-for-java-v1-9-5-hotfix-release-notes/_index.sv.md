---
title: Aspose.Cells for Java v1.9.5 Release Notes för snabbkorrigering
type: docs
weight: 10
url: /sv/java/aspose-cells-for-java-v1-9-5-hotfix-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Cells for Java v1.9.5 Snabbkorrigering](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-v1.9.5-hotfix/)

{{% /alert %}} 

 Kära kunder,

 Vi har släppt Aspose.Cells for Java V1.9.5!

 *Vad är nytt?

- Stöder att känna igen Excel-filformat automatiskt för Workbook.open(String) och Workbook.open(InputStream)* Stöder bearbetning av celler i kalkylarksfil i händelsedrivet läge genom att introducera nya API(LightCells)* Stöder för att ta bort formrelaterade objekt, inklusive kommentar, bild och så vidare* Stöder för att kopiera former när du kopierar arbetsbok eller kalkylblad* Stöder för att kontrollera om en cell eller stil är procent eller datum
