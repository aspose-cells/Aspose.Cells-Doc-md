---
title: Aspose.Cells för Java 20.2 Release Notes
type: docs
weight: 50
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för Java 20.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.2/).
