---
title: Aspose.Cells för Java 7.3.2 Release Notes
type: docs
weight: 30
url: /sv/java/aspose-cells-for-java-7-3-2-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Cells för Java 7.3.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.3.2/)

{{% /alert %}} 

Vi är
 glad att kunna meddela Aspose.Cells för Java v7.3.2!

 Nya egenskaper

- Shape.getRight()/getBottom() för att få en förskjutning av formen från det nedre högra hörnet till cellen
- Ställ in kalkylbladsflikfärg till standardfärg

 Förbättringar

- Stäng interna strömmar för att frigöra minnesresurser i PDF-konvertering
- Kopiera Sparklines när du kopierar arbetsblad
...
- Att spara till PDF orsakade ett undantag -II
- Att spara till PDF orsakade ett undantag -III
- Att spara till PDF orsakade ett undantag -IV
