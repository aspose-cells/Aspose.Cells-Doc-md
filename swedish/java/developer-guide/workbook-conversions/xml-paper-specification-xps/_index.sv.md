...
Aspose.Cells använder samma högfientliga sidlayout och renderingsmotor för att producera utdata i alla dess stödda fasta layoutformat, t.ex. PDF, XPS etc.

**Bilderna nedan visar den höga grad av trohet med vilken Aspose.Cells har konverterat ett dokument från XLS till XPS.**
