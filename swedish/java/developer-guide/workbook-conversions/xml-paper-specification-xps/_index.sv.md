...
type: docs
weight: 30
url: /sv/java/xml-paper-specification-xps/
---
...
| :- | :- |
## **XPS i Aspose.Cells**
Vilket som helst dokument som läses in i Aspose.Cells kan konverteras till XPS.

Aspose.Cells använder samma högfidelitativa sidlayout- och renderingsmotor för att producera utdata i alla sina stödda format med fast layout, t.ex. PDF, XPS etc.

**Bilderna nedan visar den höga grad av trohet som Aspose.Cells har konverterat ett dokument från XLS till XPS**
