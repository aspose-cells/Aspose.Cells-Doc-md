...
Se följande exempelkod, dess[källfil för Excel](50528370.xlsx), och dess[utdata PDF-fil](50528369.pdf). Skärmdumpen visar bokmärkena och namngivna destinationer i utdata-PDF-filen. Skärmdumpen beskriver också hur du visar namngivna destinationer och att du behöver en professionell version av Acrobat Reader.
