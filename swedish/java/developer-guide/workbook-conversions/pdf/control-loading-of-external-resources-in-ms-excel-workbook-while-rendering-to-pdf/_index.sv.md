---
title: Kontrollera laddningen av externa resurser i MS Excel Workbook medan du renderar till PDF
type: docs
weight: 40
...
## **Kontrollera laddningen av externa resurser i MS Excel Workbook medan du renderar till PDF**

Följande exempelkod förklarar hur du använder[**PdfSaveOptions.StreamProvider**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#StreamProvider)att kontrollera belastningen av externa resurser och manipulera dem. Vänligen kontrollera[exempel på Excel-fil](50528353.xlsx)används i koden och[mata ut PDF](50528354.pdf)genereras av koden. De[skärmdump](50528357.png)visar hur[gammal extern bild](50528356.png)i exemplet Excel-filen ersattes med en[ny bild](50528355.png)i utdata-PDF.
