...
{{% /alert %}} 
 ...
 Aspose.Cells API:er tillhandahåller[**Pdf Säkerhetsalternativ**](https://reference.aspose.com/cells/java/com.aspose.cells/PdfSecurityOptions)klass för att arbeta med säkerheten för filformatet PDF. Exempelkoden nedan beskriver hur man skapar säkra PDF-filer med Aspose.Cells for Java API.
