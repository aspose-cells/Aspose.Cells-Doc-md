...
- [**TextCrossType. CROSS_BEHÅLL**](https://reference.aspose.com/cells/java/com.aspose.cells/textcrosstype#CROSS_KEEP): Visa strängen som MS Excel exporterar PDF/bild
...
Följande exempelkod läser in exemplet på Excel-filen och sparar den i PDF-/bildformat genom att ange olika[**TextCrossType**](https://reference.aspose.com/cells/java/com.aspose.cells/TextCrossType)Exemplet på Excel-filen och utdatafilerna kan laddas ner från följande länkar:
