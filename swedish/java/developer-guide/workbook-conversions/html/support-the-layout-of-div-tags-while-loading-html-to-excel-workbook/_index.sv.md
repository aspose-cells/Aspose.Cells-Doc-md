...
{{% /alert %}} 
## **Stöd layouten för DIV-taggar när du laddar HTML till Excel-arbetsboken**
 Följande exempelkod illustrerar användningen av[HtmlLoadOptions.SupportDivTag](https://reference.aspose.com/cells/java/com.aspose.cells/htmlloadoptions#SupportDivTag) fast egendom. Vänligen ladda ner[Aspose Logotyp](5473442.png) används inuti ingången HTML och[output excel-fil](5473439.xlsx) genereras av koden.
