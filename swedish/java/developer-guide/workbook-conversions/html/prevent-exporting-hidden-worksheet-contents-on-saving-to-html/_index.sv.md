...
Förutom att kontrollera om du vill exportera dolda kalkylblad eller inte, kan du också konfigurera ytterligare inställningar för att exportera arbetsbok till HTML. Följande artiklar visar andra funktioner som stöds av Aspose.Cells för att exportera arbetsböcker till HTML.

- [Konvertera Excel till HTML med rubriker](/cells/sv/java/convert-excel-to-html-with-headings/)
- [Uteslut oanvända formatmallar under konvertering av Excel till HTML](/cells/sv/java/exclude-unused-styles-during-excel-to-html-conversion/)
- [Exportera kommentarer medan du sparar Excel-fil till HTML](/cells/sv/java/export-comments-while-saving-excel-file-to-html/)
- [Döljer överlagrat innehåll med CrossHideRight samtidigt som du sparar till HTML](/cells/sv/java/hiding-overlaid-content-with-crosshideright-while-saving-to-html/)
