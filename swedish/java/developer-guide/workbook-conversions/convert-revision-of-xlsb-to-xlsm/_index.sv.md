...
Följande skärmdump visar hur .bin-filer har konverterats till .xml-filer när XLSB-filen konverteras till XLSM-format med Aspose.Cells.

![todo:image_alt_text](convert-revision-of-xlsb-to-xlsm_2.png)

Här är koden för att konvertera XLSB-filen till XLSM-format med Aspose.Cells.
