...
{{% alert color="primary" %}}
 ...
 Du kan använda Aspose.Cells för att ställa in AutoRecover-egenskapen för arbetsboken. Standardvärdet för den här egenskapen är**Sann** . När du ställer in den**falsk** en arbetsbok inaktiverar Microsoft Excel automatisk återställning (Autosave) på den Excel-filen.
