---
title: Använder Json data i Smart Markers
type: docs
weight: 30
url: /sv/java/using-json-data-in-smart-markers/
---
...
Aspose.Cells for Java stöder JSON-data i smarta markörer, JSON-data kan vara hierarkiskt inbäddad. Kontrollera [mallfilen](smartmarker.xlsx), [JSON-filen](smartmarker.json) och skärmdumpen av den genererade Excel-filen med följande kod.
...
Aspose.Cells for Java stöder JSON-data i smarta markörer, JSON-data kan vara hierarkiskt inbäddad. Subtotal användes för data statistik i Excel-mallen. Kontrollera [mallfilen](jsonExcelTemplate.xlsx), [JSON-filen](jsonData.json) och skärmdumpen av den genererade Excel-filen med följande kod.
