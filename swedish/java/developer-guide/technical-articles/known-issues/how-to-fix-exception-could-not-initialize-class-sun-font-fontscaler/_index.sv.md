---
title: Hur man fixar undantag - Kunde inte initiera klassen sun.font.FontScaler
type: docs
weight: 40
url: /sv/java/how-to-fix-exception-could-not-initialize-class-sun-font-fontscaler/
---
## **Möjliga användningsscenarier**
Den här artikeln kommer att förklara hur man åtgärdar undantag - Kunde inte initiera klassen sun.font.FontScaler. Undantaget ser ungefär ut som detta
...
## **Systemmiljö**
Systemmiljön kan vara ungefär så här
...
{{< /highlight >}}
## **Möjlig lösning**
Du kommer sannolikt att lösa problemet genom att integrera följande JAR i din klassväg:

- ae-awt.jar
## **Ladda ner länk för ae-awt.jar**
