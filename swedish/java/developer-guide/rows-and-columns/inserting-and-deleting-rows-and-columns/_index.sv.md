...
- [SAMMA_SOM_OVAN](https://reference.aspose.com/cells/java/com.aspose.cells/copyformattype#SAME_AS_ABOVE)Formaterar raden på samma sätt som raden ovan.
- [SAMMA_SOM_NEDAN](https://reference.aspose.com/cells/java/com.aspose.cells/copyformattype#SAME_AS_BELOW): Formaterar raden på samma sätt som under raden.
- [KLAR](https://reference.aspose.com/cells/java/com.aspose.cells/copyformattype#CLEAR): Rensar formateringen.
...
## **Infoga en eller flera kolumner**
