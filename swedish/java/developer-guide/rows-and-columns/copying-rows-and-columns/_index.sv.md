...
Aspose.Cells tillhandahåller metoden [copyRow](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyRow-com.aspose.cells.Cells-int-int-) av [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells) klassen. Denna metod kopierar alla typer av data inklusive formler, värden, kommentarer, cellformat, dolda celler, bilder och andra ritobjekt från källraden till destinationsraden.

Metoden [copyRow](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyRow-com.aspose.cells.Cells-int-int-) tar följande parametrar:
...
Använd denna metod för att kopiera en rad inom ett ark, eller till ett annat ark. Metoden [copyRow](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyRow-com.aspose.cells.Cells-int-int-) fungerar på ett liknande sätt som i Microsoft Excel. Så, till exempel, du behöver inte ange höjden på destinationsraden explicit, det värdet kopieras också.
...
Du kan också kopiera flera rader till en ny destination samtidigt som du använder [**Cells.copyRows**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyRow-com.aspose.cells.Cells-int-int-)-metoden som tar en ytterligare parameter av typ integer för att ange antalet källrader som ska kopieras.
...
Aspose.Cells tillhandahåller metoden [copyColumn](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyColumn-com.aspose.cells.Cells-int-int-) av [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells) klassen, denna metod kopierar alla typer av data, inklusive formler - med uppdaterade referenser - och värden, kommentarer, cellformat, dolda celler, bilder och andra ritobjekt från källkolumnen till destinationskolumnen.

Metoden [copyColumn](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyColumn-com.aspose.cells.Cells-int-int-) tar följande parametrar:

- käll [Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells) objekt,
- källkolumnens index och
- destinationskolumnens index.

Använd metoden [copyColumn](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyColumn-com.aspose.cells.Cells-int-int-) för att kopiera en kolumn inom ett ark eller till ett annat ark.
...
På liknande sätt som [**Cells.copyRows**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyRow-com.aspose.cells.Cells-int-int-)-metoden tillhandahåller också Aspose.Cells API:er metoden [**Cells.copyColumns**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#copyColumns-com.aspose.cells.Cells-int-int-int-) för att kopiera flera källkolumner till en ny plats.
