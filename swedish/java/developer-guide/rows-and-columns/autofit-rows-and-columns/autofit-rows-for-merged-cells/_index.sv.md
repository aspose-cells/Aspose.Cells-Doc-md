...
type: docs
weight: 50
url: /sv/java/autofit-rows-for-merged-cells/
---
{{% alert color="primary" %}}
...
{{% /alert %}}
 ...
 Aspose.Cells stöder den här funktionen genom[**AutoFitterOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/AutoFitterOptions)API. Med denna API är det möjligt att automatiskt anpassa rader i ett kalkylblad inklusive sammanslagna celler.

Efter att ha kört koden anpassar Aspose.Cells rader automatiskt för sammanslagna celler.
...
- [Autopassa rader och kolumner](/cells/sv/java/autofit-rows-and-columns/)
