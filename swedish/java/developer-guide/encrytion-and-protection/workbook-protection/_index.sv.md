...
description: Skydda och avskydda arbetsboksstrukturen för Excel-filer med java-koder. Lås och lås upp Excel- (xlsx, xls, xsb) och Open office calc-filer (ODS) med Aspose.Cells för Java.
---
{{% alert color="primary" %}}
...
## **Skydda arbetsboksstrukturen med Aspose.Cell för Java**
...
## **Avskydda arbetsboksstruktur med Aspose.Cell för Java**
