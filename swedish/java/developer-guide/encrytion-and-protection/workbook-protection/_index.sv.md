...
description: Skydda och avskydda arbetsbokens struktur för Excel filer med hjälp av javakod. Lås och lås upp Excel (xlsx, xls, xsb) och Open office calc (ODS) filer med hjälp av Aspose.Cells for Java.
---
