...
{{% alert color="primary" %}}
 ...
 En digital signatur ger en garanti för att en arbetsboksfil är giltig och att ingen har ändrat den. Du kan skapa en personlig digital signatur genom att använda**SELFCERT** verktyg som levereras med Microsoft Office-paketet eller något annat verktyg. Du kan till och med köpa en digital signatur. När du har skapat eller skaffat en digital signatur måste du bifoga den till din arbetsbok. Att fästa en digital signatur liknar att försegla ett kuvert. Om ett kuvert kommer förseglat har du en viss grad av säkerhet att ingen har manipulerat dess innehåll.

 Aspose.Cells för Java API tillhandahåller[**com.aspose.cells.DigitalSignatureCollection**](https://reference.aspose.com/cells/java/com.aspose.cells/DigitalSignatureCollection) & [**com.aspose.cells.DigitalSignature**](https://reference.aspose.com/cells/java/com.aspose.cells/DigitalSignature) klasser för att signera kalkylbladen samt validera dem.
...
Följande kodavsnitt visar användningen av Aspose.Cells för Java API för att signera ett kalkylblad.
...
Följande kodavsnitt visar användningen av Aspose.Cells för Java API för att validera kalkylarket.
