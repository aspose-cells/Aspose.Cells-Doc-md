...
## **Beräkning av Excel 2016 MINIFS och MAXIFS funktioner**
 Följande exempelkod laddar[exempel på excel-fil](5472586.xlsx) och ringer till[Workbook.calculateFormula()](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#calculateFormula\(\) ) metod för att utföra formelberäkningen via Aspose.Cells och sparar sedan resultaten i[mata ut PDF](5472585.pdf).
## **Exempelkod**
