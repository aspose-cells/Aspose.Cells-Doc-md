...
![todo:image_alt_text](calculation-of-array-formula-of-data-tables_1.png)
 ...
 Om du ändrar värdet på cell B1 till 100 kommer värdena i Data Table som är fyllda med gul färg att bli 120. Exempelkoden genererar[utgång PDF](5472577.pdf) som visar 120 som värden i datatabellen som visas i den här bilden.

![todo:image_alt_text](calculation-of-array-formula-of-data-tables_2.png)

 Här är exempelkoden som används för att generera[utgång PDF](5472577.pdf) från[source excel-fil](5472579.xlsx). Läs kommentarerna för mer information.
