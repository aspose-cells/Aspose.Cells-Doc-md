...
### **Ställa in teckensnittsnamn**
 Använd ett specifikt teckensnitt på text i celler med hjälp av[Font](https://reference.aspose.com/cells/java/com.aspose.cells/Font) föremål[Ange namn](https://reference.aspose.com/cells/java/com.aspose.cells/font#Name)fast egendom.
...
### **Ställ in teckensnitt till fet stil**
 Ställ in text till fetstil genom att ställa in[Font](https://reference.aspose.com/cells/java/com.aspose.cells/Font) föremål[setFet](https://reference.aspose.com/cells/java/com.aspose.cells/font#IsBold) egendom till**Sann**.
...
### **Ställa in teckensnittsstorlek**
 Ställ in teckenstorleken med hjälp av[Font](https://reference.aspose.com/cells/java/com.aspose.cells/Font) föremål[setSize](https://reference.aspose.com/cells/java/com.aspose.cells/font#Size)fast egendom.
...
|[DUBBEL_REKTO](https://reference.aspose.com/cells/java/com.aspose.cells/fontunderlinetype#DOUBLE_ACCOUNTING)|Dubbel redovisningsunderstrykning|
...
### **Ställa in genomstruken effekt på text**
 Överstruken text med[Font](https://reference.aspose.com/cells/java/com.aspose.cells/Font) föremål[setStrikeout](https://reference.aspose.com/cells/java/com.aspose.cells/font#IsStrikeout)fast egendom.
...
### **Ställa in Subscript**
 Gör text upphöjd genom att använda[Font](https://reference.aspose.com/cells/java/com.aspose.cells/Font) föremål[setSubscript](https://reference.aspose.com/cells/java/com.aspose.cells/font#IsSubscript)fast egendom.
...
### **Ställa in Upphöjd**
 Använd upphöjd text på text med[Font](https://reference.aspose.com/cells/java/com.aspose.cells/Font) föremål[setSuperscript](https://reference.aspose.com/cells/java/com.aspose.cells/font#IsSuperscript)fast egendom.
