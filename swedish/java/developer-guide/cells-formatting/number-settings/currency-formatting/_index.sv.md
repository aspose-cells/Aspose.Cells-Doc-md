...
type: docs
weight: 10
url: /sv/java/format-number-to-currency/
description: Den här artikeln introducerar hur man formaterar nummer till valuta med API Aspose.Cells for Java.
...
För att formatera nummer som valuta i Aspose.Cells for Java-biblioteket för att arbeta med Excel-filer kan du applicera valutfomatning till celler programmatiskt. Så här gör du med Aspose.Cells for Java:
