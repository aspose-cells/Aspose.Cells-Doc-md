...
type: docs
weight: 10
url: /sv/java/format-number-to-date/
description: Den här artikeln introducerar hur man formaterar nummer till datum med Aspose.Cells for Java API.
...
För att formatera nummer som datum i biblioteket Aspose.Cells for Java för att arbeta med Excel-filer kan du tillämpa datumformat på celler programmässigt. Så här gör du med Java och Aspose.Cells:
