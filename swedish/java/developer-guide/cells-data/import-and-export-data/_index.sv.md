...
- [**ConvertNumericOrDate**](https://reference.aspose.com/cells/java/com.aspose.cells/jsonlayoutoptions#ConvertNumericOrDate): Hämtar eller ställer in ett värde som indikerar om strängen i JSON ska konverteras till numerisk eller datum.
