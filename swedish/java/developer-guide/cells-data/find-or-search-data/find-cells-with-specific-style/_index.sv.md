...
description: Den här artikeln visar hur du hittar celler med specifik stil med MS Excel och Aspose.Cells för Java API.
...
Ibland måste du hitta cellerna med någon speciell stil. Den här artikeln visar hur du uppnår detta genom att använda Microsoft Excel samt Aspose.Cells för Java API.
...
## Använder Aspose.Cells för Java
 ...
 Aspose.Cells för Java tillhandahåller funktionen för att hitta celler i kalkylblad med någon specifik stil. För detta tillhandahåller API[**FindOptions.setStyle()**](https://reference.aspose.com/cells/java/com.aspose.cells/findoptions#Style) fast egendom.
