...
Aspose.Cells tillhandahåller några överbelastning [Range.Copy](https://reference.aspose.com/cells/java/com.aspose.cells/range) metoder för att kopiera området.
## **Kopiera område**
