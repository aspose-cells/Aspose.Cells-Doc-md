...
Från och med v8.0.0 av Aspose.Cells för Java har vi tillhandahållit minnesanvändningsalternativen för prestandaöverväganden. MemorySetting-egenskapen är nu tillgänglig i klasserna LoadOptions & WorkbookSettings.
### **Exempel**
...
Med Aspose.Cells för Java har metoden getFilterColumnCollection markerats som föråldrad. Det rekommenderas att använda metoden AuotFilter.getFilterColumns istället.
