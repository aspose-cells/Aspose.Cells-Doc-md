...
type: docs
weight: 200
url: /sv/java/how-to-set-print-titles/
description: Den här artikeln visar kod som förklarar hur man ställer in utskriftstitlar med Aspose.Cells biblioteket.
keywords: Skriv ut rader och kolumner upprepade gånger, Java Hur man sätter utskriftstitlar, Sätt och rensa utskriftstitlar med Java, Hur man rensar utskriftstitlar i Java, Hur man lägger till utskriftstitlar med Java, hur man tar bort utskriftstitlar med Java, Hur man sätter utskriftstitlar i Excel, Hur man rensar utskriftstitlar i Excel.
---
...
För att ställa in utskriftstitlar i ett angivet kalkylblad: Ladda först [provfilen](input.xlsx), och du behöver sedan ändra egenskaperna [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) och [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) av [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/)-objektet för det önskade kalkylbladet. Att ställa in dessa egenskaper till ett områdesträng kommer att ställa in utskriftstitlarna.
...
För att rensa utskriftstitlar i ett specificerat kalkylblad: Ladda först [provfilen](input.xlsx), och du behöver sedan ändra egenskaperna [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) och [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) av [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/)-objektet för det önskade kalkylbladet. Att ställa in dessa egenskaper till en tom sträng rensar utskriftstitlarna.
