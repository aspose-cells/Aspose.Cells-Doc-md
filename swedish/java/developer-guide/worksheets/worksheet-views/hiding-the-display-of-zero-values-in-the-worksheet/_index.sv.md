...
type: docs
weight: 250
url: /sv/java/hiding-the-display-of-zero-values-in-the-worksheet/
---

{{% alert color="primary" %}} 

Ibland behöver du dölja nollvärden i en kalkyl. Det kan vara personlig preferens eller en formateringsstandard.
...
1. Klicka på **OK**.
   ...
   **Dölja nollvärden i Microsoft Excel** 
