...
type: docs
weight: 10
url: /sv/java/how-to-manage-pivotchart-with-pivotoptions/
...
Genom att använda Aspose.Cells kan du använda [**PivotOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/pivotoptions/) för att hantera PivotChart.
