...
description: Lär dig hur man skapar en solursdiagram i Aspose.Cells for Java, en diagram som presenterar data i en cirkel. Vår guide hjälper dig att konfigurera olika egenskaper och formatering av ditt diagram, inklusive datamärken, legender, färger och mer.
keywords: Aspose.Cells for Java, solursdiagram, skapa, ställ in egenskaper, datamärken, legend, format, färg, cirkel, datavisning.
type: docs
weight: 162
url: /sv/java/creating-sunburst-chart/
---
