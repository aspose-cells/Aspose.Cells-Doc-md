...
|CELLSJAVA-41848|Vissa dataetiketter saknas vid rendering av diagram till bild|Insekt|
|CELLSJAVA-41850|CellsException: Cell har tagits bort: D9 med MemorySetting.MEMORY_PREFERENCE|Undantag|
|CELLSJAVA-41844|Undantag: "Shape to image Error !" när du renderar ett kalkylblad till bild|Undantag|
...
Den används för att beräkna given formel direkt med användarens anpassade alternativ.
...
### **Lägger till åsidosättningsmetoden Cells.DeleteBlankColumns(DeleteOptions-alternativ) och Cells.DeleteBlankColumns(DeleteOptions-alternativ).**
...
### **Lägger till egenskapen HTMLLoadOptions.SupportDivTag**
 Anger om stöd för layouten av<div> taggen när HTML-filen innehåller<div> tags.Standardvärdet är false.
