...
type: docs
weight: 10
url: /sv/java/aspose-cells-for-android-via-java-16-12-0-release-notes/
---
...
Lägg till en XmlMap genom url/sökväg till en xml-fil.
### **Lägger till metoden ShapeCollection.AddWordArt() och PresetWordArtStyle enum.**
Lägger till förinställd WordArt sedan Excel 2007.
...
### **Lägger till metoden Cells.LinkToXmlMap(strängmappnamn, int rad, int kolumn, strängsökväg).**
...
Hämtar och ställer in den absoluta sökvägen till filen. Endast för externa länkar.
...
### **Tar bort föråldrade Cell.GetConditionalStyle()-metoden.**
