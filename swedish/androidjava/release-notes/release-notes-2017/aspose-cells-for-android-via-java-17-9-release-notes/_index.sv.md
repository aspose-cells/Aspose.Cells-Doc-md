...
|CELLSJAVA-42379|Implementering av namngiven destination vid rendering till PDF-utdata (bokmärkesfråga)|Ny funktion|
...
|CELLSJAVA-42308|Pivottabellproblem (saknade rader, pivotfältsrubriker utskrivna två gånger, datum konverterat till numeriska värden, etc.) för HTML-rendering|Insekt|
|CELLSJAVA-42298|Extra tecken som finns i HTML-utdata från Excel-fil|Insekt|
|CELLSJAVA-42277|Bilden visas inte i utdata-HTML när HtmlSaveOptions.setExportHiddenWorksheet är inställt på false|Insekt|
...
|CELLSJAVA-42301|Staplar saknas i stapeldiagrammets PDF-utdata|Insekt|
|CELLSJAVA-42293|Diagrambilden är fel i utdata-HTML|Insekt|
...
|CELLSJAVA-42252|Felaktig Y-axelskalning i utdata-PDF|Insekt|
...
|CELLSJAVA-42364|Dataetiketter från cellområdet kommer inte när de exporteras till Pdf|Insekt|
|CELLSJAVA-42359|Dataetiketter saknas för en serie som har stapelvärden som 100|Insekt|
|CELLSJAVA-42314|Diagram är tomt i utdata-PNG|Insekt|
...
|CELLSJAVA-42307|Undantag: "Radindexet ska inte finnas i den vridbara rapporten" inträffade vid rendering till HTML-filformat|Undantag|
|CELLSJAVA-42285|Undantag: "Radindex kan inte vara negativt" inträffade om det finns en pivottabell i kalkylbladet som ska konverteras till HTML-filformat|Undantag|
|CELLSJAVA-42318|Ett undantag skapas när du försöker öppna Workbook|Undantag|
|CELLSJAVA-42311|Undantag: "java.lang.NullPointerException" när en ODS-fil öppnas via Aspose.Cells API:er|Undantag|
