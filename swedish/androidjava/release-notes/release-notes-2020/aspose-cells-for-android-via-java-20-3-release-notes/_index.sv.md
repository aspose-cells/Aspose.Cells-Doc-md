...
Indikerar om ogiltiga data ska kontrolleras när filerna laddas.
### **Lägg till egenskapen LoadFilter.SheetsInLoadingOrder**
Användare kan åsidosätta den här egenskapen för att ange arken och ordningen som ska laddas när arbetsboken importeras från en mallfil.
