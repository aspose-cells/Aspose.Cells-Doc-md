...
|CELLSJAVA-43288|Den resulterande XLSB-filen är korrupt när filen sparas till XLSB|Insekt|
...
Detta gränssnitt orsakar ibland oklarheter och missförstånd för användarna. Användaren bör istället använda AbstractCalculationEngine som ger mer bekväma och flexibla API:er för att manipulera anpassade funktioner.
...
### **Lägger till metoden Cells.RemoveDuplicates().**
 ...
 Överbelastad metod för**Cells.RemoveDuplicates(...)** för användarens bekvämlighet att ta bort dubblerade rader i hela arket.
...
Indikerar om strukturen och fönstret är skyddade med lösenord.
...
### **Föråldrad Filter.Visibledropdown-egenskap.**
 ...
 Använda sig av**FilterColumn.IsDropdownVisible** istället.

### **Lägger till CopyOptions.KeepMacros-egenskapen.**

Anger om macorerna behålls i målarbetsboken. Det fungerar bara när den ursprungliga arbetsboken inte innehåller makron.
