---
title: Inställa villkorlig formatering för rapportobjekt
type: docs
weight: 30
url: /sv/reportingservices/setting-conditional-formatting-for-report-item/
---

För att ställa in villkorlig formatering för rapportobjekt:

1. Skapa och öppna en rapportdefinitionsfilsfil i Microsoft Excel.
   (För detta artikeländamål använder vi testfallet (Company Sales 2008.rdl).
1. Välj Sale-innehavare 
...
1. Välj cell I6 och lägg till villkorlig formatering för denna cell för tabellrapportobjektet. 
...
1. Lägg till villkorlig formatering för denna cell för matrisrapportobjektet eller textboxrapportobjektet. 
