...
type: docs
weight: 70
url: /sv/reportingservices/evaluate-aspose-cells/
---
{{% alert color="primary" %}}

 Du kan enkelt ladda ner Aspose.Cells for Reporting Services för utvärdering från[nedladdningssida](https://downloads.aspose.com/cells/reportingservices) . Nedladdningen av utvärderingen är densamma som den köpta nedladdningen. Utvärderingsversionen blir helt enkelt licensierad efter[ansöker om en licens](/cells/sv/reportingservices/licensing/).
...
**Figur:** Utvärderingsvarning – ett extra arbetsblad
 ...
 Om du vill testa Aspose.Cells for Reporting Services utan begränsningar i utvärderingsversionen kan du[begära en 30-dagars tillfällig licens](https://purchase.aspose.com/temporary-license).
