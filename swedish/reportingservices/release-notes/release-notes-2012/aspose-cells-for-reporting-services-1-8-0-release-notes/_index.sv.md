...
- Pivottabellsfunktion/modul
 är ytterligare optimerad



 Allmän fixering och förbättringar



 Vi har åtgärdat följande interna/allmänna buggar och förbättrat modulerna:



- Herder bakgrundsfärg bugg
- Dölj kolumnproblem
- Rad sammanslagen algoritmmodul
- Problem med sidbrytningar
- Hyperlänk och bokmärkeslänkar buggar
- ETA bugg/problem
- Radalgoritmmodul
- Excel 2007 (endast data) utdata
 insekt
...
- ServerComponent - Generera en XLSX-fil istället för CSV om en användare väljer CSV exporttype
- ServerComponent - Det går inte att exportera en korsfliksrapport till MS Excel 2007
- Serverkomponent - CSV Exportkodningsproblem
