...
För att ta reda på vilken version av Aspose.Cells du använder genom API, använd den statiska metoden CellsHelper-klassen GetVersion för att få Aspose.Cell:s versionsnummer.
