...
Lägg till en kommentar i en cell genom att anropa [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) samlingen [**add**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection/add) metod (inkapslad i [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet) objektet). Det nya [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) objektet kan nås från [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) samlingen genom att skicka kommentarindexet. Efter att ha fått tillgång till [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) objektet, anpassa kommentarnoteringen genom att använda [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) objektets [**note**](https://reference.aspose.com/cells/python-net/aspose.cells/comment/note) egenskap.
...
## **Fortsatta ämnen**
- [Ändra textriktning för kommentaren](/cells/sv/python-net/change-text-direction-of-the-comment/)
- [Hur man ändrar färgen på kommentarsfönstret](/cells/sv/python-net/how-to-change-the-comment-font-color/)
