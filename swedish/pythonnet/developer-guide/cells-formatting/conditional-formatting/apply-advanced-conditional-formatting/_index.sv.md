...
- Datastaplar för visualisering av numeriska värden
- Färgskalor för gradientbaserad cellskuggning
- Ikonsatser för grafiska indikatorer
- Regler för topp/botten
- Tidsperiodbaserad formatering

Detta exempel visar olika avancerade typer av villkorsformatering med Python.NET:
