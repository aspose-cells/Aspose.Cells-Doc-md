...
description: Aspose.Cells är ett Python bibliotek för att bearbeta kalkylbladsfiler, vilket stöder ett brett utbud av nummerformat. Denna artikel ger en lista över stödda nummerformat så att användare kan välja rätt format efter behov.
keywords: Aspose.Cells, Python Excel bibliotek, kalkylblad, nummerformat, lista, stödda
type: docs
weight: 30
url: /sv/python-net/list-of-supported-number-formats/
---

## **Aspose.Cells for Python via .NET**
Aspose.Cells för Python via .NET-komponenten erbjuder några inbyggda nummerformat för att konfigurera visningsformaten för nummer och datum. Dessa inbyggda nummerformat kan tillämpas med hjälp av **Number**-egenskapen i **Style**-objektet. Alla inbyggda nummerformat har unika siffervärden. Utvecklare kan tilldela vilket önskat numeriskt värde som helst till *Number*-egenskapen för **Style** och på så sätt tillämpa visningsformatet. Denna metod är snabbare. De inbyggda nummerformaten som stöds av Aspose.Cells för Python via .NET presenteras nedan:
