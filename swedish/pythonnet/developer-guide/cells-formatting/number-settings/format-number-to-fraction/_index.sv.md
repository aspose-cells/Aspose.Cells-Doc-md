...
type: docs
weight: 10
url: /sv/python-net/how-to-format-number-to-fraction/
description: Den här artikeln introducerar hur man formaterar nummer till bråk med Aspose.Cells för Python via .NET API.
...
## **Hur man formaterar nummer till bråk i Aspose.Cells för Python via .NET**
Formatering av nummer till bråk i Aspose.Cells för Python via .NET är en enkel process. Aspose.Cells för Python via .NET är ett kraftfullt bibliotek som låter dig arbeta med Excel-filer i .NET-applikationer utan att behöva Microsoft Excel installerat. Det ger ett brett utbud av funktioner, inklusive formatering av nummer som bråk.

Här är en steg-för-steg guide om hur du formaterar nummer till bråk i Aspose.Cells för Python via .NET:
