...
type: docs
weight: 10
url: /sv/python-net/format-number-to-date/
description: Denna artikel kommer att introducera hur man formaterar nummer till datum med Aspose.Cells för Python via .NET API.
...
## **Hur man formaterar nummer till datum i Aspose.Cells för Python via .NET**

För att formatera nummer som datum i Aspose.Cells för Python via .NET biblioteket för att arbeta med Excel-filer kan du tillämpa datumformat på cellerna programmässigt. Så här gör du med Python och Aspose.Cells:
