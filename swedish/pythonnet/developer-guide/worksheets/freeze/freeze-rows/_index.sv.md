...
description: I den här artikeln lär du dig hur du låser översta rader i Excel arbetsblad programmässigt med Aspose.Cells för Python via .NET API er.
keywords: Python Excel bibliotek, Python lås översta rader, Python lås översta raden.
---
...
## **Hur man låser rader med Aspose.Cells för Python Excel-bibliotek**
Det är enkelt att låsa rad(er) med Aspose.Cells för Python via .NET. Använd [**Worksheet.freeze_panes**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/freeze_panes/#str-int-int)-metoden för att låsa rad(er) vid den valda raden.
