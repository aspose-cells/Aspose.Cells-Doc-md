...
## **Hur man ställer in utskriftskvalitet**

Ange utskriftskvaliteten för arbetsboken som ska skrivas ut med hjälp av klassens [**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/) [**print_quality**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/print_quality/)-egenskap. Måttenheten för utskriftskvalitet är Dots Per Inches (DPI).
