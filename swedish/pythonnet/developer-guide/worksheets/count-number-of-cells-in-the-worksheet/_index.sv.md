...
type: docs
weight: 110
url: /sv/python-net/count-number-of-cells-in-the-worksheet/
description: I denna artikel kommer du att lära dig hur du programmatiskt räknar antal celler i Excel arket med Aspose.Cells för Python via .NET API.
keywords: räkna antal excel kalkylblads celler c#, excel kalkylblads celler c#
---
