---
title: Hur man hanterar PivotChart med PivotOptions
linktitle: Pivotalternativ
type: docs
weight: 10
url: /sv/python-net/how-to-manage-pivotchart-with-pivotoptions/
description: Hur man hanterar PivotChart med PivotOptions.
keywords: PivotChart
---
## Vad är PivotChart
...
Med Aspose.Cells för Python via .NET kan du använda [**PivotOptions**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/pivotoptions) för att hantera pivottabell.
