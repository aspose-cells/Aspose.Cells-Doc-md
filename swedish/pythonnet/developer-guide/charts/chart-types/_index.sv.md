---
title: Diagramtyper
description: Lär dig om de olika diagramtyper som stöds av Aspose.Cells för Python via .NET. Vår guide går igenom de olika typerna av diagram som finns tillgängliga och visar hur man skapar och modifierar dem för att förbättra dina arbetsblad.
keywords: Aspose.Cells för Python via .NET, diagramatik, diagramtyper, stöd, skapande, modifiering, arbetsblad.
type: docs
weight: 5
url: /sv/python-net/chart-types/
---

## **Introduktion**
Ett diagram är en visuell presentation av information. Aspose.Cells för Python via .NET tillåter utvecklare att visualisera information i diagram precis som Microsoft Excel gör. Att presentera information i diagram underlättar för beslutsfattare att fatta snabba och rätta beslut. Det är enklare att snabbt se jämförelser, mönster och trender i data med diagram än råa siffror. Att skapa diagram i realtid, baserat på data i ett kalkylblad, är en av Aspose.Cells kraftfullaste funktioner.

## **Diagramtyper**
Aspose.Cells för Python via .NET stöder nästan alla diagramtyper som stöds i Microsoft Excel. Diagram kategoriseras i två huvudkategorier:
...
Följande kolumndiagram stöds i Aspose.Cells för Python via .NET:
...
Följande stapeldiagram stöds i Aspose.Cells för Python via .NET:
...
Följande linjediagram stöds i Aspose.Cells för Python via .NET:
...
Följande cirkeldiagram stöds i Aspose.Cells för Python via .NET:
...
Följande spridningsdiagram stöds i Aspose.Cells för Python via .NET:
...
Följande områdediagram stöds i Aspose.Cells för Python via .NET:
...
Följande munkdiagrams stöds i Aspose.Cells för Python via .NET:
...
Följande radardiagram är stödda i Aspose.Cells för Python via .NET:
...
#### **Trattdiagram**
Ett tratt-diagram visar värden över flera stadier i en process. Till exempel kan du använda ett tratt-diagram för att visa antalet försäljningsprospekt i varje steg i en försäljningspipeline. Vanligtvis minskar värdena gradvis, vilket gör att staplarna liknar en tratt.

Följande yskärmen-diagram stöds i Aspose.Cells för Python via .NET:

#### **3D-ytterdiagram**
Liksom andra 3D-diagram är också 3D-ytterdiagram baserade på X-, Y- och Z-axlarna. Dessa diagram är användbara för att visa en variation i variabeln "Z" enligt de andra två variablerna, "X" och "Y".

Följande ytsökningsdiagram stöds i Aspose.Cells för Python via .NET.
...
Följande bubbeldiagram stöds i Aspose.Cells för Python via .NET:
...
Följande aktiediagram stöds i Aspose.Cells för Python via .NET:
...
Följande cylindriska diagram stöds i Aspose.Cells för Python via .NET:

- Simple cylinder chart
- Stacked cylinder chart
- 100% staplad cylinderdiagram
...
Följande konformade diagram stöds i Aspose.Cells för Python via .NET:
...
Följande pyramiddiagram stöds i Aspose.Cells för Python via .NET:
...
Treemap-diagrammet stöds i Aspose.Cells för Python via .NET.
...
Sunburst-diagrammet stöds i Aspose.Cells för Python via .NET.
...
Stapeldiagram och whiskerdiagram stöds i Aspose.Cells för Python via .NET.
