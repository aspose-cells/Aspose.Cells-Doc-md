...
description: Lär dig hur man förstår och arbetar med primära och sekundära axlar i Aspose.Cells för Python via .NET. Vår guide hjälper dig att förstå skillnaderna mellan primära och sekundära axlar, samt hur man konfigurerar och använder dem effektivt i dina diagram.
keywords: Aspose.Cells för Python via .NET, primära axlar, sekundära axlar, förståelse, skillnader, konfiguration, användning.
type: docs
weight: 190
url: /sv/python-net/primary-and-second-axis/
---
