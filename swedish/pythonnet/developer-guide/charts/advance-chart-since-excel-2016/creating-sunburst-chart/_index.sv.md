---
title: Hur man skapar Solifjäderdiagram
description: Lär dig hur du skapar ett solstråle diagram i Aspose.Cells för Python via .NET, ett diagram som presenterar data i en cirkel. Vår guide hjälper dig att ställa in olika egenskaper och formateringar av ditt diagram, inklusive datalabels, legender, färger och mer.
keywords: Aspose.Cells för Python via .NET, solstråle diagram, skapa, ställa in egenskaper, datalabels, legend, formatera, färg, cirkel, data rendering.
type: docs
weight: 162
url: /sv/python-net/creating-sunburst-chart/
---
