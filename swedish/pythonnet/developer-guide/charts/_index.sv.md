...
description: Lär dig hur man använder Aspose.Cells för Python via .NET för att skapa diagram i Microsoft Excel. Vår guide visar de olika typer av diagram som kan skapas, samt hur man anpassar deras utseende och formatering.
keywords: Aspose.Cells för Python via .NET, Diagramskapande, Microsoft Excel, Diagramtyper, Anpassning, Utseende, Formatering.
linktitle: Diagram
type: docs
weight: 130
url: /sv/python-net/creating-charts/
...
Det är möjligt att lägga till olika typer av diagram i kalkylblad med Aspose.Cells för Python via .NET. Aspose.Cells för Python via .NET tillhandahåller många flexibla diagramobjekt. Denna artikel diskuterar Aspose.Cells diagramobjekt.
...
Det är enkelt att skapa ett diagram med Aspose.Cells för Python via .NET med följande exempel:
...
Innan du skapar diagram är det viktigt att förstå några grundläggande koncept som är användbara vid skapande av diagram med Aspose.Cells för Python via .NET.

#### **Diagramobjekt**

Aspose.Cells för Python via .NET tillhandahåller en särskild uppsättning klasser i [**Aspose.Cells.Charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts) namnrymden som används för att skapa de diagram som stöds av Aspose.Cells för Python via .NET. Dessa klasser används för att skapa **diagramobjekt**, vilka fungerar som diagrambyggstenar. Diagramobjekten listas nedan:
...
Lägg till vilken typ av diagram som helst i ett kalkylblad genom att använda [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/charts)-samlingen. Varje objekt i [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/charts)-samlingen representerar ett [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart)-objekt. Ett [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart)-objekt inkluderar alla andra diagramobjekt som krävs för att anpassa diagrammets utseende. Nästa avsnitt visar hur du använder några grundläggande diagramobjekt för att skapa ett enkelt diagram.

### **Skapa diagram med Aspose.Cells för Python via .NET**

**Steg:**

1. Lägg till lite data i kalkylbladsceller med [**Cell**](https://reference.aspose.com/cells/python-net/aspose.cells/cell) objektets [**put_value**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/put_value) metod.
   Detta kommer att användas som datakälla för diagrammet.
1. Lägg till ett diagram i kalkylbladet genom att anropa [**add**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection/add)-metoden för [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection)-samlingen, innesluten i [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet)-objektet.
1. Ange diagramtypen med [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) uppräkningen.
   Till exempel, exemplet nedan använder värdet [**ChartType.PYRAMID**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype/) som diagramtyp.
1. Få tillgång till det nya [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) objektet från [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection) samlingen genom att skicka dess index.
1. Använd något av de diagramobjekt som är kapslade i [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) objekt för att hantera diagrammet.
   Exemplet nedan använder [**SeriesCollection**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/seriescollection) diagramobjektet för att ange diagrammets datakälla.
...
Det är möjligt att skapa många olika typer av diagram med Aspose.Cells för Python via .NET. Alla standarddiagram som stöds av Aspose.Cells för Python via .NET är fördefinierade i en enumeration vid namn [**Aspose.Cells.Charts.ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype).
...
I det ovanstående exemplet skapar enkelt att ändra [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) till *Line* ett linjediagram. Hela källan är förutsatt nedan. när koden körs, läggs ett linjediagram till kalkylarket.

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Charts-ManipulateChart-HowToCreateLineChart-1.py" >}}

#### **Bubbel-diagram**

För att skapa ett bubbeldiagram, måste [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) inställas på [**ChartType.BUBBLE**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) och några extra egenskaper såsom BubbleSizes, värden & X-värden bör ställas in. Genom att utföra följande kod läggs ett bubbel-diagram till kalkylarket.

#### **Linje med Datum Markör Diagram**

För att skapa ett linjediagram med datamarkör, [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) uppsättas till *ChartType.LineWithDataMarkers* och några extra egenskaper såsom bakgrundsområde, Seriemarkör, värden & X-värden bör ställas in. Genom att utföra följande kod läggs ett linjediagram med datamarkör till kalkylarket.

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Charts-CreateLineWithDataMarkerChart-1.py" >}}

## **Fortsatta ämnen**
- [Läs och hantera Excel 2016-diagram](/cells/sv/python-net/read-and-manipulate-excel-2016-charts/)
- [Hantera axlarna för Excel-diagram](/cells/sv/python-net/chart-axes/)
- [Ställa in diagramens utseende](/cells/sv/python-net/setting-chart-appearance/)
- [Diagramtyper](/cells/sv/python-net/chart-types/)
- [Anpassa diagram](/cells/sv/python-net/customizing-charts/)
- [Ställ in datamängd för diagrammet](/cells/sv/python-net/data-formatting-in-charts/)
- [Hantera Dataetiketter för Excel-diagram](/cells/sv/python-net/insert-datalabels-to-chart/)
- [Generera diagram genom att bearbeta Smarta Markörer](/cells/sv/python-net/generate-chart-by-processing-smart-markers/)
- [Hämta kalkylarket för diagrammet](/cells/sv/python-net/get-worksheet-of-the-chart/)
- [Hantera legenden för Excel-diagram](/cells/sv/python-net/chart-legend/)
- [Manipulera Position Size och Designer-diagram](/cells/sv/python-net/manipulate-position-size-and-designer-chart/)
- [Skapa cirkeldiagram med ledarlinjer](/cells/sv/python-net/creating-pie-chart-with-leader-lines/)
- [Former i diagram](/cells/sv/python-net/controls-in-charts/)
