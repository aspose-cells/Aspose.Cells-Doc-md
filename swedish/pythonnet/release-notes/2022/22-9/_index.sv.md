...
type: docs
weight: 8
url: /sv/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 

Detta är den första versionen för Aspose.Cells for Python via .NET.
Den här sidan innehåller utgåvor för Aspose.Cells for Python via .NET 22.9.
...
|CELLSNET-51761|När XLS-filen med pivottabell konverteras till XLSM raderades dataanslutningsdetaljerna|
|CELLSNET-51899|XLS till XLSM konvertering - MS Excel kunde inte öppna utdatafilen XLSM|
...
|CELLSNET-51800|Värden från XLSX är felaktiga i utgången PDF|
...
|CELLSNET-51912|När du konverterar Excel till PDF visar den resulterande PDF inte axeln korrekt|
|CELLSNET-51744|Gridweb fortsätter att hoppa tillbaka|
|CELLSNET-51608|Numret är dolt bakom röd/grön cirkel när du exporterar Excel till HTML på docker (Azure cloud kubernetes)|
...
|CELLSNET-51736| Cell gränser försvann i den resulterande PDF|
...
|CELLSNET-51772|Anslutningsinformationen ändras när XLS-filen konverteras till XLSM|
...
|CELLSNET-51829|XLS till XLSM filkonvertering gjorde att vissa anpassade egenskaper gick förlorade|
|CELLSNET-51830|Indatadokumentström kasseras i förtid efter att du skapat arbetsbok för en viss fil|
|CELLSNET-51865|XLS kalkylblad har inga data medan du kan se fyllda rader i Excel|
|CELLSNET-51880|XLSB till XLSM konvertering - utdatafilen XLSM är skadad|
|CELLSNET-51898|XLS till XLSM konvertering - utdatafilen XLSM är skadad|
...
|CELLSNET-51922|Cell-skyddet går förlorat efter att ha öppnat och sparat XLSX-filen|
