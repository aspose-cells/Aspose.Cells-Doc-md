...
Den här sidan innehåller utgåvor för Aspose.Cells for Python via .NET 22.11.

{{% /alert %}} 

|**Nyckel**|**Sammanfattning**|**Kategori**|
|:- |:- |:- |
|CELLSPYTHONNET-82|Om du sparade en XLSM-fil med ActiveX-kontroller skadades makron i filen|
