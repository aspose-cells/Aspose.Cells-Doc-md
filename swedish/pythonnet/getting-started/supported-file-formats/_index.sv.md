...
|[XLAM](https://docs.fileformat.com/spreadsheet/xlam/)|En Macro-aktiverad Excel-tilläggsfil som används för att lägga till nya funktioner i Excel.| |{{< emoticons/tick >}}|
...
|[Numbers](https://docs.fileformat.com/spreadsheet/numbers/)|Dokumentet är skapat av Apples "Numbers"-applikation som är en del av Apples kontorssvit iWork, en uppsättning applikationer som körs på operativsystemen Mac OS X och iOS.|{{< emoticons/tick >}}||
|[JSON](https://docs.fileformat.com/web/json/)|JavaScript-objektnotation|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[DIF](https://docs.fileformat.com/spreadsheet/dif/)|Datautbytesformat.| |{{< emoticons/tick >}}|
...
|[MARKDOWN](https://docs.fileformat.com/word-processing/md/)|Representerar ett nedskrivningsdokument.| |{{< emoticons/tick >}}|
