...
För att ta reda på vilken version av Aspose.Cells du använder genom API, använd CellsHelper klassens GetVersion statiska metod för att få Aspose.Cells versionnummer.
