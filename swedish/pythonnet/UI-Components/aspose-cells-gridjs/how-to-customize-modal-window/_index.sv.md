---
title: hur man anpassar UI utseendet för modalfönster i GridJs  
type: docs
weight: 250
url: /sv/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Denna artikel beskriver hur man anpassar UI utseendet för modalfönster i GridJs.
keywords: GridJs,anpassa,modal,UI,utseende,visual,fönster
aliases:
aliases:
...
# Modal Stilar Guide för GridJs

## Innehållsförteckning

- [Översikt](#overview)
- [CSS Klassnamn](#css-class-naming)
- [Snabbstart](#quick-start)
- [Vackra stil exempel](#beautiful-style-examples)
- [Tema galleri](#theme-gallery)
...
### Tillgängliga modala namn

| Modal Typ | Namn | CSS Klass |
|------------|------|-----------|
| Sortera | `sort` | `.x-spreadsheet-modal-sort` |
| Validering | `validation` | `.x-spreadsheet-modal-validation` |
| Sök | `search` | `.x-spreadsheet-modal-search` |
| Kontroll | `control` | `.x-spreadsheet-modal-control` |
| Nedladdning | `download` | `.x-spreadsheet-modal-download` |
| E-post | `email` | `.x-spreadsheet-modal-email` |
| InputSuggest | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| InsertURL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| Länk | `link` | `.x-spreadsheet-modal-link` |
| Skriv ut | `print` | `.x-spreadsheet-modal-print` |
| Textrotation | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| Data validering | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| Fler nummerformat | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| Valideringsvarning | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| Infoga/ta bort | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Exempel 2: Minimalistisk ren tema 🤍

Perfekt för professionella och företagsapplikationer.
...
### Exempel 3: Dark Mode Tema 🌙

Bra för applikationer med mörkt läge-stöd.
...
### Exempel 4: Lekfullt färgglatt tema 🌈

Perfekt för kreativa och roliga applikationer.
...
### Exempel 5: Företagsprofessionellt tema 💼

Lämplig för affärs- och företagsanvändning.
