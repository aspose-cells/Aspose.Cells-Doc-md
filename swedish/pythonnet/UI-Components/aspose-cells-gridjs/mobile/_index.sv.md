...
type: docs
weight: 250
url: /sv/python-net/aspose-cells-gridjs/mobile/
description: Denna artikel beskriver hur man använder GridJs på en mobil enhet.
keywords: excel, mobil, kalkylblad, redigerare, mobil kalkylblad, visare
---
...
Kör [demon av GridJs](https://github.com/aspose-cells/Aspose.Cells-for-Python-via-.NET/tree/main/Examples_GridJs_Python_Net "demo av GridJs ")

Du måste komma åt sidan genom IP-sättet på den mobila terminalen http://127.0.0.1:2022 . 
...
Navigera till sidan http://yourip:82/ .
