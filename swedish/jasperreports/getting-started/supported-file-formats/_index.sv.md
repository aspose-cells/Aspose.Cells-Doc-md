...
|[CSV](https://docs.fileformat.com/spreadsheet/csv/)|Sparar dokumentet i filen CSV (kommaseparerat värde).||{{< emoticons/tick >}}|
|[TSV](https://docs.fileformat.com/spreadsheet/tsv/)|Sparar dokumentet i filen TSV (tabbseparerade värden).||{{< emoticons/tick >}}|
|TabDelimited|Sparar dokumentet i tabbavgränsad textfil, samma som filen TSV.||{{< emoticons/tick >}}|
