...
type: docs
weight: 5
url: /sv/php-java/features/
keywords: php, excel, api, feature
description: Aspose.Cells for PHP via Java funktioner
---
## **Aspose.Cells for PHP via Java Funktionsöversikt**
Det här avsnittet ger en jämförelse av tillgängligheten för funktioner mellan Aspose.Cells for Java och Aspose.Cells for PHP via Java.
...
|**Funktion**|**Beskrivning**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
|:- |:- |:- |:- |
...
|**Funktion**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
|:- |:- |:- |
