...
description: Aspose.Cells för PHP via Java-funktioner
---
## **Aspose.Cells för PHP via Java Funktionsöversikt**
Det här avsnittet ger en jämförelse av tillgängligheten för funktioner mellan Aspose.Cells för Java och Aspose.Cells för PHP via Java.
...
|**Funktion**|**Beskrivning**|**Aspose.Cells för Java**|**Aspose.Cells för PHP via Java**|
|:- |:- |:- |:- |
...
|**Funktion**|**Aspose.Cells för Java**|**Aspose.Cells för PHP via Java**|
|:- |:- |:- |
