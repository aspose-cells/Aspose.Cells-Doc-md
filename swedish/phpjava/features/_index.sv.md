...
Den här sektionen ger en jämförelse av tillgänglighet av funktioner mellan Aspose.Cells for Java och Aspose.Cells för PHP via Java.
...
|**Funktion**|**Beskrivning**|**Aspose.Cells for Java**|**Aspose.Cells för PHP via Java**|
| :- | :- | :- | :- |
...
|**Funktion**|**Aspose.Cells for Java**|**Aspose.Cells för PHP via Java**|
| :- | :- | :- |
