...
type: docs
weight: 11
url: /sv/php-java/aspose-cells-for-php-via-java-23-2-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells for PHP via Java 23.2](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.2/).
