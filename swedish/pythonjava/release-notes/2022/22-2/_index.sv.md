...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells for Python via Java 22.2](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.2/).
