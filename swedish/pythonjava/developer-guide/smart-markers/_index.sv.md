---
title: Smart importera och placera data med smarta markörer i Python via java
linktitle: Smarta markörer
type: docs
weight: 190
url: /sv/python-java/using-smart-markers/
description: Smart import och placering av data som följer Excel-mallen med Aspose.Cells for Python via java-biblioteket.
---
## **Introduktion**
...
Det är väldigt enkelt att bearbeta de smarta markörerna. Vad som följer är ett kodavsnitt i Python via Java, som visar hur det görs.
