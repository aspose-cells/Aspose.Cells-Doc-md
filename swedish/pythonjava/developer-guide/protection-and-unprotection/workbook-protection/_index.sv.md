---
title: Skydda och avskydda arbetsboksstruktur
type: docs
weight: 40
url: /sv/python-java/protect-and-unprotect-workbook-structure/
description: Skydda och avskydda arbetsboksstrukturen för Excel-filer med Python-koder.
---
{{% alert color="primary" %}}
...
Aspose.Cells for Python stöder att skydda och avskydda arbetsboksstrukturen för Excel-filer.
{{% /alert %}}


## **Skydda och avskydda arbetsboksstruktur i MS Excel**

**![skydda och avskydda arbetsboksstruktur](protect-and-unprotect-workbook-structure.png)**
...
## **Skydda arbetsboksstrukturen med Aspose.Cell for Python**
...
## **Avskydda arbetsboksstrukturen med Aspose.Cell for Python**
Det är enkelt att avskydda arbetsboksstrukturen med Aspose.Cells API.

{{< gist "aspose-cells-gists" "32e50c6aabc547111966569f3fd39694" "Example-Unprotect-Workbook-Structure.py" >}}

{{% alert color="primary" %}}
Obs: ett korrekt lösenord krävs.
{{% /alert %}}