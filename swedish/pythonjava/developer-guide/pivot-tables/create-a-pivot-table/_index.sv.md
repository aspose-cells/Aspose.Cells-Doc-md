...
1. Lägg till några data till kalkylbladsceller genom att använda[Cell](https://reference.aspose.com/cells/python/asposecells.api/Cell)föremål[satt värde](https://reference.aspose.com/cells/python/asposecells.api/cell#Value)fast egendom. Dessa data kommer att användas som en datakälla för pivottabellen.
