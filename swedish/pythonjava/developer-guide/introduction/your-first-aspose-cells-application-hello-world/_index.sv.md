...
Det här nybörjarämnet visar hur utvecklare kan skapa en enkel första applikation (Hello World) med Aspose.Cells' enkla API. Applikationen skapar en Microsoft Excel-fil med orden Hello World i en specificerad cell i ett kalkylblad.
...
1.  Skapa en instans av**[Arbetsbok](https://reference.aspose.com/cells/python-java/asposecells.api/Workbook)**klass.
1. Använd licensen:
...
1. Få åtkomst till valfri cell i ett kalkylblad i Microsoft Excel-filen.
