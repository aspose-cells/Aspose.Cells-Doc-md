...
Följande kodavsnitt visar användningen av[HtmlSaveOptions](https://reference.aspose.com/cells/python/asposecells.api/HtmlSaveOptions) klass för att exportera Excel-filer till HTML-format.
