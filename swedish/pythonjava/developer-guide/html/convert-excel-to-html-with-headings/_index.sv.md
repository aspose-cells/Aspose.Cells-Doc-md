...
Följande exempelkod visar hur du använder[HtmlSaveOptions.ExportHeadings](https://reference.aspose.com/cells/python/asposecells.api/htmlsaveoptions#ExportHeadings)egenskap för att rendera rubriker i HTML-utdatafilen.
## **Exempelkod**
