...
Genom att använda Aspose.Cells för Python via Java kan du få HTML-strängen från cellen. Detta kan uppnås genom att använda[getHtmlString(boolesk html5)](https://reference.aspose.com/cells/python/asposecells.api/cell#getHtmlString\(boolean\)) metod som tillhandahålls av API:et. Om du passerar**falsk**som en parameter kommer den att returnera normal HTML men om du klarar det**Sann**som en parameter returnerar den HTML5-sträng.
