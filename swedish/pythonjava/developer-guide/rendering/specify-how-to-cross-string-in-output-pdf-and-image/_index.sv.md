...
---
## **Ange hur strängen ska korsas i utdata-PDF och bild**
...
Följande exempelkod läser in exemplet på Excel-filen och sparar den i PDF/Image-format genom att ange en annan TextCrossType. Exemplet på Excel-filen och utdatafilerna kan laddas ner från följande länkar:
