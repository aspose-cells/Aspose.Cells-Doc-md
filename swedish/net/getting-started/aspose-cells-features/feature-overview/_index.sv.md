...
|[.NET Standard 2.0](/cells/sv/net/system-requirements/#net-standard)|Mappen 'netStandard' innehåller assembly att använda med ramverk som implementerar .NET Standard 2.0, såsom .NET Core 2.1/3.1. Den senaste versionen av Aspose.Cells API stöder också .NET 5.0, .NET 6.0, .NET 7.0 och .NET8.0.|
...
|Ställ in utskriftsområde, skriv ut titlar eller aktivera rutnät osv.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
