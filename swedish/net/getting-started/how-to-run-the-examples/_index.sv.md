...
1. NuGet Package Manager installerad i Visual Studio. Det är för det mesta redan installerat i Visual Studio 2015. För detaljer om hur du installerar NuGet-pakethanteraren, se:[Installera NuGet-klientverktyg](https://docs.microsoft.com/en-us/nuget/install-nuget-client-tools)
1.  Gå till Verktyg->Alternativ->NuGet Package Manager->Paketkällor och se till att alternativet**nuget.org** är kontrollerad
1.  Exempelprojekt använder NuGet Automatic Package Restore-funktionen, därför bör du ha en aktiv internetanslutning. Om du inte har en aktiv internetanslutning på maskinen där exempel ska utföras, kontrollera[Installation](/cells/sv/net/installation-and-deployment/) och manuellt lägg till referens till Aspose.Cells.dll i exempelprojektet.
## **Ladda ner från GitHub**
Alla exempel på Aspose.Cells för .NET finns på[GitHub](https://github.com/aspose-cells/Aspose.Cells-for-.NET).
...
-  Vid första körningen kommer beroenden automatiskt att laddas ner via NuGet. Du kan också ladda ner DLL-filerna separat från[här](https://downloads.aspose.com/cells/net).
