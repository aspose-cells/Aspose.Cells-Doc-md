...
## **Använd Aspose.Cells för .NET på Medium Trust Permissions Set**
Du kan följa några rekommendationer för att köra Aspose.Cells för .NET på Medium Trust-nivå eller delad servermiljö:
...
Se följande exempel som visar hur man använder/kör Aspose.Cells för .NET i Medium Trust-läge.
