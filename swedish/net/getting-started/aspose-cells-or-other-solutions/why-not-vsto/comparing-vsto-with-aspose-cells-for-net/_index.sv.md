...
Den här artikeln jämför användningen av VSTO (Visual Studio Tools for Office) med andra metoder för att utveckla Microsoft Office-baserade lösningar. I synnerhet tittar den på Aspose.Cells och ger en jämförelse av hur de två lösningarna fungerar. Artiklarna ger information som utvecklare kan använda för att analysera, jämföra och utvärdera olika alternativ innan de antar en lösning.
...
1. En Microsoft Excel-fil (TempBook.xls) används som mall.
 Arbetsboken innehåller några kalkylblad med några få celler fyllda med data.
1. Exempelkoden placerar 1000*20 poster på det första kalkylbladet i mallens Excel-fil.
 Arbetsbladet är fyllt med konstanta (dummy) data in i cellerna.
