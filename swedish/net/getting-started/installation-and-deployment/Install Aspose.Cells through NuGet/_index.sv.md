---
title: Installera Aspose Cells genom NuGet
type: docs
weight: 30
url: /sv/net/installation/
---
## **Installera Aspose.Cells för .NET genom NuGet**
NuGet är det enklaste sättet att ladda ner och installera Aspose API:er för .NET. Öppna Microsoft Visual Studio och NuGet-pakethanteraren. Sök "aspose" för att hitta önskat Aspose API. Klicka på "Installera", det valda API:et laddas ner och refereras till i ditt projekt.

Obs: Du kan besöka nugets webbsida för aspose.cells för mer information:
...
- Välj**Uppkopplad**från den vänstra menyn och skriv "Aspose.Cells" i sökrutan för att hitta paketet Aspose.Cells .NET.
- Klicka på**Installera**knappen bredvid Aspose.Cells för .NET-posten för att installera den senaste versionen i ditt projekt.
...
### **Refererar till komponenten från ett VS.NET 2010 Client Profile-projekt**
...
- Hitta och välj komponentfilen Aspose.Cells.dll i din installationskatalog, till exempel: .../Program Files/Aspose/Aspose.Cells för .NET/Bin/net_ClientProfile/ **(Se till att du installerade produkten med MSI-installationsprogrammet på din maskin.)**
...
-  I den**Lägg till referens** dialogrutan, välj**.NET-fliken** (valt som standard). Om du har använt MSI-installeraren för att installera Aspose.Cells för .NET, visas Aspose.Cells.GridDesktop och Aspose.Cells.GridWeb i den övre rutan.
...
-  Klick**OK.**
## **Avinstallerar Aspose.Cells för .NET**
Om du har använt MSI-installeraren för att distribuera Aspose.Cells för .NET, följ dessa steg för att helt ta bort komponenten och kontrollerna, tillhörande demonstrationer och dokumentation:

-  Från**Start** menyn, välj**inställningar** , följd av**Kontrollpanel**.
-  Klick**Lägg till/ta bort program**.
- Välj Aspose.Cells för .NET (version).
