---
title: Umbraco Database Data Exporter till Excel
type: docs
weight: 20
...
**Notera:** Umbraco 7 och högre stöds inte i den här utgåvan. Vi ser fram emot att höra din feedback och lägga till support för Umbraco 7 i nästa version.
### **Plattformar som stöds**
Modulen stöds på alla versioner av

- Umbraco 6.0 körs på ASP.NET 4.0
## **Laddar ner**
Du kan ladda ner Aspose .NET Cells Database Data Exporter till Excel för Umbraco-modulen från en av följande platser

- [ Umbraco projekt](https://goo.gl/BPrWm2)
...
## **Videodemo**
 Vänligen kontrollera[videon](https://www.youtube.com/watch?v=MkfKyeLTauE) nedan för att se modulen i aktion.
...
1.  Bläddra till den senaste källkoden som du har laddat ner och öppna**ex Aspose.DatabaseDataExportertoExcel.sln**
