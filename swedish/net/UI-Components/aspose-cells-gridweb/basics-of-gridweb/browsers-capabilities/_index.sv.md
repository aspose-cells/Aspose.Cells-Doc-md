---
title: Webbläsares funktioner
type: docs
weight: 10
url: /sv/net/browsers-capabilities/
---
{{% alert color="primary" %}} 

Aspose.Cells.GridWeb är en GUI-baserad webbkontroll som kan bäddas in i ASP.NET webbformulär som andra webbkontroller som tillhandahålls av Microsoft .NET Framework. Det viktigaste med en webbkontroll är att tillhandahålla stöd för flera webbläsare. Aspose.Cells.GridWeb ger stöd för flera webbläsare.

{{% /alert %}} 
## **Jämförelse**
Aspose.Cells.GridWeb är byggt med Microsoft .NET Framework så det stöds fullt ut på Microsoft:s Internet Explorer (IE). På andra webbläsare har den dock mindre begränsningar. Det här avsnittet ger en detaljerad jämförelse av vilka funktioner som stöds i olika webbläsare.

|**Funktioner på klientsidan** |**Microsoft Internet Explorer** |**Google Chrome** |**Mozilla Firefox** |**Opera** |
|:- |:- |:- |:- |:- |
| Snabbmeny för Cell|{{< emoticons/tick >}}|{{< emoticons/tick >}}|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
