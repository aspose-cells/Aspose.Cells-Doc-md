...
- Ställ in en kontrollåtgärd för att få bilder/formfilers url i kalkylarket, GridJs kommer automatiskt att zippa alla bilder/former i cachen. Det kommer att använda GridCacheForStream.GetFileUrl API.
- Ställ in en kontrollåtgärd för att få filen i cachen, så att vi kan få bilderna/formerna zip-filen eller kalkylarksfilen i cache. Den kommer att använda GridCacheForStream.LoadStream API.
