...
## **Jag använder Aspose.Cells.GridWeb-kontroll på min webbplats med Visual Studio.NET 2005. Men det fungerar inte alls. Vad är problemet?**
 Aspose.Cells.GridWeb stöder båda**Filsystem** och**HTTP** lägen för Visual Studio.NET 2005. Om du fortfarande är förvirrad, ta en titt på en steg-för-steg-guide för att arbeta med Aspose.Cells.GridWeb med Visual Studio.NET 2005.
