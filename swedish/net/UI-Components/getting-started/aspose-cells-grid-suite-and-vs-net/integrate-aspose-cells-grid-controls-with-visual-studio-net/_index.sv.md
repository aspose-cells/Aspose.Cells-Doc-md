...
1. På Visual Studio.NET 2005 väljer du**Välj objekt** från menyn. Dialogrutan Anpassa verktygslådan kommer att visas (denna process är mer eller mindre densamma för nyare VS.NET IDE:er (t.ex. VS.NET 2013/2015 eller senare)).
...
1.  Klick**OK** för att lägga till kontrollerna i Visual Studio.NET Toolbox.

 Aspose.Cells Grid Controls kommer att ha lagts till i verktygslådan**Allmän** flik. Endast GridWeb-kontrollen är inte aktiv. Detta beror på att vi arbetar med en Windows Forms-applikation. GridWeb är endast tillgängligt när du arbetar med webbformulär medan GridDesktop endast kan användas med Windows-formulär.
