...
|**Kontroller**||||
| Lägg till ta bort**Knapp** , **Kryssruta** & **Kombinationsrutan** kontroller i Cells|**X**|||
|**säkerhet**||||
...
## **Förhandsämnen**
- [Aspose.Cells.GridDesktop - Desktop Grid Control](/cells/sv/net/aspose-cells-griddesktop-desktop-grid-control/)
- [Aspose.Cells.GridJs](/cells/sv/net/aspose-cells-gridjs-features/)
- [Aspose.Cells.GridWeb - Web Grid Control](/cells/sv/net/aspose-cells-gridweb-web-grid-control/)
