...
I likhet med ett av våra tidigare ämnen, beskriver detta ämne funktionen att lägga till och infoga rader i kalkylbladen vid körning med API eller Aspose.Cells.GridDesktop. Den grundläggande skillnaden mellan tillägg och infogning är att dessutom läggs en rad till i slutet av radsamlingen i kalkylbladet där som vid infogning kan en rad läggas till på valfri angiven position i kalkylbladet.
