...
Med tanke på att EnableClipboardCopyPaste är falskt och PasteType är All, visar följande skärmdump att när cell B3 kopieras och klistras in i cell C5, kopieras inte cellformateringen och endast innehållet i cell B3 kopieras.

![todo:image_alt_text](copy-paste-behavior-of-enableclipboardcopypaste-and-pastetype-griddesktop-properties_2.png)

Med tanke på att EnableClipboardCopyPaste är sant och PasteType är All, visar följande skärmdump att när cell B3 kopieras och klistras in i cell C5, kopierar den också formateringen av cell B3 till cell C5.
