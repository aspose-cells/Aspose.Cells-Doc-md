...
## **Ta bort blanksteg runt Data**
 ...
 De[**Aspose.Cells.Rendering.SheetRender**](https://reference.aspose.com/cells/net/aspose.cells.rendering/sheetrender)API konverterar ett kalkylblad till en bildfil med valfria attribut, till exempel bildformat, sidnumrerade ark etc. Flera bildformat stöds, inklusive BMP, GIF, JPG, TIFF och EMF.
