...
type: docs
weight: 20
url: /sv/net/modify-existing-sql-data-connection-using-aspose-cells/
---
...
På samma sätt tillhandahåller Aspose.Cells medel att komma åt och ändra dataanslutningar med hjälp av Workbook.DataConnections-samlingen.
