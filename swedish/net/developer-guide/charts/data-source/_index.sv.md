...
description: Lär dig om de olika datakällorna som stöds av Aspose.Cells for .NET. Vår guide går igenom de olika typerna av datakällor som finns tillgängliga och visar dig hur du ansluter och hämtar data från dem för att fylla i dina kalkylblad.
...
---
I våra tidigare ämnen har vi redan gett många exempel för att visa hur du kan ställa in en datakälla för ditt diagram, men i det här ämnet kommer vi att ge mer information om vilka typer av data som kan ställas in för ett diagram.
