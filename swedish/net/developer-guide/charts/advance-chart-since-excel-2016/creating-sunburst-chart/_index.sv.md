...
description: Lär dig hur du skapar ett solfjäderdiagram i Aspose.Cells for .NET, ett diagram som presenterar data i en cirkel. Vår guide hjälper dig att ställa in olika egenskaper och formatering av ditt diagram, inklusive datamarkörer, legenden, färger och mer.
keywords: Aspose.Cells for .NET, solfjäderdiagram, skapa, inställningar, datamarkörer, legend, formatera, färg, cirkel, datavisning.
type: docs
weight: 162
