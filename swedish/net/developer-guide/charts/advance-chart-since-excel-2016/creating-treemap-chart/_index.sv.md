---
title: Hur man skapar TreeMap-diagram
description: Lär dig hur du skapar ett Treemap-diagram i Aspose.Cells for .NET. Vår guide hjälper dig att förstå de olika egenskaperna och formateringsalternativen som finns tillgängliga för Treemap-diagram, inklusive färger, etiketter och datarepresentation.
...
type: docs
weight: 161
url: /sv/net/creating-treemap-chart/
---
...
##  **TreeMap-diagram**
Efter att ha kört koden nedan kommer du att se TreeMap-diagrammet som visas nedan.

![todo:image_alt_text](result.png)
##  **Exempelkod**
 Följande exempelkod laddar[exempel på Excel-fil](treemap.xlsx) och genererar[utdata Excel-fil](out.xlsx).
