...
description: Skapa vattenfallsdiagram i Excel med C# och Aspose.Cells för .NET API.
...
Nedan medföljande kodavsnitt visar användningen av Aspose.Cells för .NET API för att skapa ett vattenfallsdiagram från grunden.
