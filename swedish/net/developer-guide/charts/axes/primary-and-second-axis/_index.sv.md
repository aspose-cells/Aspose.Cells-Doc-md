...
description: Lär dig att förstå och arbeta med primära och sekundära axlar i Aspose.Cells for .NET. Vår guide hjälper dig att förstå skillnaderna mellan primära och sekundära axlar, samt hur du konfigurerar och använder dem effektivt i dina diagram.
keywords: Aspose.Cells for .NET, primära axlar, sekundära axlar, förståelse, skillnader, konfigurering, användning.
type: docs
weight: 190
url: /sv/net/primary-and-second-axis/
---
