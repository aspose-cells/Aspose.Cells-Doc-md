---
title: Konvertera diagram till PDF med önskad sidstorlek
type: docs
weight: 140
url: /sv/net/chart-to-pdf/
---
## **Möjliga användningsscenarier**
Du kan skapa diagram-Pdf med önskad sidstorlek med hjälp av Aspose.Cells och ange hur du vill anpassa diagrammet inuti sidan som topp, botten, mitten, vänster, höger etc. Dessutom kan utdatadiagrammet skapas i stream eller på disk.
