...
type: docs
weight: 280
url: /sv/net/change-character-spacing-of-excel-textbox-or-shape/
---

{{% alert color="primary" %}}

Du kan ändra teckenavståndet för Excel textruta eller form med hjälp av [**FontSetting.TextOptions.Spacing**](https://reference.aspose.com/cells/net/aspose.cells.drawing.texts/textoptions/properties/spacing) egenskapen.
