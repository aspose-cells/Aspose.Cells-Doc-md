...
{{% alert color="primary" %}}
 ...
 Aspose.Cells stöder visning av kulor med HTML-kod. Den här artikeln kommer att förklara hur man visar punkter genom att ställa in cellvärde med HTML. Vi kommer använda[**Cell.HtmlString**](https://reference.aspose.com/cells/net/aspose.cells/cell/properties/htmlstring) egenskap för att ställa in cellvärdet med vår HTML.
