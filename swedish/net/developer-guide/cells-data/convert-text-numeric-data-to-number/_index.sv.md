...
description: Lär dig hur du konverterar siffror lagrade som text i Excel till siffror genom att använda Aspose.Cells för .NET API.
...
## C#-kod för att konvertera sträng numerisk data till faktiska tal
