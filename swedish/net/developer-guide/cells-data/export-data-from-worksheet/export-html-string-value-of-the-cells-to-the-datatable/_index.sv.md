...
## **Exportera HTML-strängvärde för Cells till datatabellen**
 Följande exempelkod illustrerar hur du exporterar HTML-strängvärden för cellerna till DataTable medan du exporterar data från kalkylblad till DataTable. Vänligen se[exempel på Excel-fil](45056025.xlsx), dess skärmdump och konsolutgången för en referens.
## **Skärmdump**
