...
## **Möjliga användningsscenarier**
 ...
 Istället för att justera filter för att visa datum kan du använda en PivotTable Timeline——ett dynamiskt filteralternativ som låter dig enkelt filtrera efter datum/tid och zooma in på den period du vill med en skjutreglage. Microsoft Excel låter dig skapa en tidslinje genom att välja en pivottabell och sedan klicka på*Infoga > Tidslinje*. Aspose.Cells låter dig också skapa tidslinje med hjälp av[**Worksheet.Timelines.Add()**](https://reference.aspose.com/cells/net/aspose.cells.timelines/timelinecollection/methods/index)metod.
