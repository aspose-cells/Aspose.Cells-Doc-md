...
{{% alert color="primary" %}}
 ...
 Aspose.Cells låter dig ladda en lätt version av arbetsboken i minnet för att redigera dess metadatainformation. Vänligen använd[**ArbetsbokMetadata**](https://reference.aspose.com/cells/net/aspose.cells.metadata/workbookmetadata)klass för att ladda arbetsboken.
