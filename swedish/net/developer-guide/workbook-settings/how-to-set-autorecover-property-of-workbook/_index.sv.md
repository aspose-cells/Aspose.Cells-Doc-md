...
{{% alert color="primary" %}}
 ...
 Du kan använda Aspose.Cells för att ställa in AutoRecover-egenskapen för arbetsboken. Standardvärdet för den här egenskapen är**Sann** . När du ställer in den**falsk** i en arbetsbok inaktiverar Microsoft Excel Autoåterställning (Autosave) på den Excel-filen.
