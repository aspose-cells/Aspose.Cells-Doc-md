...
Ibland behöver du läsa och skriva stora Microsoft Excel-filer med en enorm lista med data eller innehåll i kalkylbladet. LightCells API är användbart för att skapa enorma Excel-kalkylblad: med det behöver du mindre minne och få bättre prestanda och effektivitet.
