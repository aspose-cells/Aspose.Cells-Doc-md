...
Utvecklare kan skapa, radera eller läsa sparklines (i mallfilen) med hjälp av API:en som tillhandahålls av Aspose.Cells. Klasserna som hanterar sparklines finns i [Aspose.Cells.Charts](https://reference.aspose.com/cells/net/aspose.cells.charts)-namnrymden så du måste importera denna namnrymd innan du använder dessa funktioner.
