...
type: docs
weight: 40
url: /sv/net/protect-and-unprotect-workbook-structure/
description: Skydda och avskydda arbetsboksstrukturen för Excel-filer med CSharp-koder.
---
{{% alert color="primary" %}}
...
## **Avskydda arbetsboksstruktur med Aspose.Cell för .Net**
