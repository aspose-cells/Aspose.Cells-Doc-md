...
- **HtmlCrossType.Cross**: Visa HTML-korssträng, prestandan för att skapa stora HTML-filer blir mer än tio gånger snabbare än att sätta värdet på Default eller FitToCell.
