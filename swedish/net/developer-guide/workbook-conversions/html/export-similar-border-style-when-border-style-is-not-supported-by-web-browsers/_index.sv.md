...
Microsoft Excel stöder vissa typer av streckade gränser som inte stöds av webbläsare. När du konverterar en sådan Excel-fil till HTML med Aspose.Cells tas sådana gränser bort. Aspose.Cells kan dock också stödja att visa sådana gränser med[**HtmlSaveOptions.ExportSimilarBorderStyle**](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/exportsimilarborderstyle) fast egendom. Vänligen ställ in dess värde som**Sann**och gränserna som inte stöds kommer också att exporteras till HTML-fil.
