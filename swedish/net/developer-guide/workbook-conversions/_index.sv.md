...
- **[ImageType](https://reference.aspose.com/cells/net/aspose.cells.drawing/imagetype)**: Anger bildtypen. Observera att alla former, inklusive diagram, återges som bilder i utdata-HTML.
...
Aspose.Cells API ger stöd för att konvertera kalkylblad till DOCX-format. För att exportera arbetsboken till DOCX, godkänn[**SaveFormat.Docx**](https://reference.aspose.com/cells/net/aspose.cells/saveformat) som den andra parametern för[**Arbetsbok.Spara**](https://reference.aspose.com/cells/net/aspose.cells.workbook/save/methods/3) metod. Du kan också använda[**DocxSaveOptions**](https://reference.aspose.com/cells/net/aspose.cells/docxsaveoptions) klass för att ange ytterligare inställningar för export av kalkylblad till DOCX.

 Följande kodexempel visar export av aktivt kalkylblad till DOCX med hjälp av[**SaveFormat.Docx**](https://reference.aspose.com/cells/net/aspose.cells/saveformat) uppräkningsmedlem. Vänligen se[utdata DOCX-fil](Book1.docx)genereras av koden för referens.
...
Aspose.Cells API ger stöd för att konvertera kalkylblad till PPTX-format. För att exportera arbetsboken till PPTX, godkänn[**SaveFormat.Pptx**](https://reference.aspose.com/cells/net/aspose.cells/saveformat) som den andra parametern för[**Arbetsbok.Spara**](https://reference.aspose.com/cells/net/aspose.cells.workbook/save/methods/3) metod. Du kan också använda[**PptxSaveOptions**](https://reference.aspose.com/cells/net/aspose.cells/pptxsaveoptions) klass för att ange ytterligare inställningar för export av kalkylblad till PPTX.

 Följande kodexempel visar export av aktivt kalkylblad till PPTX med hjälp av[**SaveFormat.Pptx**](https://reference.aspose.com/cells/net/aspose.cells/saveformat) uppräkningsmedlem. Vänligen se[ut PPTX-fil](Book1.pptx)genereras av koden för referens.
