...
{{% alert color="primary" %}}
 ...
 Som standard, när diagrammet exporteras till SVG-format**viewBox** attribut ingår inte i dess XML. Emellertid tillhandahåller Aspose.Cells[**ImageOrPrintOptions.SVGFitToViewPort**](https://reference.aspose.com/cells/net/aspose.cells.rendering/imageorprintoptions/properties/svgfittoviewport) egenskap som när den är inställd på**Sann** exporterar diagrammet till SVG med viewBox-attribut.

{{% /alert %}}

## Exportera diagram till SVG med viewBox-attribut

Följande exempelkod exporterar diagrammet till SVG-format med viewBox-attributet.
