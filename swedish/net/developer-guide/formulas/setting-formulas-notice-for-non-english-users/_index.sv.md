...
1. Använd alltid kommatecken (,) för att avgränsa funktionsparametrar. För vissa språkalternativ eller inställningar är avgränsaren för funktionsparametrar ett semikolon men Aspose.Cells använder kommatecken i engelsk stil. Använd till exempel "=OM (C5=0,0,C3/C4)" inte "=OM(C5=0;0;C3/C4)"
