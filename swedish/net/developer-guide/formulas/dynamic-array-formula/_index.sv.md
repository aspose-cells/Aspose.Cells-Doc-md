...
description: Hur man använder Aspose.Cells biblioteket för att beräkna dynamiska arrayformler i Microsoft Excel. Genom att ladda en befintlig Excel fil eller skapa en ny Excel fil kan vi använda metoden som tillhandahålls av Aspose.Cells för att beräkna den dynamiska arrayformeln och få resultatet. Slutligen sparar vi den modifierade Excel filen till disk.
...
Vänligen se följande exemplarkod som laddar [prov Excelfil](dynamicArrayFormula.xlsx) som innehåller några dummy-data. Efter att ha laddat filen, anropa funktionen [Cell.SetDynamicArrayFormula](https://reference.aspose.com/cells/net/aspose.cells/cell/setdynamicarrayformula/#setdynamicarrayformula) för att ange dynamisk matrisformel och [Workbook.RefreshDynamicArrayFormulas](https://reference.aspose.com/cells/net/aspose.cells/workbook/refreshdynamicarrayformulas/#refreshdynamicarrayformulas) funktionen för att uppdatera dynamiska matrisformler innan du anropar formelberäkning, och slutligen spara arbetsboken som [utdata Excelfil](out.xlsx). 
