...
description: Aspose.Cells är ett .NET-bibliotek för att arbeta med kalkylarksfiler. Den stöder inställning av teckensnittsinställningar för celler, så att användare kan anpassa teckensnittsstilen och egenskaperna för celler. Den här artikeln kommer att introducera hur du använder Aspose.Cells-biblioteket för att ställa in cellteckensnittsinställningar.
...
###  **Ställa in teckensnittsnamn**
 ...
 Utvecklare kan använda vilket typsnitt som helst på text inuti en cell genom att använda[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font) föremål[namn](https://reference.aspose.com/cells/net/aspose.cells/font/properties/name)fast egendom.
...
###  **Ställ in teckensnitt till fet stil**
 ...
 Utvecklare kan göra text fet genom att ställa in[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font) föremål[**IsBold**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/isbold)egendom till *sant**.
...
Ställ in teckenstorleken med[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font)föremål[**Storlek**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/size)fast egendom.
...
|Dubbelredovisning|Dubbel redovisningsunderstrykning|
...
Använd genomstruken genom att ställa in[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font) föremål[**IsStrikeout**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/isstrikeout)egendom till *sant**.
...
Använd prenumeration genom att ställa in[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font)föremål[**IsSubScript**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/issubscript)egendom till *sant**.
...
###  **Ställa in upphöjd effekt på teckensnitt**
 ...
 Utvecklare kan tillämpa den upphöjda effekten på teckensnittet genom att ställa in[**IsSuperscript**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/issuperscript) egendom av[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font)invända mot *sant**.
