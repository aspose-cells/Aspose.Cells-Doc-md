...
### **Ställ in teckensnitt till fet stil**
 ...
 Utvecklare kan göra text fet genom att ställa in[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font) föremål[**IsBold**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/isbold) egendom till**Sann**.
...
Använd genomstruken genom att ställa in[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font) föremål[**IsStrikeout**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/isstrikeout)egendom till**Sann**.
...
Använd prenumeration genom att ställa in[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font)föremål[**IsSubScript**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/issubscript) egendom till**Sann**.
...
### **Ställa in upphöjd effekt på teckensnitt**
 ...
 Utvecklare kan tillämpa den upphöjda effekten på teckensnittet genom att ställa in[**IsSuperscript**](https://reference.aspose.com/cells/net/aspose.cells/font/properties/issuperscript) egendom av[**Style.Font**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/font) protestera mot**Sann**.
