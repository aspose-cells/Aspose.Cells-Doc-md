...
type: docs
weight: 10
url: /sv/net/format-number-to-currency/
description: Denna artikel introducerar hur man formaterar nummer till valuta med hjälp av API n Aspose.Cells for .NET.
...
För att formatnummer som valuta i Aspose.Cells for .NET-biblioteket för att arbeta med Excel-filer kan du tillämpa valutainställningar på celler programatiskt. Så här kan du göra med C# och Aspose.Cells:
