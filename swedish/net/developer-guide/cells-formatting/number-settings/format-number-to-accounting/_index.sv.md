...
type: docs
weight: 10
url: /sv/net/how-to-format-number-to-accounting/
description: Den här artikeln introducerar hur man formaterar nummer till redovisning med API et Aspose.Cells for .NET.
...
## **Hur man formaterar nummer till redovisning i Aspose.Cells for .NET**
För att formatera nummer till redovisningsformat i Aspose.Cells for .NET kan du använda `Style`-objektet associerat med en cell eller ett cellområde. `Style`-objektet låter dig ange olika formateringsalternativ, inklusive nummerformat. Redovisningsformatet har vanligtvis en formkod som kan variera beroende på de specifika kraven (som om du vill visa valutasyMBOLer, decimalplatser osv.).

Här är ett grundläggande exempel på hur man tillämpar ett redovisningsnummerformat på en cell i Aspose.Cells for .NET:
