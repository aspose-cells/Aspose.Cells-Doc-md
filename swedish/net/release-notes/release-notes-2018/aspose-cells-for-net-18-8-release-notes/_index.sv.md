---
title: Aspose.Cells för .NET 18.8 Release Notes
type: docs
weight: 50
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 18.8](https://www.nuget.org/packages/Aspose.Cells/18.8.0).
