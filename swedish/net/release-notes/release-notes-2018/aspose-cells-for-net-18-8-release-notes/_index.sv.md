...
|CELLSNET-46220|Ställ in alternativet ContentCopyForAccessibility när du konverterar kalkylark till filformatet PDF|Ny funktion|
|CELLSNET-43560|Kryptera en ODS-fil|Ny funktion|
|CELLSNET-43556|Öppna krypterad ODS-fil|Ny funktion|
|CELLSNET-46209|Stöd för att läsa och skriva DConn av XLS-filen|Ny funktion|
...
|CELLSNET-46263|Applikationen hänger sig vid konvertering av XLS till PDF|Prestanda|
...
|CELLSNET-46251|Applikationen hänger sig vid konvertering av XLSX till HTML|Insekt|
|CELLSNET-46241|Problem med multilinjer i HTML|Insekt|
|CELLSNET-46219|Bredd från HTML-taggen följs inte vid konvertering av HTML till XLSX|Insekt|
...
|CELLSNET-46275|Large PDF skapad från XLS|Insekt|
|CELLSNET-46259|Konvertering av Excel till PDF lägger till en rak linje|Insekt|
|CELLSNET-46255|Problem med sidnummer (i sidfoten) i Excel till PDF-rendering|Insekt|
|CELLSNET-46238|Krypterad ODS filladdning misslyckades|Insekt|
|CELLSNET-46231|Text i kolumn A-celler renderas inte korrekt i utdata PDF|Insekt|
...
|CELLSNET-46235|Bilden kan inte visas när du sparar i formatet XLS|Insekt|
...
|CELLSNET-45377|Dataanslutningar hittades inte i dokumentet XLS|Insekt|
|CELLSNET-44487|Dataanslutningen försvann vid konvertering av XLT till XLSM|Insekt|
|CELLSNET-44486|Dataanslutningen försvann vid konvertering av XLS till XLSM|Insekt|
...
|CELLSNET-46249|Undantag görs vid läsning av filen HTML|Undantag|
|CELLSNET-46246|Undantaget görs när digital signatur läggs till på molnplattformsservern för GroupDocs|Undantag|
|CELLSNET-46232|Ogiltigt cellnamnundantag vid inläsning av XLSX-filen|Undantag|
