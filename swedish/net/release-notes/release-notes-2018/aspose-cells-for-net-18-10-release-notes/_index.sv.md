...
|CELLSNET-46383|Problem med bildkällan när du renderar Excel till filformatet HTML|Insekt|
|CELLSNET-46367|Teckenstorleken ändrades från 6,5 till 6 vid konvertering av XLSX till HTML|Insekt|
|CELLSNET-46353| Känn igen tomma taggar som<td /> samtidigt som du konverterar HTML till MS Excel-filformat|Insekt|
...
|CELLSNET-46376|PDF utmatad sidstorlek (och marginaler) matchar inte MS Excel-utdata|Insekt|
|CELLSNET-46373|Höjd på bilden i sidhuvudet trunkerad tillsammans med trasig layout under XLSM->PDF konvertering|Insekt|
...
|CELLSNET-46384|Skillnad i OLE-objekt före och efter att filen XLSB sparats|Insekt|
...
|CELLSNET-46350|Vyn ändras till skyddad vid konvertering XLS -> XLSM -> XLS|Insekt|
|CELLSNET-46347|XLSX-filen är skadad efter konvertering från en XML-fil (SpreadsheetML)|Insekt|
