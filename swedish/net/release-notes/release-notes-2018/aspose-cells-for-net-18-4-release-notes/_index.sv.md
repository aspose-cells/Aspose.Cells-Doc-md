---
title: Aspose.Cells för .NET 18.4 Release Notes
type: docs
weight: 90
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 18.4](https://www.nuget.org/packages/Aspose.Cells/18.4.0).
