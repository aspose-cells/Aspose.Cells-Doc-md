...
|CELLSNET-46032|Generera inte ensidig blank PDF när Excel-filen är tom|Förbättring|
...
|CELLSNET-46005|Skrifter omvända för olika ark i utdatafilformatet PDF|Insekt|
...
|CELLSNET-46034|Det går inte att ta bort pivottabeller (vars datakälla är extern) från filformatet XLS|Insekt|
...
|CELLSNET-45990|PDF utdata varierar med avseende på optimeringstypen|Insekt|
...
|CELLSNET-46002|Sidhuvudrader visas endast på första sidan i utdata PDF|Insekt|
...
|CELLSNET-46008|Ogiltig sträng i filen - undantag inträffar när filen XLS öppnas|Undantag|
|CELLSNET-46004|Undantag "Inmatningssträngen var inte i rätt format" när du öppnade en XLSX-fil|Undantag|
