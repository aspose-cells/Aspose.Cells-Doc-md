---
title: Aspose.Cells för .NET 20.6 Release Notes
type: docs
weight: 20
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 20.6](https://www.nuget.org/packages/Aspose.Cells/20.6.0).
...
|CELLSNET-47373|Att spara arbetsbok i PDF MemoryStream varar i mer än 2 minuter|Förbättring|
...
|CELLSNET-47390|Färgen på vissa ord är fel i HTML till ODS-rendering|Insekt|
...
|CELLSNET-47366|Poäng renderade inte till PDF-fil|Insekt|
...
|CELLSNET-47375|XLSX konverteras till skadad XLS-fil.|Insekt|
