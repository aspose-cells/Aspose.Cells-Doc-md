---
title: Aspose.Cells för .NET 20.9 Release Notes
type: docs
weight: 8
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 20.9](https://www.nuget.org/packages/Aspose.Cells/20.9.0).
