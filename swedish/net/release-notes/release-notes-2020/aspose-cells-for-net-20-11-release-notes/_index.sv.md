---
title: Aspose.Cells för .NET 20.11 Release Notes
type: docs
weight: 2
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 20.11](https://www.nuget.org/packages/Aspose.Cells/20.11.0).
