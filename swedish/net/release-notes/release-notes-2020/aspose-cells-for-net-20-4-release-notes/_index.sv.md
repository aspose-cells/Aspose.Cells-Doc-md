---
title: Aspose.Cells för .NET 20.4 Release Notes
type: docs
weight: 40
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 20.4](https://www.nuget.org/packages/Aspose.Cells/20.4.0).
