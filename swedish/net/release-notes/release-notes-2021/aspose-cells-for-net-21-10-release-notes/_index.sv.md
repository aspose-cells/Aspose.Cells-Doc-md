---
title: Aspose.Cells för .NET 21.10 Release Notes
type: docs
weight: 3
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 21.10](https://www.nuget.org/packages/Aspose.Cells/21.10.0).
