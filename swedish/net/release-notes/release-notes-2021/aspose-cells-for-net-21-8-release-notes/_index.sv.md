---
title: Aspose.Cells för .NET 21.8 Release Notes
type: docs
weight: 5
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 21.8](https://www.nuget.org/packages/Aspose.Cells/21.8.0).
