---
title: Aspose.Cells för .NET 21.1 Release Notes
type: docs
weight: 30
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 21.1](https://www.nuget.org/packages/Aspose.Cells/21.1.0).

{{% /alert %}}

|**Nyckel**|**Sammanfattning**|**Kategori**|
|:- |:- |:- |
|CELLSNET-47376|Release Aspose.Cells för .NET 5.0|Ny funktion|
