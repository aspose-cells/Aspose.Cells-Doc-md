...
\1) Aspose.Cells 
 ...
 30970 Få åtkomst till dokumentegenskaper för en krypterad XLS-fil
...
30548 StackOverflowException inträffade när vissa filer öppnades
 ...
 30785 Det går inte att ändra linjestil för en ChartPoint

 30787 Trasiga former i det kopierade kalkylbladet

 30843 Formler som använder korsade intervall fungerar inte
...
30949 Cell innehåll delas halvvägs genom ett ord när XLS-till-PDF konverteras
 ...
 31003 Problem med AutoFitRow och AutoFitMergedCells
 ...
 31095 AutoFitRows fungerar inte bra

 31098 SheetRender exporterar dubbla mellanslag/inkonsekvent mellanrum

 31099 Problem med diagrams förklaringsobjekt när du sparar som en bild

 31102 Det finns för många format i kalkylbladet

 31195 SheetRender exporterar diagram med fel höjd

 31243 Kopieringsintervall med validering

 31277 När du sparar till XLSX är dokumentet skrivskyddat

 \2) GridDesktop

 Buggar

 31051 GridDesktop-problem när ett Excel-dokument laddas
