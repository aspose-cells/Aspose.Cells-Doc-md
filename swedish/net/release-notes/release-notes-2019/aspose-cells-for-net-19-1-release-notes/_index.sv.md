...
|CELLSNET-46014|Stöd för hantering av överflödande cellinnehåll samtidigt som du sparar som PDF och bild|Ny funktion|
|CELLSNET-46490|Stöd Excel95/5.0 XLS-filer|Ny funktion|
...
|CELLSNET-46535|"#NAMN?" för formler sparade i formatet XLSB|Insekt|
...
|CELLSNET-46529|Bild saknas efter konvertering från XLSX till PDF|Insekt|
|CELLSNET-46451|Problem vid rendering av mallfilen till filformatet PDF|Insekt|
|CELLSNET-46518|Layoutproblem (vissa axeletiketter är på två rader) när mallfilen renderas till filformatet PDF|Insekt|
