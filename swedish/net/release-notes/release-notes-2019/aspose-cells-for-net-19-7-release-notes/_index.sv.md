---
title: Aspose.Cells för .NET 19.7 Release Notes
type: docs
weight: 60
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 19.7](https://www.nuget.org/packages/Aspose.Cells/19.7.0).
...
|CELLSNET-46808|Stöd läsning av tabell enstaka celler av XLS-fil.|Ny funktion|
...
|CELLSNET-46811|Stöd HeadingPairs och TitlesOfParts-taggar för XLS-fil.|Förbättring|
...
|CELLSNET-46772|Felaktig PDF skapad genom att sakna grafiken|Insekt|
...
|CELLSNET-43921|Rendering av XLSX till XLSB ger en skadad fil|Insekt|
...
|CELLSNET-46797|Understruken teckensnittsstil ignoreras när Excel-ark renderas till BMP/Tiff|Insekt|
|CELLSNET-46664|HeadingPairs och TitlesOfParts-taggar återställs igen efter konvertering av rensad XLS tillbaka till XLSM-filformat|Insekt|
...
|CELLSNET-46807|Saknar en del av texten vid konvertering av XLS till PDF|Insekt|
|CELLSNET-42168|IndexOutOfRangeException: på Workbook.SaveToStream|Undantag|
|CELLSNET-46248|Undantag görs vid läsning av HTML-fil.|Undantag|
|CELLSNET-46792|Undantag när du försöker ta bort tomma kolumner på en specifik arbetsbok|Undantag|
|CELLSNET-46799|Undantag uppstod vid konvertering av XLSX-fil till PDF|Undantag|
