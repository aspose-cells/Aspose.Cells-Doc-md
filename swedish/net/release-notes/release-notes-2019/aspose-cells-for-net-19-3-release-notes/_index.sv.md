---
title: Aspose.Cells för .NET 19.3 Release Notes
type: docs
weight: 100
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 19.3](https://www.nuget.org/packages/Aspose.Cells/19.3.0).
...
|CELLSNET-46628|Skillnad i utdata PDF|Insekt|
...
|CELLSNET-46626|Utrymmesformateringsproblem vid konvertering av XLSX-fil till PDF|Insekt|
...
|CELLSNET-46624|XLSX-filladdningsproblem|Insekt|
|CELLSNET-46635|För många sidbrytningar i ODS-fil (XLSX till ODS-rendering)|Insekt|
