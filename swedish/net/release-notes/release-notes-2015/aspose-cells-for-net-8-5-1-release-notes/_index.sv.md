---
title: Aspose.Cells för .NET 8.5.1 Release Notes
type: docs
weight: 60
...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 8.5.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.1/)
