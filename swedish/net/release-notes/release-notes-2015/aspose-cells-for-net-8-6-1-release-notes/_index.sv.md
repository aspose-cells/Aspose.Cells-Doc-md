---
title: Aspose.Cells för .NET 8.6.1 Release Notes
type: docs
weight: 30
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 8.6.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.1/)
...
## **Förbättringar**
 ...
 (CELLSNET-43933) - Cell.Formeln kan acceptera en ogiltig formel och API försöker korrigera den
