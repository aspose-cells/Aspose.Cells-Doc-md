...
## **Nya egenskaper**
 ...
 (CELLSNET-43640) - Kan inte återge det anpassade datumformatmönstret g och ge.mm.dd

 (CELLSNET-43682) - ExportDataTableAsString-funktionen bör exportera cellvärden som StringValueWithoutFormat

 (CELLSNET-41619) - Konvertera revision av XLSB till XLSM

 (CELLSNET-40366) - Hur man vet om licensen är registrerad


## **Prestanda**


 (CELLSNET-41836) - System.StackOverflowException inträffade i Aspose.Cells.dll
...
## **Buggar**
 ...
 (CELLSNET-43667) - Felaktigt formelvärde efter anrop av Worksheet.CalculateFormula
...
(CELLSNET-43705) - Datumformatet är annorlunda i utdata-pdf
 ...
 (CELLSNET-43693) - Felplacerad text vid rendering av kalkylblad till bild

 (CELLSNET-43691) - Texten trunkeras längst ner

 (CELLSNET-43690) - Texten avkortas längst ner medan kalkylbladet renderas till bild
...
(CELLSNET-43600) - Excel-filen är inte korrekt renderad
 ...
 (CELLSNET-43453) - Texten beskärs

 (CELLSNET-43365) - Horisontell linje återges inte
 ...
 (CELLSNET-42721) - Utdata pdf har en extra sida

 (CELLSNET-42720) - Text är avskuren i utdata-pdf
...
(CELLSNET-42376) - Text skärs bort från TextBox medan XLSX renderas till PDF
 ...
 (CELLSNET-43659) - Vissa linjestilar är olika

 (CELLSNET-43650) - Cells.CopyColumns kopierar inte villkorlig formatering
...
## **Undantag**
 ...
 (CELLSNET-43671) - Objektreferens är inte inställd på en instans av ett objektundantag
