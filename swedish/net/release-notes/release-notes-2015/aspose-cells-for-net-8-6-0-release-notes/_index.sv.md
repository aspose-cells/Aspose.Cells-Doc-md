...
## **Förbättringar**
 ...
 (CELLSNET-43892) - XLSX dokumentstorleken ökar för varje sparande
...
(CELLSNET-43884) - Wingdings-symboler återges inte korrekt när vissa kalkylblad konverteras till HTML
 ...
 (CELLSNET-43879) - tecken överlappade och konverterade till ######## i Excel till PDF-rendering

 (CELLSNET-43854) - Upphöjd och nedsänkt skiftade upp för mycket när bilden genererades

 (CELLSNET-42762) - Kartaxeletiketter återges i ojämn text

 (CELLSNET-42384) - WordArt-boxar försvinner när XLSX konverteras till PDF
...
(CELLSNET-42377) - SmartArt-layoutrubrik överlappar med understrykning under bildrubrik.
 ...
 (CELLSNET-41493) - Texten trunkeras/lindas i den genererade PDF
 ...
 (CELLSNET-43839) - Bilder i kalkylarket renderas inte vid konvertering till PDF
...
## **Undantag**
 ...
 (CELLSNET-43866) - CellsException när ett kalkylblad renderas till PDF
 ...
 (CELLSNET-43893) - CellsException vid rendering av ett kalkylblad till formatet PDF
 ...
 (CELLSNET-43865) - ArgumentException vid rendering av kalkylark till PDF och HTML
