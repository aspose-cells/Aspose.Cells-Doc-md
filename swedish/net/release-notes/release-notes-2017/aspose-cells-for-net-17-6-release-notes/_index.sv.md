...
type: docs
weight: 70
url: /sv/net/aspose-cells-for-net-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Cells for .NET 17.6](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.6/).

{{% /alert %}} 

|**Nyckel**|**Sammanfattning**|**Kategori**|
|:- |:- |:- |
|CELLSNET-45356|Ange alla attributvärden i HTML|Ny funktion|
|CELLSNET-45394|Stöd för nya funktioner i Office 365|Ny funktion|
...
|CELLSNET-45371|Felaktiga förklaringsobjektfärger när TotalActionRatPie-diagram konverteras till bild|Insekt|
|CELLSNET-45352|Aspose.Cells-värden börjar från 10,0 % till 14,0 %|Insekt|
|CELLSNET-45351|Aspose.Cells visar värden 0|Insekt|
|CELLSNET-45342|DataLabels i diagrammet visas eller tas inte bort i utdatafilen|Insekt|
|CELLSNET-45335|Bilden av det genererade diagrammet är felaktig|Insekt|
|CELLSNET-45424|Anpassad sortering går förlorad när den sparas till XLS av Aspose.Cells API:er|Insekt|
|CELLSNET-45421|Datasortering fungerar inte på DataSet (som har formler) i kalkylbladet|Insekt|
|CELLSNET-45416|Cell gränsproblem i Range.ApplyStyle()-metoden|Insekt|
|CELLSNET-45413|Ett inbäddat objekt i Sheet2 saknas och skalningen är fel|Insekt|
|CELLSNET-45403|Datavalidering slutar konstigt efter att ha infogat nya kolumner|Insekt|
...
|CELLSNET-45343|ListObject.ConvertToRange bryter formler i totalraden|Insekt|
|CELLSNET-45320|Vissa funktioner fungerar inte|Insekt|
|CELLSNET-45223|C1-kalkylbladet är inte helt laddat och GridWeb visar endast 64 rader istället för 75|Insekt|
...
- [Kakelbild som en textur inuti formen](/cells/sv/net/tile-picture-as-a-texture-inside-the-shape/)
- [Använda OnAjaxCallFinishedClientFunction av GridWeb](/cells/sv/net/using-onajaxcallfinishedclientfunction-of-gridweb/)
...
- [Lägg till GridWeb till webbformulär](/cells/sv/net/add-gridweb-to-web-form/)
- [Gruppera rader och skapa delsumma](/cells/sv/net/group-rows-and-create-subtotal/)
