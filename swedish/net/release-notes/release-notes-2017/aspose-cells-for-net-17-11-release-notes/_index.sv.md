...
|CELLSNET-45679|Stjärnformerna visas inte korrekt i utgången PDF|Insekt|
...
|CELLSNET-45650|Fel vid expansion av data till rätt kolumner när du sparar ett MHTML-filformat till Excel-fil|Insekt|
...
|CELLSNET-45724|Om du sparar Excel som PDF minskar kolumnbredden|Insekt|
|CELLSNET-45712|Förklaring av diagrammet saknas i utgången PDF|Insekt|
|CELLSNET-45710|Nummerformatering i diagram går förlorad efter att en Excel-fil har sparats som PDF|Insekt|
...
|CELLSNET-45758|Style.QuotePrefix-egenskapen fungerar inte för filformatet XLSB|Insekt|
...
|CELLSNET-45749|HTML-strängen med flera teckensnitt skadar utdatafilen i Excel|Insekt|
|CELLSNET-45739|SpreadsheetML-filen när den sparas på nytt via Aspose.Cells innehåller ytterligare skyddsinställningar som tillämpas|Insekt|
|CELLSNET-45738|AutoFitColumns bryter HTML-formateringen i den utgående Excel-filen|Insekt|
...
|CELLSNET-45753|När XLSB konverteras till PDF inträffar System.ArgumentOutOfRangeException|Undantag|
|CELLSNET-45751|ExportTableOptions.Index-egenskapen som används i metoden ExportDataTable() orsakar undantag|Undantag|
|CELLSNET-45726|Undantag vid laddning av utdatafilen XLS (med OLE-objekt, bilder etc. uteslutna)|Undantag|
