...
|:- |:- |:- |
|CELLSNET-45049|Trimma tomma rader och kolumner medan du exporterar kalkylblad till CSV-format|Ny funktion|
...
|CELLSNET-45067|Konvertering till PDF tar för lång tid|Prestanda|
|CELLSNET-45105|Det går inte att läsa in HTML när CultureInfo är franska|Insekt|
|CELLSNET-45089|HTML till Excel: Excel-filen är korrupt|Insekt|
|CELLSNET-45072|WordArt från XLS renderas inte i HTML|Insekt|
|CELLSNET-45053|Vissa HTML-taggar tas inte med i beräkningen och visst innehåll saknas|Insekt|
|CELLSNET-45039|Regeln för blandad stil tar inte hänsyn till när HTML-koden renderas till Excel|Insekt|
|CELLSNET-45036|Innehållet efter en tagg trimmas när HTML importeras och konverteras till XLSX|Insekt|
|CELLSNET-45035|Hela cellinnehållet blir fetstilt när en del av det ligger mellan STRONG-taggar|Insekt|
|CELLSNET-45033|Cell innehåll trimmas vid import av HTML|Insekt|
...
|CELLSNET-45130|Olika resultat med Excel exportera PDF och Aspose.Cells spara som PDF|Insekt|
...
|CELLSNET-45066|Former komprimeras horisontellt medan kalkylblad konverteras till PDF|Insekt|
|CELLSNET-45064|Axeletiketter återges inte när kalkylblad konverteras till PDF|Insekt|
...
|CELLSNET-45094|Textpositionen ändras efter att XLS har laddats och sparats|Insekt|
...
|CELLSNET-45111|När Save XLS uppstår System.ArgumentOutOfRangeException|Undantag|
|CELLSNET-45108|System.NullReferenceException i Workbook ctor för XLSB|Undantag|
...
1. [Anpassa kolumner och rader automatiskt när du laddar HTML i arbetsboken](/cells/sv/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Konvertera text till kolumner med Aspose.Cells](/cells/sv/net/convert-text-to-columns-using-aspose-cells/)
1. [Få en lista över teckensnitt som används i ett kalkylblad eller en arbetsbok](/cells/sv/net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Få varningar när du laddar Excel-fil](/cells/sv/net/get-warnings-while-loading-excel-file/)
1. [Läs och manipulera Excel 2016-diagram](/cells/sv/net/read-and-manipulate-excel-2016-charts/)
1. [Trimma ledande tomma rader och kolumner samtidigt som du exporterar kalkylblad till CSV-format](/cells/sv/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
1. [Bindande arbetsblad till ett anpassat samlingsobjekt med GridWeb](/cells/sv/net/binding-worksheet-to-a-customized-collection-object-using-gridweb/)
1. [Byt namn på dubbletter av kolumner automatiskt när du exporterar kalkylbladsdata](/cells/sv/net/rename-duplicate-columns-automatically-while-exporting-worksheet-data/)
1. [Dela paneler i GridDesktop-arbetsbladet](/cells/sv/net/split-panes-in-griddesktop-worksheet/)
