...
|CELLSNET-50152| Olika formatering och andra former rendering problem i PDF och HTML av Excel-fil|
...
|CELLSNET-50269|Finska språket - Siffror formaterade som procent saknar mellanslag före procentsymbolen|
|CELLSNET-50333|Aspose.cell kunde inte samla in arbetsbokens revisionsloggar|
|CELLSNET-50239|Saknade sida efter konvertering av en Excel-fil till PDF|
...
|CELLSNET-50270|Inmatningssträngen var inte i korrekt format. undantag när XLS-filen öppnas|
|CELLSNET-50271|Den här filens format stöds inte eller så anger du inte ett korrekt format. undantag när XLS-filen öppnas|
