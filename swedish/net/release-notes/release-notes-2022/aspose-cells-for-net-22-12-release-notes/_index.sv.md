...
{{% alert color="primary" %}}
 ...
 Den här sidan innehåller release notes för[Aspose.Cells for .NET 22.12](https://www.nuget.org/packages/Aspose.Cells/22.12.0).
...
|CELLSNET-47895|Bilder är förvrängda i Excel till PDF/HTML rendering|
...
|CELLSNET-52330|Ritningsformer inte renderade i HTML|
...
|CELLSNET-52336|Histogramdiagrammet återges inte korrekt i konverteringen XLSX till HTML/PDF|
...
|CELLSNET-52242|Förälder-barn-hierarkin är felaktig vid konvertering av Excel till JSON och vice versa|
|CELLSNET-52281|Json header kan inte ignoreras|
|CELLSNET-52289|Talformatet går förlorat vid konvertering av html till excel|
|CELLSNET-52298|Alternativet AutoSort är aktiverat för pivotfältet när du sparar om XLSX|
|CELLSNET-52299| HasRevisions-attributet är felaktigt efter att ha sparat en arbetsbok|
|CELLSNET-52332|Numbers visas som '#' eller vetenskapligt nummer vid konvertering till html|
|CELLSNET-52338| Utgången HTML är icke-deterministisk|
|CELLSNET-52344|Hyperlänkar saknas i konverteringen HTML till JSON|
