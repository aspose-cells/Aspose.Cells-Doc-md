---
title: Aspose.Cells för .NET 8.3.0 Release Notes
type: docs
weight: 10
url: /sv/net/aspose-cells-for-net-8-3-0-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells för .NET 8.3.0](https://downloads.aspose.com/cells/net/new-releases/-aspose.cells-for-.net-8.3.0/)
...
(CELLSNET-43112) - Hämta text av ekvationen för trendlinjen i diagrammet

(CELLSNET-42303) - Konvertera diagram till bild i SVG-format

(CELLSNET-43158) - Stöd för att ställa in AutoRecover-arbetsbokegenskapen
...
(CELLSNET-43053) - Fel vid visning av HTML i Chrome och Safari

(CELLSNET-42984) - Bildens ljusstyrka går förlorad när bilden renderas från Excel
...
(CELLSNET-43123) - Anpassade marginaler ignoreras

(CELLSNET-43108) - Dold formel görs synlig

(CELLSNET-43101) - Utskrift respekterar inte sidlayouten
...
(CELLSNET-43103) - Trendline går ut från tomtområdet

(CELLSNET-43068) - Att spara diagram i Excel till Pdf resulterar i en trunkerad förklaring

(CELLSNET-43052) - Chart.Calculate fungerar inte korrekt

(CELLSNET-43040) - Linjediagram görs tomt när det sparas till PNG med Chart.ToImage

(CELLSNET-43039) - Dataetiketter i diagrammet är felaktigt placerade.
...
(CELLSNET-43120) - Fel beräkning av SumProduct-formeln

(CELLSNET-43118) - API returnerar #N/A för giltig formel

(CELLSNET-43116) - "CELLRANGE" visas istället för etiketterna i Excel 2013

 (CELLSNET-43115) - Konstig karaktär ersätter*Xdddd* mönster i strängvärde

(CELLSNET-43114) - Ytterligare kommentarer skapas i Excel-fil efter att ha sparats med Aspose.Cells

(CELLSNET-43104) - Formeln går sönder vid kopiering till 512:e kolumnen
...
(CELLSNET-43142) - System.OverflowException vid öppning av Excel-filen
...
(CELLSNET-43151) - CellsException: "Antalet rader eller kolumner kan inte vara noll" vid metoden Name.GetRanges
...
(CELLSNET-43106) - Ändra positionen för horisontell rullningslist med avseende på Tabbar genom kod

### **Prestanda**

(CELLSNET-43125) - System.OutOfMemory undantag i GridWeb

### **Buggar**

(CELLSNET-43126) - TableItemStyle.Custom fungerar inte i GridWeb

(CELLSNET-42745) - Problem med justering och visningsformat vid import av XLSX-fil till GridWeb
