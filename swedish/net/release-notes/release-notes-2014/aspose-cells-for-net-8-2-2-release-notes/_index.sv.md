...
type: docs
weight: 20
url: /sv/net/aspose-cells-for-net-8-2-2-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Cells for .NET 8.2.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.2/)
...
## **Prestanda**
 ...
 (CELLSNET-43015) - Konvertering till PDF-processen verkar hänga på ett kalkylblad med 115996 rader
...
(CELLSNET-43061) - Felaktigt värde beräknat jämfört med MS Excel
 ...
 (CELLSNET-43003) - Text i form återges upp och ner när kalkylblad konverteras till bild

 (CELLSNET-43002) - Form som överlappar texten när kalkylbladet renderas som bild
...
(CELLSNET-42999) - Pilar för villkorlig formatering är mindre i storlek
 ...
 (CELLSNET-42987) - Formfärgen ändras när källfilen öppnas och sparas på nytt

 (CELLSNET-42960) - DataLabels text är inslagen i utdatabildens filformat

 (CELLSNET-42957) - Fjärde diagrammet på sidan 10 ser inte ut som Excel

 (CELLSNET-42956) - Fjärde diagrammet på sidan 8 ser inte ut som Excel

 (CELLSNET-42955) - Det andra diagrammet på sidan 8 ser inte ut som Excel

 (CELLSNET-42905) - Extra linje ovanför stapeln i stapeldiagrammet
...
(CELLSNET-42646) - Workbook RefreshChartCache-alternativet tar inte hänsyn till regionala och språkinställningar
 ...
 (CELLSNET-42639) - Textrutor har blivit felplacerade

 (CELLSNET-42638) - Teckenmärken har olika tjocklek

 (CELLSNET-42637) - Saknar axeltitel när diagram sparas som EMF med hjälp av ToImage

 (CELLSNET-42636) - Axisvärden saknas när diagram sparas som EMF med hjälp av ToImage

 (CELLSNET-42613) - Saknade element vid extrahering av komplexa diagram

 (CELLSNET-43073) - Diagrammets förformatering av anpassade datapunktsikoner ändras
...
(CELLSNET-43048) - ListObject Resize raderar CalculatedColumnFormula
 ...
 (CELLSNET-43038) - Korrupt innehåll efter kopiering av intervall med Range.CopyData

 (CELLSNET-43037) - System.NullReferenceException när en XLSX-fil laddas

 (CELLSNET-43032) - ListObject.Resize() kopierar inte datavalideringen

 (CELLSNET-43024) - Fel i "Alarm Volume_Sep152013.xlsx" kalkylblad

 (CELLSNET-43023) - Ogiltig scatterstil Val Fel i larmet "Performance_Sep152013.xlsx" kalkylblad

 (CELLSNET-43022) - Områdesnamn tas inte bort efter att arken tagits bort
...
(CELLSNET-42981) - Fel värde från en värdefunktion efter CalculateFormula
 ...
 (CELLSNET-42740) - Dataetiketter i bubbeldiagrammet är felaktiga
...
## **Undantag**
 ...
 (CELLSNET-43034) - Fel i Cell: undantag vid öppning av Excel-arbetsboken

 (CELLSNET-43013) - Null Reference undantag vid öppning av dokumentet
...
Får arbetsbladet som innehåller detta diagram..
 ...
 Uppdatering av Aspose.Cells.GridWeb.Data.RowFilterSettings egenskaper

 Ta bort properties:StartRow/EndRow och lägg till egenskaper:StartColumn/EndColumn.
