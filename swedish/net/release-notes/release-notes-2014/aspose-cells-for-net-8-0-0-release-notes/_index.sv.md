...
type: docs
weight: 90
url: /sv/net/aspose-cells-for-net-8-0-0-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells for .NET 8.0.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.8.0/)
