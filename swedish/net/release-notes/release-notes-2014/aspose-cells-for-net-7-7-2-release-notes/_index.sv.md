...
## **Buggar**
 ...
 (CELLSNET-42349) - Felaktig konvertering från HTML till XLSX
...
(CELLSNET-42163) - Villkorlig formatering går förlorad när filen öppnas och sparas på nytt
 ...
 (CELLSNET-42347) - Problem med textformatering - Bokstaven y i ordet stad är avskuren

 (CELLSNET-42344) - Rubrikkanten varierar i tjocklek på olika sidor medan XLSX konverteras till PDF
...
(CELLSNET-42289) - CHAR(151) fungerar inte korrekt i PDF
 ...
 (CELLSNET-42332) - Tecken har ändrats till versaler efter Workbook.CalculateFormula()

 (CELLSNET-42319) - Inkonsekvens av formelberäkning

 (CELLSNET-42318) - Villkorlig formatering går förlorad vid radering av rad

 (CELLSNET-42295) - XLSM till PDF: Formelfält visas som #DIV/0!
...
## **Undantag**
 ...
 (CELLSNET-42345) - NullReferenceException när Excel 2013-fil laddas

 (CELLSNET-42330) - ArgumentOutOfRangeException vid Workbook-konstruktorn

 (CELLSNET-42362) - Undantag för nollreferens vid sparande

 (CELLSNET-42350) - ArgumentException: Parametern är inte giltig

 (CELLSNET-42348) - NullReferenceException när arbetsbok sparas till MemoryStream med SaveFormat.Xlsx

 (CELLSNET-42333) - System.ArgumentException på Cells.ExportDataTableAsString

 (CELLSNET-42290) - Bilder genereras inte för Excel-filer och ger undantag för nollreferens
...
Lägger till egenskapen WorkbookSettings.RemovePersonalInformation
 ...
 Lägger till egenskapen Style.IsJustifyDistributed.

 Anger om cellerna är justerade eller distribuerad justering ska användas på den sista textraden.
