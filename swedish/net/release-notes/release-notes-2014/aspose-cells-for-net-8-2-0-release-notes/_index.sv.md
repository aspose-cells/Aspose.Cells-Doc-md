...
## **Förbättringar**
 ...
 (CELLSNET-42892) - En överbelastning av AutoFitRows krävs

 (CELLSNET-42868) - Datavalideringslistan returnerar inte förväntade värden

 (CELLSNET-42862) - Excel 2013-funktion som inte stöds - dagar
...
## **Buggar**
 ...
 (CELLSNET-42787) - Den renderade bilden är inte tydlig i den utgående pdf-filen
...
(CELLSNET-42904) - DeleteRange-problem med hyperlänksamling
 ...
 (CELLSNET-42899) - Name.GetRange returnerar null istället för det faktiska intervallet

 (CELLSNET-42897) - Felaktigt värde beräknat för COUNTIF-formeln vid rendering till PDF
 ...
 (CELLSNET-42755) - Sjökortsetiketter har ändrat position/arrangemang
...
(CELLSNET-41952) - "Undantag för slut på minne" när du sparar arbetsbok som PDF
 ...
 (CELLSNET-42875) - NullReferenceException för att öppna arbetsboken från minnesströmmen

 (CELLSNET-42863) - NullReferenceException när arbetsbok öppnas
