...
|CELLSNET-44417 | API hänger sig medan ett skadat och infekterat kalkylark konverteras till PDF| Prestanda|
|CELLSNET-44088 | Ikoner för reglerna för villkorlig formatering återges inte till HTML| Insekt|
|CELLSNET-44263 | Formatering går förlorad vid import av HTML som XLSX| Insekt|
...
|CELLSNET-44309 | Parentes visas inte roterad i utgången PDF (Excel till PDF konvertering)| Insekt|
...
|CELLSNET-44403 | Bakgrundsvattenstämpeln tas bort medan XLS till XLSX sparas| Insekt|
