...
|CELLSNET-44345 | Formel för WordArt reagerar inte på argumentändring vid konvertering av XLS till XLSB| Förbättring|
...
|CELLSNET-44326 | Genom att klicka på en cell ändras den formaterade texten till dess källa HTML| Insekt|
