---
title: Aspose.Cells för .NET 8.8.0 Release Notes
type: docs
weight: 110
...
|CELLSNET-44347 |API renderar två PDF-sidor för ett kalkylblad oavsett om OnePagePerSheet ställs in på sant| Insekt|
