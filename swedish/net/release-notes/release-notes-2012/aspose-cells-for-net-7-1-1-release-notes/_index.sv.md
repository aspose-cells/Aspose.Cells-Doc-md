---
title: Aspose.Cells för .NET 7.1.1 Release Notes
type: docs
weight: 100
...
{{% alert color="primary" %}} 
 ...
 Den här sidan innehåller release notes för[Aspose.Cells för .NET 7.1.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.1.1/)

{{% /alert %}} 

 Vi är glada att kunna meddela Aspose.Cells för .NET v7.1.1!
