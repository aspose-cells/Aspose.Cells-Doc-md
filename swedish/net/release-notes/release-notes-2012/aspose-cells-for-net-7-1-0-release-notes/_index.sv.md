...
{{% /alert %}} 
 ...
 Vi är glada att kunna meddela Aspose.Cells för .NETv7.1.0!
...
- NullReferenceException vid öppning av dokument med automatiskt formaterad pivottabell
- Pivottabellens filtrering i MS Excel 2007 och senare versioner
- Diagrammets formateringsproblem
- Kopiering av kalkylblad fungerar inte
...
- Problem med att öppna en SpreadsheetML-fil

 Prestanda

- Prestandaproblem när du lägger till intervallnamn
- Minnesundantag och formelberäkningar på celler

 Undantag

- Det går inte att kopiera ett visst kalkylblad till en annan arbetsbok

 - Pivottabellen ger undantag vid uppdatering

- ListBox med tilldelat indataområde orsakar Aspose.Cells krossning
...
- MS Excels funktion för gruppering av data vid import till GridDesktop
...
- Importera en XLSX-fil till GridWeb-problemen
- Formel fungerar inte bra
