---
title: Aspose.Grid .Net 1.5.0.0 Releaseinformation för nya versioner
type: docs
weight: 30
url: /sv/net/aspose-grid-net-1-5-0-0-new-release-release-notes/
---
{{% alert color="primary" %}} 

 Den här sidan innehåller release notes för[Aspose.Grid .Net 1.5.0.0 Ny version](https://downloads.aspose.com/cells/net/new-releases/aspose.grid-.net-1.5.0.0-new-release/)

{{% /alert %}} 

 Kära kunder,

 Vi har release Aspose.Grid v1.5!
...
Ger omfattande stöd för formler
 ...
 Ger stöd för ett stort antal celltyper
 Ger stöd för både redigerings- och visningslägen
 Ger stöd för att dölja och visa rader och kolumner
 Ger enkla, fullfjädrade exempel i både C# och VB.NET

 och många, många fler...



- Aspose.Grid.Web är en uppgradering av Aspose.Excel.Web
