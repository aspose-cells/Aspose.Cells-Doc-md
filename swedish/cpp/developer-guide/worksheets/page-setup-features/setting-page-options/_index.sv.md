---
title: Inställning av sidalternativ med C++
linktitle: Inställning av sidalternativ
type: docs
weight: 10
url: /sv/cpp/setting-page-options/
description: Denna artikel ger exempel på kod för att programmatiskt ställa in sidalternativ för Excel arbetsblad med hjälp av C++ API. Du kan ställa in sidorientering, skalningsfaktor, anpassade sidalternativ, sidstorlek, utskriftskvalitet, första sidanummer.
keywords: sätt Excel sidans orientering c++, ställ in Excel skaleringsfaktor c++, ställ in arbetsbladets sidstorlek c++
---
...
Det är möjligt att minska eller förstora storleken på ett arbetsblad genom att justera skalningsfaktorn med [**PageSetup.GetZoom()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getzoom/)-egenskapen.
...
För att anpassa innehållet i arbetsbladet till ett specifikt antal sidor, använd [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)s [**GetFitToPagesTall()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopagestall/) och [**GetFitToPagesWide()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopageswide/)-egenskaper. Dessa egenskaper används också för att skala arbetsblad.

{{% alert color="primary" %}}

Du kan antingen välja [**GetFitToPagesTall()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopagestall/)/[**GetFitToPagesWide()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfittopageswide/)- eller [**GetZoom()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getzoom/)-egenskapen, men inte båda samtidigt.
...
Ställ in pappersstorleken som arbetsbladen ska skrivas ut till med hjälp av [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)-klassens [**GetPaperSize()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getpapersize/)-egenskap. [**GetPaperSize()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getpapersize/)-egenskapen accepterar ett av de fördefinierade värdena i [**PaperSizeType**](https://reference.aspose.com/cells/cpp/aspose.cells/papersizetype/)-uppräknelsen, listade nedan.
...
Ställ in utskriftskvaliteten för arbetsbladen att skriva ut med hjälp av [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)-klassens [**GetPrintQuality()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprintquality/)-egenskap. Enheten för utskriftskvalitet är punkter per tum (DPI).
...
Börja numrera arbetsbladets sidor med hjälp av [**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)-klassens [**GetFirstPageNumber()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfirstpagenumber/)-egenskap. [**GetFirstPageNumber()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getfirstpagenumber/)-egenskapen sätter sidnummer för den första arbetsbladssidan, och de följande numreras i stigande ordning.
