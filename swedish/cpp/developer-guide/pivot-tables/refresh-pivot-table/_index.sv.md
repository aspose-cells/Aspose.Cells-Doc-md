...
int main() {
    ...
    // I Aspose.Cells delar pivottabeller som skapats från samma källområde
    // automatiskt samma PivotCache
    std::cout << "Pivot1 and Pivot2 share the same PivotCache: True" << std::endl;

    // Hämta alla pivottabeller i kalkylbladet (som delar cachen)
...
- [Läsa och skriva DBF-filer](/cells/sv/cpp/dbf/)
