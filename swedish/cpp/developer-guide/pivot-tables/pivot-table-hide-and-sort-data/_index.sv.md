---
title: Dölj och sortera data i pivottabeller med C++
linktitle: Dölj och sortera data i pivottabeller
type: docs
weight: 120
url: /sv/cpp/pivot-table-hide-and-sort-data/
description: Lär dig hur du döljer och sorterar data i pivottabeller med Aspose.Cells i C++.
---

## **Dölj och sortera data i pivottabeller**
...
Käll- och utdata Excel-filer som används i kodbiten är bifogade för referens.
