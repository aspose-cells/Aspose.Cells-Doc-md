---
title: Ersätt tagg med text i en textbox inuti kalkbladet med C++
linktitle: Ersätt taggen med text i en textruta på arbetsbladet
type: docs
weight: 1100
url: /sv/cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Ersätt taggar i kalkblads textrutor programmatiskt med Aspose.Cells for C++.
---
