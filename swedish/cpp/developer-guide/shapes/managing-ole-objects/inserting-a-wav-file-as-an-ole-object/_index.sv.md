---
title: Infoga en WAV fil som ett Ole objekt med C++
linktitle: Infoga en WAV fil som ett Ole objekt
type: docs
weight: 70
url: /sv/cpp/inserting-a-wav-file-as-an-ole-object/
description: Lär dig hur du infogar en WAV fil som ett OLE objekt i Excel ark med Aspose.Cells och C++.
---

{{% alert color="primary" %}} 

Aspose.Cells ger funktionalitet för att lägga till olika typer av OLE-objekt i Excel-ark. Vi kommer att se i följande kodexempel hur man lägger till en WAV-fil som ett OLE-objekt med hjälp av enkla API:er från Aspose.Cells. 
