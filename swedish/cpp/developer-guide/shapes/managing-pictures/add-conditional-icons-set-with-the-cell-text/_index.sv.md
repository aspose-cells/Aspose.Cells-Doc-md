---
title: Lägg till villkorssymboler bredvid celltext med C++
linktitle: Lägg till villkorliga ikoner med celltexten
type: docs
weight: 160
url: /sv/cpp/add-conditional-icons-set-with-the-cell-text/
description: Lär dig hur man lägger till villkorssymboler bredvid celltext i Excel med Aspose.Cells och C++.
---

{{% alert color="primary" %}} 

Ibland vill du lägga till villkorssymboler bredvid texten i en cell för att göra data mer meningsfull för läsaren. Du vill använda några av de villkorsformattecken som finns men utan att tillämpa villkorsformattering på cellerna. Aspose.Cells stöder denna funktion.
