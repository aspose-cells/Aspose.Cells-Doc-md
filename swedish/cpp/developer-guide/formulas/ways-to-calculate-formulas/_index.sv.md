...
Aspose.Cells stöder de flesta formler eller funktioner som ingår i Microsoft Excel. de kan användas via API:t eller med hjälp av designerkalkylblad. Aspose.Cells stöder en stor uppsättning matematiska formler, sträng-, booleska-, datum/tid-, statistiska, uppslags- och referensformler.
