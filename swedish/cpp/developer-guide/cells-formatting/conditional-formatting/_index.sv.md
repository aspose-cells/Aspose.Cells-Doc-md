---
title: Sätt villkorsstyrda format i Excel och ODS filer med C++
linktitle: Villkorliga format
type: docs
weight: 60
url: /sv/cpp/conditional-formatting/
...
Aspose.Cells tillåter utvecklare att kopiera inställningar för villkorlig formatering från en cell till en annan i kalkylbladet genom att anropa [**Range.Copy()**](https://reference.aspose.com/cells/cpp/aspose.cells/range/copy/)-metoden.
