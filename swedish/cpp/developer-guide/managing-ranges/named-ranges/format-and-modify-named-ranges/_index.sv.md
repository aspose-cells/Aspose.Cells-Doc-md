---
title: Formatera och ändra namngivna områden med C++
linktitle: Format och ändra namngivna områden
type: docs
weight: 85
url: /sv/cpp/format-and-modify-named-ranges/
description: Lär dig hur man formaterar, byter namn, sammanfogar och tar bort namngivna områden i Excel filer med Aspose.Cells och C++.
---
...
För att tillämpa formatering, definiera en [**Style**](https://reference.aspose.com/cells/cpp/aspose.cells/style/)-objekt för att ange stilinställningarna och tillämpa det på [**Range**](https://reference.aspose.com/cells/cpp/aspose.cells/range/)-objektet.
...
- Ramtyp, ramtypen, vald från [**BorderType**](https://reference.aspose.com/cells/cpp/aspose.cells/bordertype/)-uppräkningen.
- Linjestil, linjestilen, vald från [**CellBorderType**](https://reference.aspose.com/cells/cpp/aspose.cells/cellbordertype/)-uppräkningen.
...
Aspose.Cells låter dig byta namn på ett namngivet område efter behov. Du kan hämta det namngivna området och döpa om det med hjälp av [**Name.GetText()**](https://reference.aspose.com/cells/cpp/aspose.cells/name/gettext/)-attributet. Följande exempel visar hur du byter namn på ett namngivet område.
...
Aspose.Cells tillhandahåller [**Range.UnionRang**](https://reference.aspose.com/cells/cpp/aspose.cells/range/unionrang/) metod för att skapa unioner för områden, metoden returnerar en [*std::vector*](https://en.cppreference.com/w/cpp/container/vector) objekt. Följande exempel visar hur man tar union för områden.
...
Aspose.Cells tillhandahåller [**Range.Intersect**](https://reference.aspose.com/cells/cpp/aspose.cells/range/intersect/) metod för att skära två intervaller. Metoden returnerar ett [**Range**](https://reference.aspose.com/cells/cpp/aspose.cells/range/) objekt. För att kontrollera om ett intervall skär ett annat intervall, använd [**Range.Intersect**](https://reference.aspose.com/cells/cpp/aspose.cells/range/intersect/) metoden som returnerar ett booleskt värde. Följande exempel visar hur man skär intervallerna.
...
Aspose.Cells tillhandahåller [**Range.Merge()**](https://reference.aspose.com/cells/cpp/aspose.cells/range/merge/) metod för att förena cellerna i intervallet. Följande exempel visar hur man förenar de enskilda cellerna i en namngiven intervall.
...
Aspose.Cells tillhandahåller [**NameCollection.RemoveAt()**](https://reference.aspose.com/cells/cpp/aspose.cells/namecollection/removeat/)-metoden för att radera namnet på området. Använd [**Cells.ClearRange()**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/clearrange/)-metoden för att rensa innehållet i området. Fö...
