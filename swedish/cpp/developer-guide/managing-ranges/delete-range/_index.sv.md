---
title: Ta bort områden från Excel med C++
linktitle: Radera områden
type: docs
weight: 105
url: /sv/cpp/delete-ranges-from-excel/
description: Lär dig hur man raderar intervall i Excel med Aspose.Cells och C++.
---
...
Aspose.Cells tillhandahåller metoden [Cells.DeleteRange](https://reference.aspose.com/cells/cpp/aspose.cells/cells/deleterange/) för att radera ett intervall.

## **Radera områden och flytta celler åt vänster**

Radera ett intervall och skifta cellerna till vänster enligt följande koder med Aspose.Cells:
...
Radera ett intervall och skifta cellerna uppåt enligt följande koder med Aspose.Cells:
