...
type: docs
weight: 60
url: /sv/cpp/how-to-run-the-examples/
---
...
Alla exemplen av Aspose.Cells for C++ är hostade på [GitHub](https://github.com/aspose-cells/Aspose.Cells-for-C/).

- Du kan antingen klona repositoryt med din favorit-GitHub-klient eller ladda ned ZIP-filen från [här](https://github.com/aspose-cells/Aspose.Cells-for-C/archive/master.zip).
...
- Mappen **Data** i rotmappen för **Exempel** innehåller inmatningsfiler. Det är obligatoriskt att ladda ned mappen **Data** tillsammans med exemplen.
- Öppna main.cpp, alla exemplen anropas härifrån.
- Ta bort kommentaren från exemplen du vill köra inom projektet.

Tveka inte att kontakta oss via vårt forum om du har några problem med att konfigurera eller köra exemplen.
## **Bidra**
