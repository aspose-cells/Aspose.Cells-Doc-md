...
- **Data** mapp i rotmappen för**Exempel** innehåller indatafiler. Det är obligatoriskt att ladda ner**Data** mapp tillsammans med exempelprojektet.
- Öppna main.cpp, alla exempel anropas härifrån.
