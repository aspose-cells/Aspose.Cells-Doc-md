...
|[Tal](https://docs.fileformat.com/spreadsheet/numbers/)|Dokumentet är skapat av Apples "Numbers"-applikation som är en del av Apples kontorssvit iWork, en uppsättning applikationer som körs på operativsystemen Mac OS X och iOS.|{{< emoticons/tick >}}||
