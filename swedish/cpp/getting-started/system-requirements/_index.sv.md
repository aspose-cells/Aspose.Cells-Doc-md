...
<table>  
  ...
  <tr>
			<td>Linux</td>
			<td><ul><li>Ubuntu 18.04 eller senare</li><li>Fedora</li><li>OpenSUSE</li><li>CentOS</li><li>och andra</li></ul></td>
		</tr>
</table>

## Utvecklingsmiljö

Du kan använda Aspose.Cells for C++ när du utvecklar applikationer för Windows eller Linux.
...
<table>  
  ...
  <tr>
			<td><ul><li>GCC 7.5.0 eller senare</li><li>CMake 3.0.0 eller senare</li></ul></td>
			</tr>
</table>

### Ytterligare beroende av Linux

 Aspose.Cells for C++ på Linux beror på[libgdiplus](https://github.com/mono/libgdiplus//) binärer både dynamiskt bibliotek och verktyg. Installera det innan du använder:

- Installera libgdiplus på Ubuntu eller Debian</br>
