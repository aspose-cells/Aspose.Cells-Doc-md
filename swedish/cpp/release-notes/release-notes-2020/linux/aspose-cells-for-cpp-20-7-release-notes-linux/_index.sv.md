---
title: Aspose.Cells för CPP 20.7 Release Notes Linux
type: docs
weight: 10
url: /sv/cpp/aspose-cells-for-cpp-20-7-release-notes-linux/
---
{{% alert color="primary" %}} 

Den här sidan innehåller utgåvor för Aspose.Cells for C++ 20.7 för Linux.

{{% /alert %}} 

Vi är glada att kunna meddela lanseringen av Aspose.Cells for C++ 20.7 för Linux.

|**Nyckel**|**Sammanfattning**|**Kategori**|
|:- |:- |:- |
|CELLSCPP-6|Tillämpa villkorlig formatering på cellerna|Ny funktion|
|CELLSCPP-7|Läs/skriv anpassade dokumentegenskaper|Ny funktion|
|CELLSCPP-8|Läs/skriv Inbyggda dokumentegenskaper|Ny funktion|
|CELLSCPP-9|Lägg till hyperlänkar till cellerna|Ny funktion|
|CELLSCPP-11|Stöd MS Excel-teman|Ny funktion|
