---
title: Aspose.Cells för CPP 23.1 Release Notes Linux
type: docs
weight: 12
url: /sv/cpp/aspose-cells-for-cpp-23-1-release-notes-linux/
---
{{% alert color="primary" %}}

Den här sidan innehåller utgåvor för Aspose.Cells for C++ 23.1 för Linux.

{{% /alert %}}

Vi är glada att kunna meddela lanseringen av Aspose.Cells for C++ 23.1 för Linux.
