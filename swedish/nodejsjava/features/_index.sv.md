...
---
## **Aspose.Cells for Node.js via Java Funktionsöversikt**
Det här avsnittet ger en jämförelse av tillgängligheten för funktioner mellan Aspose.Cells for Java och Aspose.Cells for Node.js via Java.
...
|**Funktion**|**Beskrivning**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
|:- |:- |:- |:- |
...
|**Funktion**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
|:- |:- |:- |
...
|Rendera kalkylbladssidor till rasterbilder (Multipage TIFF, GIF).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Funktion**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
|:- |:- |:- |
|Importera/exportera data från en Array, ArrayList, ResultSet etc.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
