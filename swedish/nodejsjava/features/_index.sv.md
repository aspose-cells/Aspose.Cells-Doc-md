...
type: docs
weight: 5
url: /sv/nodejs-java/features/
keywords: "nodejs, excel, api, features"
description: "Aspose.Cells for Node.js via Java funktioner"
---

## **Aspose.Cells for Node.js via Java Funktioner Översikt**
Denna avsnitt ger en jämförelse av tillgänglighet av funktioner mellan Aspose.Cells for Java och Aspose.Cells för Node.js via Java.
...
|**Funktion**|**Beskrivning**|**Aspose.Cells for Java**|**Aspose.Cells för Node.js via Java**|
| :- | :- | :- | :- |
...
|**Funktion**|**Aspose.Cells for Java**|**Aspose.Cells för Node.js via Java**|
| :- | :- | :- |
...
|Tillämpa formatinställningar på ett kalkylblad, rad, kolumn eller ett cellområde osv.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
