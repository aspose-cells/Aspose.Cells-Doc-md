...
type: docs
weight: 9
url: /sv/nodejs-java/aspose-cells-for-node-js-via-java-23-4-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells for Node.js via Java 23.4](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.4/).
