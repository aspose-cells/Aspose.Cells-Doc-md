---
title: Aspose.Cells för Node.js via Java 20.2 Release Notes
type: docs
weight: 10
url: /sv/nodejs-java/aspose-cells-for-node-js-via-java-20-2-release-notes/
---
{{% alert color="primary" %}} 

Den här sidan innehåller utgåvor för Aspose.Cells för Node.js via Java 20.2.
...
Anger om formeln tolkas när ett formeluttryck ställs in till cell. Standardvärdet är sant. Om det är falskt, kommer det inmatade formeluttrycket att behållas som det är för cellen tills användaren anropar andra metoder för att analysera dem eller tills tolkad formeldata krävs av andra operationer, såsom beräkning av formler.
