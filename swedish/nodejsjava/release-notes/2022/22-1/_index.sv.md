---
title: Aspose.Cells för Node.js via Java 22.1 Release Notes
type: docs
weight: 12
url: /sv/nodejsjava/aspose-cells-for-node-js-via-java-22-1-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells för Node.js via Java 22.1](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.1/).
