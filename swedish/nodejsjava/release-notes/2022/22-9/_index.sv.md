---
title: Aspose.Cells för Node.js via Java 22.9 Release Notes
type: docs
weight: 4
url: /sv/nodejs-java/aspose-cells-for-node-js-via-java-22-9-release-notes/
---
{{% alert color="primary" %}}

 Den här sidan innehåller release notes för[Aspose.Cells för Node.js via Java 22.9](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.9/).
