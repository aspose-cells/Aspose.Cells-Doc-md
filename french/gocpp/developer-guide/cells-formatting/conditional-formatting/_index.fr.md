---
title: Définir les formats conditionnels des fichiers Excel et ODS avec Golang via C++
linktitle: Formats conditionnels
type: docs
weight: 60
url: /fr/go-cpp/conditional-formatting/
...
Aspose.Cells permet aux développeurs de copier les paramètres de mise en forme conditionnelle d'une cellule à une autre dans la feuille de calcul en appelant la méthode [**Range.Copy()**](https://reference.aspose.com/cells/go-cpp/range/copy_range_pasteoptions/).
