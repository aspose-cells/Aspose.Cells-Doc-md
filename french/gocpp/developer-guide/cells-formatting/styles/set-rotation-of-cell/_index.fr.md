---
title: Comment faire pivoter le texte d une cellule avec Golang via C++
linktitle: Comment faire pivoter le texte de la cellule
type: docs
weight: 80
url: /fr/go-cpp/how-to-rotate-text-of-cell/
...
La propriété [**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/) facilite la rotation des cellules. Pour faire pivoter les cellules dans Aspose.Cells, vous devez suivre ces étapes :
