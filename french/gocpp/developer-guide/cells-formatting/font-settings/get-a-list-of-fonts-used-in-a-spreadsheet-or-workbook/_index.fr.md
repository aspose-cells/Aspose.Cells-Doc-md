---
title: Obtenir une liste de polices utilisées dans une feuille de calcul ou un classeur avec Golang via C++
linktitle: Obtenir une liste de polices
description: Aspose.Cells est une bibliothèque C++ pour travailler avec des fichiers de tableur. Elle supporte la récupération d une liste de polices utilisées dans une feuille de calcul ou un classeur, permettant aux utilisateurs d obtenir des informations sur les polices utilisées dans un document. Cet article vous montrera comment utiliser la bibliothèque Aspose.Cells pour obtenir une liste de polices.
keywords: Aspose.Cells, Feuille de calcul, Classeur, Police, Liste
type: docs
weight: 20
url: /fr/go-cpp/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/
---
...
Aspose.Cells fournit la méthode [**Workbook.GetFonts**](https://reference.aspose.com/cells/go-cpp/workbook/getfonts/) qui renvoie la liste de toutes les polices utilisées dans votre classeur ou feuille de calcul.
