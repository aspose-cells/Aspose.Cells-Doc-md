---
title: Comment utiliser la palette de couleurs avec Golang via C++
linktitle: Comment utiliser la palette de couleurs
type: docs
weight: 80
url: /fr/go-cpp/excel-color-palette/
...
Aspose.Cells fournit une classe [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) qui représente un fichier Microsoft Excel. La classe [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) fournit une méthode [**ChangePalette**](https://reference.aspose.com/cells/go-cpp/workbook/changepalette/) qui prend les paramètres suivants pour ajouter une couleur personnalisée pour modifier la palette :
