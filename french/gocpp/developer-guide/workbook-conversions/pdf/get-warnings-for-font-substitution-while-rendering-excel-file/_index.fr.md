---
title: Obtenir les avertissements pour la substitution de police lors du rendu d un fichier Excel avec Golang via C++
linktitle: Obtenir des avertissements pour la substitution de police
type: docs
weight: 230
url: /fr/go-cpp/get-warnings-for-font-substitution-while-rendering-excel-file/
description: Apprenez comment obtenir des avertissements concernant la substitution de police lors du rendu de fichiers Excel en PDF en utilisant Aspose.Cells avec Golang via C++.
---
