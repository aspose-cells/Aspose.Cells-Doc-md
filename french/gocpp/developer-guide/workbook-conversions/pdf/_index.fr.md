---
title: Convertir Excel en PDF avec Golang via C++
linktitle: Convertir Excel en PDF
type: docs
weight: 220
url: /fr/go-cpp/convert-excel-to-pdf/
description: Apprenez comment convertir des classeurs Excel en format PDF en utilisant Aspose.Cells avec Golang via C++.
---
...
Veuillez noter que vous pouvez modifier ces informations dans les documents de sortie en utilisant la propriété [**PdfSaveOptions.GetProducer()**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/getproducer/).

{{% /alert %}}

### **Conversion directe**

Aspose.Cells for C++ prend en charge la conversion de feuilles de calcul en PDF indépendamment des autres logiciels. Il suffit d'enregistrer un fichier Excel en PDF en utilisant la méthode [**Save**](https://reference.aspose.com/cells/go-cpp/workbook/save/) de la classe [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/). La méthode [**Save**](https://reference.aspose.com/cells/go-cpp/workbook/save/) fournit le membre d'énumération [**SaveFormat.Pdf**](https://reference.aspose.com/cells/cpp/aspose.cells/saveformat/) qui convertit les fichiers Excel natifs en format PDF.
...
1. Une fois le code de la feuille de calcul terminé, appelez la méthode [**Save**](https://reference.aspose.com/cells/go-cpp/workbook/save/) de la classe [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) pour enregistrer la feuille de calcul.

Le format de fichier doit être PDF, il faut donc sélectionner *Pdf* (une valeur prédéfinie) dans l'énumération [**SaveFormat**](https://reference.aspose.com/cells/go-cpp/saveformat/) pour générer le document PDF final.

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-Pdf.go" >}}
### **Conversion avancée**

Vous pouvez également choisir d'utiliser la classe [**PdfSaveOptions**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/) pour définir différents attributs pour la conversion. La modification des propriétés de la classe [**PdfSaveOptions**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/) vous donne le contrôle sur les paramètres d'impression, la police, la sécurité et la compression pour le PDF de sortie.
...
Le morceau de code ci-dessous montre comment utiliser la classe [**PdfSaveOptions**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/) pour enregistrer des fichiers Excel au format PDF/A compatible.

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-Pdf-1.go" >}}
{{% alert color="primary" %}}

Veuillez noter que la propriété [**GetCompliance()**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/getcompliance/) a été ajoutée avec la version Aspose.Cells for C++ 5.3.0.

{{% /alert %}}

#### **Définir l'heure de création du PDF**

Avec la classe [**PdfSaveOptions**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/), vous pouvez obtenir ou définir l'heure de création du PDF. Le code suivant illustre l'utilisation de la propriété [**PdfSaveOptions.GetCreatedTime()**](https://reference.aspose.com/cells/go-cpp/pdfsaveoptions/getcreatedtime/) pour définir l'heure de création du fichier PDF.
...
Si votre feuille de calcul contient des formules, il est préférable d'appeler [**Workbook.CalculateFormula()**](https://reference.aspose.com/cells/go-cpp/workbook/calculateformula/) juste avant de rendre la feuille de calcul en format PDF. Cela garantira que les valeurs dépendantes des formules sont recalculées, et que les valeurs correctes sont rendues dans le PDF.
