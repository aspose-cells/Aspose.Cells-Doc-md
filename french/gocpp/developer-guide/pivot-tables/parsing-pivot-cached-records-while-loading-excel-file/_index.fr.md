---
title: Analyse des enregistrements en cache du tableau croisé dynamique lors du chargement du fichier Excel avec Golang via C++
linktitle: Analyse des enregistrements de cache de pivot
type: docs
weight: 70
url: /fr/go-cpp/parsing-pivot-cached-records-while-loading-excel-file/
