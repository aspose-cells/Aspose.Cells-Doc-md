---
title: Désactiver le vérificateur de compatibilité dans Excel avec Golang via C++
linktitle: Désactiver le vérificateur de compatibilité
type: docs
weight: 170
url: /fr/go-cpp/disable-compatibility-checker-in-excel/
...
Définissez la propriété [**Workbook.GetCheckCompatibility()**](https://reference.aspose.com/cells/go-cpp/workbooksettings/getcheckcompatibility/) sur **False** pour désactiver le vérificateur de compatibilité de Microsoft Excel.
