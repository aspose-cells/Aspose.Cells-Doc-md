---
title: Spécifier un avertissement de tri lors du tri des données avec Golang via C++
linktitle: Spécification d avertissement de tri lors du tri des données
type: docs
weight: 140
url: /fr/go-cpp/specifying-sort-warning-while-sorting-data/
...
Le code d'exemple suivant illustre l'utilisation de la propriété [**DataSorter.GetSortAsNumber()**](https://reference.aspose.com/cells/go-cpp/datasorter/getsortasnumber/) comme expliqué précédemment. Veuillez consulter son [fichier Excel d'exemple](43352075.xlsx) et son [fichier Excel de sortie](43352076.xlsx) pour plus d'aide.
