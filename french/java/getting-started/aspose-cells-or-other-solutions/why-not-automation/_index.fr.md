...
{{% alert color="primary" %}}
 ...
 Cet article a couvert les points clés expliquant pourquoi les composants Aspose sont un meilleur choix que la bureautique. Tous les différents composants Aspose offrent une solution sans risque et sans obligation[version d'évaluation](https://products.aspose.com/total/). Nous vous encourageons à profiter de cette évaluation afin de mieux voir ce que Aspose peut faire pour vos candidatures.

Pour plus d'informations, consultez les articles Internet suivants :

- [Considérations pour l'automatisation côté serveur d'Office](https://support.microsoft.com/en-us/topic/considerations-for-server-side-automation-of-office-48bcfe93-8a89-47f1-0bce-017433ad79e2)
