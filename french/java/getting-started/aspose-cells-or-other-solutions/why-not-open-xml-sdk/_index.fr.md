...
|<p>Rendu et impression :* Rendu des pages de feuille de calcul en images raster (TIFF, multipage TIFF, PNG, JPEG, BMP).*Convertissez les pages de la feuille de calcul en images vectorielles (EMF).* Convertissez les graphiques en images (TIFF, multipage TIFF, PNG, JPEG, BMP, EMF etc.)</p><p>- Spécifiez la résolution de l'image, la qualité, la compression et d'autres options. </p><p>- Imprimez des feuilles de calcul à l'aide de l'infrastructure d'impression .NET. Le composant a une méthode d'impression intégrée pour imprimer les feuilles de calcul comme indiqué dans l'aperçu avant impression de MS Excel.</p>|Non|Oui|
