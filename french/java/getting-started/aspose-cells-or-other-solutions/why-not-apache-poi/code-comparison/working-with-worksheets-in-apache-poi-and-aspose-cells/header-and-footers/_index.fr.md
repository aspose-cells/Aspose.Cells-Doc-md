---
title: En-tête et pieds de page
type: docs
weight: 60
url: /fr/java/header-and-footers/
---
## **Aspose.Cells - En-tête et pieds de page**
...
{{< /highlight >}}
## **Apache POI SS - HSSF XSSF - En-tête et pieds de page**
La classe d'en-tête est disponible pour ajuster l'en-tête dans les feuilles de calcul.
...
{{% alert color="primary" %}} 
 ...
 Pour plus de détails, visitez[Définition des en-têtes et pieds de page](/java/setting-headers-and-footers).
