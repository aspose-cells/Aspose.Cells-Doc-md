...
Le code suivant vous guidera sur la façon d'utiliser [**Aspose.Cells**](https://products.aspose.com/cells/java/) pour ajouter votre couleur d'arrière-plan préférée aux commentaires de votre choix.
...
Le code d'exemple ci-dessous crée un fichier XLSX à partir de zéro en utilisant [**Aspose.Cells**](https://products.aspose.com/cells/java/) API, et ajoute un commentaire avec une image d'arrière-plan à la cellule A1.
