...
type: docs
weight: 10
url: /fr/java/format-number-to-date/
description: Cet article expliquera comment formater un nombre en date en utilisant l API Aspose.Cells for Java.
...
Pour formater les nombres en date dans la bibliothèque Aspose.Cells for Java pour travailler avec des fichiers Excel, vous pouvez appliquer un format de date aux cellules de manière programmatique. Voici comment le faire en utilisant Java avec Aspose.Cells :
