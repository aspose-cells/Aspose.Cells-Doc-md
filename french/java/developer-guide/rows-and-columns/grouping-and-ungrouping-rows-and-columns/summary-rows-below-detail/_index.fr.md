...
Vous pouvez appliquer un sous-total aux données en utilisant la méthode [**Worksheet.Cells.subtotal()**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#subtotal-com.aspose.cells.CellArea-int-int-int[]-). Elle prend les paramètres suivants.
