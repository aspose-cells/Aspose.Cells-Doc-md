...
À partir de Aspose.Cells 6.0.0, Microsoft, la conversion Excel tp XPS est prise en charge.
...
[MHTML](https://en.wikipedia.org/wiki/MHTML) combine HTML normal avec des ressources externes ; c'est-à-dire du contenu généralement lié à des images, des animations, de l'audio, etc. dans un seul fichier. Ils sont utilisés pour les e-mails avec l'extension de fichier .mht.
...
La conversion d'une feuille de calcul en MHTML est une opération rapide, comme illustré ci-dessous.
...
|**Affichage de la feuille de calcul avant l'exportation**|**Vue HTML après exportation**|
|:- |:- |
|![Affichage de la feuille de calcul avant l'exportation](converting-workbook-to-different-formats_1.png)|![Vue HTML après exportation](converting-workbook-to-different-formats_2.png)|
...
### **Conversion d'Excel en PDF**
 ...
 Microsoft La conversion Excel en PDF a été introduite avec Aspose.Cells for Java 2.3.0. À partir de cette version, Aspose.Cells peut[convertir directement des feuilles de calcul en PDF](#direct-conversion) (y compris[PDF/A](#saving-excel-spreadsheets-to-pdfa-complied-files)), sans autre produit. Pour convertir des feuilles de calcul avec des versions plus anciennes de Aspose.Cells,[utilisez Aspose.PDF pour la conversion](#conversion-with-asposepdf-asposecells-prior-to-230).
...
Enregistrez un fichier Excel directement au format PDF à l'aide de**[Workbook.save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.io.OutputStream,%20com.aspose.cells.SaveOptions))** méthode, et fournir la**[SaveFormat.PDF](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#PDF)**membre de l'interface. La conversion directe comme celle-ci est la méthode de conversion la plus efficace. Il ne perd pas de données ni de formatage, mais conserve le PDF de sortie ressemblant au fichier Excel d'entrée.
...
L'extrait de code fourni ci-dessous illustre l'utilisation de**[PdfSaveOptions](https://reference.aspose.com/cells/java/com.aspose.cells/PdfSaveOptions)** classe pour enregistrer les fichiers Excel au format PDF compatible PDF/A.
