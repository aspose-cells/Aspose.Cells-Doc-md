...
Pour importer des données à partir d'un *ArrayList* dans des feuilles de calcul, appelez la méthode [**ImportArrayList**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#importArrayList-java.util.ArrayList-int-int-boolean-) de la collection [**Cells**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#Cells). La méthode [**ImportArrayList**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#importArrayList-java.util.ArrayList-int-int-boolean-) prend les paramètres suivants:
...
Les données peuvent facilement être exportées vers un objet tableau en utilisant la méthode [**exportArray**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#exportArray-int-int-int-int-) de la classe [**Cells**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#Cells).

#### Colonnes contenant des données fortement typées

Les feuilles de calcul stockent les données sous forme de séquence de lignes et de colonnes. Utilisez la méthode [**exportArray**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#exportArray-int-int-int-int-) pour exporter les données d'une feuille de calcul vers un tableau. [**exportArray**](https://reference.aspose.com/cells/java/com.aspose.cells/cells#exportArray-int-int-int-int-) prend les paramètres suivants pour exporter les données de la feuille de calcul en tant qu'objet *Array*:
