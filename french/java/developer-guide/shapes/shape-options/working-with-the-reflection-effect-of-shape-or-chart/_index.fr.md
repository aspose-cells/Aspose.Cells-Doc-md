...
type: docs
weight: 930
url: /fr/java/working-with-the-reflection-effect-of-shape-or-chart/
---

## **Scénarios d'utilisation possibles**
Aspose.Cells fournit la propriété [Shape.ReflectionEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#Reflection) pour travailler avec l'effet de réflexion de la forme ou du graphique. Elle contient les sous-propriétés suivantes que vous pouvez définir pour obtenir différents résultats selon vos besoins.
...
La capture d'écran suivante montre l'interface Microsoft Excel pour définir l'*effet de réflexion* de la forme.
