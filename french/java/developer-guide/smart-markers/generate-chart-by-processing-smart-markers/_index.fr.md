...
{{% alert color="primary" %}} 
 ...
 Des informations détaillées sur les marqueurs intelligents sont disponibles[ici](/cells/fr/java/smart-markers/).
...
![tâche : image_autre_texte](generate-chart-by-processing-smart-markers_1.png)
...
![tâche : image_autre_texte](generate-chart-by-processing-smart-markers_2.png)

{{% alert color="primary" %}} 

L'extrait de code ci-dessus utilise l'instance existante de la classe Workbook créée à la première étape. Si vous avez déjà le fichier de feuille de calcul du concepteur sur le disque ou la mémoire, vous pouvez créer une instance de la classe Workbook en chargeant la feuille de calcul du concepteur existante.
...
![tâche : image_autre_texte](generate-chart-by-processing-smart-markers_3.png)
