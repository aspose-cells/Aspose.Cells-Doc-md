...
Ensuite, il remplit la source de données avec des données et appelle la méthode [WorkbookDesigner.Process()](https://reference.aspose.com/cells/java/com.aspose.cells/workbookdesigner#process--) pour traiter les balises de marqueur intelligent. Le code utilise ces images, c'est-à-dire [moon.png](5472549.png) et [moon2.png](5472548.png), mais vous pouvez utiliser n'importe quelle image. La capture d'écran suivante montre le résultat de ce code exemple. Comme vous pouvez le voir, les données dans la colonne E et F sont regroupées par rapport aux données de la colonne D.
