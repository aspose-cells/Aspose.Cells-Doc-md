...
## **Développer le texte de droite à gauche lors de l'exportation du fichier Excel vers HTML**
 L'exemple de code suivant convertit le[exemple de fichier excel](5472562.xlsx) dans HTML. Cette capture d'écran montre à quoi ressemble l'exemple Excel dans Microsoft Excel 2013.

![tâche : image_autre_texte](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_1.png)

 Cette capture d'écran montre le[sortie HTML générée avec une version plus ancienne](5472570).

![tâche : image_autre_texte](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_2.png)

 Cette capture d'écran montre le[sortie HTML générée avec une version plus récente](5472563).
