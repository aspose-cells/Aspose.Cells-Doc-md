...
## **Supprimer les espaces redondants après un saut de ligne lors de l'importation de HTML**
 L'exemple de code suivant montre l'utilisation de[HtmlLoadOptions.DeleteRedundantSpaces](https://reference.aspose.com/cells/java/com.aspose.cells/htmlloadoptions#DeleteRedundantSpaces) propriété. Veuillez le régler**vrai** ou**faux** pour obtenir la sortie comme indiqué dans la capture d'écran ci-dessus.
