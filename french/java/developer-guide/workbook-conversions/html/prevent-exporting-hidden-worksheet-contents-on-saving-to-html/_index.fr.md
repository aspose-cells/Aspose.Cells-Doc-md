...
Outre le contrôle de l'exportation ou non des feuilles de calcul masquées, vous pouvez également configurer des paramètres supplémentaires pour l'exportation du classeur au format HTML. Les articles suivants présentent d'autres fonctionnalités prises en charge par Aspose.Cells pour l'exportation de classeurs au format HTML.

- [Convertir Excel en HTML avec des titres](/cells/fr/java/convert-excel-to-html-with-headings/)
