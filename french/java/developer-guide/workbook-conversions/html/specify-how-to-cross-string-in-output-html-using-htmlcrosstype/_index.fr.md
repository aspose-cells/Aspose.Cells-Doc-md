---
title: Spécifiez comment croiser la chaîne dans la sortie HTML à l'aide de HtmlCrossType
type: docs
weight: 140
...
- [**HtmlCrossType.CROSS**](https://reference.aspose.com/cells/java/com.aspose.cells/htmlcrosstype#CROSS) : Afficher la chaîne croisée HTML, les performances de création de fichiers volumineux HTML seront plus de dix fois plus rapides que de définir la valeur sur[**DÉFAUT**](https://reference.aspose.com/cells/java/com.aspose.cells/htmlcrosstype#DEFAULT) ou alors[**FIT_TO_CELL**](https://reference.aspose.com/cells/java/com.aspose.cells/htmlcrosstype#FIT_TO_CELL).

- [**HtmlCrossType.CROSS_HIDE_RIGHT**](https://reference.aspose.com/cells/java/com.aspose.cells/htmlcrosstype#CROSS_HIDE_RIGHT): Affiche la chaîne croisée HTML et masque la chaîne de droite lorsque les textes se chevauchent.
