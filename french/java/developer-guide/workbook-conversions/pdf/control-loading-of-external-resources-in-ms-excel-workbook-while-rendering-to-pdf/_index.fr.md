---
title: Contrôler le chargement des ressources externes dans le classeur MS Excel lors du rendu vers PDF
type: docs
weight: 40
...
L'exemple de code suivant explique comment utiliser[**PdfSaveOptions.StreamProvider**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#StreamProvider)pour contrôler le chargement des ressources externes et les manipuler. S'il vous plaît, vérifiez le[exemple de fichier Excel](50528353.xlsx)utilisé à l'intérieur du code et le[sortie PDF](50528354.pdf)généré par le code. Le[capture d'écran](50528357.png)montre comment le[ancienne image externe](50528356.png)dans l'exemple de fichier Excel a été remplacé par un[Nouvelle image](50528355.png)dans la sortie PDF.
