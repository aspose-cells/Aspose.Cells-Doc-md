...
type: docs
weight: 180
url: /fr/java/print-comments-while-saving-to-pdf/
---
{{% alert color="primary" %}}
...
Aspose.Cells fournit les énumérations suivantes pour prendre en charge les commentaires d'impression lors de l'enregistrement du PDF
...
## Extrait de code
 ...
 L'exemple de code suivant illustre l'utilisation[**ImprimerCommentairesType**](https://reference.aspose.com/cells/java/com.aspose.cells/printcommentstype)enum pour imprimer les commentaires lors de l'enregistrement au format PDF.
