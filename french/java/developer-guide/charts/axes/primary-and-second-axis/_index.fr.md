---
title: Axe Principal et Secondaire
description: Apprenez à comprendre et à travailler avec les axes principaux et secondaires dans Aspose.Cells for Java. Notre guide vous aidera à comprendre les différences entre les axes principaux et secondaires, et comment les configurer et les utiliser efficacement dans vos graphiques.
keywords: Aspose.Cells for Java, axes principaux, axes secondaires, compréhension, différences, configuration, utilisation.
type: docs
weight: 190
url: /fr/java/primary-and-second-axis/
---
...
Le code d'exemple suivant génère le [fichier Excel de sortie](PrimaryandSecondaryAxis.xlsx).
