...
En général, les API Aspose.Cells analysent par défaut les répertoires de polices du système d'exploitation sous Windows, Linux, MacOS. À partir de [Aspose.Cells for Java 24.7](https://releases.aspose.com/cells/java/release-notes/2024/aspose-cells-for-java-24-7-release-notes/), les API analysent également par défaut les répertoires de polices en cache dans le cloud Office.

{{% /alert %}}

{{% alert color="primary" %}}

Les API Aspose.Cells analysent toujours le répertoire de polices par défaut du système d'exploitation, à une exception près : lorsque les arguments JVM **-DAspose.Cells.FontDirExc="VotreDossierDePolices"** sont définis. Dans ce cas, les API Aspose.Cells ignoreront la recherche dans le répertoire par défaut et rechercheront uniquement dans le chemin spécifié dans ces arguments JVM.
...
1. [**FontConfigs.setFontFolder**](https://reference.aspose.com/cells/java/com.aspose.cells/fontconfigs#setFontFolder-java.lang.String-boolean-): Cette méthode est utile s'il n'y a qu'un seul dossier à définir.
1. [**FontConfigs.setFontFolders**](https://reference.aspose.com/cells/java/com.aspose.cells/fontconfigs#setFontFolders-java.lang.String[]-boolean-): Cette méthode est utile lorsque les polices résident dans des dossiers multiples et que l'utilisateur souhaite définir tous les dossiers séparément plutôt que de combiner toutes les polices dans un seul dossier.
