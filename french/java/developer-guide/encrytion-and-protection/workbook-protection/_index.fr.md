---
title: Protéger et déprotéger la structure du classeur
type: docs
weight: 40
url: /fr/java/protect-and-unprotect-workbook-structure/
description: Protéger et déprotéger la structure du classeur des fichiers Excel en utilisant des codes Java. Verrouiller et déverrouiller les fichiers Excel (xlsx, xls, xsb) et Open office calc (ODS) en utilisant Aspose.Cells for Java.
---
...
## **Protéger la structure du classeur à l'aide de Aspose.Cell pour Java**
...
## **Déprotéger la structure du classeur à l'aide de Aspose.Cell pour Java**
