...
## **Vérifier si le projet VBA dans un classeur est signé**
 ...
 Le code suivant charge le classeur et vérifie si son projet VBA est signé à l'aide[**Classeur.getVbaProject().isSigned()**](https://reference.aspose.com/cells/java/com.aspose.cells/vbaproject#IsSigned)propriété. La propriété reviendra**vrai** si le projet est signé sinon il reviendra**faux**.
