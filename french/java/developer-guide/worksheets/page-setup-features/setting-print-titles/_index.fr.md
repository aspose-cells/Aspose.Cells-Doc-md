...
type: docs
weight: 200
url: /fr/java/how-to-set-print-titles/
...
keywords: Imprimer des lignes et colonnes en boucle, Java. Comment définir des titres d impression, Définir et effacer les titres d impression avec Java, Comment effacer les titres d impression en Java, Comment ajouter des titres d impression en Java, comment supprimer les titres d impression en Java, Comment définir des titres d impression dans Excel, Comment effacer les titres d impression dans Excel.
---
...
Pour définir des titres d'impression dans une feuille spécifique : Tout d'abord, chargez le [fichier d'exemple](input.xlsx), puis vous devez modifier les propriétés [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) et [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) de l'objet [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) pour la feuille souhaitée. Définir ces propriétés avec une chaîne de plage configurera les titres d'impression.
...
Pour supprimer les titres d'impression dans une feuille spécifique : Tout d'abord, chargez le [fichier d'exemple](input.xlsx), puis modifiez les propriétés [**Worksheet.getPageSetup().setPrintTitleRows()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleRows-java.lang.String-) et [**Worksheet.getPageSetup().setPrintTitleColumns()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintTitleColumns-java.lang.String-) de l'objet [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/) pour la feuille souhaitée. En définissant ces propriétés comme une chaîne vide, vous supprimerez les titres d'impression.
