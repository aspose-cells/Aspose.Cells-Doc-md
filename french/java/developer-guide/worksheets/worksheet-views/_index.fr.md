...
#### **Suppression de volets**
 Les développeurs peuvent supprimer les volets fractionnés à l'aide de l'outil[Feuille de travail](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet) classe'[supprimerSplit](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#removeSplit\(\)) méthode.
