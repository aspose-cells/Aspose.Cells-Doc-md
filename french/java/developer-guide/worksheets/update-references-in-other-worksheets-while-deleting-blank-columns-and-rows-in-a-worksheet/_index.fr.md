...
{{% alert color="primary" %}} 
 ...
 Lorsque vous supprimez des colonnes et des lignes vides dans une feuille de calcul, ses références dans d'autres feuilles de calcul deviennent invalides. Si vous souhaitez éviter ce comportement et que ces références soient également mises à jour, veuillez utiliser le[DeleteOptions.UpdateReference](https://reference.aspose.com/cells/java/com.aspose.cells/deleteoptions#UpdateReference) et réglez-le**vrai**.
...
## **Sortie console**
Il s'agit de la sortie console de l'exemple de code ci-dessus lorsque[DeleteOptions.UpdateReference](https://reference.aspose.com/cells/java/com.aspose.cells/deleteoptions#UpdateReference) la propriété a été définie comme**vrai**.
