...
{{% alert color="primary" %}}
 ...
 Aspose.Cells for Java écrit directement les informations sur API et le numéro de version dans les documents de sortie. Par exemple, lors du rendu du document à PDF, Aspose.Cells for Java remplit**Application** champ avec la valeur 'Aspose.Cells' et**PDF Producteur** champ avec la valeur, par exemple 'Aspose.Cells for Java v17.9'.
...
{{< gist "aspose-cells-gists" "5876dc77e47649b66bdb5deefb4b5639" "Examples-src-main-java-com-aspose-cells-examples-loading_saving-AccessingDocumentProperties.java" >}}
 ...
 Le[**PropriétéDocument**](https://reference.aspose.com/cells/java/com.aspose.cells/DocumentProperty)class permet de récupérer le nom, la valeur et le type de la propriété du document :
