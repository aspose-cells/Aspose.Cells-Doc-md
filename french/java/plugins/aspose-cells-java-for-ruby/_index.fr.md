---
title: Aspose.Cells Java pour rubis
type: docs
weight: 40
url: /fr/java/aspose-cells-java-for-ruby/
---
## **Introduction**
...
### **Aspose.Cells Java pour rubis**
Le projet Aspose.Cells Java pour Ruby montre comment différentes tâches peuvent être effectuées à l'aide des API Aspose.Cells Java dans Ruby. Ce projet vise à fournir des exemples utiles aux développeurs Ruby qui souhaitent utiliser Aspose.Cells for Java dans leurs projets Ruby en utilisant Rjb (Ruby Java Bridge).
## **Configuration système requise et plates-formes prises en charge**
### **Configuration requise**
**Voici la configuration système requise pour utiliser Aspose.Cells Java pour Ruby :**
...
- [Télécharger et configurer Aspose.Cells en Ruby](/cells/fr/java/download-and-configure-aspose-cells-in-ruby/)
- [Guide du programmeur Ruby](/cells/fr/java/ruby-programmers-guide/)
...
- [Soutenir, étendre et contribuer à Aspose.Cells en Ruby](/cells/fr/java/support-extend-and-contribute-to-aspose-cells-in-ruby/)
