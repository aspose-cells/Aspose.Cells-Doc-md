---
title: Figer les volets en Python
type: docs
weight: 40
...
Pour figer les volets dans le document de feuille de calcul à l'aide de **Aspose.Cells Java pour Python**, invoquez simplement le module **FreezePanes**.
