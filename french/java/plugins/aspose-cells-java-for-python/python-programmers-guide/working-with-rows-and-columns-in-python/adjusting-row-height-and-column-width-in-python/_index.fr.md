...
description: Utilisez Python Excel API pour créer des fichiers Excel dans Python. Ajustez la hauteur des lignes et la largeur des colonnes dans XLSX ou XLS dans vos applications Python sans MS Office.
---
