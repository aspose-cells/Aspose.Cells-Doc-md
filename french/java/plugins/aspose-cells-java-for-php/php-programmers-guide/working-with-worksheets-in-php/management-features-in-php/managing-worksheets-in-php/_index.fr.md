...
Pour ajouter une feuille de calcul à un nouveau fichier Excel à l'aide**Aspose.Cells Java pour PHP** , il suffit d'appeler**add_worksheet** méthode de**Gestion des feuilles de calcul** module.
...
### **Suppression de feuilles de calcul à l'aide du nom de la feuille**
 Pour supprimer une feuille de calcul par nom de feuille à l'aide de**Aspose.Cells Java pour PHP** , il suffit d'appeler**remove_worksheet_by_name** méthode de**Gestion des feuilles de calcul** module.
...
### **Suppression de feuilles de calcul à l'aide de l'index des feuilles**
 Pour supprimer une feuille de calcul par index de feuille à l'aide de**Aspose.Cells Java pour PHP** , il suffit d'appeler**remove_worksheet_by_index** méthode de**Gestion des feuilles de calcul** module.
