---
title: Aspose.Cells for Java 8.4.2 Notes de mise à jour
type: docs
weight: 60
url: /fr/java/aspose-cells-for-java-8-4-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 8.4.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.4.2/)
...
## **Nouvelles fonctionnalités**
 ...
 (CELLSJAVA-41289) - Un moyen simple pour la configuration du graphique


## **Insectes**


 (CELLSJAVA-41323) - Les filigranes ne s'affichent pas correctement
 ...
 (CELLSJAVA-41308) - L'emplacement de la forme est incorrect lors du rendu de la feuille de calcul au format PDF
...
(CELLSJAVA-41249) - WordArt n'est pas rendu correctement dans le fichier PDF de sortie
 ...
 (CELLSJAVA-41299) - Le fichier est corrompu lorsque xls est enregistré au format xlsx
...
## **Exceptions**
 ...
 (CELLSJAVA-41280) - L'exception "java.lang.ArrayIndexOutOfBoundsException" s'est produite pour un format de date personnalisé impair

 (CELLSJAVA-41274) - java.lang.NullPointerException sur Workbook.save après des opérations de chargement et de sauvegarde répétées
...
Ajoute les énumérations PasteType.Default et PasteType.DefaultExceptBorders.
 ...
 Étant donné que la base de code de Aspose.Cells for Java correspond au code de la version .NET pertinente, la plupart des modifications, améliorations et correctifs inclus dans le Aspose.Cells for .NET v8.4.2 sont également inclus dans ce Aspose.Cells for Java v8.4.2.
