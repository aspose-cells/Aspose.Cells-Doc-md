---
title: Aspose.Cells for Java 8.6.1 Notes de mise à jour
type: docs
weight: 20
url: /fr/java/aspose-cells-for-java-8-6-1-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 8.6.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.6.1/)
...
(CELLSJAVA-41493) - Les traits d'union longs ne s'affichent pas correctement dans la sortie PDF/Image du graphique Excel
 ...
 (CELLSJAVA-41537) - Ruby n'est pas copié avec Range.copy()

 (CELLSJAVA-41534) - Perte d'informations sur la corbeille personnalisée et les métadonnées pendant Workbook.copy()

 (CELLSJAVA-41531) - L'alignement du texte ActiveXControl est permuté

 (CELLSJAVA-41525) - La plage ne se met pas à jour après l'insertion de lignes

 (CELLSJAVA-41522) - Problème de copie de mise en forme conditionnelle

 (CELLSJAVA-41507) - Problème de calcul lors du calcul d'une formule basée sur la plage nommée
...
(CELLSJAVA-41488) - La validation déroulante ne s'applique pas à plus d'une région lorsque la feuille de calcul est enregistrée sous XLS
 ...
 (CELLSJAVA-41440) - Problème d'alignement horizontal lors du chargement d'un fichier
...
(CELLSJAVA-41529) - Exception : "java.lang.ArrayIndexOutOfBoundsException" s'est produite lors du chargement d'un fichier XLSB
 ...
 (CELLSJAVA-41524) - java.lang.IndexOutOfBoundsException : index : 14, taille : 14, lors de la copie de classeurs
...
## **Insectes**
 ...
 (CELLSJAVA-41519) - Le menu de la liste se déplace vers une position incorrecte

 (CELLSJAVA-41495) - La barre de défilement horizontale ne bouge pas
