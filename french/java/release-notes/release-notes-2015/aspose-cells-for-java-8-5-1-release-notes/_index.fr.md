...
type: docs
weight: 40
url: /fr/java/aspose-cells-for-java-8-5-1-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 8.5.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.5.1/)
...
## **Insectes**
 ...
 (CELLSJAVA-41378) - L'alignement de certaines cellules n'est pas conservé dans le code HTML généré
...
(CELLSJAVA-41396) - Le calcul des formules ne fonctionne pas lorsque nous avons plus de 65 536 cellules nommées
 ...
 (CELLSJAVA-41379) - Couleurs des onglets perdues après le réenregistrement du XLSB
 ...
 (CELLSJAVA-41410) - Problème de couleur d'image dans la transformation d'Excel en PDF

 (CELLSJAVA-41406) - TextBox sur le graphique se déplace après le rendu de la feuille de calcul au format PDF

 (CELLSJAVA-41403) - Source : le produit chimique est remplacé par la bordure du graphique dans le PDF

 (CELLSJAVA-41402) - Source : le produit chimique est remplacé par la bordure du graphique en PNG
...
## **Exceptions**
 ...
 (CELLSJAVA-41408) - CellsException : Erreur entre la forme et l'image ! lors de la conversion d'une feuille de calcul en PDF
