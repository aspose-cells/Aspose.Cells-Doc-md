---
title: Aspose.Cells for Java 7.6.0 Notes de mise à jour
type: docs
weight: 20
url: /fr/java/aspose-cells-for-java-7-6-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 7.6.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.6.0/)
...
40615 - NullPointerException lors de l'ouverture d'une feuille de calcul Excel
 ...
 40618 - Le fichier de modèle Excel ne se charge pas
