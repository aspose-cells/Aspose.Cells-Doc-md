...
type: docs
weight: 1
url: /fr/java/aspose-cells-for-java-20-12-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells for Java 20.12](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.12/).
