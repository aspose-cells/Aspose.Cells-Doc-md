---
title: Aspose.Cells for Java 7.7.1 Notes de mise à jour
type: docs
weight: 90
url: /fr/java/aspose-cells-for-java-7-7-1-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 7.7.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.7.1/)
...
Refactor lecture et écriture du tableau croisé dynamique de xlsb

Caractéristiques mineures

Nouvelles fonctionnalités

(CELLSJAVA-40409) - Lecture de fichiers modèles volumineux avec LightCells
(CELLSJAVA-40269) - Lecture de fichiers modèles volumineux avec LightCells
(CELLSJAVA-40696) - Prise en charge d'ActiveX (Lire les contrôles ActiveX tels que les boutons)
(CELLSJAVA-40372) - Prise en charge d'ActiveX (Lire les contrôles ActiveX tels que les boutons)
(CELLSJAVA-40373) - Distinction entre l'image ActiveX et l'image normale

Améliorations

(CELLSJAVA-40688) - Impossible de définir la largeur de colonne par défaut
...
(CELLSJAVA-40422) - ArrayIndexOutOfBoundsException à l'ouverture du fichier


Noter
Étant donné que la base de code de Aspose.Cells for Java correspond au code de la version .NET pertinente, la plupart des modifications, améliorations et correctifs inclus dans le Aspose.Cells for .NET v7.7.1 sont également inclus dans ce Aspose.Cells for Java v7.7.1.
