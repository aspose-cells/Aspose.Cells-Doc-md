...
type: docs
weight: 30
url: /fr/java/aspose-cells-for-java-8-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 8.1.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.1.2/)
...
(CELLSJAVA-40883) - Problème avec le format de date lors de l'importation de CSV
...
(CELLSJAVA-40854) - HtmlHiddenRowDisplayType.HIDDEN provoque le décalage des cellules dans le code HTML résultant (problème de répartition)
(CELLSJAVA-40835) - Problème d'exportation des colonnes masquées dans le fichier HTML rendu
...
(CELLSJAVA-40877) - Excel en PDF - Mauvaise qualité d'image rendue par Aspose Cells 8.xx
(CELLSJAVA-40910) - Les images sont perdues lorsque le PDF est rendu à l'aide de PdfSaveOptions.setImageType(ImageFormat.getPng())
(CELLSJAVA-40907) - Des marqueurs de point de données manquent dans le graphique lorsqu'un modèle de fichier Excel est enregistré au format HTML
(CELLSJAVA-40904) - Certains graphiques ne sont pas rendus correctement dans notre format de fichier HTML
...
(CELLSJAVA-40869) - Les équations manquent de glyphes et certains textes formatés sont tronqués dans le fichier PDF rendu
(CELLSJAVA-40865) - L'image n'est pas claire dans le pdf de sortie
(CELLSJAVA-40860) - Les propriétés des bulles ont changé dans le graphique lors de la ré-enregistrement du fichier de modèle XLSX
(CELLSJAVA-40859) - Les propriétés des bulles ont changé dans le graphique lors de la ré-enregistrement du fichier de modèle XLSX
