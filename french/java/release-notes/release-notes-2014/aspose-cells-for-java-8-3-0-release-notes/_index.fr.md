...
type: docs
weight: 10
url: /fr/java/aspose-cells-for-java-8-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 8.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.3.0/)
...
(CELLSJAVA-41070) - Problème HTML vers XLS - le nombre formaté est rendu vide
...
(CELLSJAVA-41060) - La modification de la palette de couleurs du classeur lors de l'enregistrement du XLSX au format XLS entraîne l'ouverture par MS Excel de la feuille de calcul résultante en mode protégé
(CELLSJAVA-41059) - Modification de l'ordre des règles de mise en forme conditionnelle lors de l'enregistrement de XLSX vers XLS avec changement de palette
...
(CELLSJAVA-41044) - Aspose.Cells Le PDF généré ne passe pas le test de conformité PDF/A-1b
...
(CELLSJAVA-41045) - Les colonnes du graphique se chevauchent avec l'axe du bas lors du rendu de la feuille de calcul au format PDF
(CELLSJAVA-40989) - Le graphique à barres comporte des lignes verticales supplémentaires à droite des barres lorsqu'il est rendu au format PDF
(CELLSJAVA-40988) - L'étiquette de données du graphique est coupée dans le PDF rendu
(CELLSJAVA-40987) - Les étiquettes et la légende des axes du graphique se chevauchent dans le PDF rendu
