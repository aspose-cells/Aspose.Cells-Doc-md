...
type: docs
weight: 8
url: /fr/java/aspose-cells-for-java-21-5-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells for Java 21.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-21.5/).
...
|CELLSJAVA-43420| Texte pivoté incorrectement aligné lors de l'enregistrement au format HTML|
