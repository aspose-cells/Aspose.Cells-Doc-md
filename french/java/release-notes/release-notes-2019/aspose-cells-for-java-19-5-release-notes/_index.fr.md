---
title: Aspose.Cells for Java 19.5 Notes de mise à jour
type: docs
weight: 80
url: /fr/java/aspose-cells-for-java-19-5-release-notes/
---
{{% alert color="primary" %}} 

Cette page contient les notes de version pour Aspose.Cells for Java 19.5.
