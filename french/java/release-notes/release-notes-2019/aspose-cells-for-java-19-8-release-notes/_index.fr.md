...
|Punaise|
|CELLSJAVA-42970|Bordure étendue indésirable dans Excel jusqu'au rendu PDF|Punaise|
...
|CELLSJAVA-42959|Exception "Erreur de forme à l'image" lors du rendu d'un fichier XLSX en PDF|Exception|
