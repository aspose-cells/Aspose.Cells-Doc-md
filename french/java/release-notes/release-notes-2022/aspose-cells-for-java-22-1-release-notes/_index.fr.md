...
type: docs
weight: 12
url: /fr/java/aspose-cells-for-java-22-1-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells for Java 22.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.1/).
