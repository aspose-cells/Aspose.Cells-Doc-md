...
type: docs
weight: 7
url: /fr/java/aspose-cells-for-java-22-6-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells for Java 22.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.6/).
