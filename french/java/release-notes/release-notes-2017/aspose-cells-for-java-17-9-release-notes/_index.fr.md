...
- [Contrôler le chargement des ressources externes dans le classeur MS Excel lors du rendu vers PDF](/cells/fr/java/control-loading-of-external-resources-in-ms-excel-workbook-while-rendering-to-pdf/)
