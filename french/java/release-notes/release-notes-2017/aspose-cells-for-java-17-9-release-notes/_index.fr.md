...
type: docs
weight: 40
url: /fr/java/aspose-cells-for-java-17-9-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 17.9](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.9/).
...
|CELLSJAVA-42379|Implémenter la destination nommée lors du rendu en sortie PDF (requête de signet)|Nouvelle fonctionnalité|
...
- [Ajouter des signets PDF avec des destinations nommées](/cells/fr/java/add-pdf-bookmarks-with-named-destinations/)
- [Contrôlez le chargement des ressources externes dans le classeur MS Excel lors du rendu au format PDF](/cells/fr/java/control-loading-of-external-resources-in-ms-excel-workbook-while-rendering-to-pdf/)
- [Copier la macro VBA UserForm DesignerStorage du modèle au classeur cible](/cells/fr/java/copy-vba-macro-userform-designerstorage-from-template-to-target-workbook/)
- [Créer supprimer et obtenir des commentaires GridCell](/cells/fr/java/create-remove-and-get-gridcell-comments/)
- [Envoyer la forme avant ou arrière dans la feuille de calcul](/cells/fr/java/send-shape-front-or-back-inside-the-worksheet/)
