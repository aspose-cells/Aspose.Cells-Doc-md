...
type: docs
weight: 90
url: /fr/java/aspose-cells-for-java-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 17.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.4.0/).
...
- [Mot de passe protéger le projet VBA du classeur Excel](/cells/fr/java/password-protect-the-vba-project-of-excel-workbook/)
- [Découvrez si le projet VBA est protégé](/cells/fr/java/find-out-if-vba-project-is-protected/)
- [Vérifiez si le projet VBA est protégé et verrouillé pour l'affichage](/cells/fr/java/check-if-vba-project-is-protected-and-locked-for-viewing/)
