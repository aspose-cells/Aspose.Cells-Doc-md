...
type: docs
weight: 20
url: /fr/java/aspose-cells-for-java-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
- [Convertir l'art intelligent en forme de groupe](/cells/fr/java/convert-the-smart-art-to-group-shape/)
- [Créer un classeur partagé avec Aspose.Cells](/cells/fr/java/create-shared-workbook-with-aspose-cells/)
- [Déterminer si la forme est une forme artistique intelligente](/cells/fr/java/determine-if-shape-is-smart-art-shape/)
- [Trouver le nom de l'élément racine de la carte XML](/cells/fr/java/find-the-root-element-name-of-xml-map/)
- [Ignorer les erreurs lors du rendu d'Excel en PDF](/cells/fr/java/ignore-errors-while-rendering-excel-to-pdf/)
- [Mot de passe Protéger ou déprotéger le classeur partagé](/cells/fr/java/password-protect-or-unprotect-the-shared-workbook/)
- [Requête Cell Zones mappées sur le chemin de la carte XML à l'aide de la méthode Worksheet.XmlMapQuery](/cells/fr/java/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
- [Rendu de la séquence de pages à l'aide des propriétés PageIndex et PageCount de ImageOrPrintOptions](/cells/fr/java/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/)
