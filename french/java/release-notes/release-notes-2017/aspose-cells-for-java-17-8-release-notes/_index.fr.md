...
type: docs
weight: 50
url: /fr/java/aspose-cells-for-java-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 17.8](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.8/).
...
- [Ajouter une signature numérique à un fichier Excel déjà signé](/cells/fr/java/add-digital-signature-to-an-already-signed-excel-file/)
- [Désactiver les commentaires révélés de niveau inférieur lors de l'enregistrement au format HTML](/cells/fr/java/disable-downlevel-revealed-comments-while-saving-to-html/)
- [Exporter les commentaires lors de l'enregistrement du fichier Excel au format Html](/cells/fr/java/export-comments-while-saving-excel-file-to-html/)
- [Sortir une page vierge lorsqu'il n'y a rien à imprimer](/cells/fr/java/output-blank-page-when-there-is-nothing-to-print/)
