...
type: docs
weight: 80
url: /fr/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [Décaler la première ligne vers le bas lors de l'insertion de lignes de table de données Cells](/cells/fr/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
