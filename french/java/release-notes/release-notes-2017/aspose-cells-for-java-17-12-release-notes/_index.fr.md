...
type: docs
weight: 10
url: /fr/java/aspose-cells-for-java-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [Mettre à jour les jours de conservation de l'historique des journaux de révision dans le classeur partagé](/cells/fr/java/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
