...
type: docs
weight: 100
url: /fr/java/aspose-cells-for-java-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 17.3.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.3.0/).
...
1. [Personnaliser les paramètres de globalisation pour le tableau croisé dynamique](/cells/fr/java/customize-globalization-settings-for-pivot-table/)
1. [Exécuter la fonction côté client lors du changement de page GridWeb](/cells/fr/java/execute-client-side-function-on-gridweb-page-change/)
1. [Valider toute la feuille de calcul au lieu des seules cellules mises à jour](/cells/fr/java/validate-entire-worksheet-instead-of-only-the-updated-cells/)
