...
type: docs
weight: 60
url: /fr/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [Implémenter les erreurs et la valeur booléenne en russe ou dans toute autre langue](/cells/fr/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
