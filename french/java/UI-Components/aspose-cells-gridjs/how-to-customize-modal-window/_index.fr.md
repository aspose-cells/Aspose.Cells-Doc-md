...
type: docs
weight: 250
url: /fr/java/aspose-cells-gridjs/how-to-customize-ui-window/
description: This article describes how to customize UI appearence for modal window in GridJs.
keywords: GrilleJs, personnalisé, modal, UI, apparence, visuel, fenêtre
aliases:
aliases:
...
# Guide de stylisation de la modale pour GridJs
...
- [Exemples de styles magnifiques](#beautiful-style-examples)
...
| Suggestion d'entrée | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| Insérer une URL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
...
### Exemple 2 : Thème minimaliste épuré 🤍
...
### Exemple 4 : Thème coloré ludique 🌈
