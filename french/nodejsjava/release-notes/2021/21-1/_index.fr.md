---
title: Aspose.Cells pour Node.js via Java 21.1 Notes de publication
type: docs
weight: 12
url: /fr/nodejs-java/aspose-cells-for-node-js-via-java-21-1-release-notes/
---
{{% alert color="primary" %}} 

Cette page contient les notes de version pour Aspose.Cells pour Node.js via Java 21.1.
