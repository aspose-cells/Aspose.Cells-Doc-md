---
title: Aspose.Cells pour Node.js via Java 21.7 Notes de publication
type: docs
weight: 6
url: /fr/nodejs-java/aspose-cells-for-node-js-via-java-21-7-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells pour Node.js via Java 21.7](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.7/).
