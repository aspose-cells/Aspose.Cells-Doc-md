...
type: docs
weight: 8
url: /fr/nodejs-java/aspose-cells-for-node-js-via-java-23-5-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells for Node.js via Java 23.5](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-23.5/).
