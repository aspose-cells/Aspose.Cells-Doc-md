---
title: Aspose.Cells pour Node.js via Java 20.2 Notes de publication
type: docs
weight: 10
url: /fr/nodejs-java/aspose-cells-for-node-js-via-java-20-2-release-notes/
---
{{% alert color="primary" %}} 

Cette page contient les notes de version pour Aspose.Cells pour Node.js via Java 20.2.
