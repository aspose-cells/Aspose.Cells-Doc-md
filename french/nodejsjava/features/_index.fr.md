...
description: Aspose.Cells pour Node.js via les fonctionnalités Java
---
## **Aspose.Cells pour Node.js via Java Présentation des fonctionnalités**
...
|**Caractéristique**|**La description**|**Aspose.Cells for Java**|**Aspose.Cells pour Node.js via Java**|
|:- |:- |:- |:- |
...
|TableurML (XLSX, XML)| Aspose.Cells prend en charge OOXML, Flat OPC et également Excel 2003 XML. En outre,<br>le composant prend en charge tous les principaux formats de fichiers Excel 2007 et versions ultérieures, par exemple XLSX, XLTX, XLSM, XLTM, etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Caractéristique**|**Aspose.Cells for Java**|**Aspose.Cells pour Node.js via Java**|
|:- |:- |:- |
