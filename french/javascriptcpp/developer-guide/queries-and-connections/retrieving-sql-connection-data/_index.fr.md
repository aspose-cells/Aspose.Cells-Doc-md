---
title: Récupération des données de connexion SQL avec JavaScript via C++
linktitle: Récupération des données de connexion SQL
type: docs
weight: 10
url: /fr/javascript-cpp/retrieving-sql-connection-data/
---
...
Aspose.Cells for JavaScript via C++ fournit la propriété `Workbook.dataConnections` pour récupérer les connexions externes. Elle renvoie un tableau d'objets ExternalConnection dans le classeur.
