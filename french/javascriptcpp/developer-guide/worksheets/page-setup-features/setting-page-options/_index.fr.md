---
title: Définir les options de page avec JavaScript via C++
linktitle: Réglage des options de page
type: docs
weight: 10
url: /fr/javascript-cpp/setting-page-options/
description: Cet article fournit un code d exemple pour définir les options de page des feuilles Excel de manière programmatique en utilisant JavaScript via C++. Définissez l orientation de la page, le facteur d échelle, les options d adaptation à plusieurs pages, le format de papier, la qualité d impression, le numéro de la première page.
keywords: définir l orientation de la page Excel JavaScript via C++, définir le facteur d échelle Excel JavaScript via C++, définir la taille du papier de la feuille Excel JavaScript via C++
---
...
La classe [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) fournit la propriété [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) utilisée pour configurer les options de mise en page de la feuille de calcul. En fait, cette propriété [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) est un objet de la classe [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) utilisée pour définir différentes options de mise en page pour une feuille imprimée. La classe [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) fournit diverses propriétés utilisées pour définir les options de configuration de la page. Certaines de ces propriétés sont abordées ci-dessous.  

### **Orientation de la page**  

L'orientation de la page peut être définie sur portrait ou paysage en utilisant la propriété [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) de la classe [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). La propriété [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) accepte l'une des valeurs prédéfinies dans l'énumération [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype), listée ci-dessous.  
...
Il est possible de réduire ou d'agrandir la taille d'une feuille en ajustant le facteur de mise à l’échelle avec la propriété [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--).  
...
Pour adapter le contenu de la feuille à un nombre spécifique de pages, utilisez les propriétés [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) et [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) de la classe [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). Ces propriétés servent également à mettre à l’échelle les feuilles.  

{{% alert color="primary" %}}  
Vous pouvez choisir la propriété [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) ou la propriété [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--), mais pas les deux en même temps.  
{{% /alert %}}  
...
Définissez la taille du papier sur laquelle les feuilles seront imprimées en utilisant la propriété [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) de la classe [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup). La propriété [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) accepte l'une des valeurs prédéfinies dans l'énumération [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype), listée ci-dessous.  
...
### **Qualité d'impression**  
 ...
 Définir la qualité d'impression des feuilles à imprimer avec la propriété [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--). L'unité de mesure de la qualité d'impression est le point par pouce (DPI).  
