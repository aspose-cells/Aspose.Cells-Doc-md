---
title: Méthode simple pour la configuration de graphique utilisant la méthode Chart.chartDataRange avec JavaScript via C++
linktitle: Méthode simple pour la configuration de graphique en utilisant la méthode Chart.chartDataRange
description: Apprenez à configurer facilement des graphiques en utilisant la méthode Chart.chartDataRange dans Aspose.Cells for JavaScript via C++. Notre guide vous montrera comment spécifier la plage de données pour votre graphique, vous permettant de créer des graphiques professionnels et précis avec un effort minimal.
keywords: Aspose.Cells for JavaScript via C++, graphique, méthode chartDataRange, plage de données, professionnel, précis, graphiques.
type: docs
weight: 190
url: /fr/javascript-cpp/easy-way-for-chart-setup-using-chart-setchartdatarange-method/
---

{{% alert color="primary" %}}

Aspose.Cells fournit maintenant une méthode [**Chart.chartDataRange(string, boolean)**](https://reference.aspose.com/cells/javascript-cpp/chart/#chartDataRange-string-boolean-) pour configurer facilement un graphique. En utilisant cette méthode, vous n'aurez maintenant plus besoin d'ajouter séparément des données d'axe de série et de catégorie.

{{% /alert %}}

Le code exemple suivant explique l’utilisation de la méthode [**Chart.chartDataRange(string, boolean)**](https://reference.aspose.com/cells/javascript-cpp/chart/#chartDataRange-string-boolean-) pour configurer facilement un graphique.
