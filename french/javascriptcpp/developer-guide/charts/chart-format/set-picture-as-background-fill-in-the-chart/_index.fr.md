---
title: Définir une image comme remplissage d’arrière plan dans le graphique avec JavaScript via C++
linktitle: Définir une image comme fond de graphique
description: Apprenez comment définir une image comme remplissage d’arrière plan dans un graphique en utilisant Aspose.Cells for JavaScript via C++. Notre guide vous montrera comment importer et positionner l’image, ajuster sa taille et sa couleur, et appliquer des options de mise en forme pour améliorer l’apparence de votre graphique.
keywords: Aspose.Cells for JavaScript via C++, visualisation, remplissage d’arrière plan, image, importation, positionnement, taille, couleur, mise en forme.
type: docs
weight: 30
url: /fr/javascript-cpp/set-picture-as-background-fill-in-the-chart/
---
...
## Code JavaScript pour définir une image comme remplissage d’arrière-plan dans le graphique
