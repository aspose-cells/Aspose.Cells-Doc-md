---
title: Définissez le texte de la légende du graphique en remplissant à none en utilisant Aspose.Cells for JavaScript via C+
linktitle: Définir le texte de la légende du graphique sans remplissage en utilisant Aspose.Cells
description: Apprenez comment utiliser Aspose.Cells for JavaScript via C++ pour définir la couleur de remplissage d une entrée de légende de graphique sur aucune. Ce guide illustrera comment modifier la couleur de remplissage des entrées de légende dans les graphiques Microsoft Excel pour une meilleure visualisation et personnalisation.
keywords: Aspose.Cells for JavaScript via C++, Remplissage de l entrée de la légende du graphique, Microsoft Excel, Visualisation, Personnalisation.
type: docs
weight: 320
url: /fr/javascript-cpp/set-text-of-chart-legend-entry-fill-to-none-using-aspose-cells/
---

{{% alert color="primary" %}}

Si vous souhaitez définir le texte de l'entrée de la légende du graphique en aucun pour qu'il ne s'affiche pas dans la légende du graphique, veuillez définir [**LegendEntry.isTextNoFill()**](https://reference.aspose.com/cells/javascript-cpp/legendentry/#isTextNoFill--) sur **true**.
