---
title: Convertir un graphique en image pour la région japonaise avec JavaScript via C++
description: Apprenez comment utiliser Aspose.Cells for JavaScript via C++ pour configurer le graphique pour le japonais. Notre guide vous montrera comment configurer les graphiques pour supporter les caractères japonais et leur mise en forme, y compris les polices, la taille, la direction du texte et plus encore.  
keywords: Aspose.Cells for JavaScript via C++, Graphiques, Configuration japonaise, police, taille de police, direction du texte, support.  
linktitle: Définir la région japonaise  
type: docs  
weight: 10  
url: /fr/javascript-cpp/convert-chart-to-image-for-japanese-region/  
...
Première étape, vous devez définir une classe "ChartJapaneseSettings" qui hérite de [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
