...
type: docs
weight: 10
url: /fr/javascript-cpp/format-number-to-date/
description: Cet article expliquera comment formater un nombre en date en utilisant Aspose.Cells for JavaScript via C++.
...
Pour formater des nombres en date dans la bibliothèque Aspose.Cells for JavaScript via C++ pour travailler avec des fichiers Excel, vous pouvez appliquer une mise en forme de date de manière programmatique. Voici comment faire avec Aspose.Cells for JavaScript via C++ :
