...
type: docs
weight: 10
url: /fr/javascript-cpp/how-to-format-number-to-time/
description: Cet article présentera comment formater un nombre en heure en utilisant l API Aspose.Cells for JavaScript via C++.
...
## **Comment formater un nombre en heure dans Aspose.Cells for JavaScript via C++**
Formater des nombres en heure dans Aspose.Cells for JavaScript via C++ est un processus simple qui consiste à appliquer un format personnalisé aux cellules ou à une plage de cellules. Aspose.Cells est une bibliothèque puissante qui vous permet de travailler avec des fichiers Excel dans des applications Web sans avoir besoin d'installer Microsoft Excel. Voici comment vous pouvez formater des nombres en heure :

### Étape 1 : Inclure Aspose.Cells for JavaScript via C++ dans votre page

Obtenez la distribution de Aspose.Cells for JavaScript via C++ et incluez le script d'exécution dans votre page HTML.

### Étape 2 : Ouvrir un classeur existant à partir de l'entrée de fichier

Utilisez une entrée de fichier pour charger un fichier Excel existant dans le navigateur.

### Étape 3 : Accéder à la feuille de calcul

Accédez à la feuille de calcul où vous souhaitez formater les nombres en heures. Si vous travaillez avec un classeur nouveau, vous travaillerez probablement avec la première feuille.

### Étape 4 : Appliquer un format heure à une cellule

Pour formater un nombre en heure, utilisez l'objet Style associé à une cellule. Spécifiez le format horaire en utilisant des chaînes de format de nombre personnalisées.

### Étape 5 : Enregistrer le classeur et fournir un téléchargement

Après avoir appliqué les formats souhaités, enregistrez le classeur et fournissez un lien de téléchargement à l'utilisateur.
...
### Exemple de code dans le navigateur

Le code HTML suivant montre comment charger un fichier Excel, formater une valeur numérique dans la cellule A1 en heure (heures et minutes), et télécharger le classeur modifié :
