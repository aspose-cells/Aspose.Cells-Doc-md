...
type: docs
weight: 90
url: /fr/javascript-cpp/modify-an-existing-style/
---
...
## **Utilisation de Aspose.Cells for JavaScript via C++**
 ...
 Les exemples suivants montrent comment utiliser la méthode [**Style.update()**](https://reference.aspose.com/cells/javascript-cpp/style/#update--).
