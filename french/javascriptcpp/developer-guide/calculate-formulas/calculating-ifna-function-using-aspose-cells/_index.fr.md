---
title: Calcul de la fonction IFNA en utilisant Aspose.Cells for JavaScript via C++
description: Comment calculer les fonctions IFNA en utilisant la bibliothèque Aspose.Cells pour JavaScript via C++. Charger un fichier Excel existant ou en créer un nouveau, puis calculer la fonction IFNA pour obtenir le résultat. Enfin, enregistrer le fichier Excel modifié sur le disque.
keywords: Aspose.Cells, Excel, fonctions IFNA, calculs JavaScript via C++
type: docs
weight: 40
url: /fr/javascript-cpp/calculating-ifna-function-using-aspose-cells/
---
...
{{% /alert %}} 
## **Calcul de la fonction IFNA en utilisant Aspose.Cells for JavaScript via C++**
Le code d'exemple suivant illustre le calcul de la fonction IFNA en utilisant Aspose.Cells for JavaScript via C++. 
