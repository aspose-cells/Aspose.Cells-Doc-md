---
title: Insertion de Sparkline avec JavaScript via C++
linktitle: Minigraphiques
type: docs
weight: 160
url: /fr/javascript-cpp/creating-sparklines/
description: Créer un sparkline pour Excel en utilisant Aspose.Cells for JavaScript via C++.
---
...
Il est simple de créer un sparkline avec Aspose.Cells for JavaScript via C++ avec les exemples de codes suivants :
...
## **Sujets avancés**
- [Utiliser les sparklines et les paramètres de format 3D](/cells/fr/javascript-cpp/using-sparklines-and-settings-3d-format/)
