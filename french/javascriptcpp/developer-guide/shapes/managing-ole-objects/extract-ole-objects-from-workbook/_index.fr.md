---
title: Extraire les objets OLE du classeur avec JavaScript via C++
linktitle: Extraire les objets OLE du classeur
type: docs
weight: 110
url: /fr/javascript-cpp/extract-ole-objects-from-workbook/
---
...
Parfois, vous devez extraire les objets OLE d'un classeur. Aspose.Cells supporte l'extraction et la sauvegarde de ces objets OLE.
 ...
 Cet article montre comment créer une application en JavaScript via C++ et extraire différents objets OLE d’un classeur avec quelques lignes de code simples.
{{% /alert %}}
...
Démarrez un environnement JavaScript et créez un nouveau projet. Cet exemple montrera une application basée sur le navigateur, mais vous pouvez également utiliser tout environnement compatible JavaScript.

1. Ajouter des dépendances  
   1. Incluez le script Aspose.Cells for JavaScript via C++ dans votre page HTML et créez une interface utilisateur simple pour sélectionner un fichier Excel et extraire les objets OLE :
