---
title: Actualiser automatiquement l’objet OLE via Microsoft Excel en utilisant Aspose.Cells for JavaScript via C++
linktitle: Actualiser automatiquement un objet OLE via Microsoft Excel en utilisant Aspose.Cells
type: docs
weight: 270
url: /fr/javascript-cpp/automatically-refresh-ole-object-via-microsoft-excel-using-aspose-cells/
description: Apprenez comment actualiser automatiquement les objets OLE dans Excel en utilisant Aspose.Cells for JavaScript via C++.
---

{{% alert color="primary" %}}  
Aspose.Cells propose la propriété [**OleObject.autoLoad**](https://reference.aspose.com/cells/javascript-cpp/oleobject/#autoLoad--) pour rafraîchir l'objet OLE lorsque le fichier Excel est ouvert dans Microsoft Excel. Grâce à cette propriété, l'objet OLE affichera l'image OLE correcte générée par Microsoft Excel.  
{{% /alert %}}  
