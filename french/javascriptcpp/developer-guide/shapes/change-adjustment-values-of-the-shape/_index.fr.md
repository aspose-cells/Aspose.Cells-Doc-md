---
title: Changer les valeurs d ajustement de la forme avec JavaScript via C++
linktitle: Modifier les valeurs d ajustement de la forme.
type: docs
weight: 2000
url: /fr/javascript-cpp/change-adjustment-values-of-the-shape/
description: Apprenez comment modifier les valeurs d ajustement des formes dans Excel en utilisant Aspose.Cells for JavaScript via C++.
---

{{% alert color="primary" %}}  
Aspose.Cells fournit la propriété [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) pour apporter des modifications aux points d'ajustement avec les formes. Dans l'interface utilisateur Microsoft Excel, les ajustements s'affichent sous forme de nœuds de diamant jaune. Par exemple :  
...
Cet article expliquera l'utilisation de la propriété [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) pour changer la valeur d'ajustement des formes différentes.  
{{% /alert %}}  
