---
title: Insérer des plages avec JavaScript via C++
linktitle: Insérer des plages
type: docs
weight: 105
url: /fr/javascript-cpp/insert-ranges-to-excel/
description: Apprenez comment insérer des plages dans Excel et décaler les autres données en utilisant Aspose.Cells for JavaScript via C++.
---
...
## **Insérer des plages en utilisant Aspose.Cells for JavaScript via C++**

Aspose.Cells for JavaScript via C++ fournit la méthode [Cells.insertRange(CellArea, nombre, ShiftType, boolean)](https://reference.aspose.com/cells/javascript-cpp/cells/#insertRange-cellarea-number-shifttype-boolean-) pour insérer une plage.
