---
title: Formater et modifier des plages nommées avec JavaScript via C++
linktitle: Formater et modifier des plages nommées
type: docs
weight: 85
url: /fr/javascript-cpp/format-and-modify-named-ranges/
description: Apprenez comment formater et modifier des plages nommées en utilisant Aspose.Cells for JavaScript via C++. 
---
...
Pour appliquer le formatage, définissez un objet [**Style**](https://reference.aspose.com/cells/javascript-cpp/style) pour spécifier les paramètres de style et appliquez-le à l'objet [**Range**](https://reference.aspose.com/cells/javascript-cpp/range).
...
Il est possible d'ajouter des bordures à une plage de cellules plutôt qu'à une seule cellule. L'objet [**Range**](https://reference.aspose.com/cells/javascript-cpp/range) fournit une méthode [**outlineBorder(BorderType, CellBorderType, CellsColor)**](https://reference.aspose.com/cells/javascript-cpp/range/#outlineBorder-bordertype-cellbordertype-cellscolor-) qui prend les paramètres suivants pour ajouter une bordure à la plage de cellules :

- Type de bordure, le type de bordure, choisi dans l'énumération [**BorderType**](https://reference.aspose.com/cells/javascript-cpp/bordertype).
- Style de ligne, le style de ligne, choisi dans l'énumération [**CellBorderType**](https://reference.aspose.com/cells/javascript-cpp/cellbordertype).
...
Aspose.Cells permet de renommer une plage nommée selon vos besoins. Vous pouvez obtenir la plage nommée et la renommer en utilisant l'attribut [**Name.text**](https://reference.aspose.com/cells/javascript-cpp/name/#text--). L'exemple suivant montre comment renommer une plage nommée.
...
Aspose.Cells fournit la méthode [**Range.unionRang(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#unionRang-range-) pour faire l'union des plages ; cette méthode retourne un objet [*Array*]. L'exemple suivant montre comment faire l'union de plages.
...
Aspose.Cells fournit la méthode [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-) pour l’intersection de deux plages. La méthode retourne un objet [**Range**](https://reference.aspose.com/cells/javascript-cpp/range). Pour vérifier si une plage intersecte une autre, utilisez la méthode [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-) qui retourne une valeur booléenne. L'exemple suivant montre comment intersecter des plages.
...
Aspose.Cells fournit la méthode [**Range.merge()**](https://reference.aspose.com/cells/javascript-cpp/range/#merge--) pour fusionner les cellules dans la plage. L'exemple suivant montre comment fusionner les cellules individuelles d'une plage nommée.
