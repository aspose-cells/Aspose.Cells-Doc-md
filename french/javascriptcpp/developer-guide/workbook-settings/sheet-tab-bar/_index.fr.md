---
title: Comment contrôler la barre d’onglets de la feuille avec JavaScript via C++
linktitle: Comment contrôler la barre d onglets de feuilles
type: docs
weight: 600
url: /fr/javascript-cpp/how-to-control-sheet-tab-bar/
description: Découvrez comment contrôler la barre d’onglets de la feuille en utilisant le Script Aspose.Cells for Java via C++.
keywords: Comment contrôler la barre d’onglets en JavaScript via C++, Opérer la barre d’onglets en JavaScript via C++, Définir la barre d’onglets en JavaScript via C++, Contrôler la barre d’onglets en JavaScript via C++.  
---

## **Scénarios d'utilisation possibles**  
Lorsque vous devez ajuster l’affichage de la barre d’Excel, vous devez savoir comment contrôler la barre d’onglets, comme cacher ou afficher la barre d’onglets, changer sa largeur, spécifier l’onglet visible en premier, etc. Le Script Aspose.Cells for Java via C++ prend en charge ces fonctionnalités. Aspose.Cells fournit les propriétés et méthodes suivantes pour vous aider à atteindre vos objectifs.
...
## **Comment contrôler la barre d’onglets avec le Script Aspose.Cells for Java via C++**  
