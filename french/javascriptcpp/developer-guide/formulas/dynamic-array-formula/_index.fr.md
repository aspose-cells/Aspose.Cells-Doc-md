---
title: Définir des formules de tableau dynamique avec JavaScript via C++
linktitle: Définir les formules de tableau dynamiques
description: Comment utiliser la bibliothèque Aspose.Cells pour calculer des formules de tableau dynamique dans Excel en utilisant JavaScript via C++. Charger, calculer et enregistrer facilement les fichiers Excel.
keywords: Formules de tableau dynamique, Formules de tableau dynamique dans Excel, Définir des formules de tableau dynamique JavaScript via C++, Calcul des formules de tableau dynamique JavaScript via C++, manipuler des formules de tableau dynamique dans Excel.
type: docs
weight: 70
url: /fr/javascript-cpp/calculation-of-dynamic-array-formulas/
---
...
Veuillez voir le code d'exemple suivant qui charge le [fichier Excel d'exemple](dynamicArrayFormula.xlsx) contenant des données fictives. Après le chargement du fichier, appelez la fonction [Cell.dynamicArrayFormula(string, FormulaParseOptions, boolean)](https://reference.aspose.com/cells/javascript-cpp/cell/#dynamicArrayFormula-string-formulaparseoptions-boolean-) pour définir la formule de tableau dynamique et la fonction [Workbook.refreshDynamicArrayFormulas(boolean)](https://reference.aspose.com/cells/javascript-cpp/workbook/#refreshDynamicArrayFormulas-boolean-) pour actualiser les formules de tableau dynamique avant d'effectuer le calcul de formule, puis enregistrez enfin le classeur en tant que [fichier Excel de sortie](out.xlsx).  
