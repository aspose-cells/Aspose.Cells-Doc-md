...
type: docs
weight: 85
url: /fr/javascript-cpp/data-filtering/
description: Apprenez comment ajouter un filtre de données en utilisant Aspose.Cells for JavaScript via API C++.
keywords: Ajouter un filtre par couleur JavaScript via C++, Ajouter des filtres par date JavaScript via C++, Ajouter des filtres par nombre JavaScript via C++, Ajouter un filtre dynamique JavaScript via C++, Ajouter des filtres par texte JavaScript via C++, Ajouter un filtre personnalisé avec Contains JavaScript via C++, Ajouter un filtre personnalisé avec NotContains JavaScript via C++, Ajouter un filtre personnalisé avec BeginsWith JavaScript via C++, Ajouter un filtre personnalisé avec EndsWith JavaScript via C++
---

{{% alert color="primary" %}}
Microsoft Excel offre de bonnes fonctionnalités pour l'automatisation du filtrage des données de la feuille de calcul. Aspose.Cells prend entièrement en charge les fonctionnalités de filtrage automatique de Microsoft Excel. Cet article explique comment utiliser ces fonctionnalités dans Microsoft Excel, et comment les coder en utilisant Aspose.Cells for JavaScript via C++.
{{% /alert %}}
...
### **Filtre automatique avec Aspose.Cells for JavaScript via C++**
...
Dans l'exemple ci-dessous, nous avons créé le même AutoFilter en utilisant Aspose.Cells for JavaScript via C++ comme nous l'avons fait avec Microsoft Excel dans la section ci-dessus.
...
## **Sujets avancés**
- [Appliquer un filtre avancé de Microsoft Excel pour afficher les enregistrements répondant à des critères complexes](/cells/fr/javascript-cpp/apply-advanced-filter-of-microsoft-excel-to-display-records-meeting-complex-criteria/)
- [Obtenir tous les indices des lignes masquées après le rafraîchissement de l'Autofiltre](/cells/fr/javascript-cpp/get-all-hidden-rows-indices-after-refreshing-autofilter/)
