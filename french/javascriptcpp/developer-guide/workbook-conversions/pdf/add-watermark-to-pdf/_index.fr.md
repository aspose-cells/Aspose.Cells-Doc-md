---
title: Ajouter un filigrane au PDF avec JavaScript via C++
linktitle: Ajouter un filigrane au PDF
type: docs
weight: 9
url: /fr/javascript-cpp/add-watermark-to-pdf/
description: Apprenez comment ajouter un filigrane de texte et d image à un PDF lors de la conversion d Excel en PDF en utilisant Aspose.Cells for JavaScript via C++.
---
...
Vous pouvez facilement ajouter un filigrane de texte à un PDF en spécifiant le texte et la police correspondante. Vous pouvez également définir l'alignement, le décalage, la rotation, l'opacité, le premier-plan/arrière-plan et l'échelle à la page dans [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/).
