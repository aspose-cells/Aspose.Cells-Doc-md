...
type: docs
weight: 60
url: /fr/javascript-cpp/draw-slicer-while-rendering-excel-to-pdf/
---

## **Dessiner un tronçonneur lors du rendu Excel en PDF**
Si vous avez un fichier Excel avec un segmentur appliqué et que vous souhaitez exporter l’Excel au format PDF avec les paramètres du segmentur, Aspose.Cells for JavaScript via C++ le supporte maintenant par défaut. Vous exportez simplement le fichier Excel avec le segmentur en PDF, le PDF généré affichera le segmentur appliqué.
