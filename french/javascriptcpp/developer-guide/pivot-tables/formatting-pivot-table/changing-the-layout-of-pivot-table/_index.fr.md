---
title: Modifier la disposition du tableau croisé dynamique
type: docs
weight: 10
url: /fr/javascript-cpp/changing-the-layout-of-pivot-table/
description: Comment changer la mise en page du tableau croisé dynamique avec Aspose.Cells for JavaScript via C++.
keywords: Aspose.Cells for JavaScript via C++ Excel, bibliothèque JavaScript Excel, changer la mise en page du tableau croisé dynamique en utilisant Aspose.Cells for JavaScript via C++ Excel Library.
---
...
## **Comment changer la mise en page du tableau croisé dynamique en utilisant Aspose.Cells for JavaScript via C++**
La bibliothèque Aspose.Cells for JavaScript via C++ fournit également [**PivotTable.showInCompactForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInCompactForm--), [**PivotTable.showInOutlineForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInOutlineForm--) et [**PivotTable.showInTabularForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInTabularForm--) méthodes pour changer la mise en page du tableau croisé dynamique dans ces trois formes.
