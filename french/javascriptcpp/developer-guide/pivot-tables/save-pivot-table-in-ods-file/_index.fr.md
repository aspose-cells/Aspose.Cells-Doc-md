...
type: docs
weight: 150
url: /fr/javascript-cpp/save-pivot-table-in-ods-file/
---

Aspose.Cells for JavaScript via C++ offre la possibilité de sauvegarder le tableau croisé dynamique dans des fichiers ODS. Pour cela, vous convertissez simplement un classeur avec un tableau croisé dynamique existant ou créez un nouveau tableau croisé dynamique et enregistrez le fichier au format ODS. Assurez-vous d'appeler [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) avant de sauvegarder pour garantir que le tableau croisé dynamique soit correctement rendu dans le fichier ODS de sortie. Le code d'exemple suivant montre comment sauvegarder un tableau croisé dynamique dans un fichier ODS.
