...
Aspose.Cells pour JasperReports fournit une classe nommée ACXlsExporter pour exporter des rapports vers des fichiers XLS. Il prend un fichier .jrprint ou un objet JasperPrint en entrée et l'exporte vers un fichier XLS.
