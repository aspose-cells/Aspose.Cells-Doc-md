...
Pour utiliser **Aspose.Cells for JasperReports** depuis votre application, copiez **aspose.cells.jasperreports.jar** du dossier \lib de Aspose.Cells.JasperReports.zip vers le répertoire JasperReports\lib ou vers un dossier de bibliothèque de votre application. Ensuite, vous pouvez accéder aux exportateurs de manière programmatique.
