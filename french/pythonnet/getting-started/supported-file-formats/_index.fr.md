...
| :- | :- | :- | :- |
|[XLS](https://docs.fileformat.com/spreadsheet/xls/)|Excel 95/5.0 - Cahier d'exercices 2003.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[XLTM](https://docs.fileformat.com/spreadsheet/xltm/)|Modèle Excel prenant en charge les macros.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLAM](https://docs.fileformat.com/spreadsheet/xlam/)|Un fichier de complément Excel prenant en charge les macros utilisé pour ajouter de nouvelles fonctions à Excel.| |{{< emoticons/tick >}}|
...
|[Numbers](https://docs.fileformat.com/spreadsheet/numbers/)|Le document est créé par l'application "Numbers" d'Apple qui fait partie de la suite bureautique iWork d'Apple, un ensemble d'applications qui fonctionnent sur les systèmes d'exploitation Mac OS X et iOS.|{{< emoticons/tick >}}||
