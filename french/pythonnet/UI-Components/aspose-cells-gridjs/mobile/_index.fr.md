...
type: docs
weight: 250
url: /fr/python-net/aspose-cells-gridjs/mobile/
description: Cet article décrit comment utiliser GridJs sur un appareil mobile.
keywords: excel,mobile,feuille de calcul, éditeur, feuille de calcul mobile, visionneuse
---
...
Naviguez sur la page http://votreip:82/ .
