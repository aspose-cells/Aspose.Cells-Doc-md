---
title: comment personnaliser l apparence de l interface utilisateur pour la fenêtre modale dans GridJs  
type: docs
weight: 250
url: /fr/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Cet article décrit comment personnaliser l apparence de l UI pour la fenêtre modale dans GridJs.
keywords: GridJs,customiser,modal,UI,apparence,visuel,fenêtre
aliases:
aliases:
...
# Guide de style pour la modale dans GridJs

## Table des matières

- [Vue d'ensemble](#overview)
- [Nommage des classes CSS](#css-class-naming)
- [Démarrage rapide](#quick-start)
- [Exemples de styles élégants](#beautiful-style-examples)
...
### Noms de modale disponibles

| Type de modale | Nom | Classe CSS |
|------------|------|-----------|
| Tri | `sort` | `.x-spreadsheet-modal-sort` |
| Validation | `validation` | `.x-spreadsheet-modal-validation` |
| Recherche | `search` | `.x-spreadsheet-modal-search` |
| Contrôle | `control` | `.x-spreadsheet-modal-control` |
| Télécharger | `download` | `.x-spreadsheet-modal-download` |
| Email | `email` | `.x-spreadsheet-modal-email` |
| SuggestionSaisie | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| InsérerURL | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| Lien | `link` | `.x-spreadsheet-modal-link` |
| Imprimer | `print` | `.x-spreadsheet-modal-print` |
| Rotation du Texte | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| Validation des données | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| Plus de formats numériques | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| Alerte de validation | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| Insérer/Supprimer | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Exemple 2 : Thème Minimaliste 🤍

Idéal pour les applications professionnelles et d'entreprise.
...
### Exemple 3 : Thème Mode Sombre 🌙

Parfait pour les applications avec support du mode sombre.
...
### Exemple 4 : Thème Coloré et Ludique 🌈

Parfait pour les applications créatives et amusantes.
...
### Exemple 5 : Thème Professionnel d'Entreprise 💼

Adapté aux applications professionnelles et d'entreprise.
...
### 7. Maintenir la hiérarchie visuelle
