...
type: docs
weight: 50
url: /fr/python-net/link-cells-to-xml-map-elements/
---

## **Scénarios d'utilisation possibles**

Vous pouvez lier vos cellules aux éléments de la carte XML en utilisant Aspose.Cells pour Python via .NET. Veuillez utiliser la méthode [**Cells.link_to_xml_map()**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/link_to_xml_map) à cet effet.
