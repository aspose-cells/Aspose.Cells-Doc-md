...
description: Aspose.Cells est une bibliothèque Python pour travailler avec des fichiers de feuilles de calcul. Elle prend en charge la mise en forme des cellules de la feuille de calcul dans les classeurs, permettant aux utilisateurs de personnaliser l apparence et le style des cellules. Cet article présente comment formater les cellules de la feuille de calcul en utilisant Aspose.Cells pour Python via .NET.
keywords: Aspose.Cells pour Python via .NET, Classeur, Feuille, Cellule, Mise en forme, Apparence, Style
type: docs
weight: 2000
url: /fr/python-net/format-worksheet-cells-in-a-workbook/
---
...
Le projet exemple effectue toutes ces tâches et fournit aux développeurs une description détaillée de la manière de créer un classeur, d'ajouter des données et d'appliquer la mise en forme à l'aide de [Aspose.Cells pour Python via .NET](https://products.aspose.com/cells/python-net/).
...
Aspose.Cells pour Python via .NET vous permet de tracer facilement des bordures autour des cellules et des plages. Il vous permet également d'appliquer des polices et de colorier les cellules. Ce composant est suffisamment efficace pour que vous puissiez formater une ligne ou une colonne entière, définir des alignements, faire un retour à la ligne et faire pivoter du texte dans les cellules. Aspose.Cells pour Python via .NET prend également en charge tous les formats de nombres supportés par Microsoft Excel.
...
1. Ajoutez le code suivant au dossier du projet.
