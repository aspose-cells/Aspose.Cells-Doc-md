...
type: docs
weight: 10
url: /fr/python-net/format-number-to-currency/
description: Cet article expliquera comment formater un nombre en devise en utilisant l API Aspose.Cells pour Python via .NET.
...
## **Comment formater un nombre en devise dans Aspose.Cells pour Python via .NET**

Pour formater des nombres en devise dans Aspose.Cells pour Python .NET pour travailler avec des fichiers Excel, vous pouvez appliquer un format de devise aux cellules de manière programmatique. Voici comment le faire en utilisant Python avec Aspose.Cells :
