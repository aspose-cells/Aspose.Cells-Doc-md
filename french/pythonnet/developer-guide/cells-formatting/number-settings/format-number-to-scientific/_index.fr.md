...
type: docs
weight: 10
url: /fr/python-net/how-to-format-number-to-scientific/
description: Cet article présente comment formater un nombre en scientifique en utilisant l API Aspose.Cells pour Python via .NET.
...
## **Comment formater un nombre en scientifique dans Aspose.Cells pour Python via .NET**
Pour formater des nombres en notation scientifique dans Aspose.Cells pour Python via .NET, vous pouvez utiliser la propriété `Style.Custom` d'une cellule. Aspose.Cells vous permet de définir un format personnalisé pour les données dans vos feuilles de calcul, y compris la notation scientifique.
...
En suivant ces étapes, vous pouvez formater des nombres en notation scientifique dans Aspose.Cells pour Python via .NET. N'oubliez pas, vous pouvez personnaliser la chaîne de format (`"0.00E+00"`) selon vos besoins pour ajuster le nombre de décimales ou d'autres aspects de l'affichage en notation scientifique.
