...
type: docs
weight: 10
url: /fr/python-net/how-to-format-number-to-time/
description: Cet article présente comment formater un nombre en heure en utilisant Aspose.Cells pour Python via .NET API.
...
## **Comment formater un nombre en heure dans Aspose.Cells pour Python via .NET**
Le formatage des nombres en heure dans Aspose.Cells pour Python via .NET est un processus simple qui consiste à appliquer un format numérique personnalisé à une cellule ou une plage de cellules. Aspose.Cells est une bibliothèque puissante qui vous permet de travailler avec des fichiers Excel dans des applications .NET sans avoir besoin d’installer Microsoft Excel. Voici comment formater des nombres en heure :
