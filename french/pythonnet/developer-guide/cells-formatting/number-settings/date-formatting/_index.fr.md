...
type: docs
weight: 10
url: /fr/python-net/format-number-to-date/
description: Cet article expliquera comment formater un nombre en date en utilisant l API Aspose.Cells pour Python via .NET.
...
## **Comment formater un nombre en date dans Aspose.Cells pour Python via .NET**

Pour formater des nombres en date dans la bibliothèque Aspose.Cells pour Python via .NET pour travailler avec des fichiers Excel, vous pouvez appliquer un format de date aux cellules de manière programmatique. Voici comment le faire en utilisant Python avec Aspose.Cells :
