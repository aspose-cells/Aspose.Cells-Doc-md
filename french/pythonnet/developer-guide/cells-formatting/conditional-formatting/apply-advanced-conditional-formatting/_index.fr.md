...
- Barres de données pour visualiser des valeurs numériques
- Échelles de couleurs pour la coloration en dégradé des cellules
- Ensembles d'icônes pour indicateurs graphiques
- Règles de haut/bas
- Mise en forme basée sur la période temporelle

Cet exemple démontre divers types avancés de mise en forme conditionnelle avec Python.NET :
