...
type: docs
weight: 128
url: /fr/python-net/comments-and-notes/
description: Insérez et gérez des commentaires ou des notes avec Aspose.Cells pour Python via .NET.
...
Ajoutez un commentaire à une cellule en appelant la méthode [**add**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection/add) de la collection [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) (encapsulée dans l'objet [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet)). Le nouvel objet [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) peut être accédé à partir de la collection [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) en passant l'indice du commentaire. Après avoir accédé à l'objet [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment), personnalisez la note du commentaire en utilisant la propriété [**note**](https://reference.aspose.com/cells/python-net/aspose.cells/comment/note) de l'objet [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment).
...
## **Sujets avancés**
- [Modifier la direction du texte du commentaire](/cells/fr/python-net/change-text-direction-of-the-comment/)
- [Comment changer la couleur de police du commentaire](/cells/fr/python-net/how-to-change-the-comment-font-color/)
- [Comment définir l'arrière-plan du commentaire](/cells/fr/python-net/how-to-set-comment-background/)
- [Commentaires en fil](/cells/fr/python-net/threaded-comments/)
