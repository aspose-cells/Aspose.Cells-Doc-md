...
description: Convertir un graphique Excel en image en utilisant Aspose.Cells pour Python via .NET API.
keywords: Convertir un graphique Excel en image, Exporter un graphique Excel en image en Python via NET, Enregistrer un graphique Excel en image en Python.
---
...
Tout d'abord, créez un graphique circulaire dans Microsoft Excel, puis convertissez-le en fichier image avec Aspose.Cells pour Python via .NET. Le code de cet exemple crée une image EMF basée sur le graphique circulaire dans le fichier modèle Microsoft Excel.
...
Nous hébergeons nos packages Python dans des dépôts PyPi.

Installez Aspose.Cells pour Python depuis pypi, utilisez la commande suivante : $ pip install aspose-cells-python.

Et vous pouvez également suivre les instructions étape par étape sur la façon d'installer “Aspose.Cells pour Python via .NET” dans votre environnement de développement.
1. Téléchargez et installez Aspose.Cells pour Python via .NET :
   ...
   1. Et vous pouvez également suivre les [instructions étape par étape](https://docs.aspose.com/cells/python-net/getting-started/) sur la façon d'installer "Aspose.Cells for Python via .NET" dans votre environnement de développement.
...
1. Créer un projet :
   ...
   1. Ajouter une référence de bibliothèque (importer la bibliothèque) à votre projet Python.
