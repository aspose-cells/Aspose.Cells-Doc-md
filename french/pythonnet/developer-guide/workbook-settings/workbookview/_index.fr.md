---
title: Comment contrôler la vue du classeur
type: docs
weight: 600
url: /fr/python-net/how-to-control-workbook-view/
description: Apprenez comment contrôler la vue du classeur via l API Aspose.Cells pour Python via .NET.
...
Lorsque vous avez besoin d'ajuster l'affichage des pages Excel, vous devez savoir comment contrôler chaque module, comme les barres de défilement horizontales et verticales, masquer ou non les fichiers Excel ouverts, etc. Aspose.Cells offre cette fonctionnalité. Aspose.Cells fournit les propriétés et méthodes suivantes pour vous aider à atteindre vos objectifs.
