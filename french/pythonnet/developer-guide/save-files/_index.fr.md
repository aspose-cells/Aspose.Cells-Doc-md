...
type: docs
weight: 40
url: /fr/python-net/different-ways-to-save-files/
description: Aspose.Cells pour Python via .NET peut enregistrer des fichiers dans différents formats. Enregistrer les fichiers en PDF. Enregistrer les fichiers en HTML. Enregistrer les fichiers en DOCX. Enregistrer les fichiers en PPTX. Enregistrer les fichiers en JSON. Enregistrer les fichiers en MHTML.
keywords: Aspose.Cells pour Python via .NET enregistre Excel en PDF, HTML, JSON, CSV, TXT, XML, DOCX, PPTX, MHT, MHTML et autres en utilisant C#, en enregistrant ou convertissant un classeur en PDF, HTML, JSON, TXT, SQL en C#.
---

{{% alert color="primary" %}}

Aspose.Cells pour Python via .NET permet de créer et d'enregistrer des fichiers. Cet article explique les différentes manières dont les fichiers peuvent être enregistrés.

{{% /alert %}}

## **Différentes façons d'enregistrer des fichiers**

Aspose.Cells pour Python via .NET fournit la classe [**Workbook**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook) qui représente un fichier Microsoft Excel et offre les propriétés et méthodes nécessaires pour travailler avec des fichiers Excel. La classe [**Workbook**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook) fournit la méthode [**save**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook/save/#str-aspose.cells.SaveFormat) utilisée pour enregistrer des fichiers Excel. La méthode [**save**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook/save/#str-aspose.cells.SaveFormat) a plusieurs surcharges utilisées pour enregistrer des fichiers de différentes manières.

Le format de fichier dans lequel le fichier est enregistré est décidé par l'énumération [**SaveFormat**](https://reference.aspose.com/cells/python-net/aspose.cells/saveformat)
