---
title: Utiliser Aspose.Cells pour Python via .NET comme moteur Excel pour pandas
type: docs
weight: 40
url: /fr/python-net/using-aspose-as-pandas-engine/
description: Utiliser Aspose.Cells pour Python via .NET comme moteur Excel pour pandas.
keywords: Utiliser Aspose.Cells pour Python via .NET comme moteur Excel pour pandas.
---

{{% alert color="primary" %}}

Ce guide montre comment intégrer [Aspose.Cells pour Python via .NET](https://products.aspose.com/cells/python-net/) comme moteur Excel personnalisé dans la bibliothèque `pandas`, vous permettant de parser des fichiers `.xlsx`, `.xls`, etc., avec une grande fidélité.
...
- [Aspose.Cells pour Docs Python via .NET](https://docs.aspose.com/cells/python-net/)
