...
type: docs
weight: 10
url: /fr/python-net/how-to-manage-pivotchart-with-pivotoptions/
...
En utilisant Aspose.Cells pour Python via .NET, vous pouvez utiliser [**PivotOptions**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/pivotoptions) pour gérer la PivotChart.
