...
description: Apprenez comment créer un graphique Treemap dans Aspose.Cells pour Python via .NET. Notre guide vous aidera à comprendre les différentes propriétés et options de formatage disponibles pour les graphiques Treemap, y compris les couleurs, les étiquettes, et la représentation des données.
keywords: Aspose.Cells pour Python via .NET, graphique Treemap, créer, propriétés, formatage, couleurs, étiquettes, représentation des données, graphique circulaire, hiérarchique.
type: docs
weight: 161
url: /fr/python-net/creating-treemap-chart/
---
