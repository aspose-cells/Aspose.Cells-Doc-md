...
description: Apprenez comment utiliser Aspose.Cells pour Python via .NET pour créer des graphiques dans Microsoft Excel. Notre guide illustrera les différents types de graphiques qui peuvent être créés, ainsi que comment personnaliser leur apparence et leur formatage.
keywords: Aspose.Cells pour Python via .NET, Création de Graphiques, Microsoft Excel, Types de Graphiques, Personnalisation, Apparence, Formatage.
linktitle: Graphiques
type: docs
weight: 130
url: /fr/python-net/creating-charts/
...
Il est possible d’ajouter une variété de graphiques aux feuilles de calcul avec Aspose.Cells pour Python via .NET. Aspose.Cells pour Python via .NET fournit de nombreux objets de création de graphiques flexibles. Ce sujet discute des objets de création de graphiques dans Aspose.Cells.
...
Il est simple de créer un graphique avec Aspose.Cells pour Python via .NET avec les codes exemples suivants :
...
Avant de créer des graphiques, il est important de comprendre certains concepts de base qui peuvent être utiles lors de la création de graphiques avec Aspose.Cells pour Python via .NET.

#### **Objets de graphiques**

Aspose.Cells pour Python via .NET fournit un ensemble spécial de classes dans l’espace de noms [**Aspose.Cells.Charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts), utilisé pour créer les graphiques pris en charge par Aspose.Cells pour Python via .NET. Ces classes servent à créer des **objets de création de graphiques**, qui agissent comme éléments de base pour construire des graphiques. Les objets de création de graphiques sont listés ci-dessous :
...
Ajoutez n'importe quel type de graphique à une feuille de calcul en utilisant la collection de [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/charts). Chaque élément dans la collection de [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/charts) représente un objet [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart). Un objet [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) encapsule tous les autres objets de graphique nécessaires pour personnaliser l'apparence du graphique. La prochaine section montre comment utiliser quelques objets de graphique de base pour créer un graphique simple.

### **Créer un graphique avec Aspose.Cells pour Python via .NET**

**Étapes:**

1. Ajoutez des données à des cellules de feuille de calcul avec la méthode [**put_value**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/put_value) de l'objet [**Cell**](https://reference.aspose.com/cells/python-net/aspose.cells/cell).
   Cela sera utilisé comme la source de données pour le graphique.
1. Ajoutez un graphique à la feuille de calcul en appelant la méthode [**add**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection/add) de la collection [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection), encapsulée dans l'objet [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet).
1. Spécifiez le type de graphique avec l'énumération [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype).
   Par exemple, l'exemple ci-dessous utilise la valeur [**ChartType.PYRAMID**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype/) comme type de graphique.
1. Accédez au nouvel objet [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) de la collection [**charts**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chartcollection) en passant son index.
1. Utilisez l'un quelconque des objets de graphique encapsulés dans l'objet [**Chart**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/chart) pour gérer le graphique.
   L'exemple ci-dessous utilise l'objet de graphique [**SeriesCollection**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/seriescollection) pour spécifier la source de données du graphique.
...
Il est possible de créer de nombreux types de graphiques avec Aspose.Cells pour Python via .NET. Tous les graphiques standards pris en charge par Aspose.Cells pour Python via .NET sont prédéfinis dans une énumération nommée [**Aspose.Cells.Charts.ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype).
...
Dans l'exemple ci-dessus, il suffit de changer le [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) par *Line* pour créer un diagramme linéaire. Le code complet est fourni ci-dessous. Lorsque le code est exécuté, un diagramme linéaire est ajouté à la feuille de calcul.

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Charts-ManipulateChart-HowToCreateLineChart-1.py" >}}

#### **Diagramme en bulles**

Pour créer un diagramme en bulles, le [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) doit être défini sur [**ChartType.BUBBLE**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) et quelques propriétés supplémentaires telles que BubbleSizes, Values & XValues doivent être configurées en conséquence. Après l'exécution du code suivant, un diagramme en bulles est ajouté à la feuille de calcul.

#### **Diagramme linéaire avec marqueur de données**

Pour créer une ligne avec le graphique de marques de données, [**ChartType**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/charttype) doit être défini sur *ChartType.LineWithDataMarkers* et quelques propriétés supplémentaires telles que la zone de fond, les marqueurs de séries, les valeurs et les XValues doivent être définies en conséquence. En exécutant le code suivant, une ligne avec le graphique de marques de données est ajoutée à la feuille de calcul.

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Charts-CreateLineWithDataMarkerChart-1.py" >}}

## **Sujets avancés**
- [Lire et manipuler les graphiques Excel 2016](/cells/fr/python-net/read-and-manipulate-excel-2016-charts/)
- [Gérer les axes des graphiques Excel](/cells/fr/python-net/chart-axes/)
- [Réglage de l’apparence du graphique](/cells/fr/python-net/setting-chart-appearance/)
- [Types de graphiques](/cells/fr/python-net/chart-types/)
- [Personnalisation des graphiques](/cells/fr/python-net/customizing-charts/)
- [Définir la source de données pour le graphique](/cells/fr/python-net/data-formatting-in-charts/)
- [Gérer les étiquettes de données des graphiques Excel](/cells/fr/python-net/insert-datalabels-to-chart/)
- [Générer un graphique en traitant des marqueurs intelligents](/cells/fr/python-net/generate-chart-by-processing-smart-markers/)
- [Obtenir la feuille de calcul du graphique](/cells/fr/python-net/get-worksheet-of-the-chart/)
- [Gérer la légende des graphiques Excel](/cells/fr/python-net/chart-legend/)
- [Manipuler la position, la taille et le design du graphique](/cells/fr/python-net/manipulate-position-size-and-designer-chart/)
- [Créer un graphique circulaire avec des lignes de repère](/cells/fr/python-net/creating-pie-chart-with-leader-lines/)
- [Formes dans les graphiques](/cells/fr/python-net/controls-in-charts/)
- [Gérer les titres des graphiques Excel](/cells/fr/python-net/chart-and-axis-titles/)
- [Rendu du graphique](/cells/fr/python-net/chart-rendering/)
- [Obtenir le texte de l'équation de la tendance du graphique](/cells/fr/python-net/get-equation-text-of-chart-trendline/)
