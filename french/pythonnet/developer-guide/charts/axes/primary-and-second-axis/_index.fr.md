...
description: Apprenez à comprendre et à travailler avec les axes primaires et secondaires dans Aspose.Cells pour Python via .NET. Notre guide vous aidera à comprendre les différences entre axes primaires et secondaires, et comment les configurer et les utiliser efficacement dans vos graphiques.
keywords: Aspose.Cells pour Python via .NET, axes primaires, axes secondaires, compréhension, différences, configuration, utilisation.
type: docs
weight: 190
url: /fr/python-net/primary-and-second-axis/
---
