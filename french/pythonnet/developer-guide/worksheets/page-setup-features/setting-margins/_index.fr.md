...
description: Dans cet article, vous apprendrez à définir les marges d une feuille Excel à l aide de code d exemple. Vous apprendrez également comment définir de manière programmatique les marges pour le centre de la page, les marges d en tête et de pied de page de la mise en page en utilisant l API Aspose.Cells pour Python via .NET.
keywords: Bibliothèque Excel Python, définir les marges de la feuille Excel au centre, définir les marges d en tête et de pied de page de la feuille de calcul en utilisant Python.
---

{{% alert color="primary" %}}

Aspose.Cells pour Python via .NET prend en charge pleinement les options de mise en page de Microsoft Excel. Les développeurs peuvent avoir besoin de configurer les paramètres de mise en page des feuilles de calcul pour contrôler le processus d'impression. Ce sujet traite de l'utilisation d'Aspose.Cells pour Python via .NET pour configurer les marges de page.
...
## **Comment définir les marges d'en-tête et de pied de page**
