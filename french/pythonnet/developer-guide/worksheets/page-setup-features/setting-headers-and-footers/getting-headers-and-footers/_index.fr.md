...
description: Cet article explique comment obtenir de manière programmatique les en têtes et pieds de page à partir de fichiers Excel ou OpenOffice en utilisant l API Aspose.Cells pour Python via .NET.
keywords: Bibliothèque Excel Python, Obtenir les en têtes et pieds de page en Python, Analyser les en têtes et pieds de page en une liste de commandes en Python.
---
...
## **Comment Obtenir les En-têtes et Pieds de Page en utilisant la Bibliothèque Excel Aspose.Cells pour Python**
...
Aspose.Cells pour Python via .NET fournit une méthode [**Worksheet.page_setup.get_commands**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/get_commands/#str) pour analyser les en-têtes et pieds de page en tant que liste de commandes.
