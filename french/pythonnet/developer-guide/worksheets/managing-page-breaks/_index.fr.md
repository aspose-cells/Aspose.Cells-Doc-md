...
description: Cet article fournit un code d exemple et explique comment ajouter des sauts de page, effacer des sauts de page ou supprimer des sauts de page spécifiques dans les feuilles Excel programmatiquement en utilisant Aspose.Cells pour Python via .NET.
keywords: Bibliothèque Excel Python, sauts de page Python, sauts de page Excel dans Python, effacer un saut de page dans Python.
---
