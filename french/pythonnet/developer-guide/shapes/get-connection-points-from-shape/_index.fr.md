...
type: docs
weight: 3500
url: /fr/python-net/get-connection-points-from-shape/
description: Cet article montre comment obtenir les points de connexion d une forme via l API Aspose.Cells pour Python via .NET.
keywords: Bibliothèque Excel Python, Comment obtenir les points de connexion d une forme en Python.
---
