...
description: Cet article montre les données sous une forme non primitive via l API Aspose.Cells pour Python via .NET.
keywords: Bibliothèque Python Excel, Données en forme non primitive en Python, Comment accéder aux données d une forme non primitive en Python.
---
