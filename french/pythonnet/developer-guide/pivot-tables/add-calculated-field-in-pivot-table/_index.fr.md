...
description: Comment ajouter un champ calculé dans un tableau croisé dynamique avec Aspose.Cells pour Python via .NET.
keywords: Aspose.Cells pour Python Excel, bibliothèque Python Excel, Ajouter un champ calculé dans un tableau croisé dynamique en utilisant la bibliothèque Python Excel.
---
...
## **Comment ajouter un champ calculé dans un tableau croisé dynamique en utilisant la bibliothèque Excel Aspose.Cells pour Python**
Ajoutez un champ calculé au fichier Excel en utilisant Aspose.Cells pour Python via .NET. Veuillez consulter le code d'exemple suivant. Après avoir exécuté le code d'exemple, un tableau croisé dynamique avec un champ calculé est ajouté à la feuille de calcul.
