...
type: docs
weight: 130
url: /fr/python-net/clear-filter-in-pivot-table/
description: Comment effacer le filtre pivotant du champ pivotant spécifique dans le tableau croisé dynamique avec Aspose.Cells pour Python via .NET.
keywords: Aspose.Cells pour Python Excel, bibliothèque Python Excel, Effacer le filtre pivotant dans le tableau croisé dynamique en utilisant la bibliothèque Excel Aspose.Cells pour Python.
---

## **Scénarios d'utilisation possibles**
Lorsque vous créez un tableau croisé dynamique avec des données connues et que vous souhaitez filtrer le tableau croisé dynamique, vous devez apprendre et utiliser le filtre. Il peut vous aider à filtrer efficacement les données que vous souhaitez. En utilisant l'API Aspose.Cells pour Python via .NET, vous pouvez opérer le filtre sur les valeurs de champ dans les tableaux croisés dynamiques. 
...
## **Comment effacer le filtre dans le tableau croisé dynamique en utilisant la bibliothèque Excel Aspose.Cells pour Python**
Effacer le filtre dans le tableau croisé dynamique en utilisant Aspose.Cells pour Python via .NET. Veuillez consulter le code d'exemple suivant. 
