...
type: docs
weight: 60
url: /fr/python-net/setting-strong-encryption-type/
---
...
Vous pouvez également chiffrer et protéger par mot de passe des fichiers Excel avec un type de chiffrement fort en utilisant l'API Aspose.Cells pour Python via .NET.
