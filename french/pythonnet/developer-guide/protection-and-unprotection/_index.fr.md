...
type: docs
weight: 68
url: /fr/python-net/protect-and-unprotect/
alias: [/net/security-features/]
description: Cet extrait présente comment chiffrer et déchiffrer des fichiers Excel, protéger et déprotéger les données dans des fichiers Excel en utilisant des codes CSharp.
---
...
## [**Encrypt and decrypt Excel files**](/cells/fr/python-net/encrypt-and-decrypt-excel-files/)
...
## [**Protect and unprotect workbook**](/cells/fr/python-net/protect-and-unprotect-workbook-structure/)
...
## [**Protect and unprotect worksheet**](/cells/fr/python-net/protect-and-unprotect-worksheets/)
...
## [**Protect and unprotect shared workbook**](/cells/fr/python-net/password-protect-or-unprotect-the-shared-workbook)
Protéger et déprotéger le classeur partagé.

## [**Add or remove a digital signature in Office files**](/cells/fr/python-net/assign-and-validate-digital-signatures/)
Protéger l'authenticité du contenu d'un document, vous pouvez ajouter une signature numérique.

## **Sujets avancés**
- [Vérifier le mot de passe pour modifier à l'aide d'Aspose.Cells](/cells/fr/python-net/check-password-to-modify-using-aspose-cells/)
- [Détecter le format de fichier des fichiers Office Open XML cryptés - OOXML](/cells/fr/python-net/detect-file-format-of-encrypted-office-open-xml-ooxml-files/)
