---
title: Vérifier le mot de passe pour modifier en utilisant Aspose.Cells pour Python via .NET
type: docs
weight: 2400
url: /fr/python-net/check-password-to-modify-using-aspose-cells/
---

{{% alert color="primary" %}}

Parfois, vous devez vérifier si le mot de passe donné correspond au **Mot de passe pour modifier** de manière programmatique. Aspose.Cells pour Python via .NET fournit la méthode WorkbookSettings.write_protection.validate_password() que vous pouvez utiliser pour vérifier si le Mot de passe pour modifier est correct ou non.
...
## **Vérification du mot de passe pour modifier avec Aspose.Cells pour Python via .NET**
