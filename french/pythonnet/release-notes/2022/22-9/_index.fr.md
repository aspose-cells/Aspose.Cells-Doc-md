---
title: Aspose.Cells pour Python via .NET 22.9 Notes de mise à jour
type: docs
weight: 8
url: /fr/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 

Il s'agit de la première version pour Aspose.Cells pour Python via .NET.
Cette page contient les notes de version pour Aspose.Cells pour Python via .NET 22.9.
...
|CELLSNET-51899|Conversion XLS en XLSM - MS Excel n'a pas pu ouvrir le fichier XLSM de sortie|
...
|CELLSNET-51800|Les valeurs de XLSX sont incorrectes dans le PDF de sortie|
...
|CELLSNET-51187|Lignes pointillées verticales mal alignées avec des étiquettes sur l'axe dans le graphique vers le rendu SVG|
|CELLSNET-51734|La dépendance System.Security.Cryptography.Pkcs 6.0.1 nécessite .NET Core 3.1|
|CELLSNET-51912|Lors de la conversion d'Excel en PDF, le PDF résultant n'affiche pas correctement l'axe|
...
|CELLSNET-51938|XLSX vers PDF : l'espacement des caractères est incorrect|
|CELLSNET-51226|Ajouter un attribut d'identifiant pour le graphique/groupe dans le classeur Excel|
|CELLSNET-51461|Des bordures inutiles sont ajoutées pour les données dans la conversion Excel vers DOCX|
|CELLSNET-51736| Cell bordures se sont perdues dans le PDF résultant|
...
|CELLSNET-51829|La conversion de fichiers XLS en XLSM a entraîné la perte de certaines propriétés personnalisées|
...
|CELLSNET-51880|Conversion XLSB en XLSM - le fichier XLSM de sortie est corrompu|
|CELLSNET-51898|Conversion XLS en XLSM - le fichier XLSM de sortie est corrompu|
...
|CELLSNET-51961|Exception "L'index était hors plage" lors du rendu d'un ODS au format PDF|
