---
title: Aspose.Cells pour Python via .NET 22.11 Notes de mise à jour
type: docs
weight: 6
url: /fr/python-net/aspose-cells-for-python-net-22-11-release-notes/
---
{{% alert color="primary" %}} 

Il s'agit de la première version pour Aspose.Cells pour Python via .NET.
Cette page contient les notes de version pour Aspose.Cells pour Python via .NET 22.11.
...
|CELLSNET-52156|Désactiver les cellules de tableau fusionnées lors de l'enregistrement de XLSX au format HTML|
|CELLSNET-52159|Prise en charge de l'analyse de la propriété réduite lors de la conversion de HTML en Excel|
|CELLSNET-51939|XLSX vers PDF : désalignement du contenu|
|CELLSNET-51940|XLS vers PDF : désalignement du contenu dans les cellules|
|CELLSNET-52068|XLSX vers PDF : Formes manquantes/Effondrement de la mise en page|
|CELLSNET-52092|L'impression et l'espacement des caractères dans les chiffres d'Excel sont coupés|
|CELLSNET-52186|Les formes/boîtes sont vides lors de la conversion d'un document XLSX en PDF|
|CELLSNET-52225|XLSX en PDF Caractères dans les zones de texte inversés|
...
|CELLSNET-52144|Conversion XLS en XLSM modifiant le type de relation de lien|
...
|CELLSNET-52181|XLSX vers HTML : la plage Cells n'est pas exportée correctement|
...
|CELLSNET-52241|Les cases (formes) du document n'apparaissent pas dans le PDF de sortie|
