---
title: Aspose.Cells pour Python via .NET 22.8 Notes de mise à jour
type: docs
weight: 9
url: /fr/python-net/aspose-cells-for-python-net-22-8-release-notes/
---
{{% alert color="primary" %}} 

Il s'agit de la première version pour Aspose.Cells pour Python via .NET.
Cette page contient les notes de version pour Aspose.Cells pour Python via .NET 22.8.
...
|CELLSNET-51550|Les liens dans les plages nommées sont supprimés lors de la conversion XLS vers XLSM|
|CELLSNET-51551|Les fichiers ont été corrompus et le lien externe a été remplacé par un lien DDE lors de la conversion de fichiers XLS en XLSM|
|CELLSNET-51558|La conversion de fichiers XLS avec un lien de type xlAlternateStartup vers XLSM produit des fichiers corrompus|
...
|CELLSNET-51580|Un lien externe de type xlPathMissing est changé en type externalLinkPath normal dans la conversion XLS vers XLSM|
|CELLSNET-51599|Noms très longs pour les ressources de type image lors de l'enregistrement au format Html|
|CELLSNET-51627|Impossible de charger un fichier XLSM spécifique|
