...
- Visual Studio 2015 ou supérieur
...
- **Données** dossier dans le dossier racine de**Exemples** contient des fichiers d'entrée. Il est obligatoire de télécharger le**Données** dossier avec le projet d'exemples.
