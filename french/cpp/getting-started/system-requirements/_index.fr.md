...
Aspose.Cells for C++ prend en charge les systèmes d'exploitation et plates-formes 64 bits suivants :
...
<table>  
  ...
  <tr>
			...
			<td><ul><li>Windows Serveur 2008 (x64)</li><li>Windows Serveur 2012 (x64)</li><li>Windows Serveur R2 2012 (x64)</li><li>Windows Serveur 2016 (x64)</li><li>Windows 2019 Serveur (x64)</li><li>Windows Vue (x64)</li><li>Windows7 (x64)</li><li>Windows 8, 8.1 (x64)</li><li>Windows 10 (x64)</li><li>Windows 11 (x64)</li></ul></td>
		</tr>
  <tr>
			<td>Linux</td>
			<td><ul><li>Ubuntu 20.04 ou version ultérieure</li><li>Feutre</li><li>OuvrirSUSE</li><li>CentOS</li><li>Linux pour ARM (aarch64)</li></ul></td>
		</tr>
  <tr>
			<td>macOS</td>
