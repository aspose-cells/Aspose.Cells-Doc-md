...
type: docs
weight: 30
url: /fr/cpp/aspose-cells-for-cpp-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells pour RPC 17.02.0](https://downloads.aspose.com/cells/cpp/new-releases/aspose.cells-for-c---17.02.0/).
...
1. [Ajout de formules et calcul des résultats](/cells/fr/cpp/ways-to-calculate-formulas#waystocalculateformulas-addingformulas&calculatingresults)
1. [Calcul direct de la formule](/cells/fr/cpp/ways-to-calculate-formulas#waystocalculateformulas-directcalculationofformula)
1. [Calculer des formules une seule fois](/cells/fr/cpp/ways-to-calculate-formulas#waystocalculateformulas-calculatingformulasonceonly)
1. [Utilisation de la fonctionnalité ICustomFunction](/cells/fr/cpp/using-icustomfunction-feature#usingicustomfunctionfeature-usingicustomfunctionfeature) 
