...
|![tâche : image_autre_texte](kJmukRF.png)|
 Implémentation de l'objet List pour les données et spécification de la ligne totale (Select**Données** , alors**Liste** , suivie par**Ligne totale**).
