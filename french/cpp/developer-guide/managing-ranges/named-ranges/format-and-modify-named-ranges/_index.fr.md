---
title: Modifier, mettre en forme et modifier les plages nommées avec C++
linktitle: Formater et modifier des plages nommées
type: docs
weight: 85
url: /fr/cpp/format-and-modify-named-ranges/
description: Apprenez comment mettre en forme, renommer, fusionner et supprimer des plages nommées dans les fichiers Excel en utilisant Aspose.Cells avec C++.
---
...
Pour appliquer le formatage, définissez un objet [**Style**](https://reference.aspose.com/cells/cpp/aspose.cells/style/) pour spécifier les paramètres de style et appliquez-le à l'objet [**Range**](https://reference.aspose.com/cells/cpp/aspose.cells/range/).
...
Il est possible d'ajouter des bordures à une plage de cellules au lieu d'une seule cellule. L'objet [**Range**](https://reference.aspose.com/cells/cpp/aspose.cells/range/) fournit une méthode [**SetOutlineBorder**](https://reference.aspose.com/cells/cpp/aspose.cells/range/setoutlineborder/) qui prend les paramètres suivants pour ajouter une bordure à la plage de cellules:

- Type de bordure, le type de bordure, sélectionné de l'énumération [**BorderType**](https://reference.aspose.com/cells/cpp/aspose.cells/bordertype/).
- Style de ligne, le style de ligne, sélectionné de l'énumération [**CellBorderType**](https://reference.aspose.com/cells/cpp/aspose.cells/cellbordertype/).
...
Aspose.Cells vous permet de renommer une plage nommée selon vos besoins. Vous pouvez obtenir la plage nommée et la renommer en utilisant l'attribut [**Name.GetText()**](https://reference.aspose.com/cells/cpp/aspose.cells/name/gettext/). L'exemple suivant montre comment renommer une plage nommée.
...
Aspose.Cells fournit [**Range.UnionRang**](https://reference.aspose.com/cells/cpp/aspose.cells/range/unionrang/) méthode pour prendre l'union de plages, la méthode retourne un objet [*std::vector*](https://en.cppreference.com/w/cpp/container/vector). L'exemple suivant montre comment faire l'union de plages.
...
Aspose.Cells fournit la méthode [**Range.Intersect**](https://reference.aspose.com/cells/cpp/aspose.cells/range/intersect/) pour intersecter deux plages. La méthode renvoie un objet [**Range**](https://reference.aspose.com/cells/cpp/aspose.cells/range/). Pour vérifier si une plage intersecte une autre plage, utilisez la méthode [**Range.Intersect**](https://reference.aspose.com/cells/cpp/aspose.cells/range/intersect/) qui renvoie une valeur booléenne. L'exemple suivant montre comment intersecter les plages.
...
Aspose.Cells fournit la méthode [**Range.Merge()**](https://reference.aspose.com/cells/cpp/aspose.cells/range/merge/) pour fusionner les cellules dans la plage. L'exemple suivant montre comment fusionner les cellules individuelles d'une plage nommée.
