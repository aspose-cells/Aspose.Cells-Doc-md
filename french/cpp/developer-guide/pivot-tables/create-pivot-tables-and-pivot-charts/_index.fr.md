---
title: Créer des tableaux croisés dynamiques et des graphiques croisés dynamiques avec C++
linktitle: Créer des tableaux croisés dynamiques et des graphiques croisés dynamiques
type: docs
weight: 20
url: /fr/cpp/create-pivot-tables-and-pivot-charts/
description: Apprenez comment créer des tableaux croisés dynamiques et des graphiques croisés dynamiques dans les fichiers Excel à l aide d Aspose.Cells avec C++.
---
...
1. Téléchargez et installez Aspose.Cells :
   1. [Télécharger Aspose.Cells](https://downloads.aspose.com/cells/cpp).
