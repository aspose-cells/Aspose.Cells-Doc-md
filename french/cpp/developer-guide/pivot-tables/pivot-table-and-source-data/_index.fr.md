---
title: Tableau croisé dynamique et source de données avec C++
linktitle: Tableau croisé dynamique et données sources
type: docs
weight: 30
url: /fr/cpp/pivot-table-and-source-data/
description: Apprenez comment changer dynamiquement la source de données d un tableau croisé dynamique avec Aspose.Cells en C++.
---
