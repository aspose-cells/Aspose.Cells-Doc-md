...
## **Lire et écrire le format de fichier CSV**
 L'exemple de code suivant charge le[fichier source CSV](23166994.csv) et lit sa cellule A1, puis copie son contenu dans la cellule C4 et l'enregistre sous[fichier de sortie CSV](23166994.csv).
## **Exemple de code**
