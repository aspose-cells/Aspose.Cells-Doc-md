---
title: Ajuster automatiquement la hauteur des lignes pour les cellules fusionnées avec C++
linktitle: Ajuster les lignes pour les cellules fusionnées
type: docs
weight: 120
url: /fr/cpp/autofit-rows-for-merged-cells/
description: Apprenez comment ajuster automatiquement la hauteur des lignes pour les cellules fusionnées dans Excel en utilisant Aspose.Cells for C++.
---
