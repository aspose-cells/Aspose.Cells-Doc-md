...
- L'encodage des caractères peut varier en fonction de l'application source (communément Windows-1252 ou des pages de code OEM).
...
2. Accédez à la première feuille de calcul de la collection `Worksheets`.
