...
3. À l'intérieur de la boucle, créez une nouvelle instance `Workbook` de destination (un classeur vide) pour la feuille de calcul en cours.
...
4. Créez une nouvelle instance `Workbook` de destination.
