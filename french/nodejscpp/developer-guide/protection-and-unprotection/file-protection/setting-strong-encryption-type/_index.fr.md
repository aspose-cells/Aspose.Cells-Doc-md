---  
title: Définir le type de chiffrement fort avec Node.js via C++  
linktitle: Définition du type de chiffrement fort  
type: docs  
weight: 60  
url: /fr/nodejs-cpp/setting-strong-encryption-type/  
description: Apprenez comment définir des types de chiffrement forts pour les fichiers Excel utilisant Aspose.Cells for Node.js via C++.  
---  
