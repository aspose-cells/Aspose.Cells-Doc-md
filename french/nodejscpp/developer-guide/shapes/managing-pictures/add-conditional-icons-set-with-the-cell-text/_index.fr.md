---
title: Ajouter un ensemble d icônes conditionnelles avec le texte de la cellule en utilisant Node.js via C++
linktitle: Ajouter un ensemble d icônes conditionnelles avec le texte de la cellule
type: docs
weight: 160
url: /fr/nodejs-cpp/add-conditional-icons-set-with-the-cell-text/
description: Apprenez comment ajouter des icônes conditionnelles à côté du texte dans une cellule en utilisant Aspose.Cells for Node.js via C++. Améliorez la signification des données par des icônes.
---

{{% alert color="primary" %}} 

Parfois, vous souhaitez ajouter des icônes conditionnelles à côté du texte dans une cellule pour rendre les données plus significatives pour les lecteurs. Vous souhaitez utiliser certains types d'icônes de mise en forme conditionnelle sans appliquer la mise en forme conditionnelle aux cellules. Aspose.Cells for Node.js via C++ prend en charge cette fonctionnalité.
