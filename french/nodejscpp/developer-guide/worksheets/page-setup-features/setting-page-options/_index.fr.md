---  
title: Définir les options de page avec Node.js via C++  
linktitle: Réglage des options de page  
type: docs  
weight: 10  
url: /fr/nodejs-cpp/setting-page-options/  
description: Cet article fournit un code d exemple pour définir programmatiquement les options de page des feuilles Excel à l aide de Node.js via C++. Définir l orientation de la page, le facteur d échelle, les options de s adapter à plusieurs pages, la taille du papier, la qualité d impression, le numéro de première page.  
keywords: définir l orientation de la page Excel avec Node.js via C++, définir le facteur d échelle avec Node.js via C++, définir la taille du papier des feuilles Excel avec Node.js via C++  
---  
...
La classe [**Worksheet**](https://reference.aspose.com/cells/nodejs-cpp/worksheet) fournit la propriété [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) utilisée pour configurer les options de mise en page de la feuille de calcul. En fait, cette propriété [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) est un objet de la classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) utilisée pour définir différentes options de mise en page pour une feuille imprimée. La classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) fournit diverses propriétés utilisées pour définir les options de configuration de la page. Certaines de ces propriétés sont abordées ci-dessous.  

### **Orientation de la page**  

L'orientation de la page peut être définie sur portrait ou paysage en utilisant la propriété [**getOrientation()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getOrientation--) de la classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup). La propriété [**getOrientation()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getOrientation--) accepte l'une des valeurs prédéfinies dans l'énumération [**PageOrientationType**](https://reference.aspose.com/cells/nodejs-cpp/pageorientationtype), listée ci-dessous.  
...
Il est possible de réduire ou d'agrandir la taille d'une feuille en ajustant le facteur de mise à l’échelle avec la propriété [**PageSetup.getZoom()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getZoom--).  
...
Pour adapter le contenu de la feuille à un nombre spécifique de pages, utilisez les propriétés [**getFitToPagesTall()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFitToPagesTall--) et [**getFitToPagesWide()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFitToPagesWide--) de la classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup). Ces propriétés servent également à mettre à l’échelle les feuilles.  

{{% alert color="primary" %}}  
Vous pouvez choisir la propriété [**getFitToPagesTall()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFitToPagesTall--)/[**getFitToPagesWide()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFitToPagesWide--) ou la propriété [**getZoom()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getZoom--), mais pas les deux en même temps.  
{{% /alert %}}  
...
Définissez la taille du papier sur laquelle les feuilles seront imprimées en utilisant la propriété [**getPaperSize()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPaperSize--) de la classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup). La propriété [**getPaperSize()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPaperSize--) accepte l'une des valeurs prédéfinies dans l'énumération [**PaperSizeType**](https://reference.aspose.com/cells/nodejs-cpp/papersizetype), listée ci-dessous.  
...
Définissez la qualité d'impression des feuilles à imprimer avec la propriété [**getPrintQuality()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintQuality--) de la classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup). L'unité de mesure de la qualité d'impression est le point par pouce (DPI).  
...
Commencez la numérotation des pages de la feuille en utilisant la propriété [**getFirstPageNumber()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFirstPageNumber--) de la classe [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup). La propriété [**getFirstPageNumber()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getFirstPageNumber--) définit le numéro de page de la première page, et les pages suivantes sont numérotées en ordre croissant.  
