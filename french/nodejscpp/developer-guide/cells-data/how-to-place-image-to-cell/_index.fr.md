...
type: docs
weight: 130
url: /fr/nodejs-cpp/how-to-insert-picture-in-cell/
description: Apprenez comment insérer une image dans une cellule avec Aspose.Cells.
...
## **Comment insérer une image dans une cellule en utilisant Aspose.Cells for Node.js via C++**
