...
type: docs
weight: 10
url: /fr/nodejs-cpp/how-to-format-number-to-scientific/
description: Cet article expliquera comment formater un nombre en notation scientifique en utilisant l API Aspose.Cells for Node.js via C++.
...
## **Comment formater un nombre en notation scientifique dans Aspose.Cells for Node.js via C++**
Pour formater des nombres en notation scientifique dans Aspose.Cells for Node.js via C++, vous pouvez utiliser la méthode `Style.setCustom` d'une cellule. Aspose.Cells vous permet de définir un format personnalisé pour les données dans vos feuilles de calcul, y compris la notation scientifique.
