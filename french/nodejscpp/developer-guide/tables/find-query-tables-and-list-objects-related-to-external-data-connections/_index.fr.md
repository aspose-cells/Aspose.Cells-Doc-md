---
title: Trouvez les requêtes de tables et la liste des objets liés aux connexions de données externes avec Node.js via C++
linktitle: Trouver des tables de requête et des objets liste liés aux connexions de données externes
type: docs
weight: 20
url: /fr/nodejs-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: Apprenez comment trouver les requêtes de tables et la liste des objets liés aux connexions de données externes en utilisant Aspose.Cells for Node.js via C++.
---
