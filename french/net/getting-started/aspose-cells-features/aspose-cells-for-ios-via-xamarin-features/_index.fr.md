---
title: Aspose.Cells pour iOS via les fonctionnalités Xamarin
type: docs
weight: 70
url: /fr/net/aspose-cells-for-ios-via-xamarin-features/
---
## **Aspose.Cells pour iOS via Xamarin Présentation des fonctionnalités**
Cette section fournit une comparaison de la disponibilité des fonctionnalités entre Aspose.Cells for .NET et Aspose.Cells pour iOS via Xamarin.
...
|**Caractéristique**|**.NET**|**Xamarin.iOS**|
|:- |:- |:- |
|Importer/exporter des données depuis un Array, ArrayList, ResultSet etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Ajouter une copie de la feuille de calcul existante (tout le contenu, y compris les images, les graphiques, les autres objets, etc.)|{{< emoticons/tick >}}|{{< emoticons/tick >}} (Les images et les graphiques ne sont pas pris en charge)|
|Copier ou déplacer des feuilles de calcul dans ou entre des classeurs|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Insérer des images|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Créer des graphiques|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Définir un arrière-plan dégradé pour les graphiques à l'aide de API|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Ajouter des commentaires aux cellules|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Mettre en œuvre des validations de données|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Créer des sauts de page personnalisés|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Mettre en œuvre des marqueurs intelligents|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Spécifier les paramètres des propriétés du document|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Protéger/déprotéger les feuilles de calcul|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Spécifiez les options de protection avancées introduites dans Excel XP et les versions ultérieures|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Insérer des contrôles de formulaire et d'autres formes/objets de dessin|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Créer des tableaux croisés dynamiques et des graphiques croisés dynamiques|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Conserver ou supprimer le complément, VBA, les macros|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Manipuler des plages nommées|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Créer des graphiques personnalisés|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Ajoutez, conservez ou extrayez des objets OLE des feuilles de calcul.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Implémenter Microsoft Sparklines Excel 2010|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Crypter les fichiers|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Appliquez différentes couleurs aux cellules, polices, quadrillages, objets graphiques, etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}} (Les objets graphiques ne sont pas pris en charge)|
...
|Spécifiez vos marges et le centrage de la page.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Créez ou modifiez votre en-tête et/ou pied de page.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
