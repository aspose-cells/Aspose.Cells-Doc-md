...
- Définissez le "Système d'exploitation cible" sur "Aucun" ou d'autres options pour votre projet, vous utiliserez "SkiaSharp" comme dépendance de votre système Windows pour le projet .Net6. Veuillez noter qu'actuellement, SkiaSharp ne prend pas en charge les formats tels que EMF dans Windows.
...
De cette façon, vous utiliserez "SkiaSharp" comme dépendance de votre système Windows pour le projet .Net6. Veuillez noter qu'actuellement, SkiaSharp ne prend pas en charge les formats tels que EMF dans Windows.
