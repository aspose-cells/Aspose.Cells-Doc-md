...
## **Vérifiez le numéro de version à l'aide du Aspose.Cells API**
 ...
 Pour savoir quelle version de Aspose.Cells vous utilisez via le API, utilisez le[CellsHelper](https://reference.aspose.com/cells/net/aspose.cells/cellshelper) méthode statique de classe GetVersion pour obtenir le numéro de version de Aspose.Cell.
