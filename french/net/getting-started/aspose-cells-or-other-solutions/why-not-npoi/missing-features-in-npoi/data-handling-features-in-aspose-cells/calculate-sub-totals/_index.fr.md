...
## **Télécharger le code d'exécution**
 Télécharger**Calculer les sous-totaux** forment l'un des sites de codage social mentionnés ci-dessous :
...
{{% alert color="primary" %}} 
 ...
 Pour plus de détails, visitez[Création de sous-totaux](/cells/fr/net/creating-subtotals/).
