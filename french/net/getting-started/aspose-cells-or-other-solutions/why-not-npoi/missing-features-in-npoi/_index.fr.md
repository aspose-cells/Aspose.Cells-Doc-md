...
Cette section présente les fonctionnalités uniquement disponibles dans Aspose.Cells et non dans NPOI (HSSF et XSSF).

Cela est très utile pour les développeurs qui souhaitent migrer de NPOI à Aspose.Cells.

Cela inclut les nombreuses fonctionnalités d'Aspose.Cells par rapport à NPOI.
...
- [Travailler avec les graphiques dans Aspose.Cells](/cells/fr/net/working-with-charts-in-aspose-cells/)
  - [Convertir le graphique en images](/cells/fr/net/convert-chart-to-images/)
  - [Créer des graphiques](/cells/fr/net/create-charts/)
- [Travailler avec les feuilles de calcul dans Aspose.Cells](/cells/fr/net/working-with-worksheets-in-aspose-cells/)
