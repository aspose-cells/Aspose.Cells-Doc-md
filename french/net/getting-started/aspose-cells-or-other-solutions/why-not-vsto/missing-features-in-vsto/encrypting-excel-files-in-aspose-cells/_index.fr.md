---
title: Cryptage des fichiers Excel en Aspose.Cells
type: docs
weight: 90
...
![tâche : image_autre_texte](encrypting-excel-files-in-aspose-cells_1.png)
...
![tâche : image_autre_texte](encrypting-excel-files-in-aspose-cells_2.png)
