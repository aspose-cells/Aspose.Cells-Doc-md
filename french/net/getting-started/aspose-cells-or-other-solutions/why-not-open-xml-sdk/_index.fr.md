...
|<p>Rendu et impression :* Rendu des pages de feuille de calcul en images raster (TIFF, TIFF multipage, PNG, JPEG, BMP).* Rendu des pages de feuille de calcul en images vectorielles (EMF).</p><p>- Convertir des graphiques en images (TIFF, TIFF multipage, PNG, JPEG, BMP, EMF, etc.)</p><p>- Spécifiez la résolution, la qualité, la compression et d'autres options de l'image.</p><p>- Imprimer des feuilles de calcul en utilisant l'infrastructure d'impression .NET. Le composant a une méthode d'impression intégrée pour imprimer les feuilles de calcul comme indiqué dans l'aperçu avant impression de Microsoft Excel.</p>|Non|Oui|
...
- Convertissez un document au format PDF ou XPS afin qu'il apparaisse exactement comme Microsoft Excel l'aurait converti.
