...
type: docs
description: Aspose.Cells for .NET se développe et s'améliore quotidiennement. Sur cette page, vous pouvez en savoir plus sur les fonctionnalités les plus importantes et les plus intéressantes du produit
weight: 5
...
* Prise en charge de la lecture/sauvegarde des formules de tableau dynamique pour le format de fichier xlsb
...
* Prise en charge de la définition de la formule de table pour les cellules
...
* Prise en charge de l'exportation de commentaires et de notes tels qu'ils sont affichés sur la feuille en html
...
* Prise en charge de l'exportation de code HTML vers un seul fichier avec en-tête/pied de page
...
* Prise en charge de l'importation de grands fichiers csv dans plusieurs feuilles de calcul lorsque la ligne/colonne de données dépasse la limite
...
* Améliorer les performances pour l'ajout de plages pour le formatage conditionnel et la validation
