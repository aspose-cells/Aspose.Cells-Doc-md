...
{{% alert color="primary" %}}
 ...
 Vous pouvez régler le**Ombre** de**Effets de texte** de n'importe quelle forme ou zone de texte. Veuillez utiliser le[**Shape.TextBody**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shape/properties/textbody) propriété. Il présente le réglage du texte de la forme et renvoie[**FontSetting**](https://reference.aspose.com/cells/net/aspose.cells/fontsetting) objets. Après y avoir accédé, veuillez définir le**Ombre** passant par[**FontSetting.TextOptions.Shadow.PresetType.PresetType**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shadoweffect/properties/presettype) propriété. Cette propriété est du type[**Type d'ombre prédéfini**](https://reference.aspose.com/cells/net/aspose.cells.drawing/presetshadowtype)qui a plusieurs valeurs. Certains d'entre eux sont
