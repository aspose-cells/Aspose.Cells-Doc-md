...
## **Définition des propriétés ScaleCrop et LinksUpToDate des propriétés de document intégrées**
 L'exemple de code suivant définit le[ScaleCrop](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/scalecrop) et[Liens à jour](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/linksuptodate) propriétés de document intégrées étendues du classeur. S'il vous plaît, vérifiez le[fichier excel de sortie](5115500.xlsx)généré avec ce code, changez son extension en .zip et extrayez son contenu et affichez le app.xml comme indiqué dans la capture d'écran ci-dessus.
