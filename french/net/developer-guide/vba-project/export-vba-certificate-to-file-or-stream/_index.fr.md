---
title: Exporter le certificat VBA vers un fichier ou un flux
type: docs
weight: 90
url: /fr/net/export-vba-certificate-to-file-or-stream/
---
{{% alert color="primary" %}}
...
## **Exporter le certificat VBA vers un fichier ou un flux dans C#**

 Veuillez consulter l'exemple de code suivant qui enregistre les données brutes du certificat VBA dans un fichier. Vous pouvez télécharger le[exemple de fichier excel utilisé dans ce code](5115031.xlsm) à partir du lien fourni.
