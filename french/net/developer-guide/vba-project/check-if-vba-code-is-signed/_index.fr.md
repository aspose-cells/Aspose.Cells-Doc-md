...
Aspose.Cells permet à l'utilisateur de vérifier si le projet de code VBA est signé ou non. Veuillez utiliser la propriété [**Workbook.VbaProject.IsSigned**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/properties/issigned) pour vérifier si le projet de code VBA est signé ou non.

{{% /alert %}}

Le code suivant explique comment vérifier si le code VBA est signé ou non en utilisant la propriété [**Workbook.VbaProject.IsSigned**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/properties/issigned). Vous pouvez utiliser n'importe lequel de vos fichiers Excel pour tester ce code. À des fins de test, vous pouvez utiliser [ce fichier Excel utilisé dans le code](5115032.xlsm).
