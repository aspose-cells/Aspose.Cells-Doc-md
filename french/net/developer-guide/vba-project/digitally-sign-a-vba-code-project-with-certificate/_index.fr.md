...
{{% alert color="primary" %}}
 ...
 Vous pouvez signer numériquement votre projet de code VBA en utilisant Aspose.Cells avec son[**Classeur.VbaProject.Sign()**](https://reference.aspose.com/cells/net/aspose.cells.vba/vbaproject/methods/sign)méthode. Veuillez suivre ces étapes pour vérifier si votre fichier Excel est signé numériquement avec un certificat.
