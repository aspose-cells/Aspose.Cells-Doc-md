...
Un hyperlien permet de créer un lien entre deux entités. Tout le monde connaît l’utilisation des hyperliens, notamment sur les sites Web.
À l'aide de Aspose.Cells, les développeurs peuvent créer différents types de liens hypertexte dans les fichiers Excel Microsoft. Cette rubrique explique quels types d'hyperliens sont pris en charge par Aspose.Cells et comment ils peuvent être utilisés dans nos fichiers Excel.

{{% /alert %}} 
##  **Ajout d'hyperliens**
Aspose.Cells permet aux développeurs d'ajouter des hyperliens vers des fichiers Excel à l'aide des feuilles de calcul API ou du concepteur (feuilles de calcul dans lesquelles les hyperliens sont créés manuellement et Aspose.Cells est utilisé pour les importer dans d'autres feuilles de calcul).
...
##  **Ajouter un lien à une URL**
 Le[Feuille de travail](https://reference.aspose.com/cells/net/aspose.cells/worksheet) la classe contient un[Liens hypertextes](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/hyperlinks) collection. Chaque élément du[Liens hypertextes](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/hyperlinks) la collection représente un[Lien hypertexte](https://reference.aspose.com/cells/net/aspose.cells/hyperlink) . Ajoutez des hyperliens aux URL en appelant le[Liens hypertextes](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection) la collection[Ajouter](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection/methods/add/index) méthode. Le[Ajouter](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection/methods/add/index)La méthode prend les paramètres suivants :

- Cell nom, le nom de la cellule à laquelle le lien hypertexte sera ajouté.
- Nombre de lignes, nombre de lignes dans cette plage de lien hypertexte.
- Nombre de colonnes, le nombre de colonnes dans cette plage de lien hypertexte
- URL, l'adresse URL.
...
##  **Ajout d'un lien vers un Cell dans le même fichier**
 Il est possible d'ajouter des hyperliens vers des cellules d'un même fichier Excel en appelant la commande[Liens hypertextes](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection) la collection[Ajouter](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection/methods/add/index) méthode. Le[Ajouter](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection/methods/add/index)La méthode fonctionne pour les hyperliens internes et externes. Une version de la méthode surchargée prend les paramètres suivants :

- Cell nom, le nom de la cellule à laquelle le lien hypertexte sera ajouté.
- Nombre de lignes, nombre de lignes dans cette plage de lien hypertexte.
- Nombre de colonnes, nombre de colonnes dans cette plage de lien hypertexte.
...
##  **Ajout d'un lien vers un fichier externe**
 Il est possible d'ajouter des hyperliens vers des fichiers Excel externes en appelant le[Liens hypertextes](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection) la collection[Ajouter](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection/methods/add/index) méthode. Le[Ajouter](https://reference.aspose.com/cells/net/aspose.cells/hyperlinkcollection/methods/add/index)La méthode prend les paramètres suivants :
...
- [Modification des hyperliens de la feuille de calcul](/cells/fr/net/editing-hyperlinks-of-worksheet/)
