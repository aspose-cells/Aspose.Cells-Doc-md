...
- [C# Exporter vers DataTable depuis ODS](#csharp-export-to-datatable-from-ods)
...
- <a name="csharp-excel-to-datatable" id="csharp-excel-to-datatable"><strong><em>Pas:</em> Excel vers DataTable en C#</strong></a>
  - <a name="csharp-xls-to-datatable" id="csharp-xls-to-datatable"><strong><em>Pas:</em> XLS vers DataTable dans C#</strong></a>
  - <a name="csharp-xlsx-to-datatable" id="csharp-xlsx-to-datatable"><strong><em>Pas:</em> XLSX vers DataTable dans C#</strong></a>
...
- <a name="csharp-export-to-datatable-from-excel" id="csharp-export-to-datatable-from-excel"><strong><em>Pas:</em> Exporter vers DataTable à partir d'Excel en C#</strong></a>
  - <a name="csharp-export-to-datatable-from-xls" id="csharp-export-to-datatable-from-xls"><strong><em>Pas:</em> Exporter vers DataTable à partir de XLS en C#</strong></a>
  - <a name="csharp-export-to-datatable-from-xlsx" id="csharp-export-to-datatable-from-xlsx"><strong><em>Pas:</em> Exporter vers DataTable depuis XLSX en C#</strong></a>
  - <a name="csharp-export-to-datatable-from-ods" id="csharp-export-to-datatable-from-ods"><strong><em>Pas:</em> Exporter vers DataTable à partir d'ODS dans C#</strong></a>
