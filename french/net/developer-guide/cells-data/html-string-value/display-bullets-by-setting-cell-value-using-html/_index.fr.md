...
description: Ajouter des puces aux cellules Excel en utilisant HTML et la facilité d utilisation de l API Aspose.Cells for .NET.
...
Aspose.Cells prend en charge l'affichage des puces avec du code HTML. Cet article expliquera comment afficher des puces en définissant la valeur de la cellule à l'aide d'HTML. Nous utiliserons [**Cell.HtmlString**](https://reference.aspose.com/cells/net/aspose.cells/cell/properties/htmlstring) la propriété pour définir la valeur de la cellule avec notre HTML.

{{% /alert %}}

## Code C# pour afficher les puces en définissant la valeur de la cellule à l'aide d'HTML
