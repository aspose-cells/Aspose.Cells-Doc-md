...
type: docs
weight: 300
url: /fr/net/specify-formula-fields-while-importing-data-to-worksheet/
description: Apprenez comment spécifier les champs de formule lors de l importation de données dans la feuille de calcul via l API Aspose.Cells for .NET.
