...
linktitle: Enregistrer au format CSV, TSV et Txt
type: docs
weight: 40
...
- [Coupez les premières lignes et colonnes vides lors de l'exportation de feuilles de calcul au format CSV](/cells/fr/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
