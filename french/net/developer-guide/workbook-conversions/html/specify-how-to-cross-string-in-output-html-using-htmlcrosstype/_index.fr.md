...
- **HtmlCrossType.Cross**: Affichez la chaîne croisée HTML, les performances de création de fichiers HTML volumineux seront plus de dix fois plus rapides qu'en définissant la valeur sur Par défaut ou FitToCell.
