...
L'exemple de code suivant crée un fichier Excel, ajoute du texte dans la cellule**B5** dans**Rouge**couleur puis l'enregistre au format HTML en utilisant[**HtmlSaveOptions.ExportWorksheetCSSSeparately**](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/exportworksheetcssseparately) la propriété. Veuillez consulter le[sortie HTML](60489766.zip) généré par le code pour référence. Tu trouveras**feuille de style.css**à l'intérieur à la suite de l'exemple de code.
