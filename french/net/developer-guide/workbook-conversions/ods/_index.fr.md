...
Aspose.Cells prend en charge la conversion de fichiers Excel en fichiers Ods, Sxc et Fods. L'exemple de code ci-dessous montre comment convertir le [modèle](book1.xlsx) en fichiers Ods, Sxc et Fods.

{{< gist "aspose-cells-gists" "88c9872508ec3150c552eb5155edf06e" "Convert-Excel-to-ODS.cs" >}}

## **Sujets avancés**
- [Enregistrer un fichier ODS selon les spécifications ODF 1.1 et 1.2.](/cells/fr/net/save-ods-file-in-odf-1-1-and-1-2-specifications/)
