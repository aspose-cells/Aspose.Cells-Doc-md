...
## Conversion du classeur en TIFF
 ...
 L'extrait de code suivant montre comment convertir Excel en TIFF avec plusieurs pages. La[fichier Excel source](workbook-to-tiff-with-mulitiple-pages.xlsx) et[image TIFF générée](workbook-to-tiff-with-mulitiple-pages.tiff) sont joints pour votre référence.
