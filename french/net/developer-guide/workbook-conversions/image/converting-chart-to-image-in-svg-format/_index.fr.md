...
Aspose.Cells peut enregistrer des graphiques sous forme d'images dans différents formats tels que BMP, JPEG, PNG, GIF, SVG, etc. Cet article explique comment enregistrer un graphique au format SVG.
