...
type: docs
weight: 240
url: /fr/net/converting-chart-to-image-in-svg-format/
---
{{% alert color="primary" %}} 
...
Aspose.Cells peut enregistrer un graphique dans des images dans différents formats tels que BMP, JPEG, PNG, GIF, SVG, etc. Cet article explique comment enregistrer un graphique au format SVG.

{{% /alert %}} 

L'exemple de code suivant explique comment utiliser Aspose.Cells pour convertir un graphique en une image au format SVG. Le code charge le fichier Excel source Microsoft, puis enregistre le premier graphique trouvé sur la première feuille de calcul en SVG.
