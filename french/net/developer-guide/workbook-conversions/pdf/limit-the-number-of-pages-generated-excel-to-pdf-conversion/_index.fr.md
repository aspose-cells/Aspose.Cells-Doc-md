---
title: Limiter le nombre de pages générées - Conversion Excel en PDF
type: docs
weight: 180
...
Parfois, vous souhaitez imprimer une plage de pages dans un fichier PDF de sortie. Aspose.Cells a la capacité de définir une limite sur le nombre de pages générées lors de la conversion d'une feuille de calcul Excel au format de fichier PDF.

{{% /alert %}}

## **Limiter le nombre de pages générées**

L'exemple suivant montre comment rendre une plage de pages (3 et 4) dans un fichier Excel Microsoft au format PDF.
