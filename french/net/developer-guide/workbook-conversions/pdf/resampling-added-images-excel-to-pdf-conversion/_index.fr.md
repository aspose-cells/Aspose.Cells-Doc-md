...
{{% alert color="primary" %}}
 ...
 En utilisant le[**SetImageResample**](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions/methods/setimageresample)L'option minimise la taille du PDF de sortie, mais cela peut affecter un peu la qualité de l'image.
