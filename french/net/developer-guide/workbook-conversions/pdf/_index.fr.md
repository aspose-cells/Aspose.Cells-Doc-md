...
{{% alert color="primary" %}}
 ...
 Aspose.Cells for .NET écrit directement les informations sur API et le numéro de version dans les documents de sortie. Par exemple, lors du rendu du document à PDF, Aspose.Cells for .NET remplit**PDF Producteur** champ avec valeur, par exemple 'Aspose.Cells v23.2'.

 Veuillez noter que vous pouvez modifier ces informations dans les documents de sortie en**[PdfSaveOptions.Producteur](https://reference.aspose.com/cells/net/aspose.cells/pdfsaveoptions/producer/)** propriété.
