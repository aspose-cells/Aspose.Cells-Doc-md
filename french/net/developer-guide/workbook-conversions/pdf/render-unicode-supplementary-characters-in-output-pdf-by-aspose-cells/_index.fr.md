...
## Rendre les caractères supplémentaires Unicode dans la sortie PDF par Aspose.Cells
 ...
 La capture d'écran suivante montre comment Aspose.Cells a rendu le[fichier excel source](5115563.xlsx) dans le[sortie PDF](5115564.pdf). Comme vous pouvez le voir, les trois caractères supplémentaires Unicode ont été rendus exactement de la même manière que par Microsoft Excel.
