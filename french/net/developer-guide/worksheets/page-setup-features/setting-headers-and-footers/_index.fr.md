...
description: Cet article explique comment insérer par programme une image dans l'en-tête et le pied de page des feuilles de calcul Excel en définissant l'en-tête et le pied de page avec des commandes de script à l'aide de la bibliothèque C# API ou .NET.
...
1.  Sur le**Déposer** menu, sélectionnez *Configuration de la page**. Une boîte de dialogue s'affiche.
