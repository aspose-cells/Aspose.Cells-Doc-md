...
description: Cet article explique comment définir par programme les options d'impression de la fonctionnalité Mise en page de la feuille de calcul Excel à l'aide de la bibliothèque C# API et .NET. Vous pouvez définir la zone d'impression, les titres d'impression et l'ordre des pages.
