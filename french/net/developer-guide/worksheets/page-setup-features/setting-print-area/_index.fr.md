...
type: docs
weight: 200
url: /fr/net/how-to-set-print-area/
...
keywords: Limiter la plage d impression, définir la plage d impression, effacer la plage d impression, définir et effacer la plage d impression en utilisant C#, C# Comment définir la zone d impression, Définir et effacer la zone d impression en utilisant C#, Comment effacer la zone d impression en C#, Ajouter une zone d impression en C#, supprimer la zone d impression en C#, Définir la zone d impression dans Excel, Effacer la zone d impression dans Excel.
---
...
Pour effacer la zone d'impression dans une feuille spécifiée : d'abord, chargez le [fichier exemple](input.xlsx), puis modifiez la propriété [**Worksheet.PageSetup.PrintArea**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printarea/) de l'objet [**PageSetup**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/) pour la feuille souhaitée. La définition de cette propriété à une chaîne vide effacera la zone d'impression.
