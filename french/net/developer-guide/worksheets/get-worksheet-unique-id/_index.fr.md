...
description: Cet article montre comment obtenir un identifiant unique de feuille de calcul Excel à l'aide de la bibliothèque C# et .NET API par programmation
