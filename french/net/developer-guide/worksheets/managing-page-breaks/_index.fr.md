...
description: Cet article fournit un exemple de code et explique comment ajouter des sauts de page, effacer des sauts de page ou supprimer des sauts de page spécifiques dans des feuilles de calcul Excel par programmation à l'aide de la bibliothèque C# API ou .NET.
