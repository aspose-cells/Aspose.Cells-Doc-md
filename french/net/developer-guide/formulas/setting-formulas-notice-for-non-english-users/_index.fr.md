...
1. Les formules doivent être saisies en anglais. Par exemple, utilisez l'anglais "=SUM()" et non l'allemand "=SUMME()".
1. Utilisez toujours une virgule (,) pour délimiter les paramètres de fonction. Pour certaines options ou paramètres de langue, le délimiteur des paramètres de fonction est un point-virgule, mais Aspose.Cells utilise la virgule de style anglais. Par exemple, utilisez "=IF (C5=0,0,C3/C4)" et non "=IF(C5=0;0;C3/C4)"
