...
Première étape, vous devez définir une classe "ChartChineseSetttings" qui hérite de[**Paramètres de globalisation du graphique**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartglobalizationsettings/). 
...
Dans cet exemple, si vous ne définissez pas la région chinoise pour un graphique, les éléments de graphique suivants peuvent être rendus dans la langue par défaut, telle que l'anglais.
...
|Légende Réduire le nom|减少|Diminuer|
