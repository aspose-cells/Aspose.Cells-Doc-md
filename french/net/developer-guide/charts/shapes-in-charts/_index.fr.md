...
- **largeur** – la largeur de l'étiquette, en unités de 1/4000 de la zone du graphique.
 ...
 La méthode retourne[**Aspose.Cells.Drawing.Label**](https://reference.aspose.com/cells/net/aspose.cells.drawing/label)objet. La[**Étiquette**](https://reference.aspose.com/cells/net/aspose.cells.drawing/label) class représente une étiquette dans le graphique. Il compte quelques membres importants :
...
- **largeur** – la largeur de la zone de texte, en unités de 1/4000 de la zone du graphique.
 ...
 La méthode retourne[**Aspose.Cells.Drawing.TextBox**](https://reference.aspose.com/cells/net/aspose.cells.drawing/textbox) objet. La[**Zone de texte**](https://reference.aspose.com/cells/net/aspose.cells.drawing/textbox)la classe représente une zone de texte dans le graphique.
...
- **Échelle de hauteur** – l'échelle de la hauteur de l'image, une valeur en pourcentage.
 ...
 La méthode retourne un[**Aspose.Cells.Drawing.Picture**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture) objet. La[**Image**](https://reference.aspose.com/cells/net/aspose.cells.drawing/picture)La classe représente un objet image dans le graphique.
...
![tâche : image_autre_texte](controls-in-charts_1.jpg)
 ...
 La[fichier de sortie](101089316.xlsx)généré par l'extrait de code suivant est joint pour votre référence.
