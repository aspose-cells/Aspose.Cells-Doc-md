...
## **Options de titre**
 Aspose.Cells permet également de gérer les titres du graphique lors de l'exécution, avec[Titre](https://reference.aspose.com/cells/net/aspose.cells.charts/title/) objet, vous pouvez modifier le texte, la police et le format de remplissage des titres.
