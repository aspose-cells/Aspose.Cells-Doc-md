...
description: Apprenez comment créer un diagramme TreeMap dans Aspose.Cells for .NET. Notre guide vous aidera à comprendre les différentes propriétés et options de formatage disponibles pour les diagrammes TreeMap, y compris les couleurs, les étiquettes et la représentation des données.
keywords: Aspose.Cells for .NET, diagramme TreeMap, créer, propriétés, formatage, couleurs, étiquettes, représentation des données, diagramme circulaire, représentation hiérarchique.
type: docs
weight: 161
url: /fr/net/creating-treemap-chart/
---
