...
## **Crypter le fichier ODS avec Aspose.Cells pour .Net**
 Pour chiffrer un fichier ODS, chargez le fichier et définissez le[**WorkbookSettings.Password**](https://reference.aspose.com/cells/net/aspose.cells/workbooksettings/properties/password) valeur au mot de passe réel avant de l'enregistrer. Le fichier de sortie crypté ODS ne peut être ouvert que dans OpenOffice.
