...
### **Téléchargez et installez Aspose.Cells**
 ...
 Tout d'abord, vous devez[Télécharger](https://downloads.aspose.com/cells/net) Aspose.Cells pour .Net. Installez-le sur votre poste de développement. Tout[Aspose](http://www.aspose.com/) les composants, une fois installés, fonctionnent en mode d'évaluation. Le mode d'évaluation n'a pas de limite de temps et il injecte uniquement des filigranes dans les documents produits.
...
Vous pouvez parcourir le classeur et afficher chaque feuille de calcul dans une image distincte :
