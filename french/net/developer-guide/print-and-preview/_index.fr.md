...
### **Imprimer à l'aide de WorkbookRender**
 ...
 Pour imprimer un classeur entier, parcourez les feuilles et imprimez-les, ou utilisez le[**ClasseurRender**](https://reference.aspose.com/cells/net/aspose.cells.rendering/workbookrender)classe.
