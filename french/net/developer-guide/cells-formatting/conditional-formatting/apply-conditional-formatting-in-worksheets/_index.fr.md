---
title: Appliquer une mise en forme conditionnelle dans les feuilles de calcul
description: Comment utiliser la bibliothèque Aspose.Cells dans C# pour appliquer une mise en forme conditionnelle dans les feuilles de calcul. En ajustant ces critères, vous avez plus de contrôle sur l’apparence et l’apparence des cellules.
...
1. *Téléchargez et installez le Aspose.Cells**.
 1. Téléchargez le Aspose.Cells for .NET.
1. Installez-le sur votre ordinateur de développement.
 Tous les composants Aspose, une fois installés, fonctionnent en mode évaluation. Le mode d'évaluation n'a pas de limite de temps et injecte uniquement des filigranes dans les documents produits.
1. *Créer un projet**.
...
1. Application d'une mise en forme conditionnelle en fonction de la formule (extrait de code)
