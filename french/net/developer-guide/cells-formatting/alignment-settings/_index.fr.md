...
{{% alert color="primary" %}}
 ...
 Vous pouvez également appliquer le paramètre de justification distribuée à l'aide de la[**Style.IsJustifyDistributed**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/isjustifydistributed) propriété.
...
#### **Échancrure**
 ...
 Il est possible de définir le niveau d'indentation du texte dans une cellule avec la[**Style**](https://reference.aspose.com/cells/net/aspose.cells/style) objets[**Niveau d'indentation**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/indentlevel)propriété.
...
#### **Orientation**
 ...
 Définissez l'orientation (rotation) du texte dans une cellule avec la[**Style**](https://reference.aspose.com/cells/net/aspose.cells/style) objets[**Angle de rotation**](https://reference.aspose.com/cells/net/aspose.cells/style/properties/rotationangle)propriété.
