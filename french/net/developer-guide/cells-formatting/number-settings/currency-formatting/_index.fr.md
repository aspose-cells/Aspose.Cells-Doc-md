...
type: docs
weight: 10
url: /fr/net/format-number-to-currency/
description: Cet article expliquera comment formater un nombre en devise à l aide de l API Aspose.Cells for .NET.
...
Pour formater les nombres en devise dans la bibliothèque Aspose.Cells for .NET pour travailler avec des fichiers Excel, vous pouvez appliquer une mise en forme monétaire aux cellules de manière programmatique. Voici comment faire avec C# et Aspose.Cells :
