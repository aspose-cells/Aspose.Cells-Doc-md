...
type: docs
weight: 10
url: /fr/net/how-to-format-number-to-accounting/
description: Cet article expliquera comment formater un nombre en comptabilité en utilisant l API Aspose.Cells for .NET.
...
## **Comment formater un nombre en comptabilité dans Aspose.Cells for .NET**
Pour formater des nombres en format comptabilité dans Aspose.Cells for .NET, vous pouvez utiliser l'objet `Style` associé à une cellule ou une plage de cellules. L'objet `Style` permet de définir diverses options de mise en forme, y compris les formats de nombres. Le format comptabilité possède généralement un code de format qui peut varier selon les besoins spécifiques (par exemple, afficher ou non les symboles monétaires, les décimales, etc.).

Voici un exemple simple pour appliquer un format numérique comptable à une cellule dans Aspose.Cells for .NET :
