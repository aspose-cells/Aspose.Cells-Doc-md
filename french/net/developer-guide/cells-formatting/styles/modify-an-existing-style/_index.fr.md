...
description: Aspose.Cells est une bibliothèque .NET permettant de travailler avec des fichiers de feuille de calcul qui permet aux utilisateurs de modifier les styles de cellules existants. Cet article explique comment modifier un style de cellule existant avec la bibliothèque Aspose.Cells afin que les utilisateurs puissent modifier l'apparence des cellules selon leurs besoins.
...
Vous pouvez également utiliser un style existant, l'enregistrer avec le classeur et l'utiliser pour formater les informations avec les mêmes attributs.
 ...
 Lorsque les cellules ne sont pas explicitement formatées, le**Normale** style (le style par défaut du classeur) est appliqué. Microsoft Excel prédéfinit plusieurs styles en plus du style Normal, notamment Virgule, Devise et Pourcentage.
...
Cet exemple utilise un simple modèle de fichier Excel dans lequel un style appelé Pourcentage a déjà été appliqué à une plage. L'exemple:

1. obtient le style,
1. crée un objet de style et
1. modifie le formatage du style.
