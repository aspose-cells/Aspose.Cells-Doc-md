...
type: docs
weight: 50
url: /fr/net/link-cells-to-xml-map-elements/
---

## **Scénarios d'utilisation possibles**

Vous pouvez lier vos cellules aux éléments de la carte XML en utilisant Aspose.Cells. Veuillez utiliser la méthode [**Cells.LinkToXmlMap()**](https://reference.aspose.com/cells/net/aspose.cells/cells/methods/linktoxmlmap) à cette fin.
