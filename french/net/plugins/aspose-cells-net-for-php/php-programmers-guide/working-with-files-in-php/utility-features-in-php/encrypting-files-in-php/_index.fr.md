---
title: Crypter des fichiers en PHP
type: docs
weight: 10
url: /fr/net/encrypting-files-in-php/
---
## **Aspose.Cells - Crypter les fichiers Excel**
Chiffrement d'un fichier Excel Microsoft
...
## **Télécharger le code d'exécution**
 Télécharger**Chiffrement des fichiers (Aspose.Cells)**à partir de l'un des sites de codage social mentionnés ci-dessous :
