---
title: Aspose.Cells for .NET 18.8 Notes de mise à jour
type: docs
weight: 50
url: /fr/net/aspose-cells-for-net-18-8-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 18.8](https://www.nuget.org/packages/Aspose.Cells/18.8.0).
...
|CELLSNET-46219|La largeur de la balise HTML n'est pas suivie lors de la conversion de HTML en XLSX|Punaise|
|CELLSNET-46280|Exception générée lors de l'importation de données dans un fichier Excel avec SmartMarkers|Punaise|
|CELLSNET-46267|Problème avec le filtrage des données des premières lignes|Punaise|
