...
type: docs
weight: 60
url: /fr/net/aspose-cells-for-net-18-7-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-46046|Les images rondes deviennent des images carrées dans le PDF de sortie|Nouvelle fonctionnalité|
...
|CELLSNET-45921|Le cercle devient carré dans le rendu Excel vers PDF|Punaise|
...
|CELLSNET-46189|Le document PDF de sortie n'est pas le même que la sortie MS Excel|Punaise|
|CELLSNET-46187|La longueur du double soulignement n'est pas correcte - Conversion Excel en PDF|Punaise|
...
|CELLSNET-46198|PDF vierge créé lors de la conversion de XLSX en PDF|Punaise|
...
|CELLSNET-46195|La conversion de XLSX joint en PDF soulève une exception|Punaise|
|CELLSNET-46192|La conversion d'un fichier XLSX avec dde en XLS vous demandera une vue protégée|Punaise|
