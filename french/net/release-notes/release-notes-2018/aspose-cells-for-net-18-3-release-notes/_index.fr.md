...
type: docs
weight: 100
url: /fr/net/aspose-cells-for-net-18-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45966|Cause d'exception lors de la conversion HTML vers Cells vers l'arrière|Renforcement|
|CELLSNET-45976|Erreur lors de l'ouverture du fichier ODS en raison de cadres éventuellement différents qui conservent une précision différente pour les valeurs flottantes|Renforcement|
...
|CELLSNET-45896|Des bordures indésirables apparaissent autour de l'image lorsque le fichier Excel est enregistré au format PDF|Punaise|
...
|CELLSNET-45884|Graphique Smart Art sur l'onglet - les bords des cônes sont irréguliers dans le format de fichier PDF de sortie|Punaise|
...
|CELLSNET-45938|System.IndexOutOfRangeException lors de l'ouverture de fichiers XLSB|Exception|
