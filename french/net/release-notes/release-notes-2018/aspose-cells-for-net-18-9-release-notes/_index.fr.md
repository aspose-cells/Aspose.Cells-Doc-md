...
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-18-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46308|Exporter les propriétés de document personnalisées au format PDF|Nouvelle fonctionnalité|
...
|CELLSNET-46290|Mauvaises couleurs rendues pour les formes dans la conversion Excel en PDF|Punaise|
|CELLSNET-46282|Des images assez petites rendues en PDF|Punaise|
|CELLSNET-46328|Lien hypertexte cassé en HTML|Punaise|
...
|CELLSNET-46313|Problèmes de sortie PDF lors de l'utilisation de mots-clés allemands dans les en-têtes et pieds de page de script|Punaise|
...
|CELLSNET-46305|Zone de texte hors impression rendue au format PDF|Punaise|
...
|CELLSNET-46283|Bordure manquante dans la sortie ODS Excel|Punaise|
