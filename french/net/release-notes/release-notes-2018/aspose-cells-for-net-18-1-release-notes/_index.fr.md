...
type: docs
weight: 120
url: /fr/net/aspose-cells-for-net-18-1-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45763|Le texte de la forme est pivoté dans la conversion Excel en PDF|Punaise|
|CELLSNET-45669|Les caractères se chevauchent lors de la conversion en image|Punaise|
|CELLSNET-45841|Fichier XLSB traitant de Power Pivot corrompu lors de l'ouverture et de la ré-enregistrement|Punaise|
|CELLSNET-45819|Les bordures ne s'affichent pas lors de l'exportation de HTML vers Excel|Punaise|
...
|CELLSNET-45765|Les graphiques n'ont pas pu être exportés lorsque le format personnalisé utilise le format "mm"|Punaise|
...
|CELLSNET-45847|SpreadsheetML vers XLSX - Aspose.Cells définit les paramètres de protection|Punaise|
...
|CELLSNET-44690|Ré-enregistrer le XLS étire le graphique verticalement|Punaise|
...
|CELLSNET-45829|Lorsque XLSX est enregistré au format HTML, une exception IndexOutOfRangeException se produit|Exception|
