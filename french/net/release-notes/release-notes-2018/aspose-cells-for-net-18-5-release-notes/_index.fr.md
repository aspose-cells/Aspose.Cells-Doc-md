...
type: docs
weight: 80
url: /fr/net/aspose-cells-for-net-18-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46087|Configuration de la page PrintErrorType ne fonctionne pas dans le rendu Excel vers PDF|Renforcement|
|CELLSNET-46084|PageSetup.PrintDraft ne prend pas effet lors de l'enregistrement au format PDF|Renforcement|
...
|CELLSNET-46088|Le facteur de zoom de la mise en page crée un nombre incorrect de pages dans le PDF|Punaise|
...
|CELLSNET-46036|Le titre du graphique est écrasé là où les caractères s'exécutent tous ensemble dans le rendu Excel vers PDF|Punaise|
...
|CELLSNET-46104|L'enregistrement de XLSB dans XLSM crée un fichier MS Excel corrompu|Punaise|
...
|CELLSNET-46068|Aspose.Cells renvoie un PDF vierge lors de l'enregistrement d'un fichier SpreadsheetML au format PDF|Punaise|
|CELLSNET-46060|La perte de données se produit lors de la conversion d'ODS au format de fichier XLSX|Punaise|
...
|CELLSNET-46075|Exception lors du rendu d'un fichier Excel au format PDF|Exception|
