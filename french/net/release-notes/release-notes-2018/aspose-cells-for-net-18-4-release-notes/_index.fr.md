...
type: docs
weight: 90
url: /fr/net/aspose-cells-for-net-18-4-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46013|Nouveau type croisé avec masquage du contenu superposé lors de l'enregistrement au format HTML|Renforcement|
|CELLSNET-45965|Capacité à traiter l'élément LINK standard lors de la rétro-conversion|Renforcement|
|CELLSNET-46032|Ne pas générer de PDF vierge d'une seule page lorsque le fichier Excel est vide|Renforcement|
...
|CELLSNET-46005|Ecritures inversées pour différentes feuilles dans le format de fichier PDF de sortie|Punaise|
|CELLSNET-45958|Formatage incorrect lors de l'enregistrement de XLSX au format HTML|Punaise|
...
|CELLSNET-45990|La sortie PDF varie en fonction du type d'optimisation|Punaise|
...
|CELLSNET-46024|Lors de l'enregistrement de OriginalDataSource avec la barre oblique remplacée par une barre oblique inverse|Punaise|
...
|CELLSNET-46002|Les lignes d'en-tête de page sont affichées uniquement sur la première page du PDF de sortie|Punaise|
...
|CELLSNET-45992|Aspose.Cells 18.2 : L'ouverture d'un fichier XLS particulier provoque une exception ArgumentOutOfRangeException|Exception|
