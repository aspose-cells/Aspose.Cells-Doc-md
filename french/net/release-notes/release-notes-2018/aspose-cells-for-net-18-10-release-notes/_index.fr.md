...
type: docs
weight: 30
url: /fr/net/aspose-cells-for-net-18-10-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46353| Reconnaître les balises vides comme<td /> lors de la conversion du format de fichier HTML au format MS Excel|Punaise|
...
|CELLSNET-46321|Le caractère d'échappement s'affiche tel qu'il est dans le PDF|Punaise|
|CELLSNET-46376|La taille de la page de sortie PDF (et les marges) ne correspond pas à la sortie MS Excel|Punaise|
...
|CELLSNET-46357|Les fichiers XLSB ne peuvent pas être ouverts à l'aide de LoadDataFilterOption autre que LoadDataFilterOption.All|Punaise|
