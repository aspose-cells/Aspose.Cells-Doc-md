...
type: docs
weight: 70
url: /fr/net/aspose-cells-for-net-19-6-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45194|Prise en charge du dessin de Slicer lors du rendu au format PDF|Nouvelle fonctionnalité|
...
|CELLSNET-46737|Problèmes avec les lignes moyennes/épaisses lorsque XLSX est enregistré en tant qu'ODS|Renforcement|
...
|CELLSNET-46747|Les lignes de grille sont imprimées sur l'objet incorporé lors du rendu au format PDF|Punaise|
|CELLSNET-41479|Paramètres de trancheuse dans le PDF généré|Punaise|
|CELLSNET-41783|Les fichiers générés à partir d'un fichier de modèle contenant un segment doivent être corrigés|Punaise|
|CELLSNET-46733|Style/format perdu lors de l'enregistrement du tableau croisé dynamique au format HTML|Punaise|
|CELLSNET-46736|Problème de police lors de la conversion du HTML en PDF|Punaise|
...
|CELLSNET-46735|Le numéro de page ne redémarre pas à 1 sur chaque feuille du PDF de sortie|Punaise|
...
|CELLSNET-46752|Le fichier XLSX de sortie est corrompu après l'appel de InsertCutCells()|Punaise|
