...
type: docs
weight: 50
url: /fr/net/aspose-cells-for-net-19-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46827|Contenu manquant dans la conversion XLSX en ODS|Punaise|
|CELLSNET-46833|Les formes sont déformées lors de la conversion d'Excel en PDF|Punaise|
|CELLSNET-46835|Les formes de dessin ne sont pas rendues correctement dans le rendu Excel vers PDF|Punaise|
|CELLSNET-46848|Problème avec le texte arabe dans le rendu Excel vers PDF|Punaise|
...
|CELLSNET-46853|Certaines colonnes sont rendues en rouge dans le rendu Excel vers PDF|Punaise|
...
|CELLSNET-46858|La conversion XLSX en ODS modifie la police du texte dans le manuel|Punaise|
...
|CELLSNET-46723|Une exception est levée lors de l'obtention de l'image à partir de SheetRender pour le fichier ODS chiffré|Exception|
...
|CELLSNET-46831|Exception lors du rendu d'un fichier Excel au format PDF|Exception|
