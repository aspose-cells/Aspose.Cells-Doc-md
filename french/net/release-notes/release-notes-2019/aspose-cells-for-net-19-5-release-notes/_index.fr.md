...
type: docs
weight: 80
url: /fr/net/aspose-cells-for-net-19-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46693|Prise en charge de l'arrière-plan de l'ODS|Nouvelle fonctionnalité|
|CELLSNET-46695|Définir l'arrière-plan du fichier ODS|Nouvelle fonctionnalité|
|CELLSNET-46706|Ordre des numéros invalide lors de la conversion de la police arabe en PDF.|Renforcement|
...
|CELLSNET-46719|Exception lors de la définition d'une chaîne HTML à l'aide du modèle de couleur RVBA|Renforcement|
...
|CELLSNET-46689|L'enregistrement d'un classeur au format PDF est différent de la sortie native d'Excel|Punaise|
|CELLSNET-46704|La sortie de la conversion d'Excel en PDF à l'aide de Aspose.Cells est différente d'Excel|Punaise|
|CELLSNET-46720|La structure de la page est corrompue sur la dernière page de la conversion Excel en PDF|Punaise|
|CELLSNET-46727|Mauvaise numérotation des pages lors de l'enregistrement du classeur au format PDF|Punaise|
...
|CELLSNET-46697|La conversion de XLSM avec objet OLE en XLS provoque une erreur|Punaise|
...
|CELLSNET-46683|Exception lors du rendu d'un fichier Excel au format PDF|Exception|
