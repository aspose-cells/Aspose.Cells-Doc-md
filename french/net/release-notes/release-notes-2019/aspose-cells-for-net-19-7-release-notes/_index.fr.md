...
type: docs
weight: 60
url: /fr/net/aspose-cells-for-net-19-7-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46808|Prend en charge la lecture des cellules individuelles de la table du fichier XLS.|Nouvelle fonctionnalité|
...
|CELLSNET-46802|Graphique rendu différemment en XLS qu'en PDF|Punaise|
|CELLSNET-46806|Le graphique combiné ne s'affiche pas correctement au format PDF|Punaise|
|CELLSNET-41449|XLSB avec des fichiers de tableau croisé dynamique complexes|Punaise|
|CELLSNET-43921|Le rendu de XLSX en XLSB produit un fichier corrompu|Punaise|
|CELLSNET-44593|Le fichier Excel de sortie n'est pas bon lors de la conversion de HTML en Excel|Punaise|
|CELLSNET-46794|Cells décalage lors de la conversion de HTML en XLSX|Punaise|
...
|CELLSNET-46774|Texte en lignes déformé lors de la conversion d'un fichier volumineux en PDF|Punaise|
|CELLSNET-46798|Problème de conversion d'Excel en PDF|Punaise|
|CELLSNET-46797|Le style de police de soulignement est ignoré lors du rendu de la feuille Excel en BMP/Tiff|Punaise|
|CELLSNET-46664|Les balises HeadingPairs et TitlesOfParts sont à nouveau restaurées après la conversion du XLS nettoyé au format de fichier XLSM|Punaise|
...
#### **Mettre à jour l'espace de noms Aspose.Cells.ODS en tant que Aspose.Cells.Ods et mettre à jour les classes/énumérations/propriétés ODS* en tant qu'Ods**
