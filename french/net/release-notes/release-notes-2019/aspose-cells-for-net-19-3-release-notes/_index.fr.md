...
type: docs
weight: 100
url: /fr/net/aspose-cells-for-net-19-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46623|Problèmes dans les URL de fichiers partagés intégrés lors de la conversion d'un fichier Excel en HTML|Punaise|
|CELLSNET-46590|Erreur dans une cellule qui appelle une macro après le traitement du fichier par Aspose.Cells|Punaise|
|CELLSNET-46597|Mauvaise valeur dans le PDF dans le rendu Excel vers PDF|Punaise|
|CELLSNET-46613|Problèmes lors de la récupération et de la création de plages nommées|Punaise|
|CELLSNET-46625|Mauvais arrière-plan du tableau dans le PDF et le HTML de sortie|Punaise|
|CELLSNET-46628|Différence dans le PDF de sortie|Punaise|
|CELLSNET-46589|Des quadrillages inattendus sont apparus dans SVG converti à partir de la feuille de calcul MS Excel|Punaise|
|CELLSNET-46600|Le double soulignement disparaît lors de la conversion du fichier Excel en PDF|Punaise|
|CELLSNET-46626|Problèmes de formatage d'espace lors de la conversion d'un fichier XLSX en PDF|Punaise|
...
|CELLSNET-46624|Problème de chargement de fichier XLSX|Punaise|
|CELLSNET-46635|Trop de sauts de page dans le fichier ODS (rendu XLSX vers ODS)|Punaise|
