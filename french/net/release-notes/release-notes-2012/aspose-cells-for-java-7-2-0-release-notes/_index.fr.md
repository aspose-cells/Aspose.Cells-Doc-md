...
type: docs
weight: 80
url: /fr/net/aspose-cells-for-java-7-2-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for Java 7.2.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-java-7.2.0/)
