...
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-5-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 5.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.2/)
...
|19065 | PDF| Conversion en PDF via Aspose.Cells Réduit le texte|
|19024 | PDF| L'apparence du PDF généré n'est pas la même que celle d'Excel|
|19170 | PDF| Problème Enregistrer au format PDF - PDF corrompu|
