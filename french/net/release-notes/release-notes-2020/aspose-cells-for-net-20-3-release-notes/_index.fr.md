...
type: docs
weight: 50
url: /fr/net/aspose-cells-for-net-20-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-47092|Rendre les icônes disponibles pour IStreamProvider comme des images habituelles tout en enregistrant le document au format HTML|Renforcement|
...
|CELLSNET-47178|Indentation perdue lors de la création d'un tableau et de la conversion en HTML|Punaise|
...
|CELLSNET-47184|BIFF5 avec du contenu cyrillique est incorrectement converti en XLSX|Punaise|
...
|CELLSNET-47212|NullReferenceException lors de l'enregistrement d'un XLSM particulier dans XLS|Exception|
|CELLSNET-47222|Aspose.Cells 20.2 : Exception lors de la conversion d'un fichier XLSB particulier en Excel97To2003|Exception|
