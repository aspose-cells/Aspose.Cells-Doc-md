...
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-20-4-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-47276|XLSX vers CSV, virgules requises pour les cellules vides également similaires à MS Excel|Nouvelle fonctionnalité|
...
|CELLSNET-47217|Prise en charge de la mise en forme conditionnelle de la barre de données, de l'échelle de couleurs et de l'ensemble d'icônes d'ODS.|Renforcement|
...
|CELLSNET-47046|Délimiteurs de guillemets non ouverts dans les attributs HTML IMG dans le balisage HTML généré|Punaise|
...
|CELLSNET-47279|Le texte de la première colonne de toutes les lignes n'est pas sous-scripté lors de l'exportation du fichier au format HTML|Punaise|
...
|CELLSNET-47269|Conversion XLSX en CSV - virgule manquante dans la sortie|Punaise|
...
|CELLSNET-47258|Problème avec les images de codes-barres dans le rendu Feuille vers TIFF|Punaise|
...
|CELLSNET-47282|Aspose.Cells 20.3 : Problème de conversion XLSB vers XLS|Punaise|
...
|CELLSNET-47246|Exception "Impossible d'accéder à un flux fermé" lors de l'enregistrement d'un fichier Excel au format PDF|Exception|
