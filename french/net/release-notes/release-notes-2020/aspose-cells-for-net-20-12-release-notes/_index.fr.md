...
type: docs
weight: 1
url: /fr/net/aspose-cells-for-net-20-12-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47672|Réduire la taille de sortie lors de la conversion en HTML|Renforcement|
...
|CELLSNET-47758| La conversion complexe de XLSM en HTML prend beaucoup de temps|Performance|
...
|CELLSNET-47643|Quelques colonnes supplémentaires dans la nouvelle sortie dans le rendu Excel vers HTML|Punaise|
|CELLSNET-47688|Certains TD provoqueront une erreur de police pour la police Wingdings dans le rendu HTML vers PDF|Punaise|
...
|CELLSNET-47764|Nombre converti en scientifique lors de la conversion de XLSX en CSV|Punaise|
...
|CELLSNET-47735|Exception lors de l'ouverture de XLSB|Exception|
