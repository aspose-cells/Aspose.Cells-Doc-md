...
type: docs
weight: 90
url: /fr/net/aspose-cells-for-net-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 17.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.4.0/).
...
- [Définir l'en-tête de colonne](/cells/fr/net/set-column-header-tip/)
