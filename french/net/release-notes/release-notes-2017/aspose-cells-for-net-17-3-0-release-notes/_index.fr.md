---
title: Aspose.Cells for .NET 17.3.0 Notes de mise à jour
type: docs
weight: 100
url: /fr/net/aspose-cells-for-net-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 17.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.3.0/).
...
1. [Personnaliser les paramètres de globalisation pour le tableau croisé dynamique](/cells/fr/net/customize-globalization-settings-for-pivot-table/)
1. [Exécuter la fonction côté client lors du changement de page GridWeb](/cells/fr/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/fr/net/execute-client-side-function-on-gridweb-page-change/)
1. [Valider toute la feuille de calcul au lieu des seules cellules mises à jour](/cells/fr/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
