...
type: docs
weight: 60
url: /fr/net/aspose-cells-for-net-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 17.7](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.7/).
...
- [Déterminer si la taille du papier de la feuille de calcul est automatique](/cells/fr/net/determine-if-paper-size-of-worksheet-is-automatic/)
- [Rendre le tableau croisé dynamique dans GridDesktop](/cells/fr/net/render-pivottable-in-griddesktop/)
- [Légende de ligne et de colonne personnalisée de la feuille de calcul GridDesktop](/cells/fr/net/custom-row-and-custom-column-caption-of-griddesktop-worksheet/)
- [Trouver la version de GridDesktop au moment de l'exécution](/cells/fr/net/find-griddesktop-version-at-runtime/)
- [Redimensionner GridWeb dans la fenêtre du navigateur](/cells/fr/net/resize-gridweb-in-the-browser-window/)
