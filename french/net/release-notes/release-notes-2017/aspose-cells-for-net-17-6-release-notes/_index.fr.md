...
type: docs
weight: 70
url: /fr/net/aspose-cells-for-net-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 17.6](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.6/).
...
|CELLSNET-45335|L'image du graphique généré est incorrecte|Punaise|
...
- [Image en mosaïque en tant que texture à l'intérieur de la forme](/cells/fr/net/tile-picture-as-a-texture-inside-the-shape/)
- [Utilisation de la fonction OnAjaxCallFinishedClient de GridWeb](/cells/fr/net/using-onajaxcallfinishedclientfunction-of-gridweb/)
...
- [Ajouter GridWeb au formulaire Web](/cells/fr/net/add-gridweb-to-web-form/)
- [Regrouper les lignes et créer un sous-total](/cells/fr/net/group-rows-and-create-subtotal/)
