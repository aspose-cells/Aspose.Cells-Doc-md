...
type: docs
weight: 10
url: /fr/net/aspose-cells-for-net-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [Le texte déborde de la cellule GridDesktop s'il est trop long](/cells/fr/net/text-overflows-from-griddesktop-cell-if-it-is-too-long/)
- [Mettre à jour les jours de conservation de l'historique des journaux de révision dans le classeur partagé](/cells/fr/net/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
