...
type: docs
weight: 30
url: /fr/net/aspose-cells-for-net-16-10-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44695 | Charger depuis HTML ignore le style gras du bloc de style| Punaise|
|CELLSNET-44779 | La valeur calculée de la cellule D5 est erronée| Punaise|
|CELLSNET-44775 | Conversion Excel en PDF - Nombre de pages augmenté dans le format de fichier PDF de sortie| Punaise|
...
|CELLSNET-44730 | La liste justifiée ne s'affiche pas correctement dans le PDF de sortie| Punaise|
|CELLSNET-44729 | Les listes numérotées dans Excel ne s'affichent pas correctement lors de l'exportation au format PDF| Punaise|
|CELLSNET-44720 | Les extrémités de l'arc sont carrées et non rondes dans le PDF de sortie| Punaise|
...
|CELLSNET-44756 | Zone de texte supprimée après l'enregistrement du classeur| Punaise|
...
|CELLSNET-44757 | System.NullReferenceException à l'ouverture du fichier XLSB source| Exception|
