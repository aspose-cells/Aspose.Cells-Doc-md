...
type: docs
weight: 90
url: /fr/net/aspose-cells-for-net-8-8-2-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44446 | Tous les styles CSS ne sont pas préfixés lors de l'enregistrement au format HTML| Punaise|
...
|CELLSNET-44443 | Graphique croisé dynamique au format PDF - Axe y secondaire foiré| Punaise|
|CELLSNET-44450 | La rotation de l'image n'est pas correcte dans le PDF résultant| Punaise|
