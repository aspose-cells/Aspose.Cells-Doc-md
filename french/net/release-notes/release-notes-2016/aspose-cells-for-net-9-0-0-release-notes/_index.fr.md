...
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-9-0-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44650 | Impossible de convertir les couleurs d'arrière-plan ou de premier plan à partir de HTML| Punaise|
...
|CELLSNET-44644 | Le fichier résultant est corrompu lorsqu'il est ouvert et enregistre le fichier XLS| Punaise|
|CELLSNET-44622 | Le fichier XLSX final manque de styles de légende alors que ceux-ci sont présents dans le XLSX d'entrée et le HTML intermédiaire| Punaise|
...
|CELLSNET-44716 | Le résultat PDF ne correspond pas à Excel pour l'impression des lignes de titre| Punaise|
|CELLSNET-44713 | Les données sont masquées dans le résultat de la conversion du PDF| Punaise|
...
|CELLSNET-44678 | Les sparklines ne sont pas rendues correctement lors du rendu de la feuille de calcul au format PDF/image| Punaise|
...
|CELLSNET-44696 | La ligne avec la tête de flèche n'est pas complètement rendue aux formats XLSX et PDF| Punaise|
...
|CELLSNET-44691 | NullReferenceException au niveau du classeur en raison de display: none dans le code HTML source| Exception|
