---
title: Aspose.Cells for .NET 8.8.3 Notes de mise à jour
type: docs
weight: 80
url: /fr/net/aspose-cells-for-net-8-8-3-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44509 | ImportDataTable avec insertRows=true remplace la première ligne par une ligne vide| Renforcement|
|CELLSNET-44480 | Appliquer le style de tableau aux paramètres de texte enrichi| Renforcement|
|CELLSNET-44512 | Problème de performances dans la méthode Cells.CopyRows()| Performance|
...
|CELLSNET-44526 | Exception : "La chaîne d'entrée n'était pas dans un format correct." lors du chargement d'un format de fichier HTML| Exception|
|CELLSNET-44534 | Exception sur la méthode Workbook.Save.| Exception|
...
|CELLSNET-44483 | Prise en charge du copier/coller des lignes dans Aspose.Cells.GridDesktop dans le contrôle et entre le contrôle et Excel| Nouvelle fonctionnalité|
|CELLSNET-44499 | Impossible d'obtenir la propriété 'style' d'une référence indéfinie ou nulle, en raison de la définition de GridWeb.ShowHeaderBar sur false| Punaise|
|CELLSNET-44524 | Gestion de gros fichiers Excel avec Gridweb| Punaise|
|CELLSNET-44440 | La liste déroulante dans GridWeb affiche 4 entrées mais il y a 2 entrées sous les paramètres régionaux allemands| Punaise|
|CELLSNET-44506 | Exception InvalidFormula à GridWeb.ImportExcelFile| Exception|
...
#### **Ajoute la propriété GridWeb.SessionStorePath**
Obtient ou définit le chemin du magasin de session lorsque le mode de session est ViewState. Il s'agit d'un chemin relatif vers le répertoire de base de l'application Web actuelle.
