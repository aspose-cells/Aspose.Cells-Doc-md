...
type: docs
weight: 110
url: /fr/net/aspose-cells-for-net-8-8-0-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44312 |Les sauts de ligne sont perdus lors de l'importation de code HTML et de l'exportation vers une feuille de calcul| Punaise|
|CELLSNET-44311 | Les bordures sont perdues lors de l'importation de code HTML et de l'exportation vers une feuille de calcul| Punaise|
...
|CELLSNET-44347 | API rend deux pages PDF pour une feuille de calcul indépendamment de la définition de OnePagePerSheet sur true| Punaise|
...
|CELLSNET-44348 | Le nombre est arrondi lors de la conversion du HTML au format tableur| Punaise|
...
|CELLSNET-44354 | Forme à l'image Erreur lors de la conversion d'Excel en PDF| Exception|
