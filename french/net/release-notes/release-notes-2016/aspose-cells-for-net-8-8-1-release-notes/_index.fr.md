...
type: docs
weight: 100
url: /fr/net/aspose-cells-for-net-8-8-1-release-notes/
---
### **1) Aspose.Cells**
...
|CELLSNET-44263 | Le formatage est perdu lors de l'importation de HTML au format XLSX| Punaise|
...
|CELLSNET-44309 |Parenthèse non affichée pivotée dans le PDF de sortie (conversion Excel en PDF)| Punaise|
|CELLSNET-44302 | SheetRender.ToImage ne rend pas la bordure des cellules| Punaise|
|CELLSNET-43237 | Les symboles verticaux ne sont pas rendus correctement lors de la conversion de feuilles de calcul en PDF| Punaise|
...
|CELLSNET-44398 | Le rendu EMF du graphique ne fonctionne pas correctement dans la version la plus récente| Punaise|
...
|CELLSNET-44403 |Le filigrane d'arrière-plan est supprimé lors de l'enregistrement de XLS vers XLSX| Punaise|
