...
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-v4-7-0-new-release-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells pour .Net V4.7.0 Nouvelle version](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.7.0-new-release/)
...
- Prend en charge la conversion directe de fichiers Excel en PDF.
...
|7447 | PDF| Erreurs lors de l'enregistrement du classeur au format PDF|
...
|7507 | XLS| Bug lors de l'ouverture de certains fichiers XLS spéciaux|
...
|6856 | XLSX| OleObject n'a pas pu être ouvert bogue après la conversion de XLSX en XLS|
