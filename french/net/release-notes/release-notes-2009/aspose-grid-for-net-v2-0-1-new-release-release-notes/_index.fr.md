...
type: docs
weight: 30
url: /fr/net/aspose-grid-for-net-v2-0-1-new-release-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Grid for .NET V2.0.1 Nouvelle version](https://downloads.aspose.com/cells/net/new-releases/aspose.grid-for-.net-v2.0.1-new-release/)
