...
type: docs
weight: 20
url: /fr/net/aspose-cells-for-net-8-2-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.2.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.2/)
...
## **Insectes**
 ...
 (CELLSNET-43002) - Forme chevauchant le texte lorsque la feuille de calcul est rendue sous forme d'image
...
## **Exceptions**
 ...
 (CELLSNET-43013) - Exception de référence nulle à l'ouverture du document
