...
type: docs
weight: 10
url: /fr/net/aspose-cells-for-net-8-3-0-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.3.0](https://downloads.aspose.com/cells/net/new-releases/-aspose.cells-for-.net-8.3.0/)
...
(CELLSNET-43116) - "CELLRANGE" est affiché à la place des étiquettes dans Excel 2013
 ...
 (CELLSNET-43115) - Un caractère étrange remplace le*Xdddd* modèle dans la valeur de chaîne
...
(CELLSNET-43125) - Exception System.OutOfMemory dans GridWeb
