---
title: Aspose.Cells for .NET 8.2.0 Notes de mise à jour
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-8-2-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.2.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.0/)

{{% /alert %}} 

 Aspose.Cells for .NET a été mis à jour vers la version 8.2.0 et nous sommes heureux d'annoncer que cette version apporte l'ajout de plus de 40 nouvelles améliorations utiles.
...
## **Améliorations**
 ...
 (CELLSNET-42892) - Une surcharge d'AutoFitRows est requise

 (CELLSNET-42868) - La liste des validateurs de données ne renvoie pas les valeurs attendues

 (CELLSNET-42862) - Fonction Excel 2013 non prise en charge - Jours
...
(CELLSNET-42829) - Les cases à cocher ne sont pas correctement alignées dans le PDF résultant
 ...
 (CELLSNET-42920) - L'enregistrement d'un fichier Excel XLSM crée une erreur de contenu illisible

 (CELLSNET-42909) - Les lignes de repère sont masquées lors de la ré-enregistrement du fichier modèle XLSX

 (CELLSNET-42908) - La position de la cellule de fin passe de E9 à F9
...
(CELLSNET-42904) - Problème DeleteRange avec la collection Hyperlinks
 ...
 (CELLSNET-42851) - La fonction VLOOKUP est évaluée comme 0 par opposition à MS Excel

 (CELLSNET-42849) - Mappages XML perdus lors de la ré-enregistrement d'un fichier Excel

 (CELLSNET-42848) - La police du commentaire change lors de la réenregistrement du fichier ODS

 (CELLSNET-42806) - Modifications de la formule des séries de graphiques
...
(CELLSNET-41952) - "Exception de mémoire insuffisante" lors de l'enregistrement du classeur au format PDF
 ...
 (CELLSNET-42875) - NullReferenceException lors de l'ouverture du classeur à partir du flux de mémoire

 (CELLSNET-42863) - NullReferenceException lors de l'ouverture du classeur
...
## **Public API et modifications incompatibles avec les versions antérieures**
 ...
 Ajoute la propriété Cells.MultiThreadReading

 Indique si le modèle de données des cellules doit prendre en charge la lecture multithread.
