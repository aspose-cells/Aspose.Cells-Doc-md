...
type: docs
weight: 50
url: /fr/net/aspose-cells-for-net-8-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.2/)
...
(CELLSNET-42799) - Cell Problème de fusion lors de la conversion du tableau croisé dynamique en PDF
 ...
 (CELLSNET-42353) - Aspose.Cells produit une double épaisseur de flèche lors de la conversion de XLS en PDF

 (CELLSNET-42747) - Le résultat imprimé n'est pas centré correctement et la dernière ligne est perdue

 (CELLSNET-42744) - Le texte des cellules fusionnées ne s'affiche pas lors de la conversion en PDF
...
## **Exceptions**
 ...
 (CELLSNET-42812) - CellsException lors de la conversion d'une feuille de calcul en PDF
