...
type: docs
weight: 110
url: /fr/net/aspose-cells-for-net-7-7-1-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 7.7.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.7.1/)
...
## **Nouvelles fonctionnalités**
 ...
 (CELLSNET-42229) - Rendre les cellules sans couleurs sous forme de cellules transparentes dans la fonction Feuille vers image
