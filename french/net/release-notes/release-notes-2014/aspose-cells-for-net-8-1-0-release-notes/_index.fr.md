...
type: docs
weight: 60
url: /fr/net/aspose-cells-for-net-8-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.0/)
