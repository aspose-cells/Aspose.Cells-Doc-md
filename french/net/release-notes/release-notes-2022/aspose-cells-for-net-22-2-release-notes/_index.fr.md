...
type: docs
weight: 11
url: /fr/net/aspose-cells-for-net-22-2-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-50152| Divers problèmes de formatage et autres problèmes de rendu des formes dans les fichiers PDF et HTML du fichier Excel|
|CELLSNET-50300|Certaines formes ne sont pas rendues correctement dans la conversion Excel en PDF|
|CELLSNET-50301|Valeur non valide pour la référence externe dans le champ DataSource du tableau croisé dynamique|
|CELLSNET-50241|Régression : la conversion CSV en PDF ne fonctionne pas|
|CELLSNET-50268|Tableau CellsArea vide renvoyé pour les fichiers CSV/TSV|
|CELLSNET-50269|Finnois - Les nombres formatés en pourcentage manquent l'espace avant le symbole de pourcentage|
...
|CELLSNET-50225|La légende du graphique est inversée lors de l'enregistrement d'Excel au format PDF|
...
|CELLSNET-50308|Plage vers PNG : sortie non conforme aux attentes|
...
|CELLSNET-50294|Les boutons de contrôle ActiveX sont convertis en formes et le fichier est corrompu pour XLS en XLSM, puis de nouveau en XLS|
