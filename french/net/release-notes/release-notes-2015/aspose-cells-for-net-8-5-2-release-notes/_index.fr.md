...
type: docs
weight: 50
url: /fr/net/aspose-cells-for-net-8-5-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.5.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.2/)
...
(CELLSNET-43817) - CalculateFormula() ne se termine jamais pour certaines formules SUMIF Excel
 ...
 (CELLSNET-43780) - Format de papier exécutif incorrect lors de la conversion en PDF
 ...
 (CELLSNET-43805) - Conversion de feuille de calcul en PDF : le style gras est perdu

 (CELLSNET-43804) - Conversion de feuille de calcul en PDF : contenu dans les rendus TextBox avec indentation
...
(CELLSNET-43772) - Le texte dans la forme de dessin n'est pas correctement enveloppé
 ...
 (CELLSNET-43771) - L'image s'est déplacée après le rendu de la feuille de calcul au format PDF

 (CELLSNET-43748) - Le texte de la zone de texte se chevauche dans le rendu Excel vers PDF
