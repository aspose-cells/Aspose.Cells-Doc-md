...
type: docs
weight: 70
url: /fr/net/aspose-cells-for-net-8-5-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.5.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.0/)
...
## **Insectes**
 ...
 (CELLSNET-43702) - Feuille de calcul corrompue après l'ouverture et l'enregistrement du fichier de modèle XLSX

 (CELLSNET-43669) - L'ajout de plus de 14 champs au filtre de rapport du tableau croisé dynamique provoque une erreur

 (CELLSNET-43667) - Valeur de formule incorrecte après l'appel de Worksheet.CalculateFormula

 (CELLSNET-43584) - Les étiquettes de graphique sont perdues lors de la conversion au format PDF
...
(CELLSNET-43329) - Calculer la formule avec SUMIF donne un résultat différent d'Excel
 ...
 (CELLSNET-43715) - Cell Pattern Fill - La conversion PDF produit des fichiers volumineux
 ...
 (CELLSNET-43676) - Le PDF de sortie n'a pas le bon nombre de pages

 (CELLSNET-43672) - Mauvaise qualité d'image lors du rendu de la feuille de calcul au format PNG

 (CELLSNET-43661) - Le texte est tronqué lors du rendu de la feuille de calcul au format PDF

 (CELLSNET-43644) - Le texte ne s'affiche pas correctement

 (CELLSNET-43600) - Le fichier Excel n'est pas correctement rendu

 (CELLSNET-43593) - Le texte est au-dessus de la ligne et d'autres problèmes de formatage dans Excel en PDF
...
(CELLSNET-43481) - Cells avec des mots hébreux ont perdu la cohérence RTL
 ...
 (CELLSNET-42832) - Le texte en dehors du saut de page est rendu au format PDF sous forme de texte enveloppé
 ...
 (CELLSNET-42260) - Comparaison du PDF généré avec Aspose.Cells avec MS Excel

(CELLSNET-41519) - Les pages ne s'alignent pas lors de la conversion d'un fichier XLSX en PDF

 (CELLSNET-43683) - Aspose 8.4.2 lit les propriétés du graphique de manière incorrecte et est permuté

 (CELLSNET-43680) - La couleur de la légende est manquante dans le fichier PDF de sortie lors de la conversion Excel en PDF

 (CELLSNET-43679) - La mise à l'échelle horizontale de l'axe X du graphique est manquante dans le format de fichier PDF rendu

 (CELLSNET-43677) - Impossible de définir l'axe des catégories sur un axe de texte

 (CELLSNET-43668) - Le graphique à secteurs 3D n'est pas rendu correctement lors de la conversion d'Excel en PDF
 ...
 (CELLSNET-42376) - Le texte est coupé de TextBox lors du rendu de XLSX en PDF

 (CELLSNET-42369) - Le PDF n'est pas rendu correctement

(CELLSNET-43714) - Le ruban personnalisé est supprimé lors du traitement du fichier XLSM
 ...
 (CELLSNET-43664) - Le symbole de l'euro est remplacé par le signe du dollar lorsqu'il est enregistré en tant qu'ODS
