...
type: docs
weight: 20
url: /fr/net/aspose-cells-for-net-8-6-2-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.6.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.2/)
...
(CELLSNET-44031) - XLSB corrompu dans Excel 2010 après avoir enregistré dans v8.6.1
 ...
 (CELLSNET-43990) - Forme automatique mal placée lors du rendu de la feuille de calcul au format PDF
 ...
 (CELLSNET-43808) - Le style du tableau croisé dynamique est perdu lorsque les feuilles de calcul sont copiées dans un autre classeur et rendues au format PDF
 ...
 (CELLSNET-43391) - Problème de rendu HTML pour un tableau avec une colonne masquée

 (CELLSNET-44045) - Les méthodes Workbook.CalculateFormula restent bloquées pour une durée indéterminée

 (CELLSNET-44051) - Icônes de mise en forme conditionnelle manquantes dans le PDF

 (CELLSNET-44047) - Les pages sont agrandies dans le PDF de sortie
...
(CELLSNET-44049) - Les colonnes masquées perdent leur largeur
 ...
 (CELLSNET-44007) - Duplication d'objets de caméra dans la feuille de calcul résultante lors de la ré-enregistrement de XLSB

 (CELLSNET-44006) - Erreur de vue protégée lors de l'ouverture de XLS réenregistré
...
## **Exceptions**
 ...
 (CELLSNET-44052) - Une exception s'est produite sur Workbook.Save() lors de la conversion d'Excel en PDF
