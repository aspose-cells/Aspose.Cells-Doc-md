...
type: docs
weight: 40
url: /fr/net/aspose-cells-for-net-8-6-0-release-notes/
---
{{% alert color="primary" %}} 

 Cette page contient des notes de version pour[Aspose.Cells for .NET 8.6.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.0/)
...
## **Améliorations**
 ...
 (CELLSNET-43892) - La taille du document XLSX augmente à chaque enregistrement
...
(CELLSNET-43750) - Modifications du graphique dans la feuille de calcul résultante après l'actualisation du graphique
 ...
 (CELLSNET-43879) - caractères superposés et convertis en ######## dans Excel en rendu PDF
 ...
 (CELLSNET-41493) - Le texte est tronqué/enveloppé dans le PDF généré
...
(CELLSNET-43882) - PageSetup.Zoom a changé après l'ouverture et l'enregistrement du classeur
 ...
 (CELLSNET-43839) - Les images de la feuille de calcul ne s'affichent pas lors de la conversion au format PDF
...
## **Exceptions**
 ...
 (CELLSNET-43866) - CellsException lors du rendu d'une feuille de calcul au format PDF
...
(CELLSNET-43893) - CellsException lors du rendu d'une feuille de calcul au format PDF
 ...
 (CELLSNET-43865) - ArgumentException lors du rendu de la feuille de calcul au format PDF et HTML
