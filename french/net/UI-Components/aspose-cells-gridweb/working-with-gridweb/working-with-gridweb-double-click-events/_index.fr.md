---
title: Travailler avec les événements GridWeb Double Click
type: docs
weight: 80
url: /fr/net/working-with-gridweb-double-click-events/
---
{{% alert color="primary" %}} 
...
1.  Double-cliquez sur un événement dans le**Événements** liste dans le volet Propriétés.
