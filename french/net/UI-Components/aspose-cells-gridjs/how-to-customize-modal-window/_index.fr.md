...
type: docs
weight: 250
url: /fr/net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Cet article décrit comment personnaliser l apparence de l interface utilisateur pour la fenêtre modale dans GridJs.
keywords: GridJs,personnaliser,modale,UI,apparence,futur,fenêtre
aliases:
aliases:
...
# Guide de style de modale pour GridJs

## Table des matières

- [Vue d'ensemble](#overview)
- [Nomination des classes CSS](#css-class-naming)
...
## Nomination des classes CSS

### Noms de modale disponibles

| Type de modale | Nom | Classe CSS |
|------------|------|-----------|
| Tri | `tri` | `.x-spreadsheet-modal-tri` |
...
| Téléchargement | `download` | `.x-spreadsheet-modal-download` |
...
| Plus de formats de nombres | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
...
### Exemple 2 : Thème minimaliste et épuré 🤍
...
Idéal pour les applications avec support du mode sombre.
...
Convient pour les applications commerciales et professionnelles.
