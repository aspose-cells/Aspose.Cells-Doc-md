...
type: docs
weight: 250
url: /fr/net/aspose-cells-gridjs/how-to-customize-menus/
...
![todo: l'écran pour sélectionner le bouton d'inspect dans la barre d'outils](gridjs_hover_toolbar_button_inspect.png)

alors nous pouvons trouver la clé CSS associée à ce bouton :freeze
...
![todo: l'écran pour l'effet au survol du bouton de la barre d'outils](gridjs_hover_toolbar_button_hover.png)


## Personnaliser les éléments dans la barre inférieure

### Aperçu
La barre inférieure contient deux boutons interactifs :
1. &zwnj;**Bouton Ajouter Feuille**&zwnj; (`add` classe) - Crée de nouvelles feuilles
2. &zwnj;**Bouton Sélectionner Feuille**&zwnj; (`ellipsis` classe) - Gère la sélection de feuilles
...
Vous pouvez modifier l'événement de clic pour personnaliser la fonctionnalité :
```javascript
const addButton = document.querySelector('.x-spreadsheet-icon-img.add');
