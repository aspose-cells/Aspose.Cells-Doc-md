...
Aspose.Cells pour Python via Java prend en charge les fichiers ODS fonctionnels. Les exemples suivants illustrent la conversion d'Excel en fichier ODS.
### **Conversion directe**
