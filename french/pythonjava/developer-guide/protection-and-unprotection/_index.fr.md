...
type: docs
weight: 55
url: /fr/python-java/protect-and-unprotect/
description: Cet extrait présente comment chiffrer et déchiffrer des fichiers Excel, protéger et déprotéger les données dans des fichiers Excel en utilisant des codes Python.
---


{{% alert color="primary" %}}
Aspose.Cells for Python offre une large gamme de protection et de déprotection au niveau du fichier et des données, comme MS Excel :
{{% /alert %}}


## [**Encrypt and decrypt Excel files**](/cells/fr/python-java/encrypt-and-decrypt-excel-files/)
...
## [**Protect and unprotect workbook**](/cells/fr/python-java/protect-and-unprotect-workbook-structure/)
...
## [**Protect and unprotect worksheet**](/cells/fr/python-java/protect-and-unprotect-worksheet/)
