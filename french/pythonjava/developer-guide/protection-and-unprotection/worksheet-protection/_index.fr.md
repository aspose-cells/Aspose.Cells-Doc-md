...
type: docs
weight: 40
url: /fr/python-java/protect-and-unprotect-worksheet/
description: Protégez et déprotégez la feuille de calcul des fichiers Excel avec Aspose.Cells for Python via Java.
---
{{% alert color="primary" %}}
...
## **Protéger la feuille de travail à l'aide de Aspose.Cell for Python**
...
## **Déprotéger la feuille de calcul à l'aide de Aspose.Cell for Python**
