...
Microsoft Les fichiers Excel peuvent contenir de nombreux styles inutilisés. Lorsque ces fichiers sont exportés au format HTML, les styles inutilisés sont également exportés. Cela entraîne une augmentation de la taille de la sortie HTML. Aspose.Cells for Python via Java prend en charge l'exclusion de ces styles lors de la conversion du fichier Excel en HTML. Pour cela, le API fournit le[HtmlSaveOptions.ExcludeUnusedStyles](https://reference.aspose.com/cells/python/asposecells.api/htmlsaveoptions#ExcludeUnusedStyles)la propriété. Réglage de la valeur de[HtmlSaveOptions.ExcludeUnusedStyles](https://reference.aspose.com/cells/python/asposecells.api/htmlsaveoptions#ExcludeUnusedStyles) propriété à**Vrai** exclura tous les styles inutilisés de la sortie HTML.
