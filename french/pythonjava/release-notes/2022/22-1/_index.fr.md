---
title: Aspose.Cells pour Python via Java 22.1 Notes de mise à jour
type: docs
weight: 12
url: /fr/python-java/aspose-cells-for-python-via-java-22-1-release-notes/
---
{{% alert color="primary" %}}

 Cette page contient des notes de version pour[Aspose.Cells pour Python via Java 22.1](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-22.1/).
