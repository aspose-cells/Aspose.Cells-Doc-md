...
type: docs
weight: 40
url: /fr/python-java/evaluate-aspose-cells/
---
{{% alert color="primary" %}}

 Vous pouvez facilement télécharger Aspose.Cells pour évaluation à partir de[pypi](https://pypi.org/project/aspose-cells/). Le téléchargement de l'évaluation est le même que le téléchargement de la version complète : l'évaluation devient sous licence lorsque vous appliquez une licence.
