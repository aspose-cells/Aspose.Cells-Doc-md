---
title: Aspose.Cells pour Android via Java 19.9 Notes de version
type: docs
weight: 20
url: /fr/java/aspose-cells-for-android-via-java-19-9-release-notes/
---
{{% alert color="primary" %}} 

Cette page contient les notes de version pour Aspose.Cells pour Android via Java 19.9.
