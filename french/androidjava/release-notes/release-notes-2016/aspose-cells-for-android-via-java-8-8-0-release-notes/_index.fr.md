---
title: Aspose.Cells pour Android via Java 8.8.0 Notes de version
type: docs
weight: 40
url: /fr/java/aspose-cells-for-android-via-java-8-8-0-release-notes/
---
...
|CELLSJAVA-41743|Le titre graphique est manquant dans le PDF de sortie|Punaise|
...
|CELLSJAVA-41759|La mise en page est différente lors de l'enregistrement de la feuille de calcul au format HTML|Punaise|
|CELLSJAVA-41677|Un lien hypertexte pointant vers un nom défini entraîne un lien rompu lors de la conversion de la feuille de calcul en HTML|Punaise|
|CELLSJAVA-41774|Mauvais calcul sur l'analyse de simulation|Punaise|
|CELLSJAVA-41748|Le nom du mois russe s'affiche différemment en PDF par rapport à Excel|Punaise|
...
|CELLSJAVA-41777|Problème avec le fichier XLSB de sortie - Conversion XLS vers XLSB|Punaise|
...
|CELLSJAVA-41762|Chevauchement des étiquettes d'axe lors de la conversion d'une feuille de calcul en PDF|Punaise|
|CELLSJAVA-41752|Les étiquettes de données se chevauchent avec le graphique à secteurs lors du rendu au format PDF|Punaise|
...
|CELLSJAVA-41756|L'épaisseur des règles horizontales est supérieure à l'épaisseur du graphique réel lors du rendu au format PDF|Punaise|
|CELLSJAVA-41754|SmartArt n'est pas copié lors de la copie du classeur|Punaise|
|CELLSJAVA-41717|L'alignement vertical de la légende du graphique a changé lors de la conversion d'ODS en XLSX|Punaise|
|CELLSJAVA-41716|Le graphique est manquant lors de la conversion d'ODS en XLSX|Punaise|
|CELLSJAVA-41772|La conversion en HTML donne une page vide|Punaise|
|CELLSJAVA-41738|L'alignement vertical du texte dans une zone de texte change du milieu vers le haut lors du rendu de la feuille de calcul en image et PDF|Punaise|
...
|CELLSJAVA-41744|Texte mal aligné dans le PDF de sortie|Punaise|
|CELLSJAVA-41723|Aspose.Cells incompatibilité entre le PDF généré et le PDF généré par Excel de la même feuille de calcul|Punaise|
|CELLSJAVA-41802|Les étiquettes de coche de l'axe des catégories ne correspondent pas dans le PDF de sortie dans le rendu Excel vers PDF|Punaise|
|CELLSJAVA-41800|L'angle des étiquettes de graphique a changé dans le PDF du graphique|Punaise|
|CELLSJAVA-41798|L'entrée de légende est coupée lors de la conversion du graphique en PDF|Punaise|
|CELLSJAVA-41792|La barre de couleur rouge est manquante dans Excel mais s'affiche en PDF|Punaise|
...
|CELLSJAVA-41757|Des barres de valeurs positives apparaissent sous la règle de l'axe des x de valeur 0 dans le PDF du graphique|Punaise|
...
|CELLSJAVA-41746|java.lang.OutOfMemoryError : limite de temps système GC dépassée, lors de l'enregistrement de la feuille de calcul au format PDF|Exception|
...
Since the code base of Aspose.Cells for Android matches the code of relevant .NET and Java version, most of the changes, enhancements and fixes included in the Aspose.Cells for .NET v8.7.1, Aspose.Cells for .NET v8.7.2, Aspose.Cells for .NET v8.8.0, Aspose.Cells for Java v8 .7.1, Aspose.Cells for Java v8.7.2 et Aspose.Cells for Java v8.8.0 sont également inclus dans ce Aspose.Cells pour Android v8.8.0.
