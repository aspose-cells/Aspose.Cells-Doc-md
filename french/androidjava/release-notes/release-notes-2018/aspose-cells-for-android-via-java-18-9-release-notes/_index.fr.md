---
title: Aspose.Cells pour Android via Java 18.9 Notes de version
type: docs
weight: 20
...
Cette page contient les notes de version pour Aspose.Cells pour Android via Java 18.9.
...
Étant donné que la base de code de Aspose.Cells pour Android via Java correspond au code des versions .NET et Java pertinentes, la plupart des modifications, améliorations et correctifs inclus dans les versions Aspose.Cells for .NET v18.7, Aspose.Cells for .NET v18.8, 07161 9, Aspose.Cells for Java v18.7, Aspose.Cells for Java v18.8 et Aspose.Cells for Java v18.9 sont également inclus dans ce Aspose.Cells pour Android via Java v18.9.
