---
title: Aspose.Cells pour Android via Java 18.12 Notes de version
type: docs
weight: 10
url: /fr/java/aspose-cells-for-android-via-java-18-12-release-notes/
---
{{% alert color="primary" %}}

Cette page contient les notes de version pour Aspose.Cells pour Android via Java 18.12.
...
Étant donné que la base de code de Aspose.Cells pour Android via Java correspond au code des versions .NET et Java pertinentes, la plupart des modifications, améliorations et correctifs inclus dans les versions Aspose.Cells for .NET v18.10, Aspose.Cells for .NET v18.438481 12, Aspose.Cells for Java v18.10, Aspose.Cells for Java v18.11 et Aspose.Cells for Java v18.12 sont également inclus dans ce Aspose.Cells pour Android via Java v18.12.
