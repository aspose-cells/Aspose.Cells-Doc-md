...
Aspose.Cells pour Reporting Services propose un seul type d'édition. Les fonctionnalités sont résumées ci-dessous.

|**Fonctionnalités** |**Aspose.Cells pour les services de rapports** |
|:- |:- |
| Aspose.Cells.Report.Designer| Oui|
| Aspose.Cells. Moteur de rendu pour Reporting Services.| Oui|
