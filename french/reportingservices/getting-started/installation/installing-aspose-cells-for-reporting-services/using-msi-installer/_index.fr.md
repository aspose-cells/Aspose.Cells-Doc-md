---
title: Utilisation du programme d'installation MSI
type: docs
weight: 10
url: /fr/reportingservices/using-msi-installer/
---
{{% alert color="primary" %}} 
...
![tâche : image_autre_texte](using-msi-installer_4.png)
 ...
 La progression de l'installation s'affiche à l'écran.

![tâche : image_autre_texte](using-msi-installer_5.png)




1.  Une fois l'installation terminée, cliquez sur**Finir** pour fermer le programme d'installation.

![tâche : image_autre_texte](using-msi-installer_6.png)
