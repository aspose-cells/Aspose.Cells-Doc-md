...
---
 Aspose.Cells pour Reporting Services prend en charge trois types de chiffrement : XOR, WEAK ENCRYPTION et Microsoft Strong Cryptographic Provider. Consultez les informations de configuration du chiffrement dans le**Aspose.Cells.ReportingServices.xml** dossier.

 Lorsque la valeur de Chiffrement est**à l'arrêt**, Aspose.Cells pour Reporting Services désactive les fonctionnalités de chiffrement.
...
{{< /highlight >}}
 ...
 Lorsque la valeur de Chiffrement est**sur**, Aspose.Cells pour Reporting Services active le chiffrement.
