---
title: Customize initialization parameters for GridWeb client side script
type: docs
weight: 10
...
|copy_with_style| whether copy with style,the default value is false which means only copy cell content|
...
|needValidateall| whether need to validate all the validations on the active sheet  when do validation,(in aspx control page set ForceValidation="True") . the default value is false|
...
![todo:image_alt_text](align_true.png.png)
...
![todo:image_alt_text](focus_inside_true.png.png)
