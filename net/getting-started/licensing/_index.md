...
A new class [Metered](https://apireference.aspose.com/cells/net/aspose.cells/metered) has been introduced to apply metered key. Following is the sample code demonstrating how to set metered public and private key.
