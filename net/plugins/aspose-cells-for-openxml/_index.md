...
To open the project you need to download and install the latest version of Aspose.Cells for .NET from [here](https://downloads.aspose.com/cells/net) and include it in the project.
...
- [Code Comparison for common features with OpenXML](/cells/net/code-comparison-for-common-features-with-openxml/)
...
- [Missing Features in OpenXML](/cells/net/missing-features-in-openxml/)
