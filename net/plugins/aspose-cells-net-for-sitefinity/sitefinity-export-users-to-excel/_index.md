...
1. Fill the form fields as follows: 
   ...
   1. Add ~/Addons/Aspose.SiteFinity.ExportUsersToExcel/AsposeExportUsersToExcel.ascx
...
1. From the **Drag Widgets** menu on the right, select Aspose Export Users to Excel and drag it into position.
