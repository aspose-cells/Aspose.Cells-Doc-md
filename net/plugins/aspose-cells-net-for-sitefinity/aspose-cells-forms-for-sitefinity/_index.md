...
type: docs
weight: 10
url: /net/aspose-cells-forms-for-sitefinity/
---
...
1. Fill the form fields as follows: 
   1. Make sure **Enabled** is selected. 
      ...
      1. Add **Name**, **Title** and **Description** as follows: 
         ...
         1. Aspose **PageName** Form (like Aspose Edit Form , Aspose View Form , Aspose Export Form)
         1. **PageName** Form Builder & Exporter for Sitefinity.
      1. You may leave all other fields as they are.
      1. When finished, click **Save changes**.
      1. The widget is registered in the toolbox and can be used in Sitefinity. (**See** **below Image**)

|<p>![todo:image_alt_text](/download/thumbnails/5023902/814538895)</p><p></p>|
| :- |
...
1. Navigate to the page where you want to add the plugin. Make sure the page is opened in edit mode.
1. From the **Drag Widgets** menu on the right, select Aspose Edit/View/Export Form and drag it into position. (**See** **below Image** )
...
- Place **Aspose.Total.lic** file in **App_Data** folder of your Sitefinity website e.g. "Sitefinity Root Folder/App_Data/Aspose.Total.lic"
...
1. Click **Edit** button available near option label.
1. There are few pre-defined fields, you can edit/hide just by clicking **Edit** in grid.
1. You can create/delete/update new fields of any type **(TextBox, MultiLineTextBox, RadioButton, Checkboxes, DropdownList, Title, Success Message)**
#### **Dynamic Form Submit**
1. Fill in the fields.
1. Click **Submit** button to save data.
1. Each **Submit** button click will save new record in to excel.
#### **Export Saved Data**
...
1. Open Visual Studio 2013 and Choose **File** > **Open Project**
