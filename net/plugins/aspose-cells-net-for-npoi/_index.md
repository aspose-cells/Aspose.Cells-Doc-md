...
type: docs
weight: 50
url: /net/aspose-cells-net-for-npoi/
---
...
1. In order to ensure that you use the latest version with latest features we have not provided Aspose.Cells dll with source code or package therefore please add reference to Aspose.Cells.dll to your projects.
1. Click Debug on Visual Studio toolbar or F5 to run the example.

**Source code**

1. Depending upon your Visual Studio version, double click on one of the solution files 
   1. Aspose.Cells.Examples.2010.sln
   1. Aspose.Cells.Examples.2012.sln
   1. Aspose.Cells.Examples.2013.sln
1. In order to ensure that you use the latest version with latest features we have not provided Aspose.Cells dll with source code or package therefore please add reference to Aspose.Cells.dll to your projects.
1. One the solution is opened you can run any project by selecting the project and hitting F5.
1. The output document is saved in your **Bin -> Debug** folder for each project respectively.
### **Using**
...
1. Aspose.Cells Vs NPOI HWPF and XWPF v1.3 - 2012.sln
1. Aspose.Cells Vs NPOI HWPF and XWPF v1.3 - 2013.sln
...
- [Code Comparison for common features with NPOI](/cells/net/code-comparison-for-common-features-with-npoi-html/)
  - [Working with Data in NPOI and Aspose.Cells](/cells/net/working-with-data-in-npoi-and-aspose-cells-html/)
  ...
  - [Working With Formatting Features in NPOI and Aspose.Cells](/cells/net/working-with-formatting-features-in-npoi-and-aspose-cells-html/)
  ...
  - [Working with Workbooks in NPOI and Aspose.Cells](/cells/net/working-with-workbooks-in-npoi-and-aspose-cells-html/)
    - [Add Data in Cells](/cells/net/add-data-in-cells-html/)
    - [Create New Workbook](/cells/net/create-new-workbook-html/)
    - [Set Print Area](/cells/net/set-print-area-html/)
  - [Working With Worksheets in NPOI and Aspose.Cells](/cells/net/working-with-worksheets-in-npoi-and-aspose-cells-html/)
    - [Add Comment In Worksheet](/cells/net/add-comment-in-worksheet-html/)
    - [Add Image in Worksheet](/cells/net/add-image-in-worksheet-html/)
    - [Auto Fit Columns in Worksheet](/cells/net/auto-fit-columns-in-worksheet-html/)
    - [Copy Worksheet](/cells/net/copy-worksheet-html/)
    - [Create New Worksheet](/cells/net/create-new-worksheet-html/)
    - [Hiding Rows and Columns in Worksheet](/cells/net/hiding-rows-and-columns-in-worksheet-html/)
    - [Reorder Worksheets](/cells/net/reorder-worksheets-html/)
    - [Set Worksheet Zoom Factor](/cells/net/set-worksheet-zoom-factor-html/)
    - [Split Cells in Worksheet](/cells/net/split-cells-in-worksheet-html/)
    - [Working with Freeze Panes](/cells/net/working-with-freeze-panes-html/)
    - [Working with Headers and Footers](/cells/net/working-with-headers-and-footers-html/)
- [Missing Features in NPOI](/cells/net/missing-features-in-npoi-html/)
  - [Data Handling Features in Aspose.Cells](/cells/net/data-handling-features-in-aspose-cells-html/)
    - [Calculate Sub Totals](/cells/net/calculate-sub-totals-html/)
    - [Find Value in Cells](/cells/net/find-value-in-cells-html/)
    - [Formula Calculation Engine in Aspose.Cells](/cells/net/formula-calculation-engine-in-aspose-cells-html/)
  - [Miscellaneous Examples in Aspose.Cells](/cells/net/miscellaneous-examples-in-aspose-cells-html/)
    - [Convert Spreadsheet to PDF in Aspose.Cells](/cells/net/convert-spreadsheet-to-pdf-in-aspose-cells-html/)
    - [Printing Workbooks in Aspose.Cells](/cells/net/printing-workbooks-in-aspose-cells-html/)
    - [Set Print Titles](/cells/net/set-print-titles-html/)
  - [Working with Charts in Aspose.Cells](/cells/net/working-with-charts-in-aspose-cells-html/)
    - [Convert Chart to Images](/cells/net/convert-chart-to-images-html/)
    - [Create Charts](/cells/net/create-charts-html/)
  - [Working with Worksheets in Aspose.Cells](/cells/net/working-with-worksheets-in-aspose-cells-html/)
    - [Save Each Worksheet to Different PDF](/cells/net/save-each-worksheet-to-different-pdf-html/)
    - [Set Worksheet Tab Color in Aspose.Cells](/cells/net/set-worksheet-tab-color-in-aspose-cells-html/)
