...
The following sample code shows the usage of [HtmlSaveOptions.DisableDownlevelRevealedComments](https://apireference.aspose.com/net/cells/aspose.cells/htmlsaveoptions/properties/disabledownlevelrevealedcomments) property. The screenshot shows the effect of this property when it is not set to true. Please download the [sample Excel file](attachments/50266163/50528257.xlsx) used in this code and the [output HTML](attachments/50266163/50528258.zip) generated by it for a reference.
