...
This is the output PNG image after setting the **[ImageOrPrintOptions.DefaultFont](https://apireference.aspose.com/cells/net/aspose.cells.rendering/imageorprintoptions/properties/imageformat)** property to "Times New Roman".

![todo:image_alt_text](set-defaultfont-property-of-pdfsaveoptions-and-imageorprintoptions-to-have-priority_2.png)

See the output [TIFF](48496672.tiff) image after setting the **[ImageOrPrintOptions.DefaultFont](https://apireference.aspose.com/cells/net/aspose.cells.rendering/imageorprintoptions/properties/imageformat)** property to "Times New Roman".

See the output [PDF](48496673.pdf) file after setting the **[PdfSaveOptions.DefaultFont](https://apireference.aspose.com/cells/net/aspose.cells/pdfsaveoptions/properties/defaultfont)** property to "Times New Roman".
