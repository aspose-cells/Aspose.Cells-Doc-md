...
The following sample code loads the [sample Excel file](67338268.xlsx) with its individual or private set of fonts which are specified using the [IndividualFontConfigs](https://apireference.aspose.com/net/cells/aspose.cells/individualfontconfigs) class. Please see the [sample font](67338271.zip) used inside the code as well as the [output PDF](67338269.pdf) generated by it. The following screenshot shows how the output PDF looks if the font is found successfully.
