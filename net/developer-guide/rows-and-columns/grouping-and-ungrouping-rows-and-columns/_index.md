...
The [**Cells**](https://apireference.aspose.com/cells/net/aspose.cells/cells) collection provides several methods to manage rows or columns in a worksheet, few of these are discussed below in more detail.

### **Grouping Rows and Columns**

It is possible to group rows or columns by calling the [**GroupRows**](https://apireference.aspose.com/cells/net/aspose.cells/cells/methods/grouprows/index) and [**GroupColumns**](https://apireference.aspose.com/cells/net/aspose.cells/cells/methods/groupcolumns/index) methods of the [**Cells**](https://apireference.aspose.com/cells/net/aspose.cells/cells) collection. Both methods take the following parameters:
...
Developers can configure these group settings using the [**Outline**](https://apireference.aspose.com/cells/net/aspose.cells/worksheet/properties/outline) property of the [**Worksheet**](https://apireference.aspose.com/cells/net/aspose.cells/worksheet) class.
...
To ungroup any grouped rows or columns, call the [**Cells**](https://apireference.aspose.com/cells/net/aspose.cells/cells) collection's [**UngroupRows**](https://apireference.aspose.com/cells/net/aspose.cells/cells/methods/ungrouprows/index) and [**UngroupColumns**](https://apireference.aspose.com/cells/net/aspose.cells/cells/methods/ungroupcolumns) methods. Both methods take two parameters:
