...
Developers can show any hidden row or column by calling the [**UnhideRow**](https://apireference.aspose.com/cells/net/aspose.cells/cells/methods/unhiderow) and [**UnhideColumn**](https://apireference.aspose.com/cells/net/aspose.cells/cells/methods/unhidecolumn) methods of the [**Cells**](https://apireference.aspose.com/cells/net/aspose.cells/cells) collection respectively. Both methods take two parameters:
