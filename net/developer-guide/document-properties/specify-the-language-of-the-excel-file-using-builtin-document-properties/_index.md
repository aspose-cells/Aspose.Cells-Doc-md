...
The following sample code creates a workbook and changes its built-in document property named Language. Please see the [output Excel file](attachments/64456175/64716891.xlsx) generated by the code and screenshot that shows the modified Language field by [BuiltInDocumentPropertyCollection.Language](https://apireference.aspose.com/net/cells/aspose.cells.properties/builtindocumentpropertycollection/properties/language) property.

![todo:image_alt_text](specify-the-language-of-the-excel-file-using-builtin-document-properties_1.png)
## **Sample Code**
{{< gist "aspose-com-gists" "24a8eac23c3325e20dababecf735a43b" "DocumentProperties-SpecifyLanguageOfExcelFileUsingBuiltInDocumentProperties.cs" >}}
