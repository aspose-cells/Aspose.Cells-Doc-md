...
Aspose.Cells APIs have enhanced the [**Protection**](https://apireference.aspose.com/cells/net/aspose.cells/protection) class by introducing some useful properties & methods. One such method is the [**VerifyPassword**](https://apireference.aspose.com/cells/net/aspose.cells/protection/methods/verifypassword) which allows specifying a password as an instance of *string* and verifies if the same password has been used to protect the [**Worksheet**](https://apireference.aspose.com/cells/net/aspose.cells/worksheet).
