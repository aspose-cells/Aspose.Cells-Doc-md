...
The following sample code loads the [source Excel file](84378743.xlsx). It sets [TxtSaveOptions.KeepSeparatorsForBlankRow](https://apireference.aspose.com/net/cells/aspose.cells/txtsaveoptions/properties/keepseparatorsforblankrow) property to **true** and saves it as [output.csv](84378744.csv). The screenshot shows the comparison between the source Excel file, the default output generated while converting the spreadsheet to CSV and the output generated by setting [KeepSeparatorsForBlankRow](https://apireference.aspose.com/net/cells/aspose.cells/txtsaveoptions/properties/keepseparatorsforblankrow) to **true**.
