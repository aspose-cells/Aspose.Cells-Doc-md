...
The following code example demonstrates exporting active worksheet to Markdown by using [SaveFormat.Markdown](https://apireference.aspose.com/net/cells/aspose.cells/saveformat) enumeration member. Please see the [output Markdown file](attachments/5013525/89620482.md) generated by the code for reference.
