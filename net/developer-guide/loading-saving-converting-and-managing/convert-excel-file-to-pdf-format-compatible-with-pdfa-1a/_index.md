...
The following sample code explains how to convert Excel file to PDF format compatible with PDFA-1a. Please see its [output PDF](attachments/44860248/45056014.pdf) as well as the screenshot for a reference.
## **Screenshot**
