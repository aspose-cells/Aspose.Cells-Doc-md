...
When you don't need the default background color for comments, you may want to replace it with a color you're interested in, Aspose.Cells provides an API to do the job.
