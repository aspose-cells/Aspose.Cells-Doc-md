...
type: docs
weight: 140
url: /net/create-chart-pdf-with-desired-page-size/
---
...
Please see the following sample code that loads the [sample Excel file](attachments/64456036/64716906.xlsx), accesses the first chart inside the worksheet and then converts it into [output Pdf](attachments/64456036/64716907.pdf) with desired page size. The following screenshot shows that the page size in the output Pdf is 7x7 as specified inside the code and chart is center aligned both horizontally as well as vertically. 
