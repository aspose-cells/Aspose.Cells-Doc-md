...
type: docs
weight: 130
url: /net/add-filter-in-pivot-table/
...
When you create a pivot table with known data and want to filter the pivot table, you need to learn and use filter. It can help you filter out the data you want effectively. By using the Aspose.Cells API, you can add filter on field values in Pivot Tables. 
