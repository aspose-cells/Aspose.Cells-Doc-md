...
The following sample code illustrates how to export HTML string value of the cells to the DataTable while exporting data from worksheet into DataTable. Please see the [sample Excel file](attachments/44860284/45056025.xlsx), its screenshot and the console output for a reference.
## **Screenshot**
