...
The following code sample demonstrates the use of the [GetValidation](https://apireference.aspose.com/net/cells/aspose.cells/cell/methods/getvalidation) method by loading the [source ODS](attachments/101122972/101089354.ods) file and reading the validation of the cell A9.
#### **Sample Code**
{{< gist "aspose-com-gists" "922f990b02cf4e04a328bd6f37029af8" "Examples-CSharp-Worksheets-GetCellValidationInODS-1.cs" >}}
