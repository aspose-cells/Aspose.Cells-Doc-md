...
The following code sample demonstrates the use of the [GetValidation](https://apireference.aspose.com/net/cells/aspose.cells/cell/methods/getvalidation) method by loading the [source ODS](101089354.ods) file and reading the validation of the cell A9.
#### **Sample Code**
