...
type: docs
weight: 10
url: /net/aspose-cells-for-net-17-12-release-notes/
---
...
- [Text overflows from GridDesktop cell if it is too long](/cells/net/text-overflows-from-griddesktop-cell-if-it-is-too-long/)
