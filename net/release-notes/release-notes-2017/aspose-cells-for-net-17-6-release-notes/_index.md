...
type: docs
weight: 70
url: /net/aspose-cells-for-net-17-6-release-notes/
---
...
- [Using OnAjaxCallFinishedClientFunction of GridWeb](/cells/net/using-onajaxcallfinishedclientfunction-of-gridweb/)
...
- [Add GridWeb to Web Form](/cells/net/add-gridweb-to-web-form/)
- [Group Rows and Create Subtotal](/cells/net/group-rows-and-create-subtotal/)
