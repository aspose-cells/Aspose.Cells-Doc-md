...
toc : false
type: docs
url: /net/developerguide/knowledgebase/aspose.cells+and+competitors+performance+metrics+and+benchmarks/
---
...
*   1 [Benchmarking](#benchmarking)
    *   1.1 [Participating Components](#participating-components)
    *   1.2 [System Hardware](#system-hardware)
    *   1.3 [Testing Methodology](#testing-methodology)
    *   1.4 [Task Categories](#task-categories)
*   2 [Creating Microsoft Excel Files](#creating-microsoft-excel-files)
    *   2.1 [Scenario 1: Creating 50 XLS Files](#scenario-1:-creating-50-xls-files)
        *   2.1.1 [Results from Scenario 1](#results-from-scenario-1)
    *   2.2 [Scenario 2 - Create an XLS File](#scenario-2---create-an-xls-file)
        *   2.2.1 [Scenario 2 Results](#scenario-2-results)
    *   2.3 [Scenario 3 - Creating an XLS File](#scenario-3---creating-an-xls-file)
        *   2.3.1 [Scenario 3 Results](#scenario-3-results)
        *   2.3.2 [Results Chart](#results-chart)
*   3 [Reading/Updating existing Excel Files](#reading/updating-existing-excel-files)
    *   3.1 [Scenario 1 - Load a 10 MB XLS Template File](#scenario-1---load-a-10-mb-xls-template-file)
        *   3.1.1 [Scenario 1 Results](#scenario-1-results)
    *   3.2 [Scenario 2 - Load a 10 MB XLS Template File](#scenario-2---load-a-10-mb-xls-template-file)
        *   3.2.1 [Scenario 2 Results](#scenario-2-results)
    *   3.3 [Scenario 3 - Load a 10 MB XLS Template File](#scenario-3---load-a-10-mb-xls-template-file)
        *   3.3.1 [Scenario 3 Results](#scenario-3-results)
        *   3.3.2 [Result Chart](#result-chart)
