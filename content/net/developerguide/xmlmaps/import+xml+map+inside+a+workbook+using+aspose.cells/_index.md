...
toc : false
type: docs
url: /net/developerguide/xmlmaps/import+xml+map+inside+a+workbook+using+aspose.cells/
---
...
*   1 [Import XML Map using Microsoft Excel](#import-xml-map-using-microsoft-excel)
*   2 [Import XML Map using Aspose.Cells](#import-xml-map-using-aspose.cells)
{{< /panel >}}
 
