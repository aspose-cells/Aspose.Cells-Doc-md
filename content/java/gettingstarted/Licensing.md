...
*   1 [Evaluation Version Limitations](#Licensing-EvaluationVersionLimitations)
    *   1.1 [1st Limitation: Number of Opened Files](#Licensing-1stLimitation:NumberofOpenedFiles)
    *   1.2 [2nd Limitation: Worksheet with Evaluation Watermark](#Licensing-2ndLimitation:WorksheetwithEvaluationWatermark)
*   2 [Setting a License](#Licensing-SettingaLicense)
    *   2.1 [Example 1](#Licensing-Example1)
    *   2.2 [Example 2](#Licensing-Example2)
    *   2.3 [Notes on Applying a License in Aspose.Cells.GridWeb](#Licensing-NotesonApplyingaLicenseinAspose.Cells.GridWeb)
*   3 [Applying Metered License](#Licensing-ApplyingMeteredLicense)
*   4 [Validate the License](#Licensing-ValidatetheLicense)
{{< /panel >}}
 
