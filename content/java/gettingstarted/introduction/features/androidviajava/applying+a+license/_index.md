...
toc : false
type: docs
url: /java/gettingstarted/introduction/features/androidviajava/applying+a+license/
---

# Aspose.Cells for Java : Applying a License
...
In Aspose.Cells for Android via Java, the license can be [embedded as a resource](https://docs2.aspose.com/cells/java/gettingstarted/introduction/features/androidviajava/applying+a+license), or loaded from a stream:
