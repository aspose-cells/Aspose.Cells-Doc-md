...
toc : false
type: docs
url: /java/gettingstarted/introduction/why+not+automation/
---

# Aspose.Cells for Java : Why Not Automation
...
*   [Security](https://docs2.aspose.com/cells/java/gettingstarted/introduction/why+not+automation)
*   [Stability](https://docs2.aspose.com/cells/java/gettingstarted/introduction/why+not+automation)
*   [Scalability/Speed](https://docs2.aspose.com/cells/java/gettingstarted/introduction/why+not+automation)
*   [Price](https://docs2.aspose.com/cells/java/gettingstarted/introduction/why+not+automation)
*   [Features](https://docs2.aspose.com/cells/java/gettingstarted/introduction/why+not+automation)
...
![image](ri.png)This article has covered the key points on why Aspose components are a better choice than Office automation. All of the different Aspose components offer a risk-free, no-obligation [evaluation version](http://www.aspose.com/community/files/default.aspx). We encourage you to take advantage of that evaluation in order to better see what Aspose can do for your applications.
