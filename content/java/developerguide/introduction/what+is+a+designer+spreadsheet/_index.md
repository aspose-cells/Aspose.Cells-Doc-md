...
toc : false
type: docs
url: /java/developerguide/introduction/what+is+a+designer+spreadsheet/
---

# Aspose.Cells for Java : What is a Designer Spreadsheet
...
Additionally, Aspose.Cells lets you add [smart markers](https://docs2.aspose.com/cells/java/developerguide/smartmarkers/) to the designer spreadsheet. Smart markers are processed at runtime using the [`WorkbookDesigner`](http://www.aspose.com/api/java/cells/com.aspose.cells/classes/WorkbookDesigner) class's `Process` method. This can help you write less code and still get great result.

[Find out more about smart markers](https://docs2.aspose.com/cells/java/developerguide/smartmarkers/).

## Attachments:

![](https://docs2.aspose.com/cells/java/images/icons/bullet_blue.gif) [What is a Designer Spreadsheet-001.png](https://docs2.aspose.com/cells/java/attachments/5276266/5473261.png) (image/png)  
