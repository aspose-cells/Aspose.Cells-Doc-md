...
Aspose.Cells for Java : Working with GridWeb  
...
*   1 [Opening a Microsoft Excel File](#WorkingwithGridWeb-OpeningaMicrosoftExcelFile)
*   2 [Saving a Microsoft Excel File](#WorkingwithGridWeb-SavingaMicrosoftExcelFile)
    *   2.1 [Saving as a File](#WorkingwithGridWeb-SavingasaFile)
*   3 [Resizing Aspose.Cells.GridWeb and its Header Bar](#WorkingwithGridWeb-ResizingAspose.Cells.GridWebanditsHeaderBar)
    *   3.1 [Changing Width & Height of Aspose.Cells.GridWeb](#WorkingwithGridWeb-ChangingWidth&HeightofAspose.Cells.GridWeb)
    *   3.2 [Changing Width & Height of Header Bar](#WorkingwithGridWeb-ChangingWidth&HeightofHeaderBar)
*   4 [Working with Aspose.Cells.GridWeb Events](#WorkingwithGridWeb-WorkingwithAspose.Cells.GridWebEvents)
    *   4.1 [Introduction to Grid Events](#WorkingwithGridWeb-IntroductiontoGridEvents)
    *   4.2 [Handling Grid Events](#WorkingwithGridWeb-HandlingGridEvents)
*   5 [Working with Double Click Events](#WorkingwithGridWeb-WorkingwithDoubleClickEvents)
    *   5.1 [Enabling Double Click Events](#WorkingwithGridWeb-EnablingDoubleClickEvents)
    *   5.2 [Handling Double Click Events](#WorkingwithGridWeb-HandlingDoubleClickEvents)
        *   5.2.1 [Double Click Cell](#WorkingwithGridWeb-DoubleClickCell)
        *   5.2.2 [Double Click Column Header](#WorkingwithGridWeb-DoubleClickColumnHeader)
        *   5.2.3 [Double Click Row Header](#WorkingwithGridWeb-DoubleClickRowHeader)
*   6 [Setting Style or Appearance of Aspose.Cells.GridWeb](#WorkingwithGridWeb-SettingStyleorAppearanceofAspose.Cells.GridWeb)
    *   6.1 [Setting Style or Appearance of Aspose.Cells.GridWeb](#WorkingwithGridWeb-SettingStyleorAppearanceofAspose.Cells.GridWeb.1)
        *   6.1.1 [Preset Styles](#WorkingwithGridWeb-PresetStyles)
        *   6.1.2[  
{{< /panel >}}
        *   6.1.3[  
            Tab Bar Style](#WorkingwithGridWeb-TabBarStyle)
        *   6.1.4[  
            Loading Style File](#WorkingwithGridWeb-LoadingStyleFile)
        *   6.1.5 [Sample Custom Style Template](#WorkingwithGridWeb-SampleCustomStyleTemplate)
*   7 [Creating Control on a Web Form](#WorkingwithGridWeb-CreatingControlonaWebForm)
*   8 [Printing GridWeb](#WorkingwithGridWeb-PrintingGridWeb)
    *   8.1 [Printing GridWeb](#WorkingwithGridWeb-PrintingGridWeb.1)
    *   8.2 [Client Side Sample Code](#WorkingwithGridWeb-ClientSideSampleCode)
*   9 [Introduction to Different Grid Modes](#WorkingwithGridWeb-IntroductiontoDifferentGridModes)
    *   9.1 [Edit Mode](#WorkingwithGridWeb-EditMode)
    *   9.2 [Code Example](#WorkingwithGridWeb-CodeExample)
    *   9.3 [View Mode](#WorkingwithGridWeb-ViewMode)
    *   9.4 [Code Example](#WorkingwithGridWeb-CodeExample.1)
...
3.  Run the application or open the page.
...
SamplePageGridWebJavaSamplePageGridWebJava\\grid//Get acwclient directory from GridWeb latest release archive from Downloads sectionSamplePageGridWebJava\\acwclientSamplePageGridWebJava\\WEB-INFSamplePageGridWebJava\\WEB-INF\\lib//Get aspose-gridweb-x.x.x.jar file from GridWeb latest release archive from Downloads sectionSamplePageGridWebJava\\WEB-INF\\aspose-gridweb-x.x.x.jarSamplePageGridWebJava\\WEB-INF\\web.xmlSamplePageGridWebJava\\head.jsp//Create this excel file using Microsoft Excel or you can use any excel file and rename it SampleExcel.xlsxSamplePageGridWebJava\\SampleExcel.xlsxSamplePageGridWebJava\\SamplePage.jsp
...
<?xml version="1.0" encoding="UTF-8"?><web-app xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://java.sun.com/xml/ns/javaee" xmlns:web="http://java.sun.com/xml/ns/javaee/web-app\_2\_5.xsd" xsi:schemaLocation="http://java.sun.com/xml/ns/javaee http://java.sun.com/xml/ns/javaee/web-app\_2\_5.xsd" id="WebApp\_ID" version="2.5">  <display-name>testGridWeb</display-name>  <welcome-file-list>    <welcome-file>SamplePage.jsp</welcome-file>  </welcome-file-list>  <servlet>    <display-name>GridWebServlet</display-name>    <servlet-name>GridWebServlet</servlet-name>    <servlet-class>com.aspose.gridweb.GridWebServlet</servlet-class>  </servlet>  <servlet-mapping>    <servlet-name>GridWebServlet</servlet-name>    <url-pattern>/GridWebServlet</url-pattern>  </servlet-mapping></web-app>

**head.jsp**

<%String path = request.getContextPath();String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";%><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE9"/><base href="<%=basePath%>"><script type="text/javascript" language="javascript"	src="grid/acw\_client/acwmain.js"></script><script type="text/javascript" language="javascript"	src="grid/acw\_client/lang\_en.js"></script><link href="grid/acw\_client/menu.css" rel="stylesheet" type="text/css" /><style>span.acwxc {	overflow: hidden;	border: none;	display: block;	white-space: pre;}</style><style>span.rotation90 {	width: 100%;	height: 100%;	border: none;	-webkit-transform: rotate(-90deg);	-moz-transform: rotate(-90deg);	filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=3 );	display: block}</style><style>span.rotation-90 {	filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=1 );	width: 100%;	height: 100%;	border: none;	-webkit-transform: rotate(90deg);	-moz-transform: rotate(90deg);	display: block}</style><style>span.wrap {	white-space: pre-wrap;	white-space: -moz-pre-wrap;	white-space: -pre-wrap;	white-space: -o-pre-wrap;	word-wrap: break-word;	-ms-word-break: break-all;}</style>
