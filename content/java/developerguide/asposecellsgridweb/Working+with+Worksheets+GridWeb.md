...
*   1 [Accessing Worksheets](#WorkingwithWorksheetsGridWeb-AccessingWorksheets)
*   2 [Removing a Worksheet](#WorkingwithWorksheetsGridWeb-RemovingaWorksheet)
*   3 [Adding Worksheets](#WorkingwithWorksheetsGridWeb-AddingWorksheets)
    *   3.1 [Without Specifying Sheet Name](#WorkingwithWorksheetsGridWeb-WithoutSpecifyingSheetName)
    *   3.2 [With Specified Sheet Name](#WorkingwithWorksheetsGridWeb-WithSpecifiedSheetName)
*   4 [Renaming a Worksheet](#WorkingwithWorksheetsGridWeb-RenamingaWorksheet)
    *   4.1 [Renaming a Worksheet](#WorkingwithWorksheetsGridWeb-RenamingaWorksheet.1)
*   5 [Copying a Worksheet](#WorkingwithWorksheetsGridWeb-CopyingaWorksheet)
    *   5.1 [Using Sheet index](#WorkingwithWorksheetsGridWeb-UsingSheetindex)
    *   5.2 [Using Sheet Name](#WorkingwithWorksheetsGridWeb-UsingSheetName)
*   6 [Working with Named Ranges](#WorkingwithWorksheetsGridWeb-WorkingwithNamedRanges)
    *   6.1 [Adding/Referencing Named Ranges in Formulas](#WorkingwithWorksheetsGridWeb-Adding/ReferencingNamedRangesinFormulas)
*   7 [Managing Comments in Worksheet](#WorkingwithWorksheetsGridWeb-ManagingCommentsinWorksheet)
    *   7.1 [Working with Comments](#WorkingwithWorksheetsGridWeb-WorkingwithComments)
        *   7.1.1 [Adding Comments](#WorkingwithWorksheetsGridWeb-AddingComments)
        *   7.1.2 [Accessing Comments](#WorkingwithWorksheetsGridWeb-AccessingComments)
        *   7.1.3 [Removing Comments](#WorkingwithWorksheetsGridWeb-RemovingComments)
*   8 [Managing Hyperlinks in Worksheet](#WorkingwithWorksheetsGridWeb-ManagingHyperlinksinWorksheet)
    *   8.1 [Types of Hyperlinks](#WorkingwithWorksheetsGridWeb-TypesofHyperlinks)
        *   8.1.1 [Text URL Hyperlinks](#WorkingwithWorksheetsGridWeb-TextURLHyperlinks)
        *   8.1.2 [Image URL Hyperlinks](#WorkingwithWorksheetsGridWeb-ImageURLHyperlinks)
*   9 [Sorting Data](#WorkingwithWorksheetsGridWeb-SortingData)
    *   9.1 [From Top to Bottom](#WorkingwithWorksheetsGridWeb-FromToptoBottom)
    *   9.2 [From Left to Right](#WorkingwithWorksheetsGridWeb-FromLefttoRight)
*   10 [Searching and Replacing](#WorkingwithWorksheetsGridWeb-SearchingandReplacing)
    *   10.1 [The Find/Replace Dialog](#WorkingwithWorksheetsGridWeb-TheFind/ReplaceDialog)
    *   10.2 [Searching Options](#WorkingwithWorksheetsGridWeb-SearchingOptions)
    *   10.3 [Using Replace](#WorkingwithWorksheetsGridWeb-UsingReplace)
{{< /panel >}}
 
...
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472829.png)
...
For more details on how to access worksheets in Aspose.Cells.GridWeb, please refer to [Accessing Worksheets](https://docs2.aspose.com/cells/java/developerguide/asposecellsgridweb/working+with+worksheets+gridweb#workingwithworksheetsgridweb-accessingworksheets).
...
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472825.png)

After running the code, the worksheet is renamed Invoice.

**Output: the worksheet is renamed Invoice**  
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472824.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472805.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472380.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472379.png)
...
**Input: unsorted data**  
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472376.png)

After executing the code, the data is sorted in ascending order.

**Output: data sorted from top to bottom in ascending order**  
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472375.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472378.png)

After executing the code, data is sorted in ascending order.

**Output: data sorted from left to right in ascending order**  
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472387.png)
...
**Selecting Find**  
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472390.png)

A find and replace dialog is displayed.

**The Find/Replace dialog**  
![](https://docs2.aspose.com/cells/java/attachments/5276833/5472389.png)
