...
*   1 [Inserting Rows and Columns](#WorkingwithRowsandColumnsGridWeb-InsertingRowsandColumns)
    *   1.1 [Inserting Rows](#WorkingwithRowsandColumnsGridWeb-InsertingRows)
    *   1.2 [Inserting Columns](#WorkingwithRowsandColumnsGridWeb-InsertingColumns)
*   2 [Deleting Rows and Columns](#WorkingwithRowsandColumnsGridWeb-DeletingRowsandColumns)
    *   2.1 [Deleting Rows](#WorkingwithRowsandColumnsGridWeb-DeletingRows)
    *   2.2 [Deleting Columns](#WorkingwithRowsandColumnsGridWeb-DeletingColumns)
*   3 [Setting Row Height and Column Width](#WorkingwithRowsandColumnsGridWeb-SettingRowHeightandColumnWidth)
    *   3.1 [Working with Row Heights and Column Width](#WorkingwithRowsandColumnsGridWeb-WorkingwithRowHeightsandColumnWidth)
        *   3.1.1 [Setting Row Height](#WorkingwithRowsandColumnsGridWeb-SettingRowHeight)
        *   3.1.2 [Setting Column Width](#WorkingwithRowsandColumnsGridWeb-SettingColumnWidth)
*   4 [Customizing Row and Column Headers](#WorkingwithRowsandColumnsGridWeb-CustomizingRowandColumnHeaders)
    *   4.1 [Customizing Row Header](#WorkingwithRowsandColumnsGridWeb-CustomizingRowHeader)
    *   4.2 [Customizing Column Header](#WorkingwithRowsandColumnsGridWeb-CustomizingColumnHeader)
*   5 [Freeze and Unfreeze Rows and Columns](#WorkingwithRowsandColumnsGridWeb-FreezeandUnfreezeRowsandColumns)
    *   5.1 [Freezing Rows & Columns](#WorkingwithRowsandColumnsGridWeb-FreezingRows&Columns)
    *   5.2 [Unfreezing Rows & Columns](#WorkingwithRowsandColumnsGridWeb-UnfreezingRows&Columns)
*   6 [Protecting Rows and Columns](#WorkingwithRowsandColumnsGridWeb-ProtectingRowsandColumns)
    *   6.1 [Restricting Context Menu Options](#WorkingwithRowsandColumnsGridWeb-RestrictingContextMenuOptions)
{{< /panel >}}
 
