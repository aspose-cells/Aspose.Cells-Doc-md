...
*   1 [Accessing Cells in the Worksheet](#WorkingwithCellsGridWeb-AccessingCellsintheWorksheet)
    *   1.1 [Using Cell Name](#WorkingwithCellsGridWeb-UsingCellName)
    *   1.2 [Using Row & Column Indices](#WorkingwithCellsGridWeb-UsingRow&ColumnIndices)
*   2 [Accessing and Modifying the Value of a Cell](#WorkingwithCellsGridWeb-AccessingandModifyingtheValueofaCell)
    *   2.1 [Accessing & Modifying a Cell's Value](#WorkingwithCellsGridWeb-Accessing&ModifyingaCell'sValue)
        *   2.1.1 [String Values](#WorkingwithCellsGridWeb-StringValues)
        *   2.1.2 [All Types of Values](#WorkingwithCellsGridWeb-AllTypesofValues)
*   3 [Adding Formulas to the Cells](#WorkingwithCellsGridWeb-AddingFormulastotheCells)
    *   3.1 [How to Add & Calculate a Formula?](#WorkingwithCellsGridWeb-HowtoAdd&CalculateaFormula?)
    *   3.2 [Referencing Cells from Other Worksheets](#WorkingwithCellsGridWeb-ReferencingCellsfromOtherWorksheets)
*   4 [Create Data Validation in a GridCell of GridWeb](#WorkingwithCellsGridWeb-CreateDataValidationinaGridCellofGridWeb)
*   5 [Creating Custom Command Buttons](#WorkingwithCellsGridWeb-CreatingCustomCommandButtons)
    *   5.1 [Event Handling of Custom Command Button](#WorkingwithCellsGridWeb-EventHandlingofCustomCommandButton)
*   6 [Formatting cells for GridWeb](#WorkingwithCellsGridWeb-FormattingcellsforGridWeb)
    *   6.1 [Possible Usage Scenarios](#WorkingwithCellsGridWeb-PossibleUsageScenarios)
    *   6.2 [Enter Cell Data of GridWeb Worksheet in Percentage Format](#WorkingwithCellsGridWeb-EnterCellDataofGridWebWorksheetinPercentageFormat)
    *   6.3 [Sample Code](#WorkingwithCellsGridWeb-SampleCode)
{{< /panel >}}
 
...
*   [Accessing the cell by name](https://docs2.aspose.com/cells/java/developerguide/asposecellsgridweb/working+with+cells+gridweb).
*   [Accessing the cell by row and column indices](https://docs2.aspose.com/cells/java/developerguide/asposecellsgridweb/working+with+cells+gridweb).
...
[Accessing Cells in the Worksheet](https://docs2.aspose.com/cells/java/developerguide/asposecellsgridweb/working+with+cells+gridweb#workingwithcellsgridweb-accessingcellsintheworksheet) discussed accessing cells. This topic extends that discussion to show how to access and modify cell values using the GridWeb API.

### Accessing & Modifying a Cell's Value

#### String Values

Before accessing and modifying the value of a cell, you need to know how to access cells. For details about the different approaches for accessing cells, refer to [Accessing Cells in the Worksheet](https://docs2.aspose.com/cells/java/developerguide/asposecellsgridweb/working+with+cells+gridweb#workingwithcellsgridweb-accessingcellsintheworksheet).
