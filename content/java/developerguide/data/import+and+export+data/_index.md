...
toc : false
type: docs
url: /java/developerguide/data/import+and+export+data/
---
...
*   1 [Import Data into Worksheet](#import-data-into-worksheet)
    *   1.1 [Importing Data Using Aspose.Cells](#importing-data-using-aspose.cells)
        *   1.1.1 [Importing from Array](#importing-from-array)
        *   1.1.2 [Importing from Multi-dimensional Arrays](#importing-from-multi-dimensional-arrays)
        *   1.1.3 [Importing from an ArrayList](#importing-from-an-arraylist)
        *   1.1.4 [Importing from Custom Objects to merged area](#importing-from-custom-objects-to-merged-area)
        *   1.1.5 [Importing Data from JSON](#importing-data-from-json)
*   2 [Export Data from Worksheet](#export-data-from-worksheet)
    *   2.1 [Exporting Data Using Aspose.Cells - Exporting Data to Array](#exporting-data-using-aspose.cells---exporting-data-to-array)
        *   2.1.1 [Columns Containing Strongly Typed Data](#columns-containing-strongly-typed-data)
{{< /panel >}}
 
