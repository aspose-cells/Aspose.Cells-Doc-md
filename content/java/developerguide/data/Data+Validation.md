...
*   1 [Data Validation Types and Execution](#DataValidation-DataValidationTypesandExecution)
    ...
    *   1.2 [Data Validation with Aspose.Cells](#DataValidation-DataValidationwithAspose.Cells)
        ...
        *   1.2.2 [Programming Sample: Whole Number Data Validation](#DataValidation-ProgrammingSample:WholeNumberDataValidation)
        *   1.2.3 [Programming Sample: Decimal Data Validation](#DataValidation-ProgrammingSample:DecimalDataValidation)
        *   1.2.4 [Programming Sample: List Data Validation](#DataValidation-ProgrammingSample:ListDataValidation)
        *   1.2.5 [Programming Sample: Date Data Validation](#DataValidation-ProgrammingSample:DateDataValidation)
        *   1.2.6 [Programming Samples: Time Data Validation](#DataValidation-ProgrammingSamples:TimeDataValidation)
        *   1.2.7 [Programming Samples: Text Length Data Validation](#DataValidation-ProgrammingSamples:TextLengthDataValidation)
*   2 [Data Validation Rules](#DataValidation-DataValidationRules)
*   3 [Check if validation in a cell is dropdown](#DataValidation-Checkifvalidationinacellisdropdown)
*   4 [Add CellArea to existing Validation](#DataValidation-AddCellAreatoexistingValidation)
{{< /panel >}}
 
