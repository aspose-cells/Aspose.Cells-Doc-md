...
*   1 [Approaches to Format Data in Cells](#DataFormatting-ApproachestoFormatDatainCells)
    *   1.1 [Formatting Cells](#DataFormatting-FormattingCells)
        *   1.1.1 [Using the setStyle Method](#DataFormatting-UsingthesetStyleMethod)
        *   1.1.2 [Using the Style Object](#DataFormatting-UsingtheStyleObject)
        *   1.1.3 [Applying Gradient Fill Effects](#DataFormatting-ApplyingGradientFillEffects)
        *   1.1.4 [Code Example](#DataFormatting-CodeExample)
*   2 [Configuring Alignment Settings](#DataFormatting-ConfiguringAlignmentSettings)
    *   2.1 [Configuring Alignment Settings](#DataFormatting-ConfiguringAlignmentSettings.1)
        *   2.1.1 [Horizontal Alignment](#DataFormatting-HorizontalAlignment)
        *   2.1.2 [Vertical Alignment](#DataFormatting-VerticalAlignment)
    *   2.2 [Indentation](#DataFormatting-Indentation)
    *   2.3 [Orientation](#DataFormatting-Orientation)
    *   2.4 [Text Control](#DataFormatting-TextControl)
        *   2.4.1 [Wrapping Text](#DataFormatting-WrappingText)
        *   2.4.2 [Shrinking to Fit](#DataFormatting-ShrinkingtoFit)
        *   2.4.3 [Merging Cells](#DataFormatting-MergingCells)
    *   2.5 [Text Direction](#DataFormatting-TextDirection)
*   3 [Formatting Selected Characters in a Cell](#DataFormatting-FormattingSelectedCharactersinaCell)
    *   3.1 [Formatting Selected Characters](#DataFormatting-FormattingSelectedCharacters)
*   4 [Activating Sheets and Making an Active Cell or Select a Range of Cells in the Worksheet](#DataFormatting-ActivatingSheetsandMakinganActiveCellorSelectaRangeofCellsintheWorksheet)
    *   4.1 [Activating a Sheet and Making a Cell Active](#DataFormatting-ActivatingaSheetandMakingaCellActive)
        *   4.1.1 [Selecting a Range of Cells in the Worksheet](#DataFormatting-SelectingaRangeofCellsintheWorksheet)
*   5 [Formatting Rows and Columns](#DataFormatting-FormattingRowsandColumns)
    *   5.1 [Formatting Rows & Columns](#DataFormatting-FormattingRows&Columns)
        *   5.1.1 [Formatting a Row](#DataFormatting-FormattingaRow)
        *   5.1.2 [Formatting a Column](#DataFormatting-FormattingaColumn)
        *   5.1.3 [Setting Display Format of Numbers & Dates for Rows & Columns](#DataFormatting-SettingDisplayFormatofNumbers&DatesforRows&Columns)
{{< /panel >}}
 
...
**Applying Gradient Fill Effects**  
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472426.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472423.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472424.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472421.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472422.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472419.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472420.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472450.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472449.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472448.png)
...
**Formatting selected characters**  
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472447.png)
...
![](https://docs2.aspose.com/cells/java/attachments/5276212/5472425.png)
