...
toc : false
type: docs
url: /java/developerguide/data/working+with+hyperlinks+to+link+data/
---
...
*   1 [Adding Hyperlinks to Link Data](#adding-hyperlinks-to-link-data)
    *   1.1 [Adding Hyperlinks](#adding-hyperlinks)
        *   1.1.1 [Adding Link to a URL](#adding-link-to-a-url)
        *   1.1.2 [Adding a Link to a Cell in the Same File](#adding-a-link-to-a-cell-in-the-same-file)
        *   1.1.3 [Adding a Link to an External File](#adding-a-link-to-an-external-file)
{{< /panel >}}
 
