...
*   1 [Configuring Font Settings](#DealingwithFontSettings-ConfiguringFontSettings)
    ...
    *   1.4 [Setting Font Underline Type](#DealingwithFontSettings-SettingFontUnderlineType)
    *   1.5 [Setting Font Color](#DealingwithFontSettings-SettingFontColor)
    *   1.6 [Setting Strikeout Effect on Text](#DealingwithFontSettings-SettingStrikeoutEffectonText)
    *   1.7 [Setting Subscript](#DealingwithFontSettings-SettingSubscript)
    *   1.8 [Setting Superscript](#DealingwithFontSettings-SettingSuperscript)
{{< /panel >}}
 
...
![](https://docs2.aspose.com/cells/java/attachments/5276709/5473162.png)
