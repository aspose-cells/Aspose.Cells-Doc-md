...
*   1 [Creating a Named Range](#NamedRanges-CreatingaNamedRange)
    *   1.1 [Using Microsoft Excel](#NamedRanges-UsingMicrosoftExcel)
    *   1.2 [Using Aspose.Cells](#NamedRanges-UsingAspose.Cells)
        *   1.2.1 [Accessing All Named Ranges in a Spreadsheet](#NamedRanges-AccessingAllNamedRangesinaSpreadsheet)
        *   1.2.2 [Access a Specific Named Range](#NamedRanges-AccessaSpecificNamedRange)
        *   1.2.3 [Identify Cells in a Named Range](#NamedRanges-IdentifyCellsinaNamedRange)
        *   1.2.4 [Input Data into the Cells in the Named Range](#NamedRanges-InputDataintotheCellsintheNamedRange)
        *   1.2.5 [Format Ranges...Setting Background Color and Font Attributes to a Named Range](#NamedRanges-FormatRanges...SettingBackgroundColorandFontAttributestoaNamedRange)
        *   1.2.6 [Format Ranges...Adding Borders to a Named Range](#NamedRanges-FormatRanges...AddingBorderstoaNamedRange)
        *   1.2.7 [Apply style to cells in a Range](#NamedRanges-ApplystyletocellsinaRange)
        *   1.2.8 [Remove a Named Range](#NamedRanges-RemoveaNamedRange)
{{< /panel >}}
 
