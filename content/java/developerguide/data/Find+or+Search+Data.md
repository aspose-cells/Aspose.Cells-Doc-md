...
*   1 [Finding Cells that Contain Specific Data](#FindorSearchData-FindingCellsthatContainSpecificData)
*   2 [Finding Containing a Formula](#FindorSearchData-FindingContainingaFormula)
*   3 [Searching for Strings](#FindorSearchData-SearchingforStrings)
    *   3.1 [Searching for Strings that Start with Specific Characters](#FindorSearchData-SearchingforStringsthatStartwithSpecificCharacters)
    *   3.2 [Searching for Strings that End with Specific Characters](#FindorSearchData-SearchingforStringsthatEndwithSpecificCharacters)
*   4 [Searching with Regular Expressions: the RegEx Feature](#FindorSearchData-SearchingwithRegularExpressions:theRegExFeature)
{{< /panel >}}
 
