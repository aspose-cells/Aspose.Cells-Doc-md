...
*   1 [Merging Cells in a Worksheet.](#MergingandUnmergingCells-MergingCellsinaWorksheet.)
    *   1.1 [Using Microsoft Excel](#MergingandUnmergingCells-UsingMicrosoftExcel)
    *   1.2 [Using Aspose.Cells](#MergingandUnmergingCells-UsingAspose.Cells)
        *   1.2.1 [Code Example](#MergingandUnmergingCells-CodeExample)
*   2 [Unmerging (Splitting) Merged Cells](#MergingandUnmergingCells-Unmerging(Splitting)MergedCells)
    *   2.1 [Using Microsoft Excel](#MergingandUnmergingCells-UsingMicrosoftExcel.1)
    *   2.2 [Using Aspose.Cells](#MergingandUnmergingCells-UsingAspose.Cells.1)
        *   2.2.1 [Code Example](#MergingandUnmergingCells-CodeExample.1)
    *   2.3 [Related Articles](#MergingandUnmergingCells-RelatedArticles)
{{< /panel >}}
 
...
*   [Finding and splitting merged cells](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/managingrowscolumnsandcells/detect+merged+cells+in+a+worksheet).
*   [Merge and splitting a cell range using the Range.merge() and Range.unMerge() methods](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/managingrowscolumnsandcells/merge+or+unmerge+range+of+cells).
