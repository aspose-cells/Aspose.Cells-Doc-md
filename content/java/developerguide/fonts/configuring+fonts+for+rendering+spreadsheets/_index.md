...
toc : false
type: docs
url: /java/developerguide/fonts/configuring+fonts+for+rendering+spreadsheets/
---

# Aspose.Cells for Java : Configuring Fonts for Rendering Spreadsheets
...
2.  If API cannot find the fonts with the exact same name, it attempts to use the default font specified under the Workbook's [DefaultStyle.Font](https://apireference.aspose.com/java/cells/com.aspose.cells/style#Font) property.
3.  If API cannot locate the font defined under the workbook's [DefaultStyle.Font](https://apireference.aspose.com/java/cells/com.aspose.cells/style#Font) property, it attempts to select the most suitable fonts from all of the available fonts.
