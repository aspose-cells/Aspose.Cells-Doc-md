...
toc : false
type: docs
url: /java/developerguide/rowsandcolumns/inserting+and+deleting+rows+and+columns/
---
...
*   2 [Managing Rows/Columns](#managing-rows/columns)
    *   2.1 [Inserting a Row](#inserting-a-row)
    *   2.2 [Inserting Multiple Rows](#inserting-multiple-rows)
    *   2.3 [Insert a Row with Formatting](#insert-a-row-with-formatting)
    *   2.4 [Deleting a Row](#deleting-a-row)
    *   2.5 [Deleting Multiple Rows](#deleting-multiple-rows)
    *   2.6 [Inserting one or Multiple Columns](#inserting-one-or-multiple-columns)
    *   2.7 [Deleting a Column](#deleting-a-column)
{{< /panel >}}
 
