...
*   3 [Copying Rows and Columns with Aspose.Cells](#CopyingRowsandColumns-CopyingRowsandColumnswithAspose.Cells)
    *   3.1 [Copying Rows](#CopyingRowsandColumns-CopyingRows)
    *   3.2 [Copying Columns](#CopyingRowsandColumns-CopyingColumns)
    *   3.3 [Pasting Rows/Columns with Paste Options](#CopyingRowsandColumns-PastingRows/ColumnswithPasteOptions)
{{< /panel >}}
 
