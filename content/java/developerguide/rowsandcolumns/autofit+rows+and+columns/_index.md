...
toc : false
type: docs
url: /java/developerguide/rowsandcolumns/autofit+rows+and+columns/
---
...
*   1 [Auto Fitting](#auto-fitting)
    ...
    *   1.3 [AutoFit Column - Simple](#autofit-column---simple)
    *   1.4 [AutoFit Column in a Range of Cells](#autofit-column-in-a-range-of-cells)
    *   1.5 [AutoFit Rows for Merged Cells](#autofit-rows-for-merged-cells)
