...
toc : false
type: docs
url: /java/developerguide/migratingfromearliervs/public+api+changes+in+aspose.cells+8.5.2/
---

# Aspose.Cells for Java : Public API Changes in Aspose.Cells 8.5.2
...
### Enumeration Field ConsolidationFunction.DISTINCT\_COUNT Added
