...
toc : false
type: docs
url: /java/developerguide/migratingfromearliervs/public+api+changes+in+aspose.cells+8.1.0/
---

# Aspose.Cells for Java : Public API Changes in Aspose.Cells 8.1.0
...
Please check the detailed article on [Prevent Exporting Hidden Worksheet](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/rnd-prt/prevent+exporting+hidden+worksheet+contents+on+saving+to+html)
