...
toc : false
type: docs
url: /java/developerguide/migratingfromearliervs/public+api+changes+in+aspose.cells+8.5.1/
---

# Aspose.Cells for Java : Public API Changes in Aspose.Cells 8.5.1
...
Aspose.Cells for Java 8.5.1 has exposed the `Cell.getHeightOfValue` method to get the height of cell value. By using this method you can calculate height of the cell value and then set the height of the row of that cell respectively. Check the detailed article on [how to calculate the cell height & width](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/calculate+the+width+and+height+of+the+cell+value+in+unit+of+pixels).
