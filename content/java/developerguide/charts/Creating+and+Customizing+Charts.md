...
*   1 [Creating Charts](#CreatingandCustomizingCharts-CreatingCharts)
    ...
    *   1.2 [Creating a Simple Chart](#CreatingandCustomizingCharts-CreatingaSimpleChart)
        *   1.2.1 [Line with Data Marker Chart](#CreatingandCustomizingCharts-LinewithDataMarkerChart)
*   2 [Creating Custom Charts](#CreatingandCustomizingCharts-CreatingCustomCharts)
    *   2.1 [Creating Custom Charts](#CreatingandCustomizingCharts-CreatingCustomCharts.1)
{{< /panel >}}
 
