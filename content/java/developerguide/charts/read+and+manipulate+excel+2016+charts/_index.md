...
toc : false
type: docs
url: /java/developerguide/charts/read+and+manipulate+excel+2016+charts/
---

# Aspose.Cells for Java : Read and Manipulate Excel 2016 Charts
...
Here is the console output of the above sample code when executed with the provided [source excel file](https://docs2.aspose.com/cells/java/attachments/22970431/23166980.xlsx).
