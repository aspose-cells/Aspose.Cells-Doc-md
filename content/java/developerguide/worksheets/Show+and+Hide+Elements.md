...
*   1 [Show and Hide a Worksheet](#ShowandHideElements-ShowandHideaWorksheet)
    *   1.1 [Making a Worksheet Visible](#ShowandHideElements-MakingaWorksheetVisible)
    *   1.2 [Hiding a Worksheet](#ShowandHideElements-HidingaWorksheet)
*   2 [Show or Hide Tabs](#ShowandHideElements-ShoworHideTabs)
    *   2.1 [Hiding Tabs](#ShowandHideElements-HidingTabs)
    *   2.2 [Making Tabs Visible](#ShowandHideElements-MakingTabsVisible)
*   3 [Show and Hide Rows and Columns](#ShowandHideElements-ShowandHideRowsandColumns)
    *   3.1 [Hiding Row/Column Headers](#ShowandHideElements-HidingRow/ColumnHeaders)
    *   3.2 [Making Row/Column Headers Visible](#ShowandHideElements-MakingRow/ColumnHeadersVisible)
*   4 [Show and Hide Scroll Bars](#ShowandHideElements-ShowandHideScrollBars)
    *   4.1 [Hiding Scroll Bars](#ShowandHideElements-HidingScrollBars)
    *   4.2 [Making Scroll Bars Visible](#ShowandHideElements-MakingScrollBarsVisible)
*   5 [Show and Hide Gridlines](#ShowandHideElements-ShowandHideGridlines)
    *   5.1 [Controlling the Visibility of Gridlines](#ShowandHideElements-ControllingtheVisibilityofGridlines)
        *   5.1.1 [Making Gridlines Visible](#ShowandHideElements-MakingGridlinesVisible)
        *   5.1.2 [Hiding Gridlines](#ShowandHideElements-HidingGridlines)
    *   5.2 [Related Articles](#ShowandHideElements-RelatedArticles)
{{< /panel >}}
 
