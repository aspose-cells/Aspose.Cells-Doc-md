...
*   1 [Protect Worksheets](#ProtectandUnprotectWorksheet-ProtectWorksheets)
    *   1.1 [Adding or Removing Protection](#ProtectandUnprotectWorksheet-AddingorRemovingProtection)
    *   1.2 [Protecting a Few Cells](#ProtectandUnprotectWorksheet-ProtectingaFewCells)
    *   1.3 [Protect a Row in the Worksheet](#ProtectandUnprotectWorksheet-ProtectaRowintheWorksheet)
    *   1.4 [Protect a Column in the Worksheet](#ProtectandUnprotectWorksheet-ProtectaColumnintheWorksheet)
*   2 [Unprotect a Worksheet](#ProtectandUnprotectWorksheet-UnprotectaWorksheet)
    *   2.1 [Using Microsoft Excel](#ProtectandUnprotectWorksheet-UsingMicrosoftExcel)
    *   2.2 [Using Aspose.Cells](#ProtectandUnprotectWorksheet-UsingAspose.Cells)
    *   2.3 [Unprotecting a Simply Protected Worksheet](#ProtectandUnprotectWorksheet-UnprotectingaSimplyProtectedWorksheet)
    *   2.4 [Unprotecting a Password Protected Worksheet](#ProtectandUnprotectWorksheet-UnprotectingaPasswordProtectedWorksheet)
*   3 [Advanced Protection Settings since Excel XP](#ProtectandUnprotectWorksheet-AdvancedProtectionSettingssinceExcelXP)
    *   3.1 [Advanced Protection Settings Using Excel XP and Later Versions](#ProtectandUnprotectWorksheet-AdvancedProtectionSettingsUsingExcelXPandLaterVersions)
    *   3.2 [Advanced Protection Settings Using Aspose.Cells](#ProtectandUnprotectWorksheet-AdvancedProtectionSettingsUsingAspose.Cells)
    *   3.3 [Cell Locking Issue](#ProtectandUnprotectWorksheet-CellLockingIssue)
{{< /panel >}}
 
