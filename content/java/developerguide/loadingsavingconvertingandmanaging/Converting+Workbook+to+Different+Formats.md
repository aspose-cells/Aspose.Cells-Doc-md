...
*   1 [Converting Excel to XPS](#ConvertingWorkbooktoDifferentFormats-ConvertingExceltoXPS)
    *   1.1 [Converting single Worksheet to XPS](#ConvertingWorkbooktoDifferentFormats-ConvertingsingleWorksheettoXPS)
    *   1.2 [Export Whole Workbook to XPS](#ConvertingWorkbooktoDifferentFormats-ExportWholeWorkbooktoXPS)
    *   1.3 [Quick Excel to XPS Conversion](#ConvertingWorkbooktoDifferentFormats-QuickExceltoXPSConversion)
*   2 [Converting Excel to MHTML Files](#ConvertingWorkbooktoDifferentFormats-ConvertingExceltoMHTMLFiles)
*   3 [Converting to, and from, MHTML](#ConvertingWorkbooktoDifferentFormats-Convertingto,andfrom,MHTML)
*   4 [Converting Excel Files to HTML](#ConvertingWorkbooktoDifferentFormats-ConvertingExcelFilestoHTML)
    *   4.1 [Setting Image Preferences for HTML](#ConvertingWorkbooktoDifferentFormats-SettingImagePreferencesforHTML)
*   5 [Converting Excel to PDF Files](#ConvertingWorkbooktoDifferentFormats-ConvertingExceltoPDFFiles)
    *   5.1 [Converting Excel to PDF](#ConvertingWorkbooktoDifferentFormats-ConvertingExceltoPDF)
        *   5.1.1 [Direct Conversion](#ConvertingWorkbooktoDifferentFormats-DirectConversion)
        *   5.1.2 [Advanced Conversion](#ConvertingWorkbooktoDifferentFormats-AdvancedConversion)
            *   5.1.2.1 [Saving Excel Spreadsheets to PDF/A Complied Files](#ConvertingWorkbooktoDifferentFormats-SavingExcelSpreadsheetstoPDF/ACompliedFiles)
        *   5.1.3 [Conversion with Aspose.Pdf: Aspose.Cells Prior to 2.3.0](#ConvertingWorkbooktoDifferentFormats-ConversionwithAspose.Pdf:Aspose.CellsPriorto2.3.0)
        *   5.1.4 [Conversion Attributes](#ConvertingWorkbooktoDifferentFormats-ConversionAttributes)
{{< /panel >}}
 
...
|:----|:----|
|![](https://docs2.aspose.com/cells/java/attachments/5276167/5472417.png)|![](https://docs2.aspose.com/cells/java/attachments/5276167/5472418.png)|
{{< /table >}}
...
Microsoft Excel to PDF conversion was introduced with Aspose.Cells for Java 2.3.0. From that release, Aspose.Cells can [convert spreadsheets to PDF directly](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/converting+workbook+to+different+formats) (including [PDF/A](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/converting+workbook+to+different+formats)), without another product. To convert spreadsheets with older versions of Aspose.Cells, [use Aspose.PDF for the conversion](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/converting+workbook+to+different+formats).

Aspose.Cell's converts spreadsheets to PDF with a high degree of accuracy and fidelity. However, there are a few [limitations](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/converting+workbook+to+different+formats), listed at the end of this article.
