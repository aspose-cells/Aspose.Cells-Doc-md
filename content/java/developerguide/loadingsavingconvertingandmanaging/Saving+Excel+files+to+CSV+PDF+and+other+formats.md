...
*   1 [Different Ways to Save Your Files](#SavingExcelfilestoCSV,PDFandotherformats-DifferentWaystoSaveYourFiles)
*   2 [Saving File to Some Location](#SavingExcelfilestoCSV,PDFandotherformats-SavingFiletoSomeLocation)
*   3 [Saving Workbook to Text or CSV Format](#SavingExcelfilestoCSV,PDFandotherformats-SavingWorkbooktoTextorCSVFormat)
*   4 [Saving Text Files with Custom Separator](#SavingExcelfilestoCSV,PDFandotherformats-SavingTextFileswithCustomSeparator)
*   5 [Saving File to a Stream](#SavingExcelfilestoCSV,PDFandotherformats-SavingFiletoaStream)
*   6 [Saving File to Other Format](#SavingExcelfilestoCSV,PDFandotherformats-SavingFiletoOtherFormat)
    *   6.1 [XLS Files](#SavingExcelfilestoCSV,PDFandotherformats-XLSFiles)
    *   6.2 [XLSX Files](#SavingExcelfilestoCSV,PDFandotherformats-XLSXFiles)
    *   6.3 [PDF Files](#SavingExcelfilestoCSV,PDFandotherformats-PDFFiles)
        *   6.3.1 [Set ContentCopyForAccessibility option](#SavingExcelfilestoCSV,PDFandotherformats-SetContentCopyForAccessibilityoption)
        *   6.3.2 [Export Custom properties to PDF](#SavingExcelfilestoCSV,PDFandotherformats-ExportCustompropertiestoPDF)
*   7 [Convert Excel Workbook to Markdown](#SavingExcelfilestoCSV,PDFandotherformats-ConvertExcelWorkbooktoMarkdown)
{{< /panel >}}
 
