...
toc : false
type: docs
url: /java/developerguide/gridweb/clientsidescript/read+the+values+of+the+gridweb+cells+on+client+side/
---

# Aspose.Cells for Java : Read the values of the GridWeb cells on Client Side
...
![image](https://docs2.aspose.com/cells/java/attachments/46858777/47153165.png)
