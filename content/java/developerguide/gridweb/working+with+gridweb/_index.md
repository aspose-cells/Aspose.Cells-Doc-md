...
toc : false
type: docs
url: /java/developerguide/gridweb/working+with+gridweb/
---
...
*   1 [Opening a Microsoft Excel File](#opening-a-microsoft-excel-file)
*   2 [Saving a Microsoft Excel File](#saving-a-microsoft-excel-file)
    *   2.1 [Saving as a File](#saving-as-a-file)
*   3 [Resizing Aspose.Cells.GridWeb and its Header Bar](#resizing-aspose.cells.gridweb-and-its-header-bar)
    *   3.1 [Changing Width & Height of Aspose.Cells.GridWeb](#changing-width-&-height-of-aspose.cells.gridweb)
    *   3.2 [Changing Width & Height of Header Bar](#changing-width-&-height-of-header-bar)
*   4 [Working with Aspose.Cells.GridWeb Events](#working-with-aspose.cells.gridweb-events)
    *   4.1 [Introduction to Grid Events](#introduction-to-grid-events)
    *   4.2 [Handling Grid Events](#handling-grid-events)
*   5 [Working with Double Click Events](#working-with-double-click-events)
    *   5.1 [Enabling Double Click Events](#enabling-double-click-events)
    *   5.2 [Handling Double Click Events](#handling-double-click-events)
        *   5.2.1 [Double Click Cell](#double-click-cell)
        *   5.2.2 [Double Click Column Header](#double-click-column-header)
        *   5.2.3 [Double Click Row Header](#double-click-row-header)
*   6 [Setting Style or Appearance of Aspose.Cells.GridWeb](#setting-style-or-appearance-of-aspose.cells.gridweb)
    *   6.1 [Setting Style or Appearance of Aspose.Cells.GridWeb](#setting-style-or-appearance-of-aspose.cells.gridweb)
        *   6.1.1 [Preset Styles](#preset-styles)
{{< /panel >}}
        *   6.1.3[  
