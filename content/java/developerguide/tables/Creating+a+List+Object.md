...
*   1 [Advantages of a List Object](#CreatingaListObject-AdvantagesofaListObject)
    *   1.1 [Creating a List Object using Microsoft Excel](#CreatingaListObject-CreatingaListObjectusingMicrosoftExcel)
    *   1.2 [Using Aspose.Cells API](#CreatingaListObject-UsingAspose.CellsAPI)
{{< /panel >}}
 
