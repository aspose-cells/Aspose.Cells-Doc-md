...
*   1 [Possible Usage Scenarios](#ReadandWriteExternalConnectionofXLSBorXLSfile-PossibleUsageScenarios)
*   2 [Read and Write External Connection of XLSB/XLS file](#ReadandWriteExternalConnectionofXLSBorXLSfile-ReadandWriteExternalConnectionofXLSB/XLSfile)
*   3 [Sample Code](#ReadandWriteExternalConnectionofXLSBorXLSfile-SampleCode)
*   4 [Console Output](#ReadandWriteExternalConnectionofXLSBorXLSfile-ConsoleOutput)
{{< /panel >}}
 
