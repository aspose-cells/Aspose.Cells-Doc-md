...
Please check the detailed article on [Prevent Exporting Hidden Worksheet](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/renderingandprinting/prevent+exporting+hidden+worksheet+contents+on+saving+to+html)
