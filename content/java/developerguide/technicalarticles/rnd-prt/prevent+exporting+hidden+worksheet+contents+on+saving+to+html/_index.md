...
toc : false
type: docs
url: /java/developerguide/technicalarticles/rnd-prt/prevent+exporting+hidden+worksheet+contents+on+saving+to+html/
---

# Aspose.Cells for Java : Prevent Exporting Hidden Worksheet Contents on Saving to HTML
