...
*   [Copy a worksheet within a workbook](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/managingworkbooksandworksheets/copy+and+move+worksheets+within+and+between+workbooks).
*   [Move a worksheet within a workbook](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/managingworkbooksandworksheets/copy+and+move+worksheets+within+and+between+workbooks).
*   [Copy a worksheet between workbooks](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/managingworkbooksandworksheets/copy+and+move+worksheets+within+and+between+workbooks).
*   [Move a worksheet between workbooks](https://docs2.aspose.com/cells/java/developerguide/technicalarticles/managingworkbooksandworksheets/copy+and+move+worksheets+within+and+between+workbooks).
