...
toc : false
type: docs
url: /java/developerguide/technicalarticles/mngrowscolumnsandcells/populate+data+first+by+row+then+by+column/
---

# Aspose.Cells for Java : Populate Data First by Row then by Column
