...
toc : false
type: docs
url: /java/developerguide/technicalarticles/provide+exported+worksheet+html+file+path+via+ifilepathprovider+interface/
---

# Aspose.Cells for Java : Provide exported worksheet HTML file path via IFilePathProvider interface
...
![image](https://docs2.aspose.com/cells/java/attachments/5275789/5473418.png)
