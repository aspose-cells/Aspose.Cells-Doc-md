...
toc : false
type: docs
url: /java/developerguide/technicalarticles/mngworkbooksandworksheets/how+to+detect+a+file+format+and+check+if+the+file+is+encrypted/
---

# Aspose.Cells for Java : How to Detect a File Format and Check if the File is Encrypted
