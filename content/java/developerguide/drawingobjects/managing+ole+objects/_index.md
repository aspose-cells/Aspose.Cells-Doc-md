...
toc : false
type: docs
url: /java/developerguide/drawingobjects/managing+ole+objects/
---
...
*   2 [Inserting OLE Objects into a Worksheet](#inserting-ole-objects-into-a-worksheet)
*   3 [Extracting OLE Objects in the Workbook](#extracting-ole-objects-in-the-workbook)
*   4 [Extracting Embedded MOL File](#extracting-embedded-mol-file)
{{< /panel >}}
 
