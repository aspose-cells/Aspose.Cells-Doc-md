...
toc : false
type: docs
url: /java/developerguide/drawingobjects/access+and+modify+the+display+label+of+the+linked+ole+object/
---

# Aspose.Cells for Java : Access and Modify the Display Label of the Linked Ole Object
