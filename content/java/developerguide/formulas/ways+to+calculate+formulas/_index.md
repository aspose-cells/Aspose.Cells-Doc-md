...
toc : false
type: docs
url: /java/developerguide/formulas/ways+to+calculate+formulas/
---
...
*   1 [Adding Formulas & Calculating Results](#adding-formulas-&-calculating-results)
    *   1.1 [Important to Know](#important-to-know)
*   2 [Direct Calculation of Formula](#direct-calculation-of-formula)
*   3 [Calculating Formulas Once Only](#calculating-formulas-once-only)
{{< /panel >}}
 
