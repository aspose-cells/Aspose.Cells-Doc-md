...
toc : false
type: docs
url: /java/releasenotes/asposecellsforandroidviajava/2016/aspose.cells+for+android+via+java+8.9.0+release+notes/
---

# Aspose.Cells for Java : Aspose.Cells for Android via Java 8.9.0 Release Notes
...
|CELLSJAVA-41850|CellsException: Cell has been removed: D9 with MemorySetting.MEMORY\_PREFERENCE|Exception |
