...
toc : false
type: docs
url: /java/releasenotes/asposecellsforjava/java/2014/aspose.cells+for+java+8.0.0+release+notes/
---

# Aspose.Cells for Java : Aspose.Cells for Java 8.0.0 Release Notes


This page contains release notes for [Aspose.Cells for Java 8.0.0](http://www.aspose.com/downloads/cells/java/new-releases/aspose.cells-for-java-8.0.0/)
...
When building workbook with large cells data set, MemorySetting.MEMORY\_PREFERENCE option may optimize memory usage for cells data to decrease the memory cost.  
   
   
...
(CELLSJAVA-40585) - Apose.Cells: embedded sigma plot chart not rendered correctly to PDF/images  
(CELLSJAVA-40742) - Incorrect wrapping of Axis Labels when converting XLSX to PDF  
