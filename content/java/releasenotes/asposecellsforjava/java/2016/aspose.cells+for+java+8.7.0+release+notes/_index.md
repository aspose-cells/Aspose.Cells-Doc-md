...
toc : false
type: docs
url: /java/releasenotes/asposecellsforjava/java/2016/aspose.cells+for+java+8.7.0+release+notes/
---

# Aspose.Cells for Java : Aspose.Cells for Java 8.7.0 Release Notes


This page contains release notes for [Aspose.Cells for Java 8.7.0](http://www.aspose.com/downloads/cells/java/new-releases/aspose.cells-for-java-8.7.0/)
...
(CELLSJAVA-41686) - RenderingHints.VALUE\_TEXT\_ANTIALIAS\_GASP isn't taking effect while converting spreadsheet to HTML
