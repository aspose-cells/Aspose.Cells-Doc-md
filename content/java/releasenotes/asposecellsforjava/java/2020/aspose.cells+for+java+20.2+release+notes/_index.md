...
toc : false
type: docs
url: /java/releasenotes/asposecellsforjava/java/2020/aspose.cells+for+java+20.2+release+notes/
---

# Aspose.Cells for Java : Aspose.Cells for Java 20.2 Release Notes


This page contains release notes for Aspose.Cells for Java 20.2.
...
|CELLSJAVA-43123|ArrayIndexOutOfBoundsException while using MEMORY\_PREFERENCE|Exception|
