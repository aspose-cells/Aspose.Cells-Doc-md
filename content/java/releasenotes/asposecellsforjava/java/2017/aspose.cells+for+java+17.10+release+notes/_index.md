...
toc : false
type: docs
url: /java/releasenotes/asposecellsforjava/java/2017/aspose.cells+for+java+17.10+release+notes/
---

# Aspose.Cells for Java : Aspose.Cells for Java 17.10 Release Notes


This page contains release notes for [Aspose.Cells for Java 17.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.10/).
...
*   [Read and Write External Connection of XLSB file](https://docs.aspose.com/display/cellsjava/Read+and+Write+External+Connection+of+XLSB+file)
