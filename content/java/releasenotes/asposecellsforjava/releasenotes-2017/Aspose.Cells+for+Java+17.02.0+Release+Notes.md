...
1.  [AutoFit Columns and Rows while loading HTML in Workbook](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/autofit+columns+and+rows+while+loading+html+in+workbook)
...
4.  [Get Warnings while Loading Excel File](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/get+warnings+while+loading+excel+file)
...
6.  [Trim Leading Blank Rows and Columns while exporting spreadsheets to CSV format](https://docs2.aspose.com/cells/java/developerguide/loadingsavingconvertingandmanaging/trim+leading+blank+rows+and+columns+while+exporting+spreadsheets+to+csv+format)
