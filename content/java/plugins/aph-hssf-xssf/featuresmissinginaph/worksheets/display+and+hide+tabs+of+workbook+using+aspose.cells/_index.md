...
toc : false
type: docs
url: /java/plugins/aph-hssf-xssf/featuresmissinginaph/worksheets/display+and+hide+tabs+of+workbook+using+aspose.cells/
---

# Aspose.Cells for Java : Display and Hide Tabs of Workbook using Aspose.Cells
...
*   [GitHub](https://github.com/aspose-cells/Aspose.Cells-for-Java/tree/master/Plugins/Aspose_Cells_for_Apache_POI/src/main/java/com/aspose/cells/examples/asposefeatures/worksheets/AsposeDisplayAndHideTabs.java)
