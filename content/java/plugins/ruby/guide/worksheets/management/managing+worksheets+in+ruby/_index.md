...
toc : false
type: docs
url: /java/plugins/ruby/guide/worksheets/management/managing+worksheets+in+ruby/
---

# Aspose.Cells for Java : Managing Worksheets in Ruby
...
To add Worksheet to a new Excel file using **Aspose.Cells Java for Ruby**, simply call **add\_worksheet** method of **MangingWorksheets** module.
...
To access worksheet by sheet name using **Aspose.Cells Java for Ruby**, simply call **get\_worksheet** method of **MangingWorksheets** module.
...
To remove worksheet by sheet name using **Aspose.Cells Java for Ruby**, simply call **remove\_worksheet\_by\_name** method of **MangingWorksheets** module.
...
To remove worksheet by sheet index using **Aspose.Cells Java for Ruby**, simply call **remove\_worksheet\_by\_index** method of **MangingWorksheets** module.
