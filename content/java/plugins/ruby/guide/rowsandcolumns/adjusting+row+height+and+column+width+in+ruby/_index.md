...
toc : false
type: docs
url: /java/plugins/ruby/guide/rowsandcolumns/adjusting+row+height+and+column+width+in+ruby/
---

# Aspose.Cells for Java : Adjusting Row Height and Column Width in Ruby
