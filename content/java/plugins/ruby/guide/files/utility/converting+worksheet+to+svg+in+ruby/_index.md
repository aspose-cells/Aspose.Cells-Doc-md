...
toc : false
type: docs
url: /java/plugins/ruby/guide/files/utility/converting+worksheet+to+svg+in+ruby/
---

# Aspose.Cells for Java : Converting Worksheet to SVG in Ruby


## Aspose.Cells - Converting Worksheet to SVG

To convert Worksheet to SVG using Aspose.Cells for Java in Ruby, simply invoke worksheet\_to\_svg() method of Converter module.
