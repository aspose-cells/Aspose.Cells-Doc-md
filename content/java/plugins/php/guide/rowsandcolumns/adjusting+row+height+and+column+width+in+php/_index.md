...
toc : false
type: docs
url: /java/plugins/php/guide/rowsandcolumns/adjusting+row+height+and+column+width+in+php/
---

# Aspose.Cells for Java : Adjusting Row Height and Column Width in PHP
