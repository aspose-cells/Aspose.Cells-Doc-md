...
toc : false
type: docs
url: /java/plugins/php/guide/filesinphp/utility/managing+document+properties+in+php/
---

# Aspose.Cells for Java : Managing Document Properties in PHP


## Aspose.Cells - Adding Custom Properties

To add custom document properties using Aspose.Cells Java for PHP, call**add****\_custom\_property** method of the **Document** module.
