...
toc : false
type: docs
url: /java/plugins/php/guide/worksheets/security/unprotect+a+worksheet+in+php/
---

# Aspose.Cells for Java : Unprotect a Worksheet in Php


## Aspose.Cells - Unprotect a Worksheet

To protect worksheet using **Aspose.Cells Java for PHP**, call **unprotect\_worksheet** method of **protection** module.
