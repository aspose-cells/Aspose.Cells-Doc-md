...
toc : false
type: docs
url: /java/plugins/python/guide/rowsandcolumns/grouping+and+ungrouping+rows+and+columns+in+python/
---

# Aspose.Cells for Java : Grouping and Ungrouping Rows and Columns in Python
