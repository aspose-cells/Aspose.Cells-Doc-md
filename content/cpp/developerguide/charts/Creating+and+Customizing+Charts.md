...
Aspose.Cells for C++ : Creating and Customizing Charts  

# Aspose.Cells for C++ : Creating and Customizing Charts


{{< panel title="Contents Summary" style="primary" >}}
*   1 [Possible Usage Scenarios](#CreatingandCustomizingCharts-PossibleUsageScenarios)
*   2 [Pyramid Chart](#CreatingandCustomizingCharts-PyramidChart)
*   3 [Line Chart](#CreatingandCustomizingCharts-LineChart)
*   4 [Bubble Chart](#CreatingandCustomizingCharts-BubbleChart)
*   5 [Creating Custom Charts](#CreatingandCustomizingCharts-CreatingCustomCharts)
{{< /panel >}}
 
...
When the example code is executed, a pyramid chart is added to the worksheet. Please see the [output Excel file](https://docs2.aspose.com/cells/cpp/attachments/66257135/66519068.xlsx) of the following sample code.

## Line Chart

In the above example, simply changing the [ChartType](https://apireference.aspose.com/cpp/cells/namespace/aspose.cells.charts/#a2f17e69bcefc754569019185d0621b70) to [ChartType\_Line](https://apireference.aspose.com/cpp/cells/namespace/aspose.cells.charts/#a2f17e69bcefc754569019185d0621b70ad12ff1561ab1424a0c3095b6dc07ac25) creates a line chart. The complete source is provided below. when the code is executed, a line chart is added to the worksheet. Please see the [output Excel file](https://docs2.aspose.com/cells/cpp/attachments/66257135/66519069.xlsx) of the following sample code.

## Bubble Chart

In order to create a bubble chart, the [ChartType](https://apireference.aspose.com/cpp/cells/namespace/aspose.cells.charts/#a2f17e69bcefc754569019185d0621b70) has to be set to [ChartType\_Bubble](https://apireference.aspose.com/cpp/cells/namespace/aspose.cells.charts/#a2f17e69bcefc754569019185d0621b70a5efa533b454f9415e4497dbb2ab28b3d) and few extra properties such as [SetBubbleSizes](https://apireference.aspose.com/cpp/cells/class/aspose.cells.charts.i_series/#a00cf890ba7ab419d31a522ab52b02e9d) & [SetXValues](https://apireference.aspose.com/cpp/cells/class/aspose.cells.charts.i_series/#a788ff4aa51dbf9bed5327298af93a6db) need to be set accordingly. Upon executing the following code, a bubble chart is added to the worksheet. Please see the [output Excel file](https://docs2.aspose.com/cells/cpp/attachments/66257135/66519070.xlsx) of the following sample code.
