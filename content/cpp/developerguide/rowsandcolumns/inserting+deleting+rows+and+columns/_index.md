...
toc : false
type: docs
url: /cpp/developerguide/rowsandcolumns/inserting+deleting+rows+and+columns/
---
...
*   1 [Introduction](#introduction)
    *   1.1 [Managing Rows and Columns](#managing-rows-and-columns)
        *   1.1.1 [Insert a Row](#insert-a-row)
        *   1.1.2 [Inserting Multiple Rows](#inserting-multiple-rows)
        *   1.1.3 [Deleting Multiple Rows](#deleting-multiple-rows)
        *   1.1.4 [Insert a Column](#insert-a-column)
        *   1.1.5 [Delete a Column](#delete-a-column)
{{< /panel >}}
 
