...
*   1 [Possible Usage Scenarios](#ManipulatePivotTable-PossibleUsageScenarios)
*   2 [Manipulate Pivot Table](#ManipulatePivotTable-ManipulatePivotTable)
*   3 [Sample Code](#ManipulatePivotTable-SampleCode)
*   4 [Console Output](#ManipulatePivotTable-ConsoleOutput)
{{< /panel >}}
 
