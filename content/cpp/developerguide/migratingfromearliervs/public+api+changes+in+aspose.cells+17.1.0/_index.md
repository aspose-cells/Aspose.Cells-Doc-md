...
toc : false
type: docs
url: /cpp/developerguide/migratingfromearliervs/public+api+changes+in+aspose.cells+17.1.0/
---

# Aspose.Cells for C++ : Public API Changes in Aspose.Cells 17.1.0
...
Aspose.Cells for C++ now supports creation as well as the manipulation of the Named Ranges. The following code snippet demonstrates how simple is to use Aspose.Cells for C++ API to [create named ranges](https://docs2.aspose.com/cells/cpp/developerguide/data/create+named+range+in+a+workbook).
