...
*   1 [Possible Usage Scenarios](#ManipulateNamedRangeinaWorkbook-PossibleUsageScenarios)
*   2 [Manipulate Named Range in a Workbook](#ManipulateNamedRangeinaWorkbook-ManipulateNamedRangeinaWorkbook)
*   3 [Sample Code](#ManipulateNamedRangeinaWorkbook-SampleCode)
*   4 [Console Output](#ManipulateNamedRangeinaWorkbook-ConsoleOutput)
{{< /panel >}}
 
