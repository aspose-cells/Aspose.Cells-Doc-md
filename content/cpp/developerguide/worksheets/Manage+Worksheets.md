...
*   2 [Accessing Worksheets using Sheet Index](#ManageWorksheets-AccessingWorksheetsusingSheetIndex)
*   3 [Removing Worksheets using Sheet Index](#ManageWorksheets-RemovingWorksheetsusingSheetIndex)
{{< /panel >}}
 
