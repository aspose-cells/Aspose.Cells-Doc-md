...
toc : false
type: docs
url: /pythonjava/developerguide/convertingfiles/convert+excel+to+ods/
---
...
*   1 [Convert Excel to ODS](#convert-excel-to-ods)
    *   1.1 [Direct Conversion](#direct-conversion)
    *   1.2 [Save the ODS document in ODF 1.1 or 1.2 Specifications](#save-the-ods-document-in-odf-1.1-or-1.2-specifications)
{{< /panel >}}
 
