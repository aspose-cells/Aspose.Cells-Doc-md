...
1.  Click **Publish** ![image](https://docs2.aspose.com/cells/reportingservices/attachments/6094975/6193200.png) on the Aspose.Cells.Report.Designer toolbar and click the **Yes** button to save the report.  
      
    ![image](https://docs2.aspose.com/cells/reportingservices/attachments/6094975/6193185.png)  
      
    
2.  In the dialog box, enter the URL of the Report Server and click the **Refresh** button.  
      
    ![image](https://docs2.aspose.com/cells/reportingservices/attachments/6094975/6193186.png)
3.  Select a target folder and enter the report name. Click the **DataSource Setup** button to setup data sources.  
      
    ![image](https://docs2.aspose.com/cells/reportingservices/attachments/6094975/6193187.png)  
...
4.  In the dialog box, enter the data source information. Click **Select** to select the shared data sources. (If you require them, the shared data sources should be the report's prime data source). Click the **OK** button to complete the work.  
    ...
    ![image](https://docs2.aspose.com/cells/reportingservices/attachments/6094975/6193188.png)
5.  Click **Publish** to publish the report to Report Server.  
      
    ![image](https://docs2.aspose.com/cells/reportingservices/attachments/6094975/6193189.png)
