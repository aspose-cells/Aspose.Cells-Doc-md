...
*   [Set hide attributes for worksheet, rows and columns](https://docs2.aspose.com/cells/reportingservices/newfeatures/addhidefunctioninasposecellsforreportingservicesclient/set+hide+option+for+excel+row+column+and+sheet+using+dyn-hide+form).
