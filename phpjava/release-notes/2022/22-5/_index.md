...
type: docs
weight: 8
url: /php-java/aspose-cells-for-php-via-java-22-5-release-notes/
aliases: [/phpjava/aspose-cells-for-php-via-java-22-5-release-notes/]
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for PHP via Java 22.5](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.5/).
