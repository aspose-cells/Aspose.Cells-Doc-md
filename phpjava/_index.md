...
- [Aspose.Cells for PHP via Java Features](/phpjava/features/)
- [Aspose.Cells for PHP via Java Limitations and API Differences](/phpjava/limitations-and-api-differences/)
