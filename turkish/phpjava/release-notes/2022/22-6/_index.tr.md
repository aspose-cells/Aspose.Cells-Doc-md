...
{{% alert color="primary" %}}
 ...
 Bu sayfa için sürüm notları içerir[Aspose.Cells for PHP via Java 22.6](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.6/).
