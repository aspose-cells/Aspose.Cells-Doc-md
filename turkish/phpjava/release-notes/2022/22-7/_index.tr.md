---
title: Java 22.7 Sürüm Notları aracılığıyla PHP için Aspose.Cells
type: docs
weight: 6
url: /tr/php-java/aspose-cells-for-php-via-java-22-7-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Java 22.7 üzerinden PHP için Aspose.Cells](https://releases.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-22.7/).
