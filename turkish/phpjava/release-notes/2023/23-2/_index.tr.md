...
type: docs
weight: 11
url: /tr/php-java/aspose-cells-for-php-via-java-23-2-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Aspose.Cells for PHP via Java 23.2](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.2/).
