---
title: Java 21.12 Sürüm Notları aracılığıyla PHP için Aspose.Cells
type: docs
weight: 1
url: /tr/php-java/aspose-cells-for-php-via-java-21-12-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Java 21.12 üzerinden PHP için Aspose.Cells](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-21.12/).
