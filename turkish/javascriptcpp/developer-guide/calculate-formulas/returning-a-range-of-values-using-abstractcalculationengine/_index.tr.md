---
title: JavaScript ile C++ kullanarak AbstractCalculationEngine ile Bir Değer Aralığını Döndürme
...
description: Bu makale, Aspose.Cells kütüphanesini kullanarak JavaScript ile C++ kullanarak Excel de bir değer aralığını döndüren soyut hesaplama motorunu tanıtmaktadır. Bir Excel dosyasını yükleyin veya oluşturun ve değiştirilmiş dosyayı diske kaydedin.
keywords: Aspose.Cells, Excel, değer aralığını döndüren soyut hesaplama motoru, JavaScript ile C++, özel fonksiyonlar
type: docs
weight: 55
url: /tr/javascript-cpp/returning-a-range-of-values-using-abstractcalculationengine/
---

{{% alert color="primary" %}}

Aspose.Cells, Microsoft Excel tarafından desteklenmeyen kullanıcı tanımlı veya özel işlevleri uygulamak için kullanılan [**AbstractCalculationEngine**](https://reference.aspose.com/cells/javascript-cpp/abstractcalculationengine) sınıfını sağlar.

Bu makale, [**AbstractCalculationEngine**](https://reference.aspose.com/cells/javascript-cpp/abstractcalculationengine) aralığındaki değerlerin nasıl döndürüleceğini açıklayacaktır.

{{% /alert %}}

Aşağıdaki kod, [**AbstractCalculationEngine**](https://reference.aspose.com/cells/javascript-cpp/abstractcalculationengine) sınıfının kullanımını gösterir ve yöntemi aracılığıyla değer aralığını döndürür.

Bir sınıf oluşturun ve bir *calculateCustomFunction* fonksiyonu ekleyin. Bu sınıf [**AbstractCalculationEngine**](https://reference.aspose.com/cells/javascript-cpp/abstractcalculationengine) uygulamaktadır.
