...
type: docs
weight: 10
url: /tr/javascript-cpp/changing-the-layout-of-pivot-table/
description: Aspose.Cells for JavaScript kullanarak Pivot Tablo Düzenini Nasıl Değiştiririm?
keywords: Aspose.Cells for JavaScript kullanarak Excel, Excel JavaScript kütüphanesi, Pivot Tablo Düzenini Değiştirme
---
...
## **Aspose.Cells for JavaScript kullanarak Pivot Tablo Düzenini Nasıl Değiştiririm?**
Aspose.Cells for JavaScript kullanımı ile birlikte [**PivotTable.showInCompactForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInCompactForm--), [**PivotTable.showInOutlineForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInOutlineForm--) ve [**PivotTable.showInTabularForm()**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#showInTabularForm--) metodlarıyla, pivot tablonun düzenini bu üç biçimde değiştirebilirsiniz.
