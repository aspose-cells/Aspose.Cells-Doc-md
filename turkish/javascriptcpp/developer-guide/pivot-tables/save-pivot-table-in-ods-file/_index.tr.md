...
Aspose.Cells for JavaC++ ile betik, pivot tablosunu ODS dosyalarında kaydetme yeteneği sağlar. Bunun için, mevcut pivot tabloyu içeren bir çalışma kitabını dönüştürebilir veya yeni bir pivot tablo oluşturabilir ve dosyayı ODS formatında kaydedebilirsiniz. Kaydetmeden önce [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--)’ı çağırdığınızdan emin olun, böylece pivot tablonuz çıktı ODS dosyasında düzgün görüntülenir. Aşağıdaki kod parçası, pivot tabloyu ODS dosyasında kaydetmeyi gösterir.
