...
type: docs
weight: 20
url: /tr/javascript-cpp/create-pivot-tables-and-pivot-charts/
description: Aspose.Cells for JavaScript kullanarak Pivot Tablo ve Pivot Grafikler nasıl eklenir?
keywords: Aspose.Cells for JavaC++ Excel, Excel JavaScript kütüphanesi ile Pivot Tablo ve Pivot Grafik Ekleme Scripti.
---
...
Aspose.Cells for JavaScript C++ ile pivot tabloları ve pivot grafiklerini destekler (/cells/tr/javascript-cpp/create-pivot-tables-and-pivot-charts/) ve (/cells/tr/javascript-cpp/create-pivot-tables-and-pivot-charts/).

{{% /alert %}}

## **Aspose.Cells for JavaC++ kullanarak Pivot Tablolar ve Grafikler Ekle**

Aspose.Cells for JavaScript C++ ile özel bir sınıf seti sağlar, bu sınıflar pivot tablolar oluşturmak ve ayarlamak için kullanılır, bunlar PivotTable nesnelerini temel yapı blokları olarak kullanır:
...
### **Aspose.Cells for JavaScript C++ ile kullanmaya hazırlanın**
1. NPM’den Aspose.Cells for JavaScript C++’ı yükleyin, komut şu şekilde kullanılır:  $ npm install aspose.cells.node.
1. Ayrıca, geliştirme ortamınıza “Aspose.Cells for JavaScript C++” kurulumuyla ilgili adım adım talimatları takip edebilirsiniz.


### **C++ ile Aspose.Cells for JavaScript kullanarak Pivot Tablo Ekleme Yöntemleri**

C++ kullanarak pivot tablo oluşturmak için:
...
### **C++ Kütüphanesi kullanarak Pivot Grafik Ekleme Yöntemleri**

C++ kullanarak Pivot Grafik oluşturmak için:
