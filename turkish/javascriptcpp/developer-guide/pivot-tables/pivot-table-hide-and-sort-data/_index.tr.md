---
title: Özet Tablo Verilerini Gizleme ve Sıralama
type: docs
weight: 120
url: /tr/javascript-cpp/pivot-table-hide-and-sort-data/
---

## **Özet Tablo Verilerini Gizleme ve Sıralama**
Aspose.Cells for JavaC++ ile betik, pivot tablosundaki verileri gizleme ve sıralama desteği sağlar. Aşağıdaki kod parçası, Score sütununu azalan sırayla sıralayarak ve ardından 60'tan az bir skora sahip satırları gizleyerek bu özelliği gösterir.
