---
title: Excel çalışma kitabını Ods, Sxc ve Fods (OpenOffice / LibreOffice hesap tablosu) formatlarına dönüştürünüz via JavaScript
linktitle: Ods
type: docs
weight: 20
url: /tr/javascript-cpp/convert-excel-to-ods/
description: Excel dosyasını Ods (OpenOffice / LibreOffice hesap tablosu) olarak dönüştürmek veya Ods yi (OpenOffice / LibreOffice hesap tablosu) Excel e dönüştürmek için Aspose.Cells for JavaScript kullanarak nasıl yapacağınızı öğrenin.
---
...
Aspose.Cells for JavaScript, C++ aracılığıyla, OpenOffice / LibreOffice Calc tarafından desteklenen Ods, Sxc ve Fods dosyalarını yüklemeyi ve [Ods](book1.ods), [Sxc](book1.sxc) ve [Fods](book1.fods) dosyalarını Excel dosyalarına dönüştürmeyi destekler.
...
Aspose.Cells for JavaScript, C++ aracılığıyla, Excel dosyalarını Ods, Sxc ve Fods dosyalarına dönüştürmeyi destekler. Aşağıdaki kod örneği, [şablon](book1.xlsx) dosyasını Ods, Sxc ve Fods dosyalarına nasıl dönüştüreceğinizi gösterir.
...
## **Gelişmiş Konular**
- [ODS Dosyasını ODF 1.1 ve 1.2 Özelliklerine Kaydetme](/cells/tr/javascript-cpp/save-ods-file-in-odf-1-1-and-1-2-specifications/)
