---
title: Çıktı PDF ve görüntüdeki dizgi nasıl geçiş yapacağını JavaScript aracılığıyla C++ kullanarak belirtin
linktitle: Çıktı PDF ve görüntüde dizeyi nasıl geçeceğinizi belirtin
type: docs
weight: 120
url: /tr/javascript-cpp/specify-how-to-cross-string-in-output-pdf-and-image/
description: Çapraz türü belirterek çıktı PDF / Görüntüdeki metnin taşmasını kontrol etmeyi öğrenin, Aspose.Cells for JavaScript kullanarak C++.
---

## **Olası Kullanım Senaryoları**

Bir hücrede metin veya dize bulunuyorsa ve bu hücrenin genişliğinden büyükse, dizge taşar; eğer sonraki sütundaki hücre null veya boşsa. Excel dosyanızı PDF / Resim'e kaydederken, bu taşmayı [**TextCrossType**](https://reference.aspose.com/cells/javascript-cpp/textcrosstype) numaralandırmasını kullanarak çapraz türünü belirterek kontrol edebilirsiniz. Aşağıdaki değerlere sahiptir:
...
Aşağıdaki örnek kod, örnek Excel dosyasını yükler ve farklı [**TextCrossType**](https://reference.aspose.com/cells/javascript-cpp/textcrosstype) belirterek PDF/Görüntü formatına kaydeder. Örnek Excel dosyası ve çıktı dosyaları aşağıdaki linklerden indirilebilir:
