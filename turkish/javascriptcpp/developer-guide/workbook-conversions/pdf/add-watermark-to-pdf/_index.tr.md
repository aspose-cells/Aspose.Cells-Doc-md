---
title: JavaScript ile C++ kullanarak PDF ye Filigran Ekleme
linktitle: PDF ye Filigran Ekleme
type: docs
weight: 9
url: /tr/javascript-cpp/add-watermark-to-pdf/
description: Excel den PDF ye dönüştürürken PDF ye metin ve resim filigranı eklemeyi öğrenin Aspose.Cells for JavaScript ile C++ kullanarak.
---
...
PDF'ye metin filigranı eklemek için metni ve karşılık gelen yazı tipini belirtebilirsiniz. Ayrıca, hizalama, ofset, döndürme, opaklık, ön plan/arka plan ve sayfaya ölçek ayarlayabilirsiniz [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/) içindeki.
...
Bir PDF'ye görüntü filigranı eklemek için sadece görüntünün baytlarını belirtebilirsiniz. Ayrıca, hizalama, ofset, döndürme, opaklık, ön plan/arka plan ve sayfaya ölçek ayarlayabilirsiniz [RenderingWatermark](https://reference.aspose.com/cells/javascript-cpp/renderingwatermark/) içindeki.
