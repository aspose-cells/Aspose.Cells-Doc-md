---
title: JavaScript ile C++ üzerinden Çalışma Kitabı Görünümünü Kontrol Etme
linktitle: Çalışma Kitabı Görünümünü Kontrol Etme
type: docs
weight: 600
url: /tr/javascript-cpp/how-to-control-workbook-view/
description: C++ API aracılığıyla Aspose.Cells for JavaScript kullanarak Çalışma Kitabı Görünümünü nasıl kontrol edeceğinizi öğrenin.
keywords: JavaScript ile C++ kullanarak Çalışma Kitabı Görünümünü Kontrol Etme, Excel Görünümünü JavaScript ile C++ kullanarak ayarlama, Çalışma Kitabı Görünümünü JavaScript ile C++ kullanarak çalıştırma, Çalışma Kitabı Görünümünü JavaScript ile C++ kullanarak ayarlama, Excel Görünümünü JavaScript ile C++ kullanarak kontrol etme.
---

## **Olası Kullanım Senaryoları**
Excel sayfalarının görüntüsünü ayarlamanız gerektiğinde, yatay ve dikey kaydırıcılar gibi her modülü nasıl kontrol edeceğinizi, açık Excel dosyalarını gizleyip gizlemeyeceğinizi bilmeniz gerekir. Aspose.Cells for JavaScript ile C++ bu özelliği sunar. Aspose.Cells for JavaScript ile C++ aşağıdaki özellikler ve yöntemleri sağlar, böylece hedeflerinize ulaşmanıza yardımcı olur.
...
## **C++ ile Aspose.Cells for JavaScript kullanarak Çalışma Kitabı Görünümünü Nasıl Kontrol Edilir**
