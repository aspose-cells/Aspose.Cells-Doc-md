---
title: JavaScript ile XLS ve XLSX formatlarının desteklediği maksimum satır ve sütun sayısını bulunuz.
linktitle: XLS ve XLSX formatları tarafından desteklenen maksimum satır ve sütun sayısını bulun.
type: docs
weight: 20
url: /tr/javascript-cpp/find-maximum-rows-and-columns-supported-by-xls-and-xlsx-formats/
---

## **Olası Kullanım Senaryoları**  

Excel formatlarının desteklediği satır ve sütun sayıları farklıdır. Örneğin, XLS 65536 satır ve 256 sütun desteklerken, XLSX 1048576 satır ve 16384 sütun destekler. Belirli bir formatın kaç satır ve sütunu desteklediğini öğrenmek için [**WorkbookSettings.maxRow**](https://reference.aspose.com/cells/javascript-cpp/workbooksettings/#maxRow--) ve [**WorkbookSettings.maxColumn**](https://reference.aspose.com/cells/javascript-cpp/workbooksettings/#maxColumn--) özelliklerini kullanabilirsiniz.  

## **XLS ve XLSX formatları tarafından desteklenen maksimum satır ve sütun sayısını bulun.**  

Aşağıdaki örnek kod, ilk olarak XLS formatında, sonra XLSX formatında bir çalışma kitabı oluşturur. Oluşturulduktan sonra, [**WorkbookSettings.maxRow**](https://reference.aspose.com/cells/javascript-cpp/workbooksettings/#maxRow--) ve [**WorkbookSettings.maxColumn**](https://reference.aspose.com/cells/javascript-cpp/workbooksettings/#maxColumn--) özelliklerinin değerlerini yazdırır. Lütfen aşağıda verilen kodun konsol çıktılarına bakınız.  
