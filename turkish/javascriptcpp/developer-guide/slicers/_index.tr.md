...
type: docs
weight: 170
url: /tr/javascript-cpp/create-slicer/
description: C++ ile Excel dosyalarının dilimleyicilerini Aspose.Cells for JavaScript ile yönetin.
---

## **Olası Kullanım Senaryoları**

Bir dilimleyici verileri hızlıca filtrelemek için kullanılır. Bu, hem tablo hem de pivottable'da veri filtrelemek için kullanılabilir. Microsoft Excel, bir tablo veya pivottable seçip ardından *Insert > Slicer* tıklayarak dilimleyici oluşturmanıza izin verir. C++ ile Aspose.Cells for JavaScript kullanarak [**Worksheet.slicers.add()**](https://reference.aspose.com/cells/javascript-cpp/slicercollection/#add-pivottable-string-string-) metoduyla da dilimleyici oluşturabilirsiniz.

## **Pivot Tablosuna Dilimleyici Oluştur**

Lütfen aşağıdaki örnek kodu inceleyin. Bu, dilimleyici içeren örnek Excel dosyasını yükler (67338470.xlsx). Daha sonra ilk temel pivottan alanına göre dilimleyiciyi oluşturur. Son olarak, çalışma kitabını [çıktı XLSX](67338471.xlsx) ve [çıktı XLSB](67338472.xlsb) formatında kaydeder. Aşağıdaki ekran görüntüsü, C++ ile Aspose.Cells for JavaScript tarafından oluşturulan dilimleyiciyi gösterir.
