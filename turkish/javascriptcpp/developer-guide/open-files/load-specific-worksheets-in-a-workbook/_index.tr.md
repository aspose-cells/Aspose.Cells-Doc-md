---
title: JavaScript ve C++ ile Çalışma Kitabında Belirli Çalışma Sayfalarını Yükleyin
linktitle: Aşağıdaki örnek kod, örnek excel dosyasını grafikleri olmadan yükler ve çıktı PDF formatında kaydeder.
type: docs
weight: 100
url: /tr/javascript-cpp/load-specific-worksheets-in-a-workbook/
description: İşlem performansını artırmak ve bellek tüketimini azaltmak için Aspose.Cells for JavaScript ile belirli çalışma sayfalarını nasıl yükleyeceğinizi öğrenin.
---
