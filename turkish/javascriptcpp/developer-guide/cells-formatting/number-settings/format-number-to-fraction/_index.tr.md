...
type: docs
weight: 10
url: /tr/javascript-cpp/how-to-format-number-to-fraction/
description: Bu makale, Aspose.Cells for JavaScript C++ API kullanarak Kesir biçiminde sayı biçimlendirmeyi nasıl yapacağınızı tanıtacaktır.
...
## **Aspose.Cells for JavaScript C++ kullanarak Sayı Formatını Kesir olarak nasıl biçimlendirilir**
Aspose.Cells for JavaScript C++ ile sayıları kesir biçimine dönüştürme işlemi oldukça basittir. Aspose.Cells, JavaScript uygulamalarında Microsoft Excel yüklü olmadan Excel dosyalarıyla çalışmanıza olanak tanıyan güçlü bir kütüphanedir. Geniş özellikler yelpazesi içerir; bunlar arasında sayıların kesir biçimine getirilmesi de bulunur.

İşte, Aspose.Cells for JavaScript C++ kullanarak sayıları kesir biçimine dönüştürmek için adım adım bir kılavuz:
...
Bir hücreyi kesir olarak biçimlendirmek için, Style nesnesinin `number` özelliğini kullanarak belirli bir sayı biçimi kodu ayarlamanız gerekir. Aspose.Cells çeşitli kesir biçimlerini destekler, örneğin "1/2", "1/4", "2/4" vb.
...
- Style nesnesinin `custom` özelliği, tam kesir biçimini belirtmenize olanak tanır. Örneğin, `"# ??/???"` büyük ihtimalle üç basamağa kadar bölüme sahip kesirleri gösterebilir.
...
Bu adımları izleyerek, Aspose.Cells for JavaScript'i C++ üzerinden kullanarak sayıları kolayca kesir şeklinde biçimlendirebilirsiniz. Bu, finansal, istatistiksel veya eğitim uygulamalarında kesin kesir değerlerinin gerektiği durumlar için özellikle yararlı olabilir.
