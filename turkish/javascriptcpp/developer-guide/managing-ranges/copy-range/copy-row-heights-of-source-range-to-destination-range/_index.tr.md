---
title: JavaScript ile C++ aracılığıyla Kaynak Aralığın Satır Yüksekliklerini Hedef Aralığa Kopyala
linktitle: Kaynak Aralığın Satır Yüksekliklerini Hedef Aralığa Kopyala
type: docs
weight: 590
url: /tr/javascript-cpp/copy-row-heights-of-source-range-to-destination-range/
---

{{% alert color="primary" %}}

Bazen kullanıcılar, kaynak aralığın satır yüksekliklerini hedef aralığa kopyalamaları gerekir. Aspose.Cells for JavaScript via C++ bu amaçla [**PasteType.RowHeights**](https://reference.aspose.com/cells/javascript-cpp/pastetype/) enum sunar. [**PasteOptions.pasteType**](https://reference.aspose.com/cells/javascript-cpp/pasteoptions/#pasteType--) özelliği [**PasteType.RowHeights**](https://reference.aspose.com/cells/javascript-cpp/pastetype/) ile ayarlandığında, kaynak aralıktaki tüm satırların yüksekliği hedef aralığa kopyalanır.

{{% /alert %}}

 Aşağıdaki örnek kod, [**PasteType.RowHeights**](https://reference.aspose.com/cells/javascript-cpp/pastetype/) enumunu kullanarak kaynak aralığının satır yüksekliğini hedef aralığa nasıl kopyalayacağınızı gösterir. Bu kod tarafından oluşturulan çıktı Excel dosyasını Microsoft Excel’de açtığınızda, hedef aralık satır yüksekliği ile kaynak aralık satır yüksekliğinin birebir aynı olduğunu göreceksiniz.
