---
title: Bir Sayfada En Büyük Aralığı JavaScript kullanarak alın
linktitle: Çalışma sayfasındaki Maksimum Aralığı Al
type: docs
weight: 360
url: /tr/javascript-cpp/get-max-range-in-a-worksheet/
description: Bu makale, Aspose.Cells for JavaScript ile C++ kullanarak Excel dosyalarının maksimum aralığını, maksimum veri aralığını ve maksimum görüntüleme aralığını nasıl alınacağını açıklar.
---
...
Aspose.Cells for JavaScript ile C++ kullanarak bir sayfada maksimum aralığı bulma yöntemleri mevcut

{{% /alert %}}

## **Maksimum aralığı almak**
Aspose.Cells'te, [**row**](https://reference.aspose.com/cells/javascript-cpp/row/) ve [**column**](https://reference.aspose.com/cells/javascript-cpp/column/) nesneleri başlatılmışsa, bunlar boş satır veya sütunlar olmasa bile maksimum alan olarak sayılır.
