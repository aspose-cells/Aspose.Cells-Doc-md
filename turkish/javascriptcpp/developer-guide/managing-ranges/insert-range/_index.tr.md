---
title: JavaScript kullanarak C++ ile Aralıklar Ekleme
linktitle: Aralıkları Ekle
type: docs
weight: 105
url: /tr/javascript-cpp/insert-ranges-to-excel/
description: Excel e aralıklar ekleme ve diğer verileri kaydırma yöntemlerini Aspose.Cells for JavaScript kullanarak öğrenin.
---
...
## **C++ ile Aspose.Cells for JavaScript kullanarak Aralıklar Ekle**

C++ ile Aspose.Cells for JavaScript, [Cells.insertRange(CellArea, sayı, Shifttype, boolean)](https://reference.aspose.com/cells/javascript-cpp/cells/#insertRange-cellarea-number-shifttype-boolean-) metodunu sağlar, böylece aralık eklenebilir.
