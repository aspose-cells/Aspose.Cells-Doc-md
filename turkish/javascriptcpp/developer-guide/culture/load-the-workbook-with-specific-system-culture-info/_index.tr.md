---
title: Belirli Sistem Kültürü Bilgisi via JavaScript ve C++ kullanarak Çalışma Kitabını Yükleyin
linktitle: Belirli Sistem Kültür Bilgisiyle Çalışma Kitabı Yükle
type: docs
weight: 190
url: /tr/javascript-cpp/load-the-workbook-with-specific-system-culture-info/
---

## **Olası Kullanım Senaryoları**
Daha önce, belirli bir kültür biçiminde sayılar ve tarihleri yönetmek için tüm iş parçacığının kültür bilgisini değiştirmeniz gerekirdi, ancak artık Aspose.Cells for JavaScript C++ ile `LoadOptions.CultureInfo` özelliği sağlayarak tüm iş parçacığının kültür bilgisini değiştirmeden çalışma kitabınızı belirli kültür bilgisiyle yükleyebilirsiniz.
