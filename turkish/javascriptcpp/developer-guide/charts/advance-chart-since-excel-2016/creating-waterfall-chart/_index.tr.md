---
title: JavaScript ile su şelalesi grafiği nasıl oluşturulur (C++ aracılığıyla)
linktitle: Suş grafik nasıl oluşturulur
type: docs
weight: 160
url: /tr/javascript-cpp/creating-waterfall-chart/
description: Excel de JavaScript ve Aspose.Cells for JavaScript aracılığıyla su şelalesi grafikleri oluşturun.
keywords: Excel de JavaScript kullanarak su şelalesi grafiği oluşturma, C++ ile Excel de su şelalesi grafiği oluşturma, nasıl yapılır.
---
...
Aspose.Cells API’leri, çizgi grafiği yardımıyla su basma grafiği oluşturmayı sağlar. API ayrıca, [**Series.upBars**](https://reference.aspose.com/cells/javascript-cpp/series/#upBars--) ve [**Series.downBars**](https://reference.aspose.com/cells/javascript-cpp/series/#downBars--) özelliklerini ayarlayarak grafiğin şeklini değiştirme ve su basma şeklini verme özelliğine sahiptir.

 Aşağıda verilen kod parçası, C++ aracılığıyla Aspose.Cells for JavaScript kullanarak sıfırdan bir su şelalesi grafiği oluşturmayı gösterir.
