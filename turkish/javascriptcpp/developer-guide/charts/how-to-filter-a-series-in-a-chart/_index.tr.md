---
title: JavaScript ve C++ kullanarak Grafik Verileri Filtreleme için üç yöntem
linktitle: Grafik Verisini Filtreleme İçin Üç Yöntem
description: Excel’de grafiklerde filtreleme yapma yöntemlerini öğrenin. Aspose.Cells for JavaScript kullanarak. Kapsamlı rehberimiz, grafiklere filtre uygulama, grafik öğelerini özelleştirme ve veri analiz araçları kullanma ile daha iyi içgörüler ve bilinçli kararlar almanızı sağlayacak.
keywords: C++ ile Aspose.Cells for JavaScript, Excel’de grafiklerin filtrelenmesi, Veri Analizi, Karar Verme, Görselleştirme.
type: docs
weight: 2210
url: /tr/javascript-cpp/filtering-charts-in-excel/
---
...
Excel'de, belirli serileri grafikten çıkarabiliriz, bu da o serilerin grafikte gösterilmeyeceği anlamına gelir. Orijinal grafiği **Şekil 1**'de gösterilmiştir. Ancak, **Testserisi2** ve **Testserisi4**'ü filtrelediğimizde, grafik aşağıdaki gibi görünecektir, **Şekil 2**.
 ...
 C++ ile Aspose.Cells for JavaScript kullanarak, benzer bir işlemi gerçekleştirebiliriz. Bu [örnek](seriesFiltered.xlsx) dosyası için, **Testseries2** ve **Testseries4**'ü filtrelemek istiyorsak, aşağıdaki kodu çalıştırabiliriz. Ayrıca, tüm seçilen serileri depolamak için iki liste tutacağız: ([Chart.nSeries](https://reference.aspose.com/cells/javascript-cpp/chart/#nSeries--)) listesi.
