---
title: JavaScript kullanarak C++ ile Grafik Serisine Özel Etiketler Ekleme
linktitle: Grafiğin Serisinde Veri Noktalarına Özel Etiketler Ekleme
description: Grafik serisindeki veri noktalarına özel etiketler eklemeyi nasıl yapacağınızı öğrenin. Bu rehber, etiketlerin görünümünü, konumunu ve biçimini değiştirme ve verinizle doğru bağlantı kurma yollarını gösterecek.
keywords: Aspose.Cells for JavaScript kullanımıyla C++, grafik çizimi, özel etiketler, veri noktaları, seri, görünüm, konum, biçim, veri kaynağı, temsil.
type: docs
weight: 100
url: /tr/javascript-cpp/adding-custom-labels-to-data-points-in-the-series-of-the-chart/
---

{{% alert color="primary" %}}

Bir grafik serisinin veri noktalarına özel etiketler ekleyebilirsiniz. Aspose.Cells, bu özel etiketleri eklemek için [**DataLabels.text**](https://reference.aspose.com/cells/javascript-cpp/datalabels/#text--) özelliğini sağlar. Bu makale, bu özelliği veri noktalarının serisine özel etiketler eklemek için nasıl kullanacağınızı açıklayacaktır.
