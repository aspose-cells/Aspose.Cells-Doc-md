---
title: JavaScript ile Çizgili Pasta Grafik Oluşturma C++ ile
description: Microsoft Excel de lider çizgileri olan pasta grafiği oluşturmak için Aspose.Cells for JavaScript i C++ kullanarak nasıl kullanılacağını öğrenin. Kılavuzumuz, veri noktalarını legend’a bağlayan lider çizgilerini eklemeyi ve grafiğinizin genel netliğini artırmayı gösterecek.
keywords: Aspose.Cells for JavaScript ile C++, Pasta Grafiği, Lider Çizgileri, Microsoft Excel, Veri Görselleştirmesi, Grafik Özelleştirme.
linktitle: Pasta Grafiği
type: docs
weight: 45
url: /tr/javascript-cpp/creating-pie-chart-with-leader-lines/
---

{{% alert color="primary" %}}

Bu makale, C++ API kullanarak sıfırdan lider çizgili pasta grafiği oluşturma sürecini anlatır. Excel'de, 'Lider çizgilerini göster' seçeneği varsayılan olarak açıktır, bu yüzden Excel'de pasta grafiği oluşturduğunuzda lider çizgileri gösterilir. Ancak, Aspose.Cells API'leri ile benzer bir grafik oluştururken, [**Series.hasLeaderLines**](https://reference.aspose.com/cells/javascript-cpp/series/#hasLeaderLines--) özelliğini açıkça ayarlamanız gerekir.

{{% /alert %}}

İpucu çizgileri ile birlikte pasta grafik oluşturmada Aspose.Cells for JavaScript'in C++ API kullanımı göstermek için öncelikle yeni bir [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) oluşturacağız ve seri veri kaynağı olarak hizmet edecek bazı verileri gireceğiz. Veriler yerleştirildikten sonra, koleksiyona [**ChartType.Pie**](https://reference.aspose.com/cells/javascript-cpp/charttype) tipinde bir [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) ekleyeceğiz ve istenen grafik görünümünü elde etmek için farklı yönlerini ayarlayacağız.
...
## **Gelişmiş Konular**
- [Pasta Grafiğinde Özel Dilim veya Sektör Renkleri](/cells/tr/javascript-cpp/custom-slice-or-sector-colors-in-pie-chart/)
- [Bir Pasta-grafik veya Çubuk-grafikte Veri Noktalarının İkinci Pasta'nın veya Pasta'nın Çubuğu'nun Üzerinde Olup Olmadığını Bulma](/cells/tr/javascript-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/)

## İlgili Makaleler

- [Grafikler Oluşturma](/cells/tr/javascript-cpp/creating-charts/)
- [Grafikleri Özelleştirme](/cells/tr/javascript-cpp/customizing-charts/)
- [Grafiklerde Veri Biçimlendirme](/cells/tr/javascript-cpp/data-formatting-in-charts/)
