---
title: Ana ve İkincil Eksen ile JavaScript kullanarak C++
description: Aspose.Cells for JavaScript ile C++ kullanarak birincil ve ikincil eksenleri anlama ve üzerinde çalışma konusunda öğrenin. Kılavuzumuz, birincil ve ikincil eksenler arasındaki farkları anlamanıza ve bunları verimli şekilde yapılandırıp kullanmanıza yardımcı olacaktır.
keywords: Aspose.Cells for JavaScript ile C++, birincil eksenler, ikincil eksenler, anlama, farklar, yapılandırma, kullanım.
type: docs
weight: 190
url: /tr/javascript-cpp/primary-and-second-axis/
---
