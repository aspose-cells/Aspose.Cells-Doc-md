---
title: JavaScript ile C++ kullanarak Dinamik Grafikler Oluşturma
linktitle: Dinamik Grafikler Oluşturma
description: Aspose.Cells for JavaScript ile C++ kullanarak dinamik grafikler oluşturmayı öğrenin. Bu kılavuz, gereksinimlerinize göre grafikleri, serileri ve biçimlendirmeleri dinamik olarak nasıl güncelleyeceğinizi gösterecek ve veri değişikliklerini görsel olarak sunmanıza yardımcı olacaktır.
keywords: Aspose.Cells for JavaScript ile C++, grafik, dinamik grafikler, veri, seri, biçimlendirme, çalışma sayfaları, güncelleme.
type: docs
weight: 240
url: /tr/javascript-cpp/create-dynamic-charts/
---
...
Bu makale, yukarıdaki iki yöntemi kullanarak dinamik grafikler oluşturmak için Aspose.Cells for JavaScript ile C++ API'lerinin kullanımını gösterir.  
{{% /alert %}}  

## **Excel Tablolarını Kullanma**  

{{% alert color="primary" %}}  
Excel tabloları, Aspose.Cells perspektifinde ListObject olarak adlandırılır, bu nedenle "Tablo" yerine açıklık açısından "ListObject" terimini kullanacağız. Lütfen, [ListObject'ler oluşturma](/cells/tr/javascript-cpp/create-and-format-table/) konusunda detaylı bilgileri Aspose.Cells for JavaScript ile C++ kullanarak okuyun.  
{{% /alert %}}  

ListObject, kullanıcı etkileşimi üzerine sıralama ve filtreleme yapmak için yerleşik fonksiyonlar sağlar. Her iki sıralama ve filtreleme seçeneği, [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) başlık satırına otomatik olarak eklenen açılır listeler aracılığıyla sağlanır. Bu özellikler (sıralama ve filtreleme) nedeniyle, [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) dinamik grafik için veri kaynağı olarak mükemmel aday olur çünkü sıralama veya filtreleme değiştiğinde, grafikteki veri gösterimi güncellenecek ve [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject)nin mevcut durumunu yansıtacaktır.

Demoyu basit tutmak amacıyla, [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook)'ı sıfırdan oluşturacağız ve aşağıda belirtilen adımlarla ilerleyeceğiz.

1. Boş bir [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) oluşturun.
1. [**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) içinde ilk [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) in [**Cells**](https://reference.aspose.com/cells/javascript-cpp/cells) erişimi.
1. Hücrelere bazı veriler ekleyin.
1. Eklenen verilere dayanarak [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) oluşturun.
1. [**ListObject**](https://reference.aspose.com/cells/javascript-cpp/listobject) nin veri aralığına göre [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) oluşturun.
...
1. Önceki adımda oluşturulan Adlandırılmış Aralık kullanılarak [**ComboBox**](https://reference.aspose.com/cells/javascript-cpp/combobox) oluştur.
...
1. Önceki adımda oluşturulan aralığa göre [**Chart**](https://reference.aspose.com/cells/javascript-cpp/chart) oluştur.
1. Sonucu diske kaydedin.  
