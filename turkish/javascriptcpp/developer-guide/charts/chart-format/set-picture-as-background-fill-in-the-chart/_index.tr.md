---
title: Grafiklerde Arka Plan Doldurması olarak Resim Ayarlama (JavaScript ile C++ kullanarak)
linktitle: Grafiğe Arkaplan Dolgu Olarak Resim Ayarlama
description: Aspose.Cells for JavaScript ile C++ kullanarak bir grafikte arka plan doldurması olarak resim ayarlamayı öğrenin. Kılavuzumuz, resmi içe aktarma ve konumlandırma, boyut ve renk düzenleme, ve görünümünüzü geliştirmek için biçimlendirme seçenekleri uygulama adımlarını gösterecek.
keywords: Aspose.Cells for JavaScript ile C++, grafik, arka plan doldurma, resim, içe aktarma, konumlandırma, boyut, renk, biçimlendirme.
type: docs
weight: 30
url: /tr/javascript-cpp/set-picture-as-background-fill-in-the-chart/
---
...
Bunu başarmak için, Aspose.Cells [**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--) özelliğini sağlar. Aşağıdaki kod örneği, bir resmi bir grafikte arka plan olarak ayarlamak için [**Chart.plotArea**](https://reference.aspose.com/cells/javascript-cpp/chart/#plotArea--) özelliğini kullanımını göstermektedir.

## Grafiklerde arka plan doldurması ayarlamak için JavaScript kodu
