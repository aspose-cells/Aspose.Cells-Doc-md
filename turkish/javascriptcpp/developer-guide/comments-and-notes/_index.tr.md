---
title: Yardımcı kılavuzumuz, JavaScript ile C++ aracılığıyla Yorumlar ve Notlar ile yönetim sağlar
linktitle: Yorumlar ve Notlar
type: docs
weight: 128
url: /tr/javascript-cpp/comments-and-notes/
description: Aspose.Cells for JavaScript C++ ile yorumlar veya notlar ekleyin ve yönetin.
keywords: Yorumlar eklemek, notlar eklemek JavaScript C++ ile
---
...
Yorum eklemek için [**Comments**](https://reference.aspose.com/cells/javascript-cpp/commentcollection) koleksiyonunun [**CommentCollection.add(number, number)**](https://reference.aspose.com/cells/javascript-cpp/commentcollection/#add-number-number-) metodunu çağırın ({2} nesnesinde kapsüllenmiş). Yeni [**Comment**](https://reference.aspose.com/cells/javascript-cpp/comment) nesnesine, yorum dizinine geçerek erişilebilir. [**Comments**](https://reference.aspose.com/cells/javascript-cpp/commentcollection) nesnesine eriştikten sonra, yorumu özelleştirmek için [**note**](https://reference.aspose.com/cells/javascript-cpp/comment/#note--) özelliği kullanılır.
...
## **Gelişmiş Konular**
- [Yorumun Yazı Yönünü Değiştirme](/cells/tr/javascript-cpp/change-text-direction-of-the-comment/)
- [Yorum Yazı Tipi Rengini Nasıl Değiştirilir](/cells/tr/javascript-cpp/how-to-change-the-comment-font-color/)
- [Yorum arka planını nasıl ayarlarım](/cells/tr/javascript-cpp/how-to-set-comment-background/)
- [İz bırakan Yorumlar](/cells/tr/javascript-cpp/threaded-comments/)
