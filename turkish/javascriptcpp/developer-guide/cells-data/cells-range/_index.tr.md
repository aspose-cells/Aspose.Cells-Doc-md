...
type: docs
weight: 600
url: /tr/javascript-cpp/get-cells-range/
description: Aspose.Cells for JavaScript C++ API kullanarak Hücreler Aralığını Nasıl Alacağınızı Öğrenin.
...
Sayfa üzerinde sadece bazı verileri manipüle etmeniz gerekiyorsa, tüm sayfa veri aralığını bilmeniz gerekir. Aspose.Cells for JavaScript C++ bu özelliği sunar. Aspose.Cells for JavaScript C++ hedeflerinize ulaşmanıza yardımcı olacak aşağıdaki özellikler ve yöntemler sağlar.
...
## **Aspose.Cells for JavaScript C++ kullanarak Hücreler Aralığını Alın.**
Bu örnek aşağıdakileri göstermektedir:

1. Bir çalışma kitabı oluşturma.
1. İlk çalışma sayfasındaki hücrelere veri ekleme.
1. Hücreleri [**Range**](https://reference.aspose.com/cells/javascript-cpp/range) alın.
