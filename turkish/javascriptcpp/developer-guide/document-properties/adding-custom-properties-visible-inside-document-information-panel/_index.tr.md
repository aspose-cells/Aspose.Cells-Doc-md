---
title: Belge Bilgi Panelinde Görünen Özel Özellikler Eklemek JavaScript ve C++ ile
linktitle: Belge Bilgi Paneli içinde görülebilen Özel Özellikler eklemek
type: docs
weight: 300
url: /tr/javascript-cpp/adding-custom-properties-visible-inside-document-information-panel/
description: Bir çalışma kitabı nesnesine Aspose.Cells for JavaScript C++ kullanarak özel özellikler eklemeyi öğrenin. Bu özellikler Belge Bilgi Panelinde görüntülenebilir.
---
...
Lütfen belge bilgisi panelinde görünür olacak özelleştirilmiş özellik eklemek için [**ContentTypePropertyCollection.add(string, string)**](https://reference.aspose.com/cells/javascript-cpp/contenttypepropertycollection/#add-string-string-) yöntemini kullanın.
