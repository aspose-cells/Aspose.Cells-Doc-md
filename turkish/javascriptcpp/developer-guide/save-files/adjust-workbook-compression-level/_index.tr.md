---
title: JavaScript kullanarak C++ ile Çalışma Kitabı Sıkıştırma Düzeyini Ayarla
linktitle: Çalışma Kitabı Sıkıştırma Seviyesini Ayarla
type: docs
weight: 180
url: /tr/javascript-cpp/adjust-workbook-compression-level/
description: Aspose.Cells for JavaScript kullanarak çalışma kitabı sıkıştırma seviyesini ayarlamayı öğrenin.
---

## **Çalışma kitabının sıkıştırma seviyesini ayarlayın**

Geliştiriciler, daha büyük çalışma kitaplarıyla çalışırken çalışma kitabının sıkıştırma seviyesini ayarlayabilir. Geliştiriciler, daha küçük dosya boyutlarını işleme süresi yerine önceliklendirebilir veya tam tersini yapabilir. Aspose.Cells for JavaScript ile C++ kullanarak [**OoxmlCompressionType**](https://reference.aspose.com/cells/javascript-cpp/ooxmlcompressiontype) sıralaması ile çalışma kitabının sıkıştırma seviyesini ayarlayabilirsiniz. [**OoxmlCompressionType**](https://reference.aspose.com/cells/javascript-cpp/ooxmlcompressiontype) sıralaması aşağıdaki üyeleri sağlar.
...
Aşağıdaki kod parçacığı, [**OoxmlCompressionType**](https://reference.aspose.com/cells/javascript-cpp/ooxmlcompressiontype) numaralandırmasının kullanımını gösteriyor ve Düzey1, Düzey6 ve Düzey9 için dönüşüm süresini karşılaştırıyor. Oluşturulan dosyaların boyutlarını da karşılaştırabilirsiniz.  
