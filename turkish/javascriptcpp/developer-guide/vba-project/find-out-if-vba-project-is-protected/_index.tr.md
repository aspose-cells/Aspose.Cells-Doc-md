---
title: JavaScript kullanarak VBA Projesinin Korunup korunmadığını C++ ile öğrenin
linktitle: VBA Projesinin Korunup Korunmadığını Bul
type: docs
weight: 20
url: /tr/javascript-cpp/find-out-if-vba-project-is-protected/
---

## **JavaScript kullanarak VBA Projesinin Korunup korunmadığını öğrenin**

Excel dosyanızdaki VBA (Visual Basic Applications) Projesinin korunan olup olmadığını Aspose.Cells kullanarak [**VbaProject.isProtected()**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#isProtected--) özelliği ile öğrenebilirsiniz.
