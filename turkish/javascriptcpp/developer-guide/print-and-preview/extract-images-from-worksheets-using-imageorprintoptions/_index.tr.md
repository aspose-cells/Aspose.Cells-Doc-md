---
title: ImageOrPrintOptions kullanarak Çalışma Sayfalarından Resim Çekme JavaScript ile C++ üzerinden
linktitle: ImageOrPrintOptions kullanarak Çalışma Sayfalarından Görüntüleri Çıkarma
type: docs
weight: 140
url: /tr/javascript-cpp/extract-images-from-worksheets-using-imageorprintoptions/
description: Excel çalışma sayfalarından resim çıkarma ve kaydetme yöntemlerini Aspose.Cells for JavaScript kullanarak C++ üzerinden öğrenin.
---

{{% alert color="primary" %}} 

Microsoft Excel kullanıcıları tablolarına resim ekleyebilir. Aspose.Cells for JavaScript ile C++ üzerinden, Microsoft Excel dosyalarından resim okumak ve bunları yerel sürücüye kaydetmek mümkündür. Bu makale nasıl yapılacağını gösteriyor.
