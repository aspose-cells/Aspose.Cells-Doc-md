...
type: docs
weight: 100
url: /tr/javascript-cpp/export-equation/
---
...
Excel'de denklemleri LaTeX ifadeleri olarak dışa aktaracaksanız, [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) metodunu kullanabilirsiniz. 

Aşağıdaki örnek kod, [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) metodunun nasıl kullanılacağını ve üretilen sonuçların HTML'ye nasıl yerleştirileceğini gösterir:

### JavaScript'ten LaTeX'e
...
Eğer denklemleri MathML ifadeleri olarak dışa aktaracaksanız, [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) metodunu kullanabilirsiniz. 

Aşağıdaki örnek kod, [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) metodunun nasıl kullanılacağını ve üretilen sonuçların HTML'ye nasıl ekleneceğini gösterir:

### JavaScript'ten MathML'e
