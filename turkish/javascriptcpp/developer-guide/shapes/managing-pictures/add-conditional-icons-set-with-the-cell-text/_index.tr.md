---
title: Koşullu İkonlar Kümesi Ekleyerek Hücre Metni ile Kullanma JavaScript ile C++
linktitle: Hücre Metni ile Koşullu İkon Seti Ekle
type: docs
weight: 160
url: /tr/javascript-cpp/add-conditional-icons-set-with-the-cell-text/
description: Hücre metni yanına koşullu ikonlar nasıl eklenir Aspose.Cells for JavaScript kullanılarak C++ ile. Verilerin anlamını ikonlar aracılığıyla artırma.
---

{{% alert color="primary" %}} 

 Bazen, verileri okuyucular için daha anlamlı hale getirmek amacıyla hücredeki metin yanına koşullu ikonlar eklemek istersiniz. Koşullu biçimlendirme ikon türlerinden bazılarını kullanmak istiyorsunuz ancak hücrelere koşullu biçimlendirme uygulamadan. Aspose.Cells for JavaScript C++ ile bu özelliği destekler.
