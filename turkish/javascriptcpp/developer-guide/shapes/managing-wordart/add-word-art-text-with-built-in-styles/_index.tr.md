---
title: JavaScript kullanarak C++ ile yerleşik stillerle Kelime Sanatı Metni Ekle
linktitle: Dahili Stillerle Kelime Sanatı Metni Ekleyin
type: docs
weight: 270
url: /tr/javascript-cpp/add-word-art-text-with-built-in-styles/
description: Excel de yerleşik stil kullanarak görsel olarak çekici metinler oluşturmak için Aspose.Cells for JavaScript ile Kelime Sanatı Metni Ekleme öğrenin.
---

## **Olası Kullanım Senaryoları**
Bu amaçla [ShapeCollection.addWordArt()](https://reference.aspose.com/cells/javascript-cpp/shapecollection/#addWordArt-presetwordartstyle-string-number-number-number-number-number-number-) metodunu kullanın. Lütfen C++ ile Aspose.Cells for JavaScript kullanarak yerleşik stillerle Kelime Sanatı Metni ekleyebilirsiniz.
