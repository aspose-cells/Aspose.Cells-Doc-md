---
title: SmartArt ta metni JavaScript kullanarak C++ ile değiştir
linktitle: Akıllı sanatta metni değiştir
type: docs
weight: 1200
url: /tr/javascript-cpp/replace-text-in-smart-art/
description: C++ kullanarak Aspose.Cells for JavaScript ile smart art taki metni nasıl değiştireceğinizi öğrenin.
---

## **Olası Kullanım Senaryoları**  

Smart art, çalışma kitabındaki ana nesnelerden biridir. Çoğu zaman smart art'taki metni güncellemek gerekebilir. Aspose.Cells for JavaScript ile bu özellik [**Shape.text**](https://reference.aspose.com/cells/javascript-cpp/shape/#text--) özelliği ayarlayarak sağlanır.  
