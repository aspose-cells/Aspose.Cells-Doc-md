---
title: JavaScript kullanarak C++ ile Bir Ole Nesnesi olarak WAV dosyası ekleme
linktitle: Ole Nesnesi Olarak Bir WAV Dosyası Eklemek
type: docs
weight: 70
url: /tr/javascript-cpp/inserting-a-wav-file-as-an-ole-object/
description: C++ ile Aspose.Cells for JavaScript kullanarak Excel Çalışma Sayfalarına WAV dosyasını OLE nesnesi olarak nasıl ekleyeceğinizi öğrenin. 
---
