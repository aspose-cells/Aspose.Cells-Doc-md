---
title: JavaScript ve C++ kullanarak çalışma kitabından OLE Nesneleri çıkarın
linktitle: Çalışma Kitabından OLE Nesneleri Çıkarma
type: docs
weight: 110
url: /tr/javascript-cpp/extract-ole-objects-from-workbook/
---
...
Bu makale, JavaScript ve C++ kullanarak basit birkaç satır kodla çalışma kitabından farklı OLE nesneleri nasıl çıkarılacağını göstermektedir.
{{% /alert %}}
...
1. [Aspose.Cells for JavaScript'i C++ ile İndir](https://downloads.aspose.com/cells/javascript-cpp).  
...
Başlangıçta bir JavaScript ortamı başlatın ve yeni bir proje oluşturun. Bu örnek, tarayıcı tabanlı bir uygulamayı gösterecek, ancak herhangi bir JavaScript uyumlu ortamı da kullanabilirsiniz.

1. Bağımlılıkları Ekle  
   HTML sayfanıza C++ ile Aspose.Cells for JavaScript'i dahil edin ve bir Excel dosyasını seçip OLE nesnelerini çıkaracak basit bir kullanıcı arayüzü oluşturun:
