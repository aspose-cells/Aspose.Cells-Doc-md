---
title: JavaScript kullanarak Şeklin Ayar Değerlerini Değiştirin ve C++
linktitle: Şekil Ayar Değerlerini Değiştir
type: docs
weight: 2000
url: /tr/javascript-cpp/change-adjustment-values-of-the-shape/
description: Excel de şekillerin ayar değerlerini değiştirmeyi öğrenin, Aspose.Cells for JavaScript ile C++ kullanarak.
---

{{% alert color="primary" %}}  
Aspose.Cells, şekillerin ayar noktalarını değiştirmek için [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) özelliğini sağlar. Microsoft Excel arayüzünde, ayarlamalar sarı elmas düğme noktaları olarak görüntülenir. Örneğin:  
...
Bu makale, farklı şekillerin ayar değerini değiştirmek için [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) özelliğinin kullanımını açıklayacaktır.  
{{% /alert %}}  
