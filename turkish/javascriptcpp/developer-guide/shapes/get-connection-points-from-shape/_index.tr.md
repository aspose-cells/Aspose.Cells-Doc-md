---
title: Şekilden Bağlantı Noktalarını JavaScript ve C++ ile Alma
linktitle: Şekilden Bağlantı Noktalarını Al
type: docs
weight: 3500
url: /tr/javascript-cpp/get-connection-points-from-shape/
description: Excel de şekillerden bağlantı noktalarını alma işlemini Aspose.Cells for JavaScript kullanarak nasıl yapacağınızı öğrenin.
---

Aspose.Cells, çalışma sayfasındaki şekilleri yönetmek için zengin özellikler sunar. Bazen şekillerin hizalanması veya uygun yerlere yerleştirilmesi için bağlantı noktalarını almak gerekebilir. Bu amaçla, tüm bağlantı noktaları gereklidir. Aşağıdaki kod, [**Shape.connectionPoints**](https://reference.aspose.com/cells/javascript-cpp/shape/#connectionPoints--) özelliği kullanılarak bir şeklin bağlantı noktalarının listesini almanıza olanak tanır.
