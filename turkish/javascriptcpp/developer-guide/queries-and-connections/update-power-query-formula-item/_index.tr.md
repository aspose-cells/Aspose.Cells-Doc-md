---
title: Power Query Formül Öğesini JavaScript ile C++ kullanarak Güncelle
linktitle: Güç Sorgusu Formül Öğesini Güncelle
type: docs
weight: 120
url: /tr/javascript-cpp/update-power-query-formula-item/
description: C++ kullanarak Aspose.Cells for JavaScript ile bir Excel dosyasındaki Power Query Formülü öğesinin veri kaynağını nasıl güncelleyeceğinizi öğrenin.
---

## **Kullanım Senaryosu**

Veri kaynağı dosyalarının taşındığı ve Excel dosyasının dosyayı bulamadığı durumlar olabilir. Bu durumda, Aspose.Cells API, kaynak dosyanın konumunu güncellemek için [*PowerQueryFormulItem*](https://reference.aspose.com/cells/javascript-cpp/powerqueryformulaitem) sınıfını kullanma seçeneği sunar.

## **Power Query Formel Öğesi Güncelleme**

Aspose.Cells API, Power Query Formel Öğelerini güncelleme yeteneği sağlar. Aşağıdaki kod parçacığı, [**PowerQueryFormulaItem.value**](https://reference.aspose.com/cells/javascript-cpp/powerqueryformulaitem/#value--) özelliğini kullanarak Excel dosyasındaki veri kaynağı dosya konumunu güncellemeyi gösterir. Kaynak ve çıktı dosyaları referansınız için eklenmiştir.
