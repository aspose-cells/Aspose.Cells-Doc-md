---
title: Çalışma sayfasına JavaScript kullanarak C++ ile İmza satırı ekleyin
linktitle: Çalışma Sayfasına İmza Satırı Eklemek
type: docs
weight: 200
url: /tr/javascript-cpp/add-signature-line/
description: Bu makale, Aspose.Cells for JavaScript kullanılarak JavaScript kodlarıyla çalışma sayfasına imza satırı eklemeyi anlatmaktadır.
keywords: JavaScript kullanarak C++ ile Çalışma sayfasına İmza satırı ekleme, JavaScript ile Çalışma sayfasına İmza satırı ekleme nasıl yapılır, JavaScript ile Çalışma sayfasına imza satırı nasıl eklenir.
---

## **Giriş**

Aspose.Cells, çalışma sayfasına imza satırı eklemek için [**Picture.signatureLine**](https://reference.aspose.com/cells/javascript-cpp/picture/#signatureLine--) özelliğini sağlar.

## **Çalışma Sayfasına İmza Çizgisi Eklemek**

Aşağıdaki örnek kod, [**Picture.signatureLine**](https://reference.aspose.com/cells/javascript-cpp/picture/#signatureLine--) özelliğini kullanarak çalışma sayfasının imza çizgisini eklemeyi gösterir. Çalışma sonrası ekran görüntüsü, örnek kodun etkisini gösterir.
