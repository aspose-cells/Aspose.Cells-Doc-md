---
title: JavaScript ile C++ kullanarak Yazdırma Başlıkları Nasıl Ayarlanır
linktitle: Yazdırma Başlıklarını Nasıl Ayarlarsınız
type: docs
weight: 200
url: /tr/javascript-cpp/how-to-set-print-titles/
description: Bu makale, JavaScript ile C++ kullanarak Aspose.Cells kütüphanesi ile yazdırma başlıklarını nasıl ayarlayacağınızı gösterir.
keywords: Satır ve sütunları tekrar tekrar yazdırmak, JavaScript ile Yazdırma Başlıklarını Nasıl Ayarlarsınız, Yazdırma Başlıklarını JavaScript ile Ayarla ve Temizle, JavaScript ile Yazdırma Başlıklarını Nasıl Temizlersiniz, JavaScript kullanarak yazdırma başlıkları ekleme, JavaScript kullanarak yazdırma başlıklarını kaldırma, Excel de Yazdırma Başlıklarını Nasıl Ayarlarsınız, Excel de Yazdırma Başlıklarını Nasıl Temizlersiniz.  
---
...
## **Aspose.Cells for JavaScript C++ ile Yazdırma Başlıkları Nasıl Ayarlanır**  

Belirtilmiş bir çalışma sayfasında yazdırma başlıklarını ayarlamak için: İlk olarak, [örnek dosyayı](input.xlsx) yükleyin, ardından istenen çalışma sayfası için [**Worksheet.pageSetup**](https://reference.aspose.com/cells/javascript-cpp/worksheet/#pageSetup--) ve [**Worksheet.pageSetup**](https://reference.aspose.com/cells/javascript-cpp/worksheet/#pageSetup--) özelliklerini [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/) nesnesinde değiştirmeniz gerekir. Bu özellikleri bir aralık dizesine ayarlamak, yazdırma başlıklarını belirler.  
...
## **Aspose.Cells for JavaScript C++ ile Yazdırma Başlıklarını Nasıl Temizlerim**  

Belirli bir çalışma sayfasında yazdırma başlıklarını temizlemek için: İlk olarak, [örnek dosyayı](input.xlsx) yükleyin, ardından istenen çalışma sayfası için [**Worksheet.pageSetup**](https://reference.aspose.com/cells/javascript-cpp/worksheet/#pageSetup--) ve [**Worksheet.pageSetup**](https://reference.aspose.com/cells/javascript-cpp/worksheet/#pageSetup--) özelliklerini [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/) nesnesinde değiştirin. Bu özellikleri boş bir dizgeye ayarlamak, yazdırma başlıklarını temizler.  
