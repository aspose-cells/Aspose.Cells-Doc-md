---
title: JavaScript ve C++ ile Sayfa Seçenekleri Ayarlama
linktitle: Sayfa Seçeneklerini Ayarlama
type: docs
weight: 10
url: /tr/javascript-cpp/setting-page-options/
description: Bu makale, JavaScript ve C++ kullanarak Excel çalışma sayfalarının sayfa seçeneklerini programlı olarak ayarlamak için örnek kod sağlar. Sayfa Yönlendirmesi, Ölçekleme Faktörü, Sayfa Sığdırma Seçenekleri, Kağıt Boyutu, Baskı Kalitesi, İlk Sayfa Numarası ayarlama.
keywords: excel sayfa yönlendirmesi JavaScript ve C++ ile ayarlama, excel ölçekleme faktörü JavaScript ve C++ ile ayarlama, excel çalışma sayfası kağıt boyutu JavaScript ve C++ ile ayarlama
---
...
[**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) sınıfı, çalışma sayfasının sayfa düzeni seçeneklerini ayarlamak için kullanılan [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) özelliğini sağlar. Aslında, bu [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) özelliği, yazdırılan çalışma sayfası için farklı sayfa düzeni seçenekleri belirlemede kullanılan [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) sınıfının bir nesnesidir. [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) sınıfı, sayfa düzeni ayarları yapmak için çeşitli özellikler sağlar. Bu özelliklerden bazıları aşağıda tartışılmıştır.  

### **Sayfa Yönlendirmesi**  

Sayfa yönlendirmesi, [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) sınıfının [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) özelliği kullanılarak portre veya manzara olarak ayarlanabilir. [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) özelliği, aşağıda listelenen [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype) sıralamasında önceden tanımlanmış değerlerden birini kabul eder.  
...
Çalışma sayfasının boyutunu küçültmek veya büyütmek, [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) özelliği ile ölçeklendirme oranını ayarlayarak mümkündür.  
...
Çalışma sayfasının içeriğini belirli sayfa sayısına sığdırmak için [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) sınıfının [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) ve [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) özelliklerini kullanın. Bu özellikler aynı zamanda çalışma sayfalarını ölçeklendirmek için de kullanılır.  

{{% alert color="primary" %}}  
İster [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) ister [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) özelliğini seçebilirsiniz, ikisini aynı anda kullanamazsınız.  
{{% /alert %}}  
...
Çalışma sayfalarının yazdırılacağı kağıt boyutunu [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) sınıfının [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) özelliği kullanarak ayarlayın. [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) özelliği, aşağıda listelenen [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype) sıralamasında önceden tanımlanmış değerlerden birini kabul eder.  
...
İşlenen çalışma sayfalarının baskı kalitesini [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--) özelliği ile ayarlayın. Baskı kalitesi ölçüm birimi Dots Per Inches (DPI)dır.  
...
Çalışma sayfası sayfalarının numaralandırmaya [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) sınıfının [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) özelliği kullanılarak başlanabilir. [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) özelliği, ilk çalışma sayfasının sayfa numarasını belirler ve sonraki sayfalar artan sırayla numaralanır.  
