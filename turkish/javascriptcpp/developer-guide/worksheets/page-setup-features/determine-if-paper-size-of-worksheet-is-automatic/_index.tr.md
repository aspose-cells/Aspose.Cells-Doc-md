---
title: Çalışma sayfasının Kağıt Boyutunun Otomatik olup olmadığını JavaScript kullanarak C++ ile belirleyin
linktitle: Çalışma Sayfasının Kağıt Boyutunun Otomatik Olup Olmadığını Belirleyin
type: docs
weight: 90
url: /tr/javascript-cpp/determine-if-paper-size-of-worksheet-is-automatic/
description: Bu makale, C++ eklentileriyle JavaScript API sini kullanarak bir çalışma sayfasının kağıt boyutunun otomatik olarak ayarlandığını programmatically belirlemeyi açıklar.
keywords: Kağıt boyutunun otomatik olup olmadığını belirle JavaScript ve C++ ile
---

## **Olası Kullanım Senaryoları**

Çoğu zaman, çalışma sayfasının kağıt boyutu otomatik olur. Otomatik olduğunda, genellikle *Letter* olarak ayarlanır. Bazen kullanıcı, gereksinimlerine göre çalışma sayfasının kağıt boyutunu ayarlar. Bu durumda, kağıt boyutu otomatik değildir. Çalışma sayfası kağıt boyutunun otomatik olup olmadığını [**Worksheet.isAutomaticPaperSize()**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#isAutomaticPaperSize--) özelliği ile bulabilirsiniz.
