...
### **Sayfa yönlendirmesi**
 kullanarak sayfa yönü ayarlarını uygulamak için**PHP için Aspose.Cells Java** , aramak**Sayfa yönlendirmesi** yöntemi**sayfa ayarı** modül.
...
{{< /highlight >}}
### **Ölçekleme faktörü**
 kullanarak ölçekleme uygulamak için**PHP için Aspose.Cells Java** , aramak**ölçekleme** yöntemi**sayfa ayarı** modül.
