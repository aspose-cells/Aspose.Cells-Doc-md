---
title: Ruby'de Excel Dosyalarını HTML'ye Dönüştürme
type: docs
weight: 20
url: /tr/java/converting-excel-files-to-html-in-ruby/
---
## **Aspose.Cells - Excel Dosyalarını HTML'ye Dönüştürme**
Ruby'de Aspose.Cells for Java kullanarak Excel'i HTML'ye dönüştürmek için çalışma sayfasını çağırmanız yeterlidir_ile_Dönüştürücü modülünün html() yöntemi.
