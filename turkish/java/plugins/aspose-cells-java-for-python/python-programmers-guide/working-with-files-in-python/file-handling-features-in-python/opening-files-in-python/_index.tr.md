---
title: Dosyaları Python'de Açma
type: docs
weight: 10
url: /tr/java/opening-files-in-python/
---
## **Aspose.Cells - Dosyaları Python'de Açma**
Aspose.Cells Java içinde Python kullanarak bir dosyayı açmak için Document sınıfının openfile() yöntemini çağırmanız ve sona eklenecek ikinci belgeyi belirtmeniz yeterlidir.
...
{{< /highlight >}}
## **Çalışan Kodu İndir**
 İndirmek**Dosya Açılıyor (Aspose.Cells)** aşağıda belirtilen sosyal kodlama sitelerinin herhangi birinden:
