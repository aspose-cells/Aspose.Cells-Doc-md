---
title: Python da Dosyaları Açma
type: docs
weight: 10
url: /tr/java/opening-files-in-python/
---

## **Aspose.Cells - Python'da Dosyaları Açma**
Aspose.Cells Java ile Python'da bir dosyayı açmak için, sadece Document sınıfının openfile() yöntemini çağırın ve sonuna eklemek için ikinci belgeyi belirtin.
...
{{< /highlight >}}
## **Çalışan Kodu İndir**
Aşağıda belirtilen herhangi bir sosyal kodlama sitesinden **Dosya Açma (Aspose.Cells)**'i indirin:
