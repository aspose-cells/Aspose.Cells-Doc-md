...
type: docs
weight: 40
url: /tr/java/evaluation-version-limitations/
description: Bu makale, değerlendirme sürümlerini nasıl elde edebileceğinizi ve değerlendirme sürümlerinin sınırlamalarını nasıl bilebileceğinizi anlamanıza yardımcı olabilir.
...
Aspose.Cells'in Java için değerlendirme sürümünü [indirme sayfasından](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-cells) indirebilirsiniz. Değerlendirme sürümü, ürünün lisanslı sürümüyle tamamen aynı yetenekleri sağlar. Ayrıca, değerlendirme sürümü, lisans satın aldığınızda ve lisansı uygulamak için birkaç satır kod eklediğinizde lisanslı hale gelir.
...
Aspose.Cells tarafından çıktı PDF veya görüntü dosyasında, bir değerlendirme filigranı belgenin/ görüntünün üstüne yapıştırılacaktır.
<br>
