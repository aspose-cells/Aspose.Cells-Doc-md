---
title: Apache POI SS - HSSF ve XSSF için Aspose.Cells Java
linktitle: Neden Apache POI olmasın
type: docs
weight: 40
url: /tr/java/aspose-cells-java-for-apache-poi-ss-hssf-and-xssf/
description: Neden Apache POI SS - HSSF ve XSSF değil.
---
{{% alert color="primary" %}}
Bazen şu soruyu alıyoruz: Neden Apache POI yerine Aspose ürünlerini kullanmalıyız? Bu sorunun yanıtlanması kolaydır: özellikler ve işlevsellik.
{{% /alert %}}
...
Bu proje aynı zamanda POI'den Aspose.Cells'e geçmek isteyen geliştiriciler için yararlıdır.
...
Aspose bileşenleri kapsamlı bir şekilde test edilmiştir. Aspose bileşenleri tek bir JAR'da paketlendiğinden, bunların çalışması için herhangi bir ek parça veya parça takılmasına asla gerek kalmayacaktır. Bu, Aspose.Cells ile istikrarlı bir çalışma sağlamakla kalmaz, aynı zamanda öngörülemeyen durumların riskini neredeyse sıfıra indirir.
...
Aşağıdaki platformlardan herhangi birini kullanarak Apache POI SS - HSSF ve XSSF için Aspose.Cells Java ile ilgili sorunları veya önerileri günlüğe kaydedebilirsiniz:

- [Github](https://github.com/aspose-cells/Aspose.Cells-for-Java/issues)
### **Genişletin ve Katkıda Bulunun**
Aspose.Cells Java for Apache POI (HSSF+XSSF) açık kaynaktır ve kaynak kodu aşağıda listelenen başlıca sosyal kodlama web sitelerinde mevcuttur. Geliştiricilerin kaynak kodunu indirmeleri ve yeni özellikler önererek veya ekleyerek veya mevcut olanları geliştirerek katkıda bulunmaları teşvik edilir, böylece diğerleri de bundan faydalanabilir.
### **Kaynak kodu**
...
1.  Eclipse'i Açın ve Seçin**Dosya** > **İçe aktarmak...**
1. Seçme**Genel** > **Mevcut Projeleri Çalışma Alanına Dönüştürün**.
1. Şuraya göz atın:**kök dizini seçin**indirdiğiniz en son kaynak kodunun.
1. Tıklamak**Bitiş**indirilen projeyi başarıyla içe aktarmak için.
#### **NetBeans IDE'si**
1. Kaynak kodunu indirin/Klonlayın.
1. NetBeans'i Açın ve Seçin**Dosya** > **Yeni proje...**
1.  İçinde**Proje Seç** sekme: Seç**Java** > **Java Mevcut Kaynaklı Proje**.
1.  İçinde**Adı ve konumu** sekmesi: İstediğinizi sağlayın**proje Adı** ve**Proje Klasörü**.
1.  İçinde**Mevcut Kaynaklar** sekme: tıklayın**Klasörü eklemek...** ve indirdiğiniz en son kaynak kodun kök dizinini seçmek için göz atın.
1.  Tıklamak**Bitiş** indirilen projeyi başarıyla oluşturmak için.
## **Örnek Kod Örnekleri**
Bu bölüm aşağıdaki konuları içerir

- [Aspose.Cells ve Apache POI'deki Ortak Özellikler için Kod Karşılaştırması - HSSF ve XSSF](/cells/tr/java/code-comparison-for-common-features-in-aspose-cells-and-apache-poi-hssf-and-xssf/)
  - [Apache POI ve Aspose.Cells'de Çalışma Sayfalarıyla Çalışma](/cells/tr/java/working-with-worksheets-in-apache-poi-and-aspose-cells/)
    ...
    - [Apache POI ve Aspose.Cells kullanan Yakınlaştırma Faktörü](/cells/tr/java/zoom-factor-using-apache-poi-and-aspose-cells/)
  - [Apache POI ve Aspose.Cells'de Çalışma Kitaplarıyla Çalışma](/cells/tr/java/working-with-workbooks-in-apache-poi-and-aspose-cells/)
    - [Cells'de Veri Ekle](/cells/tr/java/add-data-in-cells/)
    - [Yeni Çalışma Kitabı Oluştur](/cells/tr/java/create-new-workbook/)
    - [Sayfa Düzeni - Sayfa Ayarına Sığdır](/cells/tr/java/page-setup-fit-to-page-setting/)
    - [Yazdırma Alanını Ayarla](/cells/tr/java/set-print-area/)
  - [Cells, Apache POI'de Satırlar ve Sütunlar ve Aspose.Cells ile çalışma](/cells/tr/java/working-with-cells-rows-and-columns-in-apache-poi-and-aspose-cells/)
    - [Satır ve Sütunu Otomatik Sığdır](/cells/tr/java/auto-fit-row-and-column/)
    - [Cell Hizalama Ayarları](/cells/tr/java/cell-alignment-settings/)
    - [Gizle ve Göster Cells](/cells/tr/java/hide-and-unhide-cells/)
    - [Ekle Cell Yorumlar](/cells/tr/java/insert-cell-comments/)
    - [Satırları ve Sütunları Yinele](/cells/tr/java/iterate-rows-and-columns/)
    - [Birleştirme Cells](/cells/tr/java/merge-cells/)
    - [Apache POI ve Aspose.Cells'de Bölme Bölmeleri](/cells/tr/java/split-panes-in-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells'de Bölmeleri Dondur](/cells/tr/java/freeze-panes-in-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells'de Tarih Cell'i oluşturun](/cells/tr/java/create-date-cell-in-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells'de Farklı Cell Türleri Oluşturun](/cells/tr/java/create-different-cell-types-in-apache-poi-and-aspose-cells/)
  - [Apache POI ve Aspose.Cells'deki Verilerle Çalışma](/cells/tr/java/working-with-data-in-apache-poi-and-aspose-cells/)
    - [Cell İçindekileri Alma](/cells/tr/java/getting-cell-contents/)
    - [Çalışma Sayfasına Köprü Ekleme](/cells/tr/java/insert-hyperlinks-in-worksheet/)
    - [Cells'de Yeni Hat](/cells/tr/java/new-line-in-cells/)
    - [Apache POI ve Aspose.Cells kullanarak Pivot Tablolar oluşturun](/cells/tr/java/create-pivot-tables-using-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells kullanarak Grafikler oluşturun](/cells/tr/java/create-charts-using-apache-poi-and-aspose-cells/)
  - [Apache POI ve Aspose.Cells'de Biçimlendirme Özellikleriyle Çalışma](/cells/tr/java/working-with-formatting-features-in-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells'de Sınırlarla Çalışma](/cells/tr/java/working-with-borders-in-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells'de Renklerle Çalışma](/cells/tr/java/working-with-colors-in-apache-poi-and-aspose-cells/)
    - [Apache POI ve Aspose.Cells'de Yazı Tipleriyle Çalışma](/cells/tr/java/working-with-fonts-in-apache-poi-and-aspose-cells/)
- [Aspose.Cells Apache POI SS - HSSF ve XSSF'de eksik özellikler](/cells/tr/java/aspose-cells-features-missing-in-apache-poi-ss-hssf-and-xssf/)
