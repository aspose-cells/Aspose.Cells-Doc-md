...
Her örnek, ayrı bir çalıştırılabilir sınıf olarak sağlanır. Dosyayı sağ tıklayın ve Dosyayı Çalıştır'ı seçin.

{{% alert color="primary" %}} 

 Örnekler şu şekildedir**tutulma projesi** . Lütfen kullanarak Eclipse'deki Örnekleri açın.**Dosya > Projeleri Dosya Sisteminden Aç...** menü komutu ve adımları izleyin. Şimdi, örnekleri iyi çalıştırabilmelisiniz.

{{% /alert %}} 
## **Örneği Çalıştır**
Eclipse IDE'de Örnekleri açtıktan sonra herhangi bir .java dosyasını seçin. Örneğin, bunu seçin.

TilePictureAsTextureInsideShape.java

içinde bulunan

Örnekler>src>AsposeCellsÖrnekler>DrawingObjects dizini

veya paketin içinde

AsposeHücrelerÖrnekler.ÇizimNesneleri
