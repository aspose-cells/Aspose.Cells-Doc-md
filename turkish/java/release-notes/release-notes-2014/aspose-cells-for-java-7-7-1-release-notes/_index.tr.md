---
title: Aspose.Cells for Java 7.7.1 Sürüm Notları
type: docs
weight: 90
url: /tr/java/aspose-cells-for-java-7-7-1-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 7.7.1](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-7.7.1/)
...
xlsb'nin pivot tablosunu okuma ve yazma için refactor

Küçük Özellikler

Yeni özellikler

(CELLSJAVA-40409) - Büyük şablon dosyalarını LightCells ile okuma
(CELLSJAVA-40269) - Büyük şablon dosyalarını LightCells ile okuma
(CELLSJAVA-40696) - ActiveX Desteği (Butonlar gibi ActiveX kontrollerini okuyun)
(CELLSJAVA-40372) - ActiveX Desteği (Butonlar gibi ActiveX kontrollerini okuyun)
(CELLSJAVA-40373) - ActiveX Resmi veya Normal Resim arasında ayrım yapın

Geliştirmeler

(CELLSJAVA-40688) - Varsayılan sütun genişliği ayarlanamıyor
(CELLSJAVA-40391) - Aspose'i OSGi Ortamında Kullanma
(CELLSJAVA-40418) - Kayıtlı Grafiklerde kalite nasıl ayarlanır
...
(CELLSJAVA-40697) - Aspose.cells, Excel 2013'te yapılan bir grafiği kopyalarken bir İstisna oluşturuyor
(CELLSJAVA-40706) - Dosyayı açarken ArrayIndexOutOfBoundsException
(CELLSJAVA-40422) - Dosyayı açarken ArrayIndexOutOfBoundsException


Not
Aspose.Cells for Java kod tabanı, ilgili .NET sürümünün koduyla eşleştiğinden, Aspose.Cells for .NET v7.7.1'de bulunan değişikliklerin, geliştirmelerin ve düzeltmelerin çoğu bu Aspose.Cells for Java v7.7.1'de de yer almaktadır.
