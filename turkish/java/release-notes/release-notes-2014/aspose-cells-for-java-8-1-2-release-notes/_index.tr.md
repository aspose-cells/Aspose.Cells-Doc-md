...
type: docs
weight: 30
url: /tr/java/aspose-cells-for-java-8-1-2-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 8.1.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.1.2/)
...
(CELLSJAVA-40883) - CSV Dosyasını İçe Aktarırken Tarih Formatında Sorun
(CELLSJAVA-40872) - worksheet.getCells().importResultSet, tarih sütunundan itibaren saat her zaman 00:00'dır

Hatalar

(CELLSJAVA-40866) - HTML'ye dönüştürme, SaveOptions'ta ImageFormat'ı dikkate almıyor
...
(CELLSJAVA-40835) - İşlenen HTML dosyasındaki gizli sütunları dışa aktarma sorunu
...
(CELLSJAVA-40910) - PDF, PdfSaveOptions.setImageType(ImageFormat.getPng()) kullanılarak oluşturulduğunda görüntüler kayboluyor
(CELLSJAVA-40907) - Bir şablon Excel dosyası HTML olarak kaydedildiğinde veri noktası işaretçileri grafikte eksik
(CELLSJAVA-40904) - Bazı grafikler, HTML dosya biçimine uygun şekilde işlenmez
...
(CELLSJAVA-40869) - Denklemlerde glifler eksik ve işlenen PDF dosyasında belirli biçimlendirilmiş metinler kesiliyor
(CELLSJAVA-40865) - PDF çıktısında görüntü net değil
(CELLSJAVA-40860) - Şablon XLSX dosyası yeniden kaydedilirken grafikte kabarcık özellikleri değişti
(CELLSJAVA-40859) - Şablon XLSX dosyası yeniden kaydedilirken grafikte kabarcık özellikleri değişti
