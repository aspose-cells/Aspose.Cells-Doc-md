---
title: Aspose.Cells for Java 8.4.2 Sürüm Notları
type: docs
weight: 60
url: /tr/java/aspose-cells-for-java-8-4-2-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 8.4.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.4.2/)
...
## **Yeni özellikler**
 ...
 (CELLSJAVA-41289) - Grafik kurulumu için kolay yol


## **Hatalar**


 (CELLSJAVA-41323) - Filigranlar düzgün görüntülenmiyor
...
(CELLSJAVA-41242) - Elektronik tablo PDF'e dönüştürülürken çizim karışık
 ...
 (CELLSJAVA-41299) - xls, xlsx biçiminde kaydedildiğinde dosya bozuluyor

 (CELLSJAVA-41284) - Workbook.copy() çıktı excel dosyasını bozar

 (CELLSJAVA-41283) - OR işleviyle ilgili hesaplama hatası

 (CELLSJAVA-41281) - Sütunları otomatik sığdırma işlemi, ShrinkToFit seçeneği açıkken birkaç hücrede etkili olmuyor
...
(CELLSJAVA-41314) - Grafikteki DataLabels, işlenmiş EMF görüntüsünde gösterilmiyor
 ...
 (CELLSJAVA-41275) - Grafiği resme dönüştürürken ortaya çıkan EMF'de Eksen etiketlerinden ikisi eksik
...
(CELLSJAVA-41310) - java.lang.IndexOutOfBoundsException: Dizin: 2, Boyut: 2, ctro Çalışma Kitabı'nda
 ...
 (CELLSJAVA-41280) - Tek bir özel Tarih biçimi için "java.lang.ArrayIndexOutOfBoundsException" istisnası oluştu

 (CELLSJAVA-41274) - tekrarlanan yükleme ve kaydetme işlemlerinden sonra Workbook.save'de java.lang.NullPointerException
...
MS Excel'de aralığı "Tümü" ve "Kenarlıklar hariç tümü" olarak kopyalamak için kullanılır.
 ...
 Aspose.Cells for Java kod tabanı, ilgili .NET sürümünün koduyla eşleştiğinden, Aspose.Cells for .NET v8.4.2'de bulunan değişikliklerin, geliştirmelerin ve düzeltmelerin çoğu bu Aspose.Cells for Java v8.4.2'de de yer almaktadır.
