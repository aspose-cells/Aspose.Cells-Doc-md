...
type: docs
weight: 80
url: /tr/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [Cells Veri Tablosu Satırlarını eklerken İlk Satırı aşağı kaydır](/cells/tr/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
