...
type: docs
weight: 20
url: /tr/java/aspose-cells-for-java-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSJAVA-42427|Kılavuz çizgilerini kenarlıklarla dışa aktarma, kılavuz çizgilerini Excel'de HTML oluşturmaya sınır içinde göstermiyor|Böcek|
...
|CELLSJAVA-42353|Çıkış HTML'sinde bazı oklar veya açıklamalar eksik|Böcek|
...
|CELLSJAVA-42443|MS Excel filtreleri doğru şekilde dönüştürülmüyor - XLSB'den XLSM'ye dönüştürme|Böcek|
...
|CELLSJAVA-42434|İstisna: Bir HTML dosya formatı yüklenirken "java.lang.NumberFormatException"|İstisna|
...
- [Akıllı Sanatı Grup Şekline Dönüştürün](/cells/tr/java/convert-the-smart-art-to-group-shape/)
- [Aspose.Cells ile Paylaşılan Çalışma Kitabı Oluşturun](/cells/tr/java/create-shared-workbook-with-aspose-cells/)
- [Shape'in Smart Art Shape olup olmadığını belirleme](/cells/tr/java/determine-if-shape-is-smart-art-shape/)
- [Xml Haritasının Kök Eleman Adını Bulun](/cells/tr/java/find-the-root-element-name-of-xml-map/)
- [Excel'i PDF'ye Dönüştürürken Hataları Yoksay](/cells/tr/java/ignore-errors-while-rendering-excel-to-pdf/)
- [Paylaşılan Çalışma Kitabını Parolayla Koruyun veya Korumayı Kaldırın](/cells/tr/java/password-protect-or-unprotect-the-shared-workbook/)
- [Sorgu Cell Alanları, Worksheet.XmlMapQuery yöntemi kullanılarak Xml Harita Yoluna Eşlendi](/cells/tr/java/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
- [ImageOrPrintOptions'ın PageIndex ve PageCount Özelliklerini Kullanarak Sayfa Sırasını Oluşturun](/cells/tr/java/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/)
