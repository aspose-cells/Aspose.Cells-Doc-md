...
type: docs
weight: 60
url: /tr/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [Hataları ve Boole Değerini Rusça veya Başka Bir Dilde Uygulama](/cells/tr/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
