...
type: docs
weight: 70
url: /tr/java/aspose-cells-for-java-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 17.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.6/).
...
- [Resmi Şeklin İçinde Bir Doku Olarak Döşe](/cells/tr/java/tile-picture-as-a-texture-inside-the-shape/)
- [GridWeb'in OnAjaxCallFinishedClientFunction'ını Kullanma](/cells/tr/java/using-onajaxcallfinishedclientfunction-of-gridweb/)
- [Akıllı İşaretleyici alanında Formül parametresini kullanma](/cells/tr/java/using-formula-parameter-in-smart-marker-field/)
