...
type: docs
weight: 50
url: /tr/java/aspose-cells-for-java-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 17.8](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.8/).
...
|CELLSJAVA-42358|Elde edilen PDF'de formül görüntülenmiyor|Artırma|
|CELLSJAVA-42351|HAFTANIN GÜNÜ formülü, çalışma kitabı formülü hesaplamasında yanlış değer veriyor|Artırma|
|CELLSJAVA-42332|Aspose.Cells, MS-Excel düzgün bir şekilde dönüştürebildiği halde HTML dosyasını doğru şekilde dönüştüremiyor|Böcek|
...
|CELLSJAVA-42349|Bir XLSX dosyası için Excel'den PDF'e dönüştürme askıda kaldı|Böcek|
|CELLSJAVA-42348|XLSB dosyası (Aspose.Cells API'leri tarafından) MS-Access veritabanına aktarılamıyor|Böcek|
...
- [Halihazırda imzalanmış bir Excel dosyasına Dijital İmza ekleme](/cells/tr/java/add-digital-signature-to-an-already-signed-excel-file/)
...
- [Yazdırılacak Hiçbir Şey Olmadığında Boş Sayfa Çıktısı](/cells/tr/java/output-blank-page-when-there-is-nothing-to-print/)
