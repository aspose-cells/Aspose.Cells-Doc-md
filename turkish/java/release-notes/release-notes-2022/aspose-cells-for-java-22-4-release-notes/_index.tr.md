...
type: docs
weight: 9
url: /tr/java/aspose-cells-for-java-22-4-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 22.4](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-22.4/).
