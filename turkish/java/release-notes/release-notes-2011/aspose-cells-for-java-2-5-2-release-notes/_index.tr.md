...
type: docs
weight: 70
url: /tr/java/aspose-cells-for-java-2-5-2-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 2.5.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.5.2/)
...
- Şablon dosyalarından Pivot Tabloları okumayı destekler.
 ...
 Geliştirme, XLSX dosyalarından Şekilleri okumak için yapılmıştır.
