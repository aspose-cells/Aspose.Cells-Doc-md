---
title: Aspose.Cells for Java 19.8 Sürüm Notları
type: docs
weight: 50
url: /tr/java/aspose-cells-for-java-19-8-release-notes/
---
{{% alert color="primary" %}} 

Bu sayfa Aspose.Cells for Java 19.8 için sürüm notları içerir.

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
|:- |:- |:- |
|CELLSJAVA-42949|ECDSA ve RSA algoritmaları için destek|Yeni özellik|
