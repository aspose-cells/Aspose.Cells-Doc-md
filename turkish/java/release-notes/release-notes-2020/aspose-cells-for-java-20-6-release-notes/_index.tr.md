...
type: docs
weight: 10
url: /tr/java/aspose-cells-for-java-20-6-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for Java 20.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.6/).
...
|CELLSJAVA-43181|Excel'i HTML'ye dönüştürmede satır yüksekliğindeki fark|Böcek|
