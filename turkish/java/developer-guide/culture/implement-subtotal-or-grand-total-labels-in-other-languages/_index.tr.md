...
## **Diğer dillerde Alt Toplam veya Genel Toplam etiketlerini uygulama**
 Aşağıdaki örnek kod,[örnek excel dosyası](5472584.xlsx) ve alt toplam ve genel toplam adlarını uygular.*Çince* dil. lütfen kontrol ediniz[çıktı excel dosyası](5472587.xlsx) referansınız için bu kod tarafından oluşturulmuştur.
## **Basit kod**
