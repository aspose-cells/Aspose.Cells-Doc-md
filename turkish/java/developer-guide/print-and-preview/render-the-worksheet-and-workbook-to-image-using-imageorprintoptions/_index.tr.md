...
{{% alert color="primary" %}}
 ...
 bu[**Çalışma KitabıRender**](https://reference.aspose.com/cells/java/com.aspose.cells/WorkbookRender) class, çalışma kitabını yalnızca TIFF biçiminde kaydedebilir.
