...
Bazen Koşullu Biçimlendirme DataBar'ların görüntülerini oluşturmanız gerekebilir. Aspose.Cells [**DataBar.toImage()**](https://reference.aspose.com/cells/java/com.aspose.cells/databar#toImage(com.aspose.cells.Cell,%20com.aspose.cells.ImageOrPrintOptions)) yöntemini kullanarak bu görüntüleri oluşturabilirsiniz. Bu makale, Aspose.Cells kullanarak DataBar görüntüsünün nasıl oluşturulacağını gösterir.

{{% /alert %}}

## **Örnek**

Aşağıdaki örnek kod, hücre C1'in DataBar görüntüsünü oluşturur. İlk olarak, hücrenin biçim koşulu nesnesine erişir, ardından bu nesneden DataBar nesnesine erişir ve hücrenin görüntüsünü oluşturmak için [**DataBar.toImage()**](https://reference.aspose.com/cells/java/com.aspose.cells/databar#toImage(com.aspose.cells.Cell,%20com.aspose.cells.ImageOrPrintOptions)) yöntemini kullanır. Son olarak, görüntüyü diske kaydeder.
