...
type: docs
weight: 40
url: /tr/java/protect-and-unprotect-workbook-structure/
description: Aspose.Cells for Java yi kullanarak Excel dosyaların yapılandırma yapılarının koruma ve korumasız bırakılmasının kilitlenmesi ve kilidinin açılması.
---
...
## **Aspose.Cell için Java kullanarak Çalışma Sayfası Yapısının Korunması**
...
## **Aspose.Cell için Java kullanarak Çalışma Sayfası Yapısının Korunmasının Kaldırılması**
