...
description: Java kodlarını kullanarak Excel dosyalarının çalışma kitabı yapısını koruyun ve korumasını kaldırın. Aspose.Cells for Java kullanarak Excel (xlsx,xls, xsb) ve Open office calc (ODS) dosyalarını kilitleyin ve kilidini açın.
---
{{% alert color="primary" %}}
...
## **Aspose.Cell for Java Kullanarak Çalışma Kitabı Yapısının Korumasını Kaldırın**
