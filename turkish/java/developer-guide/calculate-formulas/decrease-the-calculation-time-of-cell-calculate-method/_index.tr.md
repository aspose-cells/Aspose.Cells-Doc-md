...
## **Konsol Çıkışı**
 Bu, verilen ile çalıştırıldığında yukarıdaki örnek kodun konsol çıktısıdır.[örnek excel dosyası](5472288.xlsx) makinemizde. Lütfen unutmayın, çıktınız farklı olabilir, ancak özyinelemeli özelliği şu şekilde ayarladıktan sonra geçen süre:**YANLIŞ** ayarlamaktan her zaman daha az olacaktır.**doğru**.
