---
title: Excel 2016 MINIFS ve MAXIFS işlevlerinin hesaplanması
type: docs
weight: 1030
...
![yapılacaklar:resim_alternatif_metin](calculation-of-excel-2016-minifs-and-maxifs-functions_1.png)
## **Excel 2016 MINIFS ve MAXIFS işlevlerinin hesaplanması**
 Aşağıdaki örnek kod,[örnek excel dosyası](5472586.xlsx) ve çağırır[Workbook.calculateFormula()](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#calculateFormula\(\) ) yöntemiyle formül hesaplamasını Aspose.Cells aracılığıyla gerçekleştirir ve ardından sonuçları[çıkış PDF](5472585.pdf).
## **Basit kod**
