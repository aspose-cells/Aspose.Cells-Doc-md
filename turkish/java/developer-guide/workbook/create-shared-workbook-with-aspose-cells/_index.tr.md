...
Aşağıdaki örnek kod, ayarlayarak paylaşılan bir çalışma kitabı oluşturur.[**Workbook.Settings.Shared**](https://reference.aspose.com/cells/java/com.aspose.cells/workbooksettings#Shared)olarak mülkiyet**doğru**. ne zaman açacaksınız[çıktı excel dosyası](55541801.xlsx)Microsoft Excel'de göreceksiniz*Paylaşılan*bu ekran görüntüsünde gösterildiği gibi çıktı çalışma kitabı adıyla.
