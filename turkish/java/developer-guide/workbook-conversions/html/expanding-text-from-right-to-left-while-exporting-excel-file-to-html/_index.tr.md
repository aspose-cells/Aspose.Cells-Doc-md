...
Aşağıdaki örnek kod, [örnek excel dosyasını](5472562.xlsx) HTML'e dönüştürür. Bu ekran görüntüsü, örnek excel dosyasının Microsoft Excel 2013'te nasıl göründüğünü göstermektedir.

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_1.png)

Bu ekran görüntüsü, eski sürüm tarafından oluşturulan [çıktı HTML'yi](5472570) göstermektedir.

![todo:image_alt_text](expanding-text-from-right-to-left-while-exporting-excel-file-to-html_2.png)

Bu ekran görüntüsü, yeni sürüm tarafından oluşturulan [çıktı HTML'yi](5472563) göstermektedir.
