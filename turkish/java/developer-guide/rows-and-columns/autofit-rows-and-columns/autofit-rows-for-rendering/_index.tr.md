...
Kaydedilen PDF dosyasında metnin kırpılmasını önlemek istiyorsanız satırı otomatik olarak sığdırabilirsiniz.[AutoFitterOptions.ForRendering](https://reference.aspose.com/cells/java/com.aspose.cells/autofitteroptions/#setForRendering-boolean-) seçenek.
