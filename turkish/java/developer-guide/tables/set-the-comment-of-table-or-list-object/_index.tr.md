...
## **Çalışma Sayfasında Tablo veya Liste Nesnesinin Yorumunu Ayarlama**
 ...
 Lütfen çalışma sayfasının içindeki Tablo veya Liste Nesnesinin açıklamasını şunu kullanarak ayarlayın:[**ListObject.Comment**](https://reference.aspose.com/cells/java/com.aspose.cells/listobject#Comment)Emlak. Yorum, xl/tables/tableName.xml dosyası içinde görünür olacaktır.
