...
type: docs
weight: 30
url: /tr/java/using-formula-parameter-in-smart-marker-field/
---

## **Olası Kullanım Senaryoları**
Bazen akıllı işaretçi alanındaki formülü gömmek istersiniz. Bu makale, akıllı işaretçi alanında formülü gömmek için Formül parametresinin nasıl kullanılacağını açıklar.
