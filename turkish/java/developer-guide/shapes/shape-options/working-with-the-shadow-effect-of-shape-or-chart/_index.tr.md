...
Aspose.Cells, şekil veya grafik gölgelendirme efekti ile çalışmak için [Shape.ShadowEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#ShadowEffect) özelliğini sağlar. İhtiyaçlarınıza göre farklı sonuçlar elde etmek için aşağıdaki alt özellikleri içerir.
...
Aşağıdaki ekran görüntüsü, Şekil *Gölgelendirme Efekti* ayarını yapmak için Microsoft Excel arayüzünü göstermektedir.
