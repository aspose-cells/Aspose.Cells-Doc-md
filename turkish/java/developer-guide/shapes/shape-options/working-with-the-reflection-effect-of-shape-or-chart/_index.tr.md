...
Aspose.Cells, şekil veya grafik yansıma efekti ile çalışmak için [Shape.ReflectionEffect](https://reference.aspose.com/cells/java/com.aspose.cells/shape#Reflection) özelliğini sağlar. İhtiyaçlarınıza göre farklı sonuçlar elde etmek için aşağıdaki alt özellikleri içerir.
...
Aşağıdaki ekran görüntüsü, Şekil *Yansıma Efekti* ayarını yapmak için Microsoft Excel arayüzünü göstermektedir.
