---
title: Güneş patlaması grafiği nasıl oluşturulur
description: Aspose.Cells for Java de güneş patlaması grafiği oluşturmayı, verileri bir daire içinde sunan bir grafik oluşturmayı öğrenin. Rehberimiz, veri etiketleri, göstergeler, renkler ve daha fazlası gibi grafik özelliklerini ve biçimlendirmesini nasıl yapılandıracağınızı size yardımcı olacaktır.
keywords: Aspose.Cells for Java, güneş patlaması grafiği, oluştur, özelliklerini ayarla, veri etiketleri, gösterge, biçim, renk, daire, veri oluşturucu.
type: docs
weight: 162
url: /tr/java/creating-sunburst-chart/
---
