...
description: Birincil ve ikincil eksenlerin Aspose.Cells for Java içinde nasıl anlaşılacağını ve çalışılacağını öğrenin. Rehberimiz, birincil ve ikincil eksenler arasındaki farkları anlamanıza ve bunları grafiklerinizde etkili bir şekilde yapılandırmanıza ve kullanmanıza yardımcı olacaktır.
keywords: Aspose.Cells for Java, birincil eksenler, ikincil eksenler, anlama, farklar, yapılandırma, kullanım.
type: docs
weight: 190
url: /tr/java/primary-and-second-axis/
---
...
Aşağıdaki örnek kod, [çıktı Excel dosyasını](PrimaryandSecondaryAxis.xlsx) oluşturur.
