---
title: Grafik Serisindeki Veri Noktalarına Özel Etiketler Ekleme
type: docs
weight: 380
...
{{% alert color="primary" %}} 
 ...
 Grafik serisindeki veri noktalarına özel etiketler ekleyebilirsiniz. Aspose.Cells sağlar[ChartPoint.getDataLabels().setText()](https://reference.aspose.com/cells/java/com.aspose.cells/datalabels#Text)Bu özel etiketleri ekleme özelliği. Bu makale, grafik serisindeki veri noktalarına özel etiketler eklemek için bu özelliğin nasıl kullanılacağını açıklayacaktır.
