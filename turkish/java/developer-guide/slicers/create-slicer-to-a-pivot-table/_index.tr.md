...
Lütfen aşağıdaki örnek koda bakın. o yükler[örnek excel dosyası](67338498.xlsx)pivot tabloyu içerir. Ardından, ilk temel pivot alanını temel alarak dilimleyiciyi oluşturur. Son olarak, çalışma kitabını şuraya kaydeder:[çıkış XLSX](67338497.xlsx)ve[çıkış XLSB](67338496.xlsb)biçim. Aşağıdaki ekran görüntüsü, çıktı Excel dosyasında Aspose.Cells tarafından oluşturulan dilimleyiciyi göstermektedir.
