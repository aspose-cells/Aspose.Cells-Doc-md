---
title: Aspose.Cells for Java'deki yenilikler
type: docs
description: Aspose.Cells for Java her geçen gün genişliyor ve gelişiyor. Bu sayfada ürünün devasa ve en ilginç özellikleri hakkında bilgi edinebilirsiniz.
weight: 5
...
* GridWeb'de Onay Kutusu kontrolünü statik resim yerine etkileşimli kontrol olarak oluşturma desteği
...
* Anormal zip verileri içeren ve Java'nın ZipInputStream'i tarafından işlenemeyen OOXML formatındaki şablon dosyalarını okuma desteği
