---
title: GridJs de modal pencere için UI görünümünü nasıl özelleştireceğinizi anlatan makale  
type: docs
weight: 250
url: /tr/java/aspose-cells-gridjs/how-to-customize-ui-window/
description: Bu makale GridJs de modal pencere için UI görünümünü nasıl özelleştireceğinizi anlatmaktadır.
keywords: GridJs,özelleştir,modül,UI,görünüm,görsel,pencere
aliases:
aliases:
...
# GridJs için Modal Stil Kılavuzu

## İçindekiler

- [Genel Bakış](#overview)
- [CSS Sınıf Adlandırma](#css-class-naming)
- [Hızlı Başlangıç](#quick-start)
- [Güzel Stil Örnekleri](#beautiful-style-examples)
- [Tema Galerisi](#theme-gallery)
- [Gelişmiş Teknikler](#advanced-techniques)
...
### Mevcut Modal İsimleri

| Modal Türü | İsim | CSS Sınıfı |
|------------|------|-----------|
| Sıralama | `sort` | `.x-spreadsheet-modal-sort` |
| Doğrulama | `validation` | `.x-spreadsheet-modal-validation` |
| Arama | `search` | `.x-spreadsheet-modal-search` |
| Kontrol | `control` | `.x-spreadsheet-modal-control` |
| İndirme | `download` | `.x-spreadsheet-modal-download` |
| E-posta | `email` | `.x-spreadsheet-modal-email` |
| GirişÖnerisi | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| URLEkle | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| Bağlantı | `link` | `.x-spreadsheet-modal-link` |
| Yazdır | `print` | `.x-spreadsheet-modal-print` |
| Metin Döndür | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| Veri Doğrulama | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| Daha Fazla Sayı Biçimi | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| Doğrulama Uyarısı | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| EklemeSilme | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Örnek 2: Minimalist Temiz Tema 🤍

Profesyonel ve kurumsal uygulamalar için idealdir.
...
### Örnek 3: Karanlık Mod Teması 🌙

Karanlık mod desteği olan uygulamalar için harika.
...
### Örnek 4: Eğlenceli Renkli Tema 🌈

Yaratıcı ve eğlenceli uygulamalar için mükemmel.
...
### Örnek 5: Kurumsal Profesyonel Tema 💼

İş ve kurumsal uygulamalar için uygundur.
...
### 7. Görsel Hiyerarşiyi Sürdürmek
