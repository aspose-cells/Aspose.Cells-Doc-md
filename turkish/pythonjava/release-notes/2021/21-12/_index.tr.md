...
{{% alert color="primary" %}}
 ...
 Bu sayfa için sürüm notları içerir[Aspose.Cells for Python via Java 21.12](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-21.12/).
