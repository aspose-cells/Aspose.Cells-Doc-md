...
Java üzerinden Python için Aspose.Cells, çalışan ODS dosyalarını destekler. Aşağıdaki örnekler, Excel'in bir ODS dosyasına dönüştürülmesini göstermektedir.
### **Doğrudan Dönüşüm**
