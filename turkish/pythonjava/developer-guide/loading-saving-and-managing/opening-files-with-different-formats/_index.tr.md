...
description: Aspose.Cells for .NET API, XLSX, HTML, CSV, ODS, TSV, SXC, FODS gibi farklı formatları açmanızı/okumanızı sağlar.
...
[Desteklenen Dosya Biçimleri](https://docs.aspose.com/cells/python-java/supported-file-formats/)
