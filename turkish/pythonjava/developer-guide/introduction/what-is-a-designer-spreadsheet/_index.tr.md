...
### **Akıllı İşaretleyiciler**
 ...
 Ek olarak, Aspose.Cells, eklemenizi sağlar[akıllı işaretleyiciler](/cells/tr/python-java/smart-markers/) tasarımcı e-tablosuna. Akıllı işaretleyiciler, çalışma zamanında aşağıdakiler kullanılarak işlenir:[**Çalışma KitabıTasarımcısı**](https://reference.aspose.com/cells/python-java/asposecells.api/WorkbookDesigner) sınıfın İşlem yöntemi. Bu, daha az kod yazmanıza ve yine de harika sonuçlar almanıza yardımcı olabilir.
