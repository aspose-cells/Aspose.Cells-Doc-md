---
title: CSV Dosyalarını Aç
type: docs
weight: 10
url: /tr/python-java/open-csv-files/
---
## **CSV Dosyalarını Aç**
Virgülle Ayrılmış Değerler (CSV) dosyaları, değerleri virgülle ayrılmış veya ayrılmış kayıtlar içerir. Elektronik tablonuzu CSV formatında kaydetmek için Microsoft Excel'i kullanabilirsiniz.
