---
title: Sayı Ayarlarıyla Golang ile C++ kullanımı
...
type: docs
weight: 10
url: /tr/go-cpp/cells-number-settings/
---
...
Aspose.Cells, sayıların ve tarihlerin görüntüleme formatlarını yapılandırmak için bazı dahili sayı formatları sunar. Bu dahili sayı formatları, [**Style**](https://reference.aspose.com/cells/cpp/aspose.cells/style/) nesnesinin [**Number**](https://reference.aspose.com/cells/go-cpp/style/getnumber/) özelliğini kullanarak uygulanabilir. Tüm dahili sayı formatları benzersiz sayısal değerlere sahiptir. Geliştiriciler, istenen herhangi bir sayısal değeri [**Style**](https://reference.aspose.com/cells/cpp/aspose.cells/style/) nesnesinin [**Number**](https://reference.aspose.com/cells/go-cpp/style/getnumber/) özelliğine atayarak görüntüleme formatını uygulayabilir. Bu yaklaşım hızlıdır. Aspose.Cells tarafından desteklenen dahili sayı formatları aşağıda listelenmiştir.
...
Görüntüleme formatını ayarlama için kendi özel biçim dizinizi tanımlamak için [**Style**](https://reference.aspose.com/cells/go-cpp/style/) nesnesinin [**Custom**](https://reference.aspose.com/cells/go-cpp/style/getcustom/) özelliğini kullanın. Bu yaklaşım, önceden belirlenmiş formatları kullanmaktan daha hızlı olmasa da daha esnektir.

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-NumberSettings-1.go" >}}
{{% alert color="primary" %}}

[**Custom**](https://reference.aspose.com/cells/go-cpp/style/getcustom/) özelliğini kullanarak sayı formatını ayarlarsanız, [**Number**](https://reference.aspose.com/cells/cpp/aspose.cells/style/getnumber/) özelliğini kullanarak ayarlanan önceki biçim üzerine yazılır ve aynısı geçerlidir.
