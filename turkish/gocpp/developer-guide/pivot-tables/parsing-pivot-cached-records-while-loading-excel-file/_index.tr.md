---
title: Golang ile C++ aracılığıyla Excel dosyasını yüklerken Pivot Önbellek Kayıtlarını çözümleme
linktitle: Pivot Önbellek Kayıtlarını Ayrıştırma
type: docs
weight: 70
url: /tr/go-cpp/parsing-pivot-cached-records-while-loading-excel-file/
