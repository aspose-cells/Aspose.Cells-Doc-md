---
title: Farklı Dosya Kaydetme Yöntemleri Golang kullanarak C++ ile
linktitle: Dosyaları Kaydet
type: docs
weight: 40
url: /tr/go-cpp/different-ways-to-save-files/
...
Aspose.Cells, bir Microsoft Excel dosyasını temsil eden ve Excel dosyalarıyla çalışmak için gerekli özellikleri ve yöntemleri sağlayan [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) sunar. [**Workbook**](https://reference.aspose.com/cells/go-cpp/workbook/) sınıfı, Excel dosyalarını kaydetmek için kullanılan [**Save**](https://reference.aspose.com/cells/go-cpp/workbook/save/) yöntemini sağlar. [**Save**](https://reference.aspose.com/cells/go-cpp/workbook/save/) yöntemi, farklı şekillerde dosyaları kaydetmek için kullanılan birçok aşırı yüklemeye sahiptir.

Dosyanın kaydedildiği dosya biçimi, [**SaveFormat**](https://reference.aspose.com/cells/go-cpp/saveformat/) numaralandırmasına göre belirlenir
