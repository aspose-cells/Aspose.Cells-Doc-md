...
type: docs
weight: 20
url: /tr/go-cpp/copying-rows-and-columns/
---
...
Aspose.Cells, ICells sınıfının CopyColumn metodunu sağlar; bu metod, formüller ile birlikte güncellenmiş referanslar ve değerler, yorumlar, hücre biçimleri, gizlenmiş hücreler, resimler ve diğer çizim nesneleri dahil olmak üzere tüm veri türlerini kaynak sütundan hedef sütuna kopyalar.
