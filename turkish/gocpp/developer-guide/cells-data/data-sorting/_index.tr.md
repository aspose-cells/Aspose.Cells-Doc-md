---
title: Golang ve C++ kullanarak Veri Sıralama
linktitle: Veri Sıralama
type: docs
weight: 130
url: /tr/go-cpp/sort-data-of-excel/
...
Aspose.Cells, verileri artan veya azalan sırada sıralamak için kullanılan [**DataSorter**](https://reference.aspose.com/cells/go-cpp/datasorter/) sınıfını sağlar. Sınıf, örneğin Key1 ... Key3 ve Order1 ... Order3 gibi önemli üyelere sahiptir. Bu üyeler sıralı anahtarları tanımlamak ve anahtar sıralama sırasını belirlemek için kullanılır.

Veri sıralaması gerçekleştirmeden önce anahtarları tanımlamalı ve sıralama düzenini belirlemelisiniz. Sınıf, çalışsayadaki hücre verilerine dayalı veri sıralamasını gerçekleştirmek için kullanılan [**Sort**](https://reference.aspose.com/cells/go-cpp/datasorter/sort_cells_int_int_int_int/) yöntemini sağlar.

[**Sort**](https://reference.aspose.com/cells/go-cpp/datasorter/sort_cells_int_int_int_int/) yöntemi aşağıdaki parametreleri kabul eder:

- [**Cells**](https://reference.aspose.com/cells/go-cpp/cells/), altındaki çalışsayadaki hücreler.
- [**CellArea**](https://reference.aspose.com/cells/go-cpp/cellarea/), hücre aralığı. Veri sıralaması uygulamadan önce hücre alanını tanımlayın.
