---
title: Java 22.8 Sürüm Notları aracılığıyla Node.js için Aspose.Cells
type: docs
weight: 5
url: /tr/nodejs-java/aspose-cells-for-node-js-via-java-22-8-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Java 22.8 üzerinden Node.js için Aspose.Cells](https://releases.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-22.8/).
