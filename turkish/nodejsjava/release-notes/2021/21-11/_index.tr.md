---
title: Java 21.11 Sürüm Notları aracılığıyla Node.js için Aspose.Cells
type: docs
weight: 2
url: /tr/nodejs-java/aspose-cells-for-node-js-via-java-21-11-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Java 21.11 üzerinden Node.js için Aspose.Cells](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.11/).
