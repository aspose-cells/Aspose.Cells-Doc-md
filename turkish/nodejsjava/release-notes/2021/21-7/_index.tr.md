---
title: Java aracılığıyla Node.js için Aspose.Cells 21.7 Sürüm Notları
type: docs
weight: 6
url: /tr/nodejs-java/aspose-cells-for-node-js-via-java-21-7-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Java 21.7 üzerinden Node.js için Aspose.Cells](https://downloads.aspose.com/cells/nodejs/new-releases/aspose.cells-for-node.js-via-java-21.7/).
