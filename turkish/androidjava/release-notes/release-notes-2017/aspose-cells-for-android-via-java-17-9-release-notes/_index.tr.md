...
|CELLSJAVA-42379|PDF çıktısına işlerken Adlandırılmış Hedefi uygulama (Yer imi sorgusu)|Yeni özellik|
...
|CELLSJAVA-42308|HTML oluşturma için PivotTable sorunları (eksik satırlar, iki kez yazdırılan pivot alan başlıkları, sayısal değerlere dönüştürülen tarih vb.)|Böcek|
