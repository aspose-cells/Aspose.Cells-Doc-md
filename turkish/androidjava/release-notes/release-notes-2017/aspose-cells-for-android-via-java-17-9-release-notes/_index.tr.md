...
|CELLSJAVA-42379|PDF çıktısına dönüştürülürken Adlandırılmış Hedef uygulanıyor (Yer imi sorgusu)|Yeni özellik|
...
|CELLSJAVA-42308|HTML işleme için PivotTable sorunları (eksik satırlar, iki kez yazdırılan pivot alan başlıkları, sayısal değerlere dönüştürülen tarih vb.)|Böcek|
...
|CELLSJAVA-42314|Grafik PNG çıktısında Boş|Böcek|
|CELLSJAVA-42313|Grafik PDF çıktısında Boş|Böcek|
