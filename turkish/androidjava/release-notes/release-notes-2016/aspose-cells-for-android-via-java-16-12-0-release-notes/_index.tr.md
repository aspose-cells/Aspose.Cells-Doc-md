...
|CELLSJAVA-41438|PDF'ye kaydederken seçim veya kontrol durumu kaydedilmiyor|Böcek|
...
|CELLSJAVA-42073|Yeniden kaydetme işleminden sonra XLSM bozuluyor|Böcek|
|CELLSJAVA-42060|Elektronik tabloyu HTML'ye dönüştürürken DataBar genişliği doğru değil|Böcek|
|CELLSJAVA-42016|Turuncu Satır Pivot Tablo Toplamına dahil değil|Böcek|
|CELLSJAVA-42006|Çıktı HTML'sinde görüntü kesiliyor|Böcek|
|CELLSJAVA-42067|E-tablo HTML'ye dönüştürülürken grafik eksik|Böcek|
|CELLSJAVA-41983|XLSX'i HTML'ye dönüştürürken satır yüksekliği doğru değil|Böcek|
|CELLSJAVA-42089|DCOUNTA Excel formülü, Aspose.Cells formül hesaplama motoru tarafından iyi değerlendirilmedi|Böcek|
|CELLSJAVA-42081|Bir XLSM dosyasını PDF olarak kaydederken DataBar Koşullu Biçimlendirme ile ilgili sorun|Böcek|
|CELLSJAVA-42100|Çıktı PDF dosyasında birkaç yerde belirli karakterler arasındaki boşluk kaldırılıyor|Böcek|
...
|CELLSJAVA-42077|Çıktı PDF'sinde TextBox'ın yazı tipi nitelikleriyle ilgili sorun|Böcek|
|CELLSJAVA-42064|Çalışma sayfası EMF'ye dönüştürülürken TextBox'ın içerik rengi ve boyutu değişti|Böcek|
|CELLSJAVA-42063|Elektronik tabloyu PDF'ye dönüştürürken TextBox'ın içerik rengi ve boyutu değişti|Böcek|
|CELLSJAVA-42059|Bir Excel dosyasını PDF dosya formatına dönüştürürken İbranice kelimeler doğru şekilde oluşturulmuyor|Böcek|
|CELLSJAVA-42053|Elektronik tablo PDF'ye dönüştürülürken TextBox'taki içerik kırpılıyor|Böcek|
|CELLSJAVA-42052|Elektronik tabloyu PDF'ye dönüştürürken oklu çizgiler yanlış yerleştirilmiş|Böcek|
...
|CELLSJAVA-42024|Açıklama, Chart'ın PDF'sindeki metinle örtüşüyor|Böcek|
|CELLSJAVA-42070|Yanlış ChartPoint'in ShapeXPx & ShapeYPx değerleri|Böcek|
|CELLSJAVA-42083|XLS'yi HTML'ye dönüştürürken Dikdörtgen şeklinin eksik oluşturulması|Böcek|
|CELLSJAVA-42104|Elektronik tablo PDF dosya biçimine dönüştürülürken metin kesiliyor|Böcek|
|CELLSJAVA-42098|Bazı sayfalar tek bir PDF sayfasında tamamen işlenmediği için fazladan sayfalar eklendi|Böcek|
...
|CELLSJAVA-42054|Elektronik tablo PDF'ye dönüştürülürken Metin Kutularına beklenmeyen arka plan rengi uygulandı|Böcek|
|CELLSJAVA-42072|java.lang.ArrayIndexOutOfBounds Workbook.calculateFormula İstisnası(yanlış)|İstisna|
|CELLSJAVA-42066|Bir XLS'yi PDF'ye dönüştürürken Workbook.save'de CellsException|İstisna|
...
Dosyanın Mutlak yolunu alır ve ayarlar. Yalnızca harici bağlantılar için.
...
### **Eski Cells.MaxDataRowInColumn(int sütunu) yöntemini kaldırır.**
Bunun yerine Cells.GetLastDataRow(int) yöntemini kullanın.
### **Eskimiş PageSetup.Draft özelliğini kaldırır.**
