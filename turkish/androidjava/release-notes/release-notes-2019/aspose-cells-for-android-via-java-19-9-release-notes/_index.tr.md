---
title: Java 19.9 Sürüm Notları aracılığıyla Android için Aspose.Cells
type: docs
weight: 20
url: /tr/java/aspose-cells-for-android-via-java-19-9-release-notes/
---
{{% alert color="primary" %}} 

Bu sayfa, Java 19.9 aracılığıyla Android için Aspose.Cells için sürüm notları içerir.

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
|:- |:- |:- |
|CELLSANDROID-92|Destek Ürünü.Aile lisansı|Yeni özellik|
|CELLSJAVA-42949|Aspose.Cells, ECDSA ve RSA algoritmalarını destekliyor mu?|Yeni özellik|
|CELLSJAVA-42979|Pdf/resme dönüştürmeden önce toplam sayfa sayısını alın|Yeni özellik|
|CELLSJAVA-42967|SVG dosyasını çalışma sayfasına ekleyin|Yeni özellik|
...
|Böcek|
|CELLSJAVA-42970|Excel'den PDF'e dönüştürmede istenmeyen uzatılmış sınır çizgisi|Böcek|
