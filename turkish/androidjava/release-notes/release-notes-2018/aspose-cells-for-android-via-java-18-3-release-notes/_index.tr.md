...
|:- |:- |:- |
|CELLSJAVA-42493|Çalışma kitabı özelliklerinin dışa aktarılıp aktarılmayacağına karar vermek için bir seçenek sağlayın|Yeni özellik|
|CELLSJAVA-42491|Belge özelliklerinin dışa aktarılıp aktarılmayacağına karar vermek için bir seçenek sağlayın|Yeni özellik|
...
|CELLSJAVA-42519|PdfSaveOptions.DrawObjectEventHandler, ImageOrPrintOptions.DrawObjectEventHandler gibi gereklidir|Yeni özellik|
