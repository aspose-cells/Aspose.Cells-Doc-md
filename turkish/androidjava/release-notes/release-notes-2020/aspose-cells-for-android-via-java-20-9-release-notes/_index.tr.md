---
title: Java 20.9 Sürüm Notları aracılığıyla Android için Aspose.Cells
type: docs
weight: 9
url: /tr/java/aspose-cells-for-android-via-java-20-9-release-notes/
---
{{% alert color="primary" %}}

Bu sayfa, Java 20.9 aracılığıyla Android için Aspose.Cells için sürüm notları içerir.
...
|CELLSJAVA-43234|2014'ten önceki veriler Pivot Tablodan okunmuyor|Böcek|
...
|CELLSJAVA-43288|Ortaya çıkan XLSB dosyası, dosyayı XLSB'ye kaydederken bozuk|Böcek|
...
|CELLSJAVA-43291|ızgara içeriği gösterilmiyor|Böcek|
...
|CELLSJAVA-43170|HesaplamaFormula yönteminde CellsException|İstisna|
...
### **CalculationOptions.CustomFunction özelliğini geçersiz olarak işaretler.**
 ...
 Lütfen kullan**SoyutHesaplamaMotoru** onun yerine**ICustomFunction** ile**CalculationOptions.CustomEngine** Emlak.
...
### **Cells.RemoveDuplicates() yöntemini ekler.**
 ...
 aşırı yüklenmiş yöntem**Cells.Yinelenenleri Kaldır(...)** tüm sayfadaki yinelenen satırları kaldırmak için kullanıcının rahatlığı için.
...
### **Eski Filter.Visibledropdown özelliği.**
 ...
 Kullanmak**FilterColumn.IsDropdownVisible** yerine.
