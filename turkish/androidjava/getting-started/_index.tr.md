...
type: docs
weight: 10
url: /tr/java/aspose-cells-for-android-via-java-features/
---

## **Aspose.Cells Android via Java Özellikler Genel Bakışı**
Bu bölüm, Aspose.Cells for Java ile Aspose.Cells for Android via Java arasındaki özelliklerin kullanılabilirliği üzerine bir karşılaştırma sunmaktadır.
...
|Microsoft Excel Çalışma Kitabı (XLS/XLSB)|Bulabileceğiniz en hızlı ve en kapsamlı XLS/XLSB formatı uygulaması.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Elektronik tablo sayfalarını raster görüntülerine (Çoklu sayfa TIFF, GIF) dönüştürme.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|**Özellik**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- |
|Bir Dizi, ArrayList, ResultSet vb. veri içe/dışa aktarma.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Satırları, sütunları ve sayfaları ekleme/silme veya gizleme|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Özellik**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- |
|Hücrelerdeki tüm karakter biçimlendirmelerini (yazı tipleri, renkler, efektler, kenarlıklar ve gölgelendirme dahil) uygulayın.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Çalışma sayfası, satır, sütun veya hücre aralığı gibi Format ayarlarını uygulayın.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
