---
title: C++ kullanarak Node.js ile İsimlendirilmiş Aralıkları biçimlendirme ve değiştirme
linktitle: Biçimlendirme ve Adlandırılmış Aralıkları Düzenleme
type: docs
weight: 85
url: /tr/nodejs-cpp/format-and-modify-named-ranges/
description: Aspose.Cells for Node.js via C++ kullanarak isimlendirilmiş aralıkları nasıl biçimlendirilip değiştireceğinizi öğrenin. 
---
...
Biçimlendirme uygulamak için, stil ayarlarını belirten bir [**Style**](https://reference.aspose.com/cells/nodejs-cpp/style) nesnesi tanımlayın ve bunu [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range) nesnesine uygulayın.
...
Bir tek hücre yerine, hücre aralığına sınır ekleme mümkündür. [**Range**](https://reference.aspose.com/cells/nodejs-cpp/range) nesnesi, hücre aralığına sınır eklemek için aşağıdaki parametreleri alan bir [**setOutlineBorder(BorderType, CellBorderType, CellsColor)**](https://reference.aspose.com/cells/nodejs-cpp/range/#setOutlineBorder-bordertype-cellbordertype-cellscolor-) metodu sağlar.

- Kenar tipi, kenar türü, [**BorderType**](https://reference.aspose.com/cells/nodejs-cpp/bordertype) sıralamasından seçilir.
- Çizgi stili, çizgi stili, [**CellBorderType**](https://reference.aspose.com/cells/nodejs-cpp/cellbordertype) sıralamasından seçilir.
...
Aspose.Cells, aralıklar arasında birleşim yapmak için [**Range.unionRang(Range)**](https://reference.aspose.com/cells/nodejs-cpp/range/#unionRang-range-) metodunu sağlar; bu metod bir [*dizi*] nesnesi döndürür. Aşağıdaki örnek, aralıklar arasında birleşim yapmayı gösterir.
...
Aspose.Cells, aralıktaki hücreleri birleştirmek için [**Range.merge()**](https://reference.aspose.com/cells/nodejs-cpp/range/#merge--) metodunu sağlar. Aşağıdaki örnek, isimlendirilmiş bir aralıktaki hücreleri nasıl birleştireceğinizi gösterir.
