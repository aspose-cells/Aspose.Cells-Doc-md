...
type: docs
weight: 60
url: /tr/nodejs-cpp/draw-slicer-while-rendering-excel-to-pdf/
---
...
Dilime uygulanmış bir Excel dosyanız varsa ve dilimleyici ayarlarıyla birlikte PDF'ye dışa aktarmak istiyorsanız, Aspose.Cells for Node.js via C++ artık bunu varsayılan olarak destekliyor. Sadece dilimleyici ile Excel dosyasını PDF'ye dışa aktarın, oluşturulan PDF dilimleyici uygulamasını gösterecektir.
