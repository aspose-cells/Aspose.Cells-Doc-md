...
type: docs  
weight: 600  
url: /tr/nodejs-cpp/how-to-manage-dates-and-times/  
description: Aspose.Cells for Node.js via C++ API si aracılığıyla tarihleri ve saatleri nasıl yöneteceğinizi öğrenin.  
...
Bir sayıyı tarih ve saat olarak göstermek için, hücreye gerekli tarih ve saat biçimi uygula [Style.getNumber()](https://reference.aspose.com/cells/nodejs-cpp/style/#getNumber--) veya [Style.Custom]() özelliği kullanılır. CellValue.DateTimeValue özelliği, hücredeki sayıyla temsil edilen tarih ve saati belirten DateTime nesnesini döner.  
<br>  
...
1. 1904 tarih sistemi. İlk tarih 1 Ocak 1904 olup, seri değeri 0'dır. Son tarih 31 Aralık 9999 olup, seri değeri 2.957.003'tür. Bu tarih sistemini çalışma kitabında kullanmak için, [WorkbookSettings.getDate1904()](https://reference.aspose.com/cells/nodejs-cpp/workbooksettings/#getDate1904--) özelliğini true yapın.  
