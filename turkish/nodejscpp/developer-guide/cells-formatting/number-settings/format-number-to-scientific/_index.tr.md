...
type: docs
weight: 10
url: /tr/nodejs-cpp/how-to-format-number-to-scientific/
description: Bu makale, Aspose.Cells for Node.js via C++ API kullanarak Sayıyı Bilimsel Sayıya Biçimlendirme yöntemlerini tanıtacaktır.
...
## **Aspose.Cells for Node.js via C++ sayısını bilimsel gösterime biçimlendirme nasıl yapılır**
Aspose.Cells for Node.js via C++ sayısını bilimsel gösterime çevirmek için, bir hücrenin `Style.setCustom` metodunu kullanabilirsiniz. Aspose.Cells, çalışma sayfalarınızdaki veriler için özel biçimlendirme tanımlamanıza olanak tanır, bunlar arasında bilimsel gösterim de bulunur.
