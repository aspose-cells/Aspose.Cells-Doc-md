---
title: Excel metin kutusu veya şeklin karakter aralığını Node.js ve C++ kullanarak değiştirin
linktitle: Excel Metin Kutusu veya Şeklin Karakter Boşluğunu Değiştirme
type: docs
weight: 280
url: /tr/nodejs-cpp/change-character-spacing-of-excel-textbox-or-shape/
description: Aspose.Cells for Node.js via C++ kullanarak Excel metin kutuları veya şekillerinin karakter aralığını değiştirin. 
---

{{% alert color="primary" %}}

Bir Excel metin kutusu veya şeklin karakter aralığını [**TextOptions.getSpacing()**](https://reference.aspose.com/cells/nodejs-cpp/textoptions/#getSpacing--) özelliği kullanarak değiştirebilirsiniz.
