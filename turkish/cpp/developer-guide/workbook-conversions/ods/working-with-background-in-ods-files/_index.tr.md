---
title: C++ ile ODS Dosyalarında Arka Plan ile Çalışmak
linktitle: ODS Dosyalarında Arka Planla Çalışma
type: docs
weight: 150
url: /tr/cpp/working-with-background-in-ods-files/
description: Aspose.Cells kullanarak ODS dosyalarında renkli ve grafik arka planları nasıl yönetileceğini öğrenin.
---
...
Aspose.Cells, ODS dosyalarında arka planı yönetmek için [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/) sınıfını sağlar. Aşağıdaki kod örneği, [kaynak ODS dosyasını](90112030.ods) yükleyerek ve arka plan bilgilerini okuyarak [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/) sınıfının kullanımını gösterir. Lütfen, kod tarafından oluşturulan Consol Çıktısını referans olarak inceleyiniz.
...
Aspose.Cells, ODS dosyalarında arka planı yönetmek için [**OdsPageBackground**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/) sınıfını sağlar. Aşağıdaki kod örneği, [**OdsPageBackground.GetGraphicData()**](https://reference.aspose.com/cells/cpp/aspose.cells.ods/odspagebackground/getgraphicdata/) özelliğini kullanarak ODS dosyasına grafik arka plan eklemeyi gösterir. Lütfen, kod tarafından oluşturulan [çıktı ODS](90112030.ods) dosyasını referans alın.
