---
title: Excel Tablosu Oluşturun ve Yönetin
type: docs
weight: 30
url: /tr/cpp/create-and-manipulate-excel-table/
---
## **Olası Kullanım Senaryoları**
Aspose.Cells, yeni veya mevcut liste nesneleri veya tabloları oluşturmanıza ve değiştirmenize olanak tanır. Başlık satırı stili, sütun şeritleri, stil tipi, ara toplamı göster vb. gibi liste nesnesinin veya tablonun çeşitli yöntemlerini kullanabilir ve ayrıca tablonun ayrı ayrı sütunlarıyla çalışabilir ve adlarını ve Min. olabilecek toplam hesaplama işlevini ayarlayabilirsiniz. , Maks, Sayım, Ortalama, Toplam vb.
