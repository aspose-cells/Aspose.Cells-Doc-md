---
title: Excel Çalışma Kitabını PDF'e Dönüştür
type: docs
weight: 80
...
{{% alert color="primary" %}} 
 ...
 Aspose.Cells, API ve Sürüm Numarası ile ilgili bilgileri doğrudan çıktı belgelerine yazar. Örneğin, Belge PDF'e işlendiğinde, Aspose.Cells for C++,**Uygulama** 'Aspose.Cells' değerine sahip alan ve**PDF Yapımcı** değeri olan alan, örneğin 'Aspose.Cells v18.5.0'.
...
{{% /alert %}} 
### **Doğrudan Dönüşüm**
Aspose.Cells, diğer yazılımlardan bağımsız olarak elektronik tablolardan PDF'e dönüştürmeyi destekler. kullanarak bir Excel dosyasını PDF'e kaydetmeniz yeterlidir.[IÇalışma Kitabı](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook)sınıf'[Kayıt etmek](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a77072cfb929787df9ad1f38b02f58349)yöntem. bu[Kayıt etmek](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a77072cfb929787df9ad1f38b02f58349)yöntemi sağlar[SaveFormat_Pdf](https://reference.aspose.com/cells/cpp/namespace/aspose.cells#a11cae527e4e68f1adcac8f47ea64481a)yerel Excel dosyalarını PDF biçimine dönüştüren numaralandırma üyesi.
...
1.  Elektronik tablo kodu tamamlandığında,[IÇalışma Kitabı](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook)sınıf'[Kayıt etmek](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a77072cfb929787df9ad1f38b02f58349)elektronik tabloyu kaydetme yöntemi.
...
İle**IPdfSaveSeçenekleri** sınıf, PDF oluşturma saatini alabilir veya ayarlayabilirsiniz.
