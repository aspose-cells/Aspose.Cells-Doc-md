...
|![yapılacaklar:resim_alternatif_metin](kJmukRF.png)|
 Veriler için List nesnesini uygulamak ve toplam satırı belirtmek (Select**Veri** , o zamanlar**Liste** , bunu takiben**Toplam Satır**).
