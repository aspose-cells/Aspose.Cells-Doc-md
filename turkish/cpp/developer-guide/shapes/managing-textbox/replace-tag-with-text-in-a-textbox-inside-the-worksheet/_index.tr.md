---
title: C++ kullanarak Çalışma Sayfası içindeki bir TextBox taki etiketi metinle değiştirin
linktitle: Çalışsayıdaki bir metin kutusundaki etiketi bir metinle değiştirin.
type: docs
weight: 1100
url: /tr/cpp/replace-tag-with-text-in-a-textbox-inside-the-worksheet/
description: Aspose.Cells for C++ kullanarak çalışma sayfası içi textbox larda etiketleri programlı olarak değiştirin.
---
