---
title: C++ ile her satırı farklı Yatay Hizalamaya sahip TextBox oluşturma
linktitle: Farklı Yatay Hizalamaya sahip TextBox oluşturma
type: docs
weight: 310
url: /tr/cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: Aspose.Cells kullanarak C++ ile her satır için farklı yatay hizalama ile TextBox oluşturmayı öğrenin.
---

{{% alert color="primary" %}}

Paragraf metnin yatay hizalamasını [**TextParagraph.GetAlignmentType()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.texts/textparagraph/getalignmenttype/) özelliği kullanarak ayarlayabilirsiniz.
