---
title: Boş veya boş olmayan verileri filtreleme yolları ve C++ kullanımı
linktitle: Boş veya Boş olmayanları Filtreleme
type: docs
weight: 85
url: /tr/cpp/how-to-filter-blanks-and-non-blanks/
...
Bir sütun çok az hücre boş içeriyorsa ve yalnızca boş hücrelerin bulunduğu satırları seçmek için filtreleme gerekiyorsa, [AutoFilter.MatchBlanks(int fieldIndex)](https://reference.aspose.com/cells/cpp/aspose.cells/autofilter/matchblanks/) ve [AutoFilter.AddFilter(int fieldIndex, string criteria)](https://reference.aspose.com/cells/cpp/aspose.cells/autofilter/addfilter/) fonksiyonları aşağıda gösterildiği gibi kullanılabilir. 
