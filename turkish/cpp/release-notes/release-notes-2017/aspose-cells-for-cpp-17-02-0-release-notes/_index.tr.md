...
type: docs
weight: 30
url: /tr/cpp/aspose-cells-for-cpp-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[CPP 17.02.0 için Aspose.Cells](https://downloads.aspose.com/cells/cpp/new-releases/aspose.cells-for-c---17.02.0/).
...
1. [Formül Ekleme ve Sonuçları Hesaplama](/cells/tr/cpp/ways-to-calculate-formulas#waystocalculateformulas-addingformulas&calculatingresults)
1. [Formülün Doğrudan Hesaplanması](/cells/tr/cpp/ways-to-calculate-formulas#waystocalculateformulas-directcalculationofformula)
1. [Formülleri Yalnızca Bir Kez Hesaplama](/cells/tr/cpp/ways-to-calculate-formulas#waystocalculateformulas-calculatingformulasonceonly)
1. [ICustomFunction Özelliğini Kullanma](/cells/tr/cpp/using-icustomfunction-feature#usingicustomfunctionfeature-usingicustomfunctionfeature) 
