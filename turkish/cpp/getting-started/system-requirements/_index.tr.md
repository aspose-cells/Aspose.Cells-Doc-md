...
<table>  
  ...
  <tr>
			...
			<td><ul><li>Windows 2008 Sunucu (x64, x86)</li><li>Windows 2012 Sunucusu (x64, x86)</li><li>Windows 2012 R2 Sunucusu (x64, x86)</li><li>Windows 2016 Sunucusu (x64, x86)</li><li>Windows 2019 Sunucu (x64, x86)</li><li>Windows Vista (x64, x86)</li><li>Windows 7 (x64, x86)</li><li>Windows 8, 8.1 (x64, x86)</li><li>Windows 10 (x64, x86)</li></ul></td>
		</tr>
  <tr>
			<td>linux</td>
			<td><ul><li>Ubuntu 18.04 veya üstü</li><li>Fötr şapka</li><li>OpenSUSE</li><li>CentOS</li><li>ve diğerleri</li></ul></td>
		</tr>
</table>
...
<table>  
  ...
  <tr>
			<td><ul><li>GCC 7.5.0 veya üstü</li><li>CMake 3.0.0 veya üzeri</li></ul></td>
			</tr>
</table>
