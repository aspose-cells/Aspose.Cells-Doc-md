...
type: docs
weight: 10
url: /tr/reportingservices/introduction/
---
{{% alert color="primary" %}}
...
1. Microsoft Excel'i COM uygulamalarına açmak için sistem kayıt defterine gerekli tüm girişleri yapar.
1. Kod örnekleri almanızı sağlayan demo projeleri içerir.
