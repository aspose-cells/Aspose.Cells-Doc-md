---
title: Tablo için temel bilgileri ekleme
type: docs
weight: 20
url: /tr/reportingservices/adding-base-information-for-table/
---
Yeni bir tablo oluşturmak için:

1. Microsoft Excel'i açın.
1.  Tıklamak**Raporu Aç** 

![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_1)
...
![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_2.png)

1. Bir Microsoft Excel elektronik tablosu açın ve tablo başlığını aşağıdaki gibi tasarlayın:

   **Tablo başlığını tasarlama** 

![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_3.png)

1.  İlgili veri kümesi birleşik giriş kutusu kontrolünden bir veri kümesi "EmpSalesDetail" seçin.

   **Bir veri seti seçme** 

![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_4.png)
...
![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_5.png)



**Alan kodu, bir alanın nereye eklendiğini gösterir.** 

![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_6.png)

1.  ProdCat ve SubCat alanlarını eklemek için 5. adımı tekrarlayın.

   **Tüm alanlar eklendi** 

![yapılacaklar:resim_alternatif_Metin](adding-base-information-for-table_7.png)
