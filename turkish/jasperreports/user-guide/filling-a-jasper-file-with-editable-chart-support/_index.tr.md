...
{{% alert color="primary" %}} 
 ...
 Aspose.Cells for JasperReports, XLS dosyasına aktarılabilmesi için önce bir .jasper dosyasının bir .jrprint veya JasperPrint nesnesine doldurulmasını gerektirir. .jrxml dosyası için herhangi bir değişiklik yapılması gerekmez. Doldurma prosedürü, grafiklerin dahili temsillerini, daha sonra düzenlenebilir grafikler oluşturmak için kullanılan JasperPrint nesnesine depolar.
