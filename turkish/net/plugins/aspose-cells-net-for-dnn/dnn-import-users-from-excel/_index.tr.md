---
title: DNN Kullanıcıları Excel'den İçe Aktar
type: docs
weight: 30
...
- Excel dosyası yüklemenizi sağlar ve mevcut kullanıcıları otomatik olarak filtreler.
- Herhangi bir karışıklığı önlemek için mevcut kullanıcıları otomatik olarak atlar.
- Yeni oluşturulan kullanıcılar için dinamik parolalar oluşturun.
- Yeni oluşturulan kullanıcılara "Kayıtlı Kullanıcılar" ve "Aboneler" Güvenlik rolleri atar.
...
Bu modülleri DNN'nin diğer sürümlerine kurmak isterseniz lütfen bizimle iletişime geçmekten çekinmeyin.
## **indiriliyor**
Aspose .NET Cells DNN için Excel'den Kullanıcı İçe Aktar modülünü aşağıdaki konumlardan birinden indirebilirsiniz.
...
## **kullanma**
Aspose .NET Cells DNN için Excel'den Kullanıcı Al modülünü kurduktan sonra web sitenizde kullanmaya başlamak gerçekten çok basit. Başlamak için lütfen şu basit adımları izleyin:
...
1. Listeden 'Aspose DNN için Excel modülünden Kullanıcıları İçe Aktar' öğesini seçin ve konumuna sürükleyin.

DNN modülü için Aspose .NET Cells Import Users from Excel modülünü sayfanıza başarıyla eklediniz. Dosya Yükleme Kontrolleri, "Şablon Dosyası" bağlantısıyla birlikte görünür olacaktır. Şablon dosyasını indirebilir ve içeriklerinizi şablon dosyasına göre biçimlendirebilirsiniz. Excel dosyanızı yükledikten sonra otomatik olarak tüm kullanıcıları işler ve mevcut kullanıcıları filtreler. İçe aktarmak istediğiniz kullanıcıları seçip "Kullanıcıları İçe Aktar" düğmesine basabilirsiniz.
## **Video Demosu**
...
1.  İndirdiğiniz ve açtığınız en son kaynak koduna göz atın**Aspose.DNN.ImportUsersFromExcel.sln**
