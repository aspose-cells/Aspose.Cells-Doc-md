---
title: DNN Kullanıcıları ve Rolleri Excel'e Aktar
type: docs
weight: 20
...
Bu modülleri DNN'nin diğer sürümlerine kurmak isterseniz lütfen bizimle iletişime geçmekten çekinmeyin.
## **indiriliyor**
DNN modülü için Aspose .NET Cells Export Users and Roles to Excel'i aşağıdaki lokasyonlardan birinden indirebilirsiniz.
...
## **kullanma**
Aspose .NET Cells Export Users and Roles for DNN modülünü kurduktan sonra web sitenizde kullanmaya başlamak gerçekten çok basit. Başlamak için lütfen şu basit adımları izleyin:
...
1. Listeden 'Aspose Kullanıcıları ve Rolleri Excel'e Aktar'ı seçin ve konumuna sürükleyin.

Aspose .NET DNN için Kullanıcıları ve Rolleri Excel'e Aktar modülünü sayfanıza başarıyla eklediniz. Tüm dnn kullanıcıları ızgarada görünür olacak ve dışa aktarılacak kullanıcıları seçebilir ve açılır menüden istediğiniz çıktı biçimini seçtikten sonra "Dışa Aktar" düğmesine tıklayabilirsiniz. İstenen dosya otomatik olarak indirilecektir.
## **Video Demosu**
...
1.  İndirdiğiniz ve açtığınız en son kaynak koduna göz atın**Aspose.DNN.ExportUsersAndRolesToExcel.sln**
