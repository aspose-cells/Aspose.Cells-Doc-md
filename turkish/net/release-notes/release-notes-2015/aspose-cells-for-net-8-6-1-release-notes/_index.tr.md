...
type: docs
weight: 30
url: /tr/net/aspose-cells-for-net-8-6-1-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 8.6.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.6.1/)
...
(CELLSNET-43941) - Grafik doğru oluşturulmadı
 ...
 (CELLSNET-43984) - XLSM yeniden kaydedildiğinde Değiştirilecek Parola, Açılacak Parolaya dönüşür

 (CELLSNET-43983) - XLSX yeniden kaydedildiğinde Değiştirilecek Parola, Açılacak Parolaya dönüşür

 (CELLSNET-43982) - XLTM yeniden kaydedildiğinde Değiştirilecek Parola, Açılacak Parolaya dönüşür

 (CELLSNET-43981) - XLTM yeniden kaydedildiğinde Değiştirilecek Parola kayboluyor

 (CELLSNET-43980) - XLTX yeniden kaydedildiğinde Değiştirilecek Parola, Açılacak Parolaya dönüşür
...
(CELLSNET-43973) - XLSM yeniden kaydedildikten sonra değiştirilecek parola kayboluyor

 (CELLSNET-43968) - Excel uygulaması, ortaya çıkan XLSB'yi salt okunur olarak açmanızı önerir
 ...
 (CELLSNET-43931) - Adlandırılmış aralıktaki satırların silinmesi, elde edilen XLSX'i bozar
...
(CELLSNET-43927) - Diğer çalışma sayfasındaki listobject'e başvuran formülde #REF
 ...
 (CELLSNET-42110) - XLSX'te Aralıklar için ayarlanan kenarlık PDF'de gösterilmiyor


## **İstisnalar**


 (CELLSNET-43932) - Şekilden resme Hata! bir e-tabloyu PDF'ye dönüştürürken
 ...
 (CELLSNET-43918) - Şablon XLSX dosyasını açarken istisna
