...
type: docs
weight: 10
url: /tr/net/aspose-cells-for-net-v4-8-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET v4.8.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-v4.8.0/)
...
|8881 | Xl'ler| Bir dosyayı açarken ArgumentOutOfRangeException atar|
