...
type: docs
weight: 5
url: /tr/net/aspose-cells-for-net-22-8-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-51595|Pivot tablo ile Excel dosyasından PDF'ye dönüştürülürken hücre metninin yanlış dikey hizalaması|
|CELLSNET-51621|Paylaşılan formüller, farklı dosya biçimleri için yanlış kopyalandı|
|CELLSNET-51524|Pivot tablo ile Excel dosyasından PDF'ye dönüştürmede yanlış kelime kaydırma|
|CELLSNET-51675|PDF'ye dönüştürülürken şekil kayboluyor|
|CELLSNET-51435|Bir XLSB çalışma kitabını XLSM'ye dönüştürürken yeni çalışma sayfası ilişkileri eklenir|
...
|CELLSNET-51550|Adlandırılmış aralıklardaki bağlantılar, XLS'den XLSM'ye dönüştürmede siliniyor|
|CELLSNET-51551|XLS dosyaları XLSM'ye dönüştürülürken dosyalar bozuldu ve harici Bağlantı DDE bağlantısı olarak değiştirildi|
|CELLSNET-51558|xlAlternateStartup türü bağlantıya sahip XLS dosyalarını XLSM'ye dönüştürmek bozuk dosyaların çıktısını alıyor|
|CELLSNET-51564|Akıllı işaretleyicinin yinelenen verileri|
|CELLSNET-51574|İçinde iki sütun bulunan bir metin kutusu, bir XLSX dosyasını yeniden kaydederken yalnızca bir sütunla işlenir|
|CELLSNET-51580|xlPathMissing türündeki bir harici bağlantı, XLS'den XLSM'ye dönüştürmede normal externalLinkPath türüne değiştirilir|
|CELLSNET-51599|Html olarak kaydederken görüntü türü kaynakları için çok uzun adlar|
|CELLSNET-51627|Belirli XLSM dosyası yüklenemez|
|CELLSNET-51632|ŞeritXml çalışmıyor|
|CELLSNET-51696|XLS'yi XLSM'ye dönüştürmek, "Parolayı kaydet" veri bağlantısı tanımı özelliğini değiştiriyor|
|CELLSNET-51559|Bir XLSB dosyasını XLSM'ye dönüştürme İstisna "startIndex, dize uzunluğundan büyük olamaz"|
