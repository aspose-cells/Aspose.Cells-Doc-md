...
type: docs
weight: 6
url: /tr/net/aspose-cells-for-net-22-7-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-51492|XLSX'i HTML'ye dönüştürürken varsayılan yazı tipi uygulanmaz|
...
|CELLSNET-51472|Dış uç olarak ayarlandığında SVG'de grafik etiketleri eksik|
|CELLSNET-51491|Resim veya HTML'ye dönüştürülürken grafik serilerinde kullanılan yanlış değerler|
|CELLSNET-51525|Şelale grafiği, HTML/PNG veya PDF olarak dışa aktarıldığında farklıdır|
...
|CELLSNET-51418|xlPathMissing türündeki bir harici bağlantı, XLSB'den XLSM'ye dönüştürmede normal externalLinkPath türüne değiştirilir|
