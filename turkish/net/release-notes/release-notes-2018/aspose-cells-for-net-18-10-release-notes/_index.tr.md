...
type: docs
weight: 30
url: /tr/net/aspose-cells-for-net-18-10-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46383|Excel'i HTML dosya biçimine dönüştürürken görüntü kaynağıyla ilgili sorun|Böcek|
|CELLSNET-46367|XLSX'i HTML'ye dönüştürürken yazı tipi boyutu 6,5'ten 6'ya değiştirildi|Böcek|
|CELLSNET-46353| gibi boş etiketleri tanıyın<td /> HTML'yi MS Excel dosya formatına dönüştürürken|Böcek|
...
|CELLSNET-46321|Kaçış karakteri PDF'de olduğu gibi görüntülenir|Böcek|
|CELLSNET-46376|PDF çıktı sayfası boyutu (ve kenar boşlukları), MS Excel çıktısıyla eşleşmiyor|Böcek|
|CELLSNET-46373|Başlıktaki görüntünün yüksekliği, XLSM->PDF dönüştürme sırasında bozuk düzen ile birlikte kesildi|Böcek|
...
|CELLSNET-46385|Bir XLSX dosyasını yeniden kaydederken başlık resmi/şekli doğru şekilde oluşturulmuyor|Böcek|
...
|CELLSNET-46350|Görünüm, XLS -> XLSM -> XLS dönüştürülürken korumalı olarak değiştirildi|Böcek|
|CELLSNET-46347|XML (SpreadsheetML) dosyasından dönüştürüldükten sonra XLSX dosyası bozuk|Böcek|
