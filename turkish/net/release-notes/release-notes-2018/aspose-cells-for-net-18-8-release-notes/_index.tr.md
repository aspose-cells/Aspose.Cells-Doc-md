...
type: docs
weight: 50
url: /tr/net/aspose-cells-for-net-18-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-43560|Bir ODS dosyasını şifreleyin|Yeni özellik|
...
|CELLSNET-46263|XLS'yi PDF'ye dönüştürürken uygulama takılıyor|Verim|
|CELLSNET-46262|Cell çıktı PDF'sinde hücre metni yönü eğimli olduğunda arka plan yanlış|Böcek|
|CELLSNET-44761|Şekildeki metin PDF'de doğru şekilde oluşturulmadı|Böcek|
|CELLSNET-43916|E-tablo HTML'ye dönüştürülürken şekil gölgesi eksik|Böcek|
|CELLSNET-46251|Uygulama, XLSX'i HTML'ye dönüştürürken takılıyor|Böcek|
|CELLSNET-46241|HTML'de çok satırlı sorun|Böcek|
|CELLSNET-46219|HTML'yi XLSX'e dönüştürürken HTML etiketinden gelen genişlik izlenmiyor|Böcek|
...
|CELLSNET-46275|XLS'den oluşturulan büyük PDF|Böcek|
|CELLSNET-46259|Excel'i PDF'ye dönüştürmek düz bir çizgi ekler|Böcek|
|CELLSNET-46255|Excel'den PDF'e dönüştürmede sayfa numarası sorunu (alt bilgide)|Böcek|
|CELLSNET-46238|Şifreli ODS dosyası yükleme başarısız oldu|Böcek|
|CELLSNET-46231|Sütun A hücrelerindeki metin, çıktı PDF'sinde düzgün şekilde oluşturulmuyor|Böcek|
|CELLSNET-46165|Aspose.Cells, bir Excel dosyasını PDF dosya formatına dönüştürmeye çalışırken yanıt vermiyor|Böcek|
...
|CELLSNET-46235|Görüntü, XLS biçiminde kaydedilirken görüntülenemiyor|Böcek|
...
|CELLSNET-45377|Veri bağlantıları XLS belgesinde bulunamadı|Böcek|
|CELLSNET-44487|XLT'yi XLSM'ye dönüştürürken Veri Bağlantısı kesildi|Böcek|
|CELLSNET-44486|XLS'yi XLSM'ye dönüştürürken Veri Bağlantısı kesildi|Böcek|
|CELLSNET-43563|XLSX, ODS'ye dönüştürüldüğünde grafikler kayboluyor|Böcek|
