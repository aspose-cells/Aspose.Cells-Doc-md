...
type: docs
weight: 80
url: /tr/net/aspose-cells-for-net-18-5-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46080|PDF'ye dönüştürülürken görüntünün rengi siyah olmalıdır|Artırma|
|CELLSNET-46087|Sayfa Yapısı PrintErrorType, Excel'de PDF oluşturmaya çalışmıyor|Artırma|
|CELLSNET-46084|PageSetup.PrintDraft, PDF'ye Kaydederken etkili olmuyor|Artırma|
|CELLSNET-46100|Excel dosyasını PDF'ye dönüştürürken System.OutOfMemoryException|Verim|
...
|CELLSNET-46110|"Sorun2 kaydırma-hayır" olduğunda metin kaydırma doğru değil_gelenek_page_size.xlsx" PDF'ye dönüştürülür|Böcek|
|CELLSNET-46109|"Issue2 wrapping.xlsx" PDF'ye dönüştürüldüğünde metin kaydırma doğru değil|Böcek|
|CELLSNET-46108|"Issue3 wrapping.xlsx" PDF'ye dönüştürüldüğünde metin kaydırma doğru değil|Böcek|
|CELLSNET-46088|Sayfa Yapısı yakınlaştırma faktörü, PDF'de yanlış sayıda sayfa oluşturur|Böcek|
...
|CELLSNET-46036|Grafik başlığı, karakterlerin tümünün Excel'de PDF oluşturmada birlikte çalıştığı yerde eziliyor|Böcek|
|CELLSNET-46082|Pasta grafik açıklama renkleri, PDF'ye kaydedildikten sonra değişir ve Pasta grafik dilimleriyle eşleşmez|Böcek|
|CELLSNET-46104|XLSB'yi XLSM'ye kaydetmek, bozuk MS Excel dosyası oluşturur|Böcek|
|CELLSNET-46098|Adlandırılmış aralıklar, var olan çalışma kitabına kopyalanırken kayboluyor|Böcek|
|CELLSNET-46077|Gömülü çizim nesneleri, bir XLSX dosyasını yeniden kaydederken çıktı dosyasında çok dar görünüyor|Böcek|
|CELLSNET-46068|Aspose.Cells, bir SpreadsheetML dosyasını PDF olarak kaydederken boş PDF döndürür|Böcek|
|CELLSNET-46060|ODS'yi XLSX dosya biçimine dönüştürürken veri kaybı oluyor|Böcek|
...
|CELLSNET-46059|Yükleme sırasında istisna attığı için XLS dosyası açılamıyor|İstisna|
|CELLSNET-46097|İstisna "Geçersiz formül:"'Yeni' Ad'!G11:G15"." pivot grafik verilerini yenilerken|İstisna|
|CELLSNET-46075|Bir Excel dosyasını PDF'ye dönüştürürken istisna|İstisna|
