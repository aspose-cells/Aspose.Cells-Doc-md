...
type: docs
weight: 120
url: /tr/net/aspose-cells-for-net-18-1-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45763|Şekil metni Excel'de döndürülerek PDF'e dönüştürülür|Böcek|
|CELLSNET-45669|Resme dönüştürülürken karakterler çakışıyor|Böcek|
|CELLSNET-45841|Power Pivot ile uğraşan XLSB dosyası açma ve yeniden kaydetme sırasında bozuluyor|Böcek|
...
|CELLSNET-45826|XLSX'i PDF'ye dönüştürdükten sonra görüntü özellikleri (Başlık ve Konu) kayboluyor|Böcek|
|CELLSNET-45811|Excel'i işlemek, bir miktar veri kaybıyla sağ sınırı keser|Böcek|
|CELLSNET-45808|Excel'i PDF'ye dönüştürmek, RTL dilini kullanırken kesme işaretli kelimeleri keser|Böcek|
|CELLSNET-45840|Grafik, XLS formatına - "mouseover olayı - embed.xls" kaydedildikten sonra uzatılır|Böcek|
...
|CELLSNET-45580|Belirli bir XLS dosyasında grafik boyutu değiştirilir|Böcek|
...
|CELLSNET-45847|SpreadsheetML - XLSX - Aspose.Cells, koruma ayarlarını belirler|Böcek|
...
|CELLSNET-45831|Dönüşümden sonra hesaplama zinciri parçası kaçırıldı (XLSB -> XLSM)|Böcek|
...
|CELLSNET-45812|Mutlak yol, bir XLSX dosyasını yeniden kaydederken göreli yol olarak değişir|Böcek|
|CELLSNET-45810|RGB(255, 0, 0), HtmlString atamasında Int32 için geçerli bir değer değil|Böcek|
|CELLSNET-44690|XLS'yi yeniden kaydetmek grafiği dikey olarak uzatır|Böcek|
|CELLSNET-44621|XLSB'den XLSM'ye dönüştürme: Ortaya çıkan dosya xl\queryTables\queryTable1 içermiyor|Böcek|
...
|CELLSNET-45823|Bir SpreadsheetML dosyasını açarken istisna|İstisna|
|CELLSNET-45817|Bir hücrede HtmlString'i belirli bir değere ayarlarken istisna|İstisna|
|CELLSNET-45832|Bir XLSM dosyasını GridWeb'e yüklerken istisna|İstisna|
