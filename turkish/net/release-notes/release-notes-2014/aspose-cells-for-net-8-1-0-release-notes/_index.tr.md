...
type: docs
weight: 60
url: /tr/net/aspose-cells-for-net-8-1-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 8.1.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.1.0/)
