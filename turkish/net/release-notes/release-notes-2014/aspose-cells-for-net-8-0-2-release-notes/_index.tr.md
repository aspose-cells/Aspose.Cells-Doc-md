---
title: Aspose.Cells for .NET 8.0.2 Sürüm Notları
type: docs
weight: 70
url: /tr/net/aspose-cells-for-net-8-0-2-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 8.0.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.0.2/)
...
## **Yeni özellikler**
 ...
 (CELLSNET-42585) - Yorum Metni Yönünü Değiştir
...
(CELLSNET-42235) - TextBox Otomatik Boyutlandırma ile ilgili sorun
 ...
 (CELLSNET-42612) - Sütunları Otomatik Sığdır özelliği, Pivot'un filtrelenmiş açılır sütunları için çalışmıyor
...
(CELLSNET-42567) - PDF'ye dönüştürüldüğünde grafik kayboluyor
 ...
 (CELLSNET-42595) - Çalışma kitabı Xlsb biçiminde kaydedildiğinde kılavuz çizgileri MS-Excel Baskı Önizleme'de gösteriliyor

 (CELLSNET-42591) - AutoFitColumns, yeni Satırlar eklendiğinde ListObjects ile çalışmıyor.

 (CELLSNET-42590) - Excel Cell'in v (değer) OpenXML düğümü için xml:space="koru" özniteliği kayboldu

 (CELLSNET-42588) - XLSB dosyasına Tablo eklenemiyor
 ...
 (CELLSNET-42568) - Elek Boyutu sütunu #YOK gösterir
...
(CELLSNET-42576) - xls'yi pdf olarak kaydetmede boş referans istisnası
 ...
 (CELLSNET-42609) - Cell.GetDispalyStyle() bazı koşullu biçimlendirme kuralları için başarısız oluyor

 (CELLSNET-42587) - Dosyayı açarken System.NullReferenceException

 (CELLSNET-42577) - NullReferenceException - bir hücre için koşullu stil alınırken
...
## **Hatalar**
 ...
 (CELLSNET-42572) - Sayfa sekmesi rengi GridWeb içinde korunmaz

 (CELLSNET-42302) - WebGrid İçerik Menüsü - IE11'de FIND, JS hatasıyla başarısız oluyor: Tanımsız veya boş referansın 'acwFindReplaceDialog_Element' özelliği alınamıyor
 ...
 (CELLSNET-42623) - GridWeb için kontrol oluşturulurken hata oluştu
...
Shape.TextDirection özelliğini ekler
 ...
 HTMLLoadOptions.ConvertFormulasData özelliğini ekler

 '=' karakteri ile başlayan dize değeri formül dizesi olduğunda dizenin formüle dönüştürülüp dönüştürülmeyeceğini belirtmek için varsayılan değer yanlıştır.



 HtmlSaveOptions.ImageOptions özelliğini ekler

 Html dosyalarını kaydederken işleme seçeneklerini alır/ayarlar.



 HtmlSaveOptions.ExportChartImageFormat özelliğini geçersiz kılıyor

 Html dosyalarını kaydederken resim formatı ayarları yerine HtmlSaveOptions.ImageOptions'ı kullanır.
