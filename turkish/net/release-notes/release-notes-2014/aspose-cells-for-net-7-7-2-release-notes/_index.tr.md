...
type: docs
weight: 100
url: /tr/net/aspose-cells-for-net-7-7-2-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 7.7.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.7.2/)
...
## **Hatalar**
 ...
 (CELLSNET-42323) - Çıkan PDF, Excel dosyasındaki grafiği yansıtmıyor

 (CELLSNET-42301) - Çıktı PDF'si, Pivot Tablodaki Hesaplanan Alanlar için değerleri hesaplayamıyor

 (CELLSNET-42300) - XLS'den XLSM'ye dönüştürme sırasında Pivot Tablo görüntüleme sorunu

 (CELLSNET-42285) - Sayı biçimi Genel olan sayılar, kesirlerle birlikte görünür
...
(CELLSNET-42163) - Dosya açılıp yeniden kaydedildiğinde koşullu biçimlendirme kayboluyor
 ...
 (CELLSNET-40161) - Excel'den HTML'ye - satır sonu yok

 (CELLSNET-42336) - Çıktı PDF'sinde Pivot tablodaki ay biçimi yanlış

 (CELLSNET-42335) - XLSX PDF'ye dönüştürüldüğünde PivotTable kesiliyor

 (CELLSNET-42347) - Metin biçimlendirme sorunu - Şehir kelimesindeki y harfi kesilmiş

 (CELLSNET-42344) - XLSX'i PDF'ye dönüştürürken başlık kenarlığının kalınlığı farklı sayfalarda değişir

 (CELLSNET-42342) - XLSX'i PDF'ye dönüştürürken kesmelerin altını çiz

 (CELLSNET-42304) - PDF dışa aktarmada Simge Seti hizalaması

 (CELLSNET-42298) - PaperSizeType'ı PaperA6 olarak ayarlamak, PDF'yi PaperA4 boyutunda işler
...
(CELLSNET-42289) - CHAR(151) PDF'de düzgün çalışmıyor
 ...
 (CELLSNET-42297) - HTML'de eksik grafik

 (CELLSNET-42296) - PDF'de eksik tablo

 (CELLSNET-41743) - XLSX'te görüntü dönüştürmede şekil sorunu

 (CELLSNET-40467) - Bir XLS dosyasını XLSM olarak kaydetmek, ardından tekrar XLS'ye kaydetmek, dosyadaki grafiği değiştirir
 ...
 (CELLSNET-42295) - XLSM'den PDF'e: Formül Alanları #DIV/0 olarak Görüntüleniyor!
