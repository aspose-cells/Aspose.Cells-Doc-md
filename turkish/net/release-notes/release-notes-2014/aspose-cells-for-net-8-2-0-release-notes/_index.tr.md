---
title: Aspose.Cells for .NET 8.2.0 Sürüm Notları
type: docs
weight: 40
url: /tr/net/aspose-cells-for-net-8-2-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 8.2.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.2.0/)

{{% /alert %}} 

 Aspose.Cells for .NET, 8.2.0 sürümüne güncellendi ve bu sürümün 40'tan fazla yeni kullanışlı iyileştirme getirdiğini duyurmaktan mutluluk duyuyoruz.
...
## **Hatalar**
 ...
 (CELLSNET-42866) - Ortaya çıkan PDF'de e-tablodaki Dikey Metin eksik

 (CELLSNET-42835) - XLS, PDF'ye dönüştürüldüğünde metin şeklin yanında hizalanmıyor
 ...
 (CELLSNET-42898) - Elektronik tablo PDF olarak işlendiğinde Stilli altbilgi ile ilgili sorun
 ...
 (CELLSNET-42833) - Ortaya çıkan PDF'de metinle örtüşen şekil

(CELLSNET-42829) - Ortaya çıkan PDF'de Onay Kutuları düzgün şekilde hizalanmamış

 (CELLSNET-42776) - Elektronik tabloları PDF'ye kaydederken Görüntü Kalitesi düştü
 ...
 (CELLSNET-42830) - Ortaya çıkan PDF'de Ok yönünde değişiklik

 (CELLSNET-42828) - Ortaya çıkan PDF, çarpı işaretinin bir kısmı gösterilmeyen kırpılmış bir şekle sahip
 ...
 (CELLSNET-42909) - Şablon XLSX dosyası yeniden kaydedilirken öncü satırlar gizleniyor
...
(CELLSNET-42904) - Köprü koleksiyonuyla ilgili DeleteRange sorunu
 ...
 (CELLSNET-42897) - PDF'ye dönüştürülürken EĞERSAY formülü için hesaplanan yanlış değer
