...
type: docs
weight: 100
url: /tr/net/aspose-cells-for-net-19-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46623|Excel dosyasını HTML'ye dönüştürürken katıştırılmış paylaşılan dosya URL'lerindeki sorunlar|Böcek|
|CELLSNET-46590|Dosya Aspose.Cells tarafından işlendikten sonra makro çağıran bir hücrede hata|Böcek|
|CELLSNET-46597|Excel'den PDF'e dönüştürmede PDF'de yanlış değer|Böcek|
|CELLSNET-46613|Adlandırılmış aralıkları getirirken ve oluştururken sorunlar|Böcek|
|CELLSNET-46625|Çıktı PDF'sinde ve HTML'de yanlış tablo arka planı|Böcek|
|CELLSNET-46628|Çıktı PDF'sindeki fark|Böcek|
|CELLSNET-46589|MS Excel çalışma sayfasından dönüştürülen SVG'de beklenmeyen kılavuz çizgileri belirdi|Böcek|
|CELLSNET-46600|Excel dosyasını PDF'ye dönüştürürken çift alt çizgi kayboluyor|Böcek|
|CELLSNET-46626|XLSX dosyasını PDF'ye dönüştürürken alan biçimlendirme sorunları|Böcek|
...
|CELLSNET-46635|ODS dosyasında çok fazla sayfa sonu var (XLSX'ten ODS'ye oluşturma)|Böcek|
|CELLSNET-46618|İstisna "Örnek Salt Okunur"|İstisna|
|CELLSNET-46617|Çalışma kitabı yüklenirken istisna|İstisna|
|CELLSNET-46636|Bir XLSX dosyası yüklenirken istisna|İstisna|
