...
type: docs
weight: 20
url: /tr/net/aspose-cells-for-net-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-45679|Çıktı PDF'sinde yıldız şekilleri doğru gösterilmiyor|Böcek|
...
|CELLSNET-43912|Elektronik tablo PDF'ye dönüştürülürken çizgi nesnelerinin konumu değiştirildi|Böcek|
...
|CELLSNET-45650|Bir MHTML dosya biçimini Excel dosyasına kaydederken verileri uygun sütunlara genişletme hatası|Böcek|
...
|CELLSNET-45712|Çıkış PDF'sinde grafiğin açıklaması eksik|Böcek|
...
|CELLSNET-45684|Grafikten resme veya PDF'ye - 3D Çizgi Grafiği doğru değil veya döndürülmemiş|Böcek|
...
|CELLSNET-45749|Birden çok yazı tipine sahip HTML dizesi, çıktı Excel dosyasını bozar|Böcek|
|CELLSNET-45739|SpreadsheetML dosyası, Aspose.Cells yoluyla yeniden kaydedildiğinde, uygulanan ek koruma ayarları içerir|Böcek|
|CELLSNET-45738|AutoFitColumns, çıktı Excel dosyasındaki HTML biçimlendirmesini bozar|Böcek|
...
|CELLSNET-45728|PDF sayfası olarak kaydederken dizin aralık dışındaydı istisnası|İstisna|
...
|CELLSNET-45753|XLSB, PDF'ye dönüştürüldüğünde, System.ArgumentOutOfRangeException oluşur|İstisna|
...
- [Akıllı Sanatı Grup Şekline Dönüştürün](/cells/tr/net/convert-the-smart-art-to-group-shape/)
- [Aspose.Cells ile Paylaşılan Çalışma Kitabı Oluşturun](/cells/tr/net/create-shared-workbook-with-aspose-cells/)
- [Shape'in Smart Art Shape olup olmadığını belirleme](/cells/tr/net/determine-if-shape-is-smart-art-shape/)
- [Xml Haritasının Kök Eleman Adını Bulun](/cells/tr/net/find-the-root-element-name-of-xml-map/)
- [Excel'i PDF'ye Dönüştürürken Hataları Yoksay](/cells/tr/net/ignore-errors-while-rendering-excel-to-pdf/)
- [Paylaşılan Çalışma Kitabını Parolayla Koruyun veya Korumayı Kaldırın](/cells/tr/net/password-protect-or-unprotect-the-shared-workbook/)
- [Sorgu Cell Alanları, Worksheet.XmlMapQuery yöntemi kullanılarak Xml Harita Yoluna Eşlendi](/cells/tr/net/query-cell-areas-mapped-to-xml-map-path-using-worksheet-xmlmapquery-method/)
...
- [EnableClipboardCopyPaste ve PasteType GridDesktop Özelliklerinin Kopyala Yapıştır Davranışı](/cells/tr/net/copy-paste-behavior-of-enableclipboardcopypaste-and-pastetype-griddesktop-properties/)
