...
type: docs
weight: 120
url: /tr/net/aspose-cells-for-net-17-1-0-release-notes/
---
...
|CELLSNET-44597|Çıktı Excel dosyası, bir HTML dosyasını Excel dosya biçimine dönüştürürken iyi değil|Artırma|
|CELLSNET-44994|Bir Excel dosyasını PDF'ye dönüştürürken Almanca yerel ayarında Tarih biçimiyle ilgili sorun|Artırma|
...
|CELLSNET-44968|XLSX'te birleştirilmiş hücreler HTML'de birleştirilmiş olarak görüntülenmiyor|Böcek|
|CELLSNET-44962|Elektronik tabloyu PDF'ye dönüştürdükten sonra Pivot Tabloda yatay ve dikey çizgiler eksik|Böcek|
...
|CELLSNET-43815|WordArt nesneleri, çıktı PDF'sinde yalnızca noktalar haline gelir|Böcek|
|CELLSNET-44976|Alan grafiği, MS Excel dosyasından farklı olarak PDF çıktısında eğimlidir.|Böcek|
...
|CELLSNET-44938|Elektronik tablo PDF'ye dönüştürüldüğünde grafik doğru şekilde oluşturulmuyor|Böcek|
|CELLSNET-44919|Aspose.Cells tarafından oluşturulan görüntü, Docx'e eklendiğinde bozuluyor|Böcek|
...
|CELLSNET-45027|XLSX'i ODS'ye dönüştürürken noktalı hücre sınırları korunmaz|Böcek|
...
|CELLSNET-43733|TextBox'taki WordArt Metni, elektronik tabloyu PDF'ye dönüştürürken doldurulmuş karakterler yerine yalnızca anahat olarak işliyor|Böcek|
|CELLSNET-43725|ListObject'i XLSM'de harici veri aralığıyla yeniden boyutlandırmak sonucun bozulmasına neden olur|Böcek|
|CELLSNET-43580|Çıktı PDF'sinde renk/stil değiştiğinden bu WordArt filigranı düzgün yazdırılmıyor|Böcek|
|CELLSNET-43562|XLSX, ODS'ye dönüştürüldüğünde sütunlardaki filtreleme kaybolur|Böcek|
|CELLSNET-43405|Bir XLS'yi XLSX dosya biçimine dönüştürdükten sonra işlevin metni bozuluyor ve WordArt metni beyaz oluyor|Böcek|
...
|CELLSNET-41938|XLS dosyasıyla ilgili biçimlendirme sorunları (WordArt ile ilgili)|Böcek|
...
|CELLSNET-45016|Bir şablon XLSX dosyasını açarken istisna|İstisna|
