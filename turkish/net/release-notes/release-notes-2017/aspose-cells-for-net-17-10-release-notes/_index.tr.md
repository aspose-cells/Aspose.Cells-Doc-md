...
type: docs
weight: 30
url: /tr/net/aspose-cells-for-net-17-10-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 17.10](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.10/).
...
|CELLSNET-45408|PDF'ye dönüştürüldüğünde değer kayboluyor veya renk değiştiriyor|Böcek|
...
|CELLSNET-45651|Çalışma kitabında PDF'ye dönüştürmede Çince yazı tipi kullanıldığında Metin Kutusu boyutu değişiyor|Böcek|
...
|CELLSNET-45690|Stiller bazı hücreler için yanlış taşınıyor gibi görünüyor - SpreadsheetML'den XLSX'e dönüştürme|Böcek|
|CELLSNET-45688|Tarih sütunu doğru sıralanmamış|Böcek|
|CELLSNET-45687|Çalışma sayfaları koruma özellikleri SpreadsheetML'den taşınmaz|Böcek|
...
|CELLSNET-45703|XLSM dosyasını tekrar XLS dosya biçimine dönüştürürken istisna|İstisna|
...
- [XLSB dosyasının Harici Bağlantısını Okuma ve Yazma](/cells/tr/net/read-and-write-external-connection-of-xls-and-xlsb-files/)
...
- [HtmlCrossType kullanarak çıktı HTML'sinde dizenin nasıl çaprazlanacağını belirtin](/cells/tr/net/specify-how-to-cross-string-in-output-html-using-htmlcrosstype/)
