---
title: Aspose.Cells for .NET 17.3.0 Sürüm Notları
type: docs
weight: 100
url: /tr/net/aspose-cells-for-net-17-3-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 17.3.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.3.0/).
...
1. **GlobalizationSettings.GetColumnLablesName() ekler** method - PivotTable'da "Sütun Etiketleri" etiketinin adını alır.
...
1. [Pivot Tablo için Genelleştirme Ayarlarını Özelleştirme](/cells/tr/net/customize-globalization-settings-for-pivot-table/)
1. [GridWeb sayfa değişikliğinde istemci tarafı işlevini yürütün](/cells/tr/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/tr/net/execute-client-side-function-on-gridweb-page-change/)
1. [Yalnızca güncellenen hücreler yerine tüm çalışma sayfasını doğrulayın](/cells/tr/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
