---
title: Aspose.Cells for .NET 17.8 Sürüm Notları
type: docs
weight: 50
url: /tr/net/aspose-cells-for-net-17-8-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 17.8](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.8/).
...
|CELLSNET-45543 |Koşullu olarak biçimlendirilmiş hücrelerin taşınması, biçimlendirmeyi kaldırır|Böcek|
|CELLSNET-45541 |Space.xlsx'te H7 - boşluk görüntülenmiyor|Böcek|
|CELLSNET-45540 |ref.xlsx'teki H9 değeri kaydedilirken değişir|Böcek|
...
|CELLSNET-45527 |Gizli satırlara (donmuş bölmede) grup satırları uygulayarak GridWeb'in düzenlenemez olmasına neden olur|Böcek|
...
- [GridDesktop'un Varsayılan Yazı Tipi ve Yazı Tipi Rengi](/cells/tr/net/default-font-and-font-color-of-the-griddesktop/)
