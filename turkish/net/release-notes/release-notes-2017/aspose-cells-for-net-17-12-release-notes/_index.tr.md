...
type: docs
weight: 10
url: /tr/net/aspose-cells-for-net-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [Metin çok uzunsa GridDesktop hücresinden taşar](/cells/tr/net/text-overflows-from-griddesktop-cell-if-it-is-too-long/)
- [Paylaşılan Çalışma Kitabında Revizyon Günlüklerinin Geçmişini Koruyan Güncelleme Günleri](/cells/tr/net/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
