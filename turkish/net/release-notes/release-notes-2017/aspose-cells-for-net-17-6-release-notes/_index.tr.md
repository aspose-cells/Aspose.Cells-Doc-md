...
type: docs
weight: 70
url: /tr/net/aspose-cells-for-net-17-6-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 17.6](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.6/).
...
- [Resmi Şeklin İçinde Bir Doku Olarak Döşe](/cells/tr/net/tile-picture-as-a-texture-inside-the-shape/)
- [GridWeb'in OnAjaxCallFinishedClientFunction'ını Kullanma](/cells/tr/net/using-onajaxcallfinishedclientfunction-of-gridweb/)
...
- [GridWeb'i Web Formuna Ekleme](/cells/tr/net/add-gridweb-to-web-form/)
- [Satırları Gruplandırma ve Ara Toplam Oluşturma](/cells/tr/net/group-rows-and-create-subtotal/)
