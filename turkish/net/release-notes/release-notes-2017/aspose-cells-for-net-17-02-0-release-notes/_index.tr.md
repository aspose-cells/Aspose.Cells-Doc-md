---
title: Aspose.Cells for .NET 17.02.0 Sürüm Notları
type: docs
weight: 110
url: /tr/net/aspose-cells-for-net-17-02-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 17.02.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.02.0/).

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
|:- |:- |:- |
|CELLSNET-45049|E-tabloları CSV biçiminde dışa aktarırken boş satırları ve sütunları kırpın|Yeni özellik|
...
|CELLSNET-45067|PDF'ye dönüştürme çok uzun sürüyor|Verim|
...
|CELLSNET-45072|XLS'den WordArt HTML'de işlenmez|Böcek|
|CELLSNET-45053|Belirli HTML etiketleri dikkate alınmaz ve bazı içerikler eksiktir|Böcek|
|CELLSNET-45039|HTML'yi Excel'e dönüştürürken karma stil kuralı dikkate alınmaz|Böcek|
|CELLSNET-45036|Bir etiketten sonraki içerikler, HTML içe aktarılırken ve XLSX'e dönüştürülürken kırpılıyor|Böcek|
|CELLSNET-45035|Bir kısmı GÜÇLÜ etiketler arasında olduğunda tüm hücre içeriği kalın olur|Böcek|
|CELLSNET-45033|Cell HTML içe aktarılırken içerik kırpılıyor|Böcek|
|CELLSNET-44336|Html, XLSX'e düzgün bir şekilde dönüştürülemiyor|Böcek|
...
|CELLSNET-45085|LOGNORM.DAĞ işlevinin hesaplanan değeri PDF'de doğru değil|Böcek|
|CELLSNET-44740|Özel DateTime deseni GridColumn'a uygulanamaz|Böcek|
|CELLSNET-45130|Excel dışa aktarma PDF'sini ve Aspose.Cells'i PDF olarak kaydetmeyi kullanarak farklı sonuçlar|Böcek|
|CELLSNET-45095|E-tablodaki resim PDF'ye dönüştürülmedi|Böcek|
|CELLSNET-45075|Elektronik tablodaki köprüler PDF'ye aktarılmıyor|Böcek|
|CELLSNET-45074|Excel'de PDF oluşturmaya biçimlendirme sorunu|Böcek|
|CELLSNET-45070|Mono'de e-tabloyu PDF'ye dönüştürürken 3B Pasta Grafiği görüntülenmiyor|Böcek|
|CELLSNET-41283|PDF, Excel'den ve Aspose.Cells'den kaydedildiğinde farklı|Böcek|
...
|CELLSNET-45084|Elektronik tabloyu PDF'ye dönüştürürken grafik değeri farklı|Böcek|
|CELLSNET-45082|Chart9 sekmesindeki grafik, kaynak Excel dosyasını yükleyip kaydettikten sonra değişiyor|Böcek|
|CELLSNET-45066|Hesap tablosu PDF'ye dönüştürülürken şekiller yatay olarak sıkıştırılıyor|Böcek|
|CELLSNET-45064|Elektronik tabloyu PDF'ye dönüştürürken eksen etiketleri oluşturulmaz|Böcek|
...
|CELLSNET-45094|XLS yüklenip kaydedildikten sonra metin konumu değiştirildi|Böcek|
...
|CELLSNET-45112|Pictures.Clear() çağrıldığında, XLS'yi Kaydet, System.ArgumentOutOfRangeException oluşur|İstisna|
|CELLSNET-45111|XLS'yi Kaydettiğinizde, System.ArgumentOutOfRangeException oluşur|İstisna|
...
|CELLSNET-45088|Bir elektronik tabloyu PDF dosya biçimine dönüştürürken istisna|İstisna|
|CELLSNET-45080|Bir HTML dosya formatı yüklenirken istisna|İstisna|
...
Aspose.Cells for .NET API'in bu sürümü, API'in HTML'yi nesne modunda içe aktarırken sütunları ve satırları otomatik olarak sığdırıp sığdırmayacağını belirten HTMLLoadOptions.AutoFitColsAndRows özelliğini ekledi. Boole tipi özelliğinin varsayılan değeri false'tur; bu, hücre yüksekliklerinin ve genişliklerinin olduğu gibi içe aktarılacağı anlamına gelir, ancak yukarıda belirtilen özellik true olarak ayarlandığında, API, içeriğe göre sütun genişliklerini ve satır yüksekliklerini ayarlamaya çalışır. .
...
#### **Cells.TextToColumns Yöntemi Eklendi**
 Aspose.Cells for .NET API'lerinin son revizyonu, Excel'inkileri taklit etmek için Cells.TextToColumns yöntemini kullanıma sunmuştur.**Metni Sütunlara Dönüştür** özellik. Excel bu özelliği şu adresten sağlar:**Veri Araçları** altında**Veri** sekme. Bir sütunun içeriğini birden çok sütuna bölmek için, verilerin virgül (veya başka herhangi bir karakter) gibi belirli bir sınırlayıcı içermesi gerektiğini lütfen unutmayın.
...
1. [Çalışma Kitabında HTML yüklenirken Sütunları ve Satırları Otomatik Sığdır](/cells/tr/net/autofit-columns-and-rows-while-loading-html-in-workbook/)
1. [Aspose.Cells'i kullanarak Metni Sütunlara Dönüştür](/cells/tr/net/convert-text-to-columns-using-aspose-cells/)
1. [Elektronik Tablo veya Çalışma Kitabında kullanılan Yazı Tiplerinin Listesini Alın](/cells/tr/net/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)
1. [Excel Dosyasını Yüklerken Uyarılar Alın](/cells/tr/net/get-warnings-while-loading-excel-file/)
1. [Excel 2016 Grafiklerini Okuyun ve İşleyin](/cells/tr/net/read-and-manipulate-excel-2016-charts/)
1. [Elektronik tabloları CSV formatına dışa aktarırken Öndeki Boş Satırları ve Sütunları Kırpın](/cells/tr/net/trim-leading-blank-rows-and-columns-while-exporting-spreadsheets-to-csv-format/)
1. [Çalışma Sayfasını GridWeb Kullanarak Özelleştirilmiş Bir Koleksiyon Nesnesine Bağlama](/cells/tr/net/binding-worksheet-to-a-customized-collection-object-using-gridweb/)
1. [Çalışma sayfası verilerini dışa aktarırken yinelenen sütunları otomatik olarak yeniden adlandırın](/cells/tr/net/rename-duplicate-columns-automatically-while-exporting-worksheet-data/)
1. [GridDesktop Çalışma Sayfasında Bölme Bölmeleri](/cells/tr/net/split-panes-in-griddesktop-worksheet/)
