---
title: Aspose.Cells for .NET 7.2.2 Sürüm Notları
type: docs
weight: 60
url: /tr/net/aspose-cells-for-net-7-2-2-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 7.2.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-7.2.2/)

{{% /alert %}} 

Biz
 Aspose.Cells for .NET v7.2.2'yi duyurmaktan mutluluk duyuyoruz!
...
### **40683**
- Değer
 SumIf() İşlevinin GridWeb'de görüntülenmemesi
### **40638 - GridWeb - değil**
 beyaz boşluk gösteriliyor
### **40724**
- GridWeb Doğrulama Hatası - Satır numaraları gerçekle aynı hizada değil
 satırlar
