...
type: docs
weight: 2
url: /tr/net/aspose-cells-for-net-20-11-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47641|29 sayfa eklenirken ve çıktı XLS dosyası MS Excel'de açılırken uyarı verildi|Verim|
...
|CELLSNET-47642|Yükleyip kaydettikten sonra XLSB dosyası bozuk|Hatalar|
|CELLSNET-47660|Tarihleri içeren grafik alanı, PDF biçiminde farklı biçime sahiptir|Hatalar|
...
|CELLSNET-47698|XLS dosyasını PDF'ye dönüştürürken logo konumunda kaydırın|Hatalar|
...
|CELLSNET-47697|Çıktı PDF'sinde bazı Y ekseni değerleri grafiğin dışına çıkıyor|Hatalar|
|CELLSNET-43579|WortArt metninin eğriliği, Excel'den PDF'ye dönüştürülürken değişiyor|Hatalar|
|CELLSNET-47675|Yükleme ve kaydetme işleminden sonra XLS dosyasının içeriği değiştirilir|Hatalar|
|CELLSNET-47704|Parola korumalı (şifreli) bir XLS dosyasını düzenledikten/kaydettikten sonra Özel Özellikler kayboldu|Hatalar|
...
|CELLSNET-47689|XLSB'yi PNG ve HTML'ye dönüştürürken istisna|İstisnalar|
...
|CELLSNET-47669|1. çalışma sayfası HTML'ye dönüştürülürken geçersiz sütun dizini ArgumentException atılıyor|İstisnalar|
...
|CELLSNET-47699|ODS dosyasını açarken istisna|İstisnalar|
