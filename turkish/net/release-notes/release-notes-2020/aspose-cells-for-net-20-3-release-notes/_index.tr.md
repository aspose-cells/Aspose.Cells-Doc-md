...
type: docs
weight: 50
url: /tr/net/aspose-cells-for-net-20-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-47092|Belgeyi HTML'ye kaydederken simgeleri IStreamProvider için normal görüntüler gibi kullanılabilir hale getirin|Artırma|
...
|CELLSNET-47178|Tablo oluşturulurken ve HTML'ye dönüştürülürken girinti kayboldu|Böcek|
...
|CELLSNET-47210|Bir hücrenin zengin biçimlendirilmiş dize değeri, Apple Numbers'09'da boş|Böcek|
|CELLSNET-47213|Sayfayı başka bir çalışma kitabına kopyalama - gizli hücreler (satırlar) kayboluyor|Böcek|
|CELLSNETCORE-53|PDF'ye dönüştürüldükten sonra Excel grafik satırındaki veri noktası kaldırılır|Böcek|
|CELLSNET-47212|Belirli XLSM'yi XLS'ye kaydederken NullReferenceException|İstisna|
