...
type: docs
weight: 60
url: /tr/net/aspose-cells-for-net-20-2-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSNET-47113|Boruyla ayrılmış / CSV'den JSON'a dönüştürme|Yeni özellik|
...
|CELLSNET-47102|Excel'i Negatif Zaman özel biçiminde (s:dd) PDF'ye dönüştürdükten sonra "#" görüntüleniyor|Böcek|
...
|CELLSNET-47081|Grafiği PDF'e Dönüştürme|Böcek|
...
|CELLSNET-47133|PDF'ye dışa aktarırken tutarsızlık|Böcek|
...
|CELLSNET-47139|Harici bağlantı formülüne sahip ODS dosyası, ekstra çalışma sayfalarını gösterir|Böcek|
|CELLSNET-47145|Adlandırılmış aralık, ODS dosyasını açıp kaydettikten sonra kayboluyor|Böcek|
|CELLSNET-47146|Dosya açılmıyor|Böcek|
|CELLSNET-47147|Sayfa Kodu adı sorunu|Böcek|
|CELLSNET-47153|ODS grafikleri kaydedildikten sonra değişiyor|Böcek|
...
|CELLSNET-47140|ODS'yi GridDesktop'a yüklerken istisna|İstisna|
|CELLSNET-47105|Tablodaki bir sütunun eşlenmediği XML verilerini içe aktarırken istisna|İstisna|
|CELLSNET-47170|Bir Excel dosyasını PDF'ye kaydederken "DateTime"dan "Double"a geçersiz atama" istisnası|İstisna|
