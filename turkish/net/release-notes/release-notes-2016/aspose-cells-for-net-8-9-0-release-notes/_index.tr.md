---
title: Aspose.Cells for .NET 8.9.0 Sürüm Notları
type: docs
weight: 70
url: /tr/net/aspose-cells-for-net-8-9-0-release-notes/
---
### **1) Aspose.Cells**

|**Anahtar** |**Özet** |**Kategori** |
|:- |:- |:- |
|CELLSNET-44574 | Dosyayı HTML'ye dışa aktarırken metni sağdan sola genişletme desteği| Yeni özellik|
|CELLSNET-44561 | E-tabloyu HTML'ye dönüştürürken Varsayılan Yazı Tipini ayarlayabilme| Yeni özellik|
...
|CELLSNET-44541 | E-tabloyu HTML'ye dönüştürürken içerikler çakışıyor| Böcek|
|CELLSNET-44520 | XLSX'i XLSB olarak yeniden kaydettikten sonra Pivot Field'ın açılır menüsü kayboluyor| Böcek|
|CELLSNET-44518 | XLSX'i XLSB olarak yeniden kaydettikten sonra elektronik tablo bozuluyor| Böcek|
...
|CELLSNET-43656 | Çıktı HTML'sinde bazı metin öğeleri biraz kırpılmış| Böcek|
|CELLSNET-44590 | Üst bilgi ve alt bilgide özel karakterler bulunan Excel'i PDF'ye dışa aktarma sorunu| Böcek|
|CELLSNET-44517 | SheetRender.ToImage kullanılarak görüntüye aralık oluşturulurken dikey hizalama yanlış| Böcek|
|CELLSNET-44589 | Aspose.Cells oluşturulan EMF, Word belgesine eklendiğinde ve PDF'ye dönüştürüldüğünde yanlış eksen etiketleri gösteriyor| Böcek|
|CELLSNET-44586 | Birden az aralık, PDF'ye düzgün şekilde dışa aktarılmaz| Böcek|
|CELLSNET-44564 | Oturum 0 altında oluşturulan Grafiğin EMF'si tüm içeriği göstermiyor| Böcek|
|CELLSNET-44559 | Chart.HasAxis yanlış değer gösteriyor| Böcek|
|CELLSNET-44538 | XLSX'i HTML'ye dönüştürürken boş PNG 0KB dosyası oluşturuldu| Böcek|
...
|CELLSNET-44573 | Harici bir XLSX'ten kopyalanan çalışma sayfalarındaki resimlerin boyutları orijinallerle aynı değil| Böcek|
...
|CELLSNET-44543 | Dosya HTML'ye dönüştürülürken şeklin dolgu biçimi kayboluyor| Böcek|
...
|CELLSNET-44563 | İstisna: "Giriş dizesi doğru biçimde değildi." bir HTML dosya biçimi yüklerken| İstisna|
