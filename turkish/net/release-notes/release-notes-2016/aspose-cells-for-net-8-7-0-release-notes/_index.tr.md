---
title: Aspose.Cells for .NET 8.7.0 Sürüm Notları
type: docs
weight: 140
url: /tr/net/aspose-cells-for-net-8-7-0-release-notes/
---
{{% alert color="primary" %}} 

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 8.7.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.7.0/)
...
## **Yeni özellikler**
 ...
 (CELLSNET-43938) - VBA sertifikasını dosyaya veya akışa aktarma desteği

 (CELLSNET-43920) - VBAcode'un imzalanıp imzalanmadığını kontrol etmek için API'i destekleyin

 (CELLSNET-43867) - VBA projelerini/makrolarını dijital olarak imzalayın
...
## **Verim**
 ...
 (CELLSNET-44156) - Workbook.CalculateFormula'da konsol uygulaması çöküyor

 (CELLSNET-44120) - Workbook.CalculateFormula, Çalışma Kitabındaki formülleri hesaplamak için daha fazla zaman alıyor.

 (CELLSNET-43896) - Workbook.CalculateFormula çağrılırken işlem sonlandırıldı
...
## **Hatalar**
 ...
 (CELLSNET-44139) - CalculateFormula() yöntemi çağrılmadan önce ve sonra aynı hücre için farklı değerler
...
(CELLSNET-44138) - Cell gölgelendirme, kenarlığın incelmesine neden olarak kenarlıkla örtüşüyor
 ...
 (CELLSNET-44144) - Özel özellikler eklendiğinde çalışma sayfası içerikleri kaldırılıyor
...
## **İstisnalar**
 ...
 (CELLSNET-44119) - Workbook.CalculateFormula'da hesaplama hatası
 ...
 (CELLSNET-44143) - XLSX yüklenirken Çalışma Kitabı ctor'da istisna

 (CELLSNET-44142) - XLS ile Çalışma Kitabı örneği oluşturulurken IndexOutOfBoundsException
...
Eski Workbook.SaveOptions özelliğini siler.
 ...
 VbaProject.Sign yöntemini ekler.

 DigitalSignature ile VBA projesini imzalayın.



 VbaProject.IsValidSigned özelliğini ekler.

 VBA projesi imzasının geçerli olup olmadığını gösterir.



 VbaProject.CertRawData özelliğini ekler.

 VBA projesi imzalanmışsa sertifika ham verilerini alır.
