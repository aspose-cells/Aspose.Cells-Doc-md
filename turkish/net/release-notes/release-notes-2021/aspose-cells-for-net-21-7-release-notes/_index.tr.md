---
title: Aspose.Cells for .NET 21.7 Sürüm Notları
type: docs
weight: 6
url: /tr/net/aspose-cells-for-net-21-7-release-notes/
---
{{% alert color="primary" %}}

 Bu sayfa için sürüm notları içerir[Aspose.Cells for .NET 21.7](https://www.nuget.org/packages/Aspose.Cells/21.7.0).
...
|CELLSNET-47233|GridWeb için destek modeli ekranı|Artırma|
|CELLSNET-40295|Yazıcıya çalışma kitabı oluşturma|Artırma|
|CELLSNET-46642|Excel dosyasından PDF oluştururken WCAG 2.0'ı destekleyin|Artırma|
|CELLSNET-48175|Yazı tipleri gösterilemediğinde metin uzunluğunu ölçmeyi iyileştirin|Artırma|
...
|CELLSNET-46717| Chart.ToImage sorunları|Böcek|
...
### **SeriesCollection.Add(System.String,System.Boolean,System.Boolean) yöntemini ekler.**
