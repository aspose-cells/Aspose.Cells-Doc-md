...
type: docs
weight: 190
url: /tr/net/how-to-set-comment-background/
...
Yukarıdaki kod, istediğiniz kendi seçtiğiniz rengin yorumlara eklenmesi için [**Aspose.Cells**](https://products.aspose.com/cells/net/) kullanımını gösterecektir.
...
Aşağıdaki örnek kod, sıfırdan bir XLSX dosyası oluşturur ve hücre A1'e resim arka planlı bir yorum ekler, [**Aspose.Cells**](https://products.aspose.com/cells/net/) API.
