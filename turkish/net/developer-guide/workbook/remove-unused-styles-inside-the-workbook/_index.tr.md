...
Excel dosyasındaki kullanılmayan stiller hem yer kaplamakta hem de PDF, HTML vb. farklı formatlara dönüştürülürken performans sorunlarına neden olmaktadır. Aspose.Cells,[**Workbook.RemoveUnusedStyles()**](https://reference.aspose.com/cells/net/aspose.cells/workbook/methods/removeunusedstyles) çalışma kitabı içindeki kullanılmayan tüm stilleri kaldırmak için.
