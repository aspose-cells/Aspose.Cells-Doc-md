...
type: docs
weight: 40
url: /tr/net/evaluate-aspose-cells/
---
{{% alert color="primary" %}}

 Değerlendirme için Aspose.Cells numaralı telefondan kolayca indirebilirsiniz.[NuGet Galeri](https://www.nuget.org/packages/Aspose.Cells). Değerlendirme indirmesi, tam sürümün indirilmesi ile aynıdır: Bir lisans uyguladığınızda değerlendirme lisanslanır.
