...
type: docs
weight: 68
url: /tr/net/protect-and-unprotect/
...
## [**Encrypt and decrypt Excel files**](/cells/tr/net/encrypt-and-decrypt-excel-files/)
Excel dosyalarındaki verilere başkalarının erişmesini engellemek için Excel dosyasını bir şifre ile koruyun.

## [**Protect and unprotect workbook**](/cells/tr/net/protect-and-unprotect-workbook-structure/)
...
## [**Protect and unprotect worksheet**](/cells/tr/net/protect-and-unprotect-worksheets/)
...
## [**Protect and unprotect shared workbook**](/cells/tr/net/password-protect-or-unprotect-the-shared-workbook/)
Paylaşılan çalışma kitabını koruma ve korumayı kaldırma.

## [**Add or remove a digital signature in Office files**](/cells/tr/net/assign-and-validate-digital-signatures/)
Belge içeriğinin doğruluğunu korumak için dijital imza ekleyebilirsiniz.

## **Gelişmiş Konular**
- [Aspose.Cells Kullanarak Değiştirme Şifresini Kontrol Etme](/cells/tr/net/check-password-to-modify-using-aspose-cells/)
