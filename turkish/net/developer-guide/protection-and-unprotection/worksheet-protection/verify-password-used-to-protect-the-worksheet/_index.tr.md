...
{{% alert color="primary" %}}
 ...
 Aspose.Cells API'ler,[**Koruma**](https://reference.aspose.com/cells/net/aspose.cells/protection) bazı yararlı özellikler ve yöntemler tanıtarak sınıf. Böyle bir yöntem,[**Parolayı Doğrula**](https://reference.aspose.com/cells/net/aspose.cells/protection/methods/verifypassword) örneği olarak bir şifre belirlemeye izin veren*sicim* korumak için aynı parolanın kullanılıp kullanılmadığını doğrular.[**Çalışma kağıdı**](https://reference.aspose.com/cells/net/aspose.cells/worksheet).
