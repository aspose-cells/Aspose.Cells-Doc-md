...
Bazen dosyanın içeriği uygun olmasını garanti etmek için dosyanın biçimini algılamanız gerekebilir. Aspose.Cells, belgeyi işlemek için kullanabileceğiniz [**FileFormatUtil.DetectFileFormat()**](https://reference.aspose.com/cells/net/aspose.cells/fileformatutil/methods/detectfileformat/index) statik yöntemini ve bazı ilgili API'ları sağlar.
