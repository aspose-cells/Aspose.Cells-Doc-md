...
- OfsetÇaprazAltSağ
- OfsetAlt
- ÖtelemeDiagonalÜstSağ
- İçSol
- İç Merkez
- PerspektifÇaprazÜstSol
- PerspektifÇaprazAltSağ

{{% /alert %}}

Aşağıdaki kod parçacığı, kullanımını gösterir[**FontSetting.TextOptions.Shadow.PresetType.PresetType**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shadoweffect/properties/presettype)Shape veya TextBox metin efektlerinin gölgesini ayarlama özelliği.
