...
Aspose.Cells, çalışma sayfasına bir tablo eklerken ilk satırı aşağı kaydırmanıza olanak tanır. Bu belge, Aspose.Cells API'lerini kullanarak görevi nasıl gerçekleştirebileceğinizi açıklar.
