...
1.  Excel dosyanızı içine yükleyin[Çalışma kitabı](https://reference.aspose.com/cells/net/aspose.cells/workbook/) nesne.
   - [Çalışma kitabı](https://reference.aspose.com/cells/net/aspose.cells/workbook/) nesne Excel dosya biçimlerini yükleyebilir, örneğin XLS, XLSX, XLSM, ODS vb.
