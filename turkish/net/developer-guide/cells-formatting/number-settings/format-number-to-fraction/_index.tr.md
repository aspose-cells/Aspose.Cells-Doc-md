...
type: docs
weight: 10
url: /tr/net/how-to-format-number-to-fraction/
description: Bu makale, Aspose.Cells for .NET API sini kullanarak Sayıyı Kesir Olarak Biçimlendirmeyi tanıtır.
...
## **Number to Fraction formatlama Aspose.Cells for .NET nasıl yapılır**
Aspose.Cells for .NET sayısında sayıları kesir biçimine dönüştürmek basit bir işlemdir. Aspose.Cells, Microsoft Excel yüklü olmadan .NET uygulamalarında Excel dosyalarıyla çalışmanıza olanak sağlayan güçlü bir kütüphanedir. Sayıları kesir olarak biçimlendirme dahil birçok özellik sunar.

İşte Aspose.Cells for .NET sayısını kesirlere biçimlendirme adımlarına ilişkin bir rehber:
...
Bu adımları izleyerek, Aspose.Cells for .NET sayısını kolayca kesir olarak biçimlendirebilirsiniz. Bu, finansal, istatistiksel veya eğitimsel uygulamalarda kesin kesir değerleri gerektiğinde özellikle kullanışlıdır.
