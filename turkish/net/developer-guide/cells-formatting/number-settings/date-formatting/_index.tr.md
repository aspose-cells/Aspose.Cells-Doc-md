...
type: docs
weight: 10
url: /tr/net/format-number-to-date/
description: Bu makale, Aspose.Cells for .NET API kullanarak sayıları tarih olarak biçimlendirmeyi tanıtacaktır.
...
Excel dosyalarıyla çalışmak için Aspose.Cells for .NET kütüphanesinde sayıların tarihi formatına dönüştürmek için, hücrelere programatik olarak tarih formatı uygulayabilirsiniz. İşte Aspose.Cells kullanarak C# ile nasıl yapacağınız:
