...
description: Aspose.Cells, elektronik tablo dosyaları ile çalışmak için bir .NET kütüphanesidir. 1904 tarih sistemini uygulamayı destekler ve kullanıcıların 1 Ocak 1904 tarih sistemi üzerinden hesap yapmalarına ve biçimlendirmeleri gerçekleştirmelerine olanak tanır. Bu makale, Aspose.Cells kütüphanesini kullanarak 1904 tarih sistemini nasıl uygulayacağınızı açıklamaktadır.
keywords: Aspose.Cells, 1904 tarih sistemi, elektronik tablo, hesaplama, biçimlendirme
type: docs
weight: 7000
url: /tr/net/implement-1904-date-system/
---
