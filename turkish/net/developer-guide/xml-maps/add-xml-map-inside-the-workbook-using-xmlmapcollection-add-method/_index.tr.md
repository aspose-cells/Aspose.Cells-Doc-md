...
type: docs
weight: 10
url: /tr/net/add-xml-map-inside-the-workbook-using-xmlmapcollection-add-method/
---

## **Olası Kullanım Senaryoları**

Aspose.Cells, XML Haritasını kitap içine eklemek için kullanabileceğiniz [**XmlMapCollection.Add()**](https://reference.aspose.com/cells/net/aspose.cells/xmlmapcollection/methods/add) yöntemi sağlar.
