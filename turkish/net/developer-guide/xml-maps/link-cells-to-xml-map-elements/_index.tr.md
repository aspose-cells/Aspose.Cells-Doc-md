...
type: docs
weight: 50
url: /tr/net/link-cells-to-xml-map-elements/
---

## **Olası Kullanım Senaryoları**

Aspose.Cells kullanarak, hücrelerinizi XML Haritası öğelerine bağlayabilirsiniz. Bu amaçla lütfen [**Cells.LinkToXmlMap()**](https://reference.aspose.com/cells/net/aspose.cells/cells/methods/linktoxmlmap) yöntemini kullanın.
