...
Bazen, CSV dosyanız birden çok Kodlama (Unicode, ANSI, UTF8, UTF7, vb.) içerir. Aspose.Cells, bu tür CSV dosyalarını yüklemenize ve bunları PDF veya XLSX gibi diğer biçimlere dönüştürmenize olanak tanır.
...
|![yapılacaklar:resim_alternatif_Metin](reading-csv-file-with-multiple-encodings_1.png)|
 ...
 Aşağıdaki ekran görüntüsü, ayar yapılmadan yukarıdaki CSV dosyasından dönüştürülen XLSX dosyasını gösterir.[**TxtLoadOptions.IsMultiEncoded**](https://reference.aspose.com/cells/net/aspose.cells/txtloadoptions/properties/ismultiencoded) mülkiyet**doğru**. Gördüğünüz gibi, Unicode metni düzgün bir şekilde dönüştürülmedi.
