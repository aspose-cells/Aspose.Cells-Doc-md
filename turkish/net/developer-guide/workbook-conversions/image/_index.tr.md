...
## Çalışma Kitabını TIFF'e Dönüştürme
 ...
 Aşağıdaki kod parçacığı, Excel'in birden çok sayfayla TIFF'e nasıl dönüştürüleceğini gösterir. bu[kaynak Excel dosyası](workbook-to-tiff-with-mulitiple-pages.xlsx) ve[TIFF görüntü oluşturuldu](workbook-to-tiff-with-mulitiple-pages.tiff) referansınız için eklenmiştir.
...
- [Grafiği SVG Formatında Resme Dönüştürme](/cells/tr/net/converting-chart-to-image-in-svg-format/)
- [Grafiği viewBox özniteliğiyle SVG'e aktarın](/cells/tr/net/export-chart-to-svg-with-viewbox-attribute/)
