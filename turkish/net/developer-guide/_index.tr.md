...
<div class="row">
    <div class="col-md-6">
        <p>Bilgi</p>
        <ul>
            <li><a href="/cells/tr/net/managing-document-properties/">Döküman özellikleri</a></li>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul>
		 ...
		 <li><a href="/cells/tr/net/cells-border-settings/">Sınır</a></li>
		 <li><a href="/cells/tr/net/cells-fill-settings/">Doldurmak</a></li>
        </ul>
        <p>Koşullu biçimlendirme</p>
        <ul>
		  <li><a href="/cells/tr/net/conditional-formatting/">Koşullu biçimlendirme</a></li>
          <li><a href="/cells/tr/net/apply-advanced-conditional-formatting/">Gelişmiş Koşullu Biçimlendirmeyi Uygula</a></li>
        </ul>       
    </div>
    <div class="col-md-6">        
        <p>Çeşit</p>
        ...
        <p>Bul&Seç</p>
        <ul>
		<li><a href="/cells/tr/net/find-or-search-data/">Veri Bul veya Ara</a></li>
        </ul>
        <p>Cells</p>
        <ul>
...
<div class="row">
    <div class="col-md-6">
        <p><a href="/cells/tr/net/create-pivot-table/">Pivot tablo</a></p>
        <ul>
            <li><a href="/cells/tr/net/create-pivot-table/">Pivot Tablo Oluştur</a></li>
            <li><a href="/cells/tr/net/formatting-pivot-table/">Pivot Tabloyu Biçimlendirme</a></li>
        </ul>
        <p><a href="/cells/tr/net/create-and-format-table/">Masa</a></p>
         <ul>
            <li><a href="/cells/tr/net/create-and-format-table/">Tablo Oluşturma ve Biçimlendirme</a></li>
        ...
        <ul>
			...
			<li><a href="/cells/tr/net/insert-shapes/#inserting-a-callout-quad-arrow-to-worksheet">Çalışma Sayfasına belirtme çizgisi dörtlü ok ekleme</a></li>
		...
		<p>Bağlantılar</p>
        <ul>
            <li><a href="/cells/tr/net/working-with-hyperlinks-to-link-data/">Verileri Bağlamak için Köprülerle Çalışma</a></li>
        </ul>
        <p>Yorumlar</p>
        <ul>
        ...
        <ul>
         ...
         <p><a href="/cells/tr/net/creating-charts/">Çizelge</a></p>
		  <ul>
            <li><a href="/cells/tr/net/creating-charts/">Grafik Oluşturma</a></li>
    ...
    <div class="col-md-6">       
        <p><a href="/cells/tr/net/managing-ole-objects/">Ole nesnesi</a></p>
        <ul>
        ...
        <ul>
            <li><a href="/cells/tr/net/add-text-box-to-worksheet-in-aspose-cells/">Aspose.Cells'de Çalışma Sayfasına Metin Kutusu Ekleme</a></li>
            <li><a href="/cells/tr/net/applying-text-alignment-to-partial-text-inside-the-textbox/">TextBox içindeki kısmi metne metin hizalaması uygulama</a></li>
        </ul>
...
<div class="row">
    ...
    <div class="col-md-6">
        <p>Uygun ölçek</p>
        <ul>
		<li><a href="/cells/tr/net/setting-page-options/#scaling-factor">Ölçek</a></li>
...
<div class="row">
    <div class="col-md-6">
        <p>İşlev Kitaplığı</p>
        <ul>
            <li><a href="/cells/tr/net/supported-formula-functions/">Desteklenen Formül İşlevleri</a></li>
        </ul>
        <p>Tanımlı İsimler</p>
        <ul>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul>
         <li><a href="/cells/tr/net/worksheet-views/#page-break-preview">Sayfa Sonu Önizlemesi</a></li>
        </ul>
        <p>Göstermek</p>
         <ul>
		<li><a href="/cells/tr/net/show-and-hide-gridlines-and-row-column-headers/">Kılavuz Çizgileri ve Başlığı Görüntüle</a></li>
