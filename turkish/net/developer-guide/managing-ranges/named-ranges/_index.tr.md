...
type: docs
weight: 40
url: /tr/net/create-workbook-and-worksheet-scoped-named-ranges/
---
...
## **Gelişmiş Konular**
- [Erişim Oluştur ve Adlandırılmış Aralıkları Kopyala](/cells/tr/net/create-access-and-copy-named-ranges/)
