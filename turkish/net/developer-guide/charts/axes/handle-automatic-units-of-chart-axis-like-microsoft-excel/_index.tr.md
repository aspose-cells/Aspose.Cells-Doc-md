...
description: Aspose.Cells for .NET de Microsoft Excel e benzer şekilde grafik eksenlerinde otomatik birimlerin nasıl ele alınacağını öğrenin. Rehberimiz, grafik ekseninde otomatik birimleri yapılandırmanızı ve özelleştirmenizi, bilimsel gösterimlerin ve ölçeğin ayarlanmasını da içeren bir biçimde gösterecektir.
keywords: Aspose.Cells for .NET, grafik eksenleri, otomatik birimler, Microsoft Excel, yapılandırma, özelleştirme, bilimsel gösterim, ölçeklendirme.
type: docs
weight: 120
url: /tr/net/handle-automatic-units-of-chart-axis-like-microsoft-excel/
---
