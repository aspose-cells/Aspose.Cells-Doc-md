...
#### **Huni Grafiği**
Bir huni grafiği, bir süreçteki birden çok aşamadaki değerleri gösterir. Örneğin, bir satış kanalındaki her aşamada olası satış adaylarının sayısını göstermek için bir huni grafiği kullanabilirsiniz. Tipik olarak, değerler kademeli olarak düşerek çubukların bir huniye benzemesine olanak tanır.

Huni grafiği Aspose.Cells'de desteklenmektedir.
