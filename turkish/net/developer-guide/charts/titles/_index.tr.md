...
## **Başlık Seçenekleri**
 Aspose.Cells ayrıca çalışma zamanında grafiğin başlıklarını yönetmeye izin verir.[Başlık](https://reference.aspose.com/cells/net/aspose.cells.charts/title/) nesne, başlıklar için metni, yazı tipini ve dolgu biçimini değiştirebilirsiniz.
...
## **ileri konular**
- [ODS Dosyasından Grafik Alt Başlığını Oku](/cells/tr/net/read-chart-subtitle-from-ods-file/)
