...
### **İndirin ve yükleyin Aspose.Cells**
 ...
 Öncelikle yapmanız gerekenler[indirmek](https://downloads.aspose.com/cells/net) .Net için Aspose.Cells. Geliştirme bilgisayarınıza kurun. Herşey[Aspose](http://www.aspose.com/) bileşenler kurulduğunda değerlendirme modunda çalışır. Değerlendirme modunun zaman sınırı yoktur ve yalnızca üretilen belgelere filigran ekler.
