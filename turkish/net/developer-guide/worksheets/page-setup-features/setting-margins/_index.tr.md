...
description: Bu makalede, örnek kod kullanarak bir Excel çalışma sayfasının kenar boşluklarını nasıl ayarlayacağınızı öğreneceksiniz. Ayrıca C# API veya .NET Kitaplığını kullanarak sayfa merkezi, üst bilgi ve alt bilgi kenar boşluklarını programlı olarak nasıl ayarlayacağınızı öğreneceksiniz.
