...
description: Bu makalede, C# API veya .NET Kitaplığı kullanılarak komut dosyası komutlarıyla üst bilgi ve alt bilgi ayarlanarak Excel çalışma sayfalarının üst bilgi ve alt bilgisine nasıl programlı bir şekilde resim ekleneceği açıklanmaktadır.
...
1.  Üzerinde**Dosya** menüsünde *Sayfa Yapısı**'nı seçin. Bir diyalog görüntülenecektir.
