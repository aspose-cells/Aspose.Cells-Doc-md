...
type: docs
weight: 90
url: /tr/net/insert-background-image-to-excel/
description: Aspose.Cells for .NET kullanarak Excel'e arka plan resmi nasıl eklenir
---
{{% alert color="primary" %}} 
...
![yapılacaklar:resim_alternatif_metin](insert-background-to-excel.jpg)
