...
Zaman çizelgesi uygulanmış bir Excel dosyanız varsa ve Excel'i zaman çizelgesi ayarlarıyla PDF'e aktarmak istiyorsanız, Aspose.Cells artık bunu varsayılan olarak desteklemektedir. Excel dosyasını zaman çizelgesiyle birlikte PDF'e aktarmanız yeterlidir, oluşturulan PDF, uygulanan zaman çizelgesini gösterecektir.
