...
| `showBottombarStats` | Alt çubuk istatistiklerini gösterip göstermediği.<br>Varsayılan değer true'dur. | `true` | Evet |   
| `showRowAppenderToolbar` | Toplu satır ekleyici araç çubuğunu gösterip göstermediği.<br>Varsayılan değer true'dur. | `true` | Evet |   
