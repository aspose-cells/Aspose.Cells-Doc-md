...
- Projeniz için "Hedef İşletim Sistemi"ni "Yok" veya diğer seçenekler olarak ayarlayın, "SkiaSharp"ı .Net6 projesi için Windows sisteminize bir bağımlılık olarak kullanacaksınız.*Bağımlılık olarak "SkiaSharp" kullanan sürümün yazıcıya yazdırma özelliğini desteklemediğini lütfen unutmayın.*
...
- System.Text.Encoding.CodePages, 4.7.0.
 ...
 Bu sayede .Net6 projesi için Windows sisteminizde "SkiaSharp"ı bağımlılık olarak kullanmış olacaksınız.*Bağımlılık olarak "SkiaSharp" kullanan sürümün yazıcıya yazdırma özelliğini desteklemediğini lütfen unutmayın.*
