---
title: NPOI'de Eksik Özellikler
type: docs
weight: 20
url: /tr/net/missing-features-in-npoi/
---
Bu bölüm, yalnızca Aspose.Cells'de bulunan ve NPOI'de olmayan (HSSF ve XSSF) özellikleri gösterir.

NPOI'den Aspose.Cells'e geçmek isteyen geliştiriciler için çok faydalıdır.

Bu, NPOI ile karşılaştırıldığında Aspose.Cells'in aşağıdaki zengin özelliklerini içerir:

- [Aspose.Cells'deki Veri İşleme Özellikleri](/cells/tr/net/data-handling-features-in-aspose-cells/)
