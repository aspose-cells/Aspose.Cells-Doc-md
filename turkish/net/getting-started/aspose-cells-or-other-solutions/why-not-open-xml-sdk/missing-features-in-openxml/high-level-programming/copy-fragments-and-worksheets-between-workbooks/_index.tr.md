---
title: Fragmanları ve çalışma sayfalarını Workbooks arasında kopyalama
type: docs
weight: 20
url: /tr/net/copy-fragments-and-worksheets-between-workbooks/
---
...
1. Kitaba dialogunda, sayfaları alacak olan çalışma kitabını tıklayın.
1. Seçilen sayfaları yeni bir çalışma kitabına taşımak veya kopyalamak için, Yeni Kitap'ı tıklayın.
1. Taşınan veya kopyalanan sayfaların yerleştirileceği sayfadan önce kutusunda istediğiniz sayfadan önce tıklamanız gerekiyor.
1. Sayfaları taşımak yerine kopyalamak için, Kopyasını Oluştur onay kutusunu işaretleyin.
