...
|**Üye adı** |**Değer** |**Tanım** |
|:- |:- |:- |
| CSV'ler|1 | Bir CSV dosyasını temsil eder.|
...
| Sekmeyle Sınırlandırılmış|11 | Sekmeyle ayrılmış bir metin dosyasını temsil eder.|
...
| E-tabloML|15 | Bir Excel 2003 xml dosyasını temsil eder.|
