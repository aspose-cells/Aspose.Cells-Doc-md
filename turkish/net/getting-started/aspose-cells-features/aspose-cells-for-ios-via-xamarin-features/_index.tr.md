---
title: Xamarin Özellikleri aracılığıyla iOS için Aspose.Cells
type: docs
weight: 70
url: /tr/net/aspose-cells-for-ios-via-xamarin-features/
---
## **Aspose.Cells iOS için Xamarin Özelliklerine Genel Bakış**
Bu bölüm, Xamarin aracılığıyla iOS için Aspose.Cells for .NET ve Aspose.Cells arasındaki özelliklerin kullanılabilirliğinin karşılaştırmasını sağlar.
...
|**Özellik**|**.NET**|**Xamarin.iOS**|
|:- |:- |:- |
|Array, ArrayList, ResultSet vb.'den verileri içe/dışa aktarın.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Mevcut çalışma sayfasının bir kopyasını ekleyin (resimler, grafikler, diğer nesneler vb. dahil tüm içerikler)|{{< emoticons/tick >}}|{{< emoticons/tick >}} (Resimler ve çizelgeler desteklenmez)|
|Çalışma sayfalarını çalışma kitaplarının içinde veya arasında kopyalama veya taşıma|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|resim ekle|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Grafikler oluşturun|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|API'i kullanarak grafikler için gradyan arka planı ayarlayın|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Hücrelere yorum ekleme|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Veri doğrulamalarını uygulama|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Özel sayfa sonları oluşturun|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Microsoft Excel 2007'de desteklenen gelişmiş koşullu biçimlendirme desteği|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Bölmeleri Dondur / Çöz|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Verileri bağlamak için köprüler ekleyin|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Akıllı İşaretleyicileri Uygulayın|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Belge özellikleri ayarlarını belirtin|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Çalışma sayfalarını koruma/korumayı kaldırma|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Excel XP ve sonraki sürümlerde sunulan gelişmiş koruma seçeneklerini belirtin|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Form kontrollerini ve diğer çizim şekillerini/nesnelerini ekleyin|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Pivot tablolar ve pivot grafikler oluşturun|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Eklenti, VBA, makroları koruyun veya kaldırın|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Adlandırılmış aralıkları işleyin|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Özel grafikler oluşturun|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Elektronik tablolardan OLE nesneleri ekleyin, koruyun veya çıkarın.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Microsoft Excel 2010 mini grafiklerini uygulayın|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Dosyaları şifrele|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|Hücrelere, yazı tiplerine, kılavuz çizgilerine, grafik nesnelerine vb. farklı renkler uygulayın.|{{< emoticons/tick >}}|{{< emoticons/tick >}} (Grafik nesneleri desteklenmez)|
...
|Biçim ayarlarını bir çalışma sayfasına, satıra, sütuna veya bir hücre aralığına vb. uygulayın.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Kenar boşluklarınızı ve sayfa merkezlemenizi belirtin.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Üstbilginizi ve/veya altbilginizi oluşturun veya düzenleyin.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
