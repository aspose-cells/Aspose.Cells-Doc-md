...
Aşağıdaki tablolar Aspose.Cells for .NET özelliklerini özetlemekte ve ayrıntılı özellik açıklamalarına bağlantılar sağlamaktadır.
...
|**Özellik**|**.NET**|**.NET Standart 2.0** |
|:- |:- |:- |
|Bir DataTable, DataView, Array, DataGrid vb.'den verileri içe/dışa aktarın.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Hücreleri birleştir/böl|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Belge özelliği ayarlarını belirtin|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Çalışma Sayfalarını koruyun/korumayı kaldırın|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Transpoze seçeneklerini uygula|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Microsoft Excel 2010 mini grafiklerini uygulayın|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Microsoft Excel tarafından desteklenen tüm sayı biçimi ayarlarını hücrelere uygulayın.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Yazdırma alanını ayarlayın, başlıkları yazdırın veya kılavuz çizgilerini açın, vb.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
