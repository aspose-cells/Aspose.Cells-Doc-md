...
* Çalışma kitabındaki kullanılan fontların ikili içeriğini alma desteği
* Excel dosyasını çalışma kitabı yapısına JSON'a dönüştürmeyi destekler
* Hücre değeri, biçimlendirme, formül ve yorumu Numbers dosyasına dışa aktarmayı destekler
* HTML'yi kaydederken satır içi stil/hazırlığı HTML öğeleri içine yerleştirmeye destekler
* Oluşturulan HTML'de seçilen sayfa sekmesini vurgulama desteği
* GridJs için daha fazla kısa yol tuşunu destekler
* Excel'den kopyalanan içeriği, GridJs için çoklu hedef alanlara yapıştırmayı destekler

## Aspose.Cells for .NET 25.2
* Yükleme, kaydetme ve formül hesaplama gibi zaman alan işlemler için asenkron API'ler sağlar
* LightCells ile kaydederken hücreye zengin metin ayarlamayı destekler
* Farklı format dosyalarını okuma desteği
* dBase (dbf) format dosyası okuma ve yazma desteği
* WPS uyumlu gömülü resmi destekle
* GridJs'de salt okunur alan ayarlamayı destekle
* MS Excel'den GridJS'e sayı biçimi ayarını kopyalamayı destekle
* Kullanıcının kolaylığı için GridJS'de otomatik işlemleri geliştirme, örneğin boş satır/sütun uzatma, sayfa kaydırma, ...

## Aspose.Cells for .NET 25.1
* NET9'u destekler
* Kullanıcının özel motorundaki dinamik dizi formülü için hesaplamayı atlamayı destekle, özel fonksiyon kullanımı
* Kullanıcının özel motorundaki dış tablo referansını ifade etmesini almayı destekler
* Otomatik şekiller ve serbest şekilleri ODS dosyasına kaydetmeyi destekler
* Tablo içinde formlar ayarlarını okuma ve yazma desteği
* Font'daki Format 2 alt tablosunu destekler
* Satır verisi listesinin hücrelere içe aktarımını basitleştirir
* Güvenlik açığını gidermek için bağımlılığı güncelle
* GridJs için hücre ekleme/silme/güncelleme olaylarını daha fazla destekle
* GridJs için yerelleştirilmiş ondalık ayırıcı desteği
* GridJs için filtre listesi arama desteği
* Bir sayfada birden çok örneği destekle

## Aspose.Cells for .NET 24.12
* Hücre aralığı ekleme/silme sırasında formül değişikliklerini bildirme desteği
* BYROW ve BYCOL lambda fonksiyonlarını destekle
* LineGradientBrush, PathGradientBrush, HatchBrush ve TextureBrush'ı pcl'ye render etmeyi destekler
* HTML kaydederken inline stil veya formatlamayı css yerine yerleştirerek destekler
* Yazıya, hücreye renk gibi veri sıralayıcı anahtar olarak ekleme desteği
* PowerQueryFormulas'da sıra düzeni güncelleme ve grup eklemeyi destekler
* PivotField filtrelerinin çoklu filtreler, gün boyunca filtreleme gibi iyileştirmeleri
* GridJs'de satır/sütun eklemede veya silmede formül referansını yenilemeyi destekler
* GridJs için güncelleme izleme desteği
* GridJs'de sütunlar arasında merkezi hizalama desteği

## Aspose.Cells for .NET 24.11
* xlsx'den pcl'ye dönüştürme desteği
* PivotTable için harici kaynağın kaynağını almak için destek
* Excel sayfasında tablo ilişkilerini almak için destek
* Çok iş parçacığında hücrelerin biçimlendirilmiş dizisini almak için destek
* "PlaceInCell" resmi MemoryPreference mod ve formül hesaplaması için destek
* Hatalar, varlıklar gibi zengin değerleri içe aktarma/dışa aktarma desteği
* Excel'deki gibi İmza Satırı ekleme desteği
* Oluşturulan SVG'nin farklı framework'ler için aynı davranışı göstermesini sağlamak için geliştirme
* Serbest biçimli şekiller ekleme iyileştirmeleri
* GridJs için farklı veri türleri (tarih, saat, para birimi...) için sayı biçimi türünü ayarlama desteği
* GridJs için satır/kolon stiline sınır çizgileri çizme desteği
* GridJs'nin görüntüleme ve düzenleme iyileştirmeleri

## Aspose.Cells for .NET 24.10
* İlgili harici bağlantıdan pivot tablonun kaynağını alma desteği
* Kapsamlı pivot tablolar oluşturma desteği
* Pivot alanını aralığa dönüştürmeyi iyileştirme
* CHM dosyasını okuma desteği
* OOXML şablon dosyaları içe aktarılırken rastgele hücreleri/satırları göz ardı etme desteği, istisna yerine
* Boş satır/kolon silme için daha birçok seçenek desteği
* GridWeb için sunucu tarafı bilgisi almak veya güncellemek için destek (.Net6)
* GridJs için farklı sayı biçimi türleri ayarlama desteği
* GridJs için Tembel yükleme desteği
* GridJs'de zengin metin hücre değerleri için metni bölme iyileştirmeleri

## Aspose.Cells for .NET 24.9
* Hücre için onay kutusu oluşturma ve onay kutusunu PDF'ye gömme desteği
* Denklem içeriğini MathML ve LaTeX'e dışa aktarma desteği
* HTML kaydederken hücre adresini dışa aktarma desteği
* xlsx özellik çantası özelliklerini ayrıştırma desteği
* PDF kaydedilirken resim kaynaklarını serbest bırakmayı optimize etme
* Pivot hesaplanan öğe/sütun formüllerini alma desteği
* Gruplandırılmış pivot alanı hesaplama performansını iyileştirme
* OLE (Nesne Bağlantısı ve Gömmesi) formatını tespit etmeye destek
* GridJs'de formüllerin geliştirilmesi: formülleri göster ve formül açıklaması, doğrulama ayarları için formülleri parametre olarak kullan
* GridJs'de kullanıcı girişleri için sözdizimi denetimi ve yazım hatası düzeltmeye destek
* GridJs'de hücre biçimi zaman ise mobil cihazlar için zaman kontrolü gösterimine destek
* Mobil cihazlar için GridJs'de doğrulama düzenleme ve başarısız uyarılarının etkisini geliştirme

## Aspose.Cells for .NET 24.8
* Yeni fonksiyonlara destek: VALUETOTEXT, ARRAYTOTEXT
* Linux üzerinde .NET6.0 için GridWeb desteği
* Pivot alanı öğesine göre pivot tabloyu sıralamaya destek
* "Place in Cell" resimleri içeren tüm hücrelere ziyaret etmeye destek
* Dosyayı şifrelerken belge özelliklerini şifrelememeye destek
* GridWeb'de boşluklu formülleri düzenlemeye destek
* GridJs'de görünmez şekilleri göster veya gizle yapılandırmasına destek
* Ayarlar, formülleri düzenleme, giriş denetimi gibi GridJs özelliklerini geliştirme

## Aspose.Cells for .NET 24.7
* Formüllerde DROP fonksiyonuna destek
* Karmaşık parametrelerle LET ve MAKEARRAY fonksiyonlarının performansını artırma
* Çizelgede yıldız karakterlerinin ana hatlarını destekleme
* Bir nesneyi dekoratif hale getirmeye destek
* Dizi değişimlerini destekleme
* TreeMap grafiğinin görüntüsünü geliştirme
* "Üzerinde hücre" resmini "iç hücre" ye dönüştürmeye destek
* Yerel Office bulut yazı tipini varsayılan olarak yüklemeye destek
* JSON verisini içe aktarırken JSON şemasını korumaya destek
* AZW3 biçiminde dosya dışa aktarmaya destek
* GridJs'de hücreye sarmak ayarlandıktan sonra otomatik yükseklik ayarlamaya destek
* GridJs için akış yazıcı yöntemi kullanarak JSON oluşturmayı destekleme
