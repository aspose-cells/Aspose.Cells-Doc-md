...
description: "Python için Aspose.Cells via .NET özellikleri."
---

{{% alert color="primary" %}} 

Bu sayfa Aspose.Cells için Python via .NET özelliklerini özetler.

{{% /alert %}} 
## **Dosya Biçimleri ve Dönüşümler**
- XLS, SpreadsheetML (XLSX, XML), XLSB, XLSM, DOCX, PPTX, JSON, Virgülle Ayrılmış Değer (CSV), HTML, OpenDocument Spreadsheet (ODS), PDF, Sekmeyle Ayrılmış, Düz Metin (TXT) ve TIFF, JPG, PNG, BMP ve SVG gibi popüler görüntü biçimlerini içerir.
