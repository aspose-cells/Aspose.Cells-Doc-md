---
title: .NET aracılığıyla Python için Aspose.Cells 22.7 Sürüm Notları
type: docs
weight: 10
url: /tr/python-net/aspose-cells-for-python-net-22-7-release-notes/
---
{{% alert color="primary" %}} 

Bu, .NET üzerinden Python için Aspose.Cells için ilk versiyondur.
Bu sayfa, .NET 22.7 üzerinden Python için Aspose.Cells için sürüm notları içerir.

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
|:- |:- |:- |
|CELLSPYTHONNET-55|<p>**Dosya Biçimleri ve Dönüşümler**</p><p>- XLS, SpreadsheetML (XLSX, XML),XLSB, XLSM, DOCX, PPTX, JSON, Virgülle Ayrılmış Değer (CSV), HTML, OpenDocument Elektronik Tablo (ODS), PDF, Sekmeyle Ayrılmış, Düz Metin (TXT) ve aşağıdakiler dahil popüler görüntü biçimleri TIFF, JPG, PNG, BMP ve SVG.</p>|Yeni özellik|
|CELLSPYTHONNET-56|<p>**Oluşturma ve Yazdırma**</p><p>- Elektronik tabloyu vektör görüntülere dönüştürün (EMF)</p><p>- Çalışma sayfalarını raster görüntülere dönüştürün (Çok Sayfalı TIFF, GIF)</p><p>- Çalışma sayfalarını raster görüntülere dönüştürün (PNG, JPEG, vb.)</p><p>- Elektronik Tabloyu yüksek doğrulukla PDF'ye dönüştürün</p>|Yeni özellik|
