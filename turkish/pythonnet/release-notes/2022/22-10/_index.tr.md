---
title: .NET aracılığıyla Python için Aspose.Cells 22.10 Sürüm Notları
type: docs
weight: 7
url: /tr/python-net/aspose-cells-for-python-net-22-10-release-notes/
---
{{% alert color="primary" %}} 

Bu, .NET üzerinden Python için Aspose.Cells için ilk versiyondur.
Bu sayfa, .NET 22.10 aracılığıyla Python için Aspose.Cells için sürüm notları içerir.

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
|:- |:- |:- |
|CELLSPYTHONNET-79|MacOS sürümünü destekleyin|
...
|CELLSNET-51419|XLS dosyası XLSM'ye dönüştürülürken Pivot tablonun Harici Bağlantısı silindi|
|CELLSNET-51984|PivotTable dosyasına sahip XLSX dosyası yeniden kaydedildikten sonra bozuldu|
...
|CELLSNET-52049|XLSX'ten PDF'e: Metin düzgün biçimlendirilmemiş|
|CELLSNET-52073|Excel'de Arial Tur yazı tipinin PDF'e dönüştürülmesiyle ilgili sorun|
...
|CELLSNET-52001|Oluşturulan bozuk dosyanın XLSX dosyasının yeniden kaydedilmesi|
...
|CELLSNET-52074|HTML'den XLSX'e: Eksik hücre içeriği|
