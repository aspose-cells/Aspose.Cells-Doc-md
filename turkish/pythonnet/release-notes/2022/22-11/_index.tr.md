...
type: docs
weight: 6
url: /tr/python-net/aspose-cells-for-python-net-22-11-release-notes/
---
{{% alert color="primary" %}} 
...
|:- |:- |:- |
|CELLSPYTHONNET-82|ActiveX denetimlerine sahip bir XLSM dosyasının yeniden kaydedilmesi, dosyadaki makroları bozdu|
...
|CELLSNET-52156|XLSX'i HTML'ye kaydederken birleştirilmiş tablo hücrelerini devre dışı bırakın|
|CELLSNET-52159|Html'yi excel'e dönüştürürken daraltılmış özelliği ayrıştırma desteği|
|CELLSNET-51939|XLSX'ten PDF'e: İçerik yanlış hizalama|
|CELLSNET-51940|XLS'den PDF'e: Hücrelerde içerik kayması|
|CELLSNET-52068|XLSX'ten PDF'e: Eksik şekiller/Düzen daraltma|
|CELLSNET-52092|Excel'deki rakamlarda karakter baskısı ve boşluklar kesildi|
|CELLSNET-52186|XLSX belgesini PDF'ye dönüştürürken şekiller/kutular boş|
|CELLSNET-52225|Tersine çevrilmiş metin kutularındaki XLSX'ten PDF Karakterlerine|
...
|CELLSNET-52143| Bir XLS dosyasını XLSM'ye dönüştürürken bağlantının ilişki türü değişiyor|
|CELLSNET-52144|XLS'den XLSM'ye dönüştürme, bağlantı ilişkisi türünü değiştirme|
...
|CELLSNET-52181|XLSX'ten HTML'ye: Cells aralığı doğru şekilde dışa aktarılmadı|
...
|CELLSNET-52241|Belgedeki kutular (şekiller) PDF çıktısında görünmüyor|
