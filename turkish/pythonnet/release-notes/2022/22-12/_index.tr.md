---
title: Aspose.Cells for Python via .NET 22.12 Sürüm Notları
type: docs
weight: 5
url: /tr/python-net/aspose-cells-for-python-net-22-12-release-notes/
---
{{% alert color="primary" %}} 

Bu, Aspose.Cells for Python via .NET için ilk versiyondur.
Bu sayfa Aspose.Cells for Python via .NET 22.12 için sürüm notları içerir.
