...
type: docs
weight: 40
url: /tr/python-net/protect-and-unprotect-workbook-structure/
...
## **Workbook Yapısını Koruma Aspose.Cells for Python via .NET ile**
...
## **Workbook Yapısını Korumasını Kaldır Aspose.Cells for Python via .NET ile**
Workbook yapısını korumak veya kaldırmak Aspose.Cells for Python via .NET API ile oldukça kolaydır.
