...
type: docs
weight: 10
url: /tr/python-net/protecting-worksheets/
---
...
Aspose.Cells for Python via .NET, Microsoft Excel dosyasını temsil eden [**Workbook**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook) sınıfını sağlar. [**Workbook**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook) sınıfı, Excel dosyasındaki her bir çalışma sayfasına erişimi sağlayan [**worksheets**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook/worksheets) koleksiyonunu içerir. Bir çalışma sayfası, [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet) sınıfı ile temsil edilir.

[**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet) sınıfı, çalışma sayfasına koruma uygulamak için kullanılan [**protect**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/protect) yöntemini sağlar. [**protect**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/protect/#aspose.cells.ProtectionType-str-str) yöntemi aşağıdaki parametreleri kabul eder:

- Koruma Türü, çalışma sayfasına uygulanacak koruma türü. Koruma türü, [**ProtectionType**](https://reference.aspose.com/cells/python-net/aspose.cells/protectiontype) numaralandırma yardımıyla uygulanır.
...
[**ProtectionType**](https://reference.aspose.com/cells/python-net/aspose.cells/protectiontype) numaralandırma, aşağıdaki önceden tanımlanmış koruma türlerini içerir:
...
Örnek: Aşağıdaki örnek, çalışma sayfasındaki birkaç hücreyi nasıl koruyacağını göstermektedir. İlk olarak çalışma sayfasındaki tüm hücreleri kilidini açar ve ardından (A1, B1, C1) 3 hücreyi kilitleyerek korur. Son olarak, çalışma sayfasını korur. [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) nesnesi, bir boolean özelliğini, [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked) adlı bir özellik içerir. *Column/Row.ApplyStyle()* yöntemini kullanarak satır/sütunun kilidini açmak veya kilitlemek için [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked) özelliğini true ya da false olarak ayarlayabilirsiniz.
...
Aspose.Cells for Python via .NET kullanarak herhangi bir satırı kolayca kilitleyebilirsiniz. Burada, [**Aspose.Cells.Row**](https://reference.aspose.com/cells/python-net/aspose.cells/row) sınıfının [**apply_style()**](https://reference.aspose.com/cells/python-net/aspose.cells/row/apply_style) yöntemi kullanılarak, çalışma sayfasındaki belirli bir satıra [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) uygulanabilir. Bu yöntem iki argüman alır: bir [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) nesnesi ve uygulanan formatlamayla ilgili tüm üyeleri içeren [**StyleFlag**](https://reference.aspose.com/cells/python-net/aspose.cells/styleflag) nesnesi.

Aşağıdaki örnek, çalışma sayfasındaki bir satırı nasıl koruyacağını göstermektedir. İlk olarak, çalışma sayfasındaki tüm hücreleri kilidini açar ve ardından ilk satırı kilitleyerek korur. Son olarak, çalışma sayfasını korur. [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) nesnesi, bir [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked) adlı bir özellik içerir. Satır/sütunun kilidini açmak veya kilitlemek için [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked) özelliğini true ya da false olarak ayarlayabilirsiniz.
...
Aspose.Cells for Python via .NET, herhangi bir sütunu kolayca kilitlemenize olanak sağlar. Burada, [**Aspose.Cells.Column**](https://reference.aspose.com/cells/python-net/aspose.cells/column) sınıfının [**apply_style()**](https://reference.aspose.com/cells/python-net/aspose.cells/column/apply_style) yöntemi kullanılarak, çalışma sayfasındaki belirli bir sütuna [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) uygulanabilir. Bu yöntem iki argüman alır: bir [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) nesnesi ve uygulanan formatlamayla ilgili tüm üyeleri içeren [**StyleFlag**](https://reference.aspose.com/cells/python-net/aspose.cells/styleflag) nesnesi.

Aşağıdaki örnek, çalışma sayfasındaki bir sütunu nasıl koruyacağını göstermektedir. İlk olarak, çalışma sayfasındaki tüm hücreleri kilidini açar ve ardından ilk sütunu kilitleyerek korur. Son olarak, çalışma sayfasını korur. [**Style**](https://reference.aspose.com/cells/python-net/aspose.cells/style) nesnesi, bir [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked) adlı bir özelliğe sahiptir. Satır/sütunun kilidini açmak veya kilitlemek için [**is_locked**](https://reference.aspose.com/cells/python-net/aspose.cells/style/is_locked) özelliğini true ya da false olarak ayarlayabilirsiniz.
