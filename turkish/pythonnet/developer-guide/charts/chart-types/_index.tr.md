...
description: Aspose.Cells for Python via .NET tarafından desteklenen çeşitli grafik türleri hakkında bilgi edinin. Kılavuzumuz, kullanılabilir farklı grafik türlerinin her birini göstererek bunları nasıl oluşturup değiştirebileceğinizi anlatır.
keywords: Aspose.Cells for Python via .NET, grafikler, grafik türleri, desteklenen, oluşturma, değiştirme, çalışma sayfaları.
type: docs
weight: 5
url: /tr/python-net/chart-types/
---

## **Giriş**
Bir grafik, bir bilginin görsel gösterimidir. Aspose.Cells for Python via .NET, geliştircilere bilgileri grafiklerde görselleştirme imkanı sağlar, tıpkı Microsoft Excel gibi. Bilgi sunumunu grafiklerde yapmak, karar vericilerin hızlı ve zamanında kararlar almasını sağlar. Grafikler sayesinde karşılaştırmaları, desenleri ve eğilimleri hızlıca görmek, ham sayılardan daha kolaydır. Çalışma sayfasındaki verilere dayanarak çalışma zamanında grafikler oluşturmak, Aspose.Cells'in en güçlü özelliklerinden biridir.

## **Grafik Türleri**
Aspose.Cells for Python via .NET, Microsoft Excel'de desteklenen hemen hemen tüm grafik türlerini destekler. Grafikler iki ana kategoriye ayrılır:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki sütun grafikleridir:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki çubuk grafikleridir:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki çizgi grafikleridir:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki pasta grafikleridir:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki saçılım grafikleri:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki alan grafikler:
...
Aspose.Cells for Python via .NET tarafından desteklenen aşağıdaki donut grafikler:
...
Aşağıdaki radar grafikleri Aspose.Cells for Python via .NET'de desteklenmektedir:
...
#### **Fıskiye Grafiği**
Fıskiye grafiği, bir süreçteki birden fazla aşamadaki değerleri gösterir. Örneğin, bir satış boru hattındaki her aşamadaki satış potansiyeli sayısını göstermek için bir fıskiye grafiği kullanabilirsiniz. Genellikle değerler kademeli olarak azalır, çubukların bir fıskiyeyi andırmalarına izin verir.

Funnel grafik, Aspose.Cells for Python via .NET'de desteklenmektedir.

#### **Yüzey 3D Grafikleri**
Diğer 3D grafikler gibi, yüzey 3D grafikleri de X, Y ve Z eksenlerine dayanmaktadır. Bu grafikler, "X" ve "Y"'ye göre "Z" değişkenindeki bir değişimi göstermek için kullanışlıdır.

Aşağıdaki yüzey 3D grafikler Aspose.Cells for Python via .NET'de desteklenmektedir:
...
Aşağıdaki balon grafikler Aspose.Cells for Python via .NET'de desteklenmektedir:
...
Aşağıdaki hisse senedi grafikler Aspose.Cells for Python via .NET'de desteklenmektedir:
...
Aşağıdaki silindirik grafikler Aspose.Cells for Python via .NET'de desteklenmektedir:

- Simple cylinder chart
- Stacked cylinder chart
- 100% Yığın silindir grafiği
...
Aşağıdaki konik grafikler Aspose.Cells for Python via .NET'de desteklenmektedir:
...
Aşağıdaki piramit grafikler Aspose.Cells for Python via .NET'de desteklenmektedir:
...
Treemap grafik, Aspose.Cells for Python via .NET'de desteklenmektedir.
...
Güneş patlaması grafik, Aspose.Cells for Python via .NET'de desteklenmektedir.
...
Kutu ve saçak grafiği Aspose.Cells for Python via .NET'de desteklenmektedir.
...
Şelale grafiği Aspose.Cells for Python via .NET'de desteklenmektedir.
### **Özel Grafik Türleri**
