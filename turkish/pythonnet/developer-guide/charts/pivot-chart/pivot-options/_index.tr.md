---
title: PivotOptions ile PivotChart ı Yönetme
linktitle: Pivot Seçenekleri
type: docs
weight: 10
url: /tr/python-net/how-to-manage-pivotchart-with-pivotoptions/
description: PivotOptions ile PivotChart ı Yönetme.
keywords: PivotChart
---
## PivotChart Nedir
...
Aspose.Cells for Python via .NET kullanarak, PivotChart'ı yönetmek için [**PivotOptions**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/pivotoptions) kullanabilirsiniz.
