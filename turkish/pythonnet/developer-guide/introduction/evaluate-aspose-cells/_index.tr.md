...
{{% alert color="primary" %}}
 ...
 Değerlendirme için Aspose.Cells adresinden kolayca indirebilirsiniz.[pypi](https://pypi.org/project/aspose-cells-python/). Değerlendirme indirmesi, tam sürümün indirilmesi ile aynıdır: Bir lisans uyguladığınızda değerlendirme lisanslanır.
