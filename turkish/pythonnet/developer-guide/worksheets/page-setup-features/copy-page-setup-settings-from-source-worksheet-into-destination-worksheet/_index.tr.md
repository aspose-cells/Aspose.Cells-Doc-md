...
Aşağıdaki örnek kod, [**PageSetup.copy()**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/copy/#aspose.cells.PageSetup-aspose.cells.CopyOptions) yöntemini kullanarak bir çalışma sayfasındaki *Sayfa Ayarı ayarlarını* diğerine kopyalamanın örneklerini göstermektedir. Lütfen örnek kodu ve konsol çıktısını referans için inceleyin.
