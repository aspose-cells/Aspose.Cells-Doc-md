...
type: docs
weight: 190
url: /tr/python-net/how-to-set-comment-background/
...
Yukarıdaki kod, istediğiniz kendi seçtiğiniz rengin yorumlara eklenmesi için [**Aspose.Cells for Python via .NET**](https://products.aspose.com/cells/python-net/) kullanımını gösterecektir.
...
Aşağıdaki örnek kod, sıfırdan bir XLSX dosyası oluşturur ve hücre A1'e resim arka planlı bir yorum ekler, [**Aspose.Cells for Python via .NET**](https://products.aspose.com/cells/python-net/) API.
