---
title: Çalışma Kitabı Görünümünü Kontrol Etme
type: docs
weight: 600
url: /tr/python-net/how-to-control-workbook-view/
description: Aspose.Cells for Python via .NET kullanarak Çalışma Kitabı Görünümünü Nasıl Kontrol Edeceğinizi Öğrenin.
...
Excel sayfalarının görüntüsünü ayarlamanız gerektiğinde, yatay ve dikey kaydırma çubuklarını gizleyip gizlemediğinizi gibi her modülü nasıl kontrol edeceğinizi bilmelisiniz. Aspose.Cells bu özelliği sunar. Aspose.Cells, hedeflerinize ulaşmanıza yardımcı olmak için aşağıdaki özellikleri ve yöntemleri sağlar.
