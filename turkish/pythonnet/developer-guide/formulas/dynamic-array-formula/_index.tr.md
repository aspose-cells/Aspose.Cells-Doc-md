...
type: docs
weight: 70
url: /tr/python-net/calculation-of-dynamic-array-formulas/
---
...
## **Aspose.Cells for Python via .NET kullanarak Dinamik Dizi Formüllerini Ayarlama ve Güncelleme**
Aşağıdaki örnek kodu inceleyin, [örnek Excel dosyasını](dynamicArrayFormula.xlsx) yükler ve bazı sahte veriler içerir. Dosyayı yükledikten sonra, [**Cell.set_dynamic_array_formula**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/set_dynamic_array_formula/#str-aspose.cells.FormulaParseOptions-bool) fonksiyonunu kullanarak dinamik dizi formülü ayarlayın ve [**Workbook.refresh_dynamic_array_formulas**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook/refresh_dynamic_array_formulas/#bool) fonksiyonunu kullanarak formülleri güncelleyin ve en son olarak [çıktı Excel dosyasını](out.xlsx) kaydedin. 
