...
type: docs
weight: 10
url: /tr/python-net/how-to-format-number-to-scientific/
description: Bu makale, Aspose.Cells for Python via .NET API sini kullanarak Sayısal Verileri Bilimsel Biçime Formatlama yöntemini tanıtacaktır.
...
## **Aspose.Cells for Python via .NET kullanarak sayıları Bilimsel biçime nasıl biçimlendirilir.**
Aspose.Cells for Python via .NET kullanarak sayıları bilimsel gösterime biçimlendirmek için hücrenin `Style.Custom` özelliğini kullanabilirsiniz. Aspose.Cells, çalışma sayfasınızdaki verileri özel biçimlendirme yapmanıza imkan sağlar, bunlardan biri de bilimsel gösterimdir.
