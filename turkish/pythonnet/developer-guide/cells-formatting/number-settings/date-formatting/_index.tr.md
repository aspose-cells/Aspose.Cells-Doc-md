...
type: docs
weight: 10
url: /tr/python-net/format-number-to-date/
description: Bu makale, Aspose.Cells for Python via .NET API kullanarak sayıyı tarih formatına çevirmeyi anlatacaktır.
...
## **Aspose.Cells for Python via .NET ile Sayıyı Tarihe Formatlama Yöntemi**

Excel dosyalarıyla çalışmak için Aspose.Cells for Python via .NET kütüphanesinde sayıları tarihe biçimlendirmek için hücrelere programlama yoluyla tarih biçimi uygulayabilirsiniz. İşte Aspose.Cells ile Python kullanarak bunu nasıl yapacağınız:
