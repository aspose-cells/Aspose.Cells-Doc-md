...
type: docs
weight: 10
url: /tr/python-net/how-to-format-number-to-fraction/
description: Bu makale, Aspose.Cells for Python via .NET API kullanarak Sayı Biçimini Fraksiyona dönüştürme işlemini tanıtacaktır.
...
## **Aspose.Cells for Python via .NET kullanarak sayısal ifadeyi Kesir biçimine nasıl biçimlendirilir.**
Aspose.Cells for Python via .NET kullanarak sayıları kesir biçimine dönüştürmek oldukça basittir. Aspose.Cells for Python via .NET, Microsoft Excel yüklü olmadan .NET uygulamalarında Excel dosyalarıyla çalışmanıza olanak sağlayan güçlü bir kütüphanedir. Çeşitli özellikler içerir, bunlardan biri de sayıları kesir biçiminde biçimlendirmedir.

Aspose.Cells for Python via .NET kullanarak sayıları kesir biçimine nasıl biçimlendireceğinize dair adım adım kılavuz burada:
