...
description: Aspose.Cells for Python via .NET kullanarak Excel için sparkline oluştur.
---
...
## **Gelişmiş Konular**
- [Kıvılcımları ve Ayarları 3B Biçimi kullanarak Kullanma](/cells/tr/python-net/using-sparklines-and-settings-3d-format/)
