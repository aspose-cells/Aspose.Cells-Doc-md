...
type: docs
weight: 330
url: /tr/python-net/read-color-of-shape-s-glow-effect/
---

## Olası Kullanım Senaryoları

Herhangi bir şeklin parlama efektinin rengini okumak istiyorsanız, lütfen [**Shape.glow.color**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/gloweffect/color) özelliğini kullanın. Bu, şeklin parlama efektinin rengi ile ilgili çeşitli özellikleri bulmanıza yardımcı olacaktır.
