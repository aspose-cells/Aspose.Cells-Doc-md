...
description: Bu makale, Aspose.Cells for Python via .NET API si aracılığıyla İlkel Olmayan Şekillerdeki Verileri Göstermeyi göstermektedir.
keywords: Python Excel Kütüphanesi, Python İlkel Olmayan Şekillerdeki Veriler, Python İlkel Olmayan Şekil Verilerini Erişme yöntemlerini gösterme.
---
...
Aspose.Cells for Python via .NET'de, ilkel olmayan şekiller [**AutoShapeType.NOT_PRIMITIVE**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/autoshapetype) türüne atanmıştır. Türlerini [**Shape.auto_shape_type**](https://reference.aspose.com/cells/python-net/aspose.cells.drawing/shape/auto_shape_type) özelliğini kullanarak kontrol edebilirsiniz.
