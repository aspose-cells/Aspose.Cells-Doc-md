...
type: docs
weight: 40
url: /tr/python-net/evaluate-aspose-cells/
---

{{% alert color="primary" %}}

Aspose.Cells'i [pypi](https://pypi.org/project/aspose-cells-python/) üzerinden kolayca değerlendirmek için indirebilirsiniz. Değerlendirme indirme, tam sürüm için yapılan indirme ile aynıdır: değerlendirme; lisans uygulandığında lisanslanır.
