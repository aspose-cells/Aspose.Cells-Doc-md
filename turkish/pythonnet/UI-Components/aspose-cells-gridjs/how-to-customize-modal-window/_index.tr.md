---
title: GridJs de modal pencere için UI görünümünü nasıl özelleştirilir  
type: docs
weight: 250
url: /tr/python-net/aspose-cells-gridjs/how-to-customize-ui-window/
description: Bu makale, GridJs de modal pencere için UI görünümünü nasıl özelleştirileceğini anlatmaktadır.
keywords: GridJs,özelleştir,modal,UI,görünüm,görsel,pencere
aliases:
aliases:
...
- [CSS Sınıf İsimlendirmesi](#css-class-naming)
...
| GirdiÖnerisi | `input-suggest` | `.x-spreadsheet-modal-input-suggest` |
| BağlantıEkle | `insert-url` | `.x-spreadsheet-modal-insert-url` |
| Bağlantı | `link` | `.x-spreadsheet-modal-link` |
| Yazdır | `print` | `.x-spreadsheet-modal-print` |
| Metin Döndürme | `text-rotate` | `.x-spreadsheet-modal-text-rotate` |
| Veri Doğrulama | `data-validation` | `.x-spreadsheet-modal-component-data-validation` |
| Daha Fazla Sayı Formatı | `more-number-formats` | `.x-spreadsheet-modal-more-number-formats` |
| Doğrulama Uyarısı | `validation-alert` | `.x-spreadsheet-modal-validation-alert` |
| EkleSil | `insert-delete` | `.x-spreadsheet-modal-insert-delete` |
...
### Örnek 3: Karanlık Mod Tema 🌙

Karanlık mod desteği olan uygulamalar için mükemmeldir.
...
Yaratıcı ve eğlenceli uygulamalar için mükemmeldir.
...
İş ve kurumsal uygulamalar için uygun.
