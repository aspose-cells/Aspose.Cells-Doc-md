...
type: docs
weight: 250
url: /tr/python-net/aspose-cells-gridjs/mobile/
description: Bu makale, GridJs in mobil cihazda nasıl kullanılacağını açıklar.
keywords: excel, mobil, elektronik tablo, düzenleyici, mobil elektronik tablo, görüntüleyici
---
...
GridJs [demo’sunu](https://github.com/aspose-cells/Aspose.Cells.Grid-for-Python-via-.NET/tree/main/Examples.GridJs "GridJs demosu") çalıştırın

Mobil terminalde sayfaya IP yoluyla erişmeniz gerekecek http://127.0.0.1:2022 . 
...
Sayfaya şuradan gidiniz http://yourip:82/ .
