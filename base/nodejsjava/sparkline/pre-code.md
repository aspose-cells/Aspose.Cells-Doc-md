---
title: Sparklines in Aspose.Cells for Aspose.Cells for Node.js via Java
...
<!-- CODE_BLOCK:0:Line Sparklines example using worksheet.SparklineGroups.add(SparklineType.Line, "A1:E1", false, dest) -->
...
<!-- CODE_BLOCK:1:Column Sparklines example using worksheet.SparklineGroups.add(SparklineType.Column, "A1:E1", false, dest) -->
...
<!-- CODE_BLOCK:2:Win/Loss Sparklines example using worksheet.SparklineGroups.add(SparklineType.Stacked, "A1:E1", false, dest) -->
...
<!-- CODE_BLOCK:3:Combining All Three Sparkline Types example calling worksheet.SparklineGroups.add() three times for Line, Column, and Stacked sparklines -->
