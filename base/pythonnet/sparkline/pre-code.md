---
title: Sparklines in Aspose.Cells for Aspose.Cells for Python via .NET
...
<!-- CODE_BLOCK:0:Line Sparklines example using worksheet.sparkline_groups.add(SparklineType.Line, ...) and customizing group.line.color in Python -->
...
<!-- CODE_BLOCK:1:Column Sparklines example using worksheet.sparkline_groups.add(SparklineType.Column, ...) in Python -->
...
<!-- CODE_BLOCK:2:Win/Loss Sparklines example using worksheet.sparkline_groups.add(SparklineType.Stacked, ...) in Python -->
...
<!-- CODE_BLOCK:3:Combining all three Sparkline Types example using worksheet.sparkline_groups.add() three times in Python -->
