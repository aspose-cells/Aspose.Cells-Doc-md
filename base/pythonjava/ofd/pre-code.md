...
<!-- CODE_BLOCK:0:Creating an invoice with a logo and saving as OFD using Aspose.Cells for Python via Java -->
...
<!-- CODE_BLOCK:1:Converting an existing Excel file to OFD using Aspose.Cells for Python via Java -->
