...
linktitle: OFD
description: Aspose.Cells is a Java library for working with spreadsheet files that supports converting Excel workbooks to OFD (Open Fixed-layout Document) format. This article demonstrates how to create Excel content and export it as OFD, as well as how to convert existing Excel files to OFD using Aspose.Cells.
...
type: docs
weight: 195
url: /java/converting-excel-to-ofd-format/
