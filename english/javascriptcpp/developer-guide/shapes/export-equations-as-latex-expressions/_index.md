...
If you want to export equations in Excel as LaTeX expressions, you can use the [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) method. 

The following sample code shows how to use the [EquationNode.toLaTeX()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toLaTeX--) method and insert the generated results into HTML:
...
If you want to export equations in Excel as MathML expressions, you can use the [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) method. 

The following sample code shows how to use the [EquationNode.toMathML()](https://reference.aspose.com/cells/javascript-cpp/equationnode/#toMathML--) method and insert the generated results into HTML:
