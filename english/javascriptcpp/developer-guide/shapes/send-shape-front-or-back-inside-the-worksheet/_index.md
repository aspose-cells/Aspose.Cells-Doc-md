...
When there are multiple shapes present in the same location, their visibility is determined by their z-order positions. Aspose.Cells provides [**Shape.toFrontOrBack()**](https://reference.aspose.com/cells/javascript-cpp/shape/#toFrontOrBack-number-) method, which changes the z-order position of the shape. To send a shape to the back, you will use a negative number like -1, -2, -3, etc., and to bring a shape to the front, you will use a positive number like 1, 2, 3, etc.
