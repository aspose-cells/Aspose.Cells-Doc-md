---
title: Change Character Spacing of Excel TextBox or Shape with JavaScript via C++
linktitle: Change Character Spacing of Excel TextBox or Shape
type: docs
weight: 280
url: /javascript-cpp/change-character-spacing-of-excel-textbox-or-shape/
description: Change the character spacing of Excel textboxes or shapes using Aspose.Cells for JavaScript via C++. 
---

{{% alert color="primary" %}}

You can change the character spacing of an Excel textbox or shape using the [**TextOptions.spacing**](https://reference.aspose.com/cells/javascript-cpp/textoptions/#spacing--) property.
