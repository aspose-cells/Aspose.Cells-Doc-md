...
The following sample code demonstrates the use of [**Chart.hasAxis(axisType, isPrimary)**](https://reference.aspose.com/cells/javascript-cpp/chart/#hasAxis-AxisType-boolean-) to determine if the sample chart has Primary and Secondary Category and Value Axis.  
