...
2. Change the Y‑axis: Right‑click on the **Y‑axis**. Click **Format Axis**. In **Labels**, click the **Label Position** drop‑down and select **Low**.  
   <br>
   <img src="2.png" width=70% />
3. Select any bar and go to **Formatting**. Set an appropriate gap width.  
   <br>
   <img src="3.png" width=70% />
4. Remove the minus sign (–) from the tornado chart. Select the X‑axis. Go to **Formatting**. In the Axis Options, click **Number**. In **Category**, select **Custom**. In **Format Code** write `###0,###0`. Click **Add**.  
   <br>
