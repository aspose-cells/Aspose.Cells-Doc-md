...
1. Access the [**Series**](https://reference.aspose.com/cells/javascript-cpp/series) object’s [**ChartPoint**](https://reference.aspose.com/cells/javascript-cpp/chartpoint).
