...
First step, you need to define a class **"ChartChineseSettings"** that inherits from [**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/).  
...
<html>
    ...
    <script src="aspose.cells.js.min.js"></script>
    <script type="text/javascript">
        const { Workbook, SaveFormat, ChartChineseSettings } = AsposeCells;
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            workbook.settings.globalizationSettings = new ChartChineseSettings();
...
After the above operation, you can obtain an output chart picture with the Chinese region.  
