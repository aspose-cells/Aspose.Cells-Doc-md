...
Please use [**ContentTypePropertyCollection.add(string, string)**](https://reference.aspose.com/cells/javascript-cpp/contenttypepropertycollection/#add-string-string-) method to add a custom property which will be visible in the Document Information Panel.
