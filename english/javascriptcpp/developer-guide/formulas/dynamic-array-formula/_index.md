---
title: Setting Dynamic Array Formulas with JavaScript via C++
linktitle: Setting Dynamic Array Formulas
description: How to use Aspose.Cells library to calculate dynamic array formulas in Excel using JavaScript via C++. Load, calculate, and save Excel files easily.
keywords: Dynamic Array Formulas, Dynamic Array Formulas in Excel, Set dynamic array formulas JavaScript via C++, Calculation of dynamic array formulas JavaScript via C++, operate dynamic array formulas of Excel.
type: docs
weight: 70
url: /javascript-cpp/calculation-of-dynamic-array-formulas/
---
...
Please see the following sample code that loads the [sample Excel file](dynamicArrayFormula.xlsx) which contains some dummy data. After loading the file, call the [Cell.dynamicArrayFormula(string, FormulaParseOptions, boolean)](https://reference.aspose.com/cells/javascript-cpp/cell/#dynamicArrayFormula-string-formulaparseoptions-boolean-) function to set dynamic array formula and [Workbook.refreshDynamicArrayFormulas(boolean)](https://reference.aspose.com/cells/javascript-cpp/workbook/#refreshDynamicArrayFormulas-boolean-) function to refresh dynamic array formulas before calling formula calculation, and finally, save the workbook as [output Excel file](out.xlsx).  
