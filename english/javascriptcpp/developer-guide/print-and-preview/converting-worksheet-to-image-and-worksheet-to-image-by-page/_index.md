...
2. Install it on your development computer. All [Aspose](http://www.aspose.com/) components, when installed, work in evaluation mode. The evaluation mode has no time limit and it only injects watermarks into the produced documents. Now start your development environment and create a new console application. This example uses a JavaScript console application, but you can use any setup that integrates with JavaScript. Add a reference to Aspose.Cells into the created project.
...
The following code is used by the component to accomplish the task. It converts Sheet1 in **Testbook.xlsx** to an image file to demonstrate how easy this conversion is.
...
The following code is used by the component to accomplish the task. It converts Sheet1 in **Testbook2.xlsx** to image files by page.
