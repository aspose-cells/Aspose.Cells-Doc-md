...
Please note **that** while adding a digital signature to an already signed Excel document, if the original document is an Aspose.Cells generated document, it works well. But if the original document is generated by other engines (e.g. Microsoft Excel etc.), Aspose.Cells cannot keep the file the same after loading and re‑saving it, which will make the original signature invalid.
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Create new digital signature and add it to digital signature collection
