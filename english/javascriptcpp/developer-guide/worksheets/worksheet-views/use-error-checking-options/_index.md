...
keywords: store numbers as text in excel using JavaScript via C++, error check excel options JavaScript via C++  
---  

{{% alert color="primary" %}}  
Microsoft Excel allows users to define error checking options and rules. Users often see error checks when creating formulas; a small triangle at the top right corner of a cell appears when there's a problem with a cell. Excel provides information that helps users correct common problems.  
{{% /alert %}}  
