...
description: This article shows you code explaining how to set a print area using the Aspose.Cells library for JavaScript via C++.
...
4. **Professional Presentation:** It ensures that only the polished and final version of the data is printed, which is particularly important for reports or presentations.  
...
Clearing the print area in a spreadsheet application like Excel using Aspose.Cells will cause the entire worksheet to be included when you print the document. If a print area is set, only the specified range of cells will be printed. By clearing the print area, you ensure that no specific range is defined, and the default printing behavior—printing the entire sheet—will take effect.
...
2. **No Print Area Limits:** Previously defined print area limits will be removed. If there were specific rows and columns designated for printing, they will no longer be constrained.  
...
To set the print area in a specified worksheet, first load the [sample file](input.xlsx), and then you should modify the **PageSetup.printArea** property of the **PageSetup** object for the desired worksheet. Setting this property to a range string will set the print area.
...
To clear the print area in a specified worksheet, first load the [sample file](input.xlsx), and then you should modify the **PageSetup.printArea** property of the **PageSetup** object for the desired worksheet. Setting this property to an empty string will clear the print area.
