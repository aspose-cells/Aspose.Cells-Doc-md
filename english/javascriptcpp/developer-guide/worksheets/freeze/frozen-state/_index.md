...
description: In this article, you will learn how to check the frozen state of an Excel worksheet programmatically using JavaScript with a C++ library.
---

## **Introduction**

In this article, we will learn how to check the frozen state of an Excel worksheet programmatically. We can simply determine whether the worksheet is frozen or split in MS Excel. But is there a way to determine whether it is frozen or split using JavaScript? We can do it with Aspose.Cells for JavaScript via C++.
