...
- Method 1  
  ...
  - This will open a dialog to enter comments in the active cell.  
...
Aspose.Cells provides the [**Comments.AddThreadedComment**](https://reference.aspose.com/cells/javascript-cpp/commentcollection/#addthreadedcomment-string-string-ThreadedCommentAuthor-) method to add threaded comments. The method accepts the following three parameters.
...
To read threaded comments in Excel, simply hover your mouse over the cell containing comments to view the comments. The comment view will look like the following image.

![todo:image_alt_text](threaded-comments_1.jpg)

### **Read Threaded Comments using Aspose.Cells**

Aspose.Cells provides the [**Comments.threadedComments**](https://reference.aspose.com/cells/javascript-cpp/commentcollection/#threadedComments-string-) method to retrieve threaded comments for the specified cell. The method accepts the cell name as a parameter and returns a [**ThreadedCommentCollection**](https://reference.aspose.com/cells/javascript-cpp/threadedcommentcollection). You can iterate over the collection to view the comments.

The following example demonstrates reading comments from cell A1 by loading the [sample Excel File](89849861.xlsx). Please see the console output generated by the code for reference.
...
Aspose.Cells provides the [**Comments.threadedComments**](https://reference.aspose.com/cells/javascript-cpp/commentcollection/#threadedComments-string-) method to retrieve threaded comments for the specified cell. It returns a [**ThreadedCommentCollection**](https://reference.aspose.com/cells/javascript-cpp/threadedcommentcollection), and you can use the [**ThreadedComment.createdTime**](https://reference.aspose.com/cells/javascript-cpp/threadedcomment/#createdTime--) property to obtain the creation time.
...
Aspose.Cells provides the [**Comments.threadedComments**](https://reference.aspose.com/cells/javascript-cpp/commentcollection/#threadedComments-string-) method to retrieve threaded comments for the specified cell. The method returns a [**ThreadedCommentCollection**](https://reference.aspose.com/cells/javascript-cpp/threadedcommentcollection). You can update the required comment in the collection and save the workbook.

The following example demonstrates editing the first threaded comment in cell A1 by loading the [sample Excel File](89849861.xlsx). Please see the [output Excel file](89849862.xlsx) generated by the code showing the updated comment for reference.
