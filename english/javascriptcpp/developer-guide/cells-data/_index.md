...
Aspose.Cells allows developers to add data to the cells in worksheets by calling the [**Cell**](https://reference.aspose.com/cells/javascript-cpp/cell) class' [**putValue**](https://reference.aspose.com/cells/javascript-cpp/cell/#putValue-boolean-) method. Aspose.Cells provides overloaded versions of the [**putValue**](https://reference.aspose.com/cells/javascript-cpp/cell/#putValue-boolean-) method that let developers add different kinds of data to cells. Using these overloaded versions of the [**putValue**](https://reference.aspose.com/cells/javascript-cpp/cell/#putValue-boolean-) method, it is possible to add a Boolean, string, double, integer, or date/time values to the cell.  
...
If you use the [**putValue**](https://reference.aspose.com/cells/javascript-cpp/cell/#putValue-boolean-) method to insert a large amount of data in a worksheet, you should add values to the cells first by rows, then by columns. This approach greatly improves the efficiency of your applications.  
            ...
            for (let i = 0; i <= maxRow; i++) {
                for (let j = 0; j <= maxColumn; j++) 
                {
                    ...
                    switch (cell1.type) {
                        ...
                        // Terminating the type checking when the cell data is null
