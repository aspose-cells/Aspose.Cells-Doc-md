...
description: Learn how to manage a cell's HTML string through the Aspose.Cells for JavaScript via C++ API.
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Get the HTML string of a specific cell.
...
![HTML String Example](htmlstring.png)