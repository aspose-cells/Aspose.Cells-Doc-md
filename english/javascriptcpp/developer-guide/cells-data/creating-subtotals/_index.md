...
In the examples below, we have added subtotals to the first worksheet of the [template file](book1.xlsx) using the Aspose.Cells for JavaScript via C++ API. When the code is executed, a worksheet with subtotals is created.
