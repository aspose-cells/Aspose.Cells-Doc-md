...
description: How to use the Aspose.Cells library in JavaScript via C++ to apply conditional formatting shading for alternating rows and columns. By adjusting these criteria, you have more control over how cells look and appear.  
keywords: Aspose.Cells, Conditional Formatting, JavaScript via C++, Alternate Rows, Alternate Columns, Shading  
type: docs  
weight: 30  
...
- **MOD()** function returns the remainder after a number is divided by a divisor, where the first parameter is the numeric value whose remainder you wish to find and the second parameter is the number used to divide the first. If the divisor is 0, it will return the #DIV/0! error.  
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Add FormatConditions to the Worksheet instance
            ...
            // Add the area to the FormatConditions instance
            conditionCollection.addArea(area);

            // Add a condition to the FormatConditions instance (Expression type)
