...
The following sample code loads the source Excel file and retrieves the list of fonts used inside it. It has one dummy worksheet that contains some dummy fonts added for illustration purposes. When the code prints all the fonts inside the workbook, it also prints those dummy fonts. The following screenshot shows the sample Excel file and how the dummy fonts are listed.
