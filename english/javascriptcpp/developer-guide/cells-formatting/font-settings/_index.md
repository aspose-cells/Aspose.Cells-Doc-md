---
title: Font Settings with JavaScript via C++
linktitle: Font Settings
description: Aspose.Cells is a JavaScript library for working with spreadsheet files. It supports setting the font settings of cells, allowing users to customize the font style and properties of cells. This article will introduce how to use the Aspose.Cells library to set cell font settings.
keywords: Aspose.Cells, Cells, Font Settings, Styles, Properties, JavaScript via C++
type: docs
weight: 30
url: /javascript-cpp/cells-font-settings/
---
...
Aspose.Cells provides the [**Cell**](https://reference.aspose.com/cells/javascript-cpp/cell) class' [**style**](https://reference.aspose.com/cells/javascript-cpp/cell/#style--) and [**style**](https://reference.aspose.com/cells/javascript-cpp/cell/#style-style-) methods which are used to get and set a cell's formatting style. The [**Style**](https://reference.aspose.com/cells/javascript-cpp/style) class provides properties for configuring font settings.  

### **Setting Font Name**  

Developers can apply any font to text inside a cell by using the [**Font**](https://reference.aspose.com/cells/javascript-cpp/style/#font--) object's [**name**](https://reference.aspose.com/cells/javascript-cpp/font/#name-string-) method.  
...
Developers can make text bold by setting the [**Font**](https://reference.aspose.com/cells/javascript-cpp/style/#font--) object's [**isBold**](https://reference.aspose.com/cells/javascript-cpp/font/#isBold-boolean-) method to **true**.   
...
Set the font size with the [**Font**](https://reference.aspose.com/cells/javascript-cpp/style/#font--) object's [**size**](https://reference.aspose.com/cells/javascript-cpp/font/#size-number-) method.  
...
Use the [**Font**](https://reference.aspose.com/cells/javascript-cpp/style/#font--) object's [**color**](https://reference.aspose.com/cells/javascript-cpp/font/#color-color-) method to set the font color. Select any color from the Color enumeration (part of JavaScript) and assign it to the [**color**](https://reference.aspose.com/cells/javascript-cpp/font/#color-color-) method.  
...
Apply strikeout by setting the [**Font**](https://reference.aspose.com/cells/javascript-cpp/style/#font--) object's [**isStrikeout**](https://reference.aspose.com/cells/javascript-cpp/font/#isStrikeout-boolean-) method to **true**.  
...
Developers can apply the superscript effect on the font by setting the [**isSuperscript**](https://reference.aspose.com/cells/javascript-cpp/font/#isSuperscript-boolean-) method of the [**Font**](https://reference.aspose.com/cells/javascript-cpp/style/#font--) object to **true**.  
...
## **Advance topics**  
- [Apply Superscript and Subscript Effects on Fonts](/cells/javascript-cpp/apply-superscript-and-subscript-effects-on-fonts/)  
- [Get a List of Fonts used in a Spreadsheet or Workbook](/cells/javascript-cpp/get-a-list-of-fonts-used-in-a-spreadsheet-or-workbook/)