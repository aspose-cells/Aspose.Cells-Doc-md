...
type: docs
weight: 10
url: /javascript-cpp/how-to-format-number-to-accounting/
description: This article will introduce how to format number to accounting using Aspose.Cells for JavaScript via C++ API.
...
3. **Select Accounting Format**: Click the dropdown and select **Accounting Number Format**. This automatically applies the default accounting format to your selected cells.
...
2. **Choose Accounting and Customize**: After selecting **Accounting**, adjust the decimal places or choose a different symbol. To remove the symbol, select **None**.
...
## **How to Format Number to Accounting in Aspose.Cells for JavaScript via C++**
To format numbers to accounting format in Aspose.Cells for JavaScript via C++, you can use the `Style` object associated with a cell or range of cells. The `Style` object allows you to set various formatting options, including number formats. The accounting format typically has a format code that can vary depending on the specific requirements (such as whether to show currency symbols, decimal places, etc.).

Here’s a basic example of how to apply an accounting number format to a cell in Aspose.Cells for JavaScript via C++:

1. **Reference Aspose.Cells**: Make sure you have Aspose.Cells for JavaScript via C++ referenced in your project. You can obtain it from the Aspose website.  
