...
description: This article introduces how to format numbers to fractions using Aspose.Cells for JavaScript via C++ API.
...
To format a cell as a fraction, you need to use the `custom` property of the `Style` object to set a specific number format code. Aspose.Cells supports various fraction formats, such as `"1/2"`, `"1/4"`, `"2/4"`, etc.
