...
<html>
    ...
    <script type="text/javascript">
        ...
        class GlobalizationSettingsImp extends AsposeCells.GlobalizationSettings {
            // This function returns the subtotal name
            totalName(functionType) {
                return "Chinese Total - 可能的用法";
            }

            // This function returns the grand total name
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Set the globalization settings to change the subtotal and grand total labels
