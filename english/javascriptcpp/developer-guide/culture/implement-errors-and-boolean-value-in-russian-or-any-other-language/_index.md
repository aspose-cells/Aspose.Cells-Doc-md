...
If you are using Microsoft Excel in the Russian locale or any other locale or language, it will display errors and boolean values according to that locale. You can achieve a similar behavior using Aspose.Cells for JavaScript via C++ by using the [**WorkbookSettings.globalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/workbooksettings/#globalizationSettings--) property. You will have to override the following methods of the [**GlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/globalizationsettings) class.
