---
title: Specify whether the PivotTable is compatible for Excel 2003 while refreshing PivotTable
type: docs
weight: 80
...
Aspose.Cells for JavaScript via C++ provides the [**PivotTable.isExcel2003Compatible**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#isExcel2003Compatible-boolean-) property which you can use to specify whether the PivotTable is compatible with Excel 2003 while refreshing PivotTable. If **true**, a string must be less than or equal to 255 characters, so if the string is greater than 255 characters, it will be truncated. If **false**, a string will not have the aforementioned restriction. The default value is **true**.

{{% /alert %}}

## **Specify whether the PivotTable is compatible for Excel 2003 while refreshing PivotTable**

The following sample code explains the usage of [**PivotTable.isExcel2003Compatible**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#isExcel2003Compatible-boolean-) property. The original string is 383 characters long. But when the property is set **true** and the pivot table is refreshed, the data of cell **B5** of the pivot table is truncated and it becomes 255 characters long. However, when the property is set **false** and the pivot table is refreshed again, the data of cell **B5** of the pivot table is not truncated and remains 383 characters long. Please read the comments inside the code for a better understanding of this property.
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Access cell A3 and set its data
            const cells = dataSheet.cells;
            let cell = cells.get("A3");
            cell.value = "FooBar";

            // Access cell B3 and set its data. We set B3 to a very long string that has more than 255 characters
            ...
            // Print the length of the cell B3 string
            console.log("Length of original data string: "  + cell.stringValue.length);

            // Access cell C3 and set its data
            cell = cells.get("C3");
            cell.value = "closed";

            // Access cell D3 and set its data
            cell = cells.get("D3");
            cell.value = "2016/07/21";

            // Access the second worksheet that contains the pivot table
            const pivotSheet = workbook.worksheets.get(1);

            // Access the pivot table
            const pivotTable = pivotSheet.pivotTables.get(0);

            // The IsExcel2003Compatible property indicates whether the PivotTable is compatible with Excel 2003 while refreshing.
            ...
            // Check the value of cell B5 on the pivot sheet.
            // It will be 255 characters because we have set the IsExcel2003Compatible property to true. All the data after 255 characters has been truncated
            ...
            // Now set IsExcel2003Compatible property to false and refresh again
            pivotTable.isExcel2003Compatible = false;
            pivotTable.refreshData();
            pivotTable.calculateData();

            // Now it will print the original length of the cell data. The data has not been truncated.
