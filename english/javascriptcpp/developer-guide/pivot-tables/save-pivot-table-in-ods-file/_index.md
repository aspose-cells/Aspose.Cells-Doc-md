...
Aspose.Cells for JavaScript via C++ provides the ability to save a pivot table in ODS files. For this, you simply convert a workbook with an existing pivot table or create a new pivot table and save the file in the ODS format. Be sure to call [**PivotTable.calculateData**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#calculatedata--) before saving to ensure that the pivot table is rendered in the output ODS file. The following code snippet demonstrates saving a pivot table to an ODS file.
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Create a new workbook or load one from the selected file
            let workbook;
