...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Specify the Strict Open XML Spreadsheet format.
            ...
            // Save to the output Excel file and provide download link
