---
title: Manage settings of Excel spreadsheet files with JavaScript via C++
linktitle: Workbook Settings
type: docs
weight: 185
url: /javascript-cpp/workbook-settings/
description: Manage settings of Excel files using Aspose.Cells for JavaScript via C++.
---
