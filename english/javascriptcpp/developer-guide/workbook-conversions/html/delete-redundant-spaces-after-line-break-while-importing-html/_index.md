...
Please use the **HtmlLoadOptions.deleteRedundantSpaces** property and set it **to true** to delete all the redundant spaces coming after the line‑break tag. By default, this property is **false**, and redundant spaces are preserved in the output Excel files.
...
The following sample code shows the usage of the **HtmlLoadOptions.deleteRedundantSpaces** property. Please set it **to true** or **false** to get the output as shown in the above screenshot.
...
<html>
    ...
    <script type="text/javascript">
        ...
        document.getElementById('runExample').addEventListener('click', async () => {
            ...
            // Set HTML load options and keep deleteRedundantSpaces true
