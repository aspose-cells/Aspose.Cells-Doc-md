...
Aspose.Cells for JavaScript via C++ provides the ability to read the background information and add the background in ODS files.  
...
Aspose.Cells for JavaScript via C++ provides the [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) class to manage background in ODS Files. The following code sample demonstrates the use of [**OdsPageBackground.color**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#color--) property to add a color background to the ODS file. Please see the [output ODS](90112031.ods) file generated by the code for reference.  
