---
title: Working with Background in ODS Files with JavaScript via C++
linktitle: Working with Background in ODS Files
type: docs
weight: 150
url: /javascript-cpp/working-with-background-in-ods-files/
description: Learn how to manage backgrounds in ODS files using Aspose.Cells for JavaScript via C++.
---

## **Background in ODS Files**  

Background can be added to sheets in ODS files. The background can either be a colored background or a graphic background. The background is not visible when the file is opened, but if the file is printed to PDF, the background is visible in the generated PDF. The background is also visible in the print preview dialog.  

Aspose.Cells for JavaScript via C++ provides the ability to read background information and add background in ODS files.  

## **Read Background Information from ODS Files**  

Aspose.Cells for JavaScript via C++ provides the [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) class to manage backgrounds in ODS files. The following code sample demonstrates the use of the [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) class by loading the [source ODS](90112030.ods) file and reading the background information. Please see the console output generated by the code for reference.  
...
## **Add Colored Background to ODS Files**  

Aspose.Cells for JavaScript via C++ provides the [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) class to manage backgrounds in ODS files. The following code sample demonstrates the use of the [**OdsPageBackground.color**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#color--) property to add a colored background to the ODS file. Please see the [output ODS](90112031.ods) file generated by the code for reference.  
...
## **Add Graphic Background to ODS Files**  

Aspose.Cells for JavaScript via C++ provides the [**OdsPageBackground**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground) class to manage backgrounds in ODS files. The following code sample demonstrates the use of the [**OdsPageBackground.graphicData**](https://reference.aspose.com/cells/javascript-cpp/odspagebackground/#graphicData--) property to add a graphic background to the ODS file. Please see the [output ODS](90112030.ods) file generated by the code for reference.  
