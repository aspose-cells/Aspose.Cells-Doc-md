...
The sample code given below demonstrates the use of [**TableToRangeOptions**](https://reference.aspose.com/cells/nodejs-cpp/aspose/cells/tables/tabletorangeoptions) class.  
