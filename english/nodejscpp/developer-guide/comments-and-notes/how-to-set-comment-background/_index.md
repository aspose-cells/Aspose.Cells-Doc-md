...
keywords: add insert picture image color comment background excel Node.js via C++
...
The following code will guide you on how to use [**Aspose.Cells**](https://products.aspose.com/cells/nodejs-cpp/) to add your favorite background color to comments of your own choice.
...
## **How to insert a picture or image into a comment in Excel**
