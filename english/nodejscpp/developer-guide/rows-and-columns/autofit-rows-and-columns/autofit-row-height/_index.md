...
<br>
If you set the parameter [LoadOptions.autoFitOptions.onlyAuto](https://reference.aspose.com/cells/nodejs-cpp/loadoptions/#autoFitOptions) to true when loading the file, then Aspose.Cells will automatically adjust the row height. The adjusted line height can effectively meet the text display requirements.
<br>
