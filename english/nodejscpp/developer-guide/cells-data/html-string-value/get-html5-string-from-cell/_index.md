...
description: Learn how to get an HTML5 string from a cell using the Aspose.Cells for Node.js via C++ API.
...
The following sample code creates a workbook object and adds some text to cell A1 of the first worksheet. It then gets the normal HTML and HTML5 string from cell A1 using the [**Cell.getHtmlString(boolean)**](https://reference.aspose.com/cells/nodejs-cpp/cell/#getHtmlString-boolean-) method and prints them on the console.
