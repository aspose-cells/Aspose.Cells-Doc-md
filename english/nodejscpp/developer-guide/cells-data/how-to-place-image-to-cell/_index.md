...
2. Select **Place in Cell**. Choose one of the following sources from the **Insert Picture From** dropdown menu (**This Device**, **Stock Images**, and **Online Pictures**). **This Device** is for inserting a picture from your device. **Stock Images** is for inserting a picture from stock images. **Online Pictures** is for inserting a picture from the web.  
   <br>
...
## **How to Insert Picture in Cell Using Aspose.Cells for Node.js via C++**
...
1. Instantiate a [**Workbook**](https://reference.aspose.com/cells/nodejs-cpp/workbook) object.  
