...
We can use [**Cells**](https://reference.aspose.com/cells/nodejs-cpp/cells) collection to access cells in a worksheet. Aspose.Cells provides three basic approaches to access cells in a worksheet:
