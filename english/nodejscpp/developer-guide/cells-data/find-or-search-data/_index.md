...
- **Object:** The object to search for. The type should be `int`, `double`, `DateTime`, `string`, or `bool`.  
...
The examples below use worksheet data to demonstrate the find methods:  
