...
### **Setting Chart Lines**
Developers can also apply different kinds of styles on the lines or data markers of the [SeriesCollection](https://reference.aspose.com/cells/nodejs-cpp/aspose.cells.charts/seriescollection). The following code snippet demonstrates how to set chart lines using Aspose.Cells API.
...
Developers can apply different Microsoft Excel themes/colors to [SeriesCollection](https://reference.aspose.com/cells/nodejs-cpp/aspose.cells.charts/seriescollection) or other chart objects as shown below in the example.
...
Developers can control the visibility of major gridlines by setting the [IsVisible](https://reference.aspose.com/cells/nodejs-cpp/aspose.cells.drawing/line/properties/isvisible) property of the [Line](https://reference.aspose.com/cells/nodejs-cpp/aspose.cells.drawing/line) object to **true** or **false**.
