...
Please see the following sample code that creates a new Excel file and places the values of the chart in the first worksheet.  
Then we add a chart and set the type of the [**Axis**](https://reference.aspose.com/cells/nodejs-cpp/axis/) to a time‑scale axis using [**Axis.setCategoryType()**](https://reference.aspose.com/cells/nodejs-cpp/axis/#setCategoryType--) and then set the base units to Days.
...
// Add SeriesCollection (chart data source) to the chart ranging from cell A1 to B4
