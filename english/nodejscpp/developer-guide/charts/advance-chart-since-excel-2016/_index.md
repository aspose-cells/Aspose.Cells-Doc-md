...
The following screenshot shows the [output Excel file](22774104.xlsx) after the execution of the code. As you can see, the chart titles are changed according to their chart types.
