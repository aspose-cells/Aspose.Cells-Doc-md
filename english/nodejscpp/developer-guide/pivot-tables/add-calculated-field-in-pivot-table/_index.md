...
description: How to add a calculated field in pivot table with Aspose.Cells for Node.js via C++.
...
## **How to Add calculated field in Pivot Table Using Aspose.Cells for Node.js via C++ Library**
Add calculated field to Excel file using Aspose.Cells for Node.js via C++. Please see the following sample code. After executing the example code, a pivot table with calculated field is added to the worksheet.
