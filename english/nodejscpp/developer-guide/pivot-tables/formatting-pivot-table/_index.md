...
Microsoft Excel offers a number of different pre‑set report formats. Aspose.Cells for Node.js via C++ **supports** these formatting options too. To access them:
