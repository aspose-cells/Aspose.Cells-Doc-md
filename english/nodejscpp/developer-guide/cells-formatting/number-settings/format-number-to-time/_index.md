...
type: docs
weight: 10
url: /nodejs-cpp/how-to-format-number-to-time/
description: This article will introduce how to format number to time using Aspose.Cells for Node.js via C++ API.
...
## **How to Format Number to Time in Aspose.Cells for Node.js via C++**
Formatting numbers to time in Aspose.Cells for Node.js via C++ is a straightforward process that involves applying a custom number format to a cell or range of cells. Aspose.Cells is a powerful library that allows you to work with Excel files in Node.js applications without needing Microsoft Excel installed. Here’s how you can format numbers to time:
