...
It is often necessary to know the fonts being used in your workbook for rendering purposes. When you convert your workbook into a PDF or image, Aspose.Cells requires that all the needed fonts are installed on your system or present in your **fonts directory**. If Aspose.Cells is unable to find the needed font, it tries to replace it with some other suitable font that is present on your system or in your fonts directory and can substitute your actual font. This not only results in undesired rendering of PDFs or images but also takes processing time for finding suitable fonts.
