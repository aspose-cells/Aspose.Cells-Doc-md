...
description: How to use the Aspose.Cells library in Node.js via C++ to add conditional formatting for two‑color scales and three‑color scales. By adjusting these criteria, you have more control over how cells look and appear.  
keywords: Aspose.Cells, Conditional Formatting, Node.js via C++, Color Scale, Two Color Scale, Three Color Scale  
type: docs  
weight: 20  
...
{{% alert color="primary" %}}  
**2-Color Scale** and **3-Color Scale** Conditional Formattings are added in the same way except that they differ by [**ColorScale.setIs3ColorScale(boolean)**](https://reference.aspose.com/cells/nodejs-cpp/colorscale/#setIs3ColorScale-boolean-) method. This method is **false** for 2-Color Scale and **true** for 3-Color Scale Conditional Formattings.  
{{% /alert %}}  
