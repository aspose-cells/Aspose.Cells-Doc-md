...
- Click **Tools** > **Digital Signatures...** in **Visual Basic for Applications IDE**
...
The following sample code illustrates how to use the [**VbaProject.sign(DigitalSignature)**](https://reference.aspose.com/cells/nodejs-cpp/vbaproject/#sign-digitalsignature-) method. Below are the input and output files used in the sample code. You can use any Excel file and any certificate to test this code.
...
const password = "1234";
const comment = "Signing with Digital Signature using Aspose.Cells";
