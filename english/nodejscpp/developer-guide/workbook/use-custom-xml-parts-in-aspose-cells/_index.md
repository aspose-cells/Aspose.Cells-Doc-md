...
You can add custom XML parts using Aspose.Cells via the [**Workbook.ContentTypeProperties.add()**](https://reference.aspose.com/cells/nodejs-cpp/workbook/contenttypepropertycollection/#add) method.

The following sample code makes use of [**Workbook.ContentTypeProperties.add()**](https://reference.aspose.com/cells/nodejs-cpp/workbook/contenttypepropertycollection/#add) method and adds the **Book Catalog XML** and its name is **BookStore**. The following image shows the result of this code. As you can see, Book Catalog XML is added inside the BookStore node which is the name of this property.
