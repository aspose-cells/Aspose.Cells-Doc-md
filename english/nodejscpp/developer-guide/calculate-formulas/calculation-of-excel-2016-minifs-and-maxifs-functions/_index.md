...
The following sample code loads the [sample Excel file](5115149.xlsx) and calls the [Workbook.calculateFormula()](https://reference.aspose.com/cells/nodejs-cpp/workbook/#calculateFormula--) method to perform the formula calculation via Aspose.Cells for Node.js via C++, and then saves the result in the [output PDF](5115154.pdf).
...
// Save the calculation result in PDF format
