...
The [**Worksheet**](https://reference.aspose.com/cells/nodejs-cpp/worksheet) class provides the [**protect**](https://reference.aspose.com/cells/nodejs-cpp/worksheet/methods/protect/index) method that is used to apply protection on the worksheet. The [**protect**](https://reference.aspose.com/cells/nodejs-cpp/worksheet/methods/protect/index) method accepts the following parameters:
