...
To verify the password of the encrypted file, Aspose.Cells for Node.js via C++ provides the [**VerifyPassword**](https://reference.aspose.com/cells/nodejs-cpp/fileformatutil/#verifypassword-stream-string-) method. These methods accept two parameters, the file stream and the password that needs to be verified.
The following code snippet demonstrates the use of the [**VerifyPassword**](https://reference.aspose.com/cells/nodejs-cpp/fileformatutil/#verifypassword-stream-string-) method to verify whether the provided password is valid or not.
