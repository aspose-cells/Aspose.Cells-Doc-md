---
title: Encrypt And Decrypt ODS files with Node.js via C++
linktitle: Encrypt And Decrypt ODS files
type: docs
weight: 10
url: /nodejs-cpp/encrypt-and-decrypt-ods-files/
description: Password-protect and encrypt ODS files using Aspose.Cells for Node.js via C++. 
---
