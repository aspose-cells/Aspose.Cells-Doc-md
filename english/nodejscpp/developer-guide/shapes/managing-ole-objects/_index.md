...
- The [**getImageData()**](https://reference.aspose.com/cells/nodejs-cpp/oleobject/#getImageData--) property specifies the image (icon) data as a byte‑array. The image will be displayed to show the OLE object in the worksheet.  
...
Aspose.Cells for Node.js via C++ supports extracting objects of uncommon types like MOL (a molecular‑data file containing information about atoms and bonds). The following code snippet demonstrates extracting an embedded MOL file and saving it to disk by using this [sample Excel file](94896196.xlsx).  
