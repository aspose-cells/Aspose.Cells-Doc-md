...
Aspose.Cells provides the [OleObject.getClassIdentifier()](https://reference.aspose.com/cells/nodejs-cpp/oleobject/#getClassIdentifier--) **method** which you can use to get or set the class identifier of an embedded OLE object. OLE object class identifiers are actually GUIDs, i.e., Globally Unique Identifiers. A GUID is always 16 bytes long; therefore, class identifiers are also 16 bytes long. They are often found in the Windows Registry and provide information to the host application about how to open embedded OLE objects containing various embedded resources within the client application.
