...
{{% alert color="primary" %}}  
Aspose.Cells provides the [**OleObject.autoLoad**](https://reference.aspose.com/cells/nodejs-cpp/oleobject/#autoLoad) property to refresh the OLE object when the excel file is opened in Microsoft Excel. Because of this property, the OLE object will display the correct OLE image generated by Microsoft Excel.  
{{% /alert %}}  
