...
description: Aspose.Cells is a Node.js via C++ library for working with spreadsheet files. This article explains how to fit a picture exactly to a single cell, either by placing a floating picture over the cell or by embedding the image directly into the cell.
...
## Related Articles
- [Excel Camera in Aspose.Cells for Node.js via C++](/cells/nodejs-cpp/excel-camera/)
