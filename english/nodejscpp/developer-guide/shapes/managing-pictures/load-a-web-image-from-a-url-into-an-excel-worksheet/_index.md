...
description: How to convert an image from a URL to an actual Excel image using Aspose.Cells for Node.js via C++.  
...
{{% alert color="primary" %}}  
There may be cases where you always want the updated image from a URL. To achieve this, you may follow the instructions given in the [Insert a Linked Picture from Web Address](/cells/nodejs-cpp/insert-a-linked-picture-from-web-address/) article. By following this method, the image is loaded from the URL each time the worksheet is opened.  
{{% /alert %}}  
