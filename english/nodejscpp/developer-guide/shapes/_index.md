---  
title: Insert Pictures and Shapes of Excel files with Node.js via C++  
linktitle: Shapes  
type: docs  
weight: 140  
...
## **Advance topics**  
- [Change Adjustment Values of the Shape](/cells/nodejs-cpp/change-adjustment-values-of-the-shape/)  
- [Copy Shapes between Worksheets](/cells/nodejs-cpp/copy-shapes-between-worksheets/)  
- [Data in Non-Primitive Shape](/cells/nodejs-cpp/data-in-non-primitive-shape/)  
- [Finding Absolute Position of Shape inside the Worksheet](/cells/nodejs-cpp/finding-absolute-position-of-shape-inside-the-worksheet/)  
- [Get Connection points from shape](/cells/nodejs-cpp/get-connection-points-from-shape/)  
- [Managing Controls](/cells/nodejs-cpp/managing-controls/)  
- [Add Icons to Worksheet](/cells/nodejs-cpp/insert-svg-to-excel/)  
- [Managing OLE Objects](/cells/nodejs-cpp/managing-ole-objects/)  
- [Managing Pictures](/cells/nodejs-cpp/managing-pictures/)  
- [Manage Smart Art](/cells/nodejs-cpp/managing-smartart/)  
- [Managing TextBox](/cells/nodejs-cpp/managing-textbox-of-excel/)  
- [Add WordArt Watermark to Worksheet](/cells/nodejs-cpp/add-wordart-watermark-to-worksheet/)  
- [Refresh Values of Linked Shapes](/cells/nodejs-cpp/refresh-values-of-linked-shapes/)  
- [Send Shape Front or Back inside the Worksheet](/cells/nodejs-cpp/send-shape-front-or-back-inside-the-worksheet/)  
- [Manage Shape Options](/cells/nodejs-cpp/managing-shape-options/)  
- [Manage Shape Text Options](/cells/nodejs-cpp/managing-shape-text-options/)  
