...
Text boxes can have tags, which can be replaced with some text at runtime to configure them according to the requirement. Tags can be labels enclosed in angle brackets '<' and '>'. Multiple tags can exist within a single textbox.

## **Sample Code**
The following sample code replaces tags TAG_1 and TAG_2 with some text, say 'ys' and '1'. A sample file for testing the code can be downloaded from the link below:
