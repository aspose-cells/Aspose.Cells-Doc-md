...
5. Save the new Excel file with the new worksheets by calling the [**Workbook.save(string, SaveFormat)**](https://reference.aspose.com/cells/nodejs-cpp/workbook/#save-string-saveformat-) method of the [**Workbook**](https://reference.aspose.com/cells/nodejs-cpp/workbook) class.  
...
Removing worksheets by name works well when the name of the worksheet is known. If you don't know the worksheet's name, use an overload of the [**WorksheetCollection.removeAt(int)**](https://reference.aspose.com/cells/nodejs-cpp/worksheetcollection/#removeAt-int-) method that takes the sheet index of the worksheet instead of its name.  
...
An **active sheet** is the sheet you’re working on: the active sheet’s name on the tab is bold by default.  
...
- [Count the Number of Cells in the Worksheet](/cells/nodejs-cpp/count-number-of-cells-in-the-worksheet/)  
- [Detecting Empty Worksheets](/cells/nodejs-cpp/detecting-empty-worksheets/)  
- [Find if the Worksheet Is a Dialog Sheet](/cells/nodejs-cpp/find-if-the-worksheet-is-dialog-sheet/)  
