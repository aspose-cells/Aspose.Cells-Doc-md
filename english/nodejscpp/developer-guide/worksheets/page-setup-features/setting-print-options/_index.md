...
To select a specific print area, use the [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) class's [**PageSetup.getPrintArea()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintArea--) property. Assign a cell range that defines the print area to this property.
...
- [**PageSetup.getPrintGridlines()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintGridlines--): a Boolean property that defines whether to print gridlines or not.
...
The pre‑defined values of the [**PrintErrorsType**](https://reference.aspose.com/cells/nodejs-cpp/printerrorstype) enumeration are listed below with their descriptions.
...
// Allows printing gridlines
pageSetup.setPrintGridlines(true);

// Allows printing row/column headings
pageSetup.setPrintHeadings(true);

// Allows printing the worksheet in black & white mode
pageSetup.setBlackAndWhite(true);

// Allows printing comments as displayed on the worksheet
pageSetup.setPrintComments(AsposeCells.PrintCommentsType.PrintInPlace);

// Allows printing the worksheet with draft quality
pageSetup.setPrintDraft(true);

// Allows printing cell errors as N/A
...
The [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) class provides the [**PageSetup.getOrder()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getOrder--) property that is used to order multiple pages of your worksheet for printing. There are two possible orders:
