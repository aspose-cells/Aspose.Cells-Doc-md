...
| PaperSuperA | Super A / Super A / A4 227 × 356 mm |
| PaperSuperB | Super B / Super B / A3 305 × 487 mm |
...
Set the print quality of the worksheets to be printed with the [**PageSetup**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup) class' [**getPrintQuality()**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#getPrintQuality--) property. The measuring unit for print quality is Dots Per Inch (DPI).  
