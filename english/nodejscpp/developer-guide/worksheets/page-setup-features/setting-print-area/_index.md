...
description: This article shows you code explaining how to set a print area using the Aspose.Cells library for Node.js via C++.
...
To set the print area in a specified worksheet: first, load the [sample file](input.xlsx), and then modify the **PageSetup** object's **setPrintArea** method for the desired worksheet. Setting this property to a range string will define the print area.
...
To clear the print area in a specified worksheet: first, load the [sample file](input.xlsx), and then modify the **PageSetup** object's **setPrintArea** method for the desired worksheet. Setting this property to an empty string will clear the print area.
