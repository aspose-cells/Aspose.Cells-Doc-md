...
The following sample code illustrates how to copy *Page Setup* settings from one worksheet to another using the [**PageSetup.copy(PageSetup, CopyOptions)**](https://reference.aspose.com/cells/nodejs-cpp/pagesetup/#copy-pagesetup-copyoptions-) method. Please refer to the sample code and its console output for reference.
