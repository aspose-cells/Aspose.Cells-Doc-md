...
## **How to Print a File as Fitted Pages Wide and Tall in Excel**
...
5. Under **Scaling**, select the option **Fit to**, then specify the number of pages wide and tall you want:  
...
To set FitToPagesWide and FitToPagesTall in a specified worksheet, first load the [sample file](input.xlsx) and then modify the **PageSetup.getFitToPagesTall()** and **PageSetup.getFitToPagesWide()** properties of the **PageSetup** object for the desired worksheet. Here is an example in Node.js:
...
## **How to Print a Worksheet as One Page Using Aspose.Cells for Node.js via C++**

To print a worksheet as a single page, first load the [sample file](sample.xlsx) and then set the **PdfSaveOptions.getOnePagePerSheet()** property of the **PdfSaveOptions** object. Here is an example in Node.js:
...
// Loads the workbook that contains hidden external links
const workbook = new AsposeCells.Workbook(filePath);
...
## **How to Print All Columns of a Worksheet on One Page Using Aspose.Cells for Node.js via C++**

To print all columns of a worksheet on a single page, first load the [sample file](sample.xlsx) and then set the **PdfSaveOptions.getAllColumnsInOnePagePerSheet()** property of the **PdfSaveOptions** object. Here is an example in Node.js:
