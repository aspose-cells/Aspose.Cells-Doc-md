---  
title: Use Error Checking Options with Node.js via C++  
...
{{% alert color="primary" %}}  
Microsoft Excel allows users to define error‑checking options and rules. Users often see error checks when creating formulas; a small triangle at the top right corner of a cell appears when there's a problem with the cell. Excel provides information that helps users correct common problems.  
{{% /alert %}}  
...
2. Select the **Error Checking** tab.  
   The **Number stored as text** option is checked by default.  
3. Disable it.  
