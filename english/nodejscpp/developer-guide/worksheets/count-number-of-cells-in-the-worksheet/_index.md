...
You may count the number of cells in the worksheet by using the [**Cells.getCount()**](https://reference.aspose.com/cells/nodejs-cpp/cells/#getCount--) or [**Cells.getCountLarge()**](https://reference.aspose.com/cells/nodejs-cpp/cells/#getCountLarge--) properties as shown in the code example below.
