---  
title: Render Sequence of Pages using PageIndex and PageCount Properties of ImageOrPrintOptions with Node.js via C++  
linktitle: Render Sequence of Pages using PageIndex and PageCount Properties of ImageOrPrintOptions  
type: docs  
weight: 110  
url: /nodejs-cpp/render-sequence-of-pages-using-pageindex-and-pagecount-properties-of-imageorprintoptions/  
description: Learn how to render specific pages of an Excel file to images using Aspose.Cells for Node.js via C++.  
...
// Print the selected pages as images
