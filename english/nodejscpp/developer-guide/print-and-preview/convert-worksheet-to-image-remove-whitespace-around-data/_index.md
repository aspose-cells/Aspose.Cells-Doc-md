---
title: Convert Worksheet to Image - Remove whitespace around data with Node.js via C++
linktitle: Convert Worksheet to Image - Remove whitespace around data
type: docs
weight: 40
url: /nodejs-cpp/convert-worksheet-to-image-remove-whitespace-around-data/
description: Learn how to convert Microsoft Excel worksheets to images and remove whitespace around data using Aspose.Cells for Node.js via C++. 
---
...
The [**Aspose.Cells.Rendering.SheetRender**](https://reference.aspose.com/cells/nodejs-cpp/sheetrender) API converts a worksheet to an image file with any specified attributes, for example, image format, paginated sheets, etc. Several image formats are supported, including BMP, GIF, JPG, TIFF, and EMF.
