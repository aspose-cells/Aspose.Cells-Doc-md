...
{{% alert color="primary" %}}  
This document is designed to provide developers with a detailed understanding of how to convert a worksheet to an image file **and** worksheet with multiple pages to an image file per page.  
...
This article shows how to create a console application, convert a worksheet to an image, and convert a worksheet into one image per page with a few and simplest lines of code using the Aspose.Cells API.  
