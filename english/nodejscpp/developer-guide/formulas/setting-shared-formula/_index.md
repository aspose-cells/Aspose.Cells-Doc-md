...
If you want to add a function in a worksheet that will perform some calculations, this article explains how to achieve this task using Aspose.Cells for Node.js via C++.  
