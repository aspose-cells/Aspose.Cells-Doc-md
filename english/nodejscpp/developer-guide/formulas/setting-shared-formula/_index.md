...
Aspose.Cells lets you specify a formula using the [**Cell.Formula**](https://reference.aspose.com/cells/nodejs-cpp/cell/#formula-string) property. There are two options for adding formulas to the other cells (B3, B4, B5, and so on) in the column.
