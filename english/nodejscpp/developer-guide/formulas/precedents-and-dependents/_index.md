...
### **Tracing Dependents**
Aspose.Cells lets you get dependent cells in spreadsheets. It not only can retrieve cells that provide data for a simple formula but also find cells that provide data to complex‑formula dependents with named ranges.
