...
Earlier, Aspose.Cells would create [**PdfBookmarkEntry**](https://reference.aspose.com/cells/nodejs-cpp/pdfbookmarkentry) for a normal sheet. But now Aspose.Cells can also create [**PdfBookmarkEntry**](https://reference.aspose.com/cells/nodejs-cpp/pdfbookmarkentry) for chart sheets. Since a chart sheet does not have any other cells except cell A1, it will create a [**PdfBookmarkEntry**](https://reference.aspose.com/cells/nodejs-cpp/pdfbookmarkentry) for cell A1 only.  
