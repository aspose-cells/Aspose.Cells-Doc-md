...
When such a character occurs inside a word or sentence that is in a specific font like Times New Roman, Aspose.Cells changes the font of the entire word or sentence to a font which can display this character, such as **Arial Unicode MS**.
