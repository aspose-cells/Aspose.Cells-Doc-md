...
The following screenshot shows the effect of using [**HtmlSaveOptions.TableCssId**](https://reference.aspose.com/cells/nodejs-cpp/htmlsaveoptions/#tableCssId-string) property on output HTML.
...
The following sample code demonstrates how to make use of [**HtmlSaveOptions.TableCssId**](https://reference.aspose.com/cells/nodejs-cpp/htmlsaveoptions/#tableCssId-string) property. Please check the [output HTML](60489790.zip) generated by the code for a reference.
