...
Aspose.Cells for Node.js via C++ allows you to eliminate these Downlevel Revealed Comments by setting the [**HtmlSaveOptions.disableDownlevelRevealedComments**](https://reference.aspose.com/cells/nodejs-cpp/htmlsaveoptions/#disableDownlevelRevealedComments-boolean-) property to **true**.

## **Disable Downlevel Revealed Comments while saving to HTML**

The following sample code shows the usage of [**HtmlSaveOptions.disableDownlevelRevealedComments**](https://reference.aspose.com/cells/nodejs-cpp/htmlsaveoptions/#disableDownlevelRevealedComments-boolean-) property. The screenshot shows the effect of this property when it is not set to true. Please download the [sample Excel file](50528257.xlsx) used in this code and the [output HTML](50528258.zip) generated by it for reference.
