...
The following screenshot shows the **XLSX** file converted from the above CSV file after setting the [**TxtLoadOptions.isMultiEncoded()**](https://reference.aspose.com/cells/nodejs-cpp/txtloadoptions/#isMultiEncoded--) property to **true**. As you can see, the Unicode text is now converted properly.
