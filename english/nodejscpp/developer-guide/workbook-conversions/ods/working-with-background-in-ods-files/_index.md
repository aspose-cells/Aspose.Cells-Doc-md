---  
title: Working with Background in ODS Files with Node.js via C++  
...
Background can be added to sheets in ODS files. The background can either be a colored background or a graphic background. The background is not visible when the file is opened, but if the file is printed as a PDF, the background is visible in the generated PDF. The background is also visible in the print preview dialog.  
...
Aspose.Cells for Node.js via C++ provides the [**OdsPageBackground**](https://reference.aspose.com/cells/nodejs-cpp/odspagebackground) class to manage background in ODS files. The following code sample demonstrates the use of [**OdsPageBackground.getColor()**](https://reference.aspose.com/cells/nodejs-cpp/odspagebackground/#getColor--) property to add a colored background to the ODS file. Please see the [output ODS](90112031.ods) file generated by the code for reference.  
...
Aspose.Cells for Node.js via C++ provides the [**OdsPageBackground**](https://reference.aspose.com/cells/nodejs-cpp/odspagebackground) class to manage background in ODS files. The following code sample demonstrates the use of [**OdsPageBackground.getGraphicData()**](https://reference.aspose.com/cells/nodejs-cpp/odspagebackground/#getGraphicData--) property to add a graphic background to the ODS file. Please see the [output ODS](90112030.ods) file generated by the code for reference.  
