...
type: docs
weight: 40
url: /net/aspose-cells-for-net-5-1-2-release-notes/
description: Aspose.Cells for .Net 5.1.2 Release Notes – the latest enhancements, new features, and fixes.
keywords: Aspose.Cells for .Net 5.1.2 Release Notes, Aspose.Cells for .Net 5.1.2 updates and fixes
---

{{% alert color="primary" %}} 

This page contains release notes for [Aspose.Cells for .NET 5.1.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.2/)
