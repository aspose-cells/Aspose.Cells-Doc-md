...
type: docs
weight: 100
url: /net/aspose-cells-for-net-17-3-0-release-notes/
---
...
1. [Customize Globalization Settings for Pivot Table](/cells/net/customize-globalization-settings-for-pivot-table/)
1. [Execute client side function on GridWeb page change](/cells/net/execute-client-side-function-on-gridweb-page-change/)[](/cells/net/execute-client-side-function-on-gridweb-page-change/)
1. [Validate entire worksheet instead of only the updated cells](/cells/net/validate-entire-worksheet-instead-of-only-the-updated-cells/)
