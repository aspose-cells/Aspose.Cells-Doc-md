...
type: docs
weight: 80
url: /net/aspose-cells-for-net-17-5-release-notes/
---
...
- [Copy Page Setup Settings from Source Worksheet into Destination Worksheet](/cells/net/copy-page-setup-settings-from-source-worksheet-into-destination-worksheet/)
- [Implement Custom Paper Size of Worksheet for Rendering](/cells/net/implement-custom-paper-size-of-worksheet-for-rendering/)
- [Remove Existing PrinterSettings of Worksheets in Excel file](/cells/net/remove-existing-printersettings-of-worksheets-in-excel-file/)
