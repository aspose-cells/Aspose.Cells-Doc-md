...
type: docs
weight: 60
url: /net/aspose-cells-for-net-17-7-release-notes/
---
...
- [Implement Errors and Boolean Value in Russian or Any Other Language](/cells/net/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
- [Determine if Paper Size of Worksheet is Automatic](/cells/net/determine-if-paper-size-of-worksheet-is-automatic/)
- [Render PivotTable In GridDesktop](/cells/net/render-pivottable-in-griddesktop/)
- [Custom Row And Custom Column Caption of GridDesktop Worksheet](/cells/net/custom-row-and-custom-column-caption-of-griddesktop-worksheet/)
- [Find GridDesktop Version At RunTime](/cells/net/find-griddesktop-version-at-runtime/)
- [Resize GridWeb in the browser window](/cells/net/resize-gridweb-in-the-browser-window/)
