...
type: docs
weight: 20
url: /net/sitefinity-export-users-to-excel/
...
### **System Requirements**
In order to set up Aspose.Cells for .NET for Sitefinity add‑ons, you need to meet the following requirements:
...
4. In the left pane, click **Toolboxes**, then **PageControls**, **Sections**, **ContentToolboxSection**, and **Tools**.  
5. Click **Create new**. The widget registration form appears.  
6. Fill the form fields as follows:  
   - Make sure **Enabled** is selected.  
   - Add `~/Addons/Aspose.SiteFinity.ExportUsersToExcel/AsposeExportUsersToExcel.ascx` in the **Control CLR Type or Virtual Path** field.  
   - Add **Name**, **Title**, and **Description** as follows:  
     - Name: `Aspose.SiteFinity.ExportUsersToExcel`  
     - Title: `Aspose Export Sitefinity Users to Excel`  
     - Description: `Export Sitefinity Users to Excel`  
   - You may leave all other fields as they are.  
7. When finished, click **Save changes**. The widget is registered in the toolbox and can be used in Sitefinity.
