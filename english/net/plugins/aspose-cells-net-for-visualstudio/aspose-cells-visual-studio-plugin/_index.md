...
type: docs
weight: 20
url: /net/aspose-cells-visual-studio-plugin/
...
- Allows you to open **C#** or **VB.NET** example projects
...
In order to install and use Aspose Visual Studio Plugin you need to have one of the following Visual Studio **versions** installed:
...
**3.** In the *Select an API to View Examples* dialog, select or change the location where the example projects will be created and also select or change the example project type as **C#** or **VB.NET**, then click **Continue** to open the example project in Visual Studio.

![todo:image_alt_text](aspose-cells-visual-studio-plugin_1)

**4.** New example projects are created according to the selected project type (**C#** or **VB.NET**) in Visual Studio.
...
- **Installer** – WiX installer project to generate the MSI installer file for the plugin.
