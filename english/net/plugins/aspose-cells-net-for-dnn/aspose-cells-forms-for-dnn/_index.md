...
1. Navigate to the page where you want to add the module.
1. Select **Modules** followed by **Add New Module** from the top ribbon.
1. From the list, select ‘Aspose.NET Dynamic Forms Builder’ and drag it into position. 
...
1. Click **Settings** option available on top right module popup menu along with module title
1. Click **Aspose.Cells Forms for DNN - Settings** tab
1. There are few pre-defined fields, you can edit/hide just by clicking **Edit** in grid
1. You can create new fields any type of **(TextBox, MultiLineTextBox, RadioButton, Checkboxes, DropdownList, Title, Success Message)**
...
### **Export Saved Data**
1. Make sure you are logged-in and in a page editing mode
1. Mouse Over **Edit Icon** and Click **Export using Aspose.Cells** option available on top right module popup menu along with module title
...
1. Browse to the latest source code that you have downloaded and open e.g **Aspose.DNN.DynamicFormsBuilderExcel.sln**
