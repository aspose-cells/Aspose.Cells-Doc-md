...
Dictionary<string, int> data)
{
    ...
    using (SpreadsheetDocument document = SpreadsheetDocument.Open(docName, true))
    {
        ...
        foreach (string key in data.Keys)
        {
            ...
            StringLiteral strLit = barChartSeries.AppendChild<CategoryAxisData>(new CategoryAxisData())
        ...
        Legend legend = chart.AppendChild<Legend>(new Legend(
...
private static void InsertChartInSpreadsheet(string docName, string worksheetName, string title, string dataRange)
{
    ...
    // Add a SeriesCollection (chart data source) to the chart ranging from the A1 cell to B3
