...
// Adding some value to a cell

Cell cell = worksheet.Cells["A1"];

cell.PutValue("This is an Aspose test of fonts!");
...
Download **Working With Fonts** from any of the below mentioned social coding sites:
