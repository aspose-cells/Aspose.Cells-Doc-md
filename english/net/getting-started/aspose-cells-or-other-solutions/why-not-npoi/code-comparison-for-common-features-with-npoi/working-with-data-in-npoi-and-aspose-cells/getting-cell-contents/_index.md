...
`Cells[0]` or `Cells[name]` methods are available to access cells.  
...
NPOI provides the `Cell` class to access various properties of cells.  
...
Download **Getting Cell Contents** from any of the below‑mentioned social coding sites:  
