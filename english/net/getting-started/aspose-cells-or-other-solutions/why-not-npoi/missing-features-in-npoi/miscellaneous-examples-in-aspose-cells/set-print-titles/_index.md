...
Aspose.Cells allows you to designate row and column headers to repeat on all pages of a printed worksheet. To do so, use the [PageSetup](https://reference.aspose.com/cells/net/aspose.cells/pagesetup) class’s PrintTitleColumns and PrintTitleRows properties.  
...
Download **Set Print Titles** from any of the below mentioned social coding sites:  
