...
1. Right‑click a tab in the tab strip at the bottom of the current worksheet.  
2. Select **Tab color**.  
...
Download **Set Worksheet Tab Color** from any of the below mentioned social coding sites:
