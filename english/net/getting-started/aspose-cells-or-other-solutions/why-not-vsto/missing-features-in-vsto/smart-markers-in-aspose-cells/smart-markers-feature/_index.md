...
The parameters **noadd** and **skip** can be combined to insert data on alternating rows. Because the template is processed from bottom to top, you should add **noadd** on the first row to avoid extra rows being inserted before the alternate row.
