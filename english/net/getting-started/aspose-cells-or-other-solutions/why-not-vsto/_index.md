---
title: Aspose.Cells or VSTO
linktitle: Why Not VSTO
type: docs
weight: 10
...
Aspose.Cells for .NET provides the most flexible group of components that enable .NET applications to create and manage Excel spreadsheets without requiring Microsoft Excel to be installed on the server. Aspose.Cells is one of the leading components for all types of Excel format manipulation. Unlike similar products from other vendors, Aspose.Cells not only supports spreadsheet generation and other basic file‑formatting features, but also supports a number of advanced features. These advanced features make it much more convenient for developers to manipulate spreadsheet contents, cell formatting, and file protection. Aspose.Cells also allows importing data into spreadsheets from different data sources, adding common and complex mathematical, DateTime, financial, and text formulas/functions, and supports manipulation of charts, pictures, comments, drawing objects, and controls, etc.
...
Explore [the source code examples of Aspose.Cells for .NET features in comparison with VSTO](https://github.com/aspose-cells/Aspose.Cells-for-.NET/releases/tag/MissingFeaturesAsposeCellsForVSTO1.1). To use these source code examples, you will need to reference Aspose.Cells for .NET in your project.
