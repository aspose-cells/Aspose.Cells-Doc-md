...
Background images sit behind the text and lines in a spreadsheet. They are used to give information about a workbook, for example, when used as status watermarks, but they can also add company branding or decoration. Microsoft Excel allows users to add background images manually.
