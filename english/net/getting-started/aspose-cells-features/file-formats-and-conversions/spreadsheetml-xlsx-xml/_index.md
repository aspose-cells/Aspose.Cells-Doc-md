...
type: docs
weight: 10
url: /net/spreadsheetml-xlsx-xml/
...
| :- | :- | :- |
| Microsoft Excel 2003 | [Microsoft Excel 2003 XML](https://en.wikipedia.org/wiki/Microsoft_Office_XML_formats) | Yes |
| Microsoft Excel 2007 | [OOXML ECMA-376](https://www.ecma-international.org/publications-and-standards/standards/ecma-376/) | Yes |
...
- A robust Formula Calculation Engine that supports almost all of the standard and advanced Microsoft Excel functions.
...
Implementing even a simple find‑and‑replace operation in an Office Open XML document is difficult. Our advice: remember that being open and standard does not mean simple, and use Aspose.Cells.
