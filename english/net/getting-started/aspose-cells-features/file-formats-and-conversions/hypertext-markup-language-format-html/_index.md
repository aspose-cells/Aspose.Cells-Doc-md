...
Aspose.Cells can be used to save your Excel workbooks into HTML format. The exported HTML workbooks are Microsoft Excel‑oriented; i.e., they are similar to those exported by Microsoft Excel. You can also create workbooks from HTML, but this HTML should be Excel‑oriented.
...
### **Saving an Excel file into HTML**
