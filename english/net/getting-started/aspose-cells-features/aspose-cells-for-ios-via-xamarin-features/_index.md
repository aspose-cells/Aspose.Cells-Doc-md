...
type: docs
weight: 70
url: /net/aspose-cells-for-ios-via-xamarin-features/
---
...
|Add a copy of existing worksheet (all contents including images, charts, other objects etc.)|{{< emoticons/tick >}}|{{< emoticons/tick >}} (Images and charts are not supported)|
|Copy or move worksheets within or between workbooks|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Insert images|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Create charts|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Set gradient background for charts using API|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Add comments to cells|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
|Microsoft Excel 2007 themes and colors|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Create auto-filters|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Implement data validations|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
