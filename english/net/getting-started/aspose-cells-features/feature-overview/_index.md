...
|**Feature**|**Description**|
| :- | :- |
|[.NET Framework](/cells/net/system-requirements/#net-frameworks)|Use Aspose.Cells for .NET to build ASP.NET, Web Services, WinForms or any other type of application for any .NET Framework versions 2.0 or later including Client Profile versions. Full support for 32-bit and 64-bit.|
|[.NET Standard 2.0](/cells/net/system-requirements/#net-standard)|The 'netStandard' folder contains **assemblies** to use with **frameworks** that implement .NET Standard 2.0, such as .NET Core 2.1/3.1. The latest version of Aspose.Cells API also supports .NET 5.0, .NET 6.0, .NET 7.0 and .NET **8.0**.|
|[COM](/cells/net/system-requirements/)|Can be a lifesaver if you have to develop using **pre-.NET** technologies.|
|[Mono](/cells/net/system-requirements/)|You can use Aspose.Cells for .NET to build applications with Mono.|
|[Windows Azure](/cells/net/system-requirements/)|Aspose.Cells for .NET also runs on Windows Azure.|
...
|SpreadsheetML (XLSX, XML)|Aspose.Cells supports OOXML, Flat OPC and also Excel 2003 XML. Moreover, the component supports all the major Excel 2007, 2010 and 2013 file formats, for example, XLSX, XLTX, XLSM, XLTM, etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|HTML|Saving as HTML is available.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
| :- | :- | :- |
|Layout **documents** into pages with high fidelity to Microsoft Excel® (exactly as Microsoft Excel® would.)|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Preserve or remove add‑in, VBA, macros|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
