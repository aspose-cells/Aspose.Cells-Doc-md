...
### **Document Features**
- Open plain or encrypted Microsoft Excel files (Excel 97 - Excel 2007/2010/2013) from different sources.
- Save Excel files (Excel 97 - Excel 2007/2010/2013) in different formats (XLS, XLSX/XLSM, XLTX, XLTM, XLSB, CSV, SpreadsheetML, Tab Delimited, TSV, HTML, etc.)
...
- Display or hide tabs, scroll bars, gridlines, and row and column headers.
- Preview page breaks.
...
- Set page margins such as top, left, right, bottom, etc.
...
- Export cells data to a DataTable.
- Find or search for specific data in cells.
- Set formulas with built‑in or add‑in functions.
- Set array and R1C1 reference‑style formulas.
...
- Customize charts by setting their various properties.
- Set data for the charts dynamically.
- Add custom charts to worksheets using the API.
- Add pictures to worksheets at runtime.
- Create and add comments to cells.
- Convert chart to an image file.
