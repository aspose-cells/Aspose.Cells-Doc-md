---
title: Install Aspose Cells through NuGet
type: docs
weight: 30
...
- Click **Tools** → **Library Package Manager** → **Manage NuGet Packages** from the solution. You can also easily access the same option through the Solution Explorer. Right‑click the solution or project and select **Manage NuGet Packages** from the context menu.
...
If your VS.NET 2010 project's target framework is ".NET Framework 4" or another version, simply use the **Aspose.Cells.dll** component file located in the `net4.0`/`net2.0` folder.
