...
1. In the **Add Reference** dialog box, select the .NET tab (selected by default). If you installed using the MSI installer, Aspose.Cells will appear in the top pane.
1. Select it and click **Select**.
...
1. Click **OK**. The Aspose.Cells reference appear under the **References** node of the project.
