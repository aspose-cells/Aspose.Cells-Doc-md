...
type: docs
weight: 50
url: /net/what-is-a-designer-spreadsheet/
...
For example, you can download the example project from [here](https://github.com/aspose-cells/Aspose.Cells-for-.NET).
...
Additionally, Aspose.Cells lets you add [smart markers](/cells/net/smart-markers/) to the designer spreadsheet. Smart markers are processed at runtime using the [**WorkbookDesigner**](https://reference.aspose.com/cells/net/aspose.cells/workbookdesigner) class’s `Process` method. This can help you write less code and still get great results.
