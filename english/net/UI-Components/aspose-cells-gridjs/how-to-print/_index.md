...
aliases:
  ...
  - /net/aspose-cells-gridjs/print-configuration/
  - /net/aspose-cells-gridjs/print-layout/
...
2.  The **Settings** modal window appears, presenting various configuration options.
