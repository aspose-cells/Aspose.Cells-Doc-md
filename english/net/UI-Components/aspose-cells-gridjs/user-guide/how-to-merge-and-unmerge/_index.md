...
type: docs  
weight: 190  
url: /net/aspose-cells-gridjs/user-guide/how-to-merge-and-unmerge/
aliases:  
  - /net/aspose-cells-gridjs/merge-and-unmerge/  
  - /net/aspose-cells-gridjs/how-to-merge-cells/  
  - /net/aspose-cells-gridjs/how-to-unmerge-cells/  
  - /net/aspose-cells-gridjs/cell-merge-and-unmerge/  
...
2. **Click the "Merge" icon in the toolbar** – when the icon is clicked, it toggles to **Un‑merge** if the selection is already merged.  
...
> **For live demos and more examples, visit:** <https://github.com/aspose-cells/Aspose.Cells.Grid-for-.NET/tree/master/Examples_GridJs>  
