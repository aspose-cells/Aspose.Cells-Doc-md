...
The example below sorts data in four columns of a worksheet in descending order. Only twenty rows of the four columns are sorted in a top‑to‑bottom orientation.

Before applying the code, the worksheet contains unordered data.

![todo:image_alt_text](sort-worksheet-data_1.png)

After executing the code, the data is sorted in descending order.
