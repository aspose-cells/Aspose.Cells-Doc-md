...
Aspose.Cells.GridWeb control is represented by the **GridWeb** class.

{{% /alert %}} 

To select a preset style:

1. Add an Aspose.Cells.GridWeb control to a web form.  
2. Select a preset style to be applied to the control.
...
The GridWeb control provides the **HeaderBarStyle** property, which applies a style to both header bars of the control.
...
It is also possible to load or save a style file using Aspose.Cells.GridWeb Designer.
...
**IMPORTANT:** Loading a style file into the GridWeb control doesn't affect the formatting settings of the cells of the control.
