...
description: This article introduces features for GridWeb.
...
### **Cell Features**
- Edit multiple cells on the client side with a single postback to the server side.
- Supports number, date, and time format settings.
- Supports custom format settings.
- Controls text alignment.
- Manages borders.
- Controls the font settings.
...
### **Utility Features**
- Supports drop‑down list and regular expression validations.
