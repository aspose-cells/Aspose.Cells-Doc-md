...
if you use FriendlyUrl you need to filter out the image url request for GridWeb.thus GridWeb control server can get and resolve the request and find the image stream from the cache path.
