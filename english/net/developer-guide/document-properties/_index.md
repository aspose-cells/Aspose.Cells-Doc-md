...
Aspose.Cells for .NET directly writes the information about API and version number in output documents. For example, upon rendering the document to PDF, Aspose.Cells for .NET populates **Application** field with the value 'Aspose.Cells' and **PDF Producer** field with the value, e.g., 'Aspose.Cells v17.9'.
...
The [**Aspose.Cells.Properties.DocumentProperty**](https://reference.aspose.com/cells/net/aspose.cells.properties/documentproperty) class allows you to retrieve the name, value, and type of the document property:
...
- [Specify Document Version of the Excel File using Built‑In Document Properties](/cells/net/specify-document-version-of-the-excel-file-using-builtin-document-properties/)
- [Specify the Language of the Excel File using Built‑In Document Properties](/cells/net/specify-the-language-of-the-excel-file-using-builtin-document-properties/)
