...
## **Why Use Range Parameter in Smart Markers**
...
Sometimes, you need to sort and perform other operations on a range in SmartMarkers. Aspose.Cells makes it possible to use the range parameter in SmartMarkers. Please check the [template file](range.xlsx), the [JSON file](range.json), and the screenshot of the output Excel file generated with the following code.
