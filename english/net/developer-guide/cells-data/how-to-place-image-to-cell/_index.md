...
2. Select **Place in Cell**. Choose one of the following sources from the **Insert Picture From** dropdown menu (**This Device**, **Stock Images**, and **Online Pictures**). Use **This Device** to insert a picture from your device, **Stock Images** for pictures from the stock library, and **Online Pictures** for images from the web.  
   <br>
...
1. Go to the **Insert** tab and click on the **Pictures** option.  
2. Select **Place over Cells**. Choose one of the following sources from the **Insert Picture From** dropdown menu (**This Device**, **Stock Images**, and **Online Pictures**). Use **This Device** to insert a picture from your device, **Stock Images** for pictures from the stock library, and **Online Pictures** for images from the web.  
   <br>
