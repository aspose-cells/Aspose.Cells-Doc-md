...
description: This article describes how to view and edit data of Excel files with the Aspose.Cells library.
...
Aspose.Cells allows developers to add data to the cells in worksheets by calling the [**Cell**](https://reference.aspose.com/cells/net/aspose.cells/cell) class’s [**PutValue**](https://reference.aspose.com/cells/net/aspose.cells/cell/methods/putvalue/index) method. Aspose.Cells provides overloaded versions of the [**PutValue**](https://reference.aspose.com/cells/net/aspose.cells/cell/methods/putvalue/index) method that let developers add different kinds of data to cells. Using these overloaded versions of the [**PutValue**](https://reference.aspose.com/cells/net/aspose.cells/cell/methods/putvalue/index) method, it is possible to add Boolean, string, double, integer, or date/time values to the cell.
