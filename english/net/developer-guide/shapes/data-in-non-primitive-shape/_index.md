...
Access the shape data using the [**Shape.Paths**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shape/properties/paths) property. It returns all the connected paths that comprise the non‑primitive shape. These paths are of type [**ShapePath**](https://reference.aspose.com/cells/net/aspose.cells.drawing/shapepath), which holds a list of all the segments, and each segment contains the points that define it.
