...
The following sample code loads the [sample Excel file](5115231.xlsx) which has a non‑real OLE image. The OLE object is actually a Microsoft Word document, but the sample Excel file shows the animal image instead of the Microsoft Word image. If you open the [output Excel file](5115225.xlsx), you will see that Microsoft Excel displays the correct OLE image.
