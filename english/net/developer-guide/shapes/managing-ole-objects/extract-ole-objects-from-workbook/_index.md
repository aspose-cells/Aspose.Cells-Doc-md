...
1. Add References  
   1. Add a reference to the Aspose.Cells component in your project; for example, add a reference to `...\Program Files\Aspose\Aspose.Cells\Bin\Net1.0\Aspose.Cells.dll`.
