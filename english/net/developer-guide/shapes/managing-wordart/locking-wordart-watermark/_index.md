...
type: docs
weight: 170
url: /net/locking-wordart-watermark/
...
Aspose.Cells APIs allow locking certain aspects of the watermark so that the user interaction can be limited or completely blocked. The following code snippet demonstrates the usage of Aspose.Cells for .NET API to lock selection, movement, editing, and re‑sizing of the watermark by creating a spreadsheet from scratch.
