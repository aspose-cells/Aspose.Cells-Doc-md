...
Using a Table is similar to Method 2, which uses a range, but you have advantages using tables over ranges. When you change your range to a Table and add data, the chart automatically updates. With a range, you will have to change the data source.
