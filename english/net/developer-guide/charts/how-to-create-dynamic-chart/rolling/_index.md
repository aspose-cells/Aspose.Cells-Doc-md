...
In the following paragraphs, we will show you how to create a dynamic rolling chart using Aspose.Cells. We'll provide the code for the example, as well as the Excel file created with this code.
...
## **Notes**
In the generated file, you can continue to add data in columns A and B, while the chart dynamically counts the latest five sets of data. This is done using the `OFFSET` formula in the sample code:

```
"=OFFSET(Sheet1!$A$1,COUNT(Sheet1!$A:$A),0,-5,1)"
```

You can try changing the number “-5” to “-10” in the formula, and the dynamic chart will display the latest ten sets of data. Now we have successfully created a dynamic rolling chart using Aspose.Cells.
