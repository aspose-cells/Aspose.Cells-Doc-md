---
title: How to Create a Dynamic Scrolling Chart
...
## **Use Aspose.Cells to Create a Dynamic Scrolling Chart**
In the following paragraphs, we will show you how to create a dynamic scrolling chart using Aspose.Cells. We'll show you the code for the example, as well as the Excel file created with this code.
...
## **Notes**
In the generated file, you can operate the scroll bar, and the chart dynamically displays the latest 10 sets of data. This is done using the `OFFSET` formula in the sample code:
