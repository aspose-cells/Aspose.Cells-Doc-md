...
## **Axis Options**
Aspose.Cells also allows you to manage a chart's axes at runtime. With the [Axis](https://reference.aspose.com/cells/net/aspose.cells.charts/axis/) object, you can change all options of an axis as done in Excel.

|![todo:image_alt_text](chart_axes.png)|

## **Manage X and Y Axes**

In an Excel chart, horizontal and vertical axes are the two most commonly used axes.
