...
The fourth stock chart we will look at is the Volume Open High Low Close chart. Again, it is important to note that you must have the data in the correct order. If you need to rearrange your data table, you should do it before you set up your chart.  
