...
With the above code, you can get the position of the chart title and the chart's PlotArea.  
...
2. Units of 1/4000 of the chart area. This is a unit used in older versions of Excel **files**, and it is not recommended.  

3. Units of **pixels**.  

The conversion code for them is shown in the following code: 
