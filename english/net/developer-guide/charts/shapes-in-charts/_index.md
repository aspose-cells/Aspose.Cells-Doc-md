...
Aspose.Cells allows you to add and manipulate labels even within charts.
...
- **width** – the the width of the label, in units of 1/4000 of the chart area.
...
1. Use the TextBox control instead; there is a similar alternative to the label control in XLSX files.  
   - [**Example**](https://docs.aspose.com/cells/net/controls-in-charts/#adding-textbox-control-to-the-chart) for TextBox, which XLSX files can support.  

2. Add a worksheet whose sheet type is `"SheetType.Chart"`, and then add a chart and control on this sheet.  
...
Aspose.Cells allows you to insert checkboxes into a chart sheet by using the [**MsoDrawingType**](https://reference.aspose.com/cells/net/aspose.cells.drawing/msodrawingtype) enumeration. The following example demonstrates adding a checkbox to a chart sheet.
