...
You can find whether data points of a series are in the second pie of a *Pie of Pie* chart or in the bar of a *Bar of Pie* chart using Aspose.Cells. Please use the [ChartPoint.IsInSecondaryPlot](https://reference.aspose.com/cells/net/aspose.cells.charts/chartpoint/properties/isinsecondaryplot) property to determine this.

Please download the [sample Excel file](5115193.xlsx) used in the following sample code and see its console output. If you open the [sample Excel file](5115193.xlsx), you will find that all the data points that are less than 10 are inside the bar of the *Bar of Pie* chart, as also shown by the console output.
