...
description: In an Excel chart, you may need to set a series invisible. This article describes how to use Aspose.Cells to do it. 
...
You can download the following [sample file](SeriesFiltered.xlsx) and work with it in Excel as shown in the figure to achieve this function. Next, we will tell you how to achieve this using the Aspose.Cells library.
