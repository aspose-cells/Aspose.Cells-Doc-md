...
In our previous topics, we have already provided many examples to demonstrate how you can set a data source for your chart, but in this topic we will provide more details about the types of data that can be set for a chart.
