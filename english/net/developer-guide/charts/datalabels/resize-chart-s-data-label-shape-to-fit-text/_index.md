...
In order to mimic Excel's feature of resizing data label shapes to fit the text, the Aspose.Cells API exposes the Boolean **DataLabels.IsResizeShapeToFitText** property. The following piece of code shows the simple usage scenario of the **DataLabels.IsResizeShapeToFitText** property.
