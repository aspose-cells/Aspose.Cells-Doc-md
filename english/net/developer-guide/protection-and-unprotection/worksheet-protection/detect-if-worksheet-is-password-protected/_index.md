...
Aspose.Cells for .NET 8.7.0 exposes the [**Protection.IsProtectedWithPassword**](https://reference.aspose.com/cells/net/aspose.cells/protection/properties/isprotectedwithpassword) property to detect if a worksheet is password‑protected or not. The Boolean type [**Protection.IsProtectedWithPassword**](https://reference.aspose.com/cells/net/aspose.cells/protection/properties/isprotectedwithpassword) property returns **true** if a [**Worksheet**](https://reference.aspose.com/cells/net/aspose.cells/worksheet) is password‑protected and **false** if not.
