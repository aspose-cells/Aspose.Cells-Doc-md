...
A simply protected worksheet is one that is not protected with a password. Such worksheets can be unprotected by calling the [**Unprotect**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/methods/unprotect/index) method without passing a parameter.
