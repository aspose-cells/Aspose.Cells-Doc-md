...
type: docs
weight: 20
url: /net/set-external-links-in-formulas/
...
Sometimes, it is necessary to include links to external files in formulas, for example, to evaluate a cell or a range value against them. Aspose.Cells provides this feature, and this document explains how to use it.
