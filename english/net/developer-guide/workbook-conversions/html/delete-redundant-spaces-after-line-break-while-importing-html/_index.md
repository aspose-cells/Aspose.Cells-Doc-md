...
The following sample code shows the usage of the [**HTMLLoadOptions.DeleteRedundantSpaces**](https://reference.aspose.com/cells/net/aspose.cells/htmlloadoptions/properties/deleteredundantspaces) property. Please set it **to true** or **false** to get the output as shown in the above screenshot.
