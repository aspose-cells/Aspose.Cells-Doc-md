...
The following sample code loads the [sample Excel file](61767776.xlsx) and converts it to HTML, and does not export the Document, Workbook, and Worksheet properties in the [output HTML](61767779.zip).
