...
There might be cases where the text is cut off in the generated HTML and you want to display the complete text as a tooltip on hover. Aspose.Cells supports this by providing [**HtmlSaveOptions.AddTooltipText**](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/addtooltiptext) property. Setting the [**HtmlSaveOptions.AddTooltipText**](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/addtooltiptext) property to **true** will add the complete text as a tooltip in the generated HTML.
