...
- **drawObject**: [**DrawObject**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobject) will be initialized and returned during rendering.  
- **x**: Left coordinate of [**DrawObject**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobject).  
- **y**: Top coordinate of [**DrawObject**](https://reference.aspose.com/cells/net/aspose.cells.rendering/drawobject).  
