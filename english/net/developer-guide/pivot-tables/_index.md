...
- [Find and Refresh the Nested or Child Pivot Tables of a Parent Pivot Table](/cells/net/find-and-refresh-the-nested-or-children-pivot-tables-of-parent-pivot-table/)
- [Formatting a Pivot Table](/cells/net/formatting-pivot-table/)
- [Get External Connection Data Source of Pivot Table](/cells/net/get-external-connection-data-source-of-pivot-table/)
- [Get Pivot Table refresh date and information about who refreshed it](/cells/net/get-pivot-table-refresh-date-and-refresh-by-who-information/)
...
- [Refresh and Calculate Pivot Table that has Calculated Items](/cells/net/refresh-and-calculate-pivot-table-having-calculated-items/)
