...
1. Download and install Aspose.Cells:
   ...
   2. Install it on your development computer.  
      All [Aspose](http://www.aspose.com/) components, when installed, work in evaluation mode. The evaluation mode has no time limit and only injects watermarks into produced documents. To work with the component in its full capacity, you need a valid license.
2. Create a project:
   1. Start Visual Studio .NET.
   2. Create a new console application.
3. Add references:  
   Add a reference to the Aspose.Cells component into your project, for example `...\Program Files\Aspose\Aspose.Cells\Bin\Net1.0\Aspose.Cells.dll`.
