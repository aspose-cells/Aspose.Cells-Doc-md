...
The [**Cells**](https://reference.aspose.com/cells/net/aspose.cells/cells) collection provides several methods to manage rows or columns in a worksheet; a few of these are discussed below in more detail.
...
Developers can also control displaying summary columns to the right of detail by setting the [**SummaryColumnRight**](https://reference.aspose.com/cells/net/aspose.cells/outline/properties/summarycolumnright) property of the [**Outline**](https://reference.aspose.com/cells/net/aspose.cells/outline) class to **true** or **false**.
