...
If you want to prevent text from being clipped in the saved PDF file, you can autofit the row with the [AutoFitterOptions.ForRendering](https://reference.aspose.com/cells/net/aspose.cells/autofitteroptions/forrendering/) option.
