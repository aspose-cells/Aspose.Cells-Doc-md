...
description: Dialog Sheet is an old format of a sheet. This article provides instructions and sample code for determining programmatically whether an Excel worksheet is a Dialog Sheet using the C# API or .NET Library.
...
You can find if the sheet is a dialog sheet or some other type of sheet with [**Worksheet.Type**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/type) property provided by Aspose.Cells. If it returns the enumeration value [**SheetType.Dialog**](https://reference.aspose.com/cells/net/aspose.cells/sheettype), then it means you are dealing with a dialog sheet.
