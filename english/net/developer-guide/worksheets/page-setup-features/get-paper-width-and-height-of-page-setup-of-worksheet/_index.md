...
The following sample code explains the usage of [**PageSetup.PaperWidth**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/properties/paperwidth) and [**PageSetup.PaperHeight**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/properties/paperheight) properties. It first changes the paper size to *A2* and then finds the width and height of the paper; it then changes it to *A3*, *A4*, and *Letter*, finding the width and height for each respectively.
