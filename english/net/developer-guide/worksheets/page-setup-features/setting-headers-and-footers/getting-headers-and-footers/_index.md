...
With [**Worksheet.PageSetup.GetHeader**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/getheader/) and [**Worksheet.PageSetup.GetFooter**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/getfooter/) methods, a .NET developer can simply get headers or footers from the file.

1. Construct a Workbook to open the file.  
2. Get the worksheet where you want to get the header or footer.  
...
Aspose.Cells for .NET provides [**Worksheet.PageSetup.GetCommands**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/getcommands/) method to parse headers and footers into a command list.

The following code shows how to parse a header or footer as a command list and process commands:
