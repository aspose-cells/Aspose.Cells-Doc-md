...
Microsoft Excel allows users to define error checking options and rules. Users often see error checks when creating formulas; a small triangle at the top right corner of a cell highlights when there's a problem with the cell. Excel provides information that helps users correct common problems.
...
1. Select the **Error Checking** tab.  
   **Numbers stored as text** option is checked by default.
1. Disable it.
