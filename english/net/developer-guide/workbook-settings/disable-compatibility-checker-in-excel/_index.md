...
description: This article shows how to disable the compatibility checker through the Aspose.Cells for .NET API.  
...
Sometimes, you need to disable the Compatibility Checker for a particular spreadsheet. With Aspose.Cells APIs you can do this programmatically so that users aren't frustrated or confused by the Compatibility Checker dialog box popping up when they re‑save the file in Microsoft Excel manually.
...
Set the [**Workbook.Settings.CheckCompatibility**](https://reference.aspose.com/cells/net/aspose.cells/workbooksettings/properties/checkcompatibility) property to **false** to disable Microsoft Excel's Compatibility Checker.
