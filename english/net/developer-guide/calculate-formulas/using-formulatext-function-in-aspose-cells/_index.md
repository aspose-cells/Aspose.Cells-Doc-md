...
FormulaText is an Excel 2013 and later function. It is not supported by previous versions such as Excel 2010 or 2007. As its name suggests, it prints the text of the formula which is present in a given cell. This article will show you how to make use of this function using Aspose.Cells.
