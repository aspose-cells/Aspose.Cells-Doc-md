...
Aspose.Cells provides [**XmlMapCollection.Add()**](https://reference.aspose.com/cells/net/aspose.cells/xmlmapcollection/methods/add) method which you can use to import your XML Map inside the workbook.
