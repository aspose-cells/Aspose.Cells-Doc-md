...
type: docs
weight: 10
url: /net/format-number-to-currency/
description: This article introduces how to format numbers to currency using the Aspose.Cells for .NET API.
...
To format numbers as currency in the Aspose.Cells for .NET library for working with Excel files, you can apply currency formatting to cells programmatically. Here's how you can do it using C# with Aspose.Cells:
