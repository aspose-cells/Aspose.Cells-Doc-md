...
type: docs
weight: 10
url: /net/format-number-to-date/
description: This article introduces how to format a number to a date using the Aspose.Cells for .NET API.
...
To format numbers as dates in the Aspose.Cells for .NET library for working with Excel files, you can apply date formatting to cells programmatically. Here's how you can do it using C# with Aspose.Cells:
