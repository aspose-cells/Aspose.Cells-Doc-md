...
description: This article will introduce how to format number to accounting using Aspose.Cells for .NET API.
...
3. **Choose Accounting Format**:  
   ...
   - Choose the specific settings you want, such as the symbol for your currency and the number of decimal places to display.  
