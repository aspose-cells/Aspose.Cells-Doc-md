...
We added the second approach to optimize memory usage. After using the Cell.GetStyle method to retrieve a Style object, modify it and use the Cell.SetStyle method to set it back to this cell. This Style object won't be preserved and the .NET GC will collect it when it's not referenced.
