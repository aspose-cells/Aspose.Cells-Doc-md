...
## **Sample Code**  
In this example, we create an Excel workbook, add some sample data, access the first worksheet, and retrieve two cells ("A2" and "B3"). Then, we obtain the style of each cell, set various formatting options (e.g., font color, bold), and apply the format to the cells. Finally, we save the workbook to a new file.  
