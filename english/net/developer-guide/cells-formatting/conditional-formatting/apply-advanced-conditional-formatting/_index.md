...
Microsoft Excel 2007 and later versions (2010/2013/2016) provide some advanced features for conditional formatting. For example, it lets you apply cell shading, borders, colored icons, arrows, flags and font formatting, etc., which has become quite sophisticated.
...
- Automatically shade cells with color scales based on their relation to values in other cells in the range. The default setting shades the lowest value in red moving up to the highest value in green.
...
- [**Adding IconSets Conditional Formattings**](/cells/net/how-to-add-icon-sets-conditional-formatting/)
...
### **Compute the Color Chosen by Microsoft Excel for Color Scale Conditional Formatting**
Aspose.Cells lets you calculate the color selected by Microsoft Excel when Color Scale conditional formatting is used in a template file. See the sample code below to learn how to compute the color selected by Microsoft Excel.
