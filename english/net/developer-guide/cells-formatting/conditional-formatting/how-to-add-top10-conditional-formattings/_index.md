...
description: How to use the Aspose.Cells library in C# to apply Top10 conditional formatting. By adjusting these criteria, you have more control over how cells look and appear.
keywords: Aspose.Cells, Top10 Conditional Formatting, C#, Conditional, Formatting
type: docs
weight: 70
...
6. A dialog box will pop up. It will say **“Format cells that rank in the top 10.”** You can change the number (e.g., Top 5, Top 3, etc.). Choose a format (such as a light red fill, bold text, or click **Custom Format** for more options).  
7. Click **OK**.

## **How to Add Top10 Conditional Formatting Using Aspose.Cells for .NET**

Aspose.Cells fully supports the conditional formatting provided by Microsoft Excel 2007 and later versions in XLSX format on cells at runtime. This example demonstrates an example for Top 10 conditional formatting with different sets of attributes.
