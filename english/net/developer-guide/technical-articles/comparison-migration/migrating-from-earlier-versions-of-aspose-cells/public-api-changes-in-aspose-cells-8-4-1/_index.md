...
type: docs
weight: 140
url: /net/public-api-changes-in-aspose-cells-8-4-1/
...
This document describes the changes to the Aspose.Cells API from version 8.4.0 to 8.4.1 that may be of interest to module/application developers. It includes not only new and updated public methods, [added classes etc.](/cells/net/public-api-changes-in-aspose-cells-8-4-1/) and [removed classes etc.](/cells/net/public-api-changes-in-aspose-cells-8-4-1/), but also a description of any changes in the behavior behind the scenes in Aspose.Cells.

{{% /alert %}} 
## **Added APIs**
### **Mechanism to Modify Database Connection**
The Aspose.Cells.ExternalConnections.ExternalConnection class already contained the methods and properties that could be used to inspect the database connection details stored in a spreadsheet. Most of the properties associated with the Aspose.Cells.ExternalConnections.ExternalConnection class were read‑only until the release of Aspose.Cells for .NET 8.4.1. With this release, the API provides support to manipulate the database connection settings as well.
...
Here are the most important properties exposed by the Aspose.Cells.ExternalConnections.ExternalConnection class.
...
|ReConnectionMethod|Specifies reconnectionMethod type|
...
Aspose.Cells for .NET 8.4.1 has exposed the DataLabels.Characters method to retrieve an instance of the FontSetting class that corresponds to the sub‑string of a ChartPoints.DataLabels. In turn, the instance of the FontSetting class can be used to format the sub‑string of the DataLabels with different font settings and color.
...
### **Ability to Set Desired Image Dimensions for Spreadsheet and Chart Export**
Aspose.Cells for .NET 8.4.1 has exposed the ImageOrPrintOptions.SetDesiredSize method to set the dimensions of the resultant image while exporting spreadsheets and charts to images. The ImageOrPrintOptions.SetDesiredSize method accepts two integer‑type parameters, where the first is the desired width and the second is the desired height.
...
The same property can also be used for converting charts to images.

{{% /alert %}} 


### **Rendering Comments to PDF**
With the release of v8.4.1, the Aspose.Cells API has provided the PageSetup.PrintComments property and the PrintCommentsType enumeration in order to facilitate the rendering of comments while converting spreadsheets to PDF format. The PrintCommentsType enumeration has the following constants.
...
- PrintCommentsType.PrintSheetEnd: Comments are to be rendered at the end of the worksheet.

The following sample code demonstrates the use of the PageSetup.PrintComments property to render the comments using all possible PrintCommentsType enumeration values.
...
Aspose.Cells.GridDesktop provides the WorksheetCollection.MoveTo method, which can be used to move a worksheet to the specified index. The method takes the indexes (zero‑based) of the source worksheet and the destination worksheet as parameters.

The following sample code demonstrates the usage of the WorksheetCollection.MoveTo method.
...
Aspose.Cells for .NET 8.4.1 has exposed the Workbook.IsLicensed property, which can be of great help in determining whether the license has been successfully loaded. If you access this property before setting the license, it will return false, and vice versa; however, the license must be valid.
...
//Create an instance of SheetRender and initialize it with the worksheet instance as well as the ImageOrPrintOptions object
...
{{< /highlight >}}
## **Obsolete APIs**
### **Obsolete Workbook.ValidateFormula Method**
