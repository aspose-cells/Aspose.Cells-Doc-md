...
Aspose.Cells for .NET 8.4.2 has exposed the `VbaModuleCollection.Add` method to add a new VBA module to the instance of **Workbook**. The `VbaModuleCollection.Add` method accepts a parameter of type **Worksheet** to add a worksheet‑specific module.  
