...
This section provides a comparison of the availability of features between Aspose.Cells for Java and Aspose.Cells for PHP via Java.
...
|SpreadsheetML (XLSX, XML)|Aspose.Cells supports OOXML, Flat OPC and also Excel 2003 XML. Moreover, <br>the component supports all major Excel 2007 and later file format versions, e.g., XLSX, XLTX, XLSM, XLTM, etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Comma Separated Value (CSV)|Comprehensive support for the CSV format to interact with a variety of applications.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Adobe Portable Document Format (PDF)|Convert any Spreadsheet to PDF with high fidelity.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
| :- | :- | :- |
|Lay out the document into pages with high fidelity to Microsoft Excel® (exactly as Microsoft Excel® would do).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Render worksheet pages to raster images (PNG, JPEG, etc.).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Print spreadsheet pages using the Java printing infrastructure.|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
Aspose.Cells provides a rich object model that consists of over 100 public classes/interfaces, which allow you to programmatically generate, combine, modify, parse, or otherwise examine loaded spreadsheets. **Some key features are listed in the table below.**
...
|Microsoft Excel 2007 and later themes and colors|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Support advanced conditional formatting available in Microsoft Excel 2007 and later|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Create list objects/Microsoft Excel tables|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Preserve or remove add‑ins, VBA, macros|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Feature**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
| :- | :- | :- |
|Apply character formatting in cells including fonts, colors, effects, borders, and shading.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Apply all number format settings (as supported in Microsoft Excel) to cells.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Set all types of text alignment settings.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Apply various font settings to cells.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Apply various border settings to cells.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Apply different background patterns on cells.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Apply format settings to a worksheet, row, column, or a range of cells, etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Feature**|**Aspose.Cells for Java**|**Aspose.Cells for PHP via Java**|
| :- | :- | :- |
|Adjust page orientation, scaling, and paper size.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Specify margins and page centering.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
