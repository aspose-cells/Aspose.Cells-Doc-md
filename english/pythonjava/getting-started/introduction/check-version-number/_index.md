...
To find out which version of Aspose.Cells you are using through the API, use the [CellsHelper](https://reference.aspose.com/cells/python-java/asposecells.api/cellshelper) class's **GetVersion** static method to get Aspose.Cells' version number.
