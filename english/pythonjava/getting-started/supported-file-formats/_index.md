...
| [DBF](https://docs.fileformat.com/database/dbf/) | The file with the .dbf extension is a database file used by the dBASE database‑management system. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
