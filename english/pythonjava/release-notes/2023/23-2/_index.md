...
type: docs
weight: 11
url: /python-java/aspose-cells-for-python-via-java-23-2-release-notes/
...
This page contains release notes for [Aspose.Cells for Python via Java 23.2](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.2/).
