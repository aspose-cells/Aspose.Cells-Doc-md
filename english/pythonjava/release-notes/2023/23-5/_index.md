...
type: docs
weight: 8
url: /python-java/aspose-cells-for-python-via-java-23-5-release-notes/
---

{{% alert color="primary" %}}

This page contains release notes for [Aspose.Cells for Python via Java 23.5](https://downloads.aspose.com/cells/python-java/new-releases/aspose.cells-for-python-via-java-23.5/).
