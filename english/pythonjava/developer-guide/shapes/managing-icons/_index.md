...
If you need to use [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/) to add 'icons' in an Excel file, then this document can provide you with some help.
