...
2. Add a pivot table to the worksheet by calling the [PivotTableCollection](https://reference.aspose.com/cells/python/asposecells.api/PivotTableCollection)[add](https://reference.aspose.com/cells/python/asposecells.api/pivottablecollection#add\(java.lang.Object\)) method, encapsulated in the [Worksheet](https://reference.aspose.com/cells/python/asposecells.api/Worksheet) object.  
3. Access the [PivotTable](https://reference.aspose.com/cells/python/asposecells.api/PivotTable) object from the [PivotTableCollection](https://reference.aspose.com/cells/python/asposecells.api/PivotTableCollection) by passing the PivotTable index.  
4. Use any of the pivot table objects (explained above) encapsulated in the [PivotTableCollection](https://reference.aspose.com/cells/python/asposecells.api/PivotTableCollection) object to manage the pivot table.  
