...
type: docs
weight: 30
url: /python-java/opening-files-with-different-formats/

description: Aspose.Cells for Python via Java API allows you to open/read different formats like XLSX, HTML, CSV, ODS, TSV, SXC, FODS, etc.
