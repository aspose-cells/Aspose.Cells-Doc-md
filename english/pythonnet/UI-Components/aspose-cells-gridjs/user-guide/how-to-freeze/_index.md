...
type: docs
weight: 1
url: /python-net/aspose-cells-gridjs/user-guide/how-to-freeze/
aliases:
- /python-net/aspose-cells-gridjs/how-to-use-freeze
- /python-net/aspose-cells-gridjs/how-to-freeze-rows-and-columns
- /python-net/aspose-cells-gridjs/how-to-toggle-freeze
- /python-net/aspose-cells-gridjs/how-to-unfreeze
- /python-net/aspose-cells-gridjs/how-to-set-freeze-pane
---
