...
dir_path = ""
workbook = Workbook(os.path.join(dir_path, "Sample.xlsx"))
...
text_box = shapes[0]  # Assuming first shape is TextBox
...
shapes = workbook.worksheets[0].shapes
text_box = shapes[0]  # Type inferred as TextBox from ShapeCollection
math_node = text_box.get_equation_paragraph().get_child(0)
