...
description: This article shows how to create, access, and copy named ranges using the Aspose.Cells for Python via .NET API.
...
Suppose you have a named range of cells that spans **A1:C4**. The matrix contains **4 × 3 = 12** cells. The individual range cells are arranged sequentially:
...
Aspose.Cells for Python via .NET provides the [**Range.copy()**](https://reference.aspose.com/cells/python-net/aspose.cells/range/copy/#aspose.cells.Range) method to copy a range of cells with formatting into another range.
