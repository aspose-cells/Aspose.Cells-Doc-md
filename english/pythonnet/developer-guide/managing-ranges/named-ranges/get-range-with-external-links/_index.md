...
description: This article shows how to get a range with external links using Aspose.Cells for Python via .NET API.
...
- [**sheet_name**](https://reference.aspose.com/cells/python-net/aspose.cells/referredarea/sheet_name/): Indicates which sheet this reference belongs to
...
The sample code below demonstrates the use of the [**Name.get_referred_areas**](https://reference.aspose.com/cells/python-net/aspose.cells/name/get_referred_areas/#bool) method to get ranges with external links.
