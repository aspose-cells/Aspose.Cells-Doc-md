...
When you want to set the border for Range, you don't need to set each cell individually. You can set the border on the range. Aspose.Cells for Python via .NET offers this feature.
This article provides a sample code that uses Aspose.Cells for Python via .NET to set range border.

## **How to Set Range border in Excel**
...
## **How to Set Range border using Aspose.Cells for Python Excel Library**
This example shows how to:

1. Create a workbook.
1. Add data to cells in the first worksheet.
1. Create a [**Range**](https://reference.aspose.com/cells/python-net/aspose.cells/range).
