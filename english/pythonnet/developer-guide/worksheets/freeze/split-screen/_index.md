...
keywords: Python Excel Library, Python Freeze top rows, Python Freeze top row, Python Split worksheet vertically on columns, Python Split worksheet horizontally on rows, Python Split worksheet into four parts, Python How to remove split.
...
It's easy to split a worksheet vertically on columns programmatically with Aspose.Cells for Python via .NET. We only need to select one cell in the top row as the active cell, then split with the [**Worksheet.split**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/split/) method.
...
It's easy to split a worksheet horizontally on rows programmatically with Aspose.Cells for Python via .NET. We only need to select one cell in the left column as the active cell, then split with the [**Worksheet.split**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/split/) method.
...
It's easy to split a worksheet into four parts programmatically with Aspose.Cells for Python via .NET. We only need to select one cell not in the first row or column as the active cell, then split with the [**Worksheet.split**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/split/) method.
...
Aspose.Cells for Python via .NET provides a [**Worksheet.remove_split**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet/remove_split/) method to remove the split setting.
