...
Sometimes, you need to generate images of Conditional Formatting DataBars. You can use Aspose.Cells **DataBar.to_image()** method to generate these images. This article shows how to generate a DataBar image using Aspose.Cells for Python via .NET.

{{% /alert %}}

The following sample code generates the DataBar image of cell C1. First, it accesses the format condition object of the cell, and then, from that object, it accesses the **DataBar** object and uses its **to_image()** method to generate the cell’s image. Finally, it saves the image on disk.
