...
description: This article introduces how to format a number to a date using Aspose.Cells for Python via .NET API.
...
5. Choose the desired date format from the list on the right (e.g., MM/DD/YYYY, DD/MM/YYYY, or a custom format).  
...
To format numbers as dates in Aspose.Cells for Python via .NET, apply date formatting to cells programmatically. Here's how you can do it using Python with Aspose.Cells:
