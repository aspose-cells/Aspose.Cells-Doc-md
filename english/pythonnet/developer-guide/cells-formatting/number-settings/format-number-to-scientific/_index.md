...
description: This article will introduce how to format numbers to scientific notation using Aspose.Cells for Python via .NET API.
...
3. **Choose Scientific Format**: Then, follow the same steps as described above to apply scientific notation.
