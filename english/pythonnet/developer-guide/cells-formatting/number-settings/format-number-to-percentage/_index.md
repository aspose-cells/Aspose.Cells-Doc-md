...
description: This article will introduce how to format number to percentage using Aspose.Cells for Python via .NET API.  
...
First, ensure you have Aspose.Cells for Python via .NET installed in your project. You can easily get Aspose.Cells for Python via .NET from PyPI with the following command.
