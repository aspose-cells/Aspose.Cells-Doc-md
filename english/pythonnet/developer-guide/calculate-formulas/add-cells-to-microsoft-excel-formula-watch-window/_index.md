...
The following sample code sets formulas for cells C1 and E1, then adds both to the Watch Window. It saves the workbook as the [output Excel file](67338481.xlsx). When opening the output file in Excel, both cells will appear in the Watch Window as shown:
