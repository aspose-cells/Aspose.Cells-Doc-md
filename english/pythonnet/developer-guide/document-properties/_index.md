...
- [Specify Document Version of the Excel File using Built-In Document Properties](/cells/python-net/specify-document-version-of-the-excel-file-using-builtin-document-properties/)
- [Specify the Language of the Excel File using Built-In Document Properties](/cells/python-net/specify-the-language-of-the-excel-file-using-builtin-document-properties/)
