...
The following sample code creates a workbook and sets the value of the [**Workbook.settings.compliance**](https://reference.aspose.com/cells/python-net/aspose.cells/workbooksettings/compliance) property to [**OoxmlCompliance.ISO_29500_2008_STRICT**](https://reference.aspose.com/cells/python-net/aspose.cells/ooxmlcompliance) and saves it as the output Excel file ([output Excel file](67338272.xlsx)). If you open the output Excel file in Microsoft Excel and then open the **Save As...** dialog box, you will see its format displayed as *Strict Open XML Spreadsheet*, as shown in this screenshot.
