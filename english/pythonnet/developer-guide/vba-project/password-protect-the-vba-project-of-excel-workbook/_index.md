---
title: Password Protect the VBA Project of an Excel Workbook
type: docs
weight: 10
...
You can password‑protect the VBA (Visual Basic for Applications) project of a workbook with Aspose.Cells for Python via .NET using the [**VbaProject.protect()**](https://reference.aspose.com/cells/python-net/aspose.cells.vba/vbaproject/protect) method.
