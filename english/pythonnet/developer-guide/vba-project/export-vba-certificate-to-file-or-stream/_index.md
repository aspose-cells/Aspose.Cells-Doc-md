...
Aspose.Cells for Python via .NET allows you to export a VBA digital certificate to a stream, such as a file or memory stream. You can access the raw data of the VBA digital certificate using the [**Workbook.vba_project.cert_raw_data**](https://reference.aspose.com/cells/python-net/aspose.cells.vba/vbaproject/cert_raw_data) property.
