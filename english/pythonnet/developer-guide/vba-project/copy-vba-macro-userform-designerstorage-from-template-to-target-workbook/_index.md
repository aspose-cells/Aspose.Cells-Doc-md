...
The following screenshot shows the output Excel file and its contents, which were copied from the template Excel file. When you click on Button 1, it opens the VBA User Form, which itself has a command button that shows a message box when clicked.
