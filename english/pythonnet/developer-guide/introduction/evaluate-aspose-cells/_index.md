...
type: docs
weight: 40
url: /python-net/evaluate-aspose-cells/
---

{{% alert color="primary" %}}

You can easily download Aspose.Cells for evaluation from [pypi](https://pypi.org/project/aspose-cells-python/). The evaluation download is the same as the download for the full version: the evaluation becomes licensed when you apply a license.
