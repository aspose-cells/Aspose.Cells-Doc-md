...
keywords: Python Convert Excel workbook to Ods, Sxc and Fods (OpenOffice / LibreOffice Calc), Convert Ods (OpenOffice / LibreOffice Calc) to Excel Python via NET, Convert Excel to Ods (OpenOffice / LibreOffice Calc) using Python via NET.
...
Aspose.Cells for Python via .NET supports loading Ods, Sxc, and Fods, which are supported by OpenOffice / LibreOffice Calc, and converts [Ods](book1.ods), [Sxc](book1.sxc) and [Fods](book1.fods) to Excel files.
...
## **Advanced topics**
- [Save ODS File in ODF 1.1 and 1.2 Specifications](/cells/python-net/save-ods-file-in-odf-1-1-and-1-2-specifications/)
- [Working with Background in ODS Files](/cells/python-net/working-with-background-in-ods-files/)
