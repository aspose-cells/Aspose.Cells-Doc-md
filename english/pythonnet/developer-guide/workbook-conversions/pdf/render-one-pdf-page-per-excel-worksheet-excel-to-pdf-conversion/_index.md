...
If the [PdfSaveOptions.one_page_per_sheet](https://reference.aspose.com/cells/python-net/aspose.cells/pdfsaveoptions/one_page_per_sheet/) option is set to **true**, all the sheet content will be rendered on a single PDF page.
