...
The following screenshot shows the XLSX file converted from the above CSV file after setting the [**TxtLoadOptions.is_multi_encoded**](https://reference.aspose.com/cells/python-net/aspose.cells/txtloadoptions/is_multi_encoded/) property to **true**. As you can see, the Unicode text is now converted properly.
