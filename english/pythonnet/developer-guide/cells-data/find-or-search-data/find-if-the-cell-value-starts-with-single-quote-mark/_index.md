...
The following sample code demonstrates that strings such as `sample` and `'sample'` cannot be differentiated using the [**Cell.string_value**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/string_value/) property. Therefore, we must use the [**Style.quote_prefix**](https://reference.aspose.com/cells/python-net/aspose.cells/style/quote_prefix/) property to distinguish them.
