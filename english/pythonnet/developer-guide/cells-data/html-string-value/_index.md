...
Similarly, if there is some simple HTML, Aspose.Cells for Python via .NET can convert it into HTML rich text. Aspose.Cells for Python via .NET provides the [**Cell.html_string**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/html_string/) property, which can take such simple HTML and convert it to formatted cell text.  
