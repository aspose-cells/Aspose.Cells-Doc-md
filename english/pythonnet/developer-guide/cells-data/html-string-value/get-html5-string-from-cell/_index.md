...
description: Learn how to get an HTML5 string from a cell through the Aspose.Cells for Python via .NET API.
keywords: Python Excel Library, Python Get HTML5 string from Cell, Obtain HTML5 string from Cell using Python, Manage HTML5 string of Cell in Python.
...
The following sample code creates a workbook object and adds some text in cell A1 of the first worksheet. It then gets the normal HTML and HTML5 strings from cell A1 using the [**get_html_string(html5)**](https://reference.aspose.com/cells/python-net/aspose.cells/cell/get_html_string/#bool) method and prints them to the console.
