...
description: This article shows how to set a Pivot Table option with Aspose.Cells for Python via .NET.
...
## **How to Set Pivot Table Option Using Aspose.Cells for Python via .NET**
