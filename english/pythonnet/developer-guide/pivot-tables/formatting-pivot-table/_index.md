...
Microsoft Excel offers a number of different pre‑set report formats. Aspose.Cells for Python via .NET **supports** these formatting options too. To access them:
...
2. Assign a formatting option from the [**PivotTableAutoFormatType**](https://reference.aspose.com/cells/python-net/aspose.cells.pivot/pivottableautoformattype/) enumeration.  
