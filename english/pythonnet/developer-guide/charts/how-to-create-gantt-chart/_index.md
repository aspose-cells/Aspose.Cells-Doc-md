...
2. Select the data and go to Insert → Charts → Insert Column or Bar Chart → Stacked Bar Chart. In our example, that’s B1:B7, and then insert a **Stacked Bar** chart.  
   <br>
