...
Add a comment to a cell by calling the [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) collection's [**add**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection/add) method (encapsulated in the [**Worksheet**](https://reference.aspose.com/cells/python-net/aspose.cells/worksheet) object). The new [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) object can be accessed from the [**Comments**](https://reference.aspose.com/cells/python-net/aspose.cells/commentcollection) collection by its index. After accessing the [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) object, customize the comment note by using the [**Comment**](https://reference.aspose.com/cells/python-net/aspose.cells/comment) object's [**note**](https://reference.aspose.com/cells/python-net/aspose.cells/comment/note) property.
...
With Microsoft Excel 2007, it is also possible to have an image as the background of a cell comment. In Excel 2007 this is accomplished by following these steps (assuming that you have already added a cell comment).
...
## **Advanced topics**
- [Change Text Direction of the Comment](/cells/python-net/change-text-direction-of-the-comment/)
- [How to change the Comment Font Color](/cells/python-net/how-to-change-the-comment-font-color/)
- [How to set comment background](/cells/python-net/how-to-set-comment-background/)
- [Threaded Comments](/cells/python-net/threaded-comments/)
