---  
title: Smartly importing and placing data with Smart markers in Python via .Net  
linktitle: Smart markers  
type: docs  
weight: 190  
url: /python-net/using-smart-markers/  
description: Smartly importing and placing data according to the template Excel files with Aspose.Cells for Python via .Net library.  
