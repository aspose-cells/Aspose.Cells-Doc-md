...
Aspose.Cells provides the [**Workbook.add_digital_signature**](https://reference.aspose.com/cells/python-net/aspose.cells/workbook/add_digital_signature) method that you can use to add digital signature to an already signed Excel file.
