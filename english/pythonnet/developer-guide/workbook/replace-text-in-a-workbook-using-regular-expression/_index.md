...
The following code snippet demonstrates the use of the [**ReplaceOptions.regex_key**](https://reference.aspose.com/cells/python-net/aspose.cells/replaceoptions/regex_key) property using the [sample Excel file](101089318.xlsx). The [output file](101089319.xlsx) generated by the code snippet is attached for reference.
