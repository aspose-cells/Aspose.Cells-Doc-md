---
title: Using Sparklines and Setting 3D Format
type: docs
weight: 40
...
Sparklines help you see trends, for example, the win‑loss record for a softball league. Sparklines can even sum up the entire season of each team in the league.
...
## **Setting 3D Format**
You might need 3D charting styles so you can achieve the results for your scenario. Aspose.Cells for Python via .NET provides the relevant API to apply Microsoft Excel 2007 3D formatting.
