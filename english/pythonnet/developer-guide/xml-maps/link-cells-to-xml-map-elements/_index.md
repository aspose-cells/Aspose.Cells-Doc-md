...
type: docs
weight: 50
url: /python-net/link-cells-to-xml-map-elements/
...
The following sample code loads the [source Excel file](5115471.xlsx), which contains an XML Map, and then links cells A1, B2, C3, D4, E5, and F6 to XML Map elements FIELD1, FIELD2, FIELD4, FIELD5, FIELD7, and FIELD8, respectively, before saving the workbook to the [output Excel file](5115467.xlsx).
