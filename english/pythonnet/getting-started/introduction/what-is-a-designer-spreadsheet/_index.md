...
A designer spreadsheet is an Excel file created using Microsoft Excel in which all formatting is already applied and the contents can be decided at design time. It's more like a template file that doesn't contain any data but just the formatting, as shown below:
