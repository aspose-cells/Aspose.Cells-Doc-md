---
title: Aspose.Cells for Python via .NET 23.8 Release Notes
type: docs
weight: 6
url: /python-net/aspose-cells-for-python-net-23-8-release-notes/
description: Aspose.Cells for Python via .NET 23.8 Release Notes – the latest enhancements, new features, and fixes.
keywords: Aspose.Cells for Python via .NET 23.8 Release Notes, Aspose.Cells for Python via .NET 23.8 updates and fixes
---

{{% alert color="primary" %}} 

This is the first version for Aspose.Cells for Python via .NET.
This page contains release notes for Aspose.Cells for Python via .NET 23.8.

{{% /alert %}} 

|**Key**|**Summary**|**Category**|
| :- | :- | :- |
|CELLSPYTHONNET-166|Fix License exception issue|Bug
