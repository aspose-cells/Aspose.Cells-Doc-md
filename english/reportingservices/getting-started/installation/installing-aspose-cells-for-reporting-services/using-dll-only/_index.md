...
- Visit the Aspose.Cells for Reporting Services [download page](https://downloads.aspose.com/cells/reportingservices) and download the **Aspose.Cells for Reporting Services (zip)** archive that contains the latest version of the component and the installed documentation.  
   - There are 7 versions of **Aspose.Cells.ReportingServices.dll** in **Aspose.Cells.ReportingServices.DLLs_xx.xx.zip**. They support different Microsoft report server products.  
       - **Aspose.Cells.ReportingServices.dll** in the **SSRS2005** folder supports Microsoft SQL Server 2005 Reporting Services.  
       - **Aspose.Cells.ReportingServices.dll** in the **SSRS2008** folder supports Microsoft SQL Server 2008 Reporting Services.  
       - **Aspose.Cells.ReportingServices.dll** in the **SSRS2008R2** folder supports Microsoft SQL Server 2008R2/2012/2014 Reporting Services.  
       - **Aspose.Cells.ReportingServices.dll** in the **SSRS2016** folder supports Microsoft SQL Server 2016/2017/2019 Reporting Services.  
...
- Install Aspose.Cells for Reporting Services Report Designer:  
   ...
   - Add the Aspose.Cells for Reporting Services add‑in to Excel.  

- Install the Aspose.Cells for Reporting Services component for Microsoft SQL Server Reporting Services:  
...
1. Open the Report Manager and check the list of available export types for a report. (Launch Report Manager by opening a browser and typing the Report Manager URL into the address bar. By default, the URL is `http://<ComputerName>/Reports`.)  
