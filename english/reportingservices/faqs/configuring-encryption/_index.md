...
Configuration information for encryption is stored in the **Aspose.Cells.ReportingServices.xml** file. When the value of Encryption is set to `"off"`, Aspose.Cells.ReportingServices turns encryption off.
...
- **ReportName** – Sets the report that needs encryption settings. A report uses the same encryption method when the parameter is blank.  
- **Password** – Sets the password. It cannot be left blank.  
- **EncryptionType** – Sets the encryption type. It cannot be left blank.  
