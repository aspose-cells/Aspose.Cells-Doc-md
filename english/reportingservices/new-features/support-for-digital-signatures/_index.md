...
A digital signature provides assurance that a workbook is valid and that no one has altered it. Attaching a digital signature is similar to sealing an envelope. If an envelope arrives sealed, you have some level of assurance that no one has tampered with its contents. 

You can create a personal digital signature by using the Microsoft Selfcert.exe or any other tool, or you can purchase a digital signature. To sign a spreadsheet, attach a signature to your workbook once you have created a digital signature. 
...
- When the value of DigitalSignature is **on**, Aspose.Cells.ReportingServices turns on the digital signature functionality.  
  For example: 
