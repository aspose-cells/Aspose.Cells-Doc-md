...
We have incorporated support for creating a matrix report item in a report. The matrix context includes a corner, column groupings, row groupings, and matrix rows. Set matrix report attributes, which include name, range, and so on, through the **Set Attribute** button in Aspose.Cells’ command bar in Excel.  
