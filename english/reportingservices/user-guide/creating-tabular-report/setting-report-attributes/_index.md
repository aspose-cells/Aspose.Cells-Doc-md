...
To create a table report, you need to set report attributes before publishing the report to the Report Server. The report attributes **hold** information about the report's name, range, data grouping, sorting, and so on.
...
4. Select a range for the report.  
   ...
   The start and end **cell indices** appear in the **Range** field automatically. Here, the range includes cells from D4 to H8.  
