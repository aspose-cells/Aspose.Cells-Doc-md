...
2. Edit the hidden information.  
3. Click **Add** to add hidden information.  

![todo:image_alt_text](working-with-dyn-hide-form_2.png)

The defined area is hidden from the report.

To remove hidden information:

1. Select a sheet from the list of hidden areas in the Dyn-Hide dialog.  
2. Click **Delete**.  
   The selected area is deleted and will no longer be displayed in the report.
