...
The first step in the procedure for designing a report in Aspose.Cells.Report.Designer is to create data sources and queries. There are two ways to do this. In the first approach, we may use an existing RDL report definition file created by other tools, for example, Visual Studio, and the file contains the data sources and queries necessary for report design and data retrieval. The second approach is to create new data sources and queries in Aspose.Cells.Report.Designer.
