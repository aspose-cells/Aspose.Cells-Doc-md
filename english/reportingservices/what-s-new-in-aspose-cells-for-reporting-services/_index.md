---
title: What's new in Aspose.Cells for Reporting Services
type: docs
description: "Aspose.Cells for Reporting Services expands and enhances daily. On this page, you can learn about the huge and most interesting features of the product."
weight: 5
url: /reportingservices/what-s-new-in-aspose-cells-for-reporting-services/
---
...
* Fix a few bugs.
* Support to render numbers format.

## Aspose.Cells for Reporting Services  22.9

* Support to render SXC format.

## Aspose.Cells for Reporting Services  22.8

* Support to render XLTX format.
...
* Support to render docx format.
* Improve Text renderer.

## Aspose.Cells for Reporting Services  22.2

* Support to render pptx format.
