...
Aspose.Cells for JasperReports is available as a free, time‑unlimited evaluation from the [download page](https://downloads.aspose.com/cells/jasperreports). The evaluation and licensed versions of the product are the same download.
...
**When a valid license is present, there is no evaluation worksheet**
