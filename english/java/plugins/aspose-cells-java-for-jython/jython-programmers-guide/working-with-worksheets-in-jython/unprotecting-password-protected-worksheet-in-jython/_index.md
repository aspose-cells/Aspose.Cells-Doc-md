...
## **Aspose.Cells - Unprotect Worksheet**
To unprotect a password‑protected worksheet using **Aspose.Cells Java for Jython**, see the example code below.
...
Download the code from any of the below‑mentioned social coding sites:
