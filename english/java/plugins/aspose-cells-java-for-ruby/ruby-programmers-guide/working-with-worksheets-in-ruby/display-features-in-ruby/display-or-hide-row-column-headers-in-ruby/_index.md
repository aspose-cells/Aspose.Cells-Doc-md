...
To hide row/column headers using **Aspose.Cells Java for Ruby**, call the **DisplayHideRowColumnHeaders** module.
...
Make row and column headers visible by using the Worksheet class's `setRowColumnHeadersVisible(true)` method.
