...
### **Page Orientation**
To apply page orientation settings using **Aspose.Cells Java for Ruby**, call the **page_orientation** method of the [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pageSetup) module.
...
{{< /highlight >}}
### **Scaling Factor**
To apply scaling using **Aspose.Cells Java for Ruby**, call the **scaling** method of the [**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pageSetup) module.
