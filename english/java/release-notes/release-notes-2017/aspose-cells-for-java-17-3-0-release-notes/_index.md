...
type: docs
weight: 100
url: /java/aspose-cells-for-java-17-3-0-release-notes/
---
...
1. [Execute client side function on GridWeb page change](/cells/java/execute-client-side-function-on-gridweb-page-change/)
1. [Validate entire worksheet instead of only the updated cells](/cells/java/validate-entire-worksheet-instead-of-only-the-updated-cells/)
