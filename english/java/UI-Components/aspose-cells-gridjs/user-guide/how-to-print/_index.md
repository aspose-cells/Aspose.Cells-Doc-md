...
type: docs
weight: 195
url: /java/aspose-cells-gridjs/user-guide/how-to-print/
aliases:
  - /java/aspose-cells-gridjs/print-settings/
  - /java/aspose-cells-gridjs/printing/
  - /java/aspose-cells-gridjs/print-configuration/
  - /java/aspose-cells-gridjs/print-layout/
...
GridJs provides a built-in **Print Settings** modal that allows users to customize the layout and appearance of the worksheet before sending it to the printer or saving it as a PDF. This ensures that large datasets are presented readably on standard paper sizes.
...
*   **A4:** (Default) The standard paper size used worldwide (210 × 297 mm).
