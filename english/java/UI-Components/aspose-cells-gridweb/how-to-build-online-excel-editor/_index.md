---
title: How to Run Aspose.Cells.GridWeb to Build an Online Spreadsheet Editor or Viewer Application in Docker
type: docs
weight: 250
...
Here is a sample [`Dockerfile`](https://github.com/aspose-cells/Aspose.Cells.Grid-for-Java/tree/master/Examples.GridWeb/springboot3.3demo/Dockerfile) for GridWeb demo with a Java application:

```dockerfile
# Spring Boot 3.3 should use JDK 17 or above 
...
# Web port
EXPOSE 8080
# Install Fonts because the SDK image contains very few fonts. The command copies font files from local to Docker image.
# Make sure you have a local “fonts” directory that contains all the fonts you need to install.
# In this example, the local “fonts” directory is put in the same directory as the Dockerfile.
# COPY fonts/* /usr/share/fonts/

# Install necessary dependencies for font management, because we use jdk-slim, we need to install them
