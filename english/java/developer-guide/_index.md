...
<div class="row">
    <div class="col-md-6">
        <p>Info</p>
        <ul>
            <li><a href="/cells/java/document-properties/">Document Properties</a></li>
        </ul>
        <p>New</p>
        <ul>
            <li><a href="/cells/java/your-first-aspose-cells-application-hello-world/#code-sample-creating-a-new-workbook">Creating a New Workbook</a></li>
        </ul>
        <p>Open</p>
        <ul>
            <li><a href="/cells/java/opening-files-with-different-formats/">Opening Files with Different Formats</a></li>
            <li><a href="/cells/java/get-warnings-while-loading-excel-file/">Get Warnings while Loading Excel File</a></li>
            <li><a href="/cells/java/read-numbers-spreadsheet-developed-by-apple-inc-using-aspose-cells/">Read Numbers Spreadsheet Developed by Apple Inc. using Aspose.Cells</a></li>
        </ul>
        <p>Save</p>
        <ul>
            <li><a href="/cells/java/different-ways-to-save-files/">Different Ways to Save Files</a></li>
            <li><a href="/cells/java/encrypting-excel-files/">Encrypting Excel Files</a></li>
            <li><a href="/cells/java/save-workbook-to-strict-open-xml-spreadsheet-format/">Save Workbook to Strict Open XML Spreadsheet Format</a></li>
        </ul>
    </div>
    <div class="col-md-6">
	   <p>Print</p>
        ...
        <p>Export</p>
        <ul>
            <li><a href="/cells/java/converting-workbook-to-different-formats/">Convert Workbook to Different Formats</a></li>
            <li><a href="/cells/java/convert-excel-workbook-to-pdf/">Convert Excel Workbook to PDF</a></li>
            <li><a href="/cells/java/convert-excel-file-to-pdf-format-compatible-with-pdfa-1a/">Convert Excel file to PDF format compatible with PDFA-1a</a></li>
            <li><a href="/cells/java/converting-worksheet-to-different-image-formats/">Converting Worksheet to Different Image Formats</a></li>
            <li><a href="/cells/java/track-document-conversion-progress/">Track Document Conversion Progress</a></li>
            <li><a href="/cells/java/convert-excel-to-html-with-tooltip/">Convert Excel to HTML with tooltip</a></li>
            <li><a href="/cells/java/convert-json-to-csv/">Convert JSON to CSV</a></li>
            <li><a href="/cells/java/convert-csv-to-json/">Convert CSV to JSON</a></li>
        </ul>
        <p>Options</p>
        <ul>
            <li><a href="/cells/java/workbook-settings/">Workbook Settings</a></li>
        </ul>
    </div>
</div>
{{< /tab >}}
...
<div class="row">
    <div class="col-md-6">
        <p><a href="/cells/java/pivot-tables/">PivotTable</a></p>
        <ul>
            <li><a href="/cells/java/create-pivot-table/">Create Pivot Table</a></li>
        ...
        <ul>
            <li><a href="/cells/java/insert-a-linked-picture-from-web-address/">Insert a Linked Picture from Web Address</a></li>
            <li><a href="/cells/java/insert-a-picture-based-on-cell-reference/">Insert a Picture Based on Cell Reference</a></li>
        ...
        <ul>
            ...
            <li><a href="/cells/java/editing-hyperlinks-of-worksheet/">Editing Hyperlinks of Worksheet</a></li>
        </ul>
        <p>Comments</p>
        <ul>
        ...
        <p>SmartArt</p>
        <ul>
            <li><a href="/cells/java/determine-if-shape-is-smart-art-shape/">Determine if Shape is Smart Art Shape</a></li>
    ...
    <div class="col-md-6">       
        ...
        <p><a href="/cells/java/slicers/">Slicer</a></p>
        <ul>
            <li><a href="/cells/java/create-slicer-to-a-pivot-table/">Create Slicer to a Pivot Table</a></li>
        ...
        <ul>
            <li><a href="/cells/java/add-wordart-watermark-to-worksheet/">Add WordArt Watermark to Worksheet</a></li>
            <li><a href="/cells/java/add-wordart-watermark-to-chart/">Add WordArt Watermark to Chart</a></li>
        </ul>
        <p>Symbols</p>
        <ul>
        </ul>
...
<div class="row">
    <div class="col-md-6">
        <p>Themes</p>
        <ul>
            <li><a href="/cells/java/excel-2007-themes-and-colors/">Excel 2007 Themes and Colors</a></li>
            <li><a href="/cells/java/extract-theme-data-from-excel-file/">Extract Theme Data from Excel File</a></li>
        </ul>
        <p>Page Setup</p>
        <ul>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul>
            <li><a href="/cells/java/supported-formula-functions/">Supported Formula Functions</a></li>
        </ul>
        <p>Defined Names</p>
        <ul>
            <li><a href="/cells/java/named-ranges/">Named Ranges</a></li>
        </ul>
    </div>
    <div class="col-md-6">
        ...
        <p>Calculation</p>
        <ul>
            <li><a href="/cells/java/ways-to-calculate-formulas/">Ways to Calculate Formulas</a></li>
            <li><a href="/cells/java/returning-a-range-of-values-using-abstractcalculationengine/">Returning a Range of Values using AbstractCalculationEngine</a></li>
            <li><a href="/cells/java/aspose-cells-formula-calculation-engine/">Aspose.Cells Formula Calculation Engine</a></li>
            <li><a href="/cells/java/calculation-of-excel-2016-minifs-and-maxifs-functions/">Calculation of Excel 2016 MINIFS and MAXIFS functions</a></li>
            <li><a href="/cells/java/implement-custom-calculation-engine-to-extend-the-default-calculation-engine-of-aspose-cells/">Implement Custom Calculation Engine to extend the Default Calculation Engine of Aspose.Cells</a></li>
            <li><a href="/cells/java/calculation-of-array-formula-of-data-tables/">Calculation of Array Formula of Data Tables</a></li>
        </ul>
    </div>
</div>
{{< /tab >}}
