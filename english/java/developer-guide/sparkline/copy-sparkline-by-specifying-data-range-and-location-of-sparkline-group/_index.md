...
- Specify the Data Range and Location, and click OK.
...
The following screenshot shows the source Excel file used inside the code. The red‑highlighted area shows the "**Edit Group Location & Data...**" option to specify the data range and location of the sparkline group. Cell P4 shows the sparkline that will be copied to the other four cells, which are filled with yellow color, using Aspose.Cells.

![todo:image_alt_text](copy-sparkline-by-specifying-data-range-and-location-of-sparkline-group_1.png)

The following screenshot shows the output Excel file generated by the sample code. As you can see, the sparkline in cell P4 has been copied to the next four cells in column P, each with a different data range.
