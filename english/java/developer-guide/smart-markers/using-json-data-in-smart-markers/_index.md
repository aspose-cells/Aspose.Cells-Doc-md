...
type: docs
weight: 30
url: /java/using-json-data-in-smart-markers/
ai_search_scope: cells_java
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
---

## **Why Use JSON Data in Smart Markers**
...
Aspose.Cells for Java supports JSON data in smart markers; JSON data can be nested hierarchically. Please check [template file](smartmarker.xlsx), [JSON file](smartmarker.json) and the screenshot of the output Excel file generated with the following code.
...
Aspose.Cells for Java supports JSON data in smart markers; JSON data can be nested hierarchically. The subtotal feature was used for data statistics in the Excel template. Please check [template file](jsonExcelTemplate.xlsx), [JSON file](jsonData.json) and the screenshot of the output Excel file generated with the following code.
