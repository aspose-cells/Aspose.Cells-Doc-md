...
Aspose.Cells provides a [**Worksheet.setShowFormulas()**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#setShowFormulas-boolean-) property. Set this to **true** to set Microsoft Excel to display formulas.
...
The following image shows the formula instead of the calculated value, enabled by setting the [**Worksheet.setShowFormulas()**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#setShowFormulas-boolean-) property to **true** with Aspose.Cells.
