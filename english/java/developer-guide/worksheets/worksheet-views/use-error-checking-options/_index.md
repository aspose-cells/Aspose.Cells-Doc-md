...
Microsoft Excel allows users to define error‑checking options and rules. Users often see error checks when creating formulas, a small triangle at the top right corner of a cell appears when there is a problem with the cell. Excel provides information that helps users correct common problems.
...
Aspose.Cells provides error‑checking option features. The **ErrorCheckOptions** class manages different types of error checks, for example numbers stored as text, formula calculation errors, and validation errors. Use the **ErrorCheckType** enumeration to set the desired error checking.
...
3. Disable it.  
   See the picture below for how the green triangle is displayed for the data in MS Excel.
...
{{< highlight java >}}
 // Create a workbook and open a template spreadsheet
