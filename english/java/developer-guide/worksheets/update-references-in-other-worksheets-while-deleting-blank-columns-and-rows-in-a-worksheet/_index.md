...
## **Console Output**
This is the console output of the above sample code when [DeleteOptions.UpdateReference](https://reference.aspose.com/cells/java/com.aspose.cells/deleteoptions#setUpdateReference-boolean-) property has been set as **true**.
