...
4. In the **To book** box, select the workbook to receive the sheets.  
...
Aspose.Cells provides a method, [**Worksheet.copy()**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#copy-com.aspose.cells.Worksheet-), used to copy data and formatting from a source worksheet to a worksheet within or between workbooks. The method takes the source worksheet object as a parameter.
