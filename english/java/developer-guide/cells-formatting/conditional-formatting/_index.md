...
Developers can create a designer spreadsheet that contains conditional formatting in Microsoft Excel and then open that spreadsheet with Aspose.Cells. Aspose.Cells loads and saves the designer spreadsheet, keeping any conditional formatting settings. To find out more about designer spreadsheets, read [What is a Designer Spreadsheet](/cells/java/what-is-a-designer-spreadsheet/).
...
- [Adding 2-Color Scale and 3-Color Scale Conditional Formatting](/cells/java/adding-2-color-scale-and-3-color-scale-conditional-formattings/)
