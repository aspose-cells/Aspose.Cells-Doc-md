...
If you want to prevent text **from** being clipped in the saved PDF file, you can autofit the row with the [AutoFitterOptions.ForRendering](https://reference.aspose.com/cells/java/com.aspose.cells/autofitteroptions/#setForRendering-boolean-) option.
