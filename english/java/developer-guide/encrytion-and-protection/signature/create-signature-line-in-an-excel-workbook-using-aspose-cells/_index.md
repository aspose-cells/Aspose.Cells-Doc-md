...
Aspose.Cells also provides this feature and has exposed the [**Picture.setSignatureLine()**](https://reference.aspose.com/cells/java/com.aspose.cells/picture#setSignatureLine-com.aspose.cells.SignatureLine-) property for this purpose. This article will explain how to use this property to add a Signature Line using Aspose.Cells.

{{% /alert %}}

## Java code to create Signature Line in an Excel Workbook using Aspose.Cells

The following sample code adds a Signature Line using [**Picture.setSignatureLine()**](https://reference.aspose.com/cells/java/com.aspose.cells/picture#setSignatureLine-com.aspose.cells.SignatureLine-) property and saves the workbook. The screenshot shows how the output workbook looks like in Microsoft Excel.
