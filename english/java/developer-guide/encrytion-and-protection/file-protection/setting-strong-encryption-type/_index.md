...
Microsoft Excel (97‑2007/2010) enables you to encrypt and password‑protect spreadsheets. It uses algorithms provided by a Crypto Service Provider. A Crypto Service Provider (or CSP) is a set of cryptographic algorithms with different properties. The default CSP is **“Office 97/2000 Compatible.”** This CSP has some publicly known security issues. Spreadsheets that are secured with the **“weak encryption (XOR)”** or with the **“Office 97/2000 Compatible”** encryption type can be cracked easily.
...
The code example below applies strong encryption to a file and sets a password.
