...
The method returns a [Shape](https://reference.aspose.com/cells/java/com.aspose.cells/Shape) object.
...
Execute the above code, and you will get the following results:
