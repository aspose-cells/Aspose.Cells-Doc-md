...
1. Add some data to worksheet cells by using the [**Cell**](https://reference.aspose.com/cells/java/com.aspose.cells/cell) object's [**setValue**](https://reference.aspose.com/cells/java/com.aspose.cells/cell#setValue-java.lang.Object-) method. This data will be used as a data source for the pivot table.
