...
Comments are added to cells to record comments—anything from the details of how a formula works, where a value comes from, or questions from reviewers. Adding a background image can be an aesthetic choice, or be used to strengthen branding.  

{{% /alert %}}  

## Add picture to an Excel comment with Microsoft Excel  
...
## Add picture to an Excel comment with Aspose.Cells  
