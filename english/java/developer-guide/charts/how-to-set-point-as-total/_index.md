...
description: In some Excel charts, for example, Waterfall chart, you may need to set a point as total. This article describes how to use Aspose.Cells to do it. 
...
In some Excel charts, for example, Waterfall chart, some point data are the sum of the previous points; you may need to “set point as total”. We will show the sample code and the illustration below.
...
You can download the corrected [output file](output.xlsx).

As shown in the figure below, the four “Total” data points are set correctly, and you can see the difference compared with the previous chart.
