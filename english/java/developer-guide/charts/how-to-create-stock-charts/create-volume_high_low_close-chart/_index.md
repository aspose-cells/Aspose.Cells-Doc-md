...
This chart includes a column for volume immediately after the first (category) column, and it includes a column chart on the primary axis showing this volume, while the prices are moved to the secondary axis.
