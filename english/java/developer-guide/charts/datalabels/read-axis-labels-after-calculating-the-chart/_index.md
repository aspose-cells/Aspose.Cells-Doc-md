...
Please see the following sample code that loads the [sample Excel file](64716829.xlsx) and reads the category axis labels of the chart in the first worksheet. It then prints the values of the axis labels to the console. Refer to the console output of the sample code given below for reference.
