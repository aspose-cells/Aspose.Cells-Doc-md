...
Aspose.Cells provides [**Chart.hasAxis(int axisType, boolean isPrimary)**](https://reference.aspose.com/cells/java/com.aspose.cells/chart#hasAxis-int-boolean-) method to determine if the chart has a particular axis or not.
