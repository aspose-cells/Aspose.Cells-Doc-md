...
type: docs
weight: 360
url: /java/export-document-structure-while-converting-to-pdf/
...
With option [PdfSaveOptions.ExportDocumentStructure](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/#setExportDocumentStructure-boolean-), you can save to a tagged PDF with document structure exported.
