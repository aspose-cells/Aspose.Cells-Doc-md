...
1. SpreadsheetML version 2003 was introduced in Microsoft **Excel** 2003. SpreadsheetML was a significant step by Microsoft towards making the document format open.  
...
3. Microsoft Excel 2010 and later versions store documents in the SpreadsheetML version 2010 as defined in the updated OOXML standard.

## **SpreadsheetML in Aspose.Cells**
There are three "versions" of SpreadsheetML available:

| **SpreadsheetML “Version”** | **Applicable Standard/Specification** | **Supported in Aspose.Cells for Java** |
| :- | :- | :- |
...
| Microsoft Excel 2010 and later versions | OOXML ISO/IEC DIS 29500 | Yes |

OOXML SpreadsheetML documents most often come as XLSX files, which are ZIP packages. **In addition to XLSX,** Aspose.Cells provides extensive support for loading, saving, and converting SpreadsheetML documents. Such an all‑embracing implementation is possible because Aspose.Cells was designed with the structure of Microsoft Excel documents in mind (and SpreadsheetML is known to mimic the internal representation of Microsoft Excel documents).

**An XLSX document generated by Aspose.Cells and opened in Microsoft Excel**  

![todo:image_alt_text](spreadsheetml-xlsx-xml_1.png)

**The XLSX document generated by Aspose.Cells follows the Open Packaging Convention and can be opened in a ZIP‑capable application**  
...
- High‑level functions, such as **importing** data from different data sources including Array, ArrayList, DataTable, DataColumn, DataGrid, DataView, and DataReader, or **exporting** data to fill a DataTable or an Array with just one line of code.  
...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
  ...
  <sheetData>
    ...
    <row r="11" spans="1:7">
      <c r="D11" s="1" t="s"><v>0</v></c>
    </row>
    <row r="15" spans="1:7">
      <c r="G15" s="1" t="s"><v>0</v></c>
    </row>
    <row r="21" spans="2:7">
      <c r="G21" s="1" t="s"><v>0</v></c>
    </row>
    <row r="25" spans="2:7">
      <c r="F25" s="1" t="s"><v>0</v></c>
    </row>
    <row r="31" spans="2:7">
      <c r="B31" s="1" t="s"><v>0</v></c>
    </row>
    <row r="34" spans="6:13">
      <c r="M34" s="1" t="s"><v>0</v></c>
    </row>
    <row r="38" spans="6:13">
      <c r="F38" s="1" t="s"><v>0</v></c>
    </row>
    <row r="117" spans="8:8">
      <c r="H117" s="1" t="s"><v>0</v></c>
    </row>
    <row r="184" spans="8:8">
      <c r="H184" s="1" t="s"><v>0</v></c>
    </row>
  </sheetData>
...
**Our advice:** remember that “open and standard” does not mean simple; use Aspose.Cells.  
