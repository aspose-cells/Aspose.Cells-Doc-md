...
type: docs
weight: 140
url: /java/reading-csv-file-with-multiple-encodings/
...
**Output file 1: no accommodation made for multiple encodings** 

![todo:image_alt_text](reading-csv-file-with-multiple-encodings_2.png)

The following screenshot shows the XLSX file converted from the above CSV file after setting the `TxtLoadOptions.setMultiEncoded()` method to true. As you can see, the Unicode text is now converted properly.
...
{{< highlight java >}}
String filePath = "F:\\Downloads\\MultiEncoded.csv";
