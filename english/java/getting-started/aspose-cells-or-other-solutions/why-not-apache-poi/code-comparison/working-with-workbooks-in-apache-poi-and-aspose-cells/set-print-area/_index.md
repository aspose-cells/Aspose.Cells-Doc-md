...
To select a specific print area, use the [PageSetup](/java/pagesetup) class's setPrintArea method. Assign a cell range that defines the print area to this property.
...
The Workbook.setPrintArea method is available to set the print area.
