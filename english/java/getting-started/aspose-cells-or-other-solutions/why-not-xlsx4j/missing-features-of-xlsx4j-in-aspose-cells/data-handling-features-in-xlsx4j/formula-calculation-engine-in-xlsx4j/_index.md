...
The formula calculation engine is embedded within Aspose.Cells. It can not only recalculate the formulas imported from a designer spreadsheet file, but also supports calculating the results of formulas added at runtime.
