...
type: docs
weight: 60
url: /java/upgrade-to-modern-aspose-cells-component/
---
...
1. **ExcelDesigner** class is replaced by **WorkbookDesigner** class. 
1. **ExcelHelper** class is replaced by **CellsHelper** class. 
