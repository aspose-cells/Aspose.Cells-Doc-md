...
```java
Exception: Please add Java Advanced Imaging (JAI) references to generate TIFF images for Java 8 and older!
```

## Solution
1. Please install JAI for Java 8 and older: [How to install JAI](https://docs.aspose.com/cells/java/installation/#to-tiff-images-by-java-8-and-older)
