...
After you [Purchase](https://purchase.aspose.com/buy) an Aspose.Cells license, you can load it from file, stream, or byte array:
...
For more info about installing/configuring fonts: [Configuring Fonts for Rendering Spreadsheets](/java/configuring-fonts-for-rendering-spreadsheets/).
