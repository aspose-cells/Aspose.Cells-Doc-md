...
type: docs
weight: 30
url: /java/aspose-cells-for-android-via-java-8-9-0-release-notes/
description: Aspose.Cells for Android via Java 8.9.0 Release Notes – the latest enhancements, new features, and fixes.
keywords: Aspose.Cells for Android via Java 8.9.0 Release Notes, Aspose.Cells for Android via Java 8.9.0 updates and fixes
---
...
|CELLSJAVA-41604|Horizontal Grid-Lines of chart are not appearing properly in PDF|Bug |
...
|CELLSJAVA-41878|LightCells APIs only generates events for the first column of the row|Bug |
...
|CELLSJAVA-41852|Text overlapping when worksheet is converted to EMF on Linux|Bug |
...
|CELLSJAVA-40366|Issue with embedded icon - not printing|Bug |
...
|CELLSJAVA-41894|Character spaces problem while rendering spreadsheet to PDF|Bugs|
|CELLSJAVA-41893|Background image is distorted or blurry in the output PDF |Bug |
|CELLSJAVA-41892|Background image is stretched in output PDF |Bug |
...
|CELLSJAVA-40307|Text Overflow check|Bug |
