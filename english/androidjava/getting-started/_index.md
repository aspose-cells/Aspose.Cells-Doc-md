...
This section compares the availability of features between Aspose.Cells for Java and Aspose.Cells for Android via Java.
...
|SpreadsheetML (XLSX, XML)|Aspose.Cells supports OOXML, Flat OPC and also Excel 2003 XML. Moreover, the component supports all major Excel 2007 and later version file formats, e.g., XLSX, XLTX, XLSM, XLTM, etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
| :- | :- | :- |
|Lays out the document into pages with high fidelity to Microsoft Excel® (exactly as Microsoft Excel® would do).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Render worksheet pages to raster images (PNG, JPEG, etc.).|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|Render worksheet pages to raster images (Multipage TIFF, GIF).|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
...
|**Feature**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- |
|Import/export data from an Array, ArrayList, ResultSet etc.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|Supports advanced conditional formatting in Microsoft Excel 2007 and later versions|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|**Feature**|**Aspose.Cells for Java**|**Aspose.Cells for Android via Java**|
| :- | :- | :- |
|Apply all character formatting in the cells including fonts, colors, effects, borders and shading.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
