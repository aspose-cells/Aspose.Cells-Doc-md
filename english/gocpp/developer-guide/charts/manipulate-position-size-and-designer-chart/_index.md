...
The following example explains the usage of the above APIs. It loads the existing workbook that contains a chart in its first worksheet, then it resizes and repositions the chart using Aspose.Cells.
