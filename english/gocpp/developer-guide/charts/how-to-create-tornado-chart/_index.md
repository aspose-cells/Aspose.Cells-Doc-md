...
4. Let's remove the minus sign (‑) from the tornado chart. Select the X‑axis. Go to **Formatting**. In the axis options, click on **Number**. In **Category**, select **Custom**. In **Format Code** write `###0,###0`. Click **Add**.  
   <br>
