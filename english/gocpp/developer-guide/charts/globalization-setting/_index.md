---
title: Convert Chart to Localized Image with Golang via C++
...
type: docs
weight: 50
url: /go-cpp/convert-chart-to-localized-image/
...
When you open an XLSX file containing a chart in Excel with a Spanish regional setting, you can see elements in the chart area—such as the chart title and legend—translated into Spanish. But when you save this chart as a picture with Aspose.Cells, you may encounter the following issue: 
