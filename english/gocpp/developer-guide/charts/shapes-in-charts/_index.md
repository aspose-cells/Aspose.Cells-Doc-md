---
title: Shapes in Charts with Golang via C++
...
Aspose.Cells allows you to add and manipulate labels even in charts.

The [**Aspose::Cells::Drawing::ShapeCollection**](https://reference.aspose.com/cells/go-cpp/shapecollection/) class provides a method named [**AddLabelInChart**](https://reference.aspose.com/cells/go-cpp/shapecollection/addlabelinchart/), used to add a label control to a chart. Below is a list of the parameters used for the method:
...
The method returns an [**Aspose::Cells::Drawing::Label**](https://reference.aspose.com/cells/go-cpp/label/) object. The [**Label**](https://reference.aspose.com/cells/go-cpp/label/) class represents a label in the chart. It has some important members:

- [**Text**](https://reference.aspose.com/cells/go-cpp/shape/gettext/) (property) – specifies a label's caption string.
- [**Fill**](https://reference.aspose.com/cells/go-cpp/shape/getfill/) (property) – specifies the fill color attributes.
...
One way to highlight important information in a report is to use a text box. For example, enter text to highlight the company name or to indicate the geographic region with the highest sales. The [**Aspose::Cells::Drawing::ShapeCollection**](https://reference.aspose.com/cells/go-cpp/shapecollection/) class provides a method named [**AddTextBoxInChart**](https://reference.aspose.com/cells/go-cpp/shapecollection/addtextboxinchart/), which is used to add a text box control to a chart. Below is the parameter list used for the method:
...
The method returns an [**Aspose::Cells::Drawing::TextBox**](https://reference.aspose.com/cells/go-cpp/textbox/) object. The [**TextBox**](https://reference.aspose.com/cells/go-cpp/textbox/) class represents a text box in the chart.
...
The [**Aspose::Cells::Drawing::ShapeCollection**](https://reference.aspose.com/cells/go-cpp/shapecollection/) class provides a method named [**AddPictureInChart**](https://reference.aspose.com/cells/go-cpp/shapecollection/addpictureinchart/), which is used to add a picture object to the chart. Below is the parameter list used for the method:
...
The method returns an [**Aspose::Cells::Drawing::Picture**](https://reference.aspose.com/cells/go-cpp/picture/) object. The [**Picture**](https://reference.aspose.com/cells/go-cpp/picture/) class represents a picture object in the chart.
...
Aspose.Cells allows you to insert checkboxes into a chart sheet by using the [**MsoDrawingType**](https://reference.aspose.com/cells/go-cpp/msodrawingtype/) enumeration. The following example demonstrates adding a checkbox to a chart sheet.
