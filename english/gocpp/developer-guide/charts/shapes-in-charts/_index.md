...
The method returns [**Aspose::Cells::Drawing::Label**](https://reference.aspose.com/cells/go-cpp/label/) object. The [**Label**](https://reference.aspose.com/cells/go-cpp/label/) class represents a label in the chart. It has some important members:
...
The method returns [**Aspose::Cells::Drawing::TextBox**](https://reference.aspose.com/cells/go-cpp/textbox/) object. The [**TextBox**](https://reference.aspose.com/cells/go-cpp/textbox/) class represents a text box in the chart.
...
The [**Aspose::Cells::Drawing::ShapeCollection**](https://reference.aspose.com/cells/go-cpp/shapecollection/) class provides a method named [**AddPictureInChart**](https://reference.aspose.com/cells/go-cpp/shapecollection/addpictureinchart/), which is used to add a picture object to the chart. Following is the parameters list used for the method:
...
Aspose.Cells allows you to insert checkboxes into a chart sheet by using [**MsoDrawingType**](https://reference.aspose.com/cells/go-cpp/msodrawingtype/) enumeration. The following example demonstrates adding a checkbox to a chart sheet.
