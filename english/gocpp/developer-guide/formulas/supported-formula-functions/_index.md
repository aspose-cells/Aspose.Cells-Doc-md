---
title: Supported Excel Functions with Go
linktitle: Supported Excel Functions
type: docs
weight: 10
url: /gocpp/supported-formula-functions/
description: Supported Excel functions for reading, setting, and calculating formulas using Aspose.Cells with Go.
...
|COT|**Math and trigonometry**: Returns the cotangent of a number|
|COTH|**Math and trigonometry**: Returns the hyperbolic cotangent of a number|
...
... *(the rest of the alphabet sections continue in the same format)* ...
