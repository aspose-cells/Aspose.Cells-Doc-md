...
Once it loads the source Excel file with a custom filter, it captures the images of all worksheets one by one. Here are the output images for your reference. As you can see, the first image does not have charts, the second image does not have shapes, and the third image does not have conditional formatting.
