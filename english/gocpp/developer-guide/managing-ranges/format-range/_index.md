---
title: Format Ranges with Golang via C++
linktitle: Format Ranges
type: docs
weight: 105
url: /go-cpp/how-to-format-a-range/
description: Learn how to format ranges in Excel using Aspose.Cells with Golang via C++. Apply styles, fonts, and colors to cell ranges programmatically.
---
...
3. Once the range is selected, right‑click on the selected range and choose **"Format Cells"** from the context menu. Alternatively, you can go to the Home tab in the Excel ribbon, click the **"Format"** dropdown in the **"Cells"** group, and select **"Format Cells"**.
