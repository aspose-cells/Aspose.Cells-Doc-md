...
Before Aspose.Cells 17.1, Aspose.Cells did not render the gradient fill of the WordArt when the Excel file was converted to HTML format. Since the release of Aspose.Cells 17.1, WordArt gradient fill is supported. The following screenshot compares the effect on the gradient fill by converting the Excel file using Aspose.Cells 17.1 and the older version.
