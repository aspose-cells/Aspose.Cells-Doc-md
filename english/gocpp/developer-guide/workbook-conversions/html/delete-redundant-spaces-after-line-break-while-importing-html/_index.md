...
The following sample code shows the usage of the [**HTMLLoadOptions.GetDeleteRedundantSpaces()**](https://reference.aspose.com/cells/go-cpp/htmlloadoptions/getdeleteredundantspaces/) property. Please set it **to true** or **false** to get the output as shown in the above screenshot.
