...
The following sample code saves the [sample Excel file](60489769.xlsx) that contains Office Add-Ins. Please see the [output PDF generated with the previous version, i.e., 17.11](60489770.pdf) and the [output PDF generated with the newer version, i.e., 17.12 and onward](60489771.pdf). The previous‑version PDF is blank, but the newer‑version PDF shows the Office Add‑Ins.
