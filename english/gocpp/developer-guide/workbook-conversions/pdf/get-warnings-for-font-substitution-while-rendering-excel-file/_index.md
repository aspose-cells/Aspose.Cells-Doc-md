---
title: Get Warnings for Font Substitution while Rendering Excel File with Golang via C++
linktitle: Get Warnings for Font Substitution
type: docs
weight: 230
url: /go-cpp/get-warnings-for-font-substitution-while-rendering-excel-file/
description: Learn how to get warnings for font substitution when rendering Excel files to PDF using Aspose.Cells with Golang via C++.
---
