---
title: Draw Slicer while rendering Excel to PDF with Golang via C++
linktitle: Draw Slicer while rendering Excel to PDF
type: docs
weight: 60
url: /go-cpp/draw-slicer-while-rendering-excel-to-pdf/
description: Export Excel to PDF with slicer settings using Aspose.Cells with Golang via C++.
---
...
## **Sample Code**
{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-DrawSlicerWhileRenderingExcelToPdf.go" >}}