...
The following sample code loads the [source XLSM file](23166990.xlsm), reads cell A1, copies its contents to cell C4, and saves it as an [output XLSM file](23166991.xlsm).
