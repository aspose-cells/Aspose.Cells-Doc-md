...
The following sample code loads the [source XLSB file](23166992.xlsb), reads cell A1, copies its contents to cell C4, and saves it as an [output XLSB file](23166993.xlsb).  
