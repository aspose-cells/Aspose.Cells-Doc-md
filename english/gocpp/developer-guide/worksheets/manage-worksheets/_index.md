...
2. Call the [Add](https://reference.aspose.com/cells/go-cpp/worksheetcollection/add_string/) method of the [WorksheetCollection](https://reference.aspose.com/cells/go-cpp/worksheetcollection/) collection. An empty worksheet is added to the Excel file automatically. It can be referenced by passing the sheet index of the new worksheet to the WorksheetCollection.  
3. Obtain a worksheet reference.  
4. Perform work on the worksheets.  
5. Save the new Excel file with new worksheets by calling the [Workbook](https://reference.aspose.com/cells/go-cpp/workbook/) class [Save](https://reference.aspose.com/cells/go-cpp/workbook/save_string/) method.
