...
Aspose.Cells provides the [CellsHelper_CellIndexToName](https://reference.aspose.com/cells/go-cpp/cellshelper/cellshelper_cellindextoname/) method, which allows developers to get a cell's name when they provide the row and column index.
...
Aspose.Cells provides the [CellsHelper_CellNameToIndex](https://reference.aspose.com/cells/go-cpp/cellshelper/cellshelper_cellnametoindex/) method, which allows developers to get the row and column indices from the cell's name.
...
The following sample code illustrates how to use [CellsHelper_CellNameToIndex](https://reference.aspose.com/cells/go-cpp/cellshelper/cellshelper_cellnametoindex/) to get the row and column indices from the cell's name. The code generates the following output.
