---
title: Modify an Existing Style with Golang via C++
...
type: docs
weight: 90
url: /go-cpp/modify-an-existing-style/
---
...
The following examples demonstrate how to use [**Style.Update**](https://reference.aspose.com/cells/go-cpp/style/update/) method.
