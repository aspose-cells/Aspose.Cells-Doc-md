---
title: How to Rotate Text of Cell with Golang via C++
linktitle: How to Rotate Text of Cell
type: docs
weight: 80
url: /go-cpp/how-to-rotate-text-of-cell/
...
[**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/) property makes it convenient to rotate cells. To rotate cells in Aspose.Cells, you need to follow these steps:
