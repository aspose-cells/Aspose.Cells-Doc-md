---
title: Implement 1904 Date System with Golang via C++
linktitle: Implement 1904 Date System
description: Aspose.Cells is a C++ library for working with spreadsheet files. It supports the implementation of the 1904 date system, allowing users to calculate and format based on the January 1, 1904 date system. This article describes how to implement the 1904 date system using the Aspose.Cells library.
keywords: Aspose.Cells, 1904 date system, spreadsheet, calculation, formatting
type: docs
weight: 7000
url: /go-cpp/implement-1904-date-system/
---
