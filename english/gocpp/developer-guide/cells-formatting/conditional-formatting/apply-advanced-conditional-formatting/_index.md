---
title: Apply Advanced Conditional Formatting with Golang via C++
...
type: docs
weight: 70
url: /go-cpp/apply-advanced-conditional-formatting/
---

{{% alert color="primary" %}}

Microsoft Excel 2007 and later versions (2010/2013/2016) provide some advanced features for conditional formatting. For example, it lets you apply cell shading, borders, colored icons, arrows, flags, and font formatting, etc., which have become quite sophisticated.
