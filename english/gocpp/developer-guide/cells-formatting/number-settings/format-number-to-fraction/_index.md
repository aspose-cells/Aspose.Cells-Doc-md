---
title: How to Format Numbers to Fractions with Golang via C++
linktitle: How to Format Numbers to Fractions
type: docs
weight: 10
url: /go-cpp/how-to-format-number-to-fraction/
description: This article introduces how to format numbers as fractions using the Aspose.Cells for C++ API.
keywords: Convert a numeral into a fraction representation, Transform a digit into its fractional equivalent, Change a number into its corresponding fraction form, Format a numeric value into a fraction, Express a number as a fraction, Format Numbers to Fractions
---
...
## **How to Format Numbers to Fractions in Excel**
...
## **How to Format Numbers to Fractions in Aspose.Cells for C++**
...
### Step 4: Apply a Fractional Number Format

To format a cell as a fraction, set its `Style.Number` property to a specific number‑format code. Aspose.Cells supports various fraction formats, such as `"1/2"`, `"1/4"`, `"2/4"`, etc.
