---
title: How to Format Numbers to Time with Golang via C++
linktitle: How to Format Numbers to Time
type: docs
weight: 10
url: /go-cpp/how-to-format-number-to-time/
...
1. **Assuming your time is in cell A1** and is in the format `hhmm` (e.g., `1530`), you can use the following formula to convert it to a time:
   {{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-FormatNumberToTime.go" >}}
   ...
   {{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-FormatNumberToTime-1.go" >}}
