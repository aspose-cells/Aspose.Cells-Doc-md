---
title: How to Format Number to Percentage with Golang via C++
linktitle: How to Format Number to Percentage
type: docs
weight: 10
url: /go-cpp/how-to-format-number-to-percentage/
...
First, ensure you have Aspose.Cells for C++ installed in your project. If you haven't installed it yet, you can obtain it via NuGet. Run the following command in the NuGet Package Manager Console:
...
To format a cell or a range of cells to display numbers as percentages, set the cell's or range's style number format to a percentage format. For a range of cells, you would loop through the range and apply the style to each cell individually.
