...
description: Learn how to change the character spacing of an Excel text box or shape using Aspose.Cells with Golang via C++.
---

{{% alert color="primary" %}}

You can change the character spacing of an Excel text box or shape using the [**TextOptions.GetSpacing()**](https://reference.aspose.com/cells/go-cpp/textoptions/getspacing/) property.
