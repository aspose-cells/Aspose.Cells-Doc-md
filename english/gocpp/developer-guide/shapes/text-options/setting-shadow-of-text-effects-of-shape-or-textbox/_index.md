...
The following code snippet demonstrates the use of [**FontSetting.GetPresetType()**](https://reference.aspose.com/cells/go-cpp/shadoweffect/getpresettype/) to set the shadow of text effects for a Shape or TextBox.  
