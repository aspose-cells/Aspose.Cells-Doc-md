...
The following sample code adds Word Art text with different Built-in Styles. Please check the [output Excel file](5115470.xlsx) generated with this code. This is how the output Excel file looks in Microsoft Excel.
