...
{{% alert color="primary" %}}
The default view of Excel is the A1 style reference, where each column is defined as A, B, C..., and the cells are named A1, B2, C3, and so on.  
...
**Note:** The indexing is zero‑based in Aspose.Cells for C++, but the row index is one‑based in MS Excel.

## **Get Cell Indices using Aspose.Cells**
