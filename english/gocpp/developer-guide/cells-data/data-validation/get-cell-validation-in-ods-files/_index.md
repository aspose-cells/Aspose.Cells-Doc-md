...
The following code sample demonstrates using the [**GetValidation**](https://reference.aspose.com/cells/go-cpp/cell/getvalidation/) method by loading the [source ODS](101089354.ods) file and reading the validation for cell A9.
