---  
title: Excel – R1C1 Reference Style vs. A1 with Golang via C++  
linktitle: Excel – R1C1 Reference Style vs. A1  
type: docs  
weight: 30  
url: /go-cpp/r1c1-reference-style-vs-a1/  
description: R1C1 Reference Style vs. A1 style using Aspose.Cells with Golang via C++.  
...
Any numbers in square brackets refer to relative distance from the current cell. Unlike A1, which refers to columns followed by row numbers, R1C1 does the opposite: rows followed by columns (which does take some getting used to). Positive numbers refer to cells below and/or to the right. Negative numbers refer to cells above and/or to the left.
...
## **Comparison of R1C1 and A1 Reference Styles**  
...
## **How to Use R1C1 and A1 Reference Styles in Excel**  
The following example shows how to calculate the sum of two cell values in each style.  
<br>  
A1 Reference Style:  
<br>  
