...
type: docs
weight: 60
url: /go-cpp/how-to-run-the-examples/
---
...
All examples of Aspose.Cells for Go via C++ are hosted on [GitHub](https://github.com/aspose-cells/aspose.cells-go-cpp-examples/).
...
- Open the solution file in Text editor or IDE and build the project.
...
- Open main.go, all the examples are called from here.
