...
| [XLT](https://docs.fileformat.com/spreadsheet/xlt/) | Excel 97‑2003 Template. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
| [XLAM](https://docs.fileformat.com/spreadsheet/xlam/) | An Excel Macro‑Enabled Add‑In file that adds new functions to Excel. |  | {{< emoticons/tick >}} |
...
| [ODS](https://docs.fileformat.com/spreadsheet/ods/) | ODS (OpenDocument Spreadsheet) format. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| SpreadsheetML | Excel 2003 XML file. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| [Numbers](https://docs.fileformat.com/spreadsheet/numbers/) | The document is created by Apple’s “Numbers” application, which is part of Apple’s iWork suite, a set of applications that run on macOS and iOS. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
| [DBF](https://docs.fileformat.com/database/dbf/) | The .dbf file is a database file used by the dBASE database management system. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
...
| [JPEG](https://docs.fileformat.com/image/jpeg/) | JPEG is an image format that uses lossy compression. |  | {{< emoticons/tick >}} |
...
| [FODS](https://docs.fileformat.com/spreadsheet/fods/) | An Open Document format stored as flat XML. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| [DOCX](https://docs.fileformat.com/word-processing/docx/) | A well‑known format for Microsoft Word documents that combines XML and binary files. |  | {{< emoticons/tick >}} |
...
| [SqlScript](https://docs.fileformat.com/database/sql/) | SQL (Structured Query Language). |  | {{< emoticons/tick >}} |
...
| [Epub](https://docs.fileformat.com/ebook/epub/) | Files with .epub extension are an e‑book format that provides a standard digital publication for publishers and consumers. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| [Xml](https://docs.fileformat.com/web/xml/) | XML (Extensible Markup Language) is similar to HTML but differs in using tags to define objects. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| [Ots](https://docs.fileformat.com/spreadsheet/ots/) | Open Document Template Sheet (OTS) file. | {{< emoticons/tick >}} | {{< emoticons/tick >}} |
| [AZW3](https://docs.fileformat.com/ebook/azw3/) | AZW3 is a digital ebook file format developed by Amazon for its Kindle devices, also known as Kindle Format 8 (KF8). | {{< emoticons/tick >}} | {{< emoticons/tick >}} |