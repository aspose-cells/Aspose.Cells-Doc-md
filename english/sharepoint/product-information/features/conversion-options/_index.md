...
To make the conversion process as flexible as possible, Aspose.Cells for SharePoint allows you to set options that define how the converted file will be treated.
...
If the destination folder already contains files with the same name as the ones you want to convert, you have two options. Select **Overwrite Existing Files** to replace existing files with freshly converted ones. Deselect the option to skip processing files of the same name.
