...
[Installing Aspose.Cells for SharePoint](/cells/sharepoint/installing-aspose-cells-for-sharepoint/) walks you through the installation process. This article explains how the installation process is deployed and activated.
...
1. Installs the feature manifest and other necessary files to the appropriate directories.
...
1. Adds the conversion settings page to the sitemap file.
