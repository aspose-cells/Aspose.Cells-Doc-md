...
- [The benefits of Aspose.Cells for SharePoint](/cells/sharepoint/aspose-cells-for-sharepoint-use-and-benefits/).
...
- Aspose.Cells for SharePoint does not require any prerequisites except those required for creating a SharePoint site.
...
To convert a Microsoft Excel document from your SharePoint document library into other formats, follow the steps below:

1. Click on the desired Microsoft Excel document and then click **Convert with Aspose.Cells for SharePoint**. The Conversion Settings screen is displayed.  

   **Deciding to convert**  

2. Select the output format. Here, you can also change the output file name and the destination folder.  
