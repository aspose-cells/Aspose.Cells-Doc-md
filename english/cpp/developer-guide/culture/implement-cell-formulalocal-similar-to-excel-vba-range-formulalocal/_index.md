...
Microsoft Excel formulas may have different names in different locales, regions, or languages. For example, the **SUM** function is called **SUMME** in German. Aspose.Cells cannot work with non‑English function names. In Microsoft Excel VBA, there is the **Range.FormulaLocal** property that returns the name of the function as per its language or region. Aspose.Cells also provides the [**Cell.FormulaLocal**](https://reference.aspose.com/cells/cpp/aspose.cells/cell/getformulalocal/) property for this purpose. However, this property will only work when you implement the [**GlobalizationSettings.GetLocalFunctionName(string standardName)**](https://reference.aspose.com/cells/cpp/aspose.cells/globalizationsettings/getlocalfunctionname/) method.
