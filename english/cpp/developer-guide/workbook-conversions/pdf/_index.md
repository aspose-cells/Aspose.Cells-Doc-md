---  
title: Convert Excel to PDF with C++  
...
The code snippet below demonstrates how to use the [**PdfSaveOptions**](https://reference.aspose.com/cells/cpp/aspose.cells/pdfsaveoptions/) class to save Excel files to PDF/A‑compliant PDF format.  
...
int main()
{
    ...
    options.SetCreatedTime(Date{ 2025, 1, 1 });
