...
The following sample code saves the [sample Excel file](60489769.xlsx) that contains the Office Add-Ins. Please see the [output PDF generated with the previous version, i.e., 17.11](60489770.pdf) and the [output PDF generated with the newer version, i.e., 17.12 and onward](60489771.pdf). The PDF generated with the previous version is blank, but the PDF generated with the newer version shows the Office Add-In.  
...
int main()
{
    ...
    // Save it to PDF format with the version appended to the output filename
