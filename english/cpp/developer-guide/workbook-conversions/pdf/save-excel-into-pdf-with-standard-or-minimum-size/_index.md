...
By default, Aspose.Cells saves Excel into PDF with Standard size. However, you can also save it with Minimum size using the [PdfSaveOptions.OptimizationType](https://reference.aspose.com/cells/cpp/aspose.cells/pdfsaveoptions/optimizationtype/) property. It accepts the following values:
...
The following sample code shows how you can save Excel into PDF with Standard or Minimum size using [PdfSaveOptions.OptimizationType](https://reference.aspose.com/cells/cpp/aspose.cells/pdfsaveoptions/optimizationtype/) property.
