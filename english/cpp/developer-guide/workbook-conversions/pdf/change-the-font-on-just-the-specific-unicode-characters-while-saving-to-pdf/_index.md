...
However, this is undesirable behavior for some users, and they want only the font of that specific character to be changed instead of changing the font of the entire word or sentence.
