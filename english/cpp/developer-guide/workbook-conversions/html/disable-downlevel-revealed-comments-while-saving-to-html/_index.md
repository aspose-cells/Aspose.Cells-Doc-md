...
Aspose.Cells allows you to eliminate these Downlevel Revealed Comments by setting the [**HtmlSaveOptions.DisableDownlevelRevealedComments**](https://reference.aspose.com/cells/cpp/aspose.cells/htmlsaveoptions/disable_downlevel_revealed_comments/) property to **true**.

## **Disable Downlevel Revealed Comments while saving to HTML**

The following sample code shows the usage of [**HtmlSaveOptions.DisableDownlevelRevealedComments**](https://reference.aspose.com/cells/cpp/aspose.cells/htmlsaveoptions/disable_downlevel_revealed_comments/) property. The screenshot shows the effect of this property when it is not set to true. Please download the [sample Excel file](50528257.xlsx) used in this code and the [output HTML](50528258.zip) generated by it for a reference.
