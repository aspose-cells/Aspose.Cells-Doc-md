...
description: Learn how to set the default font while rendering a spreadsheet to HTML using Aspose.Cells for C++.  
...
Aspose.Cells allows you to set the default font while rendering a spreadsheet to HTML. Please use the [**HtmlSaveOptions.GetDefaultFontName()**](https://reference.aspose.com/cells/cpp/aspose.cells/htmlsaveoptions/getdefaultfontname/) for this purpose. This property is useful when some cells in a spreadsheet have invalid or non‑existing fonts. Thus, those cells will be rendered using the font specified by the [**HtmlSaveOptions.GetDefaultFontName()**](https://reference.aspose.com/cells/cpp/aspose.cells/htmlsaveoptions/getdefaultfontname/) property.  
...
The screenshot shows the effect of setting different default font names via the [**HtmlSaveOptions.GetDefaultFontName()**](https://reference.aspose.com/cells/cpp/aspose.cells/htmlsaveoptions/getdefaultfontname/) property.  
