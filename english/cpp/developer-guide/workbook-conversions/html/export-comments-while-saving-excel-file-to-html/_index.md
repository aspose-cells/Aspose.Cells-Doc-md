--- 
title: Export Comments while Saving Excel files to HTML with C++ 
linktitle: Export Comments while Saving Excel files to HTML 
type: docs 
weight: 40 
...
## **Export Comments while Saving Excel files to HTML**

The following sample code explains the usage of [**HtmlSaveOptions.IsExportComments**](https://reference.aspose.com/cells/cpp/aspose.cells/htmlsaveoptions/isexportcomments/) property. The screenshot shows the effect of the code on the HTML when it is set to **true**. Please download the [sample Excel file](50528260.xlsx) and the [generated HTML](5052826.txt) for reference.
