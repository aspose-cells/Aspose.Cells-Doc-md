...
description: Convert Excel to HTML and MHTML format using Aspere.Cells with C++.
...
MHTML combines normal HTML with external resources (that is, content that is usually linked in, like images, animations, audio, and so on) into one file. It is used for emails with the *.mht* file extension. Aspose.Cells supports reading and writing MHTML files.
...
- [Expanding text from right to left while exporting an Excel file to HTML](/cells/cpp/expanding-text-from-right-to-left-while-exporting-excel-file-to/)
- [Export DataBar, ColorScale, and IconSet Conditional Formatting while converting Excel to HTML](/cells/cpp/export-databar-colorscale-and-iconset-conditional-formatting-while-excel-to-html-conversion/)
...
- [Export similar border style when the original border style is not supported by web browsers](/cells/cpp/export-similar-border-style-when-border-style-is-not-supported-by-web-browsers/)
...
- [Set column width to a scalable unit like em or percent](/cells/cpp/set-column-width-to-scalable-unit-like-em-or-percent/)
- [Set default font while rendering a spreadsheet to HTML](/cells/cpp/set-default-font-while-rendering-spreadsheet-to/)
