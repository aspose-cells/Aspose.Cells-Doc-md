...
- [Provide exported worksheet html file path via IFilePathProvider interface](/cells/cpp/provide-exported-worksheet-html-file-path-via-ifilepathprovider-interface/)
