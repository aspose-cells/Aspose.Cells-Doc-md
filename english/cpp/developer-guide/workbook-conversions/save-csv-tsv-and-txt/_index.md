...
You can modify the same example to save your file to CSV. By default, [**TxtSaveOptions.Separator**](https://reference.aspose.com/cells/cpp/aspose.cells/txtsaveoptions/separator/) is a comma, so do not specify a separator if saving to CSV format.
