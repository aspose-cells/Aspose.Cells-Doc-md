---  
title: Reading CSV File with Multiple Encodings with C++  
linktitle: Reading CSV File with Multiple Encodings  
type: docs  
weight: 200  
url: /cpp/reading-csv-file-with-multiple-encodings/  
...
int main()
{
    ...
    // Create TxtLoadOptions and set the IsMultiEncoded property to true
