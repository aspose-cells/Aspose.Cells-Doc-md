...
The [**CellsHelper.MergeFiles**](https://reference.aspose.com/cells/cpp/aspose.cells/cellshelper/mergefiles/) method only supports merging data, styles, formatting, and formulas. Objects like charts, pictures, comments, or other objects may not be merged using this method. Moreover, a cached file is used to store temporary data for the process.
