...
Aspose.Cells provides a way to detect the file format of encrypted **Office Open XML** files. To identify the file type, use the [FileFormatUtil.DetectFileFormat](https://reference.aspose.com/cells/cpp/aspose.cells/fileformatutil/detectfileformat/) method as shown below in the code example.  
