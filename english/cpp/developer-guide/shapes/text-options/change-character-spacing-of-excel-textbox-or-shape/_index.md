...
You can change the character spacing of Excel textbox or shape using the [**TextOptions.Spacing**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.texts/textoptions/spacing/) property.
