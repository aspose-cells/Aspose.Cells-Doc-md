...
You can convert Smart Art Shape into Group Shape using the [**Shape::GetResultOfSmartArt()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shape/getresultofsmartart/) method. It will enable you to handle the smart art shape like a group shape. Consequently, you will have access to the individual parts of the group shape.
