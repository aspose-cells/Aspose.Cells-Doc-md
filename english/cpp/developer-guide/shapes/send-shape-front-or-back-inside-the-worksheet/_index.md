...
When there are multiple shapes present in the same location, their visibility is determined by their z-order positions. Aspose.Cells provides the [**Shape.ToFrontOrBack()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing/shape/tofrontorback/) method, which changes the z-order position of the shape. If you want to send a shape to the back, you will use a negative number like -1, -2, -3, etc. If you want to bring a shape to the front, you will use a positive number like 1, 2, 3, etc.
