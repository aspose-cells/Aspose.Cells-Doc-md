...
## **Changing Heading and Body Fonts Programmatically**

With Aspose.Cells for C++, we can check whether the default font is a theme font or set the theme font using the [**Font.GetSchemeType()**](https://reference.aspose.com/cells/cpp/aspose.cells/font/getschemetype/) property.
...
## **Dynamically Getting Local Theme Font Programmatically**
...
We must set the system regional settings before loading the file using the [**LoadOptions.GetRegion()**](https://reference.aspose.com/cells/cpp/aspose.cells/loadoptions/getregion/) property.
