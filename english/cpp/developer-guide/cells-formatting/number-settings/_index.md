...
description: Aspose.Cells is a C++ library for working with spreadsheet files that supports many different cell number settings. This article introduces how to use the Aspose.Cells library to manage the number settings of cells so that users can adjust the number format in the spreadsheet as needed.
...
On the left side of the dialog, there are many categories of values such as **General**, **Number**, **Currency**, **Accounting**, **Date**, **Time**, **Percentage**, etc. Aspose.Cells supports all of these display formats.
