...
description: This article introduces how to format numbers as dates using the Aspose.Cells for C++ API.  
...
To format numbers as dates in the Aspose.Cells for C++ library, you can apply date formatting to cells programmatically. Here's how you can do it using C++ with Aspose.Cells:  
