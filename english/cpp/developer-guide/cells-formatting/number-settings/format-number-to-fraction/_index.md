---
title: How to Format a Number as a Fraction with C++
linktitle: How to Format Number to Fraction
type: docs
weight: 10
url: /cpp/how-to-format-number-to-fraction/
description: This article will introduce how to format numbers as fractions using Aspose.Cells for C++ API.
...
## **How to Format a Number as a Fraction in Excel**
...
## **How to Format a Number as a Fraction in Aspose.Cells for C++**
