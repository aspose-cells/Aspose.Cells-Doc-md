...
description: Change the number decimal and group separators in MS Excel using C++ code with the Aspose.Cells for C++ API.  
...
The following sample code illustrates how to specify custom separators using the Aspose.Cells API. It sets the custom number decimal and group separators to a dot and a space, respectively.  
