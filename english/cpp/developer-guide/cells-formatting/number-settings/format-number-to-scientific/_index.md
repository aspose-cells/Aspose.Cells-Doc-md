---
title: How to Format Number to Scientific with C++
linktitle: How to Format Number to Scientific
type: docs
weight: 10
url: /cpp/how-to-format-number-to-scientific/
description: This article introduces how to format a number to scientific notation using the Aspose.Cells for C++ API.
...
3. **Choose More Number Formats**: Click the dropdown, and at the bottom select **More Number Formats...**. This will open the **Format Cells** dialog directly to the **Number** tab.
...
Access the worksheet where you want to format numbers to scientific notation. If you’re working with a new workbook, you’ll likely be using the first worksheet.

### Step 4: Format the Cell to Scientific Notation

To format a cell to display its number in scientific notation, set its custom format.

### Step 5: Save the Workbook

After formatting the cells as needed, don’t forget to save your workbook. This will write the workbook with the cells formatted in scientific notation as specified.
...
int main()
{
    ...
    cell.PutValue(12345.6789); // Set the value as a number
...
By following these steps, you can format numbers to scientific notation in Aspose.Cells for C++. Remember, you can customize the format string (`"0.00E+00"`) as needed to adjust the number of decimal places or other aspects of the scientific notation display.{{< app/cells/assistant language="cpp" >}}
