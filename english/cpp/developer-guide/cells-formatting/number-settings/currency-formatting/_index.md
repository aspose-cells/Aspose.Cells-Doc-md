...
description: This article introduces how to format numbers as currency using the Aspose.Cells for C++ API.
...
4. **Improves Readability**: Currency formatting adds commas as thousands separators and decimal places, making large numbers easier to read. For example, 1,000,000 becomes $1,000,000.00, which is more legible and easier to understand at a glance.  
...
## **How to Format Numbers as Currency in Aspose.Cells**
