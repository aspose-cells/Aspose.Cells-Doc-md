---
title: List of Supported Number Formats with C++
...
type: docs
weight: 30
url: /cpp/list-of-supported-number-formats/
ai_search_scope: cells_cpp
ai_search_endpoint: "https://docsearch.api.aspose.cloud/ask"
---

## **Aspose.Cells**
Aspose.Cells component offers some built-in number formats to configure the display formats of numbers and dates. These built-in number formats can be applied by using the **Number** property of the [**Style**](https://reference.aspose.com/cells/cpp/aspose.cells/style/) object. All built-in number formats are given unique numeric values. Developers can assign any desired numeric value to the *Number* property of the [**Style**](https://reference.aspose.com/cells/cpp/aspose.cells/style/) object and hence the display format is applied. This approach is faster. The built-in number formats supported by the Aspose.Cells component are given below:
