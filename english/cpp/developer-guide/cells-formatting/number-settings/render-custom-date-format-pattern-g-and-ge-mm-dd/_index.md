---
title: Render Custom Date Format Patterns g and ge.mm.dd with C++
...
Aspose.Cells is now able to render custom date format patterns such as **g** and **ge.mm.dd**. Please check the attached [source Excel file](5112361.xlsx) and the [converted PDF](5112360.pdf) produced by Aspose.Cells for your reference.

{{% /alert %}}

The following sample code converts the [source Excel file](5112361.xlsx), which contains date values with custom format patterns like **g** and **ge.mm.dd**, into the [output PDF](5112360.pdf).
