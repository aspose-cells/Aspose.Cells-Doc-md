---
title: How to Rotate Text of a Cell with C++
linktitle: How to Rotate Text of a Cell
type: docs
weight: 80
url: /cpp/how-to-rotate-text-of-cell/
description: C++ code to rotate text of a cell with Aspose.Cells for C++ API
...
## **Rotate Text of a Cell in Aspose.Cells**
...
## **How to Rotate Text of a Cell in Excel**
...
## **How to Rotate Text of a Cell using Aspose.Cells API**
...
2. **Access the Worksheet**  
   Once the workbook is loaded, you need to access the worksheet where you want to rotate the cells. You can either access the worksheet by its index or by name.  

3. **Rotate the text of a cell**  
