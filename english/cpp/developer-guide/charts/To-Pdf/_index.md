...
In order to render the chart to PDF format, the Aspose.Cells APIs have exposed the [**Chart::ToPdf**](https://reference.aspose.com/cells/cpp/aspose.cells.charts/chart/topdf/) method with the ability to store the resultant PDF on a disk path or stream.
