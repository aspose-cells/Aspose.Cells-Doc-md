...
We often use colors rather than black and white to indicate increasing and decreasing prices. In the first set of candlesticks below, red indicates an increase and green indicates a decrease.
