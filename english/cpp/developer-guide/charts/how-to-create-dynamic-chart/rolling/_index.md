...
In the next paragraphs, we will show you how to create a Dynamic Rolling Chart using Aspose.Cells. We'll show you the code for the example, as well as the Excel file created by this code.
...
You can try changing the number `-5` to `-10` in the formula, and the dynamic chart will count the latest 10 sets of data. Now we have successfully created a dynamic rolling chart using Aspose.Cells.
