...
The following code snippet demonstrates the use of the [**GetRegexKey()**](https://reference.aspose.com/cells/cpp/aspose.cells/replaceoptions/getregexkey/) property with the sample Excel file (`101089318.xlsx`). The [output file](101089319.xlsx) generated by the code snippet is attached for reference.
