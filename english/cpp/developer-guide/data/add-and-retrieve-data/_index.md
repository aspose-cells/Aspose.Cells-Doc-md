...
Aspose.Cells allows developers to add data to the cells in worksheets by calling the [Cell](https://reference.aspose.com/cells/cpp/aspose.cells/cell/) class **PutValue** method. Aspose.Cells provides overloaded versions of the **PutValue** method that **let** developers add different kinds of data to cells. Using these overloaded versions of the **PutValue** method, it is possible to add a Boolean, string, double, integer, or date/time value to the cell.
