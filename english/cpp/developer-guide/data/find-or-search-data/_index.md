...
## **Find or Search Data**
You can use Aspose.Cells to find or search data in various ways using the following methods.
...
{{< highlight java >}}
Name of the cell containing the formula =SUM(A5:A10): C6
Name of the cell containing the formula that contains "CHA": C7
Name of the cell containing the number 80: A8
Name of the cell containing a specified string: C8
Name of the cell containing the string that contains "Two": C9
Name of the cell containing a specified string: C10
Name of the cell containing a specified string: C11
{{< /highlight >}}
