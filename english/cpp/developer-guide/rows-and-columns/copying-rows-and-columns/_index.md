...
Use this method to copy a row within a sheet, or to another sheet. The `CopyRow` method works in a similar way to Microsoft Excel, so you don't need to set the height of the destination row explicitly; that value is copied too.
...
{{% alert color="primary" %}}  
When copying rows, it is important to note related images, charts, or other drawing objects, as this is the same as in Microsoft Excel:
