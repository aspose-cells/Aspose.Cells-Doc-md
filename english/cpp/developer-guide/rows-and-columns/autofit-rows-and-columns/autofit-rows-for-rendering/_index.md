...
If you want to prevent text **from** being clipped in the saved PDF file, you can autofit the row with the [AutoFitterOptions.GetForRendering()](https://reference.aspose.com/cells/cpp/aspose.cells/autofitteroptions/getforrendering/) option.
