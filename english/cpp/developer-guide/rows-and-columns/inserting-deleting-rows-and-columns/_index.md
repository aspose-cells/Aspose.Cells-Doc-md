...
Aspose.Cells provides a class, [Workbook](https://reference2.aspose.com/cells/cpp/aspose.cells/workbook/), that represents a Microsoft Excel file. The [Workbook](https://reference2.aspose.com/cells/cpp/aspose.cells/workbook/) class contains an [Worksheets](https://reference.aspose.com/cells/cpp/aspose.cells/worksheetcollection/) collection that allows access to each worksheet in an Excel file. A worksheet is represented by the [Worksheet](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/) class. The [Worksheet](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/) class provides an [Cells](https://reference2.aspose.com/cells/cpp/aspose.cells/cells/) collection that represents all cells in the worksheet.

The [Cells](https://reference2.aspose.com/cells/cpp/aspose.cells/cells/) collection provides several methods managing rows and columns in a worksheet. Some of these are discussed below.
...
To insert multiple rows into a worksheet, call the [InsertRows](https://reference.aspose.com/cells/cpp/aspose.cells/cells/insertrows/) method of the [Cells](https://reference2.aspose.com/cells/cpp/aspose.cells/cells/) collection. The [InsertRows](https://reference.aspose.com/cells/cpp/aspose.cells/cells/insertrows/) method takes two parameters:
...
To delete multiple rows from a worksheet, call the [DeleteRows](https://reference.aspose.com/cells/cpp/aspose.cells/cells/deleterows/) method of the [Cells](https://reference2.aspose.com/cells/cpp/aspose.cells/cells/) collection. The [DeleteRows](https://reference.aspose.com/cells/cpp/aspose.cells/cells/deleterows/) method takes two parameters:
