...
description: This article shows how to disable the compatibility checker through the Aspose.Cells for C++ API.  
...
Microsoft Excel's Compatibility Checker flags that when saving a file in an earlier file format, it might cause functionality issues or loss of fidelity. The Compatibility Checker is a feature of Microsoft Office Excel 2007 and Microsoft Excel 2010.  
...
Set the [**Workbook.GetCheckCompatibility()**](https://reference.aspose.com/cells/cpp/aspose.cells/workbooksettings/getcheckcompatibility/) property to **False** to disable Microsoft Excel's Compatibility Checker.  
