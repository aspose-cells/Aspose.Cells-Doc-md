...
Similarly, if there is some simple HTML, Aspose.Cells can convert it into HTML Rich Text. Aspose.Cells provides the [**Cell::GetHtmlString**](https://reference.aspose.com/cells/cpp/aspose.cells/cell/gethtmlstring/) method, which takes such simple HTML and converts it to formatted cell text.

{{% /alert %}}

The code sample below shows how to add HTML rich text inside the cell. Please see the screenshot of the resulting Excel file.
