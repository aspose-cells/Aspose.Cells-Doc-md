...
Aspose.Cells supports showing bullets with HTML code. This article will explain how to display bullets by setting a cell value using HTML. We will use [**Cell.GetHtmlString()**](https://reference.aspose.com/cells/cpp/aspose.cells/cell/gethtmlstring/) **method** to set the cell value with our HTML.  
