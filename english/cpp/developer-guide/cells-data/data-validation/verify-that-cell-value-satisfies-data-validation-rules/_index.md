...
description: Learn how to verify cell values against data validation rules using the Aspose.Cells for C++ API.
...
## **Introduction**
Aspose.Cells provides the [Cell.GetValidationValue()](https://reference.aspose.com/cells/cpp/aspose.cells/cell/getvalidationvalue/) method to validate cell values programmatically. If the value in a cell does not satisfy the data validation rule applied to that cell, it returns **False**, otherwise **True**.
...
int main()
{
    ...
    // It can take only values between 10 and 20
    Cell cell = worksheet.GetCells().Get(u"C1");

    // Enter 3 into this cell
    ...
    // Enter 15 into this cell
    // Since it is between 10 and 20, it should pass the validation
    cell.PutValue(15);

    // Check if number 15 satisfies the Data Validation rule applied on this cell
    std::cout << "Is 15 a Valid Value for this Cell: " << cell.GetValidationValue() << std::endl;

    // Enter 30 into this cell
