...
description: Learn How and Where to Use Enumerators through the Aspose.Cells for C++ API.
...
2. [**Row.GetEnumerator**](https://reference.aspose.com/cells/cpp/aspose.cells/row/getenumerator/)  
3. [**Range.GetEnumerator**](https://reference.aspose.com/cells/cpp/aspose.cells/range/getenumerator/)
...
The following code example demonstrates the implementation of the IEnumerator interface for the Cells collection.
...
3. Only initialized cells, rows, or columns should be traversed.  
