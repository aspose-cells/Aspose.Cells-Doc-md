...
1. APIs such as [**MaxRow**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/maxrow/), [**MaxDataRow**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/maxdatarow/), [**MaxColumn**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/maxcolumn/), [**MaxDataColumn**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/maxdatacolumn/) & [**MaxDisplayRange**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/maxdisplayrange/) require extra time to gather the corresponding statistics. In case the data matrix (rows x columns) is large, using these APIs could impose a performance penalty.
