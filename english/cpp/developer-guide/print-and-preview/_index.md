...
The [**Aspose.Cells.Rendering.SheetRender**](https://reference.aspose.com/cells/cpp/aspose.cells.rendering/sheetrender/) class represents a worksheet and has the [**ToPrinter**](https://reference.aspose.com/cells/cpp/aspose.cells.rendering/sheetrender/toprinter/) method which can print a worksheet. The following sample code shows how to print a worksheet.
...
int main()
{
    ...
    while (printerName.empty())
    {
        std::cout << "Please Enter Your Printer Name:" << std::endl;
    ...
    std::cout << "Printing SampleBook.xlsx" << std::endl;

    try
    {
        sr.ToPrinter(U16String(printerName.c_str()));
...
To print a whole workbook, iterate through the sheets and print them, or use the [**WorkbookRender**](https://reference.aspose.com/cells/cpp/aspose.cells.rendering/workbookrender/) class.
...
int main()
{
    ...
    Workbook workbook(srcDir + u"samplePrintingUsingWorkbookRender.xlsx");

    // Printer name
    U16String printerName(u"doPDF 8");

    // Apply different Image/Print options.
    ImageOrPrintOptions options;
    options.SetImageType(Aspose::Cells::Drawing::ImageType::Tiff);
    options.SetPrintingPage(PrintingPageType::Default);

    // To print a whole workbook, iterate through the sheets and print them, or use the WorkbookRender class.
    WorkbookRender wr(workbook, options);
...
Aspose.Cells also provides overloads for the [**WorkbookRender.ToPrinter()**](https://reference.aspose.com/cells/cpp/aspose.cells.rendering.workbookrender/toprinter/) and [**SheetRender.ToPrinter()**](https://reference.aspose.com/cells/cpp/aspose.cells.rendering.sheetrender/toprinter/) methods, so it's possible to set the print job name while printing Excel spreadsheets. By default, all print jobs are created with the name "Document".
