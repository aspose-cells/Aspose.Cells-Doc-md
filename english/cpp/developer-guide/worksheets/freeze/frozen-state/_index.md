...
Please use the [**Worksheet::PaneState**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/panestate/) property to check the state of window panes and get locked rows and columns with the [**Worksheet::GetFreezedPanes**](https://reference.aspose.com/cells/cpp/aspose.cells/worksheet/getfreezedpanes/) method. 
