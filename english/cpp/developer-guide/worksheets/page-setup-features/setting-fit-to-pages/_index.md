...
description: This article shows you code explaining how to set FitToPagesWide and FitToPagesTall using the Aspose.Cells library with C++.  
...
## **How to Print All Columns of a Worksheet in One Page Using Aspose.Cells**  

To print all columns of a worksheet on one page: first, load the [sample file](sample.xlsx), and then set the [**PdfSaveOptions.GetAllColumnsInOnePagePerSheet()**](https://reference.aspose.com/cells/cpp/aspose.cells/paginatedsaveoptions/getallcolumnsinonepagepersheet/) property of the [**PdfSaveOptions**](https://reference.aspose.com/cells/cpp/aspose.cells/pdfsaveoptions/) object. Here is an example in C++:  
