...
description: Learn how to remove existing PrinterSettings of a worksheet inside the Excel file through the Page Setup object programmatically using Aspose.Cells with C++.
...
int main()
{
    ...
    for (int i = 0; i < sheetCount; i++)
    {
        ...
        if (ps.GetPrinterSettings().GetLength() != 0)
        {
            ...
            std::cout << "Printer settings of this worksheet are now removed by setting it to null." << std::endl;
            std::cout << std::endl;
        }
    }
