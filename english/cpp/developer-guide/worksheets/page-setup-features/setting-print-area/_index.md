---
title: How to Set Print Area with C++
...
4. Adding to the Print Area: If you want to add more cells to the existing print area, select the additional cells, go to “Print Area” in the “Page Layout” tab, and choose “Add to Print Area”.  
...
## **How to Clear the Print Area Using Aspose.Cells**
