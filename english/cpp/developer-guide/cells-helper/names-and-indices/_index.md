...
The following sample code illustrates how to use [CellsHelper::CellIndexToName](https://reference.aspose.com/cells/cpp/aspose.cells/cellshelper/cellindextoname/) to access a cell's name given a known row and column index. The code generates the following output.  
...
Aspose.Cells provides the [CellsHelper::CellNameToIndex](https://reference.aspose.com/cells/cpp/aspose.cells/cellshelper/cellnametoindex/) method which allows developers to get the row and column indices from the cell's name.  
...
The following sample code illustrates how to use [CellsHelper::CellNameToIndex](https://reference.aspose.com/cells/cpp/aspose.cells/cellshelper/cellnametoindex/) to get the row and column indices from the cell's name. The code generates the following output.  
