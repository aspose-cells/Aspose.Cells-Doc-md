...
type: docs
weight: 200
url: /zh/cpp/how-to-set-print-area/
description: 本文演示如何使用 C++ 的 Aspose.Cells 库设置打印区域的代码。
keywords: 限制打印范围、设置打印范围、清除打印范围、使用 C++ 设置和清除打印范围、如何在 C++ 中设置打印区域、在 C++ 中设置和清除打印区域、在 C++ 中清除打印区域、使用 C++ 添加打印区域、使用 C++ 移除打印区域、如何在 Excel 中设置打印区域、如何在 Excel 中清除打印区域。
---
...
要在指定工作表中设置打印区域：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的[**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)对象的[**Worksheet.GetPrintArea()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprintarea/)属性。将该属性设为一个范围字符串，即可设置打印区域。
...
要在指定工作表中清除打印区域：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的[**PageSetup**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/)对象的[**Worksheet.GetPrintArea()**](https://reference.aspose.com/cells/cpp/aspose.cells/pagesetup/getprintarea/)属性。将该属性设置为空字符串，即可清除打印区域。
