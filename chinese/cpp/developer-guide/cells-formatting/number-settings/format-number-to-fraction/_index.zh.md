---
title: 如何用C++将数字格式化为分数
linktitle: 如何将数字格式化为分数
type: docs
weight: 10
url: /zh/cpp/how-to-format-number-to-fraction/
...
首先，确保你的项目中已经安装了Aspose.Cells for C++。你可以从 [Aspose.Cells for C++](https://www.aspose.com/products/cells/cpp) 官网下载该库。
