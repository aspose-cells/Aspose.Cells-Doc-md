...
应用程序通常需要能够打开不同版本中创建的 Microsoft Excel 文件，例如 Microsoft Excel 95、97 或 Microsoft Excel 2007/2010/2013/2016/2019 和 Office 365。 您可能需要以多种格式之一加载文件，包括 XLS、XLSX、XLSM、XLSB、SpreadsheetML、TabDelimited 或 TSV、CSV、ODS 等。 使用构造函数，或者指定 **[Workbook](https://reference.aspose.com/cells/cpp/aspose.cells/workbook/)**  类的 **[SetFileFormat](https://reference.aspose.com/cells/cpp/aspose.cells/workbook/setfileformat/)**  方法使用 **[FileFormatType](https://reference.aspose.com/cells/cpp/aspose.cells/fileformattype/)**  枚举来指定格式。

**[FileFormatType](https://reference.aspose.com/cells/cpp/aspose.cells/fileformattype/)**  枚举包含许多预定义的文件格式，以下是其中一些。
...
要打开Microsoft Excel 95/5.0文件，请使用**[LoadOptions](https://reference.aspose.com/cells/cpp/aspose.cells/loadoptions/)**并为要加载的模板文件设置**LoadOptions**类的相关属性。可以从以下链接下载用于测试此功能的示例文件:
...
要打开Microsoft Excel 97-2003文件，请使用**[LoadOptions](https://reference.aspose.com/cells/cpp/aspose.cells/loadoptions/)**并为要加载的模板文件设置**LoadOptions**类的相关属性。
...
要打开Microsoft Excel 2007/2010/2013/2016/2019和Office 365格式，即XLSX或XLSB，指定文件路径。还可以使用**[LoadOptions](https://reference.aspose.com/cells/cpp/aspose.cells/loadoptions/)**并设置**LoadOptions**类的相关属性/选项以加载模板文件。
