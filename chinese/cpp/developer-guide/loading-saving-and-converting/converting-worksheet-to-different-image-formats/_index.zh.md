...
`Aspose.Cells.Rendering.ISheetRender` 类表示渲染为图像的工作表。它有一个重载方法，[印象](https://reference.aspose.com/cells/cpp/aspose.cells.rendering/sheetrender/toimage/)，可以将工作表转换为具有不同属性或选项的图像文件。支持多种图像格式，例如BMP、PNG、GIF、JPG、JPEG、TIFF、EMF。
...
###  **TIFF 格式**
请看下面的示例代码，其[Excel 文件示例](67338402.xlsx)，以及[输出 TIFF 图像](67338419.zip).
