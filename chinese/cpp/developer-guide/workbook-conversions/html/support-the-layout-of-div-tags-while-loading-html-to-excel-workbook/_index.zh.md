---
title: 支持在加载HTML到Excel工作簿时保持DIV标签布局
linktitle: 支持DIV标签布局
type: docs
weight: 50
url: /zh/cpp/support-the-layout-of-div-tags-while-loading-html-to-excel-workbook/
description: 学习在将HTML加载到Excel工作簿时支持DIV标签布局的方法，使用Aspose.Cells for C++。
---

{{% alert color="primary" %}} 

通常，在将HTML加载到Excel工作簿对象时会忽略DIV标签的布局。但是，如果你希望保留DIV标签的布局，可以将[GetSupportDivTag()](https://reference.aspose.com/cells/cpp/aspose.cells/htmlloadoptions/ Getsupportdivtag/)属性设置为**true**。该属性的默认值为**false**。

{{% /alert %}} 

以下示例代码演示了[GetSupportDivTag()](https://reference.aspose.com/cells/cpp/aspose.cells/htmlloadoptions/getsupportdivtag/)属性的使用。请下载输入HTML中使用的[徽标](5115218.png)和由代码生成的[输出Excel文件](5115220.xlsx)。
