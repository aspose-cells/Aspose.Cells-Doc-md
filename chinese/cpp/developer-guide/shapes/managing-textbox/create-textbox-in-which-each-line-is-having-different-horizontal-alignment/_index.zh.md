---
title: 用 C++ 创建每行拥有不同水平对齐方式的文本框
linktitle: 创建具有不同水平对齐方式的文本框
type: docs
weight: 310
url: /zh/cpp/create-textbox-in-which-each-line-is-having-different-horizontal-alignment/
description: 学习如何用 Aspose.Cells 和 C++ 创建每行具有不同横向对齐方式的文本框。
---

{{% alert color="primary" %}}

您可以使用[**TextParagraph.GetAlignmentType()**](https://reference.aspose.com/cells/cpp/aspose.cells.drawing.texts/textparagraph/getalignmenttype/)属性来设置段落文本的水平对齐方式。
