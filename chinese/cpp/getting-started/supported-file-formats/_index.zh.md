...
|[XLSX](https://docs.fileformat.com/spreadsheet/xlsx/)|Office Open XML SpreadsheetML 工作簿或模板文件，带或不带宏。|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[XLTM](https://docs.fileformat.com/spreadsheet/xltm/)|Excel 宏启用模板。|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLAM](https://docs.fileformat.com/spreadsheet/xlam/)|启用宏的 Excel 加载项文件，用于向 Excel 添加新函数。| |{{< emoticons/tick >}}|
...
|[Numbers](https://docs.fileformat.com/spreadsheet/numbers/)|该文档由 Apple 的“Numbers”应用程序创建，该应用程序是 Apple iWork 办公套件的一部分，是一组在 Mac OS X 和 iOS 操作系统上运行的应用程序。|{{< emoticons/tick >}}||
