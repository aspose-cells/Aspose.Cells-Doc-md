...
description: 如何为C++ 安装Aspose Cells 并创建一个Hello World 应用程序。
---
{{% alert color="primary" %}} 

本页将向您展示如何为 C++ 安装 Aspose Cells 并创建 Hello World 应用程序。
...
### **安装 Aspose Cells 到 NuGet**
 ...
 NuGet 是为 C++ 下载和安装 Aspose.Cells 的最简单方法。
1. 为 C++ 创建一个 Microsoft Visual Studio 项目。
2. 包含头文件“Aspose.Cells.h”。
3. 打开 Microsoft Visual Studio 和 NuGet 包管理器。
 4.搜索“aspose.cells.cpp”找到C++需要的Aspose.Cells。
5. 点击“安装”，C++ 的Aspose.Cells 将被下载并引用到你的项目中。

**![通过 NuGet 安装 Aspose Cells](InstallThroughNuget.png)**

也可以从aspose.cells的nuget网页下载：
[Aspose.Cells 为 C++ NuGet 包](https://www.nuget.org/packages/Aspose.Cells.Cpp/)

[详细步骤更多](/cells/zh/cpp/installation/)

### **在 Windows 上将 Aspose.Cells 用于 C++ 的演示**

1. 从以下页面为 C++ 下载 Aspose.Cells：
[下载 Aspose.Cells 为 C++(Windows)](https://downloads.aspose.com/cells/cpp/)
2.解压压缩包，你会发现一个Demo，是C++如何使用Aspose.Cells。
3.用Visual Studio 2017或更高版本打开Demo.sln
4. main.cpp：这个文件展示了如何编写代码来测试 C++ 的 C++
 5. sourceFile/resultFile：这两个文件夹是main.cpp中使用的存放目录

### **如何在 Linux 操作系统上将 Aspose.Cells 用于 C++**
