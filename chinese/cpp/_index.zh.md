...
url: /zh/cpp/
is_root: true
description: Aspose.Cells for C++ 是一款原生 C++ 库，可使 C++ 开发人员能够在不需要办公自动化或 Microsoft Excel 应用程序的情况下编程创建、操纵和转换电子表格。
keywords: Aspose.Cells for C++ 创建、修复、修改、解析、合并、转换 JSON Excel XML PDF HTML TSV SQL TXT PNG JPEG 等更多格式。
---

{{% alert color="primary" %}}

**![Aspose.Cells for C++ 产品标识](home_1.png)**
