...
type: docs
weight: 20
url: /zh/go-cpp/cells-alignment-settings/
---
...
使用[**TextAlignmentType**](https://reference.aspose.com/cells/go-cpp/textalignmenttype/)枚举选择任何文本对齐类型。[**TextAlignmentType**](https://reference.aspose.com/cells/go-cpp/textalignmenttype/)枚举中预定义的文本对齐类型包括：
...
您还可以使用[**Style.IsJustifyDistributed**](https://reference.aspose.com/cells/go-cpp/style/isjustifydistributed/)属性应用两端对齐分布设置。

{{% /alert %}}

#### **水平对齐**

使用[**Style**](https://reference.aspose.com/cells/go-cpp/style/)对象的[**GetHorizontalAlignment()**](https://reference.aspose.com/cells/go-cpp/style/gethorizontalalignment/)属性使文本水平对齐。

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-AlignmentSettings.go" >}}
#### **垂直对齐**

与水平对齐类似，使用 [**Style**](https://reference.aspose.com/cells/go-cpp/style/) 对象的 [**GetVerticalAlignment()**](https://reference.aspose.com/cells/go-cpp/style/getverticalalignment/) 属性来垂直对齐文本。

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-AlignmentSettings-1.go" >}}
#### **缩进**

可以使用 [**Style**](https://reference.aspose.com/cells/go-cpp/style/) 对象的 [**GetIndentLevel()**](https://reference.aspose.com/cells/go-cpp/style/getindentlevel/) 属性来设置单元格中文本的缩进级别。

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-AlignmentSettings-2.go" >}}
#### **方向**

使用 [**Style**](https://reference.aspose.com/cells/go-cpp/style/) 对象的 [**GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/) 属性来设置单元格中文本的方向（旋转）。
...
在单元格中设置文本换行可使其更易读：单元格的高度会根据文本内容自动调整，而不会被截断或溢出到相邻单元格。可以使用 [**Style**](https://reference.aspose.com/cells/go-cpp/style/) 对象的 [**IsTextWrapped**](https://reference.aspose.com/cells/go-cpp/style/istextwrapped/) 属性来设置文本换行开或关闭。

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-AlignmentSettings-4.go" >}}
##### **缩小以适应**

在单元格中设置文本字段换行的选项是缩小文本大小以适应单元格尺寸，可以通过将 [**Style**](https://reference.aspose.com/cells/go-cpp/style/) 对象的 [**IsTextWrapped**](https://reference.aspose.com/cells/go-cpp/style/istextwrapped/) 属性设置为 **true** 来实现。

{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-AlignmentSettings-5.go" >}}
##### **合并单元格**

与 Microsoft Excel 一样，Aspose.Cells 支持将多个单元格合并为一个。Aspose.Cells 提供两种方法来完成此任务。一种方法是调用 [**GetCells()**](https://reference.aspose.com/cells/go-cpp/worksheet/getcells/) 集合的 [**Merge**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/merge/) 方法。[**Merge**](https://reference.aspose.com/cells/cpp/aspose.cells/cells/merge/) 方法接受以下参数来合并单元格：
