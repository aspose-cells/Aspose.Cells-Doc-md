---
title: 通过 C++ 在 Golang 中为 Excel 和 ODS 文件设置条件格式
linktitle: 条件格式
type: docs
weight: 60
url: /zh/go-cpp/conditional-formatting/
...
Aspose.Cells允许开发人员通过调用[**Range.Copy()**](https://reference.aspose.com/cells/go-cpp/range/copy_range_pasteoptions/)方法将一个单元格的条件格式设置复制到工作表中的另一个单元格。
