---
title: 如何通过C++使用Golang旋转单元格文本
linktitle: 如何旋转单元格文本
type: docs
weight: 80
url: /zh/go-cpp/how-to-rotate-text-of-cell/
...
[**Style.GetRotationAngle()**](https://reference.aspose.com/cells/go-cpp/style/getrotationangle/)属性使旋转单元格更加方便。要在Aspose.Cells中旋转单元格，您需要按照以下步骤操作：
1. 加载Excel工作簿
<br>
