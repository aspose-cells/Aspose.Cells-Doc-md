...
type: docs
weight: 90
url: /zh/go-cpp/modify-an-existing-style/
---
...
以下示例演示了如何使用[**Style.Update**](https://reference.aspose.com/cells/go-cpp/style/update/)方法。

### **创建和修改样式**

此示例创建一个[**Style**](https://reference.aspose.com/cells/go-cpp/style/)对象，将其应用于一范围的单元格，并修改[**Style**](https://reference.aspose.com/cells/go-cpp/style/)对象。所做的更改会自动应用到单元格及其所在范围的样式。
