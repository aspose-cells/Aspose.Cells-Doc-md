---
title: 在用Golang via C++对数据进行排序时指定排序警告
linktitle: 在排序数据时指定排序警告
type: docs
weight: 140
url: /zh/go-cpp/specifying-sort-warning-while-sorting-data/
...
下面的示例代码说明了如何使用前面解释的[**DataSorter.GetSortAsNumber()**](https://reference.aspose.com/cells/go-cpp/datasorter/getsortasnumber/)属性。有关更多帮助，请查看其[示例Excel文件](43352075.xlsx)和[输出Excel文件](43352076.xlsx)。
