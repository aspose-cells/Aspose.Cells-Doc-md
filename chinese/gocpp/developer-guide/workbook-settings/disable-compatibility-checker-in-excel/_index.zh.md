---
title: 使用C++通过Golang禁用Excel中的兼容性检查器
linktitle: 禁用兼容性检查器
type: docs
weight: 170
url: /zh/go-cpp/disable-compatibility-checker-in-excel/
...
将[**Workbook.GetCheckCompatibility()**](https://reference.aspose.com/cells/go-cpp/workbooksettings/getcheckcompatibility/)属性设置为**False**以禁用Microsoft Excel的兼容性检查程序。
