---
title: 使用Golang通过C++判断数据点是否在“饼图”或“条形图”的第二个扇区
...
type: docs
weight: 180
url: /zh/go-cpp/find-if-data-points-are-in-the-second-pie-or-bar-on-a-pie-of-pie-or-bar-of-pie-chart/
---

## **可能的使用场景**
 你可以用Aspose.Cells判断系列中的数据点是否在“Pie of Pie”图的第二个扇区或“Bar of Pie”图的条形中。请使用[ChartPoint.IsInSecondaryPlot](https://reference.aspose.com/cells/go-cpp/chartpoint/isinsecondaryplot/)属性进行判断。
