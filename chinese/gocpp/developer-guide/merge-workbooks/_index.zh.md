---
title: 通过C++使用Golang将多个工作簿合并为一个工作簿
linktitle: 工作簿合并器
type: docs
weight: 66
url: /zh/go-cpp/combine-multiple-workbooks-into-a-single-workbook/
description: 学习如何使用Aspose.Cells通过C++将多个工作簿合并为一个工作簿。
---
...
示例代码使用Aspose.Cells将两个工作簿合并为单个工作簿。该代码加载源工作簿，使用[**Workbook::Combine()**](https://reference.aspose.com/cells/go-cpp/workbook/combine/)方法将它们合并，并保存输出工作簿。
