---
title: 用C++的Golang读取形状的发光效果的颜色
linktitle: 读取形状的发光效果的颜色
type: docs
weight: 330
url: /zh/go-cpp/read-color-of-shape-s-glow-effect/
description: 学习如何使用 Aspose.Cells for C++ 读取任何形状发光效果的颜色。
---

## 可能的使用场景

如果您想要阅读任何形状的发光效果的颜色，请使用[**Shape.Glow.Color**](https://reference.aspose.com/cells/go-cpp/color/)属性。这将帮助您找到与形状的发光效果的颜色相关的各种属性。
...
{{< gist "aspose-cells-gists" "b414abd53259bbc47d2c3c0fe985395b" "Examples-Go-CPP-ReadColorOfShapeSGlowEffect.go" >}}
## 控制台输出
