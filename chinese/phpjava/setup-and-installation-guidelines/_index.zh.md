...
description: "设置Aspose.Cells for PHP通过Java和安装指南。"
---



## **系统要求**
Aspose.Cells for PHP通过Java是平台独立的API，可在安装了[PHP](https://www.php.net/downloads.php)7或更高版本的任何平台（Windows、Linux、MacOS等）上使用。安装前必须有Oracle JDK 7或更高版本。
## **安装与使用**
Aspose.Cells for PHP通过Java以ZIP存档形式分发。

要设置环境，并安装和使用Aspose.Cells for PHP通过Java，请按照以下说明进行：
### **Linux:**
...
- 下载/获取"Aspose.Cells for PHP通过Java" API并进行提取。会有一个名为"aspose.cells"的文件夹。
...
- 下载“Aspose.Cells for PHP via Java” API 并解压缩。将会得到一个名为“aspose.cells”的文件夹。
- 从 http://php-java-bridge.sourceforge.net/pjb/download.php 下载 PHP/Java Bridge 二进制文件（JavaBridge.jar），并保存到“aspose.cells”文件夹中。
- 从 http://php-java-bridge.sourceforge.net/pjb/download.php 下载 java/Java.inc PHP 库（Java.inc），并保存到“aspose.cells”文件夹中。
