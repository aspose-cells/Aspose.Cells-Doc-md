...
description: Aspose.Cells 用于 PHP 通过 Java 限制和 api 差异
---
## **公共 API 差异**


以下列表（带有示例代码段）通过 Java API 显示了 Aspose.Cells for Java 和 Aspose.Cells 之间的一些差异。
### **导入库（包比较）**
...
## **PHP 的 Aspose.Cells 通过 Java API 与 Aspose.Cells for Java API 相比的其他限制**
