...
description: "通过Java的Aspose.Cells for PHP限制和API差异。"
---

## **公共API差异**


以下列表（带有样本代码段）显示了Aspose.Cells for Java和Aspose.Cells for PHP通过Java API之间的一些差异。
### **导入库（软件包对比）**
...
## **与Aspose.Cells for Java API相比，Aspose.Cells for PHP通过Java API的其他限制**
