...
type: docs
weight: 11
url: /zh/php-java/aspose-cells-for-php-via-java-23-2-release-notes/
---
{{% alert color="primary" %}}

此页面包含发行说明[Aspose.Cells for PHP via Java 23.2](https://downloads.aspose.com/cells/php/new-releases/aspose.cells-for-php-via-java-23.2/).
