...
type: docs
weight: 50
url: /zh/python-java/read-and-write-table-with-query-table-data-source/
---
## **使用查询表数据源读写表**
通过 Java 为 Python 使用 Aspose.Cells，您可以读写一个以 QueryTable 作为数据源的表。 XLS 文件也支持此功能。下面的代码片段通过首先读取表格然后修改它以添加总计行来演示读写这样的表格。
