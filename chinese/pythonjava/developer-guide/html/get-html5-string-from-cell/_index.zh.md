...
## **从单元格获取 HTML5 字符串**
使用Aspose.Cells for Python via Java，您可以通过API提供的[getHtmlString(boolean html5)](https://reference.aspose.com/cells/python/asposecells.api/cell#getHtmlString\(boolean\))方法获取单元格的HTML字符串。如果将**false**作为参数传递，它将返回普通的HTML字符串，但如果将**true**作为参数传递，它将返回HTML5字符串。
