...
---
## **从 Cell 获取 HTML5 字符串**
使用 Aspose.Cells for Python via Java，您可以从单元格中获取 HTML 字符串。这可以通过使用[getHtmlString（布尔值 html5）](https://reference.aspose.com/cells/python/asposecells.api/cell#getHtmlString\(boolean\)API提供的方法。如果你通过**错误的**作为参数，它会返回给你普通的 HTML 但如果你通过**真的**作为参数，它将返回 HTML5 字符串。
