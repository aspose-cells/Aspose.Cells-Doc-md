...
description: 如何用Python把Excel文件转成PDF。本文演示用Python把Excel文件转成PDF，好用的Aspose.Cells for Python via Java API。
...
要将 Excel 文件直接保存到 PDF，您可以使用[**工作簿.保存**](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)方法和传递[**保存格式.PDF**](https://reference.aspose.com/cells/python/asposecells.api/saveformat#PDF)作为第二个参数。
