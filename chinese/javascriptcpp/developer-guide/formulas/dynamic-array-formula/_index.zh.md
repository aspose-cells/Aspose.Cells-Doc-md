---
title: 使用C++通过JavaScript设置动态数组公式
linktitle: 设置动态数组公式
description: 如何使用Aspose.Cells库在Excel中计算动态数组公式，使用JavaScript和C++轻松加载、计算和保存Excel文件。
keywords: 动态数组公式，Excel中的动态数组公式，用C++设置动态数组公式，JavaScript中计算动态数组公式，操作Excel的动态数组公式。
type: docs
weight: 70
url: /zh/javascript-cpp/calculation-of-dynamic-array-formulas/
---
...
请参见以下示例代码，它加载包含一些虚拟数据的[示例Excel文件](dynamicArrayFormula.xlsx)。加载文件后，调用[Cell.dynamicArrayFormula(string, FormulaParseOptions, boolean)](https://reference.aspose.com/cells/javascript-cpp/cell/#dynamicArrayFormula-string-formulaparseoptions-boolean-)函数设置动态数组公式，调用[Workbook.refreshDynamicArrayFormulas(boolean)](https://reference.aspose.com/cells/javascript-cpp/workbook/#refreshDynamicArrayFormulas-boolean-)刷新动态数组公式（在调用公式计算之前），最后将工作簿保存为[输出Excel文件](out.xlsx)。  
