---
title: 通过JavaScript在C++中为命名范围设置公式
linktitle: 设置命名范围公式
type: docs
weight: 20
url: /zh/javascript-cpp/setting-formula-for-named-range/
description: 学习如何使用C++的JavaScript为电子表格中的命名范围设置公式。
---

## **为命名范围设置公式**
与Excel应用程序类似，Aspose.Cells API提供在使用其[Range.refersTo](https://reference.aspose.com/cells/javascript-cpp/range/#refersTo--)属性时为命名范围指定公式的能力。该功能有许多使用场景，以下列出一些详细情况。
