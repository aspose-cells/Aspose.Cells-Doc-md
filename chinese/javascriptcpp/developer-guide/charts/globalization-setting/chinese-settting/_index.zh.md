---
title: 使用 JavaScript 通过 C++ 将图表转换为图片以适应中国地区
description: 学习如何使用 Aspose.Cells for JavaScript 通过 C++ 配置支持中文字符和格式的图表，包括字体、大小、文本方向等等。
keywords: Aspose.Cells for JavaScript 通过 C++，图表，中文配置，字体，字号，文本方向，支持。
linktitle: 设置中国区域
type: docs
weight: 9
url: /zh/javascript-cpp/convert-chart-to-image-for-chinese-region/
...
第一步，你需要定义一个继承自[**ChartGlobalizationSettings**](https://reference.aspose.com/cells/javascript-cpp/chartglobalizationsettings/)的类"ChartChineseSetttings"。  
