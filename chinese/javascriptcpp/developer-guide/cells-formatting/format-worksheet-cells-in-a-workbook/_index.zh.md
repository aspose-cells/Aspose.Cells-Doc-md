---
title: 用 JavaScript 通过 C++ 格式化工作簿中的工作表单元格
linktitle: 在工作簿中格式化工作表单元格
description: 学习如何使用 C++ 脚本格式化工作簿中的工作表单元格，定制电子表格中数据的外观和样式。
keywords: Aspose.Cells、工作簿、工作表、单元格、格式化、外观、样式、通过 C++ 的 JavaScript
type: docs
weight: 2000
url: /zh/javascript-cpp/format-worksheet-cells-in-a-workbook/
---
...
示例项目执行所有这些任务，并向开发者详细介绍如何使用 [Aspose.Cells](https://products.aspose.com/cells/javascript-cpp/) 创建工作簿、添加数据和应用格式。
...
2. 创建项目并添加引用：
   ...
   1. 创建新的控制台应用程序。
   1. 在你的 JavaScript 项目中添加对 Aspose.Cells 的引用。
3. 向项目添加以下代码：
