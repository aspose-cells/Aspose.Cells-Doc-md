---
title: 使用 JavaScript 通过 C++ 设置页面选项
linktitle: 设置页面选项
type: docs
weight: 10
url: /zh/javascript-cpp/setting-page-options/
description: 本文提供示例代码，用于通过 JavaScript 通过 C++ 编程方式设置 Excel 工作表的页面选项，包括页面方向、缩放比例、FitToPages 选项、纸张大小、打印质量和首页编号。
keywords: 使用 JavaScript via C++ 设置 Excel 的页面方向、缩放比例和纸张大小
---
...
Aspose.Cells 提供了一个类，[**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook)，它代表一个 Microsoft Excel 文件。[**Workbook**](https://reference.aspose.com/cells/javascript-cpp/workbook) 类包含一个 [**worksheets**](https://reference.aspose.com/cells/javascript-cpp/workbook/#worksheets--) 集合，允许访问 Excel 文件中的每个工作表。工作表由 [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) 类表示。  
 ...
 [**Worksheet**](https://reference.aspose.com/cells/javascript-cpp/worksheet) 类提供 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 属性，用于设置工作表的页面布局选项。实际上，这个 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 属性是 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 类的对象，用于设置打印工作表的不同页面布局选项。[**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 类提供多种属性，用于设置页面布局，以下将介绍部分属性。  

### **页面方向**  

 可以使用 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 类的 [**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) 属性将页面方向设置为纵向或横向。[**orientation**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#orientation--) 属性接受 [**PageOrientationType**](https://reference.aspose.com/cells/javascript-cpp/pageorientationtype) 枚举中的预定义值，具体如下：  
...
### **缩放因子**  
 ...
 通过调整 [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) 属性的缩放比例，可以缩小或放大工作表的大小。  
...
### **适合页码选项**  
 ...
 若要将工作表内容适配到特定的页数，可以使用 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 类的 [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--) 和 [**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) 属性。这些属性也用于缩放工作表。  

{{% alert color="primary" %}}  
 您可以选择 [**fitToPagesTall**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesTall--)/[**fitToPagesWide**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#fitToPagesWide--) 或 [**zoom**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#zoom--) 属性，但不能同时使用两者。  
{{% /alert %}}  
...
### **纸张尺寸**  
 ...
 使用 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 类的 [**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) 属性设置打印工作表的纸张大小。[**paperSize**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#paperSize--) 属性接受 [**PaperSizeType**](https://reference.aspose.com/cells/javascript-cpp/papersizetype) 枚举中的预定义值，具体如下：  
...
将工作表的打印质量设置为使用 [**printQuality**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printQuality--) 属性。打印质量的测量单位为每英寸点数（DPI）。  
...
### **首页页码**  
 ...
 使用 [**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup) 类的 [**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) 属性开始对工作表页面编号。[**firstPageNumber**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#firstPageNumber--) 属性设置第一张工作表页面的页码，后续页面按升序编号。  
