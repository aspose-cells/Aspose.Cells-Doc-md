---
title: 如何通过C++使用JavaScript设置打印区域
linktitle: 如何设置打印区域
type: docs
weight: 200
url: /zh/javascript-cpp/how-to-set-print-area/
description: 本文向您展示了如何使用C++的Aspose.Cells库中的JavaScript设置打印区域的代码。
keywords: 限制打印范围，设置打印范围，清除打印范围，使用C++的JavaScript设置和清除打印范围，如何用JavaScript通过C++设置和清除打印区域，如何在JavaScript通过C++中清除打印区域，如何用JavaScript通过C++添加打印区域，如何用JavaScript通过C++移除打印区域，如何在Excel中设置打印区域，如何在Excel中清除打印区域。
---
...
## **如何使用Aspose.Cells for JavaScript通过C++设置打印区域**
 ...
 要在指定工作表中设置打印区域：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的[**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/)对象的[**PageSetup.printArea**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printArea--)属性。将此属性设置为范围字符串将设置打印区域。
...
要在指定工作表中清除打印区域：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的[**PageSetup**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/)对象的[**PageSetup.printArea**](https://reference.aspose.com/cells/javascript-cpp/pagesetup/#printArea--)属性。将该属性设置为空字符串，即可清除打印区域。
