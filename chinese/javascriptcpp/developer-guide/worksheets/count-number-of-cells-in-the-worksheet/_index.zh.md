---
title: 使用 JavaScript 通过 C++ 统计工作表中的单元格数量
linktitle: 计算工作表中单元格的数量
type: docs
weight: 110
url: /zh/javascript-cpp/count-number-of-cells-in-the-worksheet/
description: 学习如何通过 Aspose.Cells for JavaScript 通过 C++ 编程方式统计 Excel 工作表中的单元格数量。
keywords: 使用 JavaScript 通过 C++ 统计 Excel 工作表单元格数量，JavaScript 通过 C++ 的工作表单元格
---

您可以使用下面给出的代码示例中所示的[**Cells.count**](https://reference.aspose.com/cells/javascript-cpp/cells/#count--)或[**Cells.countLarge**](https://reference.aspose.com/cells/javascript-cpp/cells/#countLarge--)属性来计算工作表中的单元格数量。
