...
type: docs
weight: 130
url: /zh/javascript-cpp/custom-sorting-in-pivot-table/
description: 如何使用Aspose.Cells for JavaScript通过C++对数据透视表的字段值进行排序。
keywords: 通过C++的Excel、Excel JavaScript库使用Aspose.Cells for JavaScript，对数据透视表的字段值进行排序
---

## **如何使用Aspose.Cells for JavaScript通过C++设置数据透视表的自定义排序**
通过使用Aspose.Cells for JavaScript通过C++ API，您可以根据字段值对数据透视表进行排序。以下代码片段加载示例Excel文件，并添加了三个数据透视表。第一个没有自定义排序，第二个基于“海鲜”行字段值排序，第三个基于“28/07/2000”列字段值排序。
