...
type: docs
weight: 70
url: /zh/javascript-cpp/get-the-cell-object-by-displayname-of-pivotfield-of-pivottable/
description: 如何用Aspose.Cells for JavaScript通过C++根据数据透视表中的字段显示名称获取单元格对象。
keywords: Aspose.Cells for JavaScript通过C++ Excel、Excel JavaScript库，使用Aspose.Cells for JavaScript通过C++获取数据透视表中字段显示名称对应的单元格对象。
---

{{% alert color="primary" %}}

Aspose.Cells for JavaScript通过C++提供了[**PivotTable.cellByDisplayName(string)**](https://reference.aspose.com/cells/javascript-cpp/pivottable/#cellByDisplayName-string-)方法，可以使用该方法通过显示名称访问数据透视字段的单元格对象。当你想要突出显示或格式化数据透视字段标题时，这个方法非常有用。本文介绍了如何通过显示名称检索数据字段的单元格对象，然后进行格式设置。
