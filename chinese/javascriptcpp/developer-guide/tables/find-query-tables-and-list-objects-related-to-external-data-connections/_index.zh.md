---
title: 查找与外部数据连接相关的查询表和列表对象，通过JavaScript与C++
linktitle: 查找与外部数据连接相关的查询表和列表对象
type: docs
weight: 20
url: /zh/javascript-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: 学习如何使用Aspose.Cells for JavaScript通过C++查找与外部数据连接相关的查询表和列表对象。
---
