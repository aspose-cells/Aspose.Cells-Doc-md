---
title: 用JavaScript通过C++用证书数字签署VBA代码项目
linktitle: 使用证书为VBA代码项目进行数字签名
type: docs
weight: 110
url: /zh/javascript-cpp/digitally-sign-a-vba-code-project-with-certificate/
description: 学习如何用Aspose.Cells for JavaScript通过C++用证书数字签署VBA代码项目。
---

{{% alert color="primary" %}}

您可以使用Aspose.Cells及其[**VbaProject.sign(DigitalSignature)**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#sign-digitalsignature-)方法对VBA代码项目进行数字签名。请按照以下步骤检查您的Excel文件是否已用证书进行数字签名。
...
以下示例代码演示了如何使用[**VbaProject.sign(DigitalSignature)**](https://reference.aspose.com/cells/javascript-cpp/vbaproject/#sign-digitalsignature-)方法。这是示例代码的输入和输出文件。你可以使用任何Excel文件和任何证书来测试此代码。
