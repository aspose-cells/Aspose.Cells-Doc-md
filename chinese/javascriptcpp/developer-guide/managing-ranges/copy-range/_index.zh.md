---
title: 通过C++的JavaScript复制Excel范围
linktitle: 复制范围
type: docs
weight: 105
url: /zh/javascript-cpp/copy-ranges-of-Excel/
---
...
C++的C++提供了一些重载的[Range.copy(Range, PasteOptions)](https://reference.aspose.com/cells/javascript-cpp/range/#copy-range-pasteoptions-)方法以复制范围。而[Range.copyStyle(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyStyle-range-)只复制范围的样式；[Range.copyData(Range)](https://reference.aspose.com/cells/javascript-cpp/range/#copyData-range-)则只复制范围的值。
...
## **高级主题**
- [将源范围的行高复制到目标范围](/cells/zh/javascript-cpp/copy-row-heights-of-source-range-to-destination-range/)
