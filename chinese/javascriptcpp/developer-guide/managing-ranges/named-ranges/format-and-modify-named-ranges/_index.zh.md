---
title: 用JavaScript通过C++格式化和修改命名范围
linktitle: 格式和修改命名区域
type: docs
weight: 85
url: /zh/javascript-cpp/format-and-modify-named-ranges/
description: 学习如何使用Aspose.Cells for JavaScript通过C++格式化和修改命名范围。 
---
...
要应用格式，可以定义一个 [**Style**](https://reference.aspose.com/cells/javascript-cpp/style) 对象以指定样式设置并将其应用到 [**Range**](https://reference.aspose.com/cells/javascript-cpp/range) 对象。
...
可以为单元格范围添加边框，而不只是单个单元格。[**Range**](https://reference.aspose.com/cells/javascript-cpp/range) 对象提供一个 [**outlineBorder(BorderType, CellBorderType, CellsColor)**](https://reference.aspose.com/cells/javascript-cpp/range/#outlineBorder-bordertype-cellbordertype-cellscolor-) 方法，该方法接受以下参数以为单元格范围添加边框：

- 边框类型，边框类型，从 [**BorderType**](https://reference.aspose.com/cells/javascript-cpp/bordertype) 枚举中选择。
- 线条样式，线条样式，从 [**CellBorderType**](https://reference.aspose.com/cells/javascript-cpp/cellbordertype) 枚举中选择。
...
Aspose.Cells 允许您重命名命名范围以满足您的需要。您可以通过使用 [**Name.text**](https://reference.aspose.com/cells/javascript-cpp/name/#text--) 属性获取命名范围并重命名。以下示例展示了如何重命名命名范围。
...
Aspose.Cells 提供 [**Range.unionRang(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#unionRang-range-) 方法用来取两个范围的并集；该方法返回一个 [*数组*] 对象。以下示例展示了如何取范围的并集。
...
Aspose.Cells 提供 [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-) 方法以求两个范围的交集。该方法返回一个 [**Range**](https://reference.aspose.com/cells/javascript-cpp/range) 对象。若欲判断两个范围是否相交，可使用 [**Range.intersect(Range)**](https://reference.aspose.com/cells/javascript-cpp/range/#intersect-range-) 方法，该方法返回布尔值。以下示例展示了如何求范围的交集。
...
Aspose.Cells 提供 [**Range.merge()**](https://reference.aspose.com/cells/javascript-cpp/range/#merge--) 方法以合并区域内的单元格。以下示例展示了如何合并命名范围的单个单元格。
...
Aspose.Cells 提供 [**NameCollection.removeAt(number)**](https://reference.aspose.com/cells/javascript-cpp/namecollection/#removeAt-number-) 方法以清除范围的名称。要清空范围内容，请使用 [**Cells.clearRange(CellArea)**](https://reference.aspose.com/cells/javascript-cpp/cells/#clearRange-cellarea-) 方法。以下示例展示了如何删除带有内容的命名范围。
