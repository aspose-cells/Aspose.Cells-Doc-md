---
title: 使用GridLines导出Excel到HTML via JavaScript。
linktitle: 将Excel导出为带有网格线的HTML
type: docs
weight: 40
url: /zh/javascript-cpp/export-excel-to-html-with-gridlines/
description: 学习如何使用Aspose.Cells for JavaScript via C++导出带有网格线的Excel文件到HTML格式。
---

{{% alert color="primary" %}}

如果想将带有网格线的Excel文件导出为HTML，请使用[HtmlSaveOptions.exportGridLines()](https://reference.aspose.com/cells/javascript-cpp/htmlsaveoptions/#exportGridLines--)属性并设置为**true**。

{{% /alert %}}
## **将Excel导出为带有网格线的HTML**
以下示例代码创建一个工作簿，填充一些值，然后将其以HTML格式保存，同时将[HtmlSaveOptions.exportGridLines()](https://reference.aspose.com/cells/javascript-cpp/htmlsaveoptions/#exportGridLines--)设置为**true**。
