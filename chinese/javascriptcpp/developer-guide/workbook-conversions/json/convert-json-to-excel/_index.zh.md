---
title: 使用C++通过JavaScript将JSON转换为Excel文件
linktitle: 转换 JSON 为 Excel
type: docs
weight: 300
url: /zh/javascript-cpp/convert-json-to-excel/
description: 学习如何使用C++和Aspose.Cells for JavaScript将JSON转换为Excel文件。
keywords: 无需Office 2013、Office 2016、Office 2019和Office 365即可通过JavaScript使用C++导入JSON。
---
...
## **将JSON转换为Excel工作簿**
无需担心如何将JSON转换为Excel文件，因为Aspose.Cells for JavaScript通过C++提供了最佳解决方案。Aspose.Cells API支持将JSON格式转换为电子表格。可以使用[**JsonLoadOptions**](https://reference.aspose.com/cells/javascript-cpp/jsonloadoptions)类设置导入JSON到工作簿的其他参数。
