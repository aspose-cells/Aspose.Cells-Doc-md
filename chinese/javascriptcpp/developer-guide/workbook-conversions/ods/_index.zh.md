---
title: 将Excel工作簿转换为Ods、Sxc和Fods（OpenOffice / LibreOffice calc） via JavaScript
linktitle: Ods
type: docs
weight: 20
url: /zh/javascript-cpp/convert-excel-to-ods/
description: 如何通过Aspose.Cells for JavaScript使用C++将Excel转换为Ods（OpenOffice / LibreOffice Calc）或将Ods（OpenOffice / LibreOffice Calc）转换为Excel。
---
...
Aspose.Cells for JavaScript通过C++支持加载由OpenOffice / LibreOffice Calc支持的Ods、Sxc和Fods文件，并将[Ods](book1.ods)、[Sxc](book1.sxc)和[Fods](book1.fods)转换为Excel文件。
...
Aspose.Cells for JavaScript通过C++支持将Excel文件转换为Ods、Sxc和Fods文件。下面的代码示例展示了如何将[模板](book1.xlsx)转换为Ods、Sxc和Fods文件。
...
## **高级主题**
- [按照ODF 1.1和1.2规范保存ODS文件](/cells/zh/javascript-cpp/save-ods-file-in-odf-1-1-and-1-2-specifications/)
