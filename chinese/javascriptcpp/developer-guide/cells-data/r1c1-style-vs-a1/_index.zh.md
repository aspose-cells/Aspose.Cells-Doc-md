...
type: docs
weight: 30
url: /zh/javascript-cpp/r1c1-reference-style-vs-a1/
description: 使用Aspose.Cells for Java脚本在C++中对比R1C1引用样式与A1样式。
keywords: R1C1引用样式VS A1样式JavaScript via C++，R1C1引用样式JavaScript via C++，如何在R1C1引用样式与A1样式之间切换JavaScript via C++，A1引用样式JavaScript。
---
