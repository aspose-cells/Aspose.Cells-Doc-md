---
title: 通过C++使用JavaScript设置形状或文本框中文本效果的阴影
linktitle: 设置形状或文本框的文本效果的阴影
type: docs
weight: 250
url: /zh/javascript-cpp/setting-shadow-of-text-effects-of-shape-or-textbox/
description: 学习如何使用Aspose.Cells for JavaScript通过C++为任何形状或文本框设置文本效果阴影。
---

{{% alert color="primary" %}}  

您可以使用[**Shape.textBody**](https://reference.aspose.com/cells/javascript-cpp/shape/#textBody--)属性设置任何形状或文本框的**文本效果**的**阴影**。访问后，请通过[**FontSetting.presetType**](https://reference.aspose.com/cells/javascript-cpp/shadoweffect/#presetType--)属性设置阴影，该属性属于[**PresetShadowType**](https://reference.aspose.com/cells/javascript-cpp/presetshadowtype)类型，具有多种值，包括....  
...
以下代码片段演示了如何使用[**FontSetting.presetType**](https://reference.aspose.com/cells/javascript-cpp/shadoweffect/#presetType--)属性为形状或文本框设置文本效果的阴影。  
