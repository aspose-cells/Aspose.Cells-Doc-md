---
title: 使用C++通过JavaScript更改Excel文本框或形状的字符间距
linktitle: 更改 Excel 文本框或形状的字符间距
type: docs
weight: 280
url: /zh/javascript-cpp/change-character-spacing-of-excel-textbox-or-shape/
description: 使用C++的Aspose.Cells for JavaScript，通过JavaScript更改Excel文本框或形状的字符间距。 
---

{{% alert color="primary" %}}

您可以使用[**TextOptions.spacing**](https://reference.aspose.com/cells/javascript-cpp/textoptions/#spacing--)属性更改单元格文本框或形状的字符间距。
