---
title: 使用JavaScript通过C++将WAV文件作为OLE对象插入
linktitle: 将WAV文件作为OLE对象插入
type: docs
weight: 70
url: /zh/javascript-cpp/inserting-a-wav-file-as-an-ole-object/
description: 学习如何使用Aspose.Cells for JavaScript通过C++在Excel工作表中将WAV文件作为OLE对象插入。 
---
