---
title: 用JavaScript通过C++将图片作为纹理铺贴在形状内
linktitle: 在形状内作为纹理平铺图片
type: docs
weight: 1700
url: /zh/javascript-cpp/tile-picture-as-a-texture-inside-the-shape/
description: 学习如何用Aspose.Cells for JavaScript通过C++将小图片作为纹理铺贴在形状内
---
...
你可以用一些图片填充形状表面，并用 [**Shape.isTiling()**](https://reference.aspose.com/cells/javascript-cpp/texturefill/#isTiling--) 属性平铺，设置为 **true**。请参考下面的示例代码、样例Excel文件（46465050.xlsx）和截图。  
