---
title: 用JavaScript通过C++更改形状的调整值
linktitle: 更改形状的调整值
type: docs
weight: 2000
url: /zh/javascript-cpp/change-adjustment-values-of-the-shape/
description: 学习如何使用Aspose.Cells for JavaScript通过C++在Excel中更改形状的调整值。
---

{{% alert color="primary" %}}  
Aspose.Cells 提供 [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) 属性以更改形状的调整点。在微软Excel用户界面中，调整显示为黄色菱形节点。例如：  
...
本文将解释如何使用 [**Shape.geometry**](https://reference.aspose.com/cells/javascript-cpp/shape/#geometry--) 属性来更改不同形状的调整值。  
{{% /alert %}}  
