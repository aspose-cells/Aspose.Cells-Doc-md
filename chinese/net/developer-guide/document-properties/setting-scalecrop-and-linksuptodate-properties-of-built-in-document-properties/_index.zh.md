...
---
## **可能的使用场景**
[鳞片作物](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/scalecrop)和[最新链接](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/linksuptodate)是在 OpenXml 格式中定义的两个扩展的内置文档属性。这些属性的用途如下
## **1) 鳞片作物**
...
下面的示例代码设置[鳞片作物](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/scalecrop)和[最新链接](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/linksuptodate)扩展了工作簿的内置文档属性。请检查[输出excel文件](5115500.xlsx)使用此代码生成，将其扩展名更改为 .zip 并提取其内容并查看 app.xml，如上面的屏幕截图所示。
