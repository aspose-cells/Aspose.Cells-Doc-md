...
## **可能的使用场景**
[ScaleCrop](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/scalecrop)和[LinksUpToDate](https://reference.aspose.com/cells/net/aspose.cells.properties/builtindocumentpropertycollection/properties/linksuptodate)是OpenXml格式中定义的两个扩展的内置文档属性。这些属性的作用如下
## **1) ScaleCrop**
该元素指示文档缩略图的显示模式。将此元素设置为**TRUE**以启用文档缩略图的缩放。将此元素设置为**FALSE**以使文档缩略图进行裁剪，以仅显示适合显示的部分。
