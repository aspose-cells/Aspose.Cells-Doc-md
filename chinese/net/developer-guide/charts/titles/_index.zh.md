...
## **标题选项**
Aspose.Cells 还允许在运行时管理图表的标题，用[标题](https://reference.aspose.com/cells/net/aspose.cells.charts/title/)对象，您可以更改标题的文本、字体和填充格式。
...
## **推进主题**
- [从 ODS 文件中读取图表副标题](/cells/zh/net/read-chart-subtitle-from-ods-file/)
