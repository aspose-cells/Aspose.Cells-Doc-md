...
第一步，您需要定义一个继承自的类“ChartJapaneseSetttings”[**图表全球化设置**](https://reference.aspose.com/cells/net/aspose.cells.charts/chartglobalizationsettings/). 
...
在此步骤中，您将使用在上一步中定义的类“ChartJapaneseSetttings”。
代码示例：
...
在此示例中，如果您没有为图表设置日本区域，则以下图表元素可能会以默认语言呈现，例如英语。
经过以上操作，我们就可以得到一张带有日语区域的输出图表图片。
