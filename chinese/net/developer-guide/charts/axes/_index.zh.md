---
title: 管理 Excel 图表的轴
description: 了解如何配置图表轴 Aspose.Cells for .NET。我们的指南将向您展示如何调整主轴和次轴、设置其范围以及修改其属性以增强您的图表。
...
##  **轴选项**
Aspose.Cells 还允许在运行时管理图表的轴，[轴](https://reference.aspose.com/cells/net/aspose.cells.charts/axis/)对象，您可以像在 Excel 中一样更改 Axis 的所有选项。
