...
您可以使用 Aspose.Cells 检索图表趋势线的公式文本。Aspose.Cells 提供[**趋势线.DataLabels.Text**](https://reference.aspose.com/cells/net/aspose.cells.charts/datalabels/properties/text)返回图表趋势线的公式文本的属性。要使用此属性，您首先必须调用[**图表.计算()**](https://reference.aspose.com/cells/net/aspose.cells.charts/chart/methods/calculate)方法。
