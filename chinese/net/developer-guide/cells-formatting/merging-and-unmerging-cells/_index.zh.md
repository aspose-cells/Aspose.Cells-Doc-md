---
title: 合并和分割单元格
description: Aspose.Cells是用于处理电子表格文件的.NET库，支持合并和取消合并单元格。本文将介绍如何使用Aspose.Cells库合并和取消合并单元格，以及如何自定义合并单元格样式。
keywords: Aspose.Cells, NET库, 电子表格, 合并单元格, 取消合并单元格, 样式设置, 自定义样式
type: docs
weight: 190
...
## **高级主题**
- [在工作表中检测合并的单元格](/cells/zh/net/detect-merged-cells-in-a-worksheet/)
