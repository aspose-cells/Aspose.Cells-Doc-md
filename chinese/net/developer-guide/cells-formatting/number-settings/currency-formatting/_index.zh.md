...
type: docs
weight: 10
url: /zh/net/format-number-to-currency/
description: 本文将介绍如何使用Aspose.Cells for .NET API将数字格式化为货币。
...
要在Aspose.Cells for .NET库中对Excel文件中的数字进行货币格式化，可以以编程方式应用货币格式到单元格。以下是使用C#和Aspose.Cells的示例：
