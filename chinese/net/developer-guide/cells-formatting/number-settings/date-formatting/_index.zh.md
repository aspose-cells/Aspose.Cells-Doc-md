...
type: docs
weight: 10
url: /zh/net/format-number-to-date/
description: 本文将介绍如何使用Aspose.Cells for .NET API将数字格式化为日期。
...
要在使用Aspose.Cells for .NET库处理Excel文件时将数字格式化为日期，可以以编程方式为单元格应用日期格式。以下是用C#结合Aspose.Cells的方法：
