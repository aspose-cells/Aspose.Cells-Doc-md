...
description: Aspose.Cells 是一个用于处理电子表格文件的 .NET 库。它支持在条件格式中使用图标集、数据条和颜色刻度对象，以显示电子表格中的数据。本文描述了如何使用 Aspose.Cells 库检索这些对象的数据。
keywords: Aspose.Cells, 条件格式, 图标集, 数据条, 颜色刻度, 电子表格
type: docs
weight: 10
url: /zh/net/get-icon-sets-data-bars-or-color-scales-objects-used-in-conditional-formatting/
---
