...
description: 使用Aspose.Cells for .Net插入和管理评论或备注。
keywords: 插入注释，插入备注
---
...
## **高级主题**
- [更改批注的文本方向](/cells/zh/net/change-text-direction-of-the-comment/)
- [如何更改批注字体颜色](/cells/zh/net/how-to-change-the-comment-font-color/)
