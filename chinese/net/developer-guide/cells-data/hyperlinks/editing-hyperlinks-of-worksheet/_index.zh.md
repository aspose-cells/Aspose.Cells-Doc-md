...
Aspose.Cells允许您访问工作表的所有超链接，使用[**Worksheet.Hyperlinks**](https://reference.aspose.com/cells/net/aspose.cells/worksheet/properties/hyperlinks)集合。您可以逐个访问此集合中的每个超链接并编辑其属性。
