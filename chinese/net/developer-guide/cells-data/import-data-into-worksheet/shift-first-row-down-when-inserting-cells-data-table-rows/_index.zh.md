...
下面的示例代码说明了在将表格插入工作表时如何将第一行向下移动。我们在代码中使用一个简单的模板 Excel 文件来演示该功能。您可以通过设置布尔值来使用该功能[**ImportTableOptions.ShiftFirstRowDown**](https://reference.aspose.com/cells/net/aspose.cells/importtableoptions/properties/shiftfirstrowdown)归于**真的**/**错误的**更好地理解它。请参阅[示例 Excel 文件](45056031.xlsx), [输出Excel False文件](45056032.xlsx)， 和[输出Excel真文件](45056033.xlsx)供你参考。
