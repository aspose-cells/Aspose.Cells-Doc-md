...
有时，您希望在将工作表数据导出到数据表时忽略隐藏的列。您可以使用 Aspose.Cells 通过设置来实现它[**ExportTableOptions.PlotVisibleColumns**](https://reference.aspose.com/cells/net/aspose.cells/exporttableoptions/properties/plotvisiblecolumns)至**真的** .默认情况下，它的值为**错误的**，所以你需要设置它**真的**忽略隐藏的列。
