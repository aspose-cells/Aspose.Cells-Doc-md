...
type: docs
weight: 600
url: /zh/net/get-cells-range/
description: 了解如何通过 Aspose.Cells for .NET API 获取 Cells 范围。
...
---
##  **可能的使用场景**
当你只需要操作工作表上的部分数据时，你需要知道整个工作表的数据范围。 Aspose.Cells 提供此功能。 Aspose.Cells 提供以下属性和方法来帮助您实现目标。
...
##  **使用 Aspose.Cells 获取 Cells 范围**
此示例演示如何：

1. 创建工作簿。
1. 将数据添加到第一个工作表中的单元格。
1. 获取Cells[**范围**](https://reference.aspose.com/cells/net/aspose.cells/range).
