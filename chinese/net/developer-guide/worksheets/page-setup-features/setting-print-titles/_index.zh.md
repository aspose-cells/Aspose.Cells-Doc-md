...
type: docs
weight: 200
url: /zh/net/how-to-set-print-titles/
description: 本文展示了如何使用Aspose.Cells库设置打印标题的代码。
keywords: 重复打印行和列，C#如何设置打印标题，使用C#设置和清除打印标题，如何清除C#中的打印标题，如何添加打印标题，如何删除打印标题，如何在Excel中设置打印标题，如何清除Excel中的打印标题。
---
...
要在特定工作表中设置打印标题：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的 [**Worksheet.PageSetup.PrintTitleRows**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlerows/) 和 [**Worksheet.PageSetup.PrintTitleColumns**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlecolumns/) 属性，将这些属性设置为一个范围字符串即可设置打印标题。
...
要清除特定工作表中的打印标题：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的 [**Worksheet.PageSetup.PrintTitleRows**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlerows/) 和 [**Worksheet.PageSetup.PrintTitleColumns**](https://reference.aspose.com/cells/net/aspose.cells/pagesetup/printtitlecolumns/) 属性，将这些属性设置为空字符串即可清除打印标题。
