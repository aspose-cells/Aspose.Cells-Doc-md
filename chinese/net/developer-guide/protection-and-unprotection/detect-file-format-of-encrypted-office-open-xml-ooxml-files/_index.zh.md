...
Aspose.Cells 提供了一种检测加密文件格式的方法**Microsoft 打开 XML**文件。要识别文件类型，请使用[FileFormatUtil.DetectFileFormat](https://reference.aspose.com/cells/net/aspose.cells/fileformatutil/methods/detectfileformat/index)方法如下代码示例所示。
