---
title: 智能导入JSON到Excel与智能标记
type: docs
weight: 30
url: /zh/net/how-to-import-json-into-excel-with-smart-markers/
...
## **使用Excel嵌套模板结合JSON数据**
Aspose.Cells for .NET支持智能标记中的json数据，json数据可以层级嵌套。请检查[模板文件](smartmarker.xlsx)、[json文件](smartmarker.json)以及用以下代码生成的输出Excel文件截图。
...
## **使用Excel小计模板结合JSON数据**
Aspose.Cells for .NET支持智能标记中的json数据，json数据可以层级嵌套。Excel模板中使用了小计进行数据统计。请检查[模板文件](jsonExcelTemplate.xlsx)、[json文件](jsonData.json)以及用以下代码生成的输出Excel文件截图。
