...
type: docs
weight: 130
url: /zh/net/autofit-rows-for-rendering/
---
...
如果您想防止在保存的 PDF 文件中剪切文本，您可以使用以下命令自动调整行[AutoFitterOptions.ForRendering](https://reference.aspose.com/cells/net/aspose.cells/autofitteroptions/forrendering/)选项。
