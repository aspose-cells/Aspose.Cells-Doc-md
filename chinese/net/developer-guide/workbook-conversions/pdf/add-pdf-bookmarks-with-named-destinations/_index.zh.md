...
命名目标是PDF中不依赖于PDF页面的特殊书签或链接。 这意味着，如果从PDF中添加或删除页面，则书签可能变得无效，但命名目标将保持完整。 要创建命名目标，请设置[**PdfBookmarkEntry.DestinationName**](https://reference.aspose.com/cells/net/aspose.cells.rendering/pdfbookmarkentry/properties/destinationname)属性。
