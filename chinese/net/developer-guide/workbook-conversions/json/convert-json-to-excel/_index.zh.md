...
type: docs
weight: 300
url: /zh/net/convert-json-to-excel/
description: 了解如何使用 Aspose.Cells 将 json 转换为 excel 文件。
keywords: Importing json without office 2013, office 2016, office 2019 and office 365.
---
{{% alert color="primary" %}}

Aspose.Cells 支持将 Json(JavaScript Object Notation) 文件转换为 Excel 工作簿。

{{% /alert %}}

## **将 JSON 转换为 Excel 工作簿**
无需考虑如何将 JSON 转换为 Excel 文件，因为 Apose.Cells for .NET 库有最佳决策。 Aspose.Cells API 提供JSON格式转电子表格的支持。您可以使用[**JsonLoad选项**](https://reference.aspose.com/cells/net/aspose.cells/JsonLoadOptions)类以指定用于将 JSON 导入工作簿的其他设置。

以下代码示例演示了将 JSON 导入 Excel 工作簿。请看代码转换[源文件](sample.json)到代码生成的xlsx文件，供参考。
