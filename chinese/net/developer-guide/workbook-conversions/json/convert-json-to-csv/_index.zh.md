...
下面的代码示例演示了使用**[JsonLayoutOptions](https://reference.aspose.com/cells/net/aspose.cells.utility/jsonlayoutoptions)**和**[JsonUtility](https://reference.aspose.com/cells/net/aspose.cells.utility/jsonutility)**加载的类[源文件 JSON](104398869.json)并生成[输出 CSV 文件](104398870.csv).
