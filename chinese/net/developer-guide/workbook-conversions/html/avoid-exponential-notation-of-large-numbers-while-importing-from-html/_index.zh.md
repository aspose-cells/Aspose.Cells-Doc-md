...
有时您的 Html 包含 1234567890123456 等长度超过 15 位的数字，当您将 HTML 导入 excel 文件时，这些数字会转换为指数表示法，例如 1.23457E+15。如果你愿意，你的数字应该原样导入而不是转换为指数表示法，那么请使用[**HTMLLoadOptions.KeepPrecision**](https://reference.aspose.com/cells/net/aspose.cells/abstracttextloadoptions/properties/keepprecision)属性并设置它**真的**在加载您的 HTML 时。
