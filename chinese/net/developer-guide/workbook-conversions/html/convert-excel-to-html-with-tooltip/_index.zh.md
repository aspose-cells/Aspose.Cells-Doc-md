...
在生成的 HTML 中可能会出现文本被截断的情况，您希望在悬停事件时显示完整文本作为工具提示。Aspose.Cells 支持通过提供 **[HtmlSaveOptions.AddTooltipText](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/addtooltiptext)** 属性来实现此功能。将 **[HtmlSaveOptions.AddTooltipText](https://reference.aspose.com/cells/net/aspose.cells/htmlsaveoptions/properties/addtooltiptext)** 属性设置为 **true** 将在生成的 HTML 中添加完整文本作为工具提示。
