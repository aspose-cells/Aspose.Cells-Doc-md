...
### **示例代码**
以下示例代码将示例 excel 文件转换为正常的 HTML[Excel 到 HTML 转换](/cells/zh/net/convert-workbook-to-different-formats/#convertworkbooktodifferentformats-convertingexcelworkbooktohtml).
