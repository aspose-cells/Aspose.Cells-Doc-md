...
您可以修改相同的示例以将文件保存到 CSV。默认情况下，**[TxtSaveOptions.Separator](https://reference.aspose.com/cells/net/aspose.cells/txtsaveoptions/properties/separator)**是逗号，所以如果保存为 CSV 格式，请不要指定分隔符。
