...
- 文件名。
- *[内容处置](https://reference.aspose.com/cells/net/aspose.cells/contentdisposition)**，输出文件的内容配置类型。
...
|**类型**|**描述**|
| :- | :- |
|Attachment|将电子表格发送到浏览器并作为与 .xls/.xlsx 或其他扩展名关联的附件在应用程序中打开|
|Inline|将文档发送到浏览器并提供将电子表格保存到磁盘或在浏览器中打开的选项|
...
由于对象“System.Web.HttpResponse”未包含在 .NET5 和 .Netstandard 中，
