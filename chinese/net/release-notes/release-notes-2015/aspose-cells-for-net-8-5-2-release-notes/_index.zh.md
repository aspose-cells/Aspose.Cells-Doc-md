...
type: docs
weight: 50
url: /zh/net/aspose-cells-for-net-8-5-2-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 8.5.2](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.5.2/)
