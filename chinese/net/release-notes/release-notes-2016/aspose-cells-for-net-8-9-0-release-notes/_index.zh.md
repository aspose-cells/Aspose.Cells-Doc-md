...
type: docs
weight: 70
url: /zh/net/aspose-cells-for-net-8-9-0-release-notes/
---
### **1) Aspose.Cells**

|**钥匙** |**概括** |**类别** |
|:- |:- |:- |
|CELLSNET-44574 |支持将文件导出为 HTML 时从右向左扩展文本|新功能|
...
|CELLSNET-43656 |一些文本项在输出 HTML 中被略微截断|漏洞|
|CELLSNET-44590 |将 Excel 导出为页眉和页脚中带有特殊字符的 PDF 时出现问题|漏洞|
|CELLSNET-44517 |使用 SheetRender.ToImage 生成图像范围时垂直对齐错误|漏洞|
|CELLSNET-44589 |Aspose.Cells 生成的 EMF 在插入到 Word 文档并转换为 PDF 时显示不正确的轴标签|漏洞|
|CELLSNET-44586 |小于单个间距不能正确导出为 PDF|漏洞|
|CELLSNET-44564 | Chart 在 Session 0 下生成的 EMF 没有显示所有内容|漏洞|
...
|CELLSNET-44573 |从外部 XLSX 复制的工作表中的图片大小与原始图片不同|漏洞|
...
|CELLSNET-44543 |将文件转换为 HTML 时形状的填充格式丢失|漏洞|
...
指定导出 HTML 时的默认字体名称，当样式字体不存在时将使用默认字体。如果该属性为空，Aspose.Cells将使用与原字体同族的通用字体，默认为空。
...
当 Excel 中的字符是 unicode 且未在单元格样式中设置正确的字体时，它们可能会在 PDF 和图像中显示为块。
