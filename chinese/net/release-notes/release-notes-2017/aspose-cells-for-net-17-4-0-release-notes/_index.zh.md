...
type: docs
weight: 90
url: /zh/net/aspose-cells-for-net-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 17.4.0](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.4.0/).
...
|CELLSNET-45281|迷你图在渲染为 PDF 后消失|强化|
|CELLSNET-45280|重新保存文件后迷你图消失|强化|
|CELLSNET-44438|将 CSV 保存为 PDF 时出现 OutOfMemoryException|表现|
...
|CELLSNET-45262|将工作表另存为 HTML，单元格中文本溢出|漏洞|
|CELLSNET-45248|某些文本重叠或不可见，并且在 Excel 到 HTML 呈现中垂直对齐不正确|漏洞|
|CELLSNET-45229|当 HTML 保存为 XLSX 时，文本布局不同|漏洞|
|CELLSNET-45228|当 HTML 保存为 XLSX 时，文本格式发生变化|漏洞|
|CELLSNET-45227|HTML 另存为 XLSX 时，部分内容丢失|漏洞|
|CELLSNET-45195|加载 HTML 并保存为 XLSX 时，段落丢失和更改|漏洞|
...
|CELLSNET-45265|输出图像/PDF 中的字体已更改|漏洞|
|CELLSNET-45235|Excel 和 Aspose.Cells Pdfs 之间的轻微垂直对齐差异|漏洞|
|CELLSNET-45272|字体不同，输出的 PDF 文件中缺少百分号|漏洞|
|CELLSNET-45233|图表有“轴标题”|漏洞|
|CELLSNET-45232|3D 柱形图在输出 PDF 文件中呈现不正确|漏洞|
|CELLSNET-45188|类别轴标签未在输出 PDF 中显示图表|漏洞|
|CELLSNET-45292|在 XLSM 中删除工作表会在 vba 项目中留下一张残留表|漏洞|
...
|CELLSNET-45252|在特定的 XLS 中重新保存后，表格样式已更改（表格行丢失）|漏洞|
...
|CELLSNET-44975|将 Excel 转换为 PDF 时形状文本内的格式错误|例外|
|CELLSNET-45266|VbaProject.Sign 导致异常|例外|
|CELLSNET-45239|将图片重新添加到同一个 XLS 会引发 Null Reference 错误|例外|
### **公共 API 和向后不兼容的更改**
...
- [设置列标题提示](/cells/zh/net/set-column-header-tip/)
