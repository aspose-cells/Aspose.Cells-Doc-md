...
type: docs
weight: 80
url: /zh/net/aspose-cells-for-net-17-5-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 17.5](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.5/).
...
- [将源工作表中的页面设置设置复制到目标工作表](/cells/zh/net/copy-page-setup-settings-from-source-worksheet-into-destination-worksheet/)
- [实现工作表的自定义纸张大小以进行渲染](/cells/zh/net/implement-custom-paper-size-of-worksheet-for-rendering/)
- [删除 Excel 文件中工作表的现有打印机设置](/cells/zh/net/remove-existing-printersettings-of-worksheets-in-excel-file/)
