...
type: docs
weight: 20
url: /zh/net/aspose-cells-for-net-17-11-release-notes/
---
{{% alert color="primary" %}} 
...
- [将智能艺术转换为组形](/cells/zh/net/convert-the-smart-art-to-group-shape/)
- [使用 Aspose.Cells 创建共享工作簿](/cells/zh/net/create-shared-workbook-with-aspose-cells/)
- [确定形状是否为智能艺术形状](/cells/zh/net/determine-if-shape-is-smart-art-shape/)
...
- [密码保护或取消保护共享工作簿](/cells/zh/net/password-protect-or-unprotect-the-shared-workbook/)
...
- [EnableClipboardCopyPaste 和 PasteType GridDesktop 属性的复制粘贴行为](/cells/zh/net/copy-paste-behavior-of-enableclipboardcopypaste-and-pastetype-griddesktop-properties/)
