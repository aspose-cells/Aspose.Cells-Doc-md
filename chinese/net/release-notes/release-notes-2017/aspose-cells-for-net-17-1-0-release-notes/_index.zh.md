...
type: docs
weight: 120
url: /zh/net/aspose-cells-for-net-17-1-0-release-notes/
---
|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
|CELLSNET-44747|无法通过 Aspose.Cells API 打开包含瀑布图的 MS Excel 2016 XLSX 文件|新功能|
|CELLSNET-44940|将工作表绑定到自定义集合对象 (Aspose.Cells.GridWeb)|新功能|
|CELLSNET-44939|在运行时将工作表绑定到数据集对象 (Aspose.Cells.GridWeb)|新功能|
|CELLSNET-44597|将 HTML 文件转换为 Excel 文件格式时输出 Excel 文件不好|强化|
...
|CELLSNET-45000|导入 HTML 时忽略了一些 CSS 规则|漏洞|
...
|CELLSNET-44968|XLSX 中的合并单元格在 HTML 中不显示为合并|漏洞|
|CELLSNET-44962|将电子表格转换为 PDF 后，数据透视表中缺少水平线和垂直线|漏洞|
...
|CELLSNET-43815|艺术字对象在输出 PDF 中变成单纯的点|漏洞|
|CELLSNET-44976|与 MS Excel 文件不同，面积图在 PDF 输出的末尾倾斜|漏洞|
|CELLSNET-44969|图表图像中出现不必要的线条|漏洞|
|CELLSNET-44941|文化设置不适用于输出图表的图像|漏洞|
|CELLSNET-44938|将电子表格转换为 PDF 时，图形未正确呈现|漏洞|
|CELLSNET-44919|Aspose.Cells 生成的图像在插入 Docx 时会变形|漏洞|
...
|CELLSNET-43725|使用外部数据范围调整 XLSM 中 ListObject 的大小会使结果损坏|漏洞|
|CELLSNET-43580|由于输出 PDF 中的颜色/样式已更改，因此无法正确打印此艺术字水印|漏洞|
|CELLSNET-43562|当 XLSX 转换为 ODS 时，列筛选丢失|漏洞|
|CELLSNET-43405|将 XLS 文件格式转换为 XLSX 文件格式后，函数的文本损坏且艺术字文本变为白色|漏洞|
|CELLSNET-43404|转换为 XLSX 文件格式后，XLS 文件中的艺术字文本格式发生变化|漏洞|
|CELLSNET-41938|XLS 文件的格式问题（关于艺术字）|漏洞|
|CELLSNET-41708|向使用 Aspose.Cells 创建的形状 (TextBox) 添加 3D 效果时出现问题|漏洞|
|CELLSNET-41164|Excel 到 PDF 渲染中的 SmartArt 支持|漏洞|
