...
type: docs
weight: 60
url: /zh/net/aspose-cells-for-net-17-7-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 17.7](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.7/).

{{% /alert %}} 

|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
|CELLSNET-45437|在 Excel 中支持俄语区域设置中的错误和布尔值到 PDF 渲染|新功能|
...
|CELLSNET-45396|将 Excel 文件转换为 HTML 时出现格式错误|漏洞|
...
|CELLSNET-45364|一些形状/对象在输出 PDF 中被剪切|漏洞|
...
|CELLSNET-45452|输出 PDF 中的迷你图未正确呈现|漏洞|
|CELLSNET-45493|调整 ListObject 的大小不会传递自定义格式|漏洞|
|CELLSNET-45482|提取和重新插入图像时，某些形状在 XLS 文件中丢失|漏洞|
...
|CELLSNET-45430|打开失败出现异常_至_已保存_在_xlsb_type.xlsx|例外|
### **公共 API 和向后不兼容的更改**
...
- [用俄语或任何其他语言实现错误和布尔值](/cells/zh/net/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
- [确定工作表的纸张大小是否为自动](/cells/zh/net/determine-if-paper-size-of-worksheet-is-automatic/)
- [在 GridDesktop 中呈现数据透视表](/cells/zh/net/render-pivottable-in-griddesktop/)
- [GridDesktop 工作表的自定义行和自定义列标题](/cells/zh/net/custom-row-and-custom-column-caption-of-griddesktop-worksheet/)
- [在运行时查找 GridDesktop 版本](/cells/zh/net/find-griddesktop-version-at-runtime/)
- [在浏览器窗口中调整 GridWeb 的大小](/cells/zh/net/resize-gridweb-in-the-browser-window/)
