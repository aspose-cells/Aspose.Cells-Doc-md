...
type: docs
weight: 40
url: /zh/net/aspose-cells-for-net-17-9-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 17.9](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-17.9/).
...
将表表示为连接的数据源。
#### **添加 OoxmlSaveOptions.EnableZip64 属性**
...
- [确定特定工作簿需要的堆栈大小](/cells/zh/net/aspose-cells-faqs/#aspose-cellsfaqs-determinewhichstacksizeisneededforacertainworkbook)
