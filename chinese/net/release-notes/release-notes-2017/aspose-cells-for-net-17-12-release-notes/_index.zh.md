...
type: docs
weight: 10
url: /zh/net/aspose-cells-for-net-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [如果太长，文本会从 GridDesktop 单元格溢出](/cells/zh/net/text-overflows-from-griddesktop-cell-if-it-is-too-long/)
- [更新天数在共享工作簿中保留修订日志的历史记录](/cells/zh/net/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
