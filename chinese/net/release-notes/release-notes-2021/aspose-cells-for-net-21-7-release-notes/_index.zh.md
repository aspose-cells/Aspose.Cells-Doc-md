...
type: docs
weight: 6
url: /zh/net/aspose-cells-for-net-21-7-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-48213|从 HTML 转换为 XLSX 时，富文本样式丢失|强化|
...
|CELLSNET-43625|Excel 中渲染形状到 PDF 转换的问题|漏洞|
|CELLSNET-43749|将电子表格呈现为 PDF 时更改标注位置|漏洞|
|CELLSNET-43766|圆形中的字符在输出 PDF 中稍微向左移动|漏洞|
...
|CELLSNET-43464|XLSX 到 PDF 的转换会生成更长的文档，其页数多于应有的页数|漏洞|
|CELLSNET-44706|电子表格到 PDF：形状错位或扭曲|漏洞|
|CELLSNET-45259|渲染的 emf 图像中缺少文本空间|漏洞|
|CELLSNET-45744|Aspose.Cells 在呈现 PDF 时不使用机器上安装的字体|漏洞|
|CELLSNET-46630|图形保存后变化|漏洞|
|CELLSNET-46758|一些字符在自动形状中被切断|漏洞|
|CELLSNET-46796|嵌入的 Gif 图像在 Excel 到 TIFF 转换中呈现为黑框|漏洞|
|CELLSNET-47090|XLSX 到 PDF 渲染问题|漏洞|
...
|CELLSNET-48144|Worksheet.Pictures.Add() 函数的高度和宽度比例对 TIFF 图像无效|漏洞|
...
|CELLSNET-48266|“参数无效。”将 XLSX 渲染为 HTML 时出现异常|例外|
|
