...
type: docs
weight: 3
url: /zh/net/aspose-cells-for-net-21-10-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-49132|以 XLS 文件格式打开包含 HTML 表格的文件|新功能|
...
|CELLSNET-49413|渲染 HTML 时删除不可见的形状|强化|
|CELLSNETCORE-135|应用程序在计算大文件和 UDF 时停止|表现|
|CELLSNET-49124|将 XLSM 转换为 HTML 时模糊的单选按钮|漏洞|
...
|CELLSNET-49195|XLSX 到 HTML 的转换不会保留不可见字符的序列|漏洞|
|CELLSNET-49245|当呈现为 HTML 时，特定 XLS 文件中的图像发生偏移|漏洞|
...
|CELLSNETCORE-226|在 Excel 到 EMF 转换期间呈现不必要的空白|漏洞|
...
|CELLSNET-48613|超出所选范围的资源不应导出为 HTML|漏洞|
...
|CELLSNET-49366|XLSB 格式的 Cell 数据验证输入字段问题|漏洞|
|CELLSNETCORE-269|HTML 表格中添加了高度过大的错误行|漏洞|
|CELLSNETCORE-270|Excel 一次保存为 HTML 时出现 HtmlString 字体问题|漏洞|
