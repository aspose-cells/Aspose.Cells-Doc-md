...
type: docs
weight: 20
url: /zh/net/aspose-cells-for-net-5-1-4-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 5.1.4](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-5.1.4/)
...
|**问题编号** |**零件** |**概括** |
|:- |:- |:- |
|20247 |消耗臭氧层物质|另存为 ODS 时公式出错|
|18357 | PDF格式|PIE 图上的转换问题|
|18925 | PDF格式|发布将 Excel 转换为 PDF|
...
|20181 |电子表格ML|使用超链接函数的单元格抛出异常|
|20519 |电子表格ML|未能将 Excel 2007 内容获取为 XML|
|20055 |Xls|公式包含'\r'|
