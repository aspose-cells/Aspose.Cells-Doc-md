...
type: docs
weight: 80
url: /zh/net/aspose-cells-for-net-8-0-1-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for .NET 8.0.1](https://downloads.aspose.com/cells/net/new-releases/aspose.cells-for-.net-8.0.1/)
