...
type: docs
weight: 50
url: /zh/net/aspose-cells-for-net-18-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46262|Cell 输出 PDF 中单元格文本方向倾斜时背景错误|漏洞|
|CELLSNET-44761|形状中的文本未在 PDF 中正确呈现|漏洞|
|CELLSNET-43916|将电子表格转换为 HTML 时缺少形状阴影|漏洞|
|CELLSNET-46251|将 XLSX 转换为 HTML 时应用程序挂起|漏洞|
|CELLSNET-46241|HTML 中的多行问题|漏洞|
|CELLSNET-46219|将 HTML 转换为 XLSX 时不遵循 HTML 标记的宽度|漏洞|
...
|CELLSNET-46276|Excel 到 PDF 的转换 - 添加了一个空白页面|漏洞|
|CELLSNET-46275|从 XLS 创建的大型 PDF|漏洞|
|CELLSNET-46259|将 Excel 转换为 PDF 添加直线|漏洞|
|CELLSNET-46255|Excel 到 PDF 渲染中的页码问题（在页脚中）|漏洞|
|CELLSNET-46238|加密 ODS 文件加载失败|漏洞|
|CELLSNET-46231|列单元格中的文本在输出 PDF 中未正确呈现|漏洞|
...
|CELLSNET-43563|XLSX 转换为 ODS 时图表丢失|漏洞|
|CELLSNET-41002|公式在格式转换过程中消失（XLSX -> XLS）|漏洞|
|CELLSNET-46277|计算公式时出现异常|例外|
|CELLSNET-46249|读取 HTML 文件时抛出异常|例外|
|CELLSNET-46246|GroupDocs云平台服务器添加数字签名异常|例外|
|CELLSNET-46232|加载 XLSX 文件时单元格名称异常无效|例外|
### **公共 API 和向后不兼容的更改**
