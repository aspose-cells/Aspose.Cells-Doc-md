...
type: docs
weight: 60
url: /zh/net/aspose-cells-for-net-18-7-release-notes/
---
{{% alert color="primary" %}} 
...
|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
|CELLSNET-46046|圆形图像在输出 PDF 中变为方形图像|新功能|
|CELLSNET-43538|支持数据透视表切片器|新功能|
|CELLSNET-41946|处理切片器和数据透视表|新功能|
|CELLSNET-46163|支持加解密ODS文件|新功能|
