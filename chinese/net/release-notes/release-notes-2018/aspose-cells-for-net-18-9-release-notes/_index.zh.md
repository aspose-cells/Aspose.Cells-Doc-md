...
type: docs
weight: 40
url: /zh/net/aspose-cells-for-net-18-9-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46315|支持 ODS 文件中的股票图表|新功能|
...
|CELLSNET-46290|在 Excel 到 PDF 转换中为形状渲染的颜色错误|漏洞|
|CELLSNET-46282|以 PDF 格式呈现的相当小的图像|漏洞|
...
|CELLSNET-46327|转换为 SVG 时的命名范围，不捕获确切的字体和间距|漏洞|
...
|CELLSNET-46305|以 PDF 呈现的绝版文本区域|漏洞|
