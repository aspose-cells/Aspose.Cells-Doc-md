...
type: docs
weight: 1
url: /zh/net/aspose-cells-for-net-22-12-release-notes/
---
{{% alert color="primary" %}}
...
|CELLSNET-47895|图像在 Excel 中扭曲为 PDF/HTML 渲染|
...
|CELLSNET-52330|绘制形状在 HTML 中呈现不佳|
...
|CELLSNET-52301|XLSX 图表到图像：自定义组合图表条呈现不当|
|CELLSNET-52336|直方图在 XLSX 到 HTML/PDF 的转换中未正确呈现|
|CELLSNET-52292|文本显示在输出 PDF 的错误页面上 - Excel 到 PDF 的转换|
|CELLSNET-52367|AutofitRows 导致 PDF 转换输出中的文本被剪切|
|CELLSNET-52242|将 Excel 转换为 JSON 时父子层次结构不正确，反之亦然|
|CELLSNET-52281|Json header不可忽略|
|CELLSNET-52289|html转excel时数字格式丢失|
|CELLSNET-52298|重新保存 XLSX 时为数据透视字段启用自动排序选项|
|CELLSNET-52299|保存工作簿后 HasRevisions 属性不正确|
|CELLSNET-52332|转换为 html 时，数字显示为“#”或科学数字|
