...
type: docs
weight: 60
url: /zh/net/aspose-cells-for-net-19-7-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46802|XLS 中呈现的图表与 PDF 中的图表不同|漏洞|
|CELLSNET-46806|组合图错误地呈现为 PDF|漏洞|
|CELLSNET-41449|具有复杂数据透视表文件的 XLSB|漏洞|
|CELLSNET-43921|将 XLSX 渲染为 XLSB 会产生损坏的文件|漏洞|
|CELLSNET-44593|将 HTML 转换为 Excel 时输出 Excel 文件不好|漏洞|
|CELLSNET-46794|Cells HTML 转换为 XLSX 时发生偏移|漏洞|
...
|CELLSNET-46664|HeadingPairs 和 TitlesOfParts 标签在将清理后的 XLS 转换回 XLSM 文件格式后再次恢复|漏洞|
|CELLSNET-46782|Smart Marker 不更新跨表公式参考|漏洞|
|CELLSNET-46784|智能标记 - 显示具有属性的 JSON 列表对象的问题|漏洞|
...
|CELLSNET-46803|加载 XLSX 文件时出现异常“对象引用未设置为对象的实例”|例外|
### **公共 API 和向后不兼容的更改**
