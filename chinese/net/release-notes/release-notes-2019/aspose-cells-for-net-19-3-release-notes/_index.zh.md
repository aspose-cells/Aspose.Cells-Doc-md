...
type: docs
weight: 100
url: /zh/net/aspose-cells-for-net-19-3-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46597|Excel 中 PDF 中的错误值到 PDF 渲染|漏洞|
|CELLSNET-46613|获取和创建命名范围时出现问题|漏洞|
|CELLSNET-46625|输出 PDF 和 HTML 中的表格背景错误|漏洞|
|CELLSNET-46628|输出 PDF 的差异|漏洞|
|CELLSNET-46589|从 MS Excel 工作表转换的 SVG 中出现意外的网格线|漏洞|
...
|CELLSNET-46635|ODS 文件中的分页符太多（XLSX 到 ODS 渲染）|漏洞|
