...
type: docs
weight: 50
url: /zh/net/aspose-cells-for-net-19-8-release-notes/
---
{{% alert color="primary" %}} 
...
|CELLSNET-46827|XLSX 到 ODS 转换中缺少内容|漏洞|
|CELLSNET-46833|形状在 Excel 到 PDF 转换中失真|漏洞|
|CELLSNET-46835|绘图形状在 Excel 到 PDF 渲染中未正确渲染|漏洞|
|CELLSNET-46848|将 Excel 中的阿拉伯文本转换为 PDF 的问题|漏洞|
|CELLSNET-44973|无法设置数据透视表单元格的填充颜色|漏洞|
|CELLSNET-46818|保存为 HTML 时并非所有样式都导出|漏洞|
|CELLSNET-46824|数据透视表源数据更新后数据透视表损坏|漏洞|
|CELLSNET-46820|智能标记分组数据问题|漏洞|
|CELLSNET-46840|Workbook.RemoveUnusedStyles 方法的问题|漏洞|
|CELLSNET-46853|某些列在 Excel 到 PDF 渲染中呈现为红色|漏洞|
|CELLSNET-46829|DBConnection 对象没有为 DBConnection.ConnectionInfo 提供值|漏洞|
|CELLSNET-46830|读取和写入查询|漏洞|
|CELLSNET-46841|打开带有 Aspose 错误的特定 XLS 文件|漏洞|
...
|CELLSNET-46858|XLSX 到 ODS 的转换改变了课本中的文本字体|漏洞|
|CELLSNET-46859|打印预览不显示从 XLSX 转换的 ODS 文件中的文本框|漏洞|
|CELLSNET-46723|加密ODS文件从SheetRender获取Image时抛出异常|例外|
...
|CELLSNET-46831|将 Excel 文件渲染为 PDF 时出现异常|例外|
|CELLSNET-46844|Workbook.CalculateFormula() 导致 NullReferenceException|例外|
|CELLSNET-46832|加载 XLSX 文件格式时出现异常“无效的 MsoLineDashStyle 字符串值”|例外|
### **公共 API 和向后不兼容的更改**
