...
![待办事项：图像_替代_文本](add-custom-server-side-function-validation_1.png)

![待办事项：图像_替代_文本](add-custom-server-side-function-validation_2.png)

![待办事项：图像_替代_文本](add-custom-server-side-function-validation_3.png)

![待办事项：图像_替代_文本](add-custom-server-side-function-validation_4.png)

![待办事项：图像_替代_文本](add-custom-server-side-function-validation_5.png)
## **示例代码**
