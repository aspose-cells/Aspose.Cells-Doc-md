...
![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_1.png)
...
![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_2.png)
### **复制单列**
以下示例使用一个包含一列的现有电子表格和一个对列中所有值求和的简单公式。以下是复制列之前电子表格在 Aspose.Cells.GridWeb 界面中的显示方式。

![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_3.png)
...
![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_4.png)
...
![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_5.png)

![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_6.png)
### **复制多列**
...
![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_7.png)

![待办事项：图像_替代_文本](copy-gridweb-rows-and-columns_8.png)
