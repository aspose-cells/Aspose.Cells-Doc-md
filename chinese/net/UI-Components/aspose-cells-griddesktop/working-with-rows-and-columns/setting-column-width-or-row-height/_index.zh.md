...
type: docs
weight: 60
url: /zh/net/aspose-cells-griddesktop/set-column-width-or-row-height/
description: 本文介绍了如何使用 Aspose.Cells.GridDesktop API 设置列宽和行高。
keywords: GridDesktop，设置，宽度，列，行，高度
---

{{% alert color="primary" %}} 

本主题讨论了如何使用 Aspose.Cells.GridDesktop API 设置列宽和行高。有时，工作表单元格中包含的值比原始单元格宽。这使得用户难以阅读单元格内容。有些用户不喜欢使用右箭头键查看单元格中的完整值。为了解决这些问题，开发人员可以改变列宽。更改行高可以解决类似的问题。

{{% /alert %}} 
## **如何设置列宽**
使用 Aspose.Cells.GridDesktop 设置列宽：
