---
title: 使用 Aspose.Cells 加密 Excel 文件
type: docs
weight: 30
...
![待办事项：图像_替代_文本](encrypting-excel-files-using-aspose-cells_1.png)
...
![待办事项：图像_替代_文本](encrypting-excel-files-using-aspose-cells_2.png)
