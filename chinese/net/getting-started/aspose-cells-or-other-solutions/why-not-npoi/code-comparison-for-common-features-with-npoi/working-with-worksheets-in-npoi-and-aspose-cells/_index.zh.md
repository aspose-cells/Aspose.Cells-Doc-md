---
title: 在NPOI和Aspose.Cells中使用工作表
type: docs
weight: 40
...
- [在工作表中添加批注](/cells/zh/net/add-comment-in-worksheet/)
- [在工作表中添加图像](/cells/zh/net/add-image-in-worksheet/)
- [在工作表中自动调整列宽](/cells/zh/net/auto-fit-columns-in-worksheet/)
...
- [设置工作表缩放比例](/cells/zh/net/set-worksheet-zoom-factor/)
