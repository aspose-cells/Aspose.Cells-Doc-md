...
下表总结了 Aspose.Cells for .NET 功能并提供了指向详细功能描述的链接。

{{% /alert %}} 
## **支持的平台**
Aspose.Cells for .NET 产品涵盖了大部分流行的开发环境和部署平台。
...
|[将工作表转换为图像和工作表逐页转换为图像](/cells/zh/net/converting-worksheet-to-image-and-worksheet-to-image-by-page/)|电子表格也可以导出为具有任何所需压缩类型的标记图像文件格式 (TIFF)。|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
## **渲染和打印**
