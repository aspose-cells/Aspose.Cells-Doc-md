...
type: docs
weight: 10
url: /zh/java/aspose-cells-for-java-2-4-3-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 2.4.3](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-2.4.3/)
...
|20913 |消耗臭氧层物质|读取自动过滤器|
|21073 |Xls|复制单元格|
|21164 |Xls|读取Excel2003文件|
|21155 |Xls2PDF|渲染形状/汉字|
|21283 |Xls|第一/偶数/奇数页的不同页眉/页脚|
|21480 | Xlsx|阅读风格|
|21481 |消耗臭氧层物质|整行/列引用，如“B:B”或“1:1”|
|20635 |图表|检查无效数据源|
|21580 |Xls|自动过滤|
|21679 |消耗臭氧层物质|读取模板文件|
|21703 |Xls|数字格式|
|21686 |Xls|读取文档属性|
