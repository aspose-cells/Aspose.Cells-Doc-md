...
type: docs
weight: 60
url: /zh/java/aspose-cells-for-java-8-4-2-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 8.4.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.4.2/)
...
(CELLSJAVA-41317) - 在 Excel 中通过“全部大写”功能创建的大写字符未保留在 PDF 中

(CELLSJAVA-41315) - 第 5 页中的形状呈现不正确

(CELLSJAVA-41308) - 将电子表格呈现为 PDF 格式时形状位置错误

(CELLSJAVA-41282) - 在将带有绘图的电子表格转换为 PDF 时箭头被放大

(CELLSJAVA-41249) - 艺术字在输出 PDF 文件中呈现不佳

(CELLSJAVA-41243) - 在将电子表格转换为 PDF 时，形状中的水平文本呈现为垂直

(CELLSJAVA-41242) - 将电子表格呈现为 PDF 时绘图混乱

(CELLSJAVA-41241) - 在将电子表格呈现为 PDF 时，圆形会转换为椭圆形

(CELLSJAVA-41233) - Excel 模板中的绘图对象和形状在使用 Aspose.Cells 的输出 PDF 中呈现不佳
...
(CELLSJAVA-41316) - 复制工作簿时渲染的 HTML 文件中缺少一些数据标签

(CELLSJAVA-41314) - 图表中的数据标签未显示在呈现的 EMF 图像中

(CELLSJAVA-41311) - 转换为 EMF 时缺少图表的轴标签

(CELLSJAVA-41301) - excel 中“智能艺术”中的希伯来字符在 PDF 再现中得到镜像
...
(CELLSJAVA-41275) - 在将图表转换为图像时，生成的 EMF 中缺少两个轴标签
