...
type: docs
weight: 30
url: /zh/java/aspose-cells-for-java-8-5-2-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 8.5.2](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-8.5.2/)
