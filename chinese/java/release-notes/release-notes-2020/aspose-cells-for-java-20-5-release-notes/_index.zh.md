...
type: docs
weight: 20
url: /zh/java/aspose-cells-for-java-20-5-release-notes/
---
{{% alert color="primary" %}}

此页面包含发行说明[Aspose.Cells for Java 20.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.5/).
...
|CELLSJAVA-43166|旋转的文本在 XLSX 到 HTML 的转换中呈现不正确|漏洞|
