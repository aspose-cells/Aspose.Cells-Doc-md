...
type: docs
weight: 10
url: /zh/java/aspose-cells-for-java-20-6-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 20.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-20.6/).
...
|CELLSJAVA-43181|Excel转HTML时行高的区别|漏洞|
