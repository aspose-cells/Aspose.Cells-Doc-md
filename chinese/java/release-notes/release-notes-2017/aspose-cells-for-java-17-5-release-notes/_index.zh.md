...
type: docs
weight: 80
url: /zh/java/aspose-cells-for-java-17-5-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 17.5](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.5/).
...
- [将 Excel 文件转换为与 PDFA-1a 兼容的 PDF 格式](/cells/zh/java/convert-excel-file-to-pdf-format-compatible-with-pdfa-1a/)
...
- [插入 Cells 数据表行时将第一行向下移动](/cells/zh/java/shift-first-row-down-when-inserting-cells-data-table-rows/)
