...
type: docs
weight: 50
url: /zh/java/aspose-cells-for-java-17-8-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 17.8](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.8/).
...
- [将数字签名添加到已签名的 Excel 文件](/cells/zh/java/add-digital-signature-to-an-already-signed-excel-file/)
- [保存为 HTML 时禁用下层显示评论](/cells/zh/java/disable-downlevel-revealed-comments-while-saving-to-html/)
- [将 Excel 文件保存为 Html 时导出注释](/cells/zh/java/export-comments-while-saving-excel-file-to-html/)
- [无内容打印时输出空白页](/cells/zh/java/output-blank-page-when-there-is-nothing-to-print/)
