...
type: docs
weight: 10
url: /zh/java/aspose-cells-for-java-17-12-release-notes/
---
{{% alert color="primary" %}} 
...
- [更新天数在共享工作簿中保留修订日志的历史记录](/cells/zh/java/update-days-preserving-history-of-revision-logs-in-shared-workbook/)
