...
type: docs
weight: 70
url: /zh/java/aspose-cells-for-java-17-6-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 17.6](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.6/).
...
- [平铺图片作为形状内的纹理](/cells/zh/java/tile-picture-as-a-texture-inside-the-shape/)
- [使用 GridWeb 的 OnAjaxCallFinishedClientFunction](/cells/zh/java/using-onajaxcallfinishedclientfunction-of-gridweb/)
- [在智能标记字段中使用公式参数](/cells/zh/java/using-formula-parameter-in-smart-marker-field/)
