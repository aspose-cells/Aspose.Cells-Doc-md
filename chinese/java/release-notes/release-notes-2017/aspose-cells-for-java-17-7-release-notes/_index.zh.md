...
type: docs
weight: 60
url: /zh/java/aspose-cells-for-java-17-7-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 17.7](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.7/).
...
- [用俄语或任何其他语言实现错误和布尔值](/cells/zh/java/implement-errors-and-boolean-value-in-russian-or-any-other-language/)
