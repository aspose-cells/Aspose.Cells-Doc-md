...
type: docs
weight: 90
url: /zh/java/aspose-cells-for-java-17-4-0-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 17.4.0](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.4.0/).
...
- [密码保护Excel工作簿的VBA项目](/cells/zh/java/password-protect-the-vba-project-of-excel-workbook/)
- [查看 VBA 项目是否受保护](/cells/zh/java/find-out-if-vba-project-is-protected/)
- [检查 VBA 项目是否受保护并锁定以供查看](/cells/zh/java/check-if-vba-project-is-protected-and-locked-for-viewing/)
