...
type: docs
weight: 30
url: /zh/java/aspose-cells-for-java-17-10-release-notes/
---
{{% alert color="primary" %}} 

此页面包含发行说明[Aspose.Cells for Java 17.10](https://downloads.aspose.com/cells/java/new-releases/aspose.cells-for-java-17.10/).
...
- [XLSB文件的读写外部连接](/cells/zh/java/read-and-write-external-connection-of-xlsb-or-xls-file/)
- [中断或取消工作簿的公式计算](/cells/zh/java/interrupt-or-cancel-the-formula-calculation-of-workbook/)
- [使用 HtmlCrossType 指定如何在输出 HTML 中交叉字符串](/cells/zh/java/specify-how-to-cross-string-in-output-html-using-htmlcrosstype/)
