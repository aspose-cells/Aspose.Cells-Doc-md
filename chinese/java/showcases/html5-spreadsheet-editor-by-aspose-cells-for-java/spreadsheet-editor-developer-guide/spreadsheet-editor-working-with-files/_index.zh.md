...
![待办事项：图像_替代_文本](1e2sfo0.png)

**这个怎么运作？**

这**从 Dropbox 打开**按钮使用**Dropbox JavaScript 选择器 API**打开 Dropbox 选择器对话框。 Chooser 提供所选文件的 URL，该 URL 由回调函数捕获并发送回服务器。服务器从 URL 创建一个电子表格实例，初始化一些内务处理的东西，并将 DOM 更新发送回浏览器。浏览器呈现并刷新 HTML，用户准备好编辑加载的文档。
### **从网址打开**
...
当服务器端准备好电子表格时，JSF 组件用于生成新的 HTML 并将 DOM 更新发送给用户，这些更新由 Web 浏览器呈现。
