...
description: 使用Java代码锁定和解锁Excel文件的工作簿结构。使用Aspose.Cells for Java锁定和解锁Excel（xlsx，xls，xsb）和Open office calc（ODS）文件。
---
