...
---
## **可能的使用场景**
如果要删除 Microsoft Excel 中的切片器，只需选择它并按*删除*按钮。同样，如果您想以编程方式使用 Aspose.Cells API 将其删除，请使用[工作表.getSlicers().remove()](https://reference.aspose.com/cells/java/com.aspose.cells/slicercollection#remove\(com.aspose.cells.Slicer\)） 方法。它将从工作表中删除切片器。
## **删除切片器**
