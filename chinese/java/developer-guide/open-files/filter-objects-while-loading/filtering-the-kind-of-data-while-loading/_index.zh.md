...
![待办事项：图片_替代_文本](filtering-the-kind-of-data-while-loading-the-workbook-from-template-file_1.png)

以下屏幕截图显示了[输出 PDF](5472554.pdf)您可以从给定的链接下载。在这里您可以看到，红色和黄色背景的数据不存在，但所有形状都在那里。

![待办事项：图片_替代_文本](filtering-the-kind-of-data-while-loading-the-workbook-from-template-file_2.png)
