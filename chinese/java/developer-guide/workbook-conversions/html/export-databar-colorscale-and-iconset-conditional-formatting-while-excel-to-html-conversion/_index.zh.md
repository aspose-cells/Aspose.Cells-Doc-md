...
![待办事项：图像_替代_文本](conversion_1.png)

以下屏幕截图显示了 Aspose.Cells 输出 HTML 文件，其中显示了 DataBar、ColorScale 和 IconSet 条件格式。如您所见，它看起来与[示例 excel 文件](5473447.xlsx).

![待办事项：图像_替代_文本](conversion_2.png)
## **示例代码**
以下示例代码将示例 excel 文件转换为正常的 HTML[Excel 到 HTML 转换](/cells/zh/java/converting-workbook-to-different-formats/#convertingworkbooktodifferentformats-convertingexcelfilestohtml).
