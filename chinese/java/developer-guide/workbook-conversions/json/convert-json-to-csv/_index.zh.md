...
下面的代码示例演示了使用[**JsonLayoutOptions**](https://reference.aspose.com/cells/java/com.aspose.cells/JsonLayoutOptions)和[**Json工具**](https://reference.aspose.com/cells/java/com.aspose.cells/JsonUtility)加载的类[源 JSON 文件](SampleJson.json)并生成[输出 CSV 文件](SampleJson_out.csv).
