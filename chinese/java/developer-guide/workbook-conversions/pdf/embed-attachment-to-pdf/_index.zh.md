...
通常，在转换为PDF时，OLE对象将呈现为图标或缩略图，而不包含OLE对象源数据。使用选项[PdfSaveOptions.EmbedAttachments](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions/#setEmbedAttachments-boolean-)，您可以将OLE对象源数据嵌入到PDF中的附件中。您可以在PDF中双击图标或缩略图以打开OLE对象的源文件。
