...
默认情况下，Aspose.Cells 将 Excel 保存为标准大小的 PDF。但是，您也可以使用 Minimum size 保存它[PdfSaveOptions.优化类型](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#OptimizationType)财产。它接受以下值
