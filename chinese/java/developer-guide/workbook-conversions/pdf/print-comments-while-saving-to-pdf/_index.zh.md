...
type: docs
weight: 180
url: /zh/java/print-comments-while-saving-to-pdf/
---
{{% alert color="primary" %}}

Microsoft Excel 允许您使用以下选项在打印或保存为 PDF 格式时打印注释
...
Aspose.Cells 提供以下枚举支持保存PDF时打印注释
...
下面的示例代码说明了如何使用[**打印注释类型**](https://reference.aspose.com/cells/java/com.aspose.cells/printcommentstype)枚举以在保存为 PDF 时打印注释。
