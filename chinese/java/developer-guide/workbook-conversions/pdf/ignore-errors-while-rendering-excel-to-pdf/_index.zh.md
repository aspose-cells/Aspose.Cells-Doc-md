...
下面的代码加载[示例 Excel 文件](55541813.xlsx)但示例 Excel 文件是错误的，并在执行过程中抛出错误[转换为 PDF](55541814.pdf)在 17.11 但因为我们正在使用[**PdfSaveOptions.IgnoreError**](https://reference.aspose.com/cells/java/com.aspose.cells/pdfsaveoptions#IgnoreError)属性，它不会抛出错误。但是，此屏幕截图中显示的一个圆形红色箭头状形状丢失了。
