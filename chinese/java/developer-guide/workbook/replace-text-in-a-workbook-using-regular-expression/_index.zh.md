...
以下代码片段演示了使用[**RegexKey**](https://reference.aspose.com/cells/java/com.aspose.cells/replaceoptions#RegexKey)属性，使用[样本Excel文件](SampleRegexReplace.xlsx)。以下代码片段生成的[输出文件](RegexReplace_out.xlsx)附在下面供参考。
