...
### **隐藏行或列**
开发人员可以通过调用[Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells)集合的[HideRow](https://reference.aspose.com/cells/java/com.aspose.cells/cells#hideRow\(int\))和[HideColumn](https://reference.aspose.com/cells/java/com.aspose.cells/cells#hideColumn\(int\))方法来隐藏行或列。这两种方法分别接受行/列索引作为参数，以隐藏特定的行或列。
