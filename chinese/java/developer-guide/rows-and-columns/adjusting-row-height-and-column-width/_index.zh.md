...
### **设置行高**
可以通过调用 [Cells](https://reference.aspose.com/cells/zh/java/com.aspose.cells/Cells) 集合的 [setRowHeight](https://reference.aspose.com/cells/zh/java/com.aspose.cells/cells#setRowHeight-int-double-) 方法来设置单个行的高度。 [setRowHeight](https://reference.aspose.com/cells/zh/java/com.aspose.cells/cells#setRowHeight-int-double-) 方法接受以下参数：
...
## **使用列**
### **设置列的宽度**
调用 [Cells](https://reference.aspose.com/cells/zh/java/com.aspose.cells/Cells) 集合的 [setColumnWidth](https://reference.aspose.com/cells/zh/java/com.aspose.cells/cells#setColumnWidth-int-double-) 方法可以设置列的宽度。该方法接受以下参数：
