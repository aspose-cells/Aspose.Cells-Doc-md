...
要拍摄某个范围的图像，请将打印区域设置为所需范围，然后将所有边距设置为 0。同时设置[**ImageOrPrintOptions.setOnePagePerSheet() 方法**](https://reference.aspose.com/cells/java/com.aspose.cells/imageorprintoptions#OnePagePerSheet)至**真的**.
