...
|[**CSV**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#CSV)|代表一个CSV文件|
...
|[**XLAM**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#XLAM)|表示一个 Excel XLAM 文件|
|[**TSV**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#TSV)|表示制表符分隔值文件|
...
|[**M_HTML**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#M_HTML)|代表一个 MHTML 文件|
|[**ODS**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#ODS)|表示 OpenDocument 电子表格文件|
|[**EXCEL_97_TO_2003**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#EXCEL_97_TO_2003)|表示 XLS 文件，该文件是 Excel 1997 到 2003 修订版的默认格式|
|[**电子表格_ML**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#SPREADSHEET_ML)|表示一个 SpreadSheetML 文件|
|[**XLSB**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#XLSB)|表示 Excel 2007 二进制 XLSB 文件|
...
|[**XPS**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#XPS)|表示 XML 纸张规范 (XPS) 文件|
|[**TIFF**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#TIFF)|表示标记图像文件格式 (TIFF) 文件|
...
|[**MARKDOWN**](https://reference.aspose.com/cells/java/com.aspose.cells/saveformat#MARKDOWN)|代表降价文件。|
...
您可以修改相同的示例以将文件保存到 CSV。默认情况下，[**TxtSaveOptions.分隔符**](https://reference.aspose.com/cells/java/com.aspose.cells/txtsaveoptions#Separator)是逗号，所以保存为CSV格式时不要指定分隔符。
