...
type: docs
weight: 200
url: /zh/java/how-to-set-print-area/
description: 本文展示了如何使用Aspose.Cells库设置打印区域的代码。
keywords: 限制打印范围、设置打印区域、清除打印区域、用Java设置和清除打印区域、如何在Java中设置和清除打印区域、在Excel中设置和清除打印区域的方法。
---
...
要在指定工作表中设置打印区域：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的[**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/)对象的[**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-)属性。将该属性设为一个范围字符串，即可设置打印区域。
...
要在指定工作表中清除打印区域：首先加载[示例文件](input.xlsx)，然后需要修改目标工作表的[**PageSetup**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/)对象的[**Worksheet.getPageSetup().setPrintArea()**](https://reference.aspose.com/cells/java/com.aspose.cells/pagesetup/#setPrintArea-java.lang.String-)属性。将该属性设置为空字符串，即可清除打印区域。
