...
通过设置隐藏滚动条[**工作簿**](https://reference.aspose.com/cells/java/com.aspose.cells/workbook)班级'[**设置VScrollBar可见**](https://reference.aspose.com/cells/java/com.aspose.cells/workbooksettings#IsVScrollBarVisible)要么[**设置 HScrollBar 可见**](https://reference.aspose.com/cells/java/com.aspose.cells/workbooksettings#IsHScrollBarVisible)方法**错误的**.

### **使滚动条可见**

通过设置工作簿类使滚动条可见'[**设置VScrollBar可见**](https://reference.aspose.com/cells/java/com.aspose.cells/workbooksettings#IsVScrollBarVisible)要么[**设置 HScrollBar 可见**](https://reference.aspose.com/cells/java/com.aspose.cells/workbooksettings#IsHScrollBarVisible)方法**真的**.
