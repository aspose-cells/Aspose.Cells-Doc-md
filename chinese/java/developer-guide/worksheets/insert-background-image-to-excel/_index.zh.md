...
type: docs
weight: 90
url: /zh/java/insert-background-image-to-excel/
description: 如何使用 Aspose.Cells 将背景图像插入 Excel for Java
---
{{% alert color="primary" %}} 
...
![待办事项：图片_替代_文本](set-background-picture-for-a-worksheet_1.jpg)
