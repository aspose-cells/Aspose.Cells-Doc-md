...
为了模仿Excel调整数据标签形状以适应文本的功能，Aspose.Cells API已经暴露了布尔类型 [**DataLabels.ResizeShapeToFitText**](https://reference.aspose.com/cells/java/com.aspose.cells/datalabels#IsResizeShapeToFitText) 属性。以下代码片段展示了 [**DataLabels.ResizeShapeToFitText**](https://reference.aspose.com/cells/java/com.aspose.cells/datalabels#IsResizeShapeToFitText) 属性的简单使用场景。
