...
您可以向图表系列的数据点添加自定义标签。Aspose.Cells提供了[ChartPoint.getDataLabels().setText()](https://reference.aspose.com/cells/java/com.aspose.cells/datalabels#Text) 属性来添加这些自定义标签。本文将解释如何使用此属性将自定义标签添加到图表系列的数据点。
