---
title: 如何创建旭日图表
description: 学习如何在 Aspose.Cells for Java 中创建一个太阳图表，该图表以圆形呈现数据。我们的指南将帮助您设置图表的各种属性和格式，包括数据标签、图例、颜色等。
keywords: Aspose.Cells for Java，太阳图表，创建，设置属性，数据标签，图例，格式，颜色，圆形，数据呈现。
type: docs
weight: 162
