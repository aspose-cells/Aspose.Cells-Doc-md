...
您可以使用更改 excel 文本框或形状的字符间距[字体设置.TextOptions.Spacing](https://reference.aspose.com/cells/java/com.aspose.cells/textoptions#Spacing)财产。

{{% /alert %}} 
## **更改 Excel 文本框或形状的字符间距**
下面的示例代码将excel文件中文本框的字符间距修改为点4，然后保存到磁盘中。
