...
下面的示例代码加载[示例 Excel 文件](55541806.xlsx)包含智能艺术形状，如此屏幕截图所示。然后它将智能艺术形状转换为组形状并打印[形状.IsGroup](https://reference.aspose.com/cells/java/com.aspose.cells/shape#IsGroup)财产。请查看下面给出的示例代码的控制台输出。
