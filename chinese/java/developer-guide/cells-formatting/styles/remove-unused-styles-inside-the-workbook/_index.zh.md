...
excel 文件中未使用的样式不仅占用空间，而且在转换为不同格式（如 PDF、HTML 等）时会导致性能问题。Aspose.Cells 提供了[工作簿.removeUnusedStyles()](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#removeUnusedStyles\(\)) 删除工作簿中所有未使用的样式。
