...
type: docs
weight: 1030
url: /zh/java/calculation-of-excel-2016-minifs-and-maxifs-functions/
---
...
以下示例代码加载了 [示例 Excel 文件](5472586.xlsx)，调用 [Workbook.calculateFormula()](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#calculateFormula--) 方法执行公式计算，然后将结果保存为 [输出 PDF](5472585.pdf)。
## **示例代码**
