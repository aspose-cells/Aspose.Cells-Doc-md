...
### **使用Aspose.Cells进行迷你图**
使用 Aspose.Cells 提供的 API ，开发人员可以创建、删除或读取模板文件中的 Sparkline。 管理 Sparkline 的类包含在 [Aspose.Cells.Charts](https://reference.aspose.com/cells/java/com.aspose.cells/Chart) 命名空间中，因此在使用这些特性之前，需要导入此命名空间。
