...
description: 使用Aspose.Cells for Java插入和管理注释或备注。
keywords: 插入注释，插入备注
---
...
通过调用[**Comments**](https://reference.aspose.com/cells/java/com.aspose.cells/CommentCollection)集合的**Add**方法（封装在[**Worksheet**](https://reference.aspose.com/cells/java/com.aspose.cells/Worksheet)对象中）向单元格添加注释。可以通过传递注释索引从[**Comments**](https://reference.aspose.com/cells/java/com.aspose.cells/CommentCollection)集合中访问新的[**Comment**](https://reference.aspose.com/cells/java/com.aspose.cells/Comment)对象。在访问[**Comment**](https://reference.aspose.com/cells/java/com.aspose.cells/Comment)对象之后，使用[**Comment**](https://reference.aspose.com/cells/java/com.aspose.cells/Comment)对象的[**Note**](https://reference.aspose.com/cells/java/com.aspose.cells/comment#Note)属性自定义注释。
...
## **高级主题**
- [更改批注的文本方向](/cells/zh/java/change-text-direction-of-the-comment/)
- [如何更改批注字体颜色](/cells/zh/java/how-to-change-the-comment-font-color/)
- [如何设置评论背景](/cells/zh/java/how-to-set-comment-background/)
- [线程化的批注](/cells/zh/java/threaded-comments/)
