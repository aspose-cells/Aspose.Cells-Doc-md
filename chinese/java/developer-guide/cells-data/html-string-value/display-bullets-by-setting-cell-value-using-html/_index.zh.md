---
title: 通过使用 HTML 设置 Cell 值来显示项目符号
type: docs
weight: 120
url: /zh/java/display-bullets-by-setting-cell-value-using/
description: 了解如何使用 HTML 将项目符号添加到 Excel Cells 和 Aspose.Cells for Java API。
...
{{% alert color="primary" %}}
 ...
 Aspose.Cells 现在支持用 HTML 代码显示项目符号。本文将说明如何使用 HTML 设置单元格值来显示项目符号。我们将使用[**Cell.setHtmlString()**](https://reference.aspose.com/cells/java/com.aspose.cells/cell#HtmlString)使用我们的 HTML 设置单元格值的属性。
...
- [在 Cell 中添加 HTML 富文本](/cells/zh/java/adding-html-rich-text-inside-the-cell/)
