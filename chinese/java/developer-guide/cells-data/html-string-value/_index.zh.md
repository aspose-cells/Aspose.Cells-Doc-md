...
同样，如果有一些简单的 HTML，Aspose.Cells 可以将其转换为 HTML Rich Text。 Aspose.Cells提供[**Cell.setHtmlString()**](https://reference.aspose.com/cells/java/com.aspose.cells/cell#HtmlString)属性，它可以采用这样一个简单的 HTML 并将其转换为格式化的单元格文本。
...
## 相关文章
- [通过使用 HTML 设置 Cell 值来显示项目符号](/cells/zh/java/display-bullets-by-setting-cell-value-using/)
- [从 Cell 获取 HTML5 字符串](/cells/zh/java/get-html5-string-from-cell/)
