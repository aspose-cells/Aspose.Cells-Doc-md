...
type: docs
weight: 420
url: /zh/java/editing-hyperlinks-of-worksheet/
---

{{% alert color="primary" %}} 

Aspose.Cells允许您通过[Worksheet.Hyperlinks](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet#Hyperlinks)集合访问工作表的所有超链接。您可以逐个从该集合访问每个超链接并编辑其属性。
