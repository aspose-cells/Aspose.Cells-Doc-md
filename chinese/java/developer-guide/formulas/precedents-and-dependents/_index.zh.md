...
Aspose.Cells提供[Cell](https://reference.aspose.com/cells/java/com.aspose.cells/Cell)类的[GetPrecedents](https://reference.aspose.com/cells/java/com.aspose.cells/Cell#getPrecedents--)方法，用于跟踪单元格的先例。它返回一个[ReferredAreaCollection](https://reference.aspose.com/cells/java/com.aspose.cells/ReferredAreaCollection)。如上所示，在Book1.xls中，单元格B7包含一个公式"=SUM(A1:A3)"。因此，单元格A1:A3是单元格B7的先例单元格。以下示例演示了使用模板文件Book1.xls跟踪先例的功能。
