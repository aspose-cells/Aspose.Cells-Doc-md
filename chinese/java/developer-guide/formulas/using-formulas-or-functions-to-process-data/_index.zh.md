...
Aspose.Cells提供了功能来使用[**Worksheets.RegisterAddInFunction()**](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#registerAddInFunction-java.lang.String-java.lang.String-boolean-)注册增强功能。然后，当我们设置[**Cell.Formula**](https://reference.aspose.com/cells/java/com.aspose.cells/cell#Formula)= anyFunctionFromAddIn时，输出Excel文件包含来自增强功能的计算值。
