...
下面的示例代码加载[示例 Excel 文件](55541816.xlsx)并访问第一个 XML 映射并打印其[**XmlMap.RootElementName**](https://reference.aspose.com/cells/java/com.aspose.cells/xmlmap#RootElementName)财产。请查看下面给出的示例代码的控制台输出。
