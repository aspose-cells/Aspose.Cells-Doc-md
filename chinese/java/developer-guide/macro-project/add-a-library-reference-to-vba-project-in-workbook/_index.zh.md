...
但有时，您需要通过代码添加或注册VBA项目的库引用。您可以使用 Aspose.Cells 的 [**VbaProject.getReferences().addRegisteredReference()**](https://reference.aspose.com/cells/java/com.aspose.cells/vbaprojectreferencecollection#addRegisteredReference-java.lang.String-java.lang.String-) 方法来实现。

{{% /alert %}}

## **如何向工作簿的 VBA 项目添加库引用**

以下示例代码使用[**VbaProject.getReferences().addRegisteredReference()**](https://reference.aspose.com/cells/java/com.aspose.cells/vbaprojectreferencecollection#addRegisteredReference-java.lang.String-java.lang.String-)方法向工作簿的VBA项目添加或注册了两个库引用。
