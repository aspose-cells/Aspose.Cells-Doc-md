...
Aspose.Cells API已经公开了[**add**](https://reference.aspose.com/cells/java/com.aspose.cells/customdocumentpropertycollection#add(java.lang.String,%20boolean)）方法，用于[**CustomDocumentPropertyCollection**](https://reference.aspose.com/cells/java/com.aspose.cells/CustomDocumentPropertyCollection)类以添加自定义属性到集合中。[**add**](https://reference.aspose.com/cells/java/com.aspose.cells/customdocumentpropertycollection#add(java.lang.String,%20boolean)）方法添加属性到Excel文件并返回新文档属性的引用作为[**DocumentProperty**](https://reference.aspose.com/cells/java/com.aspose.cells/DocumentProperty)对象。
...
使用Aspose.Cells移除自定义属性，调用[**DocumentPropertyCollection.remove**](https://reference.aspose.com/cells/java/com.aspose.cells/documentpropertycollection#remove(java.lang.String)）方法并传递要移除的文档属性的名称。
