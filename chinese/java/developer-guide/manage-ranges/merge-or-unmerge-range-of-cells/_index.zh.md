...
您可以使用Aspose.Cells来合并或拆分单元格范围。Aspose.Cells提供了用于此目的的[**Range.merge()**](https://reference.aspose.com/cells/java/com.aspose.cells/range#merge()和[**Range.unMerge()**](https://reference.aspose.com/cells/java/com.aspose.cells/range#unMerge()方法。本文解释了如何将单元格范围合并为单个单元格。

{{% /alert %}}

以下示例代码首先创建一个范围 - A1:D4 -，然后使用[**Range.merge()**](https://reference.aspose.com/cells/java/com.aspose.cells/range#merge()方法将范围内的单元格合并为单个单元格。
类似地，可以通过创建范围并调用[**Range.unMerge()**](https://reference.aspose.com/cells/java/com.aspose.cells/range#unMerge()方法来拆分单元格。
