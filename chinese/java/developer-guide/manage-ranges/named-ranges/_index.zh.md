...
可以通过调用[Cells](https://reference.aspose.com/cells/java/com.aspose.cells/Cells)集合的重载[createRange](https://reference.aspose.com/cells/java/com.aspose.cells/cells#createRange\(java.lang.String,%20java.lang.String\))方法来创建命名范围。[createRange](https://reference.aspose.com/cells/java/com.aspose.cells/cells#createRange\(java.lang.String,%20java.lang.String\))方法的典型版本接受以下参数：

- 左上角单元格的名称，范围中左上角单元格的名称。
- 右下角单元格的名称，范围中右下角单元格的名称。

调用[createRange](https://reference.aspose.com/cells/java/com.aspose.cells/cells#createRange\(java.lang.String,%20java.lang.String\))方法后，它会将新创建的命名范围返回为[Range](https://reference.aspose.com/cells/java/com.aspose.cells/range)类的实例。
...
#### **访问电子表格中的所有命名范围**
调用[WorksheetCollection](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection)集合的[getRangeByName](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#getRangeByName\(java.lang.String\))方法，通过名称获取指定的范围。典型的[getRangeByName](https://reference.aspose.com/cells/java/com.aspose.cells/worksheetcollection#getRangeByName\(java.lang.String\))方法需要命名范围的名称，并将指定的命名范围返回为[Range](https://reference.aspose.com/cells/java/com.aspose.cells/range)类的实例。
...
#### **格式化范围...向命名范围添加边框**
可以向单元格范围添加边框，而不仅仅是一个单元格。[Range](https://reference.aspose.com/cells/java/com.aspose.cells/range)对象提供了[setOutlineBorders](https://reference.aspose.com/cells/java/com.aspose.cells/range#setOutlineBorders\(int,%20com.aspose.cells.Color\))方法，该方法接受以下参数来向单元格范围添加边框：
...
#### **在Range中为单元格应用样式**
有时，您想要在[Range](https://reference.aspose.com/cells/java/com.aspose.cells/range)中为单元格应用样式。为此，您可以迭代范围中的单元格，并使用[Cell.setStyle](https://reference.aspose.com/cells/java/com.aspose.cells/cell#setStyle\(com.aspose.cells.Style\))方法将样式应用于单元格。
...
#### **移除命名范围**
Aspose.Cells提供[NameCollection.RemoveAt()](https://reference.aspose.com/cells/java/com.aspose.cells/namecollection#removeAt\(int\))方法来擦除范围的名称。要清除范围的内容，使用[Cells.ClearRange()](https://reference.aspose.com/cells/java/com.aspose.cells/cells#clearRange\(com.aspose.cells.CellArea\))方法。
以下示例展示了如何移除命名范围及其内容。
