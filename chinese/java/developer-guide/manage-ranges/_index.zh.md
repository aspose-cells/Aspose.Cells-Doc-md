...
- [复制行或区域时更改图表的数据源到目标工作表](/cells/zh/java/change-data-source-of-the-chart-to-destination-worksheet-while-copying-rows-or-range/)
- [复制Excel的区域](/cells/zh/java/copy-ranges-of-Excel/)
- [仅复制区域数据](/cells/zh/java/copy-range-data-only/)
- [复制具有样式的区域数据](/cells/zh/java/copy-range-data-with-style/)
...
- [剪切和粘贴区域](/cells/zh/java/cut-and-paste-cells/)
- [删除区域](/cells/zh/java/delete-ranges-from-Excel/)
- [在工作表中检测合并的单元格](/cells/zh/java/detect-merged-cells-in-a-worksheet/)
- [获取区域的地址、单元格计数、偏移、整行和整列](/cells/zh/java/get-address-cell-count-offset-entire-column-and-entire-row-of-the-range/)
...
- [合并或取消合并单元格范围](/cells/zh/java/merge-or-unmerge-range-of-cells/)
