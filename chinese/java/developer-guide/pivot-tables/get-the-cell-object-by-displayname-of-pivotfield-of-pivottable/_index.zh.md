...
Aspose.Cells提供[数据透视表.getCellByDisplayName()](https://reference.aspose.com/cells/java/com.aspose.cells/pivottable#getCellByDisplayName\(java.lang.String\)方法，您可以使用该方法通过数据透视字段的显示名称访问单元格对象。当您想要突出显示或格式化数据透视字段标题时，此方法很有用。本文介绍如何通过数据字段的显示名称检索单元格对象，然后对其应用格式。
