...
## **使用PivotTable.setEnableWizard禁用数据透视表功能。**

以下代码通过访问工作表中的数据透视表，然后调用[**setEnableWizard**](https://reference.aspose.com/cells/java/com.aspose.cells/pivottable#EnableWizard)将该标志设置为**false**，演示了此功能。示例数据透视表文件可以从此[链接](71630876.xlsx)下载。
