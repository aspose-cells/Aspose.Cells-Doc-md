...
以下示例代码加载包含三个数据透视表的[sample Excel文件](61767766.xlsx)，底部两个数据透视表是上面数据透视表的子数据透视表如截图所示。代码使用[**PivotTable.getChildren()**](https://reference.aspose.com/cells/java/com.aspose.cells/pivottable#getChildren())方法找到子数据透视表，然后逐个刷新它们。
