...
## **Aspose.Cells - 保存文件**
### **将文件保存到某个位置**
如果开发者需要使用**Aspose.Cells Java for Python**将其文件保存到某个存储位置，他们可以在调用**工作簿**对象的**save**方法时指定文件名（包括完整的存储路径）和期望的文件格式（使用**FileFormatType**枚举）。
...
从以下提到的社交编码网站之一下载**保存文件（Aspose.Cells）**：
