---
title: 在 Python 中打开文件
type: docs
weight: 10
url: /zh/java/opening-files-in-python/
---
## **Aspose.Cells - 在 Python 中打开文件**
要使用 Python 中的 Aspose.Cells Java 打开文件，只需调用 Document 类的 openfile() 方法并指定要在末尾附加的第二个文档。
