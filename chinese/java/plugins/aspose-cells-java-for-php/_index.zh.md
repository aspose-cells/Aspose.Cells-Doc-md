...
- [在 PHP 中下载并配置 Aspose.Cells](/cells/zh/java/download-and-configure-aspose-cells-in-php/)
...
通过复制，tomcat8会自动新建一个文件夹》**Java桥**“ 在**网络应用程序**.创建文件夹后，确保您的 tomcat8 正在运行，然后检查**本地主机：8080/JavaBridge**在浏览器中，它应该打开一个JavaBridge的默认页面。
...
\5.重启tomcat apache服务。
 ...
 6.前往**本地主机：8080/JavaBridge/test.php**检查 php 是否工作。你可以在那里找到其他例子
...
您可以使用以下任何平台记录与 Aspose.Cells Java for PHP 相关的任何问题或建议：
