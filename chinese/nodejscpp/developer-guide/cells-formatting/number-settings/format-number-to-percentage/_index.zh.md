...
type: docs
weight: 10
url: /zh/nodejs-cpp/how-to-format-number-to-percentage/
description: 本文将介绍如何使用 Aspose.Cells for Node.js via C++ API 将数字格式化为百分比。
...
## **如何在 Aspose.Cells for Node.js via C++ 中将数字格式化为百分比**
在 Aspose.Cells for Node.js via C++ 中将数字格式化为百分比是一个简单的过程。Aspose.Cells 是一个强大的库，允许你在 Node.js 中创建、操作和转换 Excel 文件，无需在系统中安装 Microsoft Excel。以下是使用 Aspose.Cells for Node.js via C++ 将数字格式化为百分比的方法：
