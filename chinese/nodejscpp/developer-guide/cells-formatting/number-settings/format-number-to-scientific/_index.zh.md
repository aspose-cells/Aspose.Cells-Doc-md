...
type: docs
weight: 10
url: /zh/nodejs-cpp/how-to-format-number-to-scientific/
description: 本文将介绍如何使用 Aspose.Cells for Node.js via C++ API 将数字格式化为科学计数法。
...
## **如何在 Aspose.Cells for Node.js via C++ 中将数字格式化为科学计数法**
在 Aspose.Cells for Node.js via C++ 中将数字格式化为科学计数法，可以使用单元格的 `Style.setCustom` 方法。Aspose.Cells 允许你定义自定义格式，包括科学计数法。
