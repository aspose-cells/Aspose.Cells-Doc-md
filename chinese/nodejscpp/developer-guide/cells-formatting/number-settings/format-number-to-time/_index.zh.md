...
type: docs
weight: 10
url: /zh/nodejs-cpp/how-to-format-number-to-time/
description: 本文将介绍如何使用 Aspose.Cells for Node.js via C++ API 将数字格式化为时间。
...
## **如何在 Aspose.Cells for Node.js via C++ 中将数字格式化为时间**
在 Aspose.Cells for Node.js via C++ 中将数字格式化为时间是一个简单的过程，只需为单元格或一组单元格应用自定义数字格式即可。Aspose.Cells 是一个强大的库，允许你在 Node.js 中处理 Excel 文件，无需安装 Microsoft Excel。以下是操作步骤：
