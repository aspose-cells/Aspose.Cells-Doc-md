...
type: docs
weight: 600
url: /zh/nodejs-cpp/get-cells-range/
description: 学习如何通过 Aspose.Cells for Node.js via C++ API 获取单元格范围。
keywords: 获取单元格的最大显示范围，获取单元格的最大行数，获取单元格的最大数据行数，获取单元格的最大列数，获取单元格的最大数据列数。 
---

## **可能的使用场景**
当只需要操作工作表的部分数据时，需了解整个工作表的数据范围。Aspose.Cells for Node.js via C++ 提供此功能，包含以下属性和方法，帮助你实现目标。
...
## **使用Aspose.Cells for Node.js via C++获取单元格范围**
此示例演示如何：
