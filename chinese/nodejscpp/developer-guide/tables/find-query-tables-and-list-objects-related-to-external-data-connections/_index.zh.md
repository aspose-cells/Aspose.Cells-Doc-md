---
title: 查找查询表和列表对象，它们与外部数据连接相关，使用Node.js与C++
linktitle: 查找与外部数据连接相关的查询表和列表对象
type: docs
weight: 20
url: /zh/nodejs-cpp/find-query-tables-and-list-objects-related-to-external-data-connections/
description: 学习如何使用Aspose.Cells for Node.js via C++查找查询表和列表对象，它们与外部数据连接相关。
---
