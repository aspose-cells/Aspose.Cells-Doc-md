...
|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
|CELLSJAVA-42493|提供一个选项来决定是否导出工作簿属性|新功能|
|CELLSJAVA-42491|提供一个选项来决定是否导出文档属性|新功能|
|CELLSJAVA-42498|为图表工作表创建 PdfBookmarkEntry|新功能|
|CELLSJAVA-42509|添加 LoadDataFilterOptions.NAMES 常量以在加载工作簿时过滤定义的名称|新功能|
|CELLSJAVA-42519|就像 ImageOrPrintOptions.DrawObjectEventHandler 一样需要 PdfSaveOptions.DrawObjectEventHandler|新功能|
...
|CELLSJAVA-42552|输出 HTML 与 Excel 不匹配|漏洞|
