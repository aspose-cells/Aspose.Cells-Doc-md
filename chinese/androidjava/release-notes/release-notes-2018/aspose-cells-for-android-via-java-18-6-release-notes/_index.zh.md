---
title: Aspose.Cells 适用于 Android，通过 Java 18.6 发行说明
type: docs
weight: 30
url: /zh/java/aspose-cells-for-android-via-java-18-6-release-notes/
---
{{% alert color="primary" %}}

此页面包含 Aspose.Cells for Android 的发行说明，通过 Java 18.6。
...
由于 Aspose.Cells for Android 的代码库通过 Java 与相关 .NET 和 Java 版本的代码相匹配，因此大部分更改、增强和修复都包含在 Aspose.Cells for .NET v18.4、Aspose.Cells for .NET v18.58、181831 中6、Aspose.Cells for Java v18.4、Aspose.Cells for Java v18.5 和 Aspose.Cells for Java v18.6 也包含在这个 Aspose.Cells for Android via Java v18.6 中。
