---
title: Aspose.Cells 适用于 Android，通过 Java 20.6 发行说明
type: docs
weight: 10
url: /zh/java/aspose-cells-for-android-via-java-20-6-release-notes/
---
{{% alert color="primary" %}} 

此页面包含 Aspose.Cells for Android 的发行说明，通过 Java 20.6。
...
|CELLSJAVA-43166|旋转的文本在 XLSX 到 HTML 的转换中未正确呈现|漏洞|
|CELLSJAVA-43178|将文件导出为 HTML 时，RichText 格式丢失|漏洞|
...
|CELLSJAVA-43089|雷达图翻转，轴值与 XLS 到 PDF 转换中的原始图表不相同|漏洞|
|CELLSJAVA-43171|复印纸张后文档损坏|漏洞|
|CELLSJAVA-43172|合并单元格中智能标记的问题|漏洞|
|CELLSJAVA-43180|HTML 到 Excel 的转换创建黑色工作表输出|漏洞|
|CELLSJAVA-43181|Excel 转 HTML 时行高有差异|漏洞|
|CELLSJAVA-43188|在 HTML 到 Excel 的转换过程中不保留背景颜色样式|漏洞|
...
|CELLSJAVA-43185|Linux 上 setImageResample 的 JPEG 质量始终为 75|漏洞|
...
|CELLSJAVA-43177|带有 CSV 文件的新工作簿导致“java.lang.IndexOutOfBoundsException：毫秒”|例外|
...
|CELLSJAVA-43182|加载 XLS 文件时出现“lang.IllegalStateException: Invalid encoding: null”异常|例外|
...
|CELLSJAVA-43193|加载某些 XLSX 文件时出现 NullPointerException|例外|
