---
title: Aspose.Cells 适用于 Android，通过 Java 20.9 发行说明
type: docs
weight: 9
url: /zh/java/aspose-cells-for-android-via-java-20-9-release-notes/
---
{{% alert color="primary" %}}

此页面包含适用于 Java 20.9 的 Android 版 Aspose.Cells 的发行说明。
...
|CELLSJAVA-43214|将 XLS 转换为 XLSX 时会生成损坏的 XLSX 文件|漏洞|
...
利用**FilterColumn.IsDropdownVisible**反而。
