...
type: docs
weight: 30
url: /zh/java/aspose-cells-for-android-via-java-8-9-0-release-notes/
---
|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
...
### **添加 DeleteOptions 类**
表示删除行/列的设置。
### **添加覆盖 Cells.DeleteBlankColumns(DeleteOptions options) 和 Cells.DeleteBlankColumns(DeleteOptions options) 方法。**
删除带有设置的空白行或列。
