...
一个*数据透视表*是一个交互式表格，用于汇总数据并以有意义的方式呈现数据。 SQL Server Reporting Services 在维护数据透视表时无法将报表导出为 Microsft Excel 格式。报表用户每次将数据透视表报表从 Reporting Services 导出到 Microsoft Excel 时都必须手动创建数据透视表。使用 Reporting Services 的 Aspose.Cells，您可以在报表设计时设计一次数据透视表。每次报表运行时，Reporting Services 的 Aspose.Cells 将报表导出到 Microsoft Excel 并将数据刷新到数据透视表中。
...
![待办事项：图片_替代_文本](working-with-pivottable_1.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_2.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_3.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_4.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_5.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_6.png)



设计的数据透视表如下所示。

![待办事项：图片_替代_文本](working-with-pivottable_7.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_8.png)
...
![待办事项：图片_替代_文本](working-with-pivottable_9.png)
