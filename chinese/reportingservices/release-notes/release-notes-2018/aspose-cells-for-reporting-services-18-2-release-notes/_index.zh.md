---
title: Aspose.Cells 用于 Reporting Services 18.2 发行说明
type: docs
weight: 20
...
此页面包含 Reporting Services 18.2 的 Aspose.Cells 发行说明。

{{% /alert %}} 

|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
|CELLSRS-519|使用 Aspose.Cells 为 Reporting Services 调用 MS Excel 打印格式|新功能|
