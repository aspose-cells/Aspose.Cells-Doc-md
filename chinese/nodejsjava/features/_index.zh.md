...
description: "Aspose.Cells for Node.js via Java 特性。"
---

## **Aspose.Cells for Node.js via Java 功能概述**
本部分提供了 Aspose.Cells for Java 和 Aspose.Cells for Node.js via Java 功能可用性比较。
### **文件格式和转换**
全球许多客户依赖Aspose.Cells提供的完整文档导入和导出功能。

|**特性**|**描述**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
| :- | :- | :- | :- |
...
|**特性**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
| :- | :- | :- |
...
|**特性**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
| :- | :- | :- |
|从数组，ArrayList，ResultSet等中导入/导出数据。|{{< emoticons/tick >}}|{{< emoticons/cross >}}|
