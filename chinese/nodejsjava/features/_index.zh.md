...
description: "Aspose.Cells for Node.js via Java特性."
---

## **Aspose.Cells for Node.js via Java特性概述**
本节提供了Aspose.Cells for Java和Aspose.Cells for Node.js via Java之间功能可用性的比较。
### **文件格式和转换**
全球许多客户依靠Aspose.Cells提供的全面文档导入和导出功能。

|**功能**|**描述**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
| :- | :- | :- | :- |
...
|**功能**|**Aspose.Cells for Java**|**Aspose.Cells for Node.js via Java**|
| :- | :- | :- |
...
|对工作表、行、列或一系列单元格等应用格式设置。|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
### **页面设置功能**
