...
###### **本节包括以下主题:** 
- [转换单个文件](/cells/zh/sharepoint/convert-one-file/)
...
- [在文档中进行搜索](/cells/zh/sharepoint/searching-in-a-document/)
- [向文档添加水印](/cells/zh/sharepoint/add-watermark-to-a-document/)
- [向文档添加页脚](/cells/zh/sharepoint/add-footer-to-a-document/)
- [向多个文档添加页脚](/cells/zh/sharepoint/add-footer-to-multiple-documents/)
- [向多个文档添加水印](/cells/zh/sharepoint/add-watermark-to-multiple-documents/)
