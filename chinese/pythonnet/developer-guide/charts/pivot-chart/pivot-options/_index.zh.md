...
type: docs
weight: 10
url: /zh/python-net/how-to-manage-pivotchart-with-pivotoptions/
...
## 如何使用数据透视表选项管理数据透视图
 ...
 使用Aspose.Cells for Python via .NET，您可以使用[**PivotOptions**](https://reference.aspose.com/cells/python-net/aspose.cells.charts/pivotoptions)来管理数据透视图。
