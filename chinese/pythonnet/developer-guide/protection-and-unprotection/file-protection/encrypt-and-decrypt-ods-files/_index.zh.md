...
type: docs
weight: 10
url: /zh/python-net/encrypt-and-decrypt-ods-files/
description: 使用Aspose.Cells for Python via .NET可以对ODS文件进行密码保护和加密，这是一款纯NET库。
---
...
Aspose.Cells for Python via .NET支持ODS文件的加密和解密。解密后的ODS文件可在Excel和OpenOffice中打开。 
{{% /alert %}}
...
## **使用Aspose.Cells for Python via .NET加密ODS文件**
要对ODS文件进行加密，加载文件并在保存之前将[**WorkbookSettings.password**](https://reference.aspose.com/cells/python-net/aspose.cells/workbooksettings/password)值设置为实际密码。加密的输出ODS文件只能在OpenOffice中打开。

{{< gist "aspose-cells-gists" "7bb30376b4d40cdfd596286870fb9752" "Protection-and-unprotection-EncryptingODSFiles-1.py" >}}

## **使用Aspose.Cells for Python via .NET解密ODS文件**
