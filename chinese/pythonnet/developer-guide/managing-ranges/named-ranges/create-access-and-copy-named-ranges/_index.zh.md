...
description: 本文介绍如何使用Aspose.Cells for Python via .NET API创建访问并复制已命名区域。
keywords: Python Excel库、Python创建访问并复制已命名区域、Python创建已命名区域、Python复制已命名区域、Python访问电子表格中的所有已命名区域。
---
...
在这里，我们使用Aspose.Cells for Python via .NET API来完成任务。
...
通过调用 [**Cells**](https://reference.aspose.com/cells/python-net/aspose.cells/cells) 集合的重载 [**create_range**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/create_range/#str-str) 方法，可以创建命名范围。 [**create_range**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/create_range/#str-str) 方法的典型版本使用以下参数：

- 左上角单元格的名称，范围中左上角单元格的名称。
- 右下角单元格的名称，范围中右下角单元格的名称。

调用 [**create_range**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/create_range/#str-str) 方法时，它将返回新创建的范围，作为 [**Range**](https://reference.aspose.com/cells/python-net/aspose.cells/range) 类的实例。使用此 [**Range**](https://reference.aspose.com/cells/python-net/aspose.cells/range) 对象来配置命名范围。例如，使用 [**name**](https://reference.aspose.com/cells/python-net/aspose.cells/range/name) 属性设置范围的名称。以下示例展示了如何创建跨越 B4:G14 的单元格命名范围。
...
Aspose.Cells for Python via .NET 提供了 [**Range.copy()**](https://reference.aspose.com/cells/python-net/aspose.cells/range/copy/#aspose.cells.Range) 方法，用于将带有格式的单元格范围复制到另一个范围。
