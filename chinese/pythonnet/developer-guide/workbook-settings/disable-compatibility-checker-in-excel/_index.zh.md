...
type: docs
weight: 170
url: /zh/python-net/disable-compatibility-checker-in-excel/
description: 本文介绍了如何通过 Aspose.Cells for Python via .NET API 禁用兼容性检查器。
keywords: Python 禁用兼容性检查器，Excel 在 C# 中禁用兼容性检查器，禁用工作簿中的兼容性检查器。 
---

## 在 Python 中禁用 Excel 工作表的兼容性检查器 
...
有时，您需要为特定的电子表格禁用兼容性检查器。使用 Aspose.Cells for Python via .NET 的 API，可以以编程方式实现此功能，这样用户在手动在 Microsoft Excel 中重新保存文件时，不会因兼容性检查器对话框而感到沮丧或困惑。
...
将[**Workbook.settings.check_compatibility**](https://reference.aspose.com/cells/python-net/aspose.cells/workbooksettings/check_compatibility)属性设置为**False**以禁用Microsoft Excel的兼容性检查程序。

### **代码示例**

以下代码示例演示了如何使用 Aspose.Cells for Python via .NET 禁用兼容性检查器。
