...
type: docs
weight: 10
url: /zh/python-net/supported-formula-functions/
...
Aspose.Cells for Python via .NET APIs 支持大部分标准函数和 Excel 的内置公式。以下，您可以按字母顺序找到所有支持的函数。
...
Aspose.Cells for Python via .NET 的公式计算引擎允许你设置、读取和计算以下公式和函数的结果。
