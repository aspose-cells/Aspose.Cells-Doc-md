...
type: docs
weight: 10
url: /zh/python-net/how-to-format-number-to-fraction/
description: 本文将介绍如何使用Aspose.Cells for Python via .NET API 将数字格式化为分数。
...
## **如何在Aspose.Cells for Python via .NET中将数字格式化为分数**
将数字格式化为分数在Aspose.Cells for Python via .NET中是一个简单的过程。Aspose.Cells for Python via .NET是一个功能强大的库，能够在不安装Microsoft Excel的情况下在.NET应用程序中操作Excel文件。它提供了丰富的功能，包括将数字格式化为分数。

以下是如何在Aspose.Cells for Python via .NET中将数字格式化为分数的详细步骤：

### 第一步：安装 Aspose.Cells for Python via .NET
