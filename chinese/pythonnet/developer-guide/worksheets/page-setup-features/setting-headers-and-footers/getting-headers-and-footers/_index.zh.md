...
description: 本文介绍了如何使用 Aspose.Cells for Python via .NET API 以编程方式从 Excel 或 OpenOffice 文件中获取标题和页脚。
keywords: Python Excel库，Python 获取标题和页脚，将标题和页脚解析为命令列表的方法。
---
...
## **如何使用 Aspose.Cells for Python Excel 库获取标题和页脚**
...
Aspose.Cells for Python via .NET 提供 [**Worksheet.page_setup.get_commands**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/get_commands/#str) 方法将标题和页脚解析为命令列表。
