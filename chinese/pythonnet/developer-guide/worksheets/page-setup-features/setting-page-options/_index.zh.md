...
使用[**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup)类的[**orientation**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/orientation)属性将页面方向设置为纵向或横向。[**orientation**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/orientation)属性接受[**PageOrientationType**](https://reference.aspose.com/cells/python-net/aspose.cells/pageorientationtype)枚举中列出的预定义值之一。
...
使用[**PageSetup**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/)类的[**print_quality**](https://reference.aspose.com/cells/python-net/aspose.cells/pagesetup/print_quality/)属性将要打印的工作表的打印质量设置为。打印质量的度量单位为每英寸的点数（DPI）。
