...
要将数字显示为日期和时间，请通过[Style.number](https://reference.aspose.com/cells/python-net/aspose.cells/style/number/)或[Style.Custom]()属性为单元格应用所需的日期和时间格式。CellValue.DateTimeValue属性返回DateTime对象，指定由单元格中的数字表示的日期和时间。
<br>
...
1. 1904日期系统。第一个日期是1904年1月1日，其序列值为0。最后一个日期是9999年12月31日，其序列值为2,957,003。如要在工作簿中使用此日期系统，请将[**Workbook.settings.date1904**](https://reference.aspose.com/cells/python-net/aspose.cells/workbooksettings/date1904/)属性设置为true。
