...
description: 本主题向您展示了如何使用 Aspose.Cells for Python via NET 将 HTML 转换为 PDF saveformat 和 MHTML 转换为 PDF saveformat。
keywords: 将 HTML 转换为 PDF saveformat 和 MHTML 转换为 PDF saveformat。
---
...
## **Python中的HTML到PDF转换**
如何使用[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)库将HTML转换成PDF？借助Aspose.Cells for Python via NET，您可以轻松以几行代码程序化地将HTML转换成PDF。Aspose.Cells for Python via NET能够构建跨平台应用程序，具有生成、修改、转换、渲染和打印所有Excel文件的能力。

## **Python转换HTML为PDF**
以下的C#代码示例展示了如何使用[Aspose.Cells for Python via NET](https://pypi.org/project/aspose-cells-python/)将HTML文档转换为PDF。
