...
description: 本文介绍了如何使用 Aspose.Cells for Python 通过 .NET API 复制行和列。
keywords: Python Excel库，Python如何复制行和列，Python在Python中复制行，使用Python复制列，如何使用Aspose.Cells for Python 通过 .NET 粘贴行和列，Python粘贴多行和列，Python如何复制和粘贴单行或单列。
---
...
Aspose.Cells 提供 [**Cells**](https://reference.aspose.com/cells/python-net/aspose.cells/cells) 类的 [**copy_row**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_row/#aspose.cells.Cells-int-int) 方法。该方法从源行复制包括公式、数值、注释、单元格格式、隐藏单元格、图像和其他绘图对象等所有类型的数据到目标行。

[**copy_row**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_row/#aspose.cells.Cells-int-int) 方法接受以下参数：

- 源 [**Cells**](https://reference.aspose.com/cells/python-net/aspose.cells/cells) 对象，
- 源行索引，并
- 目标行索引。
...
您可以跳过使用 [**Cells.get_row_height**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/get_row_height/#int) 方法获取源行高度以及使用 [**Cells.set_row_height**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/set_row_height/#int-float) 方法设置目标行高度的步骤，因为 [**copy_row**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_row/#aspose.cells.Cells-int-int) 方法会自动处理行高。
...
您还可以使用 [**Cells.copy_rows**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_rows/#aspose.cells.Cells-int-int-int) 方法复制多行到新的目标，该方法接受整数类型的额外参数以指定要复制的源行数。
...
Aspose.Cells 提供 [**Cells**](https://reference.aspose.com/cells/python-net/aspose.cells/cells) 类的 [**copy_column**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_column/#aspose.cells.Cells-int-int) 方法，该方法从源列复制包括更新引用的公式和数值、注释、单元格格式、隐藏单元格、图像和其他绘图对象等所有类型的数据到目标列。
...
使用 [**copy_column**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_column/#aspose.cells.Cells-int-int) 方法在同一工作表内或到另一个工作表内复制一列。
...
类似于 [**Cells.copy_rows**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_rows/#aspose.cells.Cells-int-int-int) 方法，Aspose.Cells API 还提供 [**Cells.copy_columns**](https://reference.aspose.com/cells/python-net/aspose.cells/cells/copy_columns/) 方法，以便将多个源列复制到新位置。
