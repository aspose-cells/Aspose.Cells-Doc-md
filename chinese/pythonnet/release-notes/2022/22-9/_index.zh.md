---
title: Aspose.Cells 为 Python 通过 .NET 22.9 发行说明
type: docs
weight: 8
url: /zh/python-net/aspose-cells-for-python-net-22-9-release-notes/
---
{{% alert color="primary" %}} 

这是 Aspose.Cells 的第一个版本，用于 Python 通过 .NET。
此页面包含 Aspose.Cells 的发行说明，适用于 Python via .NET 22.9。
...
|CELLSNET-51743|将 Excel 文件转换为 PDF 后，某些符号发生了变化|
...
|CELLSNET-51899|XLS 到 XLSM 的转换 - MS Excel 无法打开输出的 XLSM 文件|
...
|CELLSNET-51187|垂直虚线与图表中轴上的标签未对齐以进行 SVG 渲染|
...
|CELLSNET-51608|在 docker 上将 Excel 导出为 HTML 时，数字隐藏在红色/绿色圆圈后面（Azure 云 kubernetes）|
...
|CELLSNET-51461|为 Excel 中的数据添加不必要的边框到 DOCX 转换|
|CELLSNET-51736|Cell 边框在生成的 PDF 中丢失|
...
|CELLSNET-51778|将 XLS 文件转换为 XLSM 会删除命名范围内链接末尾的几个字符|
|CELLSNET-51785|DOCX >> Html 表格 >> Excel 表格无法正确转换|
...
|CELLSNET-51880|XLSB 到 XLSM 的转换 - 输出的 XLSM 文件已损坏|
|CELLSNET-51898|XLS 到 XLSM 的转换 - 输出的 XLSM 文件已损坏|
...
|CELLSNET-51965|将具有会计格式的 XLSX 文件导入 Aspose.Cells.GridDesktop 时出现异常|
|CELLSNET-51961|将 ODS 渲染为 PDF 时出现异常“索引超出范围”|
